...
| Offline Skill Training | [Items/StudyBook.cs](../Data/Scripts/Custom/Offline%20Skill%20Training/Items/StudyBook.cs) | Code-Verified 2026-05-04 | Medium | Event-driven study books convert offline time into randomized skill-gain attempts and optional accelerated gains. [Documentation](wiki/offline-skill-training.md). |
| Player Range Sensitive Mod | [setdeactivation.cs](../Data/Scripts/Custom/Player%20Range%20Sensitive%20Mod/setdeactivation.cs) | Code-Verified 2026-05-04; Needs Rework | Low | Runtime AI deactivation delay for player-range-sensitive creatures. [Documentation](wiki/player-range-sensitive-mod.md). Needs C# rework: `[SetDeactivation` stores unvalidated `double` input, so NaN, infinity, extreme, zero, or negative values can feed later `TimeSpan.FromMinutes` AI timer math. |
| Point Command System | [Point.cs](../Data/Scripts/Custom/Point%20Command%20%5B2.0%5D/Point.cs) | Code-Verified 2026-05-04 | Low | Player emote command for pointing at mobiles, items, or map locations. [Documentation](wiki/point-command.md). |
