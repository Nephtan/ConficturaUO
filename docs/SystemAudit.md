...
| NPC Control Commands | [CloneCommands.cs](../Data/Scripts/Custom/NPC%20Control/CloneCommands.cs) | Code-Verified 2026-05-05; Needs Rework | Medium | Counselor-level clone/control and helper staff commands. [Documentation](wiki/NPC_Control_Commands.md). Needs C# rework: `[Control` parses `NoStats`, `NoSkills`, and `NoItems`, but the active copy path ignores those flags; `UncontrolDeath` restores mana from `StamMax` instead of `ManaMax`. |
