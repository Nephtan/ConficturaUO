# SOURCE-BATCH-201 EShadowFirePitCross Guard Repair

## Target

- Candidate: `SB201-CAND-001`
- Behavior: add stale/null/mobile/source-component guard to `EShadowFirePitCrossComponent.OnDoubleClick(Mobile from)`.
- System: `Items:Gifts / ShadowDeeds / EShadowFirePitCross`
- File: `Data/Scripts/Items/Gifts/ShadowDeeds/EShadowFirePitCross.cs`
