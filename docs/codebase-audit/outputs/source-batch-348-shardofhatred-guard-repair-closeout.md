# SOURCE-BATCH-348 ShardOfHatred Guard Repair Closeout

## Summary

`SOURCE-BATCH-348` implemented `SB348-CAND-001`, a non-gated guard repair for `ShardOfHatred`.

## Source Change

- File: `Data/Scripts/Quests/Shadowlords/ShardOfHatred.cs`
- `ShardOfHatred.OnDoubleClick(Mobile from)` now returns safely for null/deleted mobiles before reading `from.Backpack`.
...
- Item ID `0x3155`, `Name = "Shard of Hatred"`, `Weight = 1.0`, and `Hue = 0x48E`.
...
- POST-BATCH-Y exact-file gate hits for `Data/Scripts/Quests/Shadowlords/ShardOfHatred.cs`: `0`
- Exact-file active overlay rows for `Data/Scripts/Quests/Shadowlords/ShardOfHatred.cs`: `0`
