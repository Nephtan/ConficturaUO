# SOURCE-BATCH-052 OilGarnet Guard Repair

## Target

- Candidate: `SB049-CAND-004`
- Behavior: add stale/null/mobile/backpack/source-oil/target-item/oil-cloth guards to OilGarnet interactions.
- System: `Items:Potions / Oils / OilGarnet`
- Source file: `Data/Scripts/Items/Potions/Oils/OilGarnet.cs`
...
Add guard-only checks in `OilGarnet.OnDoubleClick(Mobile from)` and `OilTarget.OnTarget(Mobile from, object targeted)`.
...
```text
/goal SOURCE-BATCH-052 OilGarnet Guard Repair
```
