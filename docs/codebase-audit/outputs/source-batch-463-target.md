# SOURCE-BATCH-463 BookWitchBrewing Guard Repair Target

## Target

- Batch: `SOURCE-BATCH-463`
- Candidate: `SB463-CAND-001`
- Behavior: add stale/null mobile, deleted source item, and missing-backpack guards to `BookWitchBrewing.OnDoubleClick(Mobile e)`.
- System: `Magic:Witch / BookWitchBrewing`
...
`/goal SOURCE-BATCH-463 BookWitchBrewing Guard Repair`
