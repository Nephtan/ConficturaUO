...
| Wiki index | Present: `docs/wiki/INDEX.md` with 107 indexed links |
...
| `phase-07-canonical-page-map.csv` | 105 | Canonical indexed page map with source trace and coverage status. |
| `phase-07-alias-legacy-slug-map.csv` | 2 | Alias and legacy slug map with canonical targets and independent-claim flags. |
| `phase-07-stale-claim-backlog.csv` | 115 | Generated documentation verification backlog candidates. |
...
| Metric | Count |
| --- | ---: |
| Canonical wiki pages | 105 |
| Canonical pages missing Source Trace | 104 |
| Alias or legacy slug pages | 2 |
| Alias pages with independent claims | 2 |
| Generated backlog candidates | 115 |
