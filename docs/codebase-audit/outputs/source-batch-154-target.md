# SOURCE-BATCH-154 AstralProjectionScroll Guard Repair

## Target

- Candidate: `SB154-CAND-001`
- System: `Magic:Mystic / AstralProjectionScroll`
- File: `Data/Scripts/Magic/Mystic/Scrolls/AstralProjectionScroll.cs`
- Behavior: add stale/null/mobile/source-scroll guards to `AstralProjectionScroll.OnDoubleClick(Mobile from)` and `OnDragLift(Mobile from)` before comparing owner, sending messages, or deleting the scroll.
