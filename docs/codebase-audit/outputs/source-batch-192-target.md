# SOURCE-BATCH-192 CrystalToken Guard Repair

## Target

- Candidate: `SB192-CAND-001`
- Behavior: add stale/null/mobile/source-token/backpack guards to `CrystalToken.OnDoubleClick(Mobile from)`.
- System: `Items:Gifts / CrystalToken`
- File: `Data/Scripts/Items/Gifts/Crystal Token.cs`
...
- Crystal token item ID, name, stackable setting, weight, and blessed loot type.
- Localized backpack-use failure message `1042001`.
- Valid in-backpack `CrystalTokenGump` open behavior.
