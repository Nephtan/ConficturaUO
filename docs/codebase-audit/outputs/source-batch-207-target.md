# SOURCE-BATCH-207 PileOfGlacialSnow Guard Repair

## Target

- Candidate: `SB206-CAND-002`
- Behavior: add stale/null/mobile/source-item and target guards to `PileOfGlacialSnow` snowball interaction paths.
- System: `Items:Gifts / Holiday / Christmas / PileOfGlacialSnow`
- File: `Data/Scripts/Items/Gifts/Holiday/Christmas/Christmas Gifts/PileOfGlacialSnow.cs`
...
- Target range `10`, self-target rejection, valid reciprocal snow holder rule, snowball hit/miss messages, sound `0x145`, animation, moving-effect hue `0x47F`, and winter label/properties.
