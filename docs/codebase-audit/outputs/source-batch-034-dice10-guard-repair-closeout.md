# SOURCE-BATCH-034 Closeout: Dice10 Guard Repair

Reviewed at: 2026-06-16T20:34:00-05:00

## Summary

`SOURCE-BATCH-034` implemented `SB031-CAND-004`, a non-gated `Dice10` guard repair in `Data/Scripts/Items/Misc/Games/DandD/Dice10.cs`.
...
- Targeted source scan confirmed `AddNameProperties`, telekinesis effects, sound `0x1F5`, `Utility.Random(1, 10)`, sound `0x34`, `writer.Write`, and `reader.ReadInt` markers remain present.
