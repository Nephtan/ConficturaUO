# SOURCE-BATCH-053 OilIce Guard Repair

## Target

- Candidate: `SB049-CAND-005`
- Behavior: add stale/null/mobile/backpack/source-oil/target-item/oil-cloth guards to OilIce interactions.
- System: `Items:Potions / Oils / OilIce`
- Source file: `Data/Scripts/Items/Potions/Oils/OilIce.cs`
...
Add guard-only checks in `OilIce.OnDoubleClick(Mobile from)` and `OilTarget.OnTarget(Mobile from, object targeted)`.
...
```text
/goal SOURCE-BATCH-053 OilIce Guard Repair
```
