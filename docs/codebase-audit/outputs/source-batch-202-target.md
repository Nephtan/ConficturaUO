# SOURCE-BATCH-202 EShadowPillar Guard Repair

## Target

- Candidate: `SB201-CAND-002`
- Behavior: add stale/null/mobile/source-component guard to `EShadowPillarComponent.OnDoubleClick(Mobile from)`.
- System: `Items:Gifts / ShadowDeeds / EShadowPillar`
- File: `Data/Scripts/Items/Gifts/ShadowDeeds/EShadowPillar.cs`
