# SOURCE-BATCH-252 LevelLantern Guard Repair Closeout

## Summary

`SOURCE-BATCH-252` created fresh candidate discovery and implemented `SB252-CAND-001` in `Data/Scripts/Items/Magical/God/Jewels/MagicLantern.cs`.

`LevelLantern.OnDoubleClick(Mobile from)` now guards stale/null/deleted interaction state before layer lookup, backpack checking, equip, and unequip paths.
...
- POST-BATCH-Y exact-file gate hits for `Data/Scripts/Items/Magical/God/Jewels/MagicLantern.cs`: `0`
