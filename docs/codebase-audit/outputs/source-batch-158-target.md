# SOURCE-BATCH-158 LeapScroll Guard Repair

## Target

- Candidate: `SB154-CAND-005`
- System: `Magic:Mystic / LeapScroll`
- File: `Data/Scripts/Magic/Mystic/Scrolls/LeapScroll.cs`
- Behavior: add stale/null/mobile/source-scroll guards to `LeapScroll.OnDoubleClick(Mobile from)` and `OnDragLift(Mobile from)` before comparing owner, sending messages, or deleting the scroll.
