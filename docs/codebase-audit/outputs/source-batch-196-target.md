# SOURCE-BATCH-196 ECrystalBrazier Guard Repair

## Target

- Candidate: `SB195-CAND-002`
- Behavior: add stale/null/mobile/source-component guard to `ECrystalBrazierComponent.OnDoubleClick(Mobile from)`.
- System: `Items:Gifts / CrystalDeeds / ECrystalBrazier`
- File: `Data/Scripts/Items/Gifts/CrystalDeeds/ECrystalBrazier.cs`
...
- Component item ID, light setting, and addon layout.
