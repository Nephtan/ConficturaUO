# SOURCE-BATCH-205 ESpikePostSouth Guard Repair

## Target

- Candidate: `SB204-CAND-002`
- Behavior: add stale/null/mobile/source-component guard to `ESpikePostSouthComponent.OnDoubleClick(Mobile from)`.
- System: `Items:Gifts / ShadowDeeds / ESpikePostSouth`
- File: `Data/Scripts/Items/Gifts/ShadowDeeds/ESpikePostSouth.cs`
