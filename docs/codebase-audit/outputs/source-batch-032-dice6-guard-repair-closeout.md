# SOURCE-BATCH-032 Closeout: Dice6 Guard Repair

Reviewed at: 2026-06-16T20:28:00-05:00

## Summary

`SOURCE-BATCH-032` implemented `SB031-CAND-002`, a non-gated `Dice6` guard repair in `Data/Scripts/Items/Misc/Games/DandD/Dice6.cs`.
...
- Targeted source scan confirmed `AddNameProperties`, telekinesis effects, sound `0x1F5`, `Utility.Random(1, 6)`, sound `0x34`, `writer.Write`, and `reader.ReadInt` markers remain present.
