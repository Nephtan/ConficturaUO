# SOURCE-BATCH-225 StoneWell Guard Repair

## Target

- Candidate: `SB225-CAND-001`
- Behavior: add stale/null/mobile/source-component/parent-addon guard to `StoneWellPiece.OnDoubleClick(Mobile from)`.
- System: `Items:Construction / Wells / StoneWell`
- File: `Data/Scripts/Items/Construction/Wells/stonewell.cs`
