...
| source-change-executive-decision-intake.csv | Source decisions | Excel-openable executive decision intake for remaining source-change gates, including plain-English context, recommendations, risks, automation guidance, and blank answer columns. | Complete |
