...
| `post-batch-d-pooled-enumerable-review.csv` | Post-audit | Review and repair P1 pooled enumerable ownership rows in focused source batches; 155 rows are reviewed through `POST-BATCH-D-38A`: 153 fixed and 2 false positives. | InProgress |
