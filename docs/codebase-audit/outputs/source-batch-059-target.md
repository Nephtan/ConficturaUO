# SOURCE-BATCH-059 OilSapphire Guard Repair

## Target

- Candidate: `SB049-CAND-011`
- Behavior: add stale/null/mobile/backpack/source-oil/target-item/oil-cloth guards to OilSapphire interactions.
- System: `Items:Potions / Oils / OilSapphire`
- Source file: `Data/Scripts/Items/Potions/Oils/OilSapphire.cs`
...
Add guard-only checks in `OilSapphire.OnDoubleClick(Mobile from)` and `OilTarget.OnTarget(Mobile from, object targeted)`.
...
```text
/goal SOURCE-BATCH-059 OilSapphire Guard Repair
```
