# SOURCE-BATCH-454 LearnTailorBook Guard Repair Target

## Target

- Batch: `SOURCE-BATCH-454`
- Candidate: `SB454-CAND-001`
- Behavior: add stale/null mobile, deleted source item, and missing-backpack guards to `LearnTailorBook.OnDoubleClick(Mobile e)`.
- System: `Items:Books / LearnTailorBook`
...
`/goal SOURCE-BATCH-454 LearnTailorBook Guard Repair`
