# SOURCE-BATCH-459 LearnLeatherBook Guard Repair Target

## Target

- Batch: `SOURCE-BATCH-459`
- Candidate: `SB459-CAND-001`
- Behavior: add stale/null mobile, deleted source item, and missing-backpack guards to `LearnLeatherBook.OnDoubleClick(Mobile e)`.
- System: `Items:Books / LearnLeatherBook`
...
`/goal SOURCE-BATCH-459 LearnLeatherBook Guard Repair`
