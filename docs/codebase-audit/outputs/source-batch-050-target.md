# SOURCE-BATCH-050 OilCaddellite Guard Repair

## Target

- Candidate: `SB049-CAND-002`
- Behavior: add stale/null/mobile/backpack/source-oil/target-item/oil-cloth guards to OilCaddellite interactions.
- System: `Items:Potions / Oils / OilCaddellite`
- Source file: `Data/Scripts/Items/Potions/Oils/OilCaddellite.cs`
...
- `OilCaddellite.OnDoubleClick(Mobile from)`
...
```text
/goal SOURCE-BATCH-050 OilCaddellite Guard Repair
```
