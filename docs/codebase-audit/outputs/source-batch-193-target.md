# SOURCE-BATCH-193 ShadowToken Guard Repair

## Target

- Candidate: `SB193-CAND-001`
- Behavior: add stale/null/mobile/source-token/backpack guards to `ShadowToken.OnDoubleClick(Mobile from)`.
- System: `Items:Gifts / ShadowToken`
- File: `Data/Scripts/Items/Gifts/Shadow Token.cs`
...
- Shadow token item ID, name, stackable setting, weight, and blessed loot type.
- Localized backpack-use failure message `1042001`.
- Valid in-backpack `ShadowTokenGump` open behavior.
