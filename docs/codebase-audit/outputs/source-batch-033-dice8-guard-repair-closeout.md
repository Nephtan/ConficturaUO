# SOURCE-BATCH-033 Closeout: Dice8 Guard Repair

Reviewed at: 2026-06-16T20:31:00-05:00

## Summary

`SOURCE-BATCH-033` implemented `SB031-CAND-003`, a non-gated `Dice8` guard repair in `Data/Scripts/Items/Misc/Games/DandD/Dice8.cs`.
...
- Targeted source scan confirmed `AddNameProperties`, telekinesis effects, sound `0x1F5`, `Utility.Random(1, 8)`, sound `0x34`, `writer.Write`, and `reader.ReadInt` markers remain present.
