...
1. Continue `POST-BATCH-E` with the next focused P1 runtime-hook group by the active plan, currently Offline Skill Training `StudyBook.cs` rows `RB-01712` through `RB-01715`.
