# SOURCE-BATCH-198 EObsidianPillar Guard Repair

## Target

- Candidate: `SB198-CAND-001`
- Behavior: add stale/null/mobile/source-component guard to `EObsidianPillarComponent.OnDoubleClick(Mobile from)`.
- System: `Items:Gifts / ShadowDeeds / EObsidianPillar`
- File: `Data/Scripts/Items/Gifts/ShadowDeeds/EObsidianPillar.cs`
