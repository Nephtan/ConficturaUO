# SOURCE-BATCH-197 EGlobeOfSosaria Guard Repair

## Target

- Candidate: `SB195-CAND-003`
- Behavior: add stale/null/mobile/source-component guard to `EGlobeOfSosariaComponent.OnDoubleClick(Mobile from)`.
- System: `Items:Gifts / ShadowDeeds / EGlobeOfSosaria`
- File: `Data/Scripts/Items/Gifts/ShadowDeeds/EGlobeOfSosaria.cs`
