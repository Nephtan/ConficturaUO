# SOURCE-BATCH-204 ESpikePostEast Guard Repair

## Target

- Candidate: `SB204-CAND-001`
- Behavior: add stale/null/mobile/source-component guard to `ESpikePostEastComponent.OnDoubleClick(Mobile from)`.
- System: `Items:Gifts / ShadowDeeds / ESpikePostEast`
- File: `Data/Scripts/Items/Gifts/ShadowDeeds/ESpikePostEast.cs`
