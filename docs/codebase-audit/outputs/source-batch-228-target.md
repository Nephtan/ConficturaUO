# SOURCE-BATCH-228 BrownWell Guard Repair

## Target

- Candidate: `SB228-CAND-001`
- Behavior: add stale/null/mobile/source-component/parent-addon guard to `BrownWellPiece.OnDoubleClick(Mobile from)`.
- System: `Items:Construction / Wells / BrownWell`
- File: `Data/Scripts/Items/Construction/Wells/brownwell.cs`
