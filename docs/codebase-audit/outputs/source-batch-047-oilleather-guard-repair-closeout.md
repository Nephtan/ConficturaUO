# SOURCE-BATCH-047 OilLeather Guard Repair Closeout

## Summary

SOURCE-BATCH-047 implemented the guard-only OilLeather repair in `Data/Scripts/Items/Potions/Oils/OilLeather.cs`.
...
SOURCE-BATCH-047 is complete. `SOURCE-BATCH-048+` remains pending OilWood Guard Repair from `source-batch-046-candidate-discovery.csv`.
