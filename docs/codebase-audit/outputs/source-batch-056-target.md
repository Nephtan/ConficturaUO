# SOURCE-BATCH-056 OilOnyx Guard Repair

## Target

- Candidate: `SB049-CAND-008`
- Behavior: add stale/null/mobile/backpack/source-oil/target-item/oil-cloth guards to OilOnyx interactions.
- System: `Items:Potions / Oils / OilOnyx`
- Source file: `Data/Scripts/Items/Potions/Oils/OilOnyx.cs`
...
Add guard-only checks in `OilOnyx.OnDoubleClick(Mobile from)` and `OilTarget.OnTarget(Mobile from, object targeted)`.
...
```text
/goal SOURCE-BATCH-056 OilOnyx Guard Repair
```
