# SOURCE-BATCH-063 OilTopaz Guard Repair

## Target

- Candidate: `SB049-CAND-015`
- Behavior: add stale/null/mobile/backpack/source-oil/target-item/oil-cloth guards to OilTopaz interactions.
- System: `Items:Potions / Oils / OilTopaz`
- Source file: `Data/Scripts/Items/Potions/Oils/OilTopaz.cs`
...
Add guard-only checks in `OilTopaz.OnDoubleClick(Mobile from)` and `OilTarget.OnTarget(Mobile from, object targeted)`.
...
```text
/goal SOURCE-BATCH-063 OilTopaz Guard Repair
```
