# SOURCE-BATCH-224 WoodWell Guard Repair

## Target

- Candidate: `SB224-CAND-001`
- Behavior: add stale/null/mobile/source-component/parent-addon guard to `WoodWellPiece.OnDoubleClick(Mobile from)`.
- System: `Items:Construction / Wells / WoodWell`
- File: `Data/Scripts/Items/Construction/Wells/woodwell.cs`
