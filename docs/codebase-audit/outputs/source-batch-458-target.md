# SOURCE-BATCH-458 LearnMetalBook Guard Repair Target

## Target

- Batch: `SOURCE-BATCH-458`
- Candidate: `SB458-CAND-001`
- Behavior: add stale/null mobile, deleted source item, and missing-backpack guards to `LearnMetalBook.OnDoubleClick(Mobile e)`.
- System: `Items:Books / LearnMetalBook`
...
`/goal SOURCE-BATCH-458 LearnMetalBook Guard Repair`
