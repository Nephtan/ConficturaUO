# SOURCE-BATCH-199 EObsidianRock Guard Repair

## Target

- Candidate: `SB198-CAND-002`
- Behavior: add stale/null/mobile/source-component guard to `EObsidianRockComponent.OnDoubleClick(Mobile from)`.
- System: `Items:Gifts / ShadowDeeds / EObsidianRock`
- File: `Data/Scripts/Items/Gifts/ShadowDeeds/EObsidianRock.cs`
