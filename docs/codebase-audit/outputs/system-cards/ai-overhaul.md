...
Custom AI behavior and targeting overhaul.
...
No runtime hook markers were found in matched files.
...
Mobiles; combat; creature AI core
...
docs/wiki/AI_OVERHAUL_AUDIT.md;docs/wiki/Creature_AI_Core.md
