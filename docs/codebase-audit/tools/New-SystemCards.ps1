...
$systemDefinitions = @(
    [pscustomobject]@{ Name = 'Character Level'; Classification = 'GameplayLayer'; Patterns = @('Data/Scripts/Custom/CharacterLevel/', 'CharacterLevel'); Docs = @('Character_Level'); Summary = 'Player progression layer and level-aware behavior. Marker evidence is provisional until dependency and serialization phases deepen the review.'; Dependencies = 'PlayerMobile; Random Encounters; combat display; documentation source traces' },
    ...
    [pscustomobject]@{ Name = 'OmniAI'; Classification = 'ImportedPackage'; Patterns = @('Data/Scripts/Custom/OmniAI/', 'OmniAI'); Docs = @('OmniAI'); Summary = 'Imported AI package with multiple ability modules.'; Dependencies = 'Mobiles; combat; magic abilities' },
    [pscustomobject]@{ Name = 'AI Overhaul'; Classification = 'GameplayLayer'; Patterns = @('Data/Scripts/Custom/AIOverhaul/', 'AIOverhaul', 'AITactical'); Docs = @('AI_OVERHAUL', 'Creature_AI'); Summary = 'Custom AI behavior and targeting overhaul.'; Dependencies = 'Mobiles; combat; creature AI core' },
    ...
    [pscustomobject]@{ Name = 'Static Gump Tool'; Classification = 'StaffEventTool'; Patterns = @('Data/Scripts/Custom/OzThothStaticGump/', 'StaticGump'); Docs = @('Static_Gump'); Summary = 'Staff-facing static gump creation and management tool.'; Dependencies = 'Gumps; staff commands; persistence where configured' },
