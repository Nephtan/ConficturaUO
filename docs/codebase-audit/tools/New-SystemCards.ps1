...
$systemDefinitions = @(
    ...
    [pscustomobject]@{ Name = 'Monster Nests'; Classification = 'GameplayLayer'; Patterns = @('Data/Scripts/Custom/PvE/MonsterNests/', 'MonsterNest'); Docs = @('Monster_Nest'); Summary = 'Monster nest PvE system with world-state and reward pressure.'; Dependencies = 'Mobiles; items; regions; player progression' },
    [pscustomobject]@{ Name = 'Clone Offline Player Characters'; Classification = 'GameplayLayer'; Patterns = @('Data/Scripts/Custom/PvE/CloneOfflinePlayerCharacters/', 'OfflinePlayer', 'Clone'); Docs = @('Clone_Offline'); Summary = 'Offline character clone system with mobile/item clone behavior and command surfaces.'; Dependencies = 'PlayerMobile; items; mobiles; timers' },
    ...
    [pscustomobject]@{ Name = 'Staff Toolbar'; Classification = 'StaffEventTool'; Patterns = @('Data/Scripts/Custom/ThirdParty/Staff Toolbar', 'StaffToolbar'); Docs = @('Staff_Toolbar'); Summary = 'Staff-facing toolbar and administrative convenience surface.'; Dependencies = 'Access levels; staff commands; gumps' },
