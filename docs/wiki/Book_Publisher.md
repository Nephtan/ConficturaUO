...
- Queue rows: PBN-0080.
- Backlog rows: RB-06669.
- Audit registers used: documentation-truth-table.csv, runtime-hook-map.csv, serialization-register.csv, and project-truth-register.csv.

### Source Files Reviewed

- Data/Scripts/Custom/Book Publisher [2.0]/Publisher.cs (CurrentFile)
- Data/Scripts/Custom/Book Publisher [2.0]/PublishedBook.cs (CurrentFile)
- Data/Scripts/Custom/Book Publisher [2.0]/XmlBook.cs (CurrentFile)
- Data/Scripts/Custom/Book Publisher [2.0]/SBPublisher.cs (CurrentFile)
- Data/Scripts/Custom/Book Publisher [2.0]/BookBuyInfo.cs (CurrentFile)

### Runtime Evidence

- Hook summary: Speech=3.
- Data/Scripts/Custom/Book Publisher [2.0]/Publisher.cs:L76 Speech OnSpeech access=GlobalOrInternal
- Data/Scripts/Custom/Book Publisher [2.0]/Publisher.cs:L87 Speech OnSpeech access=GlobalOrInternal
- Data/Scripts/Custom/Book Publisher [2.0]/Publisher.cs:L90 Speech OnSpeech access=GlobalOrInternal
...
- Data/Scripts/Custom/Book Publisher [2.0]/PublishedBook.cs=Keep
- Data/Scripts/Custom/Book Publisher [2.0]/Publisher.cs=Keep
- Data/Scripts/Custom/Book Publisher [2.0]/Publisher.cs=Keep
- Data/Scripts/Custom/Book Publisher [2.0]/SBPublisher.cs=Keep
- Data/Scripts/Custom/Book Publisher [2.0]/SBPublisher.cs=Keep
- Data/Scripts/Custom/Book Publisher [2.0]/XmlBook.cs=Keep
- Data/Scripts/Custom/Book Publisher [2.0]/XmlBook.cs=Keep
