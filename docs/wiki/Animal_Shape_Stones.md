...
- Queue rows: PBN-0006.
- Backlog rows: RB-06655.
- Audit registers used: documentation-truth-table.csv, runtime-hook-map.csv, serialization-register.csv, and project-truth-register.csv.

### Source Files Reviewed

- Data/Scripts/Custom/AnimalSystem/ShapeShiftStones/ (CurrentDirectory)
- Data/Scripts/Custom/AnimalSystem/ShapeShiftStones/DragonShapeChangeStone-body.cs (CurrentFile)
- Data/Scripts/Custom/AnimalSystem/ShapeShiftStones/FaeryShapeChangeStone.cs (CurrentFile)
- Data/Scripts/Custom/AnimalSystem/ShapeShiftStones/FelinusShapeChangeStone.cs (CurrentFile)
- Data/Scripts/Custom/AnimalSystem/ShapeShiftStones/RatShapeChangeStone.cs (CurrentFile)
- Data/Scripts/Custom/AnimalSystem/ShapeShiftStones/WolvenShapeChangeStone.cs (CurrentFile)
- Data/Scripts/Scripts.csproj (CurrentFile)

### Runtime Evidence

- Hook summary: Gump=8; Speech=11.
