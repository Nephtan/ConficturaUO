...
- Queue rows: PBN-0043.
- Backlog rows: RB-06762.
- Audit registers used: documentation-truth-table.csv, runtime-hook-map.csv, serialization-register.csv, and project-truth-register.csv.

### Source Files Reviewed

- Data/Scripts/Magic/Research/AncientSpellBook.cs (CurrentFile)
- Data/Scripts/Magic/Research/ResearchBag.cs (CurrentFile)
- Data/Scripts/Magic/Research/ResearchCommands.cs (CurrentFile)
- Data/Scripts/Magic/Research/ResearchFunctions.cs (CurrentFile)

### Runtime Evidence

- Hook summary: Command=1; Gump=22; Initialize=1.
- Data/Scripts/Magic/Research/AncientSpellBook.cs:L81 Gump SendGump access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L93 Gump SendGump access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L129 Gump SendGump access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L156 Gump SendGump access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L3889 Gump OnResponse access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L3903 Gump SendGump access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L3908 Gump SendGump access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L3912 Gump SendGump access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L3919 Gump SendGump access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L3923 Gump SendGump access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L3930 Gump SendGump access=Internal
- Data/Scripts/Magic/Research/ResearchBag.cs:L3934 Gump SendGump access=Internal
- Additional hook rows are recorded in runtime-hook-map.csv for this source set.

### Serialization Evidence

- Serialized rows matched: 2.
- Data/Scripts/Magic/Research/AncientSpellBook.cs:Server.Items.AncientSpellbook version=0 serialize=L99 deserialize=L109 alignment=CountMatchNeedsTypeReview:UnknownWrites=3
- Data/Scripts/Magic/Research/ResearchBag.cs:Server.Items.ResearchBag version=0 serialize=L4404 deserialize=L4445 alignment=CountMatchNeedsTypeReview:UnknownWrites=29

### Project And Runtime Coverage

- Data/Scripts/Magic/Research/AncientSpellBook.cs=Keep
- Data/Scripts/Magic/Research/AncientSpellBook.cs=Keep
- Data/Scripts/Magic/Research/ResearchBag.cs=Keep
- Data/Scripts/Magic/Research/ResearchBag.cs=Keep
- Data/Scripts/Magic/Research/ResearchCommands.cs=Keep
- Data/Scripts/Magic/Research/ResearchCommands.cs=Keep
