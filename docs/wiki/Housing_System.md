...
- Queue rows: PBN-0029; PBN-0065.
- Backlog rows: RB-06706; RB-06707.
- Audit registers used: documentation-truth-table.csv, runtime-hook-map.csv, serialization-register.csv, and project-truth-register.csv.

### Source Files Reviewed

- Data/Scripts/Items/Houses/BaseHouse.cs (CurrentFile)
- Data/Scripts/Items/Houses/HousePlacement.cs (CurrentFile)
- Data/Scripts/Items/Houses/HousePlacementTool.cs (CurrentFile)
- Data/Scripts/Items/Houses/Deeds.cs (CurrentFile)
- Data/Scripts/Items/Houses/HouseSign.cs (CurrentFile)
- Data/Scripts/System/Regions/HouseRegion.cs (CurrentFile)
- Data/Scripts/Items/Houses/HouseFoundation.cs (CurrentFile)
- Data/Scripts/System/Gumps/HouseGump.cs (CurrentFile)
- Data/Scripts/System/Gumps/HouseGumpAOS.cs (CurrentFile)
- Data/Scripts/System/Gumps/HouseDemolishGump.cs (CurrentFile)
- Data/Scripts/System/Gumps/ConfirmHouseResize.cs (CurrentFile)
- Data/Scripts/System/Gumps/SetSecureLevelGump.cs (CurrentFile)
- Data/Scripts/Items/Houses/Houses.cs (CurrentFile)
- Data/Scripts/Items/Houses/NewHouses.cs (CurrentFile)
- Data/Scripts/Items/Houses/SmallTents.cs (CurrentFile)
- Data/Scripts/Items/Houses/MovingCrate.cs (CurrentFile)
- Data/Scripts/Items/Houses/InteriorDecorator.cs (CurrentFile)

### Runtime Evidence

- Hook summary: Command=1; Event=2; Gump=97; Initialize=2; Login=1; Region=4; Speech=2; Timer=12.
- Data/Scripts/Items/Houses/BaseHouse.cs:L203 Timer Timer.DelayCall access=GlobalOrInternal
- Data/Scripts/Items/Houses/BaseHouse.cs:L974 Timer Timer.DelayCall access=GlobalOrInternal
- Data/Scripts/Items/Houses/BaseHouse.cs:L2312 Gump SendGump access=Internal
- Data/Scripts/Items/Houses/BaseHouse.cs:L2328 Gump SendGump access=Internal
- Data/Scripts/Items/Houses/BaseHouse.cs:L2348 Gump SendGump access=Internal
- Data/Scripts/Items/Houses/BaseHouse.cs:L2462 Gump SendGump access=Internal
- Data/Scripts/Items/Houses/BaseHouse.cs:L2499 Gump SendGump access=Internal
- Data/Scripts/Items/Houses/BaseHouse.cs:L3187 Timer Timer.DelayCall access=GlobalOrInternal
- Data/Scripts/Items/Houses/BaseHouse.cs:L3196 Timer Timer.DelayCall access=GlobalOrInternal
- Data/Scripts/Items/Houses/BaseHouse.cs:L3199 Timer Timer.DelayCall access=GlobalOrInternal
- Data/Scripts/Items/Houses/BaseHouse.cs:L3257 Timer Timer.DelayCall access=GlobalOrInternal
- Data/Scripts/Items/Houses/BaseHouse.cs:L3541 Timer CustomTimerSubclass access=GlobalOrInternal
- Additional hook rows are recorded in runtime-hook-map.csv for this source set.

### Serialization Evidence

- Serialized rows matched: 97.
- Data/Scripts/Items/Houses/BaseHouse.cs:Server.Multis.BaseHouse version=14 serialize=L2921 deserialize=L2990 alignment=CountMismatch:Writes=28;Reads=31
- Data/Scripts/Items/Houses/BaseHouse.cs:Server.Multis.SecureInfo version=Unknown serialize=L4090 deserialize=L alignment=CountMismatch:Writes=2;Reads=0
- Data/Scripts/Items/Houses/BaseHouse.cs:Server.Multis.TransferItem version=0 serialize=L2163 deserialize=L2170 alignment=AlignedByCountAndKnownTypes
...
- Data/Scripts/Items/Houses/BaseHouse.cs=Keep
- Data/Scripts/Items/Houses/BaseHouse.cs=Keep
- Data/Scripts/Items/Houses/Deeds.cs=Keep
- Data/Scripts/Items/Houses/Deeds.cs=Keep
- Data/Scripts/Items/Houses/HouseFoundation.cs=Keep
- Data/Scripts/Items/Houses/HouseFoundation.cs=Keep
- Data/Scripts/Items/Houses/HousePlacement.cs=Keep
- Data/Scripts/Items/Houses/HousePlacement.cs=Keep
- Data/Scripts/Items/Houses/HousePlacementTool.cs=Keep
- Data/Scripts/Items/Houses/HousePlacementTool.cs=Keep
- Data/Scripts/Items/Houses/Houses.cs=Keep
- Data/Scripts/Items/Houses/Houses.cs=Keep
- Data/Scripts/Items/Houses/HouseSign.cs=Keep
- Data/Scripts/Items/Houses/HouseSign.cs=Keep
- Data/Scripts/Items/Houses/InteriorDecorator.cs=Keep
- Data/Scripts/Items/Houses/InteriorDecorator.cs=Keep
- Data/Scripts/Items/Houses/MovingCrate.cs=Keep
- Data/Scripts/Items/Houses/MovingCrate.cs=Keep
- Data/Scripts/Items/Houses/NewHouses.cs=Keep
- Data/Scripts/Items/Houses/NewHouses.cs=Keep
