...
- Queue rows: PBN-0111.
- Backlog rows: RB-06786.
- Audit registers used: documentation-truth-table.csv, runtime-hook-map.csv, serialization-register.csv, and project-truth-register.csv.

### Source Files Reviewed

- Data/Scripts/Custom/TellAFriend/TellAFriend.cs (CurrentFile)
- Data/Scripts/Custom/TellAFriend/Rewards/StatBall.cs (CurrentFile)

### Runtime Evidence

- Hook summary: Command=1; Event=1; Gump=8; Initialize=2.
- Data/Scripts/Custom/TellAFriend/Rewards/StatBall.cs:L74 Gump SendGump access=Internal
- Data/Scripts/Custom/TellAFriend/Rewards/StatBall.cs:L83 Gump SendGump access=Internal
- Data/Scripts/Custom/TellAFriend/Rewards/StatBall.cs:L179 Gump OnResponse access=Internal
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs:L52 Initialize Initialize access=GlobalOrInternal
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs:L54 Event EventSink access=GlobalOrInternal
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs:L73 Gump SendGump access=Internal
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs:L217 Gump OnResponse access=Internal
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs:L280 Gump SendGump access=Internal
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs:L359 Gump SendGump access=Internal
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs:L414 Initialize Initialize access=GlobalOrInternal
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs:L416 Command CommandSystem.Register access=Unknown
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs:L433 Gump SendGump access=Internal

### Serialization Evidence

- Serialized rows matched: 2.
- Data/Scripts/Custom/TellAFriend/Rewards/StatBall.cs:Server.Items.StatBall version=0 serialize=L89 deserialize=L96 alignment=CountMatchNeedsTypeReview:UnknownWrites=1
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs:Server.ReferrerReward version=0 serialize=L397 deserialize=L404 alignment=AlignedByCountAndKnownTypes

### Project And Runtime Coverage

- Data/Scripts/Custom/TellAFriend/Rewards/StatBall.cs=Keep
- Data/Scripts/Custom/TellAFriend/Rewards/StatBall.cs=Keep
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs=Keep
- Data/Scripts/Custom/TellAFriend/TellAFriend.cs=Keep
