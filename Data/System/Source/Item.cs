...
namespace Server
{
    ...
    public class Item : IEntity, IHued, IComparable<Item>, ISerializable, ISpawnable
    {
        ...
        {
            get { return m_LastMobile; }
            set { m_LastMobile = value; }
        }
        ...
        {
            get { return m_LastMobileName; }
            set
            {
                m_LastMobileName = value;
                InvalidateProperties();
            }
        }
        ...
        /// </summary>
        public virtual void OnSecureTrade(
            Mobile from,
            Mobile to,
            Mobile newOwner,
            bool accepted
        ...
        {
            to.Send(
                new UnicodeMessage(m_Serial, m_ItemID, MessageType.Label, 0x3B2, 3, "ENU", "", text)
            );
        }
            ...
            if (m_Map != map)
            {
                ...
                if (m_Map != null)
                {
                    ...
                    if (oldLocation.m_X != 0)
                    {
                        ...
                        IPooledEnumerable eable = m_Map.GetClientsInRange(
                            oldLocation,
                            GetMaxUpdateRange()
                        );
        ...
        public virtual bool OnDecay()
        {
            return (
                ...
                && Parent == null
                && Map != Map.Internal
                && Region.Find(Location, Map).OnDecay(this)
            );
        }
            ...
            switch (version)
            {
                ...
                case 6:
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            LastMoved = DateTime.Now - TimeSpan.FromMinutes(minutes);
                        }
                        catch
                        {
        ...
        {
            get { return (int)Math.Ceiling(this.Weight * this.Amount); }
        }
        ...
        {
            get { return (QuestItem ? QuestItemHue : m_Hue); }
            set
            {
                if (m_Hue != value)
                {
        ...
        {
            if (item.ItemID == 0x20F4 || item.ItemID == 0x2FB9 || item.ItemID == 0x3173)
                return true;
        ...
        public void ProcessDelta()
        {
            ...
            {
                bool sendOPLUpdate =
                    ObjectPropertyList.Enabled && (flags & ItemDelta.Properties) != 0;
                ...
                if (contParent != null && !contParent.IsPublicContainer)
                {
                    if ((flags & ItemDelta.Update) != 0)
                    {
                        ...
                        if (rootParent != null)
                        {
                            ...
                            {
                                if (
                                    rootParent.CanSee(this)
                                    && rootParent.InRange(worldLoc, GetUpdateRange(rootParent))
                                )
                                {
                        ...
                        if (stc != null)
                        {
                            ...
                            if (st != null)
                            {
                                ...
                                if (tradeRecip != null)
                                {
                                    ...
                                    {
                                        if (
                                            tradeRecip.CanSee(this)
                                            && tradeRecip.InRange(
                                                worldLoc,
                                                GetUpdateRange(tradeRecip)
                                            )
                                        )
                                        {
                                            if (ns.ContainerGridLines)
                ...
                else if ((flags & ItemDelta.EquipOnly) != 0)
                {
                    if (m_Parent is Mobile)
                    {
                        ...
                        IPooledEnumerable eable = map.GetClientsInRange(
                            worldLoc,
                            GetMaxUpdateRange()
                        );
        ...
        public virtual bool OnDroppedOnto(Mobile from, Item target)
        {
            if (
                ...
                from.AccessLevel < AccessLevel.GameMaster
                && !from.InRange(target.GetWorldLocation(), 2)
            )
                return false;
            else if (!from.CanSee(target) || !from.InLOS(target))
                return false;
        ...
        public virtual bool DropToWorld(Mobile from, Point3D p)
        {
            ...
            if (landAvg > z && (z + height) > landZ)
                ...
                (landFlags & TileFlag.Impassable) != 0
                && landAvg > surfaceZ
                && (z + height) > landZ
            )
                return false;
        ...
        public void SendLocalizedMessageTo(Mobile to, int number)
        {
            ...
            to.Send(
                new MessageLocalized(Serial, ItemID, MessageType.Regular, 0x3B2, 3, number, "", "")
            );
        }
        ...
        public void SendLocalizedMessageTo(
            Mobile to,
            int number,
            AffixType affixType,
            string affix,
        ...
        {
            get { return (GetSecureTradeCont() != null); }
        }
        ...
        {
            get { return TileData.ItemTable[m_ItemID & TileData.MaxItemValue]; }
        }
        ...
        public virtual void ScissorHelper(
            Mobile from,
            Item newItem,
            int amountPerOldItem,
            bool carryHue
        )
        {
            int amount = Amount;
            ...
            if (
                !(thisParent is Container)
                || !((Container)thisParent).TryDropItem(from, newItem, false)
            )
