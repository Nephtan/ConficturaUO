...
namespace Server.Network
{
    public class PacketReader
    {
        ...
        public string ReadUnicodeStringLE()
        {
            ...
            while (
                (m_Index + 1) < m_Size && (c = (m_Data[m_Index++] | (m_Data[m_Index++] << 8))) != 0
            )
                sb.Append((char)c);
        ...
        public string ReadUnicodeStringLESafe(int fixedLength)
        {
            ...
            while (
                (m_Index + 1) < bound && (c = (m_Data[m_Index++] | (m_Data[m_Index++] << 8))) != 0
            )
            {
                if (IsSafeChar(c))
                    sb.Append((char)c);
        ...
        public string ReadUnicodeStringSafe()
        {
            ...
            while (
                (m_Index + 1) < m_Size && (c = ((m_Data[m_Index++] << 8) | m_Data[m_Index++])) != 0
            )
            {
                if (IsSafeChar(c))
                    sb.Append((char)c);
        ...
        public string ReadUnicodeStringSafe(int fixedLength)
        {
            ...
            while (
                (m_Index + 1) < bound && (c = ((m_Data[m_Index++] << 8) | m_Data[m_Index++])) != 0
            )
            {
                if (IsSafeChar(c))
                    sb.Append((char)c);
