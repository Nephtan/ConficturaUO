...
namespace Server
{
    ...
    public sealed class Map : IComparable, IComparable<Map>
    {
        ...
        public static Map Lodor
        {
            get { return m_Maps[0]; }
        }
        public static Map Sosaria
        {
            get { return m_Maps[1]; }
        }
        public static Map Underworld
        {
            get { return m_Maps[2]; }
        }
        public static Map SerpentIsland
        {
            get { return m_Maps[3]; }
        }
        public static Map IslesDread
        {
            get { return m_Maps[4]; }
        }
        public static Map SavagedEmpire
        {
            get { return m_Maps[5]; }
        }
        public static Map Atlantis
        {
            get { return m_Maps[6]; }
        }
        public static Map Internal
        {
            get { return m_Maps[0x7F]; }
        }
        ...
        public IPooledEnumerable GetObjectsInRange(Point3D p)
        {
            ...
            return PooledEnumerable.Instantiate(
                ObjectEnumerator.Instantiate(this, new Rectangle2D(p.m_X - 18, p.m_Y - 18, 37, 37))
            );
        }
        ...
        public IPooledEnumerable GetClientsInRange(Point3D p)
        {
            ...
            return PooledEnumerable.Instantiate(
                TypedEnumerator.Instantiate(
                    this,
                    new Rectangle2D(p.m_X - 18, p.m_Y - 18, 37, 37),
                    SectorEnumeratorType.Clients
                )
            );
        }
        ...
        public IPooledEnumerable GetClientsInBounds(Rectangle2D bounds)
        {
            ...
            return PooledEnumerable.Instantiate(
                TypedEnumerator.Instantiate(this, bounds, SectorEnumeratorType.Clients)
            );
        }
        ...
        public IPooledEnumerable GetItemsInBounds(Rectangle2D bounds)
        {
            ...
            return PooledEnumerable.Instantiate(
                TypedEnumerator.Instantiate(this, bounds, SectorEnumeratorType.Items)
            );
        }
        ...
        public IPooledEnumerable GetMobilesInBounds(Rectangle2D bounds)
        {
            ...
            return PooledEnumerable.Instantiate(
                TypedEnumerator.Instantiate(this, bounds, SectorEnumeratorType.Mobiles)
            );
        }
        #endregion
        ...
        public IPooledEnumerable GetMultiTilesAt(int x, int y)
        {
            ...
            return PooledEnumerable.Instantiate(
                MultiTileEnumerator.Instantiate(sector, new Point2D(x, y))
            );
        }
        ...
        */
        ...
        public void RegisterRegion(Region reg)
        {
            ...
            if (regName != null)
            {
                if (m_Regions.ContainsKey(regName))
                    Console.WriteLine(
                        "Warning: Duplicate region name '{0}' for map '{1}'",
                        regName,
                        this.Name
                    );
                else
        ...
        private class TypedEnumerator : IPooledEnumerator, IDisposable
        {
            ...
            public static TypedEnumerator Instantiate(
                Map map,
                Rectangle2D bounds,
                    ...
                    if (m_Enumerator.MoveNext())
                    {
                        ...
                        else if (o is Item)
                        {
                            ...
                            if (
                                !item.Deleted
                                && item.Parent == null
                                && m_Bounds.Contains(item.Location)
                            )
                            {
                                m_Current = o;
                                return true;
        ...
        private class MultiTileEnumerator : IPooledEnumerator, IDisposable
        {
            ...
            private static Queue<MultiTileEnumerator> m_InstancePool =
                new Queue<MultiTileEnumerator>();
        ...
        private class ObjectEnumerator : IPooledEnumerator, IDisposable
        {
            ...
            public bool MoveNext()
            {
                while (true)
                {
                    ...
                    {
                        m_Enumerator.Free();
                        m_Enumerator = SectorEnumerator.Instantiate(
                            m_Map,
                            m_Bounds,
                            SectorEnumeratorType.Mobiles
                        );
        ...
        private class SectorEnumerator : IPooledEnumerator, IDisposable
        {
            ...
            public static SectorEnumerator Instantiate(
                Map map,
                Rectangle2D bounds,
                SectorEnumeratorType type
            )
            ...
            public bool MoveNext()
            {
                while (true)
                {
                    ...
                    if (m_CurrentIndex == m_CurrentList.Count)
                    {
                        ...
                        m_CurrentIndex = -1;
                        m_CurrentList = GetListForSector(
                            m_Map.InternalGetSector(m_xSector, m_ySector)
        ...
        public bool LineOfSight(Point3D org, Point3D dest)
        {
            ...
            if (
                org.X > dest.X
                || (org.X == dest.X && org.Y > dest.Y)
                || (org.X == dest.X && org.Y == dest.Y && org.Z > dest.Z)
            )
            {
                Point3D swap = org;
                org = dest;
            ...
            x = org.m_X;
            while (
                Utility.NumberBetween(x, dest.m_X, org.m_X, 0.5)
                && Utility.NumberBetween(y, dest.m_Y, org.m_Y, 0.5)
            ...
            Rectangle2D rect = new Rectangle2D(
                pTop.m_X,
                pTop.m_Y,
                (pBottom.m_X - pTop.m_X) + 1,
                (pBottom.m_Y - pTop.m_Y) + 1
            );
