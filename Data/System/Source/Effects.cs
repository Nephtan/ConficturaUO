...
namespace Server
{
    ...
    public static class Effects
    {
        ...
        {
            return (
                m_ParticleSupportType == ParticleSupportType.Full
                    ...
                    else if (itemID != 0)
                    {
                        if (regular == null)
                            regular = Packet.Acquire(
                                new LocationEffect(e, itemID, speed, duration, hue, renderMode)
                            );
        ...
        public static void SendTargetEffect(
            IEntity target,
            int itemID,
            int duration,
            int hue,
        ...
        )
        {
            ...
            SendPacket(
                target.Location,
                target.Map,
                new TargetEffect(target, itemID, speed, duration, hue, renderMode)
            );
        }
        ...
        )
        {
            ...
            IEntity mfrom = new Entity(
                Serial.Zero,
                new Point3D(from.X, from.Y, from.Z + up),
                from.Map
            );
