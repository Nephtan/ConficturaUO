...
namespace Server
{
    ...
    public class DamageEntry
    {
        ...
        { get { return m_DamageGiven; } set { m_DamageGiven = value; } }

        public DateTime LastDamage
        { get { return m_LastDamage; } set { m_LastDamage = value; } }

        public bool HasExpired
        { get { return (DateTime.Now > (m_LastDamage + m_ExpireDelay)); } }

        public List<DamageEntry> Responsible
        { get { return m_Responsible; } set { m_Responsible = value; } }
    ...
    public class Mobile : IEntity, IHued, IComparable<Mobile>, ISerializable, ISpawnable
    {
        ...
        { get { return m_MaxPlayerResistance; } set { m_MaxPlayerResistance = value; } }
        ...
        { get { return m_Virtues; } set { } }

        public object Party
        { get { return m_Party; } set { m_Party = value; } }
        ...
        { get { return m_FwdAccessOverride; } set { m_FwdAccessOverride = value; } }

        public static bool FwdEnabled
        { get { return m_FwdEnabled; } set { m_FwdEnabled = value; } }

        public static bool FwdUOTDOverride
        { get { return m_FwdUOTDOverride; } set { m_FwdUOTDOverride = value; } }

        public static int FwdMaxSteps
        { get { return m_FwdMaxSteps; } set { m_FwdMaxSteps = value; } }
        ...
        public static int AnimateMod(int action, int body, int raceID)
        {
            ...
            )
            {
                ...
                if (action == 9 && body == 1031) { action = 6; } // ZOMBIE MAGE
        ...
        #endregion Say/SayTo/Emote/Whisper/Yell
        ...
        #endregion Beneficial Checks/Actions
        ...
        { get { return m_WalkRegion; } set { m_WalkRegion = value; } }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int RaceID
        { get { return m_RaceID; } set { m_RaceID = value; } }

        public int m_RaceAngerSound;

        [CommandProperty(AccessLevel.GameMaster)]
        public int RaceAngerSound
        { get { return m_RaceAngerSound; } set { m_RaceAngerSound = value; } }

        public int m_RaceIdleSound;

        [CommandProperty(AccessLevel.GameMaster)]
        public int RaceIdleSound
        { get { return m_RaceIdleSound; } set { m_RaceIdleSound = value; } }

        public int m_RaceDeathSound;

        [CommandProperty(AccessLevel.GameMaster)]
        public int RaceDeathSound
        { get { return m_RaceDeathSound; } set { m_RaceDeathSound = value; } }

        public int m_RaceAttackSound;

        [CommandProperty(AccessLevel.GameMaster)]
        public int RaceAttackSound
        { get { return m_RaceAttackSound; } set { m_RaceAttackSound = value; } }

        public int m_RaceHurtSound;

        [CommandProperty(AccessLevel.GameMaster)]
        public int RaceHurtSound
        { get { return m_RaceHurtSound; } set { m_RaceHurtSound = value; } }

        public bool m_RaceMakeSounds;

        [CommandProperty(AccessLevel.GameMaster)]
        public bool RaceMakeSounds
        { get { return m_RaceMakeSounds; } set { m_RaceMakeSounds = value; } }

        public int m_RaceMagicSchool;

        [CommandProperty(AccessLevel.GameMaster)]
        public int RaceMagicSchool
        { get { return m_RaceMagicSchool; } set { m_RaceMagicSchool = value; } }

        public bool m_RaceWasFemale;

        [CommandProperty(AccessLevel.GameMaster)]
        public bool RaceWasFemale
        { get { return m_RaceWasFemale; } set { m_RaceWasFemale = value; } }

        public int m_RaceSection;

        [CommandProperty(AccessLevel.GameMaster)]
        public int RaceSection
        { get { return m_RaceSection; } set { m_RaceSection = value; } }

        public int m_RaceHomeLand;

        [CommandProperty(AccessLevel.GameMaster)]
        public int RaceHomeLand
        { get { return m_RaceHomeLand; } set { m_RaceHomeLand = value; } }

        public bool m_RainbowMsg;

        [CommandProperty(AccessLevel.GameMaster)]
        public bool RainbowMsg
        { get { return m_RainbowMsg; } set { m_RainbowMsg = value; } }

        public bool m_NoAutoAttack;

        [CommandProperty(AccessLevel.GameMaster)]
        public bool NoAutoAttack
        { get { return m_NoAutoAttack; } set { m_NoAutoAttack = value; } }

        public int m_DataStoreInt1;

        [CommandProperty(AccessLevel.GameMaster)]
        public int DataStoreInt1
        { get { return m_DataStoreInt1; } set { m_DataStoreInt1 = value; } }

        public int m_DataStoreInt2;

        [CommandProperty(AccessLevel.GameMaster)]
        public int DataStoreInt2
        { get { return m_DataStoreInt2; } set { m_DataStoreInt2 = value; } }

        public int m_DataStoreInt3;

        [CommandProperty(AccessLevel.GameMaster)]
        public int DataStoreInt3
        { get { return m_DataStoreInt3; } set { m_DataStoreInt3 = value; } }

        public int m_DataStoreInt4;

        [CommandProperty(AccessLevel.GameMaster)]
        public int DataStoreInt4
        { get { return m_DataStoreInt4; } set { m_DataStoreInt4 = value; } }

        public int m_DataStoreInt5;

        [CommandProperty(AccessLevel.GameMaster)]
        public int DataStoreInt5
        { get { return m_DataStoreInt5; } set { m_DataStoreInt5 = value; } }

        public string m_DataStoreStr1;

        [CommandProperty(AccessLevel.GameMaster)]
        public string DataStoreStr1
        { get { return m_DataStoreStr1; } set { m_DataStoreStr1 = value; } }

        public string m_DataStoreStr2;

        [CommandProperty(AccessLevel.GameMaster)]
        public string DataStoreStr2
        { get { return m_DataStoreStr2; } set { m_DataStoreStr2 = value; } }

        public string m_DataStoreStr3;

        [CommandProperty(AccessLevel.GameMaster)]
        public string DataStoreStr3
        { get { return m_DataStoreStr3; } set { m_DataStoreStr3 = value; } }

        public string m_DataStoreStr4;

        [CommandProperty(AccessLevel.GameMaster)]
        public string DataStoreStr4
        { get { return m_DataStoreStr4; } set { m_DataStoreStr4 = value; } }

        public string m_DataStoreStr5;

        [CommandProperty(AccessLevel.GameMaster)]
        public string DataStoreStr5
        { get { return m_DataStoreStr5; } set { m_DataStoreStr5 = value; } }
        ...
        { get { return RecordHair; } set { RecordHair = value; InvalidateProperties(); } }

        public int RecordBeard;

        [CommandProperty(AccessLevel.Owner)]
        public int Record_Beard
        { get { return RecordBeard; } set { RecordBeard = value; InvalidateProperties(); } }

        public int RecordHairColor;

        [CommandProperty(AccessLevel.Owner)]
        public int Record_HairColor
        { get { return RecordHairColor; } set { RecordHairColor = value; InvalidateProperties(); } }

        public int RecordBeardColor;

        [CommandProperty(AccessLevel.Owner)]
        public int Record_BeardColor
        { get { return RecordBeardColor; } set { RecordBeardColor = value; InvalidateProperties(); } }

        public int RecordSkinColor;

        [CommandProperty(AccessLevel.Owner)]
        public int Record_SkinColor
        { get { return RecordSkinColor; } set { RecordSkinColor = value; InvalidateProperties(); } }
        ...
        #endregion SendLocalizedMessage
        ...
        { get { return m_DisableDismountInWarmode; } set { m_DisableDismountInWarmode = value; } }
        ...
        { get { return m_BodyWeight; } set { m_BodyWeight = value; } }
        ...
        { get { return m_DisableHiddenSelfClick; } set { m_DisableHiddenSelfClick = value; } }

        public static bool AsciiClickMessage
        { get { return m_AsciiClickMessage; } set { m_AsciiClickMessage = value; } }

        public static bool GuildClickMessage
        { get { return m_GuildClickMessage; } set { m_GuildClickMessage = value; } }

        public static bool OldPropertyTitles
        { get { return m_OldPropertyTitles; } set { m_OldPropertyTitles = value; } }

        public virtual bool ShowFameTitle
        { get { return true; } }//(m_Player || m_Body.IsHuman) && m_Fame >= 10000; }
