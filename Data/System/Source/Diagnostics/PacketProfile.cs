...
namespace Server.Diagnostics
{
    public abstract class BasePacketProfile : BaseProfile
    {
        ...
        {
            get { return (double)_totalLength / Math.Max(1, this.Count); }
        }
    ...
    {
        private static Dictionary<Type, PacketSendProfile> _profiles =
    ...
    {
        private static Dictionary<int, PacketReceiveProfile> _profiles =
