...
namespace Server
{
    ...
    public class Skill
    {
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    skillTitle = skillTitle.Replace("Alchemist", "Herbalist");
                }
                else if (skillTitle.Contains("Naturalist"))
                {
                    skillTitle = skillTitle.Replace("Naturalist", "Beastmaster");
                }
                else if (skillTitle.Contains("Shepherd"))
                {
                    skillTitle = skillTitle.Replace("Shepherd", "Beastmaster");
                }
                else if (skillTitle.Contains("Sailor"))
                {
                    ...
                    if (seafaring >= 100)
                    {
                        skillTitle = skillTitle.Replace("Atlantean", "Sea Captain");
                    }
                }
                else if (skillTitle.Contains("Veterinarian"))
                {
                    skillTitle = skillTitle.Replace("Veterinarian", "Beastmaster");
                }
                else if (skillTitle.Contains("Explorer"))
                {
                    skillTitle = skillTitle.Replace("Explorer", "Wanderer");
                }
                else if (skillTitle.Contains("Knight"))
                {
                    if (karma < 0)
                    {
                        skillTitle = skillTitle.Replace("Knight", "Death Knight");
                    }
                    else if (isBarbaric > 1)
                    {
                        skillTitle = skillTitle.Replace("Knight", "Valkyrie");
                    }
                    else
                    {
                        skillTitle = skillTitle.Replace("Knight", "Chieftain");
                    }
                }
                else if (skillTitle.Contains("Tactician"))
                {
                    skillTitle = skillTitle.Replace("Tactician", "Warlord");
                }
                else if (skillTitle.Contains("Duelist"))
                {
                    skillTitle = skillTitle.Replace("Duelist", "Defender");
                }
                else if (skillTitle.Contains("Necromancer"))
                {
                    skillTitle = skillTitle.Replace("Necromancer", "Witch Doctor");
                }
                else if (skillTitle.Contains("Bard"))
                {
                    skillTitle = skillTitle.Replace("Bard", "Chronicler");
                }
                else if (skillTitle.Contains("Wizard"))
                {
                    skillTitle = skillTitle.Replace("Wizard", "Shaman");
                }
                else if (skillTitle.Contains("Archer") && isBarbaric > 1)
                {
                    skillTitle = skillTitle.Replace("Archer", "Amazon");
                }
                else if (skillTitle.Contains("Fencer") && isBarbaric > 1)
                {
                    skillTitle = skillTitle.Replace("Fencer", "Amazon");
                }
                else if (skillTitle.Contains("Bludgeoner") && isBarbaric > 1)
                {
                    skillTitle = skillTitle.Replace("Bludgeoner", "Amazon");
                }
                else if (skillTitle.Contains("Swordsman") && isBarbaric > 1)
                {
                    skillTitle = skillTitle.Replace("Swordsman", "Amazon");
                }
                else if (skillTitle.Contains("Archer"))
                {
                    skillTitle = skillTitle.Replace("Archer", "Barbarian");
                }
                else if (skillTitle.Contains("Fencer"))
                {
                    skillTitle = skillTitle.Replace("Fencer", "Barbarian");
                }
                else if (skillTitle.Contains("Bludgeoner"))
                {
                    skillTitle = skillTitle.Replace("Bludgeoner", "Barbarian");
                }
                else if (skillTitle.Contains("Swordsman"))
                {
                    skillTitle = skillTitle.Replace("Swordsman", "Barbarian");
                }
                else if (skillTitle.Contains("Ranger"))
                {
                    skillTitle = skillTitle.Replace("Ranger", "Hunter");
                }
                else if (skillTitle.Contains("Man-at-arms"))
                {
                    skillTitle = skillTitle.Replace("Man-at-arms", "Gladiator");
                }
            }
            else if (
                !isOriental
            ...
            {
                skillTitle = skillTitle.Replace("Wizard", "Archmage");
            }
            else if (
                !isOriental
                && skillTitle.Contains("Necromancer")
            ...
            {
                skillTitle = skillTitle.Replace("Necromancer", "Archmage");
            }
            else if ((skillTitle.Contains("Brawler")) && isMonk)
            {
                skillTitle = skillTitle.Replace("Brawler", "Monk");
                if (magery >= 50 || necromancy >= 50)
                {
                    skillTitle = skillTitle.Replace("Monk", "Mystic");
                }
            }
            ...
            else if (skillTitle.Contains("Beggar") && isJester)
            {
                skillTitle = skillTitle.Replace("Beggar", "Jester");
            }
            else if (skillTitle.Contains("Scholar") && isJester)
            {
                skillTitle = skillTitle.Replace("Scholar", "Joker");
            }
            else if (skillTitle.Contains("Samurai") && karma < 0)
            {
                skillTitle = skillTitle.Replace("Samurai", "Ronin");
            }
            else if (skillTitle.Contains("Ninja") && karma < 0)
            {
                skillTitle = skillTitle.Replace("Ninja", "Yakuza");
            }
            else if (skillTitle.Contains("Wizard") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Wizard", "Wu Jen");
            }
            else if (skillTitle.Contains("Swordsman") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Swordsman", "Kensai");
            }
            else if (skillTitle.Contains("Healer") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Healer", "Shukenja");
            }
            else if (skillTitle.Contains("Necromancer") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Necromancer", "Fangshi");
            }
            else if (skillTitle.Contains("Alchemist") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Alchemist", "Waidan");
            }
            else if (skillTitle.Contains("Medium") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Medium", "Neidan");
            }
            else if (skillTitle.Contains("Archer") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Archer", "Kyudo");
            }
            else if (skillTitle.Contains("Fencer") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Fencer", "Yuki Ota");
            }
            else if (skillTitle.Contains("Tactician") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Tactician", "Sakushi");
            }
            else if (skillTitle.Contains("Knight") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Knight", "Youxia");
            }
            else if (
                (skillTitle.Contains("Healer") || skillTitle.Contains("Medium"))
                && karma >= 2500
                && healing >= 50
                && spirits >= 50
            )
            {
                ...
                if (isOriental == true)
                {
                    skillTitle = skillTitle.Replace("Priest", "Buddhist");
                }
            }
            else if (skillTitle.Contains("Brawler") && isOriental == true)
            {
                skillTitle = skillTitle.Replace("Brawler", "Karateka");
            }
            else if (skillTitle.Contains("Wizard") && isEvil == true && gender)
            {
                skillTitle = skillTitle.Replace("Wizard", "Enchantress");
            }
            else if (skillTitle.Contains("Wizard") && isEvil == true)
            {
                skillTitle = skillTitle.Replace("Wizard", "Warlock");
            }

            if (isBarbaric == 0)
            {
                if (skillTitle.Contains("Shaman") && gender)
                {
                    skillTitle = skillTitle.Replace("Shaman", "Sorceress");
                }
                if (skillTitle.Contains("Necromancer") && gender)
                {
                    skillTitle = skillTitle.Replace("Necromancer", "Witch");
                }
                if (skillTitle.Contains("Knight") && karma < 0)
                {
                    skillTitle = skillTitle.Replace("Knight", "Death Knight");
                }
                if (skillTitle.Contains("Healer") && karma < 0)
                {
                    skillTitle = skillTitle.Replace("Healer", "Mortician");
                }
            }

            if (skillTitle.Contains("Sailor") && karma < 0)
            {
                skillTitle = skillTitle.Replace("Sailor", "Pirate");
            }
            if (skillTitle.Contains("Sailor") && seafaring >= 100)
            {
                skillTitle = skillTitle.Replace("Sailor", "Sea Captain");
            }
            if (skillTitle.Contains("Pirate") && seafaring >= 100)
            {
                skillTitle = skillTitle.Replace("Pirate", "Sea Pirate");
            }
        ...
        public double Value
        {
            get { return this.TotalSkillValue; }
        }
        ...
        public double TotalSkillValue
        {
            get
            {
                ...
                double statsOffset =
                    ((m_UseStatMods ? m_Owner.Owner.Str : m_Owner.Owner.RawStr) * m_Info.StrScale)
    ...
    public class SkillInfo
    {
        ...
        {
            get { return m_DexGain; }
            set { m_DexGain = value; }
        }

        public double IntGain
        {
            get { return m_IntGain; }
            set { m_IntGain = value; }
        }

        public double GainFactor
        {
            get { return m_GainFactor; }
        ...
        private static SkillInfo[] m_Table = new SkillInfo[58]
        {
            ...
            new SkillInfo(14, "Searching", 0.0, 0.0, 0.0, "Scout", null, 0.0, 0.4, 0.6, 1.0),
            new SkillInfo(
                15,
                "Discordance",
                0.0,
            ...
            new SkillInfo(21, "Hiding", 0.0, 0.0, 0.0, "Skulker", null, 0.0, 0.8, 0.2, 1.0),
            ...
            new SkillInfo(33, "Stealing", 0.0, 10.0, 0.0, "Thief", null, 0.0, 1.0, 0.0, 1.0),
            ...
            new SkillInfo(47, "Stealth", 0.0, 0.0, 0.0, "Sneak", null, 0.0, 0.0, 0.0, 1.0),
            new SkillInfo(48, "Remove Trap", 0.0, 0.0, 0.0, "Trespasser", null, 0.0, 0.0, 0.0, 1.0),
    ...
    public class Skills
    {
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Druidism
        {
            get { return this[SkillName.Druidism]; }
            set { }
        }

        [CommandProperty(AccessLevel.Counselor)]
        public Skill Mercantile
        {
            get { return this[SkillName.Mercantile]; }
            set { }
        }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Bowcraft
        {
            get { return this[SkillName.Bowcraft]; }
            set { }
        }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Searching
        {
            get { return this[SkillName.Searching]; }
            set { }
        }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Psychology
        {
            get { return this[SkillName.Psychology]; }
            set { }
        }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Seafaring
        {
            get { return this[SkillName.Seafaring]; }
            set { }
        }
        ...
        {
            get { return this[SkillName.Marksmanship]; }
            set { }
        }

        [CommandProperty(AccessLevel.Counselor)]
        public Skill Spiritualism
        {
            get { return this[SkillName.Spiritualism]; }
            set { }
        }
        ...
        public Skill Taming
        {
            get { return this[SkillName.Taming]; }
            set { }
        }

        [CommandProperty(AccessLevel.Counselor)]
        public Skill Tasting
        {
            get { return this[SkillName.Tasting]; }
            set { }
        }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Bludgeoning
        {
            get { return this[SkillName.Bludgeoning]; }
            set { }
        }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill FistFighting
        {
            get { return this[SkillName.FistFighting]; }
            set { }
        }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Knightship
        {
            get { return this[SkillName.Knightship]; }
            set { }
        }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Elementalism
        {
            get { return this[SkillName.Elementalism]; }
            set { }
        }
        ...
        {
            get { return this[SkillName.Mysticism]; }
            set { }
        }
        ...
        {
            get { return this[SkillName.Imbuing]; }
            set { }
        }
        ...
        {
            get { return this[SkillName.Throwing]; }
            set { }
        }
        ...
        public Skill this[int skillID]
        {
            get
            {
                ...
                if (sk == null)
                    m_Skills[skillID] = sk = new Skill(
                        this,
                        SkillInfo.Table[skillID],
                        0,
                        1000,
                        SkillLock.Up
                    );
                ...
                case 1:
                {
                    ...
                    for (int i = 0; i < count; ++i)
                    {
                        if (i < info.Length)
                        {
                            ...
                            if (
                                sk.BaseFixedPoint != 0
                                || sk.CapFixedPoint != 1000
                                || sk.Lock != SkillLock.Up
                            )
                            {
                                m_Skills[i] = sk;
                                m_Total += sk.BaseFixedPoint;
