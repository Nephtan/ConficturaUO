    ...
    public class AdminGump : Gump
    {
        ...
        public void AddSelectedButton(int x, int y, int buttonID, string text, bool isSelection)
        {
            ...
            AddHtml(
                ...
                200,
                20,
                Color(text, isSelection ? SelectedColor32 : LabelColor32),
                false,
                false
            );
        }
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(Admin_OnCommand)
            );
        }
            ...
            switch (pageType)
            {
                ...
                case AdminGumpPage.Administer_WorldBuilding:
                {
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Generating"), LabelColor32),
                        false,
                        false
                    );
                ...
                case AdminGumpPage.Administer_Server:
                {
                    ...
                    AddButtonLabeled(
                        ...
                        230,
                        GetButtonID(3, 203),
                        "Shutdown & Restart (With Save)"
                    );
                    AddButtonLabeled(
                        20,
                        250,
                        GetButtonID(3, 204),
                        "Shutdown & Restart (Without Save)"
                    );
                    /*}
                    else
                    {
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Broadcast"), LabelColor32),
                        false,
                        false
                    );
                ...
                case AdminGumpPage.Administer_Access_Lockdown:
                {
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Server Lockdown"), LabelColor32),
                        false,
                        false
                    );
                    ...
                    AddSelectedButton(
                        ...
                        GetButtonID(3, 503),
                        "Seers",
                        (isLockedDown && level <= AccessLevel.Seer)
                    );
                    AddSelectedButton(
                        20,
                        300,
                ...
                case AdminGumpPage.Administer_Access:
                {
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Connectivity"), LabelColor32),
                        false,
                        false
                    );
                ...
                case AdminGumpPage.Administer_Commands:
                {
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Commands"), LabelColor32),
                        false,
                        false
                    );
                ...
                case AdminGumpPage.Clients:
                {
                    ...
                    for (
                        int i = 0, index = (listPage * 12);
                        i < 12 && index >= 0 && index < m_List.Count;
                        ++i, ++index
                    )
                    {
                ...
                case AdminGumpPage.ClientInfo:
                {
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Information"), LabelColor32),
                        false,
                        false
                    );
                    ...
                    AddLabel(
                        200,
                        y,
                        (a != null && a.Banned) ? RedHue : LabelHue,
                        a == null ? "(no account)" : a.Username
                    );
                ...
                case AdminGumpPage.AccountDetails_ChangePassword:
                {
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Change Password"), LabelColor32),
                        false,
                        false
                    );
                ...
                case AdminGumpPage.AccountDetails_ChangeAccess:
                {
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Change Access Level"), LabelColor32),
                        false,
                        false
                    );
                ...
                case AdminGumpPage.AccountDetails_Access_ClientIPs:
                {
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Client Addresses"), LabelColor32),
                        false,
                        false
                    );
                    ...
                    AddHtml(
                        ...
                        80,
                        Color(
                            "List of IP addresses which have accessed this account.",
                            LabelColor32
                        ),
                        false,
                        false
                    ...
                    if (m_List.Count == 0)
                        AddHtml(
                            ...
                            170,
                            60,
                            Color("This account has not yet been accessed.", LabelColor32),
                            false,
                            false
                        );

                    for (
                        int i = 0, index = (listPage * 6);
                        i < 6 && index >= 0 && index < m_List.Count;
                        ++i, ++index
                    )
                    {
                        AddHtml(
                            ...
                            114,
                            20,
                            Color(m_List[index].ToString(), LabelColor32),
                            false,
                            false
                        );
                        AddButton(
                ...
                case AdminGumpPage.AccountDetails_Access_Restrictions:
                {
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Address Restrictions"), LabelColor32),
                        false,
                        false
                    );
                    ...
                    if (m_List.Count == 0)
                        AddHtml(
                            ...
                            170,
                            60,
                            Color("There are no addresses in this list.", LabelColor32),
                            false,
                            false
                        );
                ...
                case AdminGumpPage.AccountDetails_Characters:
                {
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Characters"), LabelColor32),
                        false,
                        false
                    );
                ...
                case AdminGumpPage.AccountDetails_Comments:
                {
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Comments"), LabelColor32),
                        false,
                        false
                    );
                ...
                case AdminGumpPage.FirewallInfo:
                {
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center(state.ToString()), LabelColor32),
                        false,
                        false
                    );
                    ...
                    AddHtml(
                        ...
                        400,
                        20,
                        Color(Center("Potentially Effected Accounts"), LabelColor32),
                        false,
                        false
                    );
            ...
            if (okay)
            {
                ...
                from.SendGump(
                    new AdminGump(
                        ...
                        0,
                        null,
                        String.Format("{0} : The account has been deleted.", a.Username),
                        null
                    )
                );
            }
            ...
            if (okay)
            {
                ...
                from.SendGump(
                    new NoticeGump(
                        ...
                        new object[] { list, rads, ban ? page : 0 }
                    )
                );
            ...
            else
            {
                from.SendGump(
                    new NoticeGump(
                        ...
                        30720,
                        String.Format(
                            "You have chosen not to {0} the account{1}.",
                            ban ? "ban" : "delete",
                            rads.Count == 1 ? "" : "s"
                        ),
                        0xFFC000,
            ...
            switch (type)
            {
                ...
                case 1:
                {
                    switch (index)
                    {
                        ...
                        {
                            if (
                                m_List != null /*&& (m_ListPage + 1) * 12 < m_List.Count*/
                            )
                                from.SendGump(
                                    new AdminGump(
                                        from,
                    ...
                    switch (index)
                    {
                        ...
                        case 211:
                        {
                            ...
                            else
                            {
                                ...
                                InvokeCommand(
                                    String.Format("{0} {1}", index == 210 ? "BC" : "SM", text)
                                );
                            }
                        ...
                        case 312:
                            ...
                            notice =
                                "Target the player to change their access level. (Game Master)";
                            break;
                        case 313:
                        ...
                        case 314:
                        {
                            if (from.AccessLevel > AccessLevel.Administrator)
                            {
                                ...
                                notice =
                                    "Target the player to change their access level. (Administrator)";
                            }
                        ...
                        case 315:
                        {
                            if (from.AccessLevel > AccessLevel.Developer)
                            {
                                ...
                                notice =
                                    "Target the player to change their access level. (Developer)";
                            }
                        ...
                        case 403:
                            ...
                            notice =
                                "Target the item to dupe. The item will be duped at it's current location.";
                            break;
                        case 404:
                            InvokeCommand("Props");
                            ...
                            if (level > AccessLevel.Player)
                            {
                                ...
                                if (count == 0)
                                    ...
                                    notice = String.Format(
                                        "Number of players disconnected: {0}",
                                        count
                                    );
                            }
                            else
                ...
                case 4:
                {
                    switch (index)
                    {
                        ...
                        case 1:
                        {
                            ...
                            string match = (
                                matchEntry == null ? null : matchEntry.Text.Trim().ToLower()
                            );
                            string notice = null;
                            ...
                            {
                                notice = String.Format(
                                    "You must enter {0} to search.",
                                    forName ? "a name" : "an ip address"
                                );
                            }
                            else
                            {
                                ...
                                for (int i = 0; i < instances.Count; ++i)
                                {
                                    ...
                                    if (forName)
                                    {
                                        ...
                                        isMatch =
                                            (m != null && m.Name.ToLower().IndexOf(match) >= 0)
                                            || (
                                                a != null
                ...
                case 5:
                {
                    switch (index)
                    {
                        ...
                        case 6:
                        {
                            ...
                            from.SendGump(
                                new AdminGump(
                                    ...
                                    m_List,
                                    notice,
                                    dispAccount != null ? dispAccount : m_State
                                )
                            );
                            break;
                        }
                        ...
                        case 11:
                        {
                            ...
                            from.SendGump(
                                new AdminGump(
                                    ...
                                    m_List,
                                    String.Format(
                                        "The account has been {0}.",
                                        a.Banned ? "banned" : "unbanned"
                                    ),
                                    m_State
                                )
                            );
                        ...
                        case 12:
                        {
                            ...
                            string password = (
                                passwordEntry == null ? null : passwordEntry.Text.Trim()
                            );
                            string confirm = (
                                confirmEntry == null ? null : confirmEntry.Text.Trim()
                            );
                            ...
                            if (list.Count > 0)
                            {
                                ...
                                from.SendGump(
                                    new WarningGump(
                                        ...
                                        420,
                                        400,
                                        new WarningGumpCallback(BanShared_Callback),
                                        a
                                    )
                                );
                            }
                            ...
                            if (a.LoginIPs.Length > 0)
                            {
                                from.SendGump(
                                    new WarningGump(
                                        ...
                                        30720,
                                        String.Format(
                                            "You are about to firewall {0} address{1}. Do you wish to continue?",
                                            a.LoginIPs.Length,
                                            a.LoginIPs.Length != 1 ? "s" : ""
                                        ),
                                        0xFFC000,
                                        420,
                                        400,
                                        new WarningGumpCallback(FirewallShared_Callback),
                                        a
                                    )
                                );
                            }
                        ...
                        case 25:
                        {
                            ...
                            from.SendGump(
                                new WarningGump(
                                    ...
                                    30720,
                                    String.Format(
                                        "<center>Account of {0}</center><br>You are about to <em><basefont color=red>permanently delete</basefont></em> the account. Likewise, all characters on the account will be deleted, including equiped, inventory, and banked items. Any houses tied to the account will be demolished.<br><br>Do you wish to continue?",
                                        a.Username
                                    ),
                                    0xFFC000,
                                    420,
                                    280,
                                    new WarningGumpCallback(AccountDelete_Callback),
                                    m_State
                                )
                            );
                            break;
                            ...
                            if (rads.Count > 0)
                                from.SendGump(
                                    new WarningGump(
                                        ...
                                        30720,
                                        String.Format(
                                            "You are about to ban {0} marked account{1}. Be cautioned, the only way to reverse this is by hand--manually unbanning each account.<br><br>Do you wish to continue?",
                                            rads.Count,
                                            rads.Count == 1 ? "" : "s"
                                        ),
                                        0xFFC000,
                                        420,
                                        280,
                                        new WarningGumpCallback(Marked_Callback),
                                        new object[] { true, list, rads, m_ListPage }
                                    )
                                );
                            else
                                from.SendGump(
                                    new NoticeGump(
                                        ...
                                        280,
                                        new NoticeGumpCallback(ResendGump_Callback),
                                        new object[] { list, rads, m_ListPage }
                                    )
                                );
                            ...
                            if (rads.Count > 0)
                                from.SendGump(
                                    new WarningGump(
                                        ...
                                        30720,
                                        String.Format(
                                            "You are about to <em><basefont color=red>permanently delete</basefont></em> {0} marked account{1}. Likewise, all characters on the account{1} will be deleted, including equiped, inventory, and banked items. Any houses tied to the account{1} will be demolished.<br><br>Do you wish to continue?",
                                            rads.Count,
                                            rads.Count == 1 ? "" : "s"
                                        ),
                                        0xFFC000,
                                    ...
                                    if (m_List[index] is Account)
                                        ...
                                        from.SendGump(
                                            new AdminGump(
                                                ...
                                                AdminGumpPage.Accounts,
                                                0,
                                                (ArrayList)(((DictionaryEntry)m_List[index]).Value),
                                                null,
                                                new ArrayList()
                                            )
                                        );
                            ...
                            if (results.Count == 1)
                                ...
                                from.SendGump(
                                    new AdminGump(
                                        ...
                                        0,
                                        results,
                                        String.Format("Search results for : {0}", match),
                                        m_State
                                    )
                                );
                            else
                            ...
                            else
                            {
                                ...
                                from.SendGump(
                                    new AdminGump(
                                        ...
                                        0,
                                        null,
                                        String.Format("{0} : Added to firewall.", toAdd),
                                        toAdd
                                    )
                                );
                            }
                            ...
                            if (m_State is Firewall.IFirewallEntry)
                            {
                                ...
                                from.SendGump(
                                    new AdminGump(
                                        ...
                                        0,
                                        null,
                                        String.Format("{0} : Removed from firewall.", m_State),
                                        null
                                    )
                                );
                            }
                ...
                case 7:
                {
                    ...
                    if (sendGump)
                        from.SendGump(
                            new AdminGump(from, AdminGumpPage.ClientInfo, 0, null, notice, m_State)
                        );
                        ...
                        if (m_PageType == AdminGumpPage.AccountDetails_Access_ClientIPs)
                        {
                            from.SendGump(
                                new WarningGump(
                                    ...
                                    30720,
                                    String.Format(
                                        "You are about to firewall {0}. All connection attempts from a matching IP will be refused. Are you sure?",
                                        m_List[index]
                                    ),
                                    0xFFC000,
                                    420,
                                    280,
                                    new WarningGumpCallback(Firewall_Callback),
                                    new object[] { a, m_List[index] }
                                )
                            );
                        }
                        else if (m_PageType == AdminGumpPage.AccountDetails_Access_Restrictions)
                        {
                            ...
                            from.SendGump(
                                new AdminGump(
                                    ...
                                    0,
                                    null,
                                    String.Format("{0} : Removed from list.", m_List[index]),
                                    a
                                )
                            );
                        }
