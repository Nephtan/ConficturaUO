...
namespace Server.Gumps
{
    ...
    {
        public MyTalk(Mobile from, int source)
            : base(80, 80)
        {
            this.Closable = true;
            ...
            if (source > 0)
                text = Server.Misc.SpeechFunctions.SpeechText(
                    person,
                    from,
                    MyChat.talkInfo(source, 2)
                );
    ...
    public class MyChat : Gump
    {
        ...
        public MyChat(Mobile from, int source)
            : base(50, 50)
        {
            m_Origin = source;
            ...
            AddHtml(
                ...
                200,
                20,
                @"<BODY><BASEFONT Color=" + color + ">Welcome</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            y = y + d;
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (button > 0)
            {
                ...
                {
                    from.CloseGump(typeof(MyTalk));
                    from.SendGump(new MyTalk(from, 0));
                }
                else // CONVERSATIONS
                {
                    from.CloseGump(typeof(MyTalk));
                    from.SendGump(new MyTalk(from, button));
                }
            }
            else if (m_Origin > 0)
            {
        ...
        public static void speechText(string chat, Mobile m)
        {
            ...
            else if (chat == "Architect")
            {
                num = 2;
            }
            else if (chat == "Armorer")
            {
                num = 3;
            }
            else if (chat == "Assassin")
            {
                num = 4;
            }
            else if (chat == "Banker")
            ...
            else if (chat == "Courier")
            {
                num = 10;
            }
            else if (chat == "DeathKnight")
            {
                num = 11;
            }
            else if (chat == "Devon")
            ...
            else if (chat == "Frankenstein")
            {
                num = 16;
            }
            else if (chat == "Furtrader")
            {
                num = 17;
            }
            else if (chat == "GodOfLegends")
            {
                num = 18;
            }
            else if (chat == "Guard")
            ...
            else if (chat == "NecroGreeter")
            {
                num = 30;
            }
            else if (chat == "Necromancer")
            {
                num = 31;
            }
            else if (chat == "Painter")
            {
                num = 32;
            }
            else if (chat == "Pets")
            ...
            else if (chat == "Powerscroll")
            {
                num = 34;
            }
            else if (chat == "Provisioner")
            {
                num = 35;
            }
            else if (chat == "Ranger")
            ...
            else if (chat == "Shipwright")
            {
                num = 39;
            }
            else if (chat == "Stonecrafter")
            {
                num = 40;
            }
            else if (chat == "Tailor")
            ...
            else if (chat == "Variety")
            {
                num = 45;
            }
            else if (chat == "Weaponsmith")
            {
                num = 46;
            }
            else if (chat == "Xardok")
