...
namespace Server.Gumps
{
    public class QuickBar : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            if (from.FindItemOnLayer(Layer.Cloak) != null)
            {
                ...
                if (myQuiver is BaseQuiver)
                {
                    foreach (Item arrow in myQuiver.Items)
                    {
                        if (arrow is Arrow)
                        {
                            arrowCount = arrowCount + arrow.Amount;
                        }
                        if (arrow is Bolt)
                        {
                            boltCount = boltCount + arrow.Amount;
                        }
                        if (arrow is ThrowingWeapon)
                        {
                            throwCount = throwCount + arrow.Amount;
                        }
                        if (arrow is MageEye)
                        {
                            mageeyeCount = mageeyeCount + arrow.Amount;
                        }
                        if (arrow is HarpoonRope)
                        {
                            ropeCount = ropeCount + arrow.Amount;
                        }
                        if (arrow is Krystal)
                        {
                            krystalCount = krystalCount + arrow.Amount;
                        }
                    }
                }
            }
            ...
            if (keys.Length > 0)
            {
                ...
                foreach (string key in configures)
                {
                    ...
                    else if (nEntry == 37 && key == "1")
                    {
                        set37 = 1;
                    }
                    else if (nEntry == 38 && key == "1")
                    {
                        set38 = 1;
                    }
                    else if (nEntry == 39 && key == "1")
                    {
                        set39 = 1;
                    }
                    else if (nEntry == 40 && key == "1")
                    {
                        set40 = 1;
                    }
            ...
            while (i < 40)
            {
                ...
                else if (i == 37 && set37 == 1)
                {
                    showICON = true;
                }
                else if (i == 38 && set38 == 1)
                {
                    showICON = true;
                }
                else if (i == 39 && set39 == 1)
                {
                    showICON = true;
                }
                else if (i == 40 && set40 == 1)
                {
                    showICON = true;
                }
                    ...
                    if (i == 14 || (i >= 16 && i <= 21))
                    {
                        ...
                        if (v == 0)
                            AddHtml(
                                ...
                                50,
                                20,
                                @"<BODY><BASEFONT Color=#34ee39>" + s + "</BASEFONT></BODY>",
                                (bool)false,
                                (bool)false
                            );
                        else
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            {
                InvokeCommand("wealth", from);
            }
            else if (info.ButtonID == 7)
            {
                InvokeCommand("motd", from);
            }
            ...
            {
                Server.Misc.RegionMusic.MusicRegion(from, from.Region);
            }
            else if (info.ButtonID == 12)
            {
                InvokeCommand("music", from);
            }
            ...
            {
                InvokeCommand("bandself", from);
            }
            else if (info.ButtonID == 15)
            {
                InvokeCommand("bandother", from);
            }
            ...
            {
                if (from.HasGump(typeof(SpellBarsBard2)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsKnight1)))
                {
            ...
            else if (info.ButtonID == 260)
            {
                if (from.HasGump(typeof(SpellBarsKnight2)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsDeath1)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsDeath2)))
                {
            ...
            else if (info.ButtonID == 28)
            {
                ...
                {
                    DruidPouch pouch = (DruidPouch)(
                        from.Backpack.FindItemByType(typeof(DruidPouch))
                    );
                    if (pouch.Bar == 1)
                    {
                        from.SendGump(new DruidPouch.DruidBar(from, pouch, true));
                    }
                    else
                    {
                        from.SendGump(new DruidPouch.DruidBar(from, pouch, false));
                    }
                }
            }
            else if (info.ButtonID == 29)
            {
                if (from.HasGump(typeof(SpellBarsElement1)))
                {
            ...
            else if (info.ButtonID == 290)
            {
                if (from.HasGump(typeof(SpellBarsElement2)))
                {
            ...
            else if (info.ButtonID == 30)
            {
                if (from.HasGump(typeof(JediSpellbook.PowerColumn)))
                {
                    ...
                    {
                        JediSpellbook jedi = (JediSpellbook)(
                            from.Backpack.FindItemByType(typeof(JediSpellbook))
                        );
                        if (jedi.owner == from)
                ...
                {
                    JediSpellbook cube = (JediSpellbook)(
                        from.Backpack.FindItemByType(typeof(JediSpellbook))
                    );
                    if (cube.owner == from)
            ...
            {
                if (from.HasGump(typeof(BagOfTricks.TricksLargeColumn)))
                {
                    from.CloseGump(typeof(BagOfTricks.TricksLargeColumn));
                    from.SendGump(new BagOfTricks.TricksLargeRow(from));
                }
                else if (from.HasGump(typeof(BagOfTricks.TricksLargeRow)))
                {
                    from.CloseGump(typeof(BagOfTricks.TricksLargeRow));
                    from.SendGump(new BagOfTricks.TricksSmallColumn(from));
                }
                else if (from.HasGump(typeof(BagOfTricks.TricksSmallColumn)))
                {
                    from.CloseGump(typeof(BagOfTricks.TricksSmallColumn));
                    from.SendGump(new BagOfTricks.TricksSmallRow(from));
                }
                else if (from.HasGump(typeof(BagOfTricks.TricksSmallRow)))
                {
                    from.CloseGump(typeof(BagOfTricks.TricksSmallRow));
                }
                else
                {
                    from.SendGump(new BagOfTricks.TricksLargeColumn(from));
                }
            }
            else if (info.ButtonID == 32)
            {
                if (from.HasGump(typeof(SpellBarsMage1)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsMage2)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsMage3)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsMage4)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsMonk1)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsMonk2)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsNecro1)))
                {
            ...
            else if (info.ButtonID == 340)
            {
                if (from.HasGump(typeof(SpellBarsNecro2)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsPriest1)))
                {
            ...
            {
                if (from.HasGump(typeof(SpellBarsPriest2)))
                {
            ...
            else if (info.ButtonID == 37)
            {
                if (from.HasGump(typeof(ShinobiScroll.ShinobiColumn)))
                {
                    ...
                    {
                        ShinobiScroll scroll = (ShinobiScroll)(
                            from.Backpack.FindItemByType(typeof(ShinobiScroll))
                        );
            ...
            else if (info.ButtonID == 38)
            {
                if (from.HasGump(typeof(SythSpellbook.PowerColumn)))
                {
                    ...
                    {
                        SythSpellbook syth = (SythSpellbook)(
                            from.Backpack.FindItemByType(typeof(SythSpellbook))
                        );
                        if (syth.owner == from)
                ...
                {
                    SythSpellbook cube = (SythSpellbook)(
                        from.Backpack.FindItemByType(typeof(SythSpellbook))
                    );
                    if (cube.owner == from)
            ...
            else if (info.ButtonID == 39)
            {
                ...
                {
                    WitchPouch pouch = (WitchPouch)(
                        from.Backpack.FindItemByType(typeof(WitchPouch))
                    );
                    if (pouch.Bar == 1)
                    {
                        from.SendGump(new WitchPouch.WitchBar(from, pouch, true));
                    }
                    else
                    {
                        from.SendGump(new WitchPouch.WitchBar(from, pouch, false));
                    }
                }
            }
    ...
    {
        public QuickConfig(Mobile from)
            : base(50, 50)
        {
            int btn1 = 3609;
            int btn2 = 3609;
            ...
            AddHtml(
                ...
                300,
                20,
                @"<BODY><BASEFONT Color=" + color + ">CONFIGURE QUICK BAR</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">This toolbar provides a quick and convenient way to keep an eye on certain inventory items, invoke commands, and access information. Images are used to represent the function of the various buttons. You must choose what icons will appear on your quick bar, and you can select those here. The icons for spells, songs, or abilities will open or close the bar for those categories.</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                223,
                20,
                @"<BODY><BASEFONT Color=" + color + ">Open At Login</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            while (icons < 40)
            {
                ...
                AddHtml(
                    ...
                    223,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + rowText(icons) + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
        ...
        public static string rowText(int set)
        {
            ...
            {
                row = "Find Nearest Magic Portal";
            }
            else if (set == 6)
            {
                row = "Gold in the Bank";
            }
            else if (set == 7)
            {
                row = "Message of the Day";
            }
            else if (set == 8)
            {
                row = "Find Your Corpse";
            }
            else if (set == 9)
            {
                row = "Your Main Quests";
            }
            else if (set == 10)
            {
                row = "Chat & Messages";
            ...
            {
                row = "Special Attack Bar";
            }
            else if (set == 14)
            {
                row = "Bandage Yourself & Quantity";
            }
            else if (set == 15)
            {
                row = "Bandage Other";
            ...
            {
                row = "Harpoon Rope Quantity";
            }
            else if (set == 19)
            {
                row = "Mage Eye Quantity";
            }
            else if (set == 20)
            {
                row = "Krystal Quantity";
            }
            else if (set == 21)
            {
                row = "Throwing Weapon Quantity";
            }
            else if (set == 22)
            {
                row = "Reagent Bar";
