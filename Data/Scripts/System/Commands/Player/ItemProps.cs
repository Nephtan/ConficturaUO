...
namespace Server.Gumps
{
    public class ItemPropsGump : Gump
    {
        ...
        public ItemPropsGump(Mobile from, int origin)
            : base(50, 50)
        {
            m_Origin = origin;
            string color = "#ddbc4b";
            ...
            AddHtml(
                ...
                400,
                20,
                @"<BODY><BASEFONT Color=" + color + ">ITEM PROPERTIES</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
