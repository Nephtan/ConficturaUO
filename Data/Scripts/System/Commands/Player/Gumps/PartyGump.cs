    ...
    public class PartyGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">JOIN A GROUP OF ADVENTURERS</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    ...
                    + ">"
                    + m_Leader.Name
                    + " is asking you to join their party! If you wish to accompany them, select the appropriate button. Otherwise, you can simply cancel the request and continue on your own journey.</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
