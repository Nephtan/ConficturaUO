...
namespace Server.Gumps
{
    public class CreatureHelpGump : Gump
    {
        ...
        public CreatureHelpGump(Mobile from, int origin)
            : base(75, 75)
        {
            m_Origin = origin;
            string color = "#9dca8b";
            ...
            AddHtml(
                ...
                711,
                20,
                @"<BODY><BASEFONT Color=" + color + ">CREATURE HELP</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">"
                    + Server.Items.RacePotions.RaceHelp(m_Origin)
                    + "</BASEFONT></BODY>",
                (bool)false,
                (bool)true
            );
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + hilit
                    + ">"
                    + Server.Items.RacePotions.RaceEquipment()
                    + "</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
