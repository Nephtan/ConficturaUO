...
namespace Server.Misc
{
    class CorpseSearch
    {
        public static void Initialize()
        {
            CommandSystem.Register(
                "corpse",
                AccessLevel.Player,
                new CommandEventHandler(Corpse_OnCommand)
            );
        }
    ...
    public class CorpseArrow : QuestArrow
    {
        ...
        public CorpseArrow(Mobile from, Mobile target, int range)
            : base(from, target)
        {
            m_From = from;
            m_Target = target;
    ...
    public class CorpseTimer : Timer
    {
        ...
        public CorpseTimer(Mobile from, Mobile target, int range, QuestArrow arrow)
...
namespace Server.Mobiles
{
    ...
    public class CorpseCritter : BaseCreature
    {
        ...
        public CorpseCritter(Serial serial)
            : base(serial) { }
