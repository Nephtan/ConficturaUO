...
namespace Server.Gumps
{
    public class FameKarma : Gump
    {
        ...
        public FameKarma(Mobile from, int origin)
            : base(50, 50)
        {
            m_Origin = origin;
            string color = "#e87373";
            ...
            AddHtml(
                ...
                576,
                20,
                @"<BODY><BASEFONT Color=" + color + ">FAME AND KARMA</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                137,
                20,
                @"<BODY><BASEFONT Color=" + color + ">KARMA</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddHtml(
                ...
                720,
                20,
                @"<BODY><BASEFONT Color=" + color + "><CENTER>FAME</CENTER></BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                144,
                495,
                @"<BODY><BASEFONT Color=" + color + ">" + col1 + "</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddHtml(
