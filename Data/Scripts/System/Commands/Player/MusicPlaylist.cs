...
namespace Server.Gumps
{
    public class MusicPlaylist : Gump
    {
        ...
        public MusicPlaylist(Mobile from, int origin)
            : base(50, 50)
        {
            m_Origin = origin;
            this.Closable = true;
            ...
            AddHtml(
                ...
                106,
                20,
                @"<BODY><BASEFONT Color=" + color + ">Use Playlist</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (info.ButtonID > 0 && info.ButtonID < 100)
            {
                MusicPlaylistFunctions.UpdatePlaylist(from, info.ButtonID);
            }
            ...
            {
                from.SendGump(new MusicPlaylist(from, m_Origin));
            }
        }
    ...
    class MusicPlaylistFunctions
    {
        ...
        public static void PlayMusicFile(Mobile from, int song)
        {
            ...
            switch (song)
            {
                case 1:
                {
                    toPlay = MusicName.Britain;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 2:
                {
                    toPlay = MusicName.BucsDen;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 3:
                {
                    toPlay = MusicName.CastleBritain;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 4:
                {
                    toPlay = MusicName.CastleKnowledge;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 5:
                {
                    toPlay = MusicName.DeathGulch;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 6:
                {
                    toPlay = MusicName.DevilGuard;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 7:
                {
                    toPlay = MusicName.Elidor;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 8:
                {
                    toPlay = MusicName.Fawn;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 9:
                {
                    toPlay = MusicName.Grey;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 10:
                {
                    toPlay = MusicName.Luna;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 11:
                {
                    toPlay = MusicName.Montor;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 12:
                {
                    toPlay = MusicName.Moon;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 13:
                {
                    toPlay = MusicName.Renika;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 14:
                {
                    toPlay = MusicName.SkaraBrae;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 15:
                {
                    toPlay = MusicName.TimeLord;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 16:
                {
                    toPlay = MusicName.WizardDen;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 17:
                {
                    toPlay = MusicName.Yew;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 18:
                {
                    toPlay = MusicName.Adventure;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 19:
                {
                    toPlay = MusicName.Expedition;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 20:
                {
                    toPlay = MusicName.Explore;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 21:
                {
                    toPlay = MusicName.Hunting;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 22:
                {
                    toPlay = MusicName.Odyssey;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 23:
                {
                    toPlay = MusicName.Quest;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 24:
                {
                    toPlay = MusicName.Roaming;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 25:
                {
                    toPlay = MusicName.Scouting;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 26:
                {
                    toPlay = MusicName.Searching;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 27:
                {
                    toPlay = MusicName.Seeking;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 28:
                {
                    toPlay = MusicName.Traveling;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 29:
                {
                    toPlay = MusicName.Wandering;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 30:
                {
                    toPlay = MusicName.Catacombs;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 31:
                {
                    toPlay = MusicName.Clues;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 32:
                {
                    toPlay = MusicName.Covetous;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 33:
                {
                    toPlay = MusicName.DardinsPit;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 34:
                {
                    toPlay = MusicName.Deceit;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 35:
                {
                    toPlay = MusicName.Despise;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 36:
                {
                    toPlay = MusicName.Destard;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 37:
                {
                    toPlay = MusicName.Doom;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 38:
                {
                    toPlay = MusicName.Exodus;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 39:
                {
                    toPlay = MusicName.FiresHell;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 40:
                {
                    toPlay = MusicName.Hythloth;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 41:
                {
                    toPlay = MusicName.MinesMorinia;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 42:
                {
                    toPlay = MusicName.PerinianDepths;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 43:
                {
                    toPlay = MusicName.Shame;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 44:
                {
                    toPlay = MusicName.TimeAwaits;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 45:
                {
                    toPlay = MusicName.Wrong;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 46:
                {
                    toPlay = MusicName.Docks;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 47:
                {
                    toPlay = MusicName.Pirates;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 48:
                {
                    toPlay = MusicName.Sailing;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 49:
                {
                    toPlay = MusicName.Cave;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 50:
                {
                    toPlay = MusicName.Grotto;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 51:
                {
                    toPlay = MusicName.Mines;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 52:
                {
                    toPlay = MusicName.Alehouse;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 53:
                {
                    toPlay = MusicName.Bar;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 54:
                {
                    toPlay = MusicName.Guild;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 55:
                {
                    toPlay = MusicName.Inn;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 56:
                {
                    toPlay = MusicName.DarkGuild;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 57:
                {
                    toPlay = MusicName.Pub;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 58:
                {
                    toPlay = MusicName.Tavern;
                    from.Send(PlayMusic.GetInstance(toPlay));
                    break;
                }
                case 60:
