    ...
    public class Docs
    {
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(DocGen_OnCommand)
            );
        }
        ...
        private class MemberComparer : IComparer
        {
            public int Compare(object x, object y)
            {
                ...
                if (v == 0)
                {
                    v = GetNameFrom(aCtor, aProp, aMethod)
                        .CompareTo(GetNameFrom(bCtor, bProp, bMethod));
                }
        ...
        private static string m_RootDirectory = Path.GetDirectoryName(
        ...
        private static void AddIndexLink(
            StreamWriter html,
            string filePath,
            string label,
            string desc
        ...
        private static void GenerateStyles()
        {
            using (StreamWriter css = GetWriter("docs/", "styles.css"))
            {
                ...
                css.WriteLine(
                    "td.sp {{ background-color: #{0:X6}; }}",
                    Core.AOS ? SpinedAOS : SpinedLBR
                );
                css.WriteLine(
                    "td.ho {{ background-color: #{0:X6}; }}",
                    Core.AOS ? HornedAOS : HornedLBR
                );
                css.WriteLine(
                    "td.ba {{ background-color: #{0:X6}; }}",
                    Core.AOS ? BarbedAOS : BarbedLBR
                );
            }
        }
        ...
        private static void DocumentBulkOrders()
        {
            using (StreamWriter html = GetWriter("docs/bods/", "bod_smith_rewards.html"))
            {
                ...
                html.WriteLine("   <head>");
                html.WriteLine(
                    "      <title>RunUO Documentation - Bulk Orders - Smith Rewards</title>"
                );
                html.WriteLine(
                    "      <link rel=\"stylesheet\" type=\"text/css\" href=\"../styles.css\" />"
                );
                ...
                sbod.RequireExceptional = false;
                for (
                    BulkMaterialType mat = BulkMaterialType.None;
                    mat <= BulkMaterialType.Valorite;
                    ++mat
                )
                {
                    sbod.Material = mat;
            ...
            using (StreamWriter html = GetWriter("docs/bods/", "bod_tailor_rewards.html"))
            {
                ...
                html.WriteLine("   <head>");
                html.WriteLine(
                    "      <title>RunUO Documentation - Bulk Orders - Tailor Rewards</title>"
                );
                html.WriteLine(
                    "      <link rel=\"stylesheet\" type=\"text/css\" href=\"../styles.css\" />"
                );
                ...
                html.WriteLine("         <tr>");
                html.WriteLine(
                    "            <td width=\"850\" colspan=\"21\" class=\"entry\"><b>Regular: 10, 15</b></td>"
                );
                html.WriteLine("         </tr>");
                ...
                html.WriteLine("         <tr>");
                html.WriteLine(
                    "            <td width=\"850\" colspan=\"21\" class=\"entry\"><b>Regular: 20</b></td>"
                );
                html.WriteLine("         </tr>");
                ...
                html.WriteLine("         <tr>");
                html.WriteLine(
                    "            <td width=\"850\" colspan=\"21\" class=\"entry\"><b>Exceptional: 20</b></td>"
                );
                html.WriteLine("         </tr>");
        ...
        )
        {
            ...
            bool showCloth = !(
                type.IsSubclassOf(typeof(BaseArmor)) || type.IsSubclassOf(typeof(BaseShoes))
            );

            html.WriteLine("         <tr>");
            html.WriteLine(
                "            <td width=\"850\" colspan=\"21\" class=\"entry\"><b>Regular</b></td>"
            );
            html.WriteLine("         </tr>");
            ...
            for (
                BulkMaterialType mat = BulkMaterialType.Spined;
                mat <= BulkMaterialType.Barbed;
                ++mat
            )
            {
            ...
            html.WriteLine("         <tr>");
            html.WriteLine(
                "            <td width=\"850\" colspan=\"21\" class=\"entry\"><b>Exceptional</b></td>"
            );
            html.WriteLine("         </tr>");
        ...
        private static void WriteTailorBODHeader(StreamWriter html, string title)
        {
            ...
            html.WriteLine(
                "      <table border=\"0\" width=\"850\" cellpadding=\"0\" cellspacing=\"1\">"
            );
            html.WriteLine("         <tr>");
            html.WriteLine(
                "            <td width=\"250\" rowspan=\"2\" class=\"entry\"><center>{0}</center></td>",
                title
            );
            html.WriteLine(
            ...
            html.WriteLine(
                "            <td width=\"75\" colspan=\"3\" class=\"entry\"><center>Runic Kits</center></td>"
            );
            html.WriteLine("         </tr>");
            html.WriteLine("         <tr>");
            html.WriteLine(
                "            <td width=\"25\" class=\"entry\"><center><small>+5</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"entry\"><center><small>+10</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"entry\"><center><small>+15</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"entry\"><center><small>+20</small></center></td>"
            );
            html.WriteLine(
        ...
        private static void WriteTailorBODFooter(StreamWriter html)
        {
            html.WriteLine("         <tr>");
            html.WriteLine(
                "            <td width=\"250\" rowspan=\"2\" class=\"entry\">&nbsp;</td>"
            );
            html.WriteLine(
                "            <td width=\"25\" rowspan=\"2\" class=\"entry\"><center><a href=\"http://www.runuo.com/images/bodreward_cloth_full.jpg\"><img src=\"http://www.runuo.com/images/bodreward_cloth_1.jpg\" alt=\"Colored Cloth (Level 1)\" border=\"0\"></a></center></td>"
            );
        ...
        )
        {
            ...
            while (index < 20)
            {
                ...
                {
                    html.WriteLine(
                        "            <td width=\"25\" class=\"{0}\"><center><b>X</b></center></td>",
                        style
                    );
                    ++index;
                }
        ...
        private static void WriteSmithBODHeader(StreamWriter html, string title)
        {
            ...
            html.WriteLine(
                "            <td width=\"75\" colspan=\"3\" class=\"entry\"><center>Gloves</center></td>"
            );
            html.WriteLine(
            ...
            html.WriteLine("         <tr>");
            html.WriteLine(
                "            <td width=\"25\" class=\"entry\"><center><small>+1</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"entry\"><center><small>+3</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"entry\"><center><small>+5</small></center></td>"
            );
            ...
            html.WriteLine(
                "            <td width=\"25\" class=\"du\"><center><small>Du</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"sh\"><center><small>Sh</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"co\"><center><small>Co</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"br\"><center><small>Br</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"go\"><center><small>Go</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"ag\"><center><small>Ag</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"ve\"><center><small>Ve</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"va\"><center><small>Va</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"entry\"><center><small>+10</small></center></td>"
            );
            ...
            html.WriteLine(
                "            <td width=\"25\" class=\"entry\"><center><small>+30</small></center></td>"
            );
            html.WriteLine(
                "            <td width=\"25\" class=\"entry\"><center><small>+60</small></center></td>"
            );
            html.WriteLine("         </tr>");
        }
        ...
        private static void DocumentKeywords()
        {
            ...
            using (StreamWriter html = GetWriter("docs/", "keywords.html"))
            {
                ...
                for (int p = 0; p < 1 && p < tables.Count; ++p)
                {
                    ...
                    html.WriteLine(
                        "         <tr><td class=\"header\">Number</td><td class=\"header\">Text</td></tr>"
                    );
                    ...
                    for (int i = 0; i < list.Count; ++i)
                    {
                        ...
                        html.Write(
                            "         <tr><td class=\"lentry\">0x{0:X4}</td><td class=\"rentry\">",
                            entry.Index
                        );
            ...
            using (StreamWriter html = GetWriter("docs/", "commands.html"))
            {
                ...
                for (int i = 0; i < commands.Count; ++i)
                {
                    ...
                    AliasesAttribute aliases = (
                        attrs.Length == 0 ? null : attrs[0] as AliasesAttribute
                    );
        ...
        private static void DocumentConstructableObjects()
        {
            ...
            using (StreamWriter html = GetWriter("docs/", "objects.html"))
            {
                ...
                html.WriteLine(
                    "         <tr><td class=\"header\">Item Name</td><td class=\"header\">Usage</td></tr>"
                );

                for (int i = 0; i < items.Count; i += 2)
                    DocumentConstructableObject(
                        html,
                        (Type)items[i],
                        (ConstructorInfo[])items[i + 1]
                    );
        ...
        private static void DocumentConstructableObject(
            StreamWriter html,
            Type t,
        ...
        private static object[,] m_Tooltips = new object[,]
        {
            ...
            {
                typeof(SByte),
                "Numeric value in the range from negative 128 to positive 127, inclusive."
            },
            { typeof(UInt16), "Numeric value in the range from 0 to 65,535, inclusive." },
            {
                typeof(Int16),
                "Numeric value in the range from negative 32,768 to positive 32,767, inclusive."
            },
            ...
            {
                typeof(Int64),
                "Numeric value in the approximate range from negative 10^19 through 10^19."
            },
            {
                typeof(String),
            ...
            {
                typeof(Map),
                "Map or facet name. Possible values include:{0}{0}- Lodor{0}- Sosaria{0}- Underworld{0}- SerpentIsland"
            },
            {
                typeof(Poison),
        ...
        private static string GetTooltipFor(ParameterInfo param)
        {
            ...
            if (paramType.IsEnum)
            {
                ...
                sb.AppendFormat(
                    "Enumeration value or name. Possible named values include:{0}",
                    HtmlNewLine
                );
        ...
        private static void DocumentLoadedTypes()
        {
            using (StreamWriter indexHtml = GetWriter("docs/", "overview.html"))
            {
                ...
                indexHtml.WriteLine("   </head>");
                indexHtml.WriteLine(
                    "   <body bgcolor=\"white\" style=\"font-family: Courier New\" text=\"Black\" link=\"Black\" vlink=\"Black\" alink=\"#808080\">"
                );
                indexHtml.WriteLine("      <h4><a href=\"index.html\">Back to the index</a></h4>");
                indexHtml.WriteLine("      <h2>Namespaces</h2>");

                SortedList<string, List<TypeInfo>> nspaces = new SortedList<string, List<TypeInfo>>(
                    m_Namespaces
                );
        ...
        private static void SaveNamespace(string name, List<TypeInfo> types, StreamWriter indexHtml)
        {
            ...
            using (StreamWriter nsHtml = GetWriter("docs/namespaces/", fileName))
            {
                ...
                nsHtml.WriteLine(
                    "      <title>RunUO Documentation - Class Overview - {0}</title>",
                    name
                );
                nsHtml.WriteLine("   </head>");
                nsHtml.WriteLine(
                ...
                nsHtml.WriteLine(
                    "      <h4><a href=\"../overview.html\">Back to the namespace index</a></h4>"
                );
        ...
        )
        {
            ...
            using (StreamWriter typeHtml = Docs.GetWriter(info.FileName))
            {
                ...
                typeHtml.WriteLine(
                    "      <h4><a href=\"../namespaces/{0}\">Back to {1}</a></h4>",
                    nsFileName,
                    nsName
                );
        ...
        private static void WriteType(TypeInfo info, StreamWriter typeHtml)
        {
            ...
            MemberInfo[] membs = type.GetMembers(
                BindingFlags.Public
        ...
        public static void FormatGeneric(
            Type type,
            ref string typeName,
            ref string fileName,
            ref string linkName
        )
        {
            ...
            if (type.IsGenericType)
            {
                ...
                if (index > 0)
                {
                    ...
                    StringBuilder fnamBuilder = new StringBuilder(
                        "docs/types/" + Docs.SanitizeType(rootType)
                    );
