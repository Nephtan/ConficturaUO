    ...
    public class Add
    {
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(Tile_OnCommand)
            );
            CommandSystem.Register(
                "TileRXYZ",
                AccessLevel.GameMaster,
                new CommandEventHandler(TileRXYZ_OnCommand)
            );
            CommandSystem.Register(
                "TileXYZ",
                AccessLevel.GameMaster,
                new CommandEventHandler(TileXYZ_OnCommand)
            );
            CommandSystem.Register(
                "TileZ",
                AccessLevel.GameMaster,
                new CommandEventHandler(TileZ_OnCommand)
            );
        }
        ...
        private static void TileBox_Callback(
            Mobile from,
            Map map,
            Point3D start,
            Point3D end,
        ...
        public static void Tile_OnCommand(CommandEventArgs e)
        {
            if (e.Length >= 1)
                BoundingBoxPicker.Begin(
                    e.Mobile,
                    new BoundingBoxCallback(TileBox_Callback),
                    new TileState(e.Arguments)
                );
            else
                e.Mobile.SendMessage(
                    "Format: Add <type> [params] [set {<propertyName> <value> ...}]"
                );
        }
        ...
        public static void TileRXYZ_OnCommand(CommandEventArgs e)
        {
            if (e.Length >= 6)
            {
                Point3D p = new Point3D(
                    e.Mobile.X + e.GetInt32(0),
                    e.Mobile.Y + e.GetInt32(1),
                    e.Mobile.Z + e.GetInt32(4)
                );
            ...
            {
                e.Mobile.SendMessage(
                    "Format: TileRXYZ <x> <y> <w> <h> <z> <type> [params] [set {<propertyName> <value> ...}]"
                );
            }
        }
        ...
        public static void TileXYZ_OnCommand(CommandEventArgs e)
        {
            ...
            {
                e.Mobile.SendMessage(
                    "Format: TileXYZ <x> <y> <w> <h> <z> <type> [params] [set {<propertyName> <value> ...}]"
                );
            }
        }
        ...
        public static void TileZ_OnCommand(CommandEventArgs e)
        {
            if (e.Length >= 2)
            {
                ...
                BoundingBoxPicker.Begin(
                    e.Mobile,
                    new BoundingBoxCallback(TileBox_Callback),
                    new TileState(e.GetInt32(0), subArgs)
                );
            }
            else
            {
