...
namespace Server.Commands
{
    ...
    {
        private static CategoryEntry m_RootItems,
            m_RootMobiles;
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(RebuildCategorization_OnCommand)
            );
        }
        ...
        {
            CategoryEntry root = new CategoryEntry(
                null,
                "Add Menu",
                new CategoryEntry[] { Items, Mobiles }
            );
        ...
        public CategoryEntry(CategoryEntry parent, CategoryLine[] lines, ref int index)
        {
            ...
            if (start < 0)
                throw new FormatException(
                    String.Format("Input string not correctly formatted ('{0}')", text)
                );
    ...
    public class CategoryLine
    {
        ...
        public CategoryLine(string input)
        {
            ...
            if (index >= input.Length)
                throw new FormatException(
                    String.Format("Input string not correctly formatted ('{0}')", input)
                );
