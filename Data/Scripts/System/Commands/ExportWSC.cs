    ...
    public class ExportCommand
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(Export_OnCommand)
            );
        }
        ...
        public static void Export_OnCommand(CommandEventArgs e)
        {
            ...
            e.Mobile.SendMessage(
                "This will delete all static items in the world.  Please make a backup."
            );

            foreach (Item item in World.Items.Values)
            {
                if (
                    (item is Static || item is BaseFloor || item is BaseWall)
