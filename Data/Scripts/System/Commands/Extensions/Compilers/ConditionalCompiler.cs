...
namespace Server.Commands.Generic
{
    ...
    public sealed class ComparisonCondition : PropertyCondition
    {
        ...
        public override void Compile(MethodEmitter emitter)
        {
            ...
            bool couldCompare = emitter.CompareTo(
                1,
                delegate()
                {
                    m_Value.Load(emitter);
            ...
            else
            {
                ...
                switch (m_Operator)
                {
                    ...
                    case ComparisonOperator.LesserEqual:
                        throw new InvalidOperationException(
                            "Property does not support relational comparisons."
                        );
    ...
    {
        public static IConditional Compile(
        ...
        )
        {
            ...
            #region Compare
            {
                ...
                typeBuilder.DefineMethodOverride(
                    emitter.Method,
                    typeof(IConditional).GetMethod("Verify", new Type[] { typeof(object) })
                );
