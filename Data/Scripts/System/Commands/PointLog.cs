    ...
    public class PointLog
    {
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(PointLogs)
            );
        }

        [Usage("PointLog")]
        [Description(
            "Records the x, y, and z coordinates of the caller...along with the map they are in."
        )]
        public static void PointLogs(CommandEventArgs e)
        {
            ...
            if (e.Mobile.Map == Map.Lodor)
            {
                sMap = "Map.Lodor";
            }
            else if (e.Mobile.Map == Map.Underworld)
            {
                sMap = "Map.Underworld";
            }
            else if (e.Mobile.Map == Map.SerpentIsland)
            {
                sMap = "Map.SerpentIsland";
            }
            else if (e.Mobile.Map == Map.IslesDread)
            {
                sMap = "Map.IslesDread";
            }
            else if (e.Mobile.Map == Map.SavagedEmpire)
            {
                sMap = "Map.SavagedEmpire";
            }
            else if (e.Mobile.Map == Map.Atlantis)
            {
                sMap = "Map.Atlantis";
            }
