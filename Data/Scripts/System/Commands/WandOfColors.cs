...
namespace Server.Items
{
    ...
    public class WandOfColors : Item
    {
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(WandOfColors wand)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                {
                    if (m_WandOfColors.ItemID == 0x0DF2)
                    {
                        ((Mobile)targeted).Hue = ((Mobile)targeted).Hue + 1;
                    }
                    else
                    {
                        ((Mobile)targeted).Hue = ((Mobile)targeted).Hue - 1;
                    }
                    if (((Mobile)targeted).Hue < 1)
                    {
                        ((Mobile)targeted).Hue = 0;
                    }
                }
                else if (targeted is Item)
                {
                    if (m_WandOfColors.ItemID == 0x0DF2)
                    {
                        ((Item)targeted).Hue = ((Item)targeted).Hue + 1;
                    }
                    else
                    {
                        ((Item)targeted).Hue = ((Item)targeted).Hue - 1;
                    }
                    if (((Item)targeted).Hue < 1)
                    {
                        ((Item)targeted).Hue = 0;
                    }
                }
        ...
        public WandOfColors(Serial serial)
            : base(serial) { }
