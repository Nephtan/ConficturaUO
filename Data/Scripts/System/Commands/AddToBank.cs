    ...
    public class AddToBank
    {
        public static void Initialize()
        {
            ...
            CommandSystem.Register(
                ...
                new CommandEventHandler(AddToBank_OnCommand)
            );
        }
        ...
        public class DupeTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targ)
            {
                ...
                from.SendMessage(
                    "Placing {0} into bank boxes...",
                    ((Item)targ).Name == null ? "an item" : ((Item)targ).Name.ToString()
                );
                CommandLogging.WriteLine(
                    from,
                    "{0} {1} adding {2} to bank boxes )",
                    from.AccessLevel,
        ...
        private static bool GiveItemToAccessLevel(Item item, int amount, int access)
        {
            ...
            foreach (Mobile m in mobs)
            {
                if (m is PlayerMobile)
                {
                    bool give = false;
                    if (
                        (access & (int)AddToBankGump.Switches.Administrator) != 0
                    ...
                    )
                    {
                        ...
                        (access & (int)AddToBankGump.Switches.GameMaster) != 0
                    ...
                    )
                    {
                        ...
                        (access & (int)AddToBankGump.Switches.Seer) != 0
                        && m.AccessLevel == AccessLevel.Seer
                    )
                    {
                        give = true;
                    }
                    else if (
                        (access & (int)AddToBankGump.Switches.Counselor) != 0
            ...
            for (int i = 0; i < props.Length; i++)
            {
                try
                {
                    if (props[i].CanRead && props[i].CanWrite)
                    {
                        ...
                        if (
                            src is Container
                            && (props[i].Name == "TotalWeight" || props[i].Name == "TotalItems")
                        )
                        {
    ...
    public class AddToBankGump : Gump
    {
        ...
        public void RenderGump(int rule, int access, string type)
        {
            ...
            AddRadio(
                ...
                209,
                208,
                rule == (int)Switches.GiveToAccount,
                (int)Switches.GiveToAccount
            );
            ...
            AddRadio(
                ...
                209,
                208,
                rule == (int)Switches.GiveToCharacter,
                (int)Switches.GiveToCharacter
            );
            ...
            AddRadio(
                ...
                209,
                208,
                rule == (int)Switches.GiveToAccessLevel,
                (int)Switches.GiveToAccessLevel
            );
            ...
            AddCheck(
                ...
                210,
                211,
                (access & (int)Switches.Administrator) != 0,
                (int)Switches.Administrator
            );
            ...
            AddCheck(
                ...
                210,
                211,
                (access & (int)Switches.GameMaster) != 0,
                (int)Switches.GameMaster
            );
            ...
            AddCheck(
                ...
                210,
                211,
                (access & (int)Switches.Counselor) != 0,
                (int)Switches.Counselor
            );
                ...
                case (int)Buttons.GiveByType:
                {
                    ...
                    else
                    {
                        ...
                        if (type == null)
                        {
                            ...
                            from.SendGump(
                                new AddToBankGump(GiveRule, Access, string.Empty, m_Amount)
                            );
                            return;
                        }
                        else
