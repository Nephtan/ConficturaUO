...
namespace Server.Misc
{
    public class AutoRestart : Timer
    {
        ...
        private static TimeSpan RestartDelay = TimeSpan.FromMinutes(5.0); // how long the server should remain active before restart (period of 'server wars')
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(Restart_OnCommand)
            );
