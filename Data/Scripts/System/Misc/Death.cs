...
namespace Server.Gumps
{
    public class ResurrectCostGump : Gump
    {
        ...
        public ResurrectCostGump(Mobile owner, int healer)
            : base(50, 50)
        {
            ...
            {
                loss =
                    " If you do, you will suffer a "
                    + c2
                    + "% loss to your fame and karma. You will also lose "
                    + c1
                    + "% of your statistics and skills.";
                c1 = "10";
                c2 = "20";
            }
            ...
            if (m_Price > 0)
            {
                if (m_Price > m_Bank && m_Price > m_Tithe)
                {
                    ...
                    {
                        sText =
                            "You currently do not have enough gold in the bank or tithed to provide an offering to the healer. Do you wish to plead to the healer for your life back now, without providing tribute? If you do, you will suffer a "
                            + c2
                            + "% loss to your fame and karma. You will also lose "
                            + c1
                            + "% of your statistics and skills.";
                    ...
                    {
                        sText =
                            "You currently do not have enough gold in the bank or tithed to provide an offering to the shrine. Do you wish to plead to the gods for your life back now, without providing tribute? If you do, you will suffer a "
                            + c2
                            + "% loss to your fame and karma. You will also lose "
                            + c1
                            + "% of your statistics and skills.";
                        ...
                        {
                            sText =
                                "You currently do not have enough gold in the bank or tithed to provide an offering to Azrael. Do you wish to plead to him for your life back now, without providing tribute? If you do, you will suffer a "
                                + c2
                                + "% loss to your fame and karma. You will also lose "
                                + c1
                                + "% of your statistics and skills.";
                        ...
                        {
                            sText =
                                "You currently do not have enough gold in the bank or tithed to provide an offering to the Reaper. Do you wish to plead to him for your life back now, without providing tribute? If you do, you will suffer a "
                                + c2
                                + "% loss to your fame and karma. You will also lose "
                                + c1
                                + "% of your statistics and skills.";
                        ...
                        {
                            sText =
                                "You currently do not have enough gold in the bank or tithed to provide an offering to the goddess of the sea. Do you wish to plead to Amphitrite for your life back now, without providing tribute? If you do, you will suffer a "
                                + c2
                                + "% loss to your fame and karma. You will also lose "
                                + c1
                                + "% of your statistics and skills.";
                        ...
                        {
                            sText =
                                "You currently do not have enough gold in the bank or tithed to provide an offering to the Archmages. Do you wish to plead to the Archmages for your life back now, without providing tribute? If you do, you will suffer a "
                                + c2
                                + "% loss to your fame and karma. You will also lose "
                                + c1
                                + "% of your statistics and skills.";
                        ...
                        {
                            sText =
                                "You currently do not have enough gold in the bank or tithed to provide an offering to Sin'Vraal. Do you wish to plead to him for your life back now, without providing tribute? If you do, you will suffer a "
                                + c2
                                + "% loss to your fame and karma. You will also lose "
                                + c1
                                + "% of your statistics and skills.";
                        ...
                        {
                            sText =
                                "You currently do not have enough gold in the bank or tithed to provide an offering to the god of the sea. Do you wish to plead to Neptune for your life back now, without providing tribute? If you do, you will suffer a "
                                + c2
                                + "% loss to your fame and karma. You will also lose "
                                + c1
                                + "% of your statistics and skills.";
                        ...
                        {
                            sText =
                                "You currently do not have enough gold in the bank or tithed to provide an offering to the lord of the sea. Do you wish to plead to Poseidon for your life back now, without providing tribute? If you do, you will suffer a "
                                + c2
                                + "% loss to your fame and karma. You will also lose "
                                + c1
                                + "% of your statistics and skills.";
                        ...
                        {
                            sText =
                                "You currently do not have enough gold in the bank or tithed to provide an offering to Ktulu. Do you wish to plead to him for your life back now, without providing tribute? If you do, you will suffer a "
                                + c2
                                + "% loss to your fame and karma. You will also lose "
                                + c1
                                + "% of your statistics and skills.";
                        ...
                        {
                            sText =
                                "You currently do not have enough gold in the bank or tithed to provide an offering to Durama. Do you wish to plead for your life back now, without providing tribute? If you do, you will suffer a "
                                + c2
                                + "% loss to your fame and karma. You will also lose "
                                + c1
                                + "% of your statistics and skills.";
                        ...
                        {
                            sText =
                                "You currently do not have enough gold in the bank or tithed to provide an offering to the Ancient Dryad. Do you wish to plead for your life back now, without providing tribute? If you do, you will suffer a "
                                + c2
                                + "% loss to your fame and karma. You will also lose "
                                + c1
                                + "% of your statistics and skills.";
                ...
                else
                {
                    ...
                    if (m_Healer < 2)
                    {
                        sText =
                            ...
                            + tribute
                            + " to provide an offering to the healer. Do you wish to offer the tribute to the healer for your life back?"
                            + loss;
                    }
                    else
                    {
                        sText =
                            "You currently have enough "
                            + tribute
                            + " to provide an offering to the shrine. Do you wish to offer the tribute to the gods for your life back?"
                            + loss;

                        if (m_Healer == 3)
                        {
                            sText =
                                "Azrael is not ready for your soul just yet, and you currently have enough "
                                + tribute
                                + " to provide an offering to him. Do you wish to offer the tribute to Azrael for your life back?"
                                + loss;
                        }
                        else if (m_Healer == 4)
                        {
                            sText =
                                "Although the Reaper would gladly take your soul, he thinks your time has come to an end too soon. You currently have enough "
                                + tribute
                                + " to provide an offering to the Reaper. Do you wish to offer the tribute to him for your life back?"
                                + loss;
                        }
                        else if (m_Healer == 5)
                        {
                            sText =
                                "You currently have enough "
                                + tribute
                                + " to provide an offering to the goddess of the sea. Do you wish to offer the tribute to Amphitrite for your life back?"
                                + loss;
                        }
                        else if (m_Healer == 6)
                        {
                            sText =
                                "You currently have enough "
                                + tribute
                                + " to provide an offering to the Archmages. Do you wish to offer the tribute to the Archmages for your life back?"
                                + loss;
                        }
                        else if (m_Healer == 7)
                        {
                            sText =
                                "You currently have enough "
                                + tribute
                                + " to provide an offering to Sin'Vraal. Do you wish to offer the tribute to Sin'Vraal for your life back?"
                                + loss;
                        }
                        else if (m_Healer == 8)
                        {
                            sText =
                                "You currently have enough "
                                + tribute
                                + " to provide an offering to the god of the sea. Do you wish to offer the tribute to Neptune for your life back?"
                                + loss;
                        }
                        else if (m_Healer == 9)
                        {
                            sText =
                                "You currently have enough "
                                + tribute
                                + " to provide an offering to the lord of the sea. Do you wish to offer the tribute to Poseidon for your life back?"
                                + loss;
                        }
                        else if (m_Healer == 10)
                        {
                            sText =
                                "Ktulu is not ready for your soul just yet, and you currently have enough "
                                + tribute
                                + " to provide an offering to him. Do you wish to offer the tribute to Ktulu for your life back?"
                                + loss;
                        }
                        else if (m_Healer == 11)
                        {
                            sText =
                                "You currently have enough "
                                + tribute
                                + " to provide an offering to Durama. Do you wish to offer the tribute for your life back?"
                                + loss;
                        }
                        else if (m_Healer == 12)
                        {
                            sText =
                                "You currently have enough "
                                + tribute
                                + " to provide an offering to the Ancient Dryad. Do you wish to offer the tribute for your life back?"
                                + loss;
                        }
                    }
                    m_ResurrectType = 2;
            ...
            {
                case 0:
                    sGrave = "YOUR LIFE BACK";
                    break;
                case 1:
                    sGrave = "YOUR RESURRECTION";
                    break;
                case 2:
                    sGrave = "RETURN TO THE LIVING";
                    break;
                case 3:
                    sGrave = "RETURN FROM THE DEAD";
                    break;
            }
            ...
            AddHtml(
                ...
                349,
                20,
                @"<BODY><BASEFONT Color=" + color + ">" + sGrave + "</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            if (m_Price > 0)
            {
                AddHtml(
                    ...
                    100,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Resurrect:</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
            ...
            if (m_Bank >= m_Price && m_Price > 0)
            {
                AddHtml(
                    ...
                    61,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Bank:</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
            ...
            else if (m_Tithe >= m_Price && m_Price > 0)
            {
                AddHtml(
                    ...
                    61,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Tithe:</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            if (info.ButtonID == 1)
            {
                ...
                else if (m_ResurrectType == 2 && m_Tithe >= m_Price)
                {
                    ...
                    from.SendMessage(
                        "" + m_Price.ToString() + " tithing has been offered to the gods."
                    );
                    ...
                    m_ResurrectType == 1
                    && from.SkillsTotal > 200
                    && (from.RawDex + from.RawInt + from.RawStr) > 90
                )
                {
...
namespace Server.Gumps
{
    ...
    {
        public ResurrectNowGump(Mobile from)
            : base(50, 50)
        {
            ...
            string sText =
                "Do you wish to plead to the gods for your life back now? You may also continue on in your spirit form and seek out a shrine or healer.";
            ...
            if (from.SkillsTotal > 200 && (from.RawDex + from.RawInt + from.RawStr) > 90)
            {
                ...
                if (BankGold >= HealCost)
                    sText =
                        "Do you wish to plead to the gods for your life back now? If you do, you will suffer a "
                        + c2
                        + "% loss to your fame and karma. You will also lose "
                        + c1
                        + "% of your statistics and skills. You have enough gold in the bank to offer the resurrection tribute, so perhaps you may want to find a shrine or healer instead of suffering the penalties.";
                    ...
                    sText =
                        ...
                        + "% loss to your fame and karma. You will also lose "
                        + c1
                        + "% of your statistics and skills. You have enough tithe to offer the resurrection tribute, so perhaps you may want to find a shrine or healer instead of suffering the penalties.";
                else
                    sText =
                        "Do you wish to plead to the gods for your life back now? If you do, you will suffer a "
                        + c2
                        + "% loss to your fame and karma. You will also lose "
                        + c1
                        + "% of your statistics and skills. You cannot afford the resurrection tribute due to the lack of gold in the bank or tithed, so perhaps you may want to do this.";
            }
            ...
            {
                case 0:
                    sGrave = "YOU HAVE DIED!";
                    break;
                case 1:
                    sGrave = "YOU HAVE PERISHED!";
                    break;
                case 2:
                    sGrave = "YOU MET YOUR END!";
                    break;
                case 3:
                    sGrave = "YOUR LIFE HAS ENDED!";
                    break;
            }
    ...
    class Death
    {
        public static void Penalty(Mobile from, bool allPenalty)
        {
            if (
                ...
                && ((GetPlayerInfo.isFromSpace(from) && !allPenalty) || allPenalty)
            )
            {
                double val1 = 0.10;
                double val2 = 0.95;
...
namespace Server.Misc
{
    class GhostHelper
    {
        ...
        public static bool SameArea(Mobile from, Mobile healer)
        {
            ...
            if (healer != null)
            {
                x = healer.X;
                y = healer.Y;
                region = Server.Misc.Worlds.GetRegionName(healer.Map, healer.Location);
                mup = healer.Map;
            }
            ...
            if (
                Worlds.IsPlayerInTheLand(map, location, from.X, from.Y) == true
                && Worlds.IsPlayerInTheLand(mup, loc, loc.X, loc.Y) == true
                && map == mup
            ) // THEY ARE IN THE SAME LAND
                return true;
    ...
    public class GhostArrow : QuestArrow
    {
        ...
        public GhostArrow(Mobile from, Mobile target, int range)
            : base(from, target)
        {
            m_From = from;
            m_Target = target;
    ...
    public class GhostTimer : Timer
    {
        ...
        public GhostTimer(Mobile from, Mobile target, int range, QuestArrow arrow)
        ...
        protected override void OnTick()
        {
            if (!m_Arrow.Running)
            {
                ...
                || m_From.Deleted
                || m_Target.Deleted
                || !m_From.InRange(m_Target, m_Range)
                || GhostHelper.SameArea(m_From, m_Target) == false
            )
            {
                m_Arrow.Stop();
                Stop();
...
namespace Server.Mobiles
{
    ...
    public class ShrineCritter : BaseCreature
    {
        ...
        public ShrineCritter(Serial serial)
            : base(serial) { }
