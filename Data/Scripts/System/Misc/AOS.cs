...
namespace Server
{
        ...
        )
        {
            ...
            if (from != null && !from.Deleted && from.Alive)
            {
                ...
                if (reflectPhys != 0)
                {
                    from.Damage(
                        Scale(
                            (damage * phys * (100 - (ignoreArmor ? 0 : m.PhysicalResistance)))
                                / 10000,
                            reflectPhys
                        ),
                        m
    ...
    public sealed class AosWeaponAttributes : BaseAttributes
    {
        ...
        {
            get { return this[AosWeaponAttribute.ResistPhysicalBonus]; }
        ...
        {
            get { return this[AosWeaponAttribute.ResistFireBonus]; }
        ...
        {
            get { return this[AosWeaponAttribute.ResistColdBonus]; }
        ...
        {
            get { return this[AosWeaponAttribute.ResistPoisonBonus]; }
        ...
        {
            get { return this[AosWeaponAttribute.ResistEnergyBonus]; }
    ...
    public abstract class BaseAttributes
    {
        ...
        {
            if (
                (bitmask == (int)AosWeaponAttribute.DurabilityBonus)
                && (this is AosWeaponAttributes)
            )
            {
                ...
                (bitmask == (int)AosArmorAttribute.DurabilityBonus) && (this is AosArmorAttributes)
            )
            {
