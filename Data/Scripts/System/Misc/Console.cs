...
namespace Server.Misc
{
    class ServerConsole
    {
        ...
        public static void EventSink_ServerStarted()
        {
            ...
            Console.WriteLine("");
            Console.WriteLine("You may now play " + MyServerSettings.ServerName() + "!");
            Console.WriteLine("");
        }
                ...
                switch (input.Trim())
                {
                    ...
                    case "restart":
                    {
                        BroadcastMessage(
                            AccessLevel.Player,
                            0x35,
                            String.Format("[Server] We are restarting...")
                        );
                        Misc.AutoSave.Save();
                    ...
                    default:
                    {
                        ...
                        Console.WriteLine(
                            "shutdown        - Performs a forced save then shuts down the server."
                        );
                        Console.WriteLine(
                            "shutdown nosave - Shuts down the server without saving."
                        );
                        Console.WriteLine(
                        ...
                        Console.WriteLine(
                            "hear            - Copies all local speech to this console:"
                        );
                        Console.WriteLine("                      Char Name (Region name): Speech.");
                        Console.WriteLine(
                            "pages           - Shows all the pages in the page queue,you type the page"
                        );
                        Console.WriteLine(
                            "                      number ,then you type your response to the player."
                        );
