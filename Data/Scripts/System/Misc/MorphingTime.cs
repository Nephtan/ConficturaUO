...
namespace Server.Misc
{
    class MorphingTime
    {
        ...
        {
            if (m.Body == 400 || m.Body == 605)
            {
                m.Female = false;
            }
            else if (m.Body == 401 || m.Body == 606)
            {
                m.Female = true;
            }
        }
        ...
        public static void MakeMeAGargoyle(Mobile m, string Job)
        {
            ...
            if (Utility.RandomMinMax(1, 2) == 1) // FEMALE
            {
                ...
                if (Job == "mage")
                {
                    ...
                    {
                        case 0:
                            m.Title = "the gargoyle wizard";
                            break;
                        case 1:
                            m.Title = "the gargoyle sorcereress";
                            break;
                        case 2:
                            m.Title = "the gargoyle mage";
                            break;
                        case 3:
                            m.Title = "the gargoyle conjurer";
                            break;
                        case 4:
                            m.Title = "the gargoyle magician";
                            break;
                        case 5:
                            m.Title = "the gargoyle witch";
                            break;
                    }
                }
            }
            ...
            foreach (Item i in m.Backpack.FindItemsByType(typeof(GargoylesPickaxe), true))
            {
                items.Add(i);
            }
        ...
        public static void VampireDressUp(Mobile m, int body)
        {
            ...
            if (body != 606 && (Utility.RandomMinMax(1, 2) == 1 || body == 605)) // MALE
            {
                m.Body = 605;
                m.Name =
                    NameList.RandomName("dark_elf_prefix_male")
                    + NameList.RandomName("dark_elf_suffix_male");
                m.BaseSoundID = 0x47D;
                if (Utility.RandomMinMax(1, 2) == 1)
                {
                ...
                {
                    case 1:
                        FancyShirt m_shirt = new FancyShirt();
                        m_shirt.Hue = Hue1;
                        m.AddItem(m_shirt);
                        LongPants m_pant = new LongPants();
                        m_pant.Hue = Hue1;
                        m.AddItem(m_pant);
                        break;
                    case 2:
                        Shirt m_shirts = new Shirt();
                        m_shirts.Hue = Hue1;
                        m.AddItem(m_shirts);
                        ShortPants m_pants = new ShortPants();
                        m_pants.Hue = Hue1;
                        m.AddItem(m_pants);
                        break;
                    case 3:
                        Robe m_robe = new Robe();
                        m_robe.Hue = Hue1;
                        m.AddItem(m_robe);
                        break;
                    case 4:
                        Robe m_robes = new Robe();
                        m_robes.Hue = Hue1;
                        m.AddItem(m_robes);
                        break;
                }
            ...
            else
            {
                ...
                m.Female = true;
                m.Name =
                    NameList.RandomName("dark_elf_prefix_female")
                    + NameList.RandomName("dark_elf_suffix_female");
                m.BaseSoundID = 0x257;
                Utility.AssignRandomHair(m);
                ...
                {
                    case 1:
                        FancyShirt f_shirt = new FancyShirt();
                        f_shirt.Hue = Hue1;
                        m.AddItem(f_shirt);
                        Skirt f_pant = new Skirt();
                        f_pant.Hue = Hue1;
                        m.AddItem(f_pant);
                        break;
                    case 2:
                        Shirt f_shirts = new Shirt();
                        f_shirts.Hue = Hue1;
                        m.AddItem(f_shirts);
                        Kilt f_pants = new Kilt();
                        f_pants.Hue = Hue1;
                        m.AddItem(f_pants);
                        break;
                    case 3:
                        PlainDress f_robe = new PlainDress();
                        f_robe.Hue = Hue1;
                        m.AddItem(f_robe);
                        break;
                    case 4:
                        PlainDress f_robes = new PlainDress();
                        f_robes.Hue = Hue1;
                        m.AddItem(f_robes);
                        break;
                    case 5:
                        FancyDress f_dress = new FancyDress();
                        f_dress.Hue = Hue1;
                        m.AddItem(f_dress);
                        break;
                }
        ...
        public static void RebuildEquipment(Mobile m)
        {
            ...
            {
                FixEquipment(m.FindItemOnLayer(Layer.OuterTorso));
            }
            if (m.FindItemOnLayer(Layer.MiddleTorso) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.MiddleTorso));
            }
            if (m.FindItemOnLayer(Layer.OneHanded) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.OneHanded));
            }
            if (m.FindItemOnLayer(Layer.TwoHanded) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.TwoHanded));
            }
            if (m.FindItemOnLayer(Layer.Bracelet) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Bracelet));
            }
            if (m.FindItemOnLayer(Layer.Ring) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Ring));
            }
            if (m.FindItemOnLayer(Layer.Helm) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Helm));
            }
            if (m.FindItemOnLayer(Layer.Arms) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Arms));
            }
            if (m.FindItemOnLayer(Layer.OuterLegs) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.OuterLegs));
            }
            if (m.FindItemOnLayer(Layer.Neck) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Neck));
            }
            if (m.FindItemOnLayer(Layer.Gloves) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Gloves));
            }
            if (m.FindItemOnLayer(Layer.Talisman) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Talisman));
            }
            if (m.FindItemOnLayer(Layer.Shoes) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Shoes));
            }
            if (m.FindItemOnLayer(Layer.Cloak) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Cloak));
            }
            if (m.FindItemOnLayer(Layer.FirstValid) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.FirstValid));
            }
            if (m.FindItemOnLayer(Layer.Waist) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Waist));
            }
            if (m.FindItemOnLayer(Layer.InnerLegs) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.InnerLegs));
            }
            if (m.FindItemOnLayer(Layer.InnerTorso) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.InnerTorso));
            }
            if (m.FindItemOnLayer(Layer.Pants) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Pants));
            }
            if (m.FindItemOnLayer(Layer.Shirt) != null)
            {
                FixEquipment(m.FindItemOnLayer(Layer.Shirt));
            }
        }
        ...
        public static void RemoveMyClothes(Mobile m)
        {
            ...
            if (m.FindItemOnLayer(Layer.Cloak) != null)
            {
                m.FindItemOnLayer(Layer.Cloak).Delete();
            }
            if (m.FindItemOnLayer(Layer.FirstValid) != null)
            {
        ...
        public static void ColorOnlyClothes(Mobile m, int hue, int rndm)
        {
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.OuterTorso).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.MiddleTorso).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Bracelet).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Ring).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Helm).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Arms).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.OuterLegs).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Neck).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Gloves).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Talisman).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Shoes).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Cloak).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Waist).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.InnerLegs).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.InnerTorso).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Pants).Hue = ColorMeRandom(rndm, hue);
                }
            ...
            )
            {
                ...
                {
                    m.FindItemOnLayer(Layer.Shirt).Hue = ColorMeRandom(rndm, hue);
                }
        ...
        public static void ColorMyClothes(Mobile m, int hue, int rndm)
        {
            ...
            if (
                m.FindItemOnLayer(Layer.OneHanded) != null
                && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.OneHanded))
            )
            {
                if (!(m.FindItemOnLayer(Layer.OneHanded) is WornHumanDeco))
                {
                    m.FindItemOnLayer(Layer.OneHanded).Hue = ColorMeRandom(rndm, hue);
                }
                Server.Misc.Arty.setArtifact(m.FindItemOnLayer(Layer.OneHanded));
            }
            if (
                m.FindItemOnLayer(Layer.TwoHanded) != null
                && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.TwoHanded))
            )
            {
                if (!(m.FindItemOnLayer(Layer.TwoHanded) is WornHumanDeco))
                {
                    m.FindItemOnLayer(Layer.TwoHanded).Hue = ColorMeRandom(rndm, hue);
                }
                Server.Misc.Arty.setArtifact(m.FindItemOnLayer(Layer.TwoHanded));
            }
            if (
                m.FindItemOnLayer(Layer.Bracelet) != null
                && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Bracelet))
            ...
            if (
                ...
                && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.FirstValid))
            )
            {
                if (!(m.FindItemOnLayer(Layer.FirstValid) is WornHumanDeco))
                {
                    m.FindItemOnLayer(Layer.FirstValid).Hue = ColorMeRandom(rndm, hue);
                }
                Server.Misc.Arty.setArtifact(m.FindItemOnLayer(Layer.FirstValid));
            }
            if (
                m.FindItemOnLayer(Layer.Waist) != null
                && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Waist))
        ...
        public static void BlessMyClothes(Mobile m)
        {
            if (m.FindItemOnLayer(Layer.OuterTorso) != null)
            {
                m.FindItemOnLayer(Layer.OuterTorso).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.MiddleTorso) != null)
            {
                m.FindItemOnLayer(Layer.MiddleTorso).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.OneHanded) != null)
            {
                m.FindItemOnLayer(Layer.OneHanded).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.TwoHanded) != null)
            {
                m.FindItemOnLayer(Layer.TwoHanded).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Bracelet) != null)
            {
                m.FindItemOnLayer(Layer.Bracelet).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Ring) != null)
            {
                m.FindItemOnLayer(Layer.Ring).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Helm) != null)
            {
                m.FindItemOnLayer(Layer.Helm).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Arms) != null)
            {
                m.FindItemOnLayer(Layer.Arms).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.OuterLegs) != null)
            {
                m.FindItemOnLayer(Layer.OuterLegs).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Neck) != null)
            {
                m.FindItemOnLayer(Layer.Neck).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Gloves) != null)
            {
                m.FindItemOnLayer(Layer.Gloves).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Talisman) != null)
            {
                m.FindItemOnLayer(Layer.Talisman).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Shoes) != null)
            {
                m.FindItemOnLayer(Layer.Shoes).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Cloak) != null)
            {
                m.FindItemOnLayer(Layer.Cloak).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.FirstValid) != null)
            {
                m.FindItemOnLayer(Layer.FirstValid).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Waist) != null)
            {
                m.FindItemOnLayer(Layer.Waist).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.InnerLegs) != null)
            {
                m.FindItemOnLayer(Layer.InnerLegs).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.InnerTorso) != null)
            {
                m.FindItemOnLayer(Layer.InnerTorso).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Pants) != null)
            {
                m.FindItemOnLayer(Layer.Pants).LootType = LootType.Blessed;
            }
            if (m.FindItemOnLayer(Layer.Shirt) != null)
            {
                m.FindItemOnLayer(Layer.Shirt).LootType = LootType.Blessed;
            }
        }
        ...
        public static void RenameSpaceAceItem(Item item, string word)
        {
            ...
            if (name == "item")
            {
                name = MorphingItem.AddSpacesToSentence((item.GetType()).Name);
            }
        ...
        public static void MakeSpaceAceMetalArmorWeapon(Item item, string material)
        {
            ...
            if (item is BaseWeapon)
            {
                ...
                {
                    Server.Misc.MorphingItem.MorphMyItem(
                        item,
                        "IGNORED",
                        ("" + material + suffix + ""),
                        "IGNORED",
                        MorphingTemplates.TemplateSpaceAce("weapons")
                    );
                }
                else
                {
            ...
            else if (item is BaseArmor)
            {
                ...
                if (Utility.RandomMinMax(1, 10) == 1)
                {
                    Server.Misc.MorphingItem.MorphMyItem(
                        ...
                        ("" + material + suffix + ""),
                        "IGNORED",
                        MorphingTemplates.TemplateSpaceAce("armors")
                    );
                }
                else
                {
            ...
            else if (Server.Misc.MaterialInfo.IsJewelryRing(item))
            {
                item.Name = material + suffix + " Ring";
            }
            else if (item.ItemID == 0x4CFD || item.ItemID == 0x4CFE)
            {
                item.Name = material + suffix + " Beads";
            }
            else if (Server.Misc.MaterialInfo.IsJewelryAmulet(item))
            {
                item.Name = material + suffix + " Amulet";
            }
            else if (Server.Misc.MaterialInfo.IsJewelryEarrings(item))
            {
                item.Name = material + suffix + " Earrings";
            }
            else if (Server.Misc.MaterialInfo.IsJewelryBracelet(item))
            {
                item.Name = material + suffix + " Bracelet";
            }
            else if (item is MagicJewelryCirclet || item.ItemID == 0x2B6F || item.ItemID == 0x3166)
            {
                item.Name = material + suffix + " Circlet";
            }
            else
            {
                RenameSpaceAceItem(item, ("" + material + suffix + ""));
        ...
        public static void MakeSpaceAceWoodArmorWeapon(Item item, string material)
        {
            ...
            if (item.Name != null)
            {
                if ((item.Name).Contains("Wood") || (item.Name).Contains("wood"))
                {
                    suffix = "";
                }
            }
        ...
        public static void MakeSpaceAceBoneArmor(Item item, string material, bool keepName)
        {
            ...
            if (item is OrcHelm)
            {
                item.Name = "skeletal helm";
            }
            else if (item is BoneLegs || item is BoneLegs)
            {
                item.Name = "skeletal leggings";
                item.ItemID = 0x49C2;
            }
            else if (item is BoneGloves || item is SavageGloves)
            {
                item.Name = "skeletal gauntlets";
                item.ItemID = 0x499D;
            }
            else if (item is BoneArms || item is SavageArms)
            {
                item.Name = "skeletal bracers";
                item.ItemID = 0x4988;
            }
            else if (item is BoneChest || item is SavageChest)
            {
                item.Name = "skeletal tunic";
                item.ItemID = 0x498F;
            }
            else if (item is BoneSkirt)
            {
                item.Name = "skeletal skirt";
            }
            else if (item is BoneHelm || item is SavageHelm)
            {
                item.Name = "skeletal helm";
                item.ItemID = 0x49C1;
            }
                ...
                if (Server.Misc.Worlds.IsOnSpaceship(m.Location, m.Map))
                {
                    ...
                    else if (item is BaseShield)
                    {
                        switch (Utility.RandomMinMax(1, 4))
                        {
                            case 1:
                                item.ItemID = 0x1B76;
                                item.Name = "hull plate";
                                break;
                            case 2:
                                item.ItemID = 0x1B76;
                                item.Name = "deck plate";
                                break;
                            case 3:
                                item.ItemID = 0x1B72;
                                item.Name = "hatch door";
                                break;
                            case 4:
                                item.ItemID = 0x1B7B;
                    ...
                    else if (item is SkeletonsKey)
                    {
                        item.Name = "minimal access card";
                        item.ItemID = 0x3A75;
                        item.Hue = 0x59A;
                    }
                    else if (item is MasterSkeletonsKey)
                    {
                        item.Name = "full access card";
                        item.ItemID = 0x3A75;
                        item.Hue = 0x66D;
                    }
                    else if (item is Lockpick)
                    {
                        item.Name = "security card";
                        item.ItemID = 0x3A75;
                        item.Hue = 0x53C;
                        item.Amount = Utility.RandomMinMax(1, 3);
                    }
                    else if (item is Krystal)
                    {
                        item.Amount = Utility.RandomMinMax(15, 50);
                    }
                    else if (item is ChickenLeg)
                    {
                        item.ItemID = 0x2023;
                        item.Hue = 0xB51;
                        item.Name = "soylent green";
                    }
                    else if (item is Ribs)
                    {
                        item.ItemID = 0x2023;
                        item.Hue = 0xB20;
                        item.Name = "spam";
                    ...
                    else if (Server.Items.HiddenTrap.IsJewelryItem(item))
                    {
                        MakeSpaceAceMetalArmorWeapon(item, null);
                    }
                    ...
                    {
                        item.Amount = Utility.RandomMinMax(5, 25);
                    }
                    else if (item is Waterskin)
                    {
                        item.ItemID = 0x4971;
                        item.Name = "empty canteen";
                    }
                    else if (item is DirtyWaterskin)
                    {
                        item.ItemID = 0x48E4;
                        item.Name = "old canteen";
                    }
                    else if (
                        (
                            item is HoodedMantle
                            || item is ClothCowl
                            || item is ClothHood
                            || item is FancyHood
                            || item is Robe
                    ...
                    )
                    {
                        ...
                        if (item is Robe)
                        {
                            catCloth = Utility.RandomMinMax(4, 7);
                        }

                        switch (catCloth)
                        {
                            case 1:
                                ((BaseClothing)item).Resistances.Energy = Utility.RandomMinMax(
                                    10,
                                    30
                                );
                                item.Name = "radiation hood";
                                item.Hue = 0xBAD;
                                break;
                            case 2:
                                ((BaseClothing)item).Resistances.Poison = Utility.RandomMinMax(
                                    10,
                                    30
                                );
                                item.Name = "biohazard hood";
                                item.Hue = 0xBA1;
                                break;
                            case 3:
                                ((BaseClothing)item).Resistances.Energy = Utility.RandomMinMax(
                    ...
                    else if ((item is BaseHat || item is MagicHat) && Utility.RandomBool()) // ONLY HALF THE HATS BECOME GOGGLES
                    {
                        ...
                        {
                            case 1:
                                item.Name = "Pilot Goggles";
                                break;
                            case 2:
                                item.Name = "Medical Goggles";
                                break;
                            case 3:
                                item.Name = "Security Goggles";
                                break;
                            case 4:
                                item.Name = "Engineering Goggles";
                                break;
                            case 5:
                                item.Name = "Science Goggles";
                                break;
                            case 6:
                                item.Name = "Laboratory Goggles";
                                break;
                            case 7:
                                item.Name = "Safety Goggles";
                                break;
                            case 8:
                                item.Name = "Sun Goggles";
                                break;
                            case 9:
                                item.Name = "Night Goggles";
                                if (item is BaseClothing)
                                {
                                    ((BaseClothing)item).Attributes.NightSight = 1;
                                }
                    ...
                    else if (item is Emerald)
                    {
                        item.ItemID = 0xF25;
                        item.Hue = 0x950;
                        item.Name = "etaan crystal";
                    }
                    else if (item is Sapphire)
                    {
                        item.ItemID = 0xF2D;
                        item.Hue = 0xB40;
                        item.Name = "trilithium crystal";
                    }
                    else if (item is Ruby)
                    {
                        item.ItemID = 0xF16;
                        item.Hue = 0x94F;
                        item.Name = "lava crystal";
                    }
                    else if (item is Citrine)
                    {
                        item.ItemID = 0xF21;
                        item.Hue = 0xB54;
                        item.Name = "dilithium crystal";
                    }
                    else if (item is Amethyst)
                    {
                        item.ItemID = 0xF10;
                        item.Hue = 0x94A;
                        item.Name = "dantari crystal";
                    }
                    else if (item is Tourmaline)
                    {
                        item.ItemID = 0xF19;
                        item.Hue = 0x86C;
                        item.Name = "vexxtal crystal";
                    }
                    else if (item is Amber)
                    {
                        item.ItemID = 0xF13;
                        item.Hue = 0x8FC;
                        item.Name = "nova crystal";
                    }
                    else if (item is Diamond)
                    {
                        ...
                        (item is KilrathiHeavyGun || item is KilrathiGun)
                    ...
                    )
                    {
                        ...
                        item is MagicJewelryRing
                        || item is MagicJewelryNecklace
                        || item is MagicJewelryEarrings
                        || item is MagicJewelryBracelet
                        || item is MagicJewelryCirclet
                    )
                    {
                        MakeSpaceAceMetalArmorWeapon(item, null);
                    }
                    ...
                    else if (item is BaseArmor)
                    {
                        ...
                        {
                            MakeSpaceAceBoneArmor(item, null, false);
                        }
                        else if (
                            item is SavageLegs
                            || item is SavageGloves
                            || item is SavageArms
                            || item is SavageChest
                            || item is SavageHelm
                        )
                        {
                            ...
                            Server.Misc.MaterialInfo.IsWoodenItem(item)
                            && Utility.RandomMinMax(1, 20) == 1
                        )
                        {
                            ((BaseArmor)item).Resource = CraftResource.PetrifiedTree;
                        }
                        else if (Server.Misc.MaterialInfo.IsWoodenItem(item))
                        {
                            MakeSpaceAceWoodArmorWeapon(item, null);
                        }
                        else if (
                            Server.Misc.MaterialInfo.IsLeatherItem(item)
                            && Utility.RandomMinMax(1, 20) == 1
                        )
                        {
                            ((BaseArmor)item).Resource = CraftResource.AlienLeather;
                        }
                        ...
                        {
                            ((BaseArmor)item).Resource = CraftResource.Xormite;
                        }
                        else if (Server.Misc.MaterialInfo.IsMetalItem(item))
                        {
                            MakeSpaceAceMetalArmorWeapon(item, null);
                        }
                    }
                    else if (item is BaseWeapon)
                    {
                        ...
                        {
                            ((BaseWeapon)item).Resource = CraftResource.AlienLeather;
                        }
                        else if (Server.Misc.MaterialInfo.IsLeatherItem(item))
                        {
                            MakeSpaceAceClothArmorWeapon(item, null);
                        ...
                        {
                            ((BaseWeapon)item).Resource = CraftResource.PetrifiedTree;
                        }
                        else if (Server.Misc.MaterialInfo.IsWoodenItem(item))
                        {
                            MakeSpaceAceWoodArmorWeapon(item, null);
                        ...
                        {
                            ((BaseWeapon)item).Resource = CraftResource.Xormite;
                        }
                        else if (Server.Misc.MaterialInfo.IsMetalItem(item))
                        {
                            MakeSpaceAceMetalArmorWeapon(item, null);
                    ...
                    {
                        Server.Items.UnknownLiquid.MakeSpaceAceLiquid(item);
                    }
                    else if (item is BasePotion)
                    {
                        Server.Items.BasePotion.MakePillBottle(item);
                    }
                    else if (item is UnknownReagent)
                    {
                        Server.Items.UnknownReagent.MakeSpaceAceReagent(item);
                    }
                    ...
                    else if (item is ArtifactManual)
                    {
                        item.Name = "magnifying lense";
                        item.ItemID = 0x202F;
                        item.Hue = 0;
                        ((ArtifactManual)item).Charges = Utility.RandomMinMax(2, 10);
                    }
                }
            }
        }
                ...
                if (Server.Misc.GetPlayerInfo.OrientalPlay(m) == true)
                {
                    ...
                    if (ninja > 0 && ninja >= samurai)
                    {
                        if (item is LeatherCap)
                        {
                            switch (Utility.RandomMinMax(1, 5))
                            {
                                case 1:
                                    ...
                                    if (item.Hue == 0)
                                    {
                                        item.Hue = Server.Misc.MaterialInfo.PlainLeatherColor();
                                    }
                                    break;
                                case 2:
                                    item.ItemID = 0x5C11;
                                    item.Name = "shinobi hood";
                                    if (item.Hue == 0)
                                    {
                                        item.Hue = Server.Misc.MaterialInfo.PlainLeatherColor();
                                    }
                        ...
                        else if (item is LeatherChest)
                        {
                            ...
                            {
                                item.ItemID = 0x64BD;
                                item.Name = "oniwaban tunic";
                            }
                            else
                            {
                                item.ItemID = 0x2793;
                                item.Name = "leather shitagi";
                                if (item.Hue == 0)
                                {
                                    item.Hue = 0x83D;
                                }
                        ...
                        else if (item is LeatherGloves)
                        {
                            ...
                            {
                                item.ItemID = 0x64B9;
                                item.Name = "oniwaban gloves";
                            }
                            else
                            {
                                item.ItemID = 0x2792;
                                item.Name = "leather yugake";
                                if (item.Hue == 0)
                                {
                                    item.Hue = 0x83D;
                                }
                        ...
                        else if (item is LeatherLegs)
                        {
                            ...
                            {
                                item.ItemID = 0x64BC;
                                item.Name = "oniwaban leggings";
                            }
                            else
                            {
                                item.ItemID = 0x2791;
                                item.Name = "leather hakama";
                                if (item.Hue == 0)
                                {
                                    item.Hue = 0x83D;
                                }
                        ...
                        else if (item is LeatherGorget)
                        {
                            item.ItemID = 0x277A;
                            item.Name = "leather nodowa";
                            if (item.Hue == 0)
                            {
                                item.Hue = 0x83D;
                            }
                        }
                        else if (item is LeatherRobe)
                        {
                            item.ItemID = 0x5C10;
                            item.Name = "shinobi robe";
                            if (item.Hue == 0)
                            {
                                item.Hue = Server.Misc.MaterialInfo.PlainLeatherColor();
                            }
                        }
                        else if (item is StuddedChest)
                        {
                            item.ItemID = 0x2793;
                            item.Name = "studded shitagi";
                            if (item.Hue == 0)
                            {
                                item.Hue = 0x837;
                            }
                        }
                        else if (item is StuddedLegs)
                        {
                            item.ItemID = 0x2791;
                            item.Name = "studded hakama";
                            if (item.Hue == 0)
                            {
                                item.Hue = 0x837;
                            }
                        }
                        else if (item is StuddedGloves)
                        {
                            item.ItemID = 0x2792;
                            item.Name = "studded yugake";
                            if (item.Hue == 0)
                            {
                                item.Hue = 0x837;
                            }
                        }
                        else if (item is StuddedGorget)
                        {
                            item.ItemID = 0x277A;
                            item.Name = "leather nodowa";
                            if (item.Hue == 0)
                    ...
                    else if (samurai > 0 && samurai >= ninja)
                    {
                        ...
                        {
                            item.ItemID = 0x2798;
                            item.Name = "leather kasa";
                        }
                        else if (item is LeatherChest)
                        {
                            item.ItemID = 0x277B;
                            item.Name = "leather do";
                        }
                        else if (item is LeatherLegs && Utility.RandomMinMax(1, 2) == 1)
                        {
                            item.ItemID = 0x278A;
                            item.Name = "leather haidate";
                        }
                        else if (item is LeatherLegs)
                        {
                            item.ItemID = 0x2786;
                            item.Name = "leather suneate";
                        }
                        else if (item is LeatherGorget)
                        {
                            item.ItemID = 0x277A;
                            item.Name = "leather mempo";
                        }
                        else if (item is LeatherArms)
                        {
                            item.ItemID = 0x277E;
                            item.Name = "leather kote";
                        }
                        else if (item is StuddedChest)
                        {
                            item.ItemID = 0x27C7;
                            item.Name = "studded do";
                        }
                        else if (item is StuddedLegs && Utility.RandomMinMax(1, 2) == 1)
                        {
                            item.ItemID = 0x278B;
                            item.Name = "studded haidate";
                        }
                        else if (item is StuddedLegs)
                        {
                            item.ItemID = 0x27D2;
                            item.Name = "studded suneate";
                        }
                        else if (item is StuddedGorget)
                        {
                            item.ItemID = 0x279D;
                            item.Name = "studded mempo";
                        }
                        else if (item is StuddedArms)
                        {
                            item.ItemID = 0x277F;
                            item.Name = "studded kote";
                        }
                    ...
                    if (item is ChainCoif)
                    {
                        item.ItemID = 0x2774;
                        item.Name = "chain hatsuburi";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x836;
                        }
                    }
                    else if (item is RingmailArms)
                    {
                        item.ItemID = 0x277F;
                        item.Name = "ringmail kote";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x836;
                        }
                    }
                    else if (item is RingmailLegs)
                    {
                        item.ItemID = 0x278D;
                        item.Name = "ringmail haidate";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x836;
                        }
                    }
                    else if (item is ChainLegs)
                    {
                        item.ItemID = 0x2788;
                        item.Name = "chain suneate";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x836;
                        }
                    }
                    else if (item is RingmailChest)
                    {
                        item.ItemID = 0x27C7;
                        item.Name = "ringmail do";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x836;
                        }
                    ...
                    else if (item is MagicDragonHelm)
                    {
                        item.ItemID = 0x2778;
                        item.Name = "scale kabuto";
                    }
                    else if (item is MagicDragonChest)
                    {
                        item.ItemID = 0x277D;
                        item.Name = "scale do";
                    }
                    else if (item is MagicDragonLegs)
                    {
                        item.ItemID = 0x278D;
                        item.Name = "scale haidate";
                    }
                    else if (item is MagicDragonArms)
                    {
                        item.ItemID = 0x2780;
                        item.Name = "scale kote";
                    }
                    else if (item is MagicDragonGloves)
                    {
                        item.Name = "scale yugake";
                    }
                    else if (item is PlateArms)
                    {
                        item.ItemID = 0x2780;
                        item.Name = "plate kote";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x539;
                        }
                    }
                    else if (item is RoyalArms)
                    {
                        item.ItemID = 0x2780;
                        item.Name = "shogun kote";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x846;
                        }
                    }
                    else if (item is PlateGorget)
                    {
                        item.ItemID = 0x2779;
                        item.Name = "plate mempo";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x539;
                        }
                    }
                    else if (item is RoyalGorget)
                    {
                        item.ItemID = 0x2779;
                        item.Name = "shogun mempo";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x846;
                        }
                    }
                    else if (item is PlateLegs)
                    {
                        item.ItemID = 0x2788;
                        item.Name = "plate suneate";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x539;
                        }
                    }
                    else if (item is RoyalsLegs)
                    {
                        item.ItemID = 0x278D;
                        item.Name = "shogun haidate";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x846;
                        }
                    }
                    else if (item is CloseHelm)
                    {
                        item.ItemID = 0x2781;
                        item.Name = "plate jingasa";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x539;
                        }
                    ...
                    else if (item is Bascinet)
                    {
                        item.ItemID = 0x2775;
                        item.Name = "plate hatsuburi";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x539;
                        }
                    }
                    else if (item is NorseHelm)
                    {
                        item.ItemID = 0x2789;
                        item.Name = "plate kabuto";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x539;
                        }
                    }
                    else if (item is PlateHelm)
                    {
                        item.ItemID = 0x2785;
                        item.Name = "plate kabuto";
                        if (item.Hue == 0)
                    ...
                    else if (item is RoyalHelm)
                    {
                        item.ItemID = 0x2778;
                        item.Name = "shogun kabuto";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x846;
                        }
                    ...
                    else if (item is MagicSash)
                    {
                        item.Name = "himo";
                    }
                    else if (item is MagicCloak)
                    {
                        item.Name = "horo";
                    }
                    ...
                    {
                        item.ItemID = 0x2788;
                        item.Name = "wooden suneate";
                    }
                    else if (item is WoodenPlateGorget)
                    {
                        item.ItemID = 0x2779;
                        item.Name = "wooden mempo";
                    }
                    else if (item is WoodenPlateArms)
                    {
                        item.ItemID = 0x2780;
                        item.Name = "wooden kote";
                    }
                    else if (item is WoodenPlateChest)
                    {
                        item.ItemID = 0x277D;
                        item.Name = "wooden do";
                    }
                    else if (item is WoodenPlateHelm)
                    {
                        item.ItemID = 0x2785;
                        item.Name = "wooden kabuto";
                    }
                    else if (item is MagicRobe || item is BaseOuterTorso)
                    {
                        ...
                        {
                            case 0:
                                item.ItemID = Utility.RandomList(0x2799, 0x27E4);
                                item.Weight = 3.0;
                                item.Name = "kamishimo";
                                break;
                            case 1:
                                item.ItemID = Utility.RandomList(0x279C, 0x27E7);
                                item.Weight = 3.0;
                                item.Name = "hakama shita";
                                break;
                            case 2:
                                item.ItemID = Utility.RandomList(0x2782, 0x27CD);
                                item.Weight = 3.0;
                                item.Name = "kimono";
                                break;
                            case 3:
                                item.ItemID = Utility.RandomList(0x2783, 0x27CE);
                                item.Weight = 3.0;
                                item.Name = "kimono";
                                break;
                        }
                    }
                    else if (item is PugilistGlove)
                    {
                        item.ItemID = 0x13C6;
                        item.Name = "wushu gloves";
                    }
                    else if (item is PugilistGloves)
                    {
                        item.ItemID = 0x13C6;
                        item.Name = "wushu gloves";
                    }
                    else if (item is Crossbow)
                    {
                        item.Name = "chu-ko-nu";
                    }
                    else if (item is ElvenCompositeLongbow)
                    {
                        item.Name = "daikyu";
                    }
                    else if (item is QuarterStaff)
                    {
                        item.Name = "bo staff";
                    }
                    else if (item is Pike)
                    {
                        item.Name = "kumade";
                    }
                    else if (item is BladedStaff)
                    {
                        item.Name = "naginata";
                    }
                    else if (item is SpikedClub)
                    {
                        item.Name = "tetsubo";
                    }
                    else if (item is Hammers)
                    {
                        item.ItemID = Utility.RandomList(0x2AB5, 0x27A6);
                        item.Name = "tetsubo";
                    }
                    ...
                    else if (item is ElvenMachete)
                    {
                        item.Name = "sutou sabre";
                    }
                    else if (item is ShortSword)
                    {
                        item.ItemID = 0x27A4;
                        item.Name = "wakizashi";
                    }
                    else if (item is Scimitar)
                    {
                        item.Name = "dao";
                    }
                    else if (item is Leafblade)
                    {
                        item.Name = "tanto";
                    }
                    ...
                    else if (item is Buckler)
                    {
                        item.ItemID = 0x1B73;
                        item.Name = "small shirudo";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x539;
                        }
                    ...
                    {
                        item.ItemID = 0x1B76;
                        item.Name = "infantry shirudo";
                        if (item.Hue == 0)
                        {
                            item.Hue = 0x539;
                        }
                    }
                    else if (item is MetalShield)
                    {
                        item.ItemID = 0x1B7B;
        ...
        {
            if (
                Server.Misc.MaterialInfo.IsStrangeMetalItem(item)
            ...
            else
            {
                ...
                else if (Server.Misc.MaterialInfo.IsLeatherItem(item) == true)
                {
                    ...
                    if (item is BaseWeapon)
                    {
                        ...
                        if (whichOne == 1 && Worlds.IsExploringSeaAreas(from) == true)
                        {
                            weapon.Resource = CraftResource.SpinedLeather;
                        }
                        else if (
                ...
                else if (Server.Misc.MaterialInfo.IsWoodenItem(item) == true)
                {
                    ...
                    if (item is BaseWeapon)
                    {
                        ...
                        if (Worlds.IsExploringSeaAreas(from) == true)
                        {
                    ...
                    else if (item is BaseInstrument)
                    {
                        ...
                        if (item is Trumpet)
                        {
                            if (chances >= 256)
                            {
                                lute.Resource = CraftResource.Iron;
                            }
                            else if (chances >= 128)
                            {
                            ...
                            if (chances == 1 && Worlds.IsExploringSeaAreas(from) == true)
                            {
        ...
        public static bool MakeSpecialMaterial(Item item, bool isEvil)
        {
            ...
            if (Utility.RandomMinMax(1, 100) == 1)
            {
                ...
                if (isEvil == true)
                {
                    pick = Utility.RandomMinMax(1, 6);
                }

                if (item.ItemID == 0x2790)
                {
                    suffix = "belt";
                }
                else if (item.ItemID == 0x2B68)
                {
                    suffix = "loin cloth";
                }
                else if (item.ItemID == 0x55DB)
                {
                    suffix = "royal loin cloth";
                }
                else if (item.ItemID == 0x153b)
                {
                    suffix = "apron";
                }
                else if (item is MagicSash)
                ...
                else if (item is MagicLantern)
                {
                    suffix = "lantern";
                }
                else if (item is MagicCandle)
                {
                    suffix = "candle";
                }
                else if (item is MagicCloak)
                ...
                else if (item is MagicTalisman)
                {
                    suffix = item.Name;
                }
                else if (item is MagicTorch)
                {
                    suffix = "torch";
                }
                else if (item.ItemID == 0x230E || item.ItemID == 0x230D)
                {
                    suffix = "dress";
                }
                else if (item.ItemID == 0x1F00 || item.ItemID == 0x1EFF)
                {
                    suffix = "dress";
                }
                else if (item.ItemID == 0x1f01 || item.ItemID == 0x1f02)
                {
                    suffix = "dress";
                }
                else if (item.ItemID == 0x170d || item.ItemID == 0x170e)
                {
                    suffix = "sandals";
                }
                else if (item.ItemID == 0x170f || item.ItemID == 0x1710)
                {
                    suffix = "shoes";
                }
                else if (item.ItemID == 5914)
                {
                    suffix = "feathered hat";
                }
                else if (item.ItemID == 5916)
                {
                    suffix = "jester hat";
                }
                else if (item.ItemID == 5911)
                {
                    suffix = "straw hat";
                }
                else if (item.ItemID == 5910)
                {
                    suffix = "tall straw hat";
                }
                else if (item.ItemID == 5908)
                {
                    suffix = "wide brim hat";
                }
                else if (item.ItemID == 5912)
                {
                    suffix = "wizard hat";
                }
                else if (item.ItemID == 5915)
                {
                    suffix = "tricorne hat";
                }
                else if (item.ItemID == 5907)
                {
                    suffix = "floppy hat";
                }
                else if (item.ItemID == 5907)
                ...
                else if (item.ItemID == 5444)
                {
                    suffix = "skullcap";
                }
                else if (item.ItemID == 5909)
                {
                    suffix = "bonnet";
                }
                else if (item.ItemID == 0x2B71)
                {
                    suffix = "hood";
                }
                else if (item.ItemID == 0x3176)
                {
                    suffix = "cowl";
                }
                else if (item.ItemID == 0x4D09)
                {
                    suffix = "fancy hood";
                }
                else if (item.ItemID == 0x4CDA)
                {
                    suffix = "Syth hood";
                }
                else if (item.ItemID == 0x4CDC)
                {
                    suffix = "Syth cowl";
                }
                else if (item.ItemID == 0x4CDB)
                {
                    suffix = "reaper hood";
                }
                else if (item.ItemID == 0x4CDD)
                {
                    suffix = "reaper cowl";
                }
                else if (item.ItemID == 0x2FC3)
                {
                    suffix = "witch hat";
                }
                else if (item.ItemID == 0x2FBC)
                {
                    suffix = "pirate hat";
                }
                else if (item.ItemID == 0x2B6D)
                {
                    suffix = "wolfskin cap";
                }
                else if (item.ItemID == 0x278F)
                {
                    suffix = "executioners hood";
                }
                else if (item.ItemID == 0x1540)
                {
                    suffix = "bandana";
                }
                else if (item.ItemID == 0x1549)
                {
                    suffix = "shaman mask";
                }
                else if (item.ItemID == 0x154B)
                {
                    suffix = "tribal mask";
                }
                else if (item.ItemID == 5445)
                {
                    suffix = "bearskin cap";
                }
                else if (item.ItemID == 5447)
                {
                    suffix = "dearskin cap";
                }
                else if (item is MagicRobe)
                {
                    suffix = "robe";
                }
                else if (item is MagicBoots)
                ...
                {
                    case 1:
                        item.Name = "shadow " + suffix;
                        item.Hue = 0x966;
                        break;
                    case 2:
                        item.Name = "ruby " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("ruby", "classic", 0);
                        break;
                    case 3:
                        item.Name = "sapphire " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("sapphire", "classic", 0);
                        break;
                    case 4:
                        item.Name = "obsidian " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("obsidian", "classic", 0);
                        break;
                    case 5:
                        item.Name = "violet " + suffix;
                        item.Hue = 0x486;
                        break;
                    case 6:
                        item.Name = "silver " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("silver", "classic", 0);
                        break;
                    case 7:
                        item.Name = "jade " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("jade", "classic", 0);
                        break;
                    case 8:
                        item.Name = "azurite " + suffix;
                        item.Hue = 0x5B6;
                        break;
                    case 9:
                        item.Name = "emerald " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("emerald", "classic", 0);
                        break;
                    case 10:
                        item.Name = "pearl " + suffix;
                        item.Hue = 0x47E;
                        break;
                    case 11:
                        item.Name = "turquoise " + suffix;
                        item.Hue = 0x495;
                        break;
                    case 12:
                        item.Name = "amethyst " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("amethyst", "classic", 0);
                        break;
                    case 13:
                        item.Name = "golden " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("gold", "classic", 0);
                        break;
                    case 14:
                        item.Name = "copper " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("copper", "classic", 0);
                        break;
                    case 15:
                        item.Name = "bronze " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("bronze", "classic", 0);
                        break;
                    case 16:
                        item.Name = "agapite " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("agapite", "classic", 0);
                        break;
                    case 17:
                        item.Name = "verite " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("verite", "classic", 0);
                        break;
                    case 18:
                        item.Name = "valorite " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("valorite", "classic", 0);
                        break;
                    case 19:
                        item.Name = "steel " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("steel", "classic", 0);
                        break;
                    case 20:
                        item.Name = "brass " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("brass", "classic", 0);
                        break;
                    case 21:
                        item.Name = "mithril " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("mithril", "classic", 0);
                        break;
                    case 22:
                        item.Name = "nepturite " + suffix;
                        item.Hue = MaterialInfo.GetMaterialColor("nepturite", "classic", 0);
                        break;
                }
            }
        ...
        public static bool CheckNecro(Mobile from)
        {
            ...
            if (
                from.Region.IsPartOf("the Undercity of Umbra")
                || from.Region.IsPartOf("the Black Magic Guild")
                || from.Region.IsPartOf("the Island of Dracula")
                || from.Region.IsPartOf("the Village of Ravendark")
                || from.Region.IsPartOf("Ravendark Woods")
            )
                return true;
        ...
        public static void TurnToUndead(Mobile from)
        {
            ...
            else if (Utility.RandomMinMax(1, 10) == 1 && from is BaseVendor)
            {
                ...
                )
                {
                    ...
                    Server.Items.NPCRace.CreateRace(
                        from,
                        Utility.RandomList(1031, 125, 724, 24, 110),
                        0
                    );
                    if (((BaseCreature)from).RangeHome < 1)
                    {
                        ((BaseCreature)from).RangeHome = 2;
                    }
                }
                ...
                else if (Utility.RandomMinMax(1, 20) == 1)
                {
                    ...
                    Server.Items.NPCRace.CreateRace(
                        from,
                        Utility.RandomList(124, 181, 307, 728, 50),
                        0
                    );
                    if (((BaseCreature)from).RangeHome < 1)
                    {
        ...
        public static void TurnToRavendark(Mobile from)
        {
            ...
            {
                case 0:
                    from.AddItem(new NecromancerRobe(color));
                    break;
                case 1:
                    from.AddItem(new AssassinRobe(color));
                    break;
                case 2:
                    from.AddItem(new MagistrateRobe(color));
                    break;
                case 3:
                    from.AddItem(new OrnateRobe(color));
                    break;
                case 4:
                    from.AddItem(new SorcererRobe(color));
                    break;
                case 5:
                    from.AddItem(new SpiderRobe(color));
                    break;
                case 6:
                    from.AddItem(new VagabondRobe(color));
                    break;
            }
            ...
            {
                case 0:
                    from.AddItem(new ClothHood(color));
                    break;
                case 1:
                    from.AddItem(new ClothCowl(color));
                    break;
                case 2:
                    from.AddItem(new FancyHood(color));
                    break;
                case 3:
                    from.AddItem(new WizardHood(color));
                    break;
                case 4:
                    from.AddItem(new HoodedMantle(color));
                    break;
            }
        ...
        public static void TurnToBarbarian(Mobile from)
        {
            ...
            for (int i = 0; i < from.Items.Count; ++i)
            {
                ...
                if (item is Hair || item is Beard)
                {
                    ...
                    ((item is BasePants) || (item is BaseOuterLegs)) && (!(from is TownGuards))
                )
                {
                    item.Delete();
        ...
        public static void TurnToPirate(Mobile from)
        {
            ...
            {
                case 1:
                    from.AddItem(new SkullCap(Utility.RandomYellowHue()));
                    break;
                case 2:
                    from.AddItem(new TricorneHat(Utility.RandomYellowHue()));
                    break;
                case 3:
                    from.AddItem(new PirateHat(Utility.RandomYellowHue()));
                    break;
            }
        }
        ...
        public static void TurnToGargoyle(Mobile from)
        {
            ...
            else
            {
                switch (Utility.RandomMinMax(1, 6))
                {
                    case 1:
                        from.Name = NameList.RandomName("imp");
                        Server.Items.NPCRace.CreateRace(from, 359, 0);
                        break;
                    case 2:
                        from.Name = NameList.RandomName("imp");
                        Server.Items.NPCRace.CreateRace(from, 202, 0);
                        break;
                    case 3:
                        from.Name = NameList.RandomName("gargoyle vendor");
                        Server.Items.NPCRace.CreateRace(from, 4, 0);
                        break;
                    case 4:
                        from.Name = NameList.RandomName("gargoyle vendor");
                        Server.Items.NPCRace.CreateRace(from, 257, 0);
                        break;
                    case 5:
                    ...
                    case 6:
                        from.Name = NameList.RandomName("gargoyle name");
                        Server.Items.NPCRace.CreateRace(from, 158, 0);
                        break;
                }
            }
        }
    ...
    public class HueGear
    {
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(HueGears)
            );
        }
        ...
        public static void HueGears(CommandEventArgs arg)
        {
            ...
            else
            {
                ...
                if (m.FindItemOnLayer(Layer.OuterTorso) != null)
                {
                    m.FindItemOnLayer(Layer.OuterTorso).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.MiddleTorso) != null)
                {
                    m.FindItemOnLayer(Layer.MiddleTorso).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.OneHanded) != null)
                {
                    m.FindItemOnLayer(Layer.OneHanded).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.TwoHanded) != null)
                {
                    m.FindItemOnLayer(Layer.TwoHanded).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Bracelet) != null)
                {
                    m.FindItemOnLayer(Layer.Bracelet).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Ring) != null)
                {
                    m.FindItemOnLayer(Layer.Ring).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Helm) != null)
                {
                    m.FindItemOnLayer(Layer.Helm).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Arms) != null)
                {
                    m.FindItemOnLayer(Layer.Arms).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.OuterLegs) != null)
                {
                    m.FindItemOnLayer(Layer.OuterLegs).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Neck) != null)
                {
                    m.FindItemOnLayer(Layer.Neck).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Gloves) != null)
                {
                    m.FindItemOnLayer(Layer.Gloves).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Talisman) != null)
                {
                    m.FindItemOnLayer(Layer.Talisman).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Shoes) != null)
                {
                    m.FindItemOnLayer(Layer.Shoes).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Cloak) != null)
                {
                    m.FindItemOnLayer(Layer.Cloak).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.FirstValid) != null)
                {
                    m.FindItemOnLayer(Layer.FirstValid).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Waist) != null)
                {
                    m.FindItemOnLayer(Layer.Waist).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.InnerLegs) != null)
                {
                    m.FindItemOnLayer(Layer.InnerLegs).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.InnerTorso) != null)
                {
                    m.FindItemOnLayer(Layer.InnerTorso).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Pants) != null)
                {
                    m.FindItemOnLayer(Layer.Pants).Hue = hue;
                }
                if (m.FindItemOnLayer(Layer.Shirt) != null)
                {
                    m.FindItemOnLayer(Layer.Shirt).Hue = hue;
                }
            }
        }
    }
