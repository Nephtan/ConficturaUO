    ...
    public class NameVerification
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(ValidateName_OnCommand)
            );
        }
...
namespace Server.Items
{
    ...
    public class CensusRecords : Item
    {
        ...
        public CensusRecords(Serial serial)
            : base(serial) { }
...
namespace Server.Gumps
{
    ...
    {
        public CensusGump(Mobile from, bool legal)
            : base(50, 50)
        {
            from.SendSound(0x4A);
            string color = "#b7765d";
            ...
            string text =
                "These are the census records for the many lands, and the sages have compiled a list of names of its citizens. Your name is on this list as well. If you want to change your name, you can do it within this book.";

            if (!legal)
            {
                text =
                    "These are the forged census records for the many lands, and the thieves guild has compiled a list of names of its citizens. Your name is on this list as well. If you want to change your name, you can do it within this book.";
            }
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    ...
                    + ">"
                    + text
                    + " So if you have an idea for a new fantasy appropriate name, and are willing to spend 2,000 gold, then delete the text below and retype it. A new name can be no longer than 16 characters.</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            else if (name != "" && info.ButtonID == 1)
            {
                ...
                )
                {
                    ...
                    CharacterCreation.CheckDupe(from, name) && pack.ConsumeTotal(typeof(Gold), 2000)
                )
                {
                    ...
                    CharacterCreation.CheckDupe(from, name)
                    && !(pack.ConsumeTotal(typeof(Gold), 2000))
                )
                {
...
namespace Server.Gumps
{
    ...
    {
        public CustomTitleGump(Mobile from)
            : base(50, 50)
        {
            this.Closable = true;
            this.Disposable = true;
            ...
            string text =
                "The world will know you as the title of your best skill, or if you specify a skill you want to be known for in your title. You can, however, choose a unique title of your own. Here you can create a title, or if you already set a custom title, you can remove or change it.";
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    ...
                    + ">"
                    + text
                    + " So if you have an idea for a unique character title, then delete the text below and retype it. A new title can be no longer than 25 characters.</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (name == "Type here...") { }
                ...
                || name.Contains("Journeyman ")
                || name.Contains("Apprentice ")
                || name.Contains("Novice ")
                || name.Contains("Neophyte ")
            )
            {
...
namespace Server.Gumps
{
    ...
    {
        public NameAlterGump(Mobile from)
            : base(50, 50)
        {
            from.SendSound(0x4A);
            this.Closable = true;
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">A fantasy world is best served with a unique fantasy name for your character. If you are reconsidering a different name, now is the time to enter the name you want to be known by in the gypsy's journal. All names must be unique to other adventurers, so choose wisely. If you feel your name is appropriate, then close this book. Otherwise, remove the text below and enter a new name for yourself that is no longer than 16 characters.</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddTextEntry(48, 237, 200, 20, 0x481, 1, @"Type here...", 16);
...
namespace Server.Gumps
{
    ...
    {
        public NameChangeGump(Mobile from)
            : base(50, 50)
        {
            Closable = false;
            Disposable = false;
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">The name you've chosen is currently in use and is no longer available. You must choose a different name before you're able to continue. So delete the text below and enter a new fantasy appropriate name.</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddTextEntry(48, 237, 200, 20, 0x481, 1, @"Type here...", 16);
...
namespace Server.Items
{
    ...
    public class ChangeName : Item
    {
        ...
        public ChangeName(Serial serial)
            : base(serial) { }
