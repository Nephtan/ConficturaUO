    ...
    public class LightCycle
    {
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register(
                ...
                new CommandEventHandler(Light_OnCommand)
            );
        }
        ...
        private static void Light_OnCommand(CommandEventArgs e)
        {
            if (e.Length >= 1)
            {
                ...
                e.Mobile.SendMessage(
                    "Global light level override has been changed to {0}.",
                    m_LevelOverride
                );
            }
            else
        ...
        public static int ComputeLevelFor(Mobile from)
        {
            ...
            if (hours < 8)
                return NightLevel
                    + (((((hours - 6) * 60) + minutes) * (DayLevel - NightLevel)) / 120);
            ...
            if (hours < 20)
                return DayLevel
                    + (((((hours - 18) * 60) + minutes) * (NightLevel - DayLevel)) / 120);
