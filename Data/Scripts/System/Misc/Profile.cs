...
namespace Server.Misc
{
    public class Profile
    {
        public static void Initialize()
        {
            ...
            EventSink.ChangeProfileRequest += new ChangeProfileRequestEventHandler(
                EventSink_ChangeProfileRequest
            );
        }
        ...
        public static void EventSink_ProfileRequest(ProfileRequestEventArgs e)
        {
            ...
            if (
                ...
                || !beholder.InRange(beheld, 12)
                || !beholder.CanSee(beheld)
            )
                return;
            ...
            beholder.Send(
                new DisplayProfile(
                    beholder != beheld || !beheld.ProfileLocked,
                    beheld,
                    header,
                    body,
                    footer
