    ...
    public class OptionsGumps
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(OptionsGumps1_OnCommand)
            );
            CommandSystem.Register(
                "GumpSaveCoordinate",
                AccessLevel.Administrator,
                new CommandEventHandler(OptionsGumps2_OnCommand)
            );
            CommandSystem.Register(
                "GumpRemoveID",
                AccessLevel.Administrator,
                new CommandEventHandler(OptionsGumps3_OnCommand)
            );
            CommandSystem.Register(
                "GumpRemoveCoordinate",
                AccessLevel.Administrator,
                new CommandEventHandler(OptionsGumps4_OnCommand)
            );
            CommandSystem.Register(
                "GumpRemoveRegion",
                AccessLevel.Administrator,
                new CommandEventHandler(OptionsGumps5_OnCommand)
            );
        }
...
namespace Server.Gumps
{
    public class GumpSaveRegion : Gump
    {
        ...
        public GumpSaveRegion(CommandEventArgs e)
            : base(50, 50)
        {
            ...
            AddHtml(
                ...
                200,
                110,
                "This will SAVE the spawners, in a specified region, to Data/Spawns/'region name'.map. Type [where if you don't know the region you are. Copy to the text box the name of the region. You also can open Data/Regions.xml to a full list of regions.<BR>Example: you type [where and appear 'your region is town of Britain'. Type 'Britain' in text box.",
                true,
                true
            );
        }
                ...
                case 101:
                {
                    ...
                    if (sRegion != "")
                    {
                        ...
                        CommandSystem.Handle(
                            from,
                            String.Format("{0}Spawngen save {1}", prefix, sRegion)
                        );
                    }
                    else
                    {
    ...
    public class GumpRemoveRegion : Gump
    {
        ...
        public GumpRemoveRegion(CommandEventArgs e)
            : base(50, 50)
        {
            m_CommandEventArgs = e;
            Closable = true;
            ...
            AddHtml(
                ...
                200,
                110,
                "This will REMOVE the spawners, in a specified region. Type [where if you don't know the region you are. Copy to the text box the name of the region. You also can open Data/Regions.xml to a full list of regions.<BR>Example: you type [where and appear 'your region is town of Britain'. Type 'Britain' in text box.",
                true,
                true
            );
        }
            ...
            switch (info.ButtonID)
            {
                ...
                case 101:
                {
                    ...
                    if (sRegion != "")
                    {
                        ...
                        CommandSystem.Handle(
                            from,
                            String.Format("{0}Spawngen remove {1}", prefix, sRegion)
                        );
                    }
                    else
                    {
    ...
    public class GumpRemoveID : Gump
    {
        ...
        public GumpRemoveID(CommandEventArgs e)
            : base(50, 50)
        {
            m_CommandEventArgs = e;
            Closable = true;
            ...
            AddHtml(
                ...
                200,
                110,
                "This command was made to UNLOAD your own custom maps. This will REMOVE the spawners with the specified ID. Type '[get spawnid' in a spawner to know your ID. Remember: 'By Hand' spawns, i.e., those done with '[add premiumspawner' have ID = 1.",
                true,
                true
            );
        }
                ...
                case 101:
                {
                    ...
                    if (sID != "")
                    {
                        try
                        {
                            ...
                            CommandSystem.Handle(
                                from,
                                String.Format("{0}Spawngen unload {1}", prefix, UnloadID)
                            );
                        }
                        catch
                        {
    ...
    public class GumpSaveCoordinate : Gump
    {
        ...
        public GumpSaveCoordinate(CommandEventArgs e)
            : base(50, 50)
        {
            m_CommandEventArgs = e;
            Closable = true;
                ...
                case 101:
                {
                    ...
                    if (sX1 != "" && sY1 != "" && sX2 != "" && sY2 != "")
                    {
                        ...
                        catch
                        {
                            ...
                            CommandSystem.Handle(
                                from,
                                String.Format("{0}GumpSaveCoordinate", prefix)
                            );
                        }
                    }
                    else
    ...
    public class GumpRemoveCoordinate : Gump
    {
        ...
        public GumpRemoveCoordinate(CommandEventArgs e)
            : base(50, 50)
        {
            m_CommandEventArgs = e;
            Closable = true;
            ...
            AddHtml(
                ...
                200,
                110,
                "This will REMOVE spawners inside specified coordinates. You can use [where in the first point and again [where in the second point to get the X and Y coordinates. You need 2: X1, Y1 for first point and X2, Y2 for the second point. The objective is determine a 'box'. This command will remove all spawners inside this box.",
                true,
                true
            );
        }
                ...
                case 101:
                {
                    ...
                    if (sX1 != "" && sY1 != "" && sX2 != "" && sY2 != "")
                    {
                        ...
                        catch
                        {
                            ...
                            CommandSystem.Handle(
                                from,
                                String.Format("{0}GumpRemoveCoordinate", prefix)
                            );
                        }
                    }
                    else
...
namespace Server.Mobiles
{
    public class PremiumSpawner : Item
    {
        ...
        public PremiumSpawner(
            ...
            int walkingRange,
            string creatureName,
            string creatureNameA,
            string creatureNameB,
            string creatureNameC,
            string creatureNameD,
            string creatureNameE
        )
            : base(0x6519)
        {
            List<string> creaturesName = new List<string>();
        ...
        public PremiumSpawner(
            ...
            int homeRange,
            int walkingRange,
            List<string> creaturesName,
            List<string> creatureNameAA,
            List<string> creatureNameBB,
            List<string> creatureNameCC,
            List<string> creatureNameDD,
            List<string> creatureNameEE
        )
            : base(0x6519)
        {
            InitSpawn(
            ...
            if (m_Running)
            {
                ...
                for (int i = 0; i < 2 && i < m_CreaturesName.Count; ++i)
                    list.Add(
                        ...
                        "{0}\t{1}",
                        m_CreaturesName[i],
                        CountCreatures(m_CreaturesName[i])
                    );
            }
            else
            {
        ...
        public void Start()
        {
            ...
            {
                if (
                    m_CreaturesName.Count > 0
                    || m_CreaturesNameA.Count > 0
                    || m_CreaturesNameB.Count > 0
                    || m_CreaturesNameC.Count > 0
                    || m_CreaturesNameD.Count > 0
                    || m_CreaturesNameE.Count > 0
                )
                {
                    m_Running = true;
                    DoTimer();
        ...
        public void OnTick()
        {
            ...
            if (m_Group)
            {
                ...
                if (
                    m_Creatures.Count == 0
                    || m_CreaturesA.Count == 0
                    || m_CreaturesB.Count == 0
                    || m_CreaturesC.Count == 0
                    || m_CreaturesD.Count == 0
                    || m_CreaturesE.Count == 0
                )
                {
                    Respawn();
                }
        ...
        public static void SpreadOut(Mobile m)
        {
            ...
            )
            {
                ...
                {
                    cleanUp = true;
                    m.Location = Worlds.GetRandomLocation("the Land of Lodoria", "land");
                    m.WhisperHue = 911;
                }
                else if (m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Sosaria)
                {
                    cleanUp = true;
                    m.Location = Worlds.GetRandomLocation("the Land of Sosaria", "land");
                    m.WhisperHue = 911;
                }
                else if (m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.SerpentIsland)
                {
                    cleanUp = true;
                    m.Location = Worlds.GetRandomLocation("the Serpent Island", "land");
                    m.WhisperHue = 911;
                }
                else if (m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.IslesDread)
                {
                    cleanUp = true;
                    m.Location = Worlds.GetRandomLocation("the Isles of Dread", "land");
                    m.WhisperHue = 911;
                }
                else if (
                    m.X >= 1125
                ...
                {
                    cleanUp = true;
                    m.Location = Worlds.GetRandomLocation("the Savaged Empire", "land");
                    m.WhisperHue = 911;
                }
                else if (
                    m.X >= 5457
                ...
                {
                    cleanUp = true;
                    m.Location = Worlds.GetRandomLocation("the Land of Ambrosia", "land");
                    m.WhisperHue = 911;
                }
                else if (
                    m.X >= 608
                ...
                {
                    cleanUp = true;
                    m.Location = Worlds.GetRandomLocation("the Island of Umber Veil", "land");
                    m.WhisperHue = 911;
                }
                else if (
                    m.X >= 6126
                ...
                {
                    cleanUp = true;
                    m.Location = Worlds.GetRandomLocation("the Bottle World of Kuldar", "land");
                    m.WhisperHue = 911;
                }
                else if (m.X == 4 && m.Y == 4 && m.Map == Map.Underworld)
                {
                    cleanUp = true;
                    m.Location = Worlds.GetRandomLocation("the Underworld", "land");
                    m.WhisperHue = 911;
                }

                if (cleanUp && startLoc == m.Location)
                {
                    m.Delete();
                }
            }
            else
            {
                ...
                if (m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Lodor)
                {
                    m.Location = Worlds.GetRandomLocation("the Land of Lodoria", "sea");
                    m.WhisperHue = 999;
                }
                else if (m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Sosaria)
                {
                    m.Location = Worlds.GetRandomLocation("the Land of Sosaria", "sea");
                    m.WhisperHue = 999;
                }
                else if (m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.SerpentIsland)
                {
                    m.Location = Worlds.GetRandomLocation("the Serpent Island", "sea");
                    m.WhisperHue = 999;
                }
                else if (m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.IslesDread)
                {
                    m.Location = Worlds.GetRandomLocation("the Isles of Dread", "sea");
                    m.WhisperHue = 999;
                }
                else if (
                    m.X >= 1125
                ...
                {
                    m.Location = Worlds.GetRandomLocation("the Savaged Empire", "sea");
                    m.WhisperHue = 999;
                }
                else if (
                    m.X >= 5457
                ...
                {
                    m.Location = Worlds.GetRandomLocation("the Underworld", "sea");
                    m.WhisperHue = 999;
                }
                else if (m.X == 4 && m.Y == 4 && m.Map == Map.Underworld)
                {
            ...
            if (props != null)
            {
                ...
                for (int i = 0; i < realProps.Length; ++i)
                {
                    ...
                    if (thisProp != null)
                    {
                        ...
                        if (
                            attr != null
                            && AccessLevel.GameMaster >= attr.WriteLevel
                            && thisProp.CanWrite
                            && !attr.ReadOnly
                        )
                ...
                if (args.Length == paramList.Length)
                {
                    ...
                    if (built != null && realProps != null)
                    {
                        for (int j = 0; j < realProps.Length; ++j)
                        {
                            ...
                            string result = Properties.InternalSetValue(
                                built,
                                realProps[j],
                                props[j, 1]
                            );
        ...
        public void Spawn(int index)
        {
            ...
            if (
                map == null
                || map == Map.Internal
                || CreaturesNameCount == 0
                || index >= CreaturesNameCount
                || Parent != null
            )
                return;
            ...
            if (ent is Mobile)
            {
                ...
                if (!MyServerSettings.Scary() && SpawnID == 8888)
                {
                    ...
                    else if (m is AncientEnt)
                    {
                        m.Delete();
                        m = new Ent();
                    }
                    else if (m is AsianDragon)
                    {
                        if (Utility.RandomBool())
                        {
                            m = new Pixie();
        ...
        public void SpawnA(int index)
        {
            ...
            if (
                map == null
                || map == Map.Internal
                || CreaturesNameCountA == 0
                || index >= CreaturesNameCountA
                || Parent != null
            )
                return;
        ...
        public void SpawnB(int index)
        {
            ...
            if (
                map == null
                || map == Map.Internal
                || CreaturesNameCountB == 0
                || index >= CreaturesNameCountB
                || Parent != null
            )
                return;
        ...
        public void SpawnC(int index)
        {
            ...
            if (
                map == null
                || map == Map.Internal
                || CreaturesNameCountC == 0
                || index >= CreaturesNameCountC
                || Parent != null
            )
                return;
        ...
        public void SpawnD(int index)
        {
            ...
            if (
                map == null
                || map == Map.Internal
                || CreaturesNameCountD == 0
                || index >= CreaturesNameCountD
                || Parent != null
            )
                return;
        ...
        public void SpawnE(int index)
        {
            ...
            if (
                map == null
                || map == Map.Internal
                || CreaturesNameCountE == 0
                || index >= CreaturesNameCountE
                || Parent != null
            )
                return;
        ...
        public Point3D GetSpawnSpotLandDungeon()
        {
            ...
            return Server.Misc.Worlds.GetRandomLocation(
                Server.Misc.Worlds.GetMyWorld(Map, Location, X, Y),
                "land"
            );
        }
        ...
        private class WarnTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                {
                    Console.WriteLine(
                        "Warning: {0} bad spawns detected, logged: 'PremiumBadspawn.log'",
                        m_List.Count
                    );
    ...
    public class PSpawnerCount
    {
        public static void Initialize()
        {
            Register(
                "pscount",
                AccessLevel.Administrator,
                new CommandEventHandler(Clearall_OnCommand)
            );
        }
    ...
    public class RunUOSpawnerExporter
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                AccessLevel.Administrator,
                new CommandEventHandler(RunUOSpawnerExporter_OnCommand)
            );
            CommandSystem.Register(
                "RSE",
                AccessLevel.Administrator,
        ...
        public static void RunUOSpawnerExporter_OnCommand(CommandEventArgs e)
        {
            ...
            using (
                StreamWriter op = new StreamWriter(
                    String.Format(@".\Data\Spawns\{0}-exported.map", map)
                )
            )
            {
                ...
                foreach (Spawner spawner in list)
                {
                    ...
                    {
                        op.WriteLine(
                            "{0}||||||{1}|{2}|{3}|{4}|{5}|{6}|{7}|{8}|1|{9}|0|0|0|0|0",
                            towrite,
                            spawner.X,
                            spawner.Y,
                            spawner.Z,
                    ...
                    {
                        op.WriteLine(
                            "## Void: {0}||||||{1}|{2}|{3}|{4}|{5}|{6}|{7}|{8}|1|{9}|0|0|0|0|0",
                            towrite,
                            spawner.X,
                            spawner.Y,
                            spawner.Z,
                    ...
                    {
                        op.WriteLine(
                            "## Inactive: {0}||||||{1}|{2}|{3}|{4}|{5}|{6}|{7}|{8}|1|{9}|0|0|0|0|0",
                            towrite,
                            spawner.X,
                            spawner.Y,
                            spawner.Z,
                ...
                e.Mobile.SendMessage(
                    String.Format(
                        "You exported {0} RunUO Spawner{1} from this facet.",
                        list.Count,
                        list.Count == 1 ? "" : "s"
                    )
                );
    ...
    public class SpawnGenerator
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                "SpawnGen",
                AccessLevel.Administrator,
                new CommandEventHandler(SpawnGen_OnCommand)
            );
        }

        [Usage(
            "SpawnGen [<filename>]|[unload <id>]|[remove <region>|<rect>]|[save <region>|<rect>][savebyhand][cleanfacet]"
        )]
        ...
        private static void SpawnGen_OnCommand(CommandEventArgs e)
        {
            ...
            {
                e.Mobile.SendMessage(
                    "Usage: SpawnGen [<filename>]|[remove <region>|<rect>|<ID>]|[save <region>|<rect>|<ID>]"
                );
            }
        ...
        private static void Remove(Mobile from, string region)
        {
            ...
            if (region == null || region == "")
            {
                CommandSystem.Handle(
                    from,
                    String.Format("{0}Global remove where premiumspawner", prefix)
                );
            }
            else
            {
        ...
        private static void RemoveByCoord(Mobile from, int x1, int y1, int x2, int y2)
        {
            ...
            {
                if (
                    itemremove is PremiumSpawner
                    && (
                        (itemremove.X >= x1 && itemremove.X <= x2)
                        && (itemremove.Y >= y1 && itemremove.Y <= y2)
                        && itemremove.Map == from.Map
                    )
                )
                {
                    itemtodo.Add(itemremove);
        ...
        private static void GenericRemove(List<Item> colecao, int count, DateTime aTime)
        {
            ...
            else
            {
                ...
                World.Broadcast(
                    0x35,
                    true,
                    "{0} PremiumSpawners have been removed in {1:F1} seconds.",
                    count,
                    (bTime - aTime).TotalSeconds
                );
            }
        }
        ...
        private static void SaveByCoord(Mobile from, int x1, int y1, int x2, int y2)
        {
            ...
            {
                if (
                    itemsave is PremiumSpawner
                    && (
                        (itemsave.X >= x1 && itemsave.X <= x2)
                        && (itemsave.Y >= y1 && itemsave.Y <= y2)
                        && itemsave.Map == from.Map
                    )
                )
                {
                    itemtodo.Add(itemsave);
        ...
        private static void GenericSave(
            List<Item> colecao,
            string mapa,
            int count,
            DateTime startTime
        )
        {
            ...
            else
            {
                    ...
                    foreach (PremiumSpawner itemsave2 in itemssave)
                    {
                        ...
                        switch (itemsave2.Map.ToString())
                        {
                            ...
                            default:
                                mapnumber = 8;
                                Console.WriteLine(
                                    "Monster Parser: Warning, unknown map {0}",
                                    itemsave2.Map
                                );
                                break;
                        }
                        ...
                        int timer1c =
                            (Utility.ToInt32(timer1b[0]) * 60) + Utility.ToInt32(timer1b[1]); //multiply hh * 60 to find mm, then add mm
                        ...
                        int timer2c =
                            (Utility.ToInt32(timer2b[0]) * 60) + Utility.ToInt32(timer2b[1]);
                ...
                World.Broadcast(
                    0x35,
                    true,
                    "{0} spawns have been saved. The entire process took {1:F1} seconds.",
                    count,
        ...
        private static void MakeSpawner(
            string[] types,
            string[] fakespawnsA,
            string[] fakespawnsB,
            string[] fakespawnsC,
    ...
    public class SpawnEditorGump : Gump
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(SpawnEditor_OnCommand)
            );
            CommandSystem.Register(
                "Editor",
                AccessLevel.GameMaster,
        ...
        public static void SpawnEditor_OnCommand(
            Mobile from,
            int page,
        ...
        public static void FilterByRegion(
            Mobile from,
            ArrayList facetList,
            Region regr,
            Map regmap,
