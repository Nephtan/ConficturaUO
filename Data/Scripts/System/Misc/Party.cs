    ...
    public class Party : IParty
    {
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register(
                ...
                new CommandEventHandler(ListenToParty_OnCommand)
            );
        }
        ...
        public static void ListenToParty_OnCommand(CommandEventArgs e)
        {
            e.Mobile.BeginTarget(
                ...
                false,
                TargetFlags.None,
                new TargetCallback(ListenToParty_OnTarget)
            );
        ...
        public void SendToAll(Packet p)
        {
            ...
            if (
                p is MessageLocalized
                || p is MessageLocalizedAffix
                || p is UnicodeMessage
                || p is AsciiMessage
            )
            {
