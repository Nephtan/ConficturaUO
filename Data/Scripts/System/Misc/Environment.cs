...
namespace Server.Items
{
    public class ComputerBeeps : Item
    {
        ...
        public ComputerBeeps(Serial serial)
            : base(serial) { }
    ...
    public class ComputerConsole : Item
    {
        ...
        public ComputerConsole(Serial serial)
            : base(serial) { }
    ...
    public class LightningCracksFar : Item
    {
        ...
        public LightningCracksFar(Serial serial)
            : base(serial) { }
    ...
    public class LightningCracks : Item
    {
        ...
        public LightningCracks(Serial serial)
            : base(serial) { }
    ...
    public class SoundWindBlowing : Item
    {
        ...
        public SoundWindBlowing(Serial serial)
            : base(serial) { }
    ...
    public class Electrical : Item
    {
        ...
        public Electrical(Serial serial)
            : base(serial) { }
    ...
    public class RavendarkStorm : Item
    {
        ...
        public RavendarkStorm(Serial serial)
            : base(serial) { }
    ...
    public class ForestSounds : Item
    {
        ...
        public ForestSounds(Serial serial)
            : base(serial) { }
    ...
    public class ElementalSounds : Item
    {
        ...
        public ElementalSounds(Serial serial)
            : base(serial) { }
