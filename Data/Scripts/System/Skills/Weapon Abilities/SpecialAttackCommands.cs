    ...
    public class SpecialAttackCommands
    {
        public static void Initialize()
        {
            CommandSystem.Register(
                "SetPrimaryAbility",
                AccessLevel.Player,
                new CommandEventHandler(SetPrimaryAbility_OnCommand)
            );
            CommandSystem.Register(
                "SetSecondaryAbility",
                AccessLevel.Player,
                new CommandEventHandler(SetSecondaryAbility_OnCommand)
            );
            CommandSystem.Register(
                "SetThirdAbility",
                AccessLevel.Player,
                new CommandEventHandler(SetThirdAbility_OnCommand)
            );
            CommandSystem.Register(
                "SetFourthAbility",
                AccessLevel.Player,
                new CommandEventHandler(SetFourthAbility_OnCommand)
            );
            CommandSystem.Register(
                "SetFifthAbility",
                AccessLevel.Player,
                new CommandEventHandler(SetFifthAbility_OnCommand)
            );
            CommandSystem.Register(
                "Set1",
                AccessLevel.Player,
