    ...
    public static class CustomWeaponAbilities
    {
        ...
        private static int HasAbilities(BaseWeapon weapon, Mobile from)
        {
            ...
            if (weapon.PrimaryAbility != null)
            {
                if (
                    (
                        from.Skills[weapon.DefSkill].Value >= sk1
                        || from.Skills[weapon.GetUsedSkill(from, true)].Value >= sk1
                    ) && (from.Skills[SkillName.Tactics].Value >= sk1)
                )
                {
                    number++;
                }
            ...
            if (weapon.SecondaryAbility != null)
            {
                if (
                    (
                        from.Skills[weapon.DefSkill].Value >= sk2
                        || from.Skills[weapon.GetUsedSkill(from, true)].Value >= sk2
                    ) && (from.Skills[SkillName.Tactics].Value >= sk2)
                )
                {
                    number++;
                }
            ...
            if (weapon.ThirdAbility != null)
            {
                if (
                    (
                        from.Skills[weapon.DefSkill].Value >= sk3
                        || from.Skills[weapon.GetUsedSkill(from, true)].Value >= sk3
                    ) && (from.Skills[SkillName.Tactics].Value >= sk3)
                )
                {
                    number++;
                }
            ...
            if (weapon.FourthAbility != null)
            {
                if (
                    (
                        from.Skills[weapon.DefSkill].Value >= sk4
                        || from.Skills[weapon.GetUsedSkill(from, true)].Value >= sk4
                    ) && (from.Skills[SkillName.Tactics].Value >= sk4)
                )
                {
                    number++;
                }
            ...
            if (weapon.FifthAbility != null)
            {
                if (
                    (
                        from.Skills[weapon.DefSkill].Value >= sk5
                        || from.Skills[weapon.GetUsedSkill(from, true)].Value >= sk5
                    ) && (from.Skills[SkillName.Tactics].Value >= sk5)
                )
                {
                    number++;
                }
