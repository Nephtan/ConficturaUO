...
namespace Server.Items
{
    public class Bladeweave : WeaponAbility
    {
        ...
        private static Dictionary<Mobile, BladeWeaveRedirect> m_NewAttack =
            new Dictionary<Mobile, BladeWeaveRedirect>();
        ...
        public override bool OnBeforeSwing(Mobile attacker, Mobile defender)
        {
            ...
            {
                case 0:
                    m_NewAttack[attacker] = new BladeWeaveRedirect(
            ...
            return ((BladeWeaveRedirect)m_NewAttack[attacker]).NewAbility.OnBeforeSwing(
                attacker,
                defender,
                false
            );
