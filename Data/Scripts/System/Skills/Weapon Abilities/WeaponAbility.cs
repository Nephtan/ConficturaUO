    ...
    public abstract class WeaponAbility
    {
        ...
        public virtual double GetRequiredSkill(Mobile from)
        {
            ...
            if (weapon != null && weapon.PrimaryAbility == this)
                return Server.Misc.MyServerSettings.SpecialWeaponAbilSkill();
            else if (weapon != null && weapon.SecondaryAbility == this)
                return Server.Misc.MyServerSettings.SpecialWeaponAbilSkill() + 10;
            else if (weapon != null && weapon.SecondaryAbility == Bladeweave)
                return Server.Misc.MyServerSettings.SpecialWeaponAbilSkill() + 10;
            else if (weapon != null && weapon.ThirdAbility == this)
                return Server.Misc.MyServerSettings.SpecialWeaponAbilSkill() + 20;
        ...
        public virtual int CalculateMana(Mobile from)
        {
            ...
            double skillTotal =
                ...
                + GetSkill(from, SkillName.FistFighting)
        ...
        public virtual bool CheckWeaponSkill(Mobile from)
        {
            ...
            if (
                ...
                && (
                    from.Skills[SkillName.Swords].Value >= reqSkill
                    || from.Skills[SkillName.Bludgeoning].Value >= reqSkill
                    || from.Skills[SkillName.Fencing].Value >= reqSkill
                )
            )
                return true;
            /* </UBWS> */
        ...
        public virtual bool Validate(Mobile from)
        {
            ...
            if (
                Spells.Bushido.HonorableExecution.IsUnderPenalty(from)
                || Spells.Ninjitsu.AnimalForm.UnderTransformation(from)
            )
            {
        ...
        public static bool IsWeaponAbility(Mobile m, WeaponAbility a)
        {
            ...
            return (
                weapon != null
                && (
                    weapon.PrimaryAbility == a
                    || weapon.SecondaryAbility == a
                    || weapon.ThirdAbility == a
                    || weapon.FourthAbility == a
                    || weapon.FifthAbility == a
                )
            ); // DJEYV
        }
