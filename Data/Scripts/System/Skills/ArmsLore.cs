    ...
    public class ArmsLore
    {
        ...
        public static void IDItem(Mobile from, Item examine, object targeted, bool automatic)
        {
            ...
            else if (targeted is UnidentifiedItem)
            {
                ...
                else if (from.CheckTargetSkill(SkillName.ArmsLore, targeted, -5, 125) || automatic)
                {
            ...
            else if (targeted is BaseWeapon)
            {
                ...
                else if (from.CheckTargetSkill(SkillName.ArmsLore, targeted, 0, 125))
                {
            ...
            else if (targeted is BaseArmor)
            {
                ...
                else if (from.CheckTargetSkill(SkillName.ArmsLore, targeted, 0, 125))
                {
                    ...
                    from.SendLocalizedMessage(
                        1038295 + (int)Math.Ceiling(Math.Min(arm.ArmorRating, 35) / 5.0)
                    );
                    /*
            ...
            else if (targeted is SwampDragon && ((SwampDragon)targeted).HasBarding)
            {
                ...
                if (from.CheckTargetSkill(SkillName.ArmsLore, targeted, 0, 125))
                {
