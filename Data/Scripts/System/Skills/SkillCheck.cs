    ...
    public class SkillCheck
    {
        ...
        )
        {
            ...
            Point2D loc = new Point2D(
                from.Location.X / LocationSize,
                from.Location.Y / LocationSize
            );
        ...
        public static bool CheckSkill(Mobile from, Skill skill, object amObj, double chance)
        {
            ...
            if (
                from.Alive
                && (
                    (gc >= Utility.RandomDouble() && AllowGain(from, skill, amObj))
                    || skill.Base < 10.0
                )
            )
            {
                ...
                {
                    from.SendMessage(
                        "You would get better at seafaring if you fished from a boat."
                    );
                }
                else
                {
        ...
        public static bool IsGuildSkill(Mobile from, SkillName skillName)
        {
            ...
            else if (pm.NpcGuild == NpcGuild.ElementalGuild)
            {
                ...
                else if (skillName == SkillName.Elementalism)
                {
                    return true;
                }
                else if (skillName == SkillName.Meditation)
            ...
            else if (pm.NpcGuild == NpcGuild.WarriorsGuild)
            {
                ...
                else if (skillName == SkillName.Bludgeoning)
                {
                    return true;
                }
            ...
            {
                if (skillName == SkillName.Mercantile)
                {
                    return true;
                }
                ...
                else if (skillName == SkillName.Tasting)
                {
                    return true;
                }
            }
            ...
            {
                if (skillName == SkillName.Seafaring)
                {
                    return true;
                }
            }
            ...
            else if (pm.NpcGuild == NpcGuild.NecromancersGuild)
            {
                ...
                else if (skillName == SkillName.Spiritualism)
                {
                    return true;
                }
            }
            ...
            {
                if (skillName == SkillName.Druidism)
                {
                    return true;
                }
                else if (skillName == SkillName.Taming)
                {
                    return true;
                }
            ...
            {
                if (skillName == SkillName.Marksmanship)
                {
                    return true;
                }
                else if (skillName == SkillName.Bowcraft)
                {
                    return true;
                }
                else if (skillName == SkillName.Tactics)
        ...
        public static void Gain(Mobile from, Skill skill)
        {
            ...
            if (skill.Base < skill.Cap && skill.Lock == SkillLock.Up)
            {
                ...
                if (from is PlayerMobile)
                    if (
                        pm != null
                        && skill.SkillName == pm.AcceleratedSkill
        ...
        public static bool CanRaise(Mobile from, Stat stat)
        {
            ...
            if (from.StatCap > 250)
            {
                ...
                {
                    case Stat.Str:
                        return (from.StrLock == StatLockType.Up && from.RawStr < 175);
                    case Stat.Dex:
                        return (from.DexLock == StatLockType.Up && from.RawDex < 175);
                    case Stat.Int:
                        return (from.IntLock == StatLockType.Up && from.RawInt < 175);
                }
            }
            else
            {
                ...
                {
                    case Stat.Str:
                        return (from.StrLock == StatLockType.Up && from.RawStr < 150);
                    case Stat.Dex:
                        return (from.DexLock == StatLockType.Up && from.RawDex < 150);
                    case Stat.Int:
                        return (from.IntLock == StatLockType.Up && from.RawInt < 150);
                }
            }
