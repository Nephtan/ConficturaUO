            ...
            private Item TryStealItem(Item toSteal, ref bool caught)
            {
                ...
                if (toSteal is DungeonChest)
                {
                    ...
                    if (m_Thief.Blessed)
                    {
                        ...
                        || dBox.ItemID == 0x35AD
                        || dBox.ItemID == 0x3868
                        || (dBox.ItemID >= 0x4B5A && dBox.ItemID <= 0x4BAB)
                        || (dBox.ItemID >= 0xECA && dBox.ItemID <= 0xED2)
                    )
                    {
                    ...
                    else
                    {
                        ...
                        {
                            m_Thief.SendMessage(
                                "You dump out the entire contents while stealing the item."
                            );
                ...
                {
                    m_Thief.SendMessage(
                        "You cannot be wielding a weapon when trying to steal something."
                    );
                }
                else if (
                    root is Mobile
                ...
                else if (toSteal is Coffer)
                {
                    ...
                    if (m_Thief.Backpack.FindItemByType(typeof(ThiefNote)) != null)
                    {
                        ...
                        if (envelope.NoteOwner == m_Thief)
                        {
                            if (
                                ...
                                && envelope.NoteItemCategory == coffer.CofferType
                            )
                            {
                                envelope.NoteItemGot = 1;
                                m_Thief.LocalOverheadMessage(
                                    MessageType.Emote,
                                    1150,
                                    true,
                    ...
                    if (Pilfer)
                    {
                        ...
                        {
                            m_Thief.SendMessage(
                                "You slip out " + coffer.CofferGold + " gold from the coffer."
                            );
                            ...
                            coffer.CofferRobber =
                                m_Thief.Name
                                + " the "
                                + Server.Misc.GetPlayerInfo.GetSkillTitle(m_Thief);
                            coffer.CofferGold = 0;
                ...
                else if (!m_Thief.CanSee(toSteal))
                {
                    ...
                    m_Thief.Backpack == null
                    || !m_Thief.Backpack.CheckHold(m_Thief, toSteal, false, true)
                )
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            int maxAmount = (int)(
                                (m_Thief.Skills[SkillName.Stealing].Value / 10.0) / toSteal.Weight
                            );
