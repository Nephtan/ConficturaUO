...
namespace Server.SkillHandlers
{
        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else if (targeted is BaseCreature)
                {
                    ...
                    if (
                        targeted is RidingDragon
                        || targeted is Daemonic
                        || targeted is DrakkhenRed
                        || targeted is DrakkhenBlack
                        || targeted is SkeletonDragon
                    ...
                    if (!c.IsDeadPet)
                    {
                        ...
                        )
                        {
                            if (c.ControlMaster == from)
                            {
                                ...
                                (!c.Controlled || !c.Tamable)
                                && from.Skills[SkillName.Druidism].Value < 100.0
                            )
                            {
    ...
    public class DruidismGump : Gump
    {
        ...
        public DruidismGump(Mobile from, BaseCreature c, int source)
            : base(50, 50)
        {
            this.Closable = true;
            ...
            if (source == 0 && c.MinTameSkill > 0)
            {
                ...
                switch (loyal)
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        loyalty = "Extremely Unhappy";
                        break;
                    case 3:
                        loyalty = "Rather Unhappy";
                        break;
                    case 4:
                        loyalty = "Unhappy";
                        break;
                    case 5:
                        loyalty = "Somewhat Content";
                        break;
                    case 6:
                        loyalty = "Content";
                        break;
                    case 7:
                        ...
                        break;
                    case 8:
                        loyalty = "Rather Happy";
                        break;
                    case 9:
                        loyalty = "Very Happy";
                        break;
                    case 10:
                        loyalty = "Extremely Happy";
                        break;
                    case 11:
                        loyalty = "Wonderfully Happy";
                        break;
                    case 12:
                        loyalty = "Euphoric";
                        break;
            ...
            colF =
                colF + "<BR> <BR> <BR>" + FormatTalent(c.Skills[SkillName.Magery].Value) + "<BR>";
