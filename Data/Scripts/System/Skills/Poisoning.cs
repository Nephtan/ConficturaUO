            ...
            private class InternalTarget : Target
            {
                ...
                protected override void OnTarget(Mobile from, object targeted)
                {
                    ...
                    if (targeted is FukiyaDarts || targeted is Shuriken)
                    {
                        ...
                        targeted is Food
                        || targeted is BaseBeverage
                        || targeted is FoodStaleBread
                        || targeted is Waterskin
                        || targeted is DirtyWaterskin
                        || targeted is FoodDriedBeef
                    )
                    {
                        startTimer = true;
                    }
                    else if (targeted is BaseWeapon)
                    {
                        ...
                        {
                            startTimer = (
                                weapon.PrimaryAbility == WeaponAbility.InfectiousStrike
                        ...
                        else if (weapon.Layer == Layer.OneHanded)
                        {
                            ...
                            if (startTimer == false)
                            {
                                from.SendMessage(
                                    38,
                                    "You can only poison slashing or piercing weapons."
                                );
                            }
                        }
                        else if (
                        ...
                        )
                        {
                            from.SendMessage(
                                38,
                                "You can only poison one-handed slashing or piercing weapons."
                            );
                        }
                    }
                    ...
                    else if (targeted is WaterFlask || targeted is WaterVial)
                    {
                        from.PrivateOverheadMessage(
                            ...
                            1150,
                            false,
                            "There isn't enough water in this to apply the right amount of poison.",
                            from.NetState
                        );
                    }
                    else // Target can't be poisoned
                    {
                        from.SendMessage(
                            38,
                            "You cannot poison that! You can only poison certain weapons, food, or drink."
                        );
                    }
                }
                ...
                private class InternalTimer : Timer
                {
                    ...
                    protected override void OnTick()
                    {
                        ...
                        )
                        {
                            if (
                                m_Target is Food
                                || m_Target is FoodStaleBread
                                || m_Target is FoodDriedBeef
                            )
                            {
                                int FoodPoisonLevel = 1;
                                if (m_Poison == Poison.Lethal)
                                {
                                    FoodPoisonLevel = 5;
                                }
                                else if (m_Poison == Poison.Deadly)
                                {
                                    FoodPoisonLevel = 4;
                                }
                                else if (m_Poison == Poison.Greater)
                                {
                                    FoodPoisonLevel = 3;
                                }
                                else if (m_Poison == Poison.Regular)
                                {
                                    FoodPoisonLevel = 2;
                                }
                                ...
                                if (m_Target.Amount > 1)
                                {
                                    m_Target.Amount = m_Target.Amount - 1;
                                }
                                else
                                {
                                    m_Target.Delete();
                                ...
                                m_Target is BaseBeverage
                                || m_Target is Waterskin
                                || m_Target is DirtyWaterskin
                            )
                            {
                            ...
                            else if (m_Target is Shuriken)
                            {
                                ...
                                ((Shuriken)m_Target).PoisonCharges = Math.Min(
                                    18 - (m_Poison.Level * 2),
                        ...
                        else // Failed
                        {
                            ...
                            if (
                                m_From.Skills[SkillName.Poisoning].Base < 80.0
                                && Utility.Random(20) == 0
                            )
                            {
