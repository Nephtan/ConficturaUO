...
namespace Server.SkillHandlers
{
    class Spiritualism
    {
        ...
        private class SpiritualismTimer : Timer
        {
            ...
            public SpiritualismTimer(Mobile m)
        ...
        private class SpiritualismSpell : Spell
        {
            ...
            public SpiritualismSpell(Mobile caster)
            ...
            public override void OnCast()
            {
                ...
                if (toChannel != null)
                {
                    min = Server.Misc.MyServerSettings.PlayerLevelMod(
                        1
                            + (int)(Caster.Skills[SkillName.Spiritualism].Value * 0.25)
                            + (int)(Caster.Skills[SkillName.FistFighting].Value * 0.15),
                        Caster
                    );
                    max = Server.Misc.MyServerSettings.PlayerLevelMod(
                        min + Server.Misc.MyServerSettings.PlayerLevelMod(4, Caster),
                        Caster
                    );
                    mana = 0;
                ...
                else
                {
                    ...
                    if (
                        ...
                        > (Caster.Skills[SkillName.Spiritualism].Value / 100.0)
                    )
                    {
