...
namespace Server.Engines.Harvest
{
    public class Herbalism : HarvestSystem
    {
        ...
        private HarvestDefinition m_Flower,
            m_Mushroom,
            m_Cactus,
            m_Lilly,
            m_Leaf,
        ...
        public HarvestDefinition Flowers
        {
            get { return m_Flower; }
        }
        public HarvestDefinition Mushroom
        {
            get { return m_Mushroom; }
        }
        public HarvestDefinition Cactus
        {
            get { return m_Cactus; }
        }
        public HarvestDefinition Lilly
        {
            get { return m_Lilly; }
        }
        public HarvestDefinition Leaf
        {
            get { return m_Leaf; }
        }
        public HarvestDefinition Grass
        {
            get { return m_Grass; }
        }
        ...
        private Herbalism()
        {
            ...
            leaf.MaxRange = 1;
            leaf.ConsumedPerHarvest = 1 * Server.Misc.MyServerSettings.Resources();
            leaf.ConsumedPerIslesDreadHarvest =
                leaf.ConsumedPerHarvest + (int)(leaf.ConsumedPerHarvest / 2) + 2;
            ...
            res = new HarvestResource[]
            {
                new HarvestResource(
                    ...
                    000.0,
                    150.0,
                    "You put an herb in your backpack",
                    typeof(PlantHerbalism_Leaf)
                )
            };

            veins = new HarvestVein[] { new HarvestVein(100.0, 0.0, res[0], res[0]) };
            ...
            mushroom.ConsumedPerIslesDreadHarvest = 1;
            ...
            res = new HarvestResource[]
            {
                new HarvestResource(
                    ...
                    150.0,
                    "You put an herb in your backpack",
                    typeof(PlantHerbalism_Mushroom)
                )
            };
            ...
            flower.ConsumedPerIslesDreadHarvest = 1;
            ...
            cactus.ConsumedPerIslesDreadHarvest = 1;
            ...
            lilly.ConsumedPerIslesDreadHarvest = 1;
            ...
            grass.ConsumedPerIslesDreadHarvest = 1;
