            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        {
                            int jarsFill = Server.Misc.MyServerSettings.Resources();
                            if (Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Isles of Dread") { jarsFill = jarsFill + (int)(jarsFill / 2) + 1; }
                            ...
                            else if (typeof(BasiliskRiding) == c.Owner.GetType()) { sName = "horrid breath"; }
                            ...
                            else if (typeof(PandaRiding) == c.Owner.GetType()) { sName = "bear hairs"; }
                            ...
                            else if (typeof(Turkey) == c.Owner.GetType()) { sName = "bird beaks"; }
                            ...
                            else if (typeof(SabretoothTigerRiding) == c.Owner.GetType()) { sName = "cat whiskers"; }
                            ...
                            else if (typeof(WolfDire) == c.Owner.GetType()) { sName = "dog hairs"; }
                            ...
                            else if (typeof(DrakkhenRed) == c.Owner.GetType()) { sName = "reptile scales"; }
                            else if (typeof(DrakkhenBlack) == c.Owner.GetType()) { sName = "reptile scales"; }
                            ...
                            else if (typeof(ZebraRiding) == c.Owner.GetType()) { sName = "animal tongues"; }
                            ...
                            else if (typeof(ManticoreRiding) == c.Owner.GetType()) { sName = "cat whiskers"; }
                            ...
                            else if (typeof(PredatorHellCatRiding) == c.Owner.GetType()) { sName = "cat whiskers"; }
                            ...
                            else if (typeof(AxeBeakRiding) == c.Owner.GetType()) { sName = "quills"; }
                            ...
                            else if (typeof(Dragoon) == c.Owner.GetType()) { sName = "dragon smoke"; }
                            else if (typeof(RidingDragon) == c.Owner.GetType()) { sName = "dragon smoke"; }
                            ...
                            else if (typeof(TigerRiding) == c.Owner.GetType()) { sName = "cat whiskers"; }
                            else if (typeof(SummonedTiger) == c.Owner.GetType()) { sName = "cat whiskers"; }
                            else if (typeof(Jaguar) == c.Owner.GetType()) { sName = "cat whiskers"; }
                            else if (typeof(WhiteTiger) == c.Owner.GetType()) { sName = "cat whiskers"; }
                            else if (typeof(WhiteTigerRiding) == c.Owner.GetType()) { sName = "cat whiskers"; }
