...
namespace Server.Items
{
    public class MixingCauldron : Item
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string My_Ingredient4
        {
            get { return MyIngredient4; }
            set
            {
                MyIngredient4 = value;
                InvalidateProperties();
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendMessage(
                    "Choose an ingredient you obtained with your surgeons knife, to put in the cauldron."
                );
            ...
            {
                from.SendMessage(
                    "Choose a different ingredient you obtained with your surgeons knife, to put in the cauldron."
                );
        ...
        public MixingCauldron(Serial serial)
            : base(serial) { }
        ...
        {
            public NecroticGump(Mobile from, MixingCauldron bowl)
                : base(25, 25)
            {
                int Known = 0;
                string sKnown = "";
                ...
                AddHtml(
                    ...
                    397,
                    24,
                    @"<BODY><BASEFONT Color=#FBFBFB><BIG>NECROTIC ALCHEMY</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddItem(41, 499, 7719);
        ...
        private class IngredientTarget : Target
        {
            ...
            public IngredientTarget(MixingCauldron pot, int nStage)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                {
                    from.SendMessage(
                        "You should get a Necrotic Alchemy book from a sage or necromancer."
                    );
                    return;
                }
                ...
                {
                    from.SendMessage(
                        "You need at least a 40 skill in forensics to concoct anything with this!"
                    );
                }
                ...
                else if (m_Stage == 6 && obj is MixingSpoon)
                {
                    ...
                    {
                        from.SendMessage("Your cauldron mixer has corroded away.");
                        spoon.Delete();
                    }
                    ...
                    if (from.CheckSkill(SkillName.Alchemy, 0, 100))
                    {
                        ...
                        if (from.CheckSkill(SkillName.Necromancy, 0, 100))
                        {
                            nHigh = nHigh + (int)from.Skills[SkillName.Necromancy].Value;
                        }
                        nHigh = nHigh / 7;
                        if (nHigh > 38)
                        {
                        ...
                        if (potionName != "")
                        {
                            ...
                            if (potionName == "eyes of the dead mixture")
                            {
                                m_Pot.Hue = 0x491;
                            }
                            else if (potionName == "tomb raiding concoction")
                            {
                                m_Pot.Hue = 0x493;
                            }
                            else if (potionName == "disease draught")
                            {
                                m_Pot.Hue = 0x4F8;
                            }
                            else if (potionName == "phantasm elixir")
                            {
                                m_Pot.Hue = 0x6DE;
                            }
                            else if (potionName == "retched air elixir")
                            {
                                m_Pot.Hue = 0xA97;
                            }
                            else if (potionName == "lich leech mixture")
                            {
                                m_Pot.Hue = 0xB87;
                            }
                            else if (potionName == "wall of spikes draught")
                            {
                                m_Pot.Hue = 0xB8F;
                            }
                            else if (potionName == "disease curing concoction")
                            {
                                m_Pot.Hue = 0x8A2;
                            }
                            else if (potionName == "blood pact elixir")
                            {
                                m_Pot.Hue = 0x5B5;
                            }
                            else if (potionName == "spectre shadow elixir")
                            {
                                m_Pot.Hue = 0x17E;
                            }
                            else if (potionName == "ghost phase concoction")
                            {
                                m_Pot.Hue = 0x47E;
                            }
                            else if (potionName == "demonic fire ooze")
                            {
                                m_Pot.Hue = 0x54F;
                            }
                            else if (potionName == "ghostly images draught")
                            {
                                m_Pot.Hue = 0xBF;
                            }
                            else if (potionName == "hellish branding ooze")
                            {
                                m_Pot.Hue = 0x54C;
                            }
                            else if (potionName == "black gate draught")
                            {
                                m_Pot.Hue = 0x2EA;
                            }
                            else if (potionName == "vampire blood draught")
                            {
                                m_Pot.Hue = 0xB85;
                            }
                        }
                        else
                        {
                            ...
                            {
                                from.SendMessage(
                                    "Having discovered all available deathly elixirs, you dump out the cauldron."
                                );
                                m_Pot.ItemID = 0x269C;
                                m_Pot.MyIngredient1 = "";
                                m_Pot.MyIngredient2 = "";
                ...
                else if (m_Stage == 7 && obj is Jar)
                {
                    ...
                    if (m_Pot.MyPotion == "eyes of the dead mixture")
                    {
                        from.AddToBackpack(new UndeadEyesScroll());
                    }
                    else if (m_Pot.MyPotion == "tomb raiding concoction")
                    {
                        from.AddToBackpack(new NecroUnlockScroll());
                    }
                    else if (m_Pot.MyPotion == "disease draught")
                    {
                        from.AddToBackpack(new NecroPoisonScroll());
                    }
                    else if (m_Pot.MyPotion == "phantasm elixir")
                    {
                        from.AddToBackpack(new PhantasmScroll());
                    }
                    else if (m_Pot.MyPotion == "retched air elixir")
                    {
                        from.AddToBackpack(new RetchedAirScroll());
                    }
                    else if (m_Pot.MyPotion == "lich leech mixture")
                    {
                        from.AddToBackpack(new ManaLeechScroll());
                    }
                    else if (m_Pot.MyPotion == "wall of spikes draught")
                    {
                        from.AddToBackpack(new WallOfSpikesScroll());
                    }
                    else if (m_Pot.MyPotion == "disease curing concoction")
                    {
                        from.AddToBackpack(new NecroCurePoisonScroll());
                    }
                    else if (m_Pot.MyPotion == "blood pact elixir")
                    {
                        from.AddToBackpack(new BloodPactScroll());
                    }
                    else if (m_Pot.MyPotion == "spectre shadow elixir")
                    {
                        from.AddToBackpack(new SpectreShadowScroll());
                    }
                    else if (m_Pot.MyPotion == "ghost phase concoction")
                    {
                        from.AddToBackpack(new GhostPhaseScroll());
                    }
                    else if (m_Pot.MyPotion == "demonic fire ooze")
                    {
                        from.AddToBackpack(new HellsGateScroll());
                    }
                    else if (m_Pot.MyPotion == "ghostly images draught")
                    {
                        from.AddToBackpack(new GhostlyImagesScroll());
                    }
                    else if (m_Pot.MyPotion == "hellish branding ooze")
                    {
                        from.AddToBackpack(new HellsBrandScroll());
                    }
                    else if (m_Pot.MyPotion == "black gate draught")
                    {
                        from.AddToBackpack(new GraveyardGatewayScroll());
                    }
                    else if (m_Pot.MyPotion == "vampire blood draught")
                    {
    ...
    public class MixingSpoon : Item
    {
        ...
        public MixingSpoon(Serial serial)
            : base(serial) { }
