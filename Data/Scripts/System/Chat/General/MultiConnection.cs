...
namespace Knives.Chat3
{
    public class MultiConnection
    {
        ...
        public static MultiConnection Connection
        {
            get { return s_Connection; }
        }

        private Socket c_Master,
            c_Slave;
            ...
            try
            {
                ...
                c_Slave.Connect(
                    new System.Net.IPEndPoint(
                        System.Net.IPAddress.Parse(Data.MultiServer),
                        Data.MultiPort
                    )
                );
            }
        ...
        public void SendMessage(Mobile m, string str)
        {
            ...
            {
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(
                    "    <" + Server.Misc.ServerList.ServerName + "> " + m.RawName + ": " + str
                );
