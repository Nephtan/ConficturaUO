...
namespace Knives.Chat3
{
    public class General
    {
            ...
            if (Data.Debug)
            {
                ...
                Console.WriteLine(
                    ...
                    (elapsed.Minutes != 0 ? elapsed.Minutes + " minutes" : "")
                        + (elapsed.Seconds != 0 ? elapsed.Seconds + " seconds" : "")
        ...
        public static bool IsInFaction(Mobile m)
        {
            ...
            return (
                ((PlayerMobile)m).FactionPlayerState != null
                && ((PlayerMobile)m).FactionPlayerState.Faction != null
            );
        }
