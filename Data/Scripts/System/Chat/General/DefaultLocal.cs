...
namespace Knives.Chat3
{
    public class DefaultLocal
    {
        public static ArrayList Load()
        {
            ...
            list.Add("Error loading global options.");
            list.Add("Error saving global options.");
            list.Add("Error filtering text.");
            ...
            list.Add("Error loading channel information.");
            list.Add("Error saving channel information.");
            ...
            list.Add("has read");
            list.Add("Error loading gump information.");
            list.Add("Error saving gump information.");
            list.Add(
            ...
            list.Add("Error loading player options.");
            list.Add("Error saving player options.");
            list.Add("Error loading friends.");
            list.Add("Error saving friends.");
            list.Add("Error loading ignores.");
            list.Add("Error saving ignores.");
            list.Add("Error loading global listens.");
            list.Add("Error saving global listens.");
            list.Add("Error loading private messages.");
            list.Add("Error saving private messages.");
            list.Add("Logging");
            list.Add("Log Chat");
            list.Add("Log Pms");
