    ...
    public class IrcGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            AddButton(
                ...
                0x2716,
                "Channel Options",
                new GumpCallback(ChannelOptions)
            );
            AddButton(
                width / 2 + 60,
                y,
            ...
            AddButton(
                width / 2 - 80,
                y + 3,
                Data.IrcEnabled ? 0x2343 : 0x2342,
                "IRC Enabled",
                new GumpCallback(IrcEnabled)
            );
            AddButton(
                width / 2 + 60,
                y + 3,
            ...
            AddButton(
                width / 2 - 80,
                y,
                Data.IrcAutoConnect ? 0x2343 : 0x2342,
                "IRC Auto Connect",
                new GumpCallback(IrcAutoConnect)
            );
            AddButton(
                width / 2 + 60,
                y,
            ...
            AddButton(
                width / 2 - 80,
                y,
                Data.IrcAutoReconnect ? 0x2343 : 0x2342,
                "IRC Auto Reconnect",
                new GumpCallback(IrcAutoReconnect)
            );
            AddButton(
                width / 2 + 60,
                y,
            ...
            AddHtml(
                ...
                "<CENTER>"
                    + General.Local(138)
                    + ": "
                    + General.Local(121 + (int)Data.IrcStaffColor)
            );
            AddButton(
                width / 2 - 80,
                y + 4,
                0x2716,
                "Irc Staff Color",
                new GumpCallback(IrcStaffColor)
            );
            AddButton(
                width / 2 + 70,
                y + 4,
            ...
            AddButton(
                ...
                y + 4,
                0x2716,
                "Connect or Cancel or Close",
                new GumpCallback(ConnectCancelClose)
            );
            AddButton(
                width / 2 + 50,
                y + 4,
