    ...
    public class EditNotGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            AddHtml(
                ...
                y += 25,
                width,
                "<CENTER>" + General.Local(272) + " | " + General.Local(273)
            );
            AddButton(
                width / 2 - 60,
                y + 3,
                !c_Not.Gump ? 0x939 : 0x2716,
                "NotGump",
                new GumpCallback(NotGump)
            );
            AddButton(
                width / 2 + 50,
                y + 3,
            ...
            AddHtml(
                ...
                width,
                "<CENTER>"
                    + (c_Not.Recur.Days != 0 ? c_Not.Recur.Days + " days " : "")
                    + (c_Not.Recur.Hours != 0 ? c_Not.Recur.Hours + "h " : "")
                    + (c_Not.Recur.Minutes != 0 ? c_Not.Recur.Minutes + "m " : "")
                    + (c_Not.Recur.Seconds != 0 ? c_Not.Recur.Seconds + "s" : "")
            );
            ...
            if (c_Not.Gump)
            {
                ...
                AddButton(
                    width / 2 - 90,
                    y,
                    c_Not.AntiMacro ? 0x2343 : 0x2342,
                    "Anti Macro",
                    new GumpCallback(AntiMacro)
                );
                AddButton(
                    width / 2 + 70,
                    y,
            ...
            if (c_Not.AntiMacro)
            {
                ...
                AddHtml(
                    ...
                    y += 20,
                    width,
                    "<CENTER>" + General.Local(155) + " | " + General.Local(281)
                );
                AddButton(
                    width / 2 - 60,
                    y + 3,
                    Data.MacroPenalty == MacroPenalty.None ? 0x939 : 0x2716,
                    "None",
                    new GumpCallback(None)
                );
                AddButton(
                    width / 2 + 50,
                    y + 3,
                    Data.MacroPenalty == MacroPenalty.Kick ? 0x939 : 0x2716,
                    "Kick",
                    new GumpCallback(Kick)
                );
