    ...
    public class GlobalGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            AddButton(
                width / 2 - 70,
                y + 3,
                Data.GetData(Current).Global ? 0x939 : 0x2716,
                "Global",
            ...
            if (Data.GetData(Current).Global)
            {
                ...
                AddButton(
                    width / 2 - 70,
                    y,
                    Data.GetData(Current).GlobalC ? 0x2343 : 0x2342,
                    "Chat",
                    new GumpCallback(GlobalChat)
                );
                AddButton(
                    width / 2 + 50,
                    y,
                ...
                AddButton(
                    width / 2 - 70,
                    y,
                    Data.GetData(Current).GlobalW ? 0x2343 : 0x2342,
                    "World",
                    new GumpCallback(GlobalWorld)
                );
                AddButton(
                    width / 2 + 50,
                    y,
                ...
                AddButton(
                    width / 2 - 70,
                    y,
                    Data.GetData(Current).GlobalM ? 0x2343 : 0x2342,
                    "Msg",
                    new GumpCallback(GlobalMsg)
                );
                AddButton(
                    width / 2 + 50,
                    y,
                ...
                AddButton(
                    width / 2 - 70,
                    y,
                    Data.GetData(Current).GlobalG ? 0x2343 : 0x2342,
                    "Guild",
                    new GumpCallback(GlobalGuild)
                );
                AddButton(
                    width / 2 + 50,
                    y,
                ...
                AddButton(
                    width / 2 - 70,
                    y,
                    Data.GetData(Current).GlobalF ? 0x2343 : 0x2342,
                    "Faction",
                    new GumpCallback(GlobalFaction)
                );
                AddButton(
                    width / 2 + 50,
                    y,
                ...
                AddButton(
                    width / 2 - 70,
                    y,
                    Data.GetData(Current).IrcRaw ? 0x2343 : 0x2342,
                    "Irc Raw",
                    new GumpCallback(IrcRaw)
                );
                AddButton(
                    width / 2 + 50,
                    y,
