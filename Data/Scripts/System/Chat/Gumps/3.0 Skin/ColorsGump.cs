    ...
    public class ColorsGump : GumpPlus
    {
            ...
            foreach (Channel c in Channel.Channels)
                if (c.CanChat(Current, false))
                {
                    ...
                    AddButton(
                        ...
                        0x2716,
                        "Channel Color",
                        new GumpStateCallback(ChannelColor),
                        c
                    );
        ...
        private class InternalPicker : HuePicker
        {
            ...
            public override void OnResponse(int hue)
            {
                ...
                {
                    case 0:
                        Data.GetData(c_Gump.Current).GlobalCC = hue;
                        break;
                    case 1:
                        Data.GetData(c_Gump.Current).GlobalWC = hue;
                        break;
                    case 2:
                        Data.GetData(c_Gump.Current).SystemC = hue;
                        break;
                    case 3:
                        Data.GetData(c_Gump.Current).StaffC = hue;
                        break;
                    case 4:
                        Data.GetData(c_Gump.Current).GlobalGC = hue;
                        break;
                    case 5:
                        Data.GetData(c_Gump.Current).GlobalFC = hue;
                        break;
                    case 6:
                        Data.GetData(c_Gump.Current).GlobalMC = hue;
                        break;
                }
