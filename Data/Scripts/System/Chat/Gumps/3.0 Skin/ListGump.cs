    ...
    public class ListGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            AddHtml(
                ...
                y,
                width,
                "<CENTER>" + General.Local(19 + (int)Data.GetData(Current).Status)
            );
        ...
        private void ShowMenu(int x)
        {
            ...
            foreach (Chat3.Channel c in Chat3.Channel.Channels)
            {
                ...
                AddHtml(
                    ...
                    y += 20,
                    width - 40,
                    (Data.GetData(Current).CurrentChannel == c ? HTML.Yellow : HTML.White)
                        + "<CENTER>"
                        + (c.Style == ChatStyle.Regional ? c.Name : c.NameFor(Current))
                );
                AddButton(
                    x + 20,
                    y,
                    c.IsIn(Current) ? 0x2343 : 0x2342,
                    "Join Channel",
                ...
                if (c.IsIn(Current))
                {
                    AddButton(
                        ...
                        0x2716,
                        "View Channel",
                        new GumpStateCallback(ViewChannel),
                        c
                    );
                    AddButton(
                        x + 40 + (width - 40) / 2 + 30,
            ...
            AddHtml(
                ...
                y += 20,
                width,
                (c_ListPage == ListPage.Channel ? "" : HTML.Gray) + "<CENTER>" + General.Local(206)
            );
