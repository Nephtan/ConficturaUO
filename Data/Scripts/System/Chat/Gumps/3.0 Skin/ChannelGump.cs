    ...
    public class ChannelGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            AddButton(
                ...
                0x2716,
                "Channel Select",
                new GumpCallback(ChannelSelect)
            );
            AddButton(
                width / 2 + 52,
                y + 3,
            ...
            if (c_Channel.GetType() == typeof(Channel))
            {
                ...
                AddButton(
                    ...
                    0x5687,
                    "Delete Channel",
                    new GumpCallback(DeleteChannel)
                );
                AddButton(
                    width / 2 + 50,
                    y + 1,
            ...
            AddButton(
                width / 2 - 100,
                y,
                c_Channel.Enabled ? 0x2343 : 0x2342,
                "Enable",
                new GumpCallback(Enable)
            );
            AddButton(
                width / 2 + 80,
                y,
            ...
            AddHtml(
                ...
                y += 25,
                width,
                "<CENTER>" + General.Local(182) + " | " + General.Local(183)
            );
            AddButton(
                width / 2 - 100,
                y + 3,
                c_Channel.Style == ChatStyle.Global ? 0x939 : 0x2716,
                "Global",
                new GumpCallback(Global)
            );
            AddButton(
                width / 2 + 90,
                y + 3,
                c_Channel.Style == ChatStyle.Regional ? 0x939 : 0x2716,
                "Regional",
                new GumpCallback(Regional)
            );
            ...
            AddButton(
                width / 2 - 100,
                y,
                c_Channel.ShowStaff ? 0x2343 : 0x2342,
                "Show Staff",
                new GumpCallback(ShowStaff)
            );
            AddButton(
                width / 2 + 80,
                y,
            ...
            AddButton(
                width / 2 - 100,
                y,
                c_Channel.ToIrc ? 0x2343 : 0x2342,
                "Send to IRC",
                new GumpCallback(SendToIrc)
            );
            AddButton(
                width / 2 + 80,
                y,
            ...
            AddButton(
                width / 2 - 100,
                y,
                c_Channel.NewChars ? 0x2343 : 0x2342,
                "Auto join new characters",
                new GumpCallback(AutoNewChars)
            );
            AddButton(
                width / 2 + 80,
                y,
            ...
            AddButton(
                width / 2 - 100,
                y,
                c_Channel.Filter ? 0x2343 : 0x2342,
                "Apply Filter",
                new GumpCallback(ApplyFilter)
            );
            AddButton(
                width / 2 + 80,
                y,
            ...
            AddButton(
                width / 2 - 100,
                y,
                c_Channel.Delay ? 0x2343 : 0x2342,
                "Apply Delay",
                new GumpCallback(ApplyDelay)
            );
            AddButton(
                width / 2 + 80,
                y,
            ...
            protected override void BuildGump()
            {
                ...
                foreach (Channel c in Channel.Channels)
                {
                    ...
                    AddButton(
                        ...
                        0x2716,
                        "Select Channel",
                        new GumpStateCallback(SelectChannel),
                        c
                    );
                    AddButton(
                        width / 2 + 50,
