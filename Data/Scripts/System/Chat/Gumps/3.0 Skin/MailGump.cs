    ...
    public class MailGump : GumpPlus
    {
        ...
        protected override void BuildGump()
        {
            ...
            AddButton(
                width / 2 - 120,
                y,
                Data.GetData(Current).SevenDays ? 0x2343 : 0x2342,
                "Seven Days",
                new GumpCallback(SevenDays)
            );
            AddButton(
                width / 2 + 100,
                y,
            ...
            AddButton(
                width / 2 - 120,
                y,
                Data.GetData(Current).WhenFull ? 0x2343 : 0x2342,
                "When Full",
                new GumpCallback(WhenFull)
            );
            AddButton(
                width / 2 + 100,
                y,
            ...
            AddButton(
                width / 2 - 120,
                y,
                Data.GetData(Current).FriendsOnly ? 0x2343 : 0x2342,
                "Friends Only",
                new GumpCallback(FriendsOnly)
            );
            AddButton(
                width / 2 + 100,
                y,
            ...
            AddButton(
                width / 2 - 120,
                y,
                Data.GetData(Current).ByRequest ? 0x2343 : 0x2342,
                "Friend Request",
                new GumpCallback(FriendRequest)
            );
            AddButton(
                width / 2 + 100,
                y,
            ...
            AddButton(
                width / 2 - 120,
                y,
                Data.GetData(Current).FriendAlert ? 0x2343 : 0x2342,
                "Friend Alert",
                new GumpCallback(FriendAlert)
            );
            AddButton(
                width / 2 + 100,
                y,
            ...
            AddButton(
                width / 2 - 120,
                y,
                Data.GetData(Current).ReadReceipt ? 0x2343 : 0x2342,
                "Read Receipt",
                new GumpCallback(ReadReceipt)
            );
            AddButton(
                width / 2 + 100,
                y,
            ...
            AddButton(
                width / 2 - 120,
                y,
                Data.GetData(Current).MsgSound ? 0x2343 : 0x2342,
                "Message Sound",
                new GumpCallback(MessageSound)
            );
            AddButton(
                width / 2 + 100,
                y,
            ...
            if (Data.GetData(Current).MsgSound)
            {
                ...
                AddTextField(
                    ...
                    0xBBA,
                    "Sound",
                    Data.GetData(Current).DefaultSound.ToString()
                );
                AddButton(
                    width / 2 + 30,
                    y + 3,
