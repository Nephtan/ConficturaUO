...
namespace Knives.Chat3
{
    public class GumpInfo
    {
        ...
        public static ArrayList Backgrounds
        {
            get { return s_Backgrounds; }
        }
        public static ArrayList TextColors
        {
            get { return s_TextColors; }
        }
        public static bool ForceMenu
        {
            get { return s_ForceMenu; }
            set { s_ForceMenu = value; }
        }
        public static Hashtable ForceInfos
        {
            get { return s_ForceInfos; }
        }
        ...
        public static void Save()
        {
            try
            {
                ...
                GenericWriter writer = new BinaryFileWriter(
                    Path.Combine(General.SavePath, "Gumps.bin"),
                    true
                );
                ...
                foreach (object o in new ArrayList(s_Infos.Values))
                {
                    ...
                    foreach (object ob in new ArrayList(((Hashtable)o).Values))
                    {
                        ...
                        if (
                            ...
                            && ((Account)info.Mobile.Account).LastLogin
        ...
        {
            get { return c_Transparent; }
            set
            {
                c_Transparent = value;
                c_DefaultTrans = false;
            }
        }
        public bool DefaultTrans
        {
            get { return c_DefaultTrans; }
            set { c_DefaultTrans = value; }
        }
        public string TextColorRGB
        {
            get { return c_TextColorRGB; }
            set { c_TextColorRGB = value; }
        }
        public string TextColor
        {
            get { return String.Format("<BASEFONT COLOR=#{0}>", c_TextColorRGB); }
        }
        public int Background
        {
            get { return c_Background; }
        }
