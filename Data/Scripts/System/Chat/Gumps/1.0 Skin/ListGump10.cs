                ...
                else if (list[i] is Mobile)
                {
                    AddHtml(
                        ...
                        ColorFor((Mobile)list[i])
                            + (Data.GetData(Owner).QuickBar ? "" : "<CENTER>")
        ...
        private void BuildTabs(int width, int y)
        {
            ...
            if (Data.GetData(Current).CurrentChannel != null)
                AddHtml(
                    ...
                    y + 3,
                    60,
                    (c_ListPage == ListPage.Channel ? HTML.Green : HTML.White)
                        + "<CENTER>"
                        + Data.GetData(Current).CurrentChannel.NameFor(Current)
                );
            ...
            AddHtml(
                ...
                y + 3,
                60,
                (c_ListPage == ListPage.Friends ? HTML.Green : HTML.White)
                    + "<CENTER>"
                    + General.Local(203)
            );
            ...
            AddHtml(
                ...
                y + 3,
                60,
                (c_ListPage == ListPage.Ignores ? HTML.Green : HTML.White)
                    + "<CENTER>"
                    + General.Local(51)
            );
            ...
            AddHtml(
                ...
                y + 3,
                60,
                (c_ListPage == ListPage.Mail ? HTML.Green : HTML.White)
                    + "<CENTER>"
                    + General.Local(56)
            );
