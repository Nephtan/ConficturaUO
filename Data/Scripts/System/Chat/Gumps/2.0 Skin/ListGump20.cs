...
namespace Knives.Chat3
{
    public class ListGump20 : GumpPlus
    {
        ...
        protected ListPage CurrentPage
        {
            get { return c_ListPage; }
        }
        public Mobile Current
        {
            get { return (c_Target == null ? Owner : c_Target); }
        }
        ...
        protected override void BuildGump()
        {
            ...
            if (
                c_ListPage == ListPage.Mail
                || (
                    c_ListPage == ListPage.Channel
                    && (
                        Data.GetData(Current).CurrentChannel is Guild
                        || Data.GetData(Current).CurrentChannel is Faction
                    )
                )
            )
                perpage /= 2;
            ...
            if (c_Target != null)
            {
                AddHtml(
                    ...
                    y += 25,
                    width,
                    "<CENTER>" + General.Local(224) + " " + c_Target.RawName
                );
                AddButton(
                    width / 2 - 80,
                    y,
            ...
            for (int i = c_Page * perpage; i < (c_Page + 1) * perpage && i < list.Count; ++i)
            {
                if (list[i] is string)
                {
                    ...
                    AddButton(
                        width - 40,
                        y,
                        Data.GetData(Current).IrcIgnores.Contains(list[i].ToString())
                            ? 0x5687
                            : 0x5686,
                        "Ignore IRC",
                        new GumpStateCallback(IgnoreIrc),
                        list[i]
                    );
                }
                else if (list[i] is Mobile)
                {
                    AddHtml(
                        ...
                        y += 20,
                        width - 35,
                        ColorFor((Mobile)list[i])
                            + ((Mobile)list[i]).RawName
                            + StatusFor((Mobile)list[i])
                    );
                    if (Current == Owner && Data.GetData(Owner).NewMsgFrom((Mobile)list[i]))
                        AddButton(
                            ...
                            0x1523,
                            "Check Msg",
                            new GumpStateCallback(CheckMsg),
                            (Mobile)list[i]
                        );
                    else
                        AddButton(
                    ...
                    if (list[i] != Current && Data.GetData(Current).QuickBar)
                    {
                        ...
                        if (Current.AccessLevel > ((Mobile)list[i]).AccessLevel)
                        {
                            if (Data.GetData(Current).GlobalAccess)
                            {
                                if (Data.GetData(Current).Global)
                                {
                                    AddButton(
                                        ...
                                        0x13A8,
                                        "Mini Ignore",
                                        new GumpStateCallback(GIgnore),
                                        list[i]
                                    );
                                    AddLabel(
                                        bar + 4,
                                        y,
                                        Data.GetData(Current).GIgnores.Contains(list[i])
                                            ? 0x44
                                            : 0x26,
                                        "I"
                                    );
                                ...
                                else
                                {
                                    AddButton(
                                        ...
                                        0x13A8,
                                        "Mini Listen",
                                        new GumpStateCallback(GListen),
                                        list[i]
                                    );
                                    AddLabel(
                                        bar + 4,
                                        y,
                                        Data.GetData(Current).GListens.Contains(list[i])
                                            ? 0x44
                                            : 0x26,
                                        "L"
                                    );
                            ...
                            AddButton(
                                ...
                                0x13A8,
                                "Mini Ban",
                                new GumpStateCallback(Ban),
                                list[i]
                            );
                            AddLabel(
                                bar + 4,
                                y,
                                Data.GetData((Mobile)list[i]).Banned ? 0x44 : 0x26,
                                "b"
                            );
                        }

                        if (
                            Current.AccessLevel >= AccessLevel.GameMaster
                            && ((Mobile)list[i]).NetState != null
                        )
                        {
                            AddButton(
                                bar -= 12,
                        ...
                        AddButton(
                            ...
                            0x13A8,
                            "Mini Ignore",
                            new GumpStateCallback(Ignore),
                            list[i]
                        );
                        AddLabel(
                            bar + 5,
                            y - 1,
                            Data.GetData(Current).Ignores.Contains(list[i]) ? 0x44 : 0x26,
                            "i"
                        );
                        ...
                        AddButton(
                            ...
                            0x13A8,
                            "Mini Friend",
                            new GumpStateCallback(Friend),
                            list[i]
                        );
                        AddLabel(
                            bar + 3,
                            y,
                            Data.GetData(Current).Friends.Contains(list[i]) ? 0x44 : 0x26,
                            "f"
                        );
                    }
                }
                else if (list[i] is Message)
                {
                    ...
                    AddHtml(
                        ...
                        y += 20,
                        width - 85,
                        ColorFor(msg) + (msg.Read ? "" : "<B>") + msg.Subject,
                        false
                    );
                ...
                else if (list[i] is Notification)
                {
                    ...
                    AddButton(
                        ...
                        0x2716,
                        "Edit Notif",
                        new GumpStateCallback(EditNotif),
                        (Notification)list[i]
                    );
                    AddButton(
                        width - 40,
            ...
            if (c_ListPage == ListPage.Mail)
                AddHtml(
                    ...
                    y += 20,
                    width,
                    "<CENTER>" + Data.GetData(Owner).Messages.Count + " / " + Data.MaxMsgs
                );
            else if (c_ListPage != ListPage.Notifications)
            {
            ...
            else
            {
                AddButton(
                    ...
                    0x29F6,
                    "Full List",
                    new GumpCallback(FullList)
                );
                AddHtml(40, y, 50, "<CENTER>" + GetTitle());
                AddButton(
                    10,
                    y,
                    c_Menu ? 0x15E0 : 0x15E2,
                    c_Menu ? 0x15E4 : 0x15E6,
                    "Menu",
                    new GumpCallback(Menu)
                );
            }
            ...
            AddLabel(
                width - 62,
                y - 1,
                Data.GetData(Current).Status == OnlineStatus.Online ? 0x47E : 0x34,
                "A"
            );
        ...
        private int ShowFullMenu(int y, int width)
        {
            AddButton(
                ...
                0x29F6,
                "Channels",
                new GumpCallback(Channels)
            );
            AddHtml(
                width / 2 - 75,
                y,
                50,
                (c_ListPage == ListPage.Channel ? HTML.Green : "")
                    + "<CENTER>"
                    + (c_ListPage == ListPage.Channel ? GetTitle() : General.Local(38))
            );
            ...
            AddHtml(
                ...
                y,
                50,
                (c_ListPage == ListPage.Friends ? HTML.Green : "") + "<CENTER>" + General.Local(203)
            );
            ...
            AddHtml(
                ...
                y,
                50,
                (c_ListPage == ListPage.Ignores ? HTML.Green : "") + "<CENTER>" + General.Local(51)
            );
            ...
            AddHtml(
                ...
                y,
                50,
                (c_ListPage == ListPage.All ? HTML.Green : "") + "<CENTER>" + General.Local(46)
            );
            ...
            AddHtml(
                ...
                y,
                50,
                (c_ListPage == ListPage.Mail ? HTML.Green : "") + "<CENTER>" + General.Local(56)
            );
            ...
            AddButton(
                ...
                0x8B1,
                "1.0",
                new GumpStateCallback(SkinChange),
                Skin.One
            );
        ...
        private void ShowSearch(int x)
        {
            ...
            foreach (char c in chars)
            {
                AddButton(
                    ...
                    0x2344,
                    "Char Search",
                    new GumpStateCallback(CharSearch),
                    c.ToString()
                );
                AddHtml(
                    difx + 6,
                    y,
                    20,
                    (c_CharSearch == c.ToString() ? HTML.Green : "") + c,
                    false
                );
        ...
        private string GetTitle()
        {
            ...
            {
                case ListPage.All:
                    return General.Local(46);
                case ListPage.Channel:
                    return Data.GetData(Current).CurrentChannel.NameFor(Current);
                case ListPage.Mail:
                    return General.Local(56);
                case ListPage.Friends:
                    return General.Local(203);
                case ListPage.Ignores:
                    return General.Local(51);
                case ListPage.GIgnores:
                    return General.Local(204);
                case ListPage.GListens:
                    return General.Local(205);
                case ListPage.Bans:
                    return General.Local(54);
                case ListPage.Notifications:
                    return General.Local(269);
            }
        ...
        private ArrayList GetList()
        {
            ...
            switch (c_ListPage)
            {
                case ListPage.All:
                    ...
                    return list;
                case ListPage.Channel:
                    return new ArrayList(Data.GetData(Current).CurrentChannel.BuildList(Current));
                case ListPage.Mail:
                    return new ArrayList(Data.GetData(Current).Messages);
                case ListPage.Friends:
                    return new ArrayList(Data.GetData(Current).Friends);
                case ListPage.Ignores:
                    return new ArrayList(Data.GetData(Current).Ignores);
                case ListPage.GIgnores:
                    return new ArrayList(Data.GetData(Current).GIgnores);
                case ListPage.GListens:
                    return new ArrayList(Data.GetData(Current).GListens);
                case ListPage.Bans:
                    list = new ArrayList();
                    foreach (Data data in Data.Datas.Values)
                        if (data.Banned)
                    ...
                    return list;
                case ListPage.Notifications:
                    return new ArrayList(Data.Notifications);
            }
        ...
        private string ColorFor(Mobile m)
        {
            ...
            if (
                Data.GetData(m).Status == OnlineStatus.Away
                || Data.GetData(m).Status == OnlineStatus.Busy
            )
                return HTML.Gray;
        ...
        private void Open(object o)
        {
            ...
            if (
                m.Read
                && Data.GetData(m.From).ReadReceipt
                && m.From.AccessLevel >= Owner.AccessLevel
            )
                m.From.SendMessage(
                    Data.GetData(m.From).SystemC,
                    Owner.RawName + " " + General.Local(197) + " " + m.Subject
                );
            ...
            if (Data.GetData(m).ByRequest && !Data.GetData(Current).Friends.Contains(m))
            {
                if (
                    !TrackSpam.LogSpam(
                        Current,
                        "Request " + m.RawName,
                        TimeSpan.FromHours(Data.RequestSpam)
                    )
                )
                {
                    TimeSpan ts = TrackSpam.NextAllowedIn(
                        Current,
                        "Request " + m.RawName,
                        TimeSpan.FromHours(Data.RequestSpam)
                    );
                    string txt =
                        (ts.Days != 0 ? ts.Days + " " + General.Local(170) + " " : "")
                        + (ts.Hours != 0 ? ts.Hours + " " + General.Local(171) + " " : "")
                        + (ts.Minutes != 0 ? ts.Minutes + " " + General.Local(172) + " " : "");
                ...
                Data.GetData(m)
                    .AddMessage(
                        new Message(Current, General.Local(84), General.Local(85), MsgType.Invite)
                    );

                Owner.SendMessage(
                    Data.GetData(Current).SystemC,
        ...
        private class InternalSort : IComparer
        {
            ...
            public int Compare(object x, object y)
            {
                if (x is Mobile && y is Mobile)
                {
                    ...
                    if (
                        !Data.GetData(c_Gump.Owner).NewMsgFrom(((Mobile)x))
                        && Data.GetData(c_Gump.Owner).NewMsgFrom(((Mobile)y))
                    )
                        return 1;
                    if (
                        Data.GetData(c_Gump.Owner).NewMsgFrom(((Mobile)x))
        ...
        private class BanGump : GumpPlus
        {
            ...
            private void BanTime(object o)
            {
                ...
                Owner.SendMessage(
                    Data.GetData(Owner).SystemC,
                    General.Local(77) + " " + c_Target.RawName
                );
            ...
            protected override void BuildGump()
            {
                ...
                foreach (Chat3.Channel c in Chat3.Channel.Channels)
                {
                    ...
                    AddHtml(
                        ...
                        y += 20,
                        width - 40,
                        (Data.GetData(c_Target).CurrentChannel == c ? HTML.Yellow : HTML.White)
                            + "<CENTER>"
                            + (c.Style == ChatStyle.Regional ? c.Name : c.NameFor(c_Target))
                    );
                    AddButton(
                        20,
                        y,
                        c.IsIn(c_Target) ? 0x2343 : 0x2342,
                        "Join Channel",
                        new GumpStateCallback(JoinChannel),
                        c
                    );
                    ...
                    if (c.IsIn(c_Target))
                    {
                        AddButton(
                            ...
                            0x2716,
                            "View Channel",
                            new GumpStateCallback(c_Gump.ViewChannel),
                            c
                        );
                        AddButton(
                            40 + (width - 40) / 2 + 30,
                ...
                AddButton(
                    ...
                    0x2716,
                    "Page",
                    new GumpStateCallback(c_Gump.Page),
                    ListPage.All
                );
                AddButton(
                    width - 30,
                ...
                AddHtml(
                    ...
                    y += 20,
                    width,
                    (c_Gump.CurrentPage == ListPage.Channel ? "" : HTML.Gray)
                        + "<CENTER>"
                        + General.Local(206)
                );
                if (c_Gump.CurrentPage == ListPage.Channel)
                {
                    ...
                    AddButton(
                        ...
                        0x2716,
                        "History",
                        new GumpCallback(c_Gump.History)
                    );
                }
                ...
                if (Data.GetData(c_Target).GlobalAccess)
                {
                    ...
                    AddButton(
                        ...
                        0x2716,
                        "Global Menu",
                        new GumpCallback(c_Gump.GlobalMenu)
                    );
                    AddButton(
                        width - 30,
                        y + 3,
                ...
                if (c_Target.AccessLevel >= AccessLevel.Administrator)
                {
                    ...
                    AddButton(
                        ...
                        0x2716,
                        "General",
                        new GumpCallback(c_Gump.GenOpt)
                    );
                    ...
                    AddButton(
                        ...
                        0x2716,
                        "Logging",
                        new GumpCallback(c_Gump.Logging)
                    );
                    ...
                    AddButton(
                        ...
                        0x2716,
                        "Channel",
                        new GumpCallback(c_Gump.Channel)
                    );
                }
