    ...
    class RegionMusic
    {
        public static void MusicRegion(Mobile from, Region reg)
        {
            if (from is PlayerMobile)
            {
                ...
                {
                    toPlay = SythMusic[Utility.Random(SythMusic.Length)];
                    switchSongs = true;
                }
                else if (reg.IsPartOf("the Tomb of Zoda the Jedi Master"))
                {
                    toPlay = JediMusic[Utility.Random(JediMusic.Length)];
                    switchSongs = true;
                }
                else if (
                    reg.IsPartOf("the Ancient Sky Ship") || reg.IsPartOf("the Ancient Crash Site")
                )
                {
                    toPlay = SpaceMusic[Utility.Random(SpaceMusic.Length)];
                    switchSongs = true;
                }
                ...
                else
                {
                    if (reg.IsPartOf("the Castle of Knowledge"))
                    {
                        ...
                        reg.IsPartOf("the Buccaneer's Den")
                    ...
                    {
                        toPlay = UnderworldMusic[Utility.Random(UnderworldMusic.Length)];
                        switchSongs = true;
                    }
                    ...
                    else if (reg is SafeRegion)
                    {
                        ...
                        switchSongs = true;
                        if (
                            reg.Name == "the Kraken Eye Cave"
                            || reg.Name == "the Anchored Cave"
                            || reg.Name == "the Ravendark Tomb"
                            || reg.Name == "the Furnace Eye Cave"
                        )
                        {
                            toPlay = CaveMusic[Utility.Random(CaveMusic.Length)];
                        }
                    ...
                    {
                        toPlay = DangerMusic[Utility.Random(DangerMusic.Length)];
                        switchSongs = true;
                        if (tunes == "Forest")
                            toPlay = LandMusic[Utility.Random(LandMusic.Length)];
                    }
                    ...
                    {
                        toPlay = HouseMusic[Utility.Random(HouseMusic.Length)];
                        switchSongs = true;
                    }
        ...
        public static MusicName[] OrientalList = new MusicName[] { MusicName.Dojo };
