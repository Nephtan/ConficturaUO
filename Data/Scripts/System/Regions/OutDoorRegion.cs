...
namespace Server.Regions
{
    ...
    {
        public OutDoorRegion(XmlElement xml, Map map, Region parent)
            : base(xml, map, parent) { }
        ...
        public override bool AllowHousing(Mobile from, Point3D p)
        {
            ...
            {
                if (
                    from.Skills[SkillName.Camping].Base >= 90
                    || from.Skills[SkillName.Tracking].Base >= 90
                )
                {
                    return true;
                }
        ...
        public override void OnEnter(Mobile m)
        {
            ...
            if (m is PlayerMobile)
            {
                ...
                if (this.Name == "the Ranger Outpost")
                {
                    PlayerSettings.SetKeys(m, "RangerOutpost", true);
                }
            }
        }
