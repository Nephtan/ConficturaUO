...
namespace Server.Regions
{
    ...
    {
        public PublicRegion(XmlElement xml, Map map, Region parent)
            : base(xml, map, parent) { }
        ...
        public override void OnEnter(Mobile m)
        {
            ...
            {
                if (this.Name == "the Druid's Glade")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "Xardok's Castle")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                ...
                else if (this.Name == "the Chamber of Tyball")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "the Tower of Stoneguard")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "the Ethereal Void")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "the Tower of Mondain")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "the Crypt of Morphius")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "the Castle of Shadowguard")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "the Guardian's Chamber")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "the Tomb of Lethe")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "Seggallions's Cave")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "Garamon's Castle")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
                else if (this.Name == "the Lyceum")
                {
                    LoggingFunctions.LogRegions(m, this.Name, "enter");
                }
            }
