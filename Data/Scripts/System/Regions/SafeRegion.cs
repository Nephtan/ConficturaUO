...
namespace Server.Regions
{
    ...
    {
        public SafeRegion(XmlElement xml, Map map, Region parent)
            : base(xml, map, parent) { }
        ...
        public override void AlterLightLevel(Mobile m, ref int global, ref int personal)
        {
            if (this.Name == "the Fort of Tenebrae")
            {
                ...
                this.Name == "the Furnace Vorpal Dock"
                || this.Name == "the Kraken Eye Cave"
                || this.Name == "the Anchored Cave"
                || this.Name == "the Ravendark Tomb"
                || this.Name == "the Furnace Eye Cave"
            )
            {
        ...
        {
            if (
                Worlds.IsAllowedSpell(m, s)
                || this.Name == "the Forgotten Lighthouse"
                || this.Name == "the Fort of Tenebrae"
        ...
        public override void OnEnter(Mobile m)
        {
            ...
            if (m is PlayerMobile)
            {
                ...
                && !(m is BaseVendor)
                && !(m is Citizens)
            ) // WATER CREATURES GO UNDER THE SURFACE
            {
