...
namespace Server.Engines.Help
{
    public class PageResponseGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            AddHtmlLocalized(150, 40, 360, 40, 1062610, false, false); // <CENTER><U>" + MyServerSettings.ServerName() + " Help Response</U></CENTER>
            ...
            AddHtml(
                ...
                480,
                290,
                String.Format("{0} tells {1}: {2}", name, from.Name, text),
                true,
                true
            );
