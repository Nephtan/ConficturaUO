            ...
            if (m_List.Length > 0)
            {
                ...
                for (int i = 0; i < m_List.Length; ++i)
                {
                    ...
                    string html = String.Format(
                        "[{0}] {1} <basefont color=#{2:X6}>[<u>{3}</u>]</basefont>",
                        typeString,
                        e.Message,
                        e.Handler == null ? 0xFF0000 : 0xFF,
                        e.Handler == null ? "Unhandled" : "Handling"
                    );
            ...
            : base(30, 30)
        {
            ...
            if (response == null)
            {
                ...
                AddHtml(
                    ...
                    390,
                    20,
                    Color(Center("Predefined Responses"), LabelColor32),
                    false,
                    false
                );
                ...
                if (canEdit)
                {
                    ...
                    AddHtml(
                        ...
                        200,
                        20,
                        Color("New Response", LabelColor32),
                        false,
                        false
                    );
                }
            ...
            else if (canEdit)
            {
                ...
                AddHtml(
                    ...
                    390,
                    20,
                    Color(Center("Predefined Response Editor"), LabelColor32),
                    false,
                    false
                );
            ...
            : base(30, 30)
        {
            try
            {
                ...
                AddLabelCropped(
                    ...
                    String.Format(
                        "{0} {1} [{2}]",
                        entry.Sender.RawName,
                        entry.Sender.Location,
                        entry.Sender.Map
                    )
                );
                ...
                else
                {
                    AddLabelCropped(
                        ...
                        264,
                        20,
                        m_AccessLevelHues[(int)entry.Handler.AccessLevel],
                        entry.Handler.Name
                    );
                ...
                AddLabelCropped(
                    ...
                    20,
                    2100,
                    String.Format("{0} [{1}]", entry.PageLocation, entry.PageMap)
                );
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 3: // go to page location
                {
                    ...
                    else
                    {
                        ...
                        state.Mobile.SendMessage(
                            "You have been teleported to the original page location."
                        );
                ...
                case 5: // delete page
                {
                    ...
                    {
                        state.Mobile.SendMessage(
                            "Someone is handling that page, it can not be deleted."
                        );
                ...
                case 7: // page handled
                {
                    if (m_Entry.Handler == state.Mobile)
                    {
                        ...
                        state.Mobile.SendMessage(
                            "You mark the page as handled, and remove it from the queue."
                        );
                ...
                case 8: // Send message
                {
                    ...
                    if (text != null)
                    {
                        ...
                        m_Entry.Sender.SendGump(
                            new MessageSentGump(m_Entry.Sender, state.Mobile.Name, text.Text)
                        );
                ...
                default:
                {
                    ...
                    if (index >= 0 && index < preresp.Count)
                    {
                        m_Entry.AddResponse(
                            state.Mobile,
                            "[PreDef] " + ((PredefinedResponse)preresp[index]).Title
                        );
                        m_Entry.Sender.SendGump(
                            new MessageSentGump(
                                m_Entry.Sender,
