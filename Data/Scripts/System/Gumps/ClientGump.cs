    ...
    public class ClientGump : Gump
    {
            ...
            switch (info.ButtonID)
            {
                ...
                case 8: // Kick
                {
                    if (
                        ...
                        && from.AccessLevel > focus.AccessLevel
                    )
                    {
            ...
            : base(30, 20)
        {
            ...
            AddHtml(
                ...
                200,
                20,
                Color(state.ToString(), LabelColor32),
                false,
                false
            );
            ...
            AddHtml(
                ...
                200,
                20,
                Color(expansionName, LabelColor32),
                false,
                false
            );
            ...
            if (m != null)
            {
                ...
                AddHtml(
                    ...
                    200,
                    20,
                    Color(String.Format("{0} (0x{1:X})", m.Name, m.Serial.Value), LabelColor32),
                    false,
                    false
                );
                ...
                AddHtml(
                    ...
                    200,
                    20,
                    Color(String.Format("{0} [{1}]", m.Location, m.Map), LabelColor32),
                    false,
                    false
                );
                ...
                if (from != m)
                {
                    ...
                    AddHtml(
                        ...
                        100,
                        20,
                        Color("Bring them here", LabelColor32),
                        false,
                        false
                    );
                }
                ...
                AddHtml(
                    ...
                    100,
                    20,
                    Color("Move to target", LabelColor32),
                    false,
                    false
                );
                ...
                if (from.AccessLevel >= AccessLevel.Counselor && from.AccessLevel > m.AccessLevel)
                {
                    ...
                    AddHtml(
                        ...
                        100,
                        20,
                        Color("Skills browser", LabelColor32),
                        false,
                        false
                    );
                }
