...
namespace Server.Gumps
{
    public class ToTAdminGump : Gump
    {
        ...
        {
            //Opening Message
            "<center>Treasures of IslesDread Admin</center><br>"
            ...
            //Treasures of IslesDread 1 message
            "<center>Treasures of IslesDread 1</center><br>"
                + "-10 charge Bleach Pigment can drop as a Lesser Artifact<br>"
                + "-50 charge Neon Pigments available as a reward<br>",
            //Treasures of IslesDread 2 message
            "<center>Treasures of IslesDread 2</center><br>"
            ...
            //Treasures of IslesDread 3 message
            "<center>Treasures of IslesDread 3</center><br>"
            ...
            : base(30, 50)
        {
            ...
            AddLabel(75, 5, 54, "Treasures of IslesDread Admin");
        ...
        public void SetupToTEras()
        {
            ...
            for (int i = 0; i < m_ToTEras; i++)
            {
                ...
                AddLabel(
                    90,
                    70 + yoffset,
                    isThisDropEra ? 167 : 137,
                    isThisDropEra ? "Active" : "Inactive"
                );
                AddButton(
                    180,
                    75 + yoffset,
                ...
                AddLabel(
                    195,
                    70 + yoffset,
                    isThisRewardEra ? 167 : 137,
                    isThisRewardEra ? "Active" : "Inactive"
                );
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (button == 1)
            {
                ...
                from.SendMessage("Treasures of IslesDread Drops have been deactivated");
            }
            else if (button >= 2)
            {
                int selectedToT;
                if (button % 2 == 0)
                {
                    ...
                    from.SendMessage(
                        "Treasures of IslesDread " + selectedToT + " Drops have been enabled"
                    );
                }
                else
                {
                    ...
                    from.SendMessage(
                        "Treasures of IslesDread " + selectedToT + " Rewards have been enabled"
                    );
                }
            }
        }
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(ToTAdmin_OnCommand)
            );
        }

        [Usage("ToTAdmin")]
        [Description("Displays a menu to configure Treasures of IslesDread.")]
