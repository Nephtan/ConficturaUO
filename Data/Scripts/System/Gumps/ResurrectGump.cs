    ...
    public class ResurrectGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            AddHtml(
                ...
                349,
                20,
                @"<BODY><BASEFONT Color=" + color + ">RESURRECTION</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">It is possible for you to be resurrected here by this healer. Do you want to return to the land of the living? If not, you can remain in the spirit realm.</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
                ...
                if (m_Price > 0)
                {
                    if (info.IsSwitched(1))
                    {
                        ...
                        else if (m_Tithe >= m_Price)
                        {
                            ...
                            from.SendMessage(
                                "" + (from.TithingPoints).ToString() + " tithing remains."
                            );
                            Server.Misc.Death.Penalty(from, false);
                            Server.Misc.Death.Penalty(from, false);
                        }
                        ...
                        {
                            from.SendMessage(
                                "You do not have enough gold or tithing tribute to be resurrected by a healer."
                            );
                            return;
                        }
                    }
