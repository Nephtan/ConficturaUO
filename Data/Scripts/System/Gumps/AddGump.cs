    ...
    public class AddGump : Gump
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(AddMenu_OnCommand)
            );
        }
            ...
            : base(50, 50)
        {
            ...
            else
            {
                AddLabel(
                    ...
                    44,
                    0x480,
                    explicitSearch ? "Nothing matched your search terms." : "No results to display."
                );
            }
        ...
        private static void Match(string match, Type[] types, List<Type> results)
        {
            ...
            for (int i = 0; i < types.Length; ++i)
            {
                ...
                if (
                    (typeofMobile.IsAssignableFrom(t) || typeofItem.IsAssignableFrom(t))
                ...
                )
                {
                    ...
                    {
                        if (
                            ctors[j].GetParameters().Length == 0
        ...
        public class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object o)
            {
                ...
                if (p != null)
                {
                    ...
                    Server.Commands.Add.Invoke(
                        from,
                        new Point3D(p),
                        new Point3D(p),
                        new string[] { m_Type.Name }
                    );
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 2: // Previous page
                {
                    if (m_Page > 0)
                        from.SendGump(
                            new AddGump(from, m_SearchString, m_Page - 1, m_SearchResults, true)
                        );
                ...
                default:
                {
                    ...
                    {
                        from.SendMessage(
                            "Where do you wish to place this object? <ESC> to cancel."
                        );
                        from.Target = new InternalTarget(
