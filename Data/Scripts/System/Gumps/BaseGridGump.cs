...
namespace Server.Gumps
{
    public abstract class BaseGridGump : Gump
    {
        ...
        )
        {
            ...
            AddButton(
                m_CurrentX + ((width - buttonWidth) / 2),
                m_CurrentY
                    + (
                        (
                            (EntryHeight * spannedEntries)
                            + (OffsetSize * (spannedEntries - 1))
                            - buttonHeight
                        ) / 2
                    ),
                normalID,
        ...
        public void AddEntryPageButton(
            int width,
            int normalID,
            int pressedID,
            int page,
        ...
        )
        {
            ...
            AddButton(
                m_CurrentX + ((width - buttonWidth) / 2),
                m_CurrentY + ((EntryHeight - buttonHeight) / 2),
                normalID,
                pressedID,
                0,
                GumpButtonType.Page,
