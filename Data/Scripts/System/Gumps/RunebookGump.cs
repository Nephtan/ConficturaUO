...
namespace Server.Gumps
{
    public class RunebookGump : Gump
    {
        ...
        private void AddBackground(Runebook book)
        {
            ...
            if (book.ItemID == 0x22C5 && book.Hue == 0)
            {
                color = 2847;
            }
            else if (book.ItemID == 0x0F3D && book.Hue == 0)
            {
                color = 2881;
            }
            else if (book.ItemID == 0x4F50 && book.Hue == 0)
            {
                color = 2847;
            }
            else if (book.ItemID == 0x4F51 && book.Hue == 0)
            {
                color = 2847;
            }
            else if (book.ItemID == 0x5463 && book.Hue == 0)
            {
                color = 2847;
            }
            else if (book.ItemID == 0x5464 && book.Hue == 0)
            {
                color = 2847;
            }
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + fonts
                    + ">CHARGES: "
                    + m_Book.CurCharges.ToString()
                    + "/"
                    + m_Book.MaxCharges.ToString()
                    + "</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
        ...
        private void AddNavigation()
        {
            ...
            int g = 120;
            AddButton(48, g, btn0, btn0, 0, GumpButtonType.Page, 1);
            g = g + 45;
            AddButton(48, g, btn1, btn1, 0, GumpButtonType.Page, 2);
            g = g + 45;
            AddButton(48, g, btn2, btn2, 0, GumpButtonType.Page, 3);
            g = g + 45;
            AddButton(48, g, btn3, btn3, 0, GumpButtonType.Page, 4);
            g = g + 45;
            AddButton(48, g, btn4, btn4, 0, GumpButtonType.Page, 5);
            g = g + 45;
            AddButton(48, g, btn5, btn5, 0, GumpButtonType.Page, 6);
            g = g + 45;
            AddButton(48, g, btn6, btn6, 0, GumpButtonType.Page, 7);
            g = g + 45;
            AddButton(48, g, btn7, btn7, 0, GumpButtonType.Page, 8);
            g = g + 45;
            AddButton(48, g, btn8, btn8, 0, GumpButtonType.Page, 9);
            g = g + 45;
            AddButton(48, g, btn9, btn9, 0, GumpButtonType.Page, 10);
            g = g + 45;
        }
        ...
        private void AddIndex()
        {
            ...
            AddHtml(
                ...
                137,
                20,
                @"<BODY><BASEFONT Color=" + fonts + ">RENAME BOOK</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            for (int i = 0; i < 16; ++i)
            {
                ...
                if (i < entries.Count)
                {
                    ...
                    world = Server.Misc.Worlds.GetMyWorld(
                        entries[i].Map,
                        entries[i].Location,
                        entries[i].Location.X,
                        entries[i].Location.Y
                    );
                    ...
                    AddHtml(
                        ...
                        313,
                        20,
                        @"<BODY><BASEFONT Color=" + hue + ">" + desc + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    AddHtml(
                        ...
                        268,
                        20,
                        @"<BODY><BASEFONT Color=" + hue + ">" + world + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
        ...
        private void AddInstructions()
        {
            ...
            AddHtml(
                ...
                302,
                20,
                @"<BODY><BASEFONT Color=" + fonts + ">" + title + "</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
        ...
        private void AddDetails(int index, int half)
        {
            ...
            if (filled > 0)
            {
                ...
                AddHtml(
                    ...
                    339,
                    20,
                    @"<BODY><BASEFONT Color=" + hue + ">" + Sextants + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    151,
                    20,
                    @"<BODY><BASEFONT Color=" + hue + ">Set As Default</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    151,
                    20,
                    @"<BODY><BASEFONT Color=" + hue + ">Remove Rune</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    291,
                    20,
                    @"<BODY><BASEFONT Color=" + fonts + ">Astral Travel</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + fonts
                        + "><RIGHT>Black Gate</RIGHT></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    291,
                    20,
                    @"<BODY><BASEFONT Color=" + fonts + ">Demonic Fire</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + fonts
                        + "><RIGHT>Elemental Gate</RIGHT></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    291,
                    20,
                    @"<BODY><BASEFONT Color=" + fonts + ">Elemental Void</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + fonts
                        + "><RIGHT>Ethereal Travel</RIGHT></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    291,
                    20,
                    @"<BODY><BASEFONT Color=" + fonts + ">Gate</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + fonts
                        + "><RIGHT>Mushroom Gateway</RIGHT></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    291,
                    20,
                    @"<BODY><BASEFONT Color=" + fonts + ">Nature Passage</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    291,
                    20,
                    @"<BODY><BASEFONT Color=" + fonts + "><RIGHT>Recall</RIGHT></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    291,
                    20,
                    @"<BODY><BASEFONT Color=" + fonts + ">Sacred Journey</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            if (
                m_Book.Deleted
                || !from.InRange(m_Book.GetWorldLocation(), (Core.ML ? 3 : 1))
                || !Multis.DesignContext.Check(from)
            )
            {
                m_Book.Openers.Remove(from);
                return;
                    ...
                    switch (type)
                    {
                        case 1: // Nature Passage
                        {
                            ...
                            else
                            {
                                ...
                                (
                                    from.Backpack.FindItemByType(typeof(NaturesPassagePotion))
                                ).Consume();
                            }
                            break;
                        }
                        case 2: // Mushroom Gateway
                        {
                            ...
                            else
                            {
                                ...
                                from.AddToBackpack(new Jar());
                                (
                                    from.Backpack.FindItemByType(typeof(MushroomGatewayPotion))
                                ).Consume();
                            }
                            break;
                        }
                        ...
                        case 4: // Black Gate
                        {
                            ...
                            else
                            {
                                ...
                                from.AddToBackpack(new Jar());
                                (
                                    from.Backpack.FindItemByType(typeof(GraveyardGatewayScroll))
                                ).Consume();
                            }
                            break;
                        }
