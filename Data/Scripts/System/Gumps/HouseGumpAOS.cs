    ...
    public class HouseGumpAOS : Gump
    {
        ...
        public void AddPageButton(int x, int y, int buttonID, int number, HouseGumpPageAOS page)
        {
            ...
            AddHtmlLocalized(
                ...
                20,
                number,
                isSelection ? SelectedColor : LabelColor,
                false,
                false
            );
        }
        ...
        public void AddButtonLabeled(int x, int y, int buttonID, int number, bool enabled)
        {
            ...
            AddHtmlLocalized(
                ...
                20,
                number,
                enabled ? LabelColor : DisabledColor,
                false,
                false
            );
        }
        ...
        private static int[] m_HangerNumbers = new int[] { 2968, 2970, 2972, 2974, 2976, 2978 };

        private static int[] m_FoundationNumbers = (
            Core.ML
                ? new int[] { 20, 189, 765, 65, 101, 0x2DF7, 0x2DFB, 0x3672, 0x3676 }
                : new int[] { 20, 189, 765, 65, 101 }
        );
            ...
            : base(50, 40)
        {
            ...
            if (m_House.Sign != null)
            {
                ...
                {
                    for (
                        int i = 0, y = (114 - (lines.Count * 14)) / 2;
                        i < lines.Count;
                        ++i, y += 14
                    )
                    {
            ...
            switch (page)
            {
                ...
                case HouseGumpPageAOS.Storage:
                {
                    ...
                    int curSecures = house.GetAosCurSecures(
                        out fromSecures,
                        out fromVendors,
                        out fromLockdowns,
                        out fromMovingCrate
                    ...
                    if (BaseHouse.NewVendorSystem)
                    {
                        ...
                        AddLabel(
                            ...
                            310,
                            LabelHue,
                            Math.Max(maxLockdowns - curLockdowns, 0).ToString()
                        );
                        ...
                        AddLabel(
                            ...
                            350,
                            LabelHue,
                            vendors.ToString() + " / " + maxVendors.ToString()
                        );
                    }
                    else
                    {
                ...
                case HouseGumpPageAOS.Customize:
                {
                    if (house.Price > 0)
                    {
                        bool isCustomizable =
                            isOwner
                            && (house is HouseFoundation)
                            && Server.Misc.MyServerSettings.AllowCustomHomes();
                        ...
                        if (Server.Misc.MyServerSettings.AllowCustomHomes())
                        {
                            ...
                            AddButtonLabeled(
                                ...
                                isOwner
                                    && isCustomizable
                                    && (((HouseFoundation)house).Signpost != null)
                            ); // Change Signpost
                            AddButtonLabeled(
                                10,
                                280,
                ...
                case HouseGumpPageAOS.ChangeSign:
                {
                    ...
                    for (int i = 0; i < pages; ++i)
                    {
                        ...
                        for (
                            int j = 0;
                            j < signsPerPage && totalSigns - (signsPerPage * i) - j > 0;
                            ++j
                        )
                        {
                            int x = 30 + ((j % 6) * 60);
            ...
            if (okay && house.IsOwner(from) && !house.HasRentedVendors)
            {
                ...
                if (e != null)
                {
                    ...
                    if (newHouse != null)
                    {
                         ...
                         */
                        from.SendGump(
                            new NoticeGump(1060637, 30720, 1060012, 32512, 420, 280, null, null)
                        );
                        return;
                    }
                }
                ...
                case 0:
                {
                    switch (index)
                    {
                        ...
                        case 1: // Lift Ban
                        {
                            if (m_House.Public)
                                from.SendGump(
                                    new HouseGumpAOS(HouseGumpPageAOS.RemoveBan, from, m_House)
                                );
                        ...
                        case 3: // Revoke Access
                        {
                            if (!m_House.Public)
                                from.SendGump(
                                    new HouseGumpAOS(HouseGumpPageAOS.RemoveAccess, from, m_House)
                                );
                ...
                case 3:
                {
                    switch (index)
                    {
                        case 0: // View Co-Owner List
                        {
                            if (isCoOwner)
                                from.SendGump(
                                    new HouseGumpAOS(HouseGumpPageAOS.ListCoOwner, from, m_House)
                                );
                        ...
                        case 2: // Remove a Co-Owner
                        {
                            if (isOwner)
                                from.SendGump(
                                    new HouseGumpAOS(HouseGumpPageAOS.RemoveCoOwner, from, m_House)
                                );
                            ...
                            if (isOwner)
                                from.SendGump(
                                    new WarningGump(
                                        ...
                                        420,
                                        280,
                                        new WarningGumpCallback(ClearCoOwners_Callback),
                                        m_House
                                    )
                                );
                        ...
                        {
                            from.SendGump(
                                new HouseGumpAOS(HouseGumpPageAOS.ListFriend, from, m_House)
                            );
                        ...
                        case 6: // Remove a Friend
                        {
                            if (isCoOwner)
                                from.SendGump(
                                    new HouseGumpAOS(HouseGumpPageAOS.RemoveFriend, from, m_House)
                                );
                            ...
                            if (isCoOwner)
                                from.SendGump(
                                    new WarningGump(
                                        ...
                                        420,
                                        280,
                                        new WarningGumpCallback(ClearFriends_Callback),
                                        m_House
                                    )
                                );
                        ...
                        {
                            from.SendGump(
                                new HouseGumpAOS(HouseGumpPageAOS.ListBan, from, m_House)
                            );
                        ...
                        case 9: // Clear Ban List
                        {
                            from.SendGump(
                                new WarningGump(
                                    ...
                                    420,
                                    280,
                                    new WarningGumpCallback(ClearBans_Callback),
                                    m_House
                                )
                            );
                        ...
                        {
                            from.SendGump(
                                new HouseGumpAOS(HouseGumpPageAOS.ListAccess, from, m_House)
                            );
                        ...
                        case 11: // Clear Access List
                        {
                            from.SendGump(
                                new WarningGump(
                                    ...
                                    420,
                                    280,
                                    new WarningGumpCallback(ClearAccess_Callback),
                                    m_House
                                )
                            );
                                ...
                                if (m_House.PlayerVendors.Count > 0)
                                {
                                    ...
                                    from.SendGump(
                                        new NoticeGump(
                                            ...
                                            320,
                                            180,
                                            new NoticeGumpCallback(PublicPrivateNotice_Callback),
                                            m_House
                                        )
                                    );
                                    break;
                    ...
                    switch (index)
                    {
                                ...
                                if (m_House.HasRentedVendors)
                                {
                                    ...
                                    from.SendGump(
                                        new NoticeGump(
                                            ...
                                            320,
                                            180,
                                            new NoticeGumpCallback(CustomizeNotice_Callback),
                                            m_House
                                        )
                                    );
                                }
                                    ...
                                    if (e != null)
                                    {
                                        ...
                                        from.SendGump(
                                            new WarningGump(
                                                ...
                                                420,
                                                280,
                                                new WarningGumpCallback(ConvertHouse_Callback),
                                                m_House
                                            )
                                        );
                                    }
                        ...
                        case 3: // Change House Sign
                        {
                            if (isOwner && m_House.Public)
                                from.SendGump(
                                    new HouseGumpAOS(HouseGumpPageAOS.ChangeSign, from, m_House)
                                );
                        ...
                        case 4: // Change House Sign Hanger
                        {
                            if (isOwner && isCustomizable)
                                from.SendGump(
                                    new HouseGumpAOS(HouseGumpPageAOS.ChangeHanger, from, m_House)
                                );
                        ...
                        case 5: // Change Signpost
                        {
                            if (isOwner && isCustomizable && foundation.Signpost != null)
                                from.SendGump(
                                    new HouseGumpAOS(HouseGumpPageAOS.ChangePost, from, m_House)
                                );
                        ...
                        case 6: // Change Foundation Style
                        {
                            if (isOwner && isCustomizable)
                                from.SendGump(
                                    new HouseGumpAOS(
                                        HouseGumpPageAOS.ChangeFoundation,
                                        from,
                                        m_House
                                    )
                                );
                    ...
                    switch (index)
                    {
                        case 0: // Demolish
                        {
                            if (
                                ...
                                && m_House.InternalizedVendors.Count == 0
                            )
                            {
                                if (
                ...
                case 10:
                {
                    if (isOwner && m_List != null && index >= 0 && index < m_List.Count)
                    {
                        ...
                        if (m_House.CoOwners.Count > 0)
                            ...
                            from.SendGump(
                                new HouseGumpAOS(HouseGumpPageAOS.Security, from, m_House)
                            );
                    }
