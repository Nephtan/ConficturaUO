    ...
    public class CreateGuildGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            AddHtml(
                ...
                479,
                20,
                @"<BODY><BASEFONT Color=" + color + ">GUILD MENU</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">As you are not a member of any guild, you can create your own by providing a unique guild name and paying the standard guild registration fee.</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                146,
                20,
                @"<BODY><BASEFONT Color=" + color + ">Registration Fee:</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddHtml(
            ...
            AddHtml(
                ...
                146,
                20,
                @"<BODY><BASEFONT Color=" + color + ">Enter Guild Name:</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                146,
                20,
                @"<BODY><BASEFONT Color=" + color + ">Abbreviation:</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                200,
                20,
                @"<BODY><BASEFONT Color=" + color + ">Ignore Guild Invites</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
        }
            ...
            switch (info.ButtonID)
            {
                case 1:
                {
                    ...
                    if (guildName.Length <= 0)
                        ...
                        Guild.FindByAbbrev(guildAbbrev) != null
                        || !BaseGuildGump.CheckProfanity(guildAbbrev)
                    )
                        pm.SendLocalizedMessage(501153); // That abbreviation is not available.
                    else if (
                        Guild.FindByName(guildName) != null
                        || !BaseGuildGump.CheckProfanity(guildName)
                    )
