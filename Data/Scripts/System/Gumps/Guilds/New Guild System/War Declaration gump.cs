    ...
    public class WarDeclarationGump : BaseGuildGump
    {
            ...
            : base(pm, g)
        {
            ...
            AddTextEntry(
                ...
                0x481,
                10,
                (war != null) ? war.WarLength.Hours.ToString() : "0"
            );
                        ...
                        if (activeWar == null)
                        {
                            ...
                            int maxKills =
                                (tKills == null)
                                    ...
                                    : Math.Max(
                                        Math.Min(
                                            Utility.ToInt32(info.GetTextEntry(11).Text),
                                            0xFFFF
                                        ),
                                        0
                                    );
                            TimeSpan warLength = TimeSpan.FromHours(
                                (tWarLength == null)
                                    ? 0
                                    : Math.Max(
                                        Math.Min(
                                            Utility.ToInt32(info.GetTextEntry(10).Text),
                                            0xFFFF
                                        ),
                                        0
                                    )
                            ...
                            {
                                guild.PendingWars.Add(
                                    new WarDeclaration(guild, m_Other, maxKills, warLength, true)
                                );
                            }
                            ...
                            {
                                m_Other.PendingWars.Add(
                                    new WarDeclaration(m_Other, guild, maxKills, warLength, false)
                                );
                            }
                            ...
                            pm.SendLocalizedMessage(
                                1070751,
                                ((m_Other.Alliance != null) ? m_Other.Alliance.Name : m_Other.Name)
