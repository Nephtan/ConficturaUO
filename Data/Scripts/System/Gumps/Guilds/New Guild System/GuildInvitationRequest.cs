    ...
    public class GuildInvitationRequest : BaseGuildGump
    {
        ...
        public override void PopulateGump()
        {
            ...
            AddHtml(
                ...
                479,
                20,
                @"<BODY><BASEFONT Color=" + color + ">GUILD INVITATION</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">You have been invited to join a guild!<BR>(Warning: Accepting will make you attackable!)</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    m_Inviter.SendLocalizedMessage(
                        1063250,
                        String.Format("{0}\t{1}", player.Name, guild.Name)
