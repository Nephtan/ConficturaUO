...
namespace Server.Guilds
{
    public abstract class BaseGuildListGump<T> : BaseGuildGump
    {
        ...
        {
            player.SendGump(
                GetResentGump(player, guild, m_Comparer, m_Ascending, m_Filter, m_StartNumber)
            );
        }
    }
