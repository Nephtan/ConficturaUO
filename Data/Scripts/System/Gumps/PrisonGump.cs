    ...
    public class PrisonGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            AddHtml(
                ...
                415,
                20,
                @"<BODY><BASEFONT Color=" + color + ">SENT TO PRISON</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
