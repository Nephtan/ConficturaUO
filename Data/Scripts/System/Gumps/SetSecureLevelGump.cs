...
namespace Server.Gumps
{
    ...
    public class SetSecureLevelGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            if (Server.Misc.MyServerSettings.HouseOwners())
            {
                ...
                AddButton(
                    10,
                    90,
                    GetFirstID(SecureLevel.Friends),
                    4007,
                    3,
            ...
            else
            {
                ...
                AddButton(
                    10,
                    90,
                    GetFirstID(SecureLevel.CoOwners),
                    4007,
                    2,
                    GumpButtonType.Reply,
                    0
