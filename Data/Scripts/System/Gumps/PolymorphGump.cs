...
namespace Server.Gumps
{
    ...
    {
        public static readonly PolymorphEntry Chicken = new PolymorphEntry(
            8401,
            0xD0,
            1015236,
            15,
        ...
        public static readonly PolymorphEntry Wolf = new PolymorphEntry(
            8426,
            0xE1,
            1015238,
            18,
        ...
        public static readonly PolymorphEntry Panther = new PolymorphEntry(
            8473,
            0xD6,
            1015239,
            20,
        ...
        public static readonly PolymorphEntry Gorilla = new PolymorphEntry(
            8437,
            0x1D,
            1015240,
            23,
        ...
        public static readonly PolymorphEntry BlackBear = new PolymorphEntry(
            8399,
            0xD3,
            1015241,
            22,
        ...
        public static readonly PolymorphEntry GrizzlyBear = new PolymorphEntry(
            8411,
            0xD4,
            1015242,
            22,
        ...
        public static readonly PolymorphEntry PolarBear = new PolymorphEntry(
            8417,
            0xD5,
            1015243,
            26,
        ...
        public static readonly PolymorphEntry HumanMale = new PolymorphEntry(
            8397,
            0x190,
            1015244,
            29,
        ...
        public static readonly PolymorphEntry HumanFemale = new PolymorphEntry(
            8398,
            0x191,
            1015254,
            29,
        ...
        public static readonly PolymorphEntry Slime = new PolymorphEntry(
            8424,
            0x33,
            1015246,
            5,
        ...
        public static readonly PolymorphEntry LizardMan = new PolymorphEntry(
            8414,
            0x21,
            1015248,
            26,
        ...
        public static readonly PolymorphEntry Gargoyle = new PolymorphEntry(
            8409,
            0x04,
            1015249,
            22,
        ...
        public static readonly PolymorphEntry Troll = new PolymorphEntry(
            8425,
            0x36,
            1015251,
            25,
        ...
        public static readonly PolymorphEntry Ettin = new PolymorphEntry(
            8408,
            0x02,
            1015252,
            25,
        ...
        public static readonly PolymorphEntry Daemon = new PolymorphEntry(
            8403,
            0x09,
            1015253,
            25,
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            if (info.ButtonID == 1 && info.Switches.Length > 0)
            {
                ...
                if (cat >= 0 && cat < Categories.Length)
                {
                    ...
                    {
                        Spell spell = new PolymorphSpell(
                            m_Caster,
                            m_Scroll,
                            Categories[cat].Entries[ent].BodyID
                        );
                        spell.Cast();
                    }
                }
