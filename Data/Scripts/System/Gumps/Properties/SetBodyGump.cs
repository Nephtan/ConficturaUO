            ...
            : base(20, 30)
        {
            ...
            else if (ourList.Count == 0)
            {
                AddLabel(
                    ...
                    40,
                    0x480,
                    "The server must have UO:3D installed to use this feature."
                );
            }
            else
            {
                for (
                    int i = 0, index = (ourPage * 12);
                    i < 12 && index >= 0 && index < ourList.Count;
                    ++i, ++index
                )
                {
                    ...
                    AddHtml(
                        ...
                        108,
                        21,
                        Color(Center(entry.DisplayName), TextColor32),
                        false,
                        false
                    );
                }
