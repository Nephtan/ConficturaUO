    ...
    public class ViewHousesGump : Gump
    {
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(ViewHouses_OnCommand)
            );
        }
        ...
        public static void ViewHouses_OnCommand(CommandEventArgs e)
        {
            e.Mobile.BeginTarget(
                ...
                false,
                TargetFlags.None,
                new TargetCallback(ViewHouses_OnTarget)
            );
        }
            ...
            : base(50, 40)
        {
            ...
            if (sel == null || sel.Deleted)
            {
                ...
                if (list.Count == 0)
                    AddHtml(
                        ...
                        160,
                        40,
                        Color("There were no houses found for that player.", White),
                        false,
                        false
                    );
                ...
                for (int i = 0; i < list.Count; ++i)
                {
                    ...
                    AddHtml(
                        ...
                        20,
                        20,
                        Color(String.Format("{0}.", i + 1), White),
                        false,
                        false
                    );
            ...
            else
            {
                ...
                AddHtml(
                    ...
                    210,
                    20,
                    Color(Right(map == null ? "(null)" : map.Name), White),
                    false,
                    false
                );
                ...
                AddHtml(
                    ...
                    210,
                    20,
                    Color(Right(sel.Location.ToString()), White),
                    false,
                    false
                );
                ...
                AddHtml(
                    ...
                    210,
                    20,
                    Color(Right(sel.Friends.Count.ToString()), White),
                    false,
                    false
                );
                ...
                AddHtml(
                    ...
                    210,
                    20,
                    Color(Right(sel.CoOwners.Count.ToString()), White),
                    false,
                    false
                );
                ...
                AddHtml(
                    ...
                    210,
                    20,
                    Color(Right(sel.Bans.Count.ToString()), White),
                    false,
                    false
                );
                ...
                AddHtml(
                    ...
                    210,
                    20,
                    Color(Right(sel.CanDecay ? "Yes" : "No"), White),
                    false,
                    false
                );
                ...
                AddHtml(
                    ...
                    210,
                    20,
                    Color(Right(sel.DecayLevel.ToString()), White),
                    false,
                    false
                );
