    ...
    public class ReportMurdererGump : Gump
    {
        ...
        public static void EventSink_PlayerDeath(PlayerDeathEventArgs e)
        {
            ...
            foreach (AggressorInfo ai in m.Aggressors)
            {
                ...
                if (
                    ai.Attacker.Player
                    && (DateTime.Now - ai.LastCombatTime) < TimeSpan.FromSeconds(30.0)
            ...
            : base(50, 50)
        {
            ...
            AddHtml(
                ...
                200,
                20,
                @"<BODY><BASEFONT Color=" + color + ">MURDERED!</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">You have been murdered! Would you like to report this crime to the captain of the town guard? If so, their murder count will increase.</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
