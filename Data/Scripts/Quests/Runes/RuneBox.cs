...
namespace Server.Items
{
    public class RuneBox : Item
    {
        ...
        public Mobile RuneBox_Owner
        {
            get { return RuneBoxOwner; }
            set { RuneBoxOwner = value; }
        }

        public int HasCompassion;

        [CommandProperty(AccessLevel.Owner)]
        public int Has_Compassion
        {
            get { return HasCompassion; }
            set
            {
                HasCompassion = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Has_Honesty
        {
            get { return HasHonesty; }
            set
            {
                HasHonesty = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Has_Humility
        {
            get { return HasHumility; }
            set
            {
                HasHumility = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Has_Justice
        {
            get { return HasJustice; }
            set
            {
                HasJustice = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Has_Sacrifice
        {
            get { return HasSacrifice; }
            set
            {
                HasSacrifice = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Has_Spirituality
        {
            get { return HasSpirituality; }
            set
            {
                HasSpirituality = value;
                InvalidateProperties();
            }
        }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (RuneBoxOwner != null)
            {
                list.Add(1049644, "Belongs to " + RuneBoxOwner.Name + "");
            }
        }
            ...
            else if ((inVirtues || inCorrupt) && runes > 7)
            {
                ...
                if (inVirtues)
                {
                    ...
                    from.LocalOverheadMessage(
                        ...
                        1150,
                        true,
                        "You have cleansed the Runes in the Chamber of Virtue."
                    );
                ...
                else
                {
                    ...
                    from.LocalOverheadMessage(
                        ...
                        1150,
                        true,
                        "You have corrupted the Runes of Virtue."
                    );
                    ...
                    box.Hue = color;
                    from.SendMessage(
                        "You have gain a really large amount of fame and lost a really large amount of karma."
                    );
                ...
                DDRelicPainting tapestry1 = new DDRelicPainting();
                tapestry1.Name = "Tapestry of " + virtue1;
                tapestry1.ItemID = 0x49A8;
                tapestry1.RelicGoldValue = Utility.RandomMinMax(10, 20) * 50;
                tapestry1.Hue = tint;
                box.DropItem(tapestry1);
                DDRelicPainting tapestry2 = new DDRelicPainting();
                tapestry2.Name = "Tapestry of " + virtue2;
                tapestry2.ItemID = 0x49A2;
                tapestry2.RelicGoldValue = Utility.RandomMinMax(10, 20) * 50;
                tapestry2.Hue = tint;
                box.DropItem(tapestry2);
                DDRelicPainting tapestry3 = new DDRelicPainting();
                tapestry3.Name = "Tapestry of " + virtue3;
                tapestry3.ItemID = 0x49B2;
                tapestry3.RelicGoldValue = Utility.RandomMinMax(10, 20) * 50;
                tapestry3.Hue = tint;
                box.DropItem(tapestry3);
                DDRelicPainting tapestry4 = new DDRelicPainting();
                tapestry4.Name = "Tapestry of " + virtue4;
                tapestry4.ItemID = 0x49A3;
                tapestry4.RelicGoldValue = Utility.RandomMinMax(10, 20) * 50;
                tapestry4.Hue = tint;
                box.DropItem(tapestry4);
                DDRelicPainting tapestry5 = new DDRelicPainting();
                tapestry5.Name = "Tapestry of " + virtue5;
                tapestry5.ItemID = 0x49A7;
                tapestry5.RelicGoldValue = Utility.RandomMinMax(10, 20) * 50;
                tapestry5.Hue = tint;
                box.DropItem(tapestry5);
                DDRelicPainting tapestry6 = new DDRelicPainting();
                tapestry6.Name = "Tapestry of " + virtue6;
                tapestry6.ItemID = 0x49A0;
                tapestry6.RelicGoldValue = Utility.RandomMinMax(10, 20) * 50;
                tapestry6.Hue = tint;
                box.DropItem(tapestry6);
                DDRelicPainting tapestry7 = new DDRelicPainting();
                tapestry7.Name = "Tapestry of " + virtue7;
                tapestry7.ItemID = 0x49A1;
                tapestry7.RelicGoldValue = Utility.RandomMinMax(10, 20) * 50;
                tapestry7.Hue = tint;
                box.DropItem(tapestry7);
                DDRelicPainting tapestry8 = new DDRelicPainting();
                tapestry8.Name = "Tapestry of " + virtue8;
                tapestry8.ItemID = 0x49B3;
                tapestry8.RelicGoldValue = Utility.RandomMinMax(10, 20) * 50;
                tapestry8.Hue = tint;
                box.DropItem(tapestry8);
                ...
                Item crystals = new Crystals(Utility.RandomMinMax(1000, 2000));
                box.DropItem(crystals);
                Item jewels = new DDJewels(Utility.RandomMinMax(2000, 4000));
                box.DropItem(jewels);
                Item gold = new Gold(Utility.RandomMinMax(4000, 6000));
                box.DropItem(gold);
                Item silver = new DDSilver(Utility.RandomMinMax(6000, 8000));
                box.DropItem(silver);
                Item copper = new DDCopper(Utility.RandomMinMax(8000, 10000));
                box.DropItem(copper);
                Item gemstones = new DDGemstones(Utility.RandomMinMax(1000, 2000));
                box.DropItem(gemstones);
                Item goldnuggets = new DDGoldNuggets(Utility.RandomMinMax(2000, 30000));
                box.DropItem(goldnuggets);
        ...
        private class RuneBoxGump : Gump
        {
            ...
            public RuneBoxGump(RuneBox box, Mobile from)
                : base(50, 50)
            {
                ...
                AddHtml(
                    ...
                    627,
                    20,
                    @"<BODY><BASEFONT Color=" + hue + ">RUNES OF VIRTUE</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
