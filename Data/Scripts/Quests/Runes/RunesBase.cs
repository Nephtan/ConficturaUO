...
namespace Server.Items
{
    public class RunesBase : BaseAddon
    {
        ...
        public RunesBase(Serial serial)
            : base(serial) { }
        ...
        public override void OnComponentUsed(AddonComponent ac, Mobile from)
        {
            ...
            else if (from is PlayerMobile)
            {
                ...
                if (
                    PlayerSettings.GetKeys(from, "Virtue")
                    || PlayerSettings.GetKeys(from, "Corrupt")
                ) // THEY ARE ALREADY DID THIS QUEST
                {
                    HasBox = true;
                    from.SendMessage(
                        "You don't need this chest as you already dealt with the runes."
                    );
                }
