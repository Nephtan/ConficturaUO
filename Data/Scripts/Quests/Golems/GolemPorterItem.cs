...
namespace Server.Items
{
    public class GolemPorterItem : Item
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Porter_Hue
        {
            get { return PorterHue; }
            set
            {
                PorterHue = value;
                InvalidateProperties();
        ...
        public GolemPorterItem(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                {
                    friend.Delete();
                    friend = new GolemFighter();
                    ((GolemFighter)friend).PorterExodus = this.PorterExodus;
                }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (PorterName != "a golem")
            {
                sType = PorterName + " the golem";
            }
