    ...
    public class GolemManual : Item
    {
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            if (from != null)
            {
                ...
                int WhatIsExtra = WhatIsDropped - WhatIsNeeded;
                if (WhatIsExtra < 1)
                {
                    WhatIsExtra = 0;
                }
                ...
                if (
                    NeedMetalType == "valorite ingots"
                    && dropped is ValoriteIngot
                    && NeedMetalQty > HaveMetalQty
                )
                {
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new ValoriteIngot(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                    ...
                    NeedMetalType == "verite ingots"
                    && dropped is VeriteIngot
                    && NeedMetalQty > HaveMetalQty
                )
                {
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new VeriteIngot(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                    ...
                    NeedMetalType == "agapite ingots"
                    && dropped is AgapiteIngot
                    && NeedMetalQty > HaveMetalQty
                )
                {
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new AgapiteIngot(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                    ...
                    NeedMetalType == "golden ingots"
                    && dropped is GoldIngot
                    && NeedMetalQty > HaveMetalQty
                )
                {
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new GoldIngot(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                    ...
                    NeedMetalType == "bronze ingots"
                    && dropped is BronzeIngot
                    && NeedMetalQty > HaveMetalQty
                )
                {
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new BronzeIngot(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                    ...
                    NeedMetalType == "copper ingots"
                    && dropped is CopperIngot
                    && NeedMetalQty > HaveMetalQty
                )
                {
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new CopperIngot(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                    ...
                    NeedMetalType == "shadow iron ingots"
                    && dropped is ShadowIronIngot
                    && NeedMetalQty > HaveMetalQty
                )
                {
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new ShadowIronIngot(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                    ...
                    HaveMetalQty = HaveMetalQty + iAmount;
                    from.SendMessage(
                        "You added " + iAmount.ToString() + " shadow iron ingot" + sEnd
                    );
                    dropped.Delete();
                    return true;
                }
                else if (
                    NeedMetalType == "dull copper ingots"
                    && dropped is DullCopperIngot
                    && NeedMetalQty > HaveMetalQty
                )
                {
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new DullCopperIngot(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                    ...
                    HaveMetalQty = HaveMetalQty + iAmount;
                    from.SendMessage(
                        "You added " + iAmount.ToString() + " dull copper ingot" + sEnd
                    );
                    dropped.Delete();
                    return true;
                }
                else if (
                    NeedMetalType == "iron ingots"
                    && dropped is IronIngot
                    && NeedMetalQty > HaveMetalQty
                )
                {
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new IronIngot(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                ...
                else if (dropped is DarkCoreExodus && HaveDarkCore == 0)
                {
                    ...
                    HaveDarkCore = 1;
                    from.SendMessage(
                        "Against most other's judgement, you added the dark core of Exodus."
                    );
                    dropped.Delete();
                    return true;
                }
                ...
                else if (dropped is ArcaneGem && NeedGems > HaveGems)
                {
                    ...
                    if (dropped.Amount > 1)
                    {
                        from.SendMessage("You added arcane gems.");
                    }
                    else
                    {
                        from.SendMessage("You added an arcane gem.");
                    }
                ...
                else if (dropped is BottleOil && NeedOil > HaveOil)
                {
                    ...
                    WhatIsExtra = WhatIsDropped - WhatIsNeeded;
                    if (WhatIsExtra < 1)
                    {
                        WhatIsExtra = 0;
                    }
                    ...
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new BottleOil(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                    ...
                    from.SendMessage(
                        "You added " + iAmount.ToString() + " technomancer oil" + sEnd
                    );
                    dropped.Delete();
                    return true;
                }
                else if (dropped is Gears && NeedGears > HaveGears)
                {
                    ...
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new Gears(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                ...
                else if (dropped is Springs && NeedSprings > HaveSprings)
                {
                    ...
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new Springs(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
        ...
        public GolemManual(Serial serial)
            : base(serial) { }
        ...
        public static string GetRandomTinker()
        {
            ...
            foreach (Mobile target in World.Mobiles.Values)
                if (target is BaseVendor)
                {
                    ...
                    {
                        if (
                            (target is Tinker || target is TinkerGuildmaster)
        ...
        public static bool ProcessGolemBook(Mobile m, Mobile tinker, Item dropped)
        {
            ...
            if (
                Server.Misc.Worlds.GetRegionName(tinker.Map, tinker.Location) != book.TinkerLocation
            )
            {
                return false;
            }
            ...
            if (GoldReturn > 0)
            {
                ...
                tinker.Say("Here is " + GoldReturn.ToString() + " gold back for all of your help.");
            }

            if (book.GolemType == "a Valorite Golem")
            {
                PortColor = MaterialInfo.GetMaterialColor("valorite", "monster", 0);
                ExodusBoost = 9;
            }
            else if (book.GolemType == "a Verite Golem")
            {
                PortColor = MaterialInfo.GetMaterialColor("verite", "monster", 0);
                ExodusBoost = 8;
            }
            else if (book.GolemType == "an Agapite Golem")
            {
                PortColor = MaterialInfo.GetMaterialColor("agapite", "monster", 0);
                ExodusBoost = 7;
            }
            else if (book.GolemType == "a Golden Golem")
            {
                PortColor = MaterialInfo.GetMaterialColor("gold", "monster", 0);
                ExodusBoost = 6;
            }
            else if (book.GolemType == "a Bronze Golem")
            {
                PortColor = MaterialInfo.GetMaterialColor("bronze", "monster", 0);
                ExodusBoost = 5;
            }
            else if (book.GolemType == "a Copper Golem")
            {
                PortColor = MaterialInfo.GetMaterialColor("copper", "monster", 0);
                ExodusBoost = 4;
            }
            else if (book.GolemType == "a Shadow Iron Golem")
            {
                PortColor = MaterialInfo.GetMaterialColor("shadow iron", "monster", 0);
                ExodusBoost = 3;
            }
            else if (book.GolemType == "a Dull Copper Golem")
            {
                PortColor = MaterialInfo.GetMaterialColor("dull copper", "monster", 0);
                ExodusBoost = 2;
            }
            ...
            {
                ball.PorterExodus = ExodusBoost;
                PortColor = 2118;
                QuestLog = QuestLog + " with the dark core of Exodus";
            }
        ...
        public class GolemManualGump : Gump
        {
            ...
            public GolemManualGump(Mobile from, GolemManual gBook)
                : base(100, 100)
            {
                m_Book = gBook;
                string color = "#c5c5c5";
                ...
                AddHtml(
                    ...
                    119,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Ingots</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    119,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Clockworks</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    119,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Crystals</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    119,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Arcane Gems</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    119,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Gears</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    119,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Oil</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    119,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Springs</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
        ...
        public string g_TinkerLocation
        {
            get { return TinkerLocation; }
            set { TinkerLocation = value; }
        }

        public string GolemType;

        [CommandProperty(AccessLevel.GameMaster)]
        public string g_GolemType
        {
            get { return GolemType; }
            set { GolemType = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string g_NeedMetalType
        {
            get { return NeedMetalType; }
            set { NeedMetalType = value; }
        }

        public int NeedMetalQty;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedMetalQty
        {
            get { return NeedMetalQty; }
            set { NeedMetalQty = value; }
        }

        public int NeedSprings;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedSprings
        {
            get { return NeedSprings; }
            set { NeedSprings = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedCrystals
        {
            get { return NeedCrystals; }
            set { NeedCrystals = value; }
        }

        public int NeedClocks;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedClocks
        {
            get { return NeedClocks; }
            set { NeedClocks = value; }
        }

        public int NeedGems;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedGems
        {
            get { return NeedGems; }
            set { NeedGems = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedGears
        {
            get { return NeedGears; }
            set { NeedGears = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveMetalQty
        {
            get { return HaveMetalQty; }
            set { HaveMetalQty = value; }
        }

        public int HaveDarkCore;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveDarkCore
        {
            get { return HaveDarkCore; }
            set { HaveDarkCore = value; }
        }

        public int HaveSprings;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveSprings
        {
            get { return HaveSprings; }
            set { HaveSprings = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveCrystals
        {
            get { return HaveCrystals; }
            set { HaveCrystals = value; }
        }

        public int HaveClocks;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveClocks
        {
            get { return HaveClocks; }
            set { HaveClocks = value; }
        }

        public int HaveGems;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveGems
        {
            get { return HaveGems; }
            set { HaveGems = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveGears
        {
            get { return HaveGears; }
            set { HaveGears = value; }
        }
    }
}
