...
namespace Server.Mobiles
{
    ...
    public class GolemFighter : BaseCreature
    {
        ...
        public int Fighter_Exodus
        {
            get { return PorterExodus; }
            set
            {
                PorterExodus = value;
        ...
        {
            get { return m_NextTalking; }
            set { m_NextTalking = value; }
        }
        ...
        public GolemFighter(Serial serial)
            : base(serial) { }
        ...
        public override void OnAfterSpawn()
        {
            ...
            else if (Hue == MaterialInfo.GetMaterialColor("dull copper", "monster", 0))
            {
                scalar = 1.1;
            }
            else if (Hue == MaterialInfo.GetMaterialColor("shadow iron", "monster", 0))
            {
                scalar = 1.2;
            }
            else if (Hue == MaterialInfo.GetMaterialColor("copper", "monster", 0))
            {
                scalar = 1.3;
            }
            else if (Hue == MaterialInfo.GetMaterialColor("bronze", "monster", 0))
            {
                scalar = 1.4;
            }
            else if (Hue == MaterialInfo.GetMaterialColor("gold", "monster", 0))
            {
                scalar = 1.5;
            }
            else if (Hue == MaterialInfo.GetMaterialColor("agapite", "monster", 0))
            {
                scalar = 1.6;
            }
            else if (Hue == MaterialInfo.GetMaterialColor("verite", "monster", 0))
            {
                scalar = 1.7;
            }
            else if (Hue == MaterialInfo.GetMaterialColor("valorite", "monster", 0))
            {
                scalar = 1.8;
            }
            else if (Hue == 2118)
            {
                ...
                else if (PorterExodus == 2)
                {
                    scalar = 1.8;
                }
                else if (PorterExodus == 3)
                {
                    scalar = 1.9;
                }
                else if (PorterExodus == 4)
                {
                    scalar = 2.0;
                }
                else if (PorterExodus == 5)
                {
                    scalar = 2.1;
                }
                else if (PorterExodus == 6)
                {
                    scalar = 2.2;
                }
                else if (PorterExodus == 7)
                {
                    scalar = 2.3;
                }
                else if (PorterExodus == 8)
                {
                    scalar = 2.4;
                }
                else if (PorterExodus == 9)
                {
                    scalar = 2.5;
                }
            }
