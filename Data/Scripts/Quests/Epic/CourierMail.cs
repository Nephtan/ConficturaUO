...
namespace Server.Items
{
    public class CourierMail : Item
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string For_Alignment
        {
            get { return ForAlignment; }
            set
            {
                ForAlignment = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Msg_Complete
        {
            get { return MsgComplete; }
            set
            {
                MsgComplete = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Msg_Reward
        {
            get { return MsgReward; }
            set
            {
                MsgReward = value;
                InvalidateProperties();
        ...
        [Constructable]
        public CourierMail(Mobile from)
            : base(0x2159)
        {
            Weight = 1.0;
            Hue = 0x9C4;
                ...
                : base(100, 100)
            {
                ...
                if (scroll.MsgComplete > 0)
                {
                    sText =
                        ...
                        + "'. Return to "
                        + scroll.ForWho
                        + " and bring them this message.<br><br>"
                        + sText;
                }
        ...
        public CourierMail(Serial serial)
            : base(serial) { }
