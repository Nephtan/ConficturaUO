...
namespace Server.Items
{
    ...
    public class Coffer : Container
    {
        ...
        public int Coffer_Robbed
        {
            get { return CofferRobbed; }
            set
            {
                CofferRobbed = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Coffer_Robber
        {
            get { return CofferRobber; }
            set
            {
                CofferRobber = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Coffer_Gold
        {
            get { return CofferGold; }
            set
            {
                CofferGold = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Coffer_Type
        {
            get { return CofferType; }
            set
            {
                CofferType = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Mobile Coffer_SnooperA
        {
            get { return CofferSnooperA; }
            set
            {
                CofferSnooperA = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Mobile Coffer_SnooperB
        {
            get { return CofferSnooperB; }
            set
            {
                CofferSnooperB = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Mobile Coffer_SnooperC
        {
            get { return CofferSnooperC; }
            set
            {
                CofferSnooperC = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Mobile Coffer_SnooperD
        {
            get { return CofferSnooperD; }
            set
            {
                CofferSnooperD = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Mobile Coffer_SnooperE
        {
            get { return CofferSnooperE; }
            set
            {
                CofferSnooperE = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Coffer_Town
        {
            get { return CofferTown; }
            set
            {
                CofferTown = value;
                InvalidateProperties();
        ...
        public static bool GetSnooper(Coffer coffer, Mobile from)
        {
            ...
            if (coffer.CofferSnooperA == from)
            {
                AlreadySnooped = true;
            }
            else if (coffer.CofferSnooperB == from)
            {
                AlreadySnooped = true;
            }
            else if (coffer.CofferSnooperC == from)
            {
                AlreadySnooped = true;
            }
            else if (coffer.CofferSnooperD == from)
            {
                AlreadySnooped = true;
            }
            else if (coffer.CofferSnooperE == from)
            {
                AlreadySnooped = true;
            }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (Server.Items.Coffer.GetSnooper(this, from))
            {
                ...
                {
                    from.SendMessage(
                        "Use your stealing skill on the coffer if you want the "
                            + CofferGold
                            + " gold."
                    );
                }
