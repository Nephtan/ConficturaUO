...
namespace Server.Items
{
    ...
    public class HollowStump : Item
    {
        ...
        public string Stump_Town
        {
            get { return StumpTown; }
            set
            {
                StumpTown = value;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 2))
            {
                ...
                if (from.Backpack.FindItemByType(typeof(ThiefNote)) != null)
                {
                    ...
                    if (
                        envelope.NoteOwner == from
                        && envelope.NoteItemGot > 0
                        && StumpTown == envelope.NoteDeliverTo
                        && envelope.NoteDeliverType == 1
                    )
                    {
        ...
        public HollowStump(Serial serial)
            : base(serial) { }
