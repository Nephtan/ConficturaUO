...
namespace Server.Items
{
    public class ThiefNote : Item
    {
        ...
        public Mobile Note_Owner
        {
            get { return NoteOwner; }
            set { NoteOwner = value; }
        }
        ...
        public string Note_ItemCategory
        {
            get { return NoteItemCategory; }
            set
            {
                NoteItemCategory = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Note_ItemGot
        {
            get { return NoteItemGot; }
            set
            {
                NoteItemGot = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Note_ItemArea
        {
            get { return NoteItemArea; }
            set
            {
                NoteItemArea = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Note_ItemPerson
        {
            get { return NoteItemPerson; }
            set
            {
                NoteItemPerson = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Note_DeliverType
        {
            get { return NoteDeliverType; }
            set
            {
                NoteDeliverType = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Note_DeliverTo
        {
            get { return NoteDeliverTo; }
            set
            {
                NoteDeliverTo = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Note_Reward
        {
            get { return NoteReward; }
            set
            {
                NoteReward = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Note_Story
        {
            get { return NoteStory; }
            set
            {
                NoteStory = value;
                InvalidateProperties();
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (NoteOwner != null)
            {
                list.Add(1049644, "Coded for " + NoteOwner.Name + "");
            }
            if (NoteItemGot > 0)
            {
                list.Add(1070722, "Stolen " + NoteItem);
            }
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendMessage(
                    "You need a break from the last job, so read this note in about "
                        + ThiefAllowed(from)
                        + " minutes."
                );
            }
            ...
            {
                from.SendMessage(
                    "This note is written in a code you don't understand so you throw it away!"
                );
                bool remove = true;
        ...
        public ThiefNote(Serial serial)
            : base(serial) { }
        ...
        public class NoteGump : Gump
        {
            ...
            public NoteGump(ThiefNote note)
                : base(100, 100)
            {
                m_Note = note;
                ...
                string describe =
                    "<br><br>Keep this note with you at all times if you are going to pursue this job. If you are to steal something from a dungeon, you need to find the pedestal with the bag or box that a thief would normally attempt to steal. Use the bag or box on the pedestal to see if you successfully steal the item. If a town merchant is someone you need to pilfer from, find their coffer use your stealing skill on it to see if you steal the item from that. Be warned, you may be flagged a criminal and the guards will surely dispatch of you if caught. If you manage to escape with you life, and the item sought, then bring this note to the location specified in these instructions. If you lose this secret note, then find the thief guildmaster and they will give you a copy of the message.";
        ...
        public static void SetupNote(ThiefNote note, Mobile m)
        {
            ...
            if (Utility.RandomBool()) // STEAL FROM TOWN
            {
                ...
                switch (Utility.RandomMinMax(0, 13))
                {
                    ...
                    case 6:
                        ...
                        rewardMod = 3;
                        if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                        {
                            searchLocation = "the Land of Sosaria";
                        }
                        break;
                    ...
                    case 9:
                        ...
                        rewardMod = 4;
                        if (!(PlayerSettings.GetDiscovered(m, "the Isles of Dread")))
                        {
                            searchLocation = "the Land of Sosaria";
                        }
                        break;
                    ...
                    case 12:
                        ...
                        rewardMod = 2;
                        if (!(PlayerSettings.GetDiscovered(m, "the Island of Umber Veil")))
                        {
                            searchLocation = "the Land of Sosaria";
                        }
                        break;
                    case 13:
                        ...
                        rewardMod = 4;
                        if (!(PlayerSettings.GetDiscovered(m, "the Bottle World of Kuldar")))
                        {
                            searchLocation = "the Land of Sosaria";
                        }
                        break;
                ...
                foreach (Item target in World.Items.Values)
                    if (
                        target is Coffer
                        && Worlds.GetMyWorld(target.Map, target.Location, target.X, target.Y)
                            == searchLocation
                    )
                    {
                        targets.Add(target);
                ...
                for (int i = 0; i < targets.Count; ++i)
                {
                    ...
                    if (xCount == aCount)
                    {
                        ...
                        note.NoteReward = (int)(
                            (Server.Misc.MyServerSettings.QuestRewardModifier() * 0.01)
                            * note.NoteReward
                        );
                    }
                }
            ...
            else // STEAL FROM DUNGEON
            {
                ...
                switch (Utility.RandomMinMax(0, 15))
                {
                    ...
                    case 14:
                        ...
                        if (!(PlayerSettings.GetDiscovered(m, "the Underworld")))
                        {
                            searchLocation = "the Underworld";
                        }
                        break;
                    case 15:
                        ...
                        if (!(PlayerSettings.GetDiscovered(m, "the Land of Ambrosia")))
                        {
                            searchLocation = "the Land of Sosaria";
                        }
                        break;
                ...
                for (int i = 0; i < targets.Count; ++i)
                {
                    ...
                    {
                        Item finding = (Item)targets[i];
                        note.NoteItemArea = Server.Misc.Worlds.GetRegionName(
                            finding.Map,
                            finding.Location
                        );
                        int difficult =
                            Server.Misc.Worlds.GetDifficultyLevel(finding.Location, finding.Map)
                            + 2;
                        if (difficult < 2)
                        {
                            difficult = 2;
            ...
            switch (Utility.RandomMinMax(0, 13))
            {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    dropLocation = "the Serpent Island";
                    if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                    {
                        dropLocation = "the Land of Sosaria";
                    }
                ...
                case 8:
                    ...
                    break;
                case 9:
                    dropLocation = "the Isles of Dread";
                    if (!(PlayerSettings.GetDiscovered(m, "the Isles of Dread")))
                    {
                        dropLocation = "the Land of Sosaria";
                    }
                ...
                case 11:
                    ...
                    break;
                case 12:
                    dropLocation = "the Island of Umber Veil";
                    if (!(PlayerSettings.GetDiscovered(m, "the Island of Umber Veil")))
                    {
                        dropLocation = "the Land of Sosaria";
                    }
                    break;
                case 13:
                    dropLocation = "the Bottle World of Kuldar";
                    if (!(PlayerSettings.GetDiscovered(m, "the Bottle World of Kuldar")))
                    {
                        dropLocation = "the Land of Sosaria";
                    }
            ...
            foreach (Item target in World.Items.Values)
                if (
                    (
                        (note.NoteDeliverType == 1 && target is HollowStump)
                        || (note.NoteDeliverType == 2 && target is HayCrate)
                    )
                    && Worlds.GetMyWorld(target.Map, target.Location, target.X, target.Y)
                        == dropLocation
                )
            ...
            note.NoteStory =
                note.NoteStory
                + " There you will also find your payment of "
                + note.NoteReward
                + " gold and instructions for your next job.";
