...
namespace Server.Items
{
    public class Museums : Item
    {
        ...
        public Mobile Discover_Owner
        {
            get { return DiscoverOwner; }
            set { DiscoverOwner = value; }
        }

        public string ThisDescription;

        [CommandProperty(AccessLevel.Owner)]
        public string This_Description
        {
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (DiscoverOwner.Name == null)
            {
                list.Add(1070722, "Discovered by " + DiscoverName);
            }
            else
            {
                list.Add(1070722, "Discovered by " + DiscoverOwner.Name);
            }
        }
        ...
        public static int AntiqueMerchantGold(int cost, Mobile player)
        {
            return (int)((cost * (player.Skills[SkillName.Mercantile].Value * 0.01) / 4));
        }
        ...
        public static int AntiqueGuildGold(int cost, Mobile player)
        {
            PlayerMobile pm = (PlayerMobile)player;
            if (pm.NpcGuild == NpcGuild.MerchantsGuild)
            {
                return (int)(cost * (25 * 0.01));
            }
            return 0;
        }
        ...
        public static void GiveAntique(Museums antique, Mobile vendor, Mobile player)
        {
            ...
            switch (Utility.RandomMinMax(0, 9))
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    say = "What a rare item. Here is " + cost.ToString() + " gold for you.";
                    break;
                case 5:
                    say = "This is quite rare. Here is " + cost.ToString() + " gold for you.";
                    break;
                case 6:
                    say =
                        "This will go nicely in my museum. Here is "
                        + cost.ToString()
                        + " gold for you.";
                    break;
                case 7:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    say = "Where did you find this? Here is " + cost.ToString() + " gold for you.";
                    break;
            }
