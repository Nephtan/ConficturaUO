...
namespace Server.Gumps
{
    public class MuseumBookGump : Gump
    {
        ...
        public MuseumBookGump(Mobile from, MuseumBook book, int page, int lookat)
            : base(50, 50)
        {
            from.SendSound(0x4A);
            string plain = "#d1b2a6";
            ...
            AddHtml(
                ...
                603,
                20,
                @"<BODY><BASEFONT Color=" + plain + ">TOME OF MUSEUM ANTIQUES</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            else
            {
                ...
                AddHtml(
                    ...
                    880,
                    50,
                    @"<BODY><BASEFONT Color=" + white + ">" + rumor + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                while (cycle > 0)
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + MuseumBook.AntiqueInfo(item, 4, m_Book)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (MuseumBook.GetMuseums(lookat, m_Book) > 0)
                {
                    AddHtml(
                        ...
                        100,
                        20,
                        @"<BODY><BASEFONT Color=" + found + ">Found</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
                else
                {
                    AddHtml(
                        ...
                        100,
                        20,
                        @"<BODY><BASEFONT Color=" + losts + ">Lost</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
                ...
                if (lookat == MuseumBook.GetNext(m_Book) && m_Book.ItemValue > 0)
                {
                    ...
                    AddHtml(
                        ...
                        100,
                        20,
                        @"<BODY><BASEFONT Color=" + white + ">" + cost + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + white
                        + ">"
                        + MuseumBook.AntiqueInfo(lookat, 4, m_Book)
                        + "<br><br>"
                        + MuseumBook.AntiqueInfo(lookat, 5, m_Book)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
