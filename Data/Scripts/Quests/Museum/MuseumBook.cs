...
namespace Server.Items
{
    public class MuseumBook : Item
    {
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (ArtOwner != null)
            {
                list.Add(1070722, "Belongs to " + ArtOwner.Name + "");
            }
            if (GetTotal(this) > 0)
            {
                list.Add(1049644, "Found " + GetTotal(this) + " out of 60 Antiques");
            }
        }

        public MuseumBook(Serial serial)
            : base(serial) { }

        public Mobile ArtOwner;

        [CommandProperty(AccessLevel.GameMaster)]
        public Mobile Art_Owner
        {
            get { return ArtOwner; }
            set { ArtOwner = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int Knight_Trophy
        {
            get { return KnightTrophy; }
            set { KnightTrophy = value; }
        }

        public int KnightStatue;

        [CommandProperty(AccessLevel.GameMaster)]
        public int Knight_Statue
        {
            get { return KnightStatue; }
            set { KnightStatue = value; }
        }

        public string RumorWorld;

        [CommandProperty(AccessLevel.GameMaster)]
        public string Rumor_World
        {
            get { return RumorWorld; }
            set { RumorWorld = value; }
        }

        public string RumorDungeon;

        [CommandProperty(AccessLevel.GameMaster)]
        public string Rumor_Dungeon
        {
            get { return RumorDungeon; }
            set { RumorDungeon = value; }
        }

        public int RumorGoal;

        [CommandProperty(AccessLevel.GameMaster)]
        public int Rumor_Goal
        {
            get { return RumorGoal; }
            set { RumorGoal = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string Rumor_From
        {
            get { return RumorFrom; }
            set { RumorFrom = value; }
        }
            ...
            )
            {
                ...
                else
                {
                    player.LocalOverheadMessage(
                        ...
                        1150,
                        true,
                        book.RumorFrom + " was either wrong or they lied."
                    );
        ...
        public static string GetRumor(MuseumBook book, int item, bool talk)
        {
            ...
            if (talk)
            {
                ...
                return who
                    + " that the "
                    + MuseumBook.AntiqueInfo(item, 4, book)
                    + " may be "
                    + locate
                    + " within "
                    + dungeon
        ...
        public static string AntiqueInfo(int item, int slice, MuseumBook book)
        {
            ...
            if (item == 1)
            {
                id = "20425";
                hex = "0x4FC9";
                name = "Dwarven Suit of Armor";
                desc = "For Gimli of the Glittering Caves";
            }
            else if (item == 2)
            {
                id = "8850";
                hex = "0x2292";
                name = "Boiling Blood";
                desc = "Of the Salem Witch";
            }
            else if (item == 3)
            {
                id = "20411";
                hex = "0x4FBB";
                name = "Shrine of Scorpius";
                desc = "The Foe of Orion";
            }
            else if (item == 4)
            {
                id = "20414";
                hex = "0x4FBE";
                name = "Trophy for Jousting";
                desc = "Won by " + GetKnight(book.KnightTrophy);
            }
            else if (item == 5)
            {
                id = "20407";
                ...
                desc = "From the Land of Middle-Earth";
                light = "2";
            }
            else if (item == 6)
            {
                id = "20403";
                hex = "0x4FB3";
                name = "Anchor of the Jolly Roger";
                desc = "Captain Hook's Ship";
            }
            else if (item == 7)
            {
                id = "1167";
                hex = "0x048F";
                name = "Brazier of the Dead";
                desc = "Forged in Dungeon Deceit";
                light = "2";
            }
            else if (item == 8)
            {
                id = "20415";
                hex = "0x4FBF";
                name = "Statue of Triton";
                desc = "The Herald of Poseidon";
            }
            else if (item == 9)
            {
                id = "21187";
                hex = "0x52C3";
                name = "Banner of Blackbeard";
                desc = "Pirate of the Eastern Coast";
            }
            else if (item == 10)
            {
                id = "8836";
                hex = "0x2284";
                name = "Brew of Magical Goo";
                desc = "Belonged to Griselda the Witch";
            }
            else if (item == 11)
            {
                id = "21189";
                hex = "0x52C5";
                name = "Head of Drachen";
                desc = "The Sea Serpent King";
            }
            else if (item == 12)
            {
                id = "20388";
                hex = "0x4FA4";
                name = "Statue of Razkarok";
                desc = "The Beast of Valusia";
            }
            else if (item == 13)
            {
                id = "21288";
                hex = "0x5328";
                name = "Axe of Perun";
                desc = "Shrine of the God of Lightning";
            }
            else if (item == 14)
            {
                id = "21355";
                hex = "0x536B";
                name = "Map of Britannia";
                desc = "The Land of the Avatar";
            }
            else if (item == 15)
            {
                id = "21323";
                hex = "0x534B";
                name = "Leaves of the Earthmother";
                desc = "From the Moonshae Isles";
            }
            else if (item == 16)
            {
                id = "20401";
            ...
            else if (item == 17)
            {
                ...
                hex = "0x4FA9";
                name = "Dwarven Statue";
                desc = "Thorin Oakenshield";
            }
            else if (item == 18)
            {
                id = "21276";
                hex = "0x531C";
                name = "Chariot of Ben-Hur";
                desc = "From the Circus Maximus";
            }
            else if (item == 19)
            {
                id = "21256";
                hex = "0x5308";
                name = "Astrological Spyglass";
                desc = "Of Zodiac the Star Master";
            }
            else if (item == 20)
            {
                id = "20399";
                hex = "0x4FAF";
                name = "Head of Tuskrage";
                desc = "The Giant Boar of Kuldara";
            }
            else if (item == 21)
            {
                id = "20429";
                hex = "0x4FCD";
                name = "Wand of Wonder";
                desc = "Belonged to Merlin the Wizard";
                light = "2";
            }
            else if (item == 22)
            {
                id = "8519";
                hex = "0x2147";
                name = "Symbol of Ultimate Wisdom";
                desc = "From the Chamber of the Codex";
            }
            else if (item == 23)
            {
                id = "20413";
                hex = "0x4FBD";
                name = "Trophy of David";
                desc = "For Defeating the Goliath";
            }
            else if (item == 24)
            {
                id = "8829";
                hex = "0x227D";
                name = "Cauldron of the Sea";
                desc = "Belonged to Morwen the Hag";
            }
            else if (item == 25)
            {
                id = "20420";
                hex = "0x4FC4";
                hue = "0x986";
                name = "Statue of a Phoenix";
                desc = "The Vermilion Bird";
            }
            else if (item == 26)
            {
                id = "20384";
                hex = "0x4FA0";
                name = "Flower of the Fellowship";
                desc = "Grown by Batlin the Druid";
            }
            else if (item == 27)
            {
                id = "20391";
                hex = "0x4FA7";
                name = "Statue of a Knight";
                desc = GetKnight(book.KnightStatue);
            }
            else if (item == 28)
            {
                id = "21191";
                hex = "0x52C7";
                name = "Head of Druk";
                desc = "The Thunder Dragon";
            }
            else if (item == 29)
            {
                id = "20387";
                hex = "0x4FA3";
                name = "Pipe of Mystical Smoke";
                desc = "Belonged to Gandalf the Grey";
            }
            else if (item == 30)
            {
                id = "18080";
                hex = "0x46A0";
                name = "Cornicopia of Feasting";
                desc = "Horn of the Goat Amalthea";
            }
            else if (item == 31)
            {
                id = "20418";
                hex = "0x4FC2";
                name = "Altar of Neptune";
                desc = "The Ruler of the Sea";
            }
            else if (item == 32)
            {
                id = "6247";
                hex = "0x1867";
                name = "Crystal of the Ruby Knight";
                desc = "From King Sarak's Vault";
                light = "2";
            }
            else if (item == 33)
            {
                ...
                desc = "The Daughter of Zeus";
            }
            else if (item == 34)
            {
                id = "21333";
                hex = "0x5355";
                name = "Desk of Elminster";
                desc = "The Sage of Shadowdale";
            }
            else if (item == 35)
            {
                id = "20386";
                hex = "0x4FA2";
                name = "Flowers from the Silver River";
                desc = "From the Land of Shannara";
            }
            else if (item == 36)
            {
                id = "732";
                hex = "0x02DC";
                hue = "0xB1B";
                name = "Lamp of the Genie";
                desc = "From the Treasure of Aladdin";
            }
            else if (item == 37)
            {
                id = "21244";
                ...
                desc = "Belonged to Doctor Jekyll";
            }
            else if (item == 38)
            {
                id = "20383";
                hex = "0x4F9F";
                name = "Mage Flower of D'Hara";
                desc = "Grown by Zeddicus Zu'l Zorander";
            }
            else if (item == 39)
            {
                id = "4085";
            ...
            else if (item == 40)
            {
                id = "19724";
                hex = "0x4D0C";
                name = "Statue of Katalkotl";
                desc = "Ruler of the Savaged Empire";
            }
            else if (item == 41)
            {
                id = "20409";
                hex = "0x4FB9";
                name = "Looking Glass of Narnia";
                desc = "From the Dream World";
                light = "2";
            }
            else if (item == 42)
            {
                id = "15283";
                hex = "0x3BB3";
                name = "Trophy of Sosaria";
                desc = "Awarded by Lord British";
            }
            else if (item == 43)
            {
                id = "20390";
            ...
            else if (item == 44)
            {
                id = "21395";
                hex = "0x5393";
                name = "Doomgiver and Soulcutter";
                desc = "The Swords of Power";
            }
            else if (item == 45)
            {
                id = "21280";
                hex = "0x5320";
                name = "Vulcan's Inferno";
                desc = "The God of Volcanic Fire";
            }
            else if (item == 46)
            {
                id = "21393";
                hex = "0x5391";
                name = "Serpent of the Stygian";
                desc = "Thulsa Doom's Snake";
            }
            else if (item == 47)
            {
                id = "21208";
                hex = "0x52D8";
                name = "Head of Xithizil";
                desc = "The Insectoid From Another World";
            }
            else if (item == 48)
            {
                id = "20430";
            ...
            else if (item == 49)
            {
                id = "21332";
                hex = "0x5354";
                name = "Candelabrum of Zeus";
                desc = "From Mount Olympus";
            }
            else if (item == 50)
            {
                id = "20424";
                hex = "0x4FC8";
                name = "Brazier of Charon";
                desc = "Ferryman of the Dead";
                light = "2";
            }
            else if (item == 51)
            {
            ...
            else if (item == 52)
            {
                ...
                hex = "0x4FAB";
                name = "Dwarven Shrine";
                desc = "For the God Moradin";
            }
            else if (item == 53)
            {
                id = "8843";
                hex = "0x228B";
                name = "Cauldron of Serpent Venom";
                desc = "Of Ezmerelda the Enchantress";
            }
            else if (item == 54)
            {
                id = "21347";
                hex = "0x5363";
                name = "Ancient Stove of Edesia";
                desc = "The Goddess of Feasts";
            }
            else if (item == 55)
            {
                id = "21171";
                hex = "0x52B3";
                name = "Monument of Death";
                desc = "Statue of the Grim Reaper";
            }
            else if (item == 56)
            {
                id = "20397";
                ...
                desc = "From the Cloud Giant's Fortress";
                light = "1";
            }
            else if (item == 57)
            {
                id = "21287";
                hex = "0x5327";
                name = "Blade of the Seeker";
                desc = "Shrine of the Sword of Truth";
            }
            else if (item == 58)
            {
                id = "21206";
                hex = "0x52D6";
                name = "Head of Proteus";
                desc = "The Lord of the River";
            }
            else if (item == 59)
            {
                id = "18406";
                hex = "0x47E6";
                name = "Egg of Stone";
                desc = "From the Last Cockatrice";
            }
            else if (item == 60)
            {
                id = "21258";
                hex = "0x530A";
                name = "Hourglass of Janus";
                desc = "The God of Time";
                light = "1";
            }
        ...
        public static string GetKnight(int knight)
        {
            ...
            {
                statue = "King Bagdemagus";
            }
            else if (knight == 3)
            {
                statue = "King Leodegrance";
            }
            else if (knight == 4)
            {
                statue = "King Pellinore";
            }
            else if (knight == 5)
            {
                statue = "King Uriens";
            ...
            {
                statue = "Sir Sagramore";
            }
            else if (knight == 52)
            {
                statue = "Sir Segwarides";
            }
            else if (knight == 53)
            {
                statue = "Sir Tor";
