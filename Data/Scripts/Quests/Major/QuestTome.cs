...
namespace Server.Items
{
    public class QuestTome : Item
    {
        ...
        public Mobile QuestTome_Owner
        {
            get { return QuestTomeOwner; }
            set { QuestTomeOwner = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_StoryGood
        {
            get { return QuestTomeStoryGood; }
            set { QuestTomeStoryGood = value; }
        }

        public string QuestTomeLocateGood;

        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_LocateGood
        {
            get { return QuestTomeLocateGood; }
            set { QuestTomeLocateGood = value; }
        }

        public string QuestTomeWorldGood;

        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_WorldGood
        {
            get { return QuestTomeWorldGood; }
            set { QuestTomeWorldGood = value; }
        }

        public string QuestTomeNPCGood;

        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_NPCGood
        {
            get { return QuestTomeNPCGood; }
            set { QuestTomeNPCGood = value; }
        }

        public string QuestTomeStoryEvil;

        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_StoryEvil
        {
            get { return QuestTomeStoryEvil; }
            set { QuestTomeStoryEvil = value; }
        }

        public string QuestTomeLocateEvil;

        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_LocateEvil
        {
            get { return QuestTomeLocateEvil; }
            set { QuestTomeLocateEvil = value; }
        }

        public string QuestTomeWorldEvil;

        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_WorldEvil
        {
            get { return QuestTomeWorldEvil; }
            set { QuestTomeWorldEvil = value; }
        }

        public string QuestTomeNPCEvil;

        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_NPCEvil
        {
            get { return QuestTomeNPCEvil; }
            set { QuestTomeNPCEvil = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_Citizen
        {
            get { return QuestTomeCitizen; }
            set { QuestTomeCitizen = value; }
        }

        public int QuestTomeGoals;

        [CommandProperty(AccessLevel.Owner)]
        public int QuestTome_Goals
        {
            get { return QuestTomeGoals; }
            set
            {
                QuestTomeGoals = value;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_Dungeon
        {
            get { return QuestTomeDungeon; }
            set { QuestTomeDungeon = value; }
        }

        public string QuestTomeLand;

        [CommandProperty(AccessLevel.GameMaster)]
        public string QuestTome_Land
        {
            get { return QuestTomeLand; }
            set { QuestTomeLand = value; }
        }

        public int QuestTomeType;

        [CommandProperty(AccessLevel.Owner)]
        public int QuestTome_Type
        {
            get { return QuestTomeType; }
            set
            {
                QuestTomeType = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Goal_Item1
        {
            get { return GoalItem1; }
            set
            {
                GoalItem1 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Goal_Item2
        {
            get { return GoalItem2; }
            set
            {
                GoalItem2 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Goal_Item3
        {
            get { return GoalItem3; }
            set
            {
                GoalItem3 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Goal_Item4
        {
            get { return GoalItem4; }
            set
            {
                GoalItem4 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Villain_Category
        {
            get { return VillainCategory; }
            set
            {
                VillainCategory = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Villain_Type
        {
            get { return VillainType; }
            set
            {
                VillainType = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Villain_Body
        {
            get { return VillainBody; }
            set
            {
                VillainBody = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Villain_Hue
        {
            get { return VillainHue; }
            set
            {
                VillainHue = value;
                InvalidateProperties();
        ...
        public QuestTome(Serial serial)
            : base(serial) { }
        ...
        private class QuestTomeGump : Gump
        {
            ...
            public QuestTomeGump(QuestTome book, Mobile from, int page)
                : base(50, 50)
            {
                m_Book = book;
                ...
                AddHtml(
                    ...
                    665,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + m_Book.Name + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                if (page > 0)
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">There are many times when adventurers are given a grand quest to obtain a magical item by slaying a powerful creature and thus using the item for good or evil. You have found the journal of one of these adventurers. What fate became of them, you will never know. Did they lose their journal? Did they perish in their search for "
                            + m_Book.GoalItem4
                            + "?<br><br>Now you possess the journal and you can pursue this quest as it is yours alone. The quest has two forks that you may go down. If your karma is locked, the goal will lead you down the vile path of "
                            + m_Book.QuestTomeNPCEvil
                            + ". Otherwise, your quest will service good for "
                            + m_Book.QuestTomeNPCGood
                            + ". You may only have a single journal quest at any one time. If you find another journal, and choose to take it while you currently have a journal, then you will get a new journal with the same unfinished quest you had before.<br><br>To defeat "
                            + m_Book.VillainName
                            + " "
                            + m_Book.VillainTitle
                            + " and claim "
                            + m_Book.GoalItem4
                            + ", you will have to find 3 unique items to aid you. You have no idea where these items are, so you will have to speak to citizens (orange names) to see if they have heard rumors that can help you. If a citizen does not initially mention anything about your quest, you will have to seek out another. When you finally get a clue, a small tune will play and your journal will be updated with that rumor they gave you. It could be true or it could be false. You won’t know until you pursue it. Sometimes the item may be in a chest or bag on a pedestal in a dungeon, or held by one of the more powerful creatures within that dungeon.<br><br>Once you collect the required relics, you must then figure out where "
                            + m_Book.VillainName
                            + " is. Again, talking to citizens may reveal a hint. Once you learn where "
                            + m_Book.VillainName
                            + " is, make haste to that location and face them in battle. Once you enter the area, find a strategic place you wish to combat them and then open the journal to call them forth to face you. The battle will surely be harsh so you best be prepared. Be sure to slay them so you can take "
                            + m_Book.GoalItem4
                            + " from them. Making them vanish by other means will rob you of your goal, as would leaving the area they are in. If they do manage to escape, you will have to seek out rumors again to determine where "
                            + m_Book.VillainName
                            + " has fled to.<br><br>Slaying "
                            + m_Book.VillainName
                            + " will reveal an abundance of wealth they have taken from other adventurers that failed to be victorious. Feel free to take this treasure for yourself, as "
                            + m_Book.VillainName
                            + " "
                            + m_Book.VillainTitle
                            + " will no longer need it. Once you have acquired "
                            + m_Book.GoalItem4
                            + ", seek out "
                            + m_Book.QuestTomeNPCGood
                            + " or "
                            + m_Book.QuestTomeNPCEvil
                            + " and hand them the journal. Your morality and fame will be affected by your choice of ethics and you will be rewarded with an item of your choosing. When you select your reward, the item will appear in your pack. Each item will appear with a number of points you can spend to enhance your item. This allows you to tailor the item to suit your style. To begin, single click the items and select 'Status'. A menu will appear that you can choose which attributes you want the item to have. Be careful, as you cannot change an attribute once you select it.</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
                else
                {
                    ...
                    AddHtml(
                        ...
                        878,
                        358,
                        @"<BODY><BASEFONT Color=" + color + ">" + story + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    if (m_Book.QuestTomeGoals < 4)
                    {
                        AddHtml(
                            ...
                            @"<BODY><BASEFONT Color="
                                + color
                                + ">"
                                + cultInfo.ToTitleCase(m_Book.GoalItem1)
                                + "</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                        if (m_Book.QuestTomeGoals > 0)
                        {
                            AddItem(0, 448, 20413);
                        }
                        AddHtml(
                            ...
                            @"<BODY><BASEFONT Color="
                                + color
                                + ">"
                                + cultInfo.ToTitleCase(m_Book.GoalItem2)
                                + "</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                        if (m_Book.QuestTomeGoals > 1)
                        {
                            AddItem(0, 500, 20413);
                        }
                        AddHtml(
                            ...
                            @"<BODY><BASEFONT Color="
                                + color
                                + ">"
                                + cultInfo.ToTitleCase(m_Book.GoalItem3)
                                + "</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                        if (m_Book.QuestTomeGoals > 2)
                        {
                            AddItem(0, 551, 20413);
                        }
                    }
                    else
                    {
                        AddHtml(
                            ...
                            @"<BODY><BASEFONT Color="
                                + color
                                + ">"
                                + cultInfo.ToTitleCase(m_Book.GoalItem4)
                                + "</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                if (info.ButtonID == 1)
                {
                    from.SendGump(new QuestTomeGump(m_Book, from, 1));
                }
            ...
            if (talk)
            {
                ...
                switch (Utility.RandomMinMax(0, 5))
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        who = "I overheard some " + RandomThings.GetRandomJob() + " say";
                        break;
                    case 5:
                        who = "My friend told me";
                        break;
                }
                return who
                    + " that "
        ...
        public static void SetRumor(Mobile m, QuestTome book)
        {
            ...
            if (book.QuestTomeType == 1)
            {
                foreach (Mobile target in World.Mobiles.Values)
                    if (
                        target.Region is DungeonRegion
                        && target.Fame >= 18000
                        && !(
                            target is Exodus
                            || target is CodexGargoyleA
                            || target is CodexGargoyleB
                            || target is Syth
                        )
                    )
                    {
        ...
        public static bool FoundItem(Mobile player, int type, MajorItemOnCorpse chest)
        {
            ...
            if (
                ...
                && book.QuestTomeDungeon
                    == Server.Misc.Worlds.GetRegionName(player.Map, player.Location)
                && book.QuestTomeOwner == player
                && book.QuestTomeGoals < 3
            )
            {
                ...
                chest != null
                && book.VillainName == chest.VillainName
                && book.VillainTitle == chest.VillainTitle
                && book.QuestTomeOwner == player
                && book.QuestTomeGoals >= 3
            )
            {
