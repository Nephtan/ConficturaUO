...
namespace Server.Items
{
    public class BlackrockSerpentOrder : Item
    {
        ...
        public BlackrockSerpentOrder(Serial serial)
            : base(serial) { }
    ...
    public class BlackrockSerpentChaos : Item
    {
        ...
        public BlackrockSerpentChaos(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public BlackrockSerpentBalance()
            : base(0x25C0)
        {
            Name = "Blackrock Serpent";
            Weight = 1.0;
        ...
        public BlackrockSerpentBalance(Serial serial)
            : base(serial) { }
    ...
    public class SerpentCapturedOrder : Item
    {
        ...
        public SerpentCapturedOrder(Serial serial)
            : base(serial) { }
    ...
    public class SerpentCapturedChaos : Item
    {
        ...
        public SerpentCapturedChaos(Serial serial)
            : base(serial) { }
    ...
    public class SerpentCapturedBalance : Item
    {
        ...
        public SerpentCapturedBalance(Serial serial)
            : base(serial) { }
