...
namespace Server.Items
{
    public class QuestTeleporter : Item
    {
        ...
        public int Teleporter_Open
        {
            get { return TeleporterOpen; }
            set
            {
                TeleporterOpen = value;
                InvalidateProperties();
            }
        }

        [CommandProperty(AccessLevel.Owner)]
        public int Teleporter_Sound
        {
            get { return TeleporterSound; }
            set
            {
                TeleporterSound = value;
                InvalidateProperties();
            }
        }

        [CommandProperty(AccessLevel.Owner)]
        public int Teleporter_Item
        {
            get { return TeleporterItem; }
            set
            {
                TeleporterItem = value;
                InvalidateProperties();
            }
        }

        [CommandProperty(AccessLevel.Owner)]
        public string Teleporter_Message
        {
            get { return TeleporterMessage; }
            set
            {
                TeleporterMessage = value;
                InvalidateProperties();
            }
        }

        [CommandProperty(AccessLevel.Owner)]
        public string Teleporter_Fail
        {
            get { return TeleporterFail; }
            set
            {
                TeleporterFail = value;
                InvalidateProperties();
            }
        }

        [CommandProperty(AccessLevel.Owner)]
        public string Teleporter_Quest
        {
            get { return TeleporterQuest; }
            set
            {
                TeleporterQuest = value;
                InvalidateProperties();
            }
        }

        [CommandProperty(AccessLevel.Owner)]
        public string Teleporter_Lock
        {
            get { return TeleporterLock; }
            set
            {
                TeleporterLock = value;
                InvalidateProperties();
            }
        }

        [CommandProperty(AccessLevel.Owner)]
        public string Teleporter_LockMsg
        {
            get { return TeleporterLockMsg; }
            set
            {
                TeleporterLockMsg = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return TeleporterPointDest; }
            set
            {
                TeleporterPointDest = value;
                InvalidateProperties();
            }
        }
        ...
        public Map MapDest
        {
            get { return TeleporterMapDest; }
            set
            {
                TeleporterMapDest = value;
                InvalidateProperties();
            }
        }
        ...
        public void DoQuestTeleporter(Mobile m)
        {
            ...
            {
                if (
                    PlayerSettings.GetBardsTaleQuest(m, "BardsTaleWin")
                    && this.Name == "a mysterious crystal ball"
                    && this.X == 2830
                    && this.Y == 1875
                )
                {
                ...
                else if (TeleporterOpen == 1 || TeleporterQuest == "blank")
                {
                    ...
                    {
                        PlayerSettings.SetBardsTaleQuest(m, TeleporterQuest, true);
                    }
                    ...
                    PlayerSettings.GetKeys(m, TeleporterQuest)
                    || PlayerSettings.GetBardsTaleQuest(m, TeleporterQuest)
                )
                {
                    TeleporterOpen = 1;
                    BaseCreature.TeleportPets(m, TeleporterPointDest, TeleporterMapDest, false);
                    ...
                    Timer.DelayCall(
                        ...
                        new TimerCallback(CloseQuestTeleporter)
                    );
                    m.PrivateOverheadMessage(
                        MessageType.Regular,
                        1150,
        ...
        public QuestTeleporter(Serial serial)
            : base(serial) { }
