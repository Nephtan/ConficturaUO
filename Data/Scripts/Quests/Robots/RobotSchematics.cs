...
namespace Server.Items
{
    public class RobotSchematics : Item
    {
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            if (from != null)
            {
                ...
                if (dropped is RobotSheetMetal && NeedMetalQty > HaveMetalQty)
                {
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new RobotSheetMetal(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                ...
                else if (dropped is RobotOil && NeedOil > HaveOil)
                {
                    ...
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new RobotOil(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                ...
                else if (dropped is RobotGears && NeedGears > HaveGears)
                {
                    ...
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new RobotGears(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                ...
                else if (dropped is RobotBolt && NeedBolts > HaveBolts)
                {
                    ...
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new RobotBolt(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
                ...
                else if (dropped is DDXormite && NeedXormite > HaveXormite)
                {
                    ...
                    if (WhatIsExtra > 0)
                    {
                        from.AddToBackpack(new DDXormite(WhatIsExtra));
                    }
                    iAmount = WhatIsTaken;
        ...
        public RobotSchematics(Serial serial)
            : base(serial) { }
        ...
        public static bool ProcessRobotBook(Mobile m, Mobile tinker, Item dropped)
        {
            ...
            if (XormiteReturn > 0)
            {
                ...
                tinker.Say(
                    "Here is " + XormiteReturn.ToString() + " xormite back for all of your help."
                );
            }
        ...
        public class RobotSchematicsGump : Gump
        {
            ...
            public RobotSchematicsGump(Mobile from, RobotSchematics gBook)
                : base(25, 25)
            {
                m_Book = gBook;
                ...
                AddHtml(
                    ...
                    310,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>Robot Schematics</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    136,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>Sheet Metal</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    136,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>Engine Parts</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>"
                        + gBook.HaveEngineParts.ToString()
                        + "/"
                        + gBook.NeedEngineParts.ToString()
                        + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    136,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>Curcuit Board</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>"
                        + gBook.HaveCircuitBoard.ToString()
                        + "/"
                        + gBook.NeedCircuitBoard.ToString()
                        + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    136,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>Transistors</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>"
                        + gBook.HaveTransistors.ToString()
                        + "/"
                        + gBook.NeedTransistors.ToString()
                        + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    136,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>Gears</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    136,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>Oil</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    136,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>Bolts</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>"
                        + gBook.HaveBolts.ToString()
                        + "/"
                        + gBook.NeedBolts.ToString()
                        + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>"
                        + gBook.HaveXormite.ToString()
                        + "/"
                        + gBook.NeedXormite.ToString()
                        + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    660,
                    321,
                    @"<BODY><BASEFONT Color=#00FF06>" + sText + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    653,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>Bring Gathered Materials to the Tinker in "
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedBolts
        {
            get { return NeedBolts; }
            set { NeedBolts = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedXormite
        {
            get { return NeedXormite; }
            set { NeedXormite = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedCircuitBoard
        {
            get { return NeedCircuitBoard; }
            set { NeedCircuitBoard = value; }
        }

        public int NeedEngineParts;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedEngineParts
        {
            get { return NeedEngineParts; }
            set { NeedEngineParts = value; }
        }

        public int NeedTransistors;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_NeedTransistors
        {
            get { return NeedTransistors; }
            set { NeedTransistors = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveBolts
        {
            get { return HaveBolts; }
            set { HaveBolts = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveXormite
        {
            get { return HaveXormite; }
            set { HaveXormite = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveCircuitBoard
        {
            get { return HaveCircuitBoard; }
            set { HaveCircuitBoard = value; }
        }

        public int HaveEngineParts;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveEngineParts
        {
            get { return HaveEngineParts; }
            set { HaveEngineParts = value; }
        }

        public int HaveTransistors;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveTransistors
        {
            get { return HaveTransistors; }
            set { HaveTransistors = value; }
        }
