...
namespace Server.Items
{
    public class MangarsRobe : MagicRobe
    {
        ...
        public MangarsRobe(Serial serial)
            : base(serial) { }
    ...
    public class MangarsNecroRobe : MagicRobe
    {
        ...
        public MangarsNecroRobe(Serial serial)
            : base(serial) { }
    ...
    public class MangarsElementalistRobe : MagicRobe
    {
        [Constructable]
        public MangarsElementalistRobe()
        {
            Hue = 0x497;
            ItemID = 0x26AE;
            Name = "Mangar's Robe";
        ...
        public MangarsElementalistRobe(Serial serial)
            : base(serial) { }
    ...
    public class BardicFeatheredHat : MagicHat
    {
        ...
        public BardicFeatheredHat(Serial serial)
            : base(serial) { }
