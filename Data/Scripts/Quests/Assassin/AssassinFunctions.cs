    ...
    class AssassinFunctions
    {
            ...
            if (PlayerSettings.GetQuestState(m, "AssassinQuest"))
            {
                ...
                )
                {
                    m.PrivateOverheadMessage(
                        ...
                        0x22,
                        false,
                        "Your victim has been assassinated!",
                        m.NetState
                    );
        ...
        public static void FindTarget(Mobile m, int fee)
        {
                ...
                if (target is BaseCreature)
                {
                    ...
                    if (
                        ...
                        && (
                            ...
                            <= GetPlayerInfo.GetPlayerDifficulty(m)
                        )
                        && reg.IsPartOf(typeof(DungeonRegion))
                    )
                    {
            ...
            for (int i = 0; i < targets.Count; ++i)
            {
                ...
                if (xCount == aCount)
                {
                    ...
                    string kDollar = (
                        (int)((Server.Misc.MyServerSettings.QuestRewardModifier() * 0.01) * nFee)
                    ).ToString();
                    ...
                    string myexplorer =
                        ...
                        + killName
                        + "#"
                        + Server.Misc.Worlds.GetRegionName(theVictim.Map, theVictim.Location)
                        + "#0#"
                        + kDollar
                        + "#"
                        + kWorld
            ...
            if (PlayerSettings.GetQuestState(m, "AssassinQuest"))
            {
                ...
                if (nAssassinDone > 0 && nAssassinFee > 0)
                {
                    ...
                    switch (Utility.RandomMinMax(0, 9))
                    {
                        case 0:
                            sMessage =
                                "I assume the death was quick. Here is "
                                + nAssassinFee.ToString()
                                + " gold for you.";
                            break;
                        case 1:
                            sMessage =
                                "I bet they never seen you coming. Here is "
                                + nAssassinFee.ToString()
                                + " gold for you.";
                            break;
                        case 2:
                            sMessage =
                                "Was the death swift? Here is "
                                + nAssassinFee.ToString()
                                + " gold for you.";
                            break;
                        case 3:
                            sMessage =
                                "Were there any witnesses? Here is "
                                + nAssassinFee.ToString()
                                + " gold for you.";
                            break;
                        case 4:
                            sMessage =
                                "I am impressed. Here is "
                                + nAssassinFee.ToString()
                                + " gold for you.";
                            break;
                        case 5:
                            sMessage =
                                "Word of your deed already reached my ears. Here is "
                                + nAssassinFee.ToString()
                                + " gold for you.";
                            break;
                        case 6:
                            sMessage =
                                "How you did that one, I'll never know. Here is "
                                + nAssassinFee.ToString()
                                + " gold for you.";
                            break;
                        case 7:
                            sMessage =
                                "You are one of my best. Here is "
                                + nAssassinFee.ToString()
                                + " gold for you.";
                            break;
                        case 8:
                            sMessage =
                                "Did you leave the body behind? Here is "
                                + nAssassinFee.ToString()
                                + " gold for you.";
                            break;
                        case 9:
                            sMessage =
                                "Next time, strike from the shadows. Here is "
                                + nAssassinFee.ToString()
                                + " gold for you.";
                            break;
                    }
        ...
        public static string QuestSentence(Mobile m)
        {
            ...
            if (PlayerSettings.GetQuestState(m, "AssassinQuest"))
            {
                ...
                if (sAssassinTitle.Length > 0)
                {
                    sVictimCalled = sAssassinTitle;
                }
        ...
        public static string QuestStatus(Mobile m)
        {
            ...
            if (PlayerSettings.GetQuestState(m, "AssassinQuest"))
            {
                ...
                if (nAssassinDone == 1)
                {
                    sVictimQuest = "Return to Xardok for your " + sWorth + " gold payment";
                }
            }
            return sVictimQuest;
        }
