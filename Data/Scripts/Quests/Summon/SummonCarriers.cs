    ...
    class SummonQuests
    {
        ...
        public static int SummonCarriers(Mobile m, BaseCreature b, int Heat)
        {
            ...
            )
            {
                ...
                reg.IsPartOf("the Halls of Undermountain")
                && m is WeedElemental
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
            ...
            )
            {
                ...
                reg.IsPartOf("the Fires of Hell")
                && m is Drake
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
            ...
            else if (reg.IsPartOf("the Mines of Morinia") && m is AntaurKing)
            {
                ...
                reg.IsPartOf("the Perinian Depths")
                && m is VampireLord
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
            ...
            )
            {
                ...
                reg.IsPartOf("the Dungeon of Time Awaits")
                && m is Daemon
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
            ...
            )
            {
                ...
                reg.IsPartOf("the Ancient Prison")
                && m is DeadWizard
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
            ...
            )
            {
                ...
                && (m is Dragons || m is RidingDragon)
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
                    m.Map,
            ...
            )
            {
                ...
                reg.IsPartOf("the Gargoyle Crypts")
                && m is SpectralGargoyle
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
                    m.Map,
            ...
            )
            {
                ...
                reg.IsPartOf("the Serpent Sanctum")
                && m is OphidianKnight
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
            ...
            )
            {
                ...
                reg.IsPartOf("the Dungeon of the Mad Archmage")
                && m is Archmage
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
            ...
            )
            {
                ...
                reg.IsPartOf("the Halls of Ogrimar")
                && m is OrkMage
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
            ...
            ) //  already mutated sand demon
            {
                ...
                {
                    case 0:
                        m.Title = "the sand fiend";
                        break;
                    case 1:
                        m.Title = "the desert fiend";
                        break;
                    case 2:
                        m.Title = "the fiend of the wastes";
                        break;
                    case 3:
                        m.Title = "the wasteland fiend";
                        break;
                    case 4:
                        m.Title = "the fiend of the barrens";
                        break;
                }
            ...
            )
            {
                ...
                reg.IsPartOf("the Sanctum of Saltmarsh")
                && m is Sleestax
                && Server.Misc.SummonQuests.IsInLocation(
                    b.Home.X,
                    b.Home.Y,
        ...
        public static bool IsInLocation(
            int myX,
            int myY,
            Map myMap,
            int spotX,
                            ...
                            foreach (PartyMemberInfo pmi in p.Members)
                            {
                                ...
                                )
                                {
                                    LoggingFunctions.LogSlayingLord(
                                        pmi.Mobile,
                                        m.Name + " from the Magical Prison"
                                    );
        ...
        public class GoodiesTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                Item g = new Gold(100, 200);
                g.Delete();

                int r1 = (int)(
                    Utility.RandomMinMax(80, 160) * (MyServerSettings.GetGoldCutRate() * .01)
                );
                int r2 = (int)(
                    Utility.RandomMinMax(200, 400) * (MyServerSettings.GetGoldCutRate() * .01)
                );
                int r3 = (int)(
                    Utility.RandomMinMax(400, 800) * (MyServerSettings.GetGoldCutRate() * .01)
                );
                int r4 = (int)(
                    Utility.RandomMinMax(800, 1200) * (MyServerSettings.GetGoldCutRate() * .01)
                );
                int r5 = (int)(
                    Utility.RandomMinMax(1200, 1600) * (MyServerSettings.GetGoldCutRate() * .01)
                );
                ...
                switch (Utility.Random(21))
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        g = new DDGemstones(r2);
                        break;
                    case 2:
                        g = new DDJewels(r2);
                        break;
                    case 3:
                        g = new DDGoldNuggets(r3);
                        break;
                    case 4:
                        g = new Gold(r3);
                        break;
