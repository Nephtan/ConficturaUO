...
namespace Server.Items
{
    public class FrankenJournal : Item
    {
        ...
        public Mobile Journal_Owner
        {
            get { return JournalOwner; }
            set { JournalOwner = value; }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Has_ArmLeft
        {
            get { return HasArmLeft; }
            set
            {
                HasArmLeft = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Has_ArmRight
        {
            get { return HasArmRight; }
            set
            {
                HasArmRight = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Has_LegLeft
        {
            get { return HasLegLeft; }
            set
            {
                HasLegLeft = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Has_LegRight
        {
            get { return HasLegRight; }
            set
            {
                HasLegRight = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Brain_From
        {
            get { return BrainFrom; }
            set
            {
                BrainFrom = value;
                InvalidateProperties();
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            {
                list.Add(1049644, "Now Belongs to " + JournalOwner.Name + "");
            }
        }
        ...
        public FrankenJournal(Serial serial)
            : base(serial) { }
        ...
        private class FrankenGump : Gump
        {
            ...
            public FrankenGump(FrankenJournal book, Mobile from)
                : base(50, 50)
            {
                string color = "#edad9c";
                m_Journal = book;
                ...
                AddHtml(
                    ...
                    420,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">FRANKENSTEIN'S JOURNAL</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                {
                    AddItem(449, 417 + v, 14988);
                } // RIGHT ARM
                if (book.HasArmLeft > 0)
                {
                    AddItem(547, 417 + v, 14991);
                } // LEFT ARM
                if (book.HasLegRight > 0)
                {
                    AddItem(471, 467 + v, 16025);
                } // RIGHT LEG
                if (book.HasLegLeft > 0)
                {
                    AddItem(522, 466 + v, 16002);
                } // LEFT LEG
                if (book.HasTorso > 0)
                {
                    AddItem(491, 415 + v, 15003);
                } // TORSO
                if (book.HasHead > 0)
                {
                    AddItem(504, 399 + v, 15873);
                } // HEAD
                ...
                if (bodyParts > 6)
                {
                    ...
                    AddHtml(
                        ...
                        261,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Reanimate a Slave</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">Reanimate a Protector</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
