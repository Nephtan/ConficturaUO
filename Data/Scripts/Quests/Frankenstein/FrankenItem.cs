...
namespace Server.Items
{
    public class FrankenItem : Item
    {
        ...
        private class BodyTarget : Target
        {
            ...
            public BodyTarget(FrankenItem part)
                        ...
                        if (from != null && from == xJournal.JournalOwner)
                        {
                            if (m_Part is FrankenLegLeft)
                            {
                                ...
                                else
                                {
                                    from.SendSound(0x48);
                                    from.SendMessage(
                                        "You now have a left leg for this experiment."
                                    );
                                    m_Part.Delete();
                                    xJournal.HasLegLeft = 1;
                            ...
                            else if (m_Part is FrankenLegRight)
                            {
                                ...
                                else
                                {
                                    from.SendSound(0x48);
                                    from.SendMessage(
                                        "You now have a right leg for this experiment."
                                    );
                                    m_Part.Delete();
                                    xJournal.HasLegRight = 1;
                                    from.Backpack.FindItemByType(typeof(SewingKit)).Delete();
                                }
                            }
                            else if (m_Part is FrankenArmLeft)
                            {
                                ...
                                else
                                {
                                    from.SendSound(0x48);
                                    from.SendMessage(
                                        "You now have a left arm for this experiment."
                                    );
                                    m_Part.Delete();
                                    xJournal.HasArmLeft = 1;
                                    from.Backpack.FindItemByType(typeof(SewingKit)).Delete();
                                }
                            }
                            else if (m_Part is FrankenArmRight)
                            {
                                ...
                                else
                                {
                                    from.SendSound(0x48);
                                    from.SendMessage(
                                        "You now have a right arm for this experiment."
                                    );
                                    m_Part.Delete();
                                    xJournal.HasArmRight = 1;
                                    from.Backpack.FindItemByType(typeof(SewingKit)).Delete();
                                }
                            }
                            else if (m_Part is FrankenHead)
                            {
                                ...
                                {
                                    from.SendSound(0x48);
                                    from.SendMessage("You now have a head for this experiment.");
                                    m_Part.Delete();
                                    xJournal.HasHead = 1;
                                    from.Backpack.FindItemByType(typeof(SewingKit)).Delete();
                                }
                            ...
                            else if (m_Part is FrankenTorso)
                            {
                                ...
                                {
                                    from.SendSound(0x48);
                                    from.SendMessage("You now have a torso for this experiment.");
                                    m_Part.Delete();
                                    xJournal.HasTorso = 1;
                                    from.Backpack.FindItemByType(typeof(SewingKit)).Delete();
                                }
                            ...
                            else if (m_Part is FrankenBrain)
                            {
                                ...
                                {
                                    from.SendMessage(
                                        "Your forensics skill isn't good enough to work with this brain."
                                    );
                                }
                                else
                                {
                                    ...
                                    {
                                        from.SendMessage(
                                            "The current brain is beginning to rot, so you throw it out."
                                        );
                                    }
                                    from.SendMessage(
                                        "You now have a fresh brain for this experiment."
                                    );
                                    from.SendSound(0x48);
        ...
        public FrankenItem(Serial serial)
            : base(serial) { }
