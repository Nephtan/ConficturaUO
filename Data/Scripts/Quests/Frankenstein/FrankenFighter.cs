...
namespace Server.Mobiles
{
    ...
    public class FrankenFighter : BaseCreature
    {
        ...
        public int Fighter_Level
        {
            get { return FighterLevel; }
            set
            {
                FighterLevel = value;
        ...
        public FrankenFighter(Serial serial)
            : base(serial) { }
        ...
        public override void OnAfterSpawn()
        {
            ...
            else if (FighterLevel < 25)
            {
                scalar = 1.3;
            }
            else if (FighterLevel < 30)
            {
                scalar = 1.4;
            }
            else if (FighterLevel < 35)
            {
                scalar = 1.5;
            }
            else if (FighterLevel < 40)
            {
                scalar = 1.6;
            }
            else if (FighterLevel < 45)
            {
                scalar = 1.7;
            }
            else if (FighterLevel < 50)
            {
                scalar = 1.8;
            }
            else if (FighterLevel < 55)
            {
                scalar = 1.9;
            }
            else if (FighterLevel < 60)
            {
                scalar = 2;
            }
            else if (FighterLevel < 65)
            {
                scalar = 2.1;
            }
            else if (FighterLevel < 70)
            {
                scalar = 2.2;
            }
            else if (FighterLevel < 75)
            {
                scalar = 2.3;
            }
            else if (FighterLevel < 80)
            {
                scalar = 2.4;
            }
            else if (FighterLevel < 85)
            {
                scalar = 2.5;
            }
            else if (FighterLevel < 90)
            {
                scalar = 2.6;
            }
            else if (FighterLevel < 95)
            {
                scalar = 2.7;
            }
            else
