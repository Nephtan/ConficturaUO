...
namespace Server.Items
{
    public class FrankenPorterItem : Item
    {
        ...
        public FrankenPorterItem(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                if (this.PorterType > 0)
                {
                    friend.Delete();
                    friend = new FrankenFighter();
                    ((FrankenFighter)friend).FighterLevel = this.PorterLevel;
                }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (PorterName != "a reanimation")
            {
                sType = PorterName + " the reanimation";
            }
