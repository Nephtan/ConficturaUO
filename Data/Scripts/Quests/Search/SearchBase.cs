...
namespace Server.Items
{
    public class SearchBase : BaseAddon
    {
        ...
        {
            int surface = Utility.RandomList(
                0x40A3,
                0x40A4,
                0x40A5,
                0x40A6,
        ...
        public SearchBase(Serial serial)
            : base(serial) { }
        ...
        public override void OnComponentUsed(AddonComponent ac, Mobile from)
        {
            ...
            else if (monsters > 0)
            {
                ...
                from.Backpack.FindItemByType(typeof(SearchPage)) != null
            ...
            )
            {
                ...
                if (from.Backpack.FindItemByType(typeof(CourierMail)) != null)
                {
                    ...
                    if (
                        envelope.SearchDungeon
                            == Server.Misc.Worlds.GetRegionName(from.Map, from.Location)
                        && envelope.owner == from
                        && (
                            envelope.DungeonMap == from.Map
                            || envelope.DungeonMap == Server.Misc.Worlds.GetPCDefaultMap(from)
                        )
                        && envelope.MsgComplete == 0
                    )
                    {
                        ...
                        from.LocalOverheadMessage(
                            ...
                            1150,
                            true,
                            "You found the " + envelope.SearchItem + "."
                        );
                        from.SendSound(0x3D);
                        EmptyBox = 0;
                    }
                ...
                if (from.Backpack.FindItemByType(typeof(ResearchBag)) != null)
                {
                    ResearchBag bag = (ResearchBag)
                        from.Backpack.FindItemByType(typeof(ResearchBag));
                ...
                if (from.Backpack.FindItemByType(typeof(VortexCube)) != null)
                {
                    ...
                    if (cube.CubeOwner == from)
                    {
                        ...
                        int crystals =
                            cube.HasCrystalRed
                            + cube.HasCrystalBlue
                            + cube.HasCrystalGreen
                            + cube.HasCrystalYellow
                            + cube.HasCrystalWhite
                            + cube.HasCrystalPurple;
                        ...
                        )
                        {
                            if (cube.HasCrystalRed == 0)
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    1150,
                                    true,
                                    "You found the red Void Crystal!"
                                );
                                from.SendSound(0x3D);
                                LoggingFunctions.LogGeneric(
                                    from,
                                    "has found the red Void Crystal."
                                );
                                EmptyBox = 0;
                            }
                            else if (cube.HasCrystalBlue == 0)
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    1150,
                                    true,
                                    "You found the blue Void Crystal!"
                                );
                                from.SendSound(0x3D);
                                LoggingFunctions.LogGeneric(
                                    from,
                                    "has found the blue Void Crystal."
                                );
                                EmptyBox = 0;
                            }
                            else if (cube.HasCrystalBlue == 0)
                            ...
                            else if (cube.HasCrystalGreen == 0)
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    1150,
                                    true,
                                    "You found the green Void Crystal!"
                                );
                                from.SendSound(0x3D);
                                LoggingFunctions.LogGeneric(
                                    from,
                                    "has found the green Void Crystal."
                                );
                                EmptyBox = 0;
                            }
                            else if (cube.HasCrystalYellow == 0)
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    1150,
                                    true,
                                    "You found the yellow Void Crystal!"
                                );
                                from.SendSound(0x3D);
                                LoggingFunctions.LogGeneric(
                                    from,
                                    "has found the yellow Void Crystal."
                                );
                                EmptyBox = 0;
                            }
                            else if (cube.HasCrystalWhite == 0)
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    1150,
                                    true,
                                    "You found the white Void Crystal!"
                                );
                                from.SendSound(0x3D);
                                LoggingFunctions.LogGeneric(
                                    from,
                                    "has found the white Void Crystal."
                                );
                                EmptyBox = 0;
                            }
                            else if (cube.HasCrystalPurple == 0)
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    1150,
                                    true,
                                    "You found the purple Void Crystal!"
                                );
                                from.SendSound(0x3D);
                                LoggingFunctions.LogGeneric(
                                    from,
                                    "has found the purple Void Crystal."
                                );
                                EmptyBox = 0;
                            }
                ...
                if (from.Backpack.FindItemByType(typeof(AlienEgg)) != null)
                {
                    ...
                    )
                    {
                        ...
                        {
                            pickNewEggSpot = true;
                            egg.HaveYellowCrystal = 1;
                            from.LocalOverheadMessage(
                                MessageType.Emote,
                                1150,
                                true,
                                "You found the sun crystal!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        ...
                        {
                            pickNewEggSpot = true;
                            egg.HaveRedCrystal = 1;
                            from.LocalOverheadMessage(
                                MessageType.Emote,
                                1150,
                                true,
                                "You found the blood crystal!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        else if (egg.HavePotion < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the potion of growth!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                    ...
                    )
                    {
                        ...
                        if (egg.HavePotionA < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the elixir of the flame!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        else if (egg.HavePotionB < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the potion of the earth!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        else if (egg.HavePotionC < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the mixture of the sea!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        else if (egg.HavePotionD < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the oil of the winds!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                    ...
                    )
                    {
                        ...
                        if (skull.HavePotionA < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the heart of the dead god!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        else if (skull.HavePotionB < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the eye of the mad king!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        else if (skull.HavePotionC < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the orb of the astral lich!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        else if (skull.HavePotionD < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the mind of the planar ghost!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                ...
                if (from.Backpack.FindItemByType(typeof(DemonPrison)) != null)
                {
                    ...
                    )
                    {
                        ...
                        {
                            pickNewprisonSpot = true;
                            prison.HaveShardA = 1;
                            from.LocalOverheadMessage(
                                MessageType.Emote,
                                1150,
                                true,
                                "You found the shard of hellfire!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        else if (prison.HaveShardB < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the shard of the abyss!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        ...
                        else if (prison.HaveShardD < 1)
                        {
                            ...
                            from.LocalOverheadMessage(
                                ...
                                1150,
                                true,
                                "You found the shard of the void!"
                            );
                            from.SendSound(0x3D);
                            EmptyBox = 0;
                        }
                        ...
                        )
                        {
                            if (stone.SearchReal >= Utility.RandomMinMax(1, 100))
                            {
                                ...
                                if (itemType != null)
                                {
                                    ...
                                    from.LocalOverheadMessage(
                                        ...
                                        1150,
                                        true,
                                        "You found the " + stone.SearchItem + "."
                                    );
                                    from.SendSound(0x3D);
                                }
                            }
                            else if (1 == Utility.RandomMinMax(1, 2))
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    1150,
                                    true,
                                    "The " + stone.SearchItem + " appears to be a fake."
                                );
                            ...
                            else
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    0xB1F,
                                    true,
                                    "The tablet for the " + stone.SearchItem + " seems to be false."
                                );
                ...
                if (from.Backpack.FindItemByType(typeof(SearchPage)) != null)
                {
                    ...
                    if (
                        ...
                        && page.owner == from
                        && (
                            page.DungeonMap == from.Map
                            || page.DungeonMap == Server.Misc.Worlds.GetPCDefaultMap(from)
                        )
                    )
                    {
                        if (LeadToAnotherSpot >= Utility.RandomMinMax(1, 100))
                        {
                            ...
                            from.SendMessage(
                                "so you update your notes for the new place to search."
                            );
                            EmptyBox = 0;
                        }
                        else
                        {
                            ...
                            else if (page.LegendPercent >= Utility.RandomMinMax(1, 200))
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    1150,
                                    true,
                                    "The legend was false, but there was "
                                        + sGold
                                        + " gold in here."
                                );
                            ...
                            else if (1 == Utility.RandomMinMax(1, 2))
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    1150,
                                    true,
                                    "The " + page.SearchItem + " appears to be a fake."
                                );
                                from.SendSound(0x3D);
                            }
                            else
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    0xB1F,
                                    true,
                                    "The legends of the " + page.SearchItem + " seemed to be false."
                                );
                                from.PlaySound(0x249);
                            }
                            scroll.Delete();
