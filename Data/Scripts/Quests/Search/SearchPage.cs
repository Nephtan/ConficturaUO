...
namespace Server.Items
{
    public class SearchPage : Item
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Search_Dungeon
        {
            get { return SearchDungeon; }
            set
            {
                SearchDungeon = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Search_World
        {
            get { return SearchWorld; }
            set
            {
                SearchWorld = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Legend_Real
        {
            get { return LegendReal; }
            set
            {
                LegendReal = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Legend_Percent
        {
            get { return LegendPercent; }
            set
            {
                LegendPercent = value;
                InvalidateProperties();
        ...
        [Constructable]
        public SearchPage(Mobile from, int LegendLore, string seekType, string seekName)
            : base(0x2159)
        {
            SearchItem = seekName;
            SearchType = seekType;
            ...
            {
                case 1:
                    Name = "highly unlikely legend for " + from.Name;
                    break;
                case 2:
                    Name = "unlikely legend for " + from.Name;
                    break;
                case 3:
                    Name = "somewhat unlikely legend for " + from.Name;
                    break;
                case 4:
                    Name = "somewhat reliable legend for " + from.Name;
                    break;
                case 5:
                    Name = "reliable legend for " + from.Name;
                    break;
                case 6:
            ...
            LegendReal = 0;
            if (LegendLore >= Utility.RandomMinMax(1, 100))
            {
                LegendReal = 1;
            }
        ...
        {
            public SearchGump(Mobile from, Item parchment)
                : base(100, 100)
            {
        ...
        public static void PickSearchLocation(SearchPage scroll, string DungeonNow, Mobile from)
        {
            ...
            string sMessage = scroll.SearchDungeon = thisPlace;
        ...
        public SearchPage(Serial serial)
            : base(serial) { }
