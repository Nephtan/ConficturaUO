...
namespace Server.Items
{
    ...
    public class DoorCodex : Item
    {
        ...
        public DoorCodex(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile m)
        {
            if (m.Y < this.Y && m.InRange(this.GetWorldLocation(), 2))
            {
                ...
                m.Y > this.Y
                && m.InRange(this.GetWorldLocation(), 2)
                && m.Backpack.FindItemByType(typeof(VortexCube)) != null
            )
            {
                ...
                m.Y > this.Y
                && m.InRange(this.GetWorldLocation(), 2)
                && m.Backpack.FindItemByType(typeof(CodexWisdom)) != null
            )
            {
