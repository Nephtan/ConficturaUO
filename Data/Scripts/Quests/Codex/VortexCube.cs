...
namespace Server.Items
{
    public class VortexCube : Item
    {
        ...
        {
            get { return HasConvexLense; }
            set
            {
                HasConvexLense = value;
        ...
        {
            get { return HasConcaveLense; }
            set
            {
                HasConcaveLense = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return LocationKeyLaw; }
            set
            {
                LocationKeyLaw = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return LocationKeyChaos; }
            set
            {
                LocationKeyChaos = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return TextKeyBalance; }
            set
            {
                TextKeyBalance = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return LocationKeyBalance; }
            set
            {
                LocationKeyBalance = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return HasCrystalBlue; }
            set
            {
                HasCrystalBlue = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return HasCrystalGreen; }
            set
            {
                HasCrystalGreen = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return HasCrystalYellow; }
            set
            {
                HasCrystalYellow = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return HasCrystalWhite; }
            set
            {
                HasCrystalWhite = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return HasCrystalPurple; }
            set
            {
                HasCrystalPurple = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return LocationCrystal; }
            set
            {
                LocationCrystal = value;
                InvalidateProperties();
            }
        }
        ...
        public VortexCube(Serial serial)
            : base(serial) { }
        ...
        private class VortexGump : Gump
        {
            ...
            public VortexGump(VortexCube cube, Mobile from)
                : base(50, 50)
            {
                m_Cube = cube;
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">CODEX OF ULTIMATE WISDOM</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    181,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">The Vortex Cube</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    1016,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Found!</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    181,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">The Concave Lense</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    181,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">The Convex Lense</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                if (m_Cube.HasKeyLaw > 0)
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">The Key of Law has been found!</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
                ...
                if (m_Cube.HasKeyBalance > 0)
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">The Key of Balance has been found!</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
                else
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">The Key of Balance "
                            + m_Cube.TextKeyBalance
                            + " "
                            + m_Cube.LocationKeyBalance
                            + ".</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (m_Cube.HasKeyChaos > 0)
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">The Key of Chaos has been found!</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">The Void Crystals are scattered throughout the land. The Vortex Cube can draw you toward the dungeons they may be in.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                if (
                    (
                        m_Cube.HasCrystalRed
                        + m_Cube.HasCrystalBlue
                        + m_Cube.HasCrystalGreen
                        + m_Cube.HasCrystalYellow
                        + m_Cube.HasCrystalWhite
                ...
                )
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">All of the Void Crystals have been found!</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
                else if (m_Cube.HasCrystalRed == 0)
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">The Red Void Crystal "
                            + m_Cube.TextCrystal
                            + " "
                            + m_Cube.LocationCrystal
                            + ".</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
        ...
        public static string GargoyleLocation(string gargoyle)
        {
            ...
            foreach (Mobile mob in World.Mobiles.Values)
                ...
                {
                    where =
                        "the gargoyle is said to be within "
                        + Server.Misc.Worlds.GetRegionName(mob.Map, mob.Location);
                }
