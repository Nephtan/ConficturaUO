...
namespace Server
{
    public class CodexGump : Gump
    {
        ...
        public CodexGump(CodexWisdom codex, string warn, Mobile from)
            : base(50, 50)
        {
            string color = "#6cb89a";
            int display = 60;
            ...
            if (m_CodexWisdom.SkillFirst > 0 && m_CodexWisdom.SkillSecond > 0)
            {
                title = "CHOOSE A SKILL TO FORGET SO YOU CAN LEARN A DIFFERENT ONE";
            }
            else if (m_CodexWisdom.SkillFirst == 0 && m_CodexWisdom.SkillSecond > 0)
            {
                title =
                    "CHOOSE ONE SKILL TO STUDY OR ONE TO FORGET SO YOU CAN LEARN A DIFFERENT ONE";
            }
            else if (m_CodexWisdom.SkillFirst > 0 && m_CodexWisdom.SkillSecond == 0)
            {
                title =
            ...
            {
                warn =
                    "If you change your skills and leave the chamber, the lenses will vanish and you may need to find others.";
            }
            ...
            AddHtml(
                ...
                727,
                20,
                @"<BODY><BASEFONT Color=" + color + ">CODEX OF ULTIMATE WISDOM</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddHtml(
            ...
            AddHtml(
                ...
                976,
                20,
                @"<BODY><BASEFONT Color=" + color + ">" + warn + "</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (info.ButtonID > 0)
            {
                ...
                if (
                    (m_CodexWisdom.SkillFirst == 55 || m_CodexWisdom.SkillSecond == 55)
                    && (m_CodexWisdom.SkillFirst == 31 || m_CodexWisdom.SkillSecond == 31)
                )
                {
                    updateBook = false;
                ...
                if (
                    (m_CodexWisdom.SkillFirst == 55 || m_CodexWisdom.SkillSecond == 55)
                    && (m_CodexWisdom.SkillFirst == 36 || m_CodexWisdom.SkillSecond == 36)
                )
                {
                    updateBook = false;
    ...
    public class LenseGump : Gump
    {
        ...
        public LenseGump(CodexWisdom codex, int status, Mobile from)
            : base(50, 50)
        {
            string color = "#acacac";
            string hue = "#ffffff";
            ...
            if (status > 0)
            {
                phrase = "This can only be studied within the Chamber of the Codex.";
            }
            ...
            AddHtml(
                ...
                200,
                20,
                @"<BODY><BASEFONT Color=" + color + ">CODEX OF WISDOM</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                227,
                71,
                @"<BODY><BASEFONT Color=" + hue + ">" + phrase + "</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            if (m_CodexWisdom.HasConcaveLense > 0)
            {
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">You have the Concave Lense.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            ...
            else
            {
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Naxatilor "
                        + Server.Items.VortexCube.GargoyleLocation("Naxatilor")
                        + ".</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            ...
            if (m_CodexWisdom.HasConvexLense > 0)
            {
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + hue
                        + ">You have the Convex Lense.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddItem(-4, 251, 1518);
            ...
            else
            {
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + hue
                        + ">Lor-wis-lem "
                        + Server.Items.VortexCube.GargoyleLocation("Lor-wis-lem")
                        + ".</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
    ...
    public class CodexWisdom : MagicTalisman
    {
        ...
        public Mobile Codex_Owner
        {
            get { return CodexOwner; }
            set { CodexOwner = value; }
        }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (CodexOwner != null)
            {
                list.Add(1049644, "Belongs to " + CodexOwner.Name + "");
            }
        }
        ...
        {
            if (book.SkillFirst > 0)
            {
                book.SkillBonuses.SetValues(0, GetCodexSkill(book.SkillFirst), 100);
            }
            else
            {
                book.SkillBonuses.SetValues(0, SkillName.Alchemy, 0);
            }
            if (book.SkillSecond > 0)
            {
                book.SkillBonuses.SetValues(1, GetCodexSkill(book.SkillSecond), 100);
            }
            else
            {
                book.SkillBonuses.SetValues(1, SkillName.Alchemy, 0);
            }
        ...
        public CodexWisdom(Serial serial)
            : base(serial) { }
