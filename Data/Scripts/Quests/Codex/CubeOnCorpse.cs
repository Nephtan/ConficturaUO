...
namespace Server.Items
{
    public class CubeOnCorpse : Item
    {
            ...
            if (from is PlayerMobile)
            {
                ...
                for (int i = 0; i < targets.Count; ++i)
                {
                    ...
                    if (item is CodexWisdom)
                    {
                        ...
                        from.SendMessage(
                            "You don't need the Vortex Cube since the Codex is already in your pack."
                        );
                    }
        ...
        public static string GetRumor()
        {
            ...
            {
                case 0:
                    rumor = "is said to be in";
                    break;
                case 1:
                    rumor = "is rumored to be in";
                    break;
                case 2:
                    rumor = "has legends tell of it being in";
                    break;
                case 3:
                    rumor = "was heard to be in";
                    break;
            }
        ...
        public CubeOnCorpse(Serial serial)
            : base(serial) { }
