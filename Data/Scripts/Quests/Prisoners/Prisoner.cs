...
namespace Server.Items
{
    public class Prisoner : Item
    {
        ...
        public int Prisoner_Reward
        {
            get { return PrisonerReward; }
            set
            {
                PrisonerReward = value;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int Prisoner_Join
        {
            get { return PrisonerJoin; }
            set
            {
                PrisonerJoin = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int Prisoner_Type
        {
            get { return PrisonerType; }
            set
            {
                PrisonerType = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string Prisoner_Title
        {
            get { return PrisonerTitle; }
            set
            {
                PrisonerTitle = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int Prisoner_Sound
        {
            get { return PrisonerSound; }
            set
            {
                PrisonerSound = value;
                InvalidateProperties();
        ...
        public void BuildPrisoner()
        {
            ...
            {
                case 0:
                    monster = Utility.RandomMinMax(1, 12);
                    break;
                case 1:
                    monster = Utility.RandomMinMax(13, 22);
                    break;
                case 2:
                    monster = Utility.RandomMinMax(23, 30);
                    break;
                case 3:
                    monster = Utility.RandomMinMax(31, 34);
                    break;
                case 4:
                    monster = Utility.RandomMinMax(35, 41);
                    break;
                case 5:
                    monster = Utility.RandomMinMax(42, 47);
                    break;
                case 6:
                    monster = 48;
                    break;
            ...
            {
                case 1:
                    PrisonerTitle = "the bugbear";
                    PrisonerName = NameList.RandomName("giant");
                    PrisonerBody = 343;
                    PrisonerSound = 427;
                    PrisonerType = 1;
                    break;
                case 2:
                    PrisonerTitle = "the morlock";
                    PrisonerName = NameList.RandomName("savage");
                    PrisonerBody = 332;
                    PrisonerSound = 427;
                    PrisonerType = 1;
                    break;
                case 3:
                    PrisonerTitle = "the mind flayer";
                    PrisonerName = NameList.RandomName("vampire");
                    PrisonerBody = 768;
                    PrisonerSound = 898;
                    PrisonerType = 3;
                    break;
                case 4:
                    PrisonerTitle = "the hobgoblin";
                    PrisonerName = NameList.RandomName("giant");
                    PrisonerBody = 11;
                    PrisonerSound = 1114;
                    PrisonerType = 1;
                    break;
                case 5:
                    PrisonerTitle = "the goblin";
                    PrisonerName = NameList.RandomName("goblin");
                    PrisonerBody = 647;
                    PrisonerSound = 0x543;
                    PrisonerType = 2;
                    break;
                case 6:
                    ...
                    break;
                case 7:
                    PrisonerTitle = "the gnoll";
                    PrisonerName = NameList.RandomName("urk");
                    PrisonerBody = 510;
                    PrisonerSound = 1114;
                    PrisonerType = 1;
                    break;
                case 8:
                    PrisonerTitle = "the satyr";
                    PrisonerName = NameList.RandomName("elf_male");
                    PrisonerBody = 271;
                    PrisonerSound = 1414;
                    PrisonerType = 1;
                    break;
                case 9:
                    PrisonerTitle = "the centaur";
                    PrisonerName = NameList.RandomName("centaur");
                    PrisonerBody = 101;
                    PrisonerSound = 679;
                    PrisonerType = 2;
                    break;
                case 10:
                    PrisonerTitle = "the pixie";
                    PrisonerName = NameList.RandomName("pixie");
                    PrisonerBody = 128;
                    PrisonerSound = 1127;
                    PrisonerType = 3;
                    break;
                case 11:
                    PrisonerTitle = "the minotaur";
                    PrisonerName = NameList.RandomName("greek");
                    PrisonerBody = 78;
                    PrisonerSound = 1358;
                    PrisonerType = 1;
                    break;
                case 12:
                    ...
                    break;
                case 13:
                    PrisonerTitle = "the sleestax";
                    PrisonerName = NameList.RandomName("lizardman");
                    PrisonerBody = 541;
                    PrisonerSound = 417;
                    PrisonerType = 1;
                    break;
                case 14:
                    PrisonerTitle = "the sakkhra";
                    PrisonerName = NameList.RandomName("lizardman");
                    PrisonerBody = 326;
                    PrisonerSound = 417;
                    PrisonerType = 3;
                ...
                case 22:
                    ...
                    break;
                case 23:
                    PrisonerTitle = "the orx";
                    PrisonerName = NameList.RandomName("ork");
                    PrisonerBody = 107;
                    PrisonerSound = 1114;
                    PrisonerType = 1;
                    break;
                case 24:
                    ...
                    break;
                case 25:
                    PrisonerTitle = "the orc";
                    PrisonerName = NameList.RandomName("orc");
                    PrisonerBody = 17;
                    PrisonerSound = 1114;
                    PrisonerType = 3;
                    break;
                ...
                case 30:
                    ...
                    break;
                case 31:
                    PrisonerTitle = "the tritun";
                    PrisonerName = NameList.RandomName("drakkul");
                    PrisonerBody = 690;
                    PrisonerSound = 1363;
                    PrisonerType = 1;
                    break;
                ...
                case 34:
                    ...
                    break;
                case 35:
                    PrisonerTitle = "the ratman";
                    PrisonerName = NameList.RandomName("ratman");
                    PrisonerBody = 42;
                    PrisonerSound = 437;
                    PrisonerType = 2;
                    break;
            ...
            if (PrisonerType == 1)
            {
                PrisonerTitle = PrisonerTitle + " " + GetMeleeTitle();
                PrisonerReward = (reward * 100);
                PrisonerJoin = (join * 100);
            }
            else if (PrisonerType == 2)
            {
                PrisonerTitle = PrisonerTitle + " " + GetArcherTitle();
                PrisonerReward = (reward * 125);
                PrisonerJoin = (join * 125);
            }
            else if (PrisonerType == 3)
            {
                PrisonerTitle = PrisonerTitle + " " + GetMageTitle();
                PrisonerReward = (reward * 150);
                PrisonerJoin = (join * 150);
            }
            else if (PrisonerType == 97)
            {
                PrisonerReward = (reward * 150);
                PrisonerJoin = (4000 + (10 * Utility.RandomMinMax(10, 100)));
            }
            else if (PrisonerType == 98)
            {
                PrisonerReward = (reward * 150);
                PrisonerJoin = (5000 + (10 * Utility.RandomMinMax(10, 100)));
            }
            else if (PrisonerType == 99)
            {
                PrisonerReward = (reward * 150);
                PrisonerJoin = (6000 + (10 * Utility.RandomMinMax(10, 100)));
            }
        }
        ...
        private class PrisonerGump : Gump
        {
            ...
            public PrisonerGump(Prisoner jail, Mobile from)
                : base(50, 50)
            {
                m_Jail = jail;
                ...
                {
                    FullName = FullName + " (Warrior)";
                }
                else if (m_Jail.PrisonerType == 98)
                {
                    FullName = FullName + " (Archer)";
                }
                else if (m_Jail.PrisonerType == 99)
                {
                    FullName = FullName + " (Wizard)";
                }
                ...
                AddHtml(
                    ...
                    382,
                    361,
                    @"<BODY><BASEFONT Color=" + color + ">" + paragraph + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)true
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        ...
                        + ">Give Them "
                        + m_Jail.PrisonerJoin
                        + " Gold to Join You</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Leave Them to Their Fate</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            ...
            public override void OnResponse(NetState sender, RelayInfo info)
            {
                ...
                if (info.ButtonID == 1)
                {
                    ...
                    LoggingFunctions.LogStandard(
                        from,
                        "has freed " + m_Jail.PrisonerName + " " + m_Jail.PrisonerTitle + "."
                    );
                ...
                else if (info.ButtonID == 2)
                {
                    ...
                    if (gold >= join)
                    {
                        ...
                        if (begging)
                            from.SendMessage(
                                "You beg "
                                    + m_Jail.PrisonerName
                                    + " to join you as a henchman for only "
                                    + join
                                    + " gold."
                            );
                        else
                            from.SendMessage(
                                "" + m_Jail.PrisonerName + " has joined you as a henchman."
                            );
                    ...
                    {
                        from.SendMessage(
                            "You do not have enough gold to convince them to join you."
                        );
                    }
                }
                else if (info.ButtonID == 3)
                {
                    ...
                    {
                        case 0:
                            from.Say("I will leave you to your fate, " + m_Jail.PrisonerName + "!");
                            break;
                        case 1:
                            from.Say("" + m_Jail.PrisonerName + ", stay here and rot!");
                            break;
                        case 2:
                            from.Say(
                                "" + m_Jail.PrisonerName + ", the world is better with you in here!"
                            );
                            break;
                        case 3:
                            from.Say(
                                "You are not the sort I wish to free, " + m_Jail.PrisonerName + "."
                            );
                            break;
                        case 4:
                            from.Say("You must be here for a reason, " + m_Jail.PrisonerName + ".");
                            break;
                    }
                }
            }
