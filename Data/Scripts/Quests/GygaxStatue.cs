...
namespace Server.Items
{
    public class GygaxStatue : Item
    {
        ...
        public class GygaxGump : Gump
        {
                ...
                : base(50, 50)
            {
                ...
                AddHtml(
                    ...
                    308,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">THE STATUE OF GYGAX</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + "><BR><BR>The Black Knight has stolen the Statue of Gygax, but you can claim it as your own if you can find it within his vault. You must first collect the items shown below and have those when you are near the it. While standing there, read this scroll to take the statue for yourself.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    185,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Dungeon Masters Guide</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    152,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Players Handbook</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    152,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Monster Manual</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    27,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">D4</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    27,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">D6</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    27,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">D8</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    43,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">D10</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    43,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">D12</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    43,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">D20</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
        ...
        public override void OnDoubleClick(Mobile e)
        {
            ...
            )
            {
                ...
                relic.RelicGoldValue = (int)(
                    relic.RelicGoldValue * (MyServerSettings.GetGoldCutRate() * .01)
                );
                ...
                e.LocalOverheadMessage(
                    MessageType.Emote,
                    1150,
                    true,
                    "You claim the Statue of Gygax!"
                );
                e.SendSound(0x3D);
        ...
        public GygaxStatue(Serial serial)
            : base(serial) { }
    ...
    public class StatueGygaxAddon : BaseAddon
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Relic_Color
        {
            get { return RelicColor; }
            set
            {
                RelicColor = value;
                InvalidateProperties();
        ...
        {
            get { return new StatueGygaxAddonDeed(Relic_Value, Relic_Color); }
        }

        [Constructable]
        public StatueGygaxAddon()
            : this(0, 0) { }
        ...
        public override void OnComponentUsed(AddonComponent ac, Mobile from)
        {
            if (ac.ItemID == 0x53A8)
            {
                ...
                from.SendSound(0x208);
            }
            else if (ac.ItemID == 0x53A9)
            {
                ac.ItemID = 0x53A8;
                ac.Light = LightType.Empty;
                from.SendSound(0x3be);
            }
        }

        public StatueGygaxAddon(Serial serial)
            : base(serial) { }
    ...
    public class StatueGygaxAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new StatueGygaxAddon(Relic_Value, Hue); }
        }

        [Constructable]
        public StatueGygaxAddonDeed()
            : this(0, 0) { }
        ...
        public StatueGygaxAddonDeed(Serial serial)
            : base(serial) { }
