...
namespace Server.Items
{
    ...
    public class StandardQuestBoard : Item
    {
        ...
        public override void OnDoubleClick(Mobile e)
        {
            if (e.InRange(this.GetWorldLocation(), 4))
            {
                ...
                e.SendGump(
                    new BoardGump(
                        e,
                        "SEEKING BRAVE ADVENTURERS",
                        "The townsfolk are looking for brave adventurers, "
                            + e.Name
        ...
        public class StandardQuestEntry : ContextMenuEntry
        {
            ...
            public StandardQuestEntry(Mobile from)
                : base(6120, 12)
            {
                m_Mobile = from;
            }
        ...
        public class StandardQuestComplete : ContextMenuEntry
        {
            ...
            public StandardQuestComplete(Mobile from)
                : base(548, 12)
            {
                m_Mobile = from;
            }
        ...
        public StandardQuestBoard(Serial serial)
            : base(serial) { }
