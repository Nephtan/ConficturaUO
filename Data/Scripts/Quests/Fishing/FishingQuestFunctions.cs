...
namespace Server.Misc
{
    class FishingQuestFunctions
    {
        ...
        public static void CheckTarget(Mobile m, Mobile target, Item box)
        {
            ...
            if (PlayerSettings.GetQuestState(m, "FishingQuest"))
            {
                ...
                if (
                    ...
                    && (
                        target is AncientLich
                        || target is PirateCaptain
                        || target is ElfPirateCaptain
                    )
                )
                {
                    IsSeaTarget = true;
                ...
                if (sPCCategory == "Item" && target != null)
                {
                    if (
                        sPCCategory == "Item"
                        && target.WhisperHue == 999
                        && FishingQuestFunctions.ChanceToFindQuestedItem()
                ...
                else if (target != null)
                {
                    ...
                    )
                    {
                        m.PrivateOverheadMessage(
                            ...
                            1153,
                            false,
                            "The quested bounty has been fulfilled!",
                            m.NetState
                        );
                        explorer = explorer.Replace("#0#", "#1#");
                        m.SendSound(0x3D);
        ...
        public static void FindTarget(Mobile m, int fee)
        {
            ...
            {
                PirateHunt = 1;
                WorldPick = Utility.RandomMinMax(0, 6);
            }
            ...
            foreach (Mobile target in World.Mobiles.Values)
                if (target is BaseCreature)
                {
                    ...
                    if (PirateHunt == 1)
                    {
                        ...
                        {
                            if (
                                (target is AncientLich || target is ElfPirateCaptain)
                                && reg.IsPartOf(typeof(PirateRegion))
                                && target.Map == Map.Lodor
                                && Worlds.GetMyWorld(
                                    target.Map,
                                    target.Location,
                                    target.X,
            ...
            for (int i = 0; i < targets.Count; ++i)
            {
                ...
                if (xCount == aCount)
                {
                    if (Utility.RandomMinMax(1, 3) != 1) // KILL SOMETHING
                    {
                        ...
                        string kWorld = Worlds.GetMyWorld(
                            theone.Map,
                            theone.Location,
                            theone.X,
                            theone.Y
                        ...
                        if (
                            theone is AncientLich
                            || theone is PirateCaptain
                            || theone is ElfPirateCaptain
                        )
                        {
                            ...
                            myexplorer =
                                ...
                                + "#"
                                + useTitle
                                + "#the Pirate Captain#the high seas#0#"
                                + kDollar
                                + "#"
                                + kWorld
                                + "#Monster";
                        ...
                        string theStory =
                            myexplorer + "#" + FishingQuestFunctions.QuestSentence(PC); // ADD THE STORY PART
                    ...
                    else // FIND SOMETHING
                    {
                        ...
                        string kDollar = (
                            (int)(
                                (Server.Misc.MyServerSettings.QuestRewardModifier() * 0.01) * nFee
                            )
                        ).ToString();
        ...
        public static string QuestSentence(Mobile m)
        {
            ...
            if (PlayerSettings.GetQuestState(m, "FishingQuest"))
            {
                ...
                if (sPCCategory == "Item")
                {
                    ...
                    {
                        case 0:
                            sTaken = "They lost it after";
                            break;
                        case 1:
                            sTaken = "It was lost when";
                            break;
                        case 2:
                            sTaken = "They last saw it when";
                            break;
                        case 3:
                            sTaken = "It was last seen before";
                            break;
                        case 4:
                            sTaken = "They had it before";
                            break;
                    }
                    ...
                    {
                        case 0:
                            sMonster = "a sea creature";
                            break;
                        case 1:
                            sMonster = "a monster from the deep";
                            break;
                        case 2:
                            sMonster = "a creature from the sea";
                            break;
                        case 3:
                            sMonster = "a horror from the deep";
                            break;
                        case 4:
                            sMonster = "an ocean creature";
                            break;
                    }
                    ...
                    {
                        case 0:
                            sHappened = "was attacked";
                            break;
                        case 1:
                            sHappened = "was sunk";
                            break;
                        case 2:
                            sHappened = "was destroyed";
                            break;
                        case 3:
                            sHappened = "was overturned";
                            break;
                        case 4:
                            sHappened = "was overrun";
                            break;
                    }
                    string sWord4 =
                        sTaken + " their " + sBoat + " " + sHappened + " by " + sMonster;
        ...
        public static string QuestStatus(Mobile m)
        {
            ...
            if (PlayerSettings.GetQuestState(m, "FishingQuest"))
            {
                ...
                {
                    sexplorerQuest =
                        "Return to any sailor quest bulletin board for your "
                        + sWorth
                        + " gold payment";
                }
            }
