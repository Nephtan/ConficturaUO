...
namespace Server.Items
{
    public class HoardPiles : Item
    {
        ...
        public string Hoard_Name
        {
            get { return HoardName; }
            set
            {
                HoardName = value;
                InvalidateProperties();
        ...
        {
            get { return TimeSpan.FromMinutes(10.0); }
        } // HOW LONG UNTIL THE PILE DECAYS IN MINUTES
        ...
        public HoardPiles(Serial serial)
            : base(serial) { }
            ...
            else if (m_Uses < 5)
            {
                ...
                switch (Utility.Random(17))
                {
                    ...
                    case 4:
                        ...
                        if (item is UnusualDyes && Server.Misc.GetPlayerInfo.EvilPlay(from))
                        {
                    ...
                    case 6:
                        ...
                        if (scroll > 2)
                        {
                            item = Loot.RandomScroll(47, 63, SpellbookType.Regular);
                        }
                        else if (scroll == 2)
                        {
                            item = Loot.RandomScroll(20, 31, SpellbookType.Elementalism);
                        }
                        else
                        {
                    ...
                    case 7:
                        ...
                        if (
                            (Region.Find(from.Location, from.Map)).IsPartOf(
                                "the Ancient Crash Site"
                            )
                            || (Region.Find(from.Location, from.Map)).IsPartOf(
                                "the Ancient Sky Ship"
                            )
                        )
                        {
                    ...
                    case 11:
                        ...
                        item = ContainerFunctions.LootMutate(
                            from,
                    ...
                    case 12:
                        ...
                        int min,
                            max;
                        Server.Misc.ContainerFunctions.GetRandomAOSStats(
                            out attributeCount,
                            out min,
                            out max,
                            6
                    ...
                    case 16:
                        ...
                        if (Server.Misc.Worlds.IsOnSpaceship(from.Location, from.Map))
                        {
                            Server.Misc.ContainerFunctions.MakeSpaceCrate(
                                ((LockableContainer)item)
                            );
                            box = item.Name;
                        }
                        ...
                        ContainerFunctions.AddGoldToContainer(
                            xTraCash,
                            (LootChest)item,
                            zone,
                            from
                        ...
                        {
                            Item artys = Loot.RandomArty();
                            ((LootChest)item).DropItem(artys);
                        }
                        break;
                }
