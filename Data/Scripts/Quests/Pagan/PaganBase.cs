...
namespace Server.Items
{
    public class PaganBase : BaseAddon
    {
        ...
        public PaganBase(string pagan)
        {
            ...
            {
                iThing = 0x1861;
                sThing = "Tongue of Flame";
                ItemType = 2;
            }
            else if (pagan == "earth")
            {
                iThing = 0x1862;
                sThing = "Heart of Earth";
                ItemType = 3;
            }
            else if (pagan == "water")
            {
                iThing = 0x1863;
                sThing = "Tear of the Seas";
                ItemType = 4;
            }
        ...
        public PaganBase(Serial serial)
            : base(serial) { }
        ...
        public override void OnComponentUsed(AddonComponent ac, Mobile from)
        {
            ...
            else if (from.Backpack.FindItemByType(typeof(ObeliskTip)) != null)
            {
                ...
                {
                    from.SendMessage(
                        "This piece of blackrock does not belong to you so it vanishes!"
                    );
                    bool remove = true;
