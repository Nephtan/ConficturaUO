...
namespace Server.Items
{
    public class ObeliskTip : Item
    {
        ...
        {
            get { return ObeliskOwner; }
            set { ObeliskOwner = value; }
        }
        ...
        public ObeliskTip(Serial serial)
            : base(serial) { }
        ...
        private class ObeliskGump : Gump
        {
            ...
            public ObeliskGump(ObeliskTip tip, Mobile from)
                : base(50, 50)
            {
                m_Tip = tip;
                ...
                AddHtml(
                    ...
                    665,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">THE TITAN OF ETHER</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">There are those that seek to become the Titan of Ether, but in order to do so, one must defeat the four Titans of the Underworld. Lithos, Pyros, Hydros, and Stratos all contain an elemental power that can be infused within blackrock and empower another. These Titans cannot simply be slain by normal means, as their opponent must possess a particular piece of blackrock in order to best them. These blackrock fragments are scattered throughout the lands and you will have to search far and wide to find them. If you undertake this great quest, be sure to carry the Obelisk Tip with you at all times. If you have the appropriate piece of blackrock, you can decide to face the Titan. If the Titan is slain, the blackrock will absorb their power. Once all of the Titans' power has been absorbed in the four pieces of blackrock, bring the Obelisk Tip to the Obsidian Fortress and approach the Blackrock Gate to become the Titan of Ether. Titans of Ether can become grandmasters in five additional skills, and their abilities can total 300 instead of 250.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    150,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Obelisk Tip</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    150,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Khumash-Gor</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddItem(48, 95, 6239);
                ...
                AddHtml(
                    ...
                    150,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Breath of Air</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    150,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Stratos</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                if (tip.HasAir > 0)
                ...
                AddHtml(
                    ...
                    150,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Tongue of Flame</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    150,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Pyros</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                if (tip.HasFire > 0)
                ...
                AddHtml(
                    ...
                    150,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Heart of Earth</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    150,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Lithos</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                if (tip.HasEarth > 0)
                ...
                AddHtml(
                    ...
                    150,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Tear of the Seas</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    150,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Hydros</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                if (tip.HasWater > 0)
                ...
                AddHtml(
                    ...
                    878,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + stones + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    878,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + titans + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
