...
namespace Server.Items
{
    public class PaganArtifact : Item
    {
        ...
        public int Pagan_Item
        {
            get { return PaganItem; }
            set
            {
                PaganItem = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Pagan_Color
        {
            get { return PaganColor; }
            set
            {
                PaganColor = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Pagan_Name
        {
            get { return PaganName; }
            set
            {
                PaganName = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Pagan_Points
        {
            get { return PaganPoints; }
            set
            {
                PaganPoints = value;
                InvalidateProperties();
            ...
            : base(0x05D5)
        {
            ...
            if (arty < 1)
            {
                arty = Utility.RandomMinMax(1, 15);
            }
            if (PaganItem < 1)
            {
                SetupArtifactInfo(arty);
            }
        }
        ...
        public void SetupArtifactInfo(int arty)
        {
            ...
            switch (arty)
            {
                case 1:
                    PaganItem = helms;
                    PaganColor = color;
                    PaganName = "Magic Helm Armour";
                    if (PaganColor == 0xB74)
                    {
                        PaganName = "Ghost Helm Armour";
                    }
                    break;
                case 2:
                    PaganItem = 0x1410;
                    PaganColor = color;
                    PaganName = "Magic Arm Armour";
                    if (PaganColor == 0xB74)
                    {
                        PaganName = "Ghost Arm Armour";
                    }
                    break;
                case 3:
                    PaganItem = 0x46AA;
                    PaganColor = color;
                    PaganName = "Magic Leg Armour";
                    if (PaganColor == 0xB74)
                    {
                        PaganName = "Ghost Leg Armour";
                    }
                    break;
                case 4:
                    PaganItem = 0x1413;
                    PaganColor = color;
                    PaganName = "Magic Neck Armour";
                    if (PaganColor == 0xB74)
                    {
                        PaganName = "Ghost Neck Armour";
                    }
                    break;
                case 5:
                    PaganItem = 0x1414;
                    PaganColor = color;
                    PaganName = "Magic Gauntlet Armour";
                    if (PaganColor == 0xB74)
                    {
                        PaganName = "Ghost Gauntlet Armour";
                    }
                    break;
                case 6:
                    PaganItem = 0x1415;
                    PaganColor = color;
                    PaganName = "Magic Chest Armour";
                    if (PaganColor == 0xB74)
                    {
                        PaganName = "Ghost Chest Armour";
                    }
                    break;
                ...
                case 7:
                    PaganItem = 0x1BC4;
                    PaganColor = 0x6FC;
                    PaganName = "Magic Shield";
                    break;
                case 8:
                    PaganItem = 0x1BC3;
                    PaganColor = 0xB01;
                    PaganName = "Daemon Shield";
                    break;
                ...
                case 12:
                    PaganItem = 0xF60;
                    PaganColor = 0x6FC;
                    PaganName = "Blade of Striking";
                    break;
                case 13:
                    PaganItem = 0x2D2C;
                    PaganColor = 0xB44;
                    PaganName = "Korghin's Fang";
                    break;
                case 14:
                    PaganItem = 0xF5D;
                    PaganColor = 0xB2A;
                    PaganName = "Bonecrusher";
                    break;
                case 15:
                    PaganItem = 0x13FA;
                    PaganColor = 0x6FC;
                ...
                case 16:
                    PaganItem = 0x13B5;
                    PaganColor = 0xB2A;
                    PaganName = "Scimitar of Khumash-Gor";
                    break;
            }
        }

        public PaganArtifact(Serial serial)
            : base(serial) { }
        ...
        private class PaganArtifactGump : Gump
        {
            ...
            public PaganArtifactGump(Mobile from, PaganArtifact arty)
                : base(50, 50)
            {
                string hue = "#b7765d";
                m_Artifact = arty;
                ...
                AddHtml(
                    ...
                    420,
                    20,
                    @"<BODY><BASEFONT Color=" + hue + ">" + arty.PaganName + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + hue
                        + ">This chest contains a Pagan artifact, "
                        + arty.PaganName
                        + ". If you take it out of this chest, it will be yours. When it is in your possession, single-click the item where a menu will be presented for you to spend points to customize this artifact to your liking. Once the points are spent, the item will be as it is forever. Do you wish to take the Pagan artifact, "
                        + arty.PaganName
                        + ", from the chest?</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                {
                    AddItem(95 + i, 163 + 0, m_Artifact.PaganItem, color);
                }
                else if (m_Artifact.PaganItem == 0x1410)
                {
                    AddItem(97 + i, 160 + o, 5136, color);
                }
                else if (m_Artifact.PaganItem == 0x46AA)
                {
                    AddItem(93 + i, 158 + o, 5137, color);
                }
                else if (m_Artifact.PaganItem == 0x1413)
                {
                    AddItem(103 + i, 164 + o, 5139, color);
                }
                else if (m_Artifact.PaganItem == 0x1414)
                {
                    AddItem(98 + i, 160 + o, 5140, color);
                }
                else if (m_Artifact.PaganItem == 0x1415)
                {
                    AddItem(97 + i, 155 + o, 5141, color);
                }
                else if (m_Artifact.PaganName == "Magic Shield")
                {
                    AddItem(93 + i, 158 + o, 7108, color);
                }
                else if (m_Artifact.PaganName == "Daemon Shield")
                {
                    AddItem(97 + i, 162 + o, 7107, color);
                }
                else if (m_Artifact.PaganName == "Slayer")
                {
                    AddItem(101 + i, 159 + o, 5126, color);
                }
                else if (m_Artifact.PaganName == "Flame Sting")
                {
                    AddItem(103 + i, 155 + o, 5120, color);
                }
                else if (m_Artifact.PaganName == "Protector")
                {
                    AddItem(105 + i, 162 + o, 3935, color);
                }
                else if (m_Artifact.PaganName == "Blade of Striking")
                {
                    AddItem(92 + i, 155 + o, 3936, color);
                }
                else if (m_Artifact.PaganName == "Korghin's Fang")
                {
                    AddItem(83 + i, 159 + o, 11564, color);
                }
                else if (m_Artifact.PaganName == "Bonecrusher")
                {
                    AddItem(103 + i, 158 + o, 3933, color);
                }
                else if (m_Artifact.PaganName == "Deceiver")
                {
                    AddItem(104 + i, 158 + o, 5114, color);
                }
                else if (m_Artifact.PaganName == "Scimitar of Khumash-Gor")
                {
                    AddItem(101 + i, 160 + o, 5045, color);
                }
            }
            ...
            public override void OnResponse(NetState sender, RelayInfo info)
            {
                ...
                if (info.ButtonID == 1)
                {
                    ...
                    )
                    {
                        ...
                        {
                            armor = new GiftPlateHelm();
                            armor.ItemID = m_Artifact.PaganItem;
                        }
                        ...
                        from.SendMessage(
                            "You take possession of the Pagan artifact, "
                                + m_Artifact.PaganName
                                + "!"
                        );
                    ...
                    else
                    {
                        ...
                        {
                            sword = new GiftKryss();
                            sword.Slayer = SlayerName.FlameDousing;
                        ...
                        {
                            sword = new GiftBroadsword();
                            sword.SkillBonuses.SetValues(
                                0,
