...
namespace Server.Items
{
    public class CanopicJar : Item
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Jar_Contents
        {
            get { return JarContents; }
            set
            {
                JarContents = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Jar_Potion
        {
            get { return JarPotion; }
            set
            {
                JarPotion = value;
                InvalidateProperties();
            ...
            : base(0x2FEE)
        {
            ...
            if (Weight < 30.0)
            {
                ...
                {
                    case 1:
                        JarPotion = "Nightsight Potions";
                        break;
                    case 2:
                        JarPotion = "Lesser Cure Potions";
                        break;
                    case 3:
                        JarPotion = "Cure Potions";
                        break;
                    case 4:
                        JarPotion = "Greater Cure Potions";
                        break;
                    case 5:
                        JarPotion = "Agility Potions";
                        break;
                    case 6:
                        JarPotion = "Greater Agility Potions";
                        break;
                    case 7:
                        JarPotion = "Strength Potions";
                        break;
                    case 8:
                        JarPotion = "Greater Strength Potions";
                        break;
                    case 9:
                        JarPotion = "Lesser Poison Potions";
                        break;
                    case 10:
                        JarPotion = "Poison Potions";
                        break;
                    case 11:
                        JarPotion = "Greater Poison Potions";
                        break;
                    case 12:
                        JarPotion = "Deadly Poison Potions";
                        break;
                    case 13:
                        JarPotion = "Refresh Potions";
                        break;
                    case 14:
                        JarPotion = "Total Refresh Potions";
                        break;
                    case 15:
                        JarPotion = "Lesser Heal Potions";
                        break;
                    case 16:
                        JarPotion = "Heal Potions";
                        break;
                    case 17:
                        JarPotion = "Greater Heal Potions";
                        break;
                    case 18:
                        JarPotion = "Lesser Explosion Potions";
                        break;
                    case 19:
                        JarPotion = "Explosion Potions";
                        break;
                    case 20:
                        JarPotion = "Greater Explosion Potions";
                        break;
                    case 21:
                        JarPotion = "Lesser Invisibility Potions";
                        break;
                    case 22:
                        JarPotion = "Invisibility Potions";
                        break;
                    case 23:
                        JarPotion = "Greater Invisibility Potions";
                        break;
                    case 24:
                        JarPotion = "Lesser Rejuvenate Potions";
                        break;
                    case 25:
                        JarPotion = "Rejuvenate Potions";
                        break;
                    case 26:
                        JarPotion = "Greater Rejuvenate Potions";
                        break;
                    case 27:
                        JarPotion = "Lesser Mana Potions";
                        break;
                    case 28:
                        JarPotion = "Mana Potions";
                        break;
                    case 29:
                        JarPotion = "Greater Mana Potions";
                        break;
                    case 30:
                        JarPotion = "Lethal Poison Potions";
                        break;
                    case 31:
                        JarPotion = "Invulnerability Potions";
                        break;
                }
            }
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        from.SendMessage(
                            "You will need at least 500 gold in your pack to pay the alchemist."
                        );
                    }
                }
            }
        ...
        public CanopicJar(Serial serial)
            : base(serial) { }
