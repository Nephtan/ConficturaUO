...
namespace Server.Items
{
    public class PotionCauldron : BaseAddon
    {
        ...
        {
            get { return TimeSpan.FromMinutes(30.0); }
        } // HOW LONG UNTIL THE POOL DECAYS IN MINUTES
        ...
        public PotionCauldron()
        {
            ...
            switch (m_Pool)
            {
                case 0:
                    potionHue = 1109;
                    potionName = "Cauldron of Nightsight Liquid";
                    break;
                case 1:
                    potionHue = 45;
                    potionName = "Cauldron of Lesser Cure Liquid";
                    break;
                case 2:
                    potionHue = 45;
                    potionName = "Cauldron of Cure Liquid";
                    break;
                case 3:
                    potionHue = 45;
                    potionName = "Cauldron of Greater Cure Liquid";
                    break;
                case 4:
                    potionHue = 396;
                    potionName = "Cauldron of Agility Liquid";
                    break;
                case 5:
                    potionHue = 396;
                    potionName = "Cauldron of Greater Agility Liquid";
                    break;
                case 6:
                    potionHue = 1001;
                    potionName = "Cauldron of Strength Liquid";
                    break;
                case 7:
                    potionHue = 1001;
                    potionName = "Cauldron of Greater Strength Liquid";
                    break;
                case 8:
                    potionHue = 73;
                    potionName = "Cauldron of Lesser Poison Liquid";
                    break;
                case 9:
                    potionHue = 73;
                    potionName = "Cauldron of Poison Liquid";
                    break;
                case 10:
                    potionHue = 73;
                    potionName = "Cauldron of Greater Poison Liquid";
                    break;
                case 11:
                    potionHue = 73;
                    potionName = "Cauldron of Deadly Poison Liquid";
                    break;
                case 12:
                    potionHue = 140;
                    potionName = "Cauldron of Refresh Liquid";
                    break;
                case 13:
                    potionHue = 140;
                    potionName = "Cauldron of Total Refresh Liquid";
                    break;
                case 14:
                    potionHue = 50;
                    potionName = "Cauldron of Lesser Heal Liquid";
                    break;
                case 15:
                    potionHue = 50;
                    potionName = "Cauldron of Heal Liquid";
                    break;
                case 16:
                    potionHue = 50;
                    potionName = "Cauldron of Greater Heal Liquid";
                    break;
                case 17:
                    potionHue = 425;
                    potionName = "Cauldron of Lesser Explosion Liquid";
                    break;
                case 18:
                    potionHue = 425;
                    potionName = "Cauldron of Explosion Liquid";
                    break;
                case 19:
                    potionHue = 425;
                    potionName = "Cauldron of Greater Explosion Liquid";
                    break;
                case 20:
                    potionHue = 0x490;
                    potionName = "Cauldron of Lesser Invisibility Liquid";
                    break;
                case 21:
                    potionHue = 0x490;
                    potionName = "Cauldron of Invisibility Liquid";
                    break;
                case 22:
                    potionHue = 0x490;
                    potionName = "Cauldron of Greater Invisibility Liquid";
                    break;
                case 23:
                    potionHue = 0x48E;
                    potionName = "Cauldron of Lesser Rejuvenate Liquid";
                    break;
                case 24:
                    potionHue = 0x48E;
                    potionName = "Cauldron of Rejuvenate Liquid";
                    break;
                case 25:
                    potionHue = 0x48E;
                    potionName = "Cauldron of Greater Rejuvenate Liquid";
                    break;
                case 26:
                    potionHue = 0x48D;
                    potionName = "Cauldron of Lesser Mana Liquid";
                    break;
                case 27:
                    potionHue = 0x48D;
                    potionName = "Cauldron of Mana Liquid";
                    break;
                case 28:
                    potionHue = 0x48D;
                    potionName = "Cauldron of Greater Mana Liquid";
                    break;
                case 29:
                    potionHue = 0x496;
                    potionName = "Cauldron of Invulnerability Liquid";
                    break;
            }
        ...
        public PotionCauldron(Serial serial)
            : base(serial) { }
        ...
        public override void OnComponentUsed(AddonComponent ac, Mobile from)
        {
            ...
            else if (m_Uses > 0)
            {
                if (from.Backpack != null)
                {
                    ...
                    if (iBottle != null)
                    {
                        if (iBottle.Amount > 1)
                        {
                            iBottle.Amount = iBottle.Amount - 1;
                        }
                        else
                        {
                            iBottle.Consume();
                        ...
                        from.PlaySound(0x4E);
                        from.SendMessage(
                            "You fill a potion bottle with the liquid from the cauldron."
                        );
                    ...
                    {
                        from.SendMessage(
                            "You do not have an empty potion bottle to draw liquid from the cauldron."
                        );
                    }
                }
            }
            ...
            {
                from.SendMessage(
                    "There is no longer enough in the cauldron to fill an entire bottle."
                );
            }
        }
    ...
    public class EmptyPotionCauldron : BaseAddon
    {
        ...
        public EmptyPotionCauldron(Serial serial)
            : base(serial) { }
