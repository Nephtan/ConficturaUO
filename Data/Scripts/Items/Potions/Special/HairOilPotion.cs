...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public HairOilPotion()
            : base(0x180F, PotionEffect.HairOil)
        {
            Hue = 0xB50;
            Name = "hair styling potion";
        }

        public HairOilPotion(Serial serial)
            : base(serial) { }
        ...
        private class PotionGump : Gump
        {
            ...
            public PotionGump(HairOilPotion potion, Mobile from)
                : base(25, 25)
            {
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">CHOOSE A NEW HAIR STYLE</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                if (m_From.HairItemID != 0x203B)
                {
                    ...
                    AddHtml(
                        ...
                        195,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Short</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    y = y + 35;
                ...
                if (m_From.HairItemID != 0x203C)
                {
                    ...
                    AddHtml(
                        ...
                        195,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Long</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    y = y + 35;
                ...
                if (m_From.HairItemID != 0x203D)
                {
                    ...
                    AddHtml(
                        ...
                        195,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Pony Tail</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    y = y + 35;
                ...
                if (m_From.HairItemID != 0x2044)
                {
                    ...
                    AddHtml(
                        ...
                        195,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Mohawk</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    y = y + 35;
                ...
                if (m_From.HairItemID != 0x2045)
                {
                    ...
                    AddHtml(
                        ...
                        195,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Pageboy</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    y = y + 35;
                ...
                if (m_From.HairItemID != 0x2047)
                {
                    ...
                    AddHtml(
                        ...
                        195,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Afro</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    y = y + 35;
                ...
                if (m_From.HairItemID != 0x2049)
                {
                    ...
                    AddHtml(
                        ...
                        195,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Pig Tails</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    y = y + 35;
                ...
                if (m_From.HairItemID != 0x204A)
                {
                    ...
                    AddHtml(
                        ...
                        195,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Krisna</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    y = y + 35;
                ...
                if (m_From.Female && m_From.HairItemID != 0x2046)
                {
                    ...
                    AddHtml(
                        ...
                        195,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Buns</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    y = y + 35;
                ...
                else if (!(m_From.Female) && m_From.HairItemID != 0x2048)
                {
                    ...
                    AddHtml(
                        ...
                        195,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Receeding</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    y = y + 35;
