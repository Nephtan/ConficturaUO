...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public DurabilityPotion()
            : base(0x180F, PotionEffect.Durability)
        {
            Hue = 0xB7D;
            Name = "durability potion";
        }

        public DurabilityPotion(Serial serial)
            : base(serial) { }
        ...
        private class DurabilityTarget : Target
        {
            ...
            public DurabilityTarget(DurabilityPotion potion, Mobile from)
