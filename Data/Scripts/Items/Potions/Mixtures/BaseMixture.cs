...
namespace Server.Items
{
    public class BaseMixture : BasePotion
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Slime_Magery
        {
            get { return SlimeMagery; }
            set
            {
                SlimeMagery = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Slime_Poisons
        {
            get { return SlimePoisons; }
            set
            {
                SlimePoisons = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Slime_Phys
        {
            get { return SlimePhys; }
            set
            {
                SlimePhys = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Slime_Cold
        {
            get { return SlimeCold; }
            set
            {
                SlimeCold = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Slime_Fire
        {
            get { return SlimeFire; }
            set
            {
                SlimeFire = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Slime_Pois
        {
            get { return SlimePois; }
            set
            {
                SlimePois = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Slime_Engy
        {
            get { return SlimeEngy; }
            set
            {
                SlimeEngy = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Slime_Glow
        {
            get { return SlimeGlow; }
            set
            {
                SlimeGlow = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Slime_Hate
        {
            get { return SlimeHate; }
            set
            {
                SlimeHate = value;
                InvalidateProperties();
        ...
        [Constructable]
        public BaseMixture(PotionEffect p)
            : base(0x1FDB, p) { }
        ...
        private class ThrowTarget : Target
        {
            ...
            public ThrowTarget(BaseMixture potion)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else
                {
                    ...
                    if (EnhancePotions(from) >= Utility.RandomMinMax(1, 120))
                    {
                        slimy++;
                    }
                    if (from.Skills[SkillName.Cooking].Value >= Utility.RandomMinMax(1, 200))
                    {
                        slimy++;
                    }
                    if (from.Skills[SkillName.Tasting].Value >= Utility.RandomMinMax(1, 200))
                    {
                        slimy++;
                    }
                    ...
                    Server.Mobiles.AlchemicSlime.MakeSlime(
                        from,
                        d,
                        m_Potion.SlimeMagery,
                        m_Potion.SlimePoisons,
                        m_Potion.SlimeName,
                        m_Potion.SlimeHue,
                        m_Potion.SlimePhys,
                        m_Potion.SlimeCold,
        ...
        public BaseMixture(Serial serial)
            : base(serial) { }
