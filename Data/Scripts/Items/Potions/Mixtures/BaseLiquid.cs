...
namespace Server.Items
{
    public abstract class BaseLiquid : BasePotion
    {
        ...
        public BaseLiquid(PotionEffect p)
            : base(0x2155, p) { }

        public BaseLiquid(Serial serial)
            : base(serial) { }
        ...
        public static int GetLiquidBonus(Mobile from)
        {
            return (
                1
                + (int)(Server.Items.BasePotion.EnhancePotions(from) / 20)
                + (int)(from.Skills[SkillName.Tasting].Value / 20)
                + (int)(from.Skills[SkillName.Cooking].Value / 20)
            );
        }
        ...
        private class ThrowTarget : Target
        {
            ...
            public ThrowTarget(BaseLiquid potion)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else
                {
                    MonsterSplatter.AddSplatter(
                        ...
                        from,
                        m_Potion.Name,
                        (Server.Items.PotionKeg.GetPotionColor(m_Potion)),
                        m_Potion.LiquidGlow
                    );
                }
