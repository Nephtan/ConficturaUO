...
namespace Server.Mobiles
{
    ...
    public class AlchemicSlime : BaseCreature
    {
        ...
        )
        {
            ...
            int MinDamage = (int)(TotalDamage / 2);
            if (MinDamage < 1)
            {
                MinDamage = 1;
            }
            ...
            BaseCreature slime = new AlchemicSlime(
                from,
                TotalSkill,
                TotalTime,
                magery,
            ...
            if (fire > 0)
            {
                coldResist = (int)(Resists * (1.0 - (fire * 0.01)));
            }
            int fireResist = Resists;
            if (cold > 0)
            {
                fireResist = (int)(Resists * (1.0 - (cold * 0.01)));
            }
        ...
        public AlchemicSlime(Serial serial)
            : base(serial) { }
