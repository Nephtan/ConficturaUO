...
namespace Server.Items
{
    public abstract class BaseRejuvenatePotion : BasePotion
    {
        ...
        public BaseRejuvenatePotion(PotionEffect effect)
            : base(0x180F, effect) { }

        public BaseRejuvenatePotion(Serial serial)
            : base(serial) { }
        ...
        public override void Drink(Mobile from)
        {
            if (from.BeginAction(typeof(BaseRejuvenatePotion)))
            {
                ...
                Timer.DelayCall(
                    ...
                    new TimerStateCallback(ReleaseRejuvenateLock),
                    from
                );
            }
            else
                from.LocalOverheadMessage(
                    ...
                    0x22,
                    true,
                    "You must wait 10 seconds before using another rejuvenation potion."
                );
        }
