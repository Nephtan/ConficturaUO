...
namespace Server.Items
{
    public abstract class BaseFrostbitePotion : BasePotion
    {
        ...
        public BaseFrostbitePotion(PotionEffect effect)
            : base(0x180F, effect) { }

        public BaseFrostbitePotion(Serial serial)
            : base(serial) { }
        ...
        public static void AddDelay(Mobile m)
        {
            ...
            m_Delay[m] = Timer.DelayCall(
                TimeSpan.FromSeconds(30),
                new TimerStateCallback(EndDelay_Callback),
                m
            );
        }
        ...
        private class ThrowTarget : Target
        {
            ...
            public ThrowTarget(BaseFrostbitePotion potion)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                Timer.DelayCall(
                    ...
                    new TimerStateCallback(m_Potion.Explode_Callback),
