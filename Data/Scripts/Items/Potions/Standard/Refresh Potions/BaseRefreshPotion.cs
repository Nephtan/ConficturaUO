...
namespace Server.Items
{
    public abstract class BaseRefreshPotion : BasePotion
    {
        ...
        public override void Drink(Mobile from)
        {
            ...
            {
                from.Stam += Server.Misc.MyServerSettings.PlayerLevelMod(
                    Scale(from, (int)(Refresh * from.StamMax)),
                    from
                );
            ...
            {
                from.SendMessage(
                    "You decide against drinking this potion, as you are already at full stamina."
                );
            }
        }
    }
