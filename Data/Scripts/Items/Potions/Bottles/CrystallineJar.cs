...
namespace Server.Items
{
    public class CrystallineJar : Item
    {
        ...
        private class ScoopTarget : Target
        {
            ...
            public ScoopTarget(CrystallineJar jar)
        ...
        private class ThrowTarget : Target
        {
            ...
            public ThrowTarget(CrystallineJar potion)
        ...
        public CrystallineJar(Serial serial)
            : base(serial) { }
