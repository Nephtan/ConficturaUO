    ...
    public class OilWood : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (!IsChildOf(from.Backpack))
            {
                ...
                from.Skills[SkillName.Carpentry].Base >= 90
                || from.Skills[SkillName.Bowcraft].Base >= 90
            )
            {
