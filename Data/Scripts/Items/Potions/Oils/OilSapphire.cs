...
namespace Server.Items
{
    public class OilSapphire : Item
    {
            ...
            : base(0x1FDD)
        {
            ...
            Amount = amount;
            Hue = 1462;
            Name = "oil of metal enhancement ( sapphire )";
        }
        ...
        {
            private OilSapphire m_Oil;

            public OilTarget(OilSapphire tube)
        ...
        public OilSapphire(Serial serial)
            : base(serial) { }
