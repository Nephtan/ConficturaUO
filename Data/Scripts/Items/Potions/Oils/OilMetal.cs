...
namespace Server.Items
{
    public class OilMetal : Item
    {
        ...
        private class OilTarget : Target
        {
            ...
            public OilTarget(OilMetal tube)
