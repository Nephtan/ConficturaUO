...
namespace Server.Items
{
    public class OilRuby : Item
    {
            ...
            : base(0x1FDD)
        {
            ...
            Amount = amount;
            Hue = 1461;
            Name = "oil of metal enhancement ( ruby )";
        }
        ...
        {
            private OilRuby m_Oil;

            public OilTarget(OilRuby tube)
