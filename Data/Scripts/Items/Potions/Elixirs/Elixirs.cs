...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public ElixirAlchemy()
            : base(PotionEffect.ElixirAlchemy)
        {
            Name = "elixir of alchemy";
        }

        public ElixirAlchemy(Serial serial)
            : base(serial) { }
        ...
        public override void Drink(Mobile m)
        {
            if (!m.CanBeginAction(typeof(ElixirAlchemy)) || !DrankTooMuch(m))
            {
                m.PrivateOverheadMessage(
                    ...
                    0x14C,
                    false,
                    "You cannot drink another one of these elixirs yet",
                    m.NetState
                );
            }
            else
            {
                ...
                object[] mods = new object[] { new DefaultSkillMod(skill, true, MySkill), };
    ...
    {
        [Constructable]
        public ElixirAnatomy()
            : base(PotionEffect.ElixirAnatomy)
        {
            Name = "elixir of anatomy";
        }

        public ElixirAnatomy(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirAnimalLore()
            : base(PotionEffect.ElixirAnimalLore)
        {
            Name = "elixir of druidism";
        }

        public ElixirAnimalLore(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirAnimalTaming()
            : base(PotionEffect.ElixirAnimalTaming)
        {
            Name = "elixir of taming";
        }

        public ElixirAnimalTaming(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirArchery()
            : base(PotionEffect.ElixirArchery)
        {
            Name = "elixir of marksmanship";
        }

        public ElixirArchery(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirArmsLore()
            : base(PotionEffect.ElixirArmsLore)
        {
            Name = "elixir of arms lore";
        }

        public ElixirArmsLore(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirBegging()
            : base(PotionEffect.ElixirBegging)
        {
            Name = "elixir of begging";
        }

        public ElixirBegging(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirBlacksmith()
            : base(PotionEffect.ElixirBlacksmith)
        {
            Name = "elixir of blacksmithing";
        }

        public ElixirBlacksmith(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirCamping()
            : base(PotionEffect.ElixirCamping)
        {
            Name = "elixir of camping";
        }

        public ElixirCamping(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirCarpentry()
            : base(PotionEffect.ElixirCarpentry)
        {
            Name = "elixir of carpentry";
        }

        public ElixirCarpentry(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirCartography()
            : base(PotionEffect.ElixirCartography)
        {
            Name = "elixir of cartography";
        }

        public ElixirCartography(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirCooking()
            : base(PotionEffect.ElixirCooking)
        {
            Name = "elixir of cooking";
        }

        public ElixirCooking(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirDetectHidden()
            : base(PotionEffect.ElixirDetectHidden)
        {
            Name = "elixir of searching";
        }

        public ElixirDetectHidden(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirDiscordance()
            : base(PotionEffect.ElixirDiscordance)
        {
            Name = "elixir of discordance";
        }

        public ElixirDiscordance(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirEvalInt()
            : base(PotionEffect.ElixirEvalInt)
        {
            Name = "elixir of psychology";
        }

        public ElixirEvalInt(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirFencing()
            : base(PotionEffect.ElixirFencing)
        {
            Name = "elixir of fencing";
        }

        public ElixirFencing(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirFishing()
            : base(PotionEffect.ElixirFishing)
        {
            Name = "elixir of seafaring";
        }

        public ElixirFishing(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirFletching()
            : base(PotionEffect.ElixirFletching)
        {
            Name = "elixir of bowcrafting";
        }

        public ElixirFletching(Serial serial)
            : base(serial) { }
    ...
    public class ElixirFocus : BaseElixir
    {
        [Constructable]
        public ElixirFocus()
            : base(PotionEffect.ElixirFocus)
        {
            Name = "elixir of focus";
        }

        public ElixirFocus(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirForensics()
            : base(PotionEffect.ElixirForensics)
        {
            Name = "elixir of forensics";
        }

        public ElixirForensics(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirHealing()
            : base(PotionEffect.ElixirHealing)
        {
            Name = "elixir of the healer";
        }

        public ElixirHealing(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirHerding()
            : base(PotionEffect.ElixirHerding)
        {
            Name = "elixir of herding";
        }

        public ElixirHerding(Serial serial)
            : base(serial) { }
    ...
    public class ElixirHiding : BaseElixir
    {
        [Constructable]
        public ElixirHiding()
            : base(PotionEffect.ElixirHiding)
        {
            Name = "elixir of hiding";
        }

        public ElixirHiding(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirInscribe()
            : base(PotionEffect.ElixirInscribe)
        {
            Name = "elixir of inscription";
        }

        public ElixirInscribe(Serial serial)
            : base(serial) { }
    ...
    public class ElixirItemID : BaseElixir
    {
        [Constructable]
        public ElixirItemID()
            : base(PotionEffect.ElixirItemID)
        {
            Name = "elixir of mercantile";
        }

        public ElixirItemID(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirLockpicking()
            : base(PotionEffect.ElixirLockpicking)
        {
            Name = "elixir of lockpicking";
        }

        public ElixirLockpicking(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirLumberjacking()
            : base(PotionEffect.ElixirLumberjacking)
        {
            Name = "elixir of lumberjacking";
        }

        public ElixirLumberjacking(Serial serial)
            : base(serial) { }
    ...
    public class ElixirMacing : BaseElixir
    {
        [Constructable]
        public ElixirMacing()
            : base(PotionEffect.ElixirMacing)
        {
            Name = "elixir of bludgeoning";
        }

        public ElixirMacing(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirMagicResist()
            : base(PotionEffect.ElixirMagicResist)
        {
            Name = "elixir of magic resistance";
        }

        public ElixirMagicResist(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirMeditation()
            : base(PotionEffect.ElixirMeditation)
        {
            Name = "elixir of meditating";
        }

        public ElixirMeditation(Serial serial)
            : base(serial) { }
    ...
    public class ElixirMining : BaseElixir
    {
        [Constructable]
        public ElixirMining()
            : base(PotionEffect.ElixirMining)
        {
            Name = "elixir of mining";
        }

        public ElixirMining(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirMusicianship()
            : base(PotionEffect.ElixirMusicianship)
        {
            Name = "elixir of musicianship";
        }

        public ElixirMusicianship(Serial serial)
            : base(serial) { }
    ...
    public class ElixirParry : BaseElixir
    {
        [Constructable]
        public ElixirParry()
            : base(PotionEffect.ElixirParry)
        {
            Name = "elixir of parrying";
        }

        public ElixirParry(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirPeacemaking()
            : base(PotionEffect.ElixirPeacemaking)
        {
            Name = "elixir of peacemaking";
        }

        public ElixirPeacemaking(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirPoisoning()
            : base(PotionEffect.ElixirPoisoning)
        {
            Name = "elixir of poisoning";
        }

        public ElixirPoisoning(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirProvocation()
            : base(PotionEffect.ElixirProvocation)
        {
            Name = "elixir of provocation";
        }

        public ElixirProvocation(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirRemoveTrap()
            : base(PotionEffect.ElixirRemoveTrap)
        {
            Name = "elixir of removing trap";
        }

        public ElixirRemoveTrap(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirSnooping()
            : base(PotionEffect.ElixirSnooping)
        {
            Name = "elixir of snooping";
        }

        public ElixirSnooping(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirSpiritSpeak()
            : base(PotionEffect.ElixirSpiritSpeak)
        {
            Name = "elixir of spiritualism";
        }

        public ElixirSpiritSpeak(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirStealing()
            : base(PotionEffect.ElixirStealing)
        {
            Name = "elixir of stealing";
        }

        public ElixirStealing(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirStealth()
            : base(PotionEffect.ElixirStealth)
        {
            Name = "elixir of stealth";
        }

        public ElixirStealth(Serial serial)
            : base(serial) { }
    ...
    public class ElixirSwords : BaseElixir
    {
        [Constructable]
        public ElixirSwords()
            : base(PotionEffect.ElixirSwords)
        {
            Name = "elixir of sword fighting";
        }

        public ElixirSwords(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirTactics()
            : base(PotionEffect.ElixirTactics)
        {
            Name = "elixir of tactics";
        }

        public ElixirTactics(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirTailoring()
            : base(PotionEffect.ElixirTailoring)
        {
            Name = "elixir of tailoring";
        }

        public ElixirTailoring(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirTasteID()
            : base(PotionEffect.ElixirTasteID)
        {
            Name = "elixir of tasting";
        }

        public ElixirTasteID(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirTinkering()
            : base(PotionEffect.ElixirTinkering)
        {
            Name = "elixir of tinkering";
        }

        public ElixirTinkering(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirTracking()
            : base(PotionEffect.ElixirTracking)
        {
            Name = "elixir of tracking";
        }

        public ElixirTracking(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirVeterinary()
            : base(PotionEffect.ElixirVeterinary)
        {
            Name = "elixir of veterinary";
        }

        public ElixirVeterinary(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public ElixirWrestling()
            : base(PotionEffect.ElixirWrestling)
        {
            Name = "elixir of fist fighting";
        }

        public ElixirWrestling(Serial serial)
            : base(serial) { }
