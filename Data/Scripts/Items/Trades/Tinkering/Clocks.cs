...
namespace Server.Items
{
    ...
    public class Clock : Item
    {
        ...
        public static void GetTime(
            ...
            int x,
            int y,
            out int generalNumber,
            out string exactTime
        )
        {
            x = 100;
            y = 100;
    ...
    public class DDRelicClock1 : Clock
    {
        ...
        public DDRelicClock1(Serial serial)
            : base(serial) { }
    ...
    public class DDRelicClock2 : Clock
    {
        ...
        public DDRelicClock2(Serial serial)
            : base(serial) { }
    ...
    public class DDRelicClock3 : Clock
    {
        ...
        public DDRelicClock3(Serial serial)
            : base(serial) { }
