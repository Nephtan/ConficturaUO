...
namespace Server.Items
{
    public class BaseWoodBoard : Item, ICommodity
    {
        ...
        [Constructable]
        public BaseWoodBoard(CraftResource resource)
            : this(resource, 1) { }
            ...
            : base(0x1BD7)
        {
            ...
            Name = Server.Misc.MaterialInfo.GetResourceName(resource) + "board";
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            Name = Server.Misc.MaterialInfo.GetResourceName(m_Resource) + "board";
            ItemID = 0x1BD7;
        }
    }
    ...
    public class CherryBoard : BaseWoodBoard
    {
        ...
        [Constructable]
        public CherryBoard(int amount)
            : base(CraftResource.CherryTree, amount) { }

        public CherryBoard(Serial serial)
            : base(serial) { }
    ...
    public class GoldenOakBoard : BaseWoodBoard
    {
        ...
        [Constructable]
        public GoldenOakBoard(int amount)
            : base(CraftResource.GoldenOakTree, amount) { }

        public GoldenOakBoard(Serial serial)
            : base(serial) { }
    ...
    public class HickoryBoard : BaseWoodBoard
    {
        ...
        [Constructable]
        public HickoryBoard(int amount)
            : base(CraftResource.HickoryTree, amount) { }

        public HickoryBoard(Serial serial)
            : base(serial) { }
    ...
    public class PineBoard : BaseWoodBoard
    {
        ...
        [Constructable]
        public PineBoard(int amount)
            : base(CraftResource.PineTree, amount) { }

        public PineBoard(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public RosewoodBoard()
            : this(1) { }

        [Constructable]
        public RosewoodBoard(int amount)
            : base(CraftResource.RosewoodTree, amount) { }

        public RosewoodBoard(Serial serial)
            : base(serial) { }
    ...
    public class WalnutBoard : BaseWoodBoard
    {
        ...
        [Constructable]
        public WalnutBoard(int amount)
            : base(CraftResource.WalnutTree, amount) { }

        public WalnutBoard(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public DriftwoodBoard()
            : this(1) { }

        [Constructable]
        public DriftwoodBoard(int amount)
            : base(CraftResource.DriftwoodTree, amount) { }

        public DriftwoodBoard(Serial serial)
            : base(serial) { }
    ...
    public class GhostBoard : BaseWoodBoard
    {
        ...
        [Constructable]
        public GhostBoard(int amount)
            : base(CraftResource.GhostTree, amount) { }

        public GhostBoard(Serial serial)
            : base(serial) { }
