        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else if (targeted is ILockpickable)
                {
                    ...
                    if (
                        Server.Misc.ContainerFunctions.IsSpaceCrate(item.ItemID)
            ...
            private class InternalTimer : Timer
            {
                ...
                protected void BrokeLockPickTest()
                {
                    ...
                    if (Utility.Random(4) == 0)
                    {
                        ...
                        {
                            m_From.PlaySound(0x549);
                            m_From.PrivateOverheadMessage(
                                0,
                                1150,
                                false,
                                "You broke the key card.",
                                m_From.NetState
                            );
                        }
                        else
                ...
                protected override void OnTick()
                {
                    ...
                    if (m_Item.LockLevel == 0 || m_Item.LockLevel == -255)
                    {
                        ...
                        if (m_Lockpick.ItemID == 0x3A75)
                        {
                            m_From.PrivateOverheadMessage(
                                ...
                                1150,
                                false,
                                "This lock cannot be hacked by normal means.",
                                m_From.NetState
                            );
                        }
                        else
                    ...
                    if ((m_From.Skills[SkillName.Lockpicking].Value + 2) < m_Item.RequiredSkill)
                    {
                        ...
                        if (m_Lockpick.ItemID == 0x3A75)
                        {
                            m_From.PrivateOverheadMessage(
                                ...
                                1150,
                                false,
                                "You don't see how that lock can be hacked.",
                                m_From.NetState
                            );
                        }
                        else
                    ...
                    )
                    {
                        ...
                        if (m_Lockpick.ItemID == 0x3A75)
                        {
                            m_From.PlaySound(0x54B);
                            m_From.PrivateOverheadMessage(
                                0,
                                1150,
                                false,
                                "Your skill at hacking worked.",
                                m_From.NetState
                            );
                        }
                        else
                    ...
                    else
                    {
                        ...
                        if (m_Lockpick.ItemID == 0x3A75)
                        {
                            m_From.PrivateOverheadMessage(
                                ...
                                1150,
                                false,
                                "You are unable to hack the lock.",
                                m_From.NetState
                            );
                        }
                        else
