...
namespace Server.Items
{
    ...
    public class PickBoxEasy : LockableContainer
    {
        ...
        public PickBoxEasy(Serial serial)
            : base(serial) { }
    ...
    public class PickBoxNormal : LockableContainer
    {
        ...
        public PickBoxNormal(Serial serial)
            : base(serial) { }
    ...
    public class PickBoxDifficult : LockableContainer
    {
        ...
        public PickBoxDifficult(Serial serial)
            : base(serial) { }
    ...
    public class PickBoxChallenging : LockableContainer
    {
        ...
        public PickBoxChallenging(Serial serial)
            : base(serial) { }
    ...
    public class PickBoxHard : LockableContainer
    {
        ...
        public PickBoxHard(Serial serial)
            : base(serial) { }
