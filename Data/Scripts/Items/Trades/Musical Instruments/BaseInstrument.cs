...
namespace Server.Items
{
    ...
    public abstract class BaseInstrument : Item, ICraftable, ISlayer
    {
        ...
        public static void PickInstrument(Mobile from, InstrumentPickedCallback callback)
        {
            ...
            else
            {
                ...
                from.BeginTarget(
                    ...
                    false,
                    TargetFlags.None,
                    new TargetStateCallback(OnPickedInstrument),
                    callback
                );
            }
        }
        ...
        {
            return (
                bc != null && bc.AI == AIType.AI_Mage && bc.Skills[SkillName.Magery].Base > 5.0
            );
        }
        ...
        public override bool OnEquip(Mobile from)
        {
            ...
            {
                from.SendMessage(
                    "Your need to at least a natural neophyte skill in musicianship to equip that!"
                );
                return false;
            }
