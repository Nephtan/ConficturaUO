...
namespace Server.Items
{
    public class TreasureMap : MapItem
    {
                ...
                try
                {
                    bc = (BaseCreature)
                        Activator.CreateInstance(
                            m_DefaultSpawns[level][Utility.Random(m_DefaultSpawns[level].Length)]
                        );
                }
                catch
                {
        ...
        public TreasureMap(int level, Map map, Point3D location, int x, int y)
        {
            ...
            else if (world == "the World of Atlantis")
            {
                map = Map.Sosaria;
            }
            else
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            from.SendAsciiMessage(
                                0x44,
                                "Try looking for the treasure chest more to the {0}.",
                                sDir
                            );
                        }
                    }
        ...
        private class DigTimer : Timer
        {
            ...
            {
                if (
                    m_NextSkillTime != m_From.NextSkillTime
                    || m_NextSpellTime != m_From.NextSpellTime
                ...
                if (m_Count > 1 && m_Dirt1 == null)
                {
                    ...
                    m_Dirt2.MoveToWorld(
                        new Point3D(m_Location.X, m_Location.Y - 1, m_Location.Z),
                        m_Map
                    );
                }
                ...
                else if (m_Count > 10)
                {
                    if (m_Chest == null)
                    {
                        ...
                        m_Chest.MoveToWorld(
                            new Point3D(m_Location.X, m_Location.Y, m_Location.Z - 15),
                            m_Map
                        );
                    }
                    else
        ...
        public string GetName()
        {
            ...
            if (m_Decoder != null)
            {
                ...
                {
                    name = "deviously drawn";
                }
                else if (m_Level == 6)
                {
                    name = "ingeniously drawn";
                }
                else if (m_Level == 7)
                {
                    name = "diabolically drawn";
                }
            }
            else
            {
                if (m_Level == 1)
                {
                    name = "plainly mysterious";
                }
                else if (m_Level == 2)
                {
                    name = "expertly mysterious";
                }
                else if (m_Level == 3)
                {
                    name = "adeptly mysterious";
                }
                else if (m_Level == 4)
                {
                    name = "cleverly mysterious";
                }
                else if (m_Level == 5)
                {
                    name = "deviously mysterious";
                }
                else if (m_Level == 6)
                {
                    name = "ingeniously mysterious";
                }
                else if (m_Level == 7)
                {
                    name = "diabolically mysterious";
                }
            }
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            if (m_Decoder != null)
            {
                int ScrollX = loc.X;
                int ScrollY = loc.Y;
                Map ScrollMap = Worlds.GetMyDefaultTreasureMap(world);
            ...
            list.Add(
                1053099,
                String.Format("<BASEFONT COLOR=#DDCC22>\t{0}<BASEFONT Color=#FBFBFB>", mDesc)
            ); // for somewhere in Lodor : for somewhere in Sosaria  etc...
            ...
            if (m_Completed)
            {
                from.Send(
                    new MessageLocalizedAffix(
                        ...
                        String.Format(
                            " completed by {0}",
                            m_CompletedBy == null ? "someone" : m_CompletedBy.Name
                        ),
                        ""
                    )
                );
            ...
            else if (m_Decoder != null)
            {
                ...
                if (m_Level == 6)
                    ...
                    LabelTo(
                        from,
                        1041522,
                        String.Format("#{0}\t \t#{1}", 1041510 + m_Level, mDesc)
                    );
            }
            // = Not Decoded
            else
            {
                ...
                if (m_Level == 6)
                    ...
                    LabelTo(
                        from,
                        1041522,
                        String.Format("#{0}\t \t#{1}", 1041516 + m_Level, mDesc)
                    );
            }
        }
        ...
        public virtual void Slice()
        {
            ...
            if (m_Decoder != null && Age >= 30)
            {
                ...
                {
                    world = "the Land of Sosaria";
                } // NO TREASURE MAPS IN SKARA BRAE
                else if (world == "the Moon of Luna")
                {
                    world = "the Land of Sosaria";
                } // NO TREASURE MAPS ON THE MOON
