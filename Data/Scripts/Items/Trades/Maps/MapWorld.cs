...
namespace Server.Items
{
    public class MapWorld : Item, ICraftable
    {
        ...
        {
            public MapAmbrosiaGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
        ...
        {
            public MapBottleGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                this.Disposable = true;
        ...
        {
            public MapDreadGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                this.Disposable = true;
        ...
        {
            public MapLodoriaGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                this.Disposable = true;
        ...
        {
            public MapSerpentGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                this.Disposable = true;
        ...
        {
            public MapSosariaGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                this.Disposable = true;
        ...
        {
            public MapSavageGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                this.Disposable = true;
        ...
        {
            public MapUmberGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                this.Disposable = true;
        ...
        {
            public MapUnderworldGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                this.Disposable = true;
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (ItemID != 0x4CC2 && ItemID != 0x4CC3)
            {
                ItemID = Utility.RandomList(0x4CC2, 0x4CC3);
            }
            Hue = 0xB63;
...
namespace Server.Items
{
    public class WorldMapLodor : Item
    {
        ...
        {
            public WorldMapGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                this.Disposable = true;
        ...
        public WorldMapLodor(Serial serial)
            : base(serial) { }
    ...
    public class WorldMapSosaria : Item
    {
        ...
        public WorldMapSosaria(Serial serial)
            : base(serial) { }
    ...
    public class WorldMapBottle : Item
    {
        ...
        public WorldMapBottle(Serial serial)
            : base(serial) { }
    ...
    public class WorldMapSerpent : Item
    {
        ...
        public WorldMapSerpent(Serial serial)
            : base(serial) { }
    ...
    public class WorldMapUmber : Item
    {
        ...
        public WorldMapUmber(Serial serial)
            : base(serial) { }
    ...
    public class WorldMapAmbrosia : Item
    {
        ...
        public WorldMapAmbrosia(Serial serial)
            : base(serial) { }
    ...
    public class WorldMapIslesOfDread : Item
    {
        ...
        public WorldMapIslesOfDread(Serial serial)
            : base(serial) { }
    ...
    public class WorldMapSavage : Item
    {
        ...
        public WorldMapSavage(Serial serial)
            : base(serial) { }
    ...
    public class WorldMapUnderworld : Item
    {
        ...
        public WorldMapUnderworld(Serial serial)
            : base(serial) { }
