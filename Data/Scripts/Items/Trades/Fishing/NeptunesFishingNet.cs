...
namespace Server.Items
{
    public class NeptunesFishingNet : Item
    {
        ...
        private static int[] m_Hues = new int[] { 0x48D, 0x48E, 0x48F, 0x490, 0x491 };

        public NeptunesFishingNet(Serial serial)
            : base(serial) { }
        ...
        protected virtual void FinishEffect(Point3D p, Map map, Mobile from)
        {
            ...
            switch (Utility.Random(7))
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    monster = "DemonOfTheSea";
                    SpawnAt = from.Location;
                    onBoat = 1;
                    break;
                case 3:
                    monster = "DeepWaterElemental";
                    break;
                case 4:
                    monster = "KelpElemental";
                    break;
                case 5:
                    monster = "IcebergElemental";
                    SpawnAt = from.Location;
                    onBoat = 1;
                    break;
                case 6:
                    monster = "DeepSeaDragon";
                    break;
            }
