...
namespace Server.Items
{
    public class HighSeasRelic : Item
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Relic_Origin
        {
            get { return RelicOrigin; }
            set
            {
                RelicOrigin = value;
                InvalidateProperties();
            ...
            : base(0x41FD)
        {
            ...
            switch (Utility.RandomMinMax(0, 20))
            {
                case 0:
                    ...
                    ItemID = 0x897;
                    Weight = 100.0;
                    RelicGoldValue = Utility.RandomMinMax(80, 200);
                    RelicFlipID1 = 0x897;
                    RelicFlipID2 = 0x898;
                ...
                case 1:
                    ...
                    ItemID = 0x1EB5;
                    Weight = 20.0;
                    RelicGoldValue = Utility.RandomMinMax(20, 80);
                    RelicFlipID1 = 0x1EB5;
                    RelicFlipID2 = 0x1EB5;
                    break;
                case 2:
                    Name = "old cannon ball";
                    ItemID = 0x0E73;
                    Weight = 10.0;
                    RelicGoldValue = Utility.RandomMinMax(10, 20);
                    RelicFlipID1 = 0x0E73;
                    RelicFlipID2 = 0x0E73;
                    break;
                case 3:
                    Name = "old cannon balls";
                    ItemID = 0x0E74;
                    Weight = 50.0;
                    RelicGoldValue = Utility.RandomMinMax(20, 40);
                    RelicFlipID1 = 0x0E74;
                    RelicFlipID2 = 0x0E74;
                    break;
                case 4:
                ...
                case 5:
                    ...
                    ItemID = 0x14F3;
                    Weight = 5.0;
                    RelicGoldValue = Utility.RandomMinMax(60, 130);
                    RelicFlipID1 = 0x14F3;
                    RelicFlipID2 = 0x14F4;
                    break;
                case 6:
                    Name = "mounted lobster";
                    ItemID = 0x46BC;
                    Weight = 2.0;
                    RelicGoldValue = Utility.RandomMinMax(40, 80);
                    RelicFlipID1 = 0x46BC;
                    RelicFlipID2 = 0x46BD;
                    break;
                case 7:
                ...
                case 9:
                    ...
                    ItemID = 0x14F8;
                    Weight = 10.0;
                    RelicGoldValue = Utility.RandomMinMax(10, 30);
                    RelicFlipID1 = 0x14F8;
                    RelicFlipID2 = 0x14FA;
                    break;
                case 10:
                    Name = "worn flogging whip";
                    ItemID = 0x166E;
                    Weight = 2.0;
                    RelicGoldValue = Utility.RandomMinMax(10, 30);
                    RelicFlipID1 = 0x166E;
                ...
                case 12:
                    ...
                    ItemID = 0x1AD6;
                    Weight = 20.0;
                    RelicGoldValue = Utility.RandomMinMax(50, 120);
                    RelicFlipID1 = 0x1AD6;
                    RelicFlipID2 = 0x1AD7;
                    Hue = 0x96D;
                    break;
                case 13:
                    ...
                    ItemID = 0x1E2A;
                    Weight = 10.0;
                    RelicGoldValue = Utility.RandomMinMax(40, 100);
                    RelicFlipID1 = 0x1E2A;
                    RelicFlipID2 = 0x1E2B;
                    break;
                case 14:
                    Name = "ruined fishing net";
                    ItemID = 0x1EA3;
                    Weight = 10.0;
                    RelicGoldValue = Utility.RandomMinMax(30, 90);
                    RelicFlipID1 = 0x1EA3;
                    RelicFlipID2 = 0x1EA4;
                    break;
                case 15:
                    Name = "rotten fishing net";
                    ItemID = 0x1EA5;
                    Weight = 10.0;
                    RelicGoldValue = Utility.RandomMinMax(30, 90);
                    RelicFlipID1 = 0x1EA5;
        ...
        public HighSeasRelic(Serial serial)
            : base(serial) { }
