...
namespace Server.Items
{
    public class SkullSouthLargeAddon : BaseAddon
    {
        ...
        {
            get { return new SkullSouthLargeAddonDeed(); }
        }
        ...
        public SkullSouthLargeAddon(Serial serial)
            : base(serial) { }
    ...
    public class SkullSouthLargeAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new SkullSouthLargeAddon(); }
        }
        ...
        public SkullSouthLargeAddonDeed(Serial serial)
            : base(serial) { }
