...
namespace Server.Items
{
    public class DolphinSouthLargeAddon : BaseAddon
    {
        ...
        {
            get { return new DolphinSouthLargeAddonDeed(); }
        }
        ...
        public DolphinSouthLargeAddon(Serial serial)
            : base(serial) { }
    ...
    public class DolphinSouthLargeAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new DolphinSouthLargeAddon(); }
        }
        ...
        public DolphinSouthLargeAddonDeed(Serial serial)
            : base(serial) { }
