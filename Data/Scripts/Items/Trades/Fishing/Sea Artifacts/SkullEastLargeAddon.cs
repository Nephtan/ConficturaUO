...
namespace Server.Items
{
    public class SkullEastLargeAddon : BaseAddon
    {
        ...
        {
            get { return new SkullEastLargeAddonDeed(); }
        }
        ...
        public SkullEastLargeAddon(Serial serial)
            : base(serial) { }
    ...
    public class SkullEastLargeAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new SkullEastLargeAddon(); }
        }
        ...
        public SkullEastLargeAddonDeed(Serial serial)
            : base(serial) { }
