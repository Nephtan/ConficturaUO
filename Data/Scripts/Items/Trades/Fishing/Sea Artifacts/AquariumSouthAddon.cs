...
namespace Server.Items
{
    public class AquariumSouthAddon : BaseAddon
    {
        ...
        {
            get { return new AquariumSouthAddonDeed(); }
        }
        ...
        public AquariumSouthAddon(Serial serial)
            : base(serial) { }
    ...
    public class AquariumSouthAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new AquariumSouthAddon(); }
        }
        ...
        public AquariumSouthAddonDeed(Serial serial)
            : base(serial) { }
