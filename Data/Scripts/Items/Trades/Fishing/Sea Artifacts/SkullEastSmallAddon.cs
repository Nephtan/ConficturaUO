...
namespace Server.Items
{
    public class SkullEastSmallAddon : BaseAddon
    {
        private static int[,] m_AddOnSimpleComponents = new int[,]
        {
            ...
            { 18190, 2, -1, 0 },
            { 18186, 2, 0, 0 },
            { 18194, 2, 1, 0 } // 13	14	15
        };

        public override BaseAddonDeed Deed
        {
            get { return new SkullEastSmallAddonDeed(); }
        }
        ...
        public SkullEastSmallAddon(Serial serial)
            : base(serial) { }
    ...
    public class SkullEastSmallAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new SkullEastSmallAddon(); }
        }
        ...
        public SkullEastSmallAddonDeed(Serial serial)
            : base(serial) { }
