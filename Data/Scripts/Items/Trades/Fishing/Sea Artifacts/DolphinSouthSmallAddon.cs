...
namespace Server.Items
{
    public class DolphinSouthSmallAddon : BaseAddon
    {
        private static int[,] m_AddOnSimpleComponents = new int[,]
        {
            ...
            { 18283, 1, 0, 0 },
            { 18276, 1, 1, 0 },
            { 18289, 1, 2, 0 } // 13	14	15
        };

        public override BaseAddonDeed Deed
        {
            get { return new DolphinSouthSmallAddonDeed(); }
        }
        ...
        public DolphinSouthSmallAddon(Serial serial)
            : base(serial) { }
    ...
    public class DolphinSouthSmallAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new DolphinSouthSmallAddon(); }
        }
        ...
        public DolphinSouthSmallAddonDeed(Serial serial)
            : base(serial) { }
