...
namespace Server.Items
{
    public class DolphinEastSmallAddon : BaseAddon
    {
        private static int[,] m_AddOnSimpleComponents = new int[,]
        {
            ...
            { 18296, 0, 1, 0 },
            { 18299, 1, 1, 0 },
            { 18292, 2, 1, 0 } // 13	14	15
        };

        public override BaseAddonDeed Deed
        {
            get { return new DolphinEastSmallAddonDeed(); }
        }
        ...
        public DolphinEastSmallAddon(Serial serial)
            : base(serial) { }
    ...
    public class DolphinEastSmallAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new DolphinEastSmallAddon(); }
        }
        ...
        public DolphinEastSmallAddonDeed(Serial serial)
            : base(serial) { }
