...
namespace Server.Items
{
    public class SkullSouthSmallAddon : BaseAddon
    {
        private static int[,] m_AddOnSimpleComponents = new int[,]
        {
            ...
            { 18236, 1, 0, 0 },
            { 18209, 1, 1, 0 },
            { 18198, 1, 2, 0 } // 13	14	15
        };

        public override BaseAddonDeed Deed
        {
            get { return new SkullSouthSmallAddonDeed(); }
        }
        ...
        public SkullSouthSmallAddon(Serial serial)
            : base(serial) { }
    ...
    public class SkullSouthSmallAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new SkullSouthSmallAddon(); }
        }
        ...
        public SkullSouthSmallAddonDeed(Serial serial)
            : base(serial) { }
