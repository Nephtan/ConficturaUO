...
namespace Server.Items
{
    public class DolphinEastLargeAddon : BaseAddon
    {
        ...
        {
            get { return new DolphinEastLargeAddonDeed(); }
        }
        ...
        public DolphinEastLargeAddon(Serial serial)
            : base(serial) { }
    ...
    public class DolphinEastLargeAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new DolphinEastLargeAddon(); }
        }
        ...
        public DolphinEastLargeAddonDeed(Serial serial)
            : base(serial) { }
