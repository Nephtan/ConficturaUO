...
namespace Server.Items
{
    public class Sextant : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendMessage(
                    "You will need a magical sextant to see the stars through the cavern ceiling!"
                );
            }
            else if (
                Sextant.Format(
            ...
            {
                from.SendMessage(
                    "You can't use a sextant as the sun and stars are blocked by the evil darkness here!"
                );
            }
            else if (
            ...
            )
            {
                ...
                Server.Misc.Worlds.GetRegionName(from.Map, from.Location) == "the Ranger Outpost"
            )
            {
        ...
        public static Point3D ReverseLookup(
            Map map,
            int xLong,
            int yLat,
            int xMins,
