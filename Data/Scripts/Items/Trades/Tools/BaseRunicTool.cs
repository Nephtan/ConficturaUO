...
namespace Server.Items
{
    public abstract class BaseRunicTool : BaseTool
    {
        ...
        private static void ApplyAttribute(
            AosArmorAttributes attrs,
            int min,
            int max,
            AosArmorAttribute attr,
            int low,
            int high
        )
        {
        ...
        private static void ApplyAttribute(
            AosElementAttributes attrs,
            int min,
            int max,
            AosElementAttribute attr,
            int low,
            int high
        )
        {
        ...
        private static void ApplySkillBonus(
            AosSkillBonuses attrs,
            int min,
            int max,
            int index,
            int low,
        ...
        )
        {
            ...
            else if (attrs.Owner is BaseWeapon)
            {
                ...
                else if (bm.Skill == SkillName.Marksmanship)
                {
                    possibleSkills = m_PossibleWepMarksmanshipSkills;
                }
                else if (bm.Skill == SkillName.Fencing)
                {
                    possibleSkills = m_PossibleWepFencingSkills;
                }
                else if (bm.Skill == SkillName.Bludgeoning)
                {
                    possibleSkills = m_PossibleWepBludgeoningSkills;
                }
                else if (bm.Skill == SkillName.FistFighting)
                {
                    possibleSkills = m_PossibleWepFistFightingSkills;
                }
            }
            ...
            do
            {
                ...
                {
                    if (
                        attrs.GetValues(i, out check, out bonus)
                        && (
                            (check == sk)
        ...
        public void ApplyAttributesTo(BaseWeapon weapon)
        {
            ...
            int attributeCount = Utility.RandomMinMax(
                attrs.RunicMinAttributes,
                attrs.RunicMaxAttributes
            );
                ...
                switch (random)
                {
                        ...
                        switch (Utility.Random(5))
                        {
                            case 0:
                                ApplyAttribute(
                                    ...
                                    min,
                                    max,
                                    AosWeaponAttribute.HitPhysicalArea,
                                    2,
                                    50,
                                    2
                                );
                            ...
                            case 1:
                                ApplyAttribute(
                                    ...
                                    min,
                                    max,
                                    AosWeaponAttribute.HitFireArea,
                                    2,
                                    50,
                                    2
                                );
                            ...
                            case 2:
                                ApplyAttribute(
                                    ...
                                    min,
                                    max,
                                    AosWeaponAttribute.HitColdArea,
                                    2,
                                    50,
                                    2
                                );
                            ...
                            case 3:
                                ApplyAttribute(
                                    ...
                                    min,
                                    max,
                                    AosWeaponAttribute.HitPoisonArea,
                                    2,
                                    50,
                                    2
                                );
                    ...
                    case 16:
                        ApplyAttribute(
                            ...
                            min,
                            max,
                            AosWeaponAttribute.LowerStatReq,
                            10,
                            100,
                            10
                        );
        ...
        private static int AssignElementalDamage(
            BaseWeapon weapon,
            AosElementAttribute attr,
            int totalDamage
        )
            ...
            for (int i = 0; i < attributeCount; ++i)
            {
                ...
                switch (random)
                {
                    ...
                    case 20:
                        ...
                        break;
                    case 21:
                        ApplyAttribute(primary, min, max, AosAttribute.WeaponSpeed, 1, 2);
                        break;
                    case 22:
                        ApplyAttribute(secondary, min, max, AosArmorAttribute.SelfRepair, 1, 5);
                        break;
            ...
            for (int i = 0; i < attributeCount; ++i)
            {
                ...
                switch (random)
                {
                    ...
                    case 18:
                        ...
                        break;
                    case 19:
                        ApplyAttribute(primary, min, max, AosAttribute.BonusHits, 5, 20);
                        break;
                    case 20:
                        ApplyAttribute(primary, min, max, AosAttribute.BonusStam, 5, 20);
                        break;
                    case 21:
                        ApplyAttribute(primary, min, max, AosAttribute.BonusMana, 5, 20);
                        break;
                    case 22:
                        ApplyAttribute(primary, min, max, AosAttribute.ReflectPhysical, 5, 15);
                        break;
                    case 23:
                        ApplyAttribute(primary, min, max, AosAttribute.RegenHits, 1, 5);
                        break;
                    case 24:
                        ApplyAttribute(primary, min, max, AosAttribute.RegenStam, 1, 5);
                        break;
                    case 25:
                        ApplyAttribute(primary, min, max, AosAttribute.RegenMana, 1, 5);
                        break;
                    case 26:
                        ApplyAttribute(primary, min, max, AosAttribute.WeaponSpeed, 1, 2);
                        break;
