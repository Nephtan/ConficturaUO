...
namespace Server.Items
{
    public class reagents_magic_jar1 : Item
    {
        ...
        public reagents_magic_jar1(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                from.PrivateOverheadMessage(
                    ...
                    0x14C,
                    false,
                    "You dump the contents into your backpack",
                    from.NetState
                );
                this.Delete();
            }
    ...
    public class reagents_magic_jar2 : Item
    {
        ...
        public reagents_magic_jar2(Serial serial)
            : base(serial) { }
    ...
    public class reagents_magic_jar3 : Item
    {
        ...
        public reagents_magic_jar3(Serial serial)
            : base(serial) { }
