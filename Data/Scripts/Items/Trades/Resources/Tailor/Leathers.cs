...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public NecroticLeather()
            : this(1) { }

        [Constructable]
        public NecroticLeather(int amount)
            : base(CraftResource.NecroticLeather, amount) { }

        public NecroticLeather(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public VolcanicLeather()
            : this(1) { }

        [Constructable]
        public VolcanicLeather(int amount)
            : base(CraftResource.VolcanicLeather, amount) { }

        public VolcanicLeather(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public FrozenLeather()
            : this(1) { }

        [Constructable]
        public FrozenLeather(int amount)
            : base(CraftResource.FrozenLeather, amount) { }

        public FrozenLeather(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public GoliathLeather()
            : this(1) { }

        [Constructable]
        public GoliathLeather(int amount)
            : base(CraftResource.GoliathLeather, amount) { }

        public GoliathLeather(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public DraconicLeather()
            : this(1) { }

        [Constructable]
        public DraconicLeather(int amount)
            : base(CraftResource.DraconicLeather, amount) { }

        public DraconicLeather(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public HellishLeather()
            : this(1) { }

        [Constructable]
        public HellishLeather(int amount)
            : base(CraftResource.HellishLeather, amount) { }

        public HellishLeather(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public DinosaurLeather()
            : this(1) { }

        [Constructable]
        public DinosaurLeather(int amount)
            : base(CraftResource.DinosaurLeather, amount) { }

        public DinosaurLeather(Serial serial)
            : base(serial) { }
    ...
    public class AlienLeather : BaseLeather
    {
        ...
        [Constructable]
        public AlienLeather(int amount)
            : base(CraftResource.AlienLeather, amount) { }

        public AlienLeather(Serial serial)
            : base(serial) { }
