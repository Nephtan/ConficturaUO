...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public NecroticHides()
            : this(1) { }

        [Constructable]
        public NecroticHides(int amount)
            : base(CraftResource.NecroticLeather, amount) { }

        public NecroticHides(Serial serial)
            : base(serial) { }
    ...
    public class VolcanicHides : BaseHides, IScissorable
    {
        ...
        [Constructable]
        public VolcanicHides(int amount)
            : base(CraftResource.VolcanicLeather, amount) { }

        public VolcanicHides(Serial serial)
            : base(serial) { }
    ...
    public class FrozenHides : BaseHides, IScissorable
    {
        ...
        [Constructable]
        public FrozenHides(int amount)
            : base(CraftResource.FrozenLeather, amount) { }

        public FrozenHides(Serial serial)
            : base(serial) { }
    ...
    public class GoliathHides : BaseHides, IScissorable
    {
        ...
        [Constructable]
        public GoliathHides(int amount)
            : base(CraftResource.GoliathLeather, amount) { }

        public GoliathHides(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public DraconicHides()
            : this(1) { }

        [Constructable]
        public DraconicHides(int amount)
            : base(CraftResource.DraconicLeather, amount) { }

        public DraconicHides(Serial serial)
            : base(serial) { }
    ...
    public class HellishHides : BaseHides, IScissorable
    {
        ...
        [Constructable]
        public HellishHides(int amount)
            : base(CraftResource.HellishLeather, amount) { }

        public HellishHides(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public DinosaurHides()
            : this(1) { }

        [Constructable]
        public DinosaurHides(int amount)
            : base(CraftResource.DinosaurLeather, amount) { }

        public DinosaurHides(Serial serial)
            : base(serial) { }
    ...
    public class AlienHides : BaseHides, IScissorable
    {
        ...
        [Constructable]
        public AlienHides(int amount)
            : base(CraftResource.AlienLeather, amount) { }

        public AlienHides(Serial serial)
            : base(serial) { }
