...
namespace Server.Items
{
    public class HardCrystals : Item
    {
        [Constructable]
        public HardCrystals()
            : this(1, "crystalline rock") { }

        [Constructable]
        public HardCrystals(int amount, string name)
            : base(0x3003)
        {
            Weight = 0.01;
            Stackable = true;
            ...
            if (Name == "crystalline dull copper")
            {
                material = "dull copper";
            }
            else if (Name == "crystalline shadow iron")
            {
                material = "shadow iron";
            }
            else if (Name == "crystalline copper")
            {
                material = "copper";
            }
            else if (Name == "crystalline bronze")
            {
                material = "bronze";
            }
            else if (Name == "crystalline gold")
            {
                material = "gold";
            }
            else if (Name == "crystalline agapite")
            {
                material = "agapite";
            }
            else if (Name == "crystalline verite")
            {
                material = "verite";
            }
            else if (Name == "crystalline valorite")
            {
                material = "valorite";
            }
            else if (Name == "crystalline caddellite")
            {
                material = "caddellite";
            }
            else if (Name == "crystalline onyx")
            {
                material = "onyx";
            }
            else if (Name == "crystalline quartz")
            {
                material = "quartz";
            }
            else if (Name == "crystalline ruby")
            {
                material = "ruby";
            }
            else if (Name == "crystalline sapphire")
            {
                material = "sapphire";
            }
            else if (Name == "crystalline spinel")
            {
                material = "spinel";
            }
            else if (Name == "crystalline topaz")
            {
                material = "topaz";
            }
            else if (Name == "crystalline amethyst")
            {
                material = "amethyst";
            }
            else if (Name == "crystalline emerald")
            {
                material = "emerald";
            }
            else if (Name == "crystalline garnet")
            {
                material = "garnet";
            }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else if (from.Skills[SkillName.Blacksmith].Value >= 50)
            {
                ...
                from.SendMessage(
                    "You smelt the crystalline metal the and put the ingots in your backpack."
                );
                this.Delete();
            }
            else
        ...
        public HardCrystals(Serial serial)
            : base(serial) { }
