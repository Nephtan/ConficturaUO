...
namespace Server.Items
{
    public class RareMetals : Item
    {
        [Constructable]
        public RareMetals()
            : this(1, "silver stones") { }

        [Constructable]
        public RareMetals(int amount, string name)
            : base(0x19B9)
        {
            Weight = 12.0;
            Stackable = true;
            ...
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("copper", "", 0);
            }
            else if (Name == "verite stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("verite", "", 0);
            }
            else if (Name == "valorite stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("valorite", "", 0);
            }
            else if (Name == "agapite stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("agapite", "", 0);
            }
            else if (Name == "bronze stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("bronze", "", 0);
            }
            else if (Name == "dull copper stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("dull copper", "", 0);
            }
            else if (Name == "gold stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("gold", "", 0);
            }
            else if (Name == "shadow iron stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("shadow iron", "", 0);
            }
            else if (Name == "mithril stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("mithril", "", 0);
            }
            else if (Name == "xormite stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("xormite", "", 0);
            }
            else if (Name == "obsidian stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("obsidian", "", 0);
            }
            else if (Name == "nepturite stones")
            {
                Hue = Server.Misc.MaterialInfo.GetMaterialColor("nepturite", "", 0);
            }
        }
        ...
        public RareMetals(Serial serial)
            : base(serial) { }
