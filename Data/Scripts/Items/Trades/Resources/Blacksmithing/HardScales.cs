...
namespace Server.Items
{
    public class HardScales : Item
    {
        ...
        [Constructable]
        public HardScales(int amount, string name)
            : base(0x26B2)
        {
            Weight = 0.01;
            Stackable = true;
            ...
            if (Name == "dull copper scales")
            {
                material = "dull copper";
            }
            else if (Name == "shadow iron scales")
            {
                material = "shadow iron";
            }
            else if (Name == "copper scales")
            {
                material = "copper";
            }
            else if (Name == "bronze scales")
            {
                material = "bronze";
            }
            else if (Name == "gold scales")
            {
                material = "gold";
            }
            else if (Name == "agapite scales")
            {
                material = "agapite";
            }
            else if (Name == "verite scales")
            {
                material = "verite";
            }
            else if (Name == "valorite scales")
            {
                material = "valorite";
            }
            else if (Name == "caddellite scales")
            {
                material = "caddellite";
            }
            else if (Name == "onyx scales")
            {
                material = "onyx";
            }
            else if (Name == "quartz scales")
            {
                material = "quartz";
            }
            else if (Name == "ruby scales")
            {
                material = "ruby";
            }
            else if (Name == "sapphire scales")
            {
                material = "sapphire";
            }
            else if (Name == "spinel scales")
            {
                material = "spinel";
            }
            else if (Name == "topaz scales")
            {
                material = "topaz";
            }
            else if (Name == "amethyst scales")
            {
                material = "amethyst";
            }
            else if (Name == "emerald scales")
            {
                material = "emerald";
            }
            else if (Name == "garnet scales")
            {
                material = "garnet";
            }
        ...
        public HardScales(Serial serial)
            : base(serial) { }
