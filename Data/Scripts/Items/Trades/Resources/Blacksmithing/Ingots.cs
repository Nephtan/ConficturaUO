...
namespace Server.Items
{
    ...
    public class SteelIngot : BaseIngot
    {
        ...
        public SteelIngot(int amount)
            : base(CraftResource.Steel, amount) { }
    ...
    public class BrassIngot : BaseIngot
    {
        ...
        [Constructable]
        public BrassIngot(int amount)
            : base(CraftResource.Brass, amount) { }

        public BrassIngot(Serial serial)
            : base(serial) { }
    ...
    public class MithrilIngot : BaseIngot
    {
        ...
        [Constructable]
        public MithrilIngot(int amount)
            : base(CraftResource.Mithril, amount) { }

        public MithrilIngot(Serial serial)
            : base(serial) { }
    ...
    public class XormiteIngot : BaseIngot
    {
        ...
        [Constructable]
        public XormiteIngot(int amount)
            : base(CraftResource.Xormite, amount) { }

        public XormiteIngot(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public NepturiteIngot()
            : this(1) { }

        [Constructable]
        public NepturiteIngot(int amount)
            : base(CraftResource.Nepturite, amount) { }

        public NepturiteIngot(Serial serial)
            : base(serial) { }
