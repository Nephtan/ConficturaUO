...
namespace Server.Items
{
    public abstract class BaseOre : Item, ICommodity
    {
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            Name = Server.Misc.MaterialInfo.GetResourceName(m_Resource) + "ore";
        }
            ...
            : base(0x19B9)
        {
            ...
            m_Resource = resource;
            Name = Server.Misc.MaterialInfo.GetResourceName(resource) + "ore";
        }
        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is BaseOre)
                {
                    ...
                    if (
                        (ore.ItemID == 0x19B9 && worth > 120000)
                    ...
                    )
                    {
                        ...
                        ore.RootParent is Mobile
                        && (plusWeight + ((Mobile)ore.RootParent).Backpack.TotalWeight)
    ...
    public class ObsidianOre : BaseOre
    {
        ...
        public ObsidianOre(int amount)
            : base(CraftResource.Obsidian, amount) { }
    ...
    public class MithrilOre : BaseOre
    {
        ...
        [Constructable]
        public MithrilOre(int amount)
            : base(CraftResource.Mithril, amount) { }

        public MithrilOre(Serial serial)
            : base(serial) { }
    ...
    public class XormiteOre : BaseOre
    {
        ...
        [Constructable]
        public XormiteOre(int amount)
            : base(CraftResource.Xormite, amount) { }

        public XormiteOre(Serial serial)
            : base(serial) { }
    ...
    public class NepturiteOre : BaseOre
    {
        ...
        [Constructable]
        public NepturiteOre(int amount)
            : base(CraftResource.Nepturite, amount) { }

        public NepturiteOre(Serial serial)
            : base(serial) { }
