...
namespace Server.Items
{
    public abstract class BaseGranite : Item
    {
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            Stackable = true;
            Name = Server.Misc.MaterialInfo.GetResourceName(m_Resource) + "granite";
            ItemID = 0x2158;
        }
            ...
            : base(0x2158)
        {
            ...
            Stackable = true;
            m_Resource = resource;
            Name = Server.Misc.MaterialInfo.GetResourceName(resource) + "granite";
        }
    ...
    public class DullCopperGranite : BaseGranite
    {
        ...
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("dull copper", "classic", 0)); }
        }
    ...
    public class ShadowIronGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("shadow iron", "classic", 0)); }
        }
    ...
    public class CopperGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("copper", "classic", 0)); }
        }
    ...
    public class BronzeGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("bronze", "classic", 0)); }
        }
    ...
    public class GoldGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("gold", "classic", 0)); }
        }
    ...
    public class AgapiteGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("agapite", "classic", 0)); }
        }
    ...
    public class VeriteGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("verite", "classic", 0)); }
        }
    ...
    public class ValoriteGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("valorite", "classic", 0)); }
        }
    ...
    public class ObsidianGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("obsidian", "classic", 0)); }
        }
    ...
    public class MithrilGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("mithril", "classic", 0)); }
        }
    ...
    public class DwarvenGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("dwarven", "classic", 0)); }
        }
    ...
    public class XormiteGranite : BaseGranite
    {
        public override int Hue
        {
            get { return (Server.Misc.MaterialInfo.GetMaterialColor("xormite", "classic", 0)); }
        }

        [Constructable]
        public XormiteGranite()
            : base(CraftResource.Xormite) { }

        public XormiteGranite(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public NepturiteGranite()
            : base(CraftResource.Nepturite) { }

        public NepturiteGranite(Serial serial)
            : base(serial) { }
