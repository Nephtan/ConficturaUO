...
namespace Server.Items
{
    public class RoughSharpeningStone : Item
    {
        ...
        [Constructable]
        public RoughSharpeningStone()
            : this(5) { }

        [Constructable]
        public RoughSharpeningStone(int uses)
            : base(0x1F14)
        {
            Weight = 1.0;
            i_Uses = uses;
            ...
            if (o is Item)
            {
                ...
                else if (o is BaseSword && ((BaseSword)o).IsChildOf(from.Backpack))
                {
                    ...
                    if (i_DI >= 60)
                    {
                        ...
                        from.SendMessage(
                            32,
                            "You need at least 60.0 blacksmith to sharpen weapons with this stone"
                        );
                    else if (!Deleted)
                    {
        ...
        public RoughSharpeningStone(Serial serial)
            : base(serial) { }
    ...
    public class RoughSharpeningStoneTarget : Target
    {
        ...
        public RoughSharpeningStoneTarget(RoughSharpeningStone blade)
