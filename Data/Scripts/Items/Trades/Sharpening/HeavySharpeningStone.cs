...
namespace Server.Items
{
    public class HeavySharpeningStone : Item
    {
        ...
        [Constructable]
        public HeavySharpeningStone()
            : this(5) { }

        [Constructable]
        public HeavySharpeningStone(int uses)
            : base(0x1F14)
        {
            Weight = 1.0;
            i_Uses = uses;
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add(1070722, "Can Greatly Increase A Swordsmanship Weapon's Damage");
        }
            ...
            if (o is Item)
            {
                ...
                else if (o is BaseSword && ((BaseSword)o).IsChildOf(from.Backpack))
                {
                    ...
                    if (i_DI >= 70)
                    {
                        ...
                        from.SendMessage(
                            32,
                            "You need at least 80.0 blacksmith to sharpen weapons with this stone"
                        );
                    else if (!Deleted)
                    {
        ...
        public HeavySharpeningStone(Serial serial)
            : base(serial) { }
    ...
    public class HeavySharpeningStoneTarget : Target
    {
        ...
        public HeavySharpeningStoneTarget(HeavySharpeningStone blade)
