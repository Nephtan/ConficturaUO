...
namespace Server.Items
{
    public class ElementalSharpeningStone : Item
    {
        ...
        [Constructable]
        public ElementalSharpeningStone()
            : this(5) { }

        [Constructable]
        public ElementalSharpeningStone(int uses)
            : base(0x1F14)
        {
            Weight = 1.0;
            i_Uses = uses;
            ...
            if (o is Item)
            {
                ...
                else if (o is BaseSword && ((BaseSword)o).IsChildOf(from.Backpack))
                {
                    ...
                    if (i_DI >= 70)
                    {
                        ...
                        from.SendMessage(
                            32,
                            "You need at least 100.0 blacksmith and magery to sharpen weapons with elemental power"
                        );
                    ...
                    else if (!Deleted)
                    {
                        int bonus = Utility.Random(
                            (int)(from.Skills[SkillName.Blacksmith].Value / 20)
                        );
                        if (bonus > 0)
                        {
                            if (70 < i_DI + bonus)
                            ...
                            from.SendMessage(
                                88,
                                "You sharpened the weapon with {0} elemental damage increase",
                                bonus
                            );
                        }
                        else
                ...
                else if (o is BaseKnife && ((BaseKnife)o).IsChildOf(from.Backpack))
                {
                    ...
                    if (i_DI >= 70)
                    {
                        ...
                        from.SendMessage(
                            32,
                            "You need at least 100.0 blacksmith to sharpen weapons with elemntal power"
                        );
                    else if (!Deleted)
                    {
                        int bonus = Utility.Random(
                        ...
                        if (bonus > 0)
                        {
                            ...
                            from.SendMessage(
                                88,
                                "You sharpened the weapon with {0} elemental damange increase",
                                bonus
                            );
                        }
                        else
                ...
                else if (o is BaseAxe && ((BaseAxe)o).IsChildOf(from.Backpack))
                {
                    ...
                    if (i_DI >= 50)
                    {
                        ...
                        from.SendMessage(
                            32,
                            "You need at least 100.0 blacksmith to sharpen weapons with elemental power"
                        );
                    else if (!Deleted)
                    {
                        int bonus = Utility.Random(
        ...
        public ElementalSharpeningStone(Serial serial)
            : base(serial) { }
    ...
    public class ElementalSharpeningStoneTarget : Target
    {
        ...
        public ElementalSharpeningStoneTarget(ElementalSharpeningStone blade)
