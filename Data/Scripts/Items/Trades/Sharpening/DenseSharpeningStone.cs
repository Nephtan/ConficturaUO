...
namespace Server.Items
{
    public class DenseSharpeningStone : Item
    {
        ...
        [Constructable]
        public DenseSharpeningStone()
            : this(5) { }

        [Constructable]
        public DenseSharpeningStone(int uses)
            : base(0x1F14)
        {
            Weight = 1.0;
            i_Uses = uses;
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add(1070722, "Can Wondrously Increase A Swordsmanship Weapon's Damage");
        }
            ...
            if (o is Item)
            {
                ...
                else if (o is BaseSword && ((BaseSword)o).IsChildOf(from.Backpack))
                {
                    ...
                    if (i_DI >= 70)
                    {
                        ...
                        from.SendMessage(
                            32,
                            "You need at least 100.0 blacksmith to sharpen weapons with this stone"
                        );
                    else if (!Deleted)
                    {
        ...
        public DenseSharpeningStone(Serial serial)
            : base(serial) { }
    ...
    public class DenseSharpeningStoneTarget : Target
    {
        ...
        public DenseSharpeningStoneTarget(DenseSharpeningStone blade)
