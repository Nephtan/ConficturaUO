...
namespace Server.Items
{
    public abstract class BaseLog : Item, ICommodity
    {
        ...
        int ICommodity.DescriptionNumber
        {
            get
            {
                return CraftResources.IsStandard(m_Resource)
                    ? LabelNumber
            ...
            : base(0x1BE0)
        {
            ...
            Name = Server.Misc.MaterialInfo.GetResourceName(resource) + "log";
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            Name = Server.Misc.MaterialInfo.GetResourceName(m_Resource) + "log";
            ItemID = 0x1BE0;
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (
                RootParent is BaseCreature
                && ((BaseCreature)RootParent).Controlled
                && ((BaseCreature)RootParent).ControlMaster == from
                && from.InRange(((BaseCreature)RootParent).Location, 2)
            )
            {
                from.SendMessage("Select the saw mill on which to cut the logs.");
                from.Target = new InternalTarget(this);
            }
            else if (!(RootParent is BaseCreature) && from.InRange(this.GetWorldLocation(), 2))
            {
                from.SendMessage("Select the saw mill on which to cut the logs.");
                from.Target = new InternalTarget(this);
            }
            else if (RootParent is BaseCreature)
            {
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(BaseLog log)
    ...
    public class AshLog : BaseLog
    {
        ...
        public AshLog(int amount)
            : base(CraftResource.AshTree, amount) { }
    ...
    public class CherryLog : BaseLog
    {
        ...
        public CherryLog(int amount)
            : base(CraftResource.CherryTree, amount) { }
    ...
    public class EbonyLog : BaseLog
    {
        ...
        public EbonyLog(int amount)
            : base(CraftResource.EbonyTree, amount) { }
    ...
    public class GoldenOakLog : BaseLog
    {
        ...
        [Constructable]
        public GoldenOakLog(int amount)
            : base(CraftResource.GoldenOakTree, amount) { }

        public GoldenOakLog(Serial serial)
            : base(serial) { }
    ...
    public class HickoryLog : BaseLog
    {
        ...
        [Constructable]
        public HickoryLog(int amount)
            : base(CraftResource.HickoryTree, amount) { }

        public HickoryLog(Serial serial)
            : base(serial) { }
    ...
    public class MahoganyLog : BaseLog
    {
        ...
        public MahoganyLog(int amount)
            : base(CraftResource.MahoganyTree, amount) { }
    ...
    public class OakLog : BaseLog
    {
        ...
        public OakLog(int amount)
            : base(CraftResource.OakTree, amount) { }
    ...
    public class PineLog : BaseLog
    {
        ...
        [Constructable]
        public PineLog(int amount)
            : base(CraftResource.PineTree, amount) { }

        public PineLog(Serial serial)
            : base(serial) { }
    ...
    public class RosewoodLog : BaseLog
    {
        ...
        [Constructable]
        public RosewoodLog(int amount)
            : base(CraftResource.RosewoodTree, amount) { }

        public RosewoodLog(Serial serial)
            : base(serial) { }
    ...
    public class WalnutLog : BaseLog
    {
        ...
        [Constructable]
        public WalnutLog(int amount)
            : base(CraftResource.WalnutTree, amount) { }

        public WalnutLog(Serial serial)
            : base(serial) { }
    ...
    public class DriftwoodLog : BaseLog
    {
        ...
        [Constructable]
        public DriftwoodLog(int amount)
            : base(CraftResource.DriftwoodTree, amount) { }

        public DriftwoodLog(Serial serial)
            : base(serial) { }
    ...
    public class GhostLog : BaseLog
    {
        ...
        [Constructable]
        public GhostLog(int amount)
            : base(CraftResource.GhostTree, amount) { }

        public GhostLog(Serial serial)
            : base(serial) { }
    ...
    public class PetrifiedLog : BaseLog
    {
        ...
        public PetrifiedLog(int amount)
            : base(CraftResource.PetrifiedTree, amount) { }
    ...
    public class ElvenLog : BaseLog
    {
        ...
        public ElvenLog(int amount)
            : base(CraftResource.ElvenTree, amount) { }
