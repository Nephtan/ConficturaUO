...
namespace Server.Items
{
    public class DrakkhenEggRed : Item
    {
        ...
        public DrakkhenEggRed(Serial serial)
            : base(serial) { }
        ...
        {
            public DrakkhenEggGump(Mobile from, DrakkhenEggRed egg)
                : base(50, 50)
            {
                string color = "#f73d3c";
                ...
                string cost =
                    " Place " + need + " more gold onto the crystal and give it to a druid.";
                if (egg.HaveGold >= 50000)
                {
                    cost = " You can now give this to a druid as you have enough gold.";
                }
                ...
                AddHtml(
                    ...
                    420,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">DRAKKHEN CRYSTAL</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
    ...
    public class DrakkhenEggBlack : Item
    {
        ...
        public DrakkhenEggBlack(Serial serial)
            : base(serial) { }
        ...
        public class DrakkhenEggGump : Gump
        {
            public DrakkhenEggGump(Mobile from, DrakkhenEggBlack egg)
                : base(50, 50)
            {
                string color = "#f73d3c";
