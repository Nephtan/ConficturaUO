    ...
    public class DragonEgg : Item
    {
        ...
        public static bool ProcessDragonEgg(Mobile m, Mobile vet, Item dropped)
        {
            ...
            if (GoldReturn > 0)
            {
                ...
                vet.Say("Here is " + GoldReturn.ToString() + " gold back for all of your help.");
            }
        ...
        {
            public DragonEggGump(Mobile from, DragonEgg egg)
                : base(50, 50)
            {
                from.SendSound(0x4A);
                string color = "#94d3b4";
                ...
                string sText =
                    "This egg contains the embryo of a "
                    + sDragon
                    + ". Dwarves would take these eggs and brew the potions of the four elements to pour over the shell. The elixir of the flame, the potion of the earth, the mixture of the sea, and the oil of the winds are the four alchemical potions used in this process. Once these liquids are poured onto the shell, it could be broken by the young "
                    + sDragon
                    + " and the power of all the elements combined would mature the "
                    + sDragon
                    + " to almost be fully grown. These alchemical skills died off with the dwarven race, but you did hear rumors of these potions being seen in various places. These are usually in long lost dungeons or ruins, and said to be last seen in small chests resting on a runic pedestal. If you could get them, and bring the egg to an animal expert, they may be able to help you hatch it. The animal expert will require some gold (placed onto the egg) as you will need the help of a particular animal expert and they will require payment for their services. This animal expert is at the location shown below. If you have any veterinary skill, they may refund some of the gold for the help you may provide in the birth. When hatched and almost fully grown, these "
                    + sDragon
                    + "s will become your bonded pet. You will have to feed it and stable it when required. You can also perform some druidism on it without having any proficiency in the skill. This will help you with information about them, like what they want to eat.";
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Gold: "
                        + egg.HaveGold.ToString()
                        + "/"
                        + egg.NeedGold.ToString()
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Bring Gathered Materials to the Animal Expert in "
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_DragonBody
        {
            get { return DragonBody; }
            set { DragonBody = value; }
        }
        ...
        {
            get { return HavePotionA; }
            set { HavePotionA = value; }
        }
        ...
        {
            get { return HavePotionC; }
            set { HavePotionC = value; }
        }
        ...
        {
            get { return HavePotionB; }
            set { HavePotionB = value; }
        }
        ...
        {
            get { return HavePotionD; }
            set { HavePotionD = value; }
        }
    }
}
