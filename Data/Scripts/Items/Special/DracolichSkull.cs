...
namespace Server.Items
{
    public class DracolichSkull : Item
    {
        ...
        public DracolichSkull(Serial serial)
            : base(serial) { }
        ...
        public static bool ProcessDracolichSkull(Mobile m, Mobile necro, Item dropped)
        {
            ...
            m.PrivateOverheadMessage(
                ...
                1153,
                false,
                "Your skeletal dragon has reanimated.",
                m.NetState
            );
        ...
        {
            public DracolichSkullGump(Mobile from, DracolichSkull skull)
                : base(50, 50)
            {
                string color = "#cacaca";
                from.SendSound(0x4A);
                ...
                AddHtml(
                    ...
                    420,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">ENCHANTED DRAGON SKULL</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Gold: "
                        + skull.HaveGold.ToString()
                        + "/"
                        + skull.NeedGold.ToString()
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Bring the Gathered Materials to the Black Magic Guildmaster</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
