...
namespace Server.Items
{
    public abstract class BaseHolidayBells : Item
    {
        ...
        public BaseHolidayBells(int itemID)
            : base(itemID) { }
        ...
        {
            get { return m_TurnedOn && IsLockedDown; }
        }
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            if (
                ...
                Effects.PlaySound(
                    this.Location,
                    this.Map,
                    m_Sounds[Utility.Random(m_Sounds.Length)]
                );

            base.OnMovement(m, oldLocation);
        }

        public BaseHolidayBells(Serial serial)
            : base(serial) { }
        ...
        private class OnOffGump : Gump
        {
            ...
            public OnOffGump(BaseHolidayBells chimes)
                : base(150, 200)
            {
                m_Chimes = chimes;
                ...
                AddHtmlLocalized(
                    ...
                    300,
                    35,
                    chimes.TurnedOn ? 1011035 : 1011034,
                    false,
                    false
    ...
    public class HolidayBells : BaseHolidayBells
    {
        ...
        public HolidayBells(Serial serial)
            : base(serial) { }
