...
namespace Server.Items
{
    public class GiftBoxHues
    {
        ...
        {
            get { return m_NormalHues[Utility.Random(m_NormalHues.Length)]; }
        }
        public static int RandomNeonBoxHue
        {
            get { return m_NeonHues[Utility.Random(m_NeonHues.Length)]; }
        }
        ...
        private static readonly int[] m_NeonHues = { 0x438, 0x424, 0x433, 0x445, 0x42b, 0x448 };
    }
