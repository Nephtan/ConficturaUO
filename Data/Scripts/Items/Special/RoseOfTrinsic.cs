...
namespace Server.Items
{
    ...
    public class RoseOfMoon : Item, ISecurable
    {
        ...
        private class SpawnTimer : Timer
        {
            ...
            public SpawnTimer(RoseOfMoon rose, TimeSpan delay)
                : base(delay)
            {
                m_Rose = rose;
        ...
        public RoseOfMoon(Serial serial)
            : base(serial) { }
    ...
    public class RoseOfMoonPetal : Item
    {
        ...
        [Constructable]
        public RoseOfMoonPetal()
            : this(1) { }

        [Constructable]
        public RoseOfMoonPetal(int amount)
            : base(0x1021)
        {
            Stackable = true;
            Amount = amount;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                from.AddStatMod(
                    new StatMod(StatType.Str, "RoseOfMoonPetal", 5, TimeSpan.FromMinutes(5.0))
                );
        ...
        public RoseOfMoonPetal(Serial serial)
            : base(serial) { }
