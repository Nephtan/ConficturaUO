...
namespace Server.Items
{
    public class BarbaricSatchel : Item
    {
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            else
            {
                ...
                if (
                    dropped != null
                    && (
                        dropped is BaseArmor
                        || dropped is BaseClothing
                        || dropped is BaseJewel
                        || dropped is BaseHat
                    )
                )
                {
                    if (dropped.Layer == Layer.OuterTorso)
                    {
                        ...
                        dropped is BaseClothing
                        && dropped.Layer == Layer.MiddleTorso
                        && dropped is BaseOuterTorso
                        && (dropped.ItemID == 0x1541 || dropped.ItemID == 0x0409)
                    )
                    {
                        openGump = true;
                        make = "robe";
                    ...
                    else if (dropped.Layer == Layer.Gloves && dropped is BaseArmor)
                    {
                        ...
                        dropped.ItemID == 0x2B68
                        || dropped.ItemID == 0x567B
                        || dropped.ItemID == 0x2790
                    )
                    {
                    ...
                    else if (dropped is BaseShield)
                    {
                        ...
                        (dropped.Layer == Layer.Pants || dropped.Layer == Layer.InnerLegs)
                        && dropped is BaseArmor
                    )
                    {
                        openGump = true;
                        ...
                        (dropped.Layer == Layer.Shirt || dropped.Layer == Layer.InnerTorso)
                        && dropped is BaseArmor
                    )
                    {
                        openGump = true;
        ...
        public BarbaricSatchel(Serial serial)
            : base(serial) { }
        ...
        {
            public BarbaricSatchelGump(Mobile from, Item satchel)
                : base(50, 50)
            {
                this.Closable = true;
                ...
                AddHtml(
                    ...
                    200,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">BARBARIC SATCHEL</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    116,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Robe</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    116,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Sleeves</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    116,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Helm</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    116,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Hat</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    116,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Sash</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    116,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Gloves</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    116,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Leggings</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    116,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Tunic</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    116,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Amulet</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    116,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Cloak</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
        ...
        public class BarbaricAlterGump : Gump
        {
            ...
            public BarbaricAlterGump(Mobile from, Item item, string make)
                : base(25, 25)
            {
                from.PlaySound(0x48);
                m_Item = item;
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">What do you want to change the item into?</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                if (make == "robe")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><CENTER>Scant</CENTER></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    AddHtml(
                    ...
                    || item is MagicHat
                    || (
                        Server.Misc.MaterialInfo.IsAnyKindOfClothItem(item)
                ...
                else if (item is BaseShield)
                {
                    ...
                    (item.Layer == Layer.Pants || item.Layer == Layer.InnerLegs)
                    && item is BaseArmor
                )
                {
                    AddImage(0, 0, 164);
                    ...
                    (item.Layer == Layer.Shirt || item.Layer == Layer.InnerTorso)
                    && item is BaseArmor
                )
                {
                    AddImage(0, 0, 164);
        ...
        public static string GetRandomBarbarian()
        {
            ...
            switch (Utility.RandomMinMax(0, 35))
            {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    name = "of the berserkers";
                    break;
                case 10:
                    name = "of stygia";
                    break;
                case 11:
                    name = "of the primitives";
                    break;
                case 12:
                    name = "of the natives";
                    break;
