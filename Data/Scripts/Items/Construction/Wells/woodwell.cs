...
namespace Server.Items
{
    public class WoodWellAddon : BaseAddon, IWaterSource
    {
        ...
        {
            get { return new WoodWellDeed(); }
        }

        [Constructable]
        public WoodWellAddon()
            : this(false) { }
        ...
        public WoodWellAddon(Serial serial)
            : base(serial) { }
    ...
    public class WoodWellPiece : AddonComponent
    {
        ...
        public WoodWellPiece(WoodWellAddon woodwell, int itemid)
            : base(itemid)
        {
            m_woodwell = woodwell;
        }
        ...
        public WoodWellPiece(Serial serial)
            : base(serial) { }
    ...
    public class WoodWellDeed : BaseAddonDeed
    {
        ...
        public WoodWellDeed(Serial serial)
            : base(serial) { }
