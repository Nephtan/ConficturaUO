...
namespace Server.Items
{
    public class RedWellAddon : BaseAddon, IWaterSource
    {
        ...
        public RedWellAddon(Serial serial)
            : base(serial) { }
    ...
    public class RedWellPiece : AddonComponent
    {
        ...
        public RedWellPiece(RedWellAddon redwell, int itemid)
            : base(itemid)
        {
            m_redwell = redwell;
        }
        ...
        {
            if (from == null || from.Deleted || Deleted || m_redwell == null || m_redwell.Deleted)
                return;
        ...
        public RedWellPiece(Serial serial)
            : base(serial) { }
    ...
    public class RedWellDeed : BaseAddonDeed
    {
        ...
        public RedWellDeed(Serial serial)
            : base(serial) { }
