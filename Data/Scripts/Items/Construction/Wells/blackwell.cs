...
namespace Server.Items
{
    public class BlackWellAddon : BaseAddon, IWaterSource
    {
        ...
        {
            get { return new BlackWellDeed(); }
        }

        [Constructable]
        public BlackWellAddon()
            : this(false) { }
        ...
        public BlackWellAddon(Serial serial)
            : base(serial) { }
    ...
    public class BlackWellPiece : AddonComponent
    {
        ...
        public BlackWellPiece(BlackWellAddon blackwell, int itemid)
            : base(itemid)
        {
        ...
        {
            if (from == null || from.Deleted || Deleted || m_Blackwell == null || m_Blackwell.Deleted)
                return;
        ...
        public BlackWellPiece(Serial serial)
            : base(serial) { }
    ...
    public class BlackWellDeed : BaseAddonDeed
    {
        ...
        public BlackWellDeed(Serial serial)
            : base(serial) { }
