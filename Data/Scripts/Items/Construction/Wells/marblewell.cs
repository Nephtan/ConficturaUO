...
namespace Server.Items
{
    public class MarbleWellAddon : BaseAddon, IWaterSource
    {
        ...
        {
            get { return new MarbleWellDeed(); }
        }

        [Constructable]
        public MarbleWellAddon()
            : this(false) { }
        ...
        public MarbleWellAddon(Serial serial)
            : base(serial) { }
    ...
    public class MarbleWellPiece : AddonComponent
    {
        ...
        public MarbleWellPiece(MarbleWellAddon marblewell, int itemid)
            : base(itemid)
        {
        ...
        {
            if (from == null || from.Deleted || Deleted || m_marblewell == null || m_marblewell.Deleted)
                return;
            ...
            if (from.InRange(m_marblewell.GetWorldLocation(), 4))
            {
                ...
                else
                {
                    ...
                    switch (Utility.RandomMinMax(1, 5))
                    {
                        case 1:
                            msg =
                                "You drink your fill of the cool well water. The quiet sounds of splashing water are softly musical.";
                            break;
                        case 2:
                            msg =
                                "The well's invigorating water refreshes you and sets your mind at ease. You drink your fill.";
                            break;
                        case 3:
                            msg =
                                "You drink deeply of the clean well water. The shimmering reflections on the surface stir your thoughts.";
                            break;
                        case 4:
                            msg =
                                "As you drink from the water, an tantalizing scent reminds you of memories long forgotten.";
                            break;
                        case 5:
                            msg =
                                "You drink from the pure well and quiet dreams of sylvan delight pass through your mind.";
                            break;
                    }
        ...
        public MarbleWellPiece(Serial serial)
            : base(serial) { }
    ...
    public class MarbleWellDeed : BaseAddonDeed
    {
        ...
        {
            get { return new MarbleWellAddon(); }
        }
        ...
        public MarbleWellDeed(Serial serial)
            : base(serial) { }
