...
namespace Server.Items
{
    public class BrownWellAddon : BaseAddon, IWaterSource
    {
        ...
        {
            get { return new BrownWellDeed(); }
        }

        [Constructable]
        public BrownWellAddon()
            : this(false) { }
        ...
        public BrownWellAddon(Serial serial)
            : base(serial) { }
    ...
    public class BrownWellPiece : AddonComponent
    {
        ...
        public BrownWellPiece(BrownWellAddon brownwell, int itemid)
            : base(itemid)
        {
        ...
        {
            if (from == null || from.Deleted || Deleted || m_brownwell == null || m_brownwell.Deleted)
                return;
        ...
        public BrownWellPiece(Serial serial)
            : base(serial) { }
    ...
    public class BrownWellDeed : BaseAddonDeed
    {
        ...
        public BrownWellDeed(Serial serial)
            : base(serial) { }
