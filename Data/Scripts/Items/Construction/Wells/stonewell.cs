...
namespace Server.Items
{
    public class StoneWellAddon : BaseAddon, IWaterSource
    {
        ...
        public StoneWellAddon(Serial serial)
            : base(serial) { }
    ...
    public class StoneWellPiece : AddonComponent
    {
        ...
        public StoneWellPiece(StoneWellAddon stonewell, int itemid)
            : base(itemid)
        {
        ...
        {
            if (from == null || from.Deleted || Deleted || m_stonewell == null || m_stonewell.Deleted)
                return;
        ...
        public StoneWellPiece(Serial serial)
            : base(serial) { }
    ...
    public class StoneWellDeed : BaseAddonDeed
    {
        ...
        public StoneWellDeed(Serial serial)
            : base(serial) { }
