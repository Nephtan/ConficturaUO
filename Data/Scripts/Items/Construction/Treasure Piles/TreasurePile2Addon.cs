...
namespace Server.Items
{
    public class TreasurePile2Addon : BaseAddon
    {
        ...
        {
            get { return new TreasurePile2AddonDeed(); }
        }
        ...
        public TreasurePile2Addon(Serial serial)
            : base(serial) { }
    ...
    public class TreasurePile2AddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new TreasurePile2Addon(); }
        }
        ...
        public TreasurePile2AddonDeed(Serial serial)
            : base(serial) { }
