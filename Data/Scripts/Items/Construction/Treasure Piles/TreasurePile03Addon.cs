...
namespace Server.Items
{
    public class TreasurePile03Addon : BaseAddon
    {
        ...
        {
            get { return new TreasurePile03AddonDeed(); }
        }
        ...
        public TreasurePile03Addon(Serial serial)
            : base(serial) { }
    ...
    public class TreasurePile03AddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new TreasurePile03Addon(); }
        }
        ...
        public TreasurePile03AddonDeed(Serial serial)
            : base(serial) { }
