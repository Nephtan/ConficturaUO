...
namespace Server.Items
{
    public class TreasurePile02Addon : BaseAddon
    {
        ...
        {
            get { return new TreasurePile02AddonDeed(); }
        }
        ...
        public TreasurePile02Addon(Serial serial)
            : base(serial) { }
    ...
    public class TreasurePile02AddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new TreasurePile02Addon(); }
        }
        ...
        public TreasurePile02AddonDeed(Serial serial)
            : base(serial) { }
