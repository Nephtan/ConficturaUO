...
namespace Server.Items
{
    public class TreasurePile05Addon : BaseAddon
    {
        ...
        {
            get { return new TreasurePile05AddonDeed(); }
        }
        ...
        public TreasurePile05Addon(Serial serial)
            : base(serial) { }
    ...
    public class TreasurePile05AddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new TreasurePile05Addon(); }
        }
        ...
        public TreasurePile05AddonDeed(Serial serial)
            : base(serial) { }
