...
namespace Server.Items
{
    public class TreasurePile01Addon : BaseAddon
    {
        ...
        {
            get { return new TreasurePile01AddonDeed(); }
        }
        ...
        public TreasurePile01Addon(Serial serial)
            : base(serial) { }
    ...
    public class TreasurePile01AddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new TreasurePile01Addon(); }
        }
        ...
        public TreasurePile01AddonDeed(Serial serial)
            : base(serial) { }
