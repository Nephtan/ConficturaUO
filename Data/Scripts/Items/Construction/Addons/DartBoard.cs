...
namespace Server.Items
{
    public class DartBoard : AddonComponent
    {
        ...
        {
            get { return this.East ? new Point3D(-1, 0, 0) : new Point3D(0, -1, 0); }
        }

        public bool East
        {
            get { return this.ItemID == 0x1E2F; }
        }
    ...
    public class DartBoardEastAddon : BaseAddon
    {
        ...
        {
            get { return new DartBoardEastDeed(); }
        }
    ...
    public class DartBoardEastDeed : BaseAddonDeed
    {
        ...
        {
            get { return new DartBoardEastAddon(); }
        }
    ...
    public class DartBoardSouthAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get { return new DartBoardSouthDeed(); }
        }
    ...
    public class DartBoardSouthDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get { return new DartBoardSouthAddon(); }
        }
