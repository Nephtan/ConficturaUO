...
namespace Server.Items
{
    ...
    public class TrainingDaemon : AddonComponent
    {
        ...
        [Constructable]
        public TrainingDaemon()
            : this(0x56AB) { }

        [Constructable]
        public TrainingDaemon(int itemID)
            : base(itemID)
        {
            m_MinSkill = -25.0;
            m_MaxSkill = Server.Misc.MyServerSettings.TrainDummies();
        ...
        public void Use(Mobile from, BaseWeapon weapon)
        {
            ...
            {
                int cycle = Server.Misc.MyServerSettings.TrainMulti();
                int extra = 0;
        ...
        public TrainingDaemon(Serial serial)
            : base(serial) { }
        ...
        private class InternalTimer : Timer
        {
            ...
            public InternalTimer(TrainingDaemon dummy)
                : base(TimeSpan.FromSeconds(0.25), TimeSpan.FromSeconds(1.40))
            {
                m_Dummy = dummy;
    ...
    public class TrainingDaemonEastAddon : BaseAddon
    {
        ...
        public TrainingDaemonEastAddon(Serial serial)
            : base(serial) { }
    ...
    public class TrainingDaemonEastDeed : BaseAddonDeed
    {
        ...
        public TrainingDaemonEastDeed(Serial serial)
            : base(serial) { }
    ...
    public class TrainingDaemonSouthAddon : BaseAddon
    {
        ...
        public TrainingDaemonSouthAddon(Serial serial)
            : base(serial) { }
    ...
    public class TrainingDaemonSouthDeed : BaseAddonDeed
    {
        ...
        public TrainingDaemonSouthDeed(Serial serial)
            : base(serial) { }
