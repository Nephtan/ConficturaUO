...
namespace Server.Items
{
    public class TigerRugEastAddon : BaseAddon
    {
        ...
        {
            get { return new TigerRugEastDeed(); }
        }
        ...
        public TigerRugEastAddon(Serial serial)
            : base(serial) { }
    ...
    public class TigerRugEastDeed : BaseAddonDeed
    {
        ...
        {
            get { return new TigerRugEastAddon(); }
        }
        ...
        public TigerRugEastDeed(Serial serial)
            : base(serial) { }
    ...
    public class TigerRugSouthAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get { return new TigerRugSouthDeed(); }
        }
        ...
        public TigerRugSouthAddon(Serial serial)
            : base(serial) { }
    ...
    public class TigerRugSouthDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get { return new TigerRugSouthAddon(); }
        }
        ...
        public TigerRugSouthDeed(Serial serial)
            : base(serial) { }
    ...
    public class WhiteTigerRugEastAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get { return new WhiteTigerRugEastDeed(); }
        }
        ...
        public WhiteTigerRugEastAddon(Serial serial)
            : base(serial) { }
    ...
    public class WhiteTigerRugEastDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get { return new WhiteTigerRugEastAddon(); }
        }
        ...
        public WhiteTigerRugEastDeed(Serial serial)
            : base(serial) { }
    ...
    public class WhiteTigerRugSouthAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get { return new WhiteTigerRugSouthDeed(); }
        }
        ...
        public WhiteTigerRugSouthAddon(Serial serial)
            : base(serial) { }
    ...
    public class WhiteTigerRugSouthDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get { return new WhiteTigerRugSouthAddon(); }
        }
        ...
        public WhiteTigerRugSouthDeed(Serial serial)
            : base(serial) { }
