...
namespace Server.Items
{
    ...
    public class FarmablePumpkinLarge : FarmableCrop
    {
        ...
        [Constructable]
        public FarmablePumpkinLarge()
            : base(GetCropID())
        {
            Name = "large pumpkin";
        }

        public FarmablePumpkinLarge(Serial serial)
            : base(serial) { }
    ...
    public class FarmablePumpkinTall : FarmableCrop
    {
        ...
        [Constructable]
        public FarmablePumpkinTall()
            : base(GetCropID())
        {
            Name = "tall pumpkin";
        }

        public FarmablePumpkinTall(Serial serial)
            : base(serial) { }
    ...
    public class FarmablePumpkinGreen : FarmableCrop
    {
        ...
        [Constructable]
        public FarmablePumpkinGreen()
            : base(GetCropID())
        {
            Name = "green pumpkin";
        }

        public FarmablePumpkinGreen(Serial serial)
            : base(serial) { }
    ...
    public class FarmablePumpkinGiant : FarmableCrop
    {
        ...
        [Constructable]
        public FarmablePumpkinGiant()
            : base(GetCropID())
        {
            Name = "giant pumpkin";
        }

        public FarmablePumpkinGiant(Serial serial)
            : base(serial) { }
