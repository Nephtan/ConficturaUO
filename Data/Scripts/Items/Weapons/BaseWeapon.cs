    ...
    public abstract class BaseWeapon : Item, IWeapon, IFactionItem, ICraftable, ISlayer, IDurability
    {
        ...
        public static void CheckMetalColor(BaseWeapon weapon)
        {
            ...
            )
            {
                ...
                if (weapon.Resource == CraftResource.RegularLeather && weapon.Hue == 0)
                {
                    weapon.Hue = Server.Misc.MaterialInfo.PlainLeatherColor();
                }
                if (weapon.Hue == 0)
                {
                    ...
                    else if (weapon.Resource == CraftResource.DullCopper)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor(
                            "dull copper",
                            "",
                            0
                        );
                    ...
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("copper", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Bronze)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("bronze", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Gold)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("gold", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Agapite)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("agapite", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Verite)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("verite", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Valorite)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("valorite", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Steel)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("steel", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Brass)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("brass", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Mithril)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("mithril", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Xormite)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("xormite", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Obsidian)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("obsidian", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Nepturite)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("nepturite", "", 0);
                    }
                    else if (weapon.Resource == CraftResource.Dwarven)
                    {
                        weapon.Hue = Server.Misc.MaterialInfo.GetMaterialColor("dwarven", "", 0);
                    }
                }
            }
        }
        ...
        public virtual WeaponAbility ThirdAbility
        {
            get { return null; }
        }
        public virtual WeaponAbility FourthAbility
        {
            get { return null; }
        }
        public virtual WeaponAbility FifthAbility
        {
            get { return null; }
        }
        ...
        {
            get { return m_AosWeaponAttributes.ResistPhysicalBonus; }
        }
        public override int FireResistance
        {
            get { return m_AosWeaponAttributes.ResistFireBonus; }
        }
        public override int ColdResistance
        {
            get { return m_AosWeaponAttributes.ResistColdBonus; }
        }
        public override int PoisonResistance
        {
            get { return m_AosWeaponAttributes.ResistPoisonBonus; }
        }
        public override int EnergyResistance
        {
            get { return m_AosWeaponAttributes.ResistEnergyBonus; }
        }
        ...
        public int MinDamage
        {
            get
            {
                return (
                    m_MinDamage == -1
                        ? Core.AOS
                            ? (AosMinDamage + WeaponMaterialDamage(m_Resource))
                            : OldMinDamage
                        : m_MinDamage
                );
            }
        ...
        public int MaxDamage
        {
            get
            {
                return (
                    m_MaxDamage == -1
                        ? Core.AOS
                            ? (AosMaxDamage + WeaponMaterialDamage(m_Resource))
                            : OldMaxDamage
                        : m_MaxDamage
                );
            }
            ...
            set
            {
                if (m_AccuracyLevel != value)
                {
                    ...
                    if (UseSkillMod)
                    {
                        ...
                        {
                            m_SkillMod = new DefaultSkillMod(
                                AccuracySkill,
                                true,
                                (int)m_AccuracyLevel * 5
                            );
        ...
        public override bool CheckConflictingLayer(Mobile m, Item item, Layer layer)
        {
            ...
            if (this.Layer == Layer.TwoHanded && layer == Layer.OneHanded)
            {
                ...
                && layer == Layer.TwoHanded
                && !(item is BaseShield)
                && !(Server.Misc.MaterialInfo.IsMagicLight(item))
            )
            {
        ...
        public override bool OnEquip(Mobile from)
        {
            ...
            )
            {
                ...
                m_MageMod = new DefaultSkillMod(
                    SkillName.Magery,
                    true,
                    -30 + m_AosWeaponAttributes.MageWeapon
                );
        ...
        public virtual SkillName GetUsedSkill(Mobile m, bool checkSkillAttrs)
        {
            ...
            else
            {
                ...
                if (
                    ...
                    && !m.Player
                    && !m.Body.IsHuman
                    && m.Skills[SkillName.FistFighting].Value > m.Skills[sk].Value
                )
                    sk = SkillName.FistFighting;
            }
        ...
        public virtual bool CheckHit(Mobile attacker, Mobile defender)
        {
            ...
            if (Core.AOS)
            {
                ...
                if (
                    CheckAnimal(attacker, typeof(GreyWolf))
                    || CheckAnimal(attacker, typeof(MysticalFox))
                )
        ...
        public virtual void OnBeforeSwing(Mobile attacker, Mobile defender)
        {
            ...
            if (
                ...
                && attacker.Skills[SkillName.Hiding].Value > Utility.RandomMinMax(1, 125)
            )
            {
                PlayerMobile pm = (PlayerMobile)attacker;

                pm.ToTItemsTurnedIn = 1;

                if (attacker.Skills[SkillName.Stealth].Value > Utility.RandomMinMax(1, 250))
                {
                    pm.ToTItemsTurnedIn = 2;
                }
            }
        }
        ...
        public virtual int GetPackInstinctBonus(Mobile attacker, Mobile defender)
        {
            ...
            if (
                bc == null
                || bc.PackInstinct == PackInstinct.None
        ...
        public virtual void OnHit(Mobile attacker, Mobile defender, double damageBonus)
        {
            ...
            if (attacker is PlayerMobile)
            {
                ...
                if (pm.ToTItemsTurnedIn > 0)
                {
                    ...
                    {
                        sneakBonus = (double)(sneakBonus / 2);
                    }
            ...
            if (
                MirrorImage.HasClone(defender)
                && (defender.Skills.Ninjitsu.Value / 150.0) > Utility.RandomDouble()
            )
            {
                Clone bc;
            ...
            if (cs != CheckSlayerResult.None)
            {
                ...
                {
                    attacker.SendMessage(
                        "This weapon seems to be doing quite well against this enemy."
                    );
                }
            }
            ...
            if (
                (m_Slayer == SlayerName.Silver || m_Slayer2 == SlayerName.Silver)
                && context != null
            ...
            if (attacker is PlayerMobile && !(Core.ML && defender is PlayerMobile))
            {
                ...
                if (
                    pmAttacker.SentHonorContext != null
                    && pmAttacker.SentHonorContext.Target == defender
                )
                {
            ...
            if (
                ...
                && (
                    (
                        ...
                        && (
                            defender is Slime
                            || defender is Xenomorph
                            || defender is GreenSlime
                            || defender is BlackPudding
                            || defender is LavaPuddle
                            || defender is AcidPuddle
                            || defender is ToxicElemental
                        )
                    )
                    || Utility.Random(25) == 0
                )
            ...
            if (poisonWeapon != null && attacker is PlayerMobile && defender != null)
            {
                ...
                if (p != null)
                {
                    ...
                    if (
                        Server.Items.WeaponAbility.GetCurrentAbility(attacker)
                            == WeaponAbility.ShadowInfectiousStrike
                        && willPoison == true
                        && ClassicPoisons == 0
                    )
                        willPoison = false;
                    ...
                    if (
                        ClassicPoisons > 0
                        && !(this is BaseKnife || this is BaseSword || this is BaseSpear)
                    )
                    {
                        willPoison = false;
                    }
        ...
        public virtual void DoDispel(Mobile attacker, Mobile defender)
        {
            if (defender is BaseCreature)
            {
                ...
                else
                {
                    ...
                    if (defender is BaseCreature)
                        dispellable =
                            ((BaseCreature)defender).Summoned
                            && !((BaseCreature)defender).IsAnimatedDead;
        ...
        public virtual CheckSlayerResult CheckSlayers(Mobile attacker, Mobile defender)
        {
            ...
            if (
                atkSlayer != null && atkSlayer.Slays(defender)
        ...
        public virtual void AddBlood(Mobile attacker, Mobile defender, int damage)
        {
            if (
                damage > 0
                && Server.Items.BaseRace.IsBleeder(defender)
                && (
            ...
            )
            {
                ...
                int extraBlood = (
                    Core.SE ? Utility.RandomMinMax(3, 4) : Utility.RandomMinMax(0, 1)
                );
            ...
            else
            {
                ...
                if (resInfo != null)
                {
                    ...
                    if (attrInfo != null)
                    {
                        ...
                        left = ApplyCraftAttributeElementDamage(
                            attrInfo.WeaponColdDamage,
                            ref cold,
                            left
                        );
                        left = ApplyCraftAttributeElementDamage(
                            attrInfo.WeaponEnergyDamage,
                            ref nrgy,
                            left
                        );
                        left = ApplyCraftAttributeElementDamage(
                            attrInfo.WeaponFireDamage,
                            ref fire,
                            left
                        );
                        left = ApplyCraftAttributeElementDamage(
                            attrInfo.WeaponPoisonDamage,
                            ref pois,
                            left
                        );
                        left = ApplyCraftAttributeElementDamage(
                            attrInfo.WeaponChaosDamage,
                            ref chaos,
                            left
                        );
                        left = ApplyCraftAttributeElementDamage(
                            attrInfo.WeaponDirectDamage,
                            ref direct,
                            left
                        );
        ...
        private int ApplyCraftAttributeElementDamage(
            int attrDamage,
            ref int element,
            int totalRemaining
        )
        ...
        public virtual void OnMiss(Mobile attacker, Mobile defender)
        {
            ...
            if (attacker is BaseCreature)
            {
                ...
                if (bc.AI == AIType.AI_Archer)
                {
                    ...
                    if (bc.FindItemOnLayer(Layer.OneHanded) is BaseMeleeWeapon)
                    {
                        sound = (
                            (BaseMeleeWeapon)(bc.FindItemOnLayer(Layer.OneHanded))
                        ).DefMissSound;
                    }
                    else if (bc.FindItemOnLayer(Layer.TwoHanded) is BaseMeleeWeapon)
                    {
                        sound = (
                            (BaseMeleeWeapon)(bc.FindItemOnLayer(Layer.TwoHanded))
                        ).DefMissSound;
                    }
        ...
        public virtual double ScaleDamageAOS(Mobile attacker, double damage, bool checkSkills)
        {
            ...
            double anatomyBonus = GetBonus(
                attacker.Skills[SkillName.Anatomy].Value,
                0.500,
                100.0,
                5.00
            );
            double tacticsBonus = GetBonus(
                attacker.Skills[SkillName.Tactics].Value,
                0.625,
                100.0,
                6.25
            );
            double lumberBonus = GetBonus(
                attacker.Skills[SkillName.Lumberjacking].Value,
                0.200,
                100.0,
                10.00
            );
            double armsLoreBonus = GetBonus(
                attacker.Skills[SkillName.ArmsLore].Value,
                0.625,
                100.0,
                6.25
            );
            double miningBonus = GetBonus(
                attacker.Skills[SkillName.Mining].Value,
                0.200,
                100.0,
                10.00
            );
            double fishingBonus = GetBonus(
                attacker.Skills[SkillName.Seafaring].Value,
                0.200,
                100.0,
                10.00
            );
            double ninjaBonus = GetBonus(
                attacker.Skills[SkillName.Ninjitsu].Value,
                0.625,
                100.0,
                6.25
            );
            double bushidoBonus = GetBonus(
                attacker.Skills[SkillName.Bushido].Value,
                0.625,
                100.0,
                6.25
            );
            double necroBonus = GetBonus(
                attacker.Skills[SkillName.Necromancy].Value,
                0.625,
                100.0,
                6.25
            );
            double wizardBonus = GetBonus(
                attacker.Skills[SkillName.Magery].Value,
                0.625,
                100.0,
                6.25
            );
            double bowyerBonus = GetBonus(
                attacker.Skills[SkillName.Bowcraft].Value,
                0.625,
                100.0,
                6.25
            );
            double ellyBonus = GetBonus(
                attacker.Skills[SkillName.Elementalism].Value,
                0.625,
                100.0,
                6.25
            );
            ...
            if (
                !(
                    this is BaseStaff
                    || this is WizardWand
                    || this is BaseWizardStaff
                    || this is BaseLevelStave
                    || this is BaseGiftStave
                    || this is GiftScepter
                    || this is LevelScepter
                    || this is Scepter
                )
            )
            {
            ...
            double totalBonus =
                ...
                + miningBonus
                + fishingBonus
                + ((double)(GetDamageBonus() + damageBonus) / 100.0);
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            if ((prop = m_AosAttributes.NightSight) != 0)
                if (
                    ...
                    && !(this is LightSword)
                    && !(this is DoubleLaserSword)
                    && !(this is LevelLaserSword)
                    && !(this is LevelDoubleLaserSword)
                )
            ...
            if (strReq > 0)
                list.Add(1061170, strReq.ToString());
            if (dexReq > 0)
                list.Add(1060658, "{0}\t{1}", "dexterity requirement", dexReq.ToString());
            if (intReq > 0)
                list.Add(1060662, "{0}\t{1}", "intelligence requirement", intReq.ToString());
            ...
            if (Core.SE || m_AosWeaponAttributes.UseBestSkill == 0)
            {
                switch (Skill)
                {
                    ...
                    case SkillName.Bludgeoning:
                        list.Add(1061173);
                        break; // skill required: bludgeoning
                    case SkillName.Fencing:
                        list.Add(1061174);
                        break; // skill required: fencing
                    case SkillName.Marksmanship:
                        list.Add(1061175);
                        break; // skill required: marksmanship
                    case SkillName.FistFighting:
                        list.Add("skill required: fist fighting");
                        break;
                }
            }
