    ...
    public class MonsterGloves : BaseRanged
    {
        ...
        public override int EffectID
        {
            get
            {
                ...
                else if (ThrowType == "Axes")
                {
                    return 0x10B3;
                }
                else if (ThrowType == "Daggers")
                {
                    return 0x529F;
                }
                else if (ThrowType == "Darts")
                {
                    return 0x52B0;
                }
                else if (ThrowType == "Spear")
                {
                    return 0x528A;
                }
                else if (ThrowType == "Boulder")
                {
                    return 0x1368;
                }
                else if (ThrowType == "Bones")
                {
                    return 0xF7E;
                }
                else if (ThrowType == "Bandages")
                {
                    return 0xE21;
                }
                else
        ...
        {
            get { return WeaponAbility.ZapIntStrike; }
        }
        ...
        public MonsterGloves(Serial serial)
            : base(serial) { }
