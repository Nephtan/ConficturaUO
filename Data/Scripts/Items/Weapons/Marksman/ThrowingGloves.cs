    ...
    public class ThrowingGloves : BaseRanged
    {
        ...
        public override int EffectID
        {
            get
            {
                ...
                else if (GloveType == "Axes")
                {
                    return 0x10B3;
                }
                else if (GloveType == "Daggers")
                {
                    return 0x529F;
                }
                else if (GloveType == "Darts")
                {
                    return 0x52B0;
                }
        ...
        {
            get { return typeof(ThrowingWeapon); }
        }
        public override Item Ammo
        {
            get { return new ThrowingWeapon(); }
        }
        ...
        public override WeaponAbility SecondaryAbility
        {
            get
            {
                if (GloveType == "Stones")
                {
                    return WeaponAbility.StunningStrike;
                }
                else if (GloveType == "Axes")
                {
        ...
        public override WeaponAbility FourthAbility
        {
            get
            {
                if (GloveType == "Stones")
                {
                    return WeaponAbility.DeathBlow;
                }
                else if (GloveType == "Axes")
                {
                    return WeaponAbility.ConsecratedStrike;
                }
                else if (GloveType == "Daggers")
                {
                    return WeaponAbility.DevastatingBlow;
                }
                else if (GloveType == "Darts")
                {
                    return WeaponAbility.ToxicStrike;
                }
                else if (GloveType == "Cards")
                {
                    return WeaponAbility.DevastatingBlow;
                ...
                {
                    return WeaponAbility.ShadowInfectiousStrike;
                }
            }
        }
        ...
        public override WeaponAbility FifthAbility
        {
            get
            {
                ...
                {
                    return WeaponAbility.LightningStriker;
                }
                else if (GloveType == "Cards")
                {
                    return WeaponAbility.DeathBlow;
        ...
        {
            get { return WeaponAnimation.Punching; }
        }

        [Constructable]
        public ThrowingGloves()
            : base(0x13C6)
        {
            if (GloveType == "" || GloveType == null)
            {
                GloveType = "Stones";
            }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                else if (GloveType == "Stars" && Server.Misc.GetPlayerInfo.isJester(from))
                {
                    GloveType = "Cards";
                }
                else if (GloveType == "Cards" && Server.Misc.GetPlayerInfo.isJester(from))
                {
                    GloveType = "Tomatoes";
                }
                else
        ...
        public ThrowingGloves(Serial serial)
            : base(serial) { }
