...
namespace Server.Items
{
    public class SlayerGroup
    {
        ...
        static SlayerGroup()
        {
            ...
            {
                new SlayerEntry(SlayerName.ScorpionsBane, typeof(Scorpion), typeof(DeadlyScorpion)),
                new SlayerEntry(
