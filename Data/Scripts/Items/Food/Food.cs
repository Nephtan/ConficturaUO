...
namespace Server.Items
{
    public abstract class Food : Item
    {
        ...
        public virtual int HitsBonus
        {
            get { return 0; }
            set { M_HitsBonus = value; }
        }
        public virtual int ManaBonus
        {
            get { return 0; }
            set { M_ManaBonus = value; }
        }
        ...
        public virtual bool Eat(Mobile from)
        {
            ...
            if (FillHunger(from, m_FillFactor, HitsBonus, ManaBonus)) // added HitsBonus, ManaBonus - alari
            {
                ...
                if (iHurt > 0)
                {
                    ...
                    {
                        if (
                            (int)from.Skills[SkillName.Tasting].Value
    ...
    {
        [Constructable]
        public FoodBeefJerky()
            : this(1) { }

        [Constructable]
        public FoodBeefJerky(int amount)
            : base(amount, 0x979)
        {
        ...
        public FoodBeefJerky(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public FoodToadStool()
            : this(1) { }

        [Constructable]
        public FoodToadStool(int amount)
            : base(amount, 0xB4D)
        {
        ...
        public FoodToadStool(Serial serial)
            : base(serial) { }
    ...
    public class FoodPotato : Food
    {
        ...
        public FoodPotato(Serial serial)
            : base(serial) { }
    ...
    public class FoodImpBerry : Food
    {
        ...
        [Constructable]
        public FoodImpBerry(int amount)
            : base(amount, 0xF7A)
        {
            this.Name = "imp berry";
            this.Hue = 0x48E;
        ...
        public FoodImpBerry(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public FoodDriedBeef()
            : this(1) { }

        [Constructable]
        public FoodDriedBeef(int amount)
            : base(amount, 0x979)
        {
        ...
        public FoodDriedBeef(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public FoodStaleBread()
            : this(1) { }

        [Constructable]
        public FoodStaleBread(int amount)
            : base(amount, 0x103B)
        {
        ...
        public FoodStaleBread(Serial serial)
            : base(serial) { }
