...
namespace Server.Items
{
    public class ManyArrows100 : Item
    {
        ...
        public ManyArrows100(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                from.PrivateOverheadMessage(
                    ...
                    0x14C,
                    false,
                    "You separate the arrows into your backpack",
                    from.NetState
                );
                this.Delete();
            }
    ...
    public class ManyArrows1000 : Item
    {
        ...
        public ManyArrows1000(Serial serial)
            : base(serial) { }
    ...
    public class ManyBolts100 : Item
    {
        ...
        public ManyBolts100(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                from.PrivateOverheadMessage(
                    ...
                    0x14C,
                    false,
                    "You separate the bolts into your backpack",
                    from.NetState
                );
                this.Delete();
            }
    ...
    public class ManyBolts1000 : Item
    {
        ...
        public ManyBolts1000(Serial serial)
            : base(serial) { }
