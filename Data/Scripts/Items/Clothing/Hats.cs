...
namespace Server.Items
{
    ...
    public class ClothHood : BaseHat
    {
        ...
        public ClothHood(Serial serial)
            : base(serial) { }
    ...
    public class HoodedMantle : BaseHat
    {
        ...
        public HoodedMantle(Serial serial)
            : base(serial) { }
    ...
    public class ClothCowl : BaseHat
    {
        ...
        public ClothCowl(Serial serial)
            : base(serial) { }
    ...
    public class WizardHood : BaseHat
    {
        ...
        public WizardHood(Serial serial)
            : base(serial) { }
    ...
    public class FancyHood : BaseHat
    {
        ...
        public FancyHood(Serial serial)
            : base(serial) { }
    ...
    public class SkullCap : BaseHat
    {
        ...
        public override int InitMinHits
        {
            get { return (Core.ML ? 14 : 7); }
        }
        public override int InitMaxHits
        {
            get { return (Core.ML ? 28 : 12); }
        }
