...
namespace Server.Items
{
            ...
            IWearableDurability
    {
        ...
        {
            get { return BasePhysicalResistance + m_AosResistances.Physical; }
        }
        public override int FireResistance
        {
            get { return BaseFireResistance + m_AosResistances.Fire; }
        }
        public override int ColdResistance
        {
            get { return BaseColdResistance + m_AosResistances.Cold; }
        }
        public override int PoisonResistance
        {
            get { return BasePoisonResistance + m_AosResistances.Poison; }
        }
        public override int EnergyResistance
        {
            get { return BaseEnergyResistance + m_AosResistances.Energy; }
        }
                ...
                if (item is BaseClothing)
                {
                    ...
                    if (clothing.RequiredRace != null && m.Race != clothing.RequiredRace)
                    {
                        if (clothing.RequiredRace == Race.Elf)
                            ...
                            m.SendMessage(
                                "Only {0} may use this.",
                                clothing.RequiredRace.PluralName
                            );
        ...
        public virtual int OnHit(BaseWeapon weapon, int damageTaken)
        {
            ...
            if (25 > Utility.Random(100)) // 25% chance to lower durability
            {
                ...
                else if (Core.AOS && m_AosClothingAttributes.SelfRepair > Utility.Random(10))
                {
                    HitPoints += 2;
                }
                else
        ...
        public override void OnAfterDuped(Item newItem)
        {
            ...
            clothing.m_AosClothingAttributes = new AosArmorAttributes(
                newItem,
