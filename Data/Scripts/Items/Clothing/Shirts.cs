...
namespace Server.Items
{
    ...
    public class SquireShirt : BaseShirt
    {
        ...
        public SquireShirt(Serial serial)
            : base(serial) { }
    ...
    public class FormalCoat : BaseShirt
    {
        ...
        public FormalCoat(Serial serial)
            : base(serial) { }
    ...
    public class WizardShirt : BaseShirt
    {
        ...
        public WizardShirt(Serial serial)
            : base(serial) { }
    ...
    public class BeggarVest : BaseShirt
    {
        ...
        public BeggarVest(Serial serial)
            : base(serial) { }
    ...
    public class RoyalVest : BaseShirt
    {
        ...
        public RoyalVest(Serial serial)
            : base(serial) { }
    ...
    public class RusticVest : BaseShirt
    {
        ...
        public RusticVest(Serial serial)
            : base(serial) { }
