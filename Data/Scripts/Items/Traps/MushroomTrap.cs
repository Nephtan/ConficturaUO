...
namespace Server.Items
{
    public class MushroomTrap : BaseTrap
    {
        ...
        public int Shroom_Type
        {
            get { return ShroomType; }
            set
            {
                ShroomType = value;
            ...
            : base(0x1A81)
        {
            ...
            switch (Utility.RandomMinMax(1, 6))
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    Name = "curious mushroom";
                    break;
                case 5:
                    Name = "peculiar mushroom";
                    break;
                case 6:
                    Name = "bizarre mushroom";
                    break;
            }
        ...
        public override void OnTrigger(Mobile from)
        {
            ...
            if (
                Server.Misc.SeeIfGemInBag.GemInPocket(from) == true
                || Server.Misc.SeeIfJewelInBag.JewelInPocket(from) == true
            )
                return;
            ...
            switch (ShroomType)
            {
                case 1:
                    ...
                    itHurts = (int)(
                        (Utility.RandomMinMax(40, 200) * (100 - from.PhysicalResistance)) / 100
                    );
                ...
                case 2:
                    ...
                    from.LocalOverheadMessage(
                        ...
                        0xB1F,
                        true,
                        "A mushroom released odd spores!"
                    );
                ...
                case 3:
                    ...
                    from.BoltEffect(0);
                    itHurts = (int)(
                        (Utility.RandomMinMax(40, 200) * (100 - from.EnergyResistance)) / 100
                    );
                    ...
                    from.LocalOverheadMessage(
                        ...
                        0xB1F,
                        true,
                        "A mushroom released strange energy!"
                    );
