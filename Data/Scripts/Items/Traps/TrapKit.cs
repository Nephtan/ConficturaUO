        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else if (Charges > 0)
            {
                ...
                else if (from.Skills[SkillName.RemoveTrap].Value > 0)
                {
                    ...
                    if (m_Metal == "Dull Copper")
                    {
                        Power = Power + 3;
                    }
                    else if (m_Metal == "Shadow Iron")
                    {
                        Power = Power + 6;
                    }
                    else if (m_Metal == "Copper")
                    {
                        Power = Power + 9;
                    }
                    else if (m_Metal == "Bronze")
                    {
                        Power = Power + 12;
                    }
                    else if (m_Metal == "Gold")
                    {
                        Power = Power + 15;
                    }
                    else if (m_Metal == "Agapite")
                    {
                        Power = Power + 18;
                    }
                    else if (m_Metal == "Verite")
                    {
                        Power = Power + 21;
                    }
                    else if (m_Metal == "Valorite")
                    {
                        Power = Power + 24;
                    }
                    else if (m_Metal == "Nepturite")
                    {
                        Power = Power + 27;
                    }
                    else if (m_Metal == "Obsidian")
                    {
                        Power = Power + 30;
                    }
                    else if (m_Metal == "Steel")
                    {
                        Power = Power + 33;
                    }
                    else if (m_Metal == "Brass")
                    {
                        Power = Power + 36;
                    }
                    else if (m_Metal == "Mithril")
                    {
                        Power = Power + 39;
                    }
                    else if (m_Metal == "Xormite")
                    {
                        Power = Power + 42;
                    }
                    else if (m_Metal == "Dwarven")
                    {
                        Power = Power + 78;
                    }
