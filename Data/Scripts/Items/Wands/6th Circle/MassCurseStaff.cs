...
{
    public class MassCurseMagicStaff : BaseMagicStaff
    {
        [Constructable]
        public MassCurseMagicStaff()
            : base(MagicStaffEffect.Charges, 1, 7)
        {
            IntRequirement = 35;
            Name = "wand of mass curses";
        ...
        public MassCurseMagicStaff(Serial serial)
            : base(serial) { }
