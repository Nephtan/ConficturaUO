...
namespace Server.Items
{
    ...
    public abstract class BaseMagicStaff : BaseBashing
    {
        ...
        public BaseMagicStaff(MagicStaffEffect effect, int minCharges, int maxCharges)
            : base(0xDF2)
        {
            Weight = 1.0;
            Effect = effect;
        ...
        public BaseMagicStaff(Serial serial)
            : base(serial) { }
        ...
        public virtual void ApplyDelayTo(Mobile from)
        {
            ...
            Timer.DelayCall(
                GetUseDelay,
                new TimerStateCallback(ReleaseMagicStaffLock_Callback),
                from
            );
        }
        ...
        public override bool OnDragLift(Mobile from)
        {
            ...
            {
                from.SendMessage(
                    "You cannot use a wand with a weapon equipped or while wearing pugilist gloves."
                );
            }
