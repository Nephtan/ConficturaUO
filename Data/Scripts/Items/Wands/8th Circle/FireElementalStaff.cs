...
{
    public class FireElementalMagicStaff : BaseMagicStaff
    {
        [Constructable]
        public FireElementalMagicStaff()
            : base(MagicStaffEffect.Charges, 1, 3)
        {
            IntRequirement = 45;
            Name = "wand of fire elementals";
        ...
        public FireElementalMagicStaff(Serial serial)
            : base(serial) { }
