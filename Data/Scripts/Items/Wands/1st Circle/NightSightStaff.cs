...
{
    public class NightSightMagicStaff : BaseMagicStaff
    {
        [Constructable]
        public NightSightMagicStaff()
            : base(MagicStaffEffect.Charges, 1, 25)
        {
            IntRequirement = 10;
            Name = "wand of night sight";
        ...
        public NightSightMagicStaff(Serial serial)
            : base(serial) { }
