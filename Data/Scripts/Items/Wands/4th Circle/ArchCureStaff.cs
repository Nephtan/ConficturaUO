...
{
    public class ArchCureMagicStaff : BaseMagicStaff
    {
        [Constructable]
        public ArchCureMagicStaff()
            : base(MagicStaffEffect.Charges, 1, 11)
        {
            IntRequirement = 25;
            Name = "wand of arch curing";
        ...
        public ArchCureMagicStaff(Serial serial)
            : base(serial) { }
