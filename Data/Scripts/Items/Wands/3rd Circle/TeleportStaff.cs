...
{
    public class TeleportMagicStaff : BaseMagicStaff
    {
        [Constructable]
        public TeleportMagicStaff()
            : base(MagicStaffEffect.Charges, 1, 15)
        {
            IntRequirement = 20;
            Name = "wand of teleporting";
        ...
        public TeleportMagicStaff(Serial serial)
            : base(serial) { }
