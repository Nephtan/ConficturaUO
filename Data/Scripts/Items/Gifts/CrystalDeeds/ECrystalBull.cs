...
namespace Server.Items
{
    ...
    public class ECrystalBullAddon : BaseAddon
    {
        ...
        {
            get { return new ECrystalBullDeed(); }
        }
        ...
        public ECrystalBullAddon(Serial serial)
            : base(serial) { }
    ...
    public class ECrystalBullDeed : BaseAddonDeed
    {
        ...
        {
            get { return new ECrystalBullAddon(m_East); }
        }
        ...
        private class InternalGump : Gump
        {
            ...
            public InternalGump(ECrystalBullDeed deed)
                : base(60, 35)
            {
                m_Deed = deed;
        ...
        public ECrystalBullDeed(Serial serial)
            : base(serial) { }
