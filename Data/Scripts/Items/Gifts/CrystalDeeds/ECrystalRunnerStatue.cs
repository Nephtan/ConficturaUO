...
namespace Server.Items
{
    ...
    public class ECrystalRunnerStatueAddon : BaseAddon
    {
        ...
        public ECrystalRunnerStatueAddon(Serial serial)
            : base(serial) { }
    ...
    public class ECrystalRunnerStatueDeed : BaseAddonDeed
    {
        ...
        {
            get { return new ECrystalRunnerStatueAddon(m_East); }
        }
        ...
        private class InternalGump : Gump
        {
            ...
            public InternalGump(ECrystalRunnerStatueDeed deed)
                : base(60, 35)
            {
                m_Deed = deed;
        ...
        public ECrystalRunnerStatueDeed(Serial serial)
            : base(serial) { }
