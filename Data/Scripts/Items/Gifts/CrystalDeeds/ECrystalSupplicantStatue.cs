...
namespace Server.Items
{
    ...
    public class ECrystalSupplicantStatueAddon : BaseAddon
    {
        ...
        public ECrystalSupplicantStatueAddon(Serial serial)
            : base(serial) { }
    ...
    public class ECrystalSupplicantStatueDeed : BaseAddonDeed
    {
        ...
        {
            get { return new ECrystalSupplicantStatueAddon(m_East); }
        }
        ...
        private class InternalGump : Gump
        {
            ...
            public InternalGump(ECrystalSupplicantStatueDeed deed)
                : base(60, 35)
            {
                m_Deed = deed;
        ...
        public ECrystalSupplicantStatueDeed(Serial serial)
            : base(serial) { }
