...
namespace Server.Items
{
    ...
    public class ECrystalTableAddon : BaseAddon
    {
        ...
        {
            get { return new ECrystalTableDeed(); }
        }
        ...
        public ECrystalTableAddon(Serial serial)
            : base(serial) { }
    ...
    public class ECrystalTableDeed : BaseAddonDeed
    {
        ...
        {
            get { return new ECrystalTableAddon(m_East); }
        }
        ...
        private class InternalGump : Gump
        {
            ...
            public InternalGump(ECrystalTableDeed deed)
                : base(60, 35)
            {
                m_Deed = deed;
        ...
        public ECrystalTableDeed(Serial serial)
            : base(serial) { }
