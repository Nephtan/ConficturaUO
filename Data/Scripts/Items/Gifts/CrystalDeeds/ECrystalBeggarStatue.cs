...
namespace Server.Items
{
    ...
    public class ECrystalBeggarStatueAddon : BaseAddon
    {
        ...
        public ECrystalBeggarStatueAddon(Serial serial)
            : base(serial) { }
    ...
    public class ECrystalBeggarStatueDeed : BaseAddonDeed
    {
        ...
        {
            get { return new ECrystalBeggarStatueAddon(m_East); }
        }
        ...
        private class InternalGump : Gump
        {
            ...
            public InternalGump(ECrystalBeggarStatueDeed deed)
                : base(60, 35)
            {
                m_Deed = deed;
        ...
        public ECrystalBeggarStatueDeed(Serial serial)
            : base(serial) { }
