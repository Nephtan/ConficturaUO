...
namespace Server.Items
{
    public class DaemonDartBoard : AddonComponent
    {
        public bool East
        {
            get { return this.ItemID == 0x56AB; }
        }

        [Constructable]
        public DaemonDartBoard()
            : this(true) { }

        [Constructable]
        public DaemonDartBoard(bool east)
            : base(east ? 0x56AB : 0x56B1)
        {
        ...
        public void Throw(Mobile from)
        {
            ...
            if (nAnimate == 1 && ItemID >= 0x56AB && ItemID <= 0x56B0)
            {
                ItemID = 0x56AC;
            }
            else if (nAnimate == 1 && ItemID >= 0x56B1 && ItemID <= 0x56B6)
            {
                ItemID = 0x56B2;
            }
        ...
        public virtual void OnDaemonReset()
        {
            ...
            else if (ItemID >= 0x56AB && ItemID <= 0x56B0)
            {
                ItemID = 0x56AB;
            }
            else
        ...
        public DaemonDartBoard(Serial serial)
            : base(serial) { }
    ...
    public class DaemonDartBoardEastAddon : BaseAddon
    {
        ...
        public DaemonDartBoardEastAddon(Serial serial)
            : base(serial) { }
    ...
    public class DaemonDartBoardEastDeed : BaseAddonDeed
    {
        ...
        public DaemonDartBoardEastDeed(Serial serial)
            : base(serial) { }
    ...
    public class DaemonDartBoardSouthAddon : BaseAddon
    {
        ...
        public DaemonDartBoardSouthAddon(Serial serial)
            : base(serial) { }
    ...
    public class DaemonDartBoardSouthDeed : BaseAddonDeed
    {
        ...
        public DaemonDartBoardSouthDeed(Serial serial)
            : base(serial) { }
