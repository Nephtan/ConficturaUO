...
namespace Server.Items
{
    public class MongbatDartBoard : AddonComponent
    {
        ...
        [Constructable]
        public MongbatDartBoard(bool east)
            : base(east ? 0x1953 : 0x1950) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (ItemID != 0x1950 && ItemID != 0x1953)
                ...
                canThrow = (
                    dir == Direction.Up || dir == Direction.North || dir == Direction.Right
                );
        ...
        public void Throw(Mobile from)
        {
            ...
            if (nAnimate == 1 && ItemID >= 0x1953 && ItemID <= 0x1955)
            {
                ItemID = 0x1954;
            }
            else if (nAnimate == 1 && ItemID >= 0x1950 && ItemID <= 0x1952)
            {
                ItemID = 0x1951;
            }
        ...
        {
            if (ItemID != 0x1951 && ItemID != 0x1954)
            {
                Timer.DelayCall(TimeSpan.FromSeconds(0.1), new TimerCallback(OnMongbatReset));
            }
            else if (ItemID >= 0x1953 && ItemID <= 0x1955)
            {
                ItemID = 0x1953;
            }
            else
    ...
    public class MongbatDartBoardEastAddon : BaseAddon
    {
        ...
        {
            get { return new MongbatDartBoardEastDeed(); }
        }
        ...
        public MongbatDartBoardEastAddon(Serial serial)
            : base(serial) { }
    ...
    public class MongbatDartBoardEastDeed : BaseAddonDeed
    {
        ...
        {
            get { return new MongbatDartBoardEastAddon(); }
        }
        ...
        public MongbatDartBoardEastDeed(Serial serial)
            : base(serial) { }
    ...
    public class MongbatDartBoardSouthAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get { return new MongbatDartBoardSouthDeed(); }
        }
        ...
        public MongbatDartBoardSouthAddon(Serial serial)
            : base(serial) { }
    ...
    public class MongbatDartBoardSouthDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get { return new MongbatDartBoardSouthAddon(); }
        }
        ...
        public MongbatDartBoardSouthDeed(Serial serial)
            : base(serial) { }
