...
namespace Server.Items
{
    ...
    public class halloween_shackles : Item
    {
        ...
        public halloween_shackles(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public halloween_ruined_bookcase()
            : base(0x0C14)
        {
            Weight = 1.0;
        ...
        public halloween_ruined_bookcase(Serial serial)
            : base(serial) { }
    ...
    public class halloween_covered_chair : Item
    {
        ...
        public halloween_covered_chair(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public halloween_HauntedMirror1()
            : base(10875)
        {
            Weight = 1.0;
            Name = "gothic mirror";
        ...
        public halloween_HauntedMirror1(Serial serial)
            : base(serial) { }
    ...
    public class halloween_HauntedMirror2 : Item
    {
        ...
        public halloween_HauntedMirror2(Serial serial)
            : base(serial) { }
    ...
    public class halloween_devil_face : Item
    {
        ...
        public halloween_devil_face(Serial serial)
            : base(serial) { }
