...
namespace Server.Items
{
    public class EvilFireplaceSouthFaceAddon : BaseAddon
    {
        ...
        {
            get { return new EvilFireplaceSouthFaceAddonDeed(); }
        }
        ...
        public EvilFireplaceSouthFaceAddon(Serial serial)
            : base(serial) { }
    ...
    public class EvilFireplaceSouthFaceAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new EvilFireplaceSouthFaceAddon(); }
        }
        ...
        public EvilFireplaceSouthFaceAddonDeed(Serial serial)
            : base(serial) { }
    ...
    public class EvilFireplaceEastFaceAddon : BaseAddon
    {
        ...
        public override BaseAddonDeed Deed
        {
            get { return new EvilFireplaceEastFaceAddonDeed(); }
        }
        ...
        public EvilFireplaceEastFaceAddon(Serial serial)
            : base(serial) { }
    ...
    public class EvilFireplaceEastFaceAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get { return new EvilFireplaceEastFaceAddon(); }
        }
        ...
        public EvilFireplaceEastFaceAddonDeed(Serial serial)
            : base(serial) { }
