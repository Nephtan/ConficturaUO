...
namespace Server.Items
{
    public class halloween_coffin_eastAddon : BaseAddon
    {
        ...
        {
            get { return new halloween_coffin_eastAddonDeed(); }
        }
        ...
        public halloween_coffin_eastAddon(Serial serial)
            : base(serial) { }
    ...
    public class halloween_coffin_eastAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new halloween_coffin_eastAddon(); }
        }
        ...
        public halloween_coffin_eastAddonDeed(Serial serial)
            : base(serial) { }
    ...
    public class halloween_coffin_southAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get { return new halloween_coffin_southAddonDeed(); }
        }
        ...
        public halloween_coffin_southAddon(Serial serial)
            : base(serial) { }
    ...
    public class halloween_coffin_southAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get { return new halloween_coffin_southAddon(); }
        }
        ...
        public halloween_coffin_southAddonDeed(Serial serial)
            : base(serial) { }
    ...
    public class halloween_block_southAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get { return new halloween_block_southAddonDeed(); }
        }
        ...
        public halloween_block_southAddon(Serial serial)
            : base(serial) { }
    ...
    public class halloween_block_southAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get { return new halloween_block_southAddon(); }
        }
        ...
        public halloween_block_southAddonDeed(Serial serial)
            : base(serial) { }
    ...
    public class halloween_block_eastAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get { return new halloween_block_eastAddonDeed(); }
        }
        ...
        public halloween_block_eastAddon(Serial serial)
            : base(serial) { }
    ...
    public class halloween_block_eastAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get { return new halloween_block_eastAddon(); }
        }
        ...
        public halloween_block_eastAddonDeed(Serial serial)
            : base(serial) { }
