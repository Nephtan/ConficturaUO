...
namespace Server.Items
{
    public class HalloweenBonePileAddon : BaseAddon
    {
        ...
        {
            get { return new HalloweenBonePileDeed(); }
        }
        ...
        public HalloweenBonePileAddon(Serial serial)
            : base(serial) { }
    ...
    public class HalloweenBonePileDeed : BaseAddonDeed
    {
        ...
        {
            get { return new HalloweenBonePileAddon(); }
        }
        ...
        public HalloweenBonePileDeed(Serial serial)
            : base(serial) { }
