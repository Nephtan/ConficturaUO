...
namespace Server.Items
{
    public class HalloweenCostume : Robe
    {
            ...
            else
            {
                switch (Utility.RandomMinMax(0, 24))
                {
                    ...
                    case 22:
                        ...
                        break;
                    case 23:
                        Name = "Swamp Thing Costume";
                        Hue = 752;
                        break;
                    case 24:
                        Name = "Black Knight Costume";
                        Hue = 1;
                        break;
                }
            }
        ...
        public override bool OnEquip(Mobile mob)
        {
            if (base.OnEquip(mob))
            {
                if (mob.BodyMod > 0)
                {
                    mob.PublicOverheadMessage(
                        MessageType.Regular,
                        0x44,
                        false,
                        "This costume will not fit in this form"
                    );
        ...
        public HalloweenCostume(Serial serial)
            : base(serial) { }
    ...
    public class ChocolateMonster : Item
    {
                ...
                if (90 > Utility.Random(100))
                {
                    switch (Utility.RandomMinMax(0, 18))
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            Name = "Chocolate Centaur";
                            ItemID = 9601;
                            break;
                        case 2:
                            Name = "Chocolate Demon";
                            ItemID = 9604;
                            break;
                        case 3:
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            Name = "Chocolate Unicorn";
                            ItemID = 9678;
                            break;
                        case 8:
                            Name = "Chocolate Snake";
                            ItemID = 9663;
                            break;
                        case 9:
                            Name = "Chocolate Ratman";
                            ItemID = 9655;
                            break;
                        case 10:
                            Name = "Chocolate Zombie";
                            ItemID = 9685;
                            break;
                        case 11:
                            Name = "Chocolate Minotaur";
                            ItemID = 11657;
                            break;
                        case 12:
                            Name = "Chocolate Werewolf";
                            ItemID = 11670;
                            break;
                        case 13:
                        ...
                        case 15:
                            ...
                            break;
                        case 16:
                            Name = "Chocolate Lizardman";
                            ItemID = 8414;
                            break;
                        case 17:
                            Name = "Chocolate Elemental";
                            ItemID = 8435;
                            break;
                        case 18:
                            Name = "Chocolate Spider";
                            ItemID = 8445;
                            break;
                    }
                }
        ...
        public override void OnDoubleClick(Mobile m)
        {
            ...
            switch (Utility.RandomMinMax(0, 6))
            {
                case 0:
                    ...
                    break;
                case 1:
                    phrase = "Tastes pretty good";
                    break;
                case 2:
                    phrase = "I feel a sugar buzz coming on";
                    break;
                case 3:
                    phrase = "I think it was stale";
                    break;
                case 4:
                    phrase = "Do I feel a razor blade?";
                    break;
                case 5:
                    phrase = "Ouch...my tooth!";
                    break;
                case 6:
                    phrase = "This will go straight to the hips";
                    break;
            }
        ...
        public ChocolateMonster(Serial serial)
            : base(serial) { }
    ...
    {
        private static int[] m_Color = new int[] { 0x386, 1258, 1194, 1150 };
        ...
        public HalloweenBag()
        {
            ...
            if (nGift == 1)
            {
                DropItem(new CarvedPumpkin());
            }
            else
            {
                DropItem(new CarvedPumpkin2());
            }
        }

        public HalloweenBag(Serial serial)
            : base(serial) { }
