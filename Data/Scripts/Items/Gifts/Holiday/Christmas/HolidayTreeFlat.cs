...
namespace Server.Items
{
    public class HolidayTreeFlat : BaseAddon
    {
        ...
        {
            get { return new HolidayTreeFlatDeed(); }
        }
        ...
        public HolidayTreeFlat()
        {
            if (Utility.RandomMinMax(1, 2) == 1)
            {
                for (int i = 0; i < m_AddOnSimpleComponentsA.Length / 4; i++)
                    AddComponent(
                        new AddonComponent(m_AddOnSimpleComponentsA[i, 0]),
                        m_AddOnSimpleComponentsA[i, 1],
                        m_AddOnSimpleComponentsA[i, 2],
                        m_AddOnSimpleComponentsA[i, 3]
                    );
            }
            else
            {
                for (int i = 0; i < m_AddOnSimpleComponentsB.Length / 4; i++)
                    AddComponent(
                        new AddonComponent(m_AddOnSimpleComponentsB[i, 0]),
                        m_AddOnSimpleComponentsB[i, 1],
                        m_AddOnSimpleComponentsB[i, 2],
                        m_AddOnSimpleComponentsB[i, 3]
                    );
            }
        }

        public HolidayTreeFlat(Serial serial)
            : base(serial) { }
    ...
    public class HolidayTreeFlatDeed : BaseAddonDeed
    {
        ...
        {
            get { return new HolidayTreeFlat(); }
        }
        ...
        public HolidayTreeFlatDeed(Serial serial)
            : base(serial) { }
