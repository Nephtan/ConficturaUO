...
namespace Server.Items
{
    ...
    public class EShadowAltarAddon : BaseAddon
    {
        ...
        public EShadowAltarAddon(Serial serial)
            : base(serial) { }
    ...
    public class EShadowAltarDeed : BaseAddonDeed
    {
        ...
        {
            get { return new EShadowAltarAddon(m_East); }
        }
        ...
        private class InternalGump : Gump
        {
            ...
            public InternalGump(EShadowAltarDeed deed)
                : base(60, 35)
            {
                m_Deed = deed;
        ...
        public EShadowAltarDeed(Serial serial)
            : base(serial) { }
