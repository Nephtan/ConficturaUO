...
namespace Server.Items
{
    public class RoseEastSmallAddon : BaseAddon
    {
        private static int[,] m_AddOnSimpleComponents = new int[,]
        {
            ...
            { 18266, 0, 1, 0 },
            { 18269, 1, 1, 0 },
            { 18267, 2, 1, 0 } // 13	14	15
        };

        public override BaseAddonDeed Deed
        {
            get { return new RoseEastSmallAddonDeed(); }
        }
        ...
        public RoseEastSmallAddon(Serial serial)
            : base(serial) { }
    ...
    public class RoseEastSmallAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new RoseEastSmallAddon(); }
        }
        ...
        public RoseEastSmallAddonDeed(Serial serial)
            : base(serial) { }
