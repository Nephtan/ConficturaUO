...
namespace Server.Items
{
    public class RoseSouthSmallAddon : BaseAddon
    {
        private static int[,] m_AddOnSimpleComponents = new int[,]
        {
            ...
            { 18253, 1, 0, 0 },
            { 18256, 1, 1, 0 },
            { 18252, 1, 2, 0 } // 13	14	15
        };

        public override BaseAddonDeed Deed
        {
            get { return new RoseSouthSmallAddonDeed(); }
        }
        ...
        public RoseSouthSmallAddon(Serial serial)
            : base(serial) { }
    ...
    public class RoseSouthSmallAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new RoseSouthSmallAddon(); }
        }
        ...
        public RoseSouthSmallAddonDeed(Serial serial)
            : base(serial) { }
