...
namespace Server.Items
{
    public class RoseEastLargeAddon : BaseAddon
    {
        ...
        {
            get { return new RoseEastLargeAddonDeed(); }
        }
        ...
        public RoseEastLargeAddon(Serial serial)
            : base(serial) { }
    ...
    public class RoseEastLargeAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new RoseEastLargeAddon(); }
        }
        ...
        public RoseEastLargeAddonDeed(Serial serial)
            : base(serial) { }
