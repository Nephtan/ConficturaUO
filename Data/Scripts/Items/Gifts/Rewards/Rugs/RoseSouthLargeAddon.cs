...
namespace Server.Items
{
    public class RoseSouthLargeAddon : BaseAddon
    {
        ...
        {
            get { return new RoseSouthLargeAddonDeed(); }
        }
        ...
        public RoseSouthLargeAddon(Serial serial)
            : base(serial) { }
    ...
    public class RoseSouthLargeAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new RoseSouthLargeAddon(); }
        }
        ...
        public RoseSouthLargeAddonDeed(Serial serial)
            : base(serial) { }
