    ...
    public class MagicForges : Item
    {
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            if (!e.Handled)
            {
                ...
                if (
                    m.Region.IsPartOf("the Altar of Golden Rangers")
                    || m.Region.IsPartOf("the Ranger Outpost")
                )
                {
                    keyword = "Aurum";
                }
                else if (m.Region.IsPartOf("the Moon's Core"))
                {
                    keyword = "Ultimum Potentiae";
                }
                else if (m.Region.IsPartOf("the Black Magic Guild"))
                {
                    keyword = "Kas";
                }
                else if (m.Region.IsPartOf("the Tomb of Kas the Bloody Handed"))
                {
                    keyword = "Mortem Mangone";
                }
                else if (m.Region.IsPartOf("the Tomb of Malak the Syth Lord"))
                {
                    keyword = "Anakasu Arrii Venaal";
                }
                else if (m.Region.IsPartOf("the Tomb of Zoda the Jedi Master"))
                {
                    keyword = "Oh Beh Wahn";
                }
                else if (m.Region.IsPartOf("Dungeon Rock"))
                {
                    keyword = "Vas An Ort Ailem";
                }
                else if (m.Region.IsPartOf("the Lost Graveyard"))
                {
                    keyword = "Cryst An Immortalis";
                }
                ...
                else if (this.Name == "Priest Grave")
                {
                    if (this.X == 3082)
                    {
                        keyword = "caelesti lumine";
                    }
                    else if (this.X == 805)
                    {
                        keyword = "famem prohibere";
                    }
                    else if (this.X == 981)
                    {
                        keyword = "sacrum munus";
                    }
                    else if (this.X == 1756)
                    {
                    ...
                    {
                        keyword = "spiritus mundi";
                    }
                    else if (this.X == 926)
                    {
                        keyword = "accipe spiritum";
                    }
                    else if (this.X == 4167)
                    {
                        keyword = "reditus vitae";
                    }
                    else
                    {
                        keyword = "fascinare";
                ...
                else if (this.Name != "Magic Forge Trigger")
                {
                    keyword = this.Name;
                }
                ...
                if (
                    !isMatch
                    && m.Karma >= 0
                    && m.Skills[SkillName.Psychology].Base > 0
                    && Server.Misc.GetPlayerInfo.isJedi(m, false)
                    && this.Name == "Priest Grave"
                )
                {
                    if (this.X == 3082)
                    {
                ...
                if (this.Name == "Priest Grave") // PRIEST GRAVES
                {
                    ...
                    if (m.Karma >= 2500 && isPriest > 0 && priestCheck)
                    {
                        ...
                        if (this.X == 3082)
                        {
                            priest = "Drumat the Apostle";
                            symbol = "HolyManSymbol774";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol774)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Vincent the Priest";
                            symbol = "HolyManSymbol775";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol775)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Father Michal";
                            symbol = "HolyManSymbol778";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol778)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Xephyn the Monk";
                            symbol = "HolyManSymbol782";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol782)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Sister Tiana";
                            symbol = "HolyManSymbol779";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol779)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Chancellor Davis";
                            symbol = "HolyManSymbol783";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol783)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Abigayl the Preacher";
                            symbol = "HolyManSymbol776";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol776)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Edwin the Pope";
                            symbol = "HolyManSymbol781";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol781)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Deacon Wilems";
                            symbol = "HolyManSymbol773";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol773)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Patriarch Morden";
                            symbol = "HolyManSymbol770";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol770)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Brother Kurklan";
                            symbol = "HolyManSymbol780";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol780)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Archbishop Halyrn";
                            symbol = "HolyManSymbol771";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol771)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Cardinal Greggs";
                            symbol = "HolyManSymbol777";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol777)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        {
                            priest = "Bishop Leantre";
                            symbol = "HolyManSymbol772";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is HolyManSymbol772)
                                {
                                    targets.Add(item);
                                }
                            }
                ...
                else if (this.Name != "Magic Forge Trigger") // DEATH KNIGHT SHRINES
                {
                    if (m.Karma < 0 && m.Skills[SkillName.Knightship].Base > 0)
                    {
                        ...
                        {
                            skull = "DeathKnightSkull750";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull750)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Monduiz" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull751";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull751)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Kath" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull752";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull752)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Myrhal" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull753";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull753)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Maeril" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull754";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull754)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Farian" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull755";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull755)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Androma" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull756";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull756)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Oslan" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull757";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull757)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Rezinar" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull758";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull758)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Thyrian" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull759";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull759)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Minar" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull760";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull760)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Urkar" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull761";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull761)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Luren" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull762";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull762)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Khayven" && this.Name == keyword)
                        {
                            skull = "DeathKnightSkull763";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is DeathKnightSkull763)
                                {
                                    targets.Add(item);
                                }
                            }
                    ...
                    )
                    {
                        ...
                        if (this.Name == "Dzwol Hyal" && this.Name == keyword)
                        {
                            syth = "SythDatacron01";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is SythDatacron01)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Zayin Kun" && this.Name == keyword)
                        {
                            syth = "SythDatacron02";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is SythDatacron02)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Rhak Skuri" && this.Name == keyword)
                        {
                            syth = "SythDatacron03";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is SythDatacron03)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Chwit Sutta" && this.Name == keyword)
                        {
                            syth = "SythDatacron04";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is SythDatacron04)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Qyasik Tukata" && this.Name == keyword)
                        {
                            syth = "SythDatacron05";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is SythDatacron05)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Sutta Wo" && this.Name == keyword)
                        {
                            syth = "SythDatacron06";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is SythDatacron06)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Taral Wai" && this.Name == keyword)
                        {
                            syth = "SythDatacron07";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is SythDatacron07)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Wai Kusk" && this.Name == keyword)
                        {
                            syth = "SythDatacron08";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is SythDatacron08)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Derriphan Tyuk" && this.Name == keyword)
                        {
                            syth = "SythDatacron09";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is SythDatacron09)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        else if (this.Name == "Itsu Sutta" && this.Name == keyword)
                        {
                            syth = "SythDatacron10";
                            ArrayList targets = new ArrayList();
                            foreach (Item item in World.Items.Values)
                            {
                                if (item is SythDatacron10)
                                {
                                    targets.Add(item);
                                }
                            }
                        ...
                        if (syth != "")
                        {
                            ...
                            if (itemType != null)
                            {
                                ...
                                Effects.SendLocationParticles(
                                    EffectItem.Create(sythL, m.Map, EffectItem.DefaultDuration),
                                    0x3789,
                                    10,
                                    32,
                                    5032
                    ...
                    if (m.Skills[SkillName.Knightship].Base >= 60 && m.Karma <= -5000)
                    {
                        ...
                        if (m.RaceID == 0)
                        {
                            if (m.Hue == 0x47E)
                            {
                                ...
                                m.SendMessage(
                                    "Your body turns back to the colors of life, and your equipment is blackened."
                                );
                            }
                            else
                            {
                                ...
                                m.SendMessage(
                                    "Your body turned a deathly white, and your equipment is blackened."
                                );
                            }
                        }
                    }
                ...
                else if (m.Map == Map.SerpentIsland && m.Region.IsPartOf("the Serpent Sanctum"))
                {
                    ...
                    if (rock != null)
                    {
                        ...
                        LoggingFunctions.LogGenericQuest(
                            m,
                            "has acquired the power from the serpent of balance"
                        );
                ...
                else if (m.Map == Map.SerpentIsland && m.Region.IsPartOf("the Ethereal Void"))
                {
                    ...
                    if (rock1 != null && rock2 != null && rock3 != null)
                    {
                        Server.Items.QuestSouvenir.GiveReward(
                            ...
                            rock1.Name,
                            rock1.Hue,
                            Utility.RandomList(0x1A7F, 0x1A80)
                        );
                        Server.Items.QuestSouvenir.GiveReward(
                            m,
                            rock2.Name,
                                ...
                                if (p != null)
                                {
                                    foreach (PartyMemberInfo pmi in p.Members)
                                    {
                                        if (
                                            ...
                                            && pmi.Mobile.InRange(this.Location, 20)
                                        )
                                        {
                                            ...
                                            pmi.Mobile.SendMessage(
                                                "Two items have appeared in your backpack!"
                                            );
                                            pmi.Mobile.FixedParticles(
                                                0x376A,
                                                9,
                                                32,
                                                5030,
                        ...
                        LoggingFunctions.LogGenericQuest(
                            m,
                            "has maintained the balance between order and chaos"
                        );
                    }
                }
                else if (m.Region.IsPartOf("Dungeon Rock")) // EXODUS - FORGE OF VIRTUE
                {
                    if (m.Backpack.FindItemByType(typeof(DarkCoreExodus)) != null)
                    {
                        ...
                        else
                        {
                            ...
                            m.PlaySound(0x208);
                            m.SendMessage(
                                "You destroy the dark core of Exodus, unleashing the power."
                            );
                            ...
                            for (int x = -5; x <= 5; ++x)
                            {
                                for (int y = -5; y <= 5; ++y)
                                {
                                    ...
                                    if (dist <= 5)
                                        new Server.Misc.SummonQuests.GoodiesTimer(
                                            m.Map,
                                            707 + x,
                                            2210 + y
                                        ).Start();
                                ...
                                if (enchant.ItemID != 5703)
                                {
                                    ...
                                    )
                                    {
                                        ...
                                        if (Change == 1)
                                        {
                                            ...
                                            {
                                                checkItem.Substring(0, index),
                                                checkItem.Substring(index + 1)
                                            };
                                            ...
                                            if (itemType != null)
                                            {
                                                ...
                                                if (nameItem == null)
                                                {
                                                    nameItem = MorphingItem.AddSpacesToSentence(
                                                ...
                                                enchant.Name =
                                                    LootPackEntry.MagicItemAdj(
                                                        "start",
                                                        Server.Misc.GetPlayerInfo.OrientalPlay(m),
                                                        Server.Misc.GetPlayerInfo.EvilPlay(m),
                                                        enchant.ItemID
                                                    )
                                                    + " "
                                                    + enchant.Name;
                            ...
                            if (p != null)
                            {
                                foreach (PartyMemberInfo pmi in p.Members)
                                {
                                    ...
                                    )
                                    {
                                        LoggingFunctions.LogGenericQuest(
                                            pmi.Mobile,
                                            "has destroyed the dark core of Exodus"
                                        );
                                        ...
                                        pmi.Mobile.SendMessage(
                                            "An item has appeared in your backpack!"
                                        );
                                    }
                                }
                            }
                ...
                {
                    if (
                        m.Backpack.FindItemByType(typeof(ShardOfFalsehood)) != null
                        && m.Backpack.FindItemByType(typeof(ShardOfCowardice)) != null
                        && m.Backpack.FindItemByType(typeof(ShardOfHatred)) != null
                    )
                    {
                        ...
                        foreach (Item item in World.Items.Values)
                            if (
                                item is ShardOfHatred
                                || item is ShardOfFalsehood
                                || item is ShardOfCowardice
                            )
                            {
                                targets.Add(item);
                            }
                ...
                else if (m.Region.IsPartOf("the Tomb of Kas the Bloody Handed")) // DEATH KNIGHT TOMB
                {
                    ...
                    if (m.Karma < 0 && m.Skills[SkillName.Knightship].Base > 0)
                    {
                        ...
                        Server.Misc.BookProperties.GetBookProperties(book, 6, 45);
                        m.AddToBackpack(book);
                ...
                else if (m.Region.IsPartOf("the Tomb of Malak the Syth Lord")) // SYTH TOMB
                {
                    ...
                    if (m.Karma < 0 && m.Skills[SkillName.Psychology].Base > 0)
                    {
                        ...
                        LoggingFunctions.LogGenericQuest(
                            m,
                            "has obtained Malak's Datacron of Syth Knowledge"
                        );
                ...
                else if (m.Region.IsPartOf("the Tomb of Zoda the Jedi Master")) // JEDI TOMB
                {
                    ...
                    if (m.Karma >= 2500 && m.Skills[SkillName.Psychology].Base >= 25)
                    {
                        ...
                        LoggingFunctions.LogGenericQuest(
                            m,
                            "has obtained Zoda's Datacron of Jedi Wisdom"
                        );
                ...
                {
                    if (
                        m.Skills[SkillName.Camping].Base >= 90
                        || m.Skills[SkillName.Tracking].Base >= 90
                    )
                    {
                        if (m.Backpack.FindItemByType(typeof(GoldenFeathers)) != null)
                        {
                            ...
                            {
                                m.SendMessage(
                                    "You need your own golden feathers to receive the ranger blessing."
                                );
                            }
                        }
                        else
                        {
                            m.SendMessage(
                                "You need golden feathers to receive the ranger blessing."
                            );
                        }
                    }
                    else
                ...
                {
                    if (
                        m.Skills[SkillName.Elementalism].Base >= 80
                        || m.Skills[SkillName.Magery].Base >= 80
                        || m.Skills[SkillName.Necromancy].Base >= 80
                    )
                    {
                        if (
                            m.Backpack.FindItemByType(typeof(StaffPartVenom)) != null
                        ...
                        )
                        {
                            ...
                            LoggingFunctions.LogGenericQuest(
                                m,
                                "has assembled the staff of ultimate power"
                            );
                            ...
                            if (
                                m.Skills[SkillName.Elementalism].Base
                                > m.Skills[SkillName.Magery].Base
                            )
                            {
                                magic = 2;
                        ...
                        )
                        {
                            if (enchant is BaseWeapon)
                            {
                                ...
                                if (
                                    ...
                                    && Server.Misc.MaterialInfo.IsAnyKindOfMetalItem(enchant)
                                )
                                {
                                    Effects.SendLocationParticles(
                                        EffectItem.Create(
                                    ...
                                    {
                                        weapon.HitPoints = weapon.HitPoints - 1;
                                    }
                                    if (weapon.MaxHitPoints > 0)
                                    {
                                        weapon.MaxHitPoints = weapon.MaxHitPoints - 1;
                                    }
                                    ...
                                    {
                                        weapon.WeaponAttributes.HitPoisonArea =
                                            Utility.RandomMinMax(1, 100);
                                    }
                                    enchant.Hue = Utility.RandomList(0xB51);
                                }
                            }
                            else if (enchant is BaseArmor)
                            {
                                ...
                                )
                                {
                                    ...
                                    {
                                        armor.HitPoints = armor.HitPoints - 1;
                                    }
                                    if (armor.MaxHitPoints > 0)
                                    {
                                        armor.MaxHitPoints = armor.MaxHitPoints - 1;
                                    }
                        ...
                        )
                        {
                            if (enchant is BaseWeapon)
                            {
                                ...
                                )
                                {
                                    ...
                                    if (Utility.RandomMinMax(1, 20) == 1)
                                    {
                                        weapon.WeaponAttributes.HitColdArea = Utility.RandomMinMax(
                                            1,
                                            100
                                        );
                                    }
                                    enchant.Hue = Utility.RandomList(0xB57);
                                }
                            }
                            else if (enchant is BaseArmor)
                            {
                        ...
                        )
                        {
                            if (enchant is BaseWeapon)
                            {
                                ...
                                )
                                {
                                    ...
                                    if (Utility.RandomMinMax(1, 20) == 1)
                                    {
                                        weapon.WeaponAttributes.HitEnergyArea =
                                            Utility.RandomMinMax(1, 100);
                                    }
                                    enchant.Hue = Utility.RandomList(0xAFE);
                                }
                            }
                            else if (enchant is BaseArmor)
                            {
                        ...
                        )
                        {
                            if (enchant is BaseWeapon)
                            {
                                ...
                                )
                                {
                                    ...
                                    if (Utility.RandomMinMax(1, 20) == 1)
                                    {
                                        weapon.WeaponAttributes.HitFireArea = Utility.RandomMinMax(
                                            1,
                                            100
                                        );
                                    }
                                    enchant.Hue = Utility.RandomList(0xB54);
                                }
                            }
                            else if (enchant is BaseArmor)
                            {
        ...
        public MagicForges(Serial serial)
            : base(serial) { }
