...
namespace Server.Items
{
    ...
    public class ControlPanel : AddonComponent
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (m_User != null)
            {
                ...
                if (
                    m_User.Deleted
                    || m_User.Map != Map
                    || !m_User.InRange(this, 3)
                    || m_User.NetState == null
                    || DateTime.Now - m_LastUse >= m_UseTimeout
                )
                {
                    m_User.CloseGump(typeof(GameGump));
                }
                ...
                : base(5, 30)
            {
                ...
                if (from.Skills.Lockpicking.Value >= 65.0)
                {
                    ...
                    AddHtml(
                        ...
                        140,
                        40,
                        "Attempt to Decipher the Circuit Path",
                        false,
                        false
                    );
                }
        ...
        public void DoDamage(Mobile to)
        {
            ...
            to.NonlocalOverheadMessage(
                MessageType.Regular,
                0xC9,
                true,
                string.Format("* {0} spasms from electric shock *", to.Name)
            );
        ...
        private class DamageTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                m_To.NonlocalOverheadMessage(
                    ...
                    0xC9,
                    true,
                    string.Format("* {0} spasms from electric shock *", m_To.Name)
                );
