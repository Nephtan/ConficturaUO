...
namespace Server.Items
{
    public class AllDyeTubsMountEthereal : DyeTub
    {
        ...
        public AllDyeTubsMountEthereal(Serial serial)
            : base(serial) { }
        ...
        public class AllDyeTubsMountEtherealTarget : Target
        {
            ...
            public AllDyeTubsMountEtherealTarget(AllDyeTubsMountEthereal dyetub)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                if (targeted is Item)
                {
                    ...
                    if (
                        (item is EtherealMount)
                        && (from.Backpack != null && from.Backpack.ConsumeTotal(typeof(Gold), 100))
                    )
                    {
