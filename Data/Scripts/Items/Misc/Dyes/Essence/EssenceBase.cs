...
namespace Server.Items
{
    public class EssenceBase : BaseAddon
    {
        ...
        public EssenceBase(string orb)
        {
            ...
            if (orb == "ork")
            {
                iColor = ItemColor = 0x1CB;
                ItemHairColor = 0x455;
                sThing = ItemName = "Essence of the Ork";
                ItemType = "ork";
            }
            else if (orb == "tritun")
            {
                iColor = ItemColor = 0x555;
                ItemHairColor = 0x554;
                sThing = ItemName = "Essence of the Tritun";
                ItemType = "tritun";
            }
            else if (orb == "vampire")
            {
                iColor = ItemColor = 0x47E;
                ItemHairColor = 0x497;
                sThing = ItemName = "Essence of the Vampire";
                ItemType = "vampire";
            }
            else if (orb == "ghost")
            {
                iColor = ItemColor = 0x47E;
                ItemHairColor = 0x47E;
                sThing = ItemName = "Essence of the Ghost";
                ItemType = "ghost";
            }
            else if (orb == "demon")
            {
                iColor = ItemColor = 0x5B5;
                ItemHairColor = 0x497;
                sThing = ItemName = "Essence of the Demon";
                ItemType = "demon";
            }
            else if (orb == "ice")
            {
                iColor = ItemColor = 0xB78;
                ItemHairColor = 0x8D3;
                sThing = ItemName = "Essence of the Snow";
                ItemType = "ice";
            }
            else if (orb == "fire")
            {
                iColor = ItemColor = 0xB17;
                ItemHairColor = 0xB71;
                sThing = ItemName = "Essence of the Flame";
                ItemType = "fire";
            }
            else if (orb == "shadow")
            {
                iColor = ItemColor = 0x497;
                ItemHairColor = 0x497;
                sThing = ItemName = "Essence of the Shadows";
                ItemType = "shadow";
            }
            else if (orb == "dark")
            {
                iColor = ItemColor = 1;
                ItemHairColor = 1;
                sThing = ItemName = "Essence of the Dark";
                ItemType = "dark";
            }
            else if (orb == "lizard")
            {
                iColor = ItemColor = 0xACF;
                ItemHairColor = 0xACC;
                sThing = ItemName = "Essence of the Lizard";
                ItemType = "lizard";
            }
            else if (orb == "darkness")
            {
                iColor = ItemColor = 1;
                ItemHairColor = 1;
                sThing = ItemName = "Essence of Darkness";
                ItemType = "darkness";
            }
            else if (orb == "radiated")
            {
                iPed = 0x22BD;
                iColor = ItemColor = 0xB79;
                ItemHairColor = 0xB51;
                sThing = ItemName = "Essence of the Radiated";
                ItemType = "radiated";
            }
        ...
        public EssenceBase(Serial serial)
            : base(serial) { }
            ...
            if (m is PlayerMobile && m.RaceID == 0)
            {
                if (DateTime.Now >= m_NextTalk && Utility.InRange(m.Location, this.Location, 2))
                {
                    m.PrivateOverheadMessage(
                        ...
                        1150,
                        false,
                        "I could use that item on the pedestal to take it.",
                        m.NetState
                    );
        ...
        public override void OnComponentUsed(AddonComponent ac, Mobile from)
        {
            ...
            else
            {
                ...
                foreach (Item item in World.Items.Values)
                    ...
                    {
                        if (
                            ((EssenceOrb)item).m_Owner == from
                            && ((EssenceOrb)item).m_Type == ItemType
                        )
                            targets.Add(item);
                    }
                ...
                if (!(from.Region is SavageRegion))
                {
                    ...
                    if (ItemColor == 0xB79 && ItemHairColor == 0xB51)
                    {
                        Pedul.ItemID = 0x22BD;
                    }
