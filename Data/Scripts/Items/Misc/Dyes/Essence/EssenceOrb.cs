...
namespace Server.Items
{
    public class EssenceOrb : Item
    {
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int mMorphHue
        {
            get { return m_MorphHue; }
            set
            {
                m_MorphHue = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int mMorphHairHue
        {
            get { return m_MorphHairHue; }
            set
            {
                m_MorphHairHue = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string mMorphName
        {
            get { return m_MorphName; }
            set
            {
                m_MorphName = value;
                InvalidateProperties();
        ...
        public EssenceOrb(Serial serial)
            : base(serial) { }
