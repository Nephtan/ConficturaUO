...
namespace Server.Items
{
    public class UnusualDyes : Item
    {
            ...
            : base(0x282F)
        {
            ...
            {
                case 0:
                    Name = "an odd jar of dye";
                    break;
                case 1:
                    Name = "an unusual jar of dye";
                    break;
                case 2:
                    Name = "a bizarre jar of dye";
                    break;
                case 3:
                    Name = "a curious jar of dye";
                    break;
                case 4:
                    Name = "a peculiar jar of dye";
                    break;
                case 5:
                    Name = "a strange jar of dye";
                    break;
                case 6:
                    Name = "a weird jar of dye";
                    break;
            }
        ...
        private class DyeTarget : Target
        {
            ...
            public DyeTarget(UnusualDyes tube)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (m_Dye == null || m_Dye.Deleted || pack == null || !m_Dye.IsChildOf(pack))
                {
                    from.SendLocalizedMessage(1060640); // The item must be in your backpack to use it.
                    return;
                }
        ...
        public UnusualDyes(Serial serial)
            : base(serial) { }
