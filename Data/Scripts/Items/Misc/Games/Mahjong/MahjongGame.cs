...
namespace Server.Engines.Mahjong
{
    public class MahjongGame : Item, ISecurable
    {
        ...
        {
            get { return m_DealerIndicator; }
        }
        public MahjongWallBreakIndicator WallBreakIndicator
        {
            get { return m_WallBreakIndicator; }
        }
            ...
            : base(0xFAA)
        {
            ...
            BuildWalls();
            m_DealerIndicator = new MahjongDealerIndicator(
                this,
                new Point2D(300, 300),
                MahjongPieceDirection.Up,
                MahjongWind.North
            );
        ...
        private void BuildHorizontalWall(
            ...
            int y,
            int stackLevel,
            MahjongPieceDirection direction,
        ...
        )
        {
            for (int i = 0; i < 17; i++)
            {
                ...
                m_Tiles[index + i] = new MahjongTile(
                    this,
                    index + i,
                    typeGenerator.Next(),
                    position,
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            if (
                from.Alive
                && IsAccessibleTo(from)
                && m_Players.GetInGameMobiles(true, false).Count == 0
            )
