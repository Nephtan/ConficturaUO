...
namespace Server.Items
{
    ...
    public class FlipableAddonAttribute : Attribute
    {
        ...
        private static Type[] m_Params = new Type[] { typeof(Mobile), typeof(Direction) };
                ...
                try
                {
                    ...
                    if (flipMethod != null)
                    {
                        ...
                        if (addon is BaseAddon)
                            result = ((BaseAddon)addon).CouldFit(
                                addon.Location,
                                from.Map,
                                from,
                                ref house
                            ...
                            result = ((BaseAddonContainer)addon).CouldFit(
                                addon.Location,
                                from.Map,
                                from,
                                ref house
                        ...
                        if (result != AddonFitResult.Valid)
                        {
                            ...
                            if (result == AddonFitResult.Blocked)
                                ...
                                from.SendMessage(
                                    "You must close all house doors before placing this."
                                );
