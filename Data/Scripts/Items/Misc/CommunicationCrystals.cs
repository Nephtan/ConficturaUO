...
namespace Server.Items
{
    ...
    public class BroadcastCrystal : Item
    {
        ...
        public override bool HandlesOnSpeech
        {
            get
            {
                return Active
                    && Receivers.Count > 0
                    && (RootParent == null || RootParent is Mobile);
            }
        }
        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                {
                    foreach (
                        ReceiverCrystal receiver in new List<ReceiverCrystal>(m_Crystal.Receivers)
                    )
                    {
    ...
    public class ReceiverCrystal : Item
    {
        ...
        public void TransmitMessage(Mobile from, string message)
        {
            ...
            {
                ((Item)this.RootParent).PublicOverheadMessage(
                    MessageType.Regular,
                    0x2B2,
                    false,
                    "Crystal: " + text
