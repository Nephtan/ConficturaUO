...
namespace Server.Items
{
    ...
    public class EffectController : Item
    {
        ...
        {
            get { return m_PlaySoundAtTrigger; }
        ...
        {
            get { return m_ExplodeParticleEffect; }
        ...
        {
            get { return (m_TriggerType == EffectTriggerType.InRange); }
        }
        ...
        public void PlaySound(object trigger)
        {
            ...
            Effects.PlaySound(
                (ent is Item) ? ((Item)ent).GetWorldLocation() : ent.Location,
                ent.Map,
                m_SoundID
            );
        }
        ...
        public void DoEffect(object trigger)
        {
            ...
            if (
                ...
                && ((Mobile)trigger).AccessLevel > AccessLevel.Player
            )
                return;
