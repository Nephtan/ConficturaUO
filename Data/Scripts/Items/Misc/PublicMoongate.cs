...
namespace Server.Items
{
    public class PublicMoongate : Item
    {
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            ...
            {
                if (
                    !Utility.InRange(m.Location, this.Location, 1)
                    && Utility.InRange(oldLocation, this.Location, 1)
                )
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(MoonGen_OnCommand)
            );
        }
        ...
        public static void MoonGen_OnCommand(CommandEventArgs e)
        {
            ...
            count += MoonGen(PMList.Sosaria);
            count += MoonGen(PMList.Lodor);
            count += MoonGen(PMList.Underworld);
            count += MoonGen(PMList.SerpentIsland);
            count += MoonGen(PMList.IslesDread);
    ...
    public class PMList
    {
        ...
        public static readonly PMList Sosaria = new PMList(
            1012000,
            1012012,
            Map.Sosaria,
            new PMEntry[]
            {
                new PMEntry(new Point3D(4467, 1283, 5), 1012003), // Elidor
                new PMEntry(new Point3D(1336, 1997, 5), 1012004), // Britain
                new PMEntry(new Point3D(1499, 3771, 5), 1012005), // DevilGuard
                new PMEntry(new Point3D(771, 752, 5), 1012006), // Yew
                new PMEntry(new Point3D(2701, 692, 5), 1012007), // Montor
                new PMEntry(new Point3D(1828, 2948, -20), 1012008), // Moon
                new PMEntry(new Point3D(643, 2067, 5), 1012009), // Skara Brae
                new PMEntry(new Point3D(3563, 2139, 34), 1012010), // Renika
                new PMEntry(new Point3D(3450, 2677, 25), 1078098) // New Haven
            }
        );

        public static readonly PMList Lodor = new PMList(
            1012001,
            1012013,
            Map.Lodor,
            new PMEntry[]
        ...
        public static readonly PMList Underworld = new PMList(
            1012002,
            1012014,
            Map.Underworld,
            new PMEntry[]
        ...
        public static readonly PMList SerpentIsland = new PMList(
            1060643,
            1062039,
            Map.SerpentIsland,
            new PMEntry[]
        ...
        public static readonly PMList IslesDread = new PMList(
            1063258,
            1063415,
            Map.IslesDread,
            new PMEntry[]
        ...
        public static readonly PMList[] UORLists = new PMList[] { Sosaria, Lodor };
        public static readonly PMList[] UORListsYoung = new PMList[] { Sosaria };
        public static readonly PMList[] LBRLists = new PMList[] { Sosaria, Lodor, Underworld };
        public static readonly PMList[] LBRListsYoung = new PMList[] { Sosaria, Underworld };
        public static readonly PMList[] AOSLists = new PMList[]
        {
            Sosaria,
            Lodor,
            Underworld,
        ...
        public static readonly PMList[] AOSListsYoung = new PMList[]
        {
            Sosaria,
            Underworld,
            SerpentIsland
        };
        public static readonly PMList[] SELists = new PMList[]
        {
            Sosaria,
            Lodor,
            Underworld,
        ...
        public static readonly PMList[] SEListsYoung = new PMList[]
        {
            Sosaria,
            Underworld,
            SerpentIsland,
        ...
        public static readonly PMList[] RedLists = new PMList[] { Lodor };
        public static readonly PMList[] SigilLists = new PMList[] { Lodor };
    }
    ...
    public class MoongateGump : Gump
    {
            ...
            : base(100, 100)
        {
            ...
            if (mobile.Player)
            {
                ...
                {
                    ClientFlags flags =
                        mobile.NetState == null ? ClientFlags.None : mobile.NetState.Flags;
                    bool young = mobile is PlayerMobile ? ((PlayerMobile)mobile).Young : false;

                    if (Core.SE && (flags & ClientFlags.IslesDread) != 0)
                        checkLists = young ? PMList.SEListsYoung : PMList.SELists;
                    else if (Core.AOS && (flags & ClientFlags.SerpentIsland) != 0)
                        checkLists = young ? PMList.AOSListsYoung : PMList.AOSLists;
                    else if ((flags & ClientFlags.Underworld) != 0)
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            if (
                !m_Mobile.InRange(m_Moongate.GetWorldLocation(), 1)
                || m_Mobile.Map != m_Moongate.Map
            )
            {
                m_Mobile.SendLocalizedMessage(1019002); // You are too far away to use the gate.
            }
            else if (m_Mobile.Player && m_Mobile.Kills >= 5 && list.Map != Map.Lodor)
            {
