    ...
    public class DDRelicWeapon : Item
    {
            ...
            : base(0x48B0)
        {
            ...
            switch (Utility.RandomMinMax(0, 9))
            {
                ...
                case 2:
                    ...
                    RelicFlipID1 = 0x48BA;
                    RelicFlipID2 = 0x48BB;
                    Name = sLook + sDecon + " sword";
                    break;
                case 3:
                    ItemID = 0x48BC;
                    RelicFlipID1 = 0x48BC;
                    RelicFlipID2 = 0x48BD;
                    Name = sLook + sDecon + " dagger";
                    break;
                case 4:
                    ItemID = 0x48BE;
                    RelicFlipID1 = 0x48BE;
                    RelicFlipID2 = 0x48BF;
                    Name = sLook + sDecon + " trident";
                    break;
                case 5:
                    ItemID = 0x48C0;
                    RelicFlipID1 = 0x48C0;
                    RelicFlipID2 = 0x48C1;
                    Name = sLook + sDecon + " war hammer";
                    break;
                case 6:
                    ItemID = 0x48C6;
                    RelicFlipID1 = 0x48C6;
                    RelicFlipID2 = 0x48C7;
                    Name = sLook + sDecon + " scythe";
                    break;
                case 7:
                    ItemID = 0x48C8;
                    RelicFlipID1 = 0x48C8;
                    RelicFlipID2 = 0x48C9;
                    Name = sLook + sDecon + " pike";
                    break;
                case 8:
                    ItemID = 0x48CA;
                    RelicFlipID1 = 0x48CA;
                    RelicFlipID2 = 0x48CB;
                    Name = sLook + sDecon + " lance";
                    break;
                case 9:
                    ItemID = 0x48D0;
                    RelicFlipID1 = 0x48D0;
                    RelicFlipID2 = 0x48D1;
                    Name = sLook + sDecon + " swords";
                    break;
            }
        }
        ...
        public static void MakeOriental(Item item)
        {
            ...
            switch (Utility.RandomMinMax(0, 9))
            {
                case 0:
                    relic.ItemID = 0x2851;
                    relic.RelicFlipID1 = 0x2851;
                    relic.RelicFlipID2 = 0x2852;
                    break;
                case 1:
                    relic.ItemID = 0x2853;
                    relic.RelicFlipID1 = 0x2853;
                    relic.RelicFlipID2 = 0x2854;
                    break;
                case 2:
                    relic.ItemID = 0x2855;
                    relic.RelicFlipID1 = 0x2855;
                    relic.RelicFlipID2 = 0x2856;
                    break;
                case 3:
                    relic.ItemID = 0x291C;
                    relic.RelicFlipID1 = 0x291C;
                    relic.RelicFlipID2 = 0x291D;
                    break;
                case 4:
                    relic.ItemID = 0x291E;
                    relic.RelicFlipID1 = 0x291E;
                    relic.RelicFlipID2 = 0x291F;
                    break;
                case 5:
                    relic.ItemID = 0x2A2A;
                    relic.RelicFlipID1 = 0x2A2A;
                    relic.RelicFlipID2 = 0x2A2A;
                    break;
                case 6:
                    relic.ItemID = 0x2A45;
                    relic.RelicFlipID1 = 0x2A45;
                    relic.RelicFlipID2 = 0x2A46;
                    break;
                case 7:
                    relic.ItemID = 0x2A47;
                    relic.RelicFlipID1 = 0x2A47;
                    relic.RelicFlipID2 = 0x2A48;
                    break;
                case 8:
                    relic.ItemID = 0x2A49;
                    relic.RelicFlipID1 = 0x2A49;
                    relic.RelicFlipID2 = 0x2A4A;
                    break;
                case 9:
                    relic.ItemID = 0x2A4B;
                    relic.RelicFlipID1 = 0x2A4B;
                    relic.RelicFlipID2 = 0x2A4C;
                    break;
            }
        }

        public DDRelicWeapon(Serial serial)
            : base(serial) { }
