...
namespace Server.Items
{
    public class DDRelicGem : Item
    {
            ...
            switch (Utility.RandomMinMax(1, 8))
            {
                case 1:
                    RelicCameFrom =
                        sGift
                        + " the "
                        + Server.Misc.RandomThings.GetRandomKingdomName()
                        + " "
                        + Server.Misc.RandomThings.GetRandomKingdom();
                    break;
                case 2:
                    RelicCameFrom =
                        sGift
                ...
                case 3:
                    RelicCameFrom =
                        sGift2
                        + " the "
                        + Server.Misc.RandomThings.GetRandomNoble()
                        + " of "
                        + Server.Misc.RandomThings.GetRandomKingdomName();
                    break;
                case 4:
                    ...
                    break;
                case 5:
                    RelicCameFrom = sGift2 + " " + Server.Misc.RandomThings.GetRandomSociety();
                    break;
                case 6:
                    RelicCameFrom =
                        sGift2
                        + " the Ship called "
                        + Server.Misc.RandomThings.GetRandomShipName("", 0);
                    break;
                case 7:
                    RelicCameFrom =
                        sGift2 + " " + Server.Misc.RandomThings.GetRandomScenePainting();
                    break;
                case 8:
                    RelicCameFrom =
                        sEye + " of the " + Server.Misc.RandomThings.GetRandomCreature();
                    break;
            }
        }
        ...
        public DDRelicGem(Serial serial)
            : base(serial) { }
