...
namespace Server.Items
{
    public class DDRelicCoins : Item
    {
            ...
            : base(0xE1A)
        {
            ...
            {
                case 0:
                    sAge = "from a long dead civilization";
                    break;
                case 1:
                    sAge = "from an ancient race";
                    break;
                case 2:
                    sAge = "of a secret order";
                    break;
                case 3:
                    sAge = "of a far off land";
                    break;
                case 4:
                    sAge = "of unknown origin";
                    break;
                case 5:
                    sAge = "from long ago";
                    break;
                case 6:
                    sAge = "from a lost city";
                    break;
                case 7:
                    sAge = "from a mysterious land";
                    break;
                case 8:
                    sAge = "from the dark times";
                    break;
                case 9:
                    sAge = "of an old race";
                    break;
                case 10:
                    ...
                    break;
                case 11:
                    sAge = "from a missing land";
                    break;
                case 12:
                    sAge = "from an unknown era";
                    break;
                case 13:
                    sAge = "used centuries ago";
                    break;
            }
        ...
        public DDRelicCoins(Serial serial)
            : base(serial) { }
