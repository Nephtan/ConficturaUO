...
namespace Server.Items
{
    public class DDRelicLeather : Item
    {
            ...
            : base(0x106B)
        {
            ...
            if ((ItemID == 0x1079) || (ItemID == 0x1078))
            {
                Name = sLook + " bundle of " + sType + " leather";
            }
            else
            {
                Name = sLook + " stretched hide of " + sType + " leather";
            }
        }
        ...
        public DDRelicLeather(Serial serial)
            : base(serial) { }
