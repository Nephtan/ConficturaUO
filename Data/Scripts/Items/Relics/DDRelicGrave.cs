...
namespace Server.Items
{
    public class DDRelicGrave : Item
    {
            ...
            : base(0xED4)
        {
            ...
            switch (Utility.RandomMinMax(0, 30))
            {
                ...
                case 20:
                    ...
                    RelicFlipID2 = 0x124B;
                    Name = "an iron maiden";
                    RelicDescription = "That Once Held " + ContainerFunctions.GetOwner("property");
                    break;
                ...
                case 22:
                    ...
                    RelicFlipID2 = 0x1D9E;
                    Name = "a bloody spike";
                    RelicDescription = "That Killed " + ContainerFunctions.GetOwner("property");
                    break;
            ...
            if (Name == "gravestone")
            {
                ...
                switch (Utility.RandomMinMax(0, 4))
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        sCarving = "Rest in Peace";
                        break;
                    case 2:
                        sCarving = "We Will Remember";
                        break;
                    case 3:
                        sCarving = "Here Rests";
                        break;
                    case 4:
                        sCarving = "Buried Here is";
                        break;
                }
                ...
                switch (Utility.RandomMinMax(0, 50))
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        sMade = "a granite " + sGrave;
                        Hue = 0xB8E;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 3:
                        sMade = "a marble " + sGrave;
                        Hue = 0xB8B;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 4:
                        sMade = "a copper " + sGrave;
                        Hue = 0x972;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 5:
                        sMade = "a silver " + sGrave;
                        Hue = 0x835;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 7:
                        sMade = "an amethyst " + sGrave;
                        Hue = 0x492;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 8:
                        sMade = "an emerald " + sGrave;
                        Hue = 0x5B4;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 10:
                        sMade = "a garnet " + sGrave;
                        Hue = 0x48F;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 11:
                        sMade = "an onyx " + sGrave;
                        Hue = 0x497;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 12:
                        sMade = "a quartz " + sGrave;
                        Hue = 0x4AC;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 13:
                        ...
                        break;
                    case 14:
                        sMade = "a sapphire " + sGrave;
                        Hue = 0x5B6;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 15:
                        sMade = "a spinel " + sGrave;
                        Hue = 0x48B;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 16:
                        sMade = "a star ruby " + sGrave;
                        Hue = 0x48E;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 17:
                        sMade = "a topaz " + sGrave;
                        Hue = 0x488;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 18:
                        sMade = "an ivory " + sGrave;
                        Hue = 0x47E;
                        RelicGoldValue = RelicGoldValue * 2;
                        break;
                    case 19:
                        sMade = "a solid gold " + sGrave;
                        Hue = 0x4AC;
                        RelicGoldValue = RelicGoldValue * 4;
                        Weight = Weight * 2;
                        break;
                }
                Name = sMade;
        ...
        public DDRelicGrave(Serial serial)
            : base(serial) { }
