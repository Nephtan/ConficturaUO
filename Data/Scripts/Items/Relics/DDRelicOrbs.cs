        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            switch (Utility.RandomMinMax(0, 51))
            {
                ...
                case 27:
                    ...
                    break;
                case 28:
                    sThing = "a pile of treasure";
                    break;
                case 29:
                    sThing = "a dead body";
                    break;
                case 30:
                    sThing = "an eye looking back at you";
                    break;
                case 31:
                    sThing = "a cross";
                    break;
            ...
            from.PrivateOverheadMessage(
                ...
                0x14C,
                false,
                "Within in the ball you can see " + sThing + ".",
                from.NetState
            );
        }

        public DDRelicOrbs(Serial serial)
            : base(serial) { }
