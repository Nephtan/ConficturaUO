...
namespace Server.Items
{
    public class DDRelicTablet : Item
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Search_Real
        {
            get { return SearchReal; }
            set
            {
                SearchReal = value;
                InvalidateProperties();
        ...
        {
            public TabletGump(Mobile from, Item tablet)
                : base(100, 100)
            {
                ...
                AddHtml(
                    ...
                    133,
                    88,
                    @"<BODY><BASEFONT Color=#111111><BIG><CENTER>Somewhere in "
                        + stone.SearchDungeon
                        + " Lies an Artifact</CENTER></BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    181,
                    18,
                    @"<BODY><BASEFONT Color=#111111><BIG><CENTER>"
                        + stone.SearchItem
                        + "</CENTER></BIG></BASEFONT></CENTER></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
        ...
        public DDRelicTablet(Serial serial)
            : base(serial) { }
