...
namespace Server.Items
{
    public class DDRelicRugAddon : BaseAddon
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Relic_MainID
        {
            get { return RelicMainID; }
            set
            {
                RelicMainID = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Relic_RugID
        {
            get { return RelicRugID; }
            set
            {
                RelicRugID = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Relic_Found
        {
            get { return RelicFound; }
            set
            {
                RelicFound = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Relic_Quality
        {
            get { return RelicQuality; }
            set
            {
                RelicQuality = value;
                InvalidateProperties();
        ...
        public override BaseAddonDeed Deed
        {
            get
            {
                return new DDRelicRugAddonDeed(
                    Relic_Value,
                    Relic_MainID,
                    Relic_RugID,
                    Relic_Color,
        ...
        public DDRelicRugAddon(Serial serial)
            : base(serial) { }
    ...
    public class DDRelicRugAddonDeed : BaseAddonDeed
    {
        ...
        )
        {
            ...
            {
                sLook = Relic_Quality;
                RelicQuality = Relic_Quality;
            }
            else if (RelQuality != "blank")
            {
                sLook = RelQuality;
                RelicQuality = RelQuality;
            }
            else
            {
                ...
                {
                    case 0:
                        sLook = sLook + ", decorative";
                        break;
                    case 1:
                        sLook = sLook + ", ceremonial";
                        break;
                    case 2:
                        sLook = sLook + ", ornamental";
                        break;
                }
                RelicQuality = sLook;
            }
            ...
            {
                ItemID = Utility.RandomList(0x3F08, 0x3F09, 0x3F0A, 0x3F0D, 0x3F17, 0x3F18, 0x3F11);
                RelicMainID = ItemID;
            }
            ...
            {
                RelicRugID = Utility.RandomMinMax(1, 13);
            }
        ...
        public DDRelicRugAddonDeed(Serial serial)
            : base(serial) { }
