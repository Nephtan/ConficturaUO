...
namespace Server.Multis
{
    public class MagicCarpetG : BaseBoat
    {
        ...
        {
            get { return new MagicDockedCarpetG(this); }
        }

        [Constructable]
        public MagicCarpetG() { }

        public MagicCarpetG(Serial serial)
            : base(serial) { }
    ...
    public class MagicCarpetGDeed : BaseBoatDeed
    {
        ...
        {
            get { return new MagicCarpetG(); }
        }

        [Constructable]
        public MagicCarpetGDeed()
            : base(0xC7, Point3D.Zero)
        {
            Name = "magic carpet";
        }

        public MagicCarpetGDeed(Serial serial)
            : base(serial) { }
    ...
    public class MagicDockedCarpetG : BaseDockedBoat
    {
        ...
        public MagicDockedCarpetG(BaseBoat boat)
            : base(0xC7, Point3D.Zero, boat) { }

        public MagicDockedCarpetG(Serial serial)
            : base(serial) { }
