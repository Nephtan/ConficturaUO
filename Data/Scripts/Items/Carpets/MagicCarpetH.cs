...
namespace Server.Multis
{
    public class MagicCarpetH : BaseBoat
    {
        ...
        {
            get { return new MagicDockedCarpetH(this); }
        }

        [Constructable]
        public MagicCarpetH() { }

        public MagicCarpetH(Serial serial)
            : base(serial) { }
    ...
    public class MagicCarpetHDeed : BaseBoatDeed
    {
        ...
        {
            get { return new MagicCarpetH(); }
        }

        [Constructable]
        public MagicCarpetHDeed()
            : base(0xC9, Point3D.Zero)
        {
            Name = "magic carpet";
        }

        public MagicCarpetHDeed(Serial serial)
            : base(serial) { }
    ...
    public class MagicDockedCarpetH : BaseDockedBoat
    {
        ...
        public MagicDockedCarpetH(BaseBoat boat)
            : base(0xC9, Point3D.Zero, boat) { }

        public MagicDockedCarpetH(Serial serial)
            : base(serial) { }
