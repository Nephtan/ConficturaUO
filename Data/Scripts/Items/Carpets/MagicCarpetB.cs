...
namespace Server.Multis
{
    public class MagicCarpetB : BaseBoat
    {
        ...
        {
            get { return new MagicDockedCarpetB(this); }
        }

        [Constructable]
        public MagicCarpetB() { }

        public MagicCarpetB(Serial serial)
            : base(serial) { }
    ...
    public class MagicCarpetBDeed : BaseBoatDeed
    {
        ...
        {
            get { return new MagicCarpetB(); }
        }

        [Constructable]
        public MagicCarpetBDeed()
            : base(0xBD, Point3D.Zero)
        {
            Name = "magic carpet";
        }

        public MagicCarpetBDeed(Serial serial)
            : base(serial) { }
    ...
    public class MagicDockedCarpetB : BaseDockedBoat
    {
        ...
        public MagicDockedCarpetB(BaseBoat boat)
            : base(0xBD, Point3D.Zero, boat) { }

        public MagicDockedCarpetB(Serial serial)
            : base(serial) { }
