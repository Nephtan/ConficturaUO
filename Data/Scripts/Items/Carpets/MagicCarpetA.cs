...
namespace Server.Multis
{
    public class MagicCarpetA : BaseBoat
    {
        ...
        {
            get { return new MagicDockedCarpetA(this); }
        }

        [Constructable]
        public MagicCarpetA() { }

        public MagicCarpetA(Serial serial)
            : base(serial) { }
    ...
    public class MagicCarpetADeed : BaseBoatDeed
    {
        ...
        {
            get { return new MagicCarpetA(); }
        }

        [Constructable]
        public MagicCarpetADeed()
            : base(0xBB, Point3D.Zero)
        {
            Name = "magic carpet";
        }

        public MagicCarpetADeed(Serial serial)
            : base(serial) { }
    ...
    public class MagicDockedCarpetA : BaseDockedBoat
    {
        ...
        public MagicDockedCarpetA(BaseBoat boat)
            : base(0xBB, Point3D.Zero, boat) { }

        public MagicDockedCarpetA(Serial serial)
            : base(serial) { }
