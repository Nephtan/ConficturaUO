...
namespace Server.Multis
{
    public class MagicCarpetD : BaseBoat
    {
        ...
        {
            get { return new MagicDockedCarpetD(this); }
        }

        [Constructable]
        public MagicCarpetD() { }

        public MagicCarpetD(Serial serial)
            : base(serial) { }
    ...
    public class MagicCarpetDDeed : BaseBoatDeed
    {
        ...
        {
            get { return new MagicCarpetD(); }
        }

        [Constructable]
        public MagicCarpetDDeed()
            : base(0xC1, Point3D.Zero)
        {
            Name = "magic carpet";
        }

        public MagicCarpetDDeed(Serial serial)
            : base(serial) { }
    ...
    public class MagicDockedCarpetD : BaseDockedBoat
    {
        ...
        public MagicDockedCarpetD(BaseBoat boat)
            : base(0xC1, Point3D.Zero, boat) { }

        public MagicDockedCarpetD(Serial serial)
            : base(serial) { }
