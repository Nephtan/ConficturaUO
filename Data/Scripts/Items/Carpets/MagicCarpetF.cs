...
namespace Server.Multis
{
    public class MagicCarpetF : BaseBoat
    {
        ...
        {
            get { return new MagicDockedCarpetF(this); }
        }

        [Constructable]
        public MagicCarpetF() { }

        public MagicCarpetF(Serial serial)
            : base(serial) { }
    ...
    public class MagicCarpetFDeed : BaseBoatDeed
    {
        ...
        [Constructable]
        public MagicCarpetFDeed()
            : base(0xC5, Point3D.Zero)
        {
            Name = "magic carpet";
        }

        public MagicCarpetFDeed(Serial serial)
            : base(serial) { }
    ...
    public class MagicDockedCarpetF : BaseDockedBoat
    {
        ...
        public MagicDockedCarpetF(BaseBoat boat)
            : base(0xC5, Point3D.Zero, boat) { }

        public MagicDockedCarpetF(Serial serial)
            : base(serial) { }
