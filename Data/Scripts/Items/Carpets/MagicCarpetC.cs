...
namespace Server.Multis
{
    public class MagicCarpetC : BaseBoat
    {
        ...
        {
            get { return new MagicDockedCarpetC(this); }
        }

        [Constructable]
        public MagicCarpetC() { }

        public MagicCarpetC(Serial serial)
            : base(serial) { }
    ...
    public class MagicCarpetCDeed : BaseBoatDeed
    {
        ...
        {
            get { return new MagicCarpetC(); }
        }

        [Constructable]
        public MagicCarpetCDeed()
            : base(0xBF, Point3D.Zero)
        {
            Name = "magic carpet";
        }

        public MagicCarpetCDeed(Serial serial)
            : base(serial) { }
    ...
    public class MagicDockedCarpetC : BaseDockedBoat
    {
        ...
        public MagicDockedCarpetC(BaseBoat boat)
            : base(0xBF, Point3D.Zero, boat) { }

        public MagicDockedCarpetC(Serial serial)
            : base(serial) { }
