...
namespace Server.Multis
{
    public class MagicCarpetE : BaseBoat
    {
        ...
        {
            get { return new MagicDockedCarpetE(this); }
        }

        [Constructable]
        public MagicCarpetE() { }

        public MagicCarpetE(Serial serial)
            : base(serial) { }
    ...
    public class MagicCarpetEDeed : BaseBoatDeed
    {
        ...
        {
            get { return new MagicCarpetE(); }
        }

        [Constructable]
        public MagicCarpetEDeed()
            : base(0xC3, Point3D.Zero)
        {
            Name = "magic carpet";
        }

        public MagicCarpetEDeed(Serial serial)
            : base(serial) { }
    ...
    public class MagicDockedCarpetE : BaseDockedBoat
    {
        ...
        public MagicDockedCarpetE(BaseBoat boat)
            : base(0xC3, Point3D.Zero, boat) { }

        public MagicDockedCarpetE(Serial serial)
            : base(serial) { }
