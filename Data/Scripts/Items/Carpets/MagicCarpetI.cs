...
namespace Server.Multis
{
    public class MagicCarpetI : BaseBoat
    {
        ...
        {
            get { return new MagicDockedCarpetI(this); }
        }

        [Constructable]
        public MagicCarpetI() { }

        public MagicCarpetI(Serial serial)
            : base(serial) { }
    ...
    public class MagicCarpetIDeed : BaseBoatDeed
    {
        ...
        {
            get { return new MagicCarpetI(); }
        }

        [Constructable]
        public MagicCarpetIDeed()
            : base(0xCB, Point3D.Zero)
        {
            Name = "magic carpet";
        }

        public MagicCarpetIDeed(Serial serial)
            : base(serial) { }
    ...
    public class MagicDockedCarpetI : BaseDockedBoat
    {
        ...
        public MagicDockedCarpetI(BaseBoat boat)
            : base(0xCB, Point3D.Zero, boat) { }

        public MagicDockedCarpetI(Serial serial)
            : base(serial) { }
