...
namespace Server.Items
{
    public class DungeonLoot
    {
        ...
        public static Type[] DungeonLootTypes
        {
            get { return m_DungeonLootTypes; }
        }
        ...
        public static Type[] HighLevelScrolls
        {
            get { return m_HighLevelScrolls; }
        }
        ...
        public static Type[] DungeonWareTypes
        {
            get { return m_DungeonWareTypes; }
        }
        ...
        public static Type[] RuneMagic
        {
            get { return m_RuneMagic; }
        }
        ...
        private static Type[] m_DungeonLoreBooks = new Type[]
        {
            ...
            typeof(BlueBook),
            typeof(BlueBook),
            typeof(WorldMapLodor),
            typeof(WorldMapSosaria),
            typeof(WorldMapBottle),
            typeof(WorldMapSerpent),
            typeof(WorldMapUmber),
            typeof(AlchemicalElixirs),
            typeof(WorldMapAmbrosia),
            typeof(WorldMapIslesOfDread),
            typeof(WorldMapSavage),
            typeof(RuneJournal),
            typeof(MapRanger),
            typeof(GoldenRangers),
            typeof(BookDruidBrewing),
            typeof(BookWitchBrewing),
            typeof(LearnWoodBook),
            typeof(LearnTraps),
            typeof(LearnTitles),
            typeof(LearnTailorBook),
            typeof(LearnStealingBook),
            typeof(LearnScalesBook),
            typeof(LearnReagentsBook),
            typeof(LearnMiscBook),
            typeof(LearnMetalBook),
            typeof(LearnLeatherBook),
            typeof(LearnGraniteBook),
            typeof(AlchemicalMixtures),
            typeof(BookOfPoisons),
            typeof(WorkShoppes),
        ...
        public static Type[] DungeonLoreBooks
        {
            get { return m_DungeonLoreBooks; }
        }
        ...
        private static Type[] m_DungeonToolsTypes = new Type[]
        {
            ...
            typeof(RecallRune),
            typeof(GraveShovel),
            typeof(DruidCauldron),
            typeof(WitchCauldron),
            typeof(LumberAxe),
            typeof(InteriorDecorator),
            ...
            typeof(Tambourine),
            typeof(BambooFlute),
            typeof(PolishBoneBrush),
            typeof(GrapplingHook),
            typeof(WoodworkingTools),
            typeof(Monocle)
        };

        public static Type[] DungeonToolsTypes
        {
            get { return m_DungeonToolsTypes; }
        }
        ...
        private static Type[] m_DungeonRareTypes = new Type[]
        {
            ...
            typeof(SkeletonsKey),
            typeof(PaintCanvas),
            typeof(HeavySharpeningStone),
            typeof(ConsecratedSharpeningStone),
            typeof(MyCircusTentEastAddonDeed),
            typeof(ManyArrows100),
            typeof(ManyBolts100),
            typeof(MyTentSouthAddonDeed),
            typeof(RoughSharpeningStone),
            typeof(DenseSharpeningStone),
            typeof(ElementalSharpeningStone),
            typeof(Runebook),
            typeof(Sand),
            typeof(MagicalDyes),
            typeof(UnknownKeg),
            typeof(ArtifactManual),
            typeof(light_dragon_brazier),
            typeof(CrystallineJar),
            typeof(TrophyBase),
            typeof(DockingLantern),
            typeof(MagicScissors),
            ...
            typeof(MalletStake),
            typeof(MySpellbook),
            typeof(MyNecromancerSpellbook),
            typeof(MySongbook),
            typeof(MyPaladinbook),
            typeof(MySamuraibook),
            typeof(MyNinjabook),
            typeof(CandleLarge),
            typeof(Candelabra),
            typeof(CandelabraStand),
            typeof(HairDyeBottle),
            typeof(GothicCandelabraA),
            typeof(GothicCandelabraB),
            typeof(RareAnvil),
            typeof(MagicHammer),
            typeof(MasterSkeletonsKey),
            typeof(UnusualDyes),
            typeof(MysticSpellbook),
            typeof(MagicPigment),
            typeof(ArmsBarrel),
            typeof(AlternateRealityMap),
            typeof(GenderPotion),
            typeof(NecromancerBarrel),
            typeof(PotionOfMight),
            typeof(PotionOfWisdom),
            typeof(PotionOfDexterity),
            typeof(CarpetBuild),
            typeof(DwarvenForge),
            typeof(SmallHollowBook),
            typeof(LargeHollowBook),
            typeof(MagicSkeltonsKey),
            typeof(SlaversNet),
            typeof(BrokenArmoireDeed),
            typeof(BrokenVanityDeed),
            typeof(BrokenFallenChairDeed),
            typeof(MyElementalSpellbook),
            typeof(BrokenCoveredChairDeed),
        ...
        private static Type[] m_DungeonJunkTypes = new Type[]
        {
            ...
            typeof(BrazierTall),
            typeof(WallTorch),
            typeof(ColoredWallTorch)
        };

        public static Type[] DungeonJunkTypes
        {
            get { return m_DungeonJunkTypes; }
        }
        ...
        private static Type[] m_DungeonOrientTypes = new Type[]
        {
            ...
            typeof(BambooScreen),
            typeof(ShojiScreen),
            typeof(OrientBasket1),
            typeof(OrientBasket2),
            typeof(OrientBasket3),
            typeof(OrientBasket4),
            typeof(OrientBasket5),
            typeof(OrientalItems)
        };

        public static Type[] DungeonOrientTypes
        {
            get { return m_DungeonOrientTypes; }
        }
        ...
        private static Type[] m_DungeonEvilTypes = new Type[]
        {
            ...
            typeof(ESpikeColumnDeed),
            typeof(ESpikePostEastDeed),
            typeof(ESpikePostSouthDeed),
            typeof(EObsidianPillarDeed),
            typeof(EObsidianRockDeed),
            typeof(EShadowAltarDeed),
            typeof(EShadowBannerDeed),
            typeof(EShadowFirePitDeed),
            typeof(EShadowFirePitCrossDeed),
            typeof(EShadowPillarDeed),
            ...
            typeof(EvilItems),
            typeof(EvilItems),
            typeof(BrokenArmoire),
            typeof(BrokenBookcase),
            typeof(BrokenDrawer),
            typeof(NecromancerBanner),
            typeof(NecromancerTable),
            typeof(BloodPentagramDeed),
            typeof(BloodyTableAddonDeed),
            typeof(DeadBodyEWDeed),
            typeof(DeadBodyNSDeed),
            typeof(EvilFireplaceSouthFaceAddonDeed),
            typeof(HalloweenBlood),
            typeof(HalloweenBonePileDeed),
            typeof(HalloweenChopper),
            typeof(HalloweenColumn),
            typeof(HalloweenGrave1),
            typeof(HalloweenGrave2),
            typeof(HalloweenGrave3),
            typeof(HalloweenMaiden),
            typeof(HalloweenPylon),
            typeof(HalloweenPylonFire),
            typeof(HalloweenShrineChaosDeed),
            typeof(HalloweenSkullPole),
            typeof(HalloweenStoneColumn),
            typeof(HalloweenStoneSpike),
            typeof(HalloweenStoneSpike2),
            typeof(HalloweenTortSkel),
            typeof(halloween_coffin_eastAddonDeed),
            typeof(halloween_block_eastAddonDeed),
            typeof(LargeDyingPlant),
            typeof(DyingPlant),
            typeof(PumpkinScarecrow),
            typeof(GrimWarning),
            typeof(SkullsOnPike),
            typeof(BlackCatStatue),
            typeof(RuinedTapestry),
            typeof(HalloweenWeb),
            typeof(halloween_shackles),
            typeof(halloween_ruined_bookcase),
            typeof(halloween_covered_chair),
            typeof(halloween_HauntedMirror1),
            typeof(halloween_HauntedMirror2),
            typeof(halloween_devil_face),
            typeof(BurningScarecrowA),
            typeof(EerieGhost),
            typeof(TrainingDaemonEastDeed),
            typeof(DaemonDartBoardEastDeed)
        };

        public static Type[] DungeonEvilTypes
        {
            get { return m_DungeonEvilTypes; }
        }
        ...
        private static Type[] m_DungeonSlayerTypes = new Type[]
        {
            typeof(SlayerDeed),
            typeof(SlayerDeed),
            typeof(LuckyHorseShoes)
        };

        public static Type[] DungeonSlayerTypes
        {
            get { return m_DungeonSlayerTypes; }
        }
        ...
        private static Type[] m_SpaceJunkTypes = new Type[]
        {
            ...
            typeof(Spyglass),
            typeof(ArtifactManual),
            typeof(LandmineSetup),
            typeof(PlasmaGrenade),
            typeof(DataPad),
            typeof(PuzzleCube),
            typeof(DuctTape),
            typeof(TinkerTools),
            typeof(FirstAidKit),
            typeof(DoubleLaserSword),
            typeof(ThermalDetonator),
            typeof(Chainsaw),
            typeof(PortableSmelter),
            typeof(RobotBatteries),
            typeof(RobotSheetMetal),
            typeof(RobotOil),
            typeof(RobotGears),
            typeof(RobotEngineParts),
            typeof(RobotCircuitBoard),
            typeof(RobotBolt),
            typeof(RobotTransistor),
            typeof(MaterialLiquifier)
        };

        public static Type[] SpaceJunkTypes
        {
            get { return m_SpaceJunkTypes; }
        }
        ...
        public static Type[] SpaceBagTypes
        {
            get { return m_SpaceBagTypes; }
        }
        ...
        public static Type[] SpaceCrashTypes
        {
            get { return m_SpaceCrashTypes; }
        }
