        ...
        public virtual bool ExecuteTrap(Mobile from)
        {
            if (m_TrapType != TrapType.None)
            {
                ...
                else if (from.CheckTargetSkill(SkillName.RemoveTrap, this, 0, nTrapLevel2))
                {
                    ...
                    SendMessageTo(
                        from,
                        "That was trapped, but you were able to disable it.",
                        0x3B2
                    );
                    return false;
                }
                ...
                if (from.Backpack != null)
                {
                    ...
                    if (GetPlayerInfo.LuckyPlayer(from.Luck))
                    {
                        ...
                        SendMessageTo(
                            from,
                            "That was trapped, but with luck on your side...it broke.",
                            0x3B2
                        );
                        return false;
                    }
                    if (magicwand != null)
                    {
                        ...
                        if (nPower >= nAgainst)
                        {
                            ...
                            SendMessageTo(
                                from,
                                "That was trapped, but your magic orb disabled it.",
                                0x3B2
                            );
                            return false;
                        }
                    ...
                    if (tenfootpole != null)
                    {
                        ...
                        if (
                            ...
                            >= Utility.RandomMinMax(nTrapLevel, nTrapLevel2)
                        )
                        {
                            ...
                            if (poles.Charges < 1)
                            {
                                SendMessageTo(
                                    from,
                                    "You tap your ten foot pole, disabling a trap and breaking the pole.",
                                    0x3B2
                                );
                                poles.Delete();
                            }
                            else
                            {
                                SendMessageTo(
                                    from,
                                    "You tap your ten foot pole, disabling a trap.",
                                    0x3B2
                                );
                ...
                int MagicAvoid = (int)(
                    (from.Skills[SkillName.RemoveTrap].Value + from.EnergyResistance) / 3
                );
                if (MagicAvoid > 90)
                {
                    MagicAvoid = 90;
                ...
                switch (m_TrapType)
                {
                    ...
                    case TrapType.MagicTrap:
                    {
                        ...
                        Effects.SendLocationEffect(
                            new Point3D(loc.X - 1, loc.Y, loc.Z),
                            Map,
                            0x36BD,
                            15
                        );
                        ...
                        Effects.SendLocationEffect(
                            new Point3D(loc.X, loc.Y - 1, loc.Z),
                            Map,
                            0x36BD,
                            15
                        );
                        ...
                        Effects.SendLocationEffect(
                            new Point3D(loc.X + 1, loc.Y + 1, loc.Z + 11),
                            Map,
                            0x36BD,
                            15
                        );
