...
namespace Server
{
    public class LootPack
    {
        public static int GetLuckChance(Mobile killer, Mobile victim)
        {
            ...
            if (
                pmKiller != null
                && pmKiller.SentHonorContext != null
        ...
        {
            List<DamageStore> list = BaseCreature.GetLootingRights(
                dead.DamageEntries,
                dead.HitsMax
            );
                ...
                if (item != null)
                {
                    if (!item.Stackable || !cont.TryDropItem(from, item, false))
                    {
                        ...
                        )
                        {
                            ...
                            if (
                                cont != null
                                && (itemID.VendorCanID == "" || itemID.VendorCanID == null)
                            )
                            {
                                cont.DropItem(item);
                                itemID.Delete();
        ...
        public static readonly LootPack MlRich = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack SePoor = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack SeMeager = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack SeAverage = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack SeRich = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack SeFilthyRich = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack SeUltraRich = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack SeSuperBoss = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack AosPoor = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack AosMeager = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack AosAverage = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack AosRich = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack AosFilthyRich = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack AosUltraRich = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack AosSuperBoss = new LootPack(
            new LootPackEntry[]
            {
                new LootPackEntry(true, Gold, 100.00, "5d100+500"),
                new LootPackEntry(false, AosMagicItemsUltraRich, 100.00, 1, 5, 25, 100),
        ...
        public static readonly LootPack OldPoor = new LootPack(
            new LootPackEntry[] { new LootPackEntry(true, Gold, 100.00, "1d25") }
        );

        public static readonly LootPack OldMeager = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack OldAverage = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack OldRich = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack OldFilthyRich = new LootPack(
            new LootPackEntry[]
            {
        ...
        public static readonly LootPack OldUltraRich = new LootPack(
            new LootPackEntry[]
            {
                new LootPackEntry(true, Gold, 100.00, "5d100+500"),
        ...
        public static readonly LootPack OldSuperBoss = new LootPack(
            new LootPackEntry[]
            {
                new LootPackEntry(true, Gold, 100.00, "5d100+500"),
                new LootPackEntry(false, Instruments, 2.00, 1, 1, 40, 100),
        ...
        public static LootPack Average
        {
            get
            {
                return Core.SE
        ...
        public static LootPack FilthyRich
        {
            get
            {
                return Core.SE
        ...
        public static LootPack UltraRich
        {
            get
            {
                return Core.SE
        ...
        public static LootPack SuperBoss
        {
            get
            {
                return Core.SE
        ...
        public static readonly LootPack LowScrolls = new LootPack(
            new LootPackEntry[] { new LootPackEntry(false, LowScrollItems, 100.00, 1) }
        );

        public static readonly LootPack MedScrolls = new LootPack(
            new LootPackEntry[] { new LootPackEntry(false, MedScrollItems, 100.00, 1) }
        );

        public static readonly LootPack HighScrolls = new LootPack(
            new LootPackEntry[] { new LootPackEntry(false, HighScrollItems, 100.00, 1) }
        );

        public static readonly LootPack Gems = new LootPack(
            new LootPackEntry[] { new LootPackEntry(false, GemItems, 100.00, 1) }
        );

        public static readonly LootPack Potions = new LootPack(
            new LootPackEntry[] { new LootPackEntry(false, PotionItems, 100.00, 1) }
        );

        public static readonly LootPack Wands = new LootPack(
            new LootPackEntry[] { new LootPackEntry(false, WandItems, 100.00, 1) }
        );
    }
    ...
    public class LootPackEntry
    {
        ...
        public static string MagicItemAdj(string placed, bool oriental, bool evil, int itemid)
        {
            ...
            if (placed == "end")
            {
                pick = Utility.RandomMinMax(38, 116);
            }
            ...
            if (placed == "end" && itemid == 0x2C9E) // SAFETY CATCH FOR DEMON/DRAGON SKULL TRINKETS
            {
                ...
                {
                    case 0:
                        sAdjective = "the Demon";
                        break;
                    case 1:
                        sAdjective = "the Dragon";
                        break;
                    case 2:
                        sAdjective = "the Daemon";
                        break;
                    case 3:
                        sAdjective = "the Devil";
                        break;
                    case 4:
                        sAdjective = "the Wyrm";
                        break;
                    case 5:
                        sAdjective = "the Drake";
                        break;
                }
            }
            else
                ...
                if (oriental == true)
                {
                    switch (pick)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            sAdjective = "mysterious";
                            break;
                        case 2:
                            sAdjective = "enchanted";
                            break;
                        case 3:
                            sAdjective = "marvelous";
                            break;
                        case 4:
                            sAdjective = "amazing";
                            break;
                        case 5:
                            sAdjective = "astonishing";
                            break;
                        case 6:
                            sAdjective = "mystical";
                            break;
                        case 7:
                            sAdjective = "astounding";
                            break;
                        case 8:
                            sAdjective = "magical";
                            break;
                        ...
                        case 10:
                            ...
                            break;
                        case 11:
                            sAdjective = "magnificent";
                            break;
                        case 12:
                            sAdjective = "phenomenal";
                            break;
                        case 13:
                            sAdjective = "fantastic";
                            break;
                        case 14:
                            sAdjective = "incredible";
                            break;
                        case 15:
                            sAdjective = "extraordinary";
                            break;
                        case 16:
                            sAdjective = "fabulous";
                            break;
                        ...
                        case 20:
                            ...
                            break;
                        case 21:
                            sAdjective = "legendary";
                            break;
                        case 22:
                            sAdjective = "mythical";
                            break;
                        case 23:
                            sAdjective = "ancestral";
                            break;
                        case 24:
                            sAdjective = "ornate";
                            break;
                        ...
                        case 31:
                            ...
                            break;
                        case 32:
                            sAdjective = "unspeakable";
                            break;
                        case 33:
                            sAdjective = "forgotten";
                            break;
                        case 34:
                            sAdjective = "great";
                            break;
                        ...
                        case 39:
                            ...
                            break;
                        case 40:
                            sAdjective = "greatness";
                            break;
                        case 41:
                            sAdjective = "magic";
                            break;
                        case 42:
                            sAdjective = "supremacy";
                            break;
                        case 43:
                            sAdjective = "the almighty";
                            break;
                        case 44:
                            sAdjective = "the sacred";
                            break;
                        case 45:
                            sAdjective = "magnificence";
                            break;
                        case 46:
                            sAdjective = "excellence";
                            break;
                        case 47:
                            sAdjective = "glory";
                            break;
                        case 48:
                            ...
                            break;
                        case 49:
                            sAdjective = "the divine";
                            break;
                        case 50:
                            sAdjective = "the forgotten";
                            break;
                        case 51:
                            sAdjective = "legend";
                            break;
                        case 52:
                            ...
                            break;
                        case 53:
                            sAdjective = "the ancients";
                            break;
                        case 54:
                            sAdjective = "wonder";
                            break;
                        case 55:
                            sAdjective = "the mighty";
                            break;
                        case 56:
                            sAdjective = "marvel";
                            break;
                        case 57:
                            ...
                            break;
                        case 58:
                            sAdjective = "mysticism";
                            break;
                        case 59:
                            sAdjective = "enchantment";
                            break;
                        case 60:
                            sAdjective = "the Karateka";
                            break;
                        case 61:
                            sAdjective = "the Ronin";
                            break;
                        case 62:
                            sAdjective = "the Samurai";
                            break;
                        case 63:
                            sAdjective = "the Ninja";
                            break;
                        case 64:
                            sAdjective = "the Yakuza";
                            break;
                        case 65:
                            sAdjective = "the Wu Jen";
                            break;
                        case 66:
                            sAdjective = "the Kensai";
                            break;
                        case 67:
                            sAdjective = "the Shukenja";
                            break;
                        case 68:
                            sAdjective = "the Fangshi";
                            break;
                        case 69:
                            sAdjective = "the Waidan";
                            break;
                        case 70:
                            sAdjective = "the Neidan";
                            break;
                        case 71:
                            sAdjective = "the Monk";
                            break;
                        case 72:
                            sAdjective = "the Kyudo";
                            break;
                        case 73:
                            sAdjective = "the Yuki Ota";
                            break;
                        case 74:
                            sAdjective = "the Sakushi";
                            break;
                        case 75:
                            sAdjective = "the Youxia";
                            break;
                        case 76:
                            sAdjective = "the Kyudoka";
                            break;
                        case 77:
                            sAdjective = "the Ashigaru";
                            break;
                        case 78:
                            sAdjective = "the Martial Artist";
                            break;
                        case 79:
                            sAdjective = "the Slayer";
                            break;
                        case 80:
                            sAdjective = "the Wako";
                            break;
                        case 81:
                            sAdjective = "the Barbarian";
                            break;
                        case 82:
                            sAdjective = "the Explorer";
                            break;
                        case 83:
                            sAdjective = "the Heretic";
                            break;
                        case 84:
                            sAdjective = "the Sumo";
                            break;
                        case 85:
                            sAdjective = "the Iaijutsu";
                            break;
                        case 86:
                            sAdjective = "the Emperor";
                            break;
                        case 87:
                            sAdjective =
                                "of the "
                            ...
                            break;
                        case 88:
                            sAdjective = "the Zhuhou";
                            break;
                        case 89:
                            sAdjective = "the Qing";
                            break;
                        case 90:
                            sAdjective = "the Empress";
                            break;
                        case 91:
                            sAdjective = "the Daifu";
                            break;
                        case 92:
                            sAdjective = "the Shi";
                            break;
                        case 93:
                            sAdjective = "the Shumin";
                            break;
                        case 94:
                            sAdjective = "the Heika";
                            break;
                        case 95:
                            sAdjective = "the Denka";
                            break;
                        case 96:
                            sAdjective = "the Hidenka";
                            break;
                        case 97:
                            sAdjective = "the Kakka";
                            break;
                        case 98:
                            sAdjective = "the Daitoryo";
                            break;
                        case 99:
                            sAdjective = "the Renshi";
                            break;
                        case 100:
                            sAdjective = "the Kyoshi";
                            break;
                        case 101:
                            sAdjective = "the Hanshi";
                            break;
                        case 102:
                            sAdjective = "the Meijin";
                            break;
                        case 103:
                            sAdjective = "the Oyakata";
                            break;
                        case 104:
                            sAdjective = "the Shihan";
                            break;
                        case 105:
                            sAdjective = "the Shidoin";
                            break;
                        case 106:
                            sAdjective = "the Shisho";
                            break;
                        case 107:
                            sAdjective = "the Zeki";
                            break;
                        case 108:
                            sAdjective = "the Shaman";
                            break;
                        case 109:
                            sAdjective = "the Shodan";
                            break;
                        case 110:
                            sAdjective = "the Nidan";
                            break;
                        case 111:
                            sAdjective = "the Yodan";
                            break;
                        case 112:
                            sAdjective = "the Godan";
                            break;
                        case 113:
                            sAdjective = "the Rokudan";
                            break;
                        case 114:
                            sAdjective = "the Shichidan";
                            break;
                        case 115:
                            sAdjective = "the Hachidan";
                            break;
                        case 116:
                            sAdjective = "the Judan";
                            break;
                    }
                }
                else if (evil == true)
                {
                    switch (pick)
                    {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            sAdjective = "malevolent";
                            break;
                        case 6:
                            sAdjective = "malicious";
                            break;
                        case 7:
                            sAdjective = "nefarious";
                            break;
                        case 8:
                            sAdjective = "wicked";
                            break;
                        ...
                        case 13:
                            ...
                            break;
                        case 14:
                            sAdjective = "disastrous";
                            break;
                        case 15:
                            sAdjective = "harmful";
                            break;
                        case 16:
                            sAdjective = "loathsome";
                            break;
                        case 17:
                            sAdjective = "maleficent";
                            break;
                        case 18:
                            sAdjective = "repulsive";
                            break;
                        case 19:
                            sAdjective = "spiteful";
                            break;
                        ...
                        case 33:
                            ...
                            break;
                        case 34:
                            sAdjective = "miserable";
                            break;
                        case 35:
                            sAdjective = "infamous";
                            break;
                        case 36:
                            sAdjective = "corrupted";
                            break;
                        case 37:
                            sAdjective = "raging";
                            break;
                        ...
                        case 48:
                            ...
                            break;
                        case 49:
                            sAdjective = "the haunted";
                            break;
                        case 50:
                            sAdjective = "the undead";
                            break;
                        case 51:
                            sAdjective = "the mummy";
                            break;
                        case 52:
                            sAdjective = "the buried";
                            break;
                        case 53:
                            sAdjective = "the poltergeist";
                            break;
                        case 54:
                            sAdjective = "the cult";
                            break;
                        case 55:
                            sAdjective = "the grave";
                            break;
                        case 56:
                            sAdjective = "blood";
                            break;
                        case 57:
                            sAdjective =
                                "the " + Server.Misc.RandomThings.GetRandomColorName(0) + " Ghost";
                            break;
                        case 58:
                            sAdjective = "the tomb";
                            break;
                        case 59:
                            sAdjective = "the crypt";
                            break;
                        case 60:
                            sAdjective = "the Necromancer";
                            break;
                        case 61:
                            sAdjective = "the Witch";
                            break;
                        case 62:
                            sAdjective = "the Warlock";
                            break;
                        case 63:
                            sAdjective = "the Vile";
                            break;
                        case 64:
                            sAdjective = "the Hated";
                            break;
                        case 65:
                            sAdjective = "the Villain";
                            break;
                        case 66:
                            sAdjective = "the Murderer";
                            break;
                        case 67:
                            sAdjective = "the Killer";
                            break;
                        case 68:
                            sAdjective = "the Ghost";
                            break;
                        case 69:
                            sAdjective = "the Death Knight";
                            break;
                        case 70:
                            sAdjective = "the Lich";
                            break;
                        case 71:
                            sAdjective = "the Occultist";
                            break;
                        case 72:
                            sAdjective = "the Cultist";
                            break;
                        case 73:
                            sAdjective = "the Diabolist";
                            break;
                        case 74:
                            sAdjective = "the Hag";
                            break;
                        case 75:
                            sAdjective = "the Butcher";
                            break;
                        case 76:
                            sAdjective = "the Slayer";
                            break;
                        case 77:
                            sAdjective = "the Executioner";
                            break;
                        case 78:
                            sAdjective = "the Demon";
                            break;
                        case 79:
                            sAdjective = "the Phantom";
                            break;
                        case 80:
                            sAdjective = "the Shadow";
                            break;
                        case 81:
                            sAdjective = "the Spectre";
                            break;
                        case 82:
                            sAdjective = "the Devil";
                            break;
                        case 83:
                            sAdjective = "the Shade";
                            break;
                        case 84:
                            sAdjective = "the Wraith";
                            break;
                        case 85:
                            sAdjective = "the Vampire";
                            break;
                        case 86:
                            sAdjective = "the Banshee";
                            break;
                        case 87:
                            sAdjective = "the Dark";
                            break;
                        case 88:
                            sAdjective = "the Black";
                            break;
                        case 89:
                            sAdjective = "the Mortician";
                            break;
                        case 90:
                            sAdjective = "the Embalmer";
                            break;
                        case 91:
                            sAdjective = "the Grave";
                            break;
                        case 92:
                            sAdjective = "the Fiend";
                            break;
                        case 93:
                            sAdjective = "the Daemon";
                            break;
                        case 94:
                            sAdjective = "the Corrupt";
                            break;
                        case 95:
                            sAdjective = "the Hateful";
                            break;
                        case 96:
                            sAdjective = "the Heinous";
                            break;
                        case 97:
                            sAdjective = "the Hideous";
                            break;
                        case 98:
                            sAdjective = "the Malevolent";
                            break;
                        case 99:
                            sAdjective = "the Malicious";
                            break;
                        case 100:
                            sAdjective = "the Nefarious";
                            break;
                        case 101:
                            sAdjective = "the Vicious";
                            break;
                        case 102:
                            sAdjective = "the Wicked";
                            break;
                        case 103:
                            sAdjective = "the Foul";
                            break;
                        case 104:
                            sAdjective = "the Baneful";
                            break;
                        case 105:
                            sAdjective = "the Depraved";
                            break;
                        case 106:
                            sAdjective = "the Loathsome";
                            break;
                        case 107:
                            sAdjective = "the Wrathful";
                            break;
                        case 108:
                            sAdjective = "the Woeful";
                            break;
                        case 109:
                            sAdjective = "the Grim";
                            break;
                        case 110:
                            sAdjective = "the Dismal";
                            break;
                        case 111:
                            sAdjective = "the Lifeless";
                            break;
                        case 112:
                            sAdjective = "the Deceased";
                            break;
                        case 113:
                            sAdjective = "the Bloodless";
                            break;
                        case 114:
                            sAdjective = "the Mortified";
                            break;
                        case 115:
                            sAdjective = "the Departed";
                            break;
                        case 116:
                            sAdjective = "the Dead";
                            break;
                ...
                else
                {
                    switch (pick)
                    {
                        ...
                        case 59:
                            ...
                            break;
                        case 60:
                            sAdjective = "the Templar";
                            break;
                        case 61:
                            sAdjective = "the Thief";
                            break;
                        case 62:
                            sAdjective = "the Illusionist";
                            break;
                        case 63:
                            sAdjective = "the Princess";
                            break;
                        case 64:
                            sAdjective = "the Invoker";
                            break;
                        case 65:
                            sAdjective = "the Priestess";
                            break;
                        case 66:
                            sAdjective = "the Conjurer";
                            break;
                        case 67:
                            sAdjective = "the Bandit";
                            break;
                        case 68:
                            sAdjective = "the Baroness";
                            break;
                        case 69:
                            sAdjective = "the Wizard";
                            break;
                        case 70:
                            sAdjective = "the Cleric";
                            break;
                        case 71:
                            sAdjective = "the Monk";
                            break;
                        case 72:
                            sAdjective = "the Minstrel";
                            break;
                        case 73:
                            sAdjective = "the Defender";
                            break;
                        case 74:
                            sAdjective = "the Cavalier";
                            break;
                        case 75:
                            sAdjective = "the Magician";
                            break;
                        case 76:
                            sAdjective = "the Witch";
                            break;
                        case 77:
                            sAdjective = "the Fighter";
                            break;
                        case 78:
                            sAdjective = "the Seeker";
                            break;
                        case 79:
                            sAdjective = "the Slayer";
                            break;
                        case 80:
                            sAdjective = "the Ranger";
                            break;
                        case 81:
                            sAdjective = "the Barbarian";
                            break;
                        ...
                        case 83:
                            ...
                            break;
                        case 84:
                            sAdjective = "the Gladiator";
                            break;
                        case 85:
                            sAdjective = "the Sage";
                            break;
                        case 86:
                            sAdjective = "the Rogue";
                            break;
                        case 87:
                            sAdjective = "the Paladin";
                            break;
                        case 88:
                            sAdjective = "the Bard";
                            break;
                        case 89:
                            sAdjective = "the Diviner";
                            break;
                        case 90:
                            sAdjective = "the Lady";
                            break;
                        case 91:
                            sAdjective = "the Outlaw";
                            break;
                        case 92:
                            sAdjective = "the Prophet";
                            break;
                        case 93:
                            sAdjective = "the Mercenary";
                            break;
                        case 94:
                            sAdjective = "the Adventurer";
                            break;
                        case 95:
                            sAdjective = "the Enchantress";
                            break;
                        case 96:
                            sAdjective = "the Queen";
                            break;
                        case 97:
                            sAdjective = "the Scout";
                            break;
                        case 98:
                            sAdjective = "the Mystic";
                            break;
                        case 99:
                            sAdjective = "the Mage";
                            break;
                        case 100:
                            sAdjective = "the Traveler";
                            break;
                        case 101:
                            sAdjective = "the Summoner";
                            break;
                        case 102:
                            sAdjective = "the Warrior";
                            break;
                        case 103:
                            sAdjective = "the Sorcereress";
                            break;
                        case 104:
                            sAdjective = "the Seer";
                            break;
                        case 105:
                            sAdjective = "the Hunter";
                            break;
                        case 106:
                            sAdjective = "the Knight";
                            break;
                        case 107:
                            sAdjective = "the Necromancer";
                            break;
                        case 108:
                            ...
                            break;
                        case 109:
                            sAdjective = "the Prince";
                            break;
                        case 110:
                            sAdjective = "the Priest";
                            break;
                        case 111:
                            sAdjective = "the Baron";
                            break;
                        case 112:
                            sAdjective = "the Warlock";
                            break;
                        case 113:
                            ...
                            break;
                        case 114:
                            sAdjective = "the Enchanter";
                            break;
                        case 115:
                            sAdjective = "the King";
                            break;
                        case 116:
                            sAdjective = "the Sorcerer";
                            break;
                    }
                }
            }
        ...
        public static string MagicItemName(Item item, Mobile m, Region from)
        {
            ...
            if (from is DungeonRegion && Utility.RandomBool())
            {
                RegionName = from.Name;
            }
            else
            {
                ...
                {
                    case 0:
                        RegionName = Server.Misc.RandomThings.MadeUpDungeon();
                        break;
                    case 1:
                        RegionName = Server.Misc.RandomThings.MadeUpCity();
                        break;
                    case 2:
                        RegionName = Server.Misc.RandomThings.GetRandomScenePainting();
                        break;
                    case 3:
                        RegionName =
                            "the "
            ...
            if (
                (item.ItemID >= 0x2776 && item.ItemID <= 0x27FA)
                || Server.Misc.GetPlayerInfo.OrientalPlay(m) == true
            )
            {
                isOriental = true;
            ...
            if (
                isEvil
                && (item is BaseMagicStaff || item is WizardWand)
            ...
            if (item is BambooFlute)
            {
                name = "flute";
            }
            else if (item is Drums)
            {
                name = "drum";
            }
            else if (item is Harp)
            {
                name = "harp";
            }
            else if (item is LapHarp)
            {
                name = "harp";
            }
            else if (item is Lute)
            {
                name = "lute";
            ...
            else if (item is Tambourine)
            {
                name = "tambourine";
            }
            else if (item is TambourineTassel)
            {
                name = "tambourine";
            }
            else if (item is Trumpet)
            {
                name = "trumpet";
            }

            int FirstLast = Utility.RandomMinMax(0, 1);
            if (Server.Misc.MaterialInfo.IsNotPlain(item) == true)
            {
                FirstLast = 2;
            }
            ...
            else if (FirstLast == 0) // FIRST COMES ADJECTIVE
            {
                ...
                switch (Utility.RandomMinMax(0, val))
                {
                    ...
                    case 6:
                        if (RegionName != "")
                        {
                            name = sAdjective + " " + name + " from " + RegionName;
                        }
                        HaveNewName = 1;
                        break;
                    case 7:
            ...
            else // FIRST COMES OWNER
            {
                ...
                {
                    case 0:
                        name = OwnerName + " " + name + " of " + eAdjective;
                        HaveNewName = 1;
                        break;
                    case 1:
                        name = name + " of " + eAdjective;
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        name = OwnerName + " " + sAdjective + " " + name;
                        HaveNewName = 1;
                        break;
                    case 4:
                        if (RegionName != "")
        ...
        public static Item Enchant(Mobile from, int enchant, Item item)
        {
            if (item != null)
            {
                ...
                if (from.Luck > 0)
                {
                    luckChance = (int)(Math.Pow(from.Luck, 1 / 1.8) * 100);
                }
