...
namespace Server.Items
{
    ...
    public class HiddenContainer : LockableContainer
    {
        ...
        public HiddenContainer(Serial serial)
            : base(serial) { }
    ...
    public class HiddenBox : HiddenContainer
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Container_Owner
        {
            get { return ContainerOwner; }
            set
            {
        ...
        [Constructable]
        public HiddenBox(int level, string my_location, Mobile finder)
            : base()
        {
            ...
            else if (this.ItemID == 0x5718)
            {
                ContainerFlip = 0x5719;
            }
            else if (this.ItemID == 0x571A)
            {
                ContainerFlip = 0x571B;
            }
            else if (this.ItemID == 0x5752)
            {
                ContainerFlip = 0x5753;
            }
            else if (this.ItemID == 0x5719)
            {
                ContainerFlip = 0x5718;
            }
            else if (this.ItemID == 0x571B)
            {
                ContainerFlip = 0x571A;
            }
            else if (this.ItemID == 0x5753)
            {
                ContainerFlip = 0x5752;
            }
        ...
        public HiddenBox(Serial serial)
            : base(serial) { }
