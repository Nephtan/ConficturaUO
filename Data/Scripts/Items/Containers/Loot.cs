...
namespace Server
{
    public class Loot
    {
        ...
        {
            get { return m_SERangedWeaponTypes; }
        }
        ...
        {
            get { return m_AosRangedWeaponTypes; }
        }
        ...
        {
            get { return m_RangedWeaponTypes; }
        }
        ...
        private static Type[] m_SEArmorTypes = new Type[]
        {
            ...
            typeof(SavageHelm),
            typeof(SavageLegs),
            typeof(StuddedHideChest),
            typeof(Bascinet),
            typeof(LeatherSandals),
            typeof(RingmailArms),
            typeof(BoneArms),
            typeof(LeatherShoes),
            ...
            typeof(RoyalBoots),
            typeof(ChainChest),
            typeof(MagicBoneArms),
            typeof(RoyalChest),
            typeof(ChainCoif),
            typeof(MagicBoneChest),
            typeof(DreadHelm),
            typeof(ChainLegs),
            typeof(MagicBoneGloves),
            typeof(RoyalGloves),
            typeof(CloseHelm),
            typeof(MagicBoneHelm),
            typeof(RoyalGorget),
            typeof(FemaleLeatherChest),
            typeof(MagicBoneLegs),
            typeof(RoyalHelm),
            ...
            typeof(LeatherChest),
            typeof(PlateArms),
            typeof(WoodenPlateArms),
            typeof(LeatherCloak),
            typeof(PlateChest),
            typeof(WoodenPlateChest),
            typeof(LeatherGloves),
            typeof(PlateGloves),
            typeof(WoodenPlateGloves),
            typeof(LeatherGorget),
            typeof(PlateGorget),
            typeof(WoodenPlateGorget),
            typeof(LeatherLegs),
            typeof(PlateHelm),
            typeof(WoodenPlateHelm),
            typeof(LeatherRobe),
            typeof(PlateLegs),
            typeof(WoodenPlateLegs),
            typeof(WhiteFurLegs),
            typeof(WhiteFurTunic),
            typeof(WhiteFurArms),
            typeof(FurLegs),
            typeof(FurTunic),
            typeof(FurArms),
            ...
            typeof(OniwabanBoots),
            typeof(OniwabanGloves),
            typeof(OniwabanLeggings),
            typeof(OniwabanHood)
        };

        public static Type[] SEArmorTypes
        {
            get { return m_SEArmorTypes; }
        }
        ...
        {
            typeof(MagicDragonArms),
            typeof(MagicDragonChest),
            typeof(MagicDragonGloves),
            typeof(MagicDragonHelm),
            typeof(MagicDragonLegs)
        };

        public static Type[] DragonArmorTypes
        {
            get { return m_DragonArmorTypes; }
        }
        ...
        private static Type[] m_AosShieldTypes = new Type[]
        {
            ...
            typeof(OrderShield),
            typeof(RoyalShield),
            typeof(GuardsmanShield),
            typeof(ElvenShield),
            typeof(DarkShield),
            typeof(CrestedShield),
            typeof(ChampionShield),
            typeof(JeweledShield)
        };

        public static Type[] AosShieldTypes
        {
            get { return m_AosShieldTypes; }
        }
        ...
        private static Type[] m_GemTypes = new Type[]
        {
            ...
            typeof(StarSapphire),
            typeof(Tourmaline),
            typeof(MagicJewelryRing),
            typeof(MagicJewelryNecklace),
            typeof(MagicJewelryEarrings),
            typeof(MagicJewelryBracelet),
            typeof(MagicJewelryCirclet)
        };

        public static Type[] GemTypes
        {
            get { return m_GemTypes; }
        }
        ...
        private static Type[] m_JewelryTypes = new Type[]
        {
            ...
            typeof(MagicCloak),
            typeof(MagicBoots),
            typeof(MagicTalisman)
        };

        public static Type[] JewelryTypes
        {
            get { return m_JewelryTypes; }
        }

        private static Type[] m_SecretRegTypes = new Type[] { typeof(UnknownReagent) };

        public static Type[] SecretRegTypes
        {
            get { return m_SecretRegTypes; }
        }
        ...
        public static Type[] WitchRegTypes
        {
            get { return m_WitchRegTypes; }
        }
        ...
        public static Type[] DruidRegTypes
        {
            get { return m_DruidRegTypes; }
        }
        ...
        public static Type[] MixerRegTypes
        {
            get { return m_MixerRegTypes; }
        }
        ...
        private static Type[] m_PotionTypes = new Type[]
        {
            ...
            typeof(RejuvenatePotion),
            typeof(GreaterRejuvenatePotion),
        ...
        {
            get { return m_PotionTypes; }
        }

        private static Type[] m_UPotionTypes = new Type[] { typeof(UnknownLiquid) };

        public static Type[] UPotionTypes
        {
            get { return m_UPotionTypes; }
        }
        ...
        {
            get { return m_SEInstrumentTypes; }
        }
        ...
        {
            get { return m_InstrumentTypes; }
        }

        private static Type[] m_QuiverTypes = new Type[] { typeof(MagicQuiver) };

        public static Type[] QuiverTypes
        {
            get { return m_QuiverTypes; }
        }
        ...
        private static Type[] m_ElementalScrollTypes = new Type[]
        {
            ...
            typeof(Elemental_Bolt_Scroll),
            typeof(Elemental_Mend_Scroll),
            typeof(Elemental_Sanctuary_Scroll),
            typeof(Elemental_Pain_Scroll),
            typeof(Elemental_Protection_Scroll),
            typeof(Elemental_Purge_Scroll),
            typeof(Elemental_Steed_Scroll),
            typeof(Elemental_Call_Scroll),
            typeof(Elemental_Force_Scroll),
            typeof(Elemental_Wall_Scroll),
            typeof(Elemental_Warp_Scroll),
            typeof(Elemental_Field_Scroll),
            typeof(Elemental_Restoration_Scroll),
            typeof(Elemental_Strike_Scroll),
            typeof(Elemental_Void_Scroll),
            typeof(Elemental_Blast_Scroll),
            typeof(Elemental_Echo_Scroll),
            typeof(Elemental_Fiend_Scroll),
            typeof(Elemental_Hold_Scroll),
            typeof(Elemental_Barrage_Scroll),
            typeof(Elemental_Rune_Scroll),
            typeof(Elemental_Storm_Scroll),
            typeof(Elemental_Summon_Scroll),
            typeof(Elemental_Devastation_Scroll),
            typeof(Elemental_Fall_Scroll),
            typeof(Elemental_Gate_Scroll),
            typeof(Elemental_Havoc_Scroll),
            typeof(Elemental_Apocalypse_Scroll),
            typeof(Elemental_Lord_Scroll),
            typeof(Elemental_Soul_Scroll),
            typeof(Elemental_Spirit_Scroll)
        };
        ...
        {
            get { return m_NecromancyScrollTypes; }
        }
        public static Type[] PaladinScrollTypes
        {
            get { return m_PaladinScrollTypes; }
        }
        public static Type[] ElementalScrollTypes
        {
            get { return m_ElementalScrollTypes; }
        }

        private static Type[] m_WandTypes = new Type[]
        {
            typeof(AgilityMagicStaff),
            typeof(PoisonFieldMagicStaff),
            typeof(MagicArrowMagicStaff),
            typeof(EarthElementalMagicStaff),
            typeof(AgilityMagicStaff),
            typeof(PoisonMagicStaff),
            typeof(MagicArrowMagicStaff),
            typeof(EarthquakeMagicStaff),
            typeof(AgilityMagicStaff),
            typeof(PoisonMagicStaff),
            typeof(MagicArrowMagicStaff),
            typeof(EnergyBoltMagicStaff),
            typeof(AgilityMagicStaff),
            typeof(PoisonMagicStaff),
            typeof(MagicLockMagicStaff),
            typeof(EnergyBoltMagicStaff),
            typeof(AgilityMagicStaff),
            typeof(PoisonMagicStaff),
            typeof(MagicLockMagicStaff),
            ...
            typeof(PoisonMagicStaff),
            typeof(MagicLockMagicStaff),
            typeof(EnergyFieldMagicStaff),
            typeof(AgilityMagicStaff),
            typeof(PoisonMagicStaff),
            typeof(MagicLockMagicStaff),
            typeof(EnergyFieldMagicStaff),
            typeof(AirElementalMagicStaff),
            typeof(PolymorphMagicStaff),
            typeof(MagicLockMagicStaff),
            typeof(EnergyVortexMagicStaff),
            typeof(ArchCureMagicStaff),
            typeof(PolymorphMagicStaff),
            typeof(MagicLockMagicStaff),
            typeof(ExplosionMagicStaff),
            typeof(ArchCureMagicStaff),
            typeof(ProtectionMagicStaff),
            typeof(MagicReflectionMagicStaff),
            typeof(ExplosionMagicStaff),
            typeof(ArchCureMagicStaff),
            typeof(ProtectionMagicStaff),
            typeof(MagicReflectionMagicStaff),
            ...
            typeof(ProtectionMagicStaff),
            typeof(MagicReflectionMagicStaff),
            typeof(FeebleMagicStaff),
            typeof(ArchCureMagicStaff),
            typeof(ProtectionMagicStaff),
            typeof(MagicReflectionMagicStaff),
            typeof(FeebleMagicStaff),
            typeof(ArchProtectionMagicStaff),
            typeof(ProtectionMagicStaff),
            typeof(MagicTrapMagicStaff),
            typeof(FeebleMagicStaff),
            typeof(ArchProtectionMagicStaff),
            typeof(ProtectionMagicStaff),
            typeof(MagicTrapMagicStaff),
            ...
            typeof(FeebleMagicStaff),
            typeof(ArchProtectionMagicStaff),
            typeof(ReactiveArmorMagicStaff),
            typeof(MagicTrapMagicStaff),
            typeof(FeebleMagicStaff),
            typeof(ArchProtectionMagicStaff),
            typeof(ReactiveArmorMagicStaff),
            ...
            typeof(ReactiveArmorMagicStaff),
            typeof(MagicTrapMagicStaff),
            typeof(FireballMagicStaff),
            typeof(BladeSpiritsMagicStaff),
            typeof(ReactiveArmorMagicStaff),
            typeof(MagicUnlockMagicStaff),
            typeof(FireballMagicStaff),
            typeof(BladeSpiritsMagicStaff),
            typeof(ReactiveArmorMagicStaff),
            typeof(MagicUnlockMagicStaff),
            typeof(FireballMagicStaff),
            typeof(BlessMagicStaff),
            typeof(ReactiveArmorMagicStaff),
            typeof(MagicUnlockMagicStaff),
            typeof(FireballMagicStaff),
            typeof(BlessMagicStaff),
            ...
            typeof(FireballMagicStaff),
            typeof(BlessMagicStaff),
            typeof(RecallMagicStaff),
            typeof(MagicUnlockMagicStaff),
            typeof(FireballMagicStaff),
            typeof(BlessMagicStaff),
            typeof(RecallMagicStaff),
            typeof(MagicUnlockMagicStaff),
            typeof(FireElementalMagicStaff),
            typeof(BlessMagicStaff),
            typeof(RecallMagicStaff),
            typeof(MagicUntrapMagicStaff),
            typeof(FireFieldMagicStaff),
            typeof(BlessMagicStaff),
            typeof(RecallMagicStaff),
            typeof(MagicUntrapMagicStaff),
            typeof(FireFieldMagicStaff),
            typeof(ChainLightningMagicStaff),
            typeof(RecallMagicStaff),
            typeof(MagicUntrapMagicStaff),
            typeof(FireFieldMagicStaff),
            typeof(ChainLightningMagicStaff),
            typeof(ResurrectionMagicStaff),
            typeof(MagicUntrapMagicStaff),
            typeof(FireFieldMagicStaff),
            typeof(ClumsyMagicStaff),
            typeof(RevealMagicStaff),
            typeof(MagicUntrapMagicStaff),
            typeof(FireFieldMagicStaff),
            typeof(ClumsyMagicStaff),
            typeof(RevealMagicStaff),
            typeof(MagicUntrapMagicStaff),
            typeof(FlameStrikeMagicStaff),
            typeof(ClumsyMagicStaff),
            typeof(RevealMagicStaff),
            typeof(MagicUntrapMagicStaff),
            typeof(FlameStrikeMagicStaff),
            typeof(ClumsyMagicStaff),
            typeof(StrengthMagicStaff),
            typeof(ManaDrainMagicStaff),
            typeof(GateTravelMagicStaff),
            typeof(ClumsyMagicStaff),
            typeof(StrengthMagicStaff),
            typeof(ManaDrainMagicStaff),
            typeof(GateTravelMagicStaff),
            ...
            typeof(ManaDrainMagicStaff),
            typeof(GreaterHealMagicStaff),
            typeof(CreateFoodMagicStaff),
            typeof(StrengthMagicStaff),
            typeof(ManaVampireMagicStaff),
            typeof(GreaterHealMagicStaff),
            typeof(CreateFoodMagicStaff),
            typeof(StrengthMagicStaff),
            typeof(ManaVampireMagicStaff),
            typeof(GreaterHealMagicStaff),
            typeof(CreateFoodMagicStaff),
            typeof(SummonCreatureMagicStaff),
            typeof(MarkMagicStaff),
            typeof(HarmMagicStaff),
            typeof(CreateFoodMagicStaff),
            typeof(SummonCreatureMagicStaff),
            typeof(MarkMagicStaff),
            typeof(HarmMagicStaff),
            ...
            typeof(CreateFoodMagicStaff),
            typeof(SummonCreatureMagicStaff),
            typeof(MassCurseMagicStaff),
            typeof(HarmMagicStaff),
            typeof(CreateFoodMagicStaff),
            typeof(SummonDaemonMagicStaff),
            typeof(MassCurseMagicStaff),
            typeof(HarmMagicStaff),
            typeof(CreateFoodMagicStaff),
            typeof(TelekinesisMagicStaff),
            typeof(MassCurseMagicStaff),
            typeof(HarmMagicStaff),
            typeof(CunningMagicStaff),
            typeof(TelekinesisMagicStaff),
            typeof(MassDispelMagicStaff),
            typeof(HarmMagicStaff),
            typeof(CunningMagicStaff),
            typeof(TelekinesisMagicStaff),
            typeof(MassDispelMagicStaff),
            typeof(HealMagicStaff),
            typeof(CunningMagicStaff),
            typeof(TelekinesisMagicStaff),
            typeof(MeteorSwarmMagicStaff),
            typeof(HealMagicStaff),
            typeof(CunningMagicStaff),
            typeof(TelekinesisMagicStaff),
            typeof(MeteorSwarmMagicStaff),
            ...
            typeof(CunningMagicStaff),
            typeof(TelekinesisMagicStaff),
            typeof(MindBlastMagicStaff),
            typeof(HealMagicStaff),
            typeof(CunningMagicStaff),
            typeof(TeleportMagicStaff),
            typeof(MindBlastMagicStaff),
            typeof(HealMagicStaff),
            typeof(CunningMagicStaff),
            typeof(TeleportMagicStaff),
            typeof(MindBlastMagicStaff),
            typeof(HealMagicStaff),
            typeof(CureMagicStaff),
            typeof(TeleportMagicStaff),
            typeof(MindBlastMagicStaff),
            typeof(HealMagicStaff),
            typeof(CureMagicStaff),
            typeof(TeleportMagicStaff),
            typeof(NightSightMagicStaff),
            typeof(HealMagicStaff),
            typeof(CureMagicStaff),
            typeof(TeleportMagicStaff),
            typeof(NightSightMagicStaff),
            typeof(IncognitoMagicStaff),
            typeof(CureMagicStaff),
            typeof(TeleportMagicStaff),
            typeof(NightSightMagicStaff),
            typeof(IncognitoMagicStaff),
            typeof(CureMagicStaff),
            typeof(WallofStoneMagicStaff),
            typeof(NightSightMagicStaff),
            typeof(IncognitoMagicStaff),
            typeof(CureMagicStaff),
            typeof(WallofStoneMagicStaff),
            ...
            typeof(WallofStoneMagicStaff),
            typeof(NightSightMagicStaff),
            typeof(InvisibilityMagicStaff),
            typeof(CurseMagicStaff),
            typeof(WallofStoneMagicStaff),
            typeof(NightSightMagicStaff),
            typeof(InvisibilityMagicStaff),
            typeof(CurseMagicStaff),
            ...
            typeof(CurseMagicStaff),
            typeof(WallofStoneMagicStaff),
            typeof(ParalyzeFieldMagicStaff),
            typeof(LightningMagicStaff),
            typeof(CurseMagicStaff),
            typeof(WaterElementalMagicStaff),
            typeof(ParalyzeFieldMagicStaff),
            typeof(LightningMagicStaff),
            typeof(CurseMagicStaff),
            typeof(WeaknessMagicStaff),
            typeof(ParalyzeFieldMagicStaff),
            typeof(LightningMagicStaff),
            typeof(DispelFieldMagicStaff),
            typeof(WeaknessMagicStaff),
            typeof(ParalyzeMagicStaff),
            typeof(LightningMagicStaff),
            typeof(DispelFieldMagicStaff),
            typeof(WeaknessMagicStaff),
            typeof(ParalyzeMagicStaff),
        ...
        public static Type[] ArtyTypes
        {
            get { return m_ArtyTypes; }
        }

        private static Type[] m_RelicTypes = new Type[]
        {
            typeof(DDRelicCoins),
            typeof(DDRelicClock1),
            typeof(DDRelicClock2),
            typeof(DDRelicClock3),
            typeof(DDRelicLight2),
            typeof(DDRelicLight1),
            typeof(DDRelicLight3),
            typeof(DDRelicVase),
            typeof(DDRelicPainting),
            typeof(DDRelicArts),
            typeof(DDRelicStatue),
            typeof(DDRelicRugAddonDeed),
            typeof(DDRelicWeapon),
            typeof(DDRelicArmor),
            typeof(DDRelicJewels),
            typeof(DDRelicInstrument),
            typeof(DDRelicScrolls),
            typeof(DDRelicCloth),
            typeof(DDRelicFur),
            typeof(DDRelicDrink),
            typeof(DDRelicReagent),
            typeof(DDRelicOrbs),
            typeof(DDRelicVase),
            typeof(DDRelicPainting),
            typeof(DDRelicArts),
            ...
            typeof(DDRelicReagent),
            typeof(DDRelicOrbs),
            typeof(DDRelicBearRugsAddonDeed),
            typeof(DDRelicLeather),
            typeof(DDRelicAlchemy),
            typeof(DDRelicBook),
            typeof(DDRelicBook),
            typeof(DDRelicBook),
            typeof(DDRelicTablet),
            typeof(DDRelicGem),
            typeof(DDRelicBanner)
        };
        public static Type[] RelicTypes
        {
            get { return m_RelicTypes; }
        }
        ...
        public static Type[] SeaTypes
        {
            get { return m_SeaTypes; }
        }

        private static Type[] m_SArtyTypes = new Type[]
        {
            typeof(GoldBricks),
            typeof(BedOfNailsDeed),
            typeof(DecoGinsengRoot),
            typeof(DecoRoseOfTrinsic),
            typeof(PhillipsWoodenSteed),
            typeof(BoneCouchDeed),
            typeof(DecoGinsengRoot2),
            typeof(DecoRoseOfTrinsic2),
            typeof(BoneTableDeed),
            typeof(DecoMandrake),
            typeof(DecoRoseOfTrinsic3),
            typeof(SackOfHolding),
            typeof(SoulStone),
            typeof(BoneThroneDeed),
            typeof(DecoMandrake2),
            typeof(BrokenChair),
            typeof(RedSoulstone),
            typeof(CreepyPortraitDeed),
            typeof(DecoMandrake3),
            typeof(EmptyJar),
            typeof(BlueSoulstone),
            typeof(DisturbingPortraitDeed),
            typeof(DecoMandrakeRoot),
            typeof(DecoFullJar),
            typeof(MinotaurStatueDeed),
            typeof(HaunterMirrorDeed),
            typeof(DecoMandrakeRoot2),
            typeof(HalfEmptyJar),
            typeof(HangingSkeletonDeed),
            typeof(DirtPatch),
            typeof(DecoNightshade),
            typeof(DecoCrystalBall),
            typeof(FlamingHeadDeed),
            typeof(EvilIdolSkull),
            typeof(DecoNightshade2),
            typeof(DecoMagicalCrystal),
            typeof(RewardBrazierDeed),
            typeof(WallBlood),
            typeof(DecoNightshade3),
            typeof(DecoSpittoon),
            typeof(BloodyPentagramDeed),
            typeof(SkullPole),
            typeof(DecoObsidian),
            typeof(DecoDeckOfTarot),
            typeof(AnkhOfSacrificeDeed),
            typeof(MonsterStatueDeed),
            typeof(DecoPumice),
            typeof(DecoDeckOfTarot2),
            typeof(WeaponEngravingTool),
            typeof(DecoStatueDeed),
            typeof(DecoWyrmsHeart),
            typeof(DecoTarot),
            typeof(IronMaidenDeed),
            typeof(GrizzledMareStatuette),
            typeof(DecoArrowShafts),
            typeof(DecoTarot2),
            typeof(StoneStatueDeed),
            typeof(TormentedChains),
            typeof(CrossbowBolts),
            typeof(DecoTarot3),
            ...
            typeof(DecoBloodspawn),
            typeof(EmptyToolKit2),
            typeof(DecoTarot5),
            typeof(MountedPixieGreenDeed),
            typeof(DecoBrimstone),
            typeof(Lockpicks),
            typeof(DecoTarot6),
            typeof(MountedPixieLimeDeed),
            typeof(DecoDragonsBlood),
            typeof(ToolKit),
            typeof(DecoTarot7),
            typeof(MountedPixieOrangeDeed),
            typeof(DecoDragonsBlood2),
            typeof(UnfinishedBarrel),
            typeof(Cards),
            typeof(SacrificialAltarDeed),
            typeof(DecoEyeOfNewt),
            typeof(DecoRock2),
            typeof(Cards2),
            ...
            typeof(DecoGarlicBulb2),
            typeof(DecoFlower),
            typeof(PlayingCards),
            typeof(SuitOfSilverArmorDeed),
            typeof(DecoGinseng),
            typeof(DecoFlower2),
            typeof(PlayingCards2),
            typeof(WoodenCoffinDeed),
            typeof(DecoGinseng2),
            typeof(JokeBook),
            typeof(HorseArmor),
            typeof(Dice4),
            ...
            typeof(Dice12),
            typeof(Dice20),
            typeof(MonsterManual),
            typeof(PlayersHandbook),
            typeof(DungeonMastersGuide),
            typeof(GygaxStatue),
            typeof(DragonOrbStatue),
            typeof(WizardsStatue),
            typeof(PandorasBox),
            typeof(ColoringBook),
        ...
        private static Type[] m_AosClothingTypes = new Type[]
        {
            ...
            typeof(FormalShirt),
            typeof(WhiteFurRobe),
            typeof(WhiteFurBoots),
            typeof(WhiteFurSarong),
            typeof(FurRobe),
            typeof(Boots),
            typeof(Sandals),
            typeof(ThighBoots)
