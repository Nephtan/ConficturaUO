...
namespace Server.Items
{
    ...
    public class CounterFancy : BaseContainer
    {
        ...
        public CounterFancy(Serial serial)
            : base(serial) { }
    ...
    public class CounterWood : BaseContainer
    {
        ...
        public CounterWood(Serial serial)
            : base(serial) { }
    ...
    public class CounterWooden : BaseContainer
    {
        ...
        public CounterWooden(Serial serial)
            : base(serial) { }
    ...
    public class CounterStained : BaseContainer
    {
        ...
        public CounterStained(Serial serial)
            : base(serial) { }
    ...
    public class CounterPolished : BaseContainer
    {
        ...
        public CounterPolished(Serial serial)
            : base(serial) { }
    ...
    public class CounterRustic : BaseContainer
    {
        ...
        public CounterRustic(Serial serial)
            : base(serial) { }
    ...
    public class CounterDark : BaseContainer
    {
        ...
        public CounterDark(Serial serial)
            : base(serial) { }
    ...
    public class CounterLight : BaseContainer
    {
        ...
        public CounterLight(Serial serial)
            : base(serial) { }
    ...
    public class SkullChest : LockableContainer
    {
        ...
        public SkullChest(Serial serial)
            : base(serial) { }
    ...
    public class DynamicFurniture
    {
        ...
        public static bool Open(Container c, Mobile m)
        {
            ...
            if (
                (c is Armoire || c is FancyArmoire || c is SkullChest)
                && !(c.RootParent is Mobile)
                && !(c.RootParent is Corpse)
                && !(c.RootParent is Container)
            )
            {
    ...
    public class FurnitureTimer : Timer
    {
        ...
        {
            if (
                m_Mobile.Map != m_Container.Map
                || !m_Mobile.InRange(m_Container.GetWorldLocation(), 3)
            )
