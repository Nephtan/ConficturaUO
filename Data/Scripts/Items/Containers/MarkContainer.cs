    ...
    public class MarkContainer : LockableContainer
    {
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(SecretLocGen_OnCommand)
            );
        }

        [Usage("SecretLocGen")]
        [Description("Generates mark containers to SerpentIsland secret locations.")]
        public static void SecretLocGen_OnCommand(CommandEventArgs e)
        {
            CreateSerpentIslandPassage(951, 546, -70, 1006, 994, -70, false, false);
            CreateSerpentIslandPassage(914, 192, -79, 1019, 1062, -70, false, false);
            CreateSerpentIslandPassage(1614, 143, -90, 1214, 1313, -90, false, false);
            CreateSerpentIslandPassage(2176, 324, -90, 1554, 172, -90, false, false);
            CreateSerpentIslandPassage(864, 812, -90, 1061, 1161, -70, false, false);
            CreateSerpentIslandPassage(1051, 1434, -85, 1076, 1244, -70, false, true);
            CreateSerpentIslandPassage(1326, 523, -87, 1201, 1554, -70, false, false);
            CreateSerpentIslandPassage(424, 189, -1, 2333, 1501, -90, true, false);
            CreateSerpentIslandPassage(1313, 1115, -85, 1183, 462, -45, false, false);
        ...
        private static void CreateSerpentIslandPassage(
            int x,
            int y,
            int z,
            int xTarget,
