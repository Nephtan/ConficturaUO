...
namespace Server.Items
{
    public class TreasureMapChest : LockableContainer
    {
            ...
            : base(0xE40)
        {
            ...
            {
                case 0:
                    sChest = "meager treasure chest";
                    break;
                case 1:
                    sChest = "simple treasure chest";
                    break;
                case 2:
                    sChest = "good treasure chest";
                    break;
                case 3:
                    sChest = "great treasure chest";
                    break;
                case 4:
                    sChest = "excellent treasure chest";
                    break;
                case 5:
                    sChest = "superb treasure chest";
                    break;
            }
