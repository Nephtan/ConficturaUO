...
namespace Server.Items
{
    ...
    public class SackOfHolding : LargeSack
    {
        ...
        public Mobile Sack_Owner
        {
            get { return SackOwner; }
            set { SackOwner = value; }
        }
        ...
        {
            public BagGump(Mobile from, Container bag)
                : base(50, 50)
            {
                string color = "#b7765d";
                from.SendSound(0x4A);
                ...
                AddHtml(
                    ...
                    200,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">BAG OF HOLDING</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
        ...
        public class BagMenu : ContextMenuEntry
        {
            ...
            public BagMenu(Mobile from, SackOfHolding bag)
                : base(6121, 1)
            {
                m_From = from;
                i_SackOfHolding = bag;
        ...
        public SackOfHolding(Serial serial)
            : base(serial) { }
