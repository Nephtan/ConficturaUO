...
namespace Server.Items
{
    public class GraveChest : SkullChest
    {
        ...
        [Constructable]
        public GraveChest(int level, Mobile digger)
            : base()
        {
            ...
            switch (Utility.RandomMinMax(0, 3))
            {
                case 0:
                    sBox = "casket";
                    ItemID = Utility.RandomList(0x27E9, 0x27EA);
                    GumpID = 0x41D;
                    Weight = 25.0;
                    break;
                case 1:
                    sBox = "sarcophagus";
                    ItemID = Utility.RandomList(0x27E0, 0x280A, 0x2802, 0x2803);
                    GumpID = 0x1D;
                    Weight = 100.0;
                    break;
                case 2:
                    sBox = "coffin";
                    ItemID = Utility.RandomList(0x2800, 0x2801);
                    GumpID = 0x41D;
                    Weight = 25.0;
                    break;
                case 3:
        ...
        public GraveChest(Serial serial)
            : base(serial) { }
