...
namespace Server.Items
{
    ...
    public class SmallBagofHolding : WeightReductionContainer
    {
        ...
        public override bool DisplayWeightReductionProperty
        {
            get { return false; }
        }
    ...
    public abstract class WeightReductionContainer : Container
    {
        ...
        public virtual bool DisplayWeightReductionProperty
        {
            get { return true; }
        }
        ...
        public virtual LootType ContainerLootType
        {
            get { return LootType.Regular; }
        }
        public virtual int ContainerHue
        {
            get { return Utility.RandomMetalHue(); }
        }
        public virtual TimeSpan AccessDelay
        {
            get { return TimeSpan.FromMinutes(5.0); }
        }
        public virtual string AccessDelayMessage
        {
            get { return "You cannot use that item yet"; }
        }
        public virtual string AddAccessMessage
        {
            get { return ""; }
        }
        public virtual string RemoveAccessMessage
        {
            get { return ""; }
        }
        ...
        public new int MaxItems
        {
            ...
            set { base.MaxItems = ContainerMaxItems; }
        }
        ...
        {
            get { return WeightReductionAmount == 1.0 ? 0 : 400; }
        }
        ...
        public WeightReductionContainer(int itemID)
            : base(itemID)
        {
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            if (DateTime.Now < NextAccessTime)
            {
                ...
                from.SendMessage(
                    String.Format(
                        "You will need to wait approximately {0} more minutes before you can try again",
        ...
        public override void UpdateTotal(Item sender, TotalType type, int delta)
        {
            if (type != TotalType.Weight)
                ...
                base.UpdateTotal(
                    sender,
                    type,
                    WeightReductionAmount == 1.0 ? 0 : (int)(delta * (1.0 - WeightReductionAmount))
                );
        }
