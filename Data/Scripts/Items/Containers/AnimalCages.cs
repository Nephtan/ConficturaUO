...
namespace Server.Items
{
    public class BaseCaged : Item
    {
        ...
        public bool ProcessCage(Mobile from)
        {
            ...
            else
            {
                ...
                if (pet.MinTameSkill > 29.0)
                {
                    pet.MinTameSkill = 29.1;
                }
                else if (pet.MinTameSkill <= 0.0)
                {
                    pet.MinTameSkill = 29.1;
                }
        ...
        public static int Cage(string size)
        {
            ...
            {
                item = Utility.RandomList(0x570B, 0x570C);
            }
            else
            {
                item = Utility.RandomList(0x570D, 0x570E);
            }
        ...
        public static int Price(string animal)
        {
            ...
            else if (animal == "BlackBear")
            {
                price = 855;
            }
            else if (animal == "BlackWolf")
            {
                price = 2400;
            }
            else if (animal == "Boar")
            ...
            else if (animal == "DesertOstard")
            {
                price = 700;
            }
            else if (animal == "DireBear")
            {
                price = 2140;
            }
            else if (animal == "DireBoar")
            {
                price = 900;
            }
            else if (animal == "Dog")
            ...
            else if (animal == "ElderBlackBearRiding")
            {
                price = 4230;
            }
            else if (animal == "ElderBrownBearRiding")
            {
                price = 4230;
            }
            else if (animal == "ElderPolarBearRiding")
            {
                price = 4230;
            }
            ...
            else if (animal == "GiantHawk")
            {
                price = 2520;
            }
            else if (animal == "GiantLizard")
            {
                price = 600;
            }
            else if (animal == "GiantRat")
            {
                price = 312;
            }
            else if (animal == "GiantRaven")
            {
                price = 2520;
            }
            else if (animal == "GiantSerpent")
            {
                price = 3720;
            }
            else if (animal == "GiantSnake")
            {
                price = 820;
            }
            else if (animal == "GiantToad")
            {
                price = 734;
            }
            else if (animal == "Goat")
            ...
            else if (animal == "GreatBear")
            {
                price = 2140;
            }
            else if (animal == "GreyWolf")
            {
                price = 1120;
            }
            else if (animal == "GrizzlyBearRiding")
            {
                price = 1767;
            }
            else if (animal == "Hawk")
            ...
            else if (animal == "HugeLizard")
            {
                price = 2520;
            }
            else if (animal == "Jackal")
            {
                price = 1120;
            }
            ...
            else if (animal == "KodiakBear")
            {
                price = 2140;
            }
            else if (animal == "LionRiding")
            {
                price = 2240;
            }
            else if (animal == "ManticoreRiding")
            {
                price = 28320;
            }
            ...
            else if (animal == "PackBear")
            {
                price = 12500;
            }
            else if (animal == "PackHorse")
            {
                price = 631;
            }
            else if (animal == "PackLlama")
            {
                price = 565;
            }
            else if (animal == "PackMule")
            {
                price = 10000;
            }
            else if (animal == "PackStegosaurus")
            {
                price = 15500;
            }
            else if (animal == "PackTurtle")
            {
                price = 14500;
            }
            else if (animal == "PandaRiding")
            {
                price = 1767;
            }
            ...
            else if (animal == "RidableLlama")
            {
                price = 490;
            }
            else if (animal == "Ridgeback")
            {
                price = 1500;
            }
            ...
            else if (animal == "SnowOstard")
            {
                price = 700;
            }
            else if (animal == "SwampDragon")
            {
                price = 1700;
            }
            else if (animal == "TigerRiding")
            {
                price = 2240;
            }
            else if (animal == "TimberWolf")
            {
                price = 768;
            }
            ...
            else if (animal == "WhiteWolf")
            {
                price = 2400;
            }
            else if (animal == "WolfDire")
            {
                price = 2400;
            }
            else if (animal == "ZebraRiding")
            {
                price = 650;
            }
            else if (animal == "GriffonRiding")
            {
                price = 28320;
            }
            else if (animal == "HippogriffRiding")
            {
                price = 28320;
            }
            else if (animal == "PackNecroSpider")
            {
                price = 631;
            }
            else if (animal == "PackNecroHound")
            {
                price = 10000;
            }
        ...
        public BaseCaged(Serial serial)
            : base(serial) { }
    ...
    public class CagedRabbit : BaseCaged
    {
        ...
        public CagedRabbit(Serial serial)
            : base(serial) { }
    ...
    public class CagedHorse : BaseCaged
    {
        ...
        public CagedHorse(Serial serial)
            : base(serial) { }
    ...
    public class CagedAlligator : BaseCaged
    {
        ...
        public CagedAlligator(Serial serial)
            : base(serial) { }
    ...
    public class CagedBlackBear : BaseCaged
    {
        ...
        public CagedBlackBear(Serial serial)
            : base(serial) { }
    ...
    public class CagedBlackWolf : BaseCaged
    {
        ...
        public CagedBlackWolf(Serial serial)
            : base(serial) { }
    ...
    public class CagedBoar : BaseCaged
    {
        ...
        public CagedBoar(Serial serial)
            : base(serial) { }
    ...
    public class CagedBobcat : BaseCaged
    {
        ...
        public CagedBobcat(Serial serial)
            : base(serial) { }
    ...
    public class CagedBrownBear : BaseCaged
    {
        ...
        public CagedBrownBear(Serial serial)
            : base(serial) { }
    ...
    public class CagedBull : BaseCaged
    {
        ...
        public CagedBull(Serial serial)
            : base(serial) { }
    ...
    public class CagedCaveBearRiding : BaseCaged
    {
        ...
        public CagedCaveBearRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedChicken : BaseCaged
    {
        ...
        public CagedChicken(Serial serial)
            : base(serial) { }
    ...
    public class CagedTurkey : BaseCaged
    {
        ...
        public CagedTurkey(Serial serial)
            : base(serial) { }
    ...
    public class CagedCougar : BaseCaged
    {
        ...
        public CagedCougar(Serial serial)
            : base(serial) { }
    ...
    public class CagedDesertOstard : BaseCaged
    {
        ...
        public CagedDesertOstard(Serial serial)
            : base(serial) { }
    ...
    public class CagedDireBear : BaseCaged
    {
        ...
        public CagedDireBear(Serial serial)
            : base(serial) { }
    ...
    public class CagedDireBoar : BaseCaged
    {
        ...
        public CagedDireBoar(Serial serial)
            : base(serial) { }
    ...
    public class CagedEagle : BaseCaged
    {
        ...
        public CagedEagle(Serial serial)
            : base(serial) { }
    ...
    public class CagedElderBlackBearRiding : BaseCaged
    {
        ...
        public CagedElderBlackBearRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedElderBrownBearRiding : BaseCaged
    {
        ...
        public CagedElderBrownBearRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedElderPolarBearRiding : BaseCaged
    {
        ...
        public CagedElderPolarBearRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedElephant : BaseCaged
    {
        ...
        public CagedElephant(Serial serial)
            : base(serial) { }
    ...
    public class CagedFerret : BaseCaged
    {
        ...
        public CagedFerret(Serial serial)
            : base(serial) { }
    ...
    public class CagedForestOstard : BaseCaged
    {
        ...
        public CagedForestOstard(Serial serial)
            : base(serial) { }
    ...
    public class CagedFrog : BaseCaged
    {
        ...
        public CagedFrog(Serial serial)
            : base(serial) { }
    ...
    public class CagedGiantHawk : BaseCaged
    {
        ...
        public CagedGiantHawk(Serial serial)
            : base(serial) { }
    ...
    public class CagedGiantLizard : BaseCaged
    {
        ...
        public CagedGiantLizard(Serial serial)
            : base(serial) { }
    ...
    public class CagedGiantRat : BaseCaged
    {
        ...
        public CagedGiantRat(Serial serial)
            : base(serial) { }
    ...
    public class CagedGiantRaven : BaseCaged
    {
        ...
        public CagedGiantRaven(Serial serial)
            : base(serial) { }
    ...
    public class CagedGiantSerpent : BaseCaged
    {
        ...
        public CagedGiantSerpent(Serial serial)
            : base(serial) { }
    ...
    public class CagedGiantSnake : BaseCaged
    {
        ...
        public CagedGiantSnake(Serial serial)
            : base(serial) { }
    ...
    public class CagedGiantToad : BaseCaged
    {
        ...
        public CagedGiantToad(Serial serial)
            : base(serial) { }
    ...
    public class CagedGoat : BaseCaged
    {
        ...
        public CagedGoat(Serial serial)
            : base(serial) { }
    ...
    public class CagedGorilla : BaseCaged
    {
        ...
        public CagedGorilla(Serial serial)
            : base(serial) { }
    ...
    public class CagedGreatBear : BaseCaged
    {
        ...
        public CagedGreatBear(Serial serial)
            : base(serial) { }
    ...
    public class CagedGreyWolf : BaseCaged
    {
        ...
        public CagedGreyWolf(Serial serial)
            : base(serial) { }
    ...
    public class CagedGrizzlyBearRiding : BaseCaged
    {
        ...
        public CagedGrizzlyBearRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedHawk : BaseCaged
    {
        ...
        public CagedHawk(Serial serial)
            : base(serial) { }
    ...
    public class CagedHugeLizard : BaseCaged
    {
        ...
        public CagedHugeLizard(Serial serial)
            : base(serial) { }
    ...
    public class CagedJackal : BaseCaged
    {
        ...
        public CagedJackal(Serial serial)
            : base(serial) { }
    ...
    public class CagedJaguar : BaseCaged
    {
        ...
        public CagedJaguar(Serial serial)
            : base(serial) { }
    ...
    public class CagedKodiakBear : BaseCaged
    {
        ...
        public CagedKodiakBear(Serial serial)
            : base(serial) { }
    ...
    public class CagedLionRiding : BaseCaged
    {
        ...
        public CagedLionRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedManticoreRiding : BaseCaged
    {
        ...
        public CagedManticoreRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedMouse : BaseCaged
    {
        ...
        public CagedMouse(Serial serial)
            : base(serial) { }
    ...
    public class CagedPackBear : BaseCaged
    {
        ...
        public CagedPackBear(Serial serial)
            : base(serial) { }
    ...
    public class CagedPackHorse : BaseCaged
    {
        ...
        public CagedPackHorse(Serial serial)
            : base(serial) { }
    ...
    public class CagedPackLlama : BaseCaged
    {
        ...
        public CagedPackLlama(Serial serial)
            : base(serial) { }
    ...
    public class CagedPackMule : BaseCaged
    {
        ...
        public CagedPackMule(Serial serial)
            : base(serial) { }
    ...
    public class CagedPackStegosaurus : BaseCaged
    {
        ...
        public CagedPackStegosaurus(Serial serial)
            : base(serial) { }
    ...
    public class CagedPackTurtle : BaseCaged
    {
        ...
        public CagedPackTurtle(Serial serial)
            : base(serial) { }
    ...
    public class CagedPandaRiding : BaseCaged
    {
        ...
        public CagedPandaRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedPanther : BaseCaged
    {
        ...
        public CagedPanther(Serial serial)
            : base(serial) { }
    ...
    public class CagedPolarBear : BaseCaged
    {
        ...
        public CagedPolarBear(Serial serial)
            : base(serial) { }
    ...
    public class CagedRaptorRiding : BaseCaged
    {
        ...
        public CagedRaptorRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedRidableLlama : BaseCaged
    {
        ...
        public CagedRidableLlama(Serial serial)
            : base(serial) { }
    ...
    public class CagedRidgeback : BaseCaged
    {
        ...
        public CagedRidgeback(Serial serial)
            : base(serial) { }
    ...
    public class CagedSheep : BaseCaged
    {
        ...
        public CagedSheep(Serial serial)
            : base(serial) { }
    ...
    public class CagedSnowOstard : BaseCaged
    {
        ...
        public CagedSnowOstard(Serial serial)
            : base(serial) { }
    ...
    public class CagedSwampDragon : BaseCaged
    {
        ...
        public CagedSwampDragon(Serial serial)
            : base(serial) { }
    ...
    public class CagedTigerRiding : BaseCaged
    {
        ...
        public CagedTigerRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedTimberWolf : BaseCaged
    {
        ...
        public CagedTimberWolf(Serial serial)
            : base(serial) { }
    ...
    public class CagedWhiteWolf : BaseCaged
    {
        ...
        public CagedWhiteWolf(Serial serial)
            : base(serial) { }
    ...
    public class CagedWolfDire : BaseCaged
    {
        ...
        public CagedWolfDire(Serial serial)
            : base(serial) { }
    ...
    public class CagedZebraRiding : BaseCaged
    {
        ...
        public CagedZebraRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedGriffonRiding : BaseCaged
    {
        ...
        public CagedGriffonRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedHippogriffRiding : BaseCaged
    {
        ...
        public CagedHippogriffRiding(Serial serial)
            : base(serial) { }
    ...
    public class CagedPackNecroSpider : BaseCaged
    {
        ...
        public CagedPackNecroSpider(Serial serial)
            : base(serial) { }
    ...
    public class CagedPackNecroHound : BaseCaged
    {
        ...
        public CagedPackNecroHound(Serial serial)
            : base(serial) { }
