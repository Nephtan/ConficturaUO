...
namespace Server.Multis
{
    public class GalleonBarbarian : BaseBoat
    {
        ...
        public GalleonBarbarian(Serial serial)
            : base(serial) { }
    ...
    public class GalleonRoyal : BaseBoat
    {
        ...
        public GalleonRoyal(Serial serial)
            : base(serial) { }
    ...
    public class GalleonExotic : BaseBoat
    {
        ...
        public GalleonExotic(Serial serial)
            : base(serial) { }
    ...
    public class GalleonLarge : BaseBoat
    {
        ...
        public GalleonLarge(Serial serial)
            : base(serial) { }
    ...
    public class GalleonWreckedBarbarian : BaseBoat
    {
        ...
        public GalleonWreckedBarbarian(Serial serial)
            : base(serial) { }
    ...
    public class GalleonWreckedRoyal : BaseBoat
    {
        ...
        public GalleonWreckedRoyal(Serial serial)
            : base(serial) { }
    ...
    public class GalleonWreckedExotic : BaseBoat
    {
        ...
        public GalleonWreckedExotic(Serial serial)
            : base(serial) { }
    ...
    public class GalleonWreckedLarge : BaseBoat
    {
        ...
        public GalleonWreckedLarge(Serial serial)
            : base(serial) { }
    ...
    public class GalleonRuinedBarbarian : BaseBoat
    {
        ...
        public GalleonRuinedBarbarian(Serial serial)
            : base(serial) { }
    ...
    public class GalleonRuinedRoyal : BaseBoat
    {
        ...
        public GalleonRuinedRoyal(Serial serial)
            : base(serial) { }
    ...
    public class GalleonRuinedExotic : BaseBoat
    {
        ...
        public GalleonRuinedExotic(Serial serial)
            : base(serial) { }
