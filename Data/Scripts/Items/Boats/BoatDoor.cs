...
namespace Server.Items
{
    public class BoatDoor : Item
    {
        ...
        public void DoBoatDoor(Mobile m)
        {
            ...
            {
                ((PlayerMobile)m).CharacterBoatDoor =
                    this.Serial.ToString() + "#" + BoatCode + "#" + sWorld;
        ...
        {
            bool inCombat = (
                m.Combatant != null && m.InRange(m.Combatant.Location, 20) && m.Combatant.InLOS(m)
            );
    ...
    public class DeckDoor : Item
    {
        ...
        public void DoDeckDoor(Mobile m)
        {
            ...
            if (m is PlayerMobile)
            {
                ...
                if (
                    Server.Misc.Worlds.GetRegionName(m.Map, m.Location) == "the Ship's Lower Deck"
                    && sCabinDoor != null
                )
                {
