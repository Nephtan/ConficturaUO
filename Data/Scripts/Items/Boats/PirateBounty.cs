...
namespace Server.Items
{
    public class PirateBounty : Item
    {
        ...
        public int Bounty_Value
        {
            get { return BountyValue; }
            set
            {
                BountyValue = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Bounty_Who
        {
            get { return BountyWho; }
            set
            {
                BountyWho = value;
                InvalidateProperties();
        ...
        {
            public BountyGump(Mobile from, PirateBounty bounty)
                : base(50, 50)
            {
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Bounties are often placed on famous pirates that sail the high seas and create havoc in their pursuit for booty. Giving this bounty contract to a town guard will reward you with the listed gold.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    65,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Bounty:</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
        ...
        public PirateBounty(Serial serial)
            : base(serial) { }
