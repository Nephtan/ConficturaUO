...
namespace Server.Multis
{
    ...
    public abstract class BaseBoat : BaseMulti
    {
        ...
        private static Rectangle2D[] m_FelWrap = new Rectangle2D[]
        {
            new Rectangle2D(16, 16, 5120 - 32, 4096 - 32)
        };
        private static Rectangle2D[] m_TramWrap = new Rectangle2D[]
        {
            new Rectangle2D(16, 16, 5120 - 32, 3127 - 32)
        };
        private static Rectangle2D[] m_SerpentIslandWrap = new Rectangle2D[]
        {
            new Rectangle2D(16, 16, 1870 - 32, 2047 - 32)
        };
        private static Rectangle2D[] m_AmbrosiaWrap = new Rectangle2D[]
        {
            new Rectangle2D(5122 + 16, 3036 + 16, 1004 - 32, 1059 - 32)
        };
        private static Rectangle2D[] m_IslesDreadWrap = new Rectangle2D[]
        {
            new Rectangle2D(16, 16, 1447 - 32, 1447 - 32)
        };
        private static Rectangle2D[] m_BottleWrap = new Rectangle2D[]
        {
            new Rectangle2D(6127 + 16, 828 + 16, 1040 - 32, 1915 - 32)
        };
        private static Rectangle2D[] m_UmberWrap = new Rectangle2D[]
        {
            new Rectangle2D(699 + 16, 3129 + 16, 1573 - 32, 966 - 32)
        };
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public BoatDoor BoatDoor
        {
            get { return m_BoatDoor; }
            set { m_BoatDoor = value; }
        }
        ...
        public virtual int BoatDoorDistance
        {
            get { return -2; }
        }
        ...
        {
            if (
                rug is MagicCarpetADeed
                || rug is MagicDockedCarpetA
                || rug is MagicCarpetBDeed
                || rug is MagicDockedCarpetB
                || rug is MagicCarpetCDeed
                || rug is MagicDockedCarpetC
                || rug is MagicCarpetDDeed
                || rug is MagicDockedCarpetD
                || rug is MagicCarpetEDeed
                || rug is MagicDockedCarpetE
                || rug is MagicCarpetFDeed
                || rug is MagicDockedCarpetF
                || rug is MagicCarpetGDeed
                || rug is MagicDockedCarpetG
                || rug is MagicCarpetHDeed
                || rug is MagicDockedCarpetH
                || rug is MagicCarpetIDeed
                || rug is MagicDockedCarpetI
            )
                return true;
        ...
        public static int translateText(BaseBoat boat, int text)
        {
            if (isCarpet(boat))
            {
                ...
                else if (text == 1007168)
                {
                    text = 1041563;
                }
                else if (text == 1007169)
                {
                    text = 1041563;
                }
                else if (text == 1007170)
                {
                    text = 1041563;
                }
                else if (text == 1007171)
                {
                    text = 1041563;
                }
                else if (text == 1007172)
                {
                    text = 1041563;
                }
                else if (text == 1042551)
                {
                    text = 1041554;
                }
                else if (text == 1042874)
                {
                    text = 1041560;
                }
                else if (text == 1042875)
                {
                    text = 1041561;
                }
                else if (text == 1042876)
                {
                    text = 1041564;
                }
                else if (text == 1042877)
                {
                    text = 1041564;
                }
                else if (text == 1042878)
                {
                    text = 1041564;
                }
                else if (text == 1042879)
                {
                    text = 1041564;
                }
                else if (text == 1042880)
                {
                    text = 1041542;
                }
                else if (text == 1042881)
                {
                    text = 1041558;
                }
                else if (text == 1042882)
                {
                    text = 1041546;
                }
                else if (text == 1042883)
                {
                    text = 1041562;
                }
                else if (text == 1042885)
                ...
                else if (text == 1043010)
                {
                    text = 1041565;
                }
                else if (text == 1043011)
                {
                    text = 1041566;
                }
                else if (text == 1043012)
                {
                    text = 1041567;
                }
                else if (text == 1043013)
                {
                    text = 1041568;
                }
                else if (text == 1043014)
                {
                    text = 1041569;
                }
                else if (text == 1043015)
                {
                    text = 1041570;
                }
                else if (text == 502484)
        ...
        public void UpdateComponents()
        {
            ...
            if (m_TillerMan != null)
            {
                m_TillerMan.Location = new Point3D(
            ...
            if (m_Hold != null)
            {
                m_Hold.Location = new Point3D(
                    X + (xOffset * HoldDistance),
                    Y + (yOffset * HoldDistance),
                    m_Hold.Z
                );
            ...
            if (m_BoatDoor != null)
            {
                m_BoatDoor.Location = new Point3D(
                    X + (xOffset * BoatDoorDistance),
                    Y + (yOffset * BoatDoorDistance),
                    m_BoatDoor.Z
                );
        ...
        public static SunkenShip CreateSunkenShip(Mobile from, Mobile killer)
        {
            ...
            string shipName = "";
            if (from is BaseSailor)
            {
                ShipWreck.Name = "sunken boat";
                if (cycle > 1)
                {
                    cycle = 1;
                }
            ...
            while (cycle > 0)
            {
                ...
                if (from.Karma < 0)
                {
                    cargo.CargoKarma = (int)(cargo.CargoValue / 5);
                }
            ...
            {
                Item i1 = new RawFishSteak(Utility.RandomMinMax(1, 8));
                ShipWreck.DropItem(i1);
            }
            if (Utility.RandomMinMax(1, 4) == 1)
            {
                Item i2 = new Fish(Utility.RandomMinMax(1, 8));
                ShipWreck.DropItem(i2);
            }
            if (Utility.RandomMinMax(1, 4) == 1)
            {
                Item i3 = new FishingPole();
                ShipWreck.DropItem(i3);
            }
            if (Utility.RandomMinMax(1, 4) == 1)
            {
                Item i4 = new NewFish();
                ShipWreck.DropItem(i4);
            }
            if (Utility.RandomMinMax(1, 4) == 1)
            {
                Item i5 = new Sextant();
                ShipWreck.DropItem(i5);
            }
            ...
            if (killer is PlayerMobile)
            {
                if (GetPlayerInfo.LuckyKiller(killer.Luck) && Utility.RandomMinMax(1, 4) == 1)
                {
                    ...
                    if (from.Karma > 0)
                    {
                        MyChest.Name = "Chest Seized from " + from.Name + " " + from.Title;
                    }
        ...
        public static void SinkShip(BaseBoat boat, Mobile captain)
        {
            if (boat != null)
            {
                ...
                {
                    if (
                        sailors.EmoteHue == boat.Serial
                        && sailors != captain
                        && (
                            sailors is BasePirate
                            || sailors.Name == "a follower"
                            || sailors.Name == "a sailor"
                            || sailors.Name == "a pirate"
                        )
                    )
                    {
                        crew.Add(sailors);
        ...
        public override void OnLocationChange(Point3D old)
        {
            if (IsNPCBoat(this))
            {
                ...
                PPlank.ItemID = 0x0F7A;
                SPlank.Visible = false;
                SPlank.ItemID = 0x0F7A;
                TillerMan.Visible = false;
                TillerMan.ItemID = 0x0F7A;
                Hold.Visible = false;
                Hold.ItemID = 0x0F7A;
                BoatDoor.Visible = false;
                BoatDoor.ItemID = 0x0F7A;
                BoatDoor.Name = "enemy ship";
                BoatDoor.Z = BoatDeckZ(this);
            }
            else
            {
                if (m_TillerMan != null)
                    m_TillerMan.Location = new Point3D(
                        X + (m_TillerMan.X - old.X),
                        Y + (m_TillerMan.Y - old.Y),
                        Z + (m_TillerMan.Z - old.Z)
                    );
                ...
                if (m_BoatDoor != null)
                    m_BoatDoor.Location = new Point3D(
                        X + (m_BoatDoor.X - old.X),
                        Y + (m_BoatDoor.Y - old.Y),
                        Z + (m_BoatDoor.Z - old.Z)
                    );

                if (m_PPlank != null)
                    m_PPlank.Location = new Point3D(
                        X + (m_PPlank.X - old.X),
                        Y + (m_PPlank.Y - old.Y),
                        Z + (m_PPlank.Z - old.Z)
                    );
        ...
        {
            int z = -2;
            if (boat is GalleonBarbarian)
            {
                z = 9;
            }
            else if (boat is GalleonRoyal)
            {
                z = 11;
            }
            else if (boat is GalleonExotic)
            {
                z = 9;
            }
            else if (boat is GalleonLarge)
            {
                z = 13;
            }
            else if (boat is GalleonWreckedBarbarian)
            {
                z = 9;
            }
            else if (boat is GalleonWreckedRoyal)
            {
                z = 11;
            }
            else if (boat is GalleonWreckedExotic)
            {
                z = 9;
            }
            else if (boat is GalleonWreckedLarge)
            {
                z = 13;
            }
            else if (boat is GalleonRuinedBarbarian)
            {
                z = 9;
            }
            else if (boat is GalleonRuinedRoyal)
            {
                z = 11;
            }
            else if (boat is GalleonRuinedExotic)
            {
                z = 9;
            }
        ...
        public bool StartMove(Direction dir, bool fast)
        {
            ...
            TimeSpan interval = (
                fast
                    ? (drift ? FastDriftInterval : FastInterval)
                    : (drift ? SlowDriftInterval : SlowInterval)
            );
            int speed = (
                fast ? (drift ? FastDriftSpeed : FastSpeed) : (drift ? SlowDriftSpeed : SlowSpeed)
            );
        ...
        public DryDockResult CheckDryDock(Mobile from)
        {
            ...
            if (
                (m_SPlank == null || !Key.ContainsKey(pack, m_SPlank.KeyValue))
                && (
                    m_PPlank == null
                    || (
                        !Key.ContainsKey(pack, m_PPlank.KeyValue)
                        && !Key.ContainsKey(bank, m_PPlank.KeyValue)
                    )
                )
            )
            ...
            IPooledEnumerable eable = map.GetObjectsInBounds(
                new Rectangle2D(X + mcl.Min.X, Y + mcl.Min.Y, mcl.Width, mcl.Height)
            );
        ...
        public void EndDryDock(Mobile from, int hue)
        {
            ...
            foreach (Mobile stow in World.Mobiles.Values)
                if (stow is PlayerMobile && stow.Region.Name == "the Ship's Lower Deck")
                {
                    ...
                    if (
                        this.m_BoatDoor.Serial.ToString() == sSerial
                        && this.m_BoatDoor.BoatCode == sCode
                    )
                    {
        ...
        public bool CanFit(Point3D p, Map map, int itemID)
        {
            ...
            foreach (Item item in eable)
            {
                ...
                if (
                    x >= 0
                    && x < newComponents.Width
                    && y >= 0
                    && y < newComponents.Height
            ...
            else
            {
                ...
                if (maxSpeed == 0)
                {
                    if (message && this.Order == BoatOrder.Single && TillerMan != null)
                        TillerMan.Say(
                            BaseBoat.translateText(this, 1042874),
                    ...
                    if (NextNavPoint + 1 < MapItem.Pins.Count)
                    {
                        ...
                        if (this.Order == BoatOrder.Course)
                        {
                            if (message && TillerMan != null)
                                TillerMan.Say(
                                    BaseBoat.translateText(this, 1042875),
                                    (NextNavPoint + 1).ToString()
        ...
        public void Teleport(int xOffset, int yOffset, int zOffset)
        {
            ...
            IPooledEnumerable eable = this.Map.GetObjectsInBounds(
                new Rectangle2D(X + mcl.Min.X, Y + mcl.Min.Y, mcl.Width, mcl.Height)
            );
            ...
            foreach (object o in eable)
            {
                if (o is Item)
                {
                    ...
                    if (
                        ...
                        && item.Visible
                        && item.Z >= Z
                        && !(item is TillerMan || item is Hold || item is Plank || item is BoatDoor)
                    )
                        toMove.Add(item);
                }
                else if (o is Mobile && Contains((Mobile)o))
