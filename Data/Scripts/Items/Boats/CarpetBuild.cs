...
namespace Server.Items
{
    public class CarpetBuild : Item
    {
        ...
        {
            public RugGump(Mobile from, int gold, int cloth)
                : base(50, 50)
            {
                from.SendSound(0x4A);
                string color = "#9ab9cb";
                ...
                AddHtml(
                    ...
                    357,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">THE CARPET OF ALADDIN</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
        ...
        public CarpetBuild(Serial serial)
            : base(serial) { }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveCloth
        {
            get { return HaveCloth; }
            set { HaveCloth = value; }
        }
    }
}
