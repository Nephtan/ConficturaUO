    ...
    public class FindboatGump : Gump
    {
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(FindBoat_OnCommand)
            );
        }
            ...
            : base(50, 40)
        {
            ...
            AddLabel(
                ...
                290,
                93,
                String.Format("Sailor Boat Locator             {0} Boats are on the water", boats)
            );
        ...
        private void AddDetails(int index)
        {
            if (index < m_List.Count)
            {
                ...
                AddLabel(
                    ...
                    40 + (row * 20),
                    1152,
                    String.Format("{0} {1}", boat.GetWorldLocation(), boat.Map)
                );
