...
namespace Knives.TownHouses
{
    public class RentalContract : TownHouseSign
    {
        ...
        public BaseHouse ParentHouse
        {
            get { return c_ParentHouse; }
        }
        ...
        public Mobile RentalMaster
        {
            get { return c_RentalMaster; }
        }
        ...
        public bool EntireHouse
        {
            get { return c_EntireHouse; }
        ...
        public bool HasContractedArea(Rectangle2D rect, int z)
        {
            foreach (Item item in TownHouseSign.AllSigns)
                if (
                    ...
                    && item != this
                    && item.Map == Map
                    && c_ParentHouse == ((RentalContract)item).ParentHouse
                )
        ...
        protected override void DemolishAlert()
        {
            ...
            c_RentalMaster.SendMessage(
                ...
                c_RentalClient.Name,
                Math.Round((DemolishTime - DateTime.Now).TotalHours, 2)
            );
        ...
        protected override void OnRentPaid()
        {
            ...
            c_RentalMaster.SendMessage(
                "The bank has transfered your rent from {0}.",
                c_RentalClient.Name
            );
        }
        ...
        public override void Delete()
        {
            ...
            else
            {
                ...
                {
                    c_RentalMaster.SendMessage(
                        "{0} has ended your rental agreement.",
                        c_RentalClient.Name
                    );
                    c_RentalClient.SendMessage(
                        "You have ended your rental agreement with {0}.",
                        c_RentalMaster.Name
                    );
                }
