...
namespace Knives.TownHouses
{
    ...
    public class TownHouseSign : Item
    {
        ...
        private ArrayList c_Blocks,
            c_DecoreItemInfos,
            c_PreviewItems;
        private TownHouse c_House;
        private Timer c_DemolishTimer,
            c_RentTimer,
            c_PreviewTimer;
        private DateTime c_DemolishTime,
            c_RentTime;
        private TimeSpan c_RentByTime,
            c_OriginalRentTime;
        ...
        protected void ConvertDoor(BaseDoor door)
        {
            ...
            GenericHouseDoor newdoor = new GenericHouseDoor(
                (DoorFacing)0,
                door.ClosedID,
                door.OpenedSound,
                door.ClosedSound
        ...
        private void RentDue()
        {
            ...
            if (
                !c_Free
                && c_House.Owner.AccessLevel == AccessLevel.Player
