    ...
    public class TownHousesGump : GumpPlusLight
    {
        ...
        public static void Initialize()
        {
            RUOVersion.AddCommand(
                ...
                new TownHouseCommandHandler(OnHouses)
            );
        }
        ...
        protected override void BuildGump()
        {
            ...
            AddHtml(
                ...
                width,
                "<CENTER>"
                    + (c_ListPage == ListPage.Town ? "TownHouses" : "Houses")
                    + " Count: "
                    + list.Count
            );
            ...
            AddButton(
                width / 2 - 100,
                y + 3,
                c_ListPage == ListPage.Town ? 0x939 : 0x2716,
                "Page",
            ...
            AddButton(
                width / 2 + 90,
                y + 3,
                c_ListPage == ListPage.House ? 0x939 : 0x2716,
                "Page",
                new GumpStateCallback(Page),
                ListPage.House
            );
            ...
            for (int i = c_Page * pp; i < (c_Page + 1) * pp && i < list.Count; ++i)
            {
                if (c_ListPage == ListPage.Town)
                {
                    ...
                    AddButton(
                        ...
                        0x2716,
                        "TownHouse Menu",
                        new GumpStateCallback(TownHouseMenu),
                        sign
                    );
                    ...
                    if (sign.House != null && sign.House.Owner != null)
                    {
                        AddHtml(
                            ...
                            y,
                            width / 2 - 40,
                            "<DIV ALIGN=RIGHT>" + sign.House.Owner.RawName
                        );
                        AddButton(
                            width - 30,
                            y + 3,
                            0x2716,
                            "House Menu",
                            new GumpStateCallback(HouseMenu),
                            sign.House
                        );
                    }
                }
                else
                {
                    ...
                    if (house.Owner != null)
                    {
                        AddHtml(
                            ...
                            y,
                            width / 2 - 40,
                            "<DIV ALIGN=RIGHT>" + house.Owner.RawName
                        );
                        AddButton(
                            width - 30,
                            y + 3,
