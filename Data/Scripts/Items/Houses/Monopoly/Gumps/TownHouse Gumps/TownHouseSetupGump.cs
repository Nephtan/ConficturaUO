    ...
    public class TownHouseSetupGump : GumpPlusLight
    {
        ...
        private void BuildTabs(int width, ref int y)
        {
            ...
            AddButton(
                x += 20,
                y,
                c_Page == Page.Welcome ? 0x939 : 0x93A,
                "Welcome Page",
            ...
            AddButton(
                x += 20,
                y,
                c_Page == Page.Blocks ? 0x939 : 0x93A,
                "Blocks Page",
                new GumpStateCallback(ChangePage),
                1
            );
            ...
            if (c_Sign.BlocksReady)
            {
                AddButton(
                    x += 20,
                    y,
                    c_Page == Page.Floors ? 0x939 : 0x93A,
                    "Floors Page",
                    new GumpStateCallback(ChangePage),
                    2
                );
            ...
            if (c_Sign.BanReady)
            {
                AddButton(
                    x += 20,
                    y,
                    c_Page == Page.LocSec ? 0x939 : 0x93A,
                    "LocSec Page",
                    new GumpStateCallback(ChangePage),
                    5
                );
            ...
            if (c_Sign.LocSecReady)
            {
                ...
                if (!c_Sign.Owned)
                {
                    AddButton(
                        x += 20,
                        y,
                        c_Page == Page.Length ? 0x939 : 0x93A,
                        "Length Page",
                        new GumpStateCallback(ChangePage),
                        7
                    );
            ...
            if (c_Sign.PriceReady)
            {
                AddButton(
                    x += 20,
                    y,
                    c_Page == Page.Skills ? 0x939 : 0x93A,
                    "Skills Page",
                    new GumpStateCallback(ChangePage),
                    9
                );
                ...
                AddButton(
                    x += 20,
                    y,
                    c_Page == Page.Other2 ? 0x939 : 0x93A,
                    "Other Page 2",
                    new GumpStateCallback(ChangePage),
                    11
                );
        ...
        private void QuickPage(int width, ref int y)
        {
            ...
            AddButton(
                ...
                0x2716,
                "Suggest LocSec",
                new GumpCallback(SuggestLocSec)
            );
            AddButton(
                width / 2 + 60,
                y + 3,
            ...
            AddButton(
                width / 2 - 110,
                y,
                c_Sign.KeepItems ? 0xD3 : 0xD2,
                "Keep Items",
                new GumpCallback(KeepItems)
            );
            AddButton(
                width / 2 + 90,
                y,
            ...
            else
            {
                ...
                AddButton(
                    width / 2 - 110,
                    y,
                    c_Sign.LeaveItems ? 0xD3 : 0xD2,
                    "LeaveItems",
                    new GumpCallback(LeaveItems)
                );
                AddButton(
                    width / 2 + 90,
                    y,
            ...
            if (c_Sign.RentByTime != TimeSpan.Zero)
            {
                ...
                AddButton(
                    width / 2 - 80,
                    y,
                    c_Sign.RecurRent ? 0xD3 : 0xD2,
                    "RecurRent",
                    new GumpCallback(RecurRent)
                );
                AddButton(
                    width / 2 + 60,
                    y,
                ...
                if (c_Sign.RecurRent)
                {
                    ...
                    AddButton(
                        width / 2 - 80,
                        y,
                        c_Sign.RentToOwn ? 0xD3 : 0xD2,
                        "RentToOwn",
                        new GumpCallback(RentToOwn)
                    );
                    AddButton(
                        width / 2 + 60,
                        y,
            ...
            if (!c_Sign.Free)
            {
                AddHtml(
                    ...
                    y += 25,
                    width / 2 - 20,
                    "<DIV ALIGN=RIGHT>" + c_Sign.PriceType + " Price"
                );
                AddTextField(
                    width / 2 + 20,
                    y,
        ...
        private void WelcomePage(int width, ref int y)
        {
            ...
            if (c_Sign.Owned)
            {
                helptext = String.Format(
                    "  This home is owned by {0}, so be aware that changing anything "
            ...
            {
                helptext = String.Format(
                    "  Welcome to the TownHouse setup menu!  This menu will guide you through "
        ...
        private void BlocksPage(int width, ref int y)
        {
            ...
            string helptext = String.Format(
                "   Setup begins with defining the area you wish to sell or rent.  "
        ...
        private void FloorsPage(int width, ref int y)
        {
            ...
            string helptext = String.Format(
                "   Now you will need to target the floors you wish to sell.  "
        ...
        private void SignPage(int width, ref int y)
        {
            ...
            string helptext = String.Format(
                "   With this sign, the owner will have the same home owning rights "
        ...
        private void BanPage(int width, ref int y)
        {
            ...
            string helptext = String.Format(
                "   The ban location determines where players are sent when ejected or "
        ...
        private void LocSecPage(int width, ref int y)
        {
            ...
            string helptext = String.Format(
                "   With this step you'll set the amount of storage for the home, or let "
        ...
        private void ItemsPage(int width, ref int y)
        {
            ...
            string helptext = String.Format(
                "   By default, the system will delete all items non-static items already "
        ...
        private void LengthPage(int width, ref int y)
        {
            ...
            string helptext = String.Format(
                "   Getting closer to completing the setup!  Now you get to specify whether "
        ...
        private void PricePage(int width, ref int y)
        {
            ...
            string helptext = String.Format(
                "   Now you get to set the price for the home.  Remember, if this is a "
        ...
        private void OtherPage(int width, ref int y)
        {
            ...
            AddButton(
                width / 2 - 80,
                y,
                c_Sign.YoungOnly ? 0xD3 : 0xD2,
                "Young Only",
                new GumpCallback(Young)
            );
            AddButton(
                width / 2 + 60,
                y,
            ...
            if (!c_Sign.YoungOnly)
            {
                ...
                AddButton(
                    width / 2 - 80,
                    y,
                    c_Sign.Murderers == Intu.No ? 0xD3 : 0xD2,
                    "No Murderers",
                    new GumpStateCallback(Murderers),
                    Intu.No
                );
                AddButton(
                    width / 2 + 60,
                ...
                AddButton(
                    width / 2 - 80,
                    y,
                    c_Sign.Murderers == Intu.Yes ? 0xD3 : 0xD2,
                    "Yes Murderers",
                    new GumpStateCallback(Murderers),
                    Intu.Yes
                );
            ...
            AddButton(
                width / 2 - 110,
                y,
                c_Sign.Relock ? 0xD3 : 0xD2,
                "Relock",
                new GumpCallback(Relock)
            );
            AddButton(
                width / 2 + 90,
                y,
        ...
        private void OtherPage2(int width, ref int y)
        {
            ...
            AddButton(
                width / 2 - 110,
                y,
                c_Sign.ForcePublic ? 0xD3 : 0xD2,
                "Public",
                new GumpCallback(ForcePublic)
            );
            AddButton(
                width / 2 + 90,
                y,
            ...
            AddButton(
                width / 2 - 110,
                y,
                c_Sign.ForcePrivate ? 0xD3 : 0xD2,
                "Private",
                new GumpCallback(ForcePrivate)
            );
            AddButton(
                width / 2 + 90,
                y,
            ...
            AddButton(
                width / 2 - 110,
                y,
                c_Sign.NoTrade ? 0xD3 : 0xD2,
                "NoTrade",
                new GumpCallback(NoTrade)
            );
            AddButton(
                width / 2 + 90,
                y,
            ...
            AddButton(
                width / 2 - 110,
                y,
                c_Sign.NoBanning ? 0xD3 : 0xD2,
                "NoBan",
                new GumpCallback(NoBan)
            );
            AddButton(
                width / 2 + 90,
                y,
