...
namespace Server.Items
{
    ...
    public class ShantyItem : ShantyPiece
    {
            ...
            : base(itemID, itemName)
        {
            ...
            if (
                ShantyRegistry.ShantyMultiIDs.ContainsKey(ItemID)
                && ShantyRegistry.ShantyMultiIDs[ItemID] != null
            )
            {
                ShantyPiece piece;
        ...
        public ShantyItem(Serial serial)
            : base(serial) { }
        #endregion
    ...
    public class ShantyPiece : Item
    {
        ...
        public ShantyPiece(int itemID, string name)
            : this(itemID, name, null) { }

        public ShantyPiece(int itemID, string name, ShantyItem multiParent)
            : base(itemID)
        {
            Movable = false;
            Name = name;
        ...
        public ShantyPiece(Serial serial)
            : base(serial) { }
