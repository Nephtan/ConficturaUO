...
namespace Server.Misc
{
    public class StairRefundEntry : ContextMenuEntry
    {
        ...
        public StairRefundEntry(Mobile from, LawnStair stair, int price)
            : base(6104, 9)
        {
            m_From = from;
            m_Stair = stair;
    ...
    public class LawnSecurityEntry : ContextMenuEntry
    {
        ...
        public LawnSecurityEntry(Mobile from, LawnGate gate)
            : base(6203, 9)
        {
            m_From = from;
            m_Gate = gate;
    ...
    public class RefundEntry : ContextMenuEntry
    {
        ...
        public RefundEntry(Mobile from, LawnGate gate, int price)
            : base(6104, 9)
        {
            m_From = from;
            m_Gate = gate;
    ...
    public class ShantyStairShantyRefundEntry : ContextMenuEntry
    {
        ...
        public ShantyStairShantyRefundEntry(Mobile from, ShantyStair stair, int price)
            : base(6104, 9)
        {
            m_From = from;
            m_Stair = stair;
    ...
    public class ShantySecurityEntry : ContextMenuEntry
    {
        ...
        public ShantySecurityEntry(Mobile from, ShantyDoor gate)
            : base(6203, 9)
        {
            m_From = from;
            m_Gate = gate;
    ...
    public class ShantyRefundEntry : ContextMenuEntry
    {
        ...
        public ShantyRefundEntry(Mobile from, ShantyDoor gate, int price)
            : base(6104, 9)
        {
            m_From = from;
            m_Gate = gate;
