    ...
    public class ShantyDoor : BaseDoor
    {
        ...
        public ShantyDoor(
            ...
            : base(
                itemID,
                itemID + 1,
                GetOpenedSound(itemID),
                GetClosedSound(itemID),
            ...
            )
        {
            ...
            if (itemID > 40000)
            {
                ItemID = itemID = itemID - Remodeling.GroundID(title);
            }
        }

        public ShantyDoor(Serial serial)
            : base(serial) { }
        #endregion
        ...
        {
            if ((itemID >= 2084 && itemID <= 2098) || (itemID >= 2124 && itemID <= 2138))
            {
                return 243;
            }
            else if ((itemID >= 2105 && itemID <= 2119) || (itemID >= 2150 && itemID <= 2162))
            {
                return 242;
            }
            else if (
