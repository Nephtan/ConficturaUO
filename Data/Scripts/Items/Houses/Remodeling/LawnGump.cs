    ...
    public class LawnGump : Gump
    {
            ...
            : base(-40, 50)
        {
            ...
            if (currentPage == 999998)
            {
                ...
                text += "<br><br>";
                text +=
                    "When you demolish a home, the items surrounding the house will be automatically removed and a check for the total value will be placed in your bank box. If your house deteriorates by any other means, the items will be removed shortly after and the total value will be placed in the owner's bank box.";
                text += "<br><br>";
                text +=
                    "These lawn tools are a great way to make the atmosphere around your home project your personal style. Keep in mind that the lawn around your home is not a safe haven as your house is. Although you could place a secure fence, it can still be potentially infiltrated by others. You can slay others in your yard as well as be slain.";
                text += "<br><br>";
                ...
                AddHtml(
                    ...
                    300,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">LAWN TOOLS - Help</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            ...
            else if (currentPage == 999995)
            {
                ...
                AddHtml(
                    ...
                    300,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">LAWN TOOLS - Remove</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddButton(595 + locMod, 14, 4017, 4017, 999997, GumpButtonType.Reply, 0);
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">If you want to remove all lawn decorations, then press the button below. The gold will be refunded to your bank box. If you want to cancel this request, press the button on the upper right.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            ...
            else
            {
                ...
                AddHtml(
                    ...
                    300,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + header + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                if (m_ItemPrice > 0)
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + String.Format("{0:0,0}", m_ItemPrice)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (m_PlayerGold > 0)
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + String.Format("{0:0,0} Gold", m_PlayerGold)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (m_SelectedID > 0)
                {
                    ...
                    AddHtml(
                        ...
                        60,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Buy</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
                ...
                else
                {
                    AddHtml(
                        ...
                        "<BODY><BASEFONT Color="
                            + color
                            + ">With these lawn tools you can add certain terrain and items around the outside of your home. Choose a category to the right to start browsing the list of things you can decorate with. Each of them have a price that will be deducted from your bank box. For additional information, you can access the HELP screen above.</BASEFONT></BODY>",
                        false,
                        false
                    );
                }
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            else if (info.ButtonID == (int)Buttons.Next)
            {
                if (
                    ...
                    && LawnRegistry.Categories[m_CurrentCategory.Name].Pages.Count
                        > m_CurrentPage + 1
                )
                {
                    from.SendGump(
                    ...
                    if (m_CurrentCategory != null)
                    {
                        from.SendGump(
                            new LawnGump(
                                from,
                                m_LawnTools,
                                m_Categories[info.ButtonID - 80851] == m_CurrentCategory.Name
                                    ? ""
                                    : m_Categories[info.ButtonID - 80851],
                                0,
                                m_SelectedID,
                                m_ItemPrice,
                                m_ItemTitle
