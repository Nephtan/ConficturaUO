...
namespace Server.Items
{
    ...
    public class LawnItem : LawnPiece
    {
            ...
            : base(itemID, itemName)
        {
            ...
            if (
                LawnRegistry.LawnMultiIDs.ContainsKey(ItemID)
                && LawnRegistry.LawnMultiIDs[ItemID] != null
            )
            {
                LawnPiece piece;
    ...
    public class LawnPiece : Item
    {
        ...
        public LawnPiece(int itemID, string name)
            : this(itemID, name, null) { }

        public LawnPiece(int itemID, string name, LawnItem multiParent)
            : base(itemID)
        {
            Movable = false;
            Name = name;
        ...
        public LawnPiece(Serial serial)
            : base(serial) { }
