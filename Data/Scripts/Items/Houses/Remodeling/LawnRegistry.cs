...
namespace Server.Misc
{
    ...
    class LawnRegistry
    {
        ...
        public static Dictionary<string, LawnGumpCategory> Categories =
            new Dictionary<string, LawnGumpCategory>();
        ...
        public static void RegisterItems()
        {
            ...
            while (cycle < 18)
            {
                ...
                {
                    x_ground = "Blood Rock";
                    x_name = "blood rock ground";
                }
                else if (cycle == 2)
                {
                    x_ground = "Cave";
                    x_name = "cavern ground";
                }
                else if (cycle == 3)
                {
                    x_ground = "Desert";
                    x_name = "desert ground";
                }
                else if (cycle == 4)
                {
                    x_ground = "Dirt";
                ...
                {
                    x_ground = "Dirt Dark";
                    x_name = "dark dirt ground";
                }
                else if (cycle == 7)
                {
                    x_ground = "Forest";
                    x_name = "forest ground";
                }
                else if (cycle == 8)
                {
                    x_ground = "Grass";
                    x_name = "grassy ground";
                }
                else if (cycle == 9)
                {
                    x_ground = "Jungle";
                    x_name = "jungle ground";
                }
                else if (cycle == 10)
                {
                    x_ground = "Lava Rock";
                    x_name = "lava rock ground";
                }
                else if (cycle == 11)
                {
                    x_ground = "Lunar Rock";
                    x_name = "lunar rock ground";
                }
                else if (cycle == 12)
                {
                    x_ground = "Magma Rock";
                    x_name = "magma rock ground";
                }
                else if (cycle == 13)
                {
                    x_ground = "Mud";
                ...
                {
                    x_ground = "Stone Light";
                    x_name = "light stone ground";
                }
                else if (cycle == 17)
                {
                    x_ground = "Stone Dark";
                    x_name = "dark stone ground";
                }
                else if (cycle == 18)
                {
                    x_ground = "Swamp";
                    x_name = "swampy ground";
                }
        ...
        public static void AddTreeInfo(
            int locationID,
            int lowRange,
            int highRange,
            out List<LawnMultiInfo> infos
        )
        { //Used while registering any trees that contain multiple itemIDs
            ...
            {
                infos.Add(
                    new LawnMultiInfo(locationID - lowRange, new Point3D(-lowRange, +lowRange, 0))
                );
                lowRange--;
            }
            while (highRange > 0)
            {
                infos.Add(
                    new LawnMultiInfo(
                        locationID + highRange,
                        new Point3D(+highRange, -highRange, 0)
                    )
                );
                highRange--;
            }
