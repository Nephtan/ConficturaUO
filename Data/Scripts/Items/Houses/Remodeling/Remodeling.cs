...
namespace Server.Misc
{
    public class Remodeling
    {
        ...
        public static void SetID(int itemID, Item item, string title)
        {
            ...
            {
                item.ItemID = Utility.RandomList(4870, 4876, 4882, 4888);
                item.Light = LightType.Circle225;
            }
        ...
        )
        {
            switch (m_SelectedID)
            {
                ...
                case 5952:
                {
                    new LawnItem(5946, m_From, "Fountain", loc, m_Price, m_Title, m_House);
                    break;
                }
                case 6610:
                {
                    new LawnItem(6604, m_From, "Fountain", loc, m_Price, m_Title, m_House);
                    break;
                }
                case 15223:
                {
                    new LawnItem(15223, m_From, "Fountain", loc, m_Price, m_Title, m_House);
                    break;
                }
                case 3807:
                {
                    new LawnItem(m_SelectedID, m_From, "Grave", loc, m_Price, m_Title, m_House);
                    break;
                }
                case 13335:
                {
                ...
                case 4595:
                {
                    new LawnItem(m_SelectedID, m_From, "Hammock", loc, m_Price, m_Title, m_House);
                    break;
                }
                case 4592:
                {
        ...
        )
        {
            switch (m_SelectedID)
            {
                ...
                case 5952:
                {
                    new ShantyItem(5946, m_From, "Fountain", loc, m_Price, m_Title, m_House);
                    break;
                }
                case 6610:
                {
                    new ShantyItem(6604, m_From, "Fountain", loc, m_Price, m_Title, m_House);
                    break;
                }
                case 15223:
                {
                    new ShantyItem(15223, m_From, "Fountain", loc, m_Price, m_Title, m_House);
                    break;
                }
                case 3807:
                {
                    new ShantyItem(m_SelectedID, m_From, "Grave", loc, m_Price, m_Title, m_House);
                    break;
                }
                case 13335:
                {
                ...
                case 4595:
                {
                    new ShantyItem(m_SelectedID, m_From, "Hammock", loc, m_Price, m_Title, m_House);
                    break;
                }
                case 4592:
                {
        ...
        public static void ItemLayout(int m_SelectedID, string m_ItemTitle, Gump gump)
        {
            ...
            if (itemid == 9541)
            {
                ...
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>This lighthouse will allow public houses, or friends of houses, to dock and launch ships.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            ...
            else if (itemid == 8602)
            {
                ...
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>This pentagram will eventually bring forth a demon that will be trapped within its circle.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            ...
            if (m_ItemTitle == "ladder")
            {
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>Once placed, you can double click these ladders and move up to the next level of your home. They can also be secured like doors. They are usually used with trapdoors to get back down.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            else if (m_ItemTitle == "trapdoor")
            {
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>Once placed, you can double click these doors and move down to the next level of your home. They can also be secured like doors. They are usually used with ladders to get back up.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            else if (m_ItemTitle == "stairs" || m_ItemTitle == "ramp")
            {
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>Once placed, you can double click these items to turn them in the direction you want. Single click them to select the option to sell them back.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            ...
            )
            {
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>Once placed, you can double click these items to open or close them. Single click them to select the option to sell them back or to set the security level to allow friends and co-owners to use them when locked.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            else if (m_ItemTitle == "void")
            {
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>WARNING: These tiles cannot be traversed over, meaning they will block your movement when trying to cross them.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            else if (itemid == 942 || itemid == 20403 || itemid == 20404)
            {
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>This item will allow public houses, or friends of houses, to dock and launch ships.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            else if (itemid == 10750 || itemid == 21408)
            {
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>Place this fire in an open space so adventurers can eventually stand 2 tiles away on the north, south, east, and west sides of it. Placing these items near other objects may have the risk of no adventurer visiting the particular fire because there isn't a place for them to stand. Also keep in mind that these items should be level with the ground as not to obstruct a visiting adventurer from stopping by.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            else if (itemid == 9895 || itemid == 9893 || itemid == 9897)
            {
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>These lamps will glow a Ravendark Red when placed on your land, making them appropriate for evil looking cemeteries.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            ...
            )
            {
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>These trees are from the dark forests of Ravendark, and they will be planted to appear in one of six different shades of evil and death.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            else if (itemid == 3959 || itemid == 3986 || itemid == 3987 || itemid == 3988)
            {
                gump.AddHtml(
                    ...
                    300,
                    200,
                    @"<BODY><BASEFONT Color=#FBFBFB>These trees are said to house the souls of the most wicked and vile. Planting them will reveal their faces and the eerie looks that gaze upon you.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
