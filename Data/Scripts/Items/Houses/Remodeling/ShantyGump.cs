    ...
    public class ShantyGump : Gump
    {
            ...
            : base(-40, 50)
        {
            ...
            if (currentPage == 999998)
            {
                ...
                text += "<br><br>";
                text +=
                    "When you demolish a home, the remodeling items will be automatically removed and a check for the total value will be placed in your bank box. If your house deteriorates by any other means, the items will be removed shortly after and the total value will be placed in the owner's bank box. These remodeling tools are a great way to make the atmosphere in your home project your personal style.";
                text += "<br><br>";
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">REMODELING TOOLS - Help</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            ...
            else if (currentPage == 999995)
            {
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">REMODELING TOOLS - Remove</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddButton(595 + locMod, 14, 4017, 4017, 999997, GumpButtonType.Reply, 0);
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">If you want to remove all remodeling decorations, then press the button below. The gold will be refunded to your bank box. If you want to cancel this request, press the button on the upper right.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            ...
            else
            {
                ...
                else
                {
                    AddHtml(
                        ...
                        "<BODY><BASEFONT Color="
                            + color
                            + ">With these remodeling tools you can add certain terrain and items inside your home. Choose a category to the right to start browsing the list of things you can decorate with. Each of them have a price that will be deducted from your bank box. For additional information, you can access the HELP screen above.</BASEFONT></BODY>",
                        false,
                        false
                    );
                }
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            else if (info.ButtonID == (int)Buttons.Next)
            {
                if (
                    ...
                    && ShantyRegistry.Categories[m_CurrentCategory.Name].Pages.Count
                        > m_CurrentPage + 1
                )
                {
                    from.SendGump(
