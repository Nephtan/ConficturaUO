...
namespace Server.Items
{
    ...
    public class TavernTable : Item
    {
        ...
        public TavernTable(Serial serial)
            : base(serial) { }
        ...
        {
            get { return DrinkerNorth; }
            set { DrinkerNorth = value; }
        }
        ...
        {
            get { return DrinkerSouth; }
            set { DrinkerSouth = value; }
        }
        ...
        {
            get { return DrinkerEast; }
            set { DrinkerEast = value; }
        }
        ...
        {
            get { return DrinkerWest; }
            set { DrinkerWest = value; }
        }
        ...
        public static void PopulateHomes()
        {
            ...
            {
                if (
                    patron is HouseVisitor
                    && patron.Karma > 0
                    && Region.Find(patron.Location, patron.Map) is HouseRegion
                )
                {
                    patrons.Add(patron);
                }
    ...
    public class TavernGump : Gump
    {
        ...
        public TavernGump(Mobile from, TavernTable table)
            : base(50, 50)
        {
            from.SendSound(0x4A);
            string color = "#b9afa8";
            ...
            AddHtml(
                ...
                416,
                20,
                @"<BODY><BASEFONT Color=" + color + ">TAVERN TABLES</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
