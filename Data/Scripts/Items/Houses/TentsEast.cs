...
namespace Server.Items
{
    public class MyTentEastAddon : BaseAddon
    {
        ...
        public int Tent_Color
        {
            get { return TentColor; }
            set
            {
                TentColor = value;
        ...
        {
            get { return new MyTentEastAddonDeed(Tent_Color, 1); }
        }

        [Constructable]
        public MyTentEastAddon()
            : this(0) { }
        ...
        public MyTentEastAddon(Serial serial)
            : base(serial) { }
    ...
    public class MyTentEastAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new MyTentEastAddon(Tent_Color); }
        }

        [Constructable]
        public MyTentEastAddonDeed()
            : this(0, 0) { }
        ...
        public MyTentEastAddonDeed(Serial serial)
            : base(serial) { }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            {
                list.Add(1049644, "Requires a 9x9 Floor Space In Your Home");
            }
        }
