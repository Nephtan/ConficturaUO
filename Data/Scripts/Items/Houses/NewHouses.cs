...
namespace Server.Multis
{
    ...
    public class LargeTent : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(1, 13, 0); }
        }

        public LargeTent(Mobile owner)
            : base(0x49, owner, 1576, 788)
        {
            SetSign(1, 12, 8);
        }

        public LargeTent(Serial serial)
            : base(serial) { }
    ...
    public class CastleTower : BaseHouse
    {
        ...
        public CastleTower(Mobile owner)
            : base(0x4A, owner, 1576, 788)
        {
            uint keyValue = CreateKeys(owner);
        ...
        public CastleTower(Serial serial)
            : base(serial) { }
    ...
    public class LogMansion : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(5, 14, 0); }
        }

        public LogMansion(Mobile owner)
            : base(0x95, owner, 1, 1)
        {
            uint keyValue = CreateKeys(owner);
        ...
        public LogMansion(Serial serial)
            : base(serial) { }
    ...
    public class Fortress : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(4, 16, 0); }
        }

        public Fortress(Mobile owner)
            : base(0x4B, owner, 5688, 3344)
        {
            uint keyValue = CreateKeys(owner);
    ...
    public class NewTwoStorySandstoneHouse : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(7, -4, 0); }
        }

        public NewTwoStorySandstoneHouse(Mobile owner)
            : base(0x4C, owner, 1, 1)
        {
        ...
        public NewTwoStorySandstoneHouse(Serial serial)
            : base(serial) { }
    ...
    public class NewBrickHouseWithSteeple : BaseHouse
    {
        ...
        public NewBrickHouseWithSteeple(Mobile owner)
            : base(0x4D, owner, 1, 1)
        {
        ...
        public NewBrickHouseWithSteeple(Serial serial)
            : base(serial) { }
    ...
    public class NewPlasterHousePictureWindow : BaseHouse
    {
        ...
        public NewPlasterHousePictureWindow(Mobile owner)
            : base(0x4F, owner, 1, 1)
        {
        ...
        public NewPlasterHousePictureWindow(Serial serial)
            : base(serial) { }
    ...
    public class NewTwoStoryBrickHome : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-3, 7, 0); }
        }

        public NewTwoStoryBrickHome(Mobile owner)
            : base(0x50, owner, 1, 1)
        {
        ...
        public NewTwoStoryBrickHome(Serial serial)
            : base(serial) { }
    ...
    public class NewTwoStoryWoodenHomeWithPorch : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(5, 4, 5); }
        }

        public NewTwoStoryWoodenHomeWithPorch(Mobile owner)
            : base(0x51, owner, 1, 1)
        {
        ...
        public NewTwoStoryWoodenHomeWithPorch(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallStoneShoppe : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-6, 6, 5); }
        }

        public NewSmallStoneShoppe(Mobile owner)
            : base(0x52, owner, 1, 1)
        {
        ...
        public NewSmallStoneShoppe(Serial serial)
            : base(serial) { }
    ...
    public class NewWoodenHomePorch : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(2, 4, 0); }
        }

        public NewWoodenHomePorch(Mobile owner)
            : base(0x53, owner, 1, 1)
        {
        ...
        public NewWoodenHomePorch(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallStoneTower : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-2, 6, 2); }
        }

        public NewSmallStoneTower(Mobile owner)
            : base(0x54, owner, 1, 1)
        {
        ...
        public NewSmallStoneTower(Serial serial)
            : base(serial) { }
    ...
    public class NewThreeStoryStoneVilla : BaseHouse
    {
        ...
        public NewThreeStoryStoneVilla(Mobile owner)
            : base(0x55, owner, 1, 1)
        {
            SetSignFace(-6, 6, 5, 0xBD2);
        ...
        public NewThreeStoryStoneVilla(Serial serial)
            : base(serial) { }
    ...
    public class NewTwoStorySmallStoneHome : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(3, 3, 5); }
        }

        public NewTwoStorySmallStoneHome(Mobile owner)
            : base(0x56, owner, 1, 1)
        {
        ...
        public NewTwoStorySmallStoneHome(Serial serial)
            : base(serial) { }
    ...
    public class NewTwoStorySmallStoneHouse : BaseHouse
    {
        ...
        public NewTwoStorySmallStoneHouse(Mobile owner)
            : base(0x57, owner, 1, 1)
        {
            SetSignFace(3, 3, 5, 0xBD2);
        ...
        public NewTwoStorySmallStoneHouse(Serial serial)
            : base(serial) { }
    ...
    public class NewTwoStorySmallStoneDwelling : BaseHouse
    {
        ...
        public NewTwoStorySmallStoneDwelling(Mobile owner)
            : base(0x58, owner, 1, 1)
        {
            SetSignFace(3, 3, 5, 0xBD2);
        ...
        public NewTwoStorySmallStoneDwelling(Serial serial)
            : base(serial) { }
    ...
    public class NewTwoStorySmallWoodenDwelling : BaseHouse
    {
        ...
        public NewTwoStorySmallWoodenDwelling(Mobile owner)
            : base(0x59, owner, 1, 1)
        {
            SetSignFace(3, 3, 5, 0xBD2);
        ...
        public NewTwoStorySmallWoodenDwelling(Serial serial)
            : base(serial) { }
    ...
    public class NewWoodenMansion : BaseHouse
    {
        ...
        public NewWoodenMansion(Mobile owner)
            : base(0x5A, owner, 1, 1)
        {
        ...
        public NewWoodenMansion(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallStoneStoreFront : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(0, 4, 6); }
        }

        public NewSmallStoneStoreFront(Mobile owner)
            : base(0x5B, owner, 1, 1)
        {
        ...
        public NewSmallStoneStoreFront(Serial serial)
            : base(serial) { }
    ...
    public class SmallLogCabinEast : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(4, -2, 0); }
        }

        public SmallLogCabinEast(Mobile owner)
            : base(0x97, owner, 1, 1)
        {
        ...
        public SmallLogCabinEast(Serial serial)
            : base(serial) { }
    ...
    public class SmallLogCabinSouth : BaseHouse
    {
        ...
        public SmallLogCabinSouth(Mobile owner)
            : base(0x99, owner, 1, 1)
        {
        ...
        public SmallLogCabinSouth(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallStoneHomeEast : BaseHouse
    {
        ...
        public NewSmallStoneHomeEast(Mobile owner)
            : base(0x5C, owner, 1, 1)
        {
        ...
        public NewSmallStoneHomeEast(Serial serial)
            : base(serial) { }
    ...
    public class NewFancyStoneWoodHome : BaseHouse
    {
        ...
        public NewFancyStoneWoodHome(Mobile owner)
            : base(0x5D, owner, 1, 1)
        {
            SetSignFace(-4, 5, 0, 0xBD2);
        ...
        public NewFancyStoneWoodHome(Serial serial)
            : base(serial) { }
    ...
    public class NewFancyWoodenStoneHouse : BaseHouse
    {
        ...
        public NewFancyWoodenStoneHouse(Mobile owner)
            : base(0x5E, owner, 1, 1)
        {
            SetSignFace(6, -4, 0, 0xBD1);
        ...
        public NewFancyWoodenStoneHouse(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallStoneHouseEast : BaseHouse
    {
        ...
        public NewSmallStoneHouseEast(Mobile owner)
            : base(0x5F, owner, 1, 1)
        {
            SetSignFace(4, -2, 0, 0xBD1);
        ...
        public NewSmallStoneHouseEast(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallWoodenShackPorch : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-4, 4, 4); }
        }

        public NewSmallWoodenShackPorch(Mobile owner)
            : base(0x60, owner, 1, 1)
        {
        ...
        public NewSmallWoodenShackPorch(Serial serial)
            : base(serial) { }
    ...
    public class NewPlainPlasterHouse : BaseHouse
    {
        ...
        public NewPlainPlasterHouse(Mobile owner)
            : base(0x61, owner, 1, 1)
        {
        ...
        public NewPlainPlasterHouse(Serial serial)
            : base(serial) { }
    ...
    public class NewPlainStoneHouse : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-5, 6, 5); }
        }

        public NewPlainStoneHouse(Mobile owner)
            : base(0x62, owner, 1, 1)
        {
        ...
        public NewPlainStoneHouse(Serial serial)
            : base(serial) { }
    ...
    public class NewPlasterHomeDirtDeck : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-2, 7, 0); }
        }

        public NewPlasterHomeDirtDeck(Mobile owner)
            : base(0x63, owner, 1, 1)
        {
        ...
        public NewPlasterHomeDirtDeck(Serial serial)
            : base(serial) { }
    ...
    public class NewWoodenHomeUpperDeck : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-5, 4, 0); }
        }

        public NewWoodenHomeUpperDeck(Mobile owner)
            : base(0x80, owner, 1, 1)
        {
        ...
        public NewWoodenHomeUpperDeck(Serial serial)
            : base(serial) { }
    ...
    public class NewTwoStoryStoneVilla : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(4, 8, 0); }
        }

        public NewTwoStoryStoneVilla(Mobile owner)
            : base(0x81, owner, 1, 1)
        {
        ...
        public NewTwoStoryStoneVilla(Serial serial)
            : base(serial) { }
    ...
    public class NewTwoStorySmallPlasterDwelling : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(3, 3, 8); }
        }

        public NewTwoStorySmallPlasterDwelling(Mobile owner)
            : base(0x82, owner, 1, 1)
        {
        ...
        public NewTwoStorySmallPlasterDwelling(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallStoneTemple : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(4, -3, 0); }
        }

        public NewSmallStoneTemple(Mobile owner)
            : base(0x83, owner, 1, 1)
        {
            SetSignFace(4, -3, 0, 0xBD1);
        }

        public NewSmallStoneTemple(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallSandstoneWorkshop : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(4, 4, 11); }
        }

        public NewSmallSandstoneWorkshop(Mobile owner)
            : base(0x84, owner, 1, 1)
        {
            SetSignFace(4, 4, 11, 0xBD2);
        }

        public NewSmallSandstoneWorkshop(Serial serial)
            : base(serial) { }
    ...
    public class NewStoneHomeWithEnclosedPatio : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(6, 0, 0); }
        }

        public NewStoneHomeWithEnclosedPatio(Mobile owner)
            : base(0x85, owner, 1, 1)
        {
        ...
        public NewStoneHomeWithEnclosedPatio(Serial serial)
            : base(serial) { }
    ...
    public class NewLogCabin : BaseHouse
    {
        ...
        public NewLogCabin(Mobile owner)
            : base(0x86, owner, 1, 1)
        {
            SetSignFace(2, 4, 0, 0xBD2);
        ...
        public NewLogCabin(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallLogCabinWithDeck : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(1, 4, 10); }
        }

        public NewSmallLogCabinWithDeck(Mobile owner)
            : base(0x88, owner, 1, 1)
        {
        ...
        public NewSmallLogCabinWithDeck(Serial serial)
            : base(serial) { }
    ...
    public class NewRaisedBrickHome : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(3, 6, 0); }
        }

        public NewRaisedBrickHome(Mobile owner)
            : base(0x89, owner, 1, 1)
        {
        ...
        public NewRaisedBrickHome(Serial serial)
            : base(serial) { }
    ...
    public class NewBrickArena : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-9, 10, 0); }
        }

        public NewBrickArena(Mobile owner)
            : base(0x8A, owner, 1, 1)
        {
        ...
        public NewBrickArena(Serial serial)
            : base(serial) { }
    ...
    public class NewStoneFort : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-5, 7, 7); }
        }

        public NewStoneFort(Mobile owner)
            : base(0x8B, owner, 1, 1)
        {
        ...
        public NewStoneFort(Serial serial)
            : base(serial) { }
    ...
    public class NewOldStoneHomeShoppe : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(8, -6, 5); }
        }

        public NewOldStoneHomeShoppe(Mobile owner)
            : base(0x8E, owner, 1, 1)
        {
        ...
        public NewOldStoneHomeShoppe(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallBrickCastle : BaseHouse
    {
        ...
        public NewSmallBrickCastle(Mobile owner)
            : base(0x8F, owner, 1, 1)
        {
        ...
        public NewSmallBrickCastle(Serial serial)
            : base(serial) { }
    ...
    public class NewSmallWizardTower : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-2, 6, 0); }
        }

        public NewSmallWizardTower(Mobile owner)
            : base(0x90, owner, 1, 1)
        {
        ...
        public NewSmallWizardTower(Serial serial)
            : base(serial) { }
    ...
    public class NewBrickHomeWithFrontDeck : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(0, 7, 0); }
        }

        public NewBrickHomeWithFrontDeck(Mobile owner)
            : base(0x91, owner, 1, 1)
        {
        ...
        public NewBrickHomeWithFrontDeck(Serial serial)
            : base(serial) { }
    ...
    public class NewMarbleShoppe : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-5, 6, 1); }
        }

        public NewMarbleShoppe(Mobile owner)
            : base(0x92, owner, 1, 1)
        {
        ...
        public NewMarbleShoppe(Serial serial)
            : base(serial) { }
    ...
    public class NewBrickHomeWithLargePorch : BaseHouse
    {
        ...
        public override Point3D BaseBanLocation
        {
            get { return new Point3D(-6, 5, 0); }
        }

        public NewBrickHomeWithLargePorch(Mobile owner)
            : base(0x93, owner, 1, 1)
        {
        ...
        public NewBrickHomeWithLargePorch(Serial serial)
            : base(serial) { }
