...
namespace Server.Items
{
    ...
    public class HousePlacementCategoryGump : Gump
    {
        ...
        public override void OnResponse(Server.Network.NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                {
                    m_From.SendGump(
                        new HousePlacementListGump(m_From, HousePlacementEntry.ClassicHouses)
                    );
                    break;
                }
                ...
                {
                    m_From.SendGump(
                        new HousePlacementListGump(m_From, HousePlacementEntry.TwoStoryFoundations)
                    );
                    break;
                }
                ...
                {
                    m_From.SendGump(
                        new HousePlacementListGump(
                            m_From,
                            HousePlacementEntry.ThreeStoryFoundations
                        )
                    );
                    break;
                }
    ...
    public class NewHousePlacementTarget : MultiTarget
    {
        ...
        protected override void OnTarget(Mobile from, object o)
        {
            if (
                !from.CheckAlive()
                || from.Backpack == null
                || from.Backpack.FindItemByType(typeof(HousePlacementTool)) == null
            )
                return;
    ...
    public class HousePlacementEntry
    {
        ...
        public int Storage
        {
            get { return BaseHouse.NewVendorSystem ? m_NewStorage : m_Storage; }
        }
        public int Lockdowns
        {
            get { return BaseHouse.NewVendorSystem ? m_NewLockdowns : m_Lockdowns; }
        }
        public int Vendors
        {
        ...
        public BaseHouse ConstructHouse(Mobile from)
        {
            try
            {
                ...
                if (m_Type == typeof(HouseFoundation))
                    ...
                    m_Type == typeof(SmallOldHouse)
                    || m_Type == typeof(SmallShop)
                    || m_Type == typeof(TwoStoryHouse)
                )
            ...
            switch (res)
            {
                case HousePlacementResult.Valid:
                {
                    ...
                    else
                    {
                        ...
                        {
                            Item contract = from.Backpack.FindItemByType(
            ...
            switch (res)
            {
                case HousePlacementResult.Valid:
                {
                    ...
                    else
                    {
                        ...
                        Point3D banLoc = new Point3D(
                            center.X + mcl.Min.X,
                            center.Y + mcl.Max.Y + 1,
                            center.Z
                        );
                        ...
                        for (int i = 0; i < mcl.List.Length; ++i)
                        {
                            ...
                            {
                                banLoc = new Point3D(
                                    center.X + entry.m_OffsetX,
                                    center.Y + entry.m_OffsetY,
                                    center.Z
                                );
                                break;
                            }
        ...
        private static HousePlacementEntry[] m_ClassicHouses = new HousePlacementEntry[]
        {
            ...
            new HousePlacementEntry(
                typeof(NewSmallStoneStoreFront),
                1030844,
                410,
                140,
                410,
            ...
            new HousePlacementEntry(
                typeof(NewSmallWoodenShackPorch),
                1030849,
                410,
                140,
                410,
            ...
            new HousePlacementEntry(
                typeof(NewSmallLogCabinWithDeck),
                1030860,
                449,
                179,
                449,
            ...
            new HousePlacementEntry(
                typeof(NewSmallSandstoneWorkshop),
                1030857,
                458,
                188,
                458,
            ...
            new HousePlacementEntry(
                typeof(NewTwoStorySmallPlasterDwelling),
                1030855,
                470,
                200,
                470,
            ...
            new HousePlacementEntry(
                typeof(NewTwoStorySmallStoneDwelling),
                1030841,
                470,
                200,
                470,
            ...
            new HousePlacementEntry(
                typeof(NewTwoStorySmallStoneHome),
                1030839,
                470,
                200,
                470,
            ...
            new HousePlacementEntry(
                typeof(NewTwoStorySmallStoneHouse),
                1030840,
                470,
                200,
                470,
            ...
            new HousePlacementEntry(
                typeof(NewTwoStorySmallWoodenDwelling),
                1030842,
                470,
                200,
                470,
            ...
            new HousePlacementEntry(
                typeof(NewBrickHomeWithFrontDeck),
                1030867,
                518,
                248,
                518,
            ...
            new HousePlacementEntry(
                typeof(NewPlasterHousePictureWindow),
                1030832,
                515,
                245,
                515,
            ...
            new HousePlacementEntry(
                typeof(NewStoneHomeWithEnclosedPatio),
                1030858,
                516,
                246,
                516,
            ...
            new HousePlacementEntry(
                typeof(NewBrickHomeWithLargePorch),
                1030869,
                533,
                263,
                533,
            ...
            new HousePlacementEntry(
                typeof(NewTwoStoryWoodenHomeWithPorch),
                1030834,
                562,
                292,
                562,
            ...
            new HousePlacementEntry(
                typeof(NewBrickHouseWithSteeple),
                1030830,
                654,
                384,
                654,
            ...
            new HousePlacementEntry(
                typeof(NewFancyWoodenStoneHouse),
                1030847,
                653,
                383,
                653,
            ...
            new HousePlacementEntry(
                typeof(NewTwoStorySandstoneHouse),
                1030829,
                725,
                455,
                725,
            ...
            new HousePlacementEntry(
                typeof(NewThreeStoryStoneVilla),
                1030838,
                965,
                695,
                965,
        ...
        {
            get { return m_TwoStoryFoundations; }
        }
        ...
        {
            get { return m_ThreeStoryFoundations; }
        }
    }
}
