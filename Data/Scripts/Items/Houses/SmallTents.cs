...
namespace Server.Multis
{
    public class BlueTent : BaseHouse
    {
        ...
        public BlueTent(Mobile owner)
            : base(0x70, owner, 500, 4)
        {
            Price = 12000;
...
namespace Server.Multis
{
    public class GreenTent : BaseHouse
    {
        ...
        public GreenTent(Mobile owner)
            : base(0x72, owner, 500, 4)
        {
            Price = 12000;
            uint keyValue = CreateKeys(owner);
        ...
        public GreenTent(Serial serial)
            : base(serial) { }
