...
namespace Server.Items
{
    public class GypsyCampAddon : BaseAddon
    {
        ...
        {
            get { return new GypsyCampAddonDeed(); }
        }
        ...
        public GypsyCampAddon()
        {
            ...
            AddComplexComponent(
                ...
                0,
                -1,
                "Sosaria & Lodor: A study of the moons",
                1
            ); // 89
        ...
        public GypsyCampAddon(Serial serial)
            : base(serial) { }
    ...
    public class GypsyCampAddonDeed : BaseAddonDeed
    {
        ...
        public GypsyCampAddonDeed(Serial serial)
            : base(serial) { }
