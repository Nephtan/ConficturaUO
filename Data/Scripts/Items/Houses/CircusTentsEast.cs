...
namespace Server.Items
{
    public class MyCircusTentEastAddon : BaseAddon
    {
        ...
        {
            get { return new MyCircusTentEastAddonDeed(Tent_Color1, Tent_Color2, 1); }
        }
        ...
        public MyCircusTentEastAddon(Serial serial)
            : base(serial) { }
    ...
    public class MyCircusTentEastAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new MyCircusTentEastAddon(Tent_Color1, Tent_Color2); }
        }
        ...
        public class MyCircusTentMenu : ContextMenuEntry
        {
            ...
            public MyCircusTentMenu(Mobile from, MyCircusTentEastAddonDeed tent)
                : base(5109, 1)
            {
                m_From = from;
                i_Tent = tent;
        ...
        public MyCircusTentEastAddonDeed(Serial serial)
            : base(serial) { }
