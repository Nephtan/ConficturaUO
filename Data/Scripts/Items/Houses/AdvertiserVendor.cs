...
namespace Server.Items
{
    ...
    public class AdvertiserVendor : Item
    {
                ...
                AddLabel(
                    ...
                    String.Format(
                        ""
                            ...
                            + "  -  Home Vendors                 There are {0} vendors in the world.",
                        pvs
                    )
                );
                ...
                try
                {
                    if (index < m_List.Count)
                    {
                        ...
                        AddLabel(
                            ...
                            46 + (row * 20),
                            1152,
                            String.Format("{0} {1}", my_location, vMap)
                        );
        ...
        public AdvertiserVendor(Serial serial)
            : base(serial) { }
