...
namespace Server.Items
{
    public class MyTentSouthAddon : BaseAddon
    {
        ...
        {
            get { return new MyTentSouthAddonDeed(Tent_Color, 1); }
        }
        ...
        public MyTentSouthAddon(Serial serial)
            : base(serial) { }
    ...
    public class MyTentSouthAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new MyTentSouthAddon(Tent_Color); }
        }

        [Constructable]
        public MyTentSouthAddonDeed()
            : this(0, 0) { }
        ...
        public MyTentSouthAddonDeed(Serial serial)
            : base(serial) { }
