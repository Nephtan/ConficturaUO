...
namespace Server.Multis
{
    ...
    public class SmallShop : BaseHouse
    {
        public override Rectangle2D[] Area
        {
            get { return (ItemID == 0x40A2 ? AreaArray1 : AreaArray2); }
        }

        public override Point3D BaseBanLocation
        {
            get { return new Point3D(3, 4, 0); }
        }
        ...
        public static Rectangle2D[] AreaArray1 = new Rectangle2D[]
        {
            new Rectangle2D(-3, -3, 8, 8)
        };
        public static Rectangle2D[] AreaArray2 = new Rectangle2D[]
        {
            new Rectangle2D(-3, -3, 8, 8)
        };
