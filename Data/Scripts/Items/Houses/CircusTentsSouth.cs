...
namespace Server.Items
{
    public class MyCircusTentSouthAddon : BaseAddon
    {
        ...
        public int Tent_Color1
        {
            get { return TentColor1; }
            set
            {
                TentColor1 = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Tent_Color2
        {
            get { return TentColor2; }
            set
            {
                TentColor2 = value;
                InvalidateProperties();
        ...
        {
            get { return new MyCircusTentSouthAddonDeed(Tent_Color1, Tent_Color2, 1); }
        }

        [Constructable]
        public MyCircusTentSouthAddon()
            : this(0, 0) { }
        ...
        public MyCircusTentSouthAddon(Serial serial)
            : base(serial) { }
    ...
    public class MyCircusTentSouthAddonDeed : BaseAddonDeed
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Tent_Found
        {
            get { return TentFound; }
            set
            {
                TentFound = value;
                InvalidateProperties();
        ...
        {
            get { return new MyCircusTentSouthAddon(Tent_Color1, Tent_Color2); }
        }

        [Constructable]
        public MyCircusTentSouthAddonDeed()
            : this(0, 0, 0) { }
        ...
        public MyCircusTentSouthAddonDeed(int RelHue1, int RelHue2, int RelRolled)
        {
            ...
            if (TentFound > 0)
            {
                TentColor1 = Tent_Color1;
                TentColor2 = Tent_Color2;
                Hue = Tent_Color1;
            }
            else if (RelRolled > 0)
            {
        ...
        public class MyCircusTentMenu : ContextMenuEntry
        {
            ...
            public MyCircusTentMenu(Mobile from, MyCircusTentSouthAddonDeed tent)
                : base(5109, 1)
            {
                m_From = from;
                i_Tent = tent;
        ...
        public MyCircusTentSouthAddonDeed(Serial serial)
            : base(serial) { }
