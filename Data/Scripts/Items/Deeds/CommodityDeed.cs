...
namespace Server.Items
{
    ...
    public class CommodityDeed : Item
    {
        ...
        {
            get { return m_Commodity == null ? 1047016 : 1047017; }
        }
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            if (m_Commodity != null && m_Commodity is ICommodity)
            {
                list.Add(
                    1060658,
                    "#{0}\t{1}",
                    ((ICommodity)m_Commodity).DescriptionNumber,
                    m_Commodity.Amount
                ); // ~1_val~: ~2_val~
            }
            else
        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else if (targeted is Item)
                {
                    ...
                    // Veteran Rewards mods
                    if (
                        box != null && m_Deed.IsChildOf(box) && ((Item)targeted).IsChildOf(box)
