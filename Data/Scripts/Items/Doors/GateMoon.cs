...
namespace Server.Items
{
    public class GateMoon : Item
    {
        ...
        public override bool OnMoveOver(Mobile m)
        {
            if (m is PlayerMobile)
            {
                ...
                if (
                    ...
                    && !(Server.Misc.PlayerSettings.GetKeys(m, "VordoKey"))
                )
                {
                    m.SendMessage("This magical gate doesn't seem to do anything.");
                }
                else if (
                    Worlds.AllowEscape(m, m.Map, m.Location, m.X, m.Y) == false
                    && Worlds.GetMyWorld(m.Map, m.Location, m.X, m.Y)
                ...
                )
                {
                    ...
                    Worlds.RegionAllowedRecall(m.Map, m.Location, m.X, m.Y) == false
                    && Worlds.GetMyWorld(m.Map, m.Location, m.X, m.Y) != "the Land of Ambrosia"
                    && Worlds.GetMyWorld(m.Map, m.Location, m.X, m.Y)
                        != "the Bottle World of Kuldar"
                )
                {
        ...
        {
            public MoonGateGump(Mobile from, bool IsBlackrock)
                : base(50, 50)
            {
                string color = "#9abdcf";
                ...
                {
                    img = 9582;
                    mainTitle = "BLACKROCK GATE DESTINATIONS";
                }
                ...
                AddHtml(
                    ...
                    243,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + mainTitle + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                while (GateAmount > 0)
                {
                    ...
                    if (sPlace != "")
                    {
                        ...
                        AddHtml(
                            ...
                            180,
                            20,
                            @"<BODY><BASEFONT Color=" + color + ">" + sPlace + "</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                if (info.ButtonID > 0 && NearGate(from))
                {
                    ...
                    {
                        if (
                            PlayerSettings.GetDiscovered(from, "the Land of Sosaria")
                            && from.Karma >= 0
                            && from.Kills < 1
                            && !Server.Items.BaseRace.IsEvil(from)
                        )
                        {
                            gX = 3907;
                            gY = 3962;
        ...
        public static string GetGateName(int gate, Mobile m)
        {
            ...
            if (
                world == "the Bottle World of Kuldar"
                && !(PlayerSettings.GetDiscovered(m, "the Bottle World of Kuldar"))
            ) { }
            else if (gate == 1 && PlayerSettings.GetDiscovered(m, "the Land of Sosaria"))
            {
                sGate = "Sosaria - Central";
            }
            else if (gate == 2 && PlayerSettings.GetDiscovered(m, "the Land of Sosaria"))
            {
                sGate = "Sosaria - Clues";
            }
            else if (gate == 3 && PlayerSettings.GetDiscovered(m, "the Land of Sosaria"))
            {
                sGate = "Sosaria - Devil Guard";
            }
            else if (gate == 4 && PlayerSettings.GetDiscovered(m, "the Land of Sosaria"))
            {
                sGate = "Sosaria - East";
            }
            else if (gate == 5 && PlayerSettings.GetDiscovered(m, "the Land of Sosaria"))
            {
                sGate = "Sosaria - Frozen Isles";
            }
            else if (gate == 6 && PlayerSettings.GetDiscovered(m, "the Land of Sosaria"))
            {
                sGate = "Sosaria - Montor";
            }
            else if (gate == 7 && PlayerSettings.GetDiscovered(m, "the Land of Sosaria"))
            {
                sGate = "Sosaria - Moon";
            }
            else if (gate == 8 && PlayerSettings.GetDiscovered(m, "the Land of Sosaria"))
            {
                sGate = "Sosaria - West";
            }
            else if (gate == 9 && PlayerSettings.GetDiscovered(m, "the Land of Sosaria"))
            {
                sGate = "Sosaria - Yew";
            }
            else if (gate == 10 && PlayerSettings.GetDiscovered(m, "the Land of Ambrosia"))
            {
                sGate = "Isle of Fire";
            }
            else if (gate == 11 && PlayerSettings.GetDiscovered(m, "the Island of Umber Veil"))
            {
                sGate = "Lost Isle";
            }
            else if (gate == 12 && PlayerSettings.GetDiscovered(m, "the Land of Ambrosia"))
            {
                sGate = "Land of Ambrosia";
            }
            else if (gate == 13 && PlayerSettings.GetDiscovered(m, "the Island of Umber Veil"))
            {
                sGate = "Island of Umber Veil";
            }
            else if (gate == 14 && PlayerSettings.GetDiscovered(m, "the Isles of Dread"))
            {
                sGate = "Isles of Dread";
            }
            else if (gate == 15 && PlayerSettings.GetDiscovered(m, "the Land of Lodoria"))
            {
                sGate = "Lodoria - Greensky";
            }
            else if (gate == 16 && PlayerSettings.GetDiscovered(m, "the Land of Lodoria"))
            {
                sGate = "Lodoria - Islegem";
            }
            else if (gate == 17 && PlayerSettings.GetDiscovered(m, "the Land of Lodoria"))
            {
                sGate = "Lodoria - Portshine";
            }
            else if (gate == 18 && PlayerSettings.GetDiscovered(m, "the Land of Lodoria"))
            {
                sGate = "Lodoria - South";
            }
            else if (gate == 19 && PlayerSettings.GetDiscovered(m, "the Land of Lodoria"))
            {
                sGate = "Lodoria - Springvale";
            }
            else if (gate == 20 && PlayerSettings.GetDiscovered(m, "the Land of Lodoria"))
            {
                sGate = "Lodoria - Whisper";
            }
            else if (gate == 21 && PlayerSettings.GetDiscovered(m, "the Land of Lodoria"))
            {
                sGate = "Lodoria - Winterlands";
            }
            else if (gate == 22 && PlayerSettings.GetDiscovered(m, "the Serpent Island"))
            {
                sGate = "Serpent Island - North";
            }
            else if (gate == 23 && PlayerSettings.GetDiscovered(m, "the Serpent Island"))
            {
                sGate = "Serpent Island - South";
            }
            else if (gate == 24 && PlayerSettings.GetDiscovered(m, "the Serpent Island"))
            {
                sGate = "Serpent Island - West";
            }
            else if (gate == 25 && PlayerSettings.GetDiscovered(m, "the Savaged Empire"))
            {
                sGate = "Savaged Empire - North";
            }
            else if (gate == 26 && PlayerSettings.GetDiscovered(m, "the Savaged Empire"))
            {
                sGate = "Savaged Empire - South";
            }
            else if (gate == 27 && PlayerSettings.GetDiscovered(m, "the Savaged Empire"))
            {
                sGate = "Savaged Empire - West";
            }
            else if (gate == 28 && PlayerSettings.GetDiscovered(m, "the Bottle World of Kuldar"))
            {
                sGate = "Bottle World of Kuldar";
            }
            else if (gate == 29 && PlayerSettings.GetDiscovered(m, "the Bottle World of Kuldar"))
            {
            ...
            {
                if (
                    PlayerSettings.GetDiscovered(m, "the Land of Sosaria")
                    && m.Karma >= 0
                    && m.Kills < 1
