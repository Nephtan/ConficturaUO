...
namespace Server.Items
{
    public class moongates : Item
    {
        ...
        [Constructable]
        public moongates(Point3D pointDest, Map mapDest)
            : this(pointDest, mapDest, false) { }

        [Constructable]
        public moongates(Point3D pointDest, Map mapDest, bool creatures)
            : base(0xF6C)
        {
            Movable = false;
            Visible = true;
        ...
        public moongates(Serial serial)
            : base(serial) { }
    ...
    public class Skillmoongates : moongates
    {
                ...
                if (sk == null || sk.Base < m_Required)
                {
                    if (m.BeginAction(this))
                    {
                        ...
                        Timer.DelayCall(
                            ...
                            new TimerStateCallback(EndMessageLock),
                            m
                        );
                    }
        ...
        public Skillmoongates(Serial serial)
            : base(serial) { }
    ...
    public class Keywordmoongates : moongates
    {
        ...
        public Keywordmoongates(Serial serial)
            : base(serial) { }
