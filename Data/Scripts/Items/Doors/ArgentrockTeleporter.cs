...
namespace Server.Items
{
    public class ArgentrockTeleporter : Item
    {
        ...
        public ArgentrockTeleporter(Serial serial)
            : base(serial) { }
        ...
        public override bool OnMoveOver(Mobile m)
        {
            ...
            {
                case 1:
                    p = new Point3D(5808, 786, -22);
                    break; // ENTER A
                case 2:
                    p = new Point3D(5887, 856, -22);
                    break; // ENTER B1
                case 3:
                    p = new Point3D(5807, 937, -22);
                    break; // ENTER B2
                case 4:
                    p = new Point3D(5808, 786, -22);
                    break; // ENTER A
                ...
                case 9:
                    ...
                    break; // ENTER B2
                case 10:
                    p = new Point3D(5977, 486, 0);
                    break; // START
                case 11:
                    p = new Point3D(6270, 647, 0);
                    break; // FINISH
            }
