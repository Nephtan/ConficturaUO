...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public SpaceDoorEast(DoorFacing facing)
            : base(0x3B1, 0x35AB, 0x55E, 0x55E, BaseDoor.GetOffset(DoorFacing.WestSS)) { }

        public SpaceDoorEast(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public SpaceDoorSouth(DoorFacing facing)
            : base(0x3B2, 0x35AC, 0x55E, 0x55E, BaseDoor.GetOffset(DoorFacing.SouthSW)) { }

        public SpaceDoorSouth(Serial serial)
            : base(serial) { }
