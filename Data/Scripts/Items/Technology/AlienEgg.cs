...
namespace Server.Items
{
    public class AlienEgg : Item
    {
        ...
        public static bool ProcessAlienEgg(Mobile m, Mobile vet, Item dropped)
        {
            ...
            if (
                Server.Misc.Worlds.GetRegionName(vet.Map, vet.Location) != egg.AnimalTrainerLocation
            )
            {
                return false;
            }
            ...
            if (vetSkill > 0)
            {
                XormiteReturn = (int)(egg.NeedXormite * (vetSkill * 0.005));
            }

            int HaveIngredients = 0;

            if (egg.HaveYellowCrystal >= 0)
            {
                HaveIngredients++;
            }
            if (egg.HaveRedCrystal >= 0)
            {
                HaveIngredients++;
            }
            if (egg.HavePotion >= 0)
            ...
            if (egg.HaveXormite >= egg.NeedXormite)
            {
                HaveIngredients++;
            }
            if (egg.HaveRod >= 0)
        ...
        public class AlienEggGump : Gump
        {
                ...
                : base(25, 25)
            {
                ...
                AddHtml(
                    ...
                    207,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>ALIEN EGG</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color=#00FF06>"
                        + egg.HaveXormite.ToString()
                        + "/"
                        + egg.NeedXormite.ToString()
                        + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    520,
                    60,
                    @"<BODY><BASEFONT Color=#00FF06>" + sRumor + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    622,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>Bring Gathered Materials to the Animal Expert in "
                        + egg.AnimalTrainerLocation
                        + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                if (egg.HaveRod > 0)
                {
                    AddItem(84, 156, 3571, 0xB71);
                }

                AddItem(235, 145, 8893);
                if (egg.HaveYellowCrystal > 0)
                {
                    AddItem(236, 144, 1796);
                }

                AddItem(385, 145, 8893);
                if (egg.HaveRedCrystal > 0)
                {
                    AddItem(387, 143, 1797);
                }

                AddItem(535, 145, 8893);
                if (egg.HavePotion > 0)
                {
                    AddItem(546, 145, 10279, 0xB3D);
                }
        ...
        public static string GetRandomVet()
        {
            ...
            foreach (Mobile target in World.Mobiles.Values)
                if (target is BaseVendor)
                {
                    ...
                    {
                        if (
                            (target is AnimalTrainer || target is Veterinarian)
        ...
        public string g_AnimalTrainerLocation
        {
            get { return AnimalTrainerLocation; }
            set { AnimalTrainerLocation = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveRedCrystal
        {
            get { return HaveRedCrystal; }
            set { HaveRedCrystal = value; }
        }

        public int HaveYellowCrystal;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HaveYellowCrystal
        {
            get { return HaveYellowCrystal; }
            set { HaveYellowCrystal = value; }
        }

        public int HavePotion;

        [CommandProperty(AccessLevel.GameMaster)]
        public int g_HavePotion
        {
            get { return HavePotion; }
            set { HavePotion = value; }
        }
    }
}
