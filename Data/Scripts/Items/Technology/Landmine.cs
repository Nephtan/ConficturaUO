...
namespace Server.Items
{
    public class LandmineSetup : Item
    {
        ...
        public LandmineSetup(Serial serial)
            : base(serial) { }
    ...
    public class Landmine : Item
    {
        ...
        [Constructable]
        public Landmine(Mobile source, int level)
            : base(0x3EA2)
        {
            Movable = false;
            Name = "a landmine";
        ...
        public override bool OnMoveOver(Mobile m)
        {
            if (owner != m)
            {
                ...
                )
                {
                    int itHurts =
                        (int)(
                            (Utility.RandomMinMax(StrMin, StrMax) * (100 - m.PhysicalResistance))
                            / 100
                        ) + 10;
