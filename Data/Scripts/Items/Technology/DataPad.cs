...
namespace Server.Items
{
    public class DataPad : Item
    {
            ...
            : base(0x27FB)
        {
            ...
            if (DataID < 1)
            {
                DataID = Utility.RandomMinMax(1, 59);
            } // DO NOT USE 60
        ...
        {
            public DataPadGump(Mobile from, DataPad Data)
                : base(100, 100)
            {
                this.Closable = true;
                ...
                AddHtml(
                    ...
                    308,
                    180,
                    @"<BODY><BASEFONT Color=#00FF06>" + SetupDataPad(Data) + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)true
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    308,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>By " + Data.DataAuthor + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
        ...
        public static string SetupDataPad(DataPad pad)
        {
            ...
            switch (pad.DataID)
            {
                ...
                case 19:
                    ...
                    text =
                        "Message for Lieutenant Evers: Lieutenant, I finished unloading the cargo, but we had to do it manually because the robotic arms, that normally do it, were behaving erratically. Bobbie said that it was due to some computer virus in the system. We shut them down just to be safe. Do you want us to go unload that Kilrathi cargo? We can if you want but there is some odd yellow liquid leaking from most of the containers. One of crates did have some bowcasters though, which I think Lieutenant Hong would be interested in. We will be in the mess hall taking a break, so let us know what you want us to do next.";
                    break;
                case 20:
                ...
                case 45:
                    ...
                    text =
                        "I have been forced to sneak around and hide as I traverse the halls. There is a group of humanoids, wearing yellow robes and hoods, patrolling the area. They seem to have a leadership structure that mimics those of cultists. I managed to crawl through the ventilation system and see where they meet. It was one of our launch bays and they built an altar next to one of the nuclear missiles. They speak in religious tones, talking about the glow and the power of the bomb. These people are clearly insane. How long have they been here? Their skin is greenish in color, but it isn't a martian green. It has a strange glow to it, almost like radiation.";
                    break;
                case 46:
                ...
                case 59:
                    ...
                    text =
                        "With many of the electronic systems either broken or malfunctioning, our team has been able to collect enough parts to make a few forest harvester droids. Because we needed to use some war mech parts, these droids have the programming for attacks that we can't seem to remove from the drives. The Captain thinks we should leave it as is, because then these droids can both harvest wood and perform sentry duties when needed. The issue we are running into is that these droids will not chop any wood, so we are still doing that manually with axes. We can, however, give the logs to the droid and they will cut them into the much needed boards. Our computer specialist is trying to solve these issues, but she isn't very confident since this programming came from Seti Alpha III.";
                    break;
                case 60:
