...
namespace Server.Items
{
    public class ThermalDetonator : Item
    {
        ...
        public ThermalDetonator(Serial serial)
            : base(serial) { }
        ...
        private void Detonate_OnTick(object state)
        {
            ...
            {
                if (parent is Item)
                    ((Item)parent).PublicOverheadMessage(
                        MessageType.Regular,
                        0x22,
                        false,
                        timer.ToString()
                    ...
                    ((Mobile)parent).PublicOverheadMessage(
                        MessageType.Regular,
                        0x22,
                        false,
                        timer.ToString()
        ...
        private class ThrowTarget : Target
        {
            ...
            public ThrowTarget(ThermalDetonator grenade)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                Timer.DelayCall(
                    TimeSpan.FromSeconds(1.0),
                    new TimerStateCallback(m_Grenade.Reposition_OnTick),
