...
namespace Server.Items
{
    public class ComputerDatabase : Item
    {
        ...
        public ComputerDatabase(Serial serial)
            : base(serial) { }
        ...
        {
            public ComputerDatabaseGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                ...
                AddHtml(
                    ...
                    191,
                    19,
                    @"<BODY><BASEFONT Color=#00FF06>Skin Color</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    191,
                    19,
                    @"<BODY><BASEFONT Color=#00FF06>Hair Color</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                if (info.ButtonID == 1)
                {
                    skinColor = Utility.RandomSkinColor();
                }
                ...
                {
                    hairColor = Utility.RandomHairColor();
                }
