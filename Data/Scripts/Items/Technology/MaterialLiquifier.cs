...
namespace Server.Items
{
    public class MaterialLiquifier : Item
    {
        ...
        public MaterialLiquifier(Serial serial)
            : base(serial) { }
        ...
        {
            public MaterialLiquifierGump(Mobile from)
                : base(25, 25)
            {
                this.Closable = true;
                ...
                AddHtml(
                    ...
                    200,
                    20,
                    @"<BODY><BASEFONT Color=#00FF06>MATERIAL LIQUIFIER</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
