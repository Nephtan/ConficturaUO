...
namespace Server.Items
{
    public class MerchantsBook : Item
    {
        ...
        {
            get { return MaterialSpecific; }
            set
            {
                MaterialSpecific = value;
                InvalidateProperties();
            }
        }
        ...
        {
            public MerchantsBookGump(Mobile from, MerchantsBook salesbook, int page)
                : base(100, 100)
            {
                m_Book = salesbook;
                ...
                AddHtml(
                    ...
                    155,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">ITEM</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                y = y + z;
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem1, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem2, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem3, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem4, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem5, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem6, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem7, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem8, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    58,
                    20,
                    @"<BODY><BASEFONT Color=" + color + "><RIGHT>GOLD</RIGHT></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                y = y + z;
                if (GetSalesForBook(m_Book, showItem1, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem1, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem2, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem2, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem3, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem3, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem4, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem4, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem5, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem5, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem6, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem6, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem7, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem7, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem8, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem8, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem9, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem10, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem11, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem12, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem13, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem14, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem15, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + GetSalesForBook(m_Book, showItem16, 1, from)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                if (GetSalesForBook(m_Book, showItem9, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem9, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem10, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem10, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem11, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem11, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem12, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem12, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem13, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem13, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem14, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem14, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem15, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem15, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (GetSalesForBook(m_Book, showItem16, 1, from) != "")
                {
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + "><RIGHT>"
                            + GetSalesForBook(m_Book, showItem16, 3, from)
                            + "</RIGHT></BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                else if (info.ButtonID < NumItemsSold)
                {
                    ...
                    if (run)
                    {
                        ...
                        {
                            cost =
                                cost - (int)((from.Skills[SkillName.Begging].Value * 0.005) * cost);
                            if (cost < 1)
                            {
                                cost = 1;
                            }
                        ...
                        if (sName != "" && nearBook == true)
                        {
                            if (from.TotalGold >= cost)
                            {
                                ...
                                if (item is BaseWeapon)
                                {
                                    ...
                                    weapon.Resource = m_Book.Resource;
                                }
                                else if (item is BaseArmor)
                                {
                                    BaseArmor armor = (BaseArmor)item;
                                    armor.Resource = m_Book.Resource;
                                }
                                ...
                                else if (item is TenFootPole)
                                {
                                    ...
                                    switch (m_Book.Resource)
                                    {
                                        ...
                                        case CraftResource.EbonyTree:
                                            ...
                                            break;
                                        case CraftResource.GoldenOakTree:
                                            cHue = MaterialInfo.GetMaterialColor(
                                                "golden oak",
                                                "",
                                                0
                                            );
                                ...
                                foreach (Mobile who in from.GetMobilesInRange(10))
                                {
                                    ...
                                    )
                                    {
                                        ...
                                        switch (Utility.Random(2))
                                        {
                                            case 0:
                                                who.Say(
                                                    "I have spent years learning the art of forging this metal."
                                                );
                                                break;
                                            case 1:
                                            ...
                                            case 2:
                                                who.Say(
                                                    "People come from afar for this forged metal."
                                                );
                                                break;
                                            case 3:
                                            ...
                                            case 5:
                                                who.Say(
                                                    "The fires are hot so I am ready to forge that metal."
                                                );
                                                break;
                                        }
                                    ...
                                    )
                                    {
                                        ...
                                        switch (Utility.Random(2))
                                        {
                                            case 0:
                                                who.Say(
                                                    "I have spent years learning the art of carving this wood."
                                                );
                                                break;
                                            case 1:
                                                who.Say("Let me see what I can make here.");
                                            ...
                                            case 2:
                                                who.Say(
                                                    "People come from afar for this crafted wood"
                                                );
                                                break;
                                            case 3:
                                                who.Say("You won't see many items like this.");
                                                break;
                                            case 4:
                                                who.Say("I think I can carve that for you.");
                                                break;
                                            case 5:
                                                who.Say(
                                                    "The blades are sharpened so I can carve that for you."
                                                );
                                                break;
                                        }
                                    ...
                                    )
                                    {
                                        ...
                                        switch (Utility.Random(2))
                                        {
                                            case 0:
                                                who.Say(
                                                    "I have spent years learning the art of leather working."
                                                );
                                                break;
                                            case 1:
                                                who.Say("Let me see what I can make here.");
                                            ...
                                            case 2:
                                                who.Say(
                                                    "People come from afar for this tanned leather."
                                                );
                                                break;
                                            case 3:
                                                who.Say("You won't see many items like this.");
                                                break;
                                            case 4:
                                                who.Say("I think I can stitch that for you.");
                                                break;
                                            case 5:
                                                who.Say(
                                                    "I found my sewing kit so I can stitch that together for you."
                                                );
                                                break;
                                        }
        ...
        public MerchantsBook(Serial serial)
            : base(serial) { }
        ...
        public static string GetSalesForBook(
            MerchantsBook book,
            int selling,
            int part,
            Mobile player
        )
        {
            ...
            else if (book.MaterialType == "leather")
            {
                ...
                if (selling == sales)
                {
                    name = "LeatherBustierArms";
                    item = "Leather Arms, Bustier";
                    cost = 97;
                }
                sales++;
                if (selling == sales)
                ...
                if (selling == sales)
                {
                    name = "FemaleLeatherChest";
                    item = "Leather Chest, Female";
                    cost = 116;
                }
                sales++;
                if (selling == sales)
                ...
                if (selling == sales)
                {
                    name = "LeatherSoftBoots";
                    item = "Leather Soft Boots";
                    cost = 120;
                }
                sales++;
                if (selling == sales)
                {
                    name = "LeatherThighBoots";
                    item = "Leather Thigh Boots";
                    cost = 105;
                }
                sales++;
                if (selling == sales)
                ...
                if (selling == sales)
                {
                    name = "OniwabanLeggings";
                    item = "Oniwaban Leggingss";
                    cost = 80;
                }
                sales++;
                if (selling == sales)
                ...
                if (selling == sales)
                {
                    name = "StuddedBustierArms";
                    item = "Studded Arms, Bustier";
                    cost = 120;
                }
                sales++;
                if (selling == sales)
                ...
                if (selling == sales)
                {
                    name = "FemaleStuddedChest";
                    item = "Studded Chest, Female";
                    cost = 62;
                }
                sales++;
                if (selling == sales)
                ...
                if (selling == sales)
                {
                    name = "LeatherHiroSode";
                    item = "Leather Hiro Sode";
                    cost = 49;
                }
                sales++;
                if (selling == sales)
            ...
            else if (book.MaterialType == "wood")
            {
                ...
                if (selling == sales)
                {
                    name = "WoodenPlateGloves";
                    item = "Wooden Gauntlets";
                    cost = 155;
                }
                sales++;
                if (selling == sales)
                {
                    name = "WoodenPlateGorget";
                    item = "Wooden Gorget";
                    cost = 104;
                }
                sales++;
                ...
                if (selling == sales)
                {
                    name = "WoodenPlateLegs";
                    item = "Wooden Leggings";
                    cost = 218;
                }
                sales++;
                if (selling == sales)
                {
                    name = "WoodenPlateChest";
                    item = "Wooden Tunic";
                    cost = 243;
                }
                sales++;
                ...
                foreach (Item item in World.Items.Values)
                    if (item is MerchantsBook)
                    {
                        ...
                        if (material == "metal")
                        {
                            ...
                            if (
                                Worlds.GetMyWorld(book.Map, book.Location, book.X, book.Y)
                                == "the Serpent Island"
                            )
                                subType = new string[]
                                {
                        ...
                        else if (material == "leather")
                        {
                            ...
                            book.Name =
                                cultInfo.ToTitleCase(category) + " Crafted Items of Leather";
                        }
                        ...
                        {
                            book.MarkUp = 2;
                            book.Resource = CraftResource.DullCopper;
                        }
                        else if (category == "shadow iron")
                        {
                            book.MarkUp = 3;
                            book.Resource = CraftResource.ShadowIron;
                        }
                        else if (category == "copper")
                        {
                            book.MarkUp = 4;
                            book.Resource = CraftResource.Copper;
                        }
                        else if (category == "bronze")
                        {
                            book.MarkUp = 5;
                            book.Resource = CraftResource.Bronze;
                        }
                        else if (category == "gold")
                        {
                            book.MarkUp = 6;
                            book.Resource = CraftResource.Gold;
                        }
                        else if (category == "agapite")
                        {
                            book.MarkUp = 7;
                            book.Resource = CraftResource.Agapite;
                        }
                        else if (category == "verite")
                        {
                            book.MarkUp = 8;
                            book.Resource = CraftResource.Verite;
                        }
                        else if (category == "valorite")
                        {
                            book.MarkUp = 9;
                            book.Resource = CraftResource.Valorite;
                        }
                        else if (category == "nepturite")
                        {
                            book.MarkUp = 9;
                            book.Resource = CraftResource.Nepturite;
                        }
                        else if (category == "obsidian")
                        {
                            book.MarkUp = 9;
                            book.Resource = CraftResource.Obsidian;
                        }
                        else if (category == "steel")
                        {
                            book.MarkUp = 10;
                            book.Resource = CraftResource.Steel;
                        }
                        else if (category == "brass")
                        {
                            book.MarkUp = 11;
                            book.Resource = CraftResource.Brass;
                        }
                        else if (category == "mithril")
                        {
                            book.MarkUp = 12;
                            book.Resource = CraftResource.Mithril;
                        }
                        else if (category == "xormite")
                        {
                            book.MarkUp = 12;
                            book.Resource = CraftResource.Xormite;
                        }
                        else if (category == "dwarven")
                        {
                            book.MarkUp = 24;
                            book.Resource = CraftResource.Dwarven;
                        }
                        else if (category == "ash")
                        {
                            book.MarkUp = 1.5;
                            book.Resource = CraftResource.AshTree;
                        }
                        else if (category == "cherry")
                        {
                            book.MarkUp = 1.5;
                            book.Resource = CraftResource.CherryTree;
                        }
                        else if (category == "ebony")
                        {
                            book.MarkUp = 2;
                            book.Resource = CraftResource.EbonyTree;
                        }
                        else if (category == "golden oak")
                        {
                            book.MarkUp = 2;
                            book.Resource = CraftResource.GoldenOakTree;
                        }
                        else if (category == "hickory")
                        {
                            book.MarkUp = 2.5;
                            book.Resource = CraftResource.HickoryTree;
                        }
                        else if (category == "mahogany")
                        {
                            book.MarkUp = 2.5;
                            book.Resource = CraftResource.MahoganyTree;
                        }
                        else if (category == "driftwood")
                        {
                            book.MarkUp = 2.5;
                            book.Resource = CraftResource.DriftwoodTree;
                        }
                        else if (category == "oak")
                        {
                            book.MarkUp = 3;
                            book.Resource = CraftResource.OakTree;
                        }
                        else if (category == "pine")
                        {
                            book.MarkUp = 3;
                            book.Resource = CraftResource.PineTree;
                        }
                        else if (category == "ghost")
                        {
                            book.MarkUp = 3;
                            book.Resource = CraftResource.GhostTree;
                        }
                        else if (category == "rosewood")
                        {
                            book.MarkUp = 3.5;
                            book.Resource = CraftResource.RosewoodTree;
                        }
                        else if (category == "walnut")
                        {
                            book.MarkUp = 3.5;
                            book.Resource = CraftResource.WalnutTree;
                        }
                        else if (category == "elven")
                        {
                            book.MarkUp = 7;
                            book.Resource = CraftResource.ElvenTree;
                        }
                        else if (category == "petrified")
                        {
                            book.MarkUp = 3;
                            book.Resource = CraftResource.PetrifiedTree;
                        }
                        else if (category == "deep sea")
                        {
                            book.MarkUp = 2;
                            book.Resource = CraftResource.SpinedLeather;
                        }
                        else if (category == "lizard")
                        {
                            book.MarkUp = 2;
                            book.Resource = CraftResource.HornedLeather;
                        }
                        else if (category == "serpent")
                        {
                            book.MarkUp = 2.5;
                            book.Resource = CraftResource.BarbedLeather;
                        }
                        else if (category == "necrotic")
                        {
                            book.MarkUp = 2.5;
                            book.Resource = CraftResource.NecroticLeather;
                        }
                        else if (category == "volcanic")
                        {
                            book.MarkUp = 3;
                            book.Resource = CraftResource.VolcanicLeather;
                        }
                        else if (category == "frozen")
                        {
                            book.MarkUp = 3;
                            book.Resource = CraftResource.FrozenLeather;
                        }
                        else if (category == "goliath")
                        {
                            book.MarkUp = 3.5;
                            book.Resource = CraftResource.GoliathLeather;
                        }
                        else if (category == "draconic")
                        {
                            book.MarkUp = 3.5;
                            book.Resource = CraftResource.DraconicLeather;
                        }
                        else if (category == "hellish")
                        {
                            book.MarkUp = 4;
                            book.Resource = CraftResource.HellishLeather;
                        }
                        else if (category == "dinosaur")
                        {
                            book.MarkUp = 4.5;
                            book.Resource = CraftResource.DinosaurLeather;
                        }
                        else if (category == "alien")
                        {
                            book.MarkUp = 5;
                            book.Resource = CraftResource.AlienLeather;
                        }
