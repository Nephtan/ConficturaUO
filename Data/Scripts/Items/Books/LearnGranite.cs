...
namespace Server.Items
{
    public class LearnGraniteBook : Item
    {
        ...
        {
            public LearnGraniteGump(Mobile from)
                : base(50, 50)
            {
                string color = "#ddbc4b";
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">CRAFTING WITH SAND AND STONE</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Mining is the skill required to find granite within caves and mountains. Stone crafters use this granite to create stone furniture and statues. To mine, you simply need to obtain a pickaxe or shovel, double-click it, and then target a mountainside or cave floor. Initially, you will mostly obtain regular granite, but as you gain more experience, you will be able to find other types of granite.<BR><BR>The various types of granite are differentiated only by their color. For instance, crafting a statue from shadow iron granite will result in a blackened statue.<BR><BR>To craft items from granite, you must first learn how to mine it. Legends speak of gargoyles who possess the knowledge to teach humans these secrets. Once your carpentry skill is sufficient, you can begin crafting with a mallet and chisel.<BR><BR>Mining is also necessary to find sand on beaches and desert sands. Glass blowers use this sand to create bottles and jars. To gather sand, you follow the same process as mining granite. Target the sand at your feet with a pickaxe or shovel. Sand is obtained in piles, and alchemists can use a blowpipe to transform it into bottles, among other things. It is believed that the gargoyles also impart their knowledge of this artistic craft.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
        ...
        public LearnGraniteBook(Serial serial)
            : base(serial) { }
