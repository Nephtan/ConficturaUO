                ...
                : base(50, 50)
            {
                ...
                else if (m_Page == 2)
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">Harpoons are sometimes the weapon of choice for sailors of the high seas. using the marksmanship skill, one can throw a spear like weapon toward their foe. Although sailing merchants sell such weapons, blacksmiths are able to construct them. In order to use a harpoon, one must be able to throw it and then pull it back to themselves so they can throw it again. In order to accomplish this, one would need a good supply of harpoon rope. This style of rope is inexpensive and also commonly sold by sailor merchants. Tailors are able to weave such rope as well. Whenever you throw a harpoon, these ropes usually are expended so be sure to bring a good supply with you on your journey if you use such a weapon. The better your seafaring skill, the more effective you can be with such weapons as well.</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    AddImage(594, 180, 10887);
