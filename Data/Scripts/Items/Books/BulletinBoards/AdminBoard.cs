...
namespace Server.Items
{
    ...
    public class AdminBoard : Item
    {
        ...
        {
            public AdminBoardGump(Mobile from)
                : base(100, 100)
            {
                from.SendSound(0x59);
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Recent Messages from Throughout the Land</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Select an Article Below to Read</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                if (message10 != "")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            ...
                            + message10
                            + " - "
                            + Server.Misc.LoggingFunctions.LogArticles(10, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (message9 != "")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            ...
                            + message9
                            + " - "
                            + Server.Misc.LoggingFunctions.LogArticles(9, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (message8 != "")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            ...
                            + message8
                            + " - "
                            + Server.Misc.LoggingFunctions.LogArticles(8, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (message7 != "")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            ...
                            + message7
                            + " - "
                            + Server.Misc.LoggingFunctions.LogArticles(7, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (message6 != "")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            ...
                            + message6
                            + " - "
                            + Server.Misc.LoggingFunctions.LogArticles(6, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (message5 != "")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            ...
                            + message5
                            + " - "
                            + Server.Misc.LoggingFunctions.LogArticles(5, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (message4 != "")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            ...
                            + message4
                            + " - "
                            + Server.Misc.LoggingFunctions.LogArticles(4, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (message3 != "")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            ...
                            + message3
                            + " - "
                            + Server.Misc.LoggingFunctions.LogArticles(3, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (message2 != "")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            ...
                            + message2
                            + " - "
                            + Server.Misc.LoggingFunctions.LogArticles(2, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                if (message1 != "")
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            ...
                            + message1
                            + " - "
                            + Server.Misc.LoggingFunctions.LogArticles(1, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
        ...
        {
            public BoardMessage(Mobile from, int message)
                : base(100, 100)
            {
                from.SendSound(0x59);
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Misc.LoggingFunctions.LogArticles(message, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Misc.LoggingFunctions.LogArticles(message, 2)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Misc.LoggingFunctions.LogArticles(message, 3)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)true
                );
        ...
        public static string GetBoardName(int face)
        {
            ...
            {
                name = "Vorgarag the Ork Lord";
            }
            else if (face == 0x4DD)
            {
                name = "Dupre the Paladin";
            }
            else if (face == 0x47A)
            {
                name = "Kalana the Oracle";
            }
            else if (face == 0x4DE)
            {
                name = "Xavier the Theurgist";
            }

            return name;
        }

        public AdminBoard(Serial serial)
            : base(serial) { }
