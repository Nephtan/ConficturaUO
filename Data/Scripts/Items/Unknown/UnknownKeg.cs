...
namespace Server.Items
{
    public class KegRemovalTimer : Timer
    {
        ...
        public KegRemovalTimer(Item item)
    ...
    public class UnknownKeg : Item
    {
        ...
        public int Keg_Filled
        {
            get { return KegFilled; }
            set
            {
                KegFilled = value;
        ...
        public UnknownKeg(Serial serial)
            : base(serial) { }
            ...
            else if (from.InRange(this.GetWorldLocation(), 1))
            {
                ...
                else
                {
                    ...
                    if (nReaction == 1)
                    {
                        ...
                        from.SendMessage(
                            "You fail to identify the liquid, convulsing and spilling the keg."
                        );
                    }
                    else if (nReaction == 2)
                    {
                        ...
                        from.Say("*hiccup!*");
                        from.SendMessage(
                            "You fail to identify the liquid, spasming and spilling the keg."
                        );
                    }
                    else if (nReaction == 3)
                    {
                    ...
                    else if (nReaction == 4)
                    {
                        ...
                        from.SendMessage(
                            "You fail to identify the liquid, coughing and spilling the keg."
                        );
                    }
                    else if (nReaction == 5)
                    {
                        ...
                        if (!from.Mounted)
                            from.Animate(33, 5, 1, true, false, 0);
                        from.SendMessage(
                            "You fail to identify the liquid, hurting your throat...you dump out the keg."
                        );
                    }
                    else if (nReaction == 6)
                    {
                        ...
                        if (!from.Mounted)
                            from.Animate(33, 5, 1, true, false, 0);
                        from.SendMessage(
                            "You fail to identify the liquid, accidentally drinking the entire keg."
                        );
                    }
                    else if (nReaction > 6)
                    {
                    ...
                    else
                    {
                        ...
                        from.SendMessage(
                            "You fail to identify the liquid, spitting it out and dumping the keg."
                        );
                    }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (KegFilled <= 0)
            {
                Kword = "The keg is empty";
            }
            else if (KegFilled < 5)
            {
                Kword = "The keg is nearly empty";
            }
            else if (KegFilled < 20)
            {
                Kword = "The keg is not very full";
            }
            else if (KegFilled < 30)
            {
                Kword = "The keg is about one quarter full";
            }
            else if (KegFilled < 40)
            {
                Kword = "The keg is about one third full";
            }
            else if (KegFilled < 47)
            {
                Kword = "The keg is almost half full";
            }
            else if (KegFilled < 54)
            {
                Kword = "The keg is approximately half full";
            }
            else if (KegFilled < 70)
            {
                Kword = "The keg is more than half full";
            }
            else if (KegFilled < 80)
            {
                Kword = "The keg is about three quarters full";
            }
            else if (KegFilled < 96)
            {
                Kword = "The keg is very full";
            }
            else if (KegFilled < 100)
            {
                Kword = "The liquid is almost to the top of the keg";
            }
            else
            {
                Kword = "The keg is completely full";
            }
