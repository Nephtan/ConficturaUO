...
namespace Server.Items
{
    public class UnknownReagent : Item
    {
        ...
        public UnknownReagent(Serial serial)
            : base(serial) { }
        ...
        public static void GiveReagent(Mobile from, int qty)
        {
            ...
            {
                ingredient.Delete();
                ingredient = Loot.RandomMixerReagent();
            }
            ...
            {
                ingredient.Delete();
                ingredient = Loot.RandomNecromancyReagent();
            }

            if (
                Server.Misc.IntelligentAction.TestForReagent(from, "wizard") && Utility.RandomBool()
            )
            {
                ingredient.Delete();
                ingredient = Loot.RandomReagent();
            }
