...
namespace Server.Items
{
    public class UnidentifiedItem : LockableContainer
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Vendor_CanID
        {
            get { return VendorCanID; }
            set
            {
                VendorCanID = value;
                InvalidateProperties();
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (VendorCanID == "Blacksmith")
            {
                sVendorCanID = "Blacksmith, Weaponsmith, or Armorer Can Identify";
            }
            else if (VendorCanID == "Jeweler")
            {
                sVendorCanID = "Jeweler Can Identify";
            }
            else if (VendorCanID == "Tailor")
            {
                sVendorCanID = "Tailor or Weaver Can Identify";
            }
            else if (VendorCanID == "Leatherworker")
            {
                sVendorCanID = "Leatherworker or Tanner Can Identify";
            }
            else if (VendorCanID == "Bowyer")
            {
                sVendorCanID = "Bowyer Can Identify";
            }
            else if (VendorCanID == "Sage")
            {
                sVendorCanID = "Sage Can Identify";
            }
            else if (VendorCanID == "Bard")
            {
                sVendorCanID = "Bard Can Identify";
            }
            else if (VendorCanID == "Carpenter")
            {
                sVendorCanID = "Carpenter Can Identify";
            }
            else
            {
                VendorCanID = "Sage";
                sVendorCanID = "Sage Can Identify";
                SkillRequired = "ItemID";
            }

            if (SkillRequired == "ItemID")
            {
                sSkillRequired = "Use Mercantile To Determine What It Is";
            }
            else if (SkillRequired == "ArmsLore")
            {
                sSkillRequired = "Use Arms Lore To Determine What It Is";
            }
        ...
        public UnidentifiedItem(Serial serial)
            : base(serial) { }
