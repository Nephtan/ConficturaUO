...
namespace Server.Items
{
    public class MysticalPearl : Item
    {
        ...
        private class PearlTarget : Target
        {
            ...
            public PearlTarget(MysticalPearl tube)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (iPearl is BaseJewel)
                {
                    ...
                    )
                    {
                        ...
                        if (iPearl is BaseNecklace)
                        {
                            pName = "Mystical Pearl Necklace";
                        }
                        else if (iPearl is BaseEarrings)
                        {
                            pName = "Mystical Pearl Earrings";
                        }
                        else if (iPearl is MagicJewelryCirclet)
                        {
                            pName = "Mystical Pearl Circlet";
                        }
                        else if (iPearl is BaseBracelet)
                        {
                            pName = "Mystical Pearl Bracelet";
                        }
                        MorphingItem.MorphMyItem(
                            ...
                            "IGNORED",
                            pName,
                            MorphingTemplates.TemplatePearlJewelry("misc")
                        );
        ...
        public MysticalPearl(Serial serial)
            : base(serial) { }
