...
namespace Server.Items
{
    public class MagicTalisman : GoldRing
    {
        ...
        public MagicTalisman()
        {
            ...
            switch (trinket)
            {
                ...
                case 46:
                    Name = "skull";
                    ItemID = 0x4D12;
                    break; // Creature Skull
                case 47:
                    Name = "fishing hook";
                    ItemID = 0x4D13;
                    SkillBonuses.SetValues(4, SkillName.Seafaring, Utility.RandomMinMax(5, 20));
                    break; // Fishing Hook
                case 48:
                    Name = "coin";
                    ItemID = 0x4D14;
        ...
        public MagicTalisman(Serial serial)
            : base(serial) { }
