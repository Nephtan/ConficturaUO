...
namespace Server.Items
{
    public class SlayerTarget : Target
    {
        ...
        public SlayerTarget(SlayerDeed deed)
    ...
    public class SlayerDeed : Item
    {
        ...
        public int Slayer_Type
        {
            get { return SlayerType; }
            set
            {
                SlayerType = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Slayer_Names
        {
            get { return SlayerNames; }
            set
            {
                SlayerNames = value;
                InvalidateProperties();
            ...
            : base(0x14F0)
        {
            ...
            {
                case 0:
                    SlayerNames = "animal hunter";
                    break;
                case 1:
                    SlayerNames = "arachnid doom";
                    break;
                case 2:
                    SlayerNames = "avian hunter";
                    break;
                case 3:
                    SlayerNames = "devilish death";
                    break;
                case 4:
                    SlayerNames = "blood bane";
                    break;
                case 5:
                    SlayerNames = "demonic dismissal";
                    break;
                case 6:
                    SlayerNames = "dragon slayer";
                    break;
                case 7:
                    SlayerNames = "stone smashing";
                    break;
                case 8:
                    SlayerNames = "elemental slayer";
                    break;
                case 9:
                    SlayerNames = "poison cleansing";
                    break;
                case 10:
                    SlayerNames = "abysmal banishment";
                    break;
                case 11:
                    SlayerNames = "fey slayer";
                    break;
                case 12:
                    SlayerNames = "flame extinguishing";
                    break;
                case 13:
                    SlayerNames = "gargoyle bane";
                    break;
                case 14:
                    SlayerNames = "giant killer";
                    break;
                case 15:
                    SlayerNames = "golem destruction";
                    break;
                case 16:
                    SlayerNames = "lizardman death";
                    break;
                case 17:
                    SlayerNames = "neptune's bane";
                    break;
                case 18:
                    SlayerNames = "ogre extinction";
                    break;
                case 19:
                    SlayerNames = "ophidian slayer";
                    break;
                case 20:
                    SlayerNames = "orcish demise";
                    break;
                case 21:
                    SlayerNames = "humanoid assassination";
                    break;
                case 22:
                    SlayerNames = "reptile slayer";
                    break;
                case 23:
                    SlayerNames = "scorpion slayer";
                    break;
                case 24:
                    SlayerNames = "supernatural vanquishing";
                    break;
                case 25:
                    SlayerNames = "slimy scourge";
                    break;
                case 26:
                    SlayerNames = "serpent eradication";
                    break;
                case 27:
                    SlayerNames = "spider eradication";
                    break;
                case 28:
                    SlayerNames = "arctic destruction";
                    break;
                case 29:
                    SlayerNames = "terathan slayer";
                    break;
                case 30:
                    SlayerNames = "troll killer";
                    break;
                case 31:
                    SlayerNames = "windy wrath";
                    break;
                case 32:
                    SlayerNames = "watery grave";
                    break;
                case 33:
                    SlayerNames = "weed ruin";
                    break;
                case 34:
                    SlayerNames = "wizard slayer";
                    break;
            }
        }
        ...
        public SlayerDeed(Serial serial)
            : base(serial) { }
        ...
        public static SlayerName GetDeedSlayer(int slays)
        {
            ...
            {
                slayer = SlayerName.SlimyScourge;
            }
            else if (slays == 26)
            {
