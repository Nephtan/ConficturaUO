...
namespace Server.Items
{
    public class GuildRings : GoldRing
    {
        ...
        public Mobile Ring_Owner
        {
            get { return RingOwner; }
            set { RingOwner = value; }
        }

        [CommandProperty(AccessLevel.Owner)]
        public string Ring_Guild
        {
            get { return RingGuild; }
            set
            {
                RingGuild = value;
        ...
        public GuildRings(Mobile from, int guild)
        {
            ...
            {
                case 1:
                    RingGuild = "MagesGuild";
                    RingName = "Member of the Wizards Guild";
                    ...
                    break;
                case 2:
                    RingGuild = "WarriorsGuild";
                    RingName = "Member of the Warriors Guild";
                    ...
                    SkillBonuses.SetValues(4, SkillName.Tactics, 10);
                    break;
                case 3:
                    RingGuild = "ThievesGuild";
                    RingName = "Member of the Thieves Guild";
                ...
                case 4:
                    ...
                    RingName = "Member of the Rangers Guild";
                    SkillBonuses.SetValues(0, SkillName.Camping, 25);
                    SkillBonuses.SetValues(1, SkillName.Tracking, 25);
                    break;
                case 5:
                    RingGuild = "HealersGuild";
                    RingName = "Member of the Healers Guild";
                    SkillBonuses.SetValues(0, SkillName.Anatomy, 15);
                    SkillBonuses.SetValues(1, SkillName.Healing, 15);
                    SkillBonuses.SetValues(2, SkillName.Veterinary, 15);
                    break;
                case 6:
                    RingGuild = "MinersGuild";
                    RingName = "Member of the Miners Guild";
                    SkillBonuses.SetValues(0, SkillName.Mining, 30);
                    break;
                case 7:
                    RingGuild = "MerchantsGuild";
                    RingName = "Member of the Merchants Guild";
                    SkillBonuses.SetValues(0, SkillName.Mercantile, 15);
                    SkillBonuses.SetValues(1, SkillName.ArmsLore, 15);
                    SkillBonuses.SetValues(2, SkillName.Tasting, 15);
                    break;
                case 8:
                    RingGuild = "TinkersGuild";
                    RingName = "Member of the Tinkers Guild";
                    SkillBonuses.SetValues(0, SkillName.Tinkering, 30);
                    break;
                case 9:
                    RingGuild = "TailorsGuild";
                    RingName = "Member of the Tailors Guild";
                    SkillBonuses.SetValues(0, SkillName.Tailoring, 30);
                    break;
                case 10:
                    RingGuild = "FishermensGuild";
                    RingName = "Member of the Mariners Guild";
                    SkillBonuses.SetValues(0, SkillName.Seafaring, 30);
                    break;
                case 11:
                    RingGuild = "BardsGuild";
                    RingName = "Member of the Bards Guild";
                    ...
                    break;
                case 12:
                    RingGuild = "BlacksmithsGuild";
                    RingName = "Member of the Blacksmiths Guild";
                    SkillBonuses.SetValues(0, SkillName.Blacksmith, 20);
                    SkillBonuses.SetValues(1, SkillName.ArmsLore, 20);
                    break;
                case 13:
                    RingGuild = "NecromancersGuild";
                    RingName = "Member of the Black Magic Guild";
                    ...
                    break;
                case 14:
                    RingGuild = "AlchemistsGuild";
                    RingName = "Member of the Alchemists Guild";
                ...
                case 15:
                    ...
                    SkillBonuses.SetValues(4, SkillName.Cooking, 5);
                    break;
                case 16:
                    RingGuild = "ArchersGuild";
                    RingName = "Member of the Archers Guild";
                    ...
                    break;
                case 17:
                    RingGuild = "CarpentersGuild";
                    RingName = "Member of the Carpenters Guild";
                    SkillBonuses.SetValues(0, SkillName.Carpentry, 20);
                    SkillBonuses.SetValues(1, SkillName.Lumberjacking, 20);
                    break;
                case 18:
                    RingGuild = "CartographersGuild";
                    RingName = "Member of the Cartographers Guild";
                    SkillBonuses.SetValues(0, SkillName.Cartography, 30);
                    break;
                case 19:
                    RingGuild = "LibrariansGuild";
                    RingName = "Member of the Librarians Guild";
                    SkillBonuses.SetValues(0, SkillName.Mercantile, 20);
                    SkillBonuses.SetValues(1, SkillName.Inscribe, 20);
                    break;
                case 20:
                    RingGuild = "CulinariansGuild";
                    RingName = "Member of the Culinary Guild";
                    SkillBonuses.SetValues(0, SkillName.Cooking, 20);
                    SkillBonuses.SetValues(1, SkillName.Tasting, 20);
                    break;
                case 21:
                    RingGuild = "AssassinsGuild";
                    RingName = "Member of the Assassins Guild";
                    SkillBonuses.SetValues(0, SkillName.Fencing, 10);
                    ...
                    break;
                case 22:
                    RingGuild = "ElementalGuild";
                    RingName = "Member of the Elemental Guild";
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (RingOwner != null)
            {
                list.Add(1049644, RingOwner.Name);
            }
        }
        ...
        public GuildRings(Serial serial)
            : base(serial) { }
