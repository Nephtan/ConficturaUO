...
namespace Server.Items
{
    public abstract class BaseLevelNecklace : BaseLevelJewel
    {
        ...
        public BaseLevelNecklace(int itemID)
            : base(itemID, Layer.Neck) { }

        public BaseLevelNecklace(Serial serial)
            : base(serial) { }
    ...
    public class LevelNecklace : BaseLevelNecklace
    {
        ...
        public LevelNecklace(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public LevelSilverBeadNecklace()
            : base(0x4CFE)
        {
            Name = "beads";
            Weight = 0.1;
