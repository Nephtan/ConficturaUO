...
namespace Server.Items
{
    public class LevelTalismanLeather : LevelGoldRing
    {
        ...
        public LevelTalismanLeather(Serial serial)
            : base(serial) { }
    ...
    public class LevelTalismanSnake : LevelGoldRing
    {
        ...
        public LevelTalismanSnake(Serial serial)
            : base(serial) { }
    ...
    public class LevelTalismanTotem : LevelGoldRing
    {
        ...
        public LevelTalismanTotem(Serial serial)
            : base(serial) { }
    ...
    public class LevelTalismanHoly : LevelGoldRing
    {
        ...
        public LevelTalismanHoly(Serial serial)
            : base(serial) { }
