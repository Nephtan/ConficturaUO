                ...
                if (LevelAttributes.m_Attributes[i].m_Category == cat)
                {
                    ...
                    if (m_Item is BaseWeapon)
                        attrvalue = ((BaseWeapon)m_Item).Attributes[
                            LevelAttributes.m_Attributes[i].m_Attribute
                        ];
                    ...
                    AddLabel(
                        ...
                        117 + (pageindex * 20),
                        LabelHue,
                        LevelAttributes.m_Attributes[i].m_Name
                            + " ("
                            + GetPointCost(m_Item, LevelAttributes.m_Attributes[i].m_XP)
                            + "sp)"
                    );
            ...
            if (m_Item is BaseWeapon)
            {
                for (int i = 0; i < LevelAttributes.m_WeaponAttributes.Length; ++i)
                {
                    if (LevelAttributes.m_WeaponAttributes[i].m_Category == cat)
                    {
                        ...
                        if (
                            LevelAttributes.m_WeaponAttributes[i].m_Attribute
                        ...
                        AddLabel(
                            ...
                            117 + (pageindex * 20),
                            LabelHue,
                            LevelAttributes.m_WeaponAttributes[i].m_Name
                                + " ("
                                + GetPointCost(m_Item, LevelAttributes.m_WeaponAttributes[i].m_XP)
                                + "sp)"
                        );
                        AddLabel(540, 117 + (pageindex * 20), LabelHue, attrvalue.ToString());
            ...
            else if (m_Item is BaseArmor)
            {
                if (cat == AttributeCategory.Resists)
                {
                    for (int i = 0; i < LevelAttributes.m_ResistanceTypes.Length; ++i)
                    {
                        ...
                        if (
                            LevelAttributes.m_ResistanceTypes[i].m_Attribute
                            == ResistanceType.Physical
                        )
                            attrvalue = ((BaseArmor)m_Item).PhysicalBonus;
                        else if (
                            LevelAttributes.m_ResistanceTypes[i].m_Attribute == ResistanceType.Fire
                        )
                            attrvalue = ((BaseArmor)m_Item).FireBonus;
                        else if (
                            LevelAttributes.m_ResistanceTypes[i].m_Attribute == ResistanceType.Cold
                        )
                        ...
                        AddLabel(
                            ...
                            117 + (pageindex * 20),
                            LabelHue,
                            LevelAttributes.m_ResistanceTypes[i].m_Name
                                + " ("
                                + GetPointCost(m_Item, LevelAttributes.m_ResistanceTypes[i].m_XP)
                                + "sp)"
                        );
                        AddLabel(540, 117 + (pageindex * 20), LabelHue, attrvalue.ToString());
                ...
                else
                {
                    for (int i = 0; i < LevelAttributes.m_ArmorAttributes.Length; ++i)
                    {
                        if (LevelAttributes.m_ArmorAttributes[i].m_Category == cat)
                        {
                            ...
                            if (
                                LevelAttributes.m_ArmorAttributes[i].m_Attribute
                            ...
                            AddLabel(
                                ...
                                117 + (pageindex * 20),
                                LabelHue,
                                LevelAttributes.m_ArmorAttributes[i].m_Name
                                    + " ("
                                    + GetPointCost(
                                        m_Item,
                                        LevelAttributes.m_ArmorAttributes[i].m_XP
                                    )
                                    + "sp)"
                            );
                            AddLabel(540, 117 + (pageindex * 20), LabelHue, attrvalue.ToString());
                    ...
                    for (int i = 0; i < LevelAttributes.m_ElementAttributes.Length; ++i)
                    {
                        ...
                        if (m_Item is BaseJewel)
                            attrvalue = ((BaseJewel)m_Item).Resistances[
                                LevelAttributes.m_ElementAttributes[i].m_Attribute
                            ];
                        else
                        ...
                        AddLabel(
                            ...
                            117 + (pageindex * 20),
                            LabelHue,
                            LevelAttributes.m_ElementAttributes[i].m_Name
                                + " ("
                                + GetPointCost(m_Item, LevelAttributes.m_ElementAttributes[i].m_XP)
                                + "sp)"
                        );
                        AddLabel(540, 117 + (pageindex * 20), LabelHue, attrvalue.ToString());
            ...
            switch (type)
            {
                ...
                case 1: // Select Attribute Type
                {
                    switch (index)
                    {
                        ...
                        {
                            m_From.SendGump(
                                new ItemExperienceGump(
                                    m_From,
                                    m_Item,
                                    AttributeCategory.Melee,
                ...
                case 2: // Attribute selected
                {
                    ...
                    if ((levitem.Points - cost) >= 0)
                    {
                        ...
                        if (index >= 0 && index < LevelAttributes.m_Attributes.Length)
                        {
                            ...
                            {
                                attrvalue = ((BaseWeapon)m_Item).Attributes[
                                    LevelAttributes.m_Attributes[index].m_Attribute
                                ];
                    ...
                    m_From.SendGump(
                        new ItemExperienceGump(
                            m_From,
                            m_Item,
                            LevelAttributes.m_Attributes[index].m_Category,
                            GumpPage.AttributeList
                        )
                    );
                ...
                case 3: // WeaponAttribute selected
                {
                    ...
                    if ((levitem.Points - cost) >= 0)
                    {
                        ...
                        if (
                            ...
                            && index < LevelAttributes.m_WeaponAttributes.Length
                        )
                        {
                            if (
                                LevelAttributes.m_WeaponAttributes[index].m_Attribute
                                == AosWeaponAttribute.DurabilityBonus
                            )
                            {
                                attrvalue = ((BaseWeapon)m_Item).MaxHitPoints;
                    ...
                    m_From.SendGump(
                        new ItemExperienceGump(
                            m_From,
                            m_Item,
                            LevelAttributes.m_WeaponAttributes[index].m_Category,
                            GumpPage.AttributeList
                        )
                    );
                ...
                case 4: // Armor Attributes Selected
                {
                    ...
                    if ((levitem.Points - cost) >= 0)
                    {
                        ...
                        if (
                            index >= 0
                            && m_Item is BaseArmor
                            && index < LevelAttributes.m_ArmorAttributes.Length
                        )
                        {
                            if (
                                LevelAttributes.m_ArmorAttributes[index].m_Attribute
                                == AosArmorAttribute.DurabilityBonus
                            )
                            {
                                attrvalue = ((BaseArmor)m_Item).MaxHitPoints;
                    ...
                    m_From.SendGump(
                        new ItemExperienceGump(
                            m_From,
                            m_Item,
                            LevelAttributes.m_ArmorAttributes[index].m_Category,
                            GumpPage.AttributeList
                        )
                    );
                ...
                case 5: // Armor Resists Selected
                {
                    ...
                    if ((levitem.Points - cost) >= 0)
                    {
                        ...
                        if (
                            index >= 0
                            && m_Item is BaseArmor
                            && index < LevelAttributes.m_ResistanceTypes.Length
                        )
                        {
                            if (
                                LevelAttributes.m_ResistanceTypes[index].m_Attribute
                                == ResistanceType.Physical
                            )
                            {
                                attrvalue = ((BaseArmor)m_Item).PhysicalBonus;
                    ...
                    m_From.SendGump(
                        new ItemExperienceGump(
                            m_From,
                            m_Item,
                            LevelAttributes.m_ResistanceTypes[index].m_Category,
                            GumpPage.AttributeList
                        )
                    );
                ...
                case 6: // Jewelry & Clothing Resists Selected
                {
                    ...
                    if ((levitem.Points - cost) >= 0)
                    {
                        ...
                        if (
                            ...
                            && index < LevelAttributes.m_ElementAttributes.Length
                        )
                        {
                            if (m_Item is BaseJewel)
                            {
                                attrvalue = ((BaseJewel)m_Item).Resistances[
                                    LevelAttributes.m_ElementAttributes[index].m_Attribute
                                ];
                                if (
                                    attrvalue
                                    < LevelAttributes.m_ElementAttributes[index].m_MaxValue
                                )
                                {
                    ...
                    m_From.SendGump(
                        new ItemExperienceGump(
                            m_From,
                            m_Item,
                            LevelAttributes.m_ElementAttributes[index].m_Category,
                            GumpPage.AttributeList
                        )
                    );
