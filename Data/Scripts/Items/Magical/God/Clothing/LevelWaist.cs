...
namespace Server.Items
{
    ...
    {
        public BaseLevelWaist(int itemID)
            : this(itemID, 0) { }

        public BaseLevelWaist(int itemID, int hue)
            : base(itemID, Layer.Waist, hue) { }

        public BaseLevelWaist(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public LevelHalfApron()
            : this(0) { }

        [Constructable]
        public LevelHalfApron(int hue)
            : base(0x153b, hue)
        {
            Weight = 2.0;
        }
    ...
    {
        [Constructable]
        public LevelWoodlandBelt()
            : this(0) { }

        [Constructable]
        public LevelWoodlandBelt(int hue)
            : base(0x2B68, hue)
        {
            Weight = 4.0;
            Name = "loin cloth";
