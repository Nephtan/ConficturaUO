...
namespace Server.Items
{
    ...
    {
        public BaseLevelOuterTorso(int itemID)
            : this(itemID, 0) { }

        public BaseLevelOuterTorso(int itemID, int hue)
            : base(itemID, Layer.OuterTorso, hue) { }

        public BaseLevelOuterTorso(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public LevelGildedDress()
            : this(0) { }

        [Constructable]
        public LevelGildedDress(int hue)
            : base(0x230E, hue)
        {
            Weight = 3.0;
            Name = "gilded dress";
    ...
    public class LevelFancyDress : BaseLevelOuterTorso
    {
        ...
        [Constructable]
        public LevelFancyDress(int hue)
            : base(0x1F00, hue)
        {
            Weight = 3.0;
    ...
    {
        [Constructable]
        public LevelHoodedShroudOfShadows()
            : this(0x455) { }

        [Constructable]
        public LevelHoodedShroudOfShadows(int hue)
            : base(0x2684, hue)
        {
    ...
    {
        [Constructable]
        public LevelPlainDress()
            : this(0) { }

        [Constructable]
        public LevelPlainDress(int hue)
            : base(0x1F01, hue)
        {
            Weight = 2.0;
            Name = "dress";
    ...
    {
        [Constructable]
        public LevelKamishimo()
            : this(0) { }

        [Constructable]
        public LevelKamishimo(int hue)
            : base(0x2799, hue)
        {
            Weight = 3.0;
        }
    ...
    {
        [Constructable]
        public LevelHakamaShita()
            : this(0) { }

        [Constructable]
        public LevelHakamaShita(int hue)
            : base(0x279C, hue)
        {
            Weight = 3.0;
        }
    ...
    {
        [Constructable]
        public LevelMaleKimono()
            : this(0) { }

        [Constructable]
        public LevelMaleKimono(int hue)
            : base(0x2782, hue)
        {
            Weight = 3.0;
        }
    ...
    {
        [Constructable]
        public LevelFemaleKimono()
            : this(0) { }

        [Constructable]
        public LevelFemaleKimono(int hue)
            : base(0x2783, hue)
        {
            Weight = 3.0;
        }
    ...
    {
        [Constructable]
        public LevelMaleElvenRobe()
            : this(0) { }

        [Constructable]
        public LevelMaleElvenRobe(int hue)
            : base(0x2FB9, hue)
        {
            Name = "robe";
            Weight = 2.0;
    ...
    {
        [Constructable]
        public LevelFemaleElvenRobe()
            : this(0) { }

        [Constructable]
        public LevelFemaleElvenRobe(int hue)
            : base(0x2FBA, hue)
        {
            Name = "robe";
            Weight = 2.0;
