...
namespace Server.Items
{
    ...
    {
        public BaseLevelShoes(int itemID)
            : this(itemID, 0) { }

        public BaseLevelShoes(int itemID, int hue)
            : base(itemID, Layer.Shoes, hue) { }

        public BaseLevelShoes(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public LevelFurBoots()
            : this(0) { }

        [Constructable]
        public LevelFurBoots(int hue)
            : base(0x2307, hue)
        {
            Weight = 3.0;
            ItemID = 0x2307;
    ...
    public class LevelThighBoots : BaseLevelShoes, IArcaneEquip
    {
        ...
        [Constructable]
        public LevelThighBoots()
            : this(0) { }

        [Constructable]
        public LevelThighBoots(int hue)
            : base(0x1711, hue)
        {
            Weight = 4.0;
        }
    ...
    public class LevelSamuraiTabi : BaseLevelShoes
    {
        ...
        [Constructable]
        public LevelSamuraiTabi(int hue)
            : base(0x2796, hue)
        {
            Weight = 2.0;
        }
    ...
    public class LevelElvenBoots : BaseLevelShoes
    {
        ...
        [Constructable]
        public LevelElvenBoots(int hue)
            : base(0x2FC4, hue)
        {
            Name = "fancy boots";
            Weight = 2.0;
