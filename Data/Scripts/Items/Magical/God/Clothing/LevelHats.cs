...
namespace Server.Items
{
    ...
    {
        public BaseLevelHat(int itemID)
            : this(itemID, 0) { }

        public BaseLevelHat(int itemID, int hue)
            : base(itemID, Layer.Helm, hue) { }

        public BaseLevelHat(Serial serial)
            : base(serial) { }
    ...
    public class LevelClothNinjaHood : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelClothNinjaHood(int hue)
            : base(0x278F, hue)
        {
            Weight = 2.0;
        }
    ...
    public class LevelFlowerGarland : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelFlowerGarland()
            : this(0) { }

        [Constructable]
        public LevelFlowerGarland(int hue)
            : base(0x2306, hue)
        {
            Weight = 1.0;
        }
    ...
    public class LevelFloppyHat : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelFloppyHat()
            : this(0) { }

        [Constructable]
        public LevelFloppyHat(int hue)
            : base(0x1713, hue)
        {
            Weight = 1.0;
        }
    ...
    public class LevelWideBrimHat : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelWideBrimHat(int hue)
            : base(0x1714, hue)
        {
            Weight = 1.0;
        }
    ...
    public class LevelSkullCap : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelSkullCap()
            : this(0) { }

        [Constructable]
        public LevelSkullCap(int hue)
            : base(0x1544, hue)
        {
            Weight = 1.0;
        }
    ...
    public class LevelBearMask : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelBearMask()
            : this(0) { }

        [Constructable]
        public LevelBearMask(int hue)
            : base(0x1545, hue)
        {
            Name = "bear mask";
            Weight = 5.0;
    ...
    public class LevelWolfMask : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelWolfMask()
            : this(0) { }

        [Constructable]
        public LevelWolfMask(int hue)
            : base(0x2B6D, hue)
        {
            Name = "wolf mask";
            Weight = 5.0;
    ...
    public class LevelDeerMask : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelDeerMask()
            : this(0) { }

        [Constructable]
        public LevelDeerMask(int hue)
            : base(0x1547, hue)
        {
            Name = "deer mask";
            Weight = 4.0;
    ...
    public class LevelHornedTribalMask : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelHornedTribalMask()
            : this(0) { }

        [Constructable]
        public LevelHornedTribalMask(int hue)
            : base(0x1549, hue)
        {
            Weight = 2.0;
        }
    ...
    public class LevelTribalMask : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelTribalMask()
            : this(0) { }

        [Constructable]
        public LevelTribalMask(int hue)
            : base(0x154B, hue)
        {
            Weight = 2.0;
        }
    ...
    public class LevelTallStrawHat : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelTallStrawHat()
            : this(0) { }

        [Constructable]
        public LevelTallStrawHat(int hue)
            : base(0x1716, hue)
        {
            Weight = 1.0;
        }
    ...
    public class LevelStrawHat : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelStrawHat()
            : this(0) { }

        [Constructable]
        public LevelStrawHat(int hue)
            : base(0x1717, hue)
        {
            Weight = 1.0;
        }
    ...
    public class LevelWizardsHat : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelWizardsHat()
            : this(0) { }

        [Constructable]
        public LevelWizardsHat(int hue)
            : base(0x1718, hue)
        {
            Weight = 1.0;
        }
    ...
    public class LevelWitchHat : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelWitchHat()
            : this(0) { }

        [Constructable]
        public LevelWitchHat(int hue)
            : base(0x2FC3, hue)
        {
            Name = "witch hat";
            Weight = 1.0;
    ...
    public class LevelFeatheredHat : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelFeatheredHat()
            : this(0) { }

        [Constructable]
        public LevelFeatheredHat(int hue)
            : base(0x171A, hue)
        {
            Weight = 1.0;
        }
    ...
    public class LevelTricorneHat : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelTricorneHat()
            : this(0) { }

        [Constructable]
        public LevelTricorneHat(int hue)
            : base(0x171B, hue)
        {
            Weight = 1.0;
        }
    ...
    public class LevelPirateHat : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelPirateHat()
            : this(0) { }

        [Constructable]
        public LevelPirateHat(int hue)
            : base(0x2FBC, hue)
        {
            Name = "pirate hat";
            Weight = 1.0;
    ...
    public class LevelJesterHat : BaseLevelHat
    {
        ...
        [Constructable]
        public LevelJesterHat()
            : this(0) { }

        [Constructable]
        public LevelJesterHat(int hue)
            : base(0x171C, hue)
        {
            Weight = 1.0;
        }
