...
namespace Server.Items
{
    ...
    {
        public BaseLevelOuterLegs(int itemID)
            : this(itemID, 0) { }

        public BaseLevelOuterLegs(int itemID, int hue)
            : base(itemID, Layer.OuterLegs, hue) { }

        public BaseLevelOuterLegs(Serial serial)
            : base(serial) { }
