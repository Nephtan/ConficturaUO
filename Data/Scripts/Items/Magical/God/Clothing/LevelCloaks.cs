...
namespace Server.Items
{
    ...
    {
        public BaseLevelCloak(int itemID)
            : this(itemID, 0) { }

        public BaseLevelCloak(int itemID, int hue)
            : base(itemID, Layer.Cloak, hue) { }

        public BaseLevelCloak(Serial serial)
            : base(serial) { }
