...
namespace Server.Items
{
    ...
    {
        public BaseLevelShirt(int itemID)
            : this(itemID, 0) { }

        public BaseLevelShirt(int itemID, int hue)
            : base(itemID, Layer.Shirt, hue) { }

        public BaseLevelShirt(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public LevelFancyShirt()
            : this(0) { }

        [Constructable]
        public LevelFancyShirt(int hue)
            : base(0x1EFD, hue)
        {
            Weight = 2.0;
        }
    ...
    public class LevelClothNinjaJacket : BaseLevelShirt
    {
        ...
        [Constructable]
        public LevelClothNinjaJacket(int hue)
            : base(0x2794, hue)
        {
            Weight = 5.0;
