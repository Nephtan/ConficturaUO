...
namespace Server.Items
{
    ...
    {
        public BaseLevelMiddleTorso(int itemID)
            : this(itemID, 0) { }

        public BaseLevelMiddleTorso(int itemID, int hue)
            : base(itemID, Layer.MiddleTorso, hue) { }

        public BaseLevelMiddleTorso(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public LevelBodySash()
            : this(0) { }

        [Constructable]
        public LevelBodySash(int hue)
            : base(0x1541, hue)
        {
            Weight = 1.0;
        }
    ...
    {
        [Constructable]
        public LevelFullApron()
            : this(0) { }

        [Constructable]
        public LevelFullApron(int hue)
            : base(0x153d, hue)
        {
            Weight = 4.0;
        }
    ...
    {
        [Constructable]
        public LevelFormalShirt()
            : this(0) { }

        [Constructable]
        public LevelFormalShirt(int hue)
            : base(0x2310, hue)
        {
            Weight = 1.0;
        }
    ...
    {
        [Constructable]
        public LevelJesterSuit()
            : this(0) { }

        [Constructable]
        public LevelJesterSuit(int hue)
            : base(0x1F9F, hue)
        {
            Weight = 4.0;
        }
    ...
    {
        [Constructable]
        public LevelJinBaori()
            : this(0) { }

        [Constructable]
        public LevelJinBaori(int hue)
            : base(0x27A1, hue)
        {
            Weight = 3.0;
        }
