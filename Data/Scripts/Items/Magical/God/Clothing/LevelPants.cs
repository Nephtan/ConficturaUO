...
namespace Server.Items
{
    ...
    {
        public BaseLevelPants(int itemID)
            : this(itemID, 0) { }

        public BaseLevelPants(int itemID, int hue)
            : base(itemID, Layer.Pants, hue) { }

        public BaseLevelPants(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public LevelShortPants()
            : this(0) { }

        [Constructable]
        public LevelShortPants(int hue)
            : base(0x152E, hue)
        {
            Weight = 2.0;
            Name = "short pants";
    ...
    {
        [Constructable]
        public LevelLongPants()
            : this(0) { }

        [Constructable]
        public LevelLongPants(int hue)
            : base(0x1539, hue)
        {
            Weight = 2.0;
            Name = "long pants";
    ...
    public class LevelTattsukeHakama : BaseLevelPants
    {
        ...
        [Constructable]
        public LevelTattsukeHakama(int hue)
            : base(0x279B, hue)
        {
            Weight = 2.0;
        }
    ...
    {
        [Constructable]
        public LevelElvenPants()
            : this(0) { }

        [Constructable]
        public LevelElvenPants(int hue)
            : base(0x2FC3, hue)
        {
            Name = "pants";
            Weight = 2.0;
