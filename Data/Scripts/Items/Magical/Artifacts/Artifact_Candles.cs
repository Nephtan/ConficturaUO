...
namespace Server.Items
{
    public class Artifact_CandleCold : GiftCandle
    {
        ...
        public Artifact_CandleCold(Serial serial)
            : base(serial) { }
    ...
    public class Artifact_CandleFire : GiftCandle
    {
        ...
        public Artifact_CandleFire(Serial serial)
            : base(serial) { }
    ...
    public class Artifact_CandlePoison : GiftCandle
    {
        ...
        public Artifact_CandlePoison(Serial serial)
            : base(serial) { }
    ...
    public class Artifact_CandleEnergy : GiftCandle
    {
        ...
        public Artifact_CandleEnergy(Serial serial)
            : base(serial) { }
    ...
    public class Artifact_CandleWizard : GiftCandle
    {
        ...
        public Artifact_CandleWizard(Serial serial)
            : base(serial) { }
    ...
    public class Artifact_CandleNecromancer : GiftCandle
    {
        ...
        public Artifact_CandleNecromancer(Serial serial)
            : base(serial) { }
