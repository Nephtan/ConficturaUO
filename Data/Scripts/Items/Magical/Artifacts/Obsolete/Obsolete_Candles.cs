...
namespace Server.Items
{
    public class CandleCold : MagicCandle
    {
        ...
        public CandleCold(Serial serial)
            : base(serial) { }
    ...
    public class CandleFire : MagicCandle
    {
        ...
        public CandleFire(Serial serial)
            : base(serial) { }
    ...
    public class CandlePoison : MagicCandle
    {
        ...
        public CandlePoison(Serial serial)
            : base(serial) { }
    ...
    public class CandleEnergy : MagicCandle
    {
        ...
        public CandleEnergy(Serial serial)
            : base(serial) { }
    ...
    public class CandleWizard : MagicCandle
    {
        ...
        public CandleWizard(Serial serial)
            : base(serial) { }
    ...
    public class CandleNecromancer : MagicCandle
    {
        ...
        public CandleNecromancer(Serial serial)
            : base(serial) { }
