...
namespace Server.Items
{
    ...
    public class RodOfResurrection : Scepter
    {
        ...
        public ResurrectEffect Effect
        {
            get { return m_ResurrectEffect; }
            set
            {
                m_ResurrectEffect = value;
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Mobile owner, RodOfResurrection rod)
        ...
        public RodOfResurrection(Serial serial)
            : base(serial) { }
