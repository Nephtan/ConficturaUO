...
namespace Server.Misc
{
    class MorphingItem
    {
        public static void MorphMyItem(
            Item i,
            string etch,
            string prefix,
            string names,
        ...
        )
        {
            if (i is BaseWeapon)
            {
                ...
                foreach (string s in morph)
                {
                    ...
                    if (force > 0 && cycle == 35)
                    {
                        x.HitPoints = x.HitPoints + force;
                        x.MaxHitPoints = x.MaxHitPoints + force;
                    }
                    if (force > 0 && cycle == 36)
                    {
                        x.MinDamage = x.MinDamage + force;
                        x.MaxDamage = x.MaxDamage + force;
                    }
                    if (force > 0 && cycle == 37)
                    {
