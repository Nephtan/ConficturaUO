    ...
    class MorphingTemplates
    {
        ...
        public static string TemplateCaddellite(string s) /////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 23 FOR WeaponAttributes.UseBestSkill */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 24 FOR WeaponAttributes.DurabilityBonus */powers = powers + "," + "0";
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("caddellite", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateStarRuby(string s) ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("star ruby", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
        ...
        public static string TemplateSpinel(string s) /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("spinel", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateSilver(string s) /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("silver", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateRuby(string s) ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("ruby", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateQuartz(string s) /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("quartz", "", 0)).ToString(); // INT ONLY
        ...
        public static string TemplateOnyx(string s) ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("onyx", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateMarble(string s) /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("marble", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateGarnet(string s) /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("garnet", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateIce(string s) ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("ice", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateJade(string s) ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("jade", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateTopaz(string s) //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("topaz", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateAmethyst(string s) ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("amethyst", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateEmerald(string s) ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("emerald", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
        ...
        public static string TemplateSapphire(string s) ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (s == "weapons")
            {
                ...
                /* ENTRY 25 FOR Hue */powers =
                    powers
                    + ","
                    + (Server.Misc.MaterialInfo.GetMaterialColor("sapphire", "", 0)).ToString(); // INT ONLY
                /* ENTRY 26 FOR AccuracyLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 27 FOR DamageLevel */powers = powers + "," + "0"; // VALUE OF 1-6
                /* ENTRY 28 FOR Quality */powers = powers + "," + "0"; // VALUE OF 1
                /* ENTRY 29 FOR DurabilityLevel */powers = powers + "," + "0"; // VALUE OF 1-6
