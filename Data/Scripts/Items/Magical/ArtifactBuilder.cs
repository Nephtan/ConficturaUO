    ...
    class ArtifactBuilder
    {
        public static Item CreateArtifact(string arty)
        {
            ...
            while (artifact == null)
            {
                ...
                {
                    arty = "any";
                    int HighSearch = 346 + 3; // THERE ARE 346 ARTIFACTS SO CHANGE THE SECOND NUMBER TO THE NUMBER OF CATEGORIES LISTED BELOW...
                ...
                if (arty == "driftwood") // ONLY FOR SEA TRAVELERS
                {
                    ...
                    {
                        artifact.Hue = 0x5B2;
                        artifact.Name = "runed driftwood " + artifact.Name;
                    }
                }
                else if (arty == "kelp") // ONLY FOR SEA TRAVELERS
                {
                    ...
                    {
                        artifact.Hue = 0x483;
                        artifact.Name = artifact.Name.Replace("leather", "kelp woven");
                    }
                }
                else if (arty == "barnacle") // ONLY FOR SEA TRAVELERS
                {
                    ...
                    if (artifact != null)
                    {
                        artifact.Name = "barnacled " + artifact.Name;
                        artifact.Hue = 0xB91;
                    }
                }
                else if (arty == "bronzed") // ONLY FOR SEA TRAVELERS
                {
                    ...
                    if (artifact != null)
                    {
                        artifact.Name = "bronzed " + artifact.Name + " of the valkyrie";
                        artifact.Hue = 2418;
                    }
                }
                else if (arty == "neptune") // ONLY FOR SEA TRAVELERS
                {
                    ...
                    {
                        case 1:
                            artifact = CreateArmorItem("any");
                            break;
                        case 2:
                            artifact = CreateBowItem();
                            break;
                        case 3:
                            artifact = CreateMetalShield();
                            break;
                        case 4:
                            artifact = CreateMetalWeapon();
                            break;
                    }
                    ...
                    {
                        artifact.ItemID = 0x140E;
                        artifact.Name = "helm";
                    }

                    if (artifact != null)
                    {
                        artifact.Name = artifact.Name + " of Neptune";
                        artifact.Hue = 0x84C;
                    }
                }
                else if (arty == "invulnerable")
                {
                    ...
                    {
                        artifact.Hue = 0x4F2;
                        artifact.Name = artifact.Name + " of invulnerability";
                    }
                }
                else
                {
        ...
        public static void PowerArtifactArmor(Item artifact, string arty)
        {
            ...
            else if (arty == "neptune")
            {
                ...
                armor.FireBonus = 20;
                armor.SkillBonuses.SetValues(0, SkillName.Seafaring, 10);
            }
        }
        ...
        public static Item CreateArmorItem(string gender)
        {
            ...
            {
                case 0:
                    item = CreateMetalArmor(gender);
                    break;
                case 1:
                    item = CreateMetalArmor(gender);
                    break;
                case 2:
                    item = CreateStuddedArmor(gender);
                    break;
                case 3:
                    item = CreateLeatherArmor(gender);
                    break;
            }
        ...
        public static Item CreateMetalItem(string gender)
        {
            ...
            {
                case 0:
                    item = CreateMetalWeapon();
                    break;
                case 1:
                    item = CreateMetalWeapon();
                    break;
                case 2:
                    item = CreateMetalShield();
                    break;
                case 3:
                    item = CreateMetalArmor(gender);
                    break;
        ...
        public static Item CreateMetalWeapon()
        {
            ...
            int nType = Utility.RandomMinMax(0, 47);
            ...
            switch (nType)
            {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    item = new ThinLongsword();
                    item.Name = "longsword";
                    break;
                case 7:
                    item = new VikingSword();
                    item.Name = "barbarian sword";
                    break;
                case 8:
                    item = new Scimitar();
                    item.Name = "scimitar";
                    break;
                case 9:
                    item = new BoneHarvester();
                    item.Name = "sickle";
                    break;
                case 10:
                    item = new CrescentBlade();
                    item.Name = "crescent blade";
                    break;
                case 11:
                    item = new DoubleBladedStaff();
                    item.Name = "bladed staff";
                    break;
                case 12:
                    item = new Lance();
                    item.Name = "lance";
                ...
                case 26:
                    item = new RoyalSword();
                    item.Name = "royal sword";
                    break;
                case 27:
                    item = new LargeBattleAxe();
                    item.Name = "large battle axe";
                    break;
                case 28:
                    item = new WarAxe();
                    item.Name = "war axe";
        ...
        public static Item CreateMetalShield()
        {
            ...
            switch (Utility.RandomMinMax(0, 7))
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    item = new MetalShield();
                    item.Name = "small shield";
                    break;
                case 5:
                    item = new ChaosShield();
                    item.Name = "chaos shield";
                    break;
                case 6:
        ...
        public static Item CreateLeatherArmor(string gender)
        {
            ...
            switch (nType)
            {
                ...
                case 1:
                    ...
                    {
                        item = new FemaleLeatherChest();
                        item.Name = "leather armor";
                    }
                    else if (gender == "female" || Utility.RandomMinMax(0, 3) == 1)
                    {
                        item = new LeatherBustierArms();
                        item.Name = "leather bustier";
                    }
                    break;
                case 2:
                ...
                case 4:
                    ...
                    if (gender == "female" || Utility.RandomMinMax(0, 3) == 1)
                    {
                        ...
                        item.Name = "leather skirt";
                    }
                    if (Utility.RandomMinMax(0, 5) == 1)
                    {
                        item = new LeatherShorts();
                        item.Name = "leather shorts";
                    }
                    break;
                case 5:
                    item = new LeatherCap();
                    ...
                    break;
                case 6:
                    item = new LeatherJingasa();
                    item.Name = "leather jingasa";
                    break;
                case 7:
                    item = new LeatherDo();
                    ...
                    break;
                case 8:
                    item = new LeatherHiroSode();
                    item.Name = "leather hiro sode";
                    break;
                case 9:
                    item = new LeatherSuneate();
                    item.Name = "leather suneate";
                    break;
                case 10:
                    item = new LeatherHaidate();
                    item.Name = "leather haidate";
                    break;
                case 11:
                    item = new LeatherNinjaPants();
                    item.Name = "leather ninja pants";
                    break;
                case 12:
                    item = new LeatherNinjaJacket();
                    item.Name = "leather ninja jacket";
                    break;
            }
        ...
        public static Item CreateStuddedArmor(string gender)
        {
            ...
            switch (nType)
            {
                ...
                case 1:
                    ...
                    item.Name = "studded sleeves";
                    break;
                case 2:
                    item = new StuddedGloves();
                    item.Name = "studded gloves";
                    break;
                case 3:
                    item = new StuddedGorget();
                    item.Name = "studded gorget";
                    break;
                case 4:
                    item = new StuddedLegs();
                    item.Name = "studded leggings";
                    break;
                case 5:
                    item = new StuddedChest();
                    item.Name = "studded tunic";
                    if (gender == "female" || Utility.RandomMinMax(0, 3) == 1)
                    {
                        item = new FemaleStuddedChest();
                        item.Name = "studded armor";
                    }
                    else if (gender == "female" || Utility.RandomMinMax(0, 3) == 1)
                    {
                        item = new StuddedBustierArms();
                        item.Name = "studded bustier";
                    }
                    break;
                case 6:
                    item = new StuddedMempo();
                ...
                case 7:
                    ...
                    break;
                case 8:
                    item = new StuddedHiroSode();
                    item.Name = "studded hiro sode";
                    break;
                case 9:
                    item = new StuddedSuneate();
                    item.Name = "studded suneate";
                    break;
                case 10:
                    item = new StuddedHaidate();
        ...
        public static Item CreateMetalArmor(string gender)
        {
            ...
            switch (nType)
            {
                ...
                case 2:
                    item = new ChainLegs();
                    item.Name = "chainmail leggings";
                    break;
                case 3:
                    item = new RingmailChest();
                    item.Name = "ringmail tunic";
                    break;
                case 4:
                    item = new RingmailLegs();
                    item.Name = "ringmail leggings";
                    break;
                case 5:
                    item = new RingmailArms();
                    item.Name = "ringmail sleeves";
                    break;
                case 6:
                ...
                case 7:
                    ...
                    item.Name = "platemail gorget";
                    break;
                case 8:
                    item = new PlateLegs();
                    item.Name = "platemail leggings";
                    break;
                case 9:
                    item = new PlateArms();
                    item.Name = "platemail arms";
                    break;
                case 10:
                    item = new PlateGloves();
                    item.Name = "platemail gauntlets";
                    break;
                case 11:
                    item = new PlateChest();
                    item.Name = "platemail tunic";
                    if (gender == "female" || Utility.RandomMinMax(0, 3) == 1)
                    {
                ...
                case 13:
                    switch (Utility.RandomMinMax(0, 4))
                    {
                        case 0:
                            item = new PlateHelm();
                            item.Name = "platemail helm";
                            break;
                        case 1:
                            item = new CloseHelm();
                            item.Name = "close helm";
                            break;
                        case 2:
                            item = new Helmet();
                            item.Name = "helmet";
                    ...
                    break;
                case 14:
                    item = new ChainHatsuburi();
                    item.Name = "chainmail hatsuburi";
                    break;
                case 15:
                    item = new PlateHatsuburi();
                    item.Name = "platemail hatsuburi";
                    break;
                case 16:
                    item = new LightPlateJingasa();
                    item.Name = "platemail jingasa";
                    break;
                case 17:
                    item = new HeavyPlateJingasa();
                    item.Name = "platemail jingasa";
                    break;
                case 18:
                    item = new SmallPlateJingasa();
                    item.Name = "platemail jingasa";
                    break;
                case 19:
                    item = new DecorativePlateKabuto();
                    item.Name = "platemail kabuto";
                    break;
                case 20:
                    item = new PlateBattleKabuto();
                    item.Name = "platemail kabuto";
                    break;
                case 21:
                    item = new StandardPlateKabuto();
                    item.Name = "platemail kabuto";
                    break;
                case 22:
                    item = new PlateDo();
                    item.Name = "platemail do";
                    break;
                case 23:
                    item = new PlateHiroSode();
                    item.Name = "platemail hiro sade";
                    break;
                case 24:
                    item = new PlateSuneate();
                    item.Name = "platemail suneate";
                    break;
                case 25:
                    item = new PlateHaidate();
                    item.Name = "platemail haidate";
                    break;
                case 26:
                    item = new ChainHatsuburi();
                    item.Name = "chainmail hatsuburi";
        ...
        public static Item CreateBowItem()
        {
            ...
            switch (nType)
            {
                case 0:
                    ...
                    break;
                case 1:
                    item = new HeavyCrossbow();
                    item.Name = "heavy crossbow";
                    break;
                case 2:
                    item = new RepeatingCrossbow();
                    item.Name = "repeating crossbow";
                    break;
                case 3:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    item = new ElvenCompositeLongbow();
                    item.Name = "woodland longbow";
                    break;
                case 6:
                    item = new MagicalShortbow();
                    item.Name = "woodland shortbow";
                    break;
                case 7:
                    item = new Yumi();
                    item.Name = "yumi";
        ...
        {
            if (artifact is LeatherArms)
            {
                artifact.ItemID = 0x2FC8;
            }
            else if (artifact is LeatherChest)
            {
                artifact.ItemID = 0x2FC5;
            }
            else if (artifact is FemaleLeatherChest)
            {
                artifact.ItemID = 0x2FCB;
            }
            else if (artifact is LeatherBustierArms)
            {
                artifact.ItemID = 0x2FCB;
            }
            else if (artifact is LeatherGloves)
            {
                artifact.ItemID = 0x2FC6;
            }
            else if (artifact is LeatherGorget)
            {
                artifact.ItemID = 0x2FC7;
            }
            else if (artifact is LeatherLegs)
            {
                artifact.ItemID = 0x2FC9;
            }
            else if (artifact is LeatherSkirt)
            {
                artifact.ItemID = 0x2FCA;
            }
            else if (artifact is LeatherShorts)
            {
                artifact.ItemID = 0x2FC9;
            }
        }
