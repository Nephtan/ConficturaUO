...
namespace Server.Items
{
    public class StaffFiveParts : QuarterStaff
    {
        ...
        public Mobile Staff_Owner
        {
            get { return StaffOwner; }
            set { StaffOwner = value; }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Staff_Magic
        {
            get { return StaffMagic; }
            set
            {
                StaffMagic = value;
                InvalidateProperties();
        ...
        public StaffFiveParts(Mobile from, int magic)
        {
            ...
            if (magic == 1)
            {
                StaffName = StaffOwner.Name + " the Necromancer";
            }
            if (magic == 2)
            {
                StaffName = StaffOwner.Name + " the Elementalist";
            }
            ...
            if (magic == 1)
            {
                SkillBonuses.SetValues(2, SkillName.Necromancy, 25);
            }
            else if (magic == 2)
            {
                SkillBonuses.SetValues(2, SkillName.Elementalism, 25);
            }
            else
            {
        ...
        public override void OnHit(Mobile attacker, Mobile defender, double damageBonus)
        {
            ...
            switch (Utility.RandomMinMax(0, 4))
            {
                ...
                case 2:
                    ...
                    this.AosElementDamages.Fire = 100;
                    break;
                case 3:
                    this.Hue = 0x491;
                    if (StaffMagic > 0)
                    ...
                    this.AosElementDamages.Physical = 100;
                    break;
                case 4:
                    this.Hue = 0x490;
                    if (StaffMagic > 0)
        ...
        public override bool OnEquip(Mobile from)
        {
            ...
            else
            {
                from.LocalOverheadMessage(
                    ...
                    0xB1F,
                    true,
                    "The magic drains from the staff!"
                );
        ...
        public StaffFiveParts(Serial serial)
            : base(serial) { }
    ...
    public class StaffPartVenom : Item
    {
        ...
        public StaffPartVenom(Serial serial)
            : base(serial) { }
    ...
    public class StaffPartCaddellite : Item
    {
        ...
        public StaffPartCaddellite(Serial serial)
            : base(serial) { }
    ...
    public class StaffPartFire : Item
    {
        ...
        public StaffPartFire(Serial serial)
            : base(serial) { }
    ...
    public class StaffPartLight : Item
    {
        ...
        public StaffPartLight(Serial serial)
            : base(serial) { }
    ...
    public class StaffPartEnergy : Item
    {
        ...
        public StaffPartEnergy(Serial serial)
            : base(serial) { }
