...
namespace Server.Gumps
{
    ...
    public class GiftGump : Gump
    {
        ...
        public GiftGump(Mobile from, Item item, GiftAttributeCategory cat)
            : this(from, item, cat, GumpPage.None) { }

        private GiftGump(Mobile from, Item item, GiftAttributeCategory cat, GumpPage page)
            : base(40, 40)
        {
            m_From = from;
            m_Item = item;
        ...
        public void CreateAttributeList(GiftAttributeCategory cat)
        {
            ...
            for (int i = 0; i < GiftAttributes.m_Attributes.Length; ++i)
            {
                if (GiftAttributes.m_Attributes[i].m_Category == cat)
                {
                    ...
                    if (m_Item is BaseWeapon)
                        attrvalue = ((BaseWeapon)m_Item).Attributes[
                            GiftAttributes.m_Attributes[i].m_Attribute
                        ];
                    else if (m_Item is BaseArmor)
                        attrvalue = ((BaseArmor)m_Item).Attributes[
                            GiftAttributes.m_Attributes[i].m_Attribute
                        ];
                    else if (m_Item is BaseJewel)
                        attrvalue = ((BaseJewel)m_Item).Attributes[
                            GiftAttributes.m_Attributes[i].m_Attribute
                        ];
                    else if (m_Item is BaseClothing)
                        attrvalue = ((BaseClothing)m_Item).Attributes[
                            GiftAttributes.m_Attributes[i].m_Attribute
                        ];
                    else
                        return;
                    ...
                    AddLabel(
                        ...
                        117 + (pageindex * 20),
                        LabelHue,
                        GiftAttributes.m_Attributes[i].m_Name
                            + " ("
                            + GetPointCost(m_Item, GiftAttributes.m_Attributes[i].m_XP)
                            + "sp)"
                    );
            ...
            if (m_Item is BaseWeapon)
            {
                for (int i = 0; i < GiftAttributes.m_WeaponAttributes.Length; ++i)
                {
                    if (GiftAttributes.m_WeaponAttributes[i].m_Category == cat)
                    {
                        ...
                        if (
                            GiftAttributes.m_WeaponAttributes[i].m_Attribute
                        ...
                        {
                            attrvalue = ((BaseWeapon)m_Item).WeaponAttributes[
                                GiftAttributes.m_WeaponAttributes[i].m_Attribute
                            ];
                        }
                        ...
                        AddLabel(
                            ...
                            117 + (pageindex * 20),
                            LabelHue,
                            GiftAttributes.m_WeaponAttributes[i].m_Name
                                + " ("
                                + GetPointCost(m_Item, GiftAttributes.m_WeaponAttributes[i].m_XP)
                                + "sp)"
                        );
                        AddLabel(540, 117 + (pageindex * 20), LabelHue, attrvalue.ToString());
            ...
            else if (m_Item is BaseArmor)
            {
                if (cat == GiftAttributeCategory.Resists)
                {
                    for (int i = 0; i < GiftAttributes.m_ResistanceTypes.Length; ++i)
                    {
                        ...
                        if (
                            GiftAttributes.m_ResistanceTypes[i].m_Attribute
                            == ResistanceType.Physical
                        )
                            attrvalue = ((BaseArmor)m_Item).PhysicalBonus;
                        else if (
                            GiftAttributes.m_ResistanceTypes[i].m_Attribute == ResistanceType.Fire
                        )
                            attrvalue = ((BaseArmor)m_Item).FireBonus;
                        else if (
                            GiftAttributes.m_ResistanceTypes[i].m_Attribute == ResistanceType.Cold
                        )
                            attrvalue = ((BaseArmor)m_Item).ColdBonus;
                        else if (
                            GiftAttributes.m_ResistanceTypes[i].m_Attribute == ResistanceType.Poison
                        )
                            attrvalue = ((BaseArmor)m_Item).PoisonBonus;
                        else if (
                            GiftAttributes.m_ResistanceTypes[i].m_Attribute == ResistanceType.Energy
                        )
                        ...
                        AddLabel(
                            ...
                            117 + (pageindex * 20),
                            LabelHue,
                            GiftAttributes.m_ResistanceTypes[i].m_Name
                                + " ("
                                + GetPointCost(m_Item, GiftAttributes.m_ResistanceTypes[i].m_XP)
                                + "sp)"
                        );
                        AddLabel(540, 117 + (pageindex * 20), LabelHue, attrvalue.ToString());
                ...
                else
                {
                    for (int i = 0; i < GiftAttributes.m_ArmorAttributes.Length; ++i)
                    {
                        if (GiftAttributes.m_ArmorAttributes[i].m_Category == cat)
                        {
                            ...
                            if (
                                GiftAttributes.m_ArmorAttributes[i].m_Attribute
                                == AosArmorAttribute.DurabilityBonus
                            )
                            {
                            ...
                            {
                                attrvalue = ((BaseArmor)m_Item).ArmorAttributes[
                                    GiftAttributes.m_ArmorAttributes[i].m_Attribute
                                ];
                            }
                            ...
                            AddLabel(
                                ...
                                117 + (pageindex * 20),
                                LabelHue,
                                GiftAttributes.m_ArmorAttributes[i].m_Name
                                    + " ("
                                    + GetPointCost(m_Item, GiftAttributes.m_ArmorAttributes[i].m_XP)
                                    + "sp)"
                            );
                            AddLabel(540, 117 + (pageindex * 20), LabelHue, attrvalue.ToString());
                ...
                if (cat == GiftAttributeCategory.Resists)
                {
                    for (int i = 0; i < GiftAttributes.m_ElementAttributes.Length; ++i)
                    {
                        ...
                        if (m_Item is BaseJewel)
                            attrvalue = ((BaseJewel)m_Item).Resistances[
                                GiftAttributes.m_ElementAttributes[i].m_Attribute
                            ];
                        else
                            attrvalue = ((BaseClothing)m_Item).Resistances[
                                GiftAttributes.m_ElementAttributes[i].m_Attribute
                            ];
                        ...
                        AddLabel(
                            ...
                            117 + (pageindex * 20),
                            LabelHue,
                            GiftAttributes.m_ElementAttributes[i].m_Name
                                + " ("
                                + GetPointCost(m_Item, GiftAttributes.m_ElementAttributes[i].m_XP)
                                + "sp)"
                        );
                        AddLabel(540, 117 + (pageindex * 20), LabelHue, attrvalue.ToString());
            ...
            switch (type)
            {
                        ...
                        case 0: // Melee
                        {
                            m_From.SendGump(
                                new GiftGump(
                                    m_From,
                                    m_Item,
                                    GiftAttributeCategory.Melee,
                                    GumpPage.AttributeList
                                )
                            );
                ...
                case 2: // Attribute selected
                {
                    ...
                    if ((levitem.Points - cost) >= 0)
                    {
                        ...
                        if (index >= 0 && index < GiftAttributes.m_Attributes.Length)
                        {
                            ...
                            {
                                attrvalue = ((BaseWeapon)m_Item).Attributes[
                                    GiftAttributes.m_Attributes[index].m_Attribute
                                ];
                                if (attrvalue < GiftAttributes.m_Attributes[index].m_MaxValue)
                                {
                                    ((BaseWeapon)m_Item).Attributes[
                                        GiftAttributes.m_Attributes[index].m_Attribute
                                    ] += 1;
                                    levitem.Points -= cost;
                                }
                            ...
                            else if (m_Item is BaseClothing)
                            {
                                ...
                                if (attrvalue < GiftAttributes.m_Attributes[index].m_MaxValue)
                                {
                                    ((BaseClothing)m_Item).Attributes[
                                        GiftAttributes.m_Attributes[index].m_Attribute
                                    ] += 1;
                                    levitem.Points -= cost;
                                }
                    ...
                    {
                        m_From.SendMessage(
                            "You don't have enough points available!  This attribute costs "
                                + cost
                                + " points."
                        );
                    }
                    ...
                    m_From.SendGump(
                        new GiftGump(
                            m_From,
                            m_Item,
                            GiftAttributes.m_Attributes[index].m_Category,
                            GumpPage.AttributeList
                        )
                    );
                ...
                case 3: // WeaponAttribute selected
                {
                    ...
                    if ((levitem.Points - cost) >= 0)
                    {
                        ...
                        if (
                            index >= 0
                            && m_Item is BaseWeapon
                            && index < GiftAttributes.m_WeaponAttributes.Length
                        )
                        {
                            if (
                                GiftAttributes.m_WeaponAttributes[index].m_Attribute
                                == AosWeaponAttribute.DurabilityBonus
                            )
                            {
                                attrvalue = ((BaseWeapon)m_Item).MaxHitPoints;
                            ...
                            {
                                ((BaseWeapon)m_Item).WeaponAttributes[
                                    GiftAttributes.m_WeaponAttributes[index].m_Attribute
                                ] += 1;
                                levitem.Points -= cost;
                            }
                    ...
                    m_From.SendGump(
                        new GiftGump(
                            m_From,
                            m_Item,
                            GiftAttributes.m_WeaponAttributes[index].m_Category,
                            GumpPage.AttributeList
                        )
                    );
                ...
                case 4: // Armor Attributes Selected
                {
                    ...
                    if ((levitem.Points - cost) >= 0)
                    {
                        ...
                        if (
                            index >= 0
                            && m_Item is BaseArmor
                            && index < GiftAttributes.m_ArmorAttributes.Length
                        )
                        {
                            if (
                                GiftAttributes.m_ArmorAttributes[index].m_Attribute
                                == AosArmorAttribute.DurabilityBonus
                            )
                            {
                                attrvalue = ((BaseArmor)m_Item).MaxHitPoints;
                            ...
                            {
                                ((BaseArmor)m_Item).ArmorAttributes[
                                    GiftAttributes.m_ArmorAttributes[index].m_Attribute
                                ] += 1;
                                levitem.Points -= cost;
                            }
                    ...
                    m_From.SendGump(
                        new GiftGump(
                            m_From,
                            m_Item,
                            GiftAttributes.m_ArmorAttributes[index].m_Category,
                            GumpPage.AttributeList
                        )
                    );
                ...
                case 5: // Armor Resists Selected
                {
                    ...
                    {
                        // Handle the error here, for example by logging it or displaying a message to the user
                        m_From.SendMessage("Index was outside the bounds of the array: " + index);
                        m_From.SendMessage("Potential crash avoided. Please contact Nephtan.");
                        m_From.SendMessage(
                            "Report what you were up to right before this error message."
                        );
                        return;
                    }
                    ...
                    if ((levitem.Points - cost) >= 0)
                    {
                        ...
                        if (
                            index >= 0
                            && m_Item is BaseArmor
                            && index < GiftAttributes.m_ResistanceTypes.Length
                        )
                        {
                            if (
                                GiftAttributes.m_ResistanceTypes[index].m_Attribute
                                == ResistanceType.Physical
                            )
                            {
                                attrvalue = ((BaseArmor)m_Item).PhysicalBonus;
                    ...
                    m_From.SendGump(
                        new GiftGump(
                            m_From,
                            m_Item,
                            GiftAttributes.m_ResistanceTypes[index].m_Category,
                            GumpPage.AttributeList
                        )
                    );
                ...
                case 6: // Jewelry & Clothing Resists Selected
                {
                    ...
                    if ((levitem.Points - cost) >= 0)
                    {
                        ...
                        if (
                            index >= 0
                            && (m_Item is BaseJewel || m_Item is BaseClothing)
                            && index < GiftAttributes.m_ElementAttributes.Length
                        )
                        {
                            if (m_Item is BaseJewel)
                            {
                                attrvalue = ((BaseJewel)m_Item).Resistances[
                                    GiftAttributes.m_ElementAttributes[index].m_Attribute
                                ];
                                if (
                                    attrvalue < GiftAttributes.m_ElementAttributes[index].m_MaxValue
                                )
                                {
                                    ((BaseJewel)m_Item).Resistances[
                                        GiftAttributes.m_ElementAttributes[index].m_Attribute
                                    ] += 1;
                                    levitem.Points -= cost;
                                }
                            ...
                            else
                            {
                                ...
                                {
                                    ((BaseClothing)m_Item).Resistances[
                                        GiftAttributes.m_ElementAttributes[index].m_Attribute
                                    ] += 1;
                                    levitem.Points -= cost;
                                }
                    ...
                    m_From.SendGump(
                        new GiftGump(
                            m_From,
                            m_Item,
                            GiftAttributes.m_ElementAttributes[index].m_Category,
                            GumpPage.AttributeList
                        )
                    );
