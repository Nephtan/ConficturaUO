...
namespace Server.Items
{
    ...
    {
        public BaseGiftWaist(int itemID)
            : this(itemID, 0) { }

        public BaseGiftWaist(int itemID, int hue)
            : base(itemID, Layer.Waist, hue) { }

        public BaseGiftWaist(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public GiftHalfApron()
            : this(0) { }

        [Constructable]
        public GiftHalfApron(int hue)
            : base(0x153b, hue)
        {
            Weight = 2.0;
        }
    ...
    {
        [Constructable]
        public GiftWoodlandBelt()
            : this(0) { }

        [Constructable]
        public GiftWoodlandBelt(int hue)
            : base(0x2B68, hue)
        {
            Weight = 4.0;
            Name = "loin cloth";
