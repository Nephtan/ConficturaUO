...
namespace Server.Items
{
    ...
    {
        public BaseGiftPants(int itemID)
            : this(itemID, 0) { }

        public BaseGiftPants(int itemID, int hue)
            : base(itemID, Layer.Pants, hue) { }

        public BaseGiftPants(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public GiftShortPants()
            : this(0) { }

        [Constructable]
        public GiftShortPants(int hue)
            : base(0x152E, hue)
        {
            Weight = 2.0;
            Name = "short pants";
    ...
    {
        [Constructable]
        public GiftLongPants()
            : this(0) { }

        [Constructable]
        public GiftLongPants(int hue)
            : base(0x1539, hue)
        {
            Weight = 2.0;
            Name = "long pants";
    ...
    {
        [Constructable]
        public GiftTattsukeHakama()
            : this(0) { }

        [Constructable]
        public GiftTattsukeHakama(int hue)
            : base(0x279B, hue)
        {
            Weight = 2.0;
        }
