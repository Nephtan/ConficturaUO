...
namespace Server.Items
{
    public abstract class BaseGiftClothing : BaseClothing, IGiftable
    {
        ...
        public BaseGiftClothing(int itemID, Layer layer)
            : this(itemID, layer, 0) { }

        public BaseGiftClothing(int itemID, Layer layer, int hue)
            : base(itemID, layer, hue)
        {
            m_Owner = null;
            m_Gifter = "";
            m_How = "";
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (m_Points > 5)
            {
                list.Add(1070722, "Single Click to Customize");
            }
            ...
            {
                list.Add(1049644, m_Points + " Enchantement Points");
            }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            if (m_Points > 0)
            {
                list.Add(new GiftInfoEntry(from, this, GiftAttributeCategory.Melee));
            }
        }
