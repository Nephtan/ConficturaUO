...
namespace Server.Items
{
    ...
    {
        public BaseGiftOuterLegs(int itemID)
            : this(itemID, 0) { }

        public BaseGiftOuterLegs(int itemID, int hue)
            : base(itemID, Layer.OuterLegs, hue) { }

        public BaseGiftOuterLegs(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public GiftFurSarong()
            : this(0) { }

        [Constructable]
        public GiftFurSarong(int hue)
            : base(0x230C, hue)
        {
            Weight = 3.0;
        }
