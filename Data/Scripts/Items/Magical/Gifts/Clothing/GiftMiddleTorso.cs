...
namespace Server.Items
{
    ...
    {
        public BaseGiftMiddleTorso(int itemID)
            : this(itemID, 0) { }

        public BaseGiftMiddleTorso(int itemID, int hue)
            : base(itemID, Layer.MiddleTorso, hue) { }

        public BaseGiftMiddleTorso(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public GiftFullApron()
            : this(0) { }

        [Constructable]
        public GiftFullApron(int hue)
            : base(0x153d, hue)
        {
            Weight = 4.0;
        }
    ...
    public class GiftFormalShirt : BaseGiftMiddleTorso
    {
        ...
        [Constructable]
        public GiftFormalShirt(int hue)
            : base(0x2310, hue)
        {
            Weight = 1.0;
        }
    ...
    {
        [Constructable]
        public GiftJesterSuit()
            : this(0) { }

        [Constructable]
        public GiftJesterSuit(int hue)
            : base(0x1F9F, hue)
        {
            Weight = 4.0;
        }
