...
namespace Server.Items
{
    ...
    {
        public BaseGiftShoes(int itemID)
            : this(itemID, 0) { }

        public BaseGiftShoes(int itemID, int hue)
            : base(itemID, Layer.Shoes, hue) { }

        public BaseGiftShoes(Serial serial)
            : base(serial) { }
    ...
    public class GiftThighBoots : BaseGiftShoes, IArcaneEquip
    {
        ...
        [Constructable]
        public GiftThighBoots()
            : this(0) { }

        [Constructable]
        public GiftThighBoots(int hue)
            : base(0x1711, hue)
        {
            Weight = 4.0;
        }
    ...
    {
        [Constructable]
        public GiftNinjaTabi()
            : this(0) { }

        [Constructable]
        public GiftNinjaTabi(int hue)
            : base(0x2797, hue)
        {
            Weight = 2.0;
        }
    ...
    {
        [Constructable]
        public GiftSamuraiTabi()
            : this(0) { }

        [Constructable]
        public GiftSamuraiTabi(int hue)
            : base(0x2796, hue)
        {
            Weight = 2.0;
        }
    ...
    public class GiftElvenBoots : BaseGiftShoes
    {
        ...
        [Constructable]
        public GiftElvenBoots()
            : this(0) { }

        [Constructable]
        public GiftElvenBoots(int hue)
            : base(0x2FC4, hue)
        {
            Name = "fancy boots";
            Weight = 2.0;
