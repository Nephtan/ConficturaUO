...
namespace Server.Items
{
    ...
    {
        public BaseGiftOuterTorso(int itemID)
            : this(itemID, 0) { }

        public BaseGiftOuterTorso(int itemID, int hue)
            : base(itemID, Layer.OuterTorso, hue) { }

        public BaseGiftOuterTorso(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public GiftGildedDress()
            : this(0) { }

        [Constructable]
        public GiftGildedDress(int hue)
            : base(0x230E, hue)
        {
            Weight = 3.0;
            Name = "gilded dress";
    ...
    {
        [Constructable]
        public GiftFancyDress()
            : this(0) { }

        [Constructable]
        public GiftFancyDress(int hue)
            : base(0x1F00, hue)
        {
            Weight = 3.0;
    ...
    {
        [Constructable]
        public GiftHoodedShroudOfShadows()
            : this(0x455) { }

        [Constructable]
        public GiftHoodedShroudOfShadows(int hue)
            : base(0x2684, hue)
        {
    ...
    {
        [Constructable]
        public GiftPlainDress()
            : this(0) { }

        [Constructable]
        public GiftPlainDress(int hue)
            : base(0x1F01, hue)
        {
            Weight = 2.0;
            Name = "dress";
    ...
    {
        [Constructable]
        public GiftKamishimo()
            : this(0) { }

        [Constructable]
        public GiftKamishimo(int hue)
            : base(0x2799, hue)
        {
            Weight = 3.0;
        }
    ...
    {
        [Constructable]
        public GiftHakamaShita()
            : this(0) { }

        [Constructable]
        public GiftHakamaShita(int hue)
            : base(0x279C, hue)
        {
            Weight = 3.0;
        }
    ...
    {
        [Constructable]
        public GiftMaleKimono()
            : this(0) { }

        [Constructable]
        public GiftMaleKimono(int hue)
            : base(0x2782, hue)
        {
            Weight = 3.0;
        }
    ...
    {
        [Constructable]
        public GiftFemaleKimono()
            : this(0) { }

        [Constructable]
        public GiftFemaleKimono(int hue)
            : base(0x2783, hue)
        {
            Weight = 3.0;
        }
