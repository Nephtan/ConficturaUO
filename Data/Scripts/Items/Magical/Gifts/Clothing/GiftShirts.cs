...
namespace Server.Items
{
    ...
    {
        public BaseGiftShirt(int itemID)
            : this(itemID, 0) { }

        public BaseGiftShirt(int itemID, int hue)
            : base(itemID, Layer.Shirt, hue) { }

        public BaseGiftShirt(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public GiftFancyShirt()
            : this(0) { }

        [Constructable]
        public GiftFancyShirt(int hue)
            : base(0x1EFD, hue)
        {
            Weight = 2.0;
        }
    ...
    {
        [Constructable]
        public GiftClothNinjaJacket()
            : this(0) { }

        [Constructable]
        public GiftClothNinjaJacket(int hue)
            : base(0x2794, hue)
        {
            Weight = 5.0;
