...
namespace Server.Items
{
    public abstract class BaseGiftNecklace : BaseGiftJewel
    {
        ...
        public BaseGiftNecklace(int itemID)
            : base(itemID, Layer.Neck) { }

        public BaseGiftNecklace(Serial serial)
            : base(serial) { }
    ...
    public class GiftNecklace : BaseGiftNecklace
    {
        ...
        public GiftNecklace(Serial serial)
            : base(serial) { }
