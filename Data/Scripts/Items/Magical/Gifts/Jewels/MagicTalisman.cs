...
namespace Server.Items
{
    public class GiftTalismanLeather : GiftGoldRing
    {
        ...
        public GiftTalismanLeather(Serial serial)
            : base(serial) { }
    ...
    public class GiftTalismanSnake : GiftGoldRing
    {
        ...
        public GiftTalismanSnake(Serial serial)
            : base(serial) { }
    ...
    public class GiftTalismanTotem : GiftGoldRing
    {
        ...
        public GiftTalismanTotem(Serial serial)
            : base(serial) { }
    ...
    public class GiftTalismanHoly : GiftGoldRing
    {
        ...
        public GiftTalismanHoly(Serial serial)
            : base(serial) { }
