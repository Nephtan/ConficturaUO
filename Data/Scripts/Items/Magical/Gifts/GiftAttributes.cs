...
namespace Server.Items
{
    ...
    public class GiftAttributes
    {
        ...
        public static WeaponGiftAttributeInfo[] m_WeaponAttributes = new WeaponGiftAttributeInfo[]
        {
            new WeaponGiftAttributeInfo(
                ...
                "Lower Stat Requirement",
                GiftAttributeCategory.Stats,
                2,
                100
            ),
            new WeaponGiftAttributeInfo(
                AosWeaponAttribute.SelfRepair,
                "Self Repair",
                GiftAttributeCategory.Misc,
                2,
                10
        ...
        public static ElementGiftAttributeInfo[] m_ElementAttributes =
            new ElementGiftAttributeInfo[]
            {
                new ElementGiftAttributeInfo(
    ...
    public class GiftAttributeInfo
    {
        ...
        public GiftAttributeInfo(
            AosAttribute attribute,
            string name,
            GiftAttributeCategory category,
            int xp,
            int maxvalue
        )
        {
    ...
    public class WeaponGiftAttributeInfo
    {
        ...
        public WeaponGiftAttributeInfo(
    ...
    public class ArmorGiftAttributeInfo
    {
        ...
        public ArmorGiftAttributeInfo(
            AosArmorAttribute attribute,
            string name,
            GiftAttributeCategory category,
            int xp,
            int maxvalue
    ...
    public class GiftResistanceTypeInfo
    {
        ...
        public GiftResistanceTypeInfo(
            ResistanceType attribute,
            string name,
            GiftAttributeCategory category,
            int xp,
            int maxvalue
    ...
    public class ElementGiftAttributeInfo
    {
        ...
        public ElementGiftAttributeInfo(
            AosElementAttribute attribute,
            string name,
            GiftAttributeCategory category,
            int xp,
            int maxvalue
