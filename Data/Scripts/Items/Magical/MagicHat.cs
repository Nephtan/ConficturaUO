...
namespace Server.Items
{
    public class MagicHat : GoldRing
    {
        ...
        public MagicHat()
        {
            ...
            {
                myHat = Utility.RandomMinMax(0, 33);
            }
            ...
            switch (myHat)
            {
                ...
                case 31:
                    ...
                    break;
                case 32:
                    ItemID = Utility.RandomList(0x141B, 0x141C);
                    Name = "orcish mask";
                    break;
                case 33:
                    ItemID = Utility.RandomList(0x2B72, 0x3169);
                    Name = "gargoyle mask";
                    break;
            }
        ...
        private class HoodTarget : Target
        {
            ...
            public HoodTarget(MagicHat cowl)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                if (targeted is Item)
                {
                    ...
                    if (from.FindItemOnLayer(Layer.Helm) != m_Hood)
                    {
                        from.SendMessage("You must be wearing this to change the color.");
                    }
                    else if (from.FindItemOnLayer(Layer.Waist) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.OuterTorso) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.Arms) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.OuterLegs) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.Neck) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.Gloves) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.Shoes) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.Cloak) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.FirstValid) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.InnerLegs) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.InnerTorso) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.Pants) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else if (from.FindItemOnLayer(Layer.Shirt) == iHood)
                    {
                        color = iHood.Hue;
                    }
                    else
