...
namespace Server.Items
{
    public class WeaponRenamingTool : Item, IRewardItem
    {
        ...
        public WeaponRenamingTool(Serial serial)
            : base(serial) { }
        ...
        private class TargetWeapon : Target
        {
            ...
            public TargetWeapon(WeaponRenamingTool tool)
        ...
        private class InternalGump : Gump
        {
            ...
            public InternalGump(WeaponRenamingTool tool, BaseWeapon target)
                : base(0, 0)
            {
                m_Tool = tool;
                m_Target = target;
