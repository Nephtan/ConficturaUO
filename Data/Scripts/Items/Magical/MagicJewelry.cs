...
namespace Server.Items
{
    public class MagicJewelryRing : GoldRing
    {
        ...
        public MagicJewelryRing(Serial serial)
            : base(serial) { }
    ...
    public class MagicJewelryNecklace : GoldNecklace
    {
        ...
        public MagicJewelryNecklace(Serial serial)
            : base(serial) { }
    ...
    public class MagicJewelryEarrings : GoldEarrings
    {
        ...
        public MagicJewelryEarrings(Serial serial)
            : base(serial) { }
    ...
    public class MagicJewelryBracelet : GoldBracelet
    {
        ...
        public MagicJewelryBracelet(Serial serial)
            : base(serial) { }
    ...
    public class MagicJewelryCirclet : GoldBracelet
    {
        ...
        public MagicJewelryCirclet(Serial serial)
            : base(serial) { }
