...
namespace Server.Items
{
    public class SilverPlateLegs : PlateLegs ///////////////////////////////////////////////////////
    {
        ...
        public SilverPlateLegs(Serial serial)
            : base(serial) { }
    ...
    public class SilverPlateGloves : PlateGloves ///////////////////////////////////////////////////
    {
        ...
        public SilverPlateGloves(Serial serial)
            : base(serial) { }
    ...
    public class SilverPlateGorget : PlateGorget ///////////////////////////////////////////////////
    {
        ...
        public SilverPlateGorget(Serial serial)
            : base(serial) { }
    ...
    public class SilverPlateArms : PlateArms ///////////////////////////////////////////////////////
    {
        ...
        public SilverPlateArms(Serial serial)
            : base(serial) { }
    ...
    public class SilverPlateChest : PlateChest /////////////////////////////////////////////////////
    {
        ...
        public SilverPlateChest(Serial serial)
            : base(serial) { }
    ...
    public class SilverFemalePlateChest : FemalePlateChest /////////////////////////////////////////
    {
        ...
        public SilverFemalePlateChest(Serial serial)
            : base(serial) { }
    ...
    public class SilverShield : HeaterShield //////////////////////////////////////////////////////
    {
        ...
        public SilverShield(Serial serial)
            : base(serial) { }
    ...
    public class SilverPlateHelm : PlateHelm ///////////////////////////////////////////////////////
    {
        ...
        public SilverPlateHelm(Serial serial)
            : base(serial) { }
