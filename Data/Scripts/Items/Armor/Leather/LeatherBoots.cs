...
namespace Server.Items
{
    ...
    public class LeatherSandals : BaseArmor
    {
        ...
        public LeatherSandals(Serial serial)
            : base(serial) { }
    ...
    public class LeatherShoes : BaseArmor
    {
        ...
        public LeatherShoes(Serial serial)
            : base(serial) { }
    ...
    public class LeatherBoots : BaseArmor
    {
        ...
        public LeatherBoots(Serial serial)
            : base(serial) { }
    ...
    public class LeatherThighBoots : BaseArmor
    {
        ...
        public LeatherThighBoots(Serial serial)
            : base(serial) { }
    ...
    public class LeatherSoftBoots : BaseArmor
    {
        ...
        public LeatherSoftBoots(Serial serial)
            : base(serial) { }
