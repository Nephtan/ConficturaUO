    ...
    public class GMHidingStone : Item
    {
            ...
            switch (mStoneEffect)
            {
                ...
                case StoneEffect.Gate:
                    ...
                    Timer.DelayCall(
                        ...
                        new TimerStateCallback(InternalShowGate),
                        new object[] { m, effHue }
                    );
                    Timer.DelayCall(
                        TimeSpan.FromSeconds(1.5),
                        new TimerStateCallback(InternalHideGate),
                        new object[] { m, effHue }
                    );
                    break;
                //[/s7]
                ...
                case StoneEffect.DefaultRunUO:
                    ...
                    Effects.SendLocationEffect(
                        new Point3D(m.X + 1, m.Y + 1, m.Z + 11),
                        m.Map,
                        0x3728,
                        13,
                        effHue,
                ...
                case StoneEffect.Fireball:
                    ...
                    Effects.SendLocationEffect(
                        new Point3D(m.X + 1, m.Y + 1, m.Z + 10),
                        m.Map,
                        0x36D4,
                        13,
                        effHue,
        ...
        public class FireStormTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                Effects.SendLocationEffect(
                    new Point3D(m.X + inc, m.Y - inc, m.Z),
                    m.Map,
                    0x3709,
                    17,
                    ehue,
