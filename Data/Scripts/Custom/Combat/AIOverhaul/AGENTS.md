...
This file extends the root `AGENTS.md` for the `Data/Scripts/Custom/Combat/AIOverhaul/` workspace.
...
- Review `Data/Scripts/Custom/Combat/AIOverhaul/AI_HANDOFF.md` before starting any work after phase 1.
