...
{
    public class StartStopSkaraBraetram : Gump
    {
        private Mobile m_Mobile;

        public StartStopSkaraBraetram(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 1:
                {
                    ...
                    point.Name = "SkaraBraeInvasionSosaria";
                    point1.Name = "SkaraBraeInvasionSosaria";
                    point2.Name = "SkaraBraeInvasionSosaria";
                    ...
                    spawner1.Name = "SkaraBraeInvasionSosaria";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "SkaraBraeInvasionSosaria";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "SkaraBraeInvasionSosaria";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "SkaraBraeInvasionSosaria";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "SkaraBrae Sosaria is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    ...
                    SkaraBraetram.StopSkaraBraeSosaria();
                    World.Broadcast(
                        33,
                        true,
                        "SkaraBrae Sosaria's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
