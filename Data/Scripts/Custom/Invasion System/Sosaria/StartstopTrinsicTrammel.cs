...
{
    public class StartStopTrinsictram : Gump
    {
        private Mobile m_Mobile;

        public StartStopTrinsictram(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopTrinsictram));
                ...
                case 1:
                {
                    ...
                    point.Name = "TrinsicInvasionSosaria";
                    point1.Name = "TrinsicInvasionSosaria";
                    point2.Name = "TrinsicInvasionSosaria";
                    ...
                    spawner1.Name = "TrinsicInvasionSosaria";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "TrinsicInvasionSosaria";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "TrinsicInvasionSosaria";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "TrinsicInvasionSosaria";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Trinsic Sosaria is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    TrinsicInvasionStone Trinsictram = new TrinsicInvasionStone();
                    Trinsictram.StopTrinsicSosaria();
                    World.Broadcast(
                        33,
                        true,
                        "Trinsic Sosaria's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
