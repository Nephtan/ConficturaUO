...
{
    public class StartStopYewtram : Gump
    {
        private Mobile m_Mobile;

        public StartStopYewtram(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopYewtram));
                ...
                case 1:
                {
                    ...
                    point.Name = "YewInvasionSosaria";
                    point1.Name = "YewInvasionSosaria";
                    point2.Name = "YewInvasionSosaria";
                    ...
                    spawner1.Name = "YewInvasionSosaria";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "YewInvasionSosaria";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "YewInvasionSosaria";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "YewInvasionSosaria";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Yew Sosaria is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    YewInvasionStone yewtram = new YewInvasionStone();
                    yewtram.StopYewSosaria();
                    World.Broadcast(
                        33,
                        true,
                        "Yew Sosaria's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
