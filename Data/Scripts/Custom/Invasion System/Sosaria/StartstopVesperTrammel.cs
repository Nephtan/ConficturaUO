...
{
    public class StartStopVespertram : Gump
    {
        private Mobile m_Mobile;

        public StartStopVespertram(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopVespertram));
                ...
                case 1:
                {
                    ...
                    point.Name = "VesperInvasionSosaria";
                    point1.Name = "VesperInvasionSosaria";
                    point2.Name = "VesperInvasionSosaria";
                    ...
                    spawner1.Name = "VesperInvasionSosaria";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "VesperInvasionSosaria";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "VesperInvasionSosaria";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "VesperInvasionSosaria";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Vesper Sosaria is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    VesperInvasionStone Vespertram = new VesperInvasionStone();
                    Vespertram.StopVesperSosaria();
                    World.Broadcast(
                        33,
                        true,
                        "Vesper Sosaria's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
