...
{
    public class StartStopUmbraSerpentIsland : Gump
    {
        private Mobile m_Mobile;

        public StartStopUmbraSerpentIsland(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopUmbraSerpentIsland));
                ...
                case 1:
                {
                    ...
                    point.Name = "UmbraInvasionSerpentIsland";
                    point1.Name = "UmbraInvasionSerpentIsland";
                    point2.Name = "UmbraInvasionSerpentIsland";
                    ...
                    spawner1.Name = "UmbraInvasionSerpentIsland";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "UmbraInvasionSerpentIsland";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "UmbraInvasionSerpentIsland";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "UmbraInvasionSerpentIsland";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Umbra SerpentIsland is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    ...
                    umbmal.StopUmbraSerpentIsland();
                    World.Broadcast(
                        33,
                        true,
                        "Umbra SerpentIsland's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
