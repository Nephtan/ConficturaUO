...
{
    public class StartStopLunaSerpentIsland : Gump
    {
        private Mobile m_Mobile;

        public StartStopLunaSerpentIsland(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopLunaSerpentIsland));
                ...
                case 1:
                {
                    ...
                    point.Name = "LunaInvasionSerpentIsland";
                    point1.Name = "LunaInvasionSerpentIsland";
                    point2.Name = "LunaInvasionSerpentIsland";
                    ...
                    spawner1.Name = "LunaInvasionSerpentIsland";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "LunaInvasionSerpentIsland";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "LunaInvasionSerpentIsland";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "LunaInvasionSerpentIsland";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Luna SerpentIsland is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    LunaInvasionStone lunmal = new LunaInvasionStone();
                    lunmal.StopLunaSerpentIsland();
                    World.Broadcast(
                        33,
                        true,
                        "Luna SerpentIsland's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
