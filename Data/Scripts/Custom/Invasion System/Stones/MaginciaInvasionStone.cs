...
namespace Server.Items
{
    public class MaginciaInvasionStone : Item
    {
        ...
        public virtual void CleanUpMaginciaLodor()
        {
            CleanUpSpawns("MaginciaInvasionLodor");
            CleanUpWayPoints("MaginciaInvasionLodor");
        }

        public virtual void StopMaginciaLodor()
        {
            ...
            foreach (Item item in maginciafel)
            {
                ...
                {
                    ((MaginciaInvasionStone)item).CleanUpMaginciaLodor();
                }
            }
        }

        public virtual void CleanUpMaginciaSosaria()
        {
            CleanUpSpawns("MaginciaInvasionSosaria");
            CleanUpWayPoints("MaginciaInvasionSosaria");
        }

        public virtual void StopMaginciaSosaria()
        {
            ...
            foreach (Item item in maginciatram)
            {
                if (item is MaginciaInvasionStone)
                {
                    ((MaginciaInvasionStone)item).CleanUpMaginciaSosaria();
                }
            }
        }

        public MaginciaInvasionStone(Serial serial)
            : base(serial) { }
        ...
        {
            from.SendMessage("Magincia is being invated");
        }
    }
}
