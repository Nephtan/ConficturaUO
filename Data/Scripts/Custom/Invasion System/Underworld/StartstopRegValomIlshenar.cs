...
{
    public class StartStopRegVolonilsh : Gump
    {
        private Mobile m_Mobile;

        public StartStopRegVolonilsh(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopRegVolonilsh));
                ...
                case 1:
                {
                    ...
                    point.Name = "RegVolonInvasionUnderworld";
                    point1.Name = "RegVolonInvasionUnderworld";
                    point2.Name = "RegVolonInvasionUnderworld";
                    ...
                    spawner1.Name = "RegVolonInvasionUnderworld";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "RegVolonInvasionUnderworld";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "RegVolonInvasionUnderworld";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "RegVolonInvasionUnderworld";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Reg Volon Underworld is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    RegVolonInvasionStone regilsh = new RegVolonInvasionStone();
                    regilsh.StopRegVolonUnderworld();
                    World.Broadcast(
                        33,
                        true,
                        "Reg Volon Underworld's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
