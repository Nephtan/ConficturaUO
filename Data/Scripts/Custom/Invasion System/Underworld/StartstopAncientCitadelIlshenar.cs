...
{
    public class StartStopAncientCitadelilsh : Gump
    {
        private Mobile m_Mobile;

        public StartStopAncientCitadelilsh(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopAncientCitadelilsh));
                ...
                case 1:
                {
                    ...
                    point.Name = "AncientCitadelInvasionUnderworld";
                    point1.Name = "AncientCitadelInvasionUnderworld";
                    point2.Name = "AncientCitadelInvasionUnderworld";
                    ...
                    spawner1.Name = "AncientCitadelInvasionUnderworld";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "AncientCitadelInvasionUnderworld";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "AncientCitadelInvasionIlshendar";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "AncientCitadelInvasionUnderworld";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Ancient Citadel Underworld is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    AncientCitadelInvasionStone ancilsh = new AncientCitadelInvasionStone();
                    ancilsh.StopAncientCitadelUnderworld();
                    World.Broadcast(
                        33,
                        true,
                        "Ancient Citadel Underworld's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
