...
namespace Server.Gumps
{
    public class StartStopLakeShireMiregilsh : Gump
    {
        ...
        public StartStopLakeShireMiregilsh(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 1:
                {
                    ...
                    point.Name = "LakeShireMiregInvasionUnderworld";
                    point1.Name = "LakeShireMiregInvasionUnderworld";
                    point2.Name = "LakeShireMiregInvasionUnderworld";
                    ...
                    spawner1.Name = "LakeShireMiregInvasionUnderworld";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "LakeShireMiregInvasionUnderworld";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "LakeShireMiregInvasionUnderworld";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "LakeShireMiregInvasionUnderworld";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "LakeShire and Mireg Underworld is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    ...
                    lakilsh.StopLakeShireMiregUnderworld();
                    World.Broadcast(
                        33,
                        true,
                        "LakeShire and Mireg Underworld's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
