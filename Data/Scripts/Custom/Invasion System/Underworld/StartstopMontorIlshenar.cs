...
{
    public class StartStopMontorilsh : Gump
    {
        private Mobile m_Mobile;

        public StartStopMontorilsh(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 1:
                {
                    ...
                    point.Name = "MontorInvasionUnderworld";
                    point1.Name = "MontorInvasionUnderworld";
                    point2.Name = "MontorInvasionUnderworld";
                    ...
                    spawner1.Name = "MontorInvasionUnderworld";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "MontorInvasionUnderworld";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "MontorInvasionUnderworld";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "MontorInvasionUnderworld";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Montor Underworld is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    ...
                    monilsh.StopMontorUnderworld();
                    World.Broadcast(
                        33,
                        true,
                        "Montor Underworld's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
