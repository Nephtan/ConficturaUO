...
{
    public class StartStopTerortSkitasilsh : Gump
    {
        private Mobile m_Mobile;

        public StartStopTerortSkitasilsh(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopTerortSkitasilsh));
                ...
                case 1:
                {
                    ...
                    point.Name = "TerortSkitasInvasionUnderworld";
                    point1.Name = "TerortSkitasInvasionUnderworld";
                    point2.Name = "TerortSkitasInvasionUnderworld";
                    ...
                    spawner1.Name = "TerortSkitasInvasionUnderworld";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "TerortSkitasInvasionUnderworld";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "TerortSkitasInvasionUnderworld";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "TerortSkitasInvasionUnderworld";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Terort Skitas Underworld is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    TerortSkitasInvasionStone terilsh = new TerortSkitasInvasionStone();
                    terilsh.StopTerortSkitasUnderworld();
                    World.Broadcast(
                        33,
                        true,
                        "Terort Skitas Underworld's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
