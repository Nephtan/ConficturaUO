...
{
    public class StartStopSavageCampilsh : Gump
    {
        private Mobile m_Mobile;

        public StartStopSavageCampilsh(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopSavageCampilsh));
                ...
                case 1:
                {
                    ...
                    point.Name = "SavageCampInvasionUnderworld";
                    point1.Name = "SavageCampInvasionUnderworld";
                    point2.Name = "SavageCampInvasionUnderworld";
                    ...
                    spawner1.Name = "SavageCampInvasionUnderworld";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "SavageCampInvasionUnderworld";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "SavageCampInvasionUnderworld";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "SavageCampInvasionUnderworld";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Savage Camp Underworld is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    SavageCampInvasionStone savilsh = new SavageCampInvasionStone();
                    savilsh.StopSavageCampUnderworld();
                    World.Broadcast(
                        33,
                        true,
                        "Savage Camp Underworld's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
