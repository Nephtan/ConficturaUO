...
{
    public class StartStopGargoyleCityilsh : Gump
    {
        private Mobile m_Mobile;

        public StartStopGargoyleCityilsh(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopGargoyleCityilsh));
                ...
                case 1:
                {
                    ...
                    point.Name = "GargoyleCityInvasionUnderworld";
                    point1.Name = "GargoyleCityInvasionUnderworld";
                    point2.Name = "GargoyleCityInvasionUnderworld";
                    ...
                    spawner1.Name = "GargoyleCityInvasionUnderworld";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "GargoyleCityInvasionUnderworld";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "GargoyleCityInvasionUnderworld";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "GargoyleCityInvasionUnderworld";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Gargoyle City Underworld is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    GargoyleCityInvasionStone garcitilsh = new GargoyleCityInvasionStone();
                    garcitilsh.StopGargoyleCityUnderworld();
                    World.Broadcast(
                        33,
                        true,
                        "Gargoyle City Underworld's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
