...
{
    public class StartStopTrinsicfel : Gump
    {
        private Mobile m_Mobile;

        public StartStopTrinsicfel(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopTrinsicfel));
                ...
                case 1:
                {
                    ...
                    point.Name = "TrinsicInvasionLodor";
                    point1.Name = "TrinsicInvasionLodor";
                    point2.Name = "TrinsicInvasionLodor";
                    ...
                    spawner1.Name = "TrinsicInvasionLodor";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "TrinsicInvasionLodor";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "TrinsicInvasionLodor";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "TrinsicInvasionLodor";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Trinsic Lodor is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    TrinsicInvasionStone Trinsicfel = new TrinsicInvasionStone();
                    Trinsicfel.StopTrinsicLodor();
                    World.Broadcast(
                        33,
                        true,
                        "Trinsic Lodor's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
