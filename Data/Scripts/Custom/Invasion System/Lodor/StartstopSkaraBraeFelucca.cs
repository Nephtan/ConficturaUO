...
namespace Server.Gumps
{
    public class StartStopSkaraBraefel : Gump
    {
        ...
        public StartStopSkaraBraefel(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 1:
                {
                    ...
                    point.Name = "SkaraBraeInvasionLodor";
                    point1.Name = "SkaraBraeInvasionLodor";
                    point2.Name = "SkaraBraeInvasionLodor";
                    ...
                    spawner1.Name = "SkaraBraeInvasionLodor";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "SkaraBraeInvasionLodor";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "SkaraBraeInvasionLodor";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "SkaraBraeInvasionLodor";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "SkaraBrae Lodor is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    ...
                    SkaraBraefel.StopSkaraBraeLodor();
                    World.Broadcast(
                        33,
                        true,
                        "SkaraBrae Lodor's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
