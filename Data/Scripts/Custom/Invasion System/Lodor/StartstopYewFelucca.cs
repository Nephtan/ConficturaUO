...
{
    public class StartStopYewfel : Gump
    {
        private Mobile m_Mobile;

        public StartStopYewfel(Mobile from)
            : base(0, 0)
        {
            m_Mobile = from;
            Closable = false;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 0:
                {
                    from.CloseGump(typeof(StartStopYewfel));
                ...
                case 1:
                {
                    ...
                    point.Name = "YewInvasionLodor";
                    point1.Name = "YewInvasionLodor";
                    point2.Name = "YewInvasionLodor";
                    ...
                    spawner1.Name = "YewInvasionLodor";
                    spawner1.Respawn();
                    ...
                    spawner2.Name = "YewInvasionLodor";
                    spawner2.Respawn();
                    ...
                    spawner3.Name = "YewInvasionLodor";
                    spawner3.Respawn();
                    ...
                    spawner4.Name = "YewInvasionLodor";
                    spawner4.Respawn();

                    World.Broadcast(33, true, "Yew Lodor is under invasion.");
                    from.SendGump(new CityInvasion(from));
                    break;
                }
                case 2:
                {
                    YewInvasionStone yewfel = new YewInvasionStone();
                    yewfel.StopYewLodor();
                    World.Broadcast(
                        33,
                        true,
                        "Yew Lodor's invasion was successfully beaten back. No more invaders are left in the city."
                    );
                    from.SendGump(new CityInvasion(from));
                    break;
                }
