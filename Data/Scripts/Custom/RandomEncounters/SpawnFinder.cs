...
namespace Server.Misc
{
    ...
    public class SpawnFinder
    {
        ...
        )
        {
            ...
            bool found = Search.Octant(pm.Map, dir, distance, SearchDirection.Inwards, tour);
        ...
        )
        {
            ...
            StaticTile[] staticTiles = map.Tiles.GetStaticTiles(
                currentPoint.X,
                currentPoint.Y,
                true
            );
            ...
            else
            {
                ...
                {
                    if (
                        (TileData.ItemTable[staticTile.ID & 0x3FFF].Flags & TileFlag.Wet)
                        == TileFlag.Wet
                    )
                    {
                        foundWet = true;
                ...
                foreach (StaticTile staticTile in staticTileArray)
                {
                    if (map.CanSpawnMobile(currentPoint.X, currentPoint.Y, staticTile.Z))
                    {
                        ...
                        if (RandomEncounterEngine.DebugEffect)
                            Effects.SendLocationParticles(
                                EffectItem.Create(
                                    new Point3D(spawnPoint.X, spawnPoint.Y, spawnPoint.Z),
                                    map,
        ...
        public class TileComparer : IComparer
        {
            public int Compare(object o1, object o2)
            {
                ...
                if (o1 is LandTile)
                {
                    LandTile tile1 = (LandTile)o1;
                    z1 = tile1.Z;
                }
                else if (o1 is StaticTile)
                {
                ...
                if (o2 is LandTile)
                {
                    LandTile tile2 = (LandTile)o2;
                    z2 = tile2.Z;
                }
                else if (o2 is StaticTile)
                {
