...
namespace Server.Misc
{
    ...
    public class EncounterElement : IElementContainer
    {
        ...
        private float m_Probability; // 0.0-1.0, where 1.0==100%
        private int m_Min,
            m_Max; // i.e., the range of possible N
        ...
        public ArrayList Pick()
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                EncounterElement pickedElement = new EncounterElement(
                    m_XmlNode,
                    "1",
                    pick,
                    m_ID.ToString(),
    ...
    public class RegionRecord
    {
        ...
        {
            object o = m_PossibleEncounters.Find(
                new EncounterSet.QuickSearch(encounter.Probability)
            );
