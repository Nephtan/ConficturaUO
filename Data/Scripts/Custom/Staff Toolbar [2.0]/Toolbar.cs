...
namespace Joeku
{
    public class ToolbarHelper
    {
        ...
        public static void EnsureMaxed(Mobile mob)
        {
            ...
            if (mob.AccessLevel > ((Account)mob.Account).AccessLevel)
            {
                ...
                Console.WriteLine(
                    "***TOOLBAR*** Account {0}, Mobile {1}: AccessLevel resolved to {2}.",
                    ((Account)mob.Account).Username,
                    mob,
                    mob.AccessLevel
                );
            }
    ...
    public class ToolbarInfos : Item
    {
        ...
        public List<ToolbarInfo> Info
        {
            get { return p_ToolbarInfo; }
            set { p_ToolbarInfo = value; }
        }

        public ToolbarInfos() { }

        public ToolbarInfos(Serial serial)
            : base(serial) { }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                ToolbarInfo info = new ToolbarInfo(
                    ...
                    points,
                    font,
                    new bool[] { phantom, stealth, reverse, locked }
                );
            }
        }
    }
    ...
    public class ToolbarInfo
    {
        ...
        public bool Phantom
        {
            get { return p_Phantom; }
            set { p_Phantom = value; }
        }
        private bool p_Stealth;
        public bool Stealth
        {
            get { return p_Stealth; }
            set { p_Stealth = value; }
        }
        private bool p_Reverse;
        public bool Reverse
        {
            get { return p_Reverse; }
            set { p_Reverse = value; }
        }
        private bool p_Lock;
        public bool Lock
        ...
        {
            get { return p_Dimensions; }
            set { p_Dimensions = value; }
        }
    ...
    public class Toolbar : Gump
    {
        ...
        *******************/
        ...
        {
            get { return p_Commands; }
            set { p_Commands = value; }
        }
        public int Skin
        {
            get { return p_Skin; }
            ...
            : base(0, 28)
        {
            ...
            AddBackground(
                ...
                bx,
                byx,
                GumpIDs.Misc[(int)GumpIDs.MiscIDs.Background].Content[p_Skin, 0]
            );
            ...
            for (int i = 0; i < Columns * Rows; i++)
            {
                ...
                AddBackground(
                    ...
                    110,
                    24,
                    GumpIDs.Misc[(int)GumpIDs.MiscIDs.Buttonground].Content[p_Skin, 0]
                );
                ...
                AddHtml(
                    ...
                    100,
                    20,
                    String.Format("<center>{0}{1}", font, Commands[temp]),
                    false,
                    false
                );
        ...
        public void SetCoords(int offset)
        {
            InitOptsW =
                50
                + (offset * 2)
                + GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Minimize].Content[p_Skin, 2]
                + 5
                + GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Customize].Content[p_Skin, 2];
            InitOptsH =
                (offset * 2) + GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Minimize].Content[p_Skin, 3];
            if (
                GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Customize].Content[p_Skin, 3] + (offset * 2)
                > InitOptsH
            )
                InitOptsH =
                    GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Customize].Content[p_Skin, 3]
                    + (offset * 2);
        }
        ...
        public void AddInitOpts(int y, int offset)
        {
            ...
            AddButton(
                offset,
                y + offset,
                GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Minimize].Content[p_Skin, 0],
                GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Minimize].Content[p_Skin, 1],
                0,
                GumpButtonType.Page,
                Stealth ? 1 : 2
            );
            AddButton(
                offset + GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Minimize].Content[p_Skin, 2] + 5,
                y + offset,
                GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Customize].Content[p_Skin, 0],
                GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Customize].Content[p_Skin, 1],
                1,
        ...
        public void AddMinimized(int y, int offset)
        {
            ...
            AddButton(
                offset,
                y + offset,
                GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Maximize].Content[p_Skin, 0],
                GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Maximize].Content[p_Skin, 1],
                0,
                GumpButtonType.Page,
                Stealth ? 2 : 1
            );
    ...
    public class ToolbarEdit : Gump
    {
        ...
        public ToolbarEdit(ToolbarInfo info, bool expanded)
            : this(
                ...
                info.Dimensions[1],
                info.Font,
                new bool[] { info.Phantom, info.Stealth, info.Reverse, info.Lock }
            ) { }
        ...
        public void AddControls()
        {
            ...
            AddHtml(
                ...
                100,
                20,
                String.Format("{0}Font - {1}", GumpIDs.Fonts[p_Font], p_Font + 1),
                false,
                false
            );
        ...
        public void AddNavigation()
        {
            ...
            AddButton(
                595,
                95,
                this.p_Expanded ? 5603 : 5601,
                this.p_Expanded ? 5607 : 5605,
                28,
                GumpButtonType.Reply,
                0
            );
        ...
        public void AddEntries()
        {
            int buffer = 2;
            // CALC
            int entryX = p_ExpandedInt * 149,
                entryY = p_ExpandedInt * 20;
