...
namespace Server
{
    public class PlayerGovernmentSystem
    {
        ...
        {
            get { return GovernmentTestingMode.Adjust(TimeSpan.FromHours(24.0)); } // Default 1140 = 24 hours
        }

        // City Update Time
        public static TimeSpan CityUpdate
        {
            get { return GovernmentTestingMode.Adjust(TimeSpan.FromDays(7.0)); } // Default 10080 = 7 days
        }

        // Mayor Voting Time
        public static TimeSpan VoteUpdate
        {
            get { return GovernmentTestingMode.Adjust(TimeSpan.FromDays(14.0)); } // Default 20160 = 14 Days
        }
