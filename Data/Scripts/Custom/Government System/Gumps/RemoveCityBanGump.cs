...
{
    public class RemoveCityBanGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            if (m_List == null)
            {
                ArrayList total = new ArrayList(m_Stone.Banned);
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            if (info.ButtonID == 1) // Previous page
            {
                if (m_ListPage > 0)
                    from.SendGump(
                        new RemoveCityBanGump(m_Stone, m_ListPage - 1, m_List, m_CountList)
                    );
            }
            ...
            {
                from.SendMessage("You have lifted the ban.");
                m_Stone.Banned.RemoveAt(info.ButtonID - 100);
            }
        }
    }
}
