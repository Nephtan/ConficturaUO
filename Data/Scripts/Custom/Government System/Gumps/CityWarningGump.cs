    ...
    public class CityWarningGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            AddHtml(
                ...
                438,
                19,
                @"<BASEFONT COLOR=WHITE><CENTER>Message From The Britannia Housing Commission</CENTER></BASEFONT>",
                (bool)false,
                (bool)false
            );
