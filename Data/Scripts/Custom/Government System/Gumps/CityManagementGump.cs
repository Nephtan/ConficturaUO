...
namespace Server.Gumps
{
    public class CityManagementGump : Gump
    {
        ...
        public CityManagementGump(CityManagementStone stone, Mobile from)
            : base(50, 50)
        {
            m_Stone = stone;
            ...
            AddHtml(
                ...
                393,
                21,
                @"<BASEFONT COLOR=WHITE><CENTER>Information</CENTER></BASEFONT>",
                (bool)false,
                (bool)false
            );
            ...
            if (stone.Level == 1)
                AddLabel(
                    ...
                    100,
                    1149,
                    @"City Limits: " + l1offset.ToString() + "x" + l1offset.ToString()
                );
                ...
                AddLabel(
                    ...
                    100,
                    1149,
                    @"City Limits: " + l2offset.ToString() + "x" + l2offset.ToString()
                );
                ...
                AddLabel(
                    ...
                    100,
                    1149,
                    @"City Limits: " + l3offset.ToString() + "x" + l3offset.ToString()
                );
                ...
                AddLabel(
                    ...
                    100,
                    1149,
                    @"City Limits: " + l4offset.ToString() + "x" + l4offset.ToString()
                );
                ...
                AddLabel(
                    ...
                    100,
                    1149,
                    @"City Limits: " + l5offset.ToString() + "x" + l5offset.ToString()
                );
                ...
                AddLabel(
                    ...
                    100,
                    1149,
                    @"City Limits: " + l6offset.ToString() + "x" + l6offset.ToString()
                );
            else
            ...
            AddHtml(
                ...
                393,
                21,
                @"<BASEFONT COLOR=WHITE><CENTER>General Settings</CENTER></BASEFONT>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                393,
                21,
                @"<BASEFONT COLOR=WHITE><CENTER>Membership</CENTER></BASEFONT>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                393,
                21,
                @"<BASEFONT COLOR=WHITE><CENTER>Treasury</CENTER></BASEFONT>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                393,
                21,
                @"<BASEFONT COLOR=WHITE><CENTER>Taxes</CENTER></BASEFONT>",
                (bool)false,
                (bool)false
            );
            ...
            AddHtml(
                ...
                393,
                21,
                @"<BASEFONT COLOR=WHITE><CENTER>War Department</CENTER></BASEFONT>",
                (bool)false,
                (bool)false
            );
            ...
            AddLabel(
                ...
                240,
                1149,
                @"Allegiances Declared: " + stone.AllegiancesDeclared.Count.ToString()
            );
            AddLabel(
                250,
                270,
                1149,
                @"Allegiances Invites: " + stone.AllegiancesInvited.Count.ToString()
            );
            ...
            AddHtml(
                ...
                393,
                21,
                @"<BASEFONT COLOR=WHITE><CENTER>Misc.</CENTER></BASEFONT>",
                (bool)false,
                (bool)false
            );
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            {
                from.SendMessage(
                    "Please enter the new name for the city, You have up to 40 characters."
                );
            ...
            if (info.ButtonID == 3) // Toggle Guards
            {
                ...
                {
                    from.SendMessage(
                        "Your city must be at least level 3 or higher before you can enable guards."
                    );
                }
            ...
            if (info.ButtonID == 4) // Reg City
            {
                ...
                {
                    from.SendMessage(
                        "You have registered your city, It will now show up on all public city moongates."
                    );
                ...
                {
                    from.SendMessage(
                        "Your city must be at least level 3 or higher before you can register your city."
                    );
                }
            ...
            {
                from.SendMessage(
                    "Please enter your city's URL. Be sure to put http:// in front of it."
                );
            ...
            {
                from.SendMessage(
                    "Please enter the amount you wish to set the resurrection fee to."
                );
            ...
            {
                from.SendMessage(
                    "Please enter the amount you wish to set the corpse retrieval fee to."
                );
