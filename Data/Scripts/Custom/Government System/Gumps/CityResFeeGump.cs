...
namespace Server.Gumps
{
    public class CityResFeeGump : Gump
    {
        ...
        public CityResFeeGump(CityResurrectionStone stone)
            : base(50, 50)
        {
            m_Stone = stone;
            ...
            AddHtml(
                ...
                234,
                66,
                @"<BASEFONT COLOR=WHITE><CENTER>This city has a resurrection fee.<BR>Would you like to resurrect here?</CENTER></BASEFONT>",
                (bool)false,
                (bool)false
            );
