...
namespace Server.Gumps
{
    public class CityCorpseFeeGump : Gump
    {
        ...
        public CityCorpseFeeGump(CityResurrectionStone stone)
            : base(50, 50)
        {
            m_Stone = stone;
            ...
            AddHtml(
                ...
                234,
                66,
                @"<BASEFONT COLOR=WHITE><CENTER>This city has a fee to retrive your corpse.<BR>Woul you like to get your corpse?</CENTER></BASEFONT>",
                (bool)false,
                (bool)false
            );
                ...
                if (Banker.Withdraw(from, m_Stone.Sign.Stone.CorpseFee))
                {
                    ...
                    if (corpse != null)
                    {
                        if (m_Stone.RegCorpse(from))
                        {
                            ...
                            from.SendMessage(
                                "You may only do this 3 times a week. No Money taken."
                            );
                    }
                    else
                    {
                        ...
                        from.SendMessage(
                            "No money was taken from your back account since corpse was not found."
                        );
                    }
                }
                else
