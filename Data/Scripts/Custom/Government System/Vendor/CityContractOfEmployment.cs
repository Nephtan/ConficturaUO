...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public CityContractOfEmployment()
            : base(0x14F0)
        {
            Weight = 1.0;
        ...
        public CityContractOfEmployment(Serial serial)
            : base(serial) { }
                ...
                else
                {
                        ...
                        ;
                    {
                        if (from.Region is HouseRegion)
                        {
                            ...
                            if (house.Owner != from)
                                from.SendMessage(
                                    "You may not place vendors in a house you do not own!"
                                );
                            else
                            {
                        ...
                        else
                        {
                            ...
                            if (PlayerGovernmentSystem.IsAtCity(from) || market)
                            {
                                ...
                                from.SendMessage(
                                    "You may only do this in a city you are a member of!"
                                );
                        }
                    }
                }
