...
namespace Server.Items
{
    public class CityResourceBoxDeed : Item
    {
            ...
            if (IsChildOf(from.Backpack))
            {
                ...
                else
                {
                    if (!ismayor)
                        ...
                        from.SendMessage(
                            "You may only place this in city buldings or public areas."
                        );
                }
            }
            else
        ...
        public CityResourceBoxDeed(Serial serial)
            : base(serial) { }
        ...
        private class CityBoxTarget : Target
        {
            ...
            public CityBoxTarget(Mobile mob, CityResourceBoxDeed deed)
            ...
            protected override void OnTarget(Mobile from, object target)
            {
                ...
                if (
                    from.Region is PlayerCityRegion
                    && reg == from.Region
