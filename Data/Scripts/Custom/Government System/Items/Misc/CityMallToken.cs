...
namespace Server.Items
{
    public class CityMallToken : VendorMallToken
    {
            ...
            else
            {
                ...
                if (r is CityMarketRegion)
                {
                    ...
                    if (cityreg.Sign == this.Sign)
                    {
                        ...
                        CityRentedVendor vendor = new CityRentedVendor(
                            m_Lord,
                            this.Owner,
                            m_Expire,
                            this.Rent,
                        ...
                        from.SendMessage(
                            "You may only do this in a city market that you purchased a spot in!"
                        );
                }
                else
        ...
        public CityMallToken(Serial serial)
            : base(serial) { }
