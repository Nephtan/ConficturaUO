...
namespace Server.Items
{
    ...
    {
        public static void GetContextMenuEntries(
            Mobile from,
            Item item,
        ...
        private class CityResurrectEntry : ContextMenuEntry
        {
            ...
            public CityResurrectEntry(Mobile mobile, Item item)
                : base(6195, 2)
            {
                m_Mobile = mobile;
                m_Item = item;
        ...
        private class CityLockKarmaEntry : ContextMenuEntry
        {
            ...
            public CityLockKarmaEntry(PlayerMobile mobile)
        ...
        private class CityTitheEntry : ContextMenuEntry
        {
            ...
            public CityTitheEntry(Mobile mobile)
                : base(6198, 2)
            {
                m_Mobile = mobile;
    ...
    public class CityResurrectionStone : Item
    {
            ...
            if (from.InRange(this.GetWorldLocation(), 2))
            {
                ...
                if (m_Sign.Stone == pm.City)
                {
                    ...
                    else
                    {
                        from.SendMessage(
                            53,
                            "WARNING! Stone not linked to building sign. Contact a game master."
                        );
                    }
                }
                else
        ...
        public CityResurrectionStone(Serial serial)
            : base(serial) { }
        ...
        public bool RegCorpse(Mobile from)
        {
            ...
            else if (m_ghosts.ContainsKey(from))
            {
                if ((int)m_ghosts[from] < 3)
                {
                    ...
                    from.SendMessage(
                        "You have used {0} out of 3 weekly corpse retrievals",
                        (int)m_ghosts[from]
                    );
                    return true;
                }
