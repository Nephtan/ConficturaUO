...
{
    public class LargeCityGardenDeed : CityDeed
    {
        [Constructable]
        public LargeCityGardenDeed()
            : base(0x1454, new Point3D(0, 8, 0))
        {
            Name = "a large garden deed";
            Type = CivicStrutureType.LargeCityGarden;
        }

        public LargeCityGardenDeed(Serial serial)
            : base(serial) { }
