...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public SmallCityGardenDeed()
            : base(0x13EC, new Point3D(0, 4, 0))
        {
            Name = "a small garden deed";
            Type = CivicStrutureType.SmallCityGarden;
        }

        public SmallCityGardenDeed(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else if (pm.City != null)
            {
                ...
                {
                    from.SendMessage(
                        "Your city must be at least level 1 before you can place this structure."
                    );
                }
                else if (
