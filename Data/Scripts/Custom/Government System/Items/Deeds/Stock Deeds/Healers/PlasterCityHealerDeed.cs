...
{
    public class PlasterCityHealerDeed : CityDeed
    {
        [Constructable]
        public PlasterCityHealerDeed()
            : base(0x1413, new Point3D(0, 6, 0))
        {
            Name = "a plaster healer deed";
            Type = CivicStrutureType.PlasterCityHealer;
        }

        public PlasterCityHealerDeed(Serial serial)
            : base(serial) { }
