...
{
    public class FieldstoneCityHealerDeed : CityDeed
    {
        [Constructable]
        public FieldstoneCityHealerDeed()
            : base(0x1413, new Point3D(0, 6, 0))
        {
            Name = "a fieldstone healer deed";
            Type = CivicStrutureType.FieldStoneCityHealer;
        }

        public FieldstoneCityHealerDeed(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else if (pm.City != null)
            {
                ...
                {
                    from.SendMessage(
                        "Your city already has a healer, Remove that one first before placing this one."
                    );
                }
                else if (
