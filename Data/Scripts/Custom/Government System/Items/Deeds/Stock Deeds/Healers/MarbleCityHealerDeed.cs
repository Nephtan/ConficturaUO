...
{
    public class MarbleCityHealerDeed : CityDeed
    {
        [Constructable]
        public MarbleCityHealerDeed()
            : base(0x1413, new Point3D(0, 6, 0))
        {
            Name = "a marble healer deed";
            Type = CivicStrutureType.MarbleCityHealer;
        }

        public MarbleCityHealerDeed(Serial serial)
            : base(serial) { }
