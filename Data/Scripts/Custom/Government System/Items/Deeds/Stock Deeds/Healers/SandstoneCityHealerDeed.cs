...
{
    public class SandstoneCityHealerDeed : CityDeed
    {
        [Constructable]
        public SandstoneCityHealerDeed()
            : base(0x1413, new Point3D(0, 6, 0))
        {
            Name = "a sandstone healer deed";
            Type = CivicStrutureType.SandstoneCityHealer;
        }

        public SandstoneCityHealerDeed(Serial serial)
            : base(serial) { }
