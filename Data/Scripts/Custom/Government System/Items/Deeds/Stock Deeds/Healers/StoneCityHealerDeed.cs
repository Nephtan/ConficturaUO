...
{
    public class StoneCityHealerDeed : CityDeed
    {
        [Constructable]
        public StoneCityHealerDeed()
            : base(0x1413, new Point3D(0, 6, 0))
        {
            Name = "a stone healer deed";
            Type = CivicStrutureType.StoneCityHealer;
        }

        public StoneCityHealerDeed(Serial serial)
            : base(serial) { }
