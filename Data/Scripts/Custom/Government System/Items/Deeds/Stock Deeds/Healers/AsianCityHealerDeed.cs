...
{
    public class AsianCityHealerDeed : CityDeed
    {
        [Constructable]
        public AsianCityHealerDeed()
            : base(0x1413, new Point3D(0, 6, 0))
        {
            Name = "an asian healer deed";
            Type = CivicStrutureType.AsianCityHealer;
        }

        public AsianCityHealerDeed(Serial serial)
            : base(serial) { }
