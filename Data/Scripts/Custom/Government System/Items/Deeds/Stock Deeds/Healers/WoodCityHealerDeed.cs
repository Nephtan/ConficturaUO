...
{
    public class WoodCityHealerDeed : CityDeed
    {
        [Constructable]
        public WoodCityHealerDeed()
            : base(0x1413, new Point3D(0, 6, 0))
        {
            Name = "a wood healer deed";
            Type = CivicStrutureType.WoodCityHealer;
        }

        public WoodCityHealerDeed(Serial serial)
            : base(serial) { }
