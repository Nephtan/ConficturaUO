...
{
    public class PlasterCityTavernDeed : CityDeed
    {
        [Constructable]
        public PlasterCityTavernDeed()
            : base(0x1454, new Point3D(0, 8, 0))
        {
            Name = "a plaster tavern";
            Type = CivicStrutureType.PlasterCityTavern;
        }

        public PlasterCityTavernDeed(Serial serial)
            : base(serial) { }
