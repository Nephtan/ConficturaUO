...
{
    public class FieldstoneCityTavernDeed : CityDeed
    {
        [Constructable]
        public FieldstoneCityTavernDeed()
            : base(0x1454, new Point3D(0, 8, 0))
        {
            Name = "a fieldstone tavern";
            Type = CivicStrutureType.FieldStoneCityTavern;
        }

        public FieldstoneCityTavernDeed(Serial serial)
            : base(serial) { }
