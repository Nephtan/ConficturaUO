...
{
    public class AsianCityTavernDeed : CityDeed
    {
        [Constructable]
        public AsianCityTavernDeed()
            : base(0x1454, new Point3D(0, 8, 0))
        {
            Name = "an asian tavern";
            Type = CivicStrutureType.AsianCityTavern;
        }

        public AsianCityTavernDeed(Serial serial)
            : base(serial) { }
