...
{
    public class SandstoneCityTavernDeed : CityDeed
    {
        [Constructable]
        public SandstoneCityTavernDeed()
            : base(0x1454, new Point3D(0, 8, 0))
        {
            Name = "a sandstone tavern";
            Type = CivicStrutureType.SandstoneCityTavern;
        }

        public SandstoneCityTavernDeed(Serial serial)
            : base(serial) { }
