...
{
    public class MarbleCityTavernDeed : CityDeed
    {
        [Constructable]
        public MarbleCityTavernDeed()
            : base(0x1454, new Point3D(0, 8, 0))
        {
            Name = "a marble tavern";
            Type = CivicStrutureType.MarbleCityTavern;
        }

        public MarbleCityTavernDeed(Serial serial)
            : base(serial) { }
