...
{
    public class MarbleCityHealerAddon : BaseAddon
    {
        public override BaseAddonDeed Deed
        {
            get
            {
                //return new MarbleCityHealerAddonDeed();
                return null;
            }
        }

        [Constructable]
        public MarbleCityHealerAddon()
        {
            ...
            ac = new AddonComponent(675);
            AddComponent(ac, 5, 3, 27);
            ac = new AddonComponent(673);
            AddComponent(ac, 5, 4, 27);
        }

        public MarbleCityHealerAddon(Serial serial)
            : base(serial) { }
