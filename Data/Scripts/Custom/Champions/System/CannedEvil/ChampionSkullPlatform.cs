...
namespace Server.Engines.CannedEvil
{
    ...
    {
        private ChampionSkullBrazier m_Power,
            m_Enlightenment,
            m_Venom,
            m_Pain,
            m_Greed,
        ...
        public ChampionSkullPlatform()
        {
            ...
            AddComponent(
                m_Power = new ChampionSkullBrazier(this, ChampionSkullType.Power),
                0,
                -1,
                5
            );
            ...
            AddComponent(
                m_Enlightenment = new ChampionSkullBrazier(this, ChampionSkullType.Enlightenment),
                1,
                -1,
                5
            );
            ...
            AddComponent(
                m_Venom = new ChampionSkullBrazier(this, ChampionSkullType.Venom),
                -1,
                0,
                5
            );
            ...
            AddComponent(new AddonComponent(0x50F), -1, 1, 4);
            AddComponent(
                m_Greed = new ChampionSkullBrazier(this, ChampionSkullType.Greed),
                -1,
                1,
                5
            );
            ...
            AddComponent(new AddonComponent(0x50F), 0, 1, 4);
            AddComponent(
                m_Death = new ChampionSkullBrazier(this, ChampionSkullType.Death),
                0,
                1,
                5
            );
