    ...
    public class SimpleLever : Item, ILinkable
    {
        ...
        public void Activate(Mobile from, int state, ArrayList links)
        {
            ...
            if (
                m_LeverState == 0
                && m_TargetItem0 != null
                && !m_TargetItem0.Deleted
                && m_TargetProperty0 != null
            ...
            if (
                m_LeverState == 1
                && m_TargetItem1 != null
                && !m_TargetItem1.Deleted
                && m_TargetProperty1 != null
            ...
            if (
                m_LeverState == 2
                && m_TargetItem2 != null
                && !m_TargetItem2.Deleted
                && m_TargetProperty2 != null
