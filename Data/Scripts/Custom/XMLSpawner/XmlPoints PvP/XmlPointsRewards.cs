...
namespace Server.Engines.XmlSpawner2
{
    public class XmlPointsRewards
    {
        ...
        {
            get { return PointsRewardList; }
        }

        public XmlPointsRewards(
            int minpoints,
            Type reward,
            string name,
            int cost,
        ...
        public static void Initialize()
        {
            ...
            PointsRewardList.Add(
                new XmlPointsRewards(
                    1000,
                    typeof(PowerScroll),
                    "105 Smithing powerscroll",
                    1000,
                    0x14F0,
                    new object[] { SkillName.Blacksmith, 105 }
                )
            );
            PointsRewardList.Add(
                new XmlPointsRewards(
                    2000,
                    typeof(PowerScroll),
                    "110 Smithing powerscroll",
                    2000,
                    0x14F0,
                    new object[] { SkillName.Blacksmith, 110 }
                )
            );
            PointsRewardList.Add(
                new XmlPointsRewards(
                    4000,
                    typeof(PowerScroll),
                    "115 Smithing powerscroll",
                    4000,
                    0x14F0,
                    new object[] { SkillName.Blacksmith, 115 }
                )
            );
            PointsRewardList.Add(
                new XmlPointsRewards(
                    ...
                    "+20 Ancient Smithy Hammer, 50 uses",
                    500,
                    0x13E4,
                    new object[] { 20, 50 }
                )
            ...
            PointsRewardList.Add(
                new XmlPointsRewards(200, typeof(ColoredAnvil), "Colored Anvil", 400, 0xFAF, null)
            );
            PointsRewardList.Add(
                new XmlPointsRewards(
                    100,
            ...
            PointsRewardList.Add(
                new XmlPointsRewards(
                    100,
                    typeof(LeatherGlovesOfMining),
                    "+20 Leather Gloves Of Mining",
                    200,
                    0x13c6,
                    new object[] { 20 }
                )
            ...
            PointsRewardList.Add(
                new XmlPointsRewards(0, typeof(RidableLlama), "Ridable Llama", 1, 0x20f6, null)
            );
            ...
            PointsRewardList.Add(
                new XmlPointsRewards(
                    0,
                    typeof(XmlEnemyMastery),
                    "+200% Balron Mastery for 1 day",
                    2,
                    0,
                    new object[] { "Balron", 50, 200, 1440.0 }
                )
            );
            PointsRewardList.Add(
                new XmlPointsRewards(
                    0,
                    typeof(XmlStr),
                    "+20 Strength for 1 day",
                    10,
                    0,
                    new object[] { 20, 86400.0 }
                )
            );
        }
    }
