...
namespace Server.Engines.XmlSpawner2
{
    public class ChallengeRegionStone : Item
    {
        ...
        public void RefreshRegions()
        {
            ...
            if (m_ChallengeMap == null || m_ChallengeArea == null)
                return;

            // define a new one based on the named region
            m_ChallengeRegion = new ChallengeGameRegion(
                m_ChallengeRegionName,
                m_ChallengeMap,
                m_Priority,
                m_ChallengeArea
            );
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            if (
                ...
                && m_ChallengeRegion.Area != null
                && m_ChallengeRegion.Area.Length > 0
            )
            {
                ...
                case 0:
                {
                    ...
                    if (count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i < count; i++)
                            {
                                m_ChallengeArea[i] = new Rectangle3D(
                                    reader.ReadPoint3D(),
                                    reader.ReadPoint3D()
                                );
                            }
        ...
        private static void ChallengeRegionArea_Callback(
            Mobile from,
            Map map,
            Point3D start,
            Point3D end,
        ...
        )
        {
            ...
            if (s != null && from != null)
            {
                ...
                s.m_ChallengeArea[0] = Region.ConvertTo3D(
