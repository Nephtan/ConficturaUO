...
namespace Server.Engines.XmlSpawner2
{
    public class SpanishPointsText
    {
        ...
        public static void Initialize()
        {
            ...
            // challengeregion.cs
            Add(100104, "No sera permitido hacer da�o antes o despues de un desafio.");
            ...
            Add(100267, "Usted no puede publicar un desaf�o aqu�.");
            ...
            Add(100548, "{0} ya ha sido a�adido al juego.");
            Add(100549, "Tu a�adistes a {0} para el challenge.");
