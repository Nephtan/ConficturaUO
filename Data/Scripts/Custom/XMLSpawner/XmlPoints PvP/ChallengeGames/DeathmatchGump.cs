    ...
    public class DeathmatchGump : Gump
    {
            ...
            : base(20, 30)
        {
            ...
            if (gauntlet.Participants != null)
            {
                ...
                {
                    DeathmatchGauntlet.ChallengeEntry entry = (DeathmatchGauntlet.ChallengeEntry)
                        m_WorkingList[i];
            ...
            switch (info.ButtonID)
            {
                ...
                case 300:
                    ...
                    else
                    {
                        state.Mobile.SendGump(
                            new DeathmatchGump(m_gauntlet, state.Mobile, viewpage)
                        );
                    }
                ...
                default:
                {
                    ...
                    if (info.ButtonID >= 4000)
                    {
                        ...
                        {
                            DeathmatchGauntlet.ChallengeEntry entry =
                                (DeathmatchGauntlet.ChallengeEntry)m_WorkingList[selection];
                            ...
                            if (m_gauntlet.Participants != null)
                            {
                                ...
                                foreach (
                                    DeathmatchGauntlet.ChallengeEntry masterentry in m_gauntlet.Participants
                                )
                                {
                    ...
                    if (entry.Participant != null && entry.Status != ChallengeStatus.Forfeit)
                    {
                        if (forced || entry.Participant.HasGump(typeof(DeathmatchGump)))
                        {
                            entry.Participant.SendGump(
                                new DeathmatchGump(gauntlet, entry.Participant)
                            );
                        }
                    }
                }
