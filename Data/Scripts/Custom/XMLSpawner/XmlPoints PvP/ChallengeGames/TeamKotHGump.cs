...
namespace Server.Gumps
{
    public class TeamKotHGump : Gump
    {
        ...
        private TeamKotHGauntlet m_gauntlet;
            ...
            : base(20, 30)
        {
            ...
            AddLabel(100, 10, 0, XmlPoints.GetText(from, 200600)); // "Team KotH Challenge"
            AddLabel(
                20,
                30,
                0,
            ...
            if (gauntlet.Participants != null)
            {
                ...
                if (gauntlet.TargetScore > 0)
                    AddLabel(
                        ...
                        110,
                        0,
                        String.Format(XmlPoints.GetText(from, 200561), gauntlet.TargetScore)
                    ); // "Target Score: {0}"
                else
                ...
                {
                    TeamKotHGauntlet.ChallengeEntry entry = (TeamKotHGauntlet.ChallengeEntry)
                        m_WorkingList[i];
            ...
            else if (gauntlet.Winner != 0)
            {
                AddLabel(
                    ...
                    height - 35,
                    68,
                    String.Format(XmlPoints.GetText(from, 200593), gauntlet.Winner)
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 1:
                    ...
                    state.Mobile.SendGump(new TeamKotHGump(m_gauntlet, state.Mobile, viewpage));
                    break;
                ...
                case 11:
                    ...
                    if (m_WorkingList != null)
                        for (int i = 0; i < m_WorkingList.Count; i++)
                        {
                            ...
                            TeamKotHGauntlet.ChallengeEntry entry =
                                (TeamKotHGauntlet.ChallengeEntry)m_WorkingList[i];
                            if (entry != null)
                            {
                                int tval = 0;
                ...
                case 12:
                    ...
                    state.Mobile.SendGump(new TeamKotHGump(m_gauntlet, state.Mobile, page));
                    break;
                case 13:
                    // page down
                    // try doing the default for non-participants
                ...
                case 300:
                    ...
                    bool complete = true;
                    foreach (TeamKotHGauntlet.ChallengeEntry entry in m_WorkingList)
                    {
                        if (entry != null)
                        {
                            Mobile m = entry.Participant;
                ...
                default:
                {
                    ...
                    if (info.ButtonID >= 4000)
                    {
                        ...
                        {
                            TeamKotHGauntlet.ChallengeEntry entry =
                                (TeamKotHGauntlet.ChallengeEntry)m_WorkingList[selection];
                            ...
                            if (m_gauntlet.Participants != null)
                            {
                                ...
                                foreach (
                                    TeamKotHGauntlet.ChallengeEntry masterentry in m_gauntlet.Participants
                                )
                                {
                    ...
                    if (entry.Participant != null)
                    {
                        if (force || entry.Participant.HasGump(typeof(TeamKotHGump)))
                        {
                            entry.Participant.SendGump(
                                new TeamKotHGump(gauntlet, entry.Participant)
                            );
                        }
                    }
                }
        ...
        private class MemberTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Mobile && ((Mobile)targeted).Player)
                {
                    ...
                    if (m_gauntlet.Participants != null)
                    {
                        foreach (TeamKotHGauntlet.ChallengeEntry entry in m_gauntlet.Participants)
                        {
                    ...
                    m_list.Add(new TeamKotHGauntlet.ChallengeEntry(pm));
        ...
        public class TeamsGump : Gump
        {
                ...
                : base(350, 30)
            {
                ...
                AddLabel(60, 10, 0, XmlPoints.GetText(from, 200601)); // "KotH Team Status"
