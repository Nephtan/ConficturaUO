                ...
                case 11:
                    ...
                    if (m_WorkingList != null)
                        for (int i = 0; i < m_WorkingList.Count; i++)
                        {
                            ...
                            CTFGauntlet.ChallengeEntry entry = (CTFGauntlet.ChallengeEntry)
                                m_WorkingList[i];
                            if (entry != null)
                            {
                                int tval = 0;
                    ...
                    if (info.ButtonID >= 4000)
                    {
                        ...
                        if (selection < m_WorkingList.Count)
                        {
                            ...
                            if (m_gauntlet.Participants != null)
                            {
                                ...
                                foreach (
                                    CTFGauntlet.ChallengeEntry masterentry in m_gauntlet.Participants
                                )
                                {
                                ...
                                if (kickentry != null)
                                {
                                    ...
                                    if (kickentry.Participant != null)
                                    {
                                        ...
                                        kickentry.Participant.SendGump(
                                            new CTFGump(m_gauntlet, kickentry.Participant, viewpage)
                                        );
                                    }
                                }
                            }
