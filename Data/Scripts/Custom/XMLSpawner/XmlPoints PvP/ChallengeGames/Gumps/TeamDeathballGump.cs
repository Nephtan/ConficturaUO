    ...
    public class TeamDeathballGump : Gump
    {
            ...
            : base(20, 30)
        {
            ...
            if (gauntlet.Participants != null)
            {
                ...
                {
                    TeamDeathballGauntlet.ChallengeEntry entry =
                        (TeamDeathballGauntlet.ChallengeEntry)m_WorkingList[i];
            ...
            switch (info.ButtonID)
            {
                case 1:
                    ...
                    state.Mobile.SendGump(
                        new TeamDeathballGump(m_gauntlet, state.Mobile, viewpage)
                    );
                    break;
                ...
                default:
                {
                    ...
                    if (info.ButtonID >= 4000)
                    {
                        ...
                        {
                            TeamDeathballGauntlet.ChallengeEntry entry =
                                (TeamDeathballGauntlet.ChallengeEntry)m_WorkingList[selection];
                            ...
                            if (m_gauntlet.Participants != null)
                            {
                                ...
                                foreach (
                                    TeamDeathballGauntlet.ChallengeEntry masterentry in m_gauntlet.Participants
                                )
                                {
                    ...
                    if (entry.Participant != null)
                    {
                        if (force || entry.Participant.HasGump(typeof(TeamDeathballGump)))
                        {
                            entry.Participant.SendGump(
                                new TeamDeathballGump(gauntlet, entry.Participant)
                            );
                        }
                    }
                }
            ...
            if (gauntlet.Challenger != null)
            {
                if (force || gauntlet.Challenger.HasGump(typeof(TeamDeathballGump)))
                {
                    gauntlet.Challenger.SendGump(
                        new TeamDeathballGump(gauntlet, gauntlet.Challenger)
                    );
                }
            }
        }
        ...
        private class MemberTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Mobile && ((Mobile)targeted).Player)
                {
                    ...
                    {
                        foreach (
                            TeamDeathballGauntlet.ChallengeEntry entry in m_gauntlet.Participants
                        )
                        {
