    ...
    public class KingOfTheHillGump : Gump
    {
            ...
            : base(20, 30)
        {
            ...
            if (gauntlet.Participants != null)
            {
                ...
                {
                    KingOfTheHillGauntlet.ChallengeEntry entry =
                        (KingOfTheHillGauntlet.ChallengeEntry)m_WorkingList[i];
            ...
            switch (info.ButtonID)
            {
                case 1:
                    ...
                    state.Mobile.SendGump(
                        new KingOfTheHillGump(m_gauntlet, state.Mobile, viewpage)
                    );
                    break;
                ...
                default:
                {
                    ...
                    if (info.ButtonID >= 4000)
                    {
                        ...
                        {
                            KingOfTheHillGauntlet.ChallengeEntry entry =
                                (KingOfTheHillGauntlet.ChallengeEntry)m_WorkingList[selection];
                            ...
                            if (m_gauntlet.Participants != null)
                            {
                                ...
                                foreach (
                                    KingOfTheHillGauntlet.ChallengeEntry masterentry in m_gauntlet.Participants
                                )
                                {
                    ...
                    if (entry.Participant != null && entry.Status != ChallengeStatus.Forfeit)
                    {
                        if (forced || entry.Participant.HasGump(typeof(KingOfTheHillGump)))
                        {
                            entry.Participant.SendGump(
                                new KingOfTheHillGump(gauntlet, entry.Participant)
                            );
                        }
                    }
                }
            ...
            if (gauntlet.Challenger != null)
            {
                if (forced || gauntlet.Challenger.HasGump(typeof(KingOfTheHillGump)))
                {
                    gauntlet.Challenger.SendGump(
                        new KingOfTheHillGump(gauntlet, gauntlet.Challenger)
                    );
                }
            }
        }
        ...
        private class MemberTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Mobile && ((Mobile)targeted).Player)
                {
                    ...
                    {
                        foreach (
                            KingOfTheHillGauntlet.ChallengeEntry entry in m_gauntlet.Participants
                        )
                        {
