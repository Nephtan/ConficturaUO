    ...
    public class TeamLMSGump : Gump
    {
            ...
            : base(20, 30)
        {
            ...
            if (gauntlet.Participants != null)
            {
                ...
                {
                    TeamLMSGauntlet.ChallengeEntry entry = (TeamLMSGauntlet.ChallengeEntry)
                        m_WorkingList[i];
                    ...
                    if (info.ButtonID >= 4000)
                    {
                        ...
                        if (selection < m_WorkingList.Count)
                        {
                            ...
                            if (m_gauntlet.Participants != null)
                            {
                                ...
                                foreach (
                                    TeamLMSGauntlet.ChallengeEntry masterentry in m_gauntlet.Participants
                                )
                                {
                    ...
                    if (entry.Participant != null)
                    {
                        if (force || entry.Participant.HasGump(typeof(TeamLMSGump)))
                        {
                            entry.Participant.SendGump(
                                new TeamLMSGump(gauntlet, entry.Participant)
                            );
                        }
                    }
                }
