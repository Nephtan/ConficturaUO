...
namespace Server.Engines.XmlSpawner2
{
    public class PortuguesePointsText
    {
        ...
        public static void Initialize()
        {
            ...
            Add(
                100303,
                "Impossiv�l realizar o desafio: {0}: Um outro desafio j� est� sendo realizado nesta �rea."
            );
            Add(
                100304,
                "Impossiv�l realizar o desafio: {0}: Deve ser realiado numa �rea de Desafios."
            );
            ...
            Add(
                100309,
                "Voc� est� fora dos limitas da arena!  Voc� tem {0} segundos para retornar."
            );
