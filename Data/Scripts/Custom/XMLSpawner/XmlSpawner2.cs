...
namespace Server.Mobiles
{
    public class XmlSpawner : Item, ISpawner
    {
        ...
        public class SpawnPositionInfo
        {
            ...
            public SpawnPositionInfo(
                SpawnPositionType positiontype,
                Mobile trigmob,
                string[] positionargs
            )
            {
                    ...
                    for (int x = x1; x <= x1 + width; x += Server.Map.SectorSize)
                    {
                        for (int y = y1; y <= y1 + height; y += Server.Map.SectorSize)
                        {
                            ...
                            if (!duplicate)
                            {
                                ...
                                {
                                    ArrayList spawnerlist = (ArrayList)
                                        GlobalSectorTable[Map.MapID][s];
                                    if (spawnerlist == null)
                                    {
                                ...
                                if (sectorList.Count > MaxSmartSectorListSize)
                                {
                                    ...
                                    {
                                        Console.WriteLine(
                                            "SmartSpawning disabled at {0} {1} : Range too large.",
                                            loc,
                                            Map
                                        );

                                        using (
                                            StreamWriter op = new StreamWriter("badspawn.log", true)
                                        )
                                        {
                                            op.WriteLine(
                                                "{0} SmartSpawning disabled at {1} {2} : Range too large.",
                                                DateTime.Now,
                                                loc,
                                                Map
                                            );
            ...
            get
            {
                ...
                foreach (BaseXmlSpawner.KeywordTag sot in m_KeywordTagList)
                {
                    ...
                    if (
                        sot != null
                        && !sot.Deleted
                        && ((sot.Flags & BaseXmlSpawner.KeywordFlags.HoldSpawn) != 0)
                    )
                    {
                        return true;
                    }
        ...
        public bool CanFreeSpawn
        {
            get
            {
                ...
                if (
                    ...
                    && (
                        m_MobPropertyName == null
                        || m_MobPropertyName.Length == 0
                        || m_MobTriggerName == null
            ...
            get
            {
                ...
                foreach (BaseXmlSpawner.KeywordTag sot in m_KeywordTagList)
                {
                    ...
                    if (
                        sot != null
                        && !sot.Deleted
                        && ((sot.Flags & BaseXmlSpawner.KeywordFlags.HoldSequence) != 0)
                    )
                    {
                        return true;
                    }
        ...
        */
        ...
        public string SkillTrigger
        {
            ...
            set
            {
                ...
                {
                    XmlSpawnerSkillCheck.UnRegisterSkillTrigger(
                        this,
                        m_SkillTriggerName,
                        this.Map,
                        false
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (acct != null)
            {
                XmlSpawnerDefaults.DefaultEntry defs = XmlSpawnerDefaults.GetDefaults(
                    acct.ToString(),
                    from.Name
                );
                if (defs != null)
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            if (m_SpawnObjects != null)
                for (int i = 0; i < nlist_items && i < m_SpawnObjects.Count; ++i)
                {
                    ...
                    list.Add(
                        1060658 + (6 - nlist_items) + i,
                        " {0}\t{1}",
                        typename,
                        ((SpawnObject)m_SpawnObjects[i]).SpawnedObjects.Count
                    );
                }
        }
        ...
        public static void ExecuteAction(object attachedto, Mobile trigmob, string action)
        {
            ...
            Server.Mobiles.XmlSpawner.SpawnObject TheSpawn =
                new Server.Mobiles.XmlSpawner.SpawnObject(null, 0);

            TheSpawn.TypeName = action;
            string substitutedtypeName = BaseXmlSpawner.ApplySubstitution(
                null,
                attachedto,
                trigmob,
                action
        ...
        private static void RemoveFromSectorTable(Sector s, XmlSpawner spawner)
        {
            if (
                s == null
                || s.Owner == null
                || s.Owner == Map.Internal
                || GlobalSectorTable[s.Owner.MapID] == null
            )
                return;
                    ...
                    if (ds.Tables[XmlTableName] != null && ds.Tables[XmlTableName].Rows.Count > 0)
                    {
                        foreach (DataRow dr in ds.Tables[XmlTableName].Rows)
                        {
                            ...
                            if (valid_entry)
                            {
                                ...
                                m_ObjectPropertyItem = BaseXmlSpawner.FindItemByName(
                                    this,
                                    namestr,
                                    typestr
                                );
                            ...
                            if (valid_entry)
                            {
                                ...
                                m_SetPropertyItem = BaseXmlSpawner.FindItemByName(
                                    this,
                                    namestr,
                                    typestr
                                );
                            ...
                            try
                            {
                                Spawns = SpawnObject.LoadSpawnObjectsFromString2(
                                    (string)dr["Objects2"]
                                );
                            }
                            catch
                            ...
                            if (!havenew)
                            {
                                ...
                                try
                                {
                                    Spawns = SpawnObject.LoadSpawnObjectsFromString(
                                        (string)dr["Objects"]
                                    );
                                }
                                catch
        ...
        public void ReportStatus()
        {
            ...
            Console.WriteLine("Lodor");
            for (int i = 0; i < XmlSpawnerSkillCheck.RegisteredSkill.MaxSkills + 1; i++)
            {
                if (
                    XmlSpawnerSkillCheck.RegisteredSkill.TriggerList((SkillName)i, Map.Lodor).Count
                    > 0
                )
                    Console.WriteLine(
                        "\t{0} : {1}",
        ...
        private bool ValidPlayerTrig(Mobile m)
        {
            if (m == null || m.Deleted)
                return false;
            return (
                (m.Player || m_AllowNPCTriggering)
                && (m.AccessLevel <= TriggerAccessLevel)
                && (
        ...
        {
            get { return m_Running && !m_refractActivated && TODInRange && CanSpawn; }
        }
        ...
        public void CheckTriggers(Mobile m, Skill s, bool hasproximity)
        {
            ...
            if (AllowTriggering && !m_proximityActivated)
            {
                ...
                if (m_ObjectPropertyName != null && m_ObjectPropertyName.Length > 0)
                {
                    ...
                    if (
                        BaseXmlSpawner.TestItemProperty(
                            this,
                            m_ObjectPropertyItem,
                            m_ObjectPropertyName,
                            null,
                            out status_str
                        )
                    )
                ...
                if (m_PlayerPropertyName != null && m_PlayerPropertyName.Length > 0)
                {
                    ...
                    if (
                        BaseXmlSpawner.TestMobProperty(
                            this,
                            m,
                            m_PlayerPropertyName,
                            null,
                            out status_str
                        )
                    )
                ...
                if (Utility.RandomDouble() < m_TriggerProbability)
                {
                    ...
                    if (
                        m_ProximityTriggerMessage != null
                        && m_ProximityTriggerMessage.Length > 0
                        && m != null
                        && !m.Deleted
                    )
        ...
        {
            get { return (m_Running && m_SkillTrigger != null && m_SkillTrigger.Length > 0); }
        }
        ...
        {
            get { return (m_Running && m_SpeechTrigger != null && m_SpeechTrigger.Length > 0); }
        }
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            )
            {
                ...
                if (
                    m_SpeechTrigger != null
                    && e.Speech.ToLower().IndexOf(m_SpeechTrigger.ToLower()) >= 0
                )
                {
                    e.Handled = true;
        ...
        {
            get { return (m_Running && m_ProximityRange >= 0); }
        }
        ...
        private class MovementTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                if (m_Spawner != null && !m_Spawner.Deleted)
                {
                    if (
                        m_Spawner.m_Running
                        && !m_Spawner.m_proximityActivated
                        && !m_Spawner.m_refractActivated
                        && m_Spawner.TODInRange
                        && m_Spawner.CanSpawn
                    )
                    {
                        int count = 0;
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            if (m_Running && m_ProximityRange >= 0 && ValidPlayerTrig(m) && CanSpawn)
            {
                ...
                if (
                    (this.Parent == null)
                    && Utility.InRange(m.Location, this.Location, m_ProximityRange)
                )
                {
        ...
        public static bool AssignSettings(string argname, string value)
        {
            switch (argname)
            {
                ...
                case "SmartSpawnAccessLevel":
                    SmartSpawnAccessLevel = (AccessLevel)
                        Enum.Parse(typeof(AccessLevel), value, true);
                    break;
                case "XmlConfigsDir":
                    XmlConfigsDir = value;
                    break;
                ...
                case "ChangeCommand":
                    ...
                    Timer.DelayCall(
                        TimeSpan.Zero,
                        new TimerStateCallback(DelayedAssignSettings),
                    ...
                    if (split.Length >= 2)
                    {
                        ...
                        try
                        {
                            if (settingshandler(argname, value))
                                ...
                                Console.WriteLine(
                                    "'{0}' setting is invalid in section [{1}]",
                                    argname,
                                    currentsection
                                );
                        }
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register(
                "XmlSpawnerLoad",
                DiskAccessLevel,
                new CommandEventHandler(Load_OnCommand)
            );
            CommandSystem.Register(
                "XmlSpawnerSave",
                DiskAccessLevel,
                new CommandEventHandler(Save_OnCommand)
            );
            CommandSystem.Register(
                "XmlSpawnerSaveAll",
                DiskAccessLevel,
                new CommandEventHandler(SaveAll_OnCommand)
            );
            //added respawn commands
            CommandSystem.Register(
                "XmlSpawnerRespawn",
                AccessLevel.GameMaster,
                new CommandEventHandler(Respawn_OnCommand)
            );
            CommandSystem.Register(
            ...
            CommandSystem.Register(
                "XmlHome",
                AccessLevel.GameMaster,
                new CommandEventHandler(XmlHome_OnCommand)
            );
            CommandSystem.Register(
                "XmlUnLoad",
                DiskAccessLevel,
                new CommandEventHandler(UnLoad_OnCommand)
            );
            CommandSystem.Register(
                "XmlSpawnerUnLoad",
                DiskAccessLevel,
            ...
            CommandSystem.Register(
                "XmlLoadHere",
                DiskAccessLevel,
                new CommandEventHandler(LoadHere_OnCommand)
            );
            CommandSystem.Register(
                "XmlNewLoad",
                DiskAccessLevel,
                new CommandEventHandler(NewLoad_OnCommand)
            );
            CommandSystem.Register(
                "XmlNewLoadHere",
                DiskAccessLevel,
                new CommandEventHandler(NewLoadHere_OnCommand)
            );
            CommandSystem.Register(
                "XmlSave",
                DiskAccessLevel,
            ...
            CommandSystem.Register(
                "XmlSaveOld",
                DiskAccessLevel,
                new CommandEventHandler(SaveOld_OnCommand)
            );
            CommandSystem.Register(
                "XmlImportSpawners",
                DiskAccessLevel,
            ...
            CommandSystem.Register(
                "XmlImportMSF",
                DiskAccessLevel,
                new CommandEventHandler(XmlImportMSF_OnCommand)
            );
            CommandSystem.Register(
                "XmlImportMap",
                DiskAccessLevel,
                new CommandEventHandler(XmlImportMap_OnCommand)
            );
            CommandSystem.Register(
                "XmlDefaults",
                AccessLevel.Administrator,
            ...
            CommandSystem.Register(
                "XmlGet",
                AccessLevel.GameMaster,
                new CommandEventHandler(XmlGetValue_OnCommand)
            );
            ...
            CommandSystem.Register(
                "SmartStat",
                AccessLevel.GameMaster,
                new CommandEventHandler(SmartStat_OnCommand)
            );
            CommandSystem.Register(
                "XmlGo",
                AccessLevel.GameMaster,
                new CommandEventHandler(SpawnEditorGo_OnCommand)
            );
            ...
            CommandSystem.Register(
                "XmlMake",
                AccessLevel.Administrator,
                new CommandEventHandler(XmlMake_OnCommand)
            );
            CommandSystem.Register(
                "XmlTrace",
                AccessLevel.Administrator,
                new CommandEventHandler(XmlTrace_OnCommand)
            );
            CommandSystem.Register(
                "XmlResetTrace",
                AccessLevel.Administrator,
                new CommandEventHandler(XmlResetTrace_OnCommand)
            );
#endif
        }
        ...
        public class XmlSetCommand : BaseCommand
        {
            ...
            public override void Execute(CommandEventArgs e, object obj)
            {
                if (e.Length >= 2)
                {
                    string result = BaseXmlSpawner.SetPropertyValue(
                        null,
                        obj,
                        e.GetString(0),
                        e.GetString(1)
        ...
        private static void LoadDefaults(XmlElement node)
        {
            ...
            try
            {
                XmlSpawner.defTriggerProbability = double.Parse(
                    node["defTriggerProbability"].InnerText
                );
            }
            catch { }
            try
            {
                XmlSpawner.defProximityTriggerSound = int.Parse(
                    node["defProximityTriggerSound"].InnerText
                );
            }
            catch { }
            try
            ...
            if (e.Arguments.Length >= 1)
            {
                ...
                if (e.Arguments.Length == 2)
                {
                    ...
                    if (e.Arguments[0].ToLower() == "maxdelay")
                    {
                        try
                        {
                            XmlSpawner.defMaxDelay = TimeSpan.FromMinutes(
                                Convert.ToDouble(e.Arguments[1])
                            );
                    ...
                    else if (e.Arguments[0].ToLower() == "mindelay")
                    {
                        try
                        {
                            XmlSpawner.defMinDelay = TimeSpan.FromMinutes(
                                Convert.ToDouble(e.Arguments[1])
                            );
                    ...
                    else if (e.Arguments[0].ToLower() == "proximitytriggersound")
                    {
                        try
                        {
                            ...
                            m.SendMessage(
                                "ProximityTriggerSound = {0}",
                                XmlSpawner.defProximityTriggerSound
                            );
                        }
                        catch
                        {
                    ...
                    else if (e.Arguments[0].ToLower() == "triggerprobability")
                    {
                        try
                        {
                            ...
                            m.SendMessage(
                                ...
                                XmlSpawner.defTriggerProbability
                            );
                        }
                        catch
                        {
                    ...
                    else if (e.Arguments[0].ToLower() == "todstart")
                    {
                        try
                        {
                            XmlSpawner.defTODStart = TimeSpan.FromMinutes(
                                Convert.ToDouble(e.Arguments[1])
                            );
                    ...
                    else if (e.Arguments[0].ToLower() == "todend")
                    {
                        try
                        {
                            XmlSpawner.defTODEnd = TimeSpan.FromMinutes(
                                Convert.ToDouble(e.Arguments[1])
                            );
                    ...
                    else if (e.Arguments[0].ToLower() == "duration")
                    {
                        try
                        {
                            XmlSpawner.defDuration = TimeSpan.FromMinutes(
                                Convert.ToDouble(e.Arguments[1])
                            );
                    ...
                    else if (e.Arguments[0].ToLower() == "maxrefractory")
                    {
                        try
                        {
                            XmlSpawner.defMaxRefractory = TimeSpan.FromMinutes(
                                Convert.ToDouble(e.Arguments[1])
                            );
                    ...
                    else if (e.Arguments[0].ToLower() == "minrefractory")
                    {
                        try
                        {
                            XmlSpawner.defMinRefractory = TimeSpan.FromMinutes(
                                Convert.ToDouble(e.Arguments[1])
                            );
        ...
        public static void ShowSpawnPoints_OnCommand(CommandEventArgs e)
        {
            ...
            foreach (Item i in ToShow)
            {
                ...
                if (
                    (
                        xml_item.m_ShowContainerStatic == null
                        || xml_item.m_ShowContainerStatic.Deleted
                    )
        ...
        [Aliases("XmlHide")]
        [Description(
            "Makes all XmlSpawner objects invisible and unmovable returns the object id to the default."
        )]
        ...
        [Description(
            "Go command used with spawn editor, takes the name of the map as the first parameter."
        )]
        private static void SpawnEditorGo_OnCommand(CommandEventArgs e)
        {
            ...
            if (from != null && e.Length >= 1)
            {
                ...
                // Convert the xml map value to a real map object
                if (string.Compare(MapName, Map.Sosaria.Name, true) == 0)
                    NewMap = Map.Sosaria;
                else if (string.Compare(MapName, Map.Lodor.Name, true) == 0)
                    NewMap = Map.Lodor;
                else if (string.Compare(MapName, Map.Underworld.Name, true) == 0)
                    NewMap = Map.Underworld;
                else if (string.Compare(MapName, Map.SerpentIsland.Name, true) == 0)
        ...
        public static void SmartStat_OnCommand(CommandEventArgs e)
        {
            ...
            if (
                ...
                && e.Arguments[0].ToLower() == "accesslevel"
            ...
            )
            {
                ...
                {
                    SmartSpawnAccessLevel = (AccessLevel)
                        Enum.Parse(typeof(AccessLevel), e.Arguments[1], true);
                }
                catch { }
            }
            // handle the
        ...
        [Description(
            "Activates SmartSpawning on XmlSpawners that are well-suited for use of this feature."
        )]
        public static void OptimalSmartSpawning_OnCommand(CommandEventArgs e)
        {
            ...
            foreach (Item item in World.Items.Values)
            {
                if (item is XmlSpawner)
                {
                    ...
                    if (
                        spawner.HomeRange * 2 > width + maxdiff * 2
                        || spawner.HomeRange * 2 > height + maxdiff * 2 && spawner.m_Region != null
                    )
                        continue;
                    ...
                    for (int i = 0; i < nso; ++i)
                    {
                        ...
                        if (
                            ...
                            || (
                                type != null
                                && (
                                    type == typeof(BaseVendor)
                                    || type.IsSubclassOf(typeof(BaseVendor))
                                )
                            )
                            || (
                                (type == null)
            ...
            e.Mobile.SendMessage(
                "Configured {0} XmlSpawners for SmartSpawning using maxdiff of {1}",
                count,
                maxdiff
            );
        ...
        )
        {
            ...
            if (System.IO.Directory.Exists(filename) == true)
            {
                ...
                if (files != null && files.Length > 0)
                {
                    if (from != null)
                        from.SendMessage(
                            "UnLoading {0} .xml files from directory {1}",
                            files.Length,
                            filename
                        );
        ...
        )
        {
            ...
            if (ds.Tables != null && ds.Tables.Count > 0)
            {
                ...
                if (
                    ds.Tables[SpawnTablePointName] != null
                    && ds.Tables[SpawnTablePointName].Rows.Count > 0
                )
                {
                    foreach (DataRow dr in ds.Tables[SpawnTablePointName].Rows)
                    {
                        ...
                        )
                        {
                            ...
                            // Convert the xml map value to a real map object
                            if (
                                string.Compare(XmlMapName, Map.Sosaria.Name, true) == 0
                                || XmlMapName == "Sosaria"
                            )
                            {
                                SpawnMap = Map.Sosaria;
                                SosariaCount++;
                            }
                            else if (
                                string.Compare(XmlMapName, Map.Lodor.Name, true) == 0
                                || XmlMapName == "Lodor"
                            )
                            {
                                SpawnMap = Map.Lodor;
                                ...
                                string.Compare(XmlMapName, Map.Underworld.Name, true) == 0
                                || XmlMapName == "Underworld"
                            )
                            {
                                SpawnMap = Map.Underworld;
                                UnderworldCount++;
                            }
                            else if (
                                string.Compare(XmlMapName, Map.SerpentIsland.Name, true) == 0
                                || XmlMapName == "SerpentIsland"
                            )
                            {
                                SpawnMap = Map.SerpentIsland;
                                SerpentIslandCount++;
                            }
                            else if (
                                string.Compare(XmlMapName, Map.IslesDread.Name, true) == 0
                                || XmlMapName == "IslesDread"
                            )
                            {
                            ...
                            foreach (Item i in World.Items.Values)
                            {
                                if (i is XmlSpawner)
                                {
                                    ...
                                    if (
                                        (CheckXmlSpawner.UniqueId == SpawnId.ToString())
        ...
        [Aliases("XmlUnload")]
        [Description(
            "UnLoads XmlSpawner objects from the proper map as defined in the file supplied."
        )]
        ...
        public static void XmlImportMap(
            string filename,
            Mobile from,
            out int processedmaps,
            out int processedspawners
        )
        {
            ...
            if (System.IO.Directory.Exists(filename) == true)
            {
                ...
                {
                    from.SendMessage(
                        "Importing {0} .map files from directory {1}",
                        files.Length,
                        filename
                    );
                    foreach (string file in files)
        ...
        )
        {
            ...
            if (args.Length > 0 && (args[0] == "*"))
            {
                ...
                if (!badspawn && totalspawns > 0)
                {
                    ...
                    string spawnername = String.Format(
                        "{0}#{1}",
        ...
        public static void XmlImportSpawners_OnCommand(CommandEventArgs e)
        {
            if (e.Arguments.Length >= 1)
            {
                ...
                if (File.Exists(filePath))
                {
                    ...
                    e.Mobile.SendMessage(
                        "{0} spawners loaded successfully from {1}, {2} failures.",
                        successes,
                        filePath,
                        failures
                    );
                ...
                */
                ...
                if (File.Exists(filePath))
                {
                    ...
                    if (root != null)
                    {
                        ...
                        e.Mobile.SendMessage(
                            "{0} megaspawners loaded successfully from {1}, {2} failures.",
                            successes,
                            filePath,
                            failures
                        );
        ...
        private static void ImportMegaSpawner(Mobile from, XmlElement node)
        {
            ...
            if (listnode != null)
            {
                ...
                if (nentries > 0)
                {
                        ...
                        if (entrynode != null)
                        {
                            if (entrycount == 0)
                            {
                                ...
                                maxDelay = TimeSpan.FromSeconds(
                                    int.Parse(GetText(entrynode["MaxDelay"], "10:00"))
                                );
                                minDelay = TimeSpan.FromSeconds(
                                    int.Parse(GetText(entrynode["MinDelay"], "05:00"))
                                );
                            ...
                            else
                            {
                                ...
                                if (group != bool.Parse(GetText(entrynode["GroupSpawn"], "False")))
                                {
                                    ...
                                    {
                                        using (
                                            StreamWriter op = new StreamWriter(
                                                "badimport.log",
                                                true
                                            )
                                        )
                            ...
                            if (entrycount > nentries)
                            {
                                ...
                                {
                                    using (
                                        StreamWriter op = new StreamWriter("badimport.log", true)
                                    )
                                    {
                                        op.WriteLine(
                                            "{0} MSFImport Error; inconsistent entry count {1} {2}",
                                            DateTime.Now,
                                            location,
                                            map
                                        );
                                ...
                                from.SendMessage(
                                    "Inconsistent entry count detected at {0} {1}.",
                                    location,
                                    map
                                );
                                break;
                    ...
                    {
                        from.SendMessage(
                            "Individual entry setting detected at {0} {1}.",
                            location,
                            map
                        );
                        // log it
        ...
        )
        {
            ...
            if (System.IO.Directory.Exists(filename) == true)
            {
                ...
                if (files != null && files.Length > 0)
                {
                    if (from != null)
                        from.SendMessage(
                            "Loading {0} .xml files from directory {1}",
                            files.Length,
                            filename
                        );
                    foreach (string file in files)
        ...
        )
        {
                ...
                if (
                    ...
                    foreach (DataRow dr in ds.Tables[SpawnTablePointName].Rows)
                    {
                        ...
                        )
                        {
                            ...
                            if (
                                loadrelative
                                && (Math.Abs(relativex - SpawnCentreX) <= maxrange)
                            ...
                            try
                            {
                                SpawnIsRelativeHomeRange = bool.Parse(
                                    (string)dr["IsHomeRangeRelative"]
                                );
                            }
                            catch { }
                            ...
                            if (delay_in_sec)
                            {
                                try
                                {
                                    SpawnMinDelay = TimeSpan.FromSeconds(
                                        int.Parse((string)dr["MinDelay"])
                                    );
                                }
                                catch { }
                                try
                                {
                                    SpawnMaxDelay = TimeSpan.FromSeconds(
                                        int.Parse((string)dr["MaxDelay"])
                                    );
                                }
                                catch { }
                            }
                            else
                            {
                                try
                                {
                                    SpawnMinDelay = TimeSpan.FromMinutes(
                                        int.Parse((string)dr["MinDelay"])
                                    );
                                }
                                catch { }
                                try
                                {
                                    SpawnMaxDelay = TimeSpan.FromMinutes(
                                        int.Parse((string)dr["MaxDelay"])
                                    );
                                }
                                catch { }
                            ...
                            try
                            {
                                SpawnMinRefractory = TimeSpan.FromMinutes(
                                    double.Parse((string)dr["MinRefractory"])
                                );
                            }
                            catch { }
                            ...
                            try
                            {
                                SpawnMaxRefractory = TimeSpan.FromMinutes(
                                    double.Parse((string)dr["MaxRefractory"])
                                );
                            }
                            catch { }
                            ...
                            try
                            {
                                SpawnTODStart = TimeSpan.FromMinutes(
                                    double.Parse((string)dr["TODStart"])
                                );
                            }
                            catch { }
                            ...
                            try
                            {
                                SpawnTODEnd = TimeSpan.FromMinutes(
                                    double.Parse((string)dr["TODEnd"])
                                );
                            }
                            catch { }
                            ...
                            try
                            {
                                SpawnTriggerProbability = double.Parse(
                                    (string)dr["TriggerProbability"]
                                );
                            }
                            catch { }
                            ...
                            try
                            {
                                SpawnSequentialSpawning = int.Parse(
                                    (string)dr["SequentialSpawning"]
                                );
                            }
                            catch { }
                            ...
                            try
                            {
                                SpawnDuration = TimeSpan.FromMinutes(
                                    double.Parse((string)dr["Duration"])
                                );
                            }
                            catch { }
                            ...
                            try
                            {
                                SpawnDespawnTime = TimeSpan.FromHours(
                                    double.Parse((string)dr["DespawnTime"])
                                );
                            }
                            catch { }
                            ...
                            try
                            {
                                SpawnProximityTriggerSound = int.Parse(
                                    (string)dr["ProximityTriggerSound"]
                                );
                            }
                            catch { }
                            ...
                            try
                            {
                                SpawnExternalTriggering = bool.Parse(
                                    (string)dr["ExternalTriggering"]
                                );
                            }
                            catch { }
                            ...
                            if (!IsValidMapLocation(SpawnCentreX, SpawnCentreY, SpawnMap))
                            {
                                if (from != null)
                                    from.SendMessage(
                                        33,
                                        "Invalid location '{0}' at [{1} {2}] in {3}",
                                        SpawnName,
                                        SpawnCentreX,
                                        SpawnCentreY,
                                        XmlMapName
                            ...
                            if (!bad_spawner)
                            {
                                foreach (Item i in World.Items.Values)
                                {
                                    ...
                                    if (
                                        ...
                                        && !found_container
                                        && (i is Container)
                                        && (SpawnCentreX == i.Location.X)
                                        && (SpawnCentreY == i.Location.Y)
                                        && (
                                            SpawnCentreZ == i.Location.Z
                                            || SpawnCentreZ == short.MinValue
                                        )
                                    )
                                    {
                            ...
                            if (bad_spawner)
                            {
                                ...
                                try
                                {
                                    ...
                                    {
                                        op.WriteLine(
                                            "# Invalid spawner : {0}: Fileposition {1} {2}",
                                            DateTime.Now,
                                            fileposition,
                                            filename
                                        );
                            ...
                            else if (questionable_spawner)
                            {
                                ...
                                if (from != null)
                                    from.SendMessage(
                                        33,
                                        "Questionable spawner '{0}' at [{1} {2}] in {3}",
                                        SpawnName,
                                        SpawnCentreX,
                                        SpawnCentreY,
                                        XmlMapName
                            ...
                            if (!bad_spawner)
                            {
                                ...
                                if (
                                    found_container
                                    && (spawn_container != null)
                                    && !spawn_container.Deleted
                                )
                                {
                                    TheSpawn.Location = (
                                        new Point3D(ContainerX, ContainerY, ContainerZ)
                                    );
                                ...
                                else
                                {
                                    ...
                                    TheSpawn.MoveToWorld(
                                        new Point3D(SpawnCentreX, SpawnCentreY, NewZ),
                                        SpawnMap
                                    );
                                }
                    ...
                    foreach (DataRow dr in ds.Tables[SpawnTablePointName].Rows)
                    {
                        ...
                        if (found_spawner && OldSpawner != null && !OldSpawner.Deleted)
                        {
                            ...
                            if (setObjectName != null && setObjectName.Length > 0)
                            {
                                ...
                                if (loadnew)
                                {
                                    string tmpsetObjectName = String.Format(
                                        "{0}-{1}",
                                        namestr,
                                        newloadid
                                    );
                                    OldSpawner.m_SetPropertyItem = BaseXmlSpawner.FindItemByName(
                                        null,
                                        tmpsetObjectName,
                                        typestr
                                    );
                                ...
                                if (OldSpawner.m_SetPropertyItem == null)
                                {
                                    ...
                                    {
                                        using (
                                            StreamWriter op = new StreamWriter("badxml.log", true)
                                        )
                                        {
                                            op.WriteLine(
                            ...
                            if (triggerObjectName != null && triggerObjectName.Length > 0)
                            {
                                ...
                                if (loadnew)
                                {
                                    string tmptriggerObjectName = String.Format(
                                        "{0}-{1}",
                                        namestr,
                                        newloadid
                                    );
                                    OldSpawner.m_ObjectPropertyItem = BaseXmlSpawner.FindItemByName(
                                        null,
                                        tmptriggerObjectName,
                                        typestr
                                    );
                                }
                                // if this fails then try the original
            ...
            if (failedobjectitemcount > 0)
            {
                if (from != null)
                    from.SendMessage(
                        33,
                        "Failed to initialize TriggerObjects in {0} spawners. Saved to 'badxml.log'",
                        failedobjectitemcount
                    );
            }
            ...
            if (badcount > 0)
            {
                if (from != null)
                    from.SendMessage(
                        33,
                        "{0} bad spawners detected. Saved to 'badxml.log'",
                        badcount
                    );
            }
            if (questionablecount > 0)
            {
                if (from != null)
                    from.SendMessage(
                        33,
                        "{0} questionable spawners detected. Saved to 'badxml.log'",
                        questionablecount
                    );
            }
            processedmaps = 1;
        ...
        public static void NewLoad_OnCommand(CommandEventArgs e)
        {
            if (e.Mobile.AccessLevel >= DiskAccessLevel)
            {
                if (e.Arguments.Length >= 1)
                {
                    ...
                    e.Mobile.SendMessage(
                        "Usage:  {0} <SpawnFile or directory> [SpawnerPrefixFilter]",
                        e.Command
                    );
            }
            else
        ...
        public static void NewLoadHere_OnCommand(CommandEventArgs e)
        {
            if (e.Mobile.AccessLevel >= DiskAccessLevel)
            {
                if (e.Arguments.Length >= 1)
                {
                    ...
                    {
                        e.Mobile.SendMessage(
                            "Usage:  {0} <SpawnFile or directory> [SpawnerPrefixFilter][-maxrange range]",
                            e.Command
                        );
                        badargs = true;
                    }
        ...
        private static void SaveSpawns(CommandEventArgs e, bool SaveAllMaps, bool oldformat)
        {
            ...
            foreach (Item i in World.Items.Values)
            {
                if (
                    i is XmlSpawner
                    && !i.Deleted
                    && ((SaveAllMaps == true) || (i.Map == e.Mobile.Map))
        ...
        )
        {
            ...
            foreach (XmlSpawner sp in savelist)
            {
                ...
                // Convert the xml map value to a real map object
                if (string.Compare(sp.Map.Name, Map.Sosaria.Name, true) == 0)
                    SosariaCount++;
                else if (string.Compare(sp.Map.Name, Map.Lodor.Name, true) == 0)
                    LodorCount++;
                else if (string.Compare(sp.Map.Name, Map.Underworld.Name, true) == 0)
                    UnderworldCount++;
                else if (string.Compare(sp.Map.Name, Map.SerpentIsland.Name, true) == 0)
                    SerpentIslandCount++;
                ...
                if (
                    ((int)sp.m_MinDelay.TotalSeconds - 60 * (int)sp.m_MinDelay.TotalMinutes) > 0
                ...
                {
                    if (
                        (sp.m_WayPoint.Name != defwaypointname)
                        && (sp.m_WayPoint.Name != null)
        ...
        private static void WipeSpawners(CommandEventArgs e, bool WipeAll)
        {
            ...
            if (e.Mobile.AccessLevel >= AccessLevel.Administrator)
            {
                ...
                foreach (Item i in World.Items.Values)
                {
                    if (
                        (i is XmlSpawner)
                        && (WipeAll == true || i.Map == e.Mobile.Map)
                        && (i.Deleted == false)
                    )
                    {
                ...
                if (WipeAll == true)
                    ...
                    e.Mobile.SendMessage(
                        "Removed {0} XmlSpawner objects from {1}.",
                        Count,
                        e.Mobile.Map
                    );
            }
            ...
            if (e.Mobile.AccessLevel >= AccessLevel.Administrator)
            {
                ...
                foreach (Item i in World.Items.Values)
                {
                    try
                    {
                        if (
                            (i is XmlSpawner)
                            && (RespawnAll == true || i.Map == e.Mobile.Map)
                            && (i.Deleted == false)
                        )
                        {
                ...
                if (RespawnAll == true)
                    ...
                    e.Mobile.SendMessage(
                        "Respawned {0} XmlSpawner objects from {1}.",
                        Count,
                        e.Mobile.Map
                    );
            }
            ...
            if (e.Arguments.Length > 0)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    if (e.Arguments.Length > 2)
                    {
                        ...
                        x.Location = new Point3D(
                            5400 + Utility.Random(700),
                            1090 + Utility.Random(180),
                            0
                        );
                        x.Map = Map.Sosaria;
                    }
        ...
        public static void XmlTrace_OnCommand(CommandEventArgs e)
        {
            ...
            double processtime =
                currentprocess.UserProcessorTime.TotalMilliseconds - _startProcessTime;
            double sysload = 0;
            ...
            Console.WriteLine(
                "Processor Time = {0} ({1:p3} avg sys load)",
            ...
            for (int i = 0; i < MaxTraces; i++)
            {
                if (XmlSpawner._traceCount[i] > 0)
                {
                    ...
                    Console.WriteLine(
                        ...
                        i,
                        XmlSpawner._traceTotal[i],
                        XmlSpawner._traceCount[i],
                        ((double)XmlSpawner._traceTotal[i].TotalMilliseconds)
                            / XmlSpawner._traceCount[i],
                        XmlSpawner._traceName[i],
                        load
                    );
                }
            }
            ...
            foreach (SpawnObject so in m_SpawnObjects)
            {
                for (int x = 0; x < so.SpawnedObjects.Count; x++)
                {
                    ...
                    if (o is Item)
                    {
                        ...
                        if (
                            DespawnTime.TotalHours > 0
                            && !item.Deleted
                            && (item.LastMoved < DateTime.Now - DespawnTime)
                            && (item.Parent == this.Parent)
                            && (
                                !ItemFlags.GetTaken(item)
                                || (item.Parent != null && (item.Parent == this.Parent))
                            )
                        ...
                        if (
                            item.Deleted
                            || despawned
                            || (item.Parent != this.Parent) // different container
                            || (
                                ItemFlags.GetTaken(item)
                                && (item.Parent == null || (item.Parent != this.Parent))
                            )
                    ...
                    else if (o is Mobile)
                    {
                        ...
                        if (
                            DespawnTime.TotalHours > 0
                            && !m.Deleted
                            && (m.CreationTime < DateTime.Now - DespawnTime)
                            && m.Map != null
                            && m.Map != Map.Internal
                        ...
                        else if (m is BaseCreature)
                        {
                            ...
                            if (
                                b.Controlled
                                || b.IsStabled
                                || (b.Owners != null && b.Owners.Count > 0)
                            )
                            {
                                so.SpawnedObjects.Remove(o);
                                x--;
        ...
        private int RandomAvailableSpawnIndex(int sgroup)
        {
            ...
            for (int i = 0; i < m_SpawnObjects.Count; i++)
            {
                ...
                if (
                    (s.MaxCount > s.SpawnedObjects.Count)
                    && (sgroup < 0 || sgroup == s.SubGroup)
        ...
        public bool Spawn(bool smartspawn)
        {
            if (
                ...
                && (m_proximityActivated || CanFreeSpawn)
                && TODInRange
            )
            {
        ...
        )
        {
            ...
            {
                if (
                    ((SpawnObject)m_SpawnObjects[i]).TypeName.ToUpper()
                    == SpawnObjectTypeName.ToUpper()
                )
                {
        ...
        )
        {
            ...
            if (TheSpawn != null)
            {
                ...
                if (
                    (CurrentCreatureCount >= CurrentCreatureMax) || (TotalSpawnedObjects >= m_Count)
                )
                {
                    return false;
                }
                ...
                while (substitutedtypeName.StartsWith("#"))
                {
                    ...
                    if (args.Length > 0)
                    {
                        ...
                        if (keyvalueargs.Length > 0)
                        {
                            ...
                            {
                                case "#NOTILES":
                                    spawnpositioning.Add(
                                        new SpawnPositionInfo(
                                            SpawnPositionType.NoTiles,
                                            m_mob_who_triggered,
                                            keyvalueargs
                                        )
                                    );
                                ...
                                case "#DXY":
                                    spawnpositioning.Add(
                                        new SpawnPositionInfo(
                                            SpawnPositionType.DeltaLocation,
                                            m_mob_who_triggered,
                                            keyvalueargs
                                        )
                                    );
                                ...
                                case "#CONDITION":
                                    ...
                                    string[] ckeyvalueargs = BaseXmlSpawner.ParseCommaArgs(
                                        args[0],
                                        2
                                    );
                                    if (ckeyvalueargs.Length > 1)
                                    {
                                        ...
                                        if (
                                            !BaseXmlSpawner.CheckPropertyString(
                                                this,
                                                this,
                                                ckeyvalueargs[1],
                                                m_mob_who_triggered,
                                    ...
                                    {
                                        this.status_str =
                                            "invalid #CONDITION specification: " + args[0];
                                    }
                                    break;
                                default:
                ...
                else
                {
                    ...
                    if (
                        ...
                        && !(
                            this.Parent != null
                            && (type == typeof(Mobile) || type.IsSubclassOf(typeof(Mobile)))
                        )
                    )
                    {
                        string[] arglist = BaseXmlSpawner.ParseString(substitutedtypeName, 3, "/");
            ...
            for (int i = 0; i < spawner.m_SpawnObjects.Count; i++)
            {
                ...
                if (((SpawnObject)spawner.m_SpawnObjects[i]).SubGroup == sgroup)
                {
                    ...
                    if (((SpawnObject)spawner.m_SpawnObjects[i]).SpawnedObjects.Count > 0)
                    {
                        for (
                            int j = 0;
                            j < ((SpawnObject)spawner.m_SpawnObjects[i]).SpawnedObjects.Count;
                            j++
                        )
        ...
        )
        {
            ...
            {
                Console.WriteLine(
                    "fitting mob {0} checkmob={1} swim={2} walk={3}",
                    mob,
                    checkmob,
                    canswim,
                    cantwalk
            ...
            {
                Console.WriteLine(
                    "landtile at {0},{1},{2} lowZ={3} avgZ={4} topZ={5}",
                    x,
                    y,
                    z,
                    lowZ,
            ...
            {
                Console.WriteLine(
                    "landtile at {0},{1},{2} wet={3} impassable={4} hassurface={5}",
                    x,
                    y,
                    z,
                    wet,
            ...
            for (int i = 0; i < staticTiles.Length; ++i)
            {
                ...
                if (
                    (surface || impassable)
                    && (staticTiles[i].Z + id.CalcHeight) > z
                    && (z + height) > staticTiles[i].Z
                )
                    return false;
            ...
            for (int i = 0; i < items.Count; ++i)
            {
                ...
                if (item.ItemID < 0x4000 && item.AtWorldPoint(x, y))
                {
                    ...
                    if (
                        (surface || impassable || (checkBlocksFit && item.BlocksFit))
                        && (item.Z + id.CalcHeight) > z
                        && (z + height) > item.Z
                    )
                        return false;
                    else if (
            ...
            {
                Console.WriteLine(
                    "return requiresurface={0} hassurface={1}",
                    requireSurface,
                    hasSurface
                );
            }
            ...
            for (int x = startx; x <= startx + width; x++)
            {
                for (int y = starty; y <= starty + height; y++)
                {
                    ...
                    for (int i = 0; i < statictiles.Length; ++i)
                    {
                        ...
                        if (includetilelist != null && includetilelist.Count > 0)
                        {
                            includetile = includetilelist.Contains(
        ...
        )
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                else if (m_Region != null && HasRegionPoints(m_Region)) // 2004.02.08 :: Omega Red
                {
                    ...
                    if (
                        includetilelist != null
                        || excludetilelist != null
                        || tileflag != TileFlag.None
                    )
                    {
        ...
        public void DeleteSpawnObject(Mobile from, string SpawnObjectName)
        {
            ...
            try
            {
                ...
                if (TheSpawn != null)
                {
                    ...
                    while (
                        TheSpawn.SpawnedObjects != null
                        && TheSpawn.SpawnedObjects.Count > 0
...
#if(RESTRICTCONSTRUCTABLE)
                if (
                    !(requireconstructable && Add.IsConstructable(ctor, ConstructableAccessLevel))
                    && !(requireattachable && XmlAttach.IsAttachable(ctor))
                )
                    continue;
#else
                if (
                    !(requireconstructable && IsConstructable(ctor))
                    && !(requireattachable && XmlAttach.IsAttachable(ctor))
                )
                    continue;
#endif
                    ...
                    foreach (NetState state in NetState.Instances)
                    {
                        ...
                        if (m != null && (m.AccessLevel <= SmartSpawnAccessLevel || !m.Hidden))
                        {
                            ...
                            if (m.Map != null && m.Map != Map.Internal)
                            {
                                ...
                                {
                                    ArrayList spawnerlist = (ArrayList)
                                        GlobalSectorTable[m.Map.MapID][s];
                                    if (spawnerlist != null)
                                    {
                                        foreach (XmlSpawner spawner in spawnerlist)
                                        {
                                            if (
                                                ...
                                                && !spawner.Deleted
                                                && spawner.Running
                                                && spawner.SmartSpawning
                                                && spawner.IsInactivated
                                            )
                                            {
        ...
        private class WarnTimer2 : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                {
                    Console.WriteLine(
                        "Warning: {0} bad spawns detected, logged: 'badspawn.log'",
                        m_List.Count
                    );
