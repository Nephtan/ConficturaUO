    ...
    public class XmlGetAttGump : Gump
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(XmlGetAtt_OnCommand)
            );
        }
        ...
        private ArrayList Search(object target, out string status_str)
        {
            ...
            if (attachments != null)
                foreach (XmlAttachment i in attachments)
                {
                    ...
                    if (
                        Dosearchtype
                        && (i.GetType().IsSubclassOf(targetType) || i.GetType().Equals(targetType))
                    )
                    {
                        hastype = true;
                    }
            ...
            : base(X, Y)
        {
            ...
            AddLabel(
                ...
                0,
                0x33,
                String.Format("Attachments on {0} : {1}", targeted.GetType().Name, tnamestr)
            );
