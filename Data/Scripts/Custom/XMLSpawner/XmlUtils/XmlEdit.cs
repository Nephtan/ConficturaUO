    ...
    public class XmlEditDialogGump : Gump
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(XmlEditDialog_OnCommand)
            );
        }
        ...
        private class EditDialogTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                from.SendGump(
                    new XmlEditDialogGump(from, true, xd, -1, 0, null, false, null, 0, 0)
                );
            }
        }
            ...
            : base(X, Y)
        {
            ...
            else if (m_Dialog.AttachedTo is Mobile)
            {
            ...
            for (int i = 0; i < MaxEntries; i++)
            {
                ...
                AddLabel(
                    x,
                    y + 22 * (i % MaxEntriesPerPage) + 31,
                    texthue,
                    s.EntryNumber.ToString()
                );
                ...
                AddLabelCropped(
                    ...
                    21,
                    texthue,
                    TruncateLabel(s.Gump)
                );

                // display the selection button
                AddButton(
                    730,
                    y + 22 * (i % MaxEntriesPerPage) + 32,
                    (sel ? 0xD3 : 0xD2),
                    (sel ? 0xD2 : 0xD3),
                    4000 + i,
                    GumpButtonType.Reply,
            ...
            if (
                Selected >= 0
                && Selected + DisplayFrom >= 0
                && Selected + DisplayFrom < m_SearchList.Count
            )
            {
            ...
            if (m_SearchList != null)
            {
                ...
                if (last > 0)
                    AddLabel(
                        ...
                        y,
                        68,
                        String.Format("Displaying {0}-{1}", DisplayFrom, last - 1)
                    );
            }
            ...
            AddButton(
                510 + 25 * (int)(MaxEntries / MaxEntriesPerPage),
                y,
                0x15E1,
                0x15E5,
                201,
        ...
        {
            if (m_SearchList == null || m_SelectionList == null)
                return;

            string dirname;
            if (
                System.IO.Directory.Exists(XmlDialog.DefsDir)
                && filename != null
                && !filename.StartsWith("/")
                && !filename.StartsWith("\\")
            )
        ...
        {
            XmlEditDialogGump g = new XmlEditDialogGump(
                this.m_From,
                false,
                this.m_Dialog,
                this.Selected,
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            if (info == null || state == null || state.Mobile == null || m_Dialog == null)
                return;
            ...
            if (m_Dialog != null)
            {
                ...
                if (
                    tr != null
                    && (m_Dialog.TriggerOnCarried == null || m_Dialog.TriggerOnCarried.Length < 230)
                )
                {
                ...
                if (
                    ...
                    && (
                        ...
                        || m_Dialog.NoTriggerOnCarried.Length < 230
                    )
                )
                {
                    if (tr.Text != null && tr.Text.Trim().Length > 0)
            ...
            {
                // entry information
                XmlDialog.SpeechEntry entry = (XmlDialog.SpeechEntry)
                ...
                default:
                {
                    ...
                    else if (info.ButtonID >= 5000 && info.ButtonID < 5100)
                    {
                        ...
                        XmlTextEntryBook book = new XmlTextEntryBook(
                            ...
                            20,
                            true,
                            new XmlTextEntryBookCallback(ProcessXmlEditBookEntry),
                            args
                        );
        ...
        public class XmlConfirmDeleteGump : Gump
        {
            ...
            public XmlConfirmDeleteGump(
                Mobile from,
                XmlEditDialogGump gump,
