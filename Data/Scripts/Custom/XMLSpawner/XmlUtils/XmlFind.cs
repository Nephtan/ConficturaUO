    ...
    public class XmlFindGump : Gump
    {
        public class XmlFindThread
        {
            ...
            public void XmlFindThreadMain()
            {
                ...
                XmlFindGump gump = new XmlFindGump(
                    m_From,
                    m_From.Location,
                    m_From.Map,
                    true,
                ...
                Timer.DelayCall(
                    TimeSpan.Zero,
                    new TimerStateCallback(GumpDisplayCallback),
                    new object[] { m_From, gump, status_str }
                );
            }
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(XmlFind_OnCommand)
            );
        }
        ...
        public static ArrayList Search(SearchCriteria criteria, out string status_str)
        {
            ...
            try
            {
                tokunomap = Map.Parse("IslesDread");
            }
            catch { }
            ...
            try
            {
                termurmap = Map.Parse("SavagedEmpire");
            }
            catch { }
            ...
            if (
                criteria.Dosearchattach
                && criteria.Searchattachtype != null
                && criteria.Searchattachtype.Length > 0
            )
            {
            ...
            if (!criteria.Dosearchattach)
            {
                ...
                if (itemarray != null)
                {
                    foreach (Item i in itemarray)
                    {
                        ...
                        // check for map
                        if (
                            (i.Map == Map.Lodor && criteria.Dosearchfel)
                            || (i.Map == Map.Sosaria && criteria.Dosearchtram)
                            || (i.Map == Map.SerpentIsland && criteria.Dosearchmal)
                            || (i.Map == Map.Underworld && criteria.Dosearchilsh)
                        ...
                        // check for type
                        if (
                            criteria.Dosearchtype
                            && (
                                i.GetType().IsSubclassOf(targetType)
                                || i.GetType().Equals(targetType)
                            )
                        )
                        {
                            hastype = true;
                        ...
                        // check for name
                        if (
                            criteria.Dosearchname
                            && (i.Name != null)
                            && (criteria.Searchname != null)
                            && (i.Name.ToLower().IndexOf(criteria.Searchname.ToLower()) >= 0)
                        )
                        {
                            hasname = true;
                        }
                        ...
                        // check for range
                        if (
                            criteria.Dosearchrange
                            && TestRange(
                                i,
                                criteria.Searchrange,
                                criteria.Currentmap,
                                criteria.Currentloc
                            )
                        )
                        ...
                        if (criteria.Dosearchcondition && (criteria.Searchcondition != null))
                        {
                            ...
                            hascondition = BaseXmlSpawner.CheckPropertyString(
                                null,
                                i,
                        ...
                        if (criteria.Dosearchspawnentry)
                        {
                            ...
                            {
                                targetentrytype = SpawnerType.GetType(
                                    criteria.Searchspawnentry.ToLower()
                                );
                            }

                            if (
                                criteria.Searchspawnentry == null
                                || (targetentrytype == null && criteria.Dosearchspawntype)
                            )
                            {
                                hasentry = false;
                            }
                            else
                            {
                                ...
                                if (i is XmlSpawner)
                                {
                                    ...
                                    foreach (
                                        XmlSpawner.SpawnObject so in ((XmlSpawner)i).m_SpawnObjects
                                    )
                                    {
                                        if (criteria.Dosearchspawntype)
                                        {
                                            ...
                                            if (
                                                ...
                                                && (
                                                    ...
                                                    || type.IsSubclassOf(targetentrytype)
                                                )
                                            )
                                            {
                                                hasentry = true;
            ...
            if (!criteria.Dosearcherr && !criteria.Dosearchattach)
            {
                ...
                if (mobilearray != null)
                {
                    foreach (Mobile i in mobilearray)
                    {
                        ...
                        // check for age
                        if (
                            criteria.Dosearchage
                            && TestAge(i, criteria.Searchage, criteria.Searchagedirection)
                        )
                        {
                            hasage = true;
                        }
            ...
            if (criteria.Dosearchattach)
            {
                foreach (XmlAttachment i in XmlAttach.Values)
                {
                    ...
                    if (
                        ...
                        && !i.Deleted
                        && (
                            targetattachType == null
                            || i.GetType().IsSubclassOf(targetattachType)
                            || i.GetType().Equals(targetattachType)
                        )
                    )
                    {
                        newarray.Add(new SearchEntry(i));
            ...
            : base(X, Y)
        {
            ...
            if (m_ShowExtension)
            {
                ...
                AddButton(
                    415 + 25 * (int)(MaxEntries / MaxEntriesPerPage),
                    height - 25,
                    0x15E1,
                    0x15E5,
                    201,
                ...
                if (m_SearchList != null)
                {
                    AddLabel(
                        ...
                        y - 50,
                        68,
                        String.Format("Found {0} items/mobiles", m_SearchList.Count)
                    );
                    AddLabel(
                        400,
                        y - 50,
                        ...
                        String.Format(
                            ...
                            DisplayFrom,
                            (
                                DisplayFrom + MaxEntries < m_SearchList.Count
                ...
                for (int i = 0; i < MaxEntries; i++)
                {
                    ...
                    AddButton(
                        730,
                        22 * (i % MaxEntriesPerPage) + 32,
                        (e.Selected ? 0xD3 : 0xD2),
                        (e.Selected ? 0xD2 : 0xD3),
                        4000 + i,
                        GumpButtonType.Reply,
                        0
                    );
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            if (tr != null && tr.Text != null && tr.Text.Length > 0)
            {
                try
                {
                    m_SearchCriteria.Searchage = double.Parse(tr.Text);
                }
                catch { }
            }
            ...
            if (tr != null && tr.Text != null && tr.Text.Length > 0)
            {
                try
                {
                    m_SearchCriteria.Searchrange = int.Parse(tr.Text);
                }
                catch { }
            }
            ...
            switch (info.ButtonID)
            {
                ...
                case 3: // Search
                {
                    ...
                    XmlFindThread tobj = new XmlFindThread(
                        state.Mobile,
                        m_SearchCriteria,
                        CommandString
                    );
                ...
                default:
                {
                    ...
                    if (info.ButtonID >= 5000 && info.ButtonID < 5000 + MaxEntries)
                    {
                        ...
                        if (m_SearchList != null && i >= 0 && m_SearchList.Count > i + DisplayFrom)
                        {
                            ...
                            state.Mobile.SendGump(
                                new XmlGetAttGump(state.Mobile, e.Object, 10, 10)
                            );
                        }
                    }
                    break;
