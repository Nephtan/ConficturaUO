...
namespace Server.Gumps
{
    public class XmlPartialCategorizedAddGump : Gump
    {
        ...
        public XmlPartialCategorizedAddGump(
            Mobile from,
            string searchString,
            int page,
            ...
            : base(50, 50)
        {
            ...
            AddHtmlLocalized(
                ...
                20,
                1061027,
                ((m_Page + 1) * 10) < searchResults.Count ? 0x7FFF : 0x5EF7,
                false,
                false
            ); // Next page
        }
                ...
                default:
                {
                    ...
                    if (index >= 0 && index < m_SearchResults.Count)
                    {
                        ...
                        if (m_Gump is XmlAddGump && type != null)
                        {
                            ...
                            if (
                                type != null
                                && m_XmlAddGump.defs != null
                                && m_XmlAddGump.defs.NameList != null
                                && m_EntryIndex >= 0
                                && m_EntryIndex < m_XmlAddGump.defs.NameList.Length
                            )
                            {
