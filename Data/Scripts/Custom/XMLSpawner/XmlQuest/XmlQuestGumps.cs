...
namespace Server.Gumps
{
            ...
            switch (info.ButtonID)
            {
                default:
                {
                    ...
                    { // accept
                        ...
                        else if (m_Item is XmlQuestBook)
                        {
    ...
    public class XmlSimpleGump : Gump
    {
            ...
            else
            {
                try
                {
                    ...
                    AddHtml(
                        ...
                        width,
                        height,
                        XmlSimpleGump.Color(text, colorstring),
                        background,
                        scrollbar
                    );
                }
        ...
        public XmlSimpleGump(
            object invoker,
            string gumptext,
            string gumptitle,
            int gumptype,
            BaseXmlSpawner.KeywordTag tag,
            Mobile from
        )
            ...
            { // multiple selection type gump
                ...
                for (int i = 0; i < gumpSelections.Count; i++)
                {
                    ...
                    AddHtml(
                        ...
                        250,
                        40,
                        XmlSimpleGump.Color(((GumpSelection)gumpSelections[i]).Selection, "FFFFFF"),
                        false,
                        false
                    );
                }
                            ...
                            if (info.Switches != null && info.Switches.Length > 0)
                            {
                                ...
                                if (select >= 0 && select < gumpSelections.Count)
                                {
                                    ...
                                    m_gumpcallback(
                                        from,
                                        m_invoker,
                                        ((GumpSelection)gumpSelections[select]).Response
                                    );
                                }
                            }
                            break;
                        case 5:
                            ...
                            if (info.ButtonID >= 1000)
                            {
                                ...
                                if (select >= 0 && select < gumpSelections.Count)
                                {
                                    // return the response string for that selection
                                    buttonresponse = (
                                        (GumpSelection)gumpSelections[select]
                                    ).Response;
                                }
                            }
                            ...
                            if (info.Switches != null && info.Switches.Length > 0)
                            {
                                ...
                                {
                                    radioresponse = (
                                        (GumpSelection)gumpSelections[radiostate]
                                    ).Response;
                                }
                            }
