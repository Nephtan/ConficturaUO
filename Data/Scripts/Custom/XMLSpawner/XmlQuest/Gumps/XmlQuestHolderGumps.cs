                ...
                else if (foundgive)
                {
                    ...
                    else
                    {
                        if (name != null)
                        {
                            ...
                            text = String.Format(
                                "Give {0} {1}(s) named {2} to {3} ({4} left)",
                                targetcount,
                                type,
                                name,
                                mobname,
            ...
            else
            {
                ...
                { // display the title if it is there
                    ...
                    AddHtml(
                        ...
                        200,
                        30,
                        XmlSimpleGump.Color(gumptitle, "00FF42"),
                        false,
                        false
                    );
                }
                ...
                DisplayQuestStatus(
                    130,
                    192,
                    questitem.Objective1,
                    questitem.State1,
                    questitem.Completed1,
                    questitem.Description1
                );
                DisplayQuestStatus(
                    130,
                    224,
                    questitem.Objective2,
                    questitem.State2,
                    questitem.Completed2,
                    questitem.Description2
                );
                DisplayQuestStatus(
                    130,
                    256,
                    questitem.Objective3,
                    questitem.State3,
                    questitem.Completed3,
                    questitem.Description3
                );
                DisplayQuestStatus(
                    130,
                    288,
                    questitem.Objective4,
                    questitem.State4,
                    questitem.Completed4,
                    questitem.Description4
                );
                DisplayQuestStatus(
                    130,
                    320,
                    questitem.Objective5,
                    questitem.State5,
                    questitem.Completed5,
                    questitem.Description5
                );
                ...
                if ((questitem.RewardItem != null && !questitem.RewardItem.Deleted))
                {
                    ...
                    if (questitem.RewardItem.Amount > 1)
                    {
                        AddLabel(
                            ...
                            String.Format(
                                "Reward: {0} ({1})",
                                questitem.RewardItem.GetType().Name,
                        ...
                        AddLabel(
                            ...
                            String.Format(
                                "Weight: {0}",
                                questitem.RewardItem.Weight * questitem.RewardItem.Amount
                            )
                        );
                    }
                    else if (questitem.RewardItem is Container)
                    {
                        ...
                        AddLabel(
                            ...
                            String.Format(
                                "Weight: {0}",
                                questitem.RewardItem.TotalWeight + questitem.RewardItem.Weight
                            )
                        );
                    }
                    else
                    {
                        AddLabel(
                            ...
                            356,
                            55,
                            String.Format("Reward: {0}", questitem.RewardItem.GetType().Name)
                        );
                        AddLabel(
                            230,
                            373,
                            55,
                            String.Format("Weight: {0}", questitem.RewardItem.Weight)
                        );
                    }
                ...
                if (questitem.RewardAttachment != null && !questitem.RewardAttachment.Deleted)
                {
                    AddLabel(
                        ...
                        339,
                        55,
                        String.Format("Bonus: {0}", questitem.RewardAttachment.GetType().Name)
                    );
                }

                if (
                    (questitem.RewardItem != null && !questitem.RewardItem.Deleted)
                    || (questitem.RewardAttachment != null && !questitem.RewardAttachment.Deleted)
                )
                {
                ...
                if (questitem.IsValid)
                {
                    ...
                    AddHtml(
                        ...
                        200,
                        37,
                        XmlSimpleGump.Color(questitem.ExpirationString, "00FF42"),
                        false,
                        false
                    );
                }
                else if (questitem.AlreadyDone)
                {
                    ...
                    {
                        ArrayList a = XmlAttach.FindAttachments(
                            questitem.Owner,
                            typeof(XmlQuestAttachment),
                            questitem.Name
                        );
                        if (a != null && a.Count > 0)
                        {
                            AddLabel(
                                ...
                                String.Format(
                                    "Repeatable in {0}",
                                    ((XmlQuestAttachment)a[0]).Expiration
                                )
                            );
                        }
                        else
                ...
                if (XmlQuest.QuestPointsEnabled)
                {
                    AddHtml(
                        ...
                        30,
                        XmlSimpleGump.Color(
                            String.Format("Difficulty Level {0}", questitem.Difficulty),
                            "00FF42"
                        ),
                        false,
                        false
                ...
                if (questitem.PartyEnabled)
                {
                    AddHtml(
                        ...
                        200,
                        30,
                        XmlSimpleGump.Color("Party Quest", "00FF42"),
                        false,
                        false
                    );
                    if (questitem.PartyRange >= 0)
                    {
                        AddHtml(
                            ...
                            30,
                            XmlSimpleGump.Color(
                                String.Format("Party Range {0}", questitem.PartyRange),
                                "00FF42"
                            ),
                            false,
                            false
                    ...
                    else
                    {
                        AddHtml(
                            ...
                            200,
                            30,
                            XmlSimpleGump.Color("No Range Limit", "00FF42"),
                            false,
                            false
                        );
                    }
                ...
                else
                {
                    AddHtml(
                        ...
                        200,
                        30,
                        XmlSimpleGump.Color("Solo Quest", "00FF42"),
                        false,
                        false
                    );
                }
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 900:
                    ...
                    state.Mobile.SendGump(
                        new XmlQuestStatusGump(m_questitem, m_gumptitle, m_X, m_Y, m_solid, 0)
                    );
                    break;
                case 901:
                    // open a new status gump with journal display
                    state.Mobile.SendGump(
                        new XmlQuestStatusGump(m_questitem, m_gumptitle, m_X, m_Y, m_solid, 1)
                    );
                    break;
                case 952:
                    // open a new status gump with journal display
                    ...
                    {
                        state.Mobile.SendGump(
                            new JournalEntryGump(m_questitem, m_gumptitle, m_X, m_Y, m_solid)
                        );
                    }
                    break;
            }
