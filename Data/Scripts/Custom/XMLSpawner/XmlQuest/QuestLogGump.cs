...
namespace Server.Gumps
{
    public class QuestLogGump : Gump
    {
            ...
            switch (info.ButtonID)
            {
                ...
                case 10: // Top players
                {
                    ...
                    XmlQuestPoints p = (XmlQuestPoints)
                        XmlAttach.FindAttachment(m_From, typeof(XmlQuestPoints));
                    ...
                    if (info.ButtonID >= 2000)
                    {
                        ...
                        if (m_List[index] is IXmlQuest)
                        {
                            ...
                            if (o != null && !o.Deleted)
                            {
                                ...
                                m_From.SendGump(
                                    new XmlQuestStatusGump(o, o.TitleString, 320, 0, true)
                                );
                            }
                        }
                    }
            ...
            : base(12, 24)
        {
            ...
            XmlQuestPoints p = (XmlQuestPoints)
                XmlAttach.FindAttachment(from, typeof(XmlQuestPoints));
            ...
            if (list == null)
            {
                ...
                if (from.Backpack != null)
                {
                    ...
                    if (packquestitems != null)
                    {
                        ...
                        {
                            if (
                                packquestitems[i] != null
                                && !packquestitems[i].Deleted
                                && !(packquestitems[i].Parent is XmlQuestBook)
                            )
                    ...
                    if (questbookitems != null)
                    {
                        ...
                        {
                            Item[] questitems = ((XmlQuestBook)questbookitems[j]).FindItemsByType(
                                typeof(IXmlQuest)
                            );
            ...
            AddHtml(
                ...
                200,
                32,
                XmlSimpleGump.Color("Available Credits:", "FFFFFF"),
                false,
                false
            ); // Your Reward Points:
            ...
            AddHtml(
                ...
                200,
                32,
                XmlSimpleGump.Color("Rank:", "FFFFFF"),
                false,
                false
            ); // Rank
            ...
            AddHtml(
                ...
                200,
                32,
                XmlSimpleGump.Color("Quests Completed:", "FFFFFF"),
                false,
                false
            ); // Quests completed
            ...
            AddHtml(
                ...
                200,
                32,
                XmlSimpleGump.Color("Points", "FFFFFF"),
                false,
                false
            ); // Points
            AddHtml(
                ...
                200,
                32,
                XmlSimpleGump.Color("Next Available", "FFFFFF"),
                false,
                false
            ); // Next Available
            ...
            AddHtml(
                ...
                200,
                32,
                XmlSimpleGump.Color("Top Players", "FFFFFF"),
                false,
                false
            ); // Top players gump
            ...
            for (int i = index; i < (index + count) && i >= 0 && i < list.Count; ++i)
            {
                ...
                else if (obj is XmlQuestPoints.QuestEntry)
                {
                    ...
                    XmlQuestAttachment qa = (XmlQuestAttachment)
                        XmlAttach.FindAttachment(from, typeof(XmlQuestAttachment), e.Name);
                    if (qa != null)
                    {
