    ...
    public class XmlQuestLeaders
    {
        ...
        public class QuestRankEntry : IComparable
        {
            ...
            public int CompareTo(object obj)
            {
                ...
                if (p.QuestPointsAttachment.Points - QuestPointsAttachment.Points == 0)
                {
                    ...
                    if (
                        p.QuestPointsAttachment.QuestsCompleted
                            - QuestPointsAttachment.QuestsCompleted
                        == 0
                    )
                    {
                    ...
                    return p.QuestPointsAttachment.QuestsCompleted
                        - QuestPointsAttachment.QuestsCompleted;
                }
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register(
                "QuestRanking",
                AccessLevel.Player,
                new CommandEventHandler(QuestRanking_OnCommand)
            );
        }
        ...
        public static void QuestRanking_OnCommand(CommandEventArgs e)
        {
            ...
            XmlQuestPoints p = (XmlQuestPoints)
                XmlAttach.FindAttachment(e.Mobile, typeof(XmlQuestPoints));
        ...
        public static void WriteQuestLeaderboardXml(string filename, int nranks)
        {
            ...
            for (int i = 0; i < QuestRankList.Count; i++)
            {
                ...
                )
                {
                    ...
                    if (
                        r.Quester is PlayerMobile
                        && ((PlayerMobile)r.Quester).FactionPlayerState != null
                    )
                        factionname = (
                            (PlayerMobile)r.Quester
        ...
        public static void WriteQuestLeaderboardHtml(string filename, int nranks)
        {
            ...
            sw.WriteLine(
                "<TABLE border=\"1\" summary=\"This table gives quest leaderboard stats\"> "
            );
            ...
            if (e.Arguments.Length > 0)
            {
                ...
                if (e.Arguments[0].ToLower() != "off")
                {
                    ...
                    if (e.Arguments.Length > 1)
                    {
                        try
                        {
                            m_QuestLeaderboardSaveInterval = TimeSpan.FromMinutes(
                            ...
                            if (args != null)
                            {
                                ...
                                foreach (string arg in args)
                                {
                                    if (
                                        ...
                                        && r.Quester.Name != null
                                        && (
                                            r.Quester.Name.ToLower().IndexOf(arg.Trim().ToLower())
                                            >= 0
                                        )
                                    )
                                    {
