...
namespace Server.Gumps
{
    public class XmlSetPoint3DGump : Gump
    {
        ...
        private static readonly int EntryWidth =
            CoordWidth + OffsetSize + CoordWidth + OffsetSize + CoordWidth;
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                {
                    m_Mobile.Target = new InternalTarget(
                        m_Property,
                        m_Mobile,
                        m_Object,
                        m_Stack,
