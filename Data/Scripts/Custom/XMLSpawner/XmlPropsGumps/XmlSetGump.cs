    ...
    public class XmlSetGump : Gump
    {
        ...
        private class InternalPicker : HuePicker
        {
            ...
            public override void OnResponse(int hue)
            {
                ...
                m_Mobile.SendGump(
                    new XmlPropertiesGump(m_Mobile, m_Object, m_Stack, m_List, m_Page)
                );
            }
        }
            ...
            switch (info.ButtonID)
            {
                case 1:
                {
                    ...
                    if (text != null)
                    {
                        try
                        {
                            toSet = XmlPropertiesGump.GetObjectFromString(
                ...
                case 3: // Hue Picker
                {
                    ...
                    m_Mobile.SendHuePicker(
                        new InternalPicker(m_Property, m_Mobile, m_Object, m_Stack, m_Page, m_List)
                    );
                ...
                case 4: // Body Picker
                {
                    ...
                    m_Mobile.SendGump(
                        new SetBodyGump(m_Property, m_Mobile, m_Object, m_Stack, m_Page, m_List)
                    );
