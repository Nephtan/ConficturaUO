...
namespace Server.Mobiles
{
    ...
    public class BaseXmlSpawner
    {
        ...
        {
            valuemodKeywordHash.Add(
                name,
                (valuemodKeyword)Enum.Parse(typeof(valuemodKeyword), name)
            );
        }
                ...
                if (spawner != null && !spawner.Deleted)
                {
                    ...
                    if (spawner.m_KeywordTagList.Count > 0)
                        Serial =
                            (
                                (KeywordTag)(
                                    spawner.m_KeywordTagList[spawner.m_KeywordTagList.Count - 1]
                                )
                            ).Serial + 1;
                    else
                        Serial = 0;
                    ...
                    )
                    {
                        ...
                        else
                        {
                            ...
                            if (m_Tag != null && !m_Tag.Deleted)
                            {
                                ...
                                if (
                                    m_Tag.m_Timeout > TimeSpan.Zero
                                    && m_Tag.m_TimeoutEnd < DateTime.Now
                                )
                                {
        ...
        )
        {
            ...
            else if (IsCustomEnum(type))
            {
                try
                {
                    MethodInfo info = p.PropertyType.GetMethod(
                        "Parse",
            ...
            else if (keywordargs[0] == "SKILL")
            {
                ...
                try
                {
                    SkillName skillname = (SkillName)
                        Enum.Parse(typeof(SkillName), keywordargs[1], true);
                    if (o is Mobile)
                    {
        ...
        public static string SetPropertyObject(
            XmlSpawner spawner,
            object o,
            string name,
            object value
        ...
        )
        {
            ...
            if (keywordargs[0] == "ATTACHMENT")
            {
                ...
                if (attachments != null && attachments.Count > 0)
                {
                    string getvalue = GetPropertyValue(
                        spawner,
                        attachments[0],
                        apropname,
                        out ptype
                ...
                if (arglist.Length > 1)
                {
                    ...
                    )
                    {
                        ...
                        //else
                        {
                            ...
                            if (
                                singlearglist[1] != null
                                && singlearglist[1].Length > 0
                                && singlearglist[1][0] == '@'
                            )
                            {
                    ...
                    else
                    {
                        ...
                        {
                            valuemodKeyword kw = (valuemodKeyword)
                                valuemodKeywordHash[value_keywordargs[0]];
                            ...
                            if (kw == valuemodKeyword.RND)
                            {
                                ...
                                if (value_keywordargs.Length > 2)
                                {
                                    ...
                                    try
                                    {
                                        randvalue = String.Format(
                                            "{0}",
                                            Utility.RandomMinMax(
                                                int.Parse(value_keywordargs[1]),
                                                int.Parse(value_keywordargs[2])
                                            )
                                        );
                                    }
                                    catch
                            ...
                            else if (kw == valuemodKeyword.GETVAR)
                            {
                                ...
                                if (value_keywordargs.Length > 1)
                                {
                                    ...
                                    XmlLocalVariable var = (XmlLocalVariable)
                                        XmlAttach.FindAttachment(
                                            refobject,
                                            typeof(XmlLocalVariable),
                                            varname
                                        );
                            ...
                            else if (kw == valuemodKeyword.GETONMOB)
                            {
                                ...
                                if (value_keywordargs.Length > 2)
                                {
                                    ...
                                    Mobile testmobile = FindMobileByName(
                                        spawner,
                                        value_keywordargs[1],
                                        typestr
                                    );
                                    ...
                                    if (trigmob != null && !trigmob.Deleted)
                                    {
                                        ...
                                        if (value_keywordargs.Length > 4)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                {
                                                    status_str =
                                                        "GETONCARRIED error parsing equippedonly";
                                                    no_error = false;
                                                }
                                            }
                                        }
                            ...
                            else if (kw == valuemodKeyword.GETONNEARBY)
                            {
                                ...
                                if (value_keywordargs.Length > 3)
                                {
                                    ...
                                    if (value_keywordargs.Length > 5)
                                    {
                                        ...
                                        {
                                            status_str =
                                                "invalid searchcontainer bool in GETONNEARBY";
                                            no_error = false;
                                        }
                            ...
                            else if (kw == valuemodKeyword.MUL)
                            {
                                ...
                                if (value_keywordargs.Length > 1)
                                {
                                    ...
                                    if (value_keywordargs.Length > 2)
                                    {
                                        ...
                                        {
                                            int incarg0 = (int)(
                                                10000 * double.Parse(value_keywordargs[1])
                                            );
                                            int incarg1 = (int)(
                                                10000 * double.Parse(value_keywordargs[2])
                                            );
                                            incvalue = String.Format(
                                                "{0}",
                                                Utility.RandomMinMax(incarg0, incarg1) / 10000.0
                                            );
                                        }
                                        catch
                                        {
                                    ...
                                    // get the current property value
                                    Type ptype;
                                    string tmpvalue = GetPropertyValue(
                                        spawner,
                                        o,
                                        arglist[0],
                                        out ptype
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            int tmpval = (int)(
                                                double.Parse(currentvalue) * double.Parse(incvalue)
                                            );
                            ...
                            else if (kw == valuemodKeyword.MOB)
                            {
                                ...
                                if (value_keywordargs.Length > 1)
                                {
                                    ...
                                    try
                                    {
                                        mob_id = FindMobileByName(
                                            spawner,
                                            value_keywordargs[1],
                                            typestr
                                        ); // the format of this will be 0xvalue "name"
                                    }
                                    catch
                                    {
                                    ...
                                    string result = SetPropertyObject(
                                        spawner,
                                        o,
                                        arglist[0],
                                        mob_id
                        ...
                        else if (IsTypemodKeyword(keywordargs[0]))
                        {
                            ...
                            else if (kw == typemodKeyword.UNEQUIP)
                            {
                                ...
                                if (keywordargs.Length > 1)
                                {
                                    ...
                                    {
                                        layer = (Layer)
                                            Enum.Parse(typeof(Layer), keywordargs[1], true);
                                    }
                                    catch
                                    {
                            ...
                            else if (kw == typemodKeyword.MSG)
                            {
                                ...
                                if (keywordargs.Length > 1)
                                {
                                    try
                                    {
                                        drop_probability = Convert.ToDouble(
                                            keywordargs[1],
                                ...
                                if (o is Mobile || o is Item)
                                {
                                    ...
                                    {
                                        if (o is Mobile)
                                            ((Mobile)o).PublicOverheadMessage(
                                                MessageType.Regular,
                                                hue,
                                                false,
                                                msgstr
        ...
        )
        {
            ...
            bool testreturn = CheckPropertyString(
                spawner,
                mobile,
                testString,
                trigmob,
            ...
            else if (IsValueKeyword(pname))
            {
                ...
                else if ((kw == valueKeyword.RND) && arglist.Length > 2)
                {
                    ...
                    try
                    {
                        randvalue = String.Format(
                            "{0}",
                            Utility.RandomMinMax(int.Parse(arglist[1]), int.Parse(arglist[2]))
                        );
                    }
                    catch { }
        ...
        )
        {
            ...
            if (arglist.Length < 2)
            {
                bool returnval = CheckSingleProperty(
                    spawner,
                    o,
                    testString,
                    trigmob,
            ...
            else
            {
                ...
                if (
                    (andposition > 0 && orposition <= 0)
                    || (andposition > 0 && andposition < orposition)
                )
                {
                    // and operator
                    return (first && second);
                    ...
                    (orposition > 0 && andposition <= 0)
                    || (orposition > 0 && orposition < andposition)
                )
                {
                    // or operator
                    return (first || second);
        ...
        )
        {
            ...
            string value1 = ParseForKeywords(
                spawner,
                o,
                arglist[0].Trim(),
                trigmob,
            ...
            string value2 = ParseForKeywords(
                spawner,
                o,
                arglist[1].Trim(),
                trigmob,
            ...
            if (source != null && source.Items != null && nearbylist != null)
            {
                foreach (Item i in source.Items)
                {
                    ...
                    )
                    {
                        if (
                            proptest == null
                            || CheckPropertyString(null, i, proptest, null, out status_str)
                        )
                            nearbylist.Add(i);
                    }
        ...
        private static ArrayList GetNearbyObjects(
            object invoker,
            string targetname,
            Type targettype,
            string typestr,
        ...
        )
        {
            ...
            if (
                ...
                || targettype.IsSubclassOf(typeof(Item))
            )
            {
                if (invoker is Item)
                {
            ...
            if (
                targettype == null
                || targettype == typeof(Mobile)
                || targettype.IsSubclassOf(typeof(Mobile))
            )
            {
                if (invoker is Item)
                {
                ...
                if (mobilelist != null)
                {
                    foreach (Mobile m in mobilelist)
                    {
                        ...
                        if (
                            ...
                            && (
                                ...
                                || (
                                    ...
                                    && targettype != null
                                    && (
                                        mobtype.Equals(targettype)
                                        || mobtype.IsSubclassOf(targettype)
                                    )
                                )
                            )
                        )
                        {
                            if (
                                proptest == null
                                || CheckPropertyString(null, m, proptest, null, out status_str)
                            )
                                nearbylist.Add(m);
                        }
                    }
            ...
            if (m != null && !m.Deleted)
            {
                ...
                for (int i = 0; i < packlist.Count; ++i)
                {
                    ...
                    if (item != null && !item.Deleted)
                    {
                        ...
                        {
                            Item itemTarget = SearchPackForItem(
                                (Container)item,
                                targetName,
                                typeStr
                            );
                    ...
                    if (item != null && !item.Deleted)
                    {
                        ...
                        if (CheckNameMatch(targetName, item.Name))
                        {
                            if (
                                targettype == null
                                || (
                                    item.GetType().Equals(targettype)
        ...
        public static ArrayList SearchPackListForItemType(
            Container pack,
            string targetName,
            ArrayList itemlist
        )
            ...
            if (m != null && !m.Deleted && targetName != null && targetName.Length > 0)
            {
                ...
                for (int i = 0; i < packlist.Count; ++i)
                {
                    ...
                    if (item != null && !item.Deleted)
                    {
                        if (item is Container)
                        {
                            itemlist = SearchPackListForItemType(
                                (Container)item,
                                targetName,
                                itemlist
                            );
                ...
                if (held != null && !held.Deleted)
                {
                    ...
                    // test the item name against the trigger string
                    if (
                        held.GetType().IsSubclassOf(targetType) || held.GetType().Equals(targetType)
                    )
                    {
                        //found it
                        // add the item to the list
        ...
        public static Item FindItemByName(XmlSpawner fromspawner, string name, string typestr)
        {
            ...
            foreach (Item item in World.Items.Values)
            {
                ...
                if (
                    !item.Deleted
                    && (name.Length == 0 || String.Compare(item.Name, name, true) == 0)
                )
                {
                    if (
                        typestr == null
        ...
        public static Item FindInRecentItemSearchList(
            XmlSpawner spawner,
            string name,
            string typestr
        )
                ...
                else if (name.Length == 0 || String.Compare(m.Name, name, true) == 0)
                {
                    if (
                        ...
                        || (
                            ...
                            && targettype != null
                            && (
                                m.GetType().Equals(targettype)
                                || m.GetType().IsSubclassOf(targettype)
                            )
                        )
                    )
                    {
                        ...
                        switch (kw)
                        {
                                ...
                                if (itemkeywordargs.Length == 2)
                                {
                                    ...
                                    if (ltype != null)
                                    {
                                        ...
                                        if (method != null && method.IsStatic)
                                        {
                                            ...
                                            {
                                                status_str =
                                                    "LOOT method must be zero arg : " + itemtypestr;
                                                return false;
                                            }
                                        }
                                        else
                                        {
                                            status_str =
                                                "LOOT no valid method found : " + itemtypestr;
                                            return false;
                                        }
                                    }
                            ...
                            case itemKeyword.NECROSCROLL:
                            {
                                ...
                                if (itemkeywordargs.Length == 2)
                                {
                                    ...
                                    if (Core.AOS)
                                    {
                                        Item item = Loot.Construct(
                                            Loot.NecromancyScrollTypes,
                                            index
                                        );
                                        if (item != null)
                                        {
        ...
        public static string[] SplitString(string str, string separator)
        {
            ...
            while (index >= 0)
            {
                ...
                str = str.Substring(
                    ...
                    str.Length - (index + separator.Length)
                );
            }
        ...
        public static void PublicOverheadItemMessage(
            Item item,
            MessageType type,
            int hue,
            int font,
        ...
        )
        {
            if (item != null && item.Map != null)
            {
                ...
                IPooledEnumerable eable = item.Map.GetClientsInRange(
                    worldLoc,
                    item.GetMaxUpdateRange()
                );
        ...
        public static Item MagicJewelry(int minLevel, int maxLevel)
        {
            ...
            if (Core.AOS)
            {
                ...
                int attributeCount,
                    min,
                    max;
                BaseCreature.GetRandomAOSStats(
                    minLevel,
                    maxLevel,
                    out attributeCount,
                    out min,
        ...
        public static Item MagicArmor(int minLevel, int maxLevel, bool jewel, bool shield)
        {
            ...
            else
            {
                ...
                armor.ProtectionLevel = (ArmorProtectionLevel)
                    BaseCreature.RandomMinMaxScaled(minLevel, maxLevel);
                armor.Durability = (ArmorDurabilityLevel)
                    BaseCreature.RandomMinMaxScaled(minLevel, maxLevel);
        ...
        public static Item MagicWeapon(int minLevel, int maxLevel, bool jewel)
        {
            ...
            else
            {
                ...
                weapon.DamageLevel = (WeaponDamageLevel)
                    BaseCreature.RandomMinMaxScaled(minLevel, maxLevel);
                weapon.AccuracyLevel = (WeaponAccuracyLevel)
                    BaseCreature.RandomMinMaxScaled(minLevel, maxLevel);
                weapon.DurabilityLevel = (WeaponDurabilityLevel)
                    BaseCreature.RandomMinMaxScaled(minLevel, maxLevel);
                        ...
                        if (rangelist != null)
                        {
                            foreach (Mobile p in rangelist)
                            {
                                if (p is PlayerMobile)
                                {
                                    ...
                                    if (musicnumber == -1)
                                        p.Send(
                                            PlayMusic.GetInstance(
                                                (MusicName)
                                                    Enum.Parse(typeof(MusicName), musicstr[1], true)
                                            )
                                        );
                                    else
        ...
        public static void ResurrectPlayers(
            string arglist,
            Mobile triggermob,
            object refobject,
            out string status_str
        ...
        public static void SendBoltEffect(IEntity e, int sound, int hue)
        {
            ...
            foreach (NetState state in eable)
            {
                ...
                {
                    if (preEffect == null)
                        preEffect = Packet.Acquire(
                            new TargetParticleEffect(e, 0, 10, 5, 0, 0, 5031, 3, 0)
                        );
                ...
                switch (kw)
                {
                    ...
                    case typeKeyword.TAKE:
                    {
                        ...
                        if (drop_probability == 1 || Utility.RandomDouble() < drop_probability)
                        {
                            ...
                            Item itemTarget = SearchMobileForItem(
                                triggermob,
                                targetName,
                                typestr,
                                banksearch
                            ...
                            if (itemTarget != null)
                            {
                                ...
                                if (si == null)
                                {
                                    XmlAttach.AttachTo(
                                        invoker,
                                        new XmlSaveItem("Taken", savedItem, triggermob)
                                    );
                                }
                                else
                                {
                    ...
                    case typeKeyword.TAKEBYTYPE:
                    {
                        ...
                        {
                            // search the trigger mob for the named item
                            Item itemTarget = SearchMobileForItemType(
                                triggermob,
                                targetName,
                                banksearch
                            );
                                ...
                                if (quantity > 0 && itemTarget.Stackable)
                                {
                                    ...
                                    if (remaining <= 0)
                                    {
                                        ...
                                        while (remaining < 0)
                                        {
                                            quantity -= taken;
                                            // if didnt get the full amount then keep looking for other stacks
                                            itemTarget = SearchMobileForItemType(
                                                triggermob,
                                                targetName,
                                                banksearch
                                            );
                    ...
                    case typeKeyword.GOTO:
                    {
                        ...
                        TheSpawn.SpawnedObjects.Add(
                            new KeywordTag(substitutedtypeName, spawner, 2)
                        );
                    ...
                    case typeKeyword.CAST:
                    {
                        ...
                        if (spell != null)
                        {
                            ...
                            try
                            {
                                ...
                                if (
                                    spelltype != null
                                    && (spelltargetmethod = spelltype.GetMethod("Target")) != null
                                ) { }
                                ...
                                ParameterInfo[] spelltargetparms =
                                    spelltargetmethod.GetParameters();
                                ...
                                if (spelltargetparms != null && spelltargetparms.Length > 0)
                                {
                                    if (spelltargetparms[0].ParameterType == typeof(Server.Mobile))
                                    {
                                        ...
                                        spelltargetparms[0].ParameterType == typeof(Server.IPoint3D)
                                    )
                                    {
                                        // set the target parameter
                                        targetargs = new object[1];
