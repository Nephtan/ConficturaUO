...
namespace Server.Engines.XmlSpawner2
{
    public class PacketHandlerOverrides
    {
        public static void Initialize()
        {
            ...
            // *AGETIAN-commented*: EventSink.QuestGumpRequest += new QuestGumpRequestHandler(XmlQuest.QuestButton);
        }
        ...
        public static void ContentChangeOverride()
        {
            PacketHandlers.Register(
                ...
                0,
                true,
                new OnPacketReceive(XmlTextEntryBook.ContentChange)
            );
#if(CLIENT6017)
        ...
        public static void QuestButtonOverride()
        {
            PacketHandlers.RegisterEncoded(
                0x32,
                true,
                new OnEncodedPacketReceive(XmlQuest.QuestButton)
            );
        }
    }
}
