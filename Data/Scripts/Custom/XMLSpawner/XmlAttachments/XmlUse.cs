...
namespace Server.Engines.XmlSpawner2
{
    public class XmlUse : XmlAttachment
    {
        ...
        {
            get { return m_TargetFailureAction; }
        ...
        private bool CheckCondition(Mobile from, object target)
        {
            ...
            if (Condition != null && Condition.Length > 0)
            {
                ...
                return BaseXmlSpawner.CheckPropertyString(
                    null,
                    target,
                    Condition,
                    from,
        ...
        {
            if (
                CheckRange(from, target)
                && CheckCondition(from, target)
                && CheckMaxUses
                && CheckRefractory
            )
            {
