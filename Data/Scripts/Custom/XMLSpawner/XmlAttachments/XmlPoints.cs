...
namespace Server.Engines.XmlSpawner2
{
    public class XmlPoints : XmlAttachment
    {
        ...
        {
            get { return m_ReceiveBroadcasts; }
            set { m_ReceiveBroadcasts = value; }
        }
        ...
        public bool HasChallenge
        {
            ...
            {
                return (
                    (m_Challenger != null && !m_Challenger.Deleted)
                    || (m_ChallengeGame != null && !m_ChallengeGame.Deleted)
                );
            }
        }
        ...
        {
            get { return m_ChallengeGame; }
            set { m_ChallengeGame = value; }
        }

        public BaseChallengeGame ChallengeSetup
        {
            get { return m_ChallengeSetup; }
            set { m_ChallengeSetup = value; }
        }
        ...
        public static void AddText(LanguageType t, int index, string text)
        {
            ...
            {
                Console.WriteLine(
                    "XmlPoints: Invalid language type {0}: increase hashtable size",
                    t
                );
                return;
            }
        ...
        public string Text(int index)
        {
            ...
            {
                Console.WriteLine(
                    "XmlPoints: Missing entry for {0} in language {1}",
                    index,
                    m_CurrentLanguage
                );
                ...
                {
                    Console.WriteLine(
                        "XmlPoints: Also missing entry for {0} in system language {1}",
                        index,
                        m_SystemLanguage
                    );
                    ...
                    {
                        Console.WriteLine(
                            "XmlPoints: And finally missing entry for {0} in default language {1}",
                            index,
        ...
        public static void SendColorText(
            Mobile from,
            int color,
            int msgindex,
            object arg,
        ...
        public static void BroadcastMessage(AccessLevel ac, int hue, string message)
        {
            foreach (NetState state in NetState.Instances)
            {
                ...
                if (m != null && m.AccessLevel >= ac)
                {
                    ...
                    ArrayList list = XmlAttach.FindAttachments(
                        XmlAttach.MobileAttachments,
                        m,
                        typeof(XmlPoints)
                    );
                    if (list != null && list.Count > 0)
        ...
        public static new void Initialize()
        {
            ...
            CommandSystem.Register(
                "PointsLanguage",
                AccessLevel.Player,
                new CommandEventHandler(Language_OnCommand)
            );
            CommandSystem.Register(
                "Challenge",
                AccessLevel.Player,
                new CommandEventHandler(Challenge_OnCommand)
            );
            CommandSystem.Register(
                "LMSChallenge",
                AccessLevel.Player,
                new CommandEventHandler(LMSChallenge_OnCommand)
            );
            CommandSystem.Register(
                "TeamLMSChallenge",
                AccessLevel.Player,
                new CommandEventHandler(TeamLMSChallenge_OnCommand)
            );
            CommandSystem.Register(
                "Deathmatch",
                AccessLevel.Player,
                new CommandEventHandler(Deathmatch_OnCommand)
            );
            CommandSystem.Register(
                "TeamDeathmatch",
                AccessLevel.Player,
                new CommandEventHandler(TeamDeathmatch_OnCommand)
            );
            CommandSystem.Register(
                "DeathBall",
                AccessLevel.Player,
                new CommandEventHandler(DeathBall_OnCommand)
            );
            CommandSystem.Register(
                "KingOfTheHill",
                AccessLevel.Player,
                new CommandEventHandler(KingOfTheHill_OnCommand)
            );
            CommandSystem.Register(
                "TeamDeathBall",
                AccessLevel.Player,
                new CommandEventHandler(TeamDeathBall_OnCommand)
            );
            CommandSystem.Register(
                "TeamKotH",
                AccessLevel.Player,
                new CommandEventHandler(TeamKotH_OnCommand)
            );
            CommandSystem.Register(
                "CTFChallenge",
                AccessLevel.Player,
                new CommandEventHandler(CTFChallenge_OnCommand)
            );
            CommandSystem.Register(
                "SystemBroadcastKills",
                AccessLevel.GameMaster,
                new CommandEventHandler(SystemBroadcastKills_OnCommand)
            );
            CommandSystem.Register(
                "SeeKills",
                AccessLevel.Player,
                new CommandEventHandler(SeeKills_OnCommand)
            );
            CommandSystem.Register(
                "BroadcastKills",
                AccessLevel.Player,
                new CommandEventHandler(BroadcastKills_OnCommand)
            );
            CommandSystem.Register(
                "CheckPoints",
                AccessLevel.Player,
                new CommandEventHandler(CheckPoints_OnCommand)
            );
            CommandSystem.Register(
                "TopPlayers",
                AccessLevel.Player,
                new CommandEventHandler(TopPlayers_OnCommand)
            );
            CommandSystem.Register(
                "AddAllPoints",
                AccessLevel.Administrator,
                new CommandEventHandler(AddAllPoints_OnCommand)
            );
            CommandSystem.Register(
                "RemoveAllPoints",
                AccessLevel.Administrator,
                new CommandEventHandler(RemoveAllPoints_OnCommand)
            );
            CommandSystem.Register(
                "LeaderboardSave",
                AccessLevel.Administrator,
                new CommandEventHandler(LeaderboardSave_OnCommand)
            );
        ...
        public static void WriteLeaderboardXml(string filename, int nranks)
        {
            ...
            for (int i = 0; i < RankList.Count; i++)
            {
                ...
                if (r.Killer != null && !r.Killer.Deleted && r.Rank > 0 && a != null && !a.Deleted)
                {
                    ...
                    if (
                        r.Killer is PlayerMobile
                        && ((PlayerMobile)r.Killer).FactionPlayerState != null
                    )
                        factionname = (
                            (PlayerMobile)r.Killer
                        ).FactionPlayerState.Faction.ToString();
#endif
        ...
        public static void WriteLeaderboardHtml(string filename, int nranks)
        {
...
#if(FACTIONS)
            sw.WriteLine(
                "<TR><TH><TH>Player Name<TH>Guild<TH>Faction<TH>Points<TH>Kills<TH>Deaths<TH>Rank<TH>Change<TH>Time at current rank"
            );
#else
            ...
            for (int i = 0; i < RankList.Count; i++)
            {
                ...
                if (r.Killer != null && !r.Killer.Deleted && r.Rank > 0 && a != null && !a.Deleted)
                {
                    ...
                    // write out the entry information
                    sw.WriteLine(
                        "<TR><TH><TD>{0}<TD>{1}<TD>{2}<TD>{3}<TD>{4}<TD>{5}<TD>{6}<TD>{7}<TD>{8}",
                        r.Killer.Name,
                        guildname,
                        factionname,
                        a.Points,
            ...
            if (e.Arguments.Length > 0)
            {
                ...
                if (e.Arguments[0].ToLower() != "off")
                {
                    ...
                    if (e.Arguments.Length > 1)
                    {
                        try
                        {
                            m_LeaderboardSaveInterval = TimeSpan.FromMinutes(
                                double.Parse(e.Arguments[1])
                            );
                        }
                        catch { }
                    }
                    ...
                    m_LeaderboardTimer = new LeaderboardTimer(
                        m_LeaderboardFile,
                        m_LeaderboardSaveInterval,
                        m_LeaderboardSaveRanks
                    );
        ...
        public static void Language_OnCommand(CommandEventArgs e)
        {
            ...
            if (e.Arguments.Length > 0)
            {
                try
                {
                    a.CurrentLanguage = (LanguageType)
                        Enum.Parse(typeof(LanguageType), e.Arguments[0], true);
                }
                catch { }
            }
        ...
        [Description(
            "GM override of broadcasting of pvp results.  False means no broadcasting. True means players settings are used."
        )]
        ...
        public static bool AreChallengers(Mobile from, Mobile target)
        {
            ...
            if (
                afrom.m_ChallengeGame != null
                && !afrom.m_ChallengeGame.Deleted
                && atarget.m_ChallengeGame == afrom.m_ChallengeGame
            )
            {
        ...
        public static bool AreInAnyGame(Mobile target)
        {
            ...
            if (
                atarget != null
                && !atarget.Deleted
                && atarget.m_ChallengeGame != null
                && !atarget.m_ChallengeGame.Deleted
            )
            {
        ...
        public static bool AreInSameGame(Mobile from, Mobile target)
        {
            ...
            if (
                afrom.m_ChallengeGame != null
                && !afrom.m_ChallengeGame.Deleted
                && afrom.m_ChallengeGame == atarget.m_ChallengeGame
            )
            {
                return afrom.m_ChallengeGame.AreInGame(target)
                    && afrom.m_ChallengeGame.AreInGame(target);
            }
        ...
        public static bool YoungProtection(Mobile from, Mobile target)
        {
            ...
            if (
                (
                    (target.SkillsTotal < 6000 && (from.SkillsTotal - target.SkillsTotal) > 1000)
                    || (
        ...
        public static bool AllowChallengeGump(Mobile from, Mobile target)
        {
            ...
            */
            ...
            if (
                from.Region.IsPartOf(typeof(Regions.Jail))
                || target.Region.IsPartOf(typeof(Regions.Jail))
            )
            {
                        ...
                        if (a.Challenger != null)
                        {
                            ...
                            else
                            {
                                ...
                                SendText(
                                    ...
                                    100210,
                                    from.Name,
                                    XmlPoints.CancelTimeout.TotalMinutes
                                ...
                                {
                                    XmlPoints ca = (XmlPoints)
                                        XmlAttach.FindAttachment(a.Challenger, typeof(XmlPoints));
        ...
        public class CancelTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                XmlPoints xa = (XmlPoints)
                    XmlAttach.FindAttachment(m_attachment.Challenger, typeof(XmlPoints));
                ...
                if (xa != null && !xa.Deleted)
                {
                    ...
                    if (xa.Challenger == from)
                    {
                        ...
                        {
                            m_attachment.Challenger.SendMessage(
                                String.Format(xa.Text(100214), from.Name)
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            if (
                m_Kills > 0
                && m_PointsDecay > 0
                && m_Points > DefaultStartingPoints
                && (DateTime.Now - m_LastDecay) > m_PointsDecayTime
                && (DateTime.Now - m_LastKill) > m_PointsDecayTime
                && (DateTime.Now - m_LastDeath) > m_PointsDecayTime
            )
            {
                m_Points -= m_PointsDecay;
                if (m_Points < DefaultStartingPoints)
                    m_Points = DefaultStartingPoints;
        ...
        public override void OnKill(Mobile killed, Mobile killer)
        {
            ...
            if (
                !(AttachedTo is Mobile)
                || !CanAffectPoints((Mobile)AttachedTo, killer, killed, false)
            )
            {
                awardpoints = false;
            }
            ...
            if (Broadcast && m_SystemBroadcast)
            {
                BroadcastMessage(
                    AccessLevel.Player,
                    0x482,
                    String.Format(SystemText(100216), killer.Name, killed.Name)
        ...
        public bool CanAffectPoints(Mobile from, Mobile killer, Mobile killed, bool assumechallenge)
        {
            ...
            if (
                (from == killer && m_Challenger == killed)
                || (from == killed && m_Challenger == killer)
            )
            {
                inchallenge = true;
            }
        ...
        public void ClearAggression(Mobile source, Mobile target)
        {
            ...
            if (klist != null && klist.Count > 0)
            {
                ...
                {
                    if (
                        ((AggressorInfo)klist[j]).Attacker == source
                        || ((AggressorInfo)klist[j]).Defender == source
                    )
                    {
        ...
        public override void OnKilled(Mobile killed, Mobile killer)
        {
            ...
            if (
                ChallengeGame != null
                && !ChallengeGame.Deleted
                && ChallengeGame.GetParticipant(killer) != null
                && ChallengeGame.GetParticipant(killed) != null
            )
            {
            ...
            if (killed == m_Challenger || killer == m_Challenger)
            {
                ...
                if (AutoResAfterDuel)
                {
                    ...
                    Timer.DelayCall(
                        ...
                        new TimerStateCallback(AutoRes_Callback),
                ...
                if (TeleportOnDuel)
                {
                    ...
                    Timer.DelayCall(
                        ...
                        new TimerStateCallback(Return_Callback),
            ...
            if (startpoints - Points > 0)
            {
                ...
                Timer.DelayCall(
                    ...
                    new TimerStateCallback(ReportPointLoss_Callback),
        ...
        public class PointsGump : Gump
        {
                ...
                : base(0, 0)
            {
                ...
                if (a.Challenger != null)
                {
                    ...
                    {
                        if (
                            (ca.m_CancelTimer != null && ca.m_CancelTimer.Running)
                            || (
                    ...
                    AddLabel(
                        ...
                        143,
                        challengehue,
                        String.Format(GetText(from, 200225), a.Challenger.Name)
                ...
                if (from == target)
                {
                    ...
                    AddButton(
                        x1,
                        165,
                        (a.ReceiveBroadcasts ? 0xD3 : 0xD2),
                        (a.ReceiveBroadcasts ? 0xD2 : 0xD3),
                        100,
                    ...
                    AddButton(
                        x2,
                        165,
                        (a.Broadcast ? 0xD3 : 0xD2),
                        (a.Broadcast ? 0xD2 : 0xD3),
                        200,
                        GumpButtonType.Reply,
                        0
                    );
                ...
                switch (info.ButtonID)
                {
                    case 100:
                        ...
                        state.Mobile.SendGump(
                            new PointsGump(m_attachment, state.Mobile, m_target, m_text)
                        );
                        break;
                    case 200:
                    ...
                    case 310:
                        // Challenge game info
                        if (
                            m_attachment.ChallengeGame != null
                            && !m_attachment.ChallengeGame.Deleted
                        )
                    ...
                    case 401:
                        // last man standing
                        BaseChallengeGame.DoSetupChallenge(
                            state.Mobile,
                            100302,
                            typeof(LastManStandingGauntlet)
                        );
                ...
                : base(0, 0)
            {
                ...
                for (int i = 0; i < RankList.Count; i++)
                {
                    ...
                    )
                    {
                            ...
                            if (args != null)
                            {
                                ...
                                foreach (string arg in args)
                                {
                                    if (
                                        ...
                                        && r.Killer.Name != null
                                        && (
                                            r.Killer.Name.ToLower().IndexOf(arg.Trim().ToLower())
                                            >= 0
                                        )
                                    )
                                    {
                        ...
                        int mins = (int)(
                            timeranked.TotalMinutes - ((int)timeranked.TotalHours) * 60
                        );
        ...
        private class IssueChallengeGump : Gump
        {
                ...
                : base(0, 0)
            {
                ...
                if (
                    ...
                    || atarg == null
                    || atarg.Deleted
                    || !a.CanAffectPoints(from, from, target, true)
                )
                {
                ...
                switch (info.ButtonID)
                {
                    default:
                    {
                        if (radiostate > 1)
                        {
                            // issue the challenge
                            m_Target.SendGump(
                                new ConfirmChallengeGump(
                                    m_From,
                                    m_Target,
                                    XmlPoints.DuelLocations[radiostate - 2]
                                )
                            );
                ...
                : base(0, 0)
            {
                ...
                else
                {
                    AddLabel(
                        ...
                        y,
                        0,
                        String.Format(GetText(target, 200649), GetText(target, 200661))
                    ); // "Location: Duel Here"
                }
                y += 20;
                ...
                switch (info.ButtonID)
                {
                    default:
                    {
                        if (radiostate == 1)
                        {
                            ...
                            if (
                                m_DuelLocation != null
                                && !XmlPoints.DuelLocationAvailable(m_DuelLocation)
                            )
                            {
                            ...
                            XmlPoints a = (XmlPoints)
                                XmlAttach.FindAttachment(m_From, typeof(XmlPoints));

                            // first confirm that they dont already have a challenge going
                            if (
                                a != null
                                && !a.Deleted
                                && (a.Challenger != null || a.ChallengeGame != null)
                            )
                            {
                            ...
                            XmlPoints ta = (XmlPoints)
                                XmlAttach.FindAttachment(m_Target, typeof(XmlPoints));

                            // first confirm that they dont already have a challenge going
                            if (
                                ta != null
                                && !ta.Deleted
                                && (ta.Challenger != null || ta.ChallengeGame != null)
                            )
                            {
                            ...
                            m_From.Send(
                                new MobileMoving(m_Target, Notoriety.Compute(m_From, m_Target))
                            );
                            ...
                            m_Target.Send(
                                new MobileMoving(m_From, Notoriety.Compute(m_Target, m_From))
                            );
