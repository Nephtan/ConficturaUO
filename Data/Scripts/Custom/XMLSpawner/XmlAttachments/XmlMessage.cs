...
namespace Server.Engines.XmlSpawner2
{
    public class XmlMessage : XmlAttachment
    {
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            {
                msg = String.Format(
                    "{0} : {1} secs between uses, {2} charges left",
                    Message,
                    Refractory.TotalSeconds,
                    Charges
                );
            }
            else
        ...
        {
            get { return (ActivationWord != null); }
        }
        ...
        public override void OnMovement(MovementEventArgs e)
        {
            ...
            )
            {
                ...
                && Utility.InRange(e.Mobile.Location, ((Mobile)AttachedTo).Location, proximityrange)
            )
            {
                OnTrigger(null, e.Mobile);
            }
        ...
        public override void OnTrigger(object activator, Mobile m)
        {
            ...
            {
                ((Mobile)AttachedTo).PublicOverheadMessage(
                    MessageType.Regular,
                    0x3B2,
                    true,
                    Message
