...
namespace Server.Engines.XmlSpawner2
{
    public class XmlSkill : XmlAttachment
    {
        ...
        {
            get { return m_RequireIdentification; }
        ...
        public override string OnIdentify(Mobile from)
        {
            if (AttachedTo is BaseArmor || AttachedTo is BaseWeapon)
            {
                ...
                return String.Format(
                    "activated by {0} : skill {1} mod of {2} when equipped",
                    m_Word,
                    m_Skill,
                    m_Value
                );
            ...
            {
                return String.Format(
                    "activated by {0} : skill {1} mod of {2} lasting {3} mins",
                    m_Word,
                    m_Skill,
                    m_Value,
        ...
        public override void OnTrigger(object activator, Mobile m)
        {
            ...
            if (
                (AttachedTo is BaseArmor || AttachedTo is BaseWeapon)
                && (((Item)AttachedTo).Layer != Layer.Invalid)
            )
            {
