    ...
    public class XmlSaveItem : XmlAttachment
    {
        ...
        public Item SavedItem
        {
            get
            {
                ...
                if (
                    m_SavedItem != null
                    && (m_SavedItem.Parent != m_Container || m_SavedItem.Deleted)
                )
                {
                    m_WasOwnedBy = null;
                    m_SavedItem = null;
        ...
        public bool RestoreItem
        {
            ...
            set
            {
                if (
                    ...
                    && ((IEntity)AttachedTo).Map != Map.Internal
                    && ((IEntity)AttachedTo).Map != null
                )
                {
