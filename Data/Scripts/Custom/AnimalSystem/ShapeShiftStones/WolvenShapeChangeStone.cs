...
{
    public class WolvenShapeShiftStone : Item
    {
        [Constructable]
        public WolvenShapeShiftStone()
            : base(0x1870)
        {
            Name = "a Wolven ShapeShift Stone";
            Movable = false;
            LootType = LootType.Blessed;
            Hue = 1952;
        }

        public WolvenShapeShiftStone(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            private WolvenShapeShiftStone wss;
            private Mobile user;

            public HueGump(WolvenShapeShiftStone shiftstone, Mobile from)
                : base(150, 150)
            {
                wss = shiftstone;
                user = from;
        ...
        private class ChangeHue : ContextMenuEntry
        {
            ...
            public ChangeHue(WolvenShapeShiftStone wsss, Mobile from)
                : base(0313, 1)
            {
                WSS = wsss;
                m_From = from;
