...
namespace Server.Voting
{
    ...
    public sealed class VoteConfig
    {
        ...
        /// </summary>
        public static string GlobalDefaultName = NameList.RandomName("UOGateway.com");

        /// <summary>
        /// The default URL to launch in the request senders' browser.
        /// </summary>
        public static string GlobalDefaultURL =
            "https://www.uogateway.com/shard.php?id=1429&act=vote";
        ...
        * ============================================================== *
        ...
        /// </summary>
        [CommandProperty(AccessLevel.GameMaster)]
        public TimeSpan DefaultCoolDown
        {
            get { return _DefaultCoolDown; }
