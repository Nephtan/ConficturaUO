...
namespace Server.Mobiles
{
    public class Publisher : BaseVendor
    {
        ...
        public Publisher(Serial serial)
            : base(serial) { }
        ...
        {
            get { return NpcGuild.BardsGuild; }
        }
        ...
        private void Publish(Mobile contributor, BaseBook book)
        {
            ...
            if (!publishedBook.IsPublishable())
            {
                ...
                this.SayTo(
                    contributor,
                    "You might want to try writing something of interest first."
                );
            }
            else if (XmlBook.Save(publishedBook))
            {
                switch (Utility.Random(3))
                {
                    case 0:
                    {
                        ...
                        this.SayTo(
                            contributor,
                            "This seems to be a excellent material. Let me see... hm... here - your royalty. You should see the story soon. I am sure it will sell well."
                        );
                    ...
                    case 1:
                    {
                        ...
                        this.SayTo(
                            contributor,
                            "This seems to be decent material. Let me see... hm... here - your royalty. You should see the story soon. I hope it will sell well."
                        );
                    ...
                    case 2:
                    {
                        ...
                        this.SayTo(
                            contributor,
                            "I don't know if this is good enough to be sold, but let me see... hm... here - I can't give you more for this. I am not sure it will sell at all."
                        );
        ...
        private void Republish(Mobile contributor, PublishedBook book)
        {
            ...
            else if (book.IsModified())
            {
                ...
                if (XmlBook.Save(book))
                {
                    ...
                    this.SayTo(
                        contributor,
                        "Your book appears to have changed. Let me publish that for you!"
                    );
                    contributor.SendMessage("You receive some gold.");
                    if (m_Sound)
                        Effects.PlaySound(contributor.Location, contributor.Map, 0x2E5);
                ...
                else
                {
                    this.SayTo(
                        contributor,
                        "Our machines are not working right. Check back later."
                    );
                }
            }
            else
