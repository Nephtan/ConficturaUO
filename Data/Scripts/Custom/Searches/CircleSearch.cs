...
namespace Server.Searches
{
    ...
    public class CircleSearch
    {
        ...
        //--------------------------------------------------------------------------------------------------
        public bool SearchCircle(Map map, int radius, Tour tour)
        {
            return SearchCircle(map, radius, ClockDirection.CounterClockwise, tour);
        }

        //--------------------------------------------------------------------------------------------------
        public bool SearchCircle(Map map, int radius, ClockDirection clockDirection, Tour tour)
        {
        ...
        {
            return SearchConcentricCircles(
                map,
                start,
