...
namespace Server.Items
{
    public class AlmondCookies : ContainerFood
    {
        ...
        {
            get { return "You make some almond cookies."; }
        }
    ...
    public class ChocChipCookies : ContainerFood
    {
        ...
        public override string CookedMessage
        {
            get { return "You make some chocolate chip cookies."; }
        }
        public override Item FoodContainer
        {
            get { return new DirtyPlate(); }
    ...
    public class GingerSnaps : ContainerFood
    {
        ...
        public override string CookedMessage
        {
            get { return "You make some ginger snaps."; }
        }
        public override Item FoodContainer
        {
            get { return new DirtyPlate(); }
    ...
    public class OatmealCookies : ContainerFood
    {
        ...
        public override string CookedMessage
        {
            get { return "You make some oatmeal cookies."; }
        }
        public override Item FoodContainer
        {
            get { return new DirtyPlate(); }
    ...
    public class PeanutButterCookies : ContainerFood
    {
        ...
        public override string CookedMessage
        {
            get { return "You make some peanut butter cookies."; }
        }
        public override Item FoodContainer
        {
            get { return new DirtyPlate(); }
    ...
    public class PumpkinCookies : ContainerFood
    {
        ...
        public override string CookedMessage
        {
            get { return "You make some pumpkin cookies."; }
        }
        public override Item FoodContainer
        {
            get { return new DirtyPlate(); }
