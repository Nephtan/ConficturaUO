...
namespace Server.Items
{
            ...
            else
            {
                ...
                )
                {
                    this.PublicOverheadMessage(
                        ...
                        false,
                        string.Format(
                            "Fermentation process: " + StadeFermentation.ToString() + " %"
                        )
                    );
                }
                else if (
                ...
                )
                {
                    if (m_FromBonusSkill < 10)
                    {
                        this.PublicOverheadMessage(
                            ...
                            1152,
                            false,
                            string.Format("Fermentation failed, the milk is lost.")
                        );
                    ...
                    { // m_FromBonusSkill is random 1-100 + cooking/5
                        if (FromAfaire == 1)
                        {
                            from.SendMessage(
                                0x84C,
                                "You obtain a wonderful Roquefort from the form."
                            );
                        ...
                        else if (FromAfaire == 2)
                        {
                            from.SendMessage(
                                0x84C,
                                "You obtain a wonderful crottin de Chavignol from the form."
                            );
                        ...
                        else
                        {
                            from.SendMessage(
                                0x84C,
                                "You obtain a wonderful Maroille from the form."
                            );
                    ...
                    else // ((m_FromBonusSkill >= 10 )&& (m_FromBonusSkill < 95 ))
                    {
                        if (FromAfaire == 1)
                        {
                            from.SendMessage(
                                0x84C,
                                "You obtain a wonderful sheep cheese from the form."
                            );
                        ...
                        else if (FromAfaire == 2)
                        {
                            from.SendMessage(
                                0x84C,
                                "You obtain a wonderful goat cheese from the form."
                            );
                        ...
                        else
                        {
                            from.SendMessage(
                                0x84C,
                                "You obtain a wonderful cow cheese from the form."
                            );
    ...
    public class OnRempliMouleFromton : Target
    {
        ...
        public OnRempliMouleFromton(CheeseForm m_CheeseForm)
            ...
            if (o is MilkBucket)
            {
                ...
                if (m_SautFromage.Laitage >= 15)
                {
                    ...
                    if (m_SautFromage.m_bestiole == 1)
                    {
                        m_SautFromage.Name =
                            "Milk Bucket: "
                            + m_SautFromage.Laitage.ToString()
                            + "/50 liters of sheep milk.";
