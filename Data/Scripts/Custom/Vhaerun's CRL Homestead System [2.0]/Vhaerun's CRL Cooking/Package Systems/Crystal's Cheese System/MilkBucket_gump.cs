...
namespace Server.Gumps
{
    public class LaitageHelpGump : Gump
    {
        ...
        public LaitageHelpGump(Object state)
            : base(30, 30)
        {
            Closable = true;
            Dragable = true;
