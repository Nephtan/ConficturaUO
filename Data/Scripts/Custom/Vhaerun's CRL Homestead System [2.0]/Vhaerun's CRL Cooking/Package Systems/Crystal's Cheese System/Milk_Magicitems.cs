...
namespace Server.Items
{
    public abstract class BaseMagicCheese : Item
    {
        ...
        public BaseMagicCheese(int hue)
            : base(0x97E)
        {
            Weight = 1.0;
        ...
        public BaseMagicCheese(Serial serial)
            : base(serial) { }

        public virtual bool Apply(Mobile from)
        {
            bool applied = Spells.SpellHelper.AddStatOffset(
                from,
                Type,
                Bonus,
    ...
    public class FromageDeChevreMagic : BaseMagicCheese
    {
        ...
        [Constructable]
        public FromageDeChevreMagic()
            : base(151)
        {
            this.Name = "crottin de Chavignol (magic goat cheese)";
        }

        public FromageDeChevreMagic(Serial serial)
            : base(serial) { }
    ...
    public class FromageDeVacheMagic : BaseMagicCheese
    {
        ...
        [Constructable]
        public FromageDeVacheMagic()
            : base(151)
        {
            this.Name = "Maroille (magic cow cheese)";
        }

        public FromageDeVacheMagic(Serial serial)
            : base(serial) { }
    ...
    public class FromageDeBrebisMagic : BaseMagicCheese
    {
        ...
        [Constructable]
        public FromageDeBrebisMagic()
            : base(151)
        {
            this.Name = "Roquefort (magic sheep cheese)";
        }

        public FromageDeBrebisMagic(Serial serial)
            : base(serial) { }
