...
namespace Server.Items
{
    ...
    public class BottleCowMilk : MilkBottle
    {
        ...
        public BottleCowMilk(Serial serial)
            : base(serial) { }
    ...
    public class BottleGoatMilk : MilkBottle
    {
        ...
        public BottleGoatMilk(Serial serial)
            : base(serial) { }
    ...
    public class BottleSheepMilk : MilkBottle
    {
        ...
        public BottleSheepMilk(Serial serial)
            : base(serial) { }
    ...
    public class FromageDeVache : Food, ICarvable
    {
        ...
        [Constructable]
        public FromageDeVache()
            : this(1) { }

        [Constructable]
        public FromageDeVache(int amount)
            : base(amount, 0x97E)
        {
            this.Weight = 0.4;
            this.FillFactor = 12;
        ...
        public FromageDeVache(Serial serial)
            : base(serial) { }
    ...
    public class FromageDeVacheWedge : Food, ICarvable
    {
        ...
        [Constructable]
        public FromageDeVacheWedge()
            : this(1) { }

        [Constructable]
        public FromageDeVacheWedge(int amount)
            : base(amount, 0x97D)
        {
            this.Weight = 0.3;
            this.FillFactor = 9;
        ...
        public FromageDeVacheWedge(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public FromageDeVacheWedgeSmall()
            : this(1) { }

        [Constructable]
        public FromageDeVacheWedgeSmall(int amount)
            : base(amount, 0x97C)
        {
            this.Weight = 0.1;
            this.FillFactor = 3;
        ...
        public FromageDeVacheWedgeSmall(Serial serial)
            : base(serial) { }
    ...
    public class FromageDeBrebis : Food, ICarvable
    {
        ...
        [Constructable]
        public FromageDeBrebis()
            : this(1) { }

        [Constructable]
        public FromageDeBrebis(int amount)
            : base(amount, 0x97E)
        {
            this.Weight = 0.4;
            this.FillFactor = 12;
        ...
        public FromageDeBrebis(Serial serial)
            : base(serial) { }
    ...
    public class FromageDeBrebisWedge : Food, ICarvable
    {
        ...
        [Constructable]
        public FromageDeBrebisWedge()
            : this(1) { }

        [Constructable]
        public FromageDeBrebisWedge(int amount)
            : base(amount, 0x97D)
        {
            this.Weight = 0.3;
            this.FillFactor = 9;
        ...
        public FromageDeBrebisWedge(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public FromageDeBrebisWedgeSmall()
            : this(1) { }

        [Constructable]
        public FromageDeBrebisWedgeSmall(int amount)
            : base(amount, 0x97C)
        {
            this.Weight = 0.1;
            this.FillFactor = 3;
        ...
        public FromageDeBrebisWedgeSmall(Serial serial)
            : base(serial) { }
    ...
    public class FromageDeChevre : Food, ICarvable
    {
        ...
        [Constructable]
        public FromageDeChevre(int amount)
            : base(amount, 0x97E)
        {
            this.Weight = 0.4;
            this.FillFactor = 12;
        ...
        public FromageDeChevre(Serial serial)
            : base(serial) { }
    ...
    public class FromageDeChevreWedge : Food, ICarvable
    {
        ...
        [Constructable]
        public FromageDeChevreWedge()
            : this(1) { }

        [Constructable]
        public FromageDeChevreWedge(int amount)
            : base(amount, 0x97D)
        {
            this.Weight = 0.3;
            this.FillFactor = 9;
        ...
        public FromageDeChevreWedge(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public FromageDeChevreWedgeSmall()
            : this(1) { }

        [Constructable]
        public FromageDeChevreWedgeSmall(int amount)
            : base(amount, 0x97C)
        {
            this.Weight = 0.1;
            this.FillFactor = 3;
        ...
        public FromageDeChevreWedgeSmall(Serial serial)
            : base(serial) { }
