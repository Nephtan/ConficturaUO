...
namespace Server.Items
{
    ...
    public class FromQuiFermente : Timer
    {
        ...
        public FromQuiFermente(CheeseForm m_TimerCheeseForm)
            : base(TimeSpan.FromSeconds(1), TimeSpan.FromSeconds(72), 100) //base( TimeSpan.FromSeconds(delai avant premier tick),TimeSpan.FromSeconds(durée du tick),nombre de répétition)
        {
