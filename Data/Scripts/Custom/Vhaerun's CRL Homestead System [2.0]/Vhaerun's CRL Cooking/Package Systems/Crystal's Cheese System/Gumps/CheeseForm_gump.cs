...
namespace Server.Gumps
{
    public class CheeseFormHelpGump : Gump
    {
        ...
        public CheeseFormHelpGump(Object state)
            : base(30, 30)
        {
            Closable = true;
            Dragable = true;
