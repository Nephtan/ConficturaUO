...
namespace Server.Items
{
    ...
    public class Silverware : Item
    {
        ...
        [Constructable]
        public Silverware()
            : this(Utility.RandomList(0x9BD, 0x9BE, 0x9D5, 0x9D4)) { }
    ...
    public class SilverwareN : Silverware
    {
        ...
        public SilverwareN(Serial serial)
            : base(serial) { }
    ...
    public class SilverwareS : Silverware
    {
        ...
        public SilverwareS(Serial serial)
            : base(serial) { }
    ...
    public class SilverwareE : Silverware
    {
        ...
        public SilverwareE(Serial serial)
            : base(serial) { }
    ...
    public class SilverwareW : Silverware
    {
        ...
        public SilverwareW(Serial serial)
            : base(serial) { }
