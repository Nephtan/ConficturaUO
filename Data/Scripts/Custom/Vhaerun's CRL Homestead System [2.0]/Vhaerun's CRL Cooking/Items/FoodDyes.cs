    ...
    public class FoodDyes : Item
    {
        ...
        private class InternalTarget : Target
        {
            ...
            private class InternalPicker : HuePicker
            {
                ...
                public InternalPicker(Item mixture)
                    : base(mixture.ItemID)
                {
                    m_Mixture = mixture;
                }
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                if (
                    targeted is CakeMix
                    || targeted is CookieMix
                    || targeted is FruitCakeMix
                    || targeted is MeatCakeMix
                    || targeted is VegetableCakeMix
                )
                {
