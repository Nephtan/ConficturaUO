...
namespace Server.Items
{
    public abstract class BaseHops : Item, ICommodity
    {
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                ...
                case 0:
                {
                    ...
                    {
                        case 0:
                            info = HopsInfo.BitterHops;
                            break;
                        case 1:
                            info = HopsInfo.SnowHops;
                            break;
                        case 2:
                            info = HopsInfo.ElvenHops;
                            break;
                        case 3:
                            info = HopsInfo.SweetHops;
                            break;
                        default:
                            info = null;
                            break;
        ...
        public BaseHops(HopsVariety variety)
            : this(variety, 1) { }

        public BaseHops(HopsVariety variety, int amount)
            : base(0x1AA2)
        {
            Stackable = true;
            Weight = 0.1;
        ...
        public override void AddNameProperty(ObjectPropertyList list)
        {
            if (Amount > 1)
                list.Add(
                    ...
                    "{0}\t{1}",
                    Amount,
                    "Bunches of " + BrewingResources.GetName(m_Variety) + " Cones"
                ); // ~1_NUMBER~ ~2_ITEMNAME~
            else
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            if (this.Amount > 1)
                this.LabelTo(
                    from,
                    "{0} Hops Bunches : {1}",
                    BrewingResources.GetName(m_Variety),
                    Amount
                );
            else
                this.LabelTo(from, "{0} Hops Bunch", BrewingResources.GetName(m_Variety));
        }
    }
    ...
    public class BitterHops : BaseHops
    {
        ...
        public BitterHops(int amount)
            : base(HopsVariety.BitterHops, amount)
        {
            Name = "Bitter Hops";
        }
    ...
    public class SnowHops : BaseHops
    {
        ...
        public SnowHops(int amount)
            : base(HopsVariety.SnowHops, amount) { }
    ...
    public class ElvenHops : BaseHops
    {
        ...
        public ElvenHops(int amount)
            : base(HopsVariety.ElvenHops, amount) { }
    ...
    public class SweetHops : BaseHops
    {
        ...
        public SweetHops(int amount)
            : base(HopsVariety.SweetHops, amount) { }
