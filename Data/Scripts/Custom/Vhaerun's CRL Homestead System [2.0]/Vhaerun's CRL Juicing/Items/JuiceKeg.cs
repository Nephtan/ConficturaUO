...
namespace Server.Items
{
    public class JuiceKeg : Item, ICraftable
    {
            ...
            get
            {
                if (!m_AllowBottling)
                    m_AllowBottling = (
                        0
                        >= TimeSpan.Compare(
                            TimeSpan.FromSeconds(m_BottleDuration),
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            {
                list.Add(1060847, "Fresh\t{0}", JuiceType);
            }
            else
            {
        ...
        public BaseCraftJuice FillBottle()
        {
            switch (m_Variety)
            {
                default:
                    return new BottleOfJuice();
            }
        }
