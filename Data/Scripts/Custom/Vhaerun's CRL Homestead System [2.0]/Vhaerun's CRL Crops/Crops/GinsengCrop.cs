...
{
    public class GinsengSeed : BaseCrop
    {
    ...
    public class GinsengSeedling : BaseCrop
    {
        ...
        [Constructable]
        public GinsengSeedling(Mobile sower)
            : base(0xC7E)
        {
            Movable = false;
    ...
    public class GinsengCrop : BaseCrop
    {
        ...
        [Constructable]
        public GinsengCrop(Mobile sower)
            : base(0x18EA)
        {
            Movable = false;
            Name = "Ginseng Plant";
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(GinsengCrop plant)
