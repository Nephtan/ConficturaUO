...
namespace Server.Items.Crops
{
    public class CelerySeed : BaseCrop
    {
        ...
        public CelerySeed(Serial serial)
            : base(serial) { }
    ...
    public class CelerySeedling : BaseCrop
    {
        ...
        [Constructable]
        public CelerySeedling(Mobile sower)
            : base(0xC68)
        {
            Movable = false;
        ...
        public CelerySeedling(Serial serial)
            : base(serial) { }
    ...
    public class CeleryCrop : BaseCrop
    {
        ...
        [Constructable]
        public CeleryCrop(Mobile sower)
            : base(0xC69)
        {
            Movable = false;
            Name = "Celery Plant";
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(CeleryCrop plant)
        ...
        public CeleryCrop(Serial serial)
            : base(serial) { }
