...
{
    public class SnowPeasSeed : BaseCrop
    {
        ...
        [Constructable]
        public SnowPeasSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public SnowPeasSeed(Serial serial)
            : base(serial) { }
    ...
    public class SnowPeasSeedling : BaseCrop
    {
        ...
        [Constructable]
        public SnowPeasSeedling(Mobile sower)
        ...
        public SnowPeasSeedling(Serial serial)
            : base(serial) { }
    ...
    public class SnowPeasCrop : BaseCrop
    {
        ...
        [Constructable]
        public SnowPeasCrop(Mobile sower)
            : base(0xCF2)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(SnowPeasCrop plant)
        ...
        public SnowPeasCrop(Serial serial)
            : base(serial) { }
