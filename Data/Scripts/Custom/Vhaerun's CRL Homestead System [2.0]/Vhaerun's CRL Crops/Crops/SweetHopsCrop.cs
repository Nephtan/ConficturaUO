...
{
    public class SweetHopsSeed : BaseCrop
    {
        ...
        [Constructable]
        public SweetHopsSeed()
            : this(1) { }

        [Constructable]
        public SweetHopsSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public SweetHopsSeed(Serial serial)
            : base(serial) { }
    ...
    public class SweetHopsSeedling : BaseCrop
    {
        ...
        [Constructable]
        public SweetHopsSeedling(Mobile sower)
            : base(0xC7E)
        {
            Movable = false;
        ...
        public SweetHopsSeedling(Serial serial)
            : base(serial) { }
    ...
    public class SweetHopsCrop : BaseCrop
    {
        ...
        [Constructable]
        public SweetHopsCrop(Mobile sower)
            : base(0x1AA1)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(SweetHopsCrop plant)
        ...
        public SweetHopsCrop(Serial serial)
            : base(serial) { }
