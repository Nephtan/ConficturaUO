...
{
    public class PearTreeSeed : BaseCrop
    {
    ...
    public class PearTree : BaseTree
    {
        ...
        [Constructable]
        public PearTree(Point3D pnt, Map map)
        ...
        private class FruitTimer : Timer
        {
            ...
            public FruitTimer(PearTree plant)
        ...
        private class StumpTimer : Timer
        {
            ...
            public StumpTimer(PearTree Tree, FruitTreeStump Stump, Mobile from)
