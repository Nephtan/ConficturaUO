...
namespace Server.Items.Crops
{
    ...
    public class HaySeedling : BaseCrop
    {
        ...
        [Constructable]
        public HaySeedling(Mobile sower)
        ...
        public HaySeedling(Serial serial)
            : base(serial) { }
    ...
    public class HayCrop : BaseCrop
    {
        ...
        public static void init(HayCrop plant, bool full)
        {
        ...
        {
            private HayCrop i_plant;

            public CropTimer(HayCrop plant)
