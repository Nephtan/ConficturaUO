...
{
    public class SnowHopsSeed : BaseCrop
    {
        ...
        [Constructable]
        public SnowHopsSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public SnowHopsSeed(Serial serial)
            : base(serial) { }
    ...
    public class SnowHopsSeedling : BaseCrop
    {
        ...
        [Constructable]
        public SnowHopsSeedling(Mobile sower)
            : base(0xC7E)
        {
            Movable = false;
        ...
        public SnowHopsSeedling(Serial serial)
            : base(serial) { }
    ...
    public class SnowHopsCrop : BaseCrop
    {
        ...
        [Constructable]
        public SnowHopsCrop(Mobile sower)
            : base(0x1AA1)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(SnowHopsCrop plant)
        ...
        public SnowHopsCrop(Serial serial)
            : base(serial) { }
