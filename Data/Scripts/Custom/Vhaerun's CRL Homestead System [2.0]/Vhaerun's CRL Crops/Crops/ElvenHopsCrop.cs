...
{
    public class ElvenHopsSeed : BaseCrop
    {
        ...
        [Constructable]
        public ElvenHopsSeed()
            : this(1) { }

        [Constructable]
        public ElvenHopsSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public ElvenHopsSeed(Serial serial)
            : base(serial) { }
    ...
    public class ElvenHopsSeedling : BaseCrop
    {
        ...
        [Constructable]
        public ElvenHopsSeedling(Mobile sower)
            : base(0xC7E)
        {
            Movable = false;
        ...
        public ElvenHopsSeedling(Serial serial)
            : base(serial) { }
    ...
    public class ElvenHopsCrop : BaseCrop
    {
        ...
        [Constructable]
        public ElvenHopsCrop(Mobile sower)
            : base(0x1AA1)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(ElvenHopsCrop plant)
        ...
        public ElvenHopsCrop(Serial serial)
            : base(serial) { }
