...
{
    public class RedPepperSeed : BaseCrop
    {
        ...
        [Constructable]
        public RedPepperSeed()
            : this(1) { }

        [Constructable]
        public RedPepperSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public RedPepperSeed(Serial serial)
            : base(serial) { }
    ...
    public class RedPepperSeedling : BaseCrop
    {
        ...
        [Constructable]
        public RedPepperSeedling(Mobile sower)
        ...
        public RedPepperSeedling(Serial serial)
            : base(serial) { }
    ...
    public class RedPepperCrop : BaseCrop
    {
        ...
        [Constructable]
        public RedPepperCrop(Mobile sower)
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(RedPepperCrop plant)
        ...
        public RedPepperCrop(Serial serial)
            : base(serial) { }
