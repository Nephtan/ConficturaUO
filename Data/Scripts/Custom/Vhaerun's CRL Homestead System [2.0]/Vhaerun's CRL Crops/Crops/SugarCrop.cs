...
{
    public class SugarSeed : BaseCrop
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            this.Consume();
            Item item = new SugarSeedling(from);
            item.Location = m_pnt;
            item.Map = m_map;
        }

        public SugarSeed(Serial serial)
            : base(serial) { }
    ...
    public class SugarSeedling : BaseCrop
    {
        ...
        [Constructable]
        public SugarSeedling(Mobile sower)
            : base(Utility.RandomList(0x1EBE, 0x1EBF))
        {
            Movable = false;
            Name = "Sugarcane Seedling";
            m_sower = sower;
            Hue = 0x238;
        ...
        public static void init(SugarSeedling plant)
        {
            plant.thisTimer = new CropHelper.GrowTimer(plant, typeof(SugarCrop), plant.Sower);
        ...
        public SugarSeedling(Serial serial)
            : base(serial) { }
    ...
    public class SugarCrop : BaseCrop
    {
        ...
        [Constructable]
        public SugarCrop(Mobile sower)
            : base(Utility.RandomList(0xC58, 0xC59))
        {
            Movable = false;
            Name = "Sugarcane";
            Hue = 0x237;
        ...
        public static void init(SugarCrop plant, bool full)
        {
        ...
        {
            private SugarCrop i_plant;

            public CropTimer(SugarCrop plant)
        ...
        public SugarCrop(Serial serial)
            : base(serial) { }
