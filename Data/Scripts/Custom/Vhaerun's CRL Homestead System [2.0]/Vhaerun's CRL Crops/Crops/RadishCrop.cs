...
{
    public class RadishSeed : BaseCrop
    {
        ...
        public RadishSeed(Serial serial)
            : base(serial) { }
    ...
    public class RadishSeedling : BaseCrop
    {
        ...
        [Constructable]
        public RadishSeedling(Mobile sower)
            : base(0xC68)
        {
            Movable = false;
        ...
        public RadishSeedling(Serial serial)
            : base(serial) { }
    ...
    public class RadishCrop : BaseCrop
    {
        ...
        [Constructable]
        public RadishCrop(Mobile sower)
            : base(0xC69)
        {
            Movable = false;
            Name = "Radish Plant";
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(RadishCrop plant)
        ...
        public RadishCrop(Serial serial)
            : base(serial) { }
