...
{
    public class BitterHopsSeed : BaseCrop
    {
        ...
        [Constructable]
        public BitterHopsSeed()
            : this(1) { }

        [Constructable]
        public BitterHopsSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public BitterHopsSeed(Serial serial)
            : base(serial) { }
    ...
    public class BitterHopsSeedling : BaseCrop
    {
        ...
        [Constructable]
        public BitterHopsSeedling(Mobile sower)
            : base(0xC7E)
        {
            Movable = false;
        ...
        public BitterHopsSeedling(Serial serial)
            : base(serial) { }
    ...
    public class BitterHopsCrop : BaseCrop
    {
        ...
        [Constructable]
        public BitterHopsCrop(Mobile sower)
            : base(0x1AA1)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(BitterHopsCrop plant)
        ...
        public BitterHopsCrop(Serial serial)
            : base(serial) { }
