...
{
    public class OrangePepperSeed : BaseCrop
    {
        ...
        [Constructable]
        public OrangePepperSeed()
            : this(1) { }

        [Constructable]
        public OrangePepperSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public OrangePepperSeed(Serial serial)
            : base(serial) { }
    ...
    public class OrangePepperSeedling : BaseCrop
    {
        ...
        [Constructable]
        public OrangePepperSeedling(Mobile sower)
            : base(Utility.RandomList(0xCB6, 0xCB0))
        {
            Movable = false;
        ...
        {
            plant.thisTimer = new CropHelper.GrowTimer(
                plant,
                typeof(OrangePepperCrop),
                plant.Sower
            );
        ...
        public OrangePepperSeedling(Serial serial)
            : base(serial) { }
    ...
    public class OrangePepperCrop : BaseCrop
    {
        ...
        [Constructable]
        public OrangePepperCrop(Mobile sower)
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(OrangePepperCrop plant)
        ...
        public OrangePepperCrop(Serial serial)
            : base(serial) { }
