...
{
    public class SweetPotatoSeed : BaseCrop
    {
        ...
        [Constructable]
        public SweetPotatoSeed()
            : this(1) { }

        [Constructable]
        public SweetPotatoSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public SweetPotatoSeed(Serial serial)
            : base(serial) { }
    ...
    public class SweetPotatoSeedling : BaseCrop
    {
        ...
        [Constructable]
        public SweetPotatoSeedling(Mobile sower)
            : base(0xCB6)
        {
            Movable = false;
        ...
        public SweetPotatoSeedling(Serial serial)
            : base(serial) { }
    ...
    public class SweetPotatoCrop : BaseCrop
    {
        ...
        [Constructable]
        public SweetPotatoCrop(Mobile sower)
            : base(0xC63)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(SweetPotatoCrop plant)
        ...
        public SweetPotatoCrop(Serial serial)
            : base(serial) { }
