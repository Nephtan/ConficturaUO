...
namespace Server.Items.Crops
{
    public class FieldCornSeed : BaseCrop
    {
        ...
        [Constructable]
        public FieldCornSeed()
            : this(1) { }

        [Constructable]
        public FieldCornSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public FieldCornSeed(Serial serial)
            : base(serial) { }
    ...
    public class FieldCornSeedling : BaseCrop
    {
        ...
        [Constructable]
        public FieldCornSeedling(Mobile sower)
            : base(0xCB5)
        {
            Movable = false;
        ...
        public FieldCornSeedling(Serial serial)
            : base(serial) { }
    ...
    public class FieldCornCrop : BaseCrop
    {
        ...
        [Constructable]
        public FieldCornCrop(Mobile sower)
            : base(0xC7E)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(FieldCornCrop plant)
        ...
        public FieldCornCrop(Serial serial)
            : base(serial) { }
