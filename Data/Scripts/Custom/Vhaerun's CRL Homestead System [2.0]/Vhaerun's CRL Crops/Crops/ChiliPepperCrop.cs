...
{
    public class ChiliPepperSeed : BaseCrop
    {
        ...
        [Constructable]
        public ChiliPepperSeed()
            : this(1) { }

        [Constructable]
        public ChiliPepperSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public ChiliPepperSeed(Serial serial)
            : base(serial) { }
    ...
    public class ChiliPepperSeedling : BaseCrop
    {
        ...
        [Constructable]
        public ChiliPepperSeedling(Mobile sower)
            : base(Utility.RandomList(0xCB6, 0xCB5))
        {
            Movable = false;
        ...
        public ChiliPepperSeedling(Serial serial)
            : base(serial) { }
    ...
    public class ChiliPepperCrop : BaseCrop
    {
        ...
        [Constructable]
        public ChiliPepperCrop(Mobile sower)
            : base(0x234C)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(ChiliPepperCrop plant)
        ...
        public ChiliPepperCrop(Serial serial)
            : base(serial) { }
