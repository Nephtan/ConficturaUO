...
namespace Server.Items.Crops
{
    ...
    public class TeaSeedling : BaseCrop
    {
        ...
        [Constructable]
        public TeaSeedling(Mobile sower)
            : base(0xCB6)
        {
            Movable = false;
            Name = "Tea Seedling";
        ...
        public TeaSeedling(Serial serial)
            : base(serial) { }
    ...
    public class TeaCrop : BaseCrop
    {
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(TeaCrop plant)
