...
{
    public class OatsSeed : BaseCrop
    {
    ...
    public class OatsSeedling : BaseCrop
    {
        ...
        [Constructable]
        public OatsSeedling(Mobile sower)
        ...
        public static void init(OatsSeedling plant)
        {
            plant.thisTimer = new CropHelper.GrowTimer(plant, typeof(OatsCrop), plant.Sower);
        ...
        public OatsSeedling(Serial serial)
            : base(serial) { }
    ...
    public class OatsCrop : BaseCrop
    {
        ...
        public static void init(OatsCrop plant, bool full)
        {
            ...
            if (DateTime.Now > lastpicked.AddSeconds(3)) // 3 seconds between picking
            {
                ...
                if (from.InRange(this.GetWorldLocation(), 1))
                {
                    ...
                    else //check skill and sower
                    {
                        ...
                        OatSheath crop = new OatSheath(pick);
        ...
        {
            private OatsCrop i_plant;

            public CropTimer(OatsCrop plant)
