...
{
    public class HoneydewMelonSeed : BaseCrop
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            this.Consume();
            Item item = new HoneydewMelonSeedling();
            item.Location = m_pnt;
            item.Map = m_map;
        }
    ...
    public class HoneydewMelonSeedling : BaseCrop
    {
        ...
        public static void init(HoneydewMelonSeedling plant)
        {
            ...
            plant.thisTimer = new TreeHelper.TreeTimer(plant, typeof(HoneydewMelonCrop), delay);
            plant.thisTimer.Start();
        }

        public HoneydewMelonSeedling(Serial serial)
            : base(serial) { }
    ...
    public class HoneydewMelonCrop : BaseTree
    {
        public Item i_trunk;
        ...
        private class FruitTimer : Timer
        {
            ...
            public FruitTimer(HoneydewMelonCrop plant)
        ...
        public void Chop(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 1))
            {
                if ((chopTimer == null) || (!chopTimer.Running))
                {
                    ...
                    {
                        HoneydewMelon fruit = new HoneydewMelon((int)Utility.Random(13) + m_yield);
                        ...
                        FruitTreeStump i_stump = new FruitTreeStump(typeof(HoneydewMelonCrop));
        ...
        {
            private HoneydewMelonCrop i_tree;
            private FruitTreeStump i_stump;
            private Mobile m_chopper;

            public StumpTimer(HoneydewMelonCrop Tree, FruitTreeStump Stump, Mobile from)
