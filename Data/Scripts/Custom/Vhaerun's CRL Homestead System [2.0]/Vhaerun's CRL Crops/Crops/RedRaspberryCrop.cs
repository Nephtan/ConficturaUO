...
{
    public class RedRaspberryTreeSeed : BaseCrop
    {
        ...
        [Constructable]
        public RedRaspberryTreeSeed()
            : this(1) { }

        [Constructable]
        public RedRaspberryTreeSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public RedRaspberryTreeSeed(Serial serial)
            : base(serial) { }
    ...
    public class RedRaspberrySapling : BaseCrop
    {
        ...
        [Constructable]
        public RedRaspberrySapling()
            : base(Utility.RandomList(0xCC9, 0xCC9))
        {
            Movable = false;
            Name = "Red Raspberry Bush Sapling";
            Hue = 0x2E0;
        ...
        public RedRaspberrySapling(Serial serial)
            : base(serial) { }
    ...
    public class RedRaspberryTree : BaseTree
    {
        public Item i_trunk;
        ...
        [Constructable]
        public RedRaspberryTree(Point3D pnt, Map map)
            : base(0xC9E) // leaves
        {
            Movable = false;
            MoveToWorld(pnt, map);
            Hue = 0x2DE;
            Name = "Red Raspberry Bush";

            init(this, false);
        }

        public static void init(RedRaspberryTree plant, bool full)
        {
        ...
        {
            private RedRaspberryTree i_plant;

            public FruitTimer(RedRaspberryTree plant)
        ...
        public void Chop(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 1))
            {
                if ((chopTimer == null) || (!chopTimer.Running))
                {
                    ...
                    {
                        RedRaspberry fruit = new RedRaspberry((int)Utility.Random(13) + m_yield);
                        ...
                        FruitTreeStump i_stump = new FruitTreeStump(typeof(RedRaspberryTree));
        ...
        {
            private RedRaspberryTree i_tree;
            private FruitTreeStump i_stump;
            private Mobile m_chopper;

            public StumpTimer(RedRaspberryTree Tree, FruitTreeStump Stump, Mobile from)
        ...
        public RedRaspberryTree(Serial serial)
            : base(serial) { }
