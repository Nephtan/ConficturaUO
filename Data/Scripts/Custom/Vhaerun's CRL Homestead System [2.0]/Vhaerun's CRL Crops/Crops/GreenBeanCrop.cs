...
{
    public class GreenBeanSeed : BaseCrop
    {
        ...
        [Constructable]
        public GreenBeanSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public GreenBeanSeed(Serial serial)
            : base(serial) { }
    ...
    public class GreenBeanSeedling : BaseCrop
    {
        ...
        [Constructable]
        public GreenBeanSeedling(Mobile sower)
            : base(Utility.RandomList(0xD32, 0xD33))
        {
            Movable = false;
        ...
        public GreenBeanSeedling(Serial serial)
            : base(serial) { }
    ...
    public class GreenBeanCrop : BaseCrop
    {
        ...
        [Constructable]
        public GreenBeanCrop(Mobile sower)
            : base(0xD04)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(GreenBeanCrop plant)
        ...
        public GreenBeanCrop(Serial serial)
            : base(serial) { }
