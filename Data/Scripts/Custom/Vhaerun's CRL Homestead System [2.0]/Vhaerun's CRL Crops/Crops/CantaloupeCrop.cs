...
{
    public class CantaloupeSeed : BaseCrop
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            this.Consume();
            Item item = new CantaloupeSeedling();
            item.Location = m_pnt;
            item.Map = m_map;
        }
    ...
    public class CantaloupeSeedling : BaseCrop
    {
        ...
        public static void init(CantaloupeSeedling plant)
        {
            ...
            plant.thisTimer = new TreeHelper.TreeTimer(plant, typeof(CantaloupeCrop), delay);
            plant.thisTimer.Start();
        }

        public CantaloupeSeedling(Serial serial)
            : base(serial) { }
    ...
    public class CantaloupeCrop : BaseTree
    {
        public Item i_trunk;
        ...
        [Constructable]
        public CantaloupeCrop(Point3D pnt, Map map)
        ...
        private class FruitTimer : Timer
        {
            ...
            public FruitTimer(CantaloupeCrop plant)
        ...
        public void Chop(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 1))
            {
                if ((chopTimer == null) || (!chopTimer.Running))
                {
                    ...
                    {
                        Cantaloupe fruit = new Cantaloupe((int)Utility.Random(13) + m_yield);
                        ...
                        FruitTreeStump i_stump = new FruitTreeStump(typeof(CantaloupeCrop));
        ...
        {
            private CantaloupeCrop i_tree;
            private FruitTreeStump i_stump;
            private Mobile m_chopper;

            public StumpTimer(CantaloupeCrop Tree, FruitTreeStump Stump, Mobile from)
