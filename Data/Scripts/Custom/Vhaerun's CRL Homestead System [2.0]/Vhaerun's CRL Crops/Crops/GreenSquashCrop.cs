...
{
    public class GreenSquashSeed : BaseCrop
    {
        ...
        [Constructable]
        public GreenSquashSeed()
            : this(1) { }

        [Constructable]
        public GreenSquashSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            this.Consume();
            Item item = new GreenSquashSeedling();
            item.Location = m_pnt;
            item.Map = m_map;
        }

        public GreenSquashSeed(Serial serial)
            : base(serial) { }
    ...
    public class GreenSquashSeedling : BaseCrop
    {
        ...
        public static void init(GreenSquashSeedling plant)
        {
            ...
            plant.thisTimer = new TreeHelper.TreeTimer(plant, typeof(GreenSquashCrop), delay);
            plant.thisTimer.Start();
        }

        public GreenSquashSeedling(Serial serial)
            : base(serial) { }
    ...
    public class GreenSquashCrop : BaseTree
    {
        public Item i_trunk;
        ...
        private class FruitTimer : Timer
        {
            ...
            public FruitTimer(GreenSquashCrop plant)
        ...
        public void Chop(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 1))
            {
                if ((chopTimer == null) || (!chopTimer.Running))
                {
                    ...
                    {
                        GreenSquash fruit = new GreenSquash((int)Utility.Random(13) + m_yield);
                        ...
                        FruitTreeStump i_stump = new FruitTreeStump(typeof(GreenSquashCrop));
        ...
        {
            private GreenSquashCrop i_tree;
            private FruitTreeStump i_stump;
            private Mobile m_chopper;

            public StumpTimer(GreenSquashCrop Tree, FruitTreeStump Stump, Mobile from)
        ...
        public GreenSquashCrop(Serial serial)
            : base(serial) { }
