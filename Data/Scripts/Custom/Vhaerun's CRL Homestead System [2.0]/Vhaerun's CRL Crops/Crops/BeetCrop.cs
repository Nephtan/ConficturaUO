...
{
    public class BeetSeed : BaseCrop
    {
    ...
    public class BeetSeedling : BaseCrop
    {
        ...
        [Constructable]
        public BeetSeedling(Mobile sower)
            : base(0xC68)
        {
            Movable = false;
            Name = "Beet Seedling";
        ...
        public BeetSeedling(Serial serial)
            : base(serial) { }
    ...
    public class BeetCrop : BaseCrop
    {
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(BeetCrop plant)
