...
{
    public class PomegranateTreeSeed : BaseCrop
    {
        ...
        [Constructable]
        public PomegranateTreeSeed()
            : this(1) { }

        [Constructable]
        public PomegranateTreeSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            this.Consume();
            Item item = new PomegranateSapling();
            item.Location = m_pnt;
            item.Map = m_map;
        }

        public PomegranateTreeSeed(Serial serial)
            : base(serial) { }
    ...
    public class PomegranateSapling : BaseCrop
    {
        ...
        public static void init(PomegranateSapling plant)
        {
            TimeSpan delay = TreeHelper.SaplingTime;
            plant.treeTime = DateTime.Now + delay;

            plant.thisTimer = new TreeHelper.TreeTimer(plant, typeof(PomegranateTree), delay);
            plant.thisTimer.Start();
        }

        public PomegranateSapling(Serial serial)
            : base(serial) { }
    ...
    public class PomegranateTree : BaseTree
    {
        public Item i_trunk;
        ...
        [Constructable]
        public PomegranateTree(Point3D pnt, Map map)
            : base(0xD9A) // leaves
        {
            Movable = false;
            MoveToWorld(pnt, map);
        ...
        public static void init(PomegranateTree plant, bool full)
        {
        ...
        {
            private PomegranateTree i_plant;

            public FruitTimer(PomegranateTree plant)
        ...
        public void Chop(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 1))
            {
                if ((chopTimer == null) || (!chopTimer.Running))
                {
                    ...
                    {
                        Pomegranate fruit = new Pomegranate((int)Utility.Random(13) + m_yield);
                        ...
                        FruitTreeStump i_stump = new FruitTreeStump(typeof(PomegranateTree));
        ...
        {
            private PomegranateTree i_tree;
            private FruitTreeStump i_stump;
            private Mobile m_chopper;

            public StumpTimer(PomegranateTree Tree, FruitTreeStump Stump, Mobile from)
        ...
        public PomegranateTree(Serial serial)
            : base(serial) { }
