...
{
    public class PotatoSeed : BaseCrop
    {
    ...
    public class PotatoSeedling : BaseCrop
    {
        ...
        [Constructable]
        public PotatoSeedling(Mobile sower)
            : base(0xCB6)
        {
            Movable = false;
        ...
        public PotatoSeedling(Serial serial)
            : base(serial) { }
    ...
    public class PotatoCrop : BaseCrop
    {
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(PotatoCrop plant)
