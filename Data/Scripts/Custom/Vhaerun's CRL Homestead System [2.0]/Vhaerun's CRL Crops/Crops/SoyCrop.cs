...
namespace Server.Items.Crops
{
    ...
    public class SoySeedling : BaseCrop
    {
        ...
        [Constructable]
        public SoySeedling(Mobile sower)
            : base(0xCB0)
        {
            Movable = false;
            Name = "Soy Seedling";
        ...
        public SoySeedling(Serial serial)
            : base(serial) { }
    ...
    public class SoyCrop : BaseCrop
    {
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(SoyCrop plant)
