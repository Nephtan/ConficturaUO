...
namespace Server.Items.Crops
{
    public class GreenPepperSeed : BaseCrop
    {
        ...
        [Constructable]
        public GreenPepperSeed()
            : this(1) { }

        [Constructable]
        public GreenPepperSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public GreenPepperSeed(Serial serial)
            : base(serial) { }
    ...
    public class GreenPepperSeedling : BaseCrop
    {
        ...
        [Constructable]
        public GreenPepperSeedling(Mobile sower)
        ...
        public GreenPepperSeedling(Serial serial)
            : base(serial) { }
    ...
    public class GreenPepperCrop : BaseCrop
    {
        ...
        [Constructable]
        public GreenPepperCrop(Mobile sower)
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(GreenPepperCrop plant)
        ...
        public GreenPepperCrop(Serial serial)
            : base(serial) { }
