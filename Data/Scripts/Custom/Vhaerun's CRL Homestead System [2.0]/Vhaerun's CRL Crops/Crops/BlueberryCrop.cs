...
{
    public class BlueberryTreeSeed : BaseCrop
    {
        ...
        [Constructable]
        public BlueberryTreeSeed()
            : this(1) { }

        [Constructable]
        public BlueberryTreeSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            this.Consume();
            Item item = new BlueberrySapling();
            item.Location = m_pnt;
            item.Map = m_map;
        }

        public BlueberryTreeSeed(Serial serial)
            : base(serial) { }
    ...
    public class BlueberrySapling : BaseCrop
    {
        ...
        public static void init(BlueberrySapling plant)
        {
            TimeSpan delay = TreeHelper.SaplingTime;
            plant.treeTime = DateTime.Now + delay;

            plant.thisTimer = new TreeHelper.TreeTimer(plant, typeof(BlueberryTree), delay);
            plant.thisTimer.Start();
        }

        public BlueberrySapling(Serial serial)
            : base(serial) { }
    ...
    public class BlueberryTree : BaseTree
    {
        public Item i_trunk;
        ...
        [Constructable]
        public BlueberryTree(Point3D pnt, Map map)
            : base(0xC9E) // leaves
        {
            Movable = false;
            MoveToWorld(pnt, map);
        ...
        public static void init(BlueberryTree plant, bool full)
        {
        ...
        {
            private BlueberryTree i_plant;

            public FruitTimer(BlueberryTree plant)
        ...
        {
            private BlueberryTree i_tree;
            private FruitTreeStump i_stump;
            private Mobile m_chopper;

            public StumpTimer(BlueberryTree Tree, FruitTreeStump Stump, Mobile from)
        ...
        public BlueberryTree(Serial serial)
            : base(serial) { }
