...
{
    public class SpinachSeed : BaseCrop
    {
        ...
        public SpinachSeed(Serial serial)
            : base(serial) { }
    ...
    public class SpinachSeedling : BaseCrop
    {
        ...
        [Constructable]
        public SpinachSeedling(Mobile sower)
            : base(0xCB4)
        {
            Movable = false;
        ...
        public SpinachSeedling(Serial serial)
            : base(serial) { }
    ...
    public class SpinachCrop : BaseCrop
    {
        ...
        [Constructable]
        public SpinachCrop(Mobile sower)
            : base(Utility.RandomList(0xD09, 0xD0A))
        {
            Movable = false;
            Name = "Spinach Plant";
            Hue = 0x29D;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(SpinachCrop plant)
        ...
        public SpinachCrop(Serial serial)
            : base(serial) { }
