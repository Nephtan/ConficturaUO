...
{
    public class PumpkinSeed : BaseCrop
    {
    ...
    public class PumpkinSeedling : BaseCrop
    {
        ...
        public PumpkinSeedling(Serial serial)
            : base(serial) { }
    ...
    public class PumpkinCrop : BaseTree
    {
        public Item i_trunk;
        ...
        [Constructable]
        public PumpkinCrop(Point3D pnt, Map map)
        ...
        private class FruitTimer : Timer
        {
            ...
            public FruitTimer(PumpkinCrop plant)
        ...
        {
            private PumpkinCrop i_tree;
            private FruitTreeStump i_stump;
            private Mobile m_chopper;

            public StumpTimer(PumpkinCrop Tree, FruitTreeStump Stump, Mobile from)
