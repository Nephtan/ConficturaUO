...
{
    public class EggplantSeed : BaseCrop
    {
        ...
        [Constructable]
        public EggplantSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public EggplantSeed(Serial serial)
            : base(serial) { }
    ...
    public class EggplantSeedling : BaseCrop
    {
        ...
        [Constructable]
        public EggplantSeedling(Mobile sower)
            : base(0xCB6)
        {
            Movable = false;
        ...
        public EggplantSeedling(Serial serial)
            : base(serial) { }
    ...
    public class EggplantCrop : BaseCrop
    {
        ...
        [Constructable]
        public EggplantCrop(Mobile sower)
            : base(Utility.RandomList(0xC9B, 0xC9D))
        {
            Movable = false;
            Name = "Eggplant Plant";
            Hue = 0x2A1;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(EggplantCrop plant)
        ...
        public EggplantCrop(Serial serial)
            : base(serial) { }
