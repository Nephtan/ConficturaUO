...
{
    public class CoffeeSeed : BaseCrop
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            this.Consume();
            Item item = new CoffeeSeedling(from);
            item.Location = m_pnt;
            item.Map = m_map;
        }

        public CoffeeSeed(Serial serial)
            : base(serial) { }
    ...
    public class CoffeeSeedling : BaseCrop
    {
        ...
        [Constructable]
        public CoffeeSeedling(Mobile sower)
        ...
        public static void init(CoffeeSeedling plant)
        {
            plant.thisTimer = new CropHelper.GrowTimer(plant, typeof(CoffeeCrop), plant.Sower);
        ...
        public CoffeeSeedling(Serial serial)
            : base(serial) { }
    ...
    public class CoffeeCrop : BaseCrop
    {
        ...
        [Constructable]
        public CoffeeCrop(Mobile sower)
            : base(Utility.RandomList(0xC53, 0xC54))
        {
            Movable = false;
            Name = "Coffee Plant";
            Hue = 0x46A;
        ...
        public static void init(CoffeeCrop plant, bool full)
        {
        ...
        {
            private CoffeeCrop i_plant;

            public CropTimer(CoffeeCrop plant)
        ...
        public CoffeeCrop(Serial serial)
            : base(serial) { }
