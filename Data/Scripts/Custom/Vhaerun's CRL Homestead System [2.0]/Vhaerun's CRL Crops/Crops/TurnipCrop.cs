...
{
    public class TurnipSeed : BaseCrop
    {
    ...
    public class TurnipSeedling : BaseCrop
    {
        ...
        [Constructable]
        public TurnipSeedling(Mobile sower)
            : base(0xC61)
        {
            Movable = false;
        ...
        public TurnipSeedling(Serial serial)
            : base(serial) { }
    ...
    public class TurnipCrop : BaseCrop
    {
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(TurnipCrop plant)
