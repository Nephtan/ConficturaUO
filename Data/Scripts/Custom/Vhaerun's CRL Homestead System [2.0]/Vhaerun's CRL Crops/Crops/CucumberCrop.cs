...
{
    public class CucumberSeed : BaseCrop
    {
        ...
        [Constructable]
        public CucumberSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            this.Consume();
            Item item = new CucumberSeedling();
            item.Location = m_pnt;
            item.Map = m_map;
        }

        public CucumberSeed(Serial serial)
            : base(serial) { }
    ...
    public class CucumberSeedling : BaseCrop
    {
        ...
        public static void init(CucumberSeedling plant)
        {
            ...
            plant.thisTimer = new TreeHelper.TreeTimer(plant, typeof(CucumberCrop), delay);
            plant.thisTimer.Start();
        }

        public CucumberSeedling(Serial serial)
            : base(serial) { }
    ...
    public class CucumberCrop : BaseTree
    {
        public Item i_trunk;
            ...
            if (DateTime.Now > lastpicked.AddSeconds(3)) // 3 seconds between picking
            {
                ...
                if (from.InRange(this.GetWorldLocation(), 2))
                {
                    ...
                    else //check skill
                    {
                        ...
                        m_yield -= pick;
                        from.SendMessage("You pick {0} Cucumber{1}!", pick, (pick == 1 ? "" : "s"));
        ...
        private class FruitTimer : Timer
        {
            ...
            public FruitTimer(CucumberCrop plant)
        ...
        public void Chop(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 1))
            {
                if ((chopTimer == null) || (!chopTimer.Running))
                {
                    ...
                    {
                        Cucumber fruit = new Cucumber((int)Utility.Random(13) + m_yield);
                        ...
                        FruitTreeStump i_stump = new FruitTreeStump(typeof(CucumberCrop));
        ...
        {
            private CucumberCrop i_tree;
            private FruitTreeStump i_stump;
            private Mobile m_chopper;

            public StumpTimer(CucumberCrop Tree, FruitTreeStump Stump, Mobile from)
        ...
        public CucumberCrop(Serial serial)
            : base(serial) { }
