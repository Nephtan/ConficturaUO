...
{
    public class PeachTreeSeed : BaseCrop
    {
    ...
    public class PeachTree : BaseTree
    {
        ...
        [Constructable]
        public PeachTree(Point3D pnt, Map map)
        ...
        private class FruitTimer : Timer
        {
            ...
            public FruitTimer(PeachTree plant)
        ...
        private class StumpTimer : Timer
        {
            ...
            public StumpTimer(PeachTree Tree, FruitTreeStump Stump, Mobile from)
