...
{
    public class MangoTreeSeed : BaseCrop
    {
        ...
        [Constructable]
        public MangoTreeSeed()
            : this(1) { }

        [Constructable]
        public MangoTreeSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            this.Consume();
            Item item = new MangoSapling();
            item.Location = m_pnt;
            item.Map = m_map;
        }

        public MangoTreeSeed(Serial serial)
            : base(serial) { }
    ...
    public class MangoSapling : BaseCrop
    {
        ...
        public static void init(MangoSapling plant)
        {
            TimeSpan delay = TreeHelper.SaplingTime;
            plant.treeTime = DateTime.Now + delay;

            plant.thisTimer = new TreeHelper.TreeTimer(plant, typeof(MangoTree), delay);
            plant.thisTimer.Start();
        }

        public MangoSapling(Serial serial)
            : base(serial) { }
    ...
    public class MangoTree : BaseTree
    {
        public Item i_trunk;
        ...
        [Constructable]
        public MangoTree(Point3D pnt, Map map)
            : base(0xDA6) // leaves
        {
            Movable = false;
            MoveToWorld(pnt, map);
        ...
        public static void init(MangoTree plant, bool full)
        {
        ...
        {
            private MangoTree i_plant;

            public FruitTimer(MangoTree plant)
        ...
        {
            private MangoTree i_tree;
            private FruitTreeStump i_stump;
            private Mobile m_chopper;

            public StumpTimer(MangoTree Tree, FruitTreeStump Stump, Mobile from)
        ...
        public MangoTree(Serial serial)
            : base(serial) { }
