...
{
    public class PeasSeed : BaseCrop
    {
    ...
    public class PeasSeedling : BaseCrop
    {
        ...
        [Constructable]
        public PeasSeedling(Mobile sower)
        ...
        public PeasSeedling(Serial serial)
            : base(serial) { }
    ...
    public class PeasCrop : BaseCrop
    {
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(PeasCrop plant)
