...
{
    public class AsparagusSeed : BaseCrop
    {
        ...
        [Constructable]
        public AsparagusSeed()
            : this(1) { }

        [Constructable]
        public AsparagusSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public AsparagusSeed(Serial serial)
            : base(serial) { }
    ...
    public class AsparagusSeedling : BaseCrop
    {
        ...
        [Constructable]
        public AsparagusSeedling(Mobile sower)
            : base(0xD32)
        {
            Movable = false;
        ...
        public AsparagusSeedling(Serial serial)
            : base(serial) { }
    ...
    public class AsparagusCrop : BaseCrop
    {
        ...
        [Constructable]
        public AsparagusCrop(Mobile sower)
            : base(0xC88)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(AsparagusCrop plant)
        ...
        public AsparagusCrop(Serial serial)
            : base(serial) { }
