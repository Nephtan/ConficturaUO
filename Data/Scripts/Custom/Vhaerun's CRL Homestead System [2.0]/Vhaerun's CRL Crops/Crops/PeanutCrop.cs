...
{
    public class PeanutSeed : BaseCrop
    {
        ...
        public PeanutSeed(Serial serial)
            : base(serial) { }
    ...
    public class PeanutSeedling : BaseCrop
    {
        ...
        [Constructable]
        public PeanutSeedling(Mobile sower)
            : base(0xCB4)
        {
            Movable = false;
        ...
        public PeanutSeedling(Serial serial)
            : base(serial) { }
    ...
    public class PeanutCrop : BaseCrop
    {
        ...
        [Constructable]
        public PeanutCrop(Mobile sower)
            : base(0xC61)
        {
            Movable = false;
            Name = "Peanut Plant";
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(PeanutCrop plant)
        ...
        public PeanutCrop(Serial serial)
            : base(serial) { }
