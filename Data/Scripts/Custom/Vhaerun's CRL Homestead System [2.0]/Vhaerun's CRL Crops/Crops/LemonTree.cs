...
{
    public class LemonTreeSeed : BaseCrop
    {
    ...
    public class LemonSapling : BaseCrop
    {
        ...
        public static void init(LemonSapling plant)
        {
            TimeSpan delay = TreeHelper.SaplingTime;
            plant.treeTime = DateTime.Now + delay;

            plant.thisTimer = new TreeHelper.TreeTimer(plant, typeof(LemonTree), delay);
    ...
    public class LemonTree : BaseTree
    {
        public Item i_trunk;
        ...
        [Constructable]
        public LemonTree(Point3D pnt, Map map)
        ...
        public static void init(LemonTree plant, bool full)
        {
        ...
        {
            private LemonTree i_plant;

            public FruitTimer(LemonTree plant)
        ...
        {
            private LemonTree i_tree;
            private FruitTreeStump i_stump;
            private Mobile m_chopper;

            public StumpTimer(LemonTree Tree, FruitTreeStump Stump, Mobile from)
