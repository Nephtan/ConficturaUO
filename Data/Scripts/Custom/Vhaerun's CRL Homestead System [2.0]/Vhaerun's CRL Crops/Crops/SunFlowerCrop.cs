...
namespace Server.Items.Crops
{
    public class SunFlowerSeed : BaseCrop
    {
        ...
        [Constructable]
        public SunFlowerSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public SunFlowerSeed(Serial serial)
            : base(serial) { }
    ...
    public class SunFlowerSeedling : BaseCrop
    {
        ...
        [Constructable]
        public SunFlowerSeedling(Mobile sower)
            : base(0xCB6)
        {
            Movable = false;
        ...
        public SunFlowerSeedling(Serial serial)
            : base(serial) { }
    ...
    public class SunFlowerCrop : BaseCrop
    {
        ...
        [Constructable]
        public SunFlowerCrop(Mobile sower)
            : base(0xC85)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(SunFlowerCrop plant)
        ...
        public SunFlowerCrop(Serial serial)
            : base(serial) { }
