...
{
    public class GingerSeed : BaseCrop
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            this.Consume();
            Item item = new GingerSeedling(from);
            item.Location = m_pnt;
            item.Map = m_map;
        }

        public GingerSeed(Serial serial)
            : base(serial) { }
    ...
    public class GingerSeedling : BaseCrop
    {
        ...
        [Constructable]
        public GingerSeedling(Mobile sower)
            : base(0xCB5)
        {
            Movable = false;
            Name = "Ginger Seedling";
            m_sower = sower;

            init(this);
        }

        public static void init(GingerSeedling plant)
        {
            plant.thisTimer = new CropHelper.GrowTimer(plant, typeof(GingerCrop), plant.Sower);
        ...
        public GingerSeedling(Serial serial)
            : base(serial) { }
    ...
    public class GingerCrop : BaseCrop
    {
        ...
        [Constructable]
        public GingerCrop(Mobile sower)
            : base(0xCC7)
        {
            Movable = false;
            Name = "Ginger Plant";
        ...
        public static void init(GingerCrop plant, bool full)
        {
            ...
            if (DateTime.Now > lastpicked.AddSeconds(3)) // 3 seconds between picking
            {
                ...
                if (from.InRange(this.GetWorldLocation(), 1))
                {
                    ...
                    else //check skill and sower
                    {
                        ...
                        GingerRoot crop = new GingerRoot(pick);
        ...
        {
            private GingerCrop i_plant;

            public CropTimer(GingerCrop plant)
        ...
        public GingerCrop(Serial serial)
            : base(serial) { }
