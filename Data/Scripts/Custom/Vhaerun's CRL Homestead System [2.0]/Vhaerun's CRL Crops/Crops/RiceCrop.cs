...
{
    public class RiceSeed : BaseCrop
    {
    ...
    public class RiceSeedling : BaseCrop
    {
        ...
        [Constructable]
        public RiceSeedling(Mobile sower)
        ...
        public RiceSeedling(Serial serial)
            : base(serial) { }
    ...
    public class RiceCrop : BaseCrop
    {
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(RiceCrop plant)
