...
{
    public class TomatoSeed : BaseCrop
    {
    ...
    public class TomatoSeedling : BaseCrop
    {
        ...
        [Constructable]
        public TomatoSeedling(Mobile sower)
            : base(0xC61)
        {
            Movable = false;
        ...
        public TomatoSeedling(Serial serial)
            : base(serial) { }
    ...
    public class TomatoCrop : BaseCrop
    {
        ...
        {
            plant.PickGraphic = (0xC9C);
            plant.FullGraphic = (0xC9C);
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(TomatoCrop plant)
