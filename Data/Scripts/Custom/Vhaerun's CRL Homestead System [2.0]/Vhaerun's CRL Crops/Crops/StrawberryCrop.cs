...
{
    public class StrawberrySeed : BaseCrop
    {
        ...
        [Constructable]
        public StrawberrySeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public StrawberrySeed(Serial serial)
            : base(serial) { }
    ...
    public class StrawberrySeedling : BaseCrop
    {
        ...
        [Constructable]
        public StrawberrySeedling(Mobile sower)
        ...
        public StrawberrySeedling(Serial serial)
            : base(serial) { }
    ...
    public class StrawberryCrop : BaseCrop
    {
        ...
        [Constructable]
        public StrawberryCrop(Mobile sower)
            : base(Utility.RandomList(0x1A99, 0x1A9A))
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(StrawberryCrop plant)
        ...
        public StrawberryCrop(Serial serial)
            : base(serial) { }
