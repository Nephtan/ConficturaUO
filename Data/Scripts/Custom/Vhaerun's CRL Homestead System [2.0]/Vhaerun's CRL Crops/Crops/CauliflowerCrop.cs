...
{
    public class CauliflowerSeed : BaseCrop
    {
        ...
        [Constructable]
        public CauliflowerSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public CauliflowerSeed(Serial serial)
            : base(serial) { }
    ...
    public class CauliflowerSeedling : BaseCrop
    {
        ...
        [Constructable]
        public CauliflowerSeedling(Mobile sower)
            : base(0xCB5)
        {
            Movable = false;
        ...
        public CauliflowerSeedling(Serial serial)
            : base(serial) { }
    ...
    public class CauliflowerCrop : BaseCrop
    {
        ...
        [Constructable]
        public CauliflowerCrop(Mobile sower)
            : base(0xD06)
        {
            Movable = false;
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(CauliflowerCrop plant)
        ...
        public CauliflowerCrop(Serial serial)
            : base(serial) { }
