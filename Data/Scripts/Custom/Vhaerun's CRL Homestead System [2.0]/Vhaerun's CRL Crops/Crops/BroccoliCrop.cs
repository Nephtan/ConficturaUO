...
{
    public class BroccoliSeed : BaseCrop
    {
        ...
        [Constructable]
        public BroccoliSeed(int amount)
            : base(0xF27)
        {
            Stackable = true;
            Weight = .5;
        ...
        public BroccoliSeed(Serial serial)
            : base(serial) { }
    ...
    public class BroccoliSeedling : BaseCrop
    {
        ...
        [Constructable]
        public BroccoliSeedling(Mobile sower)
            : base(0xC61)
        {
            Movable = false;
        ...
        public BroccoliSeedling(Serial serial)
            : base(serial) { }
    ...
    public class BroccoliCrop : BaseCrop
    {
        ...
        [Constructable]
        public BroccoliCrop(Mobile sower)
            : base(0xC62)
        {
            Movable = false;
            Name = "Broccoli Plant";
        ...
        private class CropTimer : Timer
        {
            ...
            public CropTimer(BroccoliCrop plant)
        ...
        public BroccoliCrop(Serial serial)
            : base(serial) { }
