//================================================//
// Created by masternightmage			  //
// For inclusion in dracana's winecrafting system //
//================================================//
using System;
using Server;
using Server.Items;
...
namespace Server.Items
{
    public class kegstorageAddon : BaseAddon
    {
        ...
        {
            get { return new kegstorageAddonDeed(); }
        }
        ...
        public kegstorageAddon(Serial serial)
            : base(serial) { }
    ...
    public class kegstorageAddonDeed : BaseAddonDeed
    {
        ...
        {
            get { return new kegstorageAddon(); }
        }
        ...
        public kegstorageAddonDeed(Serial serial)
            : base(serial) { }
