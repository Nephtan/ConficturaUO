//================================================//
// Created by dracana				  //
// Desc: Gumps related to placing grapevines.     //
//       Player and Admin specific.               //
//================================================//
using System;
...
namespace Server.Gumps
{
    ...
    public class AddGrapeVineGump : Gump
    {
        ...
        public AddGrapeVineGump(Mobile from, object notice, int varietyindex)
            : this(from, notice, varietyindex, GumpPage.None) { }

        private AddGrapeVineGump(Mobile from, object notice, int varietyindex, GumpPage page)
            : base(40, 40)
        {
            m_From = from;
            m_Page = page;
            ...
            AddHtml(
                ...
                510,
                20,
                "<basefont color=" + LabelColor + "><CENTER>Add Grapevine Menu</CENTER></basefont>",
                false,
                false
            );
            ...
            AddHtml(
                ...
                245,
                22,
                "<basefont color=" + LabelColor + "><CENTER>VINE TYPE</CENTER></basefont>",
                false,
                false
            );
            AddHtml(
                ...
                260,
                22,
                "<basefont color=" + LabelColor + "><CENTER>VINE DETAILS</CENTER></basefont>",
                false,
                false
            ...
            AddHtml(
                ...
                150,
                18,
                "<basefont color=" + LabelColor + ">MOVE</basefont>",
                false,
                false
            );
            ...
            AddHtml(
                ...
                150,
                18,
                "<basefont color=" + LabelColor + ">DELETE</basefont>",
                false,
                false
            );
            // ****************************************
            ...
            else
            {
                ...
                AddHtml(
                    ...
                    250,
                    18,
                    "<basefont color=" + LabelColor + ">" + m_Grapes[0].m_Name + "</basefont>",
                    false,
                    false
                );
            }
        ...
        public void CreateItemDisplay(int index)
        {
            ...
            AddHtml(
                ...
                150,
                18,
                "<basefont color=" + LabelColor + ">ADD NOW</basefont>",
                false,
                false
            );
        }
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(int itype, int ivariety)
                    ...
                    if (obj is BaseGrapeVine)
                    {
                        ...
                        if (VinePlacement.ValidatePlacement(loc, from, o))
                        {
                            ...
                            )
                            {
                                ...
                                from.SendGump(
                                    new AddGrapeVineGump(from, addnotice, m_IVariety, GumpPage.None)
                                );
                            }
                            else
                            {
                        ...
                        else
                        {
                            vine.Delete();
                            string addnotice =
                                "Invalid target or something is blocking vine placement.";
                            from.SendGump(
                                new AddGrapeVineGump(from, addnotice, m_IVariety, GumpPage.None)
                            );
                        }
        ...
        public class PickVineMoveTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object o)
            {
                ...
                if (o is BaseGrapeVine)
                {
                    ...
                    {
                        from.SendMessage(
                            "Invalid target.  Only grapevines that you placed can be moved."
                        );
                    }
                }
                else
        ...
        public class VineMoveToTarget : Target
        {
            ...
            public VineMoveToTarget(object o)
                : base(-1, true, TargetFlags.None)
            {
                m_Object = o;
        ...
        public class VineDeleteTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object o)
            {
                ...
                if (o is BaseGrapeVine)
                {
                    ...
                    {
                        from.SendMessage(
                            "Invalid target.  Only grapevines that you placed can be deleted."
                        );
                    }
                }
                else
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (type)
            {
                ...
                case 2: // Item details
                {
                    if (index >= 0 && index < m_Types.Length)
                        m_From.SendGump(
                            new AddGrapeVineGump(
                                m_From,
                                index,
                                m_VarietyIndex,
                                GumpPage.DisplayItem
                            )
                        );

                    break;
                }
                case 3: // Add Vine from Display
                {
                    if (index >= 0 && index < m_Types.Length)
                    {
                        m_From.Target = new InternalTarget(index, m_VarietyIndex);
                ...
                case 4: // Resource selected
                {
                    if (m_Page == GumpPage.PickResource && index >= 0 && index < m_Grapes.Length)
                    {
                        ...
                        m_From.SendGump(
                            new AddGrapeVineGump(m_From, null, m_VarietyIndex, GumpPage.None)
                        );
                    }
                    else if (
                    ...
                    switch (index)
                    {
                        ...
                        case 1: // Move
                        {
                            ...
                            else
                            {
                                ...
                                CommandSystem.Handle(m_From, String.Format("{0}Move", prefix));
                            }
                        ...
                        case 2: // Delete
                        {
                            ...
                            {
                                string prefix = CommandSystem.Prefix;
                                CommandSystem.Handle(m_From, String.Format("{0}Delete", prefix));
                            }
