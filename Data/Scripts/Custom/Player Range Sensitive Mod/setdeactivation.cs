    ...
    public class SetDeactivation
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(SetDeactivation_OnCommand)
            );
        }

        [Usage("SetDeactivation [minutes]")]
        [Description(
            "Sets/reports the default AI deactivation delay for the PlayerRangeSensitive mod in minutes"
        )]
        public static void SetDeactivation_OnCommand(CommandEventArgs e)
        {
            ...
            e.Mobile.SendMessage(
                "Default AI deactivation delay set to {0} minutes",
                DefaultDeactivationDelay
            );
        }
    }
}
