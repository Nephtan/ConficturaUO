...
namespace Server.Engines.Craft
{
    public class DefDruidism : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(
                typeof(NaturesPassagePotion),
                "Brews",
                "nature passage mixture",
                15.0,
                35.0,
                typeof(SeaSalt),
                "Sea Salt",
            ...
            index = AddCraft(
                typeof(ShieldOfEarthPotion),
                "Brews",
                "shield of earth liquid",
                20.0,
                40.0,
                typeof(Ginseng),
                "Ginseng",
            ...
            index = AddCraft(
                typeof(StoneCirclePotion),
                "Brews",
                "stone rising concoction",
                30.0,
                50.0,
                typeof(BeetleShell),
                "Beetle Shell",
            ...
            index = AddCraft(
                typeof(GraspingRootsPotion),
                "Brews",
                "grasping roots mixture",
                35.0,
                55.0,
                typeof(MandrakeRoot),
                "Mandrake Root",
