    ...
    public class DefTinkering : CraftSystem
    {
        ...
        public override int CanCraft(Mobile from, BaseTool tool, Type itemType)
        {
            if (tool == null || tool.Deleted || tool.UsesRemaining < 0)
                ...
                itemType != null
                && (
                    itemType.IsSubclassOf(typeof(BaseFactionTrapDeed))
                    || itemType == typeof(FactionTrapRemovalKit)
                )
        ...
        public override void InitCraftList()
        {
            ...
            AddCraft(
                typeof(DullCopperBracelet),
                1044049,
                "dull copper bracelet",
                40.0,
                90.0,
                typeof(DullCopperIngot),
                "dull copper ingot",
            ...
            AddCraft(
                typeof(DullCopperEarrings),
                1044049,
                "dull copper earrings",
                40.0,
                90.0,
                typeof(DullCopperIngot),
                "dull copper ingot",
            ...
            AddCraft(
                typeof(ShadowIronBracelet),
                1044049,
                "shadow iron bracelet",
                40.0,
                90.0,
                typeof(ShadowIronIngot),
                "shadow iron ingot",
            ...
            AddCraft(
                typeof(ShadowIronEarrings),
                1044049,
                "shadow iron earrings",
                40.0,
                90.0,
                typeof(ShadowIronIngot),
                "shadow iron ingot",
