...
namespace Server.Engines.Craft
{
    public class DefWitchery : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(
                typeof(UndeadEyesScroll),
                "Brews",
                "eyes of the dead mixture",
                10.0,
                30.0,
                typeof(MummyWrap),
                "Mummy Wrap",
            ...
            index = AddCraft(
                typeof(NecroUnlockScroll),
                "Brews",
                "tomb raiding concoction",
                15.0,
                40.0,
                typeof(Maggot),
                "Maggot",
            ...
            index = AddCraft(
                typeof(NecroCurePoisonScroll),
                "Brews",
                "disease curing concoction",
                45.0,
                70.0,
                typeof(Wolfsbane),
                "Wolfsbane",
            ...
            index = AddCraft(
                typeof(SpectreShadowScroll),
                "Brews",
                "spectre shadow elixir",
                55.0,
                80.0,
                typeof(VioletFungus),
                "Violet Fungus",
            ...
            index = AddCraft(
                typeof(GhostPhaseScroll),
                "Brews",
                "ghost phase concoction",
                60.0,
                85.0,
                typeof(BitterRoot),
                "Bitter Root",
            ...
            index = AddCraft(
                typeof(GhostlyImagesScroll),
                "Brews",
                "ghostly images draught",
                70.0,
                95.0,
                typeof(MummyWrap),
                "Mummy Wrap",
            ...
            index = AddCraft(
                typeof(HellsBrandScroll),
                "Brews",
                "hellish branding ooze",
                75.0,
                100.0,
                typeof(WerewolfClaw),
                "Werewolf Claw",
            ...
            index = AddCraft(
                typeof(VampireGiftScroll),
                "Brews",
                "vampire blood draught",
                85.0,
                120.0,
                typeof(WerewolfClaw),
                "Werewolf Claw",
