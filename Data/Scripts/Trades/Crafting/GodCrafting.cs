...
namespace Server.Items
{
    ...
    public class GodSmithing : BaseTool
    {
        ...
        {
            get { return DefGodSmithing.CraftSystem; }
        }
        ...
        public GodSmithing(Serial serial)
            : base(serial) { }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (ItemID != 0x0FB4 && ItemID != 0x0FB5)
            {
                ItemID = 0x0FB4;
            }
        }
    ...
    public class GodSewing : BaseTool
    {
        public override CraftSystem CraftSystem
        {
            get { return DefGodSewing.CraftSystem; }
        }
        ...
        public GodSewing(Serial serial)
            : base(serial) { }
    ...
    public class GodBrewing : BaseTool
    {
        public override CraftSystem CraftSystem
        {
            get { return DefGodBrewing.CraftSystem; }
        }
        ...
        public GodBrewing(Serial serial)
            : base(serial) { }
