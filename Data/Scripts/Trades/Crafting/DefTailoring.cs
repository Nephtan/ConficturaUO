...
namespace Server.Engines.Craft
{
    public class DefTailoring : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            AddSubRes(typeof(HornedLeather), 1049152, 55.0, 1044462, 1049311);
            AddSubRes(typeof(BarbedLeather), 1049153, 60.0, 1044462, 1049311);
            AddSubRes(typeof(NecroticLeather), 1034403, 65.0, 1044462, 1049311);
            AddSubRes(typeof(VolcanicLeather), 1034414, 70.0, 1044462, 1049311);
            AddSubRes(typeof(FrozenLeather), 1034425, 75.0, 1044462, 1049311);
            AddSubRes(typeof(SpinedLeather), 1049151, 80.0, 1044462, 1049311);
            AddSubRes(typeof(GoliathLeather), 1034370, 85.0, 1044462, 1049311);
            AddSubRes(typeof(DraconicLeather), 1034381, 90.0, 1044462, 1049311);
            AddSubRes(typeof(HellishLeather), 1034392, 95.0, 1044462, 1049311);
            AddSubRes(typeof(DinosaurLeather), 1036104, 99.0, 1044462, 1049311);
            AddSubRes(typeof(AlienLeather), 1034444, 99.0, 1044462, 1049311);
