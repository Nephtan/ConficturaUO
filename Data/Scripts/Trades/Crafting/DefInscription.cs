    ...
    public class DefInscription : CraftSystem
    {
        ...
        )
        {
            ...
            int index = AddCraft(
                ...
                minSkill + 1.0,
                regs[0],
                id < 0x4000 ? 1020000 + id : 1078872 + id,
                1,
                501627
            );
        ...
        private void AddElementalSpell(Type type)
        {
            ...
            int index = AddCraft(
                type,
                "Elemental Spells",
                ElementalSpell.CommonInfo((300 + m_Elly++), 1),
                minSkill,
                maxSkill,
                typeof(BlankScroll),
                1044377,
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(
                typeof(Engines.BulkOrders.BulkOrderBook),
                "Books & Scrolls",
                "Bulk Order Book",
                65.0,
                115.0,
