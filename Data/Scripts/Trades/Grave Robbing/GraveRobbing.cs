...
namespace Server.Engines.Harvest
{
    public class GraveRobbing : HarvestSystem
    {
        ...
        private GraveRobbing()
        {
            ...
            grave.MaxRange = 1;
            grave.ConsumedPerHarvest = 1 * Server.Misc.MyServerSettings.Resources();
            grave.ConsumedPerIslesDreadHarvest =
                grave.ConsumedPerHarvest + (int)(grave.ConsumedPerHarvest / 2) + 2;
            ...
            res = new HarvestResource[]
            {
                new HarvestResource(
                    ...
                    000.0,
                    150.0,
                    "You put some bones in your backpack",
                    typeof(Bones)
                ),
                new HarvestResource(
                    000.0,
                    000.0,
                    150.0,
                    "You put a rotted arm in your backpack",
                    typeof(LeftArm)
                ),
                new HarvestResource(
                    000.0,
                ...
                new HarvestResource(
                    ...
                    000.0,
                    150.0,
                    "You put a rotted torso in your backpack",
                    typeof(Torso)
                ),
                new HarvestResource(
                    000.0,
                    000.0,
                    150.0,
                    "You put a rotted leg in your backpack",
                    typeof(LeftLeg)
                ),
                new HarvestResource(
                    000.0,
                ...
                new HarvestResource(
                    ...
                    000.0,
                    150.0,
                    "You put a bone in your backpack",
                    typeof(Bone)
                ),
                new HarvestResource(
                    000.0,
                    000.0,
                    150.0,
                    "You put a rib cage in your backpack",
                    typeof(RibCage)
                ),
                new HarvestResource(
                    000.0,
                    000.0,
                    150.0,
                    "You put a pile of bones in your backpack",
                    typeof(BonePile)
                ),
                new HarvestResource(
                    020.0,
                    010.0,
                    150.0,
                    "You put some grave dust in your backpack",
                    typeof(GraveDust)
                ),
                new HarvestResource(
                    020.0,
                    010.0,
                    150.0,
                    "You put some dirt in your backpack",
                    typeof(FertileDirt)
                ),
                new HarvestResource(
                    050.0,
                    040.0,
                    150.0,
                    "You put an unknown liquid in your backpack",
                ...
                new HarvestResource(
                    ...
                    040.0,
                    150.0,
                    "You put some unknown reagents in your backpack",
                ...
                new HarvestResource(
                    ...
                    040.0,
                    150.0,
                    "You put an unknown scroll in your backpack",
                    typeof(UnknownScroll)
                )
            };
            ...
            if (res == resource)
            {
                try
                {
                    ...
                    if (Utility.RandomMinMax(1, 100) < 3) // CHECK TO SEE IF THEY WERE WITNESSED DIGGING UP A GRAVE 2%
                    {
                        ...
                        {
                            from.SendMessage(
                                "Someone passed by, but your stealthiness has avoided you from being seen."
                            );
                        ...
                        if (caught > 0)
                        {
                            from.PrivateOverheadMessage(
                                ...
                                1150,
                                false,
                                "Someone has spotted you in the distance!",
                                from.NetState
                            );
