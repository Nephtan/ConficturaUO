...
namespace Server.Engines.Harvest
{
    public class Lumberjacking : HarvestSystem
    {
        ...
        private Lumberjacking()
        {
            ...
            lumber.ConsumedPerIslesDreadHarvest =
                lumber.ConsumedPerHarvest
                + (int)(lumber.ConsumedPerHarvest / 2)
                    ...
                    if (wear > 0 && ((BaseWeapon)tool).MaxHitPoints > 0)
                    {
                        ...
                        if (wear > 0)
                        {
                            if (((BaseWeapon)tool).MaxHitPoints > wear)
                            {
                                ...
                                if (
                                    ((BaseWeapon)tool).Parent is Mobile
                                    && Utility.RandomMinMax(1, 10) == 1
                                )
                                    ((Mobile)(((BaseWeapon)tool).Parent)).LocalOverheadMessage(
                                        MessageType.Regular,
                                        0x3B2,
                                        1061121
