...
namespace Server.Engines.Harvest
{
    public class HarvestDefinition
    {
        private int m_BankWidth,
            m_BankHeight;
        private int m_MinTotal,
            m_MaxTotal;
        private int[] m_Tiles;
        private bool m_RangedTiles;
        private TimeSpan m_MinRespawn,
            m_MaxRespawn;
        private int m_MaxRange;
        private int m_ConsumedPerHarvest,
            m_ConsumedPerIslesDreadHarvest;
        ...
        {
            get { return m_ConsumedPerHarvest; }
            set { m_ConsumedPerHarvest = value; }
        }
        public int ConsumedPerIslesDreadHarvest
        {
            get { return m_ConsumedPerIslesDreadHarvest; }
            set { m_ConsumedPerIslesDreadHarvest = value; }
        }
