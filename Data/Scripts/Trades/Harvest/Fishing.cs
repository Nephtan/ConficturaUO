...
namespace Server.Engines.Harvest
{
    public class Fishing : HarvestSystem
    {
        ...
        private Fishing()
        {
            ...
            fish.ConsumedPerHarvest = 1 * Server.Misc.MyServerSettings.Resources();
            fish.ConsumedPerIslesDreadHarvest =
                fish.ConsumedPerHarvest + (int)(fish.ConsumedPerHarvest / 2) + 2;
            ...
            veins = new HarvestVein[] { new HarvestVein(100.0, 0.0, res[0], null) };
            ...
            fish.BonusResources = new BonusHarvestResource[]
            {
                ...
                new BonusHarvestResource(80.0, 0.6, 1072597, typeof(MysticalPearl))
            };
        ...
        public override void OnConcurrentHarvest(
            Mobile from,
            Item tool,
        ...
        public static double PoleSkill(Mobile m)
        {
            Item pole = null;

            if (
                m.FindItemOnLayer(Layer.OneHanded) != null
                && m.FindItemOnLayer(Layer.OneHanded) is FishingPole
            )
            {
                pole = m.FindItemOnLayer(Layer.OneHanded);
            }
            else if (
                m.FindItemOnLayer(Layer.FirstValid) != null
                && m.FindItemOnLayer(Layer.FirstValid) is FishingPole
            )
            {
                pole = m.FindItemOnLayer(Layer.FirstValid);
            }
            ...
            if (pole != null)
            {
                bonus = FishingPole.PoleSkill(pole);
            }

            return bonus;
        }

        public static double FishSkills(Mobile from, bool checkAll)
        {
            double skill = from.Skills[SkillName.Seafaring].Base;

            if (checkAll)
            {
                skill = from.Skills[SkillName.Seafaring].Value;
            }

            return skill + PoleSkill(from);
        }

        public static void FishingSkill(Mobile from, int c)
        {
            if (
                (Worlds.IsOnBoat(from) && from.Skills[SkillName.Seafaring].Base >= 50)
        ...
        private static MutateEntry[] m_MutateTable = new MutateEntry[]
        {
            new MutateEntry(
                ...
                4080.0,
                true,
                typeof(SpecialFishingNet),
                typeof(SpecialFishingNet),
                typeof(NeptunesFishingNet),
                typeof(FabledFishingNet),
                typeof(FabledFishingNet)
            ),
            new MutateEntry(
                90.0,
        ...
        )
        {
            ...
            double skillBase = FishSkills(from, false);
            double skillValue = FishSkills(from, true);
            ...
            for (int i = 0; i < m_MutateTable.Length; ++i)
            {
                ...
                {
                    double chance =
                        (skillValue - entry.m_MinSkill) / (entry.m_MaxSkill - entry.m_MinSkill);
        ...
        public static void FishUpFromSpaceship(Mobile from)
        {
            ...
            {
                nGuild = (int)(FishSkills(from, true) / 4);
            }

            int nChance = (int)(FishSkills(from, true) / 4) + nGuild;
        ...
        public static void FishUpFromRuins(Mobile from)
        {
            ...
            if (pc.NpcGuild != NpcGuild.FishermensGuild)
            {
                nGuild = (int)(FishSkills(from, true) / 25);
            }

            Item preLoot = new RustyJunk();

            int goldBoost = (int)(FishSkills(from, true) * nGuild);
            switch (Utility.Random(18))
            {
                case 0:
                    preLoot = new DDRelicLeather();
                    DDRelicLeather RL0 = (DDRelicLeather)preLoot;
                    RL0.RelicGoldValue = RL0.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 1:
                    preLoot = new DDRelicOrbs();
                    DDRelicOrbs RL1 = (DDRelicOrbs)preLoot;
                    RL1.RelicGoldValue = RL1.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 2:
                    preLoot = new DDRelicPainting();
                    DDRelicPainting RL2 = (DDRelicPainting)preLoot;
                    RL2.RelicGoldValue = RL2.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 3:
                    preLoot = new DDRelicRugAddonDeed();
                    DDRelicRugAddonDeed RL3 = (DDRelicRugAddonDeed)preLoot;
                    RL3.RelicGoldValue = RL3.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 4:
                    preLoot = new DDRelicScrolls();
                    DDRelicScrolls RL4 = (DDRelicScrolls)preLoot;
                    RL4.RelicGoldValue = RL4.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 5:
                    preLoot = new DDRelicStatue();
                    DDRelicStatue RL5 = (DDRelicStatue)preLoot;
                    RL5.RelicGoldValue = RL5.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 6:
                    preLoot = new DDRelicVase();
                    DDRelicVase RL6 = (DDRelicVase)preLoot;
                    RL6.RelicGoldValue = RL6.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 7:
                    preLoot = new DDRelicWeapon();
                    DDRelicWeapon RL7 = (DDRelicWeapon)preLoot;
                    RL7.RelicGoldValue = RL7.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 8:
                    preLoot = new DDRelicArmor();
                    DDRelicArmor RL8 = (DDRelicArmor)preLoot;
                    RL8.RelicGoldValue = RL8.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 9:
                    preLoot = new DDRelicArts();
                    DDRelicArts RL9 = (DDRelicArts)preLoot;
                    RL9.RelicGoldValue = RL9.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 10:
                    preLoot = new DDRelicBanner();
                    DDRelicBanner RL10 = (DDRelicBanner)preLoot;
                    RL10.RelicGoldValue = RL10.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 11:
                    preLoot = new DDRelicBearRugsAddonDeed();
                    DDRelicBearRugsAddonDeed RL11 = (DDRelicBearRugsAddonDeed)preLoot;
                    RL11.RelicGoldValue = RL11.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 12:
                    preLoot = new DDRelicBook();
                    DDRelicBook RL12 = (DDRelicBook)preLoot;
                    RL12.RelicGoldValue = RL12.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 13:
                    preLoot = new DDRelicCloth();
                    DDRelicCloth RL13 = (DDRelicCloth)preLoot;
                    RL13.RelicGoldValue = RL13.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 14:
                    preLoot = new DDRelicFur();
                    DDRelicFur RL14 = (DDRelicFur)preLoot;
                    RL14.RelicGoldValue = RL14.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 15:
                    preLoot = new DDRelicInstrument();
                    DDRelicInstrument RL15 = (DDRelicInstrument)preLoot;
                    RL15.RelicGoldValue = RL15.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 16:
                    preLoot = new DDRelicJewels();
                    DDRelicJewels RL16 = (DDRelicJewels)preLoot;
                    RL16.RelicGoldValue = RL16.RelicGoldValue + goldBoost;
                    preLoot.InvalidateProperties();
                    break;
                case 17:
                    ...
                    {
                        case 0:
                            preLoot = new DDRelicClock1();
                            DDRelicClock1 RL17 = (DDRelicClock1)preLoot;
                            RL17.RelicGoldValue = RL17.RelicGoldValue + goldBoost;
                            preLoot.InvalidateProperties();
                            break;
                        case 1:
                            preLoot = new DDRelicClock2();
                            DDRelicClock2 RL18 = (DDRelicClock2)preLoot;
                            RL18.RelicGoldValue = RL18.RelicGoldValue + goldBoost;
                            preLoot.InvalidateProperties();
                            break;
                        case 2:
                            preLoot = new DDRelicClock3();
                            DDRelicClock3 RL19 = (DDRelicClock3)preLoot;
                            RL19.RelicGoldValue = RL19.RelicGoldValue + goldBoost;
                            preLoot.InvalidateProperties();
                            break;
                    }
                    break;
        ...
        public static void FishUpFromMajorWreck(Mobile from)
        {
            ...
            int mLevel = (int)(FishSkills(from, true) / 10) + 1;
            ...
            switch (nWave)
            {
                ...
                case 7: // Random Relic
                {
                    int goldBoost = (int)FishSkills(from, true);
                    switch (Utility.Random(18))
                    {
                        case 0:
                            preLoot = new DDRelicLeather();
        ...
        private static void GetRandomAOSStats(
            ...
            if (pack != null)
            {
                ...
                for (int i = 0; i < messages.Count; ++i)
                {
                    ...
                    if (from.Map == sos.TargetMap && from.InRange(sos.TargetLocation, 60))
                    {
                        ...
                        switch (nWave)
                        {
                            case 1: // Body parts
                            {
                                ...
                                else
                                {
                                    ...
                                    preLoot = new ShipwreckedItem(
                                        Utility.RandomList(list),
                                        sos.ShipName
                                    );
                                    preLoot.Hue = Utility.RandomList(
                                        0xB97,
                                        0xB98,
                                        0xB99,
                                        0xB9A,
                            ...
                            case 3: // Misc
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        preLoot = new ShipwreckedItem(
                                            Utility.RandomList(0x4FE8, 0x4FE9),
                                            sos.ShipName
                                        );
                                    }
                                    else
                            ...
                            case 5: // Hats
                            {
                                if (nChance > Utility.Random(100))
                                {
                                    ...
                                    if (Utility.RandomBool())
                                    {
                                        preLoot.Name = sAdj + "skullcap";
                                        preLoot.ItemID = 5444;
                                    }
                                    else
                                    {
                                        preLoot.Name = sAdj + "pirate hat";
                                        preLoot.ItemID = 5915;
                                    }
                            ...
                            case 6: // Sea Relic
                            {
                                if (nChance > Utility.Random(100))
                                {
                                    ...
                                    int nGold = (int)(FishSkills(from, true) / 20);
                            ...
                            case 8: // Random Relic
                            {
                                ...
                                switch (Utility.Random(19))
                                {
                                    ...
                                    case 11:
                                        preLoot = new DDRelicBearRugsAddonDeed();
                                        DDRelicBearRugsAddonDeed RL11 =
                                            (DDRelicBearRugsAddonDeed)preLoot;
                                        RL11.RelicGoldValue = RL11.RelicGoldValue + goldBoost;
                                        preLoot.InvalidateProperties();
                                        break;
                                    case 12:
                                    ...
                                    case 18:
                                        ...
                                        {
                                            case 0:
                                                preLoot = new TreasurePile01AddonDeed();
                                                break;
                                            case 1:
                                                preLoot = new TreasurePileAddonDeed();
                                                break;
                                            case 2:
                                                preLoot = new TreasurePile2AddonDeed();
                                                break;
                                            case 3:
                                                preLoot = new TreasurePile2AddonDeed();
                                                break;
                                            case 4:
                                                preLoot = new TreasurePile03AddonDeed();
                                                break;
                                            case 5:
                                                preLoot = new TreasurePile3AddonDeed();
                                                break;
                                            case 6:
                                                preLoot = new TreasurePile04AddonDeed();
                                                break;
                                            case 7:
                                                preLoot = new TreasurePile05AddonDeed();
                                                break;
                                        }
                                        break;
                                }
                            ...
                            {
                                int golden = (int)(FishSkills(from, true) / 10) + 3;
                                if (Utility.RandomBool())
                                {
                                    switch (Utility.Random(2))
                                    {
                                        case 0:
                                            preLoot = new CorpseSailor(golden);
                                            break;
                                        case 1:
                                            preLoot = new SunkenBag(golden);
                                            break;
                                    }
                                }
                                else
                                {
                                    ...
                                    {
                                        case 0:
                                            preLoot.ItemID = Utility.RandomList(0x4FDB, 0x4FDC);
                                            preLoot.Name = "sea captain shelf";
                                            break;
                                        case 1:
                                            preLoot.ItemID = Utility.RandomList(0x4FF4, 0x4FF5);
                                            preLoot.Name = "barnacled chest";
                                            break;
                                        case 2:
                                            preLoot.ItemID = Utility.RandomList(0x4FEA, 0x4FEB);
                                            preLoot.Name = "royal chest";
                                            break;
                                        case 3:
                                            preLoot.ItemID = Utility.RandomList(0x4FEC, 0x4FED);
                                            preLoot.Name = "royal cabinet";
                                            break;
                                        case 4:
                                            preLoot.ItemID = Utility.RandomList(0x4FEE, 0x4FEF);
                                            preLoot.Name = "royal cabinet";
                                            break;
                                        case 5:
                                            preLoot.ItemID = Utility.RandomList(0x4FF0, 0x4FF0);
                                            preLoot.Name = "royal dresser";
                                            break;
                                        case 6:
                                            preLoot.ItemID = Utility.RandomList(0x4FF2, 0x4FF3);
                                            preLoot.Name = "royal trunk";
                                            break;
                                    }
                                }
                                break;
                        ...
                        {
                            monster = Utility.RandomMinMax(5, 9);
                        }
                        else if (sos.Level == 3)
                        {
                            monster = Utility.RandomMinMax(10, 11);
                        }
                        else if (sos.Level == 4)
                        {
                            monster = Utility.RandomMinMax(12, 15);
                        }
                        ...
                        switch (monster)
                        {
                            case 1:
                                ...
                                break; // 1
                            case 2:
                                creature = new GiantEel();
                                Screature = "Shipwreck Eel";
                                break; // 1
                            case 3:
                                creature = new SeaSerpent();
                                Screature = "Shipwreck Serpent";
                                break; // 1
                            case 4:
                                creature = new Shark();
                                Screature = "Shipwreck Shark";
                                break; // 1
                            case 5:
                                creature = new SeaDrake();
                                Screature = "Shipwreck Drake";
                                break; // 2
                            case 6:
                                creature = new DeepSeaSerpent();
                                Screature = "Shipwreck Serpent";
                                break; // 2
                            case 7:
                                creature = new GreatWhite();
                                Screature = "Shipwreck Great White Shark";
                                break; // 2
                            case 8:
                                creature = new SeaHag();
                                Screature = "Shipwreck Hag";
                                break; // 2
                            case 9:
                                creature = new EyeOfTheDeep();
                                Screature = "Shipwreck Eye";
                                break; // 2
                            case 10:
                                creature = new SeaDragon();
                                Screature = "Shipwreck Dragon";
                                break; // 3
                            case 11:
                                creature = new DemonOfTheSea();
                                Screature = "Shipwreck Demon";
                                break; // 3
                            case 12:
                                creature = new SeaGiant();
                                Screature = "Shipwreck Giant";
                                break; // 4
                            case 13:
                                creature = new StormGiant();
                                Screature = "Shipwreck Giant";
                                break; // 4
                            case 14:
                                creature = new GiantSquid();
                                Screature = "Shipwreck Squid";
                                break; // 4
                            case 15:
                                creature = new SeaHagGreater();
                                Screature = "Shipwreck Hag";
                                break; // 4
                            case 16:
                                creature = new Calamari();
                                Screature = "Shipwreck Calamari";
                                break; // 5
                            case 17:
                                creature = new Kraken();
                                Screature = "Shipwreck Kraken";
                                break; // 5
                            case 18:
                                creature = new Megalodon();
                                Screature = "Shipwreck Megalodon";
                                break; // 5
                            case 19:
                                creature = new DeepSeaDragon();
                                Screature = "Shipwreck Wyrm";
                                break; // 5
                        }
                        ...
                        for (int c = 0; map != null && c < 20; ++c)
                        {
                            ...
                            if (
                                t.Z == -5
                                && Server.Misc.Worlds.IsWaterTile(t.ID, 0)
                        ...
                        {
                            case 0:
                                preLoot = ArtifactBuilder.CreateArtifact("driftwood");
                                break;
                            case 1:
                                preLoot = ArtifactBuilder.CreateArtifact("kelp");
                                break;
                            case 2:
                                preLoot = ArtifactBuilder.CreateArtifact("barnacle");
                                break;
                            case 3:
                                preLoot = ArtifactBuilder.CreateArtifact("bronzed");
                                break;
                            case 4:
                                preLoot = ArtifactBuilder.CreateArtifact("neptune");
                                break;
                            case 5:
                                preLoot = new ShipwreckedItem(
                                    Utility.Random(0xE9F, 10),
                        ...
                        from.SendMessage(
                            "Your hook got caught on a creature from the wreck below!"
                        );
        ...
        public override bool Give(Mobile m, Item item, bool placeAtFeet)
        {
            if (
                ...
                || item is FabledFishingNet
                || item is NeptunesFishingNet
            )
            {
            ...
            if (item is NewFish)
            {
                int nFishingSkill = (int)(FishSkills(m, true) / 5);
        ...
        public override void OnHarvestStarted(
            Mobile from,
            Item tool,
            HarvestDefinition def,
            object toHarvest
        ...
        {
            if (
                from.FindItemOnLayer(Layer.OneHanded) == null
                || tool != from.FindItemOnLayer(Layer.OneHanded)
            )
            {
