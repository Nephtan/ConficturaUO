...
namespace Server.Items
{
    ...
    public class BowyerShoppe : BaseShoppe
    {
            ...
            else
            {
                ...
                switch (Utility.RandomMinMax(1, 8))
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        task = task + "repeating crossbow";
                        break;
                    case 6:
                        task = task + "heavy crossbow";
                        break;
                    case 7:
                        task = task + "composite longbow";
                        break;
                    case 8:
                        task = task + "composite shortbow";
                        break;
                }
            }
        ...
        public BowyerShoppe(Serial serial)
            : base(serial) { }
