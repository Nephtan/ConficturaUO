...
namespace Server.Items
{
    ...
    public class BlacksmithShoppe : BaseShoppe
    {
        ...
        public static string MakeThisTask()
        {
            ...
            switch (Utility.RandomMinMax(1, 10))
            {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    task = "Smooth the dents from";
                    break;
                case 10:
                    task = "Remove the dents from";
                    break;
            }
            ...
            switch (Utility.RandomMinMax(1, 84))
            {
                ...
                case 26:
                    ...
                    break;
                case 27:
                    item = new ElvenMachete();
                    break;
                case 28:
                    item = new ElvenShield();
                    break;
                case 29:
                    item = new ElvenSpellblade();
                    break;
                case 30:
        ...
        public BlacksmithShoppe(Serial serial)
            : base(serial) { }
