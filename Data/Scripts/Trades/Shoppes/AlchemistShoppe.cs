...
namespace Server.Items
{
    ...
    public class AlchemistShoppe : BaseShoppe
    {
        ...
        public static string MakeThisTask()
        {
            ...
            {
                case 0:
                    task = task + sWord + " and " + sType + " into a vial of ";
                    break;
                case 1:
                    task = task + sWord + " and " + sType + " into a bottle of ";
                    break;
                case 2:
                    task = task + sWord + " and " + sType + " into a flask of ";
                    break;
                case 3:
                    task = task + sWord + " and " + sType + " into a jar of ";
                    break;
            }
        ...
        public AlchemistShoppe(Serial serial)
            : base(serial) { }
