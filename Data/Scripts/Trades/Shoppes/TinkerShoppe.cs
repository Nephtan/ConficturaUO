    ...
    public class TinkerShoppe : BaseShoppe
    {
        ...
        public static string MakeThisTask()
        {
            ...
            if (Utility.RandomMinMax(1, 3) == 1)
            {
                ...
                {
                    case 1:
                        item = new MagicLantern();
                        break;
                    case 2:
                        item = new MagicCandle();
                        break;
                    case 3:
                        item = new MagicJewelryRing();
                        break;
                    case 4:
                        item = new MagicJewelryNecklace();
                        break;
                    case 5:
                        item = new MagicJewelryEarrings();
                        break;
                    case 6:
                        item = new MagicJewelryBracelet();
                        break;
                    case 7:
                        item = new MagicJewelryCirclet();
                        break;
                }
        ...
        public TinkerShoppe(Serial serial)
            : base(serial) { }
