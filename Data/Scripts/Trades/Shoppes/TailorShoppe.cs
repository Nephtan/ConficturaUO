...
namespace Server.Items
{
    ...
    public class TailorShoppe : BaseShoppe
    {
            ...
            else
            {
                ...
                switch (Utility.RandomMinMax(1, 17))
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        task = task + "short pants";
                        break;
                    case 3:
                        task = task + "long pants";
                        break;
                    case 4:
                        task = task + "fancy dress";
                        break;
                    case 5:
                        task = task + "plain dress";
                        break;
                    case 6:
                        task = task + "kilt";
                        break;
                    case 7:
                        task = task + "half apron";
                        break;
                    case 8:
                        task = task + "loin cloth";
                        break;
                    case 9:
                        task = task + "cloak";
                        break;
                    ...
                    case 11:
                        ...
                        break;
                    case 12:
                        task = task + "floppy hat";
                        break;
                    case 13:
                        task = task + "wizard hat";
                        break;
                    case 14:
                        task = task + "witch hat";
                        break;
        ...
        public TailorShoppe(Serial serial)
            : base(serial) { }
