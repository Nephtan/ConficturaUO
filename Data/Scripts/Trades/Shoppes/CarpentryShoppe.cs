...
namespace Server.Items
{
    ...
    public class CarpentryShoppe : BaseShoppe
    {
            ...
            if (Utility.RandomMinMax(1, 5) == 1)
            {
                ...
                switch (Utility.RandomMinMax(1, 14))
                {
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        item = new WoodenPlateArms();
                        break;
                    case 10:
                        item = new WoodenPlateHelm();
                        break;
                    case 11:
                        item = new WoodenPlateGloves();
                        break;
                    case 12:
                        item = new WoodenPlateGorget();
                        break;
                    case 13:
                        item = new WoodenPlateLegs();
                        break;
                    case 14:
                        item = new WoodenPlateChest();
                        break;
                }
            ...
            else
            {
                ...
                switch (Utility.RandomMinMax(1, 20))
                {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        task = task + "nightstand";
                        break;
                    case 7:
                        task = task + "writing table";
                        break;
                    case 8:
                        task = task + "table";
                        break;
        ...
        public CarpentryShoppe(Serial serial)
            : base(serial) { }
