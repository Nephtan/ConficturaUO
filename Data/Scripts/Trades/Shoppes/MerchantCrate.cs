...
namespace Server.Items
{
    ...
    public class MerchantCrate : Container
    {
        ...
        public class SpeechGumpEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                PlayerMobile mobile = (PlayerMobile)m_Mobile;
                {
                    ...
                    {
                        mobile.SendGump(new SpeechGump(mobile, "A Hard Day's Work", SpeechFunctions.SpeechText(m_Mobile, m_Mobile, "MerchantCrate")));
                    }
                }
            }
        }
        ...
        public static int GetItemValue(Item item, int amount)
        {
            ...
            else if (item is OrnateAxe) { gold = 27 * amount; }
            ...
            else if (item is HoodedMantle) { gold = 6 * amount; }
            ...
            else if (item is DruidCauldron) { gold = 8 * amount; }
            ...
            else if (item is ElementalSpellbook) { gold = 30 * amount; }
            ...
            else if (item is Hammers) { gold = 14 * amount; }
            ...
            else if (item is LargeKnife) { gold = 10 * amount; }
            ...
            else if (item is ShinobiHood) { gold = 5 * amount; }
            else if (item is ShinobiMask) { gold = 5 * amount; }
            else if (item is ShinobiCowl) { gold = 5 * amount; }
            ...
            else if (item is HikingBoots) { gold = 45 * amount; }
            ...
            else if (item is ShinobiRobe) { gold = 80 * amount; }
            else if (item is OniwabanBoots) { gold = 60 * amount; }
            else if (item is OniwabanGloves) { gold = 30 * amount; }
            else if (item is OniwabanHood) { gold = 5 * amount; }
            else if (item is OniwabanLeggings) { gold = 40 * amount; }
            else if (item is OniwabanTunic) { gold = 52 * amount; }
            ...
            else if (item is Trumpet) { gold = 65 * amount; }
            ...
            else if (item is Pitchforks) { gold = 9 * amount; }
            ...
            else if ((item.GetType()).IsAssignableFrom(typeof(PresetMapEntry))) { gold = 6 * amount; }
            ...
            else if (item is ShortSword) { gold = 17 * amount; }
            ...
            else if (item is SpikedClub) { gold = 14 * amount; }
            ...
            else if (item is TrainingDaemonEastDeed) { gold = 250 * amount; }
            else if (item is TrainingDaemonSouthDeed) { gold = 250 * amount; }
            ...
            else if (item is Claymore) { gold = 29 * amount; }
            ...
            else if (item is Whip) { gold = 8 * amount; }
            ...
            else if (item is WitchCauldron) { gold = 8 * amount; }
            ...
            else if (item is CounterFancy) { gold = 110 * amount; }
            else if (item is CounterWood) { gold = 110 * amount; }
            else if (item is CounterWooden) { gold = 110 * amount; }
            else if (item is CounterStained) { gold = 110 * amount; }
            else if (item is CounterPolished) { gold = 110 * amount; }
            else if (item is CounterRustic) { gold = 110 * amount; }
            else if (item is CounterDark) { gold = 110 * amount; }
            else if (item is CounterLight) { gold = 110 * amount; }
