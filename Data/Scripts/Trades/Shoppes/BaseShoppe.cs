...
namespace Server.Items
{
    ...
    public class BaseShoppe : Item, ISecurable
    {
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (ShoppeOwner.Name == null)
            {
                list.Add(1070722, "Owner: " + ShoppeName + "");
            }
            else
            {
        ...
        public static string MakeTask(BaseShoppe shoppe)
        {
            ...
            {
                task = Server.Items.MorticianShoppe.MakeThisTask();
            }
            else if (shoppe is HerbalistShoppe)
            {
                task = Server.Items.HerbalistShoppe.MakeThisTask();
            }
            else if (shoppe is AlchemistShoppe)
            {
                task = Server.Items.AlchemistShoppe.MakeThisTask();
            }
            else if (shoppe is BlacksmithShoppe)
            {
                task = Server.Items.BlacksmithShoppe.MakeThisTask();
            }
            else if (shoppe is BowyerShoppe)
            {
                task = Server.Items.BowyerShoppe.MakeThisTask();
            }
            else if (shoppe is CarpentryShoppe)
            {
                task = Server.Items.CarpentryShoppe.MakeThisTask();
            }
            else if (shoppe is CartographyShoppe)
            {
                task = Server.Items.CartographyShoppe.MakeThisTask();
            }
            else if (shoppe is BakerShoppe)
            {
                task = Server.Items.BakerShoppe.MakeThisTask();
            }
            else if (shoppe is LibrarianShoppe)
            {
                task = Server.Items.LibrarianShoppe.MakeThisTask();
            }
            else if (shoppe is TailorShoppe)
            {
                task = Server.Items.TailorShoppe.MakeThisTask();
            }
            else if (shoppe is TinkerShoppe)
            {
                task = Server.Items.TinkerShoppe.MakeThisTask();
            }

            if (task == null || task == "")
            {
                task = "Craft that item they need for their upcoming journey";
            }
        ...
        public static void GiveNewShoppe(Mobile from, Mobile merchant)
        {
            ...
            if (
                merchant is NecroMage
                || merchant is Witches
                || merchant is Necromancer
                || merchant is NecromancerGuildmaster
            )
            {
                shoppe = new MorticianShoppe();
            }
            else if (
                merchant is Herbalist
                || merchant is DruidTree
                || merchant is Druid
                || merchant is DruidGuildmaster
            )
            {
                shoppe = new HerbalistShoppe();
            }
            else if (merchant is Alchemist || merchant is AlchemistGuildmaster)
            {
                shoppe = new AlchemistShoppe();
            }
            else if (merchant is Blacksmith || merchant is BlacksmithGuildmaster)
            {
                shoppe = new BlacksmithShoppe();
            }
            else if (merchant is Bowyer || merchant is ArcherGuildmaster)
            {
                shoppe = new BowyerShoppe();
            }
            else if (merchant is Carpenter || merchant is CarpenterGuildmaster)
            {
                shoppe = new CarpentryShoppe();
            }
            else if (merchant is Mapmaker || merchant is CartographersGuildmaster)
            {
                shoppe = new CartographyShoppe();
            }
            else if (merchant is Cook || merchant is Baker || merchant is CulinaryGuildmaster)
            {
                shoppe = new BakerShoppe();
            }
            else if (merchant is Scribe || merchant is Sage || merchant is LibrarianGuildmaster)
            {
                shoppe = new LibrarianShoppe();
            }
            else if (
                merchant is Weaver
                || merchant is Tailor
                || merchant is LeatherWorker
                || merchant is TailorGuildmaster
            )
            {
                shoppe = new TailorShoppe();
            }
            else if (merchant is Tinker || merchant is TinkerGuildmaster)
            {
                shoppe = new TinkerShoppe();
            }
            ...
            {
                merchant.PublicOverheadMessage(
                    MessageType.Regular,
                    0,
                    false,
                    string.Format("Good luck with your shoppe.")
                );
            }
            else if (gold >= fee && shoppe != null)
            {
                ...
                if (begging)
                    merchant.PublicOverheadMessage(
                        ...
                        false,
                        string.Format(
                            "Since you are begging, this shoppe is only " + fee + " gold."
                        )
                    );
                else
                    merchant.PublicOverheadMessage(
                ...
                merchant.PublicOverheadMessage(
                    ...
                    0,
                    false,
                    string.Format("Sorry, but you do not have enough gold to start a shoppe.")
                );
        }
        ...
        public static bool AlreadyHasShoppe(Mobile from, Item shelf)
        {
            ...
            {
                if (item is MorticianShoppe && item != shoppe && shoppe is MorticianShoppe)
                {
                    targets.Add(item);
                }
                else if (item is HerbalistShoppe && item != shoppe && shoppe is HerbalistShoppe)
                {
                    targets.Add(item);
                }
                else if (item is AlchemistShoppe && item != shoppe && shoppe is AlchemistShoppe)
                {
                    targets.Add(item);
                }
                else if (item is BlacksmithShoppe && item != shoppe && shoppe is BlacksmithShoppe)
                {
                    targets.Add(item);
                }
                else if (item is BowyerShoppe && item != shoppe && shoppe is BowyerShoppe)
                {
                    targets.Add(item);
                }
                else if (item is CarpentryShoppe && item != shoppe && shoppe is CarpentryShoppe)
                {
                    targets.Add(item);
                }
                else if (item is CartographyShoppe && item != shoppe && shoppe is CartographyShoppe)
                {
                    targets.Add(item);
                }
                else if (item is BakerShoppe && item != shoppe && shoppe is BakerShoppe)
                {
                    targets.Add(item);
                }
                else if (item is LibrarianShoppe && item != shoppe && shoppe is LibrarianShoppe)
                {
                    targets.Add(item);
                }
                else if (item is TailorShoppe && item != shoppe && shoppe is TailorShoppe)
                {
                    targets.Add(item);
                }
                else if (item is TinkerShoppe && item != shoppe && shoppe is TinkerShoppe)
                {
                    targets.Add(item);
                }
            }
        ...
        public static void ProgressSkill(Mobile from, BaseShoppe shoppe)
        {
            if (shoppe is MorticianShoppe)
            {
                from.CheckSkill(SkillName.Forensics, 0, 125);
            }
            else if (shoppe is HerbalistShoppe)
            {
                from.CheckSkill(SkillName.Druidism, 0, 125);
            }
            else if (shoppe is AlchemistShoppe)
            {
                from.CheckSkill(SkillName.Alchemy, 0, 125);
            }
            else if (shoppe is BlacksmithShoppe)
            {
                from.CheckSkill(SkillName.Blacksmith, 0, 125);
            }
            else if (shoppe is BowyerShoppe)
            {
                from.CheckSkill(SkillName.Bowcraft, 0, 125);
            }
            else if (shoppe is CarpentryShoppe)
            {
                from.CheckSkill(SkillName.Carpentry, 0, 125);
            }
            else if (shoppe is CartographyShoppe)
            {
                from.CheckSkill(SkillName.Cartography, 0, 125);
            }
            else if (shoppe is BakerShoppe)
            {
                from.CheckSkill(SkillName.Cooking, 0, 125);
            }
            else if (shoppe is LibrarianShoppe)
            {
            ...
            {
                from.CheckSkill(SkillName.Tailoring, 0, 125);
            }
            else if (shoppe is TinkerShoppe)
            {
                from.CheckSkill(SkillName.Tinkering, 0, 125);
            }
        }
        ...
        public class CashOutEntry : ContextMenuEntry
        {
            ...
            public CashOutEntry(Mobile from, BaseShoppe shelf)
                : base(6113, 3)
            {
                m_Mobile = from;
                m_Shoppe = shelf;
            ...
            public override void OnClick()
            {
                ...
                PlayerMobile mobile = (PlayerMobile)m_Mobile;
                {
                    ...
                    {
                        int barter = (int)m_Mobile.Skills[SkillName.Mercantile].Value;
                        ...
                        int cash = (int)(
                            m_Shoppe.ShoppeGold + (m_Shoppe.ShoppeGold * (barter / 100))
                        );

                        m_Mobile.AddToBackpack(new BankCheck(cash));
                        m_Mobile.SendMessage(
                            "You now have a check for " + cash.ToString() + " gold."
                        );
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            if ((dropped.ItemID >= 0x1BE3 && dropped.ItemID <= 0x1BFA) && this is BlacksmithShoppe)
            {
                procResource = true;
            }
            else if ((dropped.ItemID >= 0x1BE3 && dropped.ItemID <= 0x1BFA) && this is TinkerShoppe)
            {
                procResource = true;
            }
            else if (
                (dropped is BoltOfCloth || dropped is Cloth || dropped is UncutCloth)
                && this is TailorShoppe
            )
            {
                procResource = true;
            }
            else if (
                Server.Misc.MaterialInfo.IsReagent(dropped)
                && Server.Items.WitchPouch.isWitchery(dropped)
                && this is MorticianShoppe
            )
            {
                procResource = true;
            }
            else if ((dropped is BlankScroll) && this is LibrarianShoppe)
            {
                procResource = true;
            }
            else if ((dropped is Dough) && this is BakerShoppe)
            {
                procResource = true;
            }
            else if ((dropped is BlankScroll || dropped is BlankMap) && this is CartographyShoppe)
            {
                procResource = true;
            }
            else if ((dropped is BaseLog || dropped is BaseWoodBoard) && this is CarpentryShoppe)
            {
                procResource = true;
            }
            else if ((dropped is BaseLog || dropped is BaseWoodBoard) && this is BowyerShoppe)
            {
                procResource = true;
            }
            else if (
                Server.Misc.MaterialInfo.IsReagent(dropped)
                && Server.Items.DruidPouch.isDruidery(dropped)
                && this is HerbalistShoppe
            )
            {
                procResource = true;
            }
            else if (Server.Misc.MaterialInfo.IsReagent(dropped) && this is AlchemistShoppe)
            {
                procResource = true;
            }
            else if (
                (
                    dropped is GodSmithing
                    || dropped is SledgeHammer
                    || dropped is SmithHammer
                    || dropped is Tongs
                    || dropped is AncientSmithyHammer
                )
                && this is BlacksmithShoppe
            )
            {
                procTools = true;
            }
            else if (dropped is TinkerTools && this is TinkerShoppe)
            {
                procTools = true;
            }
            else if ((dropped is GodSewing || dropped is SewingKit) && this is TailorShoppe)
            {
                procTools = true;
            }
            else if (dropped is ScribesPen && this is LibrarianShoppe)
            {
                procTools = true;
            }
            else if (dropped is MapmakersPen && this is CartographyShoppe)
            {
                procTools = true;
            }
            else if (dropped is FletcherTools && this is BowyerShoppe)
            {
                procTools = true;
            }
            else if (dropped is WitchCauldron && this is MorticianShoppe)
            {
                procTools = true;
            }
            else if (dropped is DruidCauldron && this is HerbalistShoppe)
            {
                procTools = true;
            }
            else if ((dropped is MortarPestle || dropped is GodBrewing) && this is AlchemistShoppe)
            {
                procTools = true;
            }
            else if ((dropped is RollingPin || dropped is Skillet) && this is BakerShoppe)
            {
                procTools = true;
            }
            else if (
                (
                    dropped is DovetailSaw
                    ...
                    || dropped is Saw
                    || dropped is Scorp
                    || dropped is SmoothingPlane
                )
                && this is CarpentryShoppe
            )
            {
                procTools = true;
            }
        ...
        public BaseShoppe(Serial serial)
            : base(serial) { }
        ...
        private class CustomerTimer : Timer
        {
            ...
            public CustomerTimer(BaseShoppe shoppe)
        ...
        private class QuickTimer : Timer
        {
            ...
            public QuickTimer(BaseShoppe shoppe)
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public Mobile Shoppe_Owner
        {
            get { return ShoppeOwner; }
            set
            {
                ShoppeOwner = value;
        ...
        public int Shoppe_Gold
        {
            get { return ShoppeGold; }
            set
            {
                ShoppeGold = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Shoppe_Tools
        {
            get { return ShoppeTools; }
            set
            {
                ShoppeTools = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Shoppe_Resources
        {
            get { return ShoppeResources; }
            set
            {
                ShoppeResources = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Shoppe_Reputation
        {
            get { return ShoppeReputation; }
            set
            {
                ShoppeReputation = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Shoppe_Page
        {
            get { return ShoppePage; }
            set
            {
                ShoppePage = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Shelf_Skill
        {
            get { return ShelfSkill; }
            set
            {
                ShelfSkill = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public NpcGuild Shelf_Guild
        {
            get { return ShelfGuild; }
            set
            {
                ShelfGuild = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Shelf_Tools
        {
            get { return ShelfTools; }
            set
            {
                ShelfTools = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Shelf_Resources
        {
            get { return ShelfResources; }
            set
            {
                ShelfResources = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Shelf_Sound
        {
            get { return ShelfSound; }
            set
            {
                ShelfSound = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_01
        {
            get { return Customer01; }
            set
            {
                Customer01 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_02
        {
            get { return Customer02; }
            set
            {
                Customer02 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_03
        {
            get { return Customer03; }
            set
            {
                Customer03 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_04
        {
            get { return Customer04; }
            set
            {
                Customer04 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_05
        {
            get { return Customer05; }
            set
            {
                Customer05 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_06
        {
            get { return Customer06; }
            set
            {
                Customer06 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_07
        {
            get { return Customer07; }
            set
            {
                Customer07 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_08
        {
            get { return Customer08; }
            set
            {
                Customer08 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_09
        {
            get { return Customer09; }
            set
            {
                Customer09 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_10
        {
            get { return Customer10; }
            set
            {
                Customer10 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_11
        {
            get { return Customer11; }
            set
            {
                Customer11 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Customer_12
        {
            get { return Customer12; }
            set
            {
                Customer12 = value;
                InvalidateProperties();
        ...
        public static int GetSkillValue(int job, Mobile from)
        {
            ...
            if (job > 0)
            {
                ...
                else if (job == 56)
                {
                    return (int)(
                        (
                            from.Skills[SkillName.Forensics].Value
                            + from.Skills[SkillName.Necromancy].Value
                        ) / 2
                    );
                }
    ...
    public class ExplainShopped : Gump
    {
        ...
        public ExplainShopped(Mobile from, Mobile merchant)
            : base(50, 50)
        {
            m_From = from;
            m_Merchant = merchant;
            ...
            AddHtml(
                ...
                200,
                20,
                @"<BODY><BASEFONT Color=" + color + ">SETTING UP SHOPPE</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddHtml(
    ...
    public class ShoppeGump : Gump
    {
        ...
        public ShoppeGump(BaseShoppe shoppe, Mobile from)
            : base(50, 50)
        {
            m_Shop = shoppe;
            m_From = from;
            ...
            if (shoppe.ShoppePage == 3)
            {
                AddHtml(
                    ...
                    532,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">ABOUT SHOPPES</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Shows your shoppe's gold at the top, or for each individual contract.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + hilit
                        + ">Shows your shoppe's tool count at the top, or tools needed for each individual contract.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Shows your shoppe's resource count at the top, or resources needed for each individual contract.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + hilit
                        + ">Shows your reputation bonus if you are a member of the associated guild.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">Shows your chance to successfully fulfill a contract.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + hilit
                        + ">Shows your shoppe's reputation at the top, or for each individual contract.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">This will attempt to fulfill the contract. If you fail, you will lose materials and reputation. If you succeed, you will gain reputation and gold, as well as using up the appropriate materials.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + hilit
                        + ">This will refuse the request, but you will take a reduction in your shoppe's reputation by doing so.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            else
            {
                ...
                int guildBonus = 0;
                if (((PlayerMobile)from).NpcGuild == shoppe.ShelfGuild)
                {
                    guildBonus =
                        500
                        + (int)(Server.Items.BaseShoppe.GetSkillValue(shoppe.ShelfSkill, from) * 5);
                }
                ...
                AddHtml(
                    ...
                    48,
                    20,
                    @"<BODY><BASEFONT Color=" + hilit + ">" + guildBonus + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                ); // GUILD BONUS
                ...
                AddHtml(
                    ...
                    123,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Shoppe Owner:</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                while (entries > 0)
                {
                    ...
                    if (line == 1)
                    {
                        customer = shoppe.Customer01;
                    }
                    else if (line == 2)
                    {
                        customer = shoppe.Customer02;
                    }
                    else if (line == 3)
                    {
                        customer = shoppe.Customer03;
                    }
                    else if (line == 4)
                    {
                        customer = shoppe.Customer04;
                    }
                    else if (line == 5)
                    {
                        customer = shoppe.Customer05;
                    }
                    else if (line == 6)
                    {
                        customer = shoppe.Customer06;
                    }
                    else if (line == 7)
                    {
                        customer = shoppe.Customer07;
                    }
                    else if (line == 8)
                    {
                        customer = shoppe.Customer08;
                    }
                    else if (line == 9)
                    {
                        customer = shoppe.Customer09;
                    }
                    else if (line == 10)
                    {
                        customer = shoppe.Customer10;
                    }
                    else if (line == 11)
                    {
                        customer = shoppe.Customer11;
                    }
                    else if (line == 12)
                    {
                        customer = shoppe.Customer12;
                    }
                    ...
                    taskResources = Convert.ToInt32(
                        Server.Misc.Customers.GetDataElement(customer, 6)
                    );
                    taskDifficulty = Server.Misc.Customers.GetChance(
                        Server.Items.BaseShoppe.GetSkillValue(shoppe.ShelfSkill, from),
                        Convert.ToInt32(Server.Misc.Customers.GetDataElement(customer, 7))
                    );
                    taskReputation = Convert.ToInt32(
                        Server.Misc.Customers.GetDataElement(customer, 8)
                    );
                    ...
                    if (customer != "")
                    {
                        if (
                            taskDifficulty > 0
                            && shoppe.ShoppeTools >= taskTools
                            && shoppe.ShoppeResources >= taskResources
                            && (shoppe.ShoppeGold + taskGold) < 500001
                        )
                        {
                    ...
                    else
                    {
                        AddHtml(
                            ...
                            780,
                            20,
                            @"<BODY><BASEFONT Color=#284F9F>Done - Awaiting Next Customer</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    }
