...
namespace Server.Misc
{
    class Skulls
    {
        public static void MakeSkull(Mobile m, Container c, Mobile killer, string where)
        {
            ...
            else if (m is DaemonTemplate)
            {
                color = 0x846;
                bone = 2;
            }
            else if (m is Daemonic)
            {
                bone = 2;
            }
...
namespace Server.Items
{
    public class HeartOfIce : Item
    {
        ...
        public string Heart_Killer
        {
            get { return HeartKiller; }
            set
            {
                HeartKiller = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Heart_Where
        {
            get { return HeartWhere; }
            set
            {
                HeartWhere = value;
                InvalidateProperties();
        ...
        public HeartOfIce(Serial serial)
            : base(serial) { }
    ...
    public class SkullWyrm : Item
    {
        ...
        public SkullWyrm(Serial serial)
            : base(serial) { }
    ...
    public class SkullGreatDragon : Item
    {
        ...
        public SkullGreatDragon(Serial serial)
            : base(serial) { }
    ...
    public class SkullDragon : Item
    {
        ...
        public SkullDragon(Serial serial)
            : base(serial) { }
    ...
    public class SkullDemon : Item
    {
        ...
        public SkullDemon(Serial serial)
            : base(serial) { }
