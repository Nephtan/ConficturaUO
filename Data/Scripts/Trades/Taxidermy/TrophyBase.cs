...
namespace Server.Items
{
    ...
    public class TrophyBase : Item
    {
        ...
        public class TrophyGump : ContextMenuEntry
        {
            ...
            public TrophyGump(Mobile from, TrophyBase trophy)
                : base(6132, 3)
            {
                m_Mobile = from;
                m_Trophy = trophy;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            from.SendGump(
                new SpeechGump(
                    from,
                    "The Trophies of War",
                    SpeechFunctions.SpeechText(from, from, "Trophy")
                )
            );
        }
        ...
        private class CorpseTarget : Target
        {
            ...
            public CorpseTarget(TrophyBase boards)
                ...
                else
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        else
                        {
                            ...
                            if (
                                (typeof(AncientWyrm) == c.Owner.GetType())
                            ...
                            else if ((typeof(Wyrms) == c.Owner.GetType()))
                            {
                                ...
                                (typeof(NightWyrm) == c.Owner.GetType())
                            ...
                            )
                            {
                                ...
                                (typeof(Lizardman) == c.Owner.GetType())
                            ...
                            )
                            {
                                ...
                                (typeof(Sakleth) == c.Owner.GetType())
                            ...
                            else if ((typeof(Bugbear) == c.Owner.GetType()))
                            {
                                ...
                                (typeof(MinotaurCaptain) == c.Owner.GetType())
                            ...
                            )
                            {
                                ...
                                (typeof(Cyclops) == c.Owner.GetType())
                            ...
                            )
                            {
                                ...
                                (typeof(StoneGiant) == c.Owner.GetType())
                            ...
                            )
                            {
                                ...
                                (typeof(TundraOgre) == c.Owner.GetType())
                            ...
                            else if (typeof(EttinShaman) == c.Owner.GetType())
                            {
                                ...
                                (typeof(HillGiant) == c.Owner.GetType())
                            ...
                            )
                            {
                                ...
                                (typeof(FireGargoyle) == c.Owner.GetType())
                            ...
                            )
                            {
                                ...
                                (typeof(GargoyleRuby) == c.Owner.GetType())
                            ...
                            else if (typeof(Fiend) == c.Owner.GetType())
                            {
                                ...
                                (typeof(GargoyleOnyx) == c.Owner.GetType())
                            ...
                            )
                            {
                                ...
                                (typeof(BrownBear) == c.Owner.GetType())
                            ...
                            )
                            {
                                ...
                                (typeof(SabretoothBear) == c.Owner.GetType())
                            ...
                            else if (typeof(CaveBearRiding) == c.Owner.GetType())
                            {
                                ...
                                (typeof(ElderBlackBear) == c.Owner.GetType())
                            ...
                            else if (typeof(ElderPolarBearRiding) == c.Owner.GetType())
                            {
                                ...
                                (typeof(OgreLord) == c.Owner.GetType())
                            ...
                            else if (typeof(SeaGiant) == c.Owner.GetType())
                            {
                                ...
                                typeof(SandGiant) == c.Owner.GetType()
                                || typeof(AbyssGiant) == c.Owner.GetType()
                            )
                            {
                                trophyID = 0x3352;
                            ...
                            else if (typeof(JungleGiant) == c.Owner.GetType())
                            {
                                ...
                                typeof(ForestGiant) == c.Owner.GetType()
                                || typeof(FireGiant) == c.Owner.GetType()
                            )
                            {
                                trophyID = 0x336C;
                                ...
                                (typeof(ZombieGiant) == c.Owner.GetType())
                            ...
                            )
                            {
                                ...
                                typeof(GreatHart) == c.Owner.GetType()
                                || typeof(Antelope) == c.Owner.GetType()
                            )
                            {
                                trophyID = 0x1E68;
                            }
                            else if (
                                (typeof(Gorilla) == c.Owner.GetType())
                            ...
                            else if ((typeof(Yeti) == c.Owner.GetType()))
                            {
                                ...
                                (typeof(Pixie) == c.Owner.GetType())
                                || (typeof(Sprite) == c.Owner.GetType())
                                || (typeof(Faerie) == c.Owner.GetType())
                            )
                            {
                            ...
                            else if ((typeof(DarkUnicornRiding) == c.Owner.GetType()))
                            {
                                ...
                                typeof(Nightmare) == c.Owner.GetType()
                                || typeof(AncientNightmareRiding) == c.Owner.GetType()
                                || typeof(AncientNightmare) == c.Owner.GetType()
                                || typeof(Placeron) == c.Owner.GetType()
                            )
                            {
                                trophyID = 0x33AD;
                            }
                            else if (
                                (typeof(Wyvern) == c.Owner.GetType())
        ...
        public TrophyBase(Serial serial)
            : base(serial) { }
