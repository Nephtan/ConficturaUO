...
namespace Server.Items
{
    public class apiLargeWaxPot : Item
    {
        ...
        [Constructable]
        public apiLargeWaxPot()
            : this(50) { }

        [Constructable]
        public apiLargeWaxPot(int uses)
            : base(2541)
        {
        ...
        public apiLargeWaxPot(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                from.PrivateOverheadMessage(
                    ...
                    1154,
                    false,
                    "Choose the beeswax you wish to melt or target the pot to empty it.",
                    from.NetState
                );
                BeginAdd(from);
            }
                ...
                if (o is Beeswax)
                {
                    ...
                    if (UsesRemaining < 1)
                    {
                        from.PrivateOverheadMessage(
                            ...
                            1154,
                            false,
                            "The pot is too damaged to melt any more wax.",
                            from.NetState
                        );
                        return;
                    }
                    else if (m_Beeswax >= MaxWax)
                    {
                        from.PrivateOverheadMessage(
                            ...
                            1154,
                            false,
                            "The pot cannot hold any more wax.",
                            from.NetState
                        );
                        return;
                    }
                    else if (!BeeHiveHelper.Find(from, BeeHiveHelper.m_HeatSources))
                    {
                        from.PrivateOverheadMessage(
                            ...
                            1154,
                            false,
                            "You must be near a heat source to melt beeswax.",
                            from.NetState
                        );
                        return;
                    }
                    ...
                    from.PrivateOverheadMessage(
                        ...
                        1154,
                        false,
                        "You slowly melt the beeswax and mix it in the pot.",
                        from.NetState
                    );
                ...
                else if (o == this)
                {
                    ...
                    else
                    {
                        ...
                        from.PrivateOverheadMessage(
                            ...
                            1154,
                            false,
                            "You empty the pot and place the beeswax in your pack.",
                            from.NetState
                        );
                    }
                }
                    ...
                    from.PrivateOverheadMessage(
                        ...
                        1154,
                        false,
                        "You can only melt pure beeswax in the pot.",
                        from.NetState
                    );
            }
            else
    ...
    public class AddPureWaxTarget : Target
    {
        ...
        public AddPureWaxTarget(apiLargeWaxPot pot)
