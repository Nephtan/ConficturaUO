...
namespace Server.Items
{
    public class apiSmallWaxPot : Item
    {
        ...
        [Constructable]
        public apiSmallWaxPot()
            : this(50) { }

        [Constructable]
        public apiSmallWaxPot(int uses)
            : base(2532)
        {
        ...
        public apiSmallWaxPot(Serial serial)
            : base(serial) { }
        ...
        public void BeginAdd(Mobile from)
        {
            if (m_RawBeeswax < MaxWax)
                ...
                from.PrivateOverheadMessage(
                    ...
                    1154,
                    false,
                    "The pot cannot hold any more raw beeswax.",
                    from.NetState
                );
        }
        ...
        public void EndAdd(Mobile from, object o)
        {
            if (o is Item && ((Item)o).IsChildOf(from.Backpack))
            {
                if (o is RawBeeswax)
                {
                    ...
                    from.PrivateOverheadMessage(
                        ...
                        1154,
                        false,
                        "You put raw beeswax in the pot.",
                        from.NetState
                    );
                    ...
                    from.PrivateOverheadMessage(
                        ...
                        1154,
                        false,
                        "You can only put raw beeswax in the pot.",
                        from.NetState
                    );
            }
            else
            {
                from.PrivateOverheadMessage(
                    ...
                    1154,
                    false,
                    "The wax must be in your pack to target it.",
                    from.NetState
                );
            }
        }
    ...
    public class AddWaxTarget : Target
    {
        ...
        public AddWaxTarget(apiSmallWaxPot pot)
    ...
    public class apiBeeHiveSmallPotGump : Gump
    {
        ...
        public apiBeeHiveSmallPotGump(Mobile from, apiSmallWaxPot pot)
            : base(20, 20)
        {
            m_pot = pot;
                ...
                case (int)Buttons.cmdAddRaw: //Add Raw Honey
                {
                    ...
                    if (m_pot.PureBeeswax > 0)
                    {
                        from.PrivateOverheadMessage(
                            ...
                            1154,
                            false,
                            "You cannot mix raw beeswax with rendered wax.  Please empty the pot first.",
                            from.NetState
                        );
                        return;
                    }
                    ...
                    from.PrivateOverheadMessage(
                        ...
                        1154,
                        false,
                        "Choose the raw beeswax you wish to add to the pot.",
                        from.NetState
                    );
                    m_pot.BeginAdd(from);
                ...
                case (int)Buttons.cmdEmptyPot: //Empty the pot
                {
                    ...
                    if (!from.PlaceInBackpack(wax))
                    {
                        ...
                        from.PrivateOverheadMessage(
                            ...
                            1154,
                            false,
                            "There is not enough room in your backpack for the wax!",
                            from.NetState
                        );
                        from.SendGump(new apiBeeHiveSmallPotGump(from, m_pot));
                        break;
                    ...
                    from.PrivateOverheadMessage(
                        ...
                        1154,
                        false,
                        "You place the beeswax in your pack.",
                        from.NetState
                    );
                ...
                case (int)Buttons.cmdRenderWax: //render the wax
                {
                    ...
                    { //no uses remaining
                        from.PrivateOverheadMessage(
                            ...
                            1154,
                            false,
                            "The pot is too damamged to render beeswax.",
                            from.NetState
                        );
                        from.SendGump(new apiBeeHiveSmallPotGump(from, m_pot));
                        return;
                    ...
                    { //already rendered
                        from.PrivateOverheadMessage(
                            ...
                            1154,
                            false,
                            "The pot is already full of rendered beeswax.",
                            from.NetState
                        );
                        from.SendGump(new apiBeeHiveSmallPotGump(from, m_pot));
                        return;
                    ...
                    { //not enough raw beeswax
                        from.PrivateOverheadMessage(
                            ...
                            1154,
                            false,
                            "There is not enough raw beeswax in the pot.",
                            from.NetState
                        );
                        from.SendGump(new apiBeeHiveSmallPotGump(from, m_pot));
                        return;
                    ...
                    { //need a heat source to melt the wax
                        from.PrivateOverheadMessage(
                            ...
                            1154,
                            false,
                            "You must be near a heat source to render beeswax.",
                            from.NetState
                        );
                        from.SendGump(new apiBeeHiveSmallPotGump(from, m_pot));
                        return;
                    ...
                    from.PrivateOverheadMessage(
                        ...
                        1154,
                        false,
                        "You slowly melt the raw beeswax and remove the impurities.",
                        from.NetState
                    );
