...
namespace Server.Items
{
    public class WaxPaintingA : WaxPainting
    {
        ...
        public WaxPaintingA(Serial serial)
            : base(serial) { }
    ...
    public class WaxPaintingB : WaxPainting
    {
        ...
        public WaxPaintingB(Serial serial)
            : base(serial) { }
    ...
    public class WaxPaintingC : WaxPainting
    {
        ...
        public WaxPaintingC(Serial serial)
            : base(serial) { }
    ...
    public class WaxPaintingD : WaxPainting
    {
        ...
        public WaxPaintingD(Serial serial)
            : base(serial) { }
    ...
    public class WaxPaintingE : WaxPainting
    {
        ...
        public WaxPaintingE(Serial serial)
            : base(serial) { }
    ...
    public class WaxPaintingF : WaxPainting
    {
        ...
        public WaxPaintingF(Serial serial)
            : base(serial) { }
    ...
    public class WaxPaintingG : WaxPainting
    {
        ...
        public WaxPaintingG(Serial serial)
            : base(serial) { }
    ...
    public class WaxPainting : Item
    {
        ...
        public int Painting_FlipID1
        {
            get { return PaintingFlipID1; }
            set
            {
                PaintingFlipID1 = value;
                InvalidateProperties();
            }
        }

        [CommandProperty(AccessLevel.Owner)]
        public int Painting_FlipID2
        {
            get { return PaintingFlipID2; }
            set
            {
                PaintingFlipID2 = value;
                InvalidateProperties();
            }
        }
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                if (targeted is Mobile)
                {
                    ...
                    )
                    {
                        ...
                        if (portrait.Title != null)
                        {
                            sTitle = portrait.Title;
                        }
        ...
        public WaxPainting(Serial serial)
            : base(serial) { }
        ...
        public static string GetSkillTitle(Mobile mob)
        {
            ...
            if (highest != null && highest.BaseFixedPoint >= 300)
            {
                ...
                if (skillTitle.Contains("Detective"))
                {
                    skillTitle = skillTitle.Replace("Detective", "Undertaker");
                }
