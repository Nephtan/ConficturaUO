...
namespace Server.Items
{
    public class WaxSculptorsA : WaxSculptors
    {
        ...
        public WaxSculptorsA(Serial serial)
            : base(serial) { }
    ...
    public class WaxSculptorsB : WaxSculptors
    {
        ...
        public WaxSculptorsB(Serial serial)
            : base(serial) { }
    ...
    public class WaxSculptorsC : WaxSculptors
    {
        ...
        public WaxSculptorsC(Serial serial)
            : base(serial) { }
    ...
    public class WaxSculptorsD : Item
    {
        ...
        public WaxSculptorsD(Serial serial)
            : base(serial) { }
    ...
    public class WaxSculptorsE : Item
    {
        ...
        public WaxSculptorsE(Serial serial)
            : base(serial) { }
    ...
    public class WaxSculptors : Item
    {
        ...
        public int Sculptors_FlipID1
        {
            get { return SculptorsFlipID1; }
            set
            {
                SculptorsFlipID1 = value;
                InvalidateProperties();
            }
        }

        [CommandProperty(AccessLevel.Owner)]
        public int Sculptors_FlipID2
        {
            get { return SculptorsFlipID2; }
            set
            {
                SculptorsFlipID2 = value;
                InvalidateProperties();
            }
        }
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                if (targeted is Mobile)
                {
                    ...
                    )
                    {
                        ...
                        if (carving.Title != null)
                        {
                            sTitle = carving.Title;
                        }
        ...
        public WaxSculptors(Serial serial)
            : base(serial) { }
