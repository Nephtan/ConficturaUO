...
namespace Server.Items
{
    public class JarsOfWaxMetal : Item
    {
        ...
        private class WaxTarget : Target
        {
            ...
            public WaxTarget(JarsOfWaxMetal tube)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (iWax is BaseWeapon)
                {
                    ...
                    if (!iWax.IsChildOf(from.Backpack))
                    {
                        ...
                        iWax.IsChildOf(from.Backpack)
                        && Server.Misc.MaterialInfo.IsAnyKindOfMetalItem(iWax)
                    )
                    {
                        ...
                        if (cBonus > 50)
                        {
                            from.SendMessage("That metal is already in good condition.");
                        }
                        else
                        {
        ...
        public JarsOfWaxMetal(Serial serial)
            : base(serial) { }
    ...
    public class JarsOfWaxLeather : Item
    {
        ...
        private class WaxTarget : Target
        {
            ...
            public WaxTarget(JarsOfWaxLeather tube)
                : base(1, false, TargetFlags.None)
            {
                m_Wax = tube;
            }
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (iWax is BaseArmor)
                {
                    ...
                    if (!iWax.IsChildOf(from.Backpack))
                    {
                        ...
                        iWax.IsChildOf(from.Backpack)
                        && Server.Misc.MaterialInfo.IsAnyKindOfClothItem(iWax)
                    )
                    {
                        int cBonus = xWax.ArmorAttributes.DurabilityBonus;
                        ...
                        if (cBonus > 50)
                        {
                            from.SendMessage("That leather is already in good condition.");
                        }
                        else
                        {
                            xWax.ArmorAttributes.DurabilityBonus = (cBonus + 10);
        ...
        public JarsOfWaxLeather(Serial serial)
            : base(serial) { }
    ...
    public class JarsOfWaxInstrument : Item
    {
        ...
        private class WaxTarget : Target
        {
            ...
            public WaxTarget(JarsOfWaxInstrument tube)
                : base(1, false, TargetFlags.None)
            {
                m_Wax = tube;
            }
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (iWax is BaseInstrument)
                {
                    ...
                    else
                    {
                        ...
                        if (cBonus > 200)
                        {
                            from.SendMessage("That instrument is already in good condition.");
                        }
                        else
                        {
        ...
        public JarsOfWaxInstrument(Serial serial)
            : base(serial) { }
