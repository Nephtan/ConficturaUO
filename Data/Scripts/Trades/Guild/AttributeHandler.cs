...
namespace Server.Items
{
    ...
    public class AttributeHandler
    {
        ...
        public static void Initialize()
        {
            ...
            Definitions.Add(
                new AttributeHandler(
                    EnhanceType.AosWeaponAttribute,
                    "LowerStatReq",
                    "Lower Requirements",
                    100,
                    1,
            ...
            Definitions.Add(
                new AttributeHandler(
                    EnhanceType.AosElementAttribute,
                    "Physical",
                    "Physical Resist",
                    20,
                    1,
            ...
            if (itemToTest is BaseShield)
            {
                ...
                if (
                    ...
                    && (
                        !Core.AOS
                        || (
                            shield.Resource >= CraftResource.RegularLeather
                            && shield.Resource <= CraftResource.BarbedLeather
                        )
                    )
                )
                    allowed = false;
