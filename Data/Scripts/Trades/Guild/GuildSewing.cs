...
namespace Server.Items
{
    public class GuildSewing : Item
    {
        ...
        public GuildSewing(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (from is PlayerMobile)
            {
                ...
                {
                    from.SendMessage(
                        "You need to be near a tailor guildmaster, or a tailor shoppe you own, to use this!"
                    );
                }
                else
                {
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (ItemID != 0x4C80 && ItemID != 0x4C81)
            {
                ItemID = 0x4C81;
            }
        }
