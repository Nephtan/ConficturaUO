...
namespace Server.Items
{
    public class BaseStatueAddon : BaseAddon
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Statue_Material
        {
            get { return StatueMaterial; }
            set
            {
                StatueMaterial = value;
                InvalidateProperties();
            }
        }

        [CommandProperty(AccessLevel.Owner)]
        public string Statue_Maker
        {
            get { return StatueMaker; }
            set
            {
                StatueMaker = value;
                InvalidateProperties();
        ...
        [Constructable]
        public BaseStatueAddon()
            : this(1, 0xB8E, "Granite", "", "statue") { }

        [Constructable]
        public BaseStatueAddon(
            int vStatueID,
            int vStatueColor,
            string vStatueMaterial,
            string vStatueMaker,
            string vStatueName
        )
        {
        ...
        public BaseStatueAddon(Serial serial)
            : base(serial) { }
    ...
    public class BaseStatueDeed : BaseAddonDeed
    {
        ...
        public BaseStatueDeed(Serial serial)
            : base(serial) { }
    ...
    class Statues
    {
        public static void SetStatue(
            BaseStatueDeed statue,
            int StatueID,
            int StatueColor,
            string StatueMaterial,
            string StatueMaker,
            string StatueName
        )
        {
