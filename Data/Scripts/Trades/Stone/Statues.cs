...
namespace Server.Items
{
    ...
    public class StatueElvenKnight : BaseStatue
    {
        ...
        public StatueElvenKnight(Serial serial)
            : base(serial) { }
    ...
    public class StatueElvenWarrior : BaseStatue
    {
        ...
        public StatueElvenWarrior(Serial serial)
            : base(serial) { }
    ...
    public class StatueElvenSorceress : BaseStatue
    {
        ...
        public StatueElvenSorceress(Serial serial)
            : base(serial) { }
    ...
    public class StatueElvenPriestess : BaseStatue
    {
        ...
        public StatueElvenPriestess(Serial serial)
            : base(serial) { }
    ...
    public class SmallStatueWoman : BaseStatue
    {
        ...
        public SmallStatueWoman(Serial serial)
            : base(serial) { }
    ...
    public class SmallStatueDragon : BaseStatue
    {
        ...
        public SmallStatueDragon(Serial serial)
            : base(serial) { }
    ...
    public class SmallStatueNoble : BaseStatue
    {
        ...
        public SmallStatueNoble(Serial serial)
            : base(serial) { }
    ...
    public class SmallStatueAngel : BaseStatue
    {
        ...
        public SmallStatueAngel(Serial serial)
            : base(serial) { }
    ...
    public class SmallStatueMan : BaseStatue
    {
        ...
        public SmallStatueMan(Serial serial)
            : base(serial) { }
    ...
    public class SmallStatuePegasus : BaseStatue
    {
        ...
        public SmallStatuePegasus(Serial serial)
            : base(serial) { }
    ...
    public class SmallStatueSkull : BaseStatue
    {
        ...
        public SmallStatueSkull(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public StatueWomanWarriorPillar()
            : base(0x12D8)
        {
        ...
        public StatueWomanWarriorPillar(Serial serial)
            : base(serial) { }
    ...
    public class LargePegasusStatue : BaseStatue
    {
        ...
        public LargePegasusStatue(Serial serial)
            : base(serial) { }
    ...
    public class StatueFighter : BaseStatue
    {
        ...
        public StatueFighter(Serial serial)
            : base(serial) { }
    ...
    public class StatueSwordsman : BaseStatue
    {
        ...
        public StatueSwordsman(Serial serial)
            : base(serial) { }
    ...
    public class StatueNoble : BaseStatue
    {
        ...
        public StatueNoble(Serial serial)
            : base(serial) { }
    ...
    public class StatueWizard : BaseStatue
    {
        ...
        public StatueWizard(Serial serial)
            : base(serial) { }
    ...
    public class StatueDruid : BaseStatue
    {
        ...
        public StatueDruid(Serial serial)
            : base(serial) { }
    ...
    public class StatuePriest : BaseStatue
    {
        ...
        public StatuePriest(Serial serial)
            : base(serial) { }
    ...
    public class StatueAdventurer : BaseStatue
    {
        ...
        public StatueAdventurer(Serial serial)
            : base(serial) { }
    ...
    public class StatueDesertGod : BaseStatue
    {
        ...
        public StatueDesertGod(Serial serial)
            : base(serial) { }
    ...
    public class StatueAmazon : BaseStatue
    {
        ...
        public StatueAmazon(Serial serial)
            : base(serial) { }
    ...
    public class StatueBust : BaseStatue
    {
        ...
        public StatueBust(Serial serial)
            : base(serial) { }
    ...
    public class StatueGargoyleBust : BaseStatue
    {
        ...
        public StatueGargoyleBust(Serial serial)
            : base(serial) { }
    ...
    public class StatueGargoyleTall : BaseStatue
    {
        ...
        public StatueGargoyleTall(Serial serial)
            : base(serial) { }
    ...
    public class StatueWolfWinged : BaseStatue
    {
        ...
        public StatueWolfWinged(Serial serial)
            : base(serial) { }
    ...
    public class StatueSeaHorse : BaseStatue
    {
        ...
        public StatueSeaHorse(Serial serial)
            : base(serial) { }
    ...
    public class StatueMermaid : BaseStatue
    {
        ...
        public StatueMermaid(Serial serial)
            : base(serial) { }
    ...
    public class StatueGryphon : BaseStatue
    {
        ...
        public StatueGryphon(Serial serial)
            : base(serial) { }
    ...
    public class StatueDwarf : BaseStatue
    {
        ...
        public StatueDwarf(Serial serial)
            : base(serial) { }
    ...
    public class StoneWizardTable : BaseStatue
    {
        ...
        public StoneWizardTable(Serial serial)
            : base(serial) { }
    ...
    public class GargoyleFlightStatue : BaseStatue
    {
        ...
        public GargoyleFlightStatue(Serial serial)
            : base(serial) { }
