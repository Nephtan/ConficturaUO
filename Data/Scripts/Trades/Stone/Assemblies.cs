...
namespace Server.Items
{
    public class StatueGateGuardian : BaseStatueDeed
    {
        ...
        public StatueGateGuardian(Serial serial)
            : base(serial) { }
    ...
    public class StatueGiantWarrior : BaseStatueDeed
    {
        ...
        public StatueGiantWarrior(Serial serial)
            : base(serial) { }
    ...
    public class StatueHorseRider : BaseStatueDeed
    {
        ...
        public StatueHorseRider(Serial serial)
            : base(serial) { }
    ...
    public class StatueCapeWarrior : BaseStatueDeed
    {
        ...
        public StatueCapeWarrior(Serial serial)
            : base(serial) { }
    ...
    public class StoneSarcophagus : BaseStatueDeed
    {
        ...
        public StoneSarcophagus(Serial serial)
            : base(serial) { }
    ...
    public class StoneBenchLong : BaseStatueDeed
    {
        ...
        public StoneBenchLong(Serial serial)
            : base(serial) { }
    ...
    public class StoneBenchShort : BaseStatueDeed
    {
        ...
        public StoneBenchShort(Serial serial)
            : base(serial) { }
    ...
    public class StoneTableLong : BaseStatueDeed
    {
        ...
        public StoneTableLong(Serial serial)
            : base(serial) { }
    ...
    public class StoneTableShort : BaseStatueDeed
    {
        ...
        public StoneTableShort(Serial serial)
            : base(serial) { }
    ...
    public class StatueAngelTall : BaseStatueDeed
    {
        ...
        public StatueAngelTall(Serial serial)
            : base(serial) { }
    ...
    public class StatueWiseManTall : BaseStatueDeed
    {
        ...
        public StatueWiseManTall(Serial serial)
            : base(serial) { }
    ...
    public class StatueWomanTall : BaseStatueDeed
    {
        ...
        public StatueWomanTall(Serial serial)
            : base(serial) { }
    ...
    public class LargeStatueLion : BaseStatueDeed
    {
        ...
        public LargeStatueLion(Serial serial)
            : base(serial) { }
    ...
    public class MediumStatueLion : BaseStatueDeed
    {
        ...
        public MediumStatueLion(Serial serial)
            : base(serial) { }
    ...
    public class SmallStatueLion : BaseStatueDeed
    {
        ...
        public SmallStatueLion(Serial serial)
            : base(serial) { }
    ...
    public class StatueDemonicFace : BaseStatueDeed
    {
        ...
        public StatueDemonicFace(Serial serial)
            : base(serial) { }
    ...
    public class TallStatueLion : BaseStatueDeed
    {
        ...
        public TallStatueLion(Serial serial)
            : base(serial) { }
    ...
    public class LargeStatueWolf : BaseStatueDeed
    {
        ...
        public LargeStatueWolf(Serial serial)
            : base(serial) { }
    ...
    public class StatueGuardian : BaseStatueDeed
    {
        ...
        public StatueGuardian(Serial serial)
            : base(serial) { }
    ...
    public class StatueMinotaurDefend : BaseStatueDeed
    {
        ...
        public StatueMinotaurDefend(Serial serial)
            : base(serial) { }
    ...
    public class StatueMinotaurAttack : BaseStatueDeed
    {
        ...
        public StatueMinotaurAttack(Serial serial)
            : base(serial) { }
    ...
    public class StatueDaemon : BaseStatueDeed
    {
        ...
        public StatueDaemon(Serial serial)
            : base(serial) { }
