...
namespace Server.Items
{
    ...
    public class StoneSteps : BaseStatue
    {
        ...
        public StoneSteps(Serial serial)
            : base(serial) { }
    ...
    public class StoneBlock : BaseStatue
    {
        ...
        public StoneBlock(Serial serial)
            : base(serial) { }
    ...
    public class StoneRoughPillar : BaseStatue
    {
        ...
        public StoneRoughPillar(Serial serial)
            : base(serial) { }
    ...
    public class StoneColumn : BaseStatue
    {
        ...
        public StoneColumn(Serial serial)
            : base(serial) { }
    ...
    public class StoneGothicColumn : BaseStatue
    {
        ...
        public StoneGothicColumn(Serial serial)
            : base(serial) { }
    ...
    public class StoneFancyPedestal : BaseStatue
    {
        ...
        public StoneFancyPedestal(Serial serial)
            : base(serial) { }
    ...
    public class StonePedestal : BaseStatue
    {
        ...
        public StonePedestal(Serial serial)
            : base(serial) { }
    ...
    public class StoneLargeVase : BaseStatue
    {
        ...
        public StoneLargeVase(Serial serial)
            : base(serial) { }
    ...
    public class StoneVase : BaseStatue
    {
        ...
        public StoneVase(Serial serial)
            : base(serial) { }
    ...
    public class StoneAmphora : BaseStatue
    {
        ...
        public StoneAmphora(Serial serial)
            : base(serial) { }
    ...
    public class StoneLargeAmphora : BaseStatue
    {
        ...
        public StoneLargeAmphora(Serial serial)
            : base(serial) { }
    ...
    public class StoneOrnateAmphora : BaseStatue
    {
        ...
        public StoneOrnateAmphora(Serial serial)
            : base(serial) { }
    ...
    public class StoneOrnateVase : BaseStatue
    {
        ...
        public StoneOrnateVase(Serial serial)
            : base(serial) { }
    ...
    public class StoneGargoyleVase : BaseStatue
    {
        ...
        public StoneGargoyleVase(Serial serial)
            : base(serial) { }
    ...
    public class StoneMingSculpture : BaseStatue
    {
        ...
        public StoneMingSculpture(Serial serial)
            : base(serial) { }
    ...
    public class StoneYuanSculpture : BaseStatue
    {
        ...
        public StoneYuanSculpture(Serial serial)
            : base(serial) { }
    ...
    public class StoneQinSculpture : BaseStatue
    {
        ...
        public StoneQinSculpture(Serial serial)
            : base(serial) { }
    ...
    public class StoneBuddhistSculpture : BaseStatue
    {
        ...
        public StoneBuddhistSculpture(Serial serial)
            : base(serial) { }
    ...
    public class StoneQinUrn : BaseStatue
    {
        ...
        public StoneQinUrn(Serial serial)
            : base(serial) { }
    ...
    public class StoneMingUrn : BaseStatue
    {
        ...
        public StoneMingUrn(Serial serial)
            : base(serial) { }
    ...
    public class StoneYuanUrn : BaseStatue
    {
        ...
        public StoneYuanUrn(Serial serial)
            : base(serial) { }
