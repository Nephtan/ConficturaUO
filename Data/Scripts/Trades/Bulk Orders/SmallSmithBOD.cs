...
namespace Server.Engines.BulkOrders
{
    ...
    public class SmallSmithBOD : SmallBOD
    {
        ...
        public override List<Item> ComputeRewards(bool full)
        {
            ...
            RewardGroup rewardGroup = SmithRewardCalculator.Instance.LookupRewards(
                SmithRewardCalculator.Instance.ComputePoints(this)
            );
            ...
            if (entries.Length > 0)
            {
                ...
                for (int i = 0; i < entries.Length; ++i)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        double chance = item.GetSuccessChance(
                            m,
                            null,
                            system,
                            false,
                ...
                if (validEntries.Count > 0)
                {
                    ...
                    return new SmallSmithBOD(entry, material, amountMax, reqExceptional, null);
                }
            }
