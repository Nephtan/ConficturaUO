...
namespace Server.Engines.BulkOrders
{
    ...
    public abstract class SmallBOD : Item
    {
        ...
        {
            get { return (m_AmountCur == m_AmountMax); }
        }
        ...
        public void EndCombine(Mobile from, object o)
        {
            if (o is Item && ((Item)o).IsChildOf(from.Backpack))
            {
                ...
                if (m_AmountCur >= m_AmountMax)
                {
                    ...
                    m_Type == null
                    || (objectType != m_Type && !objectType.IsSubclassOf(m_Type))
                    || (!(o is BaseWeapon) && !(o is BaseArmor) && !(o is BaseClothing))
                )
                {
                ...
                else
                {
                    ...
                    if (
                        m_Material >= BulkMaterialType.DullCopper
                        && m_Material <= BulkMaterialType.Valorite
                        && material != m_Material
                    )
                    {
                        ...
                        m_Material >= BulkMaterialType.Spined
                        && m_Material <= BulkMaterialType.Barbed
                        && material != m_Material
                    )
                    {
                    ...
                    else
                    {
                        ...
                        if (o is BaseWeapon)
                            ...
                            isExceptional = (
                                ((BaseClothing)o).Quality == ClothingQuality.Exceptional
                            );
