...
namespace Server.Engines.Harvest
{
    public class Librarian : HarvestSystem
    {
        ...
        private Librarian()
        {
            ...
            library.MaxRange = 1;
            library.ConsumedPerHarvest = 1 * Server.Misc.MyServerSettings.Resources();
            library.ConsumedPerIslesDreadHarvest =
                library.ConsumedPerHarvest + (int)(library.ConsumedPerHarvest / 2) + 2;
        ...
        public override bool CheckHarvest(Mobile from, Item tool)
        {
            ...
            if (
                !(
                    from.Region is DungeonRegion
                    || from.Region is DeadRegion
                    || from.Region is CaveRegion
                    || from.Region is BardDungeonRegion
                    || from.Region is OutDoorBadRegion
                )
            )
            {
                        ...
                        try
                        {
                            ...
                            if (search > Utility.Random(5000))
                            {
                                if (from.CheckSkill(SkillName.Inscribe, 0, 125))
                                {
                                    ...
                                    {
                                        case 0:
                                            shelf = new MyNecromancerSpellbook();
                                            name = "necromancer spellbook";
                                            break;
                                        case 1:
                                            shelf = new MySpellbook();
                                            name = "a magery spellbook";
                                            break;
                                        case 2:
                                            shelf = new MyNinjabook();
                                            name = "a book of the ninja";
                                            break;
                                        case 3:
                                            shelf = new MySamuraibook();
                                            name = "a book of the samurai";
                                            break;
                                        case 4:
                                            shelf = new MyPaladinbook();
                                            name = "a book of knightship";
                                            break;
                                        case 5:
                                            shelf = new MySongbook();
                                            name = "a book of bardic songs";
                                            break;
                                        case 6:
                                            shelf = new ArtifactManual();
                                            name = "an artifact manual";
                                            break;
                                        case 7:
                                            shelf = new DDRelicTablet();
                                            ((DDRelicTablet)shelf).RelicGoldValue =
                                                ((DDRelicTablet)shelf).RelicGoldValue
                                            ...
                                            break;
                                        case 8:
                                            shelf = Server.Items.PowerScroll.RandomPowerScroll();
                                            name = "a scroll of power";
                                            break;
                                        case 9:
                                            switch (Utility.Random(6))
                                            {
                                                case 0:
                                                    shelf = new SmallBoatDeed();
                                                    break;
                                                case 1:
                                                    shelf = new SmallDragonBoatDeed();
                                                    break;
                                                case 2:
                                                    shelf = new MediumBoatDeed();
                                                    break;
                                                case 3:
                                                    shelf = new MediumDragonBoatDeed();
                                                    break;
                                                case 4:
                                                    shelf = new LargeBoatDeed();
                                                    break;
                                                case 5:
                                                    shelf = new LargeDragonBoatDeed();
                                                    break;
                                            }
                                            name = "a deed to a ship";
                                            break;
                                        case 10:
                                            shelf = new TreasureMap(
                                                Utility.RandomList(
                                                    1,
                                                    1,
                                                    1,
                                            ...
                                            break;
                                        case 11:
                                            shelf = new MyElementalSpellbook();
