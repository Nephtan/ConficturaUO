...
namespace Server.Engines.Plants
{
    ...
    public class PlantHueInfo
    {
        ...
        static PlantHueInfo()
        {
            ...
            m_Table[PlantHue.BrightYellow] = new PlantHueInfo(
                0x38,
                1060818,
                PlantHue.BrightYellow,
                0x35
            );
            ...
            m_Table[PlantHue.BrightPurple] = new PlantHueInfo(
                0x10,
                1060816,
                PlantHue.BrightPurple,
                0xD
            );
            m_Table[PlantHue.BrightGreen] = new PlantHueInfo(
                0x42,
                1060819,
                PlantHue.BrightGreen,
                0x3F
            );
            m_Table[PlantHue.BrightOrange] = new PlantHueInfo(
                0x2B,
                1060817,
                PlantHue.BrightOrange,
                0x2B
            );
        ...
        {
            return plantHue == PlantHue.Red
                || plantHue == PlantHue.Blue
                || plantHue == PlantHue.Yellow;
        }
