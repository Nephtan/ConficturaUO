    ...
    public class MainPlantGump : Gump
    {
        ...
        private void DrawPlant()
        {
            ...
            else
            {
                ...
                if (
                    m_Plant.PlantType == PlantType.CypressTwisted
                    || m_Plant.PlantType == PlantType.CypressStraight
                )
                    AddItem(130 + typeInfo.OffsetX, 96 + typeInfo.OffsetY, 0x0CCA, hueInfo.Hue);
                else
                    AddItem(
                        130 + typeInfo.OffsetX,
                        96 + typeInfo.OffsetY,
                        typeInfo.ItemID,
                        hueInfo.Hue
                    );
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (
                ((info.ButtonID >= 6 && info.ButtonID <= 10) || info.ButtonID == 12)
                ...
                case 6: // Water
                {
                    ...
                    if (!foundUsableWater)
                    {
                        ...
                        from.SendLocalizedMessage(
                            1060808,
                            "#" + m_Plant.GetLocalizedPlantStatus().ToString()
