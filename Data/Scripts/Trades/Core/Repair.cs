    ...
    public class Repair
    {
        ...
        private class InternalTarget : Target
        {
            ...
            private int GetWeakenChance(Mobile mob, SkillName skill, int curHits, int maxHits)
            {
                ...
                return (40 + (maxHits - curHits))
                    - (int)(((m_Deed != null) ? m_Deed.SkillLevel : mob.Skills[skill].Value) / 10);
            }
            ...
            private bool IsSpecialClothing(BaseClothing clothing)
            {
                ...
                {
                    return (clothing is BearMask) || (clothing is DeerMask);
                }
            ...
            private bool IsSpecialWeapon(BaseWeapon weapon)
            {
                ...
                {
                    if (
                        Server.Misc.MaterialInfo.IsAnyKindOfWoodItem(((Item)weapon))
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else if (m_CraftSystem is DefTinkering && targeted is Golem)
                {
                    ...
                    else
                    {
                        double skillValue =
                            (usingDeed)
                                ? m_Deed.SkillLevel
                                : from.Skills[SkillName.Tinkering].Value;
                            ...
                            if (pack != null)
                            {
                                ...
                                if (v > 0)
                                {
                                    ...
                                    Timer.DelayCall(
                                        ...
                                        new TimerStateCallback(EndGolemRepair),
                                        from
                                    );
                                }
                                else
                ...
                else if (targeted is BaseWeapon)
                {
                    ...
                    {
                        double skillLevel =
                            (usingDeed) ? m_Deed.SkillLevel : from.Skills[skill].Base;
                    ...
                    if (
                        m_CraftSystem.CraftItems.SearchForSubclass(weapon.GetType()) == null
                ...
                else if (targeted is BaseArmor)
                {
                    ...
                    if (
                        m_CraftSystem.CraftItems.SearchForSubclass(armor.GetType()) == null
                        && !IsSpecialArmor(armor)
                    )
                    {
                        number = (usingDeed) ? 1061136 : 1044277; // That item cannot be repaired. // You cannot repair that item with this type of repair contract.
                    }
                ...
                else if (targeted is BaseClothing)
                {
                    ...
                    if (
                        m_CraftSystem.CraftItems.SearchForSubclass(clothing.GetType()) == null
                        && !IsSpecialClothing(clothing)
                        && !((targeted is TribalMask) || (targeted is HornedTribalMask))
                    )
                    {
                        number = (usingDeed) ? 1061136 : 1044277; // That item cannot be repaired. // You cannot repair that item with this type of repair contract.
                    }
                ...
                else if (!usingDeed && targeted is BlankScroll)
                {
                    ...
                    if (from.Skills[skill].Value >= 50.0)
                    {
                        ...
                        RepairDeed deed = new RepairDeed(
