    ...
    public class CraftGump : Gump
    {
            ...
            : base(40, 40)
        {
            ...
            if (craftSystem.CraftSubRes.Init)
            {
                ...
                if (nameNumber > 0)
                    ...
                    AddLabel(
                        ...
                        362,
                        LabelHue,
                        String.Format("{0} ({1} Available)", nameString, resourceCount)
                    );
            }
            // ****************************************
            ...
            AddButton(
                ...
                4005,
                4007,
                GetButtonID(6, SearchButtonIndex),
        ...
        public int CreateGroupList()
        {
            ...
            if (displayIndex == 0 && search != null)
            {
                AddHtml(
                    ...
                    40,
                    String.Format(
                        "<BASEFONT COLOR=#{0:X6}>No categories match your search.</BASEFONT>",
                        FontColor
                    ),
                    false,
                    false
            ...
            switch (type)
            {
                ...
                case 6: // Misc. buttons
                {
                    switch (index)
                    {
                        ...
                        case SearchButtonIndex: // Apply search filter
                        {
                            if (context != null)
                            {
