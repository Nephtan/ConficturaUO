    ...
    public class CraftItem
    {
        ...
        public bool RetainsColorFrom(CraftSystem system, Type type)
        {
            ...
            for (int i = 0; !inItemTable && i < m_ColoredItemTable.Length; ++i)
                inItemTable = (
                    m_Type == m_ColoredItemTable[i] || m_Type.IsSubclassOf(m_ColoredItemTable[i])
                );

            for (
                int i = 0;
                inItemTable && !inResourceTable && i < m_ColoredResourceTable.Length;
                ++i
            )
                inResourceTable = (
                    type == m_ColoredResourceTable[i]
                    || type.IsSubclassOf(m_ColoredResourceTable[i])
                );
        ...
        )
        {
            ...
            CraftSubResCol resCol = (
                m_UseSubRes2 ? craftSystem.CraftSubRes2 : craftSystem.CraftSubRes
            );
            ...
            for (int i = 0; i < types.Length; ++i)
            {
                ...
                if ((baseType == resCol.ResType) && (typeRes != null))
                {
                    ...
                    if (
                        subResource != null
                        && from.Skills[craftSystem.MainSkill].Value < subResource.RequiredSkill
                    )
                    {
            ...
            if (consumeType == ConsumeType.All)
            {
                ...
                if (IsQuantityType(types))
                    ...
                    index = ourPack.ConsumeTotalGrouped(
                        ...
                        amounts,
                        true,
                        new OnItemConsumed(OnResourceConsumed),
                        new CheckItemGroup(CheckHueGrouping)
                    );
        ...
        {
            double chance = GetSuccessChance(
                from,
                typeRes,
                craftSystem,
                gainSkills,
        ...
        )
        {
            ...
            if (allRequiredSkills)
                chance =
                    craftSystem.GetChanceAtMin(this)
                    + (
                        (valMainSkill - minMainSkill)
                        / (maxMainSkill - minMainSkill)
                ...
                )
                {
                    ...
                    if (allRequiredSkills && chance >= 0.0)
                    {
                        if (
                            ...
                            || ((PlayerMobile)from).HasRecipe(this.Recipe)
                        )
                        {
        ...
        public int EnchantItem(Item item, Mobile from, Type typeRes, CraftSystem craftSystem)
        {
            if (!Server.Misc.Arty.canEnchant(item))
                return 0;

            if (!Server.Misc.MyServerSettings.AllowCraftMagic())
                return 0;
            ...
            if (craftSystem == DefTinkering.CraftSystem)
            {
                skill = (int)(from.Skills[SkillName.Tinkering].Value);
                if (pm.NpcGuild == NpcGuild.TinkersGuild)
                {
                    guild = 100;
                }
            }
            ...
            {
                skill = (int)(from.Skills[SkillName.Tailoring].Value);
                if (pm.NpcGuild == NpcGuild.TailorsGuild)
                {
                    guild = 100;
                }
            }
            ...
            {
                skill = (int)(from.Skills[SkillName.Carpentry].Value);
                if (pm.NpcGuild == NpcGuild.CarpentersGuild)
                {
                    guild = 100;
                }
                else if (pm.NpcGuild == NpcGuild.BardsGuild && item is BaseInstrument)
                {
                    guild = 100;
                }
            }
            ...
            {
                skill = (int)(from.Skills[SkillName.Bowcraft].Value);
                if (pm.NpcGuild == NpcGuild.ArchersGuild)
                {
                    guild = 100;
                }
            }
            else if (craftSystem == DefBlacksmithy.CraftSystem)
            {
                skill = (int)(from.Skills[SkillName.Blacksmith].Value);
                if (pm.NpcGuild == NpcGuild.BlacksmithsGuild)
                {
                    guild = 100;
                }
            }
            ...
            return (skill + guild + block + cloth);
        }
        ...
        )
        {
            ...
            if (CheckSkills(from, typeRes, craftSystem, ref ignored, ref allRequiredSkills))
            {
                ...
                {
                    AncientSmithyHammer hammer =
                        from.FindItemOnLayer(Layer.OneHanded) as AncientSmithyHammer;
                ...
                if (item != null)
                {
                    ...
                    if (quality == 2 && EnchantItem(item, from, typeRes, craftSystem) > 0)
                    {
                        if (
                            item is BaseWeapon
                            || item is BaseArmor
                        ...
                        {
                            item = Server.LootPackEntry.Enchant(
                                from,
                                EnchantItem(item, from, typeRes, craftSystem),
                                item
                            );
                        }
                    }
                    ...
                    )
                    {
                        if (item is BaseArmor)
                        {
                            ...
                            woody.Resource = CraftResource.RegularLeather;
                        }
                        item.Hue = MaterialInfo.GetMaterialColor("unicorn skin", "", 0);
                    }
                    else if (
                        item is SkinDemonLegs
                        || item is SkinDemonGloves
                    ...
                    )
                    {
                        ...
                        item.Hue = MaterialInfo.GetMaterialColor("demon skin", "", 0);
                    }
                    else if (
                        item is SkinDragonLegs
                        || item is SkinDragonGloves
                    ...
                    )
                    {
                        ...
                        item.Hue = MaterialInfo.GetMaterialColor("dragon skin", "", 0);
                    }
                    else if (
                        item is SkinNightmareLegs
                        || item is SkinNightmareGloves
                    ...
                    )
                    {
                        ...
                        item.Hue = MaterialInfo.GetMaterialColor("nightmare skin", "", 0);
                    }
                    else if (
                        item is SkinSerpentLegs
                        || item is SkinSerpentGloves
                    ...
                    )
                    {
                        ...
                        item.Hue = MaterialInfo.GetMaterialColor("serpent skin", "", 0);
                    }
                    else if (
                        item is SkinTrollLegs
                        || item is SkinTrollGloves
                    ...
                    )
                    {
                        ...
                        item.Hue = MaterialInfo.GetMaterialColor("troll skin", "", 0);
                    }
                    else if (
                        item is AmethystPlateLegs
                        || item is AmethystPlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("amethyst", "", 0);
                    }
                    else if (
                        item is CaddellitePlateLegs
                        || item is CaddellitePlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("caddellite", "", 0);
                    }
                    else if (
                        item is EmeraldPlateLegs
                        || item is EmeraldPlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("emerald", "", 0);
                    }
                    else if (
                        item is GarnetPlateLegs
                        || item is GarnetPlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("garnet", "", 0);
                    }
                    else if (
                        item is IcePlateLegs
                        || item is IcePlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("ice", "", 0);
                    }
                    else if (
                        item is JadePlateLegs
                        || item is JadePlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("jade", "", 0);
                    }
                    else if (
                        item is MarblePlateLegs
                        || item is MarblePlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("marble", "", 0);
                    }
                    else if (
                        item is OnyxPlateLegs
                        || item is OnyxPlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("onyx", "", 0);
                    }
                    else if (
                        item is QuartzPlateLegs
                        || item is QuartzPlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("quartz", "", 0);
                    }
                    else if (
                        item is RubyPlateLegs
                        || item is RubyPlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("ruby", "", 0);
                    }
                    else if (
                        item is SapphirePlateLegs
                        || item is SapphirePlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("sapphire", "", 0);
                    }
                    else if (
                        item is SilverPlateLegs
                        || item is SilverPlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("silver", "", 0);
                    }
                    else if (
                        item is SpinelPlateLegs
                        || item is SpinelPlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("spinel", "", 0);
                    }
                    else if (
                        item is StarRubyPlateLegs
                        || item is StarRubyPlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("star ruby", "", 0);
                    }
                    else if (
                        item is TopazPlateLegs
                        || item is TopazPlateGloves
                    ...
                    {
                        item.Hue = MaterialInfo.GetMaterialColor("topaz", "", 0);
                    }
                    else if (
                        item is WhiteFurRobe
                        || item is WhiteFurCape
                        || item is WhiteFurCap
                        || item is WhiteFurBoots
                        || item is WhiteFurSarong
                    )
                    {
                        item.Hue = 0x481;
                    }
                    ...
                    )
                    {
                        if (item is BaseArmor)
                        {
                            ...
                            {
                                if (item is DragonArms)
                                {
                                    item.Name = "dinosaur sleeves";
                                }
                                else if (item is DragonChest)
                                {
                                    item.Name = "dinosaur breastplate";
                                }
                                else if (item is DragonGloves)
                                {
                                    item.Name = "dinosaur gloves";
                                }
                                else if (item is DragonHelm)
                                {
                                    item.Name = "dinosaur helm";
                                }
                                else if (item is DragonLegs)
                                {
                                    item.Name = "dinosaur leggings";
                                }
                            }
                        }
                    }
                    ...
                    {
                        item.ItemID = Utility.RandomList(
                            0x1410,
                            0x1417,
                            0x303,
                            0x304,
                    ...
                    else if (item is BaseMagicStaff)
                    {
                        ...
                        if (item is ClumsyMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 20);
                        }
                        else if (item is CreateFoodMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 17);
                        }
                        else if (item is FeebleMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 16);
                        }
                        else if (item is HealMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 21);
                        }
                        else if (item is MagicArrowMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 18);
                        }
                        else if (item is NightSightMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 14);
                        }
                        else if (item is ReactiveArmorMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 15);
                        }
                        else if (item is WeaknessMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 19);
                        }
                        else if (item is AgilityMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 21);
                        }
                        else if (item is CunningMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 14);
                        }
                        else if (item is CureMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 17);
                        }
                        else if (item is HarmMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 15);
                        }
                        else if (item is MagicTrapMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 19);
                        }
                        else if (item is MagicUntrapMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 20);
                        }
                        else if (item is ProtectionMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 16);
                        }
                        else if (item is StrengthMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 21);
                        }
                        else if (item is BlessMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 18);
                        }
                        else if (item is FireballMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 14);
                        }
                        else if (item is MagicLockMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 19);
                        }
                        else if (item is MagicUnlockMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 17);
                        }
                        else if (item is PoisonMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 16);
                        }
                        else if (item is TelekinesisMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 20);
                        }
                        else if (item is TeleportMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 15);
                        }
                        else if (item is WallofStoneMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 18);
                        }
                        else if (item is ArchCureMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 21);
                        }
                        else if (item is ArchProtectionMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 15);
                        }
                        else if (item is CurseMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 17);
                        }
                        else if (item is FireFieldMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 14);
                        }
                        else if (item is GreaterHealMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 18);
                        }
                        else if (item is LightningMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 20);
                        }
                        else if (item is ManaDrainMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 19);
                        }
                        else if (item is RecallMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 20);
                        }
                        else if (item is BladeSpiritsMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 1);
                        }
                        else if (item is DispelFieldMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 7);
                        }
                        else if (item is IncognitoMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 9);
                        }
                        else if (item is MagicReflectionMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 24);
                        }
                        else if (item is MindBlastMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 11);
                        }
                        else if (item is ParalyzeMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 13);
                        }
                        else if (item is PoisonFieldMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 10);
                        }
                        else if (item is SummonCreatureMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 4);
                        }
                        else if (item is DispelMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 29);
                        }
                        else if (item is EnergyBoltMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 3);
                        }
                        else if (item is ExplosionMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 2);
                        }
                        else if (item is InvisibilityMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 5);
                        }
                        else if (item is MarkMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 23);
                        }
                        else if (item is MassCurseMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 22);
                        }
                        else if (item is ParalyzeFieldMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 8);
                        }
                        else if (item is RevealMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 37);
                        }
                        else if (item is ChainLightningMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 6);
                        }
                        else if (item is EnergyFieldMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 11);
                        }
                        else if (item is FlameStrikeMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 22);
                        }
                        else if (item is GateTravelMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 29);
                        }
                        else if (item is ManaVampireMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 9);
                        }
                        else if (item is MassDispelMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 1);
                        }
                        else if (item is MeteorSwarmMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 2);
                        }
                        else if (item is PolymorphMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 23);
                        }
                        else if (item is AirElementalMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 6);
                        }
                        else if (item is EarthElementalMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 10);
                        }
                        else if (item is EarthquakeMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 4);
                        }
                        else if (item is EnergyVortexMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 3);
                        }
                        else if (item is FireElementalMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 5);
                        }
                        else if (item is ResurrectionMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 24);
                        }
                        else if (item is SummonDaemonMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 13);
                        }
                        else if (item is WaterElementalMagicStaff)
                        {
                            Server.Misc.MaterialInfo.ColorMetal(item, 8);
                        }
                    ...
                    else if (item is BaseInstrument)
                    {
                        ...
                        ((BaseInstrument)item).UsesRemaining =
                            ((BaseInstrument)item).UsesRemaining + cUse;
                        item.Hue = cHue;
                    }
                    ...
                    else if (item is HorseArmor)
                    {
                        ...
                        {
                            case CraftResource.DullCopper:
                                color = MaterialInfo.GetMaterialColor("dull copper", "monster", 0);
                                material = "Dull Copper";
                                break;
                            case CraftResource.ShadowIron:
                                color = MaterialInfo.GetMaterialColor("shadow iron", "monster", 0);
                                material = "Shadow Iron";
                                break;
                            case CraftResource.Copper:
                                color = MaterialInfo.GetMaterialColor("copper", "monster", 0);
                                material = "Copper";
                                break;
                            case CraftResource.Bronze:
                                color = MaterialInfo.GetMaterialColor("bronze", "monster", 0);
                                material = "Bronze";
                                break;
                            case CraftResource.Gold:
                                color = MaterialInfo.GetMaterialColor("gold", "monster", 0);
                                material = "Gold";
                                break;
                            case CraftResource.Agapite:
                                color = MaterialInfo.GetMaterialColor("agapite", "monster", 0);
                                material = "Agapite";
                                break;
                            case CraftResource.Verite:
                                color = MaterialInfo.GetMaterialColor("verite", "monster", 0);
                                material = "Verite";
                                break;
                            case CraftResource.Valorite:
                                color = MaterialInfo.GetMaterialColor("valorite", "monster", 0);
                                material = "Valorite";
                                break;
                            case CraftResource.Nepturite:
                                color = MaterialInfo.GetMaterialColor("nepturite", "monster", 0);
                                material = "Nepturite";
                                break;
                            case CraftResource.Obsidian:
                                color = MaterialInfo.GetMaterialColor("obsidian", "monster", 0);
                                material = "Obsidian";
                                break;
                            case CraftResource.Steel:
                                color = MaterialInfo.GetMaterialColor("steel", "monster", 0);
                                material = "Steel";
                                break;
                            case CraftResource.Brass:
                                color = MaterialInfo.GetMaterialColor("brass", "monster", 0);
                                material = "Brass";
                                break;
                            case CraftResource.Mithril:
                                color = MaterialInfo.GetMaterialColor("mithril", "monster", 0);
                                material = "Mithril";
                                break;
                            case CraftResource.Xormite:
                                color = MaterialInfo.GetMaterialColor("xormite", "monster", 0);
                                material = "Xormite";
                                break;
                            case CraftResource.Dwarven:
                                color = MaterialInfo.GetMaterialColor("dwarven", "monster", 0);
                                material = "Dwarven";
                                break;
                        }
                    ...
                    else if (item is BaseStatueDeed)
                    {
                        ...
                        Server.Items.Statues.SetStatue(
                            (BaseStatueDeed)item,
                            (int)item.Weight,
                            color,
                            material,
                    ...
                    else if (item is TrapKit)
                    {
                        ...
                        {
                            case CraftResource.DullCopper:
                                item.Hue = MaterialInfo.GetMaterialColor(
                                    "dull copper",
                                    "classic",
                                    0
                                );
                                ((TrapKit)item).m_Metal = "Dull Copper";
                                break;
                            case CraftResource.ShadowIron:
                                item.Hue = MaterialInfo.GetMaterialColor(
                                    "shadow iron",
                    ...
                    )
                    {
                        ...
                        if (item is WoodenChest)
                        {
                            cHue = 0x724;
                        }
                        else if (item is WoodenThrone)
                        {
                            cHue = 0x840;
                        }
                        else if (item is GiantBag)
                        {
                            cHue = Server.Misc.MaterialInfo.PlainLeatherColor();
                        }
                        else if (item is LargeSack)
                        {
                            cHue = Server.Misc.MaterialInfo.PlainLeatherColor();
                        }
                        else if (item is BigBag)
                        {
                            cHue = Server.Misc.MaterialInfo.PlainLeatherColor();
                        }
                        else if (item is Bag)
                        ...
                        else if (item is AdventurerCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is AlchemyCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ArmsCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is BakerCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is BeekeeperCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is BlacksmithCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is BowyerCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ButcherCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is CarpenterCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is FletcherCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is HealerCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is HugeCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is JewelerCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is LibrarianCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is MusicianCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is NecromancerCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ProvisionerCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is SailorCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is StableCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is SupplyCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is TailorCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is TavernCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is TinkerCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is TreasureCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is WizardryCrate)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredArmoireA)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredArmoireB)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetA)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetB)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetC)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetD)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetE)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetF)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetG)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetH)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetI)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetJ)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetK)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetL)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetM)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredCabinetN)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredDresserA)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredDresserB)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredDresserC)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredDresserD)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredDresserE)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredDresserF)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredDresserG)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredDresserH)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredDresserI)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredDresserJ)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelf1)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelf2)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelf3)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelf4)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelf5)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelf6)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelf7)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelf8)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfA)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfB)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfC)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfD)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfE)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfF)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfG)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfH)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfI)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfJ)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfK)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfL)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfM)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfN)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfO)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfP)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfQ)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfR)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfS)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfT)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfU)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfV)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfW)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfX)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfY)
                        {
                            cHue = 0xABE;
                        }
                        else if (item is ColoredShelfZ)
                        {
                            cHue = 0xABE;
                        }
                        ...
                        {
                            case CraftResource.DullCopper:
                                cHue = MaterialInfo.GetMaterialColor("dull copper", "classic", 0);
                                break;
                            case CraftResource.ShadowIron:
                                cHue = MaterialInfo.GetMaterialColor("shadow iron", "classic", 0);
                                break;
                            case CraftResource.Copper:
                                cHue = MaterialInfo.GetMaterialColor("copper", "classic", 0);
                                break;
                            case CraftResource.Bronze:
                                cHue = MaterialInfo.GetMaterialColor("bronze", "classic", 0);
                                break;
                            case CraftResource.Gold:
                                cHue = MaterialInfo.GetMaterialColor("gold", "classic", 0);
                                break;
                            case CraftResource.Agapite:
                                cHue = MaterialInfo.GetMaterialColor("agapite", "classic", 0);
                                break;
                            case CraftResource.Verite:
                                cHue = MaterialInfo.GetMaterialColor("verite", "classic", 0);
                                break;
                            case CraftResource.Valorite:
                                cHue = MaterialInfo.GetMaterialColor("valorite", "classic", 0);
                                break;
                            case CraftResource.Obsidian:
                                cHue = MaterialInfo.GetMaterialColor("obsidian", "classic", 0);
                                break;
                            case CraftResource.Steel:
                                cHue = MaterialInfo.GetMaterialColor("steel", "classic", 0);
                                break;
                            case CraftResource.Brass:
                                cHue = MaterialInfo.GetMaterialColor("brass", "classic", 0);
                                break;
                            case CraftResource.Mithril:
                                cHue = MaterialInfo.GetMaterialColor("mithril", "classic", 0);
                                break;
                            case CraftResource.Xormite:
                                cHue = MaterialInfo.GetMaterialColor("xormite", "classic", 0);
                                break;
                            case CraftResource.Dwarven:
                                cHue = MaterialInfo.GetMaterialColor("dwarven", "classic", 0);
                                break;
                            case CraftResource.Nepturite:
                                cHue = MaterialInfo.GetMaterialColor("nepturite", "classic", 0);
                                break;
                            case CraftResource.AshTree:
                                cHue = MaterialInfo.GetMaterialColor("ash", "", 0);
                                break;
                            ...
                            case CraftResource.ElvenTree:
                                ...
                                break;
                            case CraftResource.SpinedLeather:
                                cHue = MaterialInfo.GetMaterialColor("deep sea", "", 0);
                                break;
                            case CraftResource.HornedLeather:
                                cHue = MaterialInfo.GetMaterialColor("lizard", "", 0);
                                break;
                            case CraftResource.BarbedLeather:
                                cHue = MaterialInfo.GetMaterialColor("serpent", "", 0);
                                break;
                            case CraftResource.NecroticLeather:
                                cHue = MaterialInfo.GetMaterialColor("necrotic", "", 0);
                                break;
                            case CraftResource.VolcanicLeather:
                                cHue = MaterialInfo.GetMaterialColor("volcanic", "", 0);
                                break;
                            case CraftResource.FrozenLeather:
                                cHue = MaterialInfo.GetMaterialColor("frozen", "", 0);
                                break;
                            case CraftResource.GoliathLeather:
                                cHue = MaterialInfo.GetMaterialColor("goliath", "", 0);
                                break;
                            case CraftResource.DraconicLeather:
                                cHue = MaterialInfo.GetMaterialColor("draconic", "", 0);
                                break;
                            case CraftResource.HellishLeather:
                                cHue = MaterialInfo.GetMaterialColor("hellish", "", 0);
                                break;
                            case CraftResource.DinosaurLeather:
                                cHue = MaterialInfo.GetMaterialColor("dinosaur", "", 0);
                                break;
                            case CraftResource.AlienLeather:
                                cHue = MaterialInfo.GetMaterialColor("alien", "", 0);
                                break;
                        }
                    ...
                    if (item is BaseArmor || item is BaseWeapon) // ELVEN WOOD
                    {
                        ...
                        else if (thisResource == CraftResource.Dwarven)
                        {
                            if (item is BaseWeapon)
                            {
                                ((BaseWeapon)item).Attributes.RegenHits = 5;
                                ((BaseWeapon)item).Attributes.AttackChance = 50;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseWeapon)item,
                                    false,
                                    0,
                            ...
                            {
                                ((BaseShield)item).Attributes.RegenHits = 5;
                                ((BaseShield)item).Attributes.DefendChance = 10;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseShield)item,
                                    false,
                                    0,
                            ...
                            {
                                ((BaseArmor)item).Attributes.RegenHits = 5;
                                ((BaseArmor)item).Attributes.DefendChance = 10;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)item,
                                    false,
                                    0,
                ...
                if (num == 0)
                    num = craftSystem.PlayEndingEffect(
                        from,
                        false,
                        true,
                        toolBroken,
                            ...
                            if (town != null && town.Owner == faction)
                            {
                                ...
                                if (pack != null)
                                {
                                    ...
                                    if (availableSilver >= def.SilverCost)
                                        queryFactionImbue = Faction.IsNearType(
                                            from,
                                            def.VendorType,
                                            12
                                        );
            ...
            else
            {
                ...
                // SkillCheck failed.
                int num = craftSystem.PlayEndingEffect(
                    from,
                    true,
                    true,
                    toolBroken,
