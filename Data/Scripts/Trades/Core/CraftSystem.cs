...
namespace Server.Engines.Craft
{
    ...
    public abstract class CraftSystem
    {
        ...
        {
            get { return m_MinCraftEffect; }
        }
        public int MaxCraftEffect
        {
            get { return m_MaxCraftEffect; }
        }
        public double Delay
        {
            get { return m_Delay; }
        ...
        private Dictionary<Mobile, CraftContext> m_ContextTable =
            new Dictionary<Mobile, CraftContext>();
        ...
        public void CreateItem(
            ...
            Type typeRes,
            BaseTool tool,
            CraftItem realCraftItem
        )
        {
            CreateItem(from, type, typeRes, tool, realCraftItem, 1);
        }
        ...
        )
        {
            ...
            if (craftItem != null)
            {
                ...
                realCraftItem.Craft(from, this, typeRes, tool, makeAmount);
