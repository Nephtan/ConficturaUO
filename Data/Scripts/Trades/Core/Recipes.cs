    ...
    public class Recipe
    {
        public static void Initialize()
        {
            CommandSystem.Register(
                ...
                new CommandEventHandler(LearnAllRecipes_OnCommand)
            );
            CommandSystem.Register(
                "ForgetAllRecipes",
                AccessLevel.GameMaster,
                new CommandEventHandler(ForgetAllRecipes_OnCommand)
            );
        }
        ...
        private static void LearnAllRecipes_OnCommand(CommandEventArgs e)
        {
            ...
            m.BeginTarget(
                -1,
                false,
                Server.Targeting.TargetFlags.None,
                new TargetCallback(
        ...
        private static void ForgetAllRecipes_OnCommand(CommandEventArgs e)
        {
            Mobile m = e.Mobile;
            m.SendMessage(
                "Target a player to have them forget all of the recipes they've learned."
            );
