...
namespace Server.Engines.Craft
{
    ...
    public class Enhance
    {
        ...
        )
        {
            ...
            if (
                craftItem.GetSuccessChance(from, resType, craftSystem, false, ref allRequiredSkills)
                <= 0.0
            )
        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                {
                    object message = null;
                    EnhanceResult res = Enhance.Invoke(
                        from,
                        m_CraftSystem,
                        m_Tool,
                        (Item)targeted,
