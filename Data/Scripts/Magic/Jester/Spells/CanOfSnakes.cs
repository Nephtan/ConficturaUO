...
namespace Server.Spells.Jester
{
    public class CanOfSnakes : JesterSpell
    {
        ...
        public CanOfSnakes(Mobile caster, Item scroll)
        ...
        public override void OnCast()
        {
            ...
            if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                Server.Mobiles.SummonedJoke.MakeJoker(
                    Caster,
                    p,
                    FoolPoisons,
                    FoolName,
                ...
                if (Caster.Skills[SkillName.Psychology].Value >= Utility.RandomMinMax(1, 200))
                {
                    qty++;
                }
                if (Caster.Skills[SkillName.Psychology].Value >= Utility.RandomMinMax(1, 200))
