...
namespace Server.Spells.Jester
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Clowns", "Get ready for the show!", -1, 0);
        ...
        public Clowns(Mobile caster, Item scroll)
        ...
        public override void OnCast()
        {
            ...
            else if (CheckSequence())
            {
                ...
                if (Caster.Skills[SkillName.Begging].Value >= Utility.RandomMinMax(1, 200))
                {
                    qty++;
                }
                if (Caster.Skills[SkillName.Psychology].Value >= Utility.RandomMinMax(1, 100))
                {
                    qty++;
                }
...
namespace Server.Mobiles
{
    public class Clown : BaseCreature
    {
        ...
        public override void OnDelete()
        {
            ...
            {
                case 0:
                    PlaySound(Female ? 780 : 1051);
                    break;
                case 1:
                    Animate(32, 5, 1, true, false, 0);
                    break;
                case 2:
                    PlaySound(Female ? 794 : 1066);
                    break;
                case 3:
                    PlaySound(Female ? 801 : 1073);
                    break;
                case 4:
                    PlaySound(792);
                    break;
                case 5:
                    PlaySound(Female ? 783 : 1054);
                    break;
            }
            ;
    ...
    public class ClownAI : BaseAI
    {
        ...
        public override bool Think()
        {
            ...
            if (Utility.RandomMinMax(1, 10) == 1)
            {
                ...
                {
                    case 0:
                        m_Mobile.PlaySound(m_Mobile.Female ? 780 : 1051);
                        break;
                    case 1:
                        m_Mobile.Animate(32, 5, 1, true, false, 0);
                        break;
                    case 2:
                        m_Mobile.PlaySound(m_Mobile.Female ? 794 : 1066);
                        break;
                    case 3:
                        m_Mobile.PlaySound(m_Mobile.Female ? 801 : 1073);
                        break;
                    case 4:
                        m_Mobile.PlaySound(792);
                        break;
                    case 5:
                        m_Mobile.PlaySound(m_Mobile.Female ? 783 : 1054);
                        break;
                }
                ;
            }
        ...
        public override bool CanSearching
        {
            get { return false; }
        }
    }
