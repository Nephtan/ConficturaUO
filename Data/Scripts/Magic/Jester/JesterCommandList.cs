    ...
    public class CastJesterSpells
    {
        public static void Initialize()
        {
            ...
            Register(
                "CanOfSnakes",
                AccessLevel.Player,
                new CommandEventHandler(CanOfSnakes_OnCommand)
            );
            ...
            Register(
                "FlowerPower",
                AccessLevel.Player,
                new CommandEventHandler(FlowerPower_OnCommand)
            );
            ...
            Register(
                "JumpAround",
                AccessLevel.Player,
                new CommandEventHandler(JumpAround_OnCommand)
            );

            Register(
                "PoppingBalloon",
                AccessLevel.Player,
                new CommandEventHandler(PoppingBalloon_OnCommand)
            );

            Register(
                "RabbitInAHat",
                AccessLevel.Player,
                new CommandEventHandler(RabbitInAHat_OnCommand)
            );

            Register(
                "SeltzerBottle",
                AccessLevel.Player,
                new CommandEventHandler(SeltzerBottle_OnCommand)
            );

            Register(
                "SurpriseGift",
                AccessLevel.Player,
                new CommandEventHandler(SurpriseGift_OnCommand)
            );
        }
