...
namespace Server.Items
{
    public class BagOfTricks : Item
    {
        ...
        public int Prank_Points
        {
            get { return PrankPoints; }
            set
            {
                PrankPoints = value;
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (PrankPoints > 0)
            {
                list.Add(1070722, "" + PrankPoints + " Prank Points");
            }
        }
        ...
        public static void UsePranks(Mobile m, int pranks)
        {
            ...
            for (int i = 0; i < tricks.Count; ++i)
            {
                ...
                if (pranks > 0)
                {
                    ...
                    {
                        bag.PrankPoints = bag.PrankPoints - pranks;
                        pranks = 0;
                        bag.InvalidateProperties();
                    }
                    else if (pranks > bag.PrankPoints)
                    {
                        pranks = pranks - bag.PrankPoints;
                        bag.PrankPoints = 0;
                        bag.InvalidateProperties();
                    }
                }
        ...
        public BagOfTricks(Serial serial)
            : base(serial) { }
        ...
        public static void DoPrank(Mobile from, int skill)
        {
            if (skill == 260)
            {
                InvokeCommand("CanOfSnakes", from);
            }
            else if (skill == 261)
            {
                InvokeCommand("Clowns", from);
            }
            else if (skill == 262)
            {
                InvokeCommand("FlowerPower", from);
            }
            else if (skill == 263)
            {
                InvokeCommand("Hilarity", from);
            }
            else if (skill == 264)
            {
                InvokeCommand("Insult", from);
            }
            else if (skill == 265)
            {
                InvokeCommand("JumpAround", from);
            }
            else if (skill == 266)
            {
                InvokeCommand("PoppingBalloon", from);
            }
            else if (skill == 267)
            {
                InvokeCommand("RabbitInAHat", from);
            }
            else if (skill == 268)
            {
                InvokeCommand("SeltzerBottle", from);
            }
            else if (skill == 269)
            {
                InvokeCommand("SurpriseGift", from);
            }
        }
        ...
        public static string JokeInfo(int ability, string type)
        {
            ...
            if (ability == 20749 || ability == (20749 + 10))
            {
                ...
                {
                    str =
                        "Opening a can of nuts will simply dazzle the audience as snakes are released instead. These snakes will follow your commands for a short period of time. The better your jester skills, the longer they will remain and the stronger they will be. Their venom will also be equally strong.";
                }
            }
            else if (ability == 20751 || ability == (20751 + 10))
            {
                ...
                {
                    str =
                        "Fool your audience by creating illusions of yourself, which may help you sneak away or distract one from yourself. Your illusions will vary in duration and amount, depending on your jester skills.";
                }
            }
            else if (ability == 20748 || ability == (20748 + 10))
            {
                ...
                {
                    str =
                        "It may be an ordinary flower, but smelling this flower will simply get you covered in acidic slime. The effectiveness of the slime is dependent on your jester skills, and it may have the potential to cover the ground in annoying splatter.";
                }
            }
            else if (ability == 20750 || ability == (20750 + 10))
            {
                ...
                {
                    str =
                        "Keep your audience in stitches! Tell a joke and see if others are frozen in laughter. The duration of the laughter is based on both your jester skills and the difficulty of the audience. The range of which your joke is heard, is also dependent on your jester skills.";
                }
            }
            else if (ability == 20747 || ability == (20747 + 10))
            {
                ...
                {
                    str =
                        "Get ready to deal a sharp tongued insult! Although your words won't have them slipping on their tears, it will demoralize them to the point where their mana will begin to fade as they reflect on their hurt feelings. The duration of the decline, as well as how much mana is lost each second, is dependent on your jester skills.";
                }
            }
            else if (ability == 20754 || ability == (20754 + 10))
            {
                ...
                {
                    str =
                        "This allows you to demonstrate your acrobatic skills, as you can quickly jump and leap around, perhaps avoiding dangers or getting to hard reaching places.";
                }
            }
            ...
            else if (ability == 20755 || ability == (20755 + 10))
            {
                ...
                {
                    str =
                        "Offer your audience a drink, and they will probably not ask you again. This will spray a target with freezing water, where the effectiveness is dependent on your jester skills, and it may have the potential to cover the ground in ice cold water.";
                }
            }
        ...
        {
            public BagOfTricksGump(Mobile from)
                : base(50, 50)
            {
                string color = "#b3706f";
                from.SendSound(0x4A);
                ...
                AddHtml(
                    ...
                    727,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">BAG OF TRICKS</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    880,
                    249,
                    @"<BODY><BASEFONT Color=" + color + ">" + JesterSpeech() + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    106,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Large Column</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    106,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Large Row</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    106,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Small Column</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    106,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Small Row</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    106,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Close All</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    106,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Cancel</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                if (info.ButtonID > 20000)
                {
                    from.SendGump(new InfoJester(info.ButtonID, from));
                }
        ...
        {
            public TricksLargeRow(Mobile from)
                : base(50, 50)
            {
                this.Closable = false;
                this.Disposable = true;
        ...
        {
            public TricksLargeColumn(Mobile from)
                : base(50, 50)
            {
                this.Closable = false;
                this.Disposable = true;
        ...
        {
            public TricksSmallRow(Mobile from)
                : base(50, 50)
            {
                this.Closable = false;
                this.Disposable = true;
        ...
        {
            public TricksSmallColumn(Mobile from)
                : base(50, 50)
            {
                this.Closable = false;
                this.Disposable = true;
...
namespace Server.Gumps
{
    ...
    {
        public InfoJester(int i, Mobile from)
            : base(50, 50)
        {
            string color = "#b3706f";
            from.SendSound(0x4A);
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">"
                    + Server.Items.BagOfTricks.JokeInfo(i, "name")
                    + "</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">"
                    + Server.Items.BagOfTricks.JokeInfo(i, "detail")
                    + "</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + ">Prank Points: "
                    + Server.Items.BagOfTricks.JokeInfo(i, "points")
                    + "</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + "><RIGHT>Mana: "
                    + Server.Items.BagOfTricks.JokeInfo(i, "mana")
                    + "<?RIGHT></BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
