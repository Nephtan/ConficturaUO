    ...
    public class DeathKnightCommands
    {
        public static void Initialize()
        {
            ...
            Register(
                "DKDemonicTouch",
                AccessLevel.Player,
                new CommandEventHandler(DKDemonicTouch_OnCommand)
            );
            Register(
                "DKDevilPact",
                AccessLevel.Player,
                new CommandEventHandler(DKDevilPact_OnCommand)
            );
            Register(
                "DKGrimReaper",
                AccessLevel.Player,
                new CommandEventHandler(DKGrimReaper_OnCommand)
            );
            Register("DKHagHand", AccessLevel.Player, new CommandEventHandler(DKHagHand_OnCommand));
            Register(
                "DKHellfire",
                AccessLevel.Player,
                new CommandEventHandler(DKHellfire_OnCommand)
            );
            Register(
                "DKLucifersBolt",
                AccessLevel.Player,
                new CommandEventHandler(DKLucifersBolt_OnCommand)
            );
            Register(
                "DKOrbOrcus",
                AccessLevel.Player,
                new CommandEventHandler(DKOrbOrcus_OnCommand)
            );
            Register(
                "DKShieldHate",
                AccessLevel.Player,
                new CommandEventHandler(DKShieldHate_OnCommand)
            );
            Register(
                "DKSoulReaper",
                AccessLevel.Player,
                new CommandEventHandler(DKSoulReaper_OnCommand)
            );
            Register(
                "DKStrengthSteel",
                AccessLevel.Player,
                new CommandEventHandler(DKStrengthSteel_OnCommand)
            );
            Register("DKStrike", AccessLevel.Player, new CommandEventHandler(DKStrike_OnCommand));
            Register(
                "DKSuccubusSkin",
                AccessLevel.Player,
                new CommandEventHandler(DKSuccubusSkin_OnCommand)
            );
        ...
        public static void DKBanish_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new BanishSpell(e.Mobile, null).Cast();
            }
            else
            {
        ...
        public static void DKDemonicTouch_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new DemonicTouchSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKDevilPact_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new DevilPactSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKGrimReaper_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new GrimReaperSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKHagHand_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new HagHandSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKHellfire_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new HellfireSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKLucifersBolt_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new LucifersBoltSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKOrbOrcus_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new OrbOfOrcusSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKShieldHate_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new ShieldOfHateSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKSoulReaper_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new SoulReaperSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKStrengthSteel_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new StrengthOfSteelSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKStrike_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new StrikeSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKSuccubusSkin_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new SuccubusSkinSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DKWrath_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new WrathSpell(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
