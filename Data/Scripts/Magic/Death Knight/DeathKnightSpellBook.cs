...
namespace Server.Items
{
    public class DeathKnightSpellbook : Spellbook
    {
        ...
        {
            get { return SpellbookType.DeathKnight; }
        }
        ...
        [Constructable]
        public DeathKnightSpellbook(ulong content, Mobile gifted)
            : base(content, 0x27B6)
        {
            Hue = 0x969;
            ...
            {
                case 1:
                    this.Name = "Kas' Book of " + sEvil + " Knights";
                    break;
                case 2:
                    this.Name = "Kas' Tome of " + sEvil + " Knights";
                    break;
            }
        }
        ...
        public DeathKnightSpellbook(Serial serial)
            : base(serial) { }
