...
namespace Server.Spells.DeathKnight
{
    public abstract class DeathKnightSpell : Spell
    {
        ...
        {
            get { return SkillName.Knightship; }
        }
        ...
        public DeathKnightSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override bool CheckCast()
        {
            ...
            {
                Caster.SendMessage(
                    "You must have at least " + RequiredSkill + " Knightship to cast this spell."
                );
                return false;
            }
            ...
            {
                Caster.SendMessage(
                    "You must have at least " + RequiredTithing + " Souls to cast this spell."
                );
                return false;
            }
