            ...
            else
            {
                ...
                if (page == 2)
                {
                    ...
                    if (!this.HasSpell(from, 750))
                    {
                        z1 = 220;
                        text1 =
                            "Saint Kargoth<BR>Land of Sosaria: Ancient Pyramid<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text1 =
                        text1
                        + "Banish summoned creatures back to their realm, demons back to hell, or elementals back to their plane of existence.";
                    icon1 = 0x5010;
                    ...
                    if (!this.HasSpell(from, 751))
                    {
                        z2 = 220;
                        text2 =
                            "Lord Monduiz Dephaar<BR>Land of Sosaria: Dungeon Clues<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text2 =
                        text2
                        + "The death knight's target is healed by demonic forces for a significant amount.";
                    icon2 = 0x5009;
                }
                else if (page == 3)
                {
                    ...
                    if (!this.HasSpell(from, 752))
                    {
                        z1 = 220;
                        text1 =
                            "Lady Kath of Naelex<BR>Land of Sosaria: Dungeon Doom<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    ...
                    if (!this.HasSpell(from, 753))
                    {
                        z2 = 220;
                        text2 =
                            "Prince Myrhal of Rax<BR>Land of Sosaria: Fires of Hell<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text2 =
                        text2
                        + "The next target hit becomes marked by the grim reaper. All damage dealt to it is increased, but the death knight takes extra damage from other kinds of creatures.";
                    icon2 = 0x402;
                }
                else if (page == 4)
                {
                    ...
                    if (!this.HasSpell(from, 754))
                    {
                        z1 = 220;
                        text1 =
                            "Sir Maeril of Naelax<BR>Land of Sosaria: Dungeon Exodus<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text1 =
                        text1
                        + "Your hand holds the powers of a hag, where it can remove curses from items and others.";
                    icon1 = 0x5002;
                    ...
                    if (!this.HasSpell(from, 755))
                    {
                        z2 = 220;
                        text2 =
                            "Sir Farian of Lirtham<BR>Land of Ambrosia: City of the Dead<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text2 =
                        text2
                        + "The death knights's enemy is scorched by a hellfire that continues to burn the enemy for a short duration.";
                    icon2 = 0x3E9;
                }
                else if (page == 5)
                {
                    ...
                    if (!this.HasSpell(from, 756))
                    {
                        z1 = 220;
                        text1 =
                            "Lord Androma of Gara<BR>Island of Umber Veil: the Mausoleum<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text1 =
                        text1
                        + "Calls down a bolt of energy from Lucifer himself, and temporarily stuns the enemy.";
                    icon1 = 0x5DC0;
                    ...
                    if (!this.HasSpell(from, 757))
                    {
                        z2 = 220;
                        text2 =
                            "Sir Oslan Knarren<BR>Land of Lodoria: Dungeon Despise<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text2 =
                ...
                else if (page == 6)
                {
                    ...
                    if (!this.HasSpell(from, 758))
                    {
                        z1 = 220;
                        text1 =
                            "Sir Rezinar of Haxx<BR>Land of Lodoria: Dungeon Deceit<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text1 =
                        text1
                        + "Channels hatred to form a barrier around the target, shielding them from physical harm.";
                    icon1 = 0x3EE;
                    ...
                    if (!this.HasSpell(from, 759))
                    {
                        z2 = 220;
                        text2 =
                            "Lord Thyrian of Naelax<BR>Land of Lodoria: Dungeon Wrong<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text2 =
                        text2
                        + "Drains the enemy of their soul, reducing their mana for a short period of time.";
                    icon2 = 0x5006;
                }
                else if (page == 7)
                {
                    ...
                    mana1 = "20";
                    text1 = "";
                    if (!this.HasSpell(from, 760))
                    {
                        z1 = 220;
                        text1 =
                            "Sir Minar of Darmen<BR>Land of Lodoria: Lodoria Catacombs<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    ...
                    mana2 = "12";
                    text2 = "";
                    if (!this.HasSpell(from, 761))
                    {
                        z2 = 220;
                        text2 =
                            "Duke Urkar of Torquann<BR>Land of Lodoria: Dungeon Shame<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text2 =
                        text2
                        + "The death knight's enemy is damaged by a demonic energy from the nine hells.";
                    icon2 = 0x12;
                }
                else if (page == 8)
                {
                    ...
                    mana1 = "32";
                    text1 = "";
                    if (!this.HasSpell(from, 762))
                    {
                        z1 = 220;
                        text1 =
                            "Sir Luren the Boar<BR>Land of Lodoria: the City of Embers<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text1 =
                        text1
                        + "The death knight's target has their skin regenerate health over time.";
                    icon1 = 0x500C;
                    ...
                    mana2 = "44";
                    text2 = "";
                    if (!this.HasSpell(from, 763))
                    {
                        z2 = 220;
                        text2 =
                            "Lord Khayven of Rax<BR>Land of Lodoria: Dungeon Hythloth<BR>"
                            + sGrave
                            + "<BR><BR>";
                    }
                    text2 =
                        text2
                        + "The death knight unleashes the forces of hell unto his nearby enemies, causing much damage.";
                    icon2 = 0x2E;
                }
                ...
                AddHtml(
                    ...
                    200,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + name1 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    57,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Souls:</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    57,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + soul1 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    57,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + skil1 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    57,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + mana1 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    250,
                    175,
                    @"<BODY><BASEFONT Color=" + color + ">" + text1 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    200,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + name2 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    57,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + soul2 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    57,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + skil2 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    57,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + mana2 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    250,
                    175,
                    @"<BODY><BASEFONT Color=" + color + ">" + text2 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
