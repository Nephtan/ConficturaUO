...
namespace Server.Spells.DeathKnight
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Strike", "Naberius Impetus", 230, 9022);
        ...
        public StrikeSpell(Mobile caster, Item scroll)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(StrikeSpell owner)
