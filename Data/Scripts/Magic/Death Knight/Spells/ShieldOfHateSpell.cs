...
namespace Server.Spells.DeathKnight
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Shield of Hate", "Bael Odi", 236, 9011);
        ...
        public ShieldOfHateSpell(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            if (m_Table.Contains(m))
            {
                Caster.LocalOverheadMessage(
                    ...
                    0x481,
                    false,
                    "That target is under the effect of that spell already."
                );
            }
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(ShieldOfHateSpell owner)
