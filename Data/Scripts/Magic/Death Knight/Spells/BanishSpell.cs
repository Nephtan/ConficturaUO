...
namespace Server.Spells.DeathKnight
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Banish", "Izanami Exsilium", 215, 9031);
        ...
        public BanishSpell(Mobile caster, Item scroll)
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(BanishSpell owner)
                    ...
                    else if (m_Owner.CheckHSequence(m))
                    {
                        ...
                        double dispelChance =
                            (
                                50.0
                                + (
                                    (100 * (from.Skills.Knightship.Value - bc.DispelDifficulty))
                                    / (bc.DispelFocus * 2)
                                )
                            ) / 100;
