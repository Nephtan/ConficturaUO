...
namespace Server.Spells.DeathKnight
{
    public class StrengthOfSteelSpell : DeathKnightSpell
    {
        ...
        public StrengthOfSteelSpell(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckBSequence(m) && CheckFizzle())
            {
                ...
                int bonus = Server.Misc.MyServerSettings.PlayerLevelMod(
                    (int)(GetKarmaPower(m) / 3),
                    Caster
                );
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(StrengthOfSteelSpell owner)
