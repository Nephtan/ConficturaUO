...
namespace Server.Spells.DeathKnight
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Demonic Touch", "Raum Curare", 224, 9061);
        ...
        public DemonicTouchSpell(Mobile caster, Item scroll)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(DemonicTouchSpell owner)
