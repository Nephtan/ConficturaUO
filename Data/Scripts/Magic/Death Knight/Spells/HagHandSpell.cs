...
namespace Server.Spells.DeathKnight
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Hag Hand", "Haures Manibus", 227, 9031);
        ...
        public HagHandSpell(Mobile caster, Item scroll)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(HagHandSpell owner)
