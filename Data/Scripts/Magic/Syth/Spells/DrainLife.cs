...
namespace Server.Spells.Syth
{
    public class DrainLife : SythSpell
    {
        ...
        public DrainLife(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            {
                Caster.SendMessage(
                    "This power cannot affect supernatural creatures, golems, constructs, or elementals."
                );
            }
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(DrainLife owner)
        ...
        public class DrainTimer : Timer
        {
            ...
            public DrainTimer(Mobile caster, Mobile m, TimeSpan duration, int min, int max)
