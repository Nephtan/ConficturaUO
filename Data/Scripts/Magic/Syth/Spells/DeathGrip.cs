...
namespace Server.Spells.Syth
{
    public class DeathGrip : SythSpell
    {
        ...
        public DeathGrip(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckHSequence(m) && CheckFizzle())
            {
                ...
                Effects.SendLocationParticles(
                    EffectItem.Create(grip, m.Map, EffectItem.DefaultDuration),
                    0x4CE3,
                    9,
                    32,
                    0x8BF - 1,
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(DeathGrip owner)
        ...
        public class GripTimer : Timer
        {
            ...
            public GripTimer(Mobile sleeper, TimeSpan duration, int min, int max, Mobile caster)
            ...
            protected override void OnTick()
            {
                ...
                if (m_Time > 60 && m_m != null && m_Caster != null)
                {
                    ...
                    AOS.Damage(
                        m_m,
                        m_Caster,
                        Utility.RandomMinMax(m_Min, m_Max),
                        true,
                        100,
                        0,
                        0,
                    ...
                    Effects.SendLocationParticles(
                        EffectItem.Create(grip, m_m.Map, EffectItem.DefaultDuration),
                        0x4CE3,
                        9,
                        32,
                        0x8BF - 1,
