    ...
    public class CastSythSpells
    {
        public static void Initialize()
        {
            ...
            Register(
                "Psychokinesis",
                AccessLevel.Player,
                new CommandEventHandler(Psychokinesis_OnCommand)
            );
            ...
            Register(
                "Projection",
                AccessLevel.Player,
                new CommandEventHandler(Projection_OnCommand)
            );

            Register(
                "ThrowSword",
                AccessLevel.Player,
                new CommandEventHandler(ThrowSword_OnCommand)
            );
            ...
            Register(
                "SythLightning",
                AccessLevel.Player,
                new CommandEventHandler(SythLightning_OnCommand)
            );

            Register(
                "Absorption",
                AccessLevel.Player,
                new CommandEventHandler(Absorption_OnCommand)
            );

            Register(
                "PsychicBlast",
                AccessLevel.Player,
                new CommandEventHandler(PsychicBlast_OnCommand)
            );
        ...
        public static void Psychokinesis_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new Psychokinesis(e.Mobile, null).Cast();
            }
            else
            {
        ...
        public static void DeathGrip_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new DeathGrip(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void Projection_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new Projection(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void ThrowSword_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new ThrowSword(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void SythSpeed_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new SythSpeed(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void SythLightning_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new SythLightning(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void Absorption_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new Absorption(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void PsychicBlast_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new PsychicBlast(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void DrainLife_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new DrainLife(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void Clone_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new CloneBody(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
