...
namespace Server.Items
{
    public class SythSpellbook : Spellbook
    {
        ...
        [Constructable]
        public SythSpellbook(ulong content, Mobile gifted)
            : base(content, 0x4CE0)
        {
            owner = gifted;
            page = 0;
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            {
                dropped.ItemID = 0x4CDE;
                dropped.Name = "Syth Exacron";
                doSythEffect = true;
            }
            else if (
                dropped.Name != null
            ...
            )
            {
                if (dropped is BaseHat || dropped is MagicHat)
                {
                    ...
                    {
                        dropped.ItemID = 0x4CDC;
                        dropped.Name = "Syth hood";
                    }
                    else
                    {
                        dropped.ItemID = 0x4CDA;
                        dropped.Name = "Syth cowl";
                    }
                    doSythEffect = true;
                }
                ...
                else if (dropped.Layer == Layer.OuterTorso)
                {
                    ...
                    {
                        dropped.ItemID = 0x2B69;
                        dropped.Name = "Syth robe";
                    }
                    else
                    {
                        dropped.ItemID = 0x2B69;
                ...
                {
                    dropped.ItemID = 0x1515;
                    dropped.Name = "Syth cloak";
                    doSythEffect = true;
                }
                else if (dropped.Layer == Layer.Helm && dropped is BaseArmor)
                {
                    dropped.ItemID = 0x2FBB;
                    dropped.Name = "Syth helm";
                    doSythEffect = true;
                }
            }
        ...
        public SythSpellbook(Serial serial)
            : base(serial) { }
        ...
        public class PowerRow : Gump
        {
            ...
            public PowerRow(Mobile from, SythSpellbook book)
                : base(25, 25)
            {
                mBook = book;
                this.Closable = false;
        ...
        public class PowerColumn : Gump
        {
            ...
            public PowerColumn(Mobile from, SythSpellbook book)
                : base(25, 25)
            {
                mBook = book;
                this.Closable = false;
                ...
                if (HasSpell(from, icon))
                {
                    ...
                    if (book.names > 0)
                    {
                        AddLabel(
                            ...
                            (r + 8),
                            0x481,
                            @"" + Server.Spells.Syth.SythSpell.SpellInfo(icon, 1) + ""
                        );
                    }
                    r = r + 50;
                }
