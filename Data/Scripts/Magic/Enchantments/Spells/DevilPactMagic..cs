...
{
    public class DevilPactMagic : EnchantMagic
    {
        ...
        public DevilPactMagic(Mobile caster, Item scroll)
        ...
        {
            private DevilPactMagic m_Owner;

            public InternalTarget(DevilPactMagic owner)
