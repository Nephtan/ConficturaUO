...
{
    public class HellfireMagic : EnchantMagic
    {
        ...
        public HellfireMagic(Mobile caster, Item scroll)
        ...
        {
            private HellfireMagic m_Owner;

            public InternalTarget(HellfireMagic owner)
