...
{
    public class ShieldOfHateMagic : EnchantMagic
    {
        ...
        public ShieldOfHateMagic(Mobile caster, Item scroll)
        ...
        {
            private ShieldOfHateMagic m_Owner;

            public InternalTarget(ShieldOfHateMagic owner)
