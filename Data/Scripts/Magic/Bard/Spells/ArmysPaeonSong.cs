...
namespace Server.Spells.Song
{
    public class ArmysPaeonSong : Song
    {
        ...
        public ArmysPaeonSong(Mobile caster, Item scroll)
        ...
        public override void OnCast()
        {
            ...
            if (CheckSequence())
            {
                ...
                for (int i = 0; i < targets.Count; ++i)
                {
                    ...
                    /////
                    double allvalue =
                        Caster.Skills[SkillName.Musicianship].Value
                        + Caster.Skills[SkillName.Provocation].Value
                        + Caster.Skills[SkillName.Discordance].Value
                        + Caster.Skills[SkillName.Peacemaking].Value;
