    ...
    public class CastSongSpells
    {
        public static void Initialize()
        {
            ...
            Register(
                "ArmysPaeon",
                AccessLevel.Player,
                new CommandEventHandler(ArmysPaeon_OnCommand)
            );

            Register(
                "EnchantingEtude",
                AccessLevel.Player,
                new CommandEventHandler(EnchantingEtude_OnCommand)
            );

            Register(
                "EnergyCarol",
                AccessLevel.Player,
                new CommandEventHandler(EnergyCarol_OnCommand)
            );

            Register(
                "EnergyThrenody",
                AccessLevel.Player,
                new CommandEventHandler(EnergyThrenody_OnCommand)
            );
            ...
            Register(
                "FireThrenody",
                AccessLevel.Player,
                new CommandEventHandler(FireThrenody_OnCommand)
            );

            Register(
                "FoeRequiem",
                AccessLevel.Player,
                new CommandEventHandler(FoeRequiem_OnCommand)
            );
            ...
            Register(
                "IceThrenody",
                AccessLevel.Player,
                new CommandEventHandler(IceThrenody_OnCommand)
            );

            Register(
                "KnightsMinne",
                AccessLevel.Player,
                new CommandEventHandler(KnightsMinne_OnCommand)
            );

            Register(
                "MagesBallad",
                AccessLevel.Player,
                new CommandEventHandler(MagesBallad_OnCommand)
            );

            Register(
                "MagicFinale",
                AccessLevel.Player,
                new CommandEventHandler(MagicFinale_OnCommand)
            );

            Register(
                "PoisonCarol",
                AccessLevel.Player,
                new CommandEventHandler(PoisonCarol_OnCommand)
            );

            Register(
                "PoisonThrenody",
                AccessLevel.Player,
                new CommandEventHandler(PoisonThrenody_OnCommand)
            );

            Register(
                "ShephardsDance",
                AccessLevel.Player,
                new CommandEventHandler(SheepfoeMambo_OnCommand)
            );

            Register(
                "SinewyEtude",
                AccessLevel.Player,
                new CommandEventHandler(SinewyEtude_OnCommand)
            );
        }
