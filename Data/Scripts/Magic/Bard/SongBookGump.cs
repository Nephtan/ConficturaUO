...
namespace Server.Gumps
{
    public class SongBookGump : Gump
    {
        ...
        public SongBookGump(Mobile from, SongBook book, int page)
            : base(100, 100)
        {
            m_Book = book;
            string color = "#d6c382";
            ...
            if (page == 1)
            {
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + "><CENTER>BARDIC SONGS</CENTER></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    148,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Assign Instrument</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                if (HasSpell(from, 351))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Army's Paeon</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 352))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Enchanting Etude</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 353))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Energy Carol</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 354))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Energy Threnody</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 355))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Fire Carol</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 356))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Fire Threnody</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 357))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Foe Requiem</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 358))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Ice Carol</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 359))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Ice Threnody</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 360))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Knight's Minne</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 361))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Mage's Ballad</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 362))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Magic Finale</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 363))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Poison Carol</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 364))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Poison Threnody</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 365))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Shepherd's Dance</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
                ...
                if (HasSpell(from, 366))
                {
                    ...
                    AddHtml(
                        ...
                        148,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Sinewy Etude</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    c++;
            ...
            else
            {
                ...
                AddHtml(
                    ...
                    177,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + s12 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    56,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + s14 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    56,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + s15 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    189,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">[" + s16 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    247,
                    143,
                    @"<BODY><BASEFONT Color=" + color + ">" + s13 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    189,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Keyboard Command:</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    177,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + s22 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    56,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + s24 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    56,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + s25 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    189,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">[" + s26 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    247,
                    143,
                    @"<BODY><BASEFONT Color=" + color + ">" + s23 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            else if (info.ButtonID < 300 && info.ButtonID > 0)
            {
                ...
                && !(from.InRange(m_Book.Instrument.GetWorldLocation(), 1))
            )
            {
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(SongBook book)
