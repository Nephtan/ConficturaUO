...
namespace Server.Spells.Mystic
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Psionic Blast", "Lum Om Summ Cah", 269, 0);
        ...
        public PsionicBlast(Mobile caster, Item scroll)
        ...
        private void AosDelay_Callback(object state)
        {
            ...
            if (caster.HarmfulCheck(defender))
            {
                SpellHelper.Damage(
                    this,
                    target,
                    Utility.RandomMinMax(damage, damage + 4),
                    0,
                    0,
                    0,
                    0,
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(PsionicBlast owner)
