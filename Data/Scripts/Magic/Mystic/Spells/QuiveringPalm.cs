...
namespace Server.Spells.Mystic
{
    public class QuiveringPalm : MysticSpell
    {
        ...
        public QuiveringPalm(Mobile caster, Item scroll)
        ...
        public override void OnCast()
        {
            ...
            if (weapon == null || weapon is Fists)
            {
                ...
                !(
                    weapon is Artifact_GlovesOfThePugilist
                    || weapon is GlovesOfThePugilist
            ...
            else if (CheckSequence())
            {
                IEntity from = new Entity(
                    Serial.Zero,
                    new Point3D(Caster.X, Caster.Y, Caster.Z),
                    Caster.Map
                );
                IEntity to = new Entity(
                    Serial.Zero,
                    new Point3D(Caster.X, Caster.Y, Caster.Z + 50),
                    Caster.Map
                );
