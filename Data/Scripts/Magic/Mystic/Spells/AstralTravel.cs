...
namespace Server.Spells.Mystic
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Astral Travel", "Ahm Mu Ra Beh", 269, 0);
        ...
        public override int MysticSpellCircle
        {
            get { return 4; }
        }
        ...
        public AstralTravel(Mobile caster, Item scroll)
            : this(caster, scroll, null, null) { }

        public AstralTravel(Mobile caster, Item scroll, RunebookEntry entry, Runebook book)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(AstralTravel owner)
