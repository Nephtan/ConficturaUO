...
namespace Server.Items
{
    public class MysticSpellbook : Spellbook
    {
        ...
        {
            get { return SpellbookType.Mystic; }
        }
            ...
            : base(content, 0x1A97)
        {
            ...
            if (owner == null)
            {
                ...
                foreach (int tram in trammel)
                {
                    ...
                    if (t == 1)
                    {
                        SetPrayer(this, tram, 3);
                    }
                    else if (t == 2)
                    {
                        SetPrayer(this, tram, 4);
                    }
                    else if (t == 3)
                    {
                        SetPrayer(this, tram, 5);
                    }
                    else if (t == 4)
                    {
                        SetPrayer(this, tram, 8);
                    }
                }
                ...
                foreach (int fel in felucca)
                {
                    ...
                    if (f == 1)
                    {
                        SetPrayer(this, fel, 2);
                    }
                    else if (f == 2)
                    {
                        SetPrayer(this, fel, 6);
                    }
                    else if (f == 3)
                    {
                        SetPrayer(this, fel, 7);
                    }
                    else if (f == 4)
                    {
                        SetPrayer(this, fel, 9);
                    }
                }
                ...
                foreach (int oth in other)
                {
                    ...
                    if (o == 1)
                    {
                        SetPrayer(this, oth, 1);
                    }
                    else if (o == 2)
                    {
                        SetPrayer(this, oth, 10);
                    }
                }
                ...
                {
                    case 0:
                        PackShrine = "Shrine of Intelligence";
                        break;
                    case 1:
                        PackShrine = "Shrine of Strength";
                        break;
                    case 2:
                        PackShrine = "Shrine of Wisdom";
                        break;
                    case 3:
                        PackShrine = "Shrine of Dexterity";
                        break;
                }
            }
        }
        ...
        {
            if (
                from.Region.Name == book.PackShrine
                && from.Skills[SkillName.FistFighting].Value >= 100
                && Server.Misc.GetPlayerInfo.isMonk(from)
            )
            {
                Item gem = null;
                ...
                if (gem != null)
                {
                    ...
                    string pray_chant =
                        pray_chant_1 + " " + pray_chant_2 + " " + pray_chant_3 + " " + pray_chant_4;
        ...
        public static bool KiTest(MysticSpellbook book, Mobile from)
        {
            ...
            if (
                !book.HasSpell(250)
                && from.Map == book.WritMap01
                && from.X >= book.WritX101
                && from.Y >= book.WritY101
                && from.X <= book.WritX201
                && from.Y <= book.WritY201
            )
            {
                if (scroll != null)
                {
                ...
                !book.HasSpell(251)
                && from.Map == book.WritMap02
                && from.X >= book.WritX102
                && from.Y >= book.WritY102
                && from.X <= book.WritX202
                && from.Y <= book.WritY202
            )
            {
                if (scroll != null)
                {
                ...
                !book.HasSpell(252)
                && from.Map == book.WritMap03
                && from.X >= book.WritX103
                && from.Y >= book.WritY103
                && from.X <= book.WritX203
                && from.Y <= book.WritY203
            )
            {
                if (scroll != null)
                {
                ...
                !book.HasSpell(253)
                && from.Map == book.WritMap04
                && from.X >= book.WritX104
                && from.Y >= book.WritY104
                && from.X <= book.WritX204
                && from.Y <= book.WritY204
            )
            {
                if (scroll != null)
                {
                ...
                !book.HasSpell(254)
                && from.Map == book.WritMap05
                && from.X >= book.WritX105
                && from.Y >= book.WritY105
                && from.X <= book.WritX205
                && from.Y <= book.WritY205
            )
            {
                if (scroll != null)
                {
                ...
                !book.HasSpell(255)
                && from.Map == book.WritMap06
                && from.X >= book.WritX106
                && from.Y >= book.WritY106
                && from.X <= book.WritX206
                && from.Y <= book.WritY206
            )
            {
                if (scroll != null)
                {
                ...
                !book.HasSpell(256)
                && from.Map == book.WritMap07
                && from.X >= book.WritX107
                && from.Y >= book.WritY107
                && from.X <= book.WritX207
                && from.Y <= book.WritY207
            )
            {
                if (scroll != null)
                {
                ...
                !book.HasSpell(257)
                && from.Map == book.WritMap08
                && from.X >= book.WritX108
                && from.Y >= book.WritY108
                && from.X <= book.WritX208
                && from.Y <= book.WritY208
            )
            {
                if (scroll != null)
                {
                ...
                !book.HasSpell(258)
                && from.Map == book.WritMap09
                && from.X >= book.WritX109
                && from.Y >= book.WritY109
                && from.X <= book.WritX209
                && from.Y <= book.WritY209
            )
            {
                if (scroll != null)
                {
                ...
                !book.HasSpell(259)
                && from.Map == book.WritMap10
                && from.X >= book.WritX110
                && from.Y >= book.WritY110
                && from.X <= book.WritX210
                && from.Y <= book.WritY210
            )
            {
                if (scroll != null)
                {
        ...
        public static void SetPrayer(MysticSpellbook book, int pray, int page)
        {
            ...
            string pray_world = Server.Misc.Worlds.GetMyWorld(
                pray_map,
                pray_location,
                pray_x1,
                pray_y1
        ...
        public string Pack_Shrine
        {
            get { return PackShrine; }
            set
            {
                PackShrine = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritPlace_01
        {
            get { return WritPlace01; }
            set
            {
                WritPlace01 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritWorld_01
        {
            get { return WritWorld01; }
            set
            {
                WritWorld01 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritCoord_01
        {
            get { return WritCoord01; }
            set
            {
                WritCoord01 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritChant_01
        {
            get { return WritChant01; }
            set
            {
                WritChant01 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Map WritMap_01
        {
            get { return WritMap01; }
            set
            {
                WritMap01 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritPlace_02
        {
            get { return WritPlace02; }
            set
            {
                WritPlace02 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritWorld_02
        {
            get { return WritWorld02; }
            set
            {
                WritWorld02 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritCoord_02
        {
            get { return WritCoord02; }
            set
            {
                WritCoord02 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritChant_02
        {
            get { return WritChant02; }
            set
            {
                WritChant02 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Map WritMap_02
        {
            get { return WritMap02; }
            set
            {
                WritMap02 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritPlace_03
        {
            get { return WritPlace03; }
            set
            {
                WritPlace03 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritWorld_03
        {
            get { return WritWorld03; }
            set
            {
                WritWorld03 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritCoord_03
        {
            get { return WritCoord03; }
            set
            {
                WritCoord03 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritChant_03
        {
            get { return WritChant03; }
            set
            {
                WritChant03 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Map WritMap_03
        {
            get { return WritMap03; }
            set
            {
                WritMap03 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritPlace_04
        {
            get { return WritPlace04; }
            set
            {
                WritPlace04 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritWorld_04
        {
            get { return WritWorld04; }
            set
            {
                WritWorld04 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritCoord_04
        {
            get { return WritCoord04; }
            set
            {
                WritCoord04 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritChant_04
        {
            get { return WritChant04; }
            set
            {
                WritChant04 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Map WritMap_04
        {
            get { return WritMap04; }
            set
            {
                WritMap04 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritPlace_05
        {
            get { return WritPlace05; }
            set
            {
                WritPlace05 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritWorld_05
        {
            get { return WritWorld05; }
            set
            {
                WritWorld05 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritCoord_05
        {
            get { return WritCoord05; }
            set
            {
                WritCoord05 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritChant_05
        {
            get { return WritChant05; }
            set
            {
                WritChant05 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Map WritMap_05
        {
            get { return WritMap05; }
            set
            {
                WritMap05 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritPlace_06
        {
            get { return WritPlace06; }
            set
            {
                WritPlace06 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritWorld_06
        {
            get { return WritWorld06; }
            set
            {
                WritWorld06 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritCoord_06
        {
            get { return WritCoord06; }
            set
            {
                WritCoord06 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritChant_06
        {
            get { return WritChant06; }
            set
            {
                WritChant06 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Map WritMap_06
        {
            get { return WritMap06; }
            set
            {
                WritMap06 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritPlace_07
        {
            get { return WritPlace07; }
            set
            {
                WritPlace07 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritWorld_07
        {
            get { return WritWorld07; }
            set
            {
                WritWorld07 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritCoord_07
        {
            get { return WritCoord07; }
            set
            {
                WritCoord07 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritChant_07
        {
            get { return WritChant07; }
            set
            {
                WritChant07 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Map WritMap_07
        {
            get { return WritMap07; }
            set
            {
                WritMap07 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritPlace_08
        {
            get { return WritPlace08; }
            set
            {
                WritPlace08 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritWorld_08
        {
            get { return WritWorld08; }
            set
            {
                WritWorld08 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritCoord_08
        {
            get { return WritCoord08; }
            set
            {
                WritCoord08 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritChant_08
        {
            get { return WritChant08; }
            set
            {
                WritChant08 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Map WritMap_08
        {
            get { return WritMap08; }
            set
            {
                WritMap08 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritPlace_09
        {
            get { return WritPlace09; }
            set
            {
                WritPlace09 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritWorld_09
        {
            get { return WritWorld09; }
            set
            {
                WritWorld09 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritCoord_09
        {
            get { return WritCoord09; }
            set
            {
                WritCoord09 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritChant_09
        {
            get { return WritChant09; }
            set
            {
                WritChant09 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Map WritMap_09
        {
            get { return WritMap09; }
            set
            {
                WritMap09 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritPlace_10
        {
            get { return WritPlace10; }
            set
            {
                WritPlace10 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritWorld_10
        {
            get { return WritWorld10; }
            set
            {
                WritWorld10 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritCoord_10
        {
            get { return WritCoord10; }
            set
            {
                WritCoord10 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string WritChant_10
        {
            get { return WritChant10; }
            set
            {
                WritChant10 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public Map WritMap_10
        {
            get { return WritMap10; }
            set
            {
                WritMap10 = value;
                InvalidateProperties();
