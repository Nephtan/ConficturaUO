...
namespace Server.Gumps
{
    public class MysticSpellbookGump : Gump
    {
            ...
            : base(100, 100)
        {
            ...
            string abil_text = "";
            string abil_info =
                "<br><br>To learn the secrets of this ability, you need to find the following location and open this book there to reach into your ki for enlightenment:<br><br>";
            string abil_skil = "";
            string abil_mana = "";
            string abil_tith = "";
            ...
            if (page == 2)
            {
                ...
                abil_text =
                    "Enter the astral plane where your soul is immune to harm. While you are in this state, you can freely travel but your interraction with the world is minimal. The better your skill, the longer it lasts. Monks use this ability to safely travel through dangerous areas.";
            }
            else if (page == 3)
            {
                abil_name = "Astral Travel";
                abil_icon = 0x410;
                abil_skil = "50";
                abil_mana = "40";
                abil_tith = "35";
            ...
            else if (page == 5)
            {
                ...
                abil_text =
                    "Perform a soothing touch, healing damage sustained. The higher your skill, the more damage you will heal with your touch.";
            }
            else if (page == 6)
            {
                abil_name = "Leap";
                ...
                abil_text =
                    "Allows you to leap over a long distance. This is a quick action and can allow a monk to leap toward an opponent, leap away to safety, or leap over some obstacles like rivers and streams.";
            }
            else if (page == 7)
            {
                abil_name = "Psionic Blast";
                abil_icon = 0x5DC2;
                abil_skil = "30";
                abil_mana = "35";
                abil_tith = "15";
                ...
                abil_text =
                    "Summon your Ki to perform a mental attack that deals an amount of energy damage based upon your fist fighting and intelligence values. Elemental Resistances may reduce damage done by this attack.";
            }
            else if (page == 8)
            {
                abil_name = "Psychic Wall";
                abil_icon = 0x1A;
                abil_skil = "60";
                abil_mana = "45";
                abil_tith = "500";
                ...
                abil_text =
                    "You sheer force of will creates a barrier around you, deflecting magical attacks. This does not work against odd magics like necromancy. Affected spells will often bounce back onto the caster.";
            }
            else if (page == 9)
            {
                abil_name = "Purity of Body";
                abil_icon = 0x96D;
                abil_skil = "40";
                abil_mana = "35";
                abil_tith = "25";
                ...
                abil_text =
                    "You can cleanse your body of poisons with this ability due to your physical discipline, and as such, it cannot be used to aid anyone else.";
            }
            else if (page == 10)
            {
                abil_name = "Quivering Palm";
                abil_icon = 0x5001;
                abil_skil = "20";
                abil_mana = "20";
                abil_tith = "20";
            ...
            else if (page == 11)
            {
                ...
                abil_text =
                    "This ability allows the monk to run as fast as a steed. This ability should be avoided if you already have a mount you are riding, or perhaps you have magical boots that allow you to run at this speed. using this ability in such conditions may cause unusual travel speeds, so be leery.";
                if (Server.Misc.MyServerSettings.NoMountsInCertainRegions())
                {
                    abil_text =
                        abil_text
                        + " Be aware when exploring the land, that there are some areas you cannot use this ability in. These are areas such as dungeons, caves, and some indoor areas. If you enter such an area, this ability will be hindered.";
                }
            }

            abil_info +=
                "<br>Make sure you bring a blank scroll with you, so you can write what you have learned. You can then place your writings within this book.<br>";
            ...
            if (page == 1)
            {
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + "><CENTER>MONK ABILITIES</CENTER></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                while (SpellsInBook > 0)
                {
                    ...
                    if (this.HasSpell(from, SpellsListed))
                    {
                        ...
                        else if (SpellsListed == 251)
                        {
                            SpellName = "Astral Travel";
                            iBUTTON = 0x410;
                        }
                        else if (SpellsListed == 252)
                        {
                            SpellName = "Create Robe";
                            iBUTTON = 0x15;
                        }
                        else if (SpellsListed == 253)
                        {
                            SpellName = "Gentle Touch";
                            iBUTTON = 0x971;
                        }
                        else if (SpellsListed == 254)
                        {
                            SpellName = "Leap";
                            iBUTTON = 0x4B2;
                        }
                        else if (SpellsListed == 255)
                        {
                            SpellName = "Psionic Blast";
                            iBUTTON = 0x5DC2;
                        }
                        else if (SpellsListed == 256)
                        {
                            SpellName = "Psychic Wall";
                            iBUTTON = 0x1A;
                        }
                        else if (SpellsListed == 257)
                        {
                            SpellName = "Purity of Body";
                            iBUTTON = 0x96D;
                        }
                        else if (SpellsListed == 258)
                        {
                            SpellName = "Quivering Palm";
                            iBUTTON = 0x5001;
                        }
                        else if (SpellsListed == 259)
                        {
                            SpellName = "Wind Runner";
                            iBUTTON = 0x19;
                        }
            ...
            else if (page > 1 && page < 12)
            {
                ...
                string ismonk =
                    "<BODY><BASEFONT Color=#f58a8a>You are not a Monk!</BASEFONT></BODY>";
                if (Server.Misc.GetPlayerInfo.isMonk(from))
                {
                    ismonk =
                        "<BODY><BASEFONT Color=#8af599>You are on the path...</BASEFONT></BODY>";
                }
                ...
                AddHtml(
                    ...
                    200,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + abil_name + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                if (this.HasSpell(from, abil_spid))
                {
                    abil_info = "";
                    showScrollBar = false;
                    AddButton(78, 94, abil_icon, abil_icon, abil_spid, GumpButtonType.Reply, 0);
                }
                ...
                AddHtml(
                    ...
                    88,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + abil_skil + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    88,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + abil_mana + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    88,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + abil_tith + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            ...
            else if (page == 12)
            {
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + "><CENTER>MONK RUCKSACK</CENTER></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
