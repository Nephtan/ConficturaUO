    ...
    public class CastMonkSpells
    {
        public static void Initialize()
        {
            ...
            Register(
                "AstralProjection",
                AccessLevel.Player,
                new CommandEventHandler(AstralProjection_OnCommand)
            );

            Register(
                "AstralTravel",
                AccessLevel.Player,
                new CommandEventHandler(AstralTravel_OnCommand)
            );

            Register(
                "CreateRobe",
                AccessLevel.Player,
                new CommandEventHandler(CreateRobe_OnCommand)
            );

            Register(
                "GentleTouch",
                AccessLevel.Player,
                new CommandEventHandler(GentleTouch_OnCommand)
            );
            ...
            Register(
                "PsionicBlast",
                AccessLevel.Player,
                new CommandEventHandler(PsionicBlast_OnCommand)
            );

            Register(
                "PsychicWall",
                AccessLevel.Player,
                new CommandEventHandler(PsychicWall_OnCommand)
            );

            Register(
                "PurityOfBody",
                AccessLevel.Player,
                new CommandEventHandler(PurityOfBody_OnCommand)
            );

            Register(
                "QuiveringPalm",
                AccessLevel.Player,
                new CommandEventHandler(QuiveringPalm_OnCommand)
            );

            Register(
                "WindRunner",
                AccessLevel.Player,
                new CommandEventHandler(WindRunner_OnCommand)
            );
        }
