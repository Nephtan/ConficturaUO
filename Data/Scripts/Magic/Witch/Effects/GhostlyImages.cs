...
namespace Server.Spells.Undead
{
    public class GhostlyImagesSpell : UndeadSpell
    {
        ...
        public GhostlyImagesSpell(Mobile caster, Item scroll)
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                Effects.SendLocationParticles(
                    EffectItem.Create(from, Caster.Map, EffectItem.DefaultDuration),
                    0x3728,
                    10,
                    10,
                    5023
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(GhostlyImagesSpell owner)
...
namespace Server.Mobiles
{
    public class dj_nc_decoy : BaseCreature
    {
        ...
        public dj_nc_decoy(Mobile caster)
        ...
        public dj_nc_decoy(Serial serial)
            : base(serial) { }
