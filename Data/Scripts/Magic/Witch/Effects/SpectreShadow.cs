...
namespace Server.Spells.Undead
{
    public class SpectreShadowSpell : UndeadSpell
    {
        ...
        public SpectreShadowSpell(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            if (!Caster.CanSee(m))
            {
                ...
                m is Mobiles.BaseVendor
                || m is Mobiles.PlayerVendor
                || m is Mobiles.PlayerBarkeeper
                || m.AccessLevel > Caster.AccessLevel
            )
            {
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(SpectreShadowSpell owner)
