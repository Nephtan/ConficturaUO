...
namespace Server.Spells.Undead
{
    public class HellsGateSpell : UndeadSpell
    {
        ...
        public HellsGateSpell(Mobile caster, Item scroll)
            : this(caster, scroll, null, null) { }

        public HellsGateSpell(Mobile caster, Item scroll, RunebookEntry entry, Runebook book)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(HellsGateSpell owner)
