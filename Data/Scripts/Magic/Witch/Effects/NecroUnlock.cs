...
namespace Server.Spells.Undead
{
    public class NecroUnlockSpell : UndeadSpell
    {
        ...
        public NecroUnlockSpell(Mobile caster, Item scroll)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(NecroUnlockSpell owner)
            ...
            protected override void OnTarget(Mobile from, object o)
            {
                ...
                if (m_Owner.CheckSequence())
                {
                    ...
                    else
                    {
                        ...
                        {
                            int level =
                                (int)(from.Skills[SkillName.Necromancy].Value)
                                + Server.Items.BasePotion.EnhancePotions(from);
                            ...
                            if (level >= cont.RequiredSkill && !(cont is TreasureMapChest))
                            {
                                ...
                                from.PrivateOverheadMessage(
                                    ...
                                    0x3B2,
                                    false,
                                    "This does not seem to work on that lock.",
                                    from.NetState
                                );
                        }
                    }
