...
namespace Server.Spells.Undead
{
    public class NecroPoisonSpell : UndeadSpell
    {
        ...
        public NecroPoisonSpell(Mobile caster, Item scroll)
            ...
            else if (CheckHSequence(m))
            {
                ...
                else
                {
                    ...
                    if (Caster.InRange(m, 2) && Caster.Map == m.Map)
                    {
                        int total =
                            (
                                Caster.Skills.Necromancy.Fixed
                                + Caster.Skills.Poisoning.Fixed
        ...
        public virtual double GetResistPercentForCircle(Mobile target)
        {
            ...
            double secondPercent =
                ...
                - (((Caster.Skills[DamageSkill].Value - 20.0) / 5.0) + (1 + 8) * 5.0);
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(NecroPoisonSpell owner)
