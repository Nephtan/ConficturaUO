...
namespace Server.Spells.Undead
{
    public class UndeadWallOfSpikesSpell : UndeadSpell
    {
        ...
        public UndeadWallOfSpikesSpell(Mobile caster, Item scroll)
                ...
                : base(0x2201)
            {
                ...
                m_Timer = new InternalTimer(
                    ...
                    TimeSpan.FromSeconds(
                        ((double)(BasePotion.EnhancePotions(caster)))
                            + 10.0
                            + ((int)(caster.Skills[SkillName.Forensics].Value / 2))
                    )
                );
                m_Timer.Start();
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(UndeadWallOfSpikesSpell owner)
