...
namespace Server.Spells.Undead
{
    public class UndeadGraveyardGatewaySpell : UndeadSpell
    {
        ...
        public UndeadGraveyardGatewaySpell(Mobile caster, Item scroll)
        ...
        public void Effect(Point3D loc, Map map, bool checkMulti)
        {
            ...
            else if ((checkMulti && SpellHelper.CheckMulti(loc, map)))
            {
                ...
                Core.SE && (GateExistsAt(map, loc) || GateExistsAt(Caster.Map, Caster.Location))
            ...
            else if (CheckSequence())
            {
                ...
                InternalItem firstGate = new InternalItem(
                    loc,
                    map,
                ...
                )
                {
                    ...
                    InternalItem secondGate = new InternalItem(
                        Caster.Location,
                        Caster.Map,
                        Server.Items.BasePotion.EnhancePotions(Caster)
                    );
        ...
        {
            public override bool ShowLodorWarning
            {
                get { return false; }
            }

            public InternalItem(Point3D target, Map map, int enhance)
                : base(target, map)
            {
                Map = map;
                ItemID = 0x1FD4;
            ...
            private class InternalTimer : Timer
            {
                ...
                public InternalTimer(Item item, int enhance)
                    : base(TimeSpan.FromSeconds(30.0 + ((double)(enhance))))
                {
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(UndeadGraveyardGatewaySpell owner)
