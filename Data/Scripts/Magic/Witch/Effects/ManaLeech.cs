...
namespace Server.Spells.Undead
{
    public class ManaLeechSpell : UndeadSpell
    {
        ...
        public ManaLeechSpell(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckHSequence(m))
            {
                ...
                toDrain =
                    (int)(GetDamageSkill(Caster) - GetResistSkill(m))
        ...
        public virtual double GetResistPercentForCircle(Mobile target)
        {
            ...
            double secondPercent =
                ...
                - (((Caster.Skills[DamageSkill].Value - 20.0) / 5.0) + (1 + 7) * 5.0);
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(ManaLeechSpell owner)
