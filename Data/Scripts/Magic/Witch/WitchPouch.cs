...
namespace Server.Items
{
    public class WitchPouch : Bag
    {
        ...
        public class WitchBag : Gump
        {
            ...
            public WitchBag(Mobile from, WitchPouch bag)
                : base(50, 50)
            {
                string color = "#d89191";
                m_Pouch = bag;
                ...
                AddHtml(
                    ...
                    300,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">WITCH'S BELT POUCH</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Eyes of the Dead</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Tomb Raiding</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Disease</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Phantasm</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Retched Air</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Lich Leech</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Wall of Spikes</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Disease Curing</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Blood Pact</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Spectre Shadow</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Ghost Phase</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Demonic Fire</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Ghostly Images</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Hellish Branding</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Black Gate</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    144,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Vampire Blood</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
        ...
        public class WitchBar : Gump
        {
            ...
            public WitchBar(Mobile from, WitchPouch bag, bool vertical)
                : base(25, 25)
            {
                this.Closable = false;
                this.Disposable = true;
                ...
                if (vertical)
                {
                    ...
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CC4, 0x2CC4, 1, GumpButtonType.Reply, 0);
                    }
                    if (bag.NecroUnlock > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CCC, 0x2CCC, 2, GumpButtonType.Reply, 0);
                    }
                    if (bag.NecroPoison > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CC2, 0x2CC2, 3, GumpButtonType.Reply, 0);
                    }
                    if (bag.Phantasm > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CC9, 0x2CC9, 4, GumpButtonType.Reply, 0);
                    }
                    if (bag.RetchedAir > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CCA, 0x2CCA, 5, GumpButtonType.Reply, 0);
                    }
                    if (bag.ManaLeech > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CC8, 0x2CC8, 6, GumpButtonType.Reply, 0);
                    }
                    if (bag.WallOfSpikes > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CCE, 0x2CCE, 7, GumpButtonType.Reply, 0);
                    }
                    if (bag.NecroCurePoison > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CC3, 0x2CC3, 8, GumpButtonType.Reply, 0);
                    }
                    if (bag.BloodPact > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CC0, 0x2CC0, 9, GumpButtonType.Reply, 0);
                    }
                    if (bag.SpectreShadow > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CCB, 0x2CCB, 10, GumpButtonType.Reply, 0);
                    }
                    if (bag.GhostPhase > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CC5, 0x2CC5, 11, GumpButtonType.Reply, 0);
                    }
                    if (bag.HellsGate > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CC1, 0x2CC1, 12, GumpButtonType.Reply, 0);
                    }
                    if (bag.GhostlyImages > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CC6, 0x2CC6, 13, GumpButtonType.Reply, 0);
                    }
                    if (bag.HellsBrand > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CC7, 0x2CC7, 14, GumpButtonType.Reply, 0);
                    }
                    if (bag.GraveyardGateway > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CBF, 0x2CBF, 15, GumpButtonType.Reply, 0);
                    }
                    if (bag.VampireGift > 0)
                    {
                        val = val + 50;
                        AddButton(15, val, 0x2CCD, 0x2CCD, 16, GumpButtonType.Reply, 0);
                    }
                    ...
                    if (bag.Titles > 0)
                    {
                        ...
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Eyes of the Dead");
                        }
                        if (bag.NecroUnlock > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Tomb Raiding");
                        }
                        if (bag.NecroPoison > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Disease");
                        }
                        if (bag.Phantasm > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Phantasm");
                        }
                        if (bag.RetchedAir > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Retched Air");
                        }
                        if (bag.ManaLeech > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Lich Leech");
                        }
                        if (bag.WallOfSpikes > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Wall of Spikes");
                        }
                        if (bag.NecroCurePoison > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Disease Curing");
                        }
                        if (bag.BloodPact > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Blood Pact");
                        }
                        if (bag.SpectreShadow > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Spectre Shadow");
                        }
                        if (bag.GhostPhase > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Ghost Phase");
                        }
                        if (bag.HellsGate > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Demonic Fire");
                        }
                        if (bag.GhostlyImages > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Ghostly Images");
                        }
                        if (bag.HellsBrand > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Hellish Brand");
                        }
                        if (bag.GraveyardGateway > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Black Gate");
                        }
                        if (bag.VampireGift > 0)
                        {
                            txt = txt + 50;
                            AddLabel(70, txt, 2433, @"Vampire Blood");
                        }
                    }
                }
                else
                {
                    ...
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CC4, 0x2CC4, 1, GumpButtonType.Reply, 0);
                    }
                    if (bag.NecroUnlock > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CCC, 0x2CCC, 2, GumpButtonType.Reply, 0);
                    }
                    if (bag.NecroPoison > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CC2, 0x2CC2, 3, GumpButtonType.Reply, 0);
                    }
                    if (bag.Phantasm > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CC9, 0x2CC9, 4, GumpButtonType.Reply, 0);
                    }
                    if (bag.RetchedAir > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CCA, 0x2CCA, 5, GumpButtonType.Reply, 0);
                    }
                    if (bag.ManaLeech > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CC8, 0x2CC8, 6, GumpButtonType.Reply, 0);
                    }
                    if (bag.WallOfSpikes > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CCE, 0x2CCE, 7, GumpButtonType.Reply, 0);
                    }
                    if (bag.NecroCurePoison > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CC3, 0x2CC3, 8, GumpButtonType.Reply, 0);
                    }
                    if (bag.BloodPact > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CC0, 0x2CC0, 9, GumpButtonType.Reply, 0);
                    }
                    if (bag.SpectreShadow > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CCB, 0x2CCB, 10, GumpButtonType.Reply, 0);
                    }
                    if (bag.GhostPhase > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CC5, 0x2CC5, 11, GumpButtonType.Reply, 0);
                    }
                    if (bag.HellsGate > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CC1, 0x2CC1, 12, GumpButtonType.Reply, 0);
                    }
                    if (bag.GhostlyImages > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CC6, 0x2CC6, 13, GumpButtonType.Reply, 0);
                    }
                    if (bag.HellsBrand > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CC7, 0x2CC7, 14, GumpButtonType.Reply, 0);
                    }
                    if (bag.GraveyardGateway > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CBF, 0x2CBF, 15, GumpButtonType.Reply, 0);
                    }
                    if (bag.VampireGift > 0)
                    {
                        val = val + 50;
                        AddButton(val, 0, 0x2CCD, 0x2CCD, 16, GumpButtonType.Reply, 0);
                    }
                }
            }
        ...
        public static void castSpell(int potion, Mobile from)
        {
            ...
            {
                (from.Backpack.FindItemByType(typeof(UndeadEyesScroll))).OnDoubleClick(from);
                warn = false;
            }
            else if (potion == 2 && from.Backpack.FindItemByType(typeof(NecroUnlockScroll)) != null)
            {
                (from.Backpack.FindItemByType(typeof(NecroUnlockScroll))).OnDoubleClick(from);
                warn = false;
            }
            else if (potion == 3 && from.Backpack.FindItemByType(typeof(NecroPoisonScroll)) != null)
            {
                (from.Backpack.FindItemByType(typeof(NecroPoisonScroll))).OnDoubleClick(from);
                warn = false;
            }
            else if (potion == 4 && from.Backpack.FindItemByType(typeof(PhantasmScroll)) != null)
            {
                (from.Backpack.FindItemByType(typeof(PhantasmScroll))).OnDoubleClick(from);
                warn = false;
            }
            else if (potion == 5 && from.Backpack.FindItemByType(typeof(RetchedAirScroll)) != null)
            {
                (from.Backpack.FindItemByType(typeof(RetchedAirScroll))).OnDoubleClick(from);
                warn = false;
            }
            else if (potion == 6 && from.Backpack.FindItemByType(typeof(ManaLeechScroll)) != null)
            {
                (from.Backpack.FindItemByType(typeof(ManaLeechScroll))).OnDoubleClick(from);
                warn = false;
            }
            else if (
            ...
            {
                (from.Backpack.FindItemByType(typeof(BloodPactScroll))).OnDoubleClick(from);
                warn = false;
            }
            else if (
            ...
            {
                (from.Backpack.FindItemByType(typeof(GhostPhaseScroll))).OnDoubleClick(from);
                warn = false;
            }
            else if (potion == 12 && from.Backpack.FindItemByType(typeof(HellsGateScroll)) != null)
            {
                (from.Backpack.FindItemByType(typeof(HellsGateScroll))).OnDoubleClick(from);
                warn = false;
            }
            else if (
            ...
            {
                (from.Backpack.FindItemByType(typeof(HellsBrandScroll))).OnDoubleClick(from);
                warn = false;
            }
            else if (
        ...
        public WitchPouch(Serial serial)
            : base(serial) { }
        ...
        public class BagWindow : ContextMenuEntry
        {
            ...
            public BagWindow(Mobile from, WitchPouch bag)
                : base(6172, 1)
            {
                m_From = from;
                witchBag = bag;
        ...
        {
            get { return NecroCurePoison; }
            set
            {
                NecroCurePoison = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return GraveyardGateway; }
            set
            {
                GraveyardGateway = value;
                InvalidateProperties();
            }
        }
