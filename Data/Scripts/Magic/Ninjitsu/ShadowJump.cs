...
namespace Server.Spells.Ninjitsu
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Shadowjump", null, -1, 9002);
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (Server.Misc.WeightOverloading.IsOverloaded(Caster))
            {
                ...
                !SpellHelper.CheckTravel(Caster, TravelCheckType.TeleportFrom)
            ...
            else if (CheckSequence())
            {
                ...
                {
                    Server.SkillHandlers.Stealth.OnUse(m); // stealth check after the jump
                }
            }
