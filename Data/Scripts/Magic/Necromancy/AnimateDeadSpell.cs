        ...
        public void Target(object obj)
        {
            if (obj is Corpse)
            {
                ...
                if (m is BaseCreature)
                {
                    ...
                    int level_caster = (int)(
                        (
                            Caster.Skills[SkillName.Necromancy].Value
                            + Caster.Skills[SkillName.Spiritualism].Value
                        ) / 2
                    );
                    if (level_caster > 100)
                    {
                    ...
                    else if (slots_limit >= slots_max)
                    {
                        ...
                        BaseCreature creature = new SummonedCorpse(
                            (int)(mod * bc.HitsMax),
                            (int)(mod * bc.StamMax),
                            (int)(mod * bc.ManaMax),
                            (int)(mod * bc.RawStr),
                        ...
                        // ZOMBIES //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        creature.Hue = Utility.RandomList(
                            0xB97,
                            0xB98,
                            0xB99,
                            0xB9A,
                        ...
                        {
                            case 0:
                                creature.Name = "a zombie" + ghost;
                                break;
                            case 1:
                                creature.Name = "a dead" + ghost;
                                break;
                            case 2:
                                creature.Name = "a rotten" + ghost;
                                break;
                            case 3:
                                creature.Name = "an undead" + ghost;
                                break;
                            case 4:
                                creature.Name = "a rotting" + ghost;
                                break;
                            case 5:
                                creature.Name = "a decaying" + ghost;
                                break;
                        }
                        ...
                        if (mage)
                        {
                            ...
                            {
                                case 0:
                                    creature.Name = "a wraith" + ghost;
                                    break;
                                case 1:
                                    creature.Name = "a ghostly" + ghost;
                                    break;
                                case 2:
                                    creature.Name = "a spectral" + ghost;
                                    break;
                                case 3:
                                    creature.Name = "a haunting" + ghost;
                                    break;
                                case 4:
                                    creature.Name = "a phantasmal" + ghost;
                                    break;
                                case 5:
                                    creature.Name = "a phantom" + ghost;
                                    break;
                                case 6:
                                    creature.Name = "a banshee" + ghost;
                                    break;
                            }
                        }
                        ...
                        ) // MAKE INTO SKELETON
                        {
                            ...
                            {
                                case 0:
                                    creature.Name = "a skeletal" + ghost;
                                    break;
                                case 1:
                                    creature.Name = "a bone" + ghost;
                                    break;
                                case 2:
                                    creature.Name = "a skeleton" + ghost;
                                    break;
                            }
                        }
                        else if (
                        ...
                        if (mage)
                        {
                            creature.SetSkill(
                                ...
                                (mod * bc.Skills[SkillName.Meditation].Value)
                            );
                            creature.SetSkill(
                                SkillName.Psychology,
                                (mod * bc.Skills[SkillName.Psychology].Value)
                            );
                            creature.SetSkill(
                                SkillName.Magery,
                                (mod * bc.Skills[SkillName.Magery].Value)
                            );
                            creature.SetSkill(
                                SkillName.MagicResist,
                                (mod * bc.Skills[SkillName.MagicResist].Value)
                            );
                            creature.SetSkill(
                                SkillName.Tactics,
                                (mod * bc.Skills[SkillName.Tactics].Value)
                            );
                            creature.SetSkill(
                                SkillName.FistFighting,
                                (mod * bc.Skills[SkillName.FistFighting].Value)
                            );
                        }
                        else
                        {
