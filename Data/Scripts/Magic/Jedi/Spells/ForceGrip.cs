...
namespace Server.Spells.Jedi
{
    public class ForceGrip : JediSpell
    {
        ...
        public ForceGrip(Mobile caster, Item scroll)
        ...
        public void Target(Item item)
        {
            if (this.CheckSequence())
            {
                ...
                {
                    Caster.SendMessage(
                        "You can not move objects that are inside of other objects or being worn."
                    );
                }
                else
                {
                    ...
                    Caster.SendMessage(
                        "You move the object to within your grasp and place it in your backpack."
                    );
                    DrainCrystals(Caster, RequiredTithing);
                }
            }
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(ForceGrip owner)
