...
namespace Server.Spells.Jedi
{
    public class SoothingTouch : JediSpell
    {
        ...
        public SoothingTouch(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckBSequence(m))
            {
                ...
                int toHeal =
                    (int)(Caster.Skills[SkillName.Psychology].Value * 0.2)
                    + (int)(GetJediDamage(Caster) * 0.1);
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(SoothingTouch owner)
