...
namespace Server.Spells.Jedi
{
    public class PsychicAura : JediSpell
    {
        ...
        public PsychicAura(Mobile caster, Item scroll)
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                if (mods == null)
                {
                    ...
                    int phys = (int)(
                        (targ.Skills[SkillName.Inscribe].Value / 15) + (GetJediDamage(Caster) / 50)
                    );
                    int engy = (int)(
                        (targ.Skills[SkillName.Inscribe].Value / 25) + (GetJediDamage(Caster) / 75)
                    );
