    ...
    public class CastJediSpells
    {
        public static void Initialize()
        {
            ...
            Register(
                "ThrowSabre",
                AccessLevel.Player,
                new CommandEventHandler(ThrowSabre_OnCommand)
            );
            ...
            Register(
                "PsychicAura",
                AccessLevel.Player,
                new CommandEventHandler(PsychicAura_OnCommand)
            );

            Register(
                "Deflection",
                AccessLevel.Player,
                new CommandEventHandler(Deflection_OnCommand)
            );

            Register(
                "SoothingTouch",
                AccessLevel.Player,
                new CommandEventHandler(SoothingTouch_OnCommand)
            );

            Register(
                "StasisField",
                AccessLevel.Player,
                new CommandEventHandler(StasisField_OnCommand)
            );
        ...
        public static void ForceGrip_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new ForceGrip(e.Mobile, null).Cast();
            }
            else
            {
        ...
        public static void MindsEye_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new MindsEye(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void ThrowSabre_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new ThrowSabre(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void Celerity_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new Celerity(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void PsychicAura_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new PsychicAura(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void Deflection_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new Deflection(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void SoothingTouch_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new SoothingTouch(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void StasisField_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new StasisField(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
        ...
        public static void Clone_OnCommand(CommandEventArgs e)
        {
            ...
            {
                new Replicate(e.Mobile, null).Cast();
            }
            else
            {
                from.SendLocalizedMessage(500015);
