...
namespace Server.Items
{
    public class RuneBag : BaseContainer
    {
        ...
        public class RuneBagMenu : ContextMenuEntry
        {
            ...
            public RuneBagMenu(Mobile from, RuneBag bag)
                : base(6122, 1)
            {
                m_From = from;
                i_RuneBag = bag;
    ...
    public class FullRuneBag : Bag
    {
            ...
            : base()
        {
            ...
            PlaceItemIn(this, 70, 100, new RuneJournal());
        ...
        public FullRuneBag(Serial serial)
            : base(serial) { }
    ...
    public abstract class RuneStone : Item
    {
        ...
        public RuneStone(Serial serial)
            : base(serial) { }
    ...
    public class RuneMagicBook : BlueBook
    {
        ...
        public RuneMagicBook()
            : base("Rune Magic", "Garamon", 50, true) // writable so players can make notes
        {
    ...
    public class RuneBagBook : RuneMagicBook
    {
        ...
        public RuneBagBook(Serial serial)
            : base(serial) { }
