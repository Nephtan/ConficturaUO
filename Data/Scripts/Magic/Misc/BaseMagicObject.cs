...
namespace Server.Items
{
    ...
    public abstract class BaseMagicObject : BaseBashing
    {
        ...
        public BaseMagicObject(MagicObjectEffect effect, int minCharges, int maxCharges)
        ...
        public BaseMagicObject(Serial serial)
            : base(serial) { }
        ...
        public virtual void ApplyDelayTo(Mobile from)
        {
            ...
            Timer.DelayCall(
                GetUseDelay,
                new TimerStateCallback(ReleaseMagicObjectLock_Callback),
                from
            );
        }
