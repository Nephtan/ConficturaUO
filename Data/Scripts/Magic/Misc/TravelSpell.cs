...
namespace Server.Spells.Magical
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("", "", 239, 9031);
        ...
        public TravelSpell(Mobile caster, Item scroll)
            : this(caster, scroll, null, null) { }

        public TravelSpell(Mobile caster, Item scroll, RunebookEntry entry, Runebook book)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(TravelSpell owner)
