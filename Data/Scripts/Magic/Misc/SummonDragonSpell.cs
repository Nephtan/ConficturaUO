...
namespace Server.Spells.Magical
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("", "", 266, 9040, false);
        ...
        public SummonDragonSpell(Mobile caster, Item scroll)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(SummonDragonSpell owner)
...
namespace Server.Mobiles
{
    ...
    public class SummonDragon : BaseCreature
    {
        ...
        public SummonDragon(Serial serial)
            : base(serial) { }
