...
namespace Server.Spells.Chivalry
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Close Wounds", "Obsu Vulni", -1, 9002);
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckBSequence(m))
            {
                ...
                int toHeal = Server.Misc.MyServerSettings.PlayerLevelMod(
                    ComputePowerValue(6) + Utility.RandomMinMax(0, 2),
                    Caster
                );
