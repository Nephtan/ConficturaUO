...
namespace Server.Spells.Herbalist
{
    public class TreefellowSpell : HerbalistSpell
    {
        ...
        public TreefellowSpell(Mobile caster, Item scroll)
        ...
        public override bool CheckCast()
        {
            ...
            else if (Caster.Skills[CastSkill].Value < RequiredSkill)
            {
                Caster.PrivateOverheadMessage(
                    ...
                    0x14C,
                    false,
                    "You lack the understanding to use this fertilizer.",
                    Caster.NetState
                );
                return false;
            }
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(TreefellowSpell owner)
...
namespace Server.Mobiles
{
    ...
    public class SummonedTreefellow : BaseCreature
    {
        ...
        {
            return (m.Int + m.Skills[SkillName.Veterinary].Value)
                / Math.Max(GetDistanceToSqrt(m), 1.0);
        }
