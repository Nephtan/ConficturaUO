    ...
    public class MushroomGatewaySpell : HerbalistSpell
    {
        ...
        public override bool CheckCast()
        {
            if (Caster.Skills[CastSkill].Value < RequiredSkill)
            {
                Caster.PrivateOverheadMessage(
                    ...
                    0x14C,
                    false,
                    "You lack the understanding to grow magical mushrooms.",
                    Caster.NetState
                );
                return false;
            }
        ...
        public void Effect(Point3D loc, Map map, bool checkMulti)
        {
            if (!map.CanSpawnMobile(loc.X, loc.Y, loc.Z))
            {
                ...
                Worlds.AllowEscape(Caster, Caster.Map, Caster.Location, Caster.X, Caster.Y) == false
            )
            {
            ...
            else if (CheckSequence())
            {
                ...
                int mushy;
                int mushz;
                InternalItem firstGatea = new InternalItem(
                    loc,
                    map,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                );
                mushx = Caster.X;
                mushy = Caster.Y;
                mushz = Caster.Z;
                ...
                InternalItem firstGateb = new InternalItem(
                    loc,
                    map,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                );
                ...
                InternalItem firstGatec = new InternalItem(
                    loc,
                    map,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                );
                ...
                InternalItem firstGated = new InternalItem(
                    loc,
                    map,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                );
                ...
                InternalItem firstGatee = new InternalItem(
                    loc,
                    map,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                );
                ...
                InternalItem firstGatef = new InternalItem(
                    loc,
                    map,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                );
                ...
                InternalItem firstGateg = new InternalItem(
                    loc,
                    map,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                );
                ...
                if (
                    Worlds.RegionAllowedTeleport(Caster.Map, Caster.Location, Caster.X, Caster.Y)
                    == true
                )
                {
                    Effects.PlaySound(loc, map, 0x1);
                    InternalItem secondGatea = new InternalItem(
                        Caster.Location,
                        Caster.Map,
                        (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                    );
                    ...
                    InternalItem secondGateb = new InternalItem(
                        Caster.Location,
                        Caster.Map,
                        (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                    );
                    ...
                    InternalItem secondGatec = new InternalItem(
                        Caster.Location,
                        Caster.Map,
                        (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                    );
                    ...
                    InternalItem secondGated = new InternalItem(
                        Caster.Location,
                        Caster.Map,
                        (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                    );
                    ...
                    InternalItem secondGatee = new InternalItem(
                        Caster.Location,
                        Caster.Map,
                        (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                    );
                    ...
                    InternalItem secondGatef = new InternalItem(
                        Caster.Location,
                        Caster.Map,
                        (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                    );
                    ...
                    InternalItem secondGateg = new InternalItem(
                        Caster.Location,
                        Caster.Map,
                        (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                    );
        ...
        {
            public InternalItem(Point3D target, Map map, double enhance)
                : base(target, map)
            {
                Map = map;
                Dispellable = true;
            ...
            private class InternalTimer : Timer
            {
                ...
                public InternalTimer(Item item, double enhance)
                    : base(TimeSpan.FromSeconds((enhance + 30.0)))
                {
                    m_Item = item;
                }
