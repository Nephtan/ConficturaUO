...
namespace Server.Spells.Herbalist
{
    public class LureStoneSpell : HerbalistSpell
    {
        ...
        private class InternalItema : Item
        {
            ...
            public InternalItema(Point3D loc, Map map, Mobile caster, double enhance)
                : base(0x1355)
            {
                m_Owner = caster;
                Visible = false;
        ...
        private class InternalItemb : Item
        {
            ...
            public InternalItemb(Point3D loc, Map map, Mobile caster, double enhance)
                : base(0x1356)
            {
                Visible = false;
                Movable = false;
