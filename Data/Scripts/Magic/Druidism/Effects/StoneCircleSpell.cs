    ...
    public class StoneCircleSpell : HerbalistSpell
    {
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                int mushy;
                int mushz;
                InternalItem firstFlamea = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                ...
                InternalItem firstFlamec = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem firstFlamed = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem hiddenflame = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem hiddenrock = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem hiddenflamea = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem hiddenrocks = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem hiddenrocka = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem hiddenrockb = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem hiddenrockc = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem hiddenrockd = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem firstFlamee = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem firstFlamef = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem firstFlameg = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem firstFlameh = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
                ...
                InternalItem firstFlamei = new InternalItem(
                    Caster.Location,
                    Caster.Map,
                    Caster,
                    (double)(Server.Items.BasePotion.EnhancePotions(Caster))
        ...
        private class InternalItem : Item
        {
            ...
            public InternalItem(Point3D loc, Map map, Mobile caster, double enhance)
                : base(0x08E2)
            {
                Visible = false;
                Movable = false;
