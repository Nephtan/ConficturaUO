...
namespace Server.Spells.Herbalist
{
    public abstract class HerbalistSpell : Spell
    {
        ...
        {
            get { return SkillName.Veterinary; }
        }
        ...
        public override bool CheckCast()
        {
            ...
            if (Caster.Skills[CastSkill].Value < RequiredSkill)
            {
                Caster.PrivateOverheadMessage(
                    ...
                    0x14C,
                    false,
                    "You lack the understanding to use this.",
                    Caster.NetState
                );
                return false;
            }
        ...
        public HerbalistSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public virtual double GetResistPercentForCircle(Mobile target)
        {
            ...
            double secondPercent =
                ...
                - (
                    ...
                    + (1 + (int)HerbalistSpellCircle) * 5.0
                );
