...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Barrage", "Baraj", 230, 9022);
        ...
        public Elemental_Barrage_Spell(Mobile caster, Item scroll)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Barrage_Spell owner)
