...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Rune", "Marca", 218, 9002);
        ...
        public Elemental_Rune_Spell(Mobile caster, Item scroll)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Rune_Spell owner)
