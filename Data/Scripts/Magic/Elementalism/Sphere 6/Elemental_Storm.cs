...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Storm", "Furtuna", 230, 9041);
        ...
        public Elemental_Storm_Spell(Mobile caster, Item scroll)
        ...
        private class InternalTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                if (m_Attacker.HarmfulCheck(m_Defender))
                {
                    ...
                    {
                        Point3D blast7w = new Point3D(
                            (m_Target.X + 2),
                            (m_Target.Y + 2),
                            m_Target.Z + 12
                        );
                        Point3D blast8w = new Point3D(
                            (m_Target.X),
                            (m_Target.Y + 2),
                            m_Target.Z + 12
                        );
                        Point3D blast9w = new Point3D(
                            (m_Target.X + 2),
                            (m_Target.Y),
                            m_Target.Z + 12
                        );
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Storm_Spell owner)
