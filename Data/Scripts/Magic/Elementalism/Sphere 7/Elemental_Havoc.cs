...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Havoc", "Haotic", 245, 9042);
        ...
        public Elemental_Havoc_Spell(Mobile caster, Item scroll)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Havoc_Spell owner)
