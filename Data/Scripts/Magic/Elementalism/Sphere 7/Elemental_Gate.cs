...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Gate", "Poarta", 263, 9032);
        ...
        public Elemental_Gate_Spell(Mobile caster, Item scroll)
            : this(caster, scroll, null) { }

        public Elemental_Gate_Spell(Mobile caster, Item scroll, RunebookEntry entry)
        ...
        private class InternalItem : Moongate
        {
            ...
            public InternalItem(Point3D target, Map map, int hue)
                : base(target, map)
            {
                Map = map;
                ItemID = 0x53FC;
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Gate_Spell owner)
