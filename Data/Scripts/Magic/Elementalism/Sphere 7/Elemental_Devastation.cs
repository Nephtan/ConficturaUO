...
namespace Server.Spells.Elementalism
{
    public class Elemental_Devastation_Spell : ElementalSpell
    {
        ...
        public Elemental_Devastation_Spell(Mobile caster, Item scroll)
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                double damage =
                    GetNewAosDamage(48, 1, 5, Caster.Player && playerVsPlayer) + nBenefit;
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Devastation_Spell owner)
