...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Mend", "Vindeca", 224, 9061);
        ...
        public Elemental_Mend_Spell(Mobile caster, Item scroll)
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Mend_Spell owner)
