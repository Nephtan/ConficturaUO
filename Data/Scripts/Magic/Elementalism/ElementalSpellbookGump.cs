...
namespace Server.Gumps
{
            ...
            : base(100, 100)
        {
            ...
            if (page == 1) // MAIN PAGE
            {
                AddHtml(
                    ...
                    89,
                    20,
                    @"<BODY><BASEFONT Color=" + fnt + "><BIG>Elemental</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    89,
                    20,
                    @"<BODY><BASEFONT Color=" + fnt + "><BIG>Spellbook</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + fnt
                        + ">Known elemental spells can be cast by selecting the button next to each listed spell. A known spell will also have a red bookmark on its detail page you can click on to cast as well.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + fnt
                        + ">Each spell has the power needed to cast, which is the amount of mana and stamina the caster needs. The bookmark below can be selected to view the information on how this magic works.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            else if (page > 1 && page < 6) // SPELL LISTS
            {
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + fnt
                        + "><BIG>"
                        + ElementalSpell.CommonInfo(id, 1)
                        + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            ...
            else // SPELL DESCRIPTIONS
            {
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + fnt
                        + "><BIG><CENTER>Elemental</CENTER></BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    100,
                    20,
                    @"<BODY><BASEFONT Color=" + fnt + "><BIG>Power:</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    100,
                    20,
                    @"<BODY><BASEFONT Color=" + fnt + "><BIG>Elementalism:</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    38,
                    20,
                    @"<BODY><BASEFONT Color=" + fnt + "><BIG>" + skill + "</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + fnt
                        + ">"
                        + ElementalSpell.DescriptionInfo(spell, m_Book.ItemID)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
    ...
    public class ElementalSpellHelp : Gump
    {
        ...
        public ElementalSpellHelp(Mobile from, ElementalSpellbook book, int page)
            : base(300, 200)
        {
            m_Book = book;
            ...
            AddHtml(
                ...
                530,
                20,
                @"<BODY><BASEFONT Color=" + fnt + ">" + cat + " ELEMENTAL MAGIC</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
