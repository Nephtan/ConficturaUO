...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Soul", "Viata", 245, 9062);
        ...
        public Elemental_Soul_Spell(Mobile caster, Item scroll)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Soul_Spell owner)
