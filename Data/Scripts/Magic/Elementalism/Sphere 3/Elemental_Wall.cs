...
namespace Server.Spells.Elementalism
{
    public class Elemental_Wall_Spell : ElementalSpell
    {
        ...
        public Elemental_Wall_Spell(Mobile caster, Item scroll)
        ...
        private class InternalItem : Item
        {
            ...
            public InternalItem(Point3D loc, Map map, Mobile caster, bool blocker, bool extra)
                : base(0x82)
            {
                string elm = ElementalSpell.GetElement(caster);
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Wall_Spell owner)
