...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Warp", "Urzeala", 215, 9031);
        ...
        public Elemental_Warp_Spell(Mobile caster, Item scroll)
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Warp_Spell owner)
