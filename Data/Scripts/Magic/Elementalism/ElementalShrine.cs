...
namespace Server.Items
{
    public class ElementalShrine : Item
    {
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            if (!e.Handled)
            {
                ...
                if (Name == "fire" && ((PlayerMobile)m).CharacterElement == 2)
                {
                    ...
                    m.PlaySound(0x208);
                    MorphingTime.ColorOnlyClothes(
                        m,
                        Server.Spells.Elementalism.ElementalSpell.ElementalHue(this.Name),
                        0
                    );
        ...
        public ElementalShrine(Serial serial)
            : base(serial) { }
