...
namespace Server.Items
{
    public class ElementalSpellbook : Spellbook
    {
        ...
        [Constructable]
        public ElementalSpellbook()
            : this((ulong)0) { }

        [Constructable]
        public ElementalSpellbook(ulong content)
            : base(content, 0x641F)
        {
        ...
        public void SetupBook(Mobile from)
        {
            ...
            if (player != null)
            {
                ...
                ElementalSpell.BookCover(this, player.CharacterElement);
            }
        }

        public ElementalSpellbook(Serial serial)
            : base(serial) { }
