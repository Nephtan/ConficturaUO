...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Hold", "Temnita", 218, 9012);
        ...
        public Elemental_Hold_Spell(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckHSequence(m))
            {
                ...
                int secs =
                    (int)((GetDamageSkill(Caster) / 10) - (GetResistSkill(m) / 10)) + nBenefit;
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Hold_Spell owner)
