...
namespace Server.Items
{
    public class ElementalEffect : Item
    {
        ...
        [Constructable]
        public ElementalEffect(int itemID, double seconds, Mobile m)
            : base(itemID)
        {
            Movable = false;
            m_Seconds = seconds;
        ...
        public ElementalEffect(Serial serial)
            : base(serial)
        {
            new InternalTimer(this).Start();
        }
        ...
        private class InternalTimer : Timer
        {
            ...
            public InternalTimer(Item ElementalEffect)
                : base(TimeSpan.FromSeconds(m_Seconds))
            {
