...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Purge", "Vindeca", 212, 9061);
        ...
        public Elemental_Purge_Spell(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckBSequence(m))
            {
                ...
                if (p != null)
                {
                    int chanceToCure =
                        10000
                        + (int)(Caster.Skills[CastSkill].Value * 75)
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Purge_Spell owner)
