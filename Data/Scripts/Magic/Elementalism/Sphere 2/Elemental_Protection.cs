...
namespace Server.Spells.Elementalism
{
    public class Elemental_Protection_Spell : ElementalSpell
    {
        ...
        public Elemental_Protection_Spell(Mobile caster, Item scroll)
            ...
            if (mods == null)
            {
                ...
                mods = new object[2]
                {
                    new ResistanceMod(
                        ...
                        -15 + Math.Min((int)(caster.Skills[SkillName.Elementalism].Value / 20), 15)
                    ),
                    new DefaultSkillMod(
                        SkillName.MagicResist,
                        true,
                        -35 + Math.Min((int)(caster.Skills[SkillName.Elementalism].Value / 20), 35)
                    )
                };
