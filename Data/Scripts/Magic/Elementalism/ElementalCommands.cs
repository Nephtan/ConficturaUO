    ...
    public class ElementalCommands
    {
        public static void Initialize()
        {
            ...
            Register(
                "ESanctuary",
                AccessLevel.Player,
                new CommandEventHandler(ESanctuary_OnCommand)
            );
            Register("EPain", AccessLevel.Player, new CommandEventHandler(EPain_OnCommand));
            Register(
                "EProtection",
                AccessLevel.Player,
                new CommandEventHandler(EProtection_OnCommand)
            );
            ...
            Register(
                "ERestoration",
                AccessLevel.Player,
                new CommandEventHandler(ERestoration_OnCommand)
            );
            ...
            Register(
                "EDevastation",
                AccessLevel.Player,
                new CommandEventHandler(EDevastation_OnCommand)
            );
            ...
            Register(
                "EApocalypse",
                AccessLevel.Player,
                new CommandEventHandler(EApocalypse_OnCommand)
            );
