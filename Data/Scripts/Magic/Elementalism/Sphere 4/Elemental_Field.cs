...
namespace Server.Spells.Elementalism
{
    public class Elemental_Field_Spell : ElementalSpell
    {
        ...
        public Elemental_Field_Spell(Mobile caster, Item scroll)
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                TimeSpan duration = TimeSpan.FromSeconds(
                    ((15 + (Caster.Skills.Elementalism.Fixed / 5)) / 4) + nBenefit
                );
        ...
        public class ElementalFieldItem : Item
        {
            ...
            public ElementalFieldItem(Serial serial)
                : base(serial) { }
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Field_Spell owner)
