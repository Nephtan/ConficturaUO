...
namespace Server.Spells.Elementalism
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Elemental Void", "Mutare", 239, 9031);
        ...
        public Elemental_Void_Spell(Mobile caster, Item scroll)
            : this(caster, scroll, null, null) { }

        public Elemental_Void_Spell(Mobile caster, Item scroll, RunebookEntry entry, Runebook book)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Elemental_Void_Spell owner)
