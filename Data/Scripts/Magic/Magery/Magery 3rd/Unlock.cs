            ...
            protected override void OnTarget(Mobile from, object o)
            {
                ...
                if (m_Owner.CheckSequence())
                {
                    ...
                    Effects.SendLocationParticles(
                        ...
                        9,
                        32,
                        Server.Misc.PlayerSettings.GetMySpellHue(true, from, 0),
                        0,
                        5024,
                        0
                    );
                    ...
                    {
                        from.SendMessage(
                            "This spell is to unlock certain containers and other types of doors."
                        );
                    }
                    ...
                    else
                    {
                        ...
                        {
                            from.SendMessage(
                                "A magical aura on this long lost treasure seems to negate your spell."
                            );
                        }
                        ...
                        {
                            from.SendMessage(
                                "This seems to be protected from magic, but maybe a thief can get it open."
                            );
                        }
                        else
                        {
                            int level = (int)(from.Skills[SkillName.Magery].Value) + 20;
