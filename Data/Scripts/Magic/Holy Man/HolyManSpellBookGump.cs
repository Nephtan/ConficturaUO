    ...
    public class HolyManSpellbookGump : Gump
    {
            ...
            : base(100, 100)
        {
            ...
            AddHtml(
                ...
                @"<BODY><BASEFONT Color="
                    + color
                    + "><CENTER>PRAYER BOOK</CENTER></BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            AddHtml(
            ...
            else
            {
                ...
                if (page == 2)
                {
                    ...
                    mana1 = "30";
                    text1 = "";
                    if (!this.HasSpell(from, 770))
                    {
                        z1 = 220;
                        text1 =
                            "Patriarch Morden rests south of the Village of Springvale<br><br>Mantra: exilium<BR><BR>";
                    }
                    ...
                    if (!this.HasSpell(from, 771))
                    {
                        z2 = 220;
                        text2 =
                            "Archbishop Halyrn rests by the Village of Whisper<br><br>Mantra: accipe spiritum<BR><BR>";
                    }
                ...
                else if (page == 3)
                {
                    ...
                    if (!this.HasSpell(from, 772))
                    {
                        z1 = 220;
                        text1 =
                            "Bishop Leantre rests in the Kuldar Cemetery<br><br>Mantra: fascinare<BR><BR>";
                    }
                    ...
                    if (!this.HasSpell(from, 773))
                    {
                        z2 = 220;
                        text2 =
                            "Deacon Wilems rests in the City of Elidor<br><br>Mantra: malleo fidei<BR><BR>";
                    }
                ...
                else if (page == 4)
                {
                    ...
                    if (!this.HasSpell(from, 774))
                    {
                        z1 = 220;
                        text1 =
                            "Drumat the Apostle rests by the City of Britain<br><br>Mantra: caelesti lumine<BR><BR>";
                    }
                    ...
                    if (!this.HasSpell(from, 775))
                    {
                        z2 = 220;
                        text2 =
                            "Vincent the Priest rests by the Town of Moon<br><br>Mantra: famem prohibere<BR><BR>";
                    }
                    text2 =
                        text2 + "The priest is able to help those that are starving or thirsty.";
                    icon2 = 0x96A;
                }
                else if (page == 5)
                {
                    ...
                    if (!this.HasSpell(from, 776))
                    {
                        z1 = 220;
                        text1 =
                            "Abigayl the Preacher rests near the Church of the Divine in the Town of Renika<br><br>Mantra: deiectionem<BR><BR>";
                    }
                    ...
                    if (!this.HasSpell(from, 777))
                    {
                        z2 = 220;
                        text2 =
                            "Cardinal Greggs rests near the Greensky Village<br><br>Mantra: reditus vitae<BR><BR>";
                    }
                    text2 =
                        text2
                        + "Brings one back to life, or summons an orb to resurrect the priest later on.";
                    icon2 = 0x96C;
                }
                else if (page == 6)
                {
                    ...
                    if (!this.HasSpell(from, 778))
                    {
                        z1 = 220;
                        text1 =
                            "Father Michal rests by the Village of Grey<br><br>Mantra: sacrum munus<BR><BR>";
                    }
                    text1 =
                        text1 + "Surrounds one with a holy aura that heals wounds much quicker.";
                    icon1 = 0x96E;
                    ...
                    mana2 = "15";
                    text2 = "";
                    if (!this.HasSpell(from, 779))
                    {
                        z2 = 220;
                        text2 =
                            "Sister Tiana rests south of the City of Montor<br><br>Mantra: benedicite<BR><BR>";
                    }
                    text2 =
                        text2
                        + "The gods grant the priest greater strength, speed, and intelligence.";
                    icon2 = 0x96D;
                }
                else if (page == 7)
                {
                    ...
                    mana1 = "30";
                    text1 = "";
                    if (!this.HasSpell(from, 780))
                    {
                        z1 = 220;
                        text1 =
                            "Brother Kurklan rests near the Village of Islegem<br><br>Mantra: spiritus mundi<BR><BR>";
                    }
                    text1 =
                        text1
                        + "Allows the priest to enter the realm of the dead, avoiding any harm.";
                    icon1 = 0x96F;
                    ...
                    mana2 = "20";
                    text2 = "";
                    if (!this.HasSpell(from, 781))
                    {
                        z2 = 220;
                        text2 =
                            "Edwin the Pope rests in the Lodoria Cemetery<br><br>Mantra: percutiat<BR><BR>";
                    }
                    text2 =
                        text2
                        + "Calls down a bolt from the heavens, doing double damage to demons and undead.";
                    icon2 = 0x970;
                }
                else if (page == 8)
                {
                    ...
                    mana1 = "10";
                    text1 = "";
                    if (!this.HasSpell(from, 782))
                    {
                        z1 = 220;
                        text1 =
                            "Xephyn the Monk rests near the Town of Devil Guard<br><br>Mantra: tactus vitae<BR><BR>";
                    }
                    ...
                    mana2 = "15";
                    text2 = "";
                    if (!this.HasSpell(from, 783))
                    {
                        z2 = 220;
                        text2 =
                            "Chancellor Davis rests on an island near the Village of Fawn<br><br>Mantra: igne iudicii<BR><BR>";
                    }
                    text2 =
                        text2
                        + "Engulfs the priest in holy flames, reflecting magic back at the caster.";
                    icon2 = 0x972;
                }
                ...
                AddHtml(
                    ...
                    57,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">Piety:</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    57,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + pity1 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                ...
                AddHtml(
                    ...
                    57,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + pity2 + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
