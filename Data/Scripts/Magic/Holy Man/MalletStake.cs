...
namespace Server.Items
{
    public class MalletStake : Item
    {
        ...
        public int Vampires_Slain
        {
            get { return VampiresSlain; }
            set
            {
                VampiresSlain = value;
        ...
        public class StakeGump : ContextMenuEntry
        {
            ...
            public StakeGump(Mobile from, MalletStake stake)
                : base(6132, 3)
            {
                m_Mobile = from;
                m_Stake = stake;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.SendGump(
                new SpeechGump(
                    from,
                    "The Vampire Scourge",
                    SpeechFunctions.SpeechText(from, from, "Stake")
                )
            );
        }
        ...
        private class CorpseTarget : Target
        {
            ...
            public CorpseTarget(MalletStake stake)
        ...
        public MalletStake(Serial serial)
            : base(serial) { }
