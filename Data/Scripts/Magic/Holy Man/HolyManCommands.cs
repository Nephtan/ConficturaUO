    ...
    public class HolyManCommands
    {
        public static void Initialize()
        {
            ...
            Register(
                "HMDampenSpirit",
                AccessLevel.Player,
                new CommandEventHandler(HMDampenSpirit_OnCommand)
            );
            Register("HMEnchant", AccessLevel.Player, new CommandEventHandler(HMEnchant_OnCommand));
            Register(
                "HMHammerFaith",
                AccessLevel.Player,
                new CommandEventHandler(HMHammerFaith_OnCommand)
            );
            Register(
                "HMHeavenlyLight",
                AccessLevel.Player,
                new CommandEventHandler(HMHeavenlyLight_OnCommand)
            );
            ...
            Register(
                "HMSacredBoon",
                AccessLevel.Player,
                new CommandEventHandler(HMSacredBoon_OnCommand)
            );
            Register(
                "HMSanctify",
                AccessLevel.Player,
                new CommandEventHandler(HMSanctify_OnCommand)
            );
            ...
            Register(
                "HMTouchLife",
                AccessLevel.Player,
                new CommandEventHandler(HMTouchLife_OnCommand)
            );
            Register(
                "HMTrialFire",
                AccessLevel.Player,
                new CommandEventHandler(HMTrialFire_OnCommand)
            );
        }
