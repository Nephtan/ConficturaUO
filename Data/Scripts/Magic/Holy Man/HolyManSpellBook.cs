...
namespace Server.Items
{
    public class HolyManSpellbook : Spellbook
    {
        ...
        {
            get { return SpellbookType.HolyMan; }
        }
        ...
        [Constructable]
        public HolyManSpellbook(ulong content, Mobile gifted)
            : base(content, 0x22C5)
        {
            Hue = 0x430;
            Layer = Layer.Invalid;
            ...
            {
                case 1:
                    this.Name = "Book of " + sGood + " Prayers";
                    break;
                case 2:
                    this.Name = "Tome of " + sGood + " Prayers";
                    break;
            }
        }
        ...
        public HolyManSpellbook(Serial serial)
            : base(serial) { }
