...
namespace Server.Spells.HolyMan
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Enchant", "Fascinare", 266, 9040);
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(EnchantSpell owner)
...
namespace Server.Items
{
    public class EnchantSpellStone : Item
    {
        ...
        public EnchantSpellStone(Serial serial)
            : base(serial) { }
        ...
        public Mobile Enchant_Owner
        {
            get { return EnchantOwner; }
            set { EnchantOwner = value; }
        }

        public int EnchantSerial;

        [CommandProperty(AccessLevel.GameMaster)]
        public int Enchant_Serial
        {
            get { return EnchantSerial; }
            set { EnchantSerial = value; }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int Enchant_Dmg
        {
            get { return EnchantDmg; }
            set { EnchantDmg = value; }
        }

        public int EnchantHue;

        [CommandProperty(AccessLevel.GameMaster)]
        public int Enchant_Hue
        {
            get { return EnchantHue; }
            set { EnchantHue = value; }
        }

        public SlayerName EnchantSlayer1;

        [CommandProperty(AccessLevel.GameMaster)]
        public SlayerName Enchant_Slayer1
        {
            get { return EnchantSlayer1; }
            set
            {
                EnchantSlayer1 = value;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public SlayerName Enchant_Slayer2
        {
            get { return EnchantSlayer2; }
            set
            {
                EnchantSlayer2 = value;
                InvalidateProperties();
            }
        }
    }
