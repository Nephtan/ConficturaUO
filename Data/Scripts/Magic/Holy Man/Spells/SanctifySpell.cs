...
namespace Server.Spells.HolyMan
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Sanctify", "Benedicite", 266, 9040);
        ...
        public SanctifySpell(Mobile caster, Item scroll)
        ...
        public override void OnCast()
        {
            ...
            if (CheckSequence())
            {
                ...
                int modify = (int)(
                    (Caster.Skills[SkillName.Healing].Value / 25)
                    + (Caster.Skills[SkillName.Spiritualism].Value / 25)
                );
