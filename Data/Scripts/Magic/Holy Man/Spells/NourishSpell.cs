...
namespace Server.Spells.HolyMan
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Nourish", "Famem Prohibere", 266, 9040);
        ...
        public NourishSpell(Mobile caster, Item scroll)
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(NourishSpell owner)
