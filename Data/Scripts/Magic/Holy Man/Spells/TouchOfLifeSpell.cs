...
namespace Server.Spells.HolyMan
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Touch of Life", "Tactus Vitae", 266, 9040);
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckBSequence(m, false))
            {
                ...
                int toHeal =
                    1
                    + (int)(
                        (Caster.Skills[SkillName.Healing].Value / 10)
                        + (Caster.Skills[SkillName.Spiritualism].Value / 10)
                    );
