...
namespace Server.Misc
{
    ...
    class Research
    {
        ...
        public static string PickWorld(int level) /////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            switch (Utility.RandomMinMax(0, level))
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    searchLocation = "the Land of Ambrosia";
                    break;
                case 3:
                    searchLocation = "the Land of Lodoria";
                    break;
                case 4:
                    searchLocation = "the Isles of Dread";
                    break;
                case 5:
                    searchLocation = "the Savaged Empire";
                    break;
                case 6:
                    searchLocation = "the Serpent Island";
                    break;
                case 7:
                    searchLocation = "the Bottle World of Kuldar";
                    break;
            }
        ...
        public static void FindLocation(Mobile m, int level, string category, ResearchBag bag) ////////////////////////////////////////////////////
        {
            ...
            sBook =
                Server.Misc.RandomThings.GetRandomBelongsTo("regular")
                + " "
                + Server.Misc.RandomThings.GetRandomBookType(1)
                + " of"
                + sEvil
                + sCat;
            ...
            {
                sBook =
                    Server.Misc.RandomThings.GetRandomBelongsTo("regular") + sEvil + " Spellbook";
            }
            if (sBook.Contains("  "))
            {
                sBook = sBook.Replace("  ", " ");
        ...
        )
        {
            ...
            )
            {
                if (skillCheck)
                {
                    double RequiredSkill = (double)(
                        Int32.Parse(Server.Misc.Research.SpellInformation(spellIndex, 8))
                    );
                ...
                {
                    high = 200;
                } // CHARM SPELLS HAVE HIGHER SCROLL CRUMBLE RATE

                if (
                    Utility.RandomMinMax(0, high)
                ...
                )
                {
                    ...
                    if (remaining == 1)
                    {
                        from.SendMessage("You have 1 scroll left for this spell.");
                    }
                    else if (remaining < 1)
                    {
                        from.SendMessage("You have no scrolls left for this spell.");
                    }
                    else if (remaining < 11)
                    {
                        from.SendMessage("You have " + remaining + " scrolls left for this spell.");
                    }
        ...
        public static void SetRunes(ResearchBag bag, Mobile from) /////////////////////////////////////////////////////////////////////////////////
        {
            ...
            from.LocalOverheadMessage(
                ...
                1150,
                true,
                "You found the Cube of " + runic + "!"
            );
            Server.Items.QuestSouvenir.GiveReward(
                from,
                "Cube of " + runic + "",
                0,
                RuneIndex(RuneName(cube, 0), 0)
            );
            from.SendSound(0x3D);
        ...
        public static void SetInk(ResearchBag bag, Mobile from) //////////////////////////////////////////////////////////////////////////////
        {
            ...
            else
            {
                ...
                if (from.Skills[SkillName.Alchemy].Value >= Utility.RandomMinMax(25, 150))
                {
                    qty++;
                }
                if (from.Skills[SkillName.Cooking].Value >= Utility.RandomMinMax(25, 150))
                {
                    qty++;
                }
                if (from.Skills[SkillName.Tasting].Value >= Utility.RandomMinMax(25, 150))
                {
                    qty++;
                }
                ...
                from.LocalOverheadMessage(
                    ...
                    1150,
                    true,
                    "You found some octopus ink!"
                );
                from.SendSound(0x3D);
            }

            int level = GetMaxCircleResearched(bag) - 1;
            if (level < 0)
            {
                level = 0;
            }
        ...
        public static string SpellInformation(int index, int slice) ///////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (index == 1)
            {
                ...
                school = "Conjuration";
                words = "kal xen";
                reagents = "Moon Crystal, Fairy Egg";
                mana = "10";
                skill = "15";
                init = "610";
                regs = "true";
            ...
            else if (index == 3)
            {
                ...
                school = "Enchanting";
                words = "por ex tym";
                reagents = "Fairy Egg, Pixie Skull";
                mana = "10";
                skill = "10";
                init = "648";
                description =
                    "Hides the target and allows them to sneak around for 2-8 minutes. They can still be discovered, however, and they cannot sneak well in heavy armor.";
            }
            else if (index == 4)
            {
                circle = "1";
                ...
                school = "Sorcery";
                words = "in flam ylem";
                reagents = "Brimstone, Mandrake Root, Ginseng";
                mana = "5";
                skill = "15";
                init = "611";
                description =
                    "Creates a magical fire at the caster's feet. When anything approaches the fire, they will take 2-20 points of fire damage every couple of seconds. The magical fire can last between 15-200 seconds dependent on the power of the caster.";
            }
            else if (index == 5)
            {
                circle = "1";
                name = "Electrical Elemental";
                school = "Summoning";
                words = "uus grav";
                reagents = "Silver Widow, Sulfurous Ash";
                mana = "40";
                skill = "70";
                init = "655";
                description =
                    "Summons an electrial elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 6)
            {
                circle = "1";
                ...
                init = "609";
                description =
                    "Those within the confusion blast could suffer from the effects for 5-20 seconds before they regain their senses.";
            }
            else if (index == 7)
            {
                circle = "1";
                ...
                school = "Theurgy";
                words = "an quas lor";
                reagents = "Grave Dust, Sea Salt, Fairy Egg";
                mana = "60";
                skill = "20";
                init = "645";
                description =
                    "This magic is an ancient form of that which gypsies use to see the truth in things. If you cast this spell on a book or parchment that you feel may be falsely written, you may learn the truth of things.";
            }
            else if (index == 8)
            {
                circle = "1";
                ...
                school = "Wizardry";
                words = "ex des bet";
                reagents = "Moon Crystal, Pig Iron";
                mana = "10";
                skill = "15";
                init = "632";
                description =
                    "Throws a magical icicle at your enemies that can cause up to 80 points of cold damage.";
            }
            else if (index == 9)
            {
                circle = "2";
                ...
                school = "Conjuration";
                words = "an flam";
                reagents = "Nightshade, Sea Salt, Black Pearl";
                mana = "20";
                skill = "35";
                init = "624";
                description =
                    "Calls forth waves of water that can cause up to 12-125 points of cold and physical damage. It will do twice the amount of damage toward creatures that suffer from flame extinguishing enchanted weapons.";
            }
            else if (index == 10)
            {
                circle = "2";
                name = "Rock Flesh";
                school = "Death";
                words = "rel sanct ylem";
                reagents = "Moon Crystal, Garlic, Pig Iron, Black Pearl";
                mana = "10";
                skill = "15";
                init = "644";
                description =
                    "With this spell, the caster gains an innate resistance to damage by transforming the very flesh into a substance as strong as stone for 1-16 minutes of a 90% physical resistance. The caster may lose some karma if they attempt this.";
            }
            else if (index == 11)
            {
                circle = "2";
                ...
                school = "Enchanting";
                words = "in vas por";
                reagents = "Fairy Egg, Butterfly Wings";
                mana = "99";
                skill = "66";
                init = "638";
                description =
                    "Increases the casters strength for up to 8 minutes, and it will also affect the caster's allies that are no more than 10 spaces away.";
            }
            else if (index == 12)
            {
                circle = "2";
                name = "Endure Cold";
                school = "Sorcery";
                words = "vas sanct flam";
                reagents = "Spiders Silk, Moon Crystal";
                mana = "15";
                skill = "20";
                init = "619";
                description =
                    "Increases the casters cold resistance for up to 8 minutes, and it will also affect the caster's allies that are no more than 3 spaces away.";
            }
            else if (index == 13)
            {
                circle = "2";
                ...
                school = "Summoning";
                words = "uus kal";
                reagents = "Red Lotus, Nightshade";
                mana = "40";
                skill = "70";
                init = "660";
                description =
                    "Summons a weed elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 14)
            {
                circle = "2";
                ...
                school = "Thaumaturgy";
                words = "vas kal xen";
                reagents = "Ginseng, Grave Dust, Pixie Skull";
                mana = "20";
                skill = "45";
                init = "652";
                description =
                    "Summons random creatures that are controlled by the caster for 8-25 minutes.";
            }
            else if (index == 15)
            {
                circle = "2";
                ...
                school = "Theurgy";
                words = "in mani";
                reagents = "Garlic, Ginseng, Fairy Egg, Pixie Skull";
                mana = "15";
                skill = "30";
                init = "631";
                description =
                    "Heals the one touched, restoring 12-125 hit points. You need to be close to your target, however.";
            }
            else if (index == 16)
            {
                circle = "2";
                ...
                school = "Wizardry";
                words = "ex des in";
                reagents = "Black Pearl, Moon Crystal";
                mana = "10";
                skill = "10";
                init = "649";
                description =
                    "Throws a magical snow ball toward your enemy, which can cause 2-80 points of cold damage.";
            }
            else if (index == 17)
            {
                circle = "3";
                ...
                school = "Conjuration";
                words = "in quas xen";
                reagents = "Gargoyle Ear, Fairy Egg";
                mana = "25";
                skill = "45";
                init = "607";
                description =
                    "Creates a clone of the caster that will appear and distract your enemies while you remain hidden from view.";
            }
            else if (index == 18)
            {
                circle = "3";
                ...
                school = "Death";
                words = "in vas corp";
                reagents = "Pixie Skull, Grave Dust";
                mana = "35";
                skill = "75";
                init = "629";
                description =
                    "This spell can grant an undead creature the true and final death. If they cannot be laid to rest, then they may take 50-200 points of energy damage.";
            }
            else if (index == 19)
            {
                circle = "3";
                ...
                school = "Enchanting";
                words = "in zu tym";
                reagents = "Fairy Egg, Mandrake Root, Sea Salt";
                mana = "15";
                skill = "40";
                init = "646";
                description =
                    "This spell can put a foe to sleep from 10-60 seconds, but taking actions against them will likely wake them up from their slumber. This spell cannot affect supernatural creatures, constructs, golems, or elementals.";
            }
            else if (index == 20)
            {
                circle = "3";
                ...
                school = "Sorcery";
                words = "sanct flam";
                reagents = "Swamp Berries, Gargoyle Ear";
                mana = "15";
                skill = "20";
                init = "620";
                description =
                    "Increases the casters fire resistance for up to 8 minutes, and it will also affect the caster's allies that are no more than 3 spaces away.";
            }
            else if (index == 21)
            {
                circle = "3";
                ...
                school = "Summoning";
                words = "uus ex des";
                reagents = "Sea Salt, Moon Crystal";
                mana = "40";
                skill = "70";
                init = "657";
                description =
                    "Summons an ice elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 22)
            {
                circle = "3";
                ...
                school = "Thaumaturgy";
                words = "ort grav por";
                reagents = "Black Pearl, Gargoyle Ear, Red Lotus";
                mana = "20";
                skill = "35";
                init = "622";
                description =
                    "Caster is transported to the location marked on the recall rune. One can use this spell on a ship key to travel to a boat's location if the boat is not dry docked. The caster will appear at the destination in a hidden state.";
            }
            else if (index == 23)
            {
                circle = "3";
                ...
                school = "Theurgy";
                words = "por ort wis";
                reagents = "Eye of Toad, Silver Widow, Gargoyle Ear, Black Pearl";
                mana = "30";
                skill = "50";
                init = "663";
                description =
                    "This spell allows the caster to identify items that have origins that are unknown to others.";
            }
            else if (index == 24)
            {
                circle = "3";
                ...
                school = "Wizardry";
                words = "in ex des";
                reagents = "Moon Crystal, Eye of Toad, Spiders Silk";
                mana = "15";
                skill = "30";
                init = "627";
                description =
                    "Creates a wall of frost that can cause 2-16 points of cold damage per second to anyone within it.";
            }
            else if (index == 25)
            {
                circle = "4";
            ...
            else if (index == 26)
            {
                ...
                school = "Death";
                words = "kal corp xen";
                reagents = "Bat Wing, Grave Dust, Pixie Skull";
                mana = "40";
                skill = "70";
                init = "653";
                description =
                    "Animates the bones of a mighty skeletal warrior that will fight for the caster for 8-25 minutes. The caster may lose some karma if they attempt this.";
            }
            else if (index == 27)
            {
                circle = "4";
                ...
                school = "Enchanting";
                words = "quas wis tym";
                reagents = "Bloodmoss, Daemon Blood, Red Lotus";
                mana = "35";
                skill = "45";
                init = "605";
                description =
                    "The caster can cause fear in a foe, causing them to flee from you for 10-60 seconds. This spell does not work on golems or constructs.";
            }
            else if (index == 28)
            {
                circle = "4";
                ...
                school = "Sorcery";
                words = "in flam";
                reagents = "Brimstone, Sulfurous Ash, Black Pearl";
                mana = "30";
                skill = "40";
                init = "633";
                description =
                    "Calls forth columns of fire that can cause up to 15-125 points of fire and physical damage. It will do twice the amount of damage toward creatures that suffer from watery grave or neptune's bane enchanted weapons.";
            }
            else if (index == 29)
            {
                circle = "4";
                ...
                school = "Summoning";
                words = "uus des ylem";
                reagents = "Pig Iron, Mandrake Root";
                mana = "40";
                skill = "70";
                init = "658";
                description =
                    "Summons a mud elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 30)
            {
                circle = "4";
                ...
                reagents = "Gargoyle Ear, Demon Claw";
                mana = "40";
                skill = "80";
                init = "603";
                description =
                    "This spell can send a demonic creature back to the plane of hell from which they spawned. If they cannot be banished, then they may take 50-200 points of energy damage.";
            }
            else if (index == 31)
            {
                circle = "4";
                ...
                school = "Theurgy";
                words = "quas an lor";
                reagents = "Red Lotus, Nox Crystal";
                mana = "15";
                skill = "50";
                init = "625";
                description =
                    "This spell will cause the caster to fade from the view of others, while at the same time moving them to a different location.";
            }
            else if (index == 32)
            {
                circle = "4";
                ...
                school = "Wizardry";
                words = "in hur grav";
                reagents = "Nightshade, Silver Widow, Swamp Berries, Silver Serpent Venom";
                mana = "25";
                skill = "45";
                init = "621";
                description =
                    "Creates a gaseous cloud of poison mist that will consume nearby enemies in the venomous vapor for 1-3 minutes.";
            }
            else if (index == 33)
            {
                circle = "5";
                ...
                school = "Conjuration";
                words = "kal bet xen";
                reagents = "Beetle Shell, Silver Widow, Fairy Egg";
                mana = "15";
                skill = "40";
                init = "661";
                description = "Unleashes a swarm of insects at your enemies for 1-3 minutes.";
            }
            else if (index == 34)
            {
                circle = "5";
                ...
                school = "Death";
                words = "quas corp";
                reagents = "Lich Dust, Grave Dust, Pixie Skull";
                mana = "70";
                skill = "90";
                init = "636";
                description =
                    "Creates a mask for the caster that when worn the undead will see you as one of their own and ignore them. The mask remains on this plane of existence for 6-15 minutes before it returns to the realm from which it came. If you attack an undead creature while wearing the mask, it will vanish and you will have to face your foe. The caster may lose some karma if they attempt this.";
            }
            else if (index == 35)
            {
                circle = "5";
                ...
                school = "Enchanting";
                words = "ort ylem tym";
                reagents = "Pixie Skull, Fairy Egg, Dragon Tooth, Moon Crystal";
                mana = "45";
                skill = "75";
                init = "618";
                description =
                    "This can greatly increase a weapon's damage by enchanting it for 15-60 minutes. A power orb is summoned and placed in the caster's pack that gives the enchantment strength until the spell wears off.";
            }
            else if (index == 36)
            {
                circle = "5";
                ...
                school = "Sorcery";
                words = "in ort flam";
                reagents = "Brimstone, Sulfurous Ash";
                mana = "15";
                skill = "30";
                init = "626";
                description =
                    "Throws a magical bolt of flame at your enemies that can cause 12-100 points of fire damage.";
            }
            else if (index == 37)
            {
                circle = "5";
                ...
                init = "656";
                description =
                    "Summons a gem rock elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 38)
            {
                circle = "5";
            ...
            else if (index == 39)
            {
                ...
                school = "Theurgy";
                words = "in wis tym";
                reagents = "Ginseng, Daemon Blood, Eye of Toad";
                mana = "30";
                skill = "50";
                init = "612";
                description =
                    "One can cast this spell on most creatures and learn things about them that are not commonly know by others.";
            }
            else if (index == 40)
            {
                circle = "5";
                ...
                school = "Wizardry";
                words = "ex des corp";
                reagents = "Moon Crystal, Grave Dust";
                mana = "40";
                skill = "67";
                init = "628";
                description =
                    "Damages an enemy with a column of frost crystals that causes 35-125 points of cold damage.";
            }
            else if (index == 41)
            {
                circle = "6";
                ...
                school = "Conjuration";
                words = "in xen tym";
                reagents = "Bat Wing, Butterfly Wings";
                mana = "30";
                skill = "50";
                init = "635";
                description =
                    "Lures a horse to the caster's location where it can be ridden for 8-25 minutes.";
            }
            else if (index == 42)
            {
                circle = "6";
                name = "Create Golem";
                school = "Death";
                words = "in ort ylem xen";
                reagents = "Pixie Skull, Grave Dust, Daemon Blood";
                mana = "40";
                skill = "70";
                init = "613";
                description =
                    "Creates a mighty flesh golem that will follow the commands of the cast for 8-25 minutes. The caster may lose some karma if they attempt this.";
            }
            else if (index == 43)
            {
                circle = "6";
                name = "Sleep Field";
                school = "Enchanting";
                words = "in zu grav tym";
                reagents = "Fairy Egg, Mandrake Root, Sea Salt, Grave Dust";
                mana = "30";
                skill = "60";
                init = "647";
                description =
                    "This spell will create a field that will put entering foes to sleep for 10-60 seconds, but taking actions against them will likely wake them up from their slumber. This spell cannot affect supernatural creatures, constructs, golems, or elementals.";
            }
            else if (index == 44)
            {
                circle = "6";
                name = "Conflagration";
                school = "Sorcery";
                words = "kal vas flam corp xen";
                reagents = "Sulfurous Ash, Brimstone, Gargoyle Ear";
                mana = "20";
                skill = "35";
                init = "608";
                description =
                    "Creates a huge inferno that can cause 2-16 points of fire damage per second to anyone within it.";
            }
            else if (index == 45)
            {
                circle = "6";
                ...
                school = "Summoning";
                words = "uus corp";
                reagents = "Swamp Berries, Nox Crystal, Beetle Shell, Eye of Toad";
                mana = "50";
                skill = "82";
                init = "650";
                description =
                    "Summons an acid elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 46)
            {
                circle = "6";
                name = "Meteor Shower";
                school = "Thaumaturgy";
                words = "kal des flam ylem";
                reagents = "Blood Moss, Brimstone, Mandrake Root, Black Pearl";
                mana = "40";
                skill = "70";
                init = "640";
                description =
                    "Damages nearby enemies with falling meteorites that hit for physical damage (with some fire and energy damage) split between the enemies. If you only hit one enemy, the enemy takes between 35-125 points of damage, but if you hit more than one enemy, the damage amount is doubled and divided amongst each enemy evenly.";
            }
            else if (index == 47)
            {
                circle = "6";
                name = "Intervention";
                school = "Theurgy";
                words = "in sanct an jux";
                reagents = "Moon Crystal, Brimstone, Nightshade, Fairy Egg";
                mana = "25";
                skill = "50";
                init = "634";
                description =
            ...
            else if (index == 48)
            {
                ...
                school = "Wizardry";
                words = "vas ex des";
                reagents = "Fairy Egg, Moon Crystal";
                mana = "25";
                skill = "55";
                init = "630";
                description =
                    "Creates a storm of ice around an enemy, causing 28-125 points of cold damage.";
            }
            else if (index == 49)
            {
                circle = "7";
                ...
                school = "Conjuration";
                words = "kal ort xen";
                reagents = "Butterfly Wings, Gargoyle Ear, Pegasus Feather";
                mana = "50";
                skill = "80";
                init = "600";
                description =
                    "Calls upon a mystical servant from the ethereal plane to aid the caster by carrying items for 1-3 hours.";
            }
            else if (index == 50)
            {
                circle = "7";
            ...
            else if (index == 51)
            {
                ...
                school = "Enchanting";
                words = "an xen ex";
                reagents = "Enchanted Seaweed, Fairy Egg, Pixie Skull";
                mana = "60";
                skill = "82";
                init = "606";
                description =
                    "This spell can charm either aggressive monsters or those of animialistic natures. When charmed, their evil or neutral tendencies are wiped from their mind and they will attack evil creatures. This charm will only last for up to a minute before they come to their senses.";
            }
            else if (index == 52)
            {
                circle = "7";
                ...
                school = "Sorcery";
                words = "vas ort flam";
                reagents = "Fairy Egg, Brimstone, Sulfurous Ash";
                mana = "30";
                skill = "60";
                init = "623";
                description =
                    "Damages nearby enemies with an explosive force consisting of mostly heat and some physical damage. If you only hit one enemy, the enemy takes between 35-125 points of damage, but if you hit more than one enemy, the damage amount is doubled and divided amongst each enemy evenly.";
            }
            else if (index == 53)
            {
                circle = "7";
                ...
                school = "Summoning";
                words = "uus nox";
                reagents = "Nightshade, Nox Crystal, Silver Serpent Venom, Silver Widow";
                mana = "50";
                skill = "86";
                init = "659";
                description =
                    "Summons a poison elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 54)
            {
                circle = "7";
                ...
                reagents = "Daemon Blood, Eye of Toad, Brimstone, Demon Claw";
                mana = "60";
                skill = "95";
                init = "654";
                description =
                    "Calls forth a devil from the realms of hell to serve the caster for 2-8 minutes. The caster may lose some karma if they attempt this.";
            }
            else if (index == 55)
            {
                circle = "7";
            ...
            else if (index == 56)
            {
                ...
                school = "Wizardry";
                words = "ex vas des";
                reagents = "Blood Moss, Spiders Silk, Mandrake Root, Moon Crystal";
                mana = "40";
                skill = "70";
                init = "602";
                description =
                    "Damages nearby enemies with falling ice and snow that hit for cold damage split between the enemies. If you only hit one enemy, the enemy takes between 35-125 points of damage, but if you hit more than one enemy, the damage amount is doubled and divided amongst each enemy evenly.";
            }
            else if (index == 57)
            {
                circle = "8";
                ...
                school = "Conjuration";
                words = "vas corp hur";
                reagents = "Daemon Blood, Eye of Toad, Unicorn Horn";
                mana = "60";
                skill = "90";
                init = "615";
                description =
                    "Creates a swirling mass of black death that spreads disease and unleashes electrical force on nearby enemies for 1-3 minutes.";
            }
            else if (index == 58)
            {
                circle = "8";
            ...
            else if (index == 59)
            {
                ...
                school = "Enchanting";
                words = "vas zu tym";
                reagents = "Fairy Egg, Mandrake Root, Enchanted Seaweed, Lich Dust";
                mana = "50";
                skill = "85";
                init = "639";
                regs = "true";
            ...
            else if (index == 60)
            {
                ...
                name = "Ring of Fire";
                school = "Sorcery";
                words = "in flam an por";
                reagents = "Brimstone, Pig Iron, Daemon Blood";
                mana = "55";
                skill = "85";
                init = "643";
                description =
                    "This spell creates a ring of fire at a chosen location, where demonic creatures cannot pass. Any demonic creature that touches the flames will be unable to cast spells, but they may still perform any special attacks they may have. The ring can last up to 50 seconds before extinguishing itself, and there is a chance that the demon can traverse the flaming circle if cast on uneven terrain.";
            }
            else if (index == 61)
            {
                circle = "8";
                ...
                school = "Summoning";
                words = "uus mani";
                reagents = "Black Pearl, Bloodmoss, Dragon Blood, Daemon Blood";
                mana = "50";
                skill = "90";
                init = "651";
                description =
                    "Summons a blood elemental that is controlled by the caster for 8-25 minutes.";
            }
            else if (index == 62)
            {
                circle = "8";
            ...
            else if (index == 63)
            {
                ...
                school = "Theurgy";
                words = "vas in mani";
                reagents = "Butterfly Wings, Garlic, Enchanted Seaweed";
                mana = "50";
                skill = "80";
                init = "642";
                description = "This spell can restore 12-125 points in health, stamina, and mana.";
            }
            else if (index == 64)
            {
                circle = "8";
            ...
            else if (slice == 9)
            {
                ...
                else if (school == "Enchanting")
                {
                    value = "11276";
                }
                else if (school == "Sorcery")
                {
                    value = "11275";
                }
                else if (school == "Summoning")
                {
                    value = "11272";
                }
                ...
                else if (school == "Theurgy")
                {
                    value = "11273";
                }
                else if (school == "Wizardry")
                {
                    value = "11271";
                }
            }
        ...
        public static string ScrollInformation(int index, int slice) //////////////////////////////////////////////////////////////////////////////
        {
            ...
            else if (index == 29)
            {
                name = "Greater Heal";
                circle = "4";
                reagents = "Garlic, Spiders Silk, Mandrake Root, Ginseng";
                mana = "32";
                skill = "60";
            }
            else if (index == 30)
            ...
            else if (index == 31)
            {
                name = "Mana Drain";
                circle = "4";
                reagents = "Black Pearl, Spiders Silk, Mandrake Root";
                mana = "32";
                skill = "60";
            }
            else if (index == 32)
            ...
            else if (index == 34)
            {
                name = "Dispel Field";
                circle = "5";
                reagents = "Black Pearl, Garlic, Spiders Silk, Sulfurous Ash";
                mana = "40";
                skill = "70";
            }
            else if (index == 35)
            ...
            else if (index == 57)
            {
                name = "Earthquake";
                circle = "8";
                reagents = "Bloodmoss, Mandrake Root, Ginseng, Sulfurous Ash";
                mana = "64";
                skill = "100";
            }
            else if (index == 58)
            ...
            else if (index == 70)
            {
                ...
                name = "Mind Rot";
                circle = "2";
                reagents = "Bat Wing, Daemon Blood, Pig Iron";
                mana = "26";
                skill = "45";
            }
            else if (index == 71)
            ...
            else if (index == 72)
            {
                ...
                name = "Animate Dead";
                circle = "3";
                reagents = "Grave Dust, Daemon Blood";
                mana = "35";
                skill = "55";
            }
            else if (index == 73)
            {
                ...
                name = "Horrific Beast";
                circle = "3";
                reagents = "Bat Wing, Daemon Blood";
                mana = "17";
                skill = "55";
            }
            else if (index == 74)
            ...
            else if (index == 75)
            {
                ...
                name = "Wither";
                circle = "5";
                reagents = "Grave Dust, Nox Crystal, Pig Iron";
                mana = "35";
                skill = "75";
            }
            else if (index == 76)
            {
                ...
                name = "Lich Form";
                circle = "6";
                reagents = "Grave Dust, Daemon Blood, Nox Crystal";
                mana = "35";
                skill = "85";
            }
            else if (index == 77)
            {
                ...
                name = "Strangle";
                circle = "6";
                reagents = "Daemon Blood, Nox Crystal";
                mana = "44";
                skill = "85";
            }
            else if (index == 78)
            {
                ...
                name = "Exorcism";
                circle = "7";
                reagents = "Nox Crystal, Grave Dust";
                mana = "60";
                skill = "95";
            }
            else if (index == 79)
            {
                ...
                circle = "7";
                reagents = "Bat Wing, Grave Dust, Pig Iron";
                mana = "62";
                skill = "95";
            }
            else if (index == 80)
            ...
            else if (index == 81)
            {
                ...
                circle = "8";
                reagents = "Bat Wing, Nox Crystal, Pig Iron";
                mana = "35";
                skill = "100";
            }
        ...
        public static bool CheckReagents(
            Mobile from,
            int spell,
            bool deplete,
            bool ancient,
        ...
        ) ////////////////////////////////////////////////////////////////////
        {
            ...
            if (ancient)
            {
                reagents = Research.SpellInformation(spell, 5);
            }
            ...
            if (reagents.Length > 0)
            {
                ...
                foreach (string reg in regs)
                {
                    if (deplete)
                    {
                        if (
                            reg == "Bat Wing"
                            && from.Backpack.FindItemByType(typeof(BatWing)) != null
                        )
                        {
                            ...
                            reg == "Black Pearl"
                            && from.Backpack.FindItemByType(typeof(BlackPearl)) != null
                        )
                        {
                            ...
                            reg == "Bloodmoss"
                            && from.Backpack.FindItemByType(typeof(Bloodmoss)) != null
                        )
                        {
                            ...
                            reg == "Daemon Blood"
                            && from.Backpack.FindItemByType(typeof(DaemonBlood)) != null
                        )
                        {
                        ...
                        )
                        {
                            ...
                            reg == "Ginseng"
                            && from.Backpack.FindItemByType(typeof(Ginseng)) != null
                        )
                        {
                            ...
                            reg == "Grave Dust"
                            && from.Backpack.FindItemByType(typeof(GraveDust)) != null
                        )
                        {
                            ...
                            reg == "Mandrake Root"
                            && from.Backpack.FindItemByType(typeof(MandrakeRoot)) != null
                        )
                        {
                            ...
                            reg == "Nightshade"
                            && from.Backpack.FindItemByType(typeof(Nightshade)) != null
                        )
                        {
                            ...
                            reg == "Nox Crystal"
                            && from.Backpack.FindItemByType(typeof(NoxCrystal)) != null
                        )
                        {
                            ...
                            reg == "Pig Iron"
                            && from.Backpack.FindItemByType(typeof(PigIron)) != null
                        )
                        {
                            ...
                            reg == "Spiders Silk"
                            && from.Backpack.FindItemByType(typeof(SpidersSilk)) != null
                        )
                        {
                            ...
                            reg == "Sulfurous Ash"
                            && from.Backpack.FindItemByType(typeof(SulfurousAsh)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(SulfurousAsh), qty);
                        }
                        else if (
                            reg == "Silver Serpent Venom"
                            && from.Backpack.FindItemByType(typeof(SilverSerpentVenom)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(SilverSerpentVenom), qty);
                        }
                        else if (
                            reg == "Dragon Blood"
                            && from.Backpack.FindItemByType(typeof(DragonBlood)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(DragonBlood), qty);
                        }
                        else if (
                            reg == "Enchanted Seaweed"
                            && from.Backpack.FindItemByType(typeof(EnchantedSeaweed)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(EnchantedSeaweed), qty);
                        }
                        else if (
                            reg == "Dragon Tooth"
                            && from.Backpack.FindItemByType(typeof(DragonTooth)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(DragonTooth), qty);
                        }
                        else if (
                            reg == "Golden Serpent Venom"
                            && from.Backpack.FindItemByType(typeof(GoldenSerpentVenom)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(GoldenSerpentVenom), qty);
                        }
                        else if (
                            reg == "Lich Dust"
                            && from.Backpack.FindItemByType(typeof(LichDust)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(LichDust), qty);
                        }
                        else if (
                            reg == "Demon Claw"
                            && from.Backpack.FindItemByType(typeof(DemonClaw)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(DemonClaw), qty);
                        }
                        else if (
                            reg == "Pegasus Feather"
                            && from.Backpack.FindItemByType(typeof(PegasusFeather)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(PegasusFeather), qty);
                        }
                        else if (
                            reg == "Phoenix Feather"
                            && from.Backpack.FindItemByType(typeof(PhoenixFeather)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(PhoenixFeather), qty);
                        }
                        else if (
                            reg == "Unicorn Horn"
                            && from.Backpack.FindItemByType(typeof(UnicornHorn)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(UnicornHorn), qty);
                        }
                        else if (
                            reg == "Demigod Blood"
                            && from.Backpack.FindItemByType(typeof(DemigodBlood)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(DemigodBlood), qty);
                        }
                        else if (
                            reg == "Ghostly Dust"
                            && from.Backpack.FindItemByType(typeof(GhostlyDust)) != null
                        )
                        {
                            pack.ConsumeTotal(typeof(GhostlyDust), qty);
                        }
                        else if (
                            reg == "Eye of Toad"
                            && from.Backpack.FindItemByType(typeof(EyeOfToad)) != null
                        )
                        {
                            ...
                            reg == "Fairy Egg"
                            && from.Backpack.FindItemByType(typeof(FairyEgg)) != null
                        )
                        {
                            ...
                            reg == "Gargoyle Ear"
                            && from.Backpack.FindItemByType(typeof(GargoyleEar)) != null
                        )
                        {
                            ...
                            reg == "Beetle Shell"
                            && from.Backpack.FindItemByType(typeof(BeetleShell)) != null
                        )
                        {
                            ...
                            reg == "Moon Crystal"
                            && from.Backpack.FindItemByType(typeof(MoonCrystal)) != null
                        )
                        {
                            ...
                            reg == "Pixie Skull"
                            && from.Backpack.FindItemByType(typeof(PixieSkull)) != null
                        )
                        {
                            ...
                            reg == "Red Lotus"
                            && from.Backpack.FindItemByType(typeof(RedLotus)) != null
                        )
                        {
                            ...
                            reg == "Sea Salt"
                            && from.Backpack.FindItemByType(typeof(SeaSalt)) != null
                        )
                        {
                            ...
                            reg == "Silver Widow"
                            && from.Backpack.FindItemByType(typeof(SilverWidow)) != null
                        )
                        {
                            ...
                            reg == "Swamp Berries"
                            && from.Backpack.FindItemByType(typeof(SwampBerries)) != null
                        )
                        {
                            ...
                            reg == "Brimstone"
                            && from.Backpack.FindItemByType(typeof(Brimstone)) != null
                        )
                        {
                            ...
                            reg == "Butterfly Wings"
                            && from.Backpack.FindItemByType(typeof(ButterflyWings)) != null
                        )
                        {
                    ...
                    {
                        if (reg == "Bat Wing" && RegCount(from, typeof(BatWing)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Black Pearl" && RegCount(from, typeof(BlackPearl)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Bloodmoss" && RegCount(from, typeof(Bloodmoss)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Daemon Blood" && RegCount(from, typeof(DaemonBlood)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Garlic" && RegCount(from, typeof(Garlic)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Ginseng" && RegCount(from, typeof(Ginseng)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Grave Dust" && RegCount(from, typeof(GraveDust)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (
                        ...
                        else if (reg == "Nightshade" && RegCount(from, typeof(Nightshade)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Nox Crystal" && RegCount(from, typeof(NoxCrystal)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Pig Iron" && RegCount(from, typeof(PigIron)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Spiders Silk" && RegCount(from, typeof(SpidersSilk)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (
                        ...
                        )
                        {
                            ...
                            reg == "Silver Serpent Venom"
                            && RegCount(from, typeof(SilverSerpentVenom)) < qty
                        )
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Dragon Blood" && RegCount(from, typeof(DragonBlood)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (
                            reg == "Enchanted Seaweed"
                            && RegCount(from, typeof(EnchantedSeaweed)) < qty
                        )
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Dragon Tooth" && RegCount(from, typeof(DragonTooth)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (
                            reg == "Golden Serpent Venom"
                            && RegCount(from, typeof(GoldenSerpentVenom)) < qty
                        )
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Lich Dust" && RegCount(from, typeof(LichDust)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Demon Claw" && RegCount(from, typeof(DemonClaw)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Unicorn Horn" && RegCount(from, typeof(UnicornHorn)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (
                        ...
                        else if (reg == "Ghostly Dust" && RegCount(from, typeof(GhostlyDust)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Eye of Toad" && RegCount(from, typeof(EyeOfToad)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Fairy Egg" && RegCount(from, typeof(FairyEgg)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Gargoyle Ear" && RegCount(from, typeof(GargoyleEar)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Beetle Shell" && RegCount(from, typeof(BeetleShell)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Moon Crystal" && RegCount(from, typeof(MoonCrystal)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Pixie Skull" && RegCount(from, typeof(PixieSkull)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Red Lotus" && RegCount(from, typeof(RedLotus)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Sea Salt" && RegCount(from, typeof(SeaSalt)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (reg == "Silver Widow" && RegCount(from, typeof(SilverWidow)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (
                        ...
                        else if (reg == "Brimstone" && RegCount(from, typeof(Brimstone)) < qty)
                        {
                            HaveReagents = false;
                        }
                        else if (
        ...
        public static void CreateNormalSpell(ResearchBag bag, Mobile from, int spell) /////////////////////////////////////////////////////////////
        {
            ...
            if (from.Mana < mana)
            {
                msg = "You lack the mana to scribe this spell to parchment.";
                canMake = false;
            }
            else if (from.Skills[SkillName.Inscribe].Value < skill)
            {
                msg = "You lack the skill to scribe this spell to parchment.";
                canMake = false;
            }
            else if (bag.BagInk < ink)
            {
                msg = "You do not have enough octopus ink in your bag.";
                canMake = false;
            }
            else if (bag.BagQuills < 1)
            {
                msg = "You need at least one quill in your bag.";
                canMake = false;
            }
            else if (bag.BagScrolls < 1)
            {
                msg = "You need at least one blank scroll in your bag.";
                canMake = false;
            }
            else if (!CheckReagents(from, spell, false, false, 1))
            {
                msg = "You do not have the right reagents to scribe this spell.";
                canMake = false;
            }
            else if (
                from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(skill - 25, skill + 25)
                && canMake
            )
            {
                from.CheckSkill(SkillName.Inscribe, 0, 125);
                canMake = false;
                if (from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(0, 125))
                {
                    from.Mana = from.Mana - mana;
                }
                if (from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(0, 125))
                {
                    bag.BagInk = bag.BagInk - 1;
                    if (bag.BagInk < 1)
                    {
                        bag.BagInk = 0;
                    }
                ...
                if (from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(0, 125))
                {
                    bag.BagScrolls = bag.BagScrolls - 1;
                    if (bag.BagScrolls < 1)
                    {
                        bag.BagScrolls = 0;
                    }
                ...
                msg =
                    "You fail to scribe the "
                    + name
                    + " scroll and some of your materials may be lost.";
            }
        ...
        public static string NextWizardry(ResearchBag bag) ///////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (found.Length > 0)
            {
                ...
                foreach (string spell in spells)
                {
                    if (spell == "0" && check)
                    {
                        scroll = ScrollInformation(entry, 2);
                        check = false;
                    }
                    else if (spell == "1")
                    {
        ...
        public static void SetWizardry(ResearchBag bag, Mobile from) //////////////////////////////////////////////////////////////////////////////
        {
            ...
            else
            {
                ...
                if (magic > 56)
                {
                    level = Utility.RandomList(5, 7);
                }
                else if (magic > 48)
                {
                    level = Utility.RandomList(4, 5);
                }
                else if (magic > 40)
                {
                    level = Utility.RandomList(3, 4);
                }
                else if (magic > 32)
                {
                    level = Utility.RandomList(2, 3);
                }
                else if (magic > 24)
                {
                    level = Utility.RandomList(1, 2);
                }
                else if (magic > 16)
                {
                    level = Utility.RandomList(0, 2);
                }
                else if (magic > 8)
                {
                    level = Utility.RandomList(0, 1);
                }
        ...
        public static string NextNecromancy(ResearchBag bag) //////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (found.Length > 0)
            {
                ...
                foreach (string spell in spells)
                {
                    if (spell == "0" && check)
                    {
                        scroll = ScrollInformation((entry + 64), 2);
                        check = false;
                    }
                    else if (spell == "1")
                    {
        ...
        public static string NextResearch(ResearchBag bag) ///////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (found.Length > 0)
            {
                ...
                foreach (string spell in spells)
                {
                    ...
                    {
                        scroll =
                            SpellInformation(entry, 2)
                            + " from the School of "
                            + SpellInformation(entry, 3);
                        check = false;
                    }
                    else if (spell == "1")
                    {
            ...
            if (check)
            {
                scroll = "Conjure from the School of Conjuration";
            }
            if (count > 63)
            {
                scroll = "";
        ...
        public static void CreateResearchSpell(ResearchBag bag, Mobile from, int spell) ///////////////////////////////////////////////////////////
        {
            ...
            {
                msg = "You have too many of these spells in your bag already.";
                canMake = false;
            }
            else if (
                from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(skill - 25, skill + 25)
        ...
        public static void CreateManySpells(ResearchBag bag, Mobile from, int spell) ///////////////////////////////////////////////////////////
        {
            ...
            while (!stopAll)
            {
                ...
                else if (GetPrepared(bag, spell) >= 500)
                {
                    ...
                    from.Skills[SkillName.Inscribe].Value
                        < Utility.RandomMinMax(skill - 25, skill + 25)
                    && canMake
                )
                {
                    from.CheckSkill(SkillName.Inscribe, 0, 125);
                    canMake = false;
                    if (
                        from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(0, 125)
                        && manaCheck
                    )
                    {
                        from.Mana = from.Mana - mana;
                    ...
                    msg =
                        "You fail to scribe the "
                        + name
                        + " scrolls and some of your materials may be lost.";
                }
            ...
            if (reagents > 0)
            {
                CheckReagents(from, spell, true, true, reagents);
            }

            if (total == 1)
            {
                bag.BagMsgString = "You successfully scribe a single " + name + " scroll.";
                bag.BagMessage = 2;
            }
            else if (total > 0)
            {
                bag.BagMsgString = "You successfully scribe " + total + " " + name + " scrolls.";
                bag.BagMessage = 2;
            }
            else
            {
        ...
        public static void SetPrepared(ResearchBag bag, int index, int amount) ////////////////////////////////////////////////////////////////////////////////
        {
            ...
            if (scrolls.Length > 0)
            {
                ...
                if (index > 32)
                {
                    bag.ResearchPrep2 = got;
                }
                else
                {
                    bag.ResearchPrep1 = got;
                }
            }
        }
        ...
        public static void CastSpell(Mobile from, int spell) //////////////////////////////////////////////////////////////////////////////////////
        {
            if (Server.Misc.ResearchSettings.ResearchMaterials(from) != null)
            {
                if (ResearchSettings.HasSpell(from, spell))
                {
                    if (spell == 1)
                    {
                        InvokeCommand("CastConjure", from);
                    }
                    else if (spell == 2)
                    {
                        InvokeCommand("CastDeathSpeak", from);
                    }
                    else if (spell == 3)
                    {
                        InvokeCommand("CastSneak", from);
                    }
                    else if (spell == 4)
                    {
                        InvokeCommand("CastCreateFire", from);
                    }
                    else if (spell == 5)
                    {
                        InvokeCommand("CastElectricalElemental", from);
                    }
                    else if (spell == 6)
                    {
                        InvokeCommand("CastConfusionBlast", from);
                    }
                    else if (spell == 7)
                    {
                        InvokeCommand("CastSeeTruth", from);
                    }
                    else if (spell == 8)
                    {
                        InvokeCommand("CastIcicle", from);
                    }
                    else if (spell == 9)
                    {
                        InvokeCommand("CastExtinguish", from);
                    }
                    else if (spell == 10)
                    {
                        InvokeCommand("CastRockFlesh", from);
                    }
                    else if (spell == 11)
                    {
                        InvokeCommand("CastMassMight", from);
                    }
                    else if (spell == 12)
                    {
                        InvokeCommand("CastEndureCold", from);
                    }
                    else if (spell == 13)
                    {
                        InvokeCommand("CastWeedElemental", from);
                    }
                    else if (spell == 14)
                    {
                        InvokeCommand("CastSpawnCreature", from);
                    }
                    else if (spell == 15)
                    {
                        InvokeCommand("CastHealingTouch", from);
                    }
                    else if (spell == 16)
                    {
                        InvokeCommand("CastSnowBall", from);
                    }
                    else if (spell == 17)
                    {
                        InvokeCommand("CastClone", from);
                    }
                    else if (spell == 18)
                    {
                        InvokeCommand("CastGrantPeace", from);
                    }
                    else if (spell == 19)
                    {
                        InvokeCommand("CastSleep", from);
                    }
                    else if (spell == 20)
                    {
                        InvokeCommand("CastEndureHeat", from);
                    }
                    else if (spell == 21)
                    {
                        InvokeCommand("CastIceElemental", from);
                    }
                    else if (spell == 22)
                    {
                        InvokeCommand("CastEtherealTravel", from);
                    }
                    else if (spell == 23)
                    {
                        InvokeCommand("CastWizardEye", from);
                    }
                    else if (spell == 24)
                    {
                        InvokeCommand("CastFrostField", from);
                    }
                    else if (spell == 25)
                    {
                        InvokeCommand("CastCreateGold", from);
                    }
                    else if (spell == 26)
                    {
                        InvokeCommand("CastAnimateBones", from);
                    }
                    else if (spell == 27)
                    {
                        InvokeCommand("CastCauseFear", from);
                    }
                    else if (spell == 28)
                    {
                        InvokeCommand("CastIgnite", from);
                    }
                    else if (spell == 29)
                    {
                        InvokeCommand("CastMudElemental", from);
                    }
                    else if (spell == 30)
                    {
                        InvokeCommand("CastBanishDaemon", from);
                    }
                    else if (spell == 31)
                    {
                        InvokeCommand("CastFadefromSight", from);
                    }
                    else if (spell == 32)
                    {
                        InvokeCommand("CastGasCloud", from);
                    }
                    else if (spell == 33)
                    {
                        InvokeCommand("CastSwarm", from);
                    }
                    else if (spell == 34)
                    {
                        InvokeCommand("CastMaskofDeath", from);
                    }
                    else if (spell == 35)
                    {
                        InvokeCommand("CastEnchant", from);
                    }
                    else if (spell == 36)
                    {
                        InvokeCommand("CastFlameBolt", from);
                    }
                    else if (spell == 37)
                    {
                        InvokeCommand("CastGemElemental", from);
                    }
                    else if (spell == 38)
                    {
                        InvokeCommand("CastCallDestruction", from);
                    }
                    else if (spell == 39)
                    {
                        InvokeCommand("CastDivination", from);
                    }
                    else if (spell == 40)
                    {
                        InvokeCommand("CastFrostStrike", from);
                    }
                    else if (spell == 41)
                    {
                        InvokeCommand("CastMagicSteed", from);
                    }
                    else if (spell == 42)
                    {
                        InvokeCommand("CastCreateGolem", from);
                    }
                    else if (spell == 43)
                    {
                        InvokeCommand("CastSleepField", from);
                    }
                    else if (spell == 44)
                    {
                        InvokeCommand("CastConflagration", from);
                    }
                    else if (spell == 45)
                    {
                        InvokeCommand("CastAcidElemental", from);
                    }
                    else if (spell == 46)
                    {
                        InvokeCommand("CastMeteorShower", from);
                    }
                    else if (spell == 47)
                    {
                        InvokeCommand("CastIntervention", from);
                    }
                    else if (spell == 48)
                    {
                        InvokeCommand("CastHailStorm", from);
                    }
                    else if (spell == 49)
                    {
                        InvokeCommand("CastAerialServant", from);
                    }
                    else if (spell == 50)
                    {
                        InvokeCommand("CastOpenGround", from);
                    }
                    else if (spell == 51)
                    {
                        InvokeCommand("CastCharm", from);
                    }
                    else if (spell == 52)
                    {
                        InvokeCommand("CastExplosion", from);
                    }
                    else if (spell == 53)
                    {
                        InvokeCommand("CastPoisonElemental", from);
                    }
                    else if (spell == 54)
                    {
                        InvokeCommand("CastInvokeDevil", from);
                    }
                    else if (spell == 55)
                    {
                        InvokeCommand("CastAirWalk", from);
                    }
                    else if (spell == 56)
                    {
                        InvokeCommand("CastAvalanche", from);
                    }
                    else if (spell == 57)
                    {
                        InvokeCommand("CastDeathVortex", from);
                    }
                    else if (spell == 58)
                    {
                        InvokeCommand("CastWithstandDeath", from);
                    }
                    else if (spell == 59)
                    {
                        InvokeCommand("CastMassSleep", from);
                    }
                    else if (spell == 60)
                    {
                        InvokeCommand("CastRingofFire", from);
                    }
                    else if (spell == 61)
                    {
                        InvokeCommand("CastBloodElemental", from);
                    }
                    else if (spell == 62)
                    {
                        InvokeCommand("CastDevastation", from);
                    }
                    else if (spell == 63)
                    {
                        InvokeCommand("CastRestoration", from);
                    }
                    else if (spell == 64)
                    {
                        InvokeCommand("CastMassDeath", from);
                    }
                }
            }
        }
