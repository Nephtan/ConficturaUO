...
namespace Server.Items
{
    ...
    public class ResearchBag : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendMessage(
                    "This must be in your pack to do any research. "
                        + Research.GetMaxSchoolResearched(this)
                        + " - "
                        + Research.GetMaxCircleResearched(this)
                        + ""
                );
            }
        ...
        public class ResearchGump : Gump
        {
            ...
            public ResearchGump(ResearchBag bag, Mobile from)
                : base(50, 50)
            {
                from.SendSound(0x55);
                string color = "#6cb89a";
                ...
                m_Bag = bag;
                m_Page = bag.BagPage;
                if (!Research.GetRunes(bag, 26) && m_Page != 12 && m_Page != 2)
                {
                    m_Page = bag.BagPage = 2;
                }
                ...
                if ((m_Page < 10 || m_Page > 20) && Research.GetRunes(bag, 26)) /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                {
                    ...
                    int button_top_menu = 3609;
                    if (m_Page == 1)
                    {
                        button_top_menu = 4011;
                    }
                    AddButton(
                        180 + m,
                        75,
                    ...
                    button_top_menu = 3609;
                    if (m_Page == 3 || (m_Page > 20 && m_Page < 30))
                    {
                        button_top_menu = 4011;
                    }
                    AddButton(
                    ...
                    button_top_menu = 3609;
                    if (m_Page == 5 || (m_Page > 30 && m_Page < 40))
                    {
                        button_top_menu = 4011;
                    }
                    AddButton(
                    ...
                    {
                        button_top_menu = 3609;
                        if (m_Page == 6 || (m_Page > 40 && m_Page < 50))
                        {
                            button_top_menu = 4011;
                        }
                        AddButton(
                ...
                if (m_Page == 1) // MAIN SCREEN /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                {
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Scrolls</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    AddHtml(
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Quills</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    AddHtml(
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Ink</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    AddHtml(
                ...
                if (m_Page == 2) // RUNES FOUND /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                {
                    ...
                    r++;
                    Rune = Research.RuneName(r, 1);
                    rune = Research.RuneName(r, 0);
                    icon = 11277;
                    if (Research.GetRunes(bag, r))
                    {
                        icon = Research.RuneIndex(rune, 1);
                    }
                    else if (next > 0)
                    {
                        icon = 11278;
                    ...
                    AddHtml(
                        ...
                        50,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">" + Rune + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    r++;
                ...
                if (m_Page == 3 || (m_Page > 20 && m_Page < 30)) // MAGERY RESEARCH
                {
                    ...
                    int mcircleIcon = 3609;
                    if (m_Page == 21 || m_Page == 3)
                    {
                        mcircleIcon = 4017;
                    }
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">1st Circle</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    if (Research.GetWizardry(bag, 8))
                    {
                        ...
                        AddHtml(
                            ...
                            85,
                            20,
                            @"<BODY><BASEFONT Color=" + color + ">2nd Circle</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    }
                    if (Research.GetWizardry(bag, 16))
                    {
                        ...
                        AddHtml(
                            ...
                            85,
                            20,
                            @"<BODY><BASEFONT Color=" + color + ">3rd Circle</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    }
                    if (Research.GetWizardry(bag, 24))
                    {
                        ...
                        AddHtml(
                            ...
                            85,
                            20,
                            @"<BODY><BASEFONT Color=" + color + ">4th Circle</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    }
                    if (Research.GetWizardry(bag, 32))
                    {
                        ...
                        AddHtml(
                            ...
                            85,
                            20,
                            @"<BODY><BASEFONT Color=" + color + ">5th Circle</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    }
                    if (Research.GetWizardry(bag, 40))
                    {
                        ...
                        AddHtml(
                            ...
                            85,
                            20,
                            @"<BODY><BASEFONT Color=" + color + ">6th Circle</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    }
                    if (Research.GetWizardry(bag, 48))
                    {
                        ...
                        AddHtml(
                            ...
                            85,
                            20,
                            @"<BODY><BASEFONT Color=" + color + ">7th Circle</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    }
                    if (Research.GetWizardry(bag, 56))
                    {
                        ...
                        AddHtml(
                            ...
                            85,
                            20,
                            @"<BODY><BASEFONT Color=" + color + ">8th Circle</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    }
                    ...
                    if (Research.GetWizardry(bag, spellName))
                    {
                        ...
                        AddHtml(
                            ...
                            @"<BODY><BASEFONT Color="
                                + color
                                + ">"
                                + Research.ScrollInformation(spellName, 2)
                                + "</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    ...
                    string msg =
                        "You have researched all of the " + spellCircle + " circle magery spells.";
                    ...
                    if (Research.GetNecromancy(bag, spellName))
                    {
                        ...
                        AddHtml(
                            ...
                            @"<BODY><BASEFONT Color="
                                + color
                                + ">"
                                + Research.ScrollInformation(spellName + 64, 2)
                                + "</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                ...
                if (m_Page == 5 || (m_Page > 30 && m_Page < 40)) // ANCIENT RESEARCH //////////////////////////////////////////////////////////////////////////////////////////////////////////////
                {
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Conjuration</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Death</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Enchanting</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Sorcery</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Summoning</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        95,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Thaumaturgy</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Theurgy</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        85,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Wizardry</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    {
                        spellName = 5;
                        spellCircle = "summoning";
                    }
                    else if (m_Page == 36)
                    {
                        spellName = 6;
                        spellCircle = "thaumaturgy";
                    }
                    else if (m_Page == 37)
                    {
                        spellName = 7;
                    ...
                    string msg =
                        "You have researched all of the ancient " + spellCircle + " magic.";
                ...
                if (m_Page == 6 || (m_Page > 40 && m_Page < 50)) // ANCIENT PREPARED SPELLS ///////////////////////////////////////////////////////////////////////////////////////////////////////
                {
                    ...
                    {
                        PrepareColor = "" + color + "";
                        IsPrepared = Research.GetPrepared(bag, spellName);
                        if (IsPrepared > 10)
                        {
                            PrepareColor = "#15E650";
                        }
                        ...
                        AddImage(
                            120 + r,
                            305,
                            Int32.Parse(Research.SpellInformation(spellName, 11))
                        );
                        AddButton(
                            170 + r,
                            315,
                ...
                else if (m_Page == 16) //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                {
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">As you learn these spells, you can begin to scribe them if you have the skills, mana, and resources to do so. Once scribed, the scroll will remain in your bag until you choose to cast it. As you cast these spells, the scribed scrolls will be depleted. Those enhanced with lower reagent qualities, may be able to keep the scrolls from crumbling to dust upon casting but that is not guaranteed. To cast a spell from this window, select the arrow button next to the spell icon. Each spell listed has a scroll button that displays the information about the spell. Look over the information to see what you will need to attempt to scribe the scroll. All scrolls require a certain inscription skill and mana to attempt, but also a blank scroll, quill, and reagents. You can attempt to scribe the scroll from the information window by pressing the scroll button if you choose to only scribe a single scroll. You can also press the other button to scribe as many scrolls as you have reagents, quills, and blank scrolls. When you scribe many at once, you only need the required mana as though you were scribing a single scroll, but the resources multiply toward the total quantity that is to be created. Lower reagent attributes do not work toward reagents needing to scribe these spells. If you fail in your attempt, there is a chance that some of the materials will be lost.</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                }
                ...
                AddHtml(
                    ...
                    382,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">" + titleTxt + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                {
                    from.SendGump(
                        new SpellInformation(m_Bag, from, m_Bag.BagPage, (info.ButtonID - 300), 0)
                    );
                }
                ...
                {
                    from.SendGump(
                        new SpellInformation(m_Bag, from, m_Bag.BagPage, (info.ButtonID - 500), 1)
                    );
                }
                ...
                {
                    from.SendGump(
                        new SpellInformation(m_Bag, from, m_Bag.BagPage, (info.ButtonID - 700), 1)
                    );
                }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Bag_Scrolls
        {
            get { return BagScrolls; }
            set
            {
                BagScrolls = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Bag_Quills
        {
            get { return BagQuills; }
            set
            {
                BagQuills = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Bag_InkLocation
        {
            get { return BagInkLocation; }
            set
            {
                BagInkLocation = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Bag_InkWorld
        {
            get { return BagInkWorld; }
            set
            {
                BagInkWorld = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Bag_Message
        {
            get { return BagMessage; }
            set
            {
                BagMessage = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Bag_MsgString
        {
            get { return BagMsgString; }
            set
            {
                BagMsgString = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Spells_Magery
        {
            get { return SpellsMagery; }
            set
            {
                SpellsMagery = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Spells_MageLocation
        {
            get { return SpellsMageLocation; }
            set
            {
                SpellsMageLocation = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Spells_MageWorld
        {
            get { return SpellsMageWorld; }
            set
            {
                SpellsMageWorld = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Spells_MageItem
        {
            get { return SpellsMageItem; }
            set
            {
                SpellsMageItem = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Spells_Necromancy
        {
            get { return SpellsNecromancy; }
            set
            {
                SpellsNecromancy = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Spells_NecroLocation
        {
            get { return SpellsNecroLocation; }
            set
            {
                SpellsNecroLocation = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Spells_NecroWorld
        {
            get { return SpellsNecroWorld; }
            set
            {
                SpellsNecroWorld = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Spells_NecroItem
        {
            get { return SpellsNecroItem; }
            set
            {
                SpellsNecroItem = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Rune_Found
        {
            get { return RuneFound; }
            set
            {
                RuneFound = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Rune_Location
        {
            get { return RuneLocation; }
            set
            {
                RuneLocation = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Rune_World
        {
            get { return RuneWorld; }
            set
            {
                RuneWorld = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Research_Spells
        {
            get { return ResearchSpells; }
            set
            {
                ResearchSpells = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Research_Location
        {
            get { return ResearchLocation; }
            set
            {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Research_World
        {
            get { return ResearchWorld; }
            set
            {
                ResearchWorld = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Research_Prep1
        {
            get { return ResearchPrep1; }
            set
            {
                ResearchPrep1 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Research_Prep2
        {
            get { return ResearchPrep2; }
            set
            {
                ResearchPrep2 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string Bars_Cast1
        {
            get { return BarsCast1; }
            set
            {
                BarsCast1 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string Bars_Cast2
        {
            get { return BarsCast2; }
            set
            {
                BarsCast2 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string Bars_Cast3
        {
            get { return BarsCast3; }
            set
            {
                BarsCast3 = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string Bars_Cast4
        {
            get { return BarsCast4; }
            set
            {
                BarsCast4 = value;
                InvalidateProperties();
        ...
        public ResearchBag(Serial serial)
            : base(serial) { }
        ...
        private class SpellInformation : Gump
        {
            ...
            public SpellInformation(ResearchBag bag, Mobile from, int page, int spell, int area)
                : base(50, 50)
            {
                from.SendSound(0x55);
                string color = "#ddbc4b";
                ...
                if (area > 0)
                {
                    ...
                    if (cubes.Length > 0)
                    {
                        ...
                        foreach (string rune in cube)
                        {
                            ...
                            if (box == 1)
                            {
                                AddImage(68, 88, Research.RuneIndex(rune, 1));
                            }
                            else if (box == 2)
                            {
                                AddImage(109, 88, Research.RuneIndex(rune, 1));
                            }
                            else if (box == 3)
                            {
                                AddImage(150, 88, Research.RuneIndex(rune, 1));
                            }
                            else if (box == 4)
                            {
                                AddImage(191, 88, Research.RuneIndex(rune, 1));
                            }
                        }
                    }
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + Research.SpellInformation(spell, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + Research.SpellInformation(spell, 3)
                            + " School of Magic<br><br>"
                            + Research.SpellInformation(spell, 6)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + Research.SpellInformation(spell, 7)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + Research.SpellInformation(spell, 8)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        30,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">1</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    AddItem(481, 97, 8273);
                    ...
                    if (reagents.Contains(", "))
                    {
                        reagents = reagents.Replace(", ", "<br>");
                    }
                    ...
                    AddHtml(
                        ...
                        120,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Scribe One</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    AddHtml(
                        ...
                        120,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Scribe Most</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                ...
                else
                {
                    ...
                    AddHtml(
                        ...
                        160,
                        20,
                        @"<BODY><BASEFONT Color=" + color + ">Scribe Spell</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + Research.ScrollInformation(spell, 2)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + Research.ScrollInformation(spell, 1)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    ...
                    AddHtmlLocalized(
                        ...
                        578,
                        282,
                        Int32.Parse(Research.ScrollInformation(spell, 6)),
                        0x7FFF,
                        false,
                        false
                    );
                    ...
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + Research.ScrollInformation(spell, 5)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
                    AddHtml(
                        ...
                        @"<BODY><BASEFONT Color="
                            + color
                            + ">"
                            + Research.ScrollInformation(spell, 4)
                            + "</BASEFONT></BODY>",
                        (bool)false,
                        (bool)false
                    );
