...
namespace Server.Spells.Research
{
    public class ResearchDevastation : ResearchSpell
    {
                    ...
                    foreach (Mobile m in eable)
                    {
                        ...
                        )
                        {
                            ...
                            if (m.Mounted)
                            {
                                ...
                                {
                                    if (
                                        ((Mobile)mount).Blessed == false
                                        && Caster.CanBeHarmful(((Mobile)mount), true)
                                    )
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(ResearchDevastation owner)
        ...
        public class DeathTimer : Timer
        {
            ...
            public DeathTimer(Mobile suicide, TimeSpan duration)
            ...
            protected override void OnTick()
            {
                if (DateTime.Now >= m_Expire)
                {
                    ...
                    Effects.SendLocationEffect(
                        ...
                        30,
                        10,
                        Server.Misc.PlayerSettings.GetMySpellHue(true, m_m, 0),
                        0
                    );
                    m_m.PlaySound(0x029);
