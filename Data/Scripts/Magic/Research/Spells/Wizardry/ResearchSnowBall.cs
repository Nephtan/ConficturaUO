...
namespace Server.Spells.Research
{
    public class ResearchSnowBall : ResearchSpell
    {
        ...
        public ResearchSnowBall(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckHSequence(m))
            {
                ...
                double baseDamage = DamagingSkill(Caster) / 3;
                if (baseDamage > 80)
                {
                    baseDamage = 80.0;
                }
                ...
                source.MovingParticles(
                    ...
                    false,
                    true,
                    Server.Misc.PlayerSettings.GetMySpellHue(true, Caster, 0xBB3),
                    0,
                    9502,
                    4019,
                    0x160,
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(ResearchSnowBall owner)
