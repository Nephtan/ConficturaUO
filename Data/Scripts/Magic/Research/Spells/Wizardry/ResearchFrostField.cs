    ...
    public class ResearchFrostField : ResearchSpell
    {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                for (int i = -2; i <= 2; ++i)
                {
                    Point3D loc = new Point3D(
                        eastToWest ? p.X + i : p.X,
                        eastToWest ? p.Y : p.Y + i,
                        p.Z
                    );
        ...
        public class FrostFieldItem : Item
        {
                ...
                : base(itemID)
            {
                ...
                Hue = Server.Misc.PlayerSettings.GetMySpellHue(false, caster, 0x480);
                ...
                m_Timer = new InternalTimer(
                    this,
                    TimeSpan.FromSeconds(Math.Abs(val) * 0.2),
                    caster.InLOS(this),
                    canFit
                );
                m_Timer.Start();
            ...
            public FrostFieldItem(Serial serial)
                : base(serial) { }
            ...
            private class InternalTimer : Timer
            {
                ...
                private bool m_InLOS,
                    m_CanFit;

                private static Queue m_Queue = new Queue();

                public InternalTimer(FrostFieldItem item, TimeSpan delay, bool inLOS, bool canFit)
                    ...
                    if (!m_Item.Visible)
                    {
                        ...
                        if (!m_Item.Deleted)
                        {
                            ...
                            Effects.SendLocationParticles(
                                ...
                                9,
                                10,
                                Server.Misc.PlayerSettings.GetMySpellHue(
                                    true,
                                    m_Item.m_Caster,
                                    0xB77
                                ),
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(ResearchFrostField owner)
