...
namespace Server.Spells.Research
{
    public class ResearchGrantPeace : ResearchSpell
    {
        ...
        public ResearchGrantPeace(Mobile caster, Item scroll)
        ...
        public void Target(Mobile m)
        {
            ...
            else if (m is BaseCreature)
            {
                ...
                double baseDamage = DamagingSkill(Caster) - 30;
                ...
                else if (CheckHSequence(m))
                {
                    ...
                    {
                        Caster.SendMessage(
                            "You fail at your attempt, but did cause some energy damage."
                        );
                        Caster.FixedParticles(0x3709, 10, 30, 5052, 0x480, 0, EffectLayer.LeftFoot);
                        Caster.PlaySound(0x208);
                        SpellHelper.Damage(this, Caster, damage, 0, 0, 0, 0, 100);
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(ResearchGrantPeace owner)
