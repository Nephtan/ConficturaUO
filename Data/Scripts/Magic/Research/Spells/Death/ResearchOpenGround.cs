...
namespace Server.Spells.Research
{
    public class ResearchOpenGround : ResearchSpell
    {
        ...
        {
            get { return TimeSpan.FromSeconds(2.00); }
        }
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                else
                {
                    ...
                    while (cycle > 0)
                    {
                        ...
                        if (cycle == 25)
                        {
                            piT.ItemID = Utility.RandomList(0x4CC8, 0x4CC9);
                            piT.Visible = true;
                        }
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(ResearchOpenGround owner)
...
namespace Server.Items
{
    public class OpenGround : Item
    {
        ...
        {
            get { return TimeSpan.FromSeconds(60.0); }
        } // HOW LONG UNTIL THE TRAP DECAYS IN SECONDS

        [Constructable]
        public OpenGround(Mobile source)
            : base(0x1B72)
        {
            Movable = false;
            Visible = false;
        ...
        public OpenGround(Serial serial)
            : base(serial) { }
