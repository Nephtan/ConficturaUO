...
namespace Server.Spells.Research
{
    public class ResearchCharm : ResearchSpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            {
                Caster.SendMessage(
                    "You cannot charm supernatural creatures, golems, constructs, or elementals."
                );
            }
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(ResearchCharm owner)
        ...
        public class CharmTimer : Timer
        {
            ...
            public CharmTimer(Mobile charmed, TimeSpan duration)
            ...
            protected override void OnTick()
            {
                ...
                if (m_Time > 60)
                {
                    ...
                    Effects.SendLocationParticles(
                        EffectItem.Create(charm, m_m.Map, EffectItem.DefaultDuration),
                        0x3039,
                        9,
                        32,
                        0x48F,
                ...
                if (DateTime.Now >= m_Expire)
                {
                    ...
                    if (bc.FightMode == FightMode.CharmMonster)
                    {
                        bc.FightMode = FightMode.Closest;
                    }
                    else if (bc.FightMode == FightMode.CharmAnimal)
                    {
