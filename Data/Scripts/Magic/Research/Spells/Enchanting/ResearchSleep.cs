...
namespace Server.Spells.Research
{
    public class ResearchSleep : ResearchSpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            {
                Caster.SendMessage(
                    "This spell cannot affect supernatural creatures, golems, constructs, or elementals."
                );
            }
            else if (CheckHSequence(m))
            {
                ...
                m.FixedParticles(
                    ...
                    32,
                    5008,
                    Server.Misc.PlayerSettings.GetMySpellHue(true, Caster, 0xB72),
                    0,
                    EffectLayer.Waist
                );
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(ResearchSleep owner)
        ...
        public class SleepyTimer : Timer
        {
            ...
            public SleepyTimer(Mobile sleeper, TimeSpan duration)
            ...
            protected override void OnTick()
            {
                ...
                if (m_Time > 30)
                {
                    ...
                    Effects.SendLocationParticles(
                        EffectItem.Create(zzz, m_m.Map, EffectItem.DefaultDuration),
                        0x4B4E,
                        9,
                        32,
                        0xB71,
