    ...
    public class ResearchConflagration : ResearchSpell
    {
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                int damage = (int)(DamagingSkill(Caster) / 15);
                if (damage > 16)
                {
                    damage = 16;
                }
                ...
                while (fires > 0)
                {
                    if (fires == 13)
                    {
                        loc = new Point3D(x, y - 2, p.Z);
                    }
                    else if (fires == 12)
                    {
                        loc = new Point3D(x - 1, y - 1, p.Z);
                    }
                    else if (fires == 11)
                    {
                        loc = new Point3D(x, y - 1, p.Z);
                    }
                    else if (fires == 10)
                    {
                        loc = new Point3D(x + 1, y - 1, p.Z);
                    ...
                    {
                        loc = new Point3D(x - 2, y, p.Z);
                    }
                    else if (fires == 8)
                    {
                        loc = new Point3D(x - 1, y, p.Z);
                    }
                    else if (fires == 7)
                    {
                        loc = new Point3D(x + 1, y, p.Z);
                    ...
                    if (!m_Item.Visible)
                    {
                        ...
                        if (!m_Item.Deleted)
                        {
                            ...
                            Effects.SendLocationParticles(
                                ...
                                9,
                                10,
                                Server.Misc.PlayerSettings.GetMySpellHue(true, m_Item.m_Caster, 0),
                                0,
                                5029,
                                0
                            );
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(ResearchConflagration owner)
