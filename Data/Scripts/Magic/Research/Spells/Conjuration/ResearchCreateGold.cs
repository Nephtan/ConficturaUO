        ...
        private class InternalTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (
                    ...
                    || targeted is BaseWeapon
                    || targeted is DDRelicCoins
                    || targeted is DDCopper
                    || targeted is DDSilver
                    || targeted is DDXormite
                )
                {
                    TurnToGold = true;
                }
                ...
                if (TurnToGold)
                {
                    ...
                    from.FixedParticles(
                        ...
                        32,
                        5008,
                        Server.Misc.PlayerSettings.GetMySpellHue(true, from, 0xAD3),
                        0,
                        EffectLayer.Waist
                    );
                }
