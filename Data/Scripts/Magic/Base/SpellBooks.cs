...
namespace Server.Items
{
    public class MyNecromancerSpellbook : NecromancerSpellbook
    {
        ...
        public MyNecromancerSpellbook()
        {
            ...
            Server.Misc.BookProperties.GetBookProperties(
                this,
                Utility.RandomMinMax(3, 7),
                Utility.RandomMinMax(25, 75)
            );
        }

        public MyNecromancerSpellbook(Serial serial)
            : base(serial) { }
    ...
    public class MyElementalSpellbook : ElementalSpellbook ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        public MyElementalSpellbook()
        {
            ...
            switch (Utility.RandomMinMax(0, 3))
            {
                case 0:
                    this.Name =
                        Server.Misc.RandomThings.GetRandomBelongsTo("regular") + " " + " Spellbook";
                    break;
                case 1:
                    this.Name =
                        Server.Misc.RandomThings.GetRandomBelongsTo("regular")
            ...
            switch (Utility.Random(12))
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    this.Content = 0xFFFFF;
                    break;
                case 5:
                    this.Content = 0xFFFFFF;
                    break;
                case 6:
                    this.Content = 0xFFFFFFF;
                    break;
                case 7:
                    this.Content = 0xFFFFFFFF;
                    break;
            }
        ...
        public MyElementalSpellbook(Serial serial)
            : base(serial) { }
    ...
    public class MySpellbook : Spellbook ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        public MySpellbook()
        {
            ...
            switch (Utility.Random(20))
            {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    this.Content = 0xFFFFFFFFF;
                    break;
                case 9:
                    this.Content = 0xFFFFFFFFFF;
                    break;
                case 10:
                    this.Content = 0xFFFFFFFFFFF;
                    break;
                case 11:
                    this.Content = 0xFFFFFFFFFFFF;
                    break;
                case 12:
                    this.Content = 0xFFFFFFFFFFFFF;
                    break;
                case 13:
                    this.Content = 0xFFFFFFFFFFFFFF;
                    break;
                case 14:
                    this.Content = 0xFFFFFFFFFFFFFFF;
                    break;
                case 15:
                    this.Content = 0xFFFFFFFFFFFFFFFF;
                    break;
            }
        ...
        public MySpellbook(Serial serial)
            : base(serial) { }
    ...
    public class MyNinjabook : BookOfNinjitsu ///////////////////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        public MyNinjabook()
        {
            ...
            switch (Utility.RandomMinMax(0, 3))
            {
                case 0:
                    this.Name =
                        Server.Misc.RandomThings.GetRandomBelongsTo("orient")
                        + " "
                        + Server.Misc.RandomThings.GetRandomBookType(1)
                        + " of the Ninja Arts";
                    break;
        ...
        public MyNinjabook(Serial serial)
            : base(serial) { }
    ...
    public class MySamuraibook : BookOfBushido //////////////////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        public MySamuraibook(Serial serial)
            : base(serial) { }
    ...
    public class MyPaladinbook : BookOfChivalry /////////////////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        public MyPaladinbook(Serial serial)
            : base(serial) { }
    ...
    public class MySongbook : SongBook //////////////////////////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        public MySongbook(Serial serial)
            : base(serial) { }
    ...
    class BookProperties
    {
        public static void GetBookProperties(Spellbook book, int nCycle, int nChance)
        {
            ...
            if (book is MyNecromancerSpellbook || book is MySpellbook)
            {
                ...
                while (cycle > 0)
                {
                    if (chance >= Utility.RandomMinMax(1, 100))
                    {
                        ...
                        {
                            case 0:
                                book.Attributes.BonusDex = Utility.RandomMinMax(1, 5);
                                break;
                            case 1:
                                book.Attributes.BonusHits = Utility.RandomMinMax(5, 20);
                                break;
                            case 2:
                                book.Attributes.BonusInt = Utility.RandomMinMax(1, 5);
                                break;
                            case 3:
                                book.Attributes.BonusMana = Utility.RandomMinMax(5, 20);
                                break;
                            case 4:
                                book.Attributes.BonusStam = Utility.RandomMinMax(5, 20);
                                break;
                            case 5:
                                book.Attributes.BonusStr = Utility.RandomMinMax(1, 5);
                                break;
                            case 6:
                                book.Attributes.CastRecovery = Utility.RandomMinMax(1, 5);
                                break;
                            case 7:
                                book.Attributes.CastSpeed = Utility.RandomMinMax(1, 5);
                                break;
                            case 8:
                                book.Attributes.LowerManaCost = Utility.RandomMinMax(2, 20);
                                break;
                            case 9:
                                book.Attributes.LowerRegCost = Utility.RandomMinMax(2, 20);
                                break;
                            case 10:
                                book.Attributes.Luck = Utility.RandomMinMax(1, 20);
                                break;
                            case 11:
                                book.Attributes.NightSight = 1;
                                break;
                            case 12:
                                book.Attributes.ReflectPhysical = Utility.RandomMinMax(5, 25);
                                break;
                            case 13:
                                book.Attributes.RegenHits = Utility.RandomMinMax(1, 5);
                                break;
                            case 14:
                                book.Attributes.RegenMana = Utility.RandomMinMax(1, 5);
                                break;
                            case 15:
                                book.Attributes.RegenStam = Utility.RandomMinMax(1, 5);
                                break;
                            case 16:
                                book.Attributes.SpellDamage = Utility.RandomMinMax(5, 25);
                                break;
                        }
                    }
                    ...
                    if (chance >= Utility.RandomMinMax(1, 100))
                    {
                        switch (Utility.RandomMinMax(0, 15))
                        {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                book.Attributes.AttackChance = Utility.RandomMinMax(1, 15);
                                break;
                            case 6:
                                book.Attributes.DefendChance = Utility.RandomMinMax(1, 15);
                                break;
                            case 7:
                                book.Attributes.EnhancePotions = Utility.RandomMinMax(5, 25);
                                break;
                            case 8:
                                book.Attributes.WeaponDamage = Utility.RandomMinMax(1, 25);
                                break;
                            case 9:
                                book.Attributes.WeaponSpeed = Utility.RandomMinMax(1, 2);
                                break;
                            case 10:
                                book.Attributes.Luck = Utility.RandomMinMax(1, 20);
                                break;
            ...
            if (chance >= Utility.Random(100))
            {
                ...
                {
                    book.SkillBonuses.SetValues(
                        2,
                        m_MiscDeadSkills[Utility.Random(m_MiscDeadSkills.Length)],
                        Utility.RandomMinMax(1, 10)
                    );
                }
                else
                {
                    book.SkillBonuses.SetValues(
                        2,
                        m_MiscSkills[Utility.Random(m_MiscSkills.Length)],
                        Utility.RandomMinMax(1, 10)
                    );
                }
            }
