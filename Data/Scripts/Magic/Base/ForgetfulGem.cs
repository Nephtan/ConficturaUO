    ...
    public class ForgetfulGem : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (
                ...
                || from.Skills[SkillName.Elementalism].Base > 0
            )
            {
        ...
        {
            public CrystalGump(Mobile from, int page)
                : base(50, 50)
            {
                ...
                AddHtml(
                    ...
                    357,
                    20,
                    @"<BODY><BASEFONT Color=" + color + ">CRYSTAL OF WIZARDRY</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                else if (page == 2)
                {
                    ...
                    if (from.Skills[SkillName.Elementalism].Base > 0)
                    {
                        AddHtml(
                            ...
                            @"<BODY><BASEFONT Color="
                                + color
                                + ">Forget Elementalism</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    ...
                    if (from.Skills[SkillName.Magery].Base > 0)
                    {
                        AddHtml(
                            ...
                            357,
                            20,
                            @"<BODY><BASEFONT Color=" + color + ">Forget Magery</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
                    ...
                    if (from.Skills[SkillName.Necromancy].Base > 0)
                    {
                        AddHtml(
                            ...
                            @"<BODY><BASEFONT Color="
                                + color
                                + ">Forget Necromancy</BASEFONT></BODY>",
                            (bool)false,
                            (bool)false
                        );
        ...
        public ForgetfulGem(Serial serial)
            : base(serial) { }
