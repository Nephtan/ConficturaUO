...
namespace Server.Spells.Bushido
{
    ...
    {
        private static SpellInfo m_Info = new SpellInfo("Evasion", null, -1, 9002);
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                Timer.DelayCall(
                    ...
                    delegate
                    {
                        Caster.EndAction(typeof(Evasion));
                    }
                );
            }
        ...
        public static TimeSpan GetEvadeDuration(Mobile m)
        {
            ...
            if (
                m.Skills.Anatomy.Value >= 100.0
                && m.Skills.Tactics.Value >= 100.0
                && m.Skills.Bushido.Value > 100.0
        ...
        public static double GetParryScalar(Mobile m)
        {
            ...
            if (
                m.Skills.Anatomy.Value >= 100
                && m.Skills.Tactics.Value >= 100
                && m.Skills.Bushido.Value > 100
            ) //Bushido being HIGHER than 100 for bonus is intended
                bonus += 0.10;
