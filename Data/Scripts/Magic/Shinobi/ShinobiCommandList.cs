    ...
    public class CastShinobiSpells
    {
        public static void Initialize()
        {
            ...
            Register(
                "CheetahPaws",
                AccessLevel.Player,
                new CommandEventHandler(CheetahPaws_OnCommand)
            );
            ...
            Register(
                "FerretFlee",
                AccessLevel.Player,
                new CommandEventHandler(FerretFlee_OnCommand)
            );

            Register(
                "MonkeyLeap",
                AccessLevel.Player,
                new CommandEventHandler(MonkeyLeap_OnCommand)
            );

            Register(
                "MysticShuriken",
                AccessLevel.Player,
                new CommandEventHandler(MysticShuriken_OnCommand)
            );

            Register(
                "TigerStrength",
                AccessLevel.Player,
                new CommandEventHandler(TigerStrength_OnCommand)
            );
        }
