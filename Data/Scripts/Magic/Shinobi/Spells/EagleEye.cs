...
namespace Server.Spells.Shinobi
{
    public class EagleEye : ShinobiSpell
    {
        ...
        private static SpellInfo m_Info = new SpellInfo("Eagle Eye", "Surudoi Me", -1, 0);
        ...
        public EagleEye(Mobile caster, Item scroll)
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (CheckSequence())
            {
                ...
                IPooledEnumerable TitemsInRange = Caster.Map.GetItemsInRange(
                    new Point3D(p),
                    1 + (int)(Caster.Skills[SkillName.Ninjitsu].Value / 20.0)
                );
                string sTrap;
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(EagleEye owner)
