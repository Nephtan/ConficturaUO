...
namespace Server.Spells.Shinobi
{
    public class Espionage : ShinobiSpell
    {
        ...
        private static SpellInfo m_Info = new SpellInfo("Espionage", "Supai", -1, 0);
        ...
        public override double RequiredSkill
        {
            ...
            {
                return (double)(
                    Int32.Parse(Server.Items.ShinobiScroll.ShinobiInfo(spellIndex, "skill"))
                );
            }
        }
        public override int RequiredTithing
        {
            get
            {
                return Int32.Parse(Server.Items.ShinobiScroll.ShinobiInfo(spellIndex, "points"));
            }
        }
        ...
        public Espionage(Mobile caster, Item scroll)
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(Espionage owner)
            ...
            protected override void OnTarget(Mobile from, object o)
            {
                ...
                if (m_Owner.CheckSequence())
                {
                    ...
                    {
                        from.SendMessage(
                            "This ability is to unlock certain containers and other types of doors."
                        );
                    }
                    ...
                    else
                    {
                        ...
                        {
                            from.SendMessage(
                                "A magical aura on this long lost treasure will always be too much for your abilities."
                            );
                        }
                        ...
                        {
                            from.SendMessage(
                                "This seems to be protected from magic, but maybe an actual lock picker can get it open."
                            );
                        }
                        else
                        {
                            ...
                            )
                            {
                                ...
                                from.SendMessage(
                                    "Your ability does not seem to have an effect on that lock!"
                                );
                        }
                    }
                }
