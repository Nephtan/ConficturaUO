...
namespace Server.Spells.Shinobi
{
    public class CheetahPaws : ShinobiSpell
    {
        ...
        private static SpellInfo m_Info = new SpellInfo("Cheetah Paws", "Chita no ashi", -1, 0);
        ...
        public CheetahPaws(Mobile caster, Item scroll)
        ...
        public override void OnCast()
        {
            ...
            {
                Caster.SendMessage(
                    "You cannot use this ability while wearing those magical shoes!"
                );
            }
