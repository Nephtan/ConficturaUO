...
namespace Server.Spells.Shinobi
{
    public class MonkeyLeap : ShinobiSpell
    {
        ...
        private static SpellInfo m_Info = new SpellInfo("Monkey Leap", "Monkiripu", -1, 0);
        ...
        public MonkeyLeap(Mobile caster, Item scroll)
        ...
        public void Target(IPoint3D p)
        {
            ...
            if (Server.Misc.WeightOverloading.IsOverloaded(Caster))
            {
                ...
                !SpellHelper.CheckTravel(Caster, map, new Point3D(p), TravelCheckType.TeleportTo)
            ) { }
        ...
        public class InternalTarget : Target
        {
            ...
            public InternalTarget(MonkeyLeap owner)
