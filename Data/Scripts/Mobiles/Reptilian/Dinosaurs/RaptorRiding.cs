...
namespace Server.Mobiles
{
    ...
    public class RaptorRiding : BaseMount
    {
        ...
        [Constructable]
        public RaptorRiding(string name)
            : base(name, 218, 16036, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0x5A;
        ...
        public override void OnAfterSpawn()
        {
            ...
            if (Worlds.GetMyWorld(this.Map, this.Location, this.X, this.Y) == "the Underworld")
            {
                ...
                Worlds.GetMyWorld(this.Map, this.Location, this.X, this.Y) == "the Isles of Dread"
            )
            {
                this.Body = 117;
            }
        ...
        public RaptorRiding(Serial serial)
            : base(serial) { }
