    ...
    public class Slitheran : BaseCreature
    {
        ...
        public override void OnGaveMeleeAttack(Mobile m)
        {
            ...
            if (1 == Utility.RandomMinMax(1, 20))
            {
                ...
                {
                    if (
                        Server.Items.HiddenTrap.IAmShielding(m, 120)
                    ...
                    else if (Server.Items.HiddenTrap.CheckInsuranceOnTrap(iWrapped, m) == true)
                    {
                        m.LocalOverheadMessage(
                            ...
                            1150,
                            true,
                            "Slime almost covered one of your protected items!"
                        );
                    }
                    else
                    {
                        m.LocalOverheadMessage(
                            ...
                            0xB1F,
                            true,
                            "One of your items is covered in slime!"
                        );
                        m.PlaySound(0x364);
        ...
        public Slitheran(Serial serial)
            : base(serial) { }
