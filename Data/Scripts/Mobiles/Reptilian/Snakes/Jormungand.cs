...
namespace Server.Mobiles
{
    ...
    public class Jormungandr : BaseCreature
    {
            ...
            if (killer != null)
            {
                ...
                if (killer is PlayerMobile)
                {
                    if (GetPlayerInfo.LuckyKiller(killer.Luck))
                    {
                        ...
                        string waters = Server.Misc.Worlds.GetRegionName(
                            killer.Map,
                            killer.Location
                        );
                    ...
                    if (
                        ...
                        && !Server.Misc.PlayerSettings.GetSpecialsKilled(killer, "Jormungandr")
                    )
                    {
        ...
        public Jormungandr(Serial serial)
            : base(serial) { }
...
namespace Server.Items
{
    ...
    public class StatueJormungandr : BaseStatue
    {
        ...
        public string Animal_Killer
        {
            get { return AnimalKiller; }
            set
            {
                AnimalKiller = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Animal_Where
        {
            get { return AnimalWhere; }
            set
            {
                AnimalWhere = value;
                InvalidateProperties();
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (AnimalWhere != "" && AnimalWhere != null)
            {
                list.Add(1070722, AnimalWhere);
            }
            if (AnimalKiller != "" && AnimalKiller != null)
            {
                list.Add(1049644, AnimalKiller);
            }
        }

        public StatueJormungandr(Serial serial)
            : base(serial) { }
