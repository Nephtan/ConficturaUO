...
namespace Server.Mobiles
{
    ...
    public class RandomSerpent : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 1:
                    m_Poison = Poison.Lethal;
                    difficulty = 60;
                    m_Treasure = Utility.RandomMinMax(1, 5);
                ...
                case 2:
                    ...
                    difficulty = 45;
                    m_Treasure = Utility.RandomMinMax(1, 4);
                    Item Venom2 = new VenomSack();
                    Venom2.Name = "deadly venom sack";
                    AddItem(Venom2);
                    break;
                case 3:
                    m_Poison = Poison.Greater;
                    difficulty = 30;
                    m_Treasure = Utility.RandomMinMax(1, 3);
                    Item Venom3 = new VenomSack();
                    Venom3.Name = "greater venom sack";
                    AddItem(Venom3);
                    break;
                case 4:
                    m_Poison = Poison.Regular;
                    difficulty = 15;
                    m_Treasure = Utility.RandomMinMax(1, 2);
                    Item Venom4 = new VenomSack();
                    Venom4.Name = "venom sack";
                    AddItem(Venom4);
                    break;
                case 5:
                    m_Poison = Poison.Lesser;
                    difficulty = 0;
                    m_Treasure = Utility.RandomMinMax(1, 1);
                    Item Venom5 = new VenomSack();
                    Venom5.Name = "lesser venom sack";
                    AddItem(Venom5);
                    break;
            }
        ...
        public override void OnAfterSpawn()
        {
            ...
            switch (Utility.RandomMinMax(0, 20))
            {
                ...
                case 12:
                    ...
                    break; // Copper
                case 13:
                    Hue = MaterialInfo.GetMaterialColor("verite", "monster", Hue);
                    break; // Verite
                case 14:
                    Hue = MaterialInfo.GetMaterialColor("valorite", "monster", Hue);
                    break; // Valorite
                case 15:
                    Hue = MaterialInfo.GetMaterialColor("agapite", "monster", Hue);
                    break; // Agapite
                case 16:
                    Hue = MaterialInfo.GetMaterialColor("bronze", "monster", Hue);
                    break; // Bronze
                case 17:
                    Hue = MaterialInfo.GetMaterialColor("dull copper", "monster", Hue);
                    break; // Dull Copper
                case 18:
                    Hue = MaterialInfo.GetMaterialColor("gold", "monster", Hue);
                    break; // Gold
                case 19:
                    Hue = MaterialInfo.GetMaterialColor("shadow iron", "monster", Hue);
                    break; // Shadow Iron
                case 20:
                    ...
                    {
                        Hue = MaterialInfo.GetMaterialColor("mithril", "monster", Hue);
                    }
        ...
        public RandomSerpent(Serial serial)
            : base(serial) { }
