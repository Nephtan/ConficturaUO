...
namespace Server.Mobiles
{
    ...
    {
        [Constructable]
        public BasiliskRiding()
            : this("a basilisk") { }

        [Constructable]
        public BasiliskRiding(string name)
            : base(name, 483, 483, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Hue = 0x9C4;
            BaseSoundID = 0x5A;
                ...
                if (iStone != null)
                {
                    ...
                    else if (Server.Items.HiddenTrap.CheckInsuranceOnTrap(iStone, m) == true)
                    {
                        m.LocalOverheadMessage(
                            ...
                            1150,
                            true,
                            "The basilisk almost turned one of your protected items to stone!"
                        );
                    }
                    else
                    {
        ...
        public BasiliskRiding(Serial serial)
            : base(serial) { }
