...
namespace Server.Mobiles
{
    public class BaneOfInsanity : BaseCreature
    {
            ...
            foreach (Mobile m in this.GetMobilesInRange(30))
            {
                if (m is PlayerMobile && m.Map == this.Map && !m.Blessed)
                {
                    ...
                    if (flame != null)
                    {
                        ...
                        winner = m;
                        m.SendMessage(
                            "The Orb of Logic has vanished after dispatching the Chaos Bane."
                        );
            ...
            else
            {
                ...
                if (winner is PlayerMobile)
                {
                    ...
                    LoggingFunctions.LogGenericQuest(
                        winner,
                        "has obtained the blackrock serpent of chaos"
                    );
                }
        ...
        public BaneOfInsanity(Serial serial)
            : base(serial) { }
