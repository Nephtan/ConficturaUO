...
namespace Server.Mobiles
{
    ...
    public class BaronAlmric : BaseCreature
    {
                    ...
                    if (GetPlayerInfo.LuckyKiller(killer.Luck) && Utility.RandomMinMax(1, 4) == 1)
                    {
                        switch (Utility.RandomMinMax(0, 5))
                        {
                            case 0:
                                ...
                                break;
                            case 1:
                                MagicDragonLegs legs = new MagicDragonLegs();
                                legs.DragonKiller = "Slain by Baron Almric";
                                c.DropItem(legs);
                                break;
                            case 2:
                                MagicDragonGloves gloves = new MagicDragonGloves();
                                gloves.DragonKiller = "Slain by Baron Almric";
                                c.DropItem(gloves);
                                break;
                            case 3:
                                MagicDragonArms arms = new MagicDragonArms();
                                arms.DragonKiller = "Slain by Baron Almric";
                                c.DropItem(arms);
                                break;
                            case 4:
                                MagicDragonChest chest = new MagicDragonChest();
                                chest.DragonKiller = "Slain by Baron Almric";
                                c.DropItem(chest);
                                break;
                            case 5:
                                MagicDragonHelm helm = new MagicDragonHelm();
                                helm.DragonKiller = "Slain by Baron Almric";
                                c.DropItem(helm);
                                break;
                        }
                    }
        ...
        public BaronAlmric(Serial serial)
            : base(serial) { }
