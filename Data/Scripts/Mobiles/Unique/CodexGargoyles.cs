...
namespace Server.Mobiles
{
    public class CodexGargoyleA : BaseCreature
    {
        ...
        public CodexGargoyleA(Serial serial)
            : base(serial) { }
    ...
    public class CodexGargoyleB : BaseCreature
    {
        ...
        public CodexGargoyleB(Serial serial)
            : base(serial) { }
...
namespace Server.Items
{
    public class GargoyleCodexCorpse : Item
    {
        ...
        public GargoyleCodexCorpse(Serial serial)
            : base(serial) { }
