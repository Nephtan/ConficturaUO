...
namespace Server.Items
{
    public class SpectresBox : Item
    {
        ...
        public SpectresBox(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (
                ...
                && PlayerSettings.GetBardsTaleQuest(from, "BardsTaleHarkynKey")
            )
            {
            ...
            else
            {
                ...
                from.PrivateOverheadMessage(
                    ...
                    1150,
                    false,
                    "You found a mysterious eye and a key with a dragon symbol on it.",
                    from.NetState
                );
                ...
                from.SendGump(
                    new Server.Gumps.ClueGump(
                        from,
                        "You have obtained an eye from the slain spectre, and the box has a key with a dragon symbol on it. A scribbled parchment claims it to be the Eye of Tarjan.",
                        "The Spectre's Eye"
                    )
                );
            }
