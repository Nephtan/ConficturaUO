...
namespace Server.Mobiles
{
    ...
    public class GrayDragon : BaseCreature
    {
        ...
        public GrayDragon(Serial serial)
            : base(serial) { }
...
namespace Server.Items
{
    public class GrayDragonBox : Item
    {
        ...
        public GrayDragonBox(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (
                PlayerSettings.GetBardsTaleQuest(from, "BardsTaleDragonKey")
            ...
            else
            {
                ...
                from.PrivateOverheadMessage(
                    ...
                    1150,
                    false,
                    "You found the rusty key that was around the gray dragon's neck.",
                    from.NetState
                );
                ...
                from.SendGump(
                    new Server.Gumps.ClueGump(
                        from,
                        "You found the rusty key that was around the gray dragon's neck. Perhaps it can be used on that nearby door.",
                        "Rusty Key"
                    )
                );
            }
