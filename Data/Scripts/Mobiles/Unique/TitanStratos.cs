...
namespace Server.Mobiles
{
    ...
    public class TitanStratos : BaseCreature
    {
            ...
            else if (CanKillIt == 0)
            {
                ...
                if (winner is PlayerMobile)
                {
                    LoggingFunctions.LogGenericQuest(
                        winner,
                        "has obtained the power of the air titan"
                    );
                }
                ...
                if (winner != null)
                {
                    ...
                    if (winner is PlayerMobile && !winner.Blessed)
                    {
                        ...
                        if (p != null)
                        {
                            ...
                            winner.StatCap < 300
                            && !Server.Misc.PlayerSettings.GetSpecialsKilled(winner, "TitanStratos")
                        )
                        {
                            Server.Misc.PlayerSettings.SetSpecialsKilled(
                                winner,
                ...
                if (GetPlayerInfo.LuckyKiller(winner.Luck) && Utility.RandomMinMax(1, 10) == 1)
                {
                    ...
                    switch (Utility.RandomMinMax(0, 3))
                    {
                        case 1:
                            Arty.Delete();
                            Arty = new Artifact_RobeofStratos();
                            break;
                        case 2:
                            Arty.Delete();
                            Arty = new Artifact_MantleofStratos();
                            break;
                        case 3:
                            Arty.Delete();
                            Arty = new Artifact_StratosManual();
                            break;
                    }
                    AddItem(Arty);
                }
        ...
        public TitanStratos(Serial serial)
            : base(serial) { }
