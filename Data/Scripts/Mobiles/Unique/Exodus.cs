    ...
    public class Exodus : BaseCreature
    {
        ...
        public override void OnGotMeleeAttack(Mobile attacker)
        {
            ...
            if (m_FieldActive)
            {
                ...
                attacker.SendAsciiMessage(
                    "Your weapon is less effective with the creature's magical barrier up!"
                );
...
namespace Server.Items
{
    public class DarkCoreExodus : Item
    {
        ...
        public DarkCoreExodus(Serial serial)
            : base(serial) { }
...
namespace Server.Gumps
{
    ...
    {
        public DarkCoreGump(Mobile from, string items, bool scroller)
            : base(50, 50)
        {
            from.SendSound(0x4A);
            ...
            AddHtml(
                ...
                403,
                20,
                @"<BODY><BASEFONT Color=" + color + ">SHRINE OF DILIGENCE</BASEFONT></BODY>",
                (bool)false,
                (bool)false
            );
            ...
            {
                text =
                    "To destroy the dark core and absorb its power into one of your items, you can only place a single piece of armor, weapon, trinket, clothing, or jewelry onto the shrine. Remove some of the items and try to destroy the dark core again.";
            }
            else if (items == "non")
            {
                text =
                    "To destroy the dark core and absorb its power into one of your items, you can only place a single piece of armor, weapon, trinket, clothing, or jewelry onto the shrine. Remove any of the items, that do not fall into these categories, and try to destroy the dark core again.";
            }
            else
            {
                text =
                    "Some items have an inherent magical aura bestowed upon them, that the magic of the dark core cannot enhance any further. These include Artefacts and Relics where you use enhancement points to modify. Below are the items on the shrine that cannot be affected. Once you remove them, you can try to destroy the dark core of exodus again.<br>"
                    + items
                    + "";
            }
