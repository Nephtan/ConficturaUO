...
namespace Server.Mobiles
{
    ...
    public class Mangar : BaseCreature
    {
        ...
        public void SpawnCreature(Mobile target)
        {
            ...
            IPooledEnumerable eable1 = this.GetMobilesInRange(4);
        ...
        public override bool OnBeforeDeath()
        {
            ...
            {
                case 0:
                    bSay = "You will never defeat me!";
                    break;
                case 1:
                    bSay = "I will be back!";
                    break;
                case 2:
                    bSay = "You can never stop me!";
                    break;
                case 3:
                    bSay = "I will return!";
                    break;
                case 4:
                    bSay = "You could never vanquish me!";
                    break;
            }
            ;
        ...
        private class InternalTimer : Timer
        {
            ...
            public InternalTimer(Mangar owner)
...
namespace Server.Items
{
    public class BardMangarPack : Item
    {
        ...
        public BardMangarPack(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 2))
            {
                if (PlayerSettings.GetBardsTaleQuest(from, "BardsTaleWin"))
                {
                    ...
                    from.SendMessage(
                        "A gate is open nearby. You better hurry or you will remain trapped here."
                    );
                }
                else
                {
                    ...
                    from.PrivateOverheadMessage(
                        ...
                        1150,
                        false,
                        "You have pulled Mangar's Vault toward you.",
                        from.NetState
                    );
                    from.SendMessage(
                        "A gate is open nearby. You better hurry or you will remain trapped here."
                    ...
                    from.SendGump(
                        new Server.Gumps.ClueGump(
                            from,
                            "You notice a magical gate is open nearby. You better hurry or you will remain trapped here.",
                            "Final Escape!"
                        )
                    );
                    ...
                    {
                        IamElemental = (int)from.Skills[SkillName.Elementalism].Base;
                    }
                    ...
                    )
                    {
                        ...
                        IamElemental > IamBard
                        && IamElemental > IamMage
                        && IamElemental > IamNecro
                        && IamElemental > 0
                    )
                    {
                        MyChest.DropItem(new MangarsElementalistRobe());
                        MyElementalSpellbook newBook = new MyElementalSpellbook();
                        newBook.Hue = 0;
                    ...
                    LoggingFunctions.LogGenericQuest(
                        from,
                        "defeated Mangar and escaped Skara Brae"
                    );
                }
            }
            else
