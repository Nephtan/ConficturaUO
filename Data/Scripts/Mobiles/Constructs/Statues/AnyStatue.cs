...
namespace Server.Mobiles
{
    ...
    public class AnyStatue : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 1:
                    RealName = "a golden sculpture";
                    break;
                case 2:
                    RealName = "an iron sculpture";
                    break;
                case 3:
                    RealName = "a jade sculpture";
                    break;
                case 4:
                    RealName = "a marble sculpture";
                    break;
                case 5:
                    RealName = "a shadow iron sculpture";
                    break;
                case 6:
                    RealName = "a silver sculpture";
                    break;
                case 7:
                    RealName = "a stone sculpture";
                    break;
                case 8:
                    RealName = "a bronze sculpture";
                    break;
            }
        ...
        public override void OnDeath(Container c)
        {
            ...
            {
                RareMetals stones = new RareMetals(
                    Utility.RandomMinMax(5, 10),
                    "gargish marble stones"
                );
                c.DropItem(stones);
            }
        ...
        public override void CheckReflect(Mobile caster, ref bool reflect)
        {
            ...
            {
                reflect = true;
            } // 50% spells are reflected back to the caster
            else
            {
                reflect = false;
            }
        ...
        public AnyStatue(Serial serial)
            : base(serial) { }
