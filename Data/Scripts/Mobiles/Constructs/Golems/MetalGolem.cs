...
namespace Server.Mobiles
{
    ...
    public class MetalGolem : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8)
        {
            ...
            Item ore = new CopperIngot(Utility.RandomMinMax(13, 21));
            ore.Delete();
            ...
            {
                case 0:
                    ore = new IronIngot(Utility.RandomMinMax(13, 21));
                    Hue = 0x430;
                    scalar = 1.0;
                    RealName = "an iron construct";
                    break; // Iron
                case 1:
                    ore = new DullCopperIngot(Utility.RandomMinMax(13, 21));
                    Hue = MaterialInfo.GetMaterialColor("dull copper", "monster", 0);
                    scalar = 1.1;
                    RealName = "a dull copper construct";
                    break; // Dull Copper
                case 2:
                    ore = new ShadowIronIngot(Utility.RandomMinMax(13, 21));
                    Hue = MaterialInfo.GetMaterialColor("shadow iron", "monster", 0);
                    scalar = 1.2;
                    RealName = "a shadow iron construct";
                    break; // Shadow Iron
                case 3:
                    ore = new CopperIngot(Utility.RandomMinMax(13, 21));
                    Hue = MaterialInfo.GetMaterialColor("copper", "monster", 0);
                    scalar = 1.3;
                    RealName = "a copper construct";
                    break; // Copper
                case 4:
                    ore = new BronzeIngot(Utility.RandomMinMax(13, 21));
                    Hue = MaterialInfo.GetMaterialColor("bronze", "monster", 0);
                    scalar = 1.4;
                    RealName = "a bronze construct";
                    break; // Bronze
                case 5:
                    ore = new GoldIngot(Utility.RandomMinMax(13, 21));
                    Hue = MaterialInfo.GetMaterialColor("gold", "monster", 0);
                    scalar = 1.5;
                    RealName = "a golden construct";
                    break; // Gold
                case 6:
                    ore = new AgapiteIngot(Utility.RandomMinMax(13, 21));
                    Hue = MaterialInfo.GetMaterialColor("agapite", "monster", 0);
                    scalar = 1.6;
                    RealName = "an agapite construct";
                    break; // Agapite
                case 7:
                    ore = new VeriteIngot(Utility.RandomMinMax(13, 21));
                    Hue = MaterialInfo.GetMaterialColor("verite", "monster", 0);
                    scalar = 1.7;
                    RealName = "a verite construct";
                    break; // Verite
                case 8:
                    ore = new ValoriteIngot(Utility.RandomMinMax(13, 21));
                    Hue = MaterialInfo.GetMaterialColor("valorite", "monster", 0);
                    scalar = 1.8;
                    RealName = "a valorite construct";
                    break; // Valorite
                case 9:
                    if (Worlds.IsExploringSeaAreas(this) == true)
                    {
                        ore = new NepturiteIngot(Utility.RandomMinMax(13, 21));
                        Hue = MaterialInfo.GetMaterialColor("nepturite", "monster", 0);
                        scalar = 1.9;
                        RealName = "a nepturite construct";
                    }
                    else if (
                    ...
                    {
                        ore = new ObsidianIngot(Utility.RandomMinMax(13, 21));
                        Hue = MaterialInfo.GetMaterialColor("obsidian", "monster", 0);
                        scalar = 1.9;
                        RealName = "an obsidian construct";
                    }
                    else if (
                        Worlds.GetMyWorld(this.Map, this.Location, this.X, this.Y)
                            == "the Underworld"
                    ...
                    {
                        ore = new XormiteIngot(Utility.RandomMinMax(13, 21));
                        Hue = MaterialInfo.GetMaterialColor("xormite", "monster", 0);
                        scalar = 2.0;
                        RealName = "a xormite construct";
                    }
                    else if (
                        Worlds.GetMyWorld(this.Map, this.Location, this.X, this.Y)
                        == "the Underworld"
                    ...
                    {
                        ore = new MithrilIngot(Utility.RandomMinMax(13, 21));
                        Hue = MaterialInfo.GetMaterialColor("mithril", "monster", 0);
                        scalar = 2.1;
                        RealName = "a mithril construct";
                    }
                    else
                    {
                        ore = new IronIngot(Utility.RandomMinMax(13, 21));
        ...
        public MetalGolem(Serial serial)
            : base(serial) { }
