...
namespace Server.Mobiles
{
    ...
    {
        [Constructable]
        public AxeBeakRiding()
            : this("an axebeak") { }

        [Constructable]
        public AxeBeakRiding(string name)
            : base(name, 25, 25, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0x8F;
        ...
        public AxeBeakRiding(Serial serial)
            : base(serial) { }
