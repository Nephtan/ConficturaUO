...
namespace Server.Mobiles
{
    ...
    public class PredatorHellCatRiding : BaseMount
    {
        ...
        [Constructable]
        public PredatorHellCatRiding()
            : this("a hell lion") { }

        [Constructable]
        public PredatorHellCatRiding(string name)
            : base(name, 340, 340, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Hue = 0x4AA;
            BaseSoundID = 0x3EE;
        ...
        public PredatorHellCatRiding(Serial serial)
            : base(serial) { }
