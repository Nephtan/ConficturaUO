...
namespace Server.Mobiles
{
    ...
    public class SabretoothTigerRiding : BaseMount
    {
        ...
        [Constructable]
        public SabretoothTigerRiding()
            : this("a sabretooth tiger") { }

        [Constructable]
        public SabretoothTigerRiding(string name)
            : base(name, 966, 340, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0x462;
            Hue = 0x54F;
        ...
        public SabretoothTigerRiding(Serial serial)
            : base(serial) { }
