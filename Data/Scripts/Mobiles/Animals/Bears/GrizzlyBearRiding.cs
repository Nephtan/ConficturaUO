...
namespace Server.Mobiles
{
    ...
    {
        [Constructable]
        public GrizzlyBearRiding()
            : this("a grizzly bear") { }

        [Constructable]
        public GrizzlyBearRiding(string name)
            : base(name, 212, 212, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA3;
        ...
        public GrizzlyBearRiding(Serial serial)
            : base(serial) { }
