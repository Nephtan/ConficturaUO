...
namespace Server.Mobiles
{
    ...
    public class ElderPolarBearRiding : BaseMount
    {
        ...
        [Constructable]
        public ElderPolarBearRiding()
            : this("an elder polar bear") { }

        [Constructable]
        public ElderPolarBearRiding(string name)
            : base(name, 179, 179, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA3;
        ...
        public ElderPolarBearRiding(Serial serial)
            : base(serial) { }
