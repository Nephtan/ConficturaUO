...
namespace Server.Mobiles
{
    ...
    public class ElderBlackBearRiding : BaseMount
    {
        ...
        [Constructable]
        public ElderBlackBearRiding()
            : this("an elder black bear") { }

        [Constructable]
        public ElderBlackBearRiding(string name)
            : base(name, 177, 177, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA3;
        ...
        public ElderBlackBearRiding(Serial serial)
            : base(serial) { }
