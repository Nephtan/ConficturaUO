...
namespace Server.Mobiles
{
    ...
    public class PandaRiding : BaseMount
    {
        ...
        [Constructable]
        public PandaRiding(string name)
            : base(name, 671, 671, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA3;
        ...
        {
            get { return Utility.RandomList(0, 0, 0, 6); }
        }
        ...
        public PandaRiding(Serial serial)
            : base(serial) { }
