...
namespace Server.Mobiles
{
    ...
    public class ElderBrownBearRiding : BaseMount
    {
        ...
        [Constructable]
        public ElderBrownBearRiding()
            : this("an elder brown bear") { }

        [Constructable]
        public ElderBrownBearRiding(string name)
            : base(name, 23, 23, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA3;
        ...
        public ElderBrownBearRiding(Serial serial)
            : base(serial) { }
