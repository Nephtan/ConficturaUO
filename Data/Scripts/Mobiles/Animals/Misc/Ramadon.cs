...
namespace Server.Mobiles
{
    ...
    public class Ramadon : BaseMount
    {
        ...
        [Constructable]
        public Ramadon(string name)
            : base(name, 0x11C, 0x3E92, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA3;
            Hue = 0xB70;
        ...
        {
            get { return Utility.RandomList(0, 0, 0, 30); }
        }
