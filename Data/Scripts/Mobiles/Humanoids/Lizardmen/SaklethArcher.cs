...
namespace Server.Mobiles
{
    ...
    public class SaklethArcher : BaseCreature
    {
            ...
            : base(AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            toss.ammo = "Throwing Daggers";
            toss.ItemID = 0x10B7;
            toss.Name = "throwing dagger";
            PackItem(toss);
        }
        ...
        public override void OnAfterSpawn()
        {
            ...
            if (
                (Region.Find(this.Location, this.Map)).IsPartOf("the Sanctum of Saltmarsh")
                && Utility.RandomMinMax(1, 4) > 1
            )
                ControlSlots = 5;
        }

        public SaklethArcher(Serial serial)
            : base(serial) { }
