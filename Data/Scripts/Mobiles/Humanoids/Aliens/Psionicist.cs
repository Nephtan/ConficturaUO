...
namespace Server.Mobiles
{
    public class Psionicist : BaseCreature
    {
        ...
        {
            base.BreathDealDamage(target, 0);
        }
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 0:
                    Title = "the psychic of the bomb";
                    break;
                case 1:
                    Title = "the psychic of the atom";
                    break;
                case 2:
                    Title = "the irradiated psychic";
                    break;
                case 3:
                    Title = "of the psychic glow";
                    break;
                case 4:
                    Title = "the glowing psychic";
                    break;
                case 5:
                    Title = "of the psychic light";
                    break;
                case 6:
                    Title = "the enlightened psychic";
                    break;
            }
        ...
        public Psionicist(Serial serial)
            : base(serial) { }
