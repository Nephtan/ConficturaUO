...
namespace Server.Mobiles
{
    ...
    public class SavageAlien : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 0:
                    Item cloth4 = new OrcHelm();
                    MorphingTime.MakeSpaceAceBoneArmor(cloth4, bone, false);
                    AddItem(cloth4);
                    break;
                case 1:
                    Item cloth5 = new SavageHelm();
                    MorphingTime.MakeSpaceAceBoneArmor(cloth5, bone, false);
                    AddItem(cloth5);
                    break;
                case 2:
                    Item cloth6 = new TribalMask();
                    cloth6.Name = "skin mask";
                    MorphingTime.MakeSpaceAceBoneArmor(cloth6, bone, true);
                    AddItem(cloth6);
                    break;
            }
            ...
            if (this.FindItemOnLayer(Layer.OneHanded) != null)
            {
                ...
                {
                    MorphingTime.MakeSpaceAceMetalArmorWeapon(
                        this.FindItemOnLayer(Layer.OneHanded),
                        metal
                    );
                }
                else if (MaterialInfo.IsAnyKindOfClothItem(this.FindItemOnLayer(Layer.OneHanded)))
                {
                    MorphingTime.MakeSpaceAceClothArmorWeapon(
                        this.FindItemOnLayer(Layer.OneHanded),
                        cloth
                    );
                }
                ...
                {
                    MorphingTime.MakeSpaceAceWoodArmorWeapon(
                        this.FindItemOnLayer(Layer.OneHanded),
                        wood
                    );
                }
            ...
            if (this.FindItemOnLayer(Layer.TwoHanded) != null)
            {
                ...
                if (hand is BaseShield)
                {
                    switch (Utility.RandomMinMax(1, 4))
                    {
                        case 1:
                            hand.ItemID = 0x1B76;
                            hand.Name = "hull plate";
                            break;
                        case 2:
                            hand.ItemID = 0x1B76;
                            hand.Name = "deck plate";
                            break;
                        case 3:
                            hand.ItemID = 0x1B72;
                            hand.Name = "hatch door";
                            break;
                        case 4:
                            hand.ItemID = 0x1B7B;
                            hand.Name = "hatch cover";
                            break;
                    }
        ...
        public SavageAlien(Serial serial)
            : base(serial) { }
