    ...
    public class EvilMageLord : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            if (this.Female = Utility.RandomBool())
            {
                ...
                {
                    case 0:
                        Title = "the " + sGrand + " wizard";
                        break;
                    case 1:
                        Title = "the " + sGrand + " sorcereress";
                        break;
                    case 2:
                        Title = "the " + sGrand + " mage";
                        break;
                    case 3:
                        Title = "the " + sGrand + " conjurer";
                        break;
                    case 4:
                        Title = "the " + sGrand + " magician";
                        break;
                    case 5:
                        Title = "the " + sGrand + " witch";
                        break;
                }
