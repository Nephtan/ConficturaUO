...
namespace Server.Mobiles
{
    ...
    public class Adventurers : BaseCreature
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Citizen_Level
        {
            get { return CitizenLevel; }
            set
            {
                CitizenLevel = value;
                InvalidateProperties();
            ...
            else
            {
                switch (Utility.Random(8))
                {
                    ...
                    case 1:
                        ...
                        PackItem(new Bolt(Utility.RandomMinMax(15, 30)));
                        break;
                    case 2:
                    ...
                    case 7:
                        AddItem(new Harpoon());
                        PackItem(new HarpoonRope(Utility.RandomMinMax(15, 30)));
                        break;
                }
                ;
            }
        ...
        {
            get { return (int)((CitizenLevel / 2) + 1); }
        }
        ...
        public Adventurers(Serial serial)
            : base(serial) { }
