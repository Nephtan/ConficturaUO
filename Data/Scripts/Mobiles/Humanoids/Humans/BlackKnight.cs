...
namespace Server.Mobiles
{
    public class BlackKnight : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            AddItem(bk_gloves);
            PlateHelm bk_helm = new PlateHelm();
            AddItem(bk_helm);
            VikingSword bk_sword = new VikingSword();
            AddItem(bk_sword);
            ChaosShield bk_shield = new ChaosShield();
            AddItem(bk_shield);
            AddItem(new Boots());
                ...
                switch (Utility.RandomMinMax(0, 7))
                {
                    case 0:
                        MorphingItem.MorphMyItem(
                            ...
                            "IGNORED",
                            "IGNORED",
                            MorphingTemplates.TemplateBlackKnight("armors")
                        );
                        break;
                    case 1:
                        MorphingItem.MorphMyItem(
                    ...
                    case 6:
                        MorphingItem.MorphMyItem(
                            ...
                            "IGNORED",
                            "IGNORED",
                            MorphingTemplates.TemplateBlackKnight("weapons")
                        );
                        break;
                    case 7:
                        MorphingItem.MorphMyItem(
        ...
        public BlackKnight(Serial serial)
            : base(serial) { }
...
namespace Server.Items
{
    public class BlackKnightBox : Item
    {
        ...
        public BlackKnightBox(Serial serial)
            : base(serial) { }
            ...
            if (from.InRange(this.GetWorldLocation(), 2))
            {
                ...
                else
                {
                    ...
                    from.PrivateOverheadMessage(
                        ...
                        1150,
                        false,
                        "You found a blackened key with a symbol of a sword on it.",
                        from.NetState
                    );
                }
            }
