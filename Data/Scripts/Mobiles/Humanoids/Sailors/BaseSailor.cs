...
namespace Server.Mobiles
{
    public class BaseSailor : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 0:
                    AddItem(new LongPants(0xBB4));
                    break;
                case 1:
                    AddItem(new ShortPants(0xBB4));
                    break;
            }
            ...
            {
                case 0:
                    AddItem(new Bandana(0x846));
                    break;
                case 1:
                    AddItem(new SkullCap(0x846));
                    break;
            }
        ...
        {
            get { return Utility.RandomMinMax(1, 3); }
        }
        ...
        public override void OnThink()
        {
            if (boatspawn == false)
            {
                ...
                else if (Worlds.TestShore(Map, X, Y, 8))
                {
                    this.Delete();
                }
            }
            ...
            if (
                DateTime.Now >= m_NextPickup
                && (
                    this is BoatSailorBard
                    || this is BoatPirateBard
                    || this is ElfBoatSailorBard
                    || this is ElfBoatPirateBard
                )
            )
            {
        ...
        public BaseSailor(Serial serial)
            : base(serial) { }
