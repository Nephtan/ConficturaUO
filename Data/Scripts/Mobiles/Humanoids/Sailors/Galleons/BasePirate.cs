...
namespace Server.Mobiles
{
    public class BasePirate : BaseCreature
    {
        ...
        {
            get { return Utility.RandomMinMax(1, 6); }
        }
        ...
        public override void OnThink()
        {
            ...
            if (!crewspawn)
            {
                ...
                BaseCreature pirate = new Brigand();
                pirate.Delete();
                bool evil = true;
                string toss = "stones";
                ...
                {
                    if (
                        this is PirateCyclops
                        || this is PirateDragonogre
                        || this is PirateEttinMage
                        || this is PirateTroll
                        || this is PirateOgreLord
                        || this is PirateMinotaur
                    )
                    {
                        ...
                        this is PirateDaemon
                        || this is PirateDemon
                        || this is PirateDemoness
                        || this is PirateDevil
                        || this is PirateSuccubus
                    )
                    {
                    ...
                    else if (this is PirateGrathek || this is PirateSakleth)
                    {
                        ...
                        {
                            case 1:
                                pirate = new LizardmanArcher();
                                toss = "spear";
                                break;
                            case 2:
                                pirate = new Lizardman();
                                toss = "daggers";
                                pirate.Body = 33;
                                break;
                            case 3:
                    ...
                    else if (this is PirateGhost)
                    {
                        ...
                        this is PirateDarkLord
                        || this is PirateLich
                        || this is PirateLichLord
                        || this is PirateSkeleton
                    )
                    {
                    ...
                    else if (this is SailorAngel || this is SailorAngelLord)
                    {
                        ...
                        switch (Utility.RandomMinMax(1, 5))
                        {
                            case 1:
                                pirate = new Pixie();
                                toss = "fire";
                                pirate.Body = Utility.RandomList(356, 128);
                                break;
                            case 2:
                                pirate = new Fairy();
                                toss = "cold";
        ...
        public void DressUpCrewMember(BaseCreature bc, Mobile captain)
        {
            if (captain is PirateDrow)
            {
                ...
                {
                    case 0:
                        bc.AddItem(new LongPants(0xBB4));
                        break;
                    case 1:
                        bc.AddItem(new ShortPants(0xBB4));
                        break;
                }
                switch (Utility.Random(2))
                {
                    case 0:
                        bc.AddItem(new Bandana(0x846));
                        break;
                    case 1:
                        bc.AddItem(new SkullCap(0x846));
                        break;
                }
            }
            ...
            else if (captain is PirateCult)
            {
                ...
                {
                    case 0:
                        bc.AddItem(new ClothCowl());
                        break;
                    case 1:
                        bc.AddItem(new ClothHood());
                        break;
                    case 2:
                        bc.AddItem(new FancyHood());
                        break;
                    case 3:
                        bc.AddItem(new HoodedMantle());
                        break;
                }
                ...
                {
                    Item hand = bc.FindItemOnLayer(Layer.TwoHanded);
                    hand.ItemID = 0x13C6;
                    hand.Name = "gloves";
                    hand.MoveToWorld(captain.Location, captain.Map);
                    bc.AddItem(hand);
            ...
            )
            {
                ...
                if (captain is SailorElfGuards)
                {
                    ...
                    bc.Hue = Utility.RandomSkinColor();
                }
            }
        ...
        public void TitleGuards(Mobile captain)
        {
            int title = 1;
            if (
                Server.Misc.Worlds.GetMyWorld(captain.Map, captain.Location, captain.X, captain.Y)
                == "the Land of Lodoria"
            )
            {
                title = Utility.RandomMinMax(1, 10);
            }
            else if (
                Server.Misc.Worlds.GetMyWorld(captain.Map, captain.Location, captain.X, captain.Y)
                == "the Land of Sosaria"
            ...
            {
                title = Utility.RandomMinMax(11, 18);
            }
            else if (
                Server.Misc.Worlds.GetMyWorld(captain.Map, captain.Location, captain.X, captain.Y)
                == "the Savaged Empire"
            ...
            {
                title = Utility.RandomMinMax(22, 23);
            }
            else if (
                Server.Misc.Worlds.GetMyWorld(captain.Map, captain.Location, captain.X, captain.Y)
                == "the Isles of Dread"
            ...
            {
                case 1:
                    captain.Title = "of the Whisper Guard";
                    break;
                case 2:
                    captain.Title = "of the Glacial Guard";
                    break;
                case 3:
                    captain.Title = "of the Springvale Guard";
                    break;
                case 4:
                    captain.Title = "of the Elidor Guard";
                    break;
                case 5:
                    captain.Title = "of the Islegem Guard";
                    break;
                case 6:
                    captain.Title = "of the Greensky Guard";
                    break;
                case 7:
                    captain.Title = "of the Dusk Guard";
                    break;
                case 8:
                    captain.Title = "of the Starguide Guard";
                    break;
                case 9:
                    captain.Title = "of the Portshine Guard";
                    break;
                case 10:
                    captain.Title = "of the Lodoria Guard";
                    break;

                case 11:
                    captain.Title = "of the Devil Guard";
                    break;
                case 12:
                    captain.Title = "of the Moon Guard";
                    break;
                case 13:
                    captain.Title = "of the Grey Guard";
                    break;
                case 14:
                    captain.Title = "of the Montor Guard";
                    break;
                case 15:
                    captain.Title = "of the Fawn Guard";
                    break;
                case 16:
                    captain.Title = "of the Yew Guard";
                    break;
                case 17:
                    captain.Title = "of the Iceclad Guard";
                    break;
                case 18:
                    captain.Title = "of the Britain Guard";
                    break;

                case 19:
                    captain.Title = "of the Renika Guard";
                    break;

                case 20:
                    captain.Title = "of the Kuldara Guard";
                    break;

                case 21:
                    captain.Title = "of the Cimmeran Guard";
                    break;

                case 22:
                    captain.Title = "of the Barako Guard";
                    break;
                case 23:
                    captain.Title = "of the Kurak Guard";
                    break;
            }
        ...
        public void DressSailor(BaseCreature bc)
        {
            ...
            {
                case 0:
                    bc.AddItem(new FancyShirt());
                    break;
                case 1:
                    bc.AddItem(new Doublet());
                    break;
                case 2:
        ...
        )
        {
            ...
            {
                MonsterGloves gloves = new MonsterGloves();
                gloves.ThrowType = "Boulder";
                bc.AddItem(gloves);
            }
            else if (toss == "bones")
            {
                MonsterGloves gloves = new MonsterGloves();
                gloves.ThrowType = "Bones";
                bc.AddItem(gloves);
            }
            else if (toss == "arrows")
            {
            ...
            else if (toss == "fire")
            {
                ...
                staff.AosElementDamages.Fire = 75;
                staff.damageType = 1;
                bc.AddItem(staff);
            }
            else if (toss == "cold")
            {
                WizardStaff staff = new WizardStaff();
                staff.AosElementDamages.Cold = 75;
                staff.damageType = 2;
                bc.AddItem(staff);
            }
            else if (toss == "energy")
            {
                WizardStaff staff = new WizardStaff();
                staff.AosElementDamages.Energy = 75;
                staff.damageType = 3;
                bc.AddItem(staff);
            }
            else if (toss == "poison")
            {
                WizardStaff staff = new WizardStaff();
                staff.AosElementDamages.Poison = 75;
                staff.damageType = 4;
                bc.AddItem(staff);
            }
            else if (toss == "bolt")
        ...
        public override bool OnBeforeDeath()
        {
            if (CaptainCanDie())
            {
                ...
                SunkenShip ShipWreck = Server.Multis.BaseBoat.CreateSunkenShip(
                    this,
                    this.LastKiller
                );
        ...
        public static int ShipColor(string color)
        {
            if (color == "reptile")
            {
                return Utility.RandomList(0xB51, 0xB19, 0xACF, 0x91E, 0xB79, 0xB27, 0xACE);
            }
            else if (color == "demon")
            {
                return Utility.RandomList(0xB02, 0xB7F, 0x7BB, 0x7B7);
            }
            else if (color == "pixie")
            {
                return Utility.RandomList(0xAEA, 0xAB5, 0x9BE, 0x926, 0x929, 0x7BC);
            }
            else if (color == "titan")
            {
                return Utility.RandomList(0x94B, 0x8D1, 0xB2C);
            }
            else if (color == "undead")
            {
                return Utility.RandomList(0xB31, 0xB38, 0xB5E, 0xB5F, 0xAB3);
            }
        ...
        public static BaseBoat HauntedShip()
        {
            ...
            {
                case 1:
                    boat = new GalleonWreckedRoyal();
                    break;
                case 2:
                    boat = new GalleonWreckedExotic();
                    break;
                case 3:
                    boat = new GalleonWreckedLarge();
                    break;
                case 4:
                    boat = new GalleonRuinedBarbarian();
                    break;
                case 5:
                    boat = new GalleonRuinedRoyal();
                    break;
                case 6:
                    boat = new GalleonRuinedExotic();
                    break;
            }
        ...
        public static BaseBoat AverageShip()
        {
            ...
            {
                case 1:
                    boat = new GalleonRoyal();
                    break;
                case 2:
                    boat = new GalleonExotic();
                    break;
            }
        ...
        public BasePirate(Serial serial)
            : base(serial) { }
