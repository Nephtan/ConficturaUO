...
namespace Server.Mobiles
{
    public class PirateCult : BasePirate
    {
        ...
        public PirateCult()
        {
            ...
            switch (Utility.RandomMinMax(1, 8))
            {
                case 1:
                    ...
                    break;
                case 2:
                    Title = "of the Krakoa " + cult;
                    break;
                case 3:
                    Title = "of the Dagon " + cult;
                    break;
                case 4:
                    Title = "of the Hydros " + cult;
                    break;
                case 5:
                    Title = "of the Kraken " + cult;
                    break;
                case 6:
                    Title = "of the Storm Giant " + cult;
                    break;
                case 7:
                    Title = "of the Jormungandr " + cult;
                    break;
                case 8:
                    Title = "of the Dragon Turtle " + cult;
                    break;
            }
            ...
            {
                case 0:
                    AddItem(new ClothCowl(hood));
                    break;
                case 1:
                    AddItem(new ClothHood(hood));
                    break;
                case 2:
                    AddItem(new FancyHood(hood));
                    break;
                case 3:
                    AddItem(new HoodedMantle(hood));
                    break;
            }
        ...
        public PirateCult(Serial serial)
            : base(serial) { }
