...
namespace Server.Mobiles
{
    public class BoatSailorArcher : BaseSailor
    {
        ...
        public BoatSailorArcher(Serial serial)
            : base(serial) { }
    ...
    public class BoatSailorBard : BaseSailor
    {
        ...
        public BoatSailorBard(Serial serial)
            : base(serial) { }
    ...
    public class BoatSailorMage : BaseSailor
    {
        ...
        public BoatSailorMage(Serial serial)
            : base(serial) { }
    ...
    public class ElfBoatSailorArcher : BaseSailor
    {
        ...
        public ElfBoatSailorArcher()
        {
            ...
            {
                case 0:
                    Title = "the elf sailor";
                    break;
                case 1:
                    Title = "the elf fisherman";
                    break;
                case 2:
                    Title = "the elf mariner";
                    break;
                case 3:
                    Title = "the elf seafarer";
                    break;
            }
        ...
        public ElfBoatSailorArcher(Serial serial)
            : base(serial) { }
    ...
    public class ElfBoatSailorBard : BaseSailor
    {
        ...
        public ElfBoatSailorBard(Serial serial)
            : base(serial) { }
    ...
    public class ElfBoatSailorMage : BaseSailor
    {
        ...
        public ElfBoatSailorMage(Serial serial)
            : base(serial) { }
