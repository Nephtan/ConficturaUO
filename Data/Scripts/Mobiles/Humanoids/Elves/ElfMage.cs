    ...
    public class ElfMage : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            if (this.Female = Utility.RandomBool())
            {
                ...
                {
                    case 0:
                        Title = "the drow wizard";
                        break;
                    case 1:
                        Title = "the drow sorceress";
                        break;
                    case 2:
                        Title = "the drow mage";
                        break;
                    case 3:
                        Title = "the drow conjurer";
                        break;
                    case 4:
                        Title = "the drow magician";
                        break;
                    case 5:
                        Title = "the drow witch";
                        break;
                }
            }
            else
