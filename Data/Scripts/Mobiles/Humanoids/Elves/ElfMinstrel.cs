...
namespace Server.Mobiles
{
    public class ElfMinstrel : BaseCreature
    {
            ...
            : base(AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            switch (Utility.RandomMinMax(0, 4))
            {
                case 0:
                    ...
                    break;
                case 1:
                    Title = "the drow minstrel";
                    break;
                case 2:
                    Title = "the drow troubadour";
                    break;
                case 3:
                    Title = "the drow musician";
                    break;
                case 4:
                    Title = "the drow balladeer";
                    break;
            }
        ...
        public override void OnDeath(Container c)
        {
            ...
            {
                case 0:
                    c.DropItem(new ArmysPaeonScroll());
                    break;
                case 1:
                    c.DropItem(new EnchantingEtudeScroll());
                    break;
                case 2:
                    c.DropItem(new EnergyCarolScroll());
                    break;
                case 3:
                    c.DropItem(new EnergyThrenodyScroll());
                    break;
                case 4:
                    c.DropItem(new FireCarolScroll());
                    break;
                case 5:
                    c.DropItem(new FireThrenodyScroll());
                    break;
                case 6:
                    c.DropItem(new FoeRequiemScroll());
                    break;
                case 7:
                    c.DropItem(new IceCarolScroll());
                    break;
                case 8:
                    c.DropItem(new IceThrenodyScroll());
                    break;
                case 9:
                    c.DropItem(new KnightsMinneScroll());
                    break;
                case 10:
                    c.DropItem(new MagesBalladScroll());
                    break;
                case 11:
                    c.DropItem(new MagicFinaleScroll());
                    break;
                case 12:
                    c.DropItem(new PoisonCarolScroll());
                    break;
                case 13:
                    c.DropItem(new PoisonThrenodyScroll());
                    break;
                case 14:
                    c.DropItem(new SheepfoeMamboScroll());
                    break;
                case 15:
                    c.DropItem(new SinewyEtudeScroll());
                    break;
            }
        }
        ...
        public ElfMinstrel(Serial serial)
            : base(serial) { }
        ...
        public void Suppress(Mobile target)
        {
            if (
                target == null
                || m_Suppressed.ContainsKey(target)
                || Deleted
                || !Alive
                || m_NextSuppress > DateTime.Now
            )
                return;
            ...
            if (!target.Hidden && CanBeHarmful(target))
            {
                ...
                for (int i = 0; i < target.Skills.Length; i++)
                {
                    ...
                    {
                        target.AddSkillMod(
                            new TimedSkillMod(s.SkillName, true, s.Base * -0.28, delay)
                        );
                    }
                }
        ...
        public void Undress(Mobile target)
        {
            ...
            if (target.Player && target.Female && !target.Hidden && CanBeHarmful(target))
            {
                ...
                if (Utility.RandomBool())
                {
                    UndressItem(target, Layer.Talisman);
                }
                if (Utility.RandomBool())
                {
                ...
                if (Utility.RandomBool())
                {
                    UndressItem(target, Layer.Waist);
                }
                if (Utility.RandomBool())
                {
        ...
        public void Provoke(Mobile target)
        {
            ...
            IPooledEnumerable eable1 = GetMobilesInRange(RangePerception);
            try
            {
