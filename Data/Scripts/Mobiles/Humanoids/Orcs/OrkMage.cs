    ...
    public class OrkMage : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            if (this.Female = Utility.RandomBool())
            {
                ...
                {
                    case 0:
                        Title = "the ork wizard";
                        break;
                    case 1:
                        Title = "the ork sorceress";
                        break;
                    case 2:
                        Title = "the ork mage";
                        break;
                    case 3:
                        Title = "the ork conjurer";
                        break;
                    case 4:
                        Title = "the ork magician";
                        break;
                    case 5:
                        Title = "the ork witch";
                        break;
