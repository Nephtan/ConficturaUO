...
namespace Server.Mobiles
{
    ...
    public class Urk : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 0:
                    Title = "the urk warrior";
                    break;
                case 1:
                    Title = "the urk savage";
                    break;
                case 2:
                    Title = "the urk barbarian";
                    break;
                case 3:
                    Title = "the urk fighter";
                    break;
                case 4:
                    Title = "the urk gladiator";
                    break;
                case 5:
                    Title = "the urk berserker";
                    break;
            }
