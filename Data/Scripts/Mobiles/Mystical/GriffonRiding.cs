...
namespace Server.Mobiles
{
    ...
    public class GriffonRiding : BaseMount
    {
        ...
        [Constructable]
        public GriffonRiding()
            : this("a griffon") { }

        [Constructable]
        public GriffonRiding(string name)
            : base(name, 0x31F, 0x3EBE, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0x2EE;
        ...
        public GriffonRiding(Serial serial)
            : base(serial) { }
