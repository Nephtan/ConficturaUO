...
namespace Server.Mobiles
{
    ...
    public class HippogriffRiding : BaseMount
    {
        ...
        [Constructable]
        public HippogriffRiding()
            : this("a hippogriff") { }

        [Constructable]
        public HippogriffRiding(string name)
            : base(name, 188, 0x3EB8, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0x2EE;
        ...
        public HippogriffRiding(Serial serial)
            : base(serial) { }
