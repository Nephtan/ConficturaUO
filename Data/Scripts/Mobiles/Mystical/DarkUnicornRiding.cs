...
namespace Server.Mobiles
{
    ...
    public class DarkUnicornRiding : BaseMount
    {
        ...
        [Constructable]
        public DarkUnicornRiding()
            : this("a dark unicorn") { }

        [Constructable]
        public DarkUnicornRiding(string name)
            : base(name, 27, 27, AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA8;
        ...
        public DarkUnicornRiding(Serial serial)
            : base(serial) { }
