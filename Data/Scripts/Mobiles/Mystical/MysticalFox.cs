    ...
    public class MysticalFox : BaseCreature
    {
        ...
        public override void OnCombatantChange()
        {
            if (
                ...
                m_DisguiseTimer = Timer.DelayCall(
                    TimeSpan.FromSeconds(Utility.RandomMinMax(15, 30)),
                    new TimerCallback(Disguise)
                );
        }
        ...
        public void Disguise()
        {
            ...
            m_DisguiseTimer = Timer.DelayCall(
                ...
                new TimerCallback(RemoveDisguise)
            );
        }
        ...
        public MysticalFox(Serial serial)
            : base(serial) { }
