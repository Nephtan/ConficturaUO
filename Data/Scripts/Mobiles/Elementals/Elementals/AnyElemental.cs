...
namespace Server.Mobiles
{
    ...
    public class AnyElemental : BaseCreature
    {
        ...
        {
            base.BreathDealDamage(target, 22);
        }
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 1:
                    RealName = "an iron grue";
                    break;
                case 2:
                    RealName = "a golden grue";
                    break;
                case 3:
                    RealName = "a shadow iron grue";
                    break;
                case 4:
                    RealName = "a valorite grue";
                    break;
                case 5:
                    RealName = "a verite grue";
                    break;
                case 6:
                    RealName = "an agapite grue";
                    break;
                case 7:
                    RealName = "a bronze grue";
                    break;
                case 8:
                    RealName = "a copper grue";
                    break;
                case 9:
                    RealName = "a dull copper grue";
                    break;
                case 10:
                    RealName = "a stone grue";
                    break;
            }
        ...
        public AnyElemental(Serial serial)
            : base(serial) { }
