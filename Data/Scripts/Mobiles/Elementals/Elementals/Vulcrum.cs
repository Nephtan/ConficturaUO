...
namespace Server.Items
{
    public class VulcrumChest : Item
    {
        ...
        public VulcrumChest(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 2))
            {
                ...
                from.PrivateOverheadMessage(
                    ...
                    1150,
                    false,
                    "You have pulled Vulcrum's Vault toward you.",
                    from.NetState
                );
                ...
                if (from is PlayerMobile)
                {
                    ...
                    if (
                        ...
                        && !Server.Misc.PlayerSettings.GetSpecialsKilled(from, "Vulcrum")
                    )
                    {
