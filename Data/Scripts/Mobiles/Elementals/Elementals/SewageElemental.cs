...
namespace Server.Mobiles
{
    ...
    public class SewageElemental : BaseCreature
    {
        ...
        {
            base.BreathDealDamage(target, 30);
        }

        [Constructable]
        public SewageElemental()
                ...
                if (iWrapped != null)
                {
                    ...
                    else if (Server.Items.HiddenTrap.CheckInsuranceOnTrap(iWrapped, m) == true)
                    {
                        m.LocalOverheadMessage(
                            ...
                            1150,
                            true,
                            "Sewage almost covered one of your protected items!"
                        );
                    }
                    else
                    {
                        m.LocalOverheadMessage(
                            ...
                            0xB1F,
                            true,
                            "One of your items is covered in sewage!"
                        );
                        m.PlaySound(0x364);
        ...
        public SewageElemental(Serial serial)
            : base(serial) { }
