...
namespace Server.Mobiles
{
    ...
    public class AnyGemElemental : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 1:
                    RealName = "a garnet grue";
                    break;
                case 2:
                    RealName = "an obsidian grue";
                    break;
                case 3:
                    RealName = "a quartz grue";
                    break;
                case 4:
                    RealName = "a silver grue";
                    break;
                case 5:
                    RealName = "a spinel grue";
                    break;
                case 6:
                    RealName = "a star ruby grue";
                    break;
                case 7:
                    RealName = "a topaz grue";
                    break;
            }
        ...
        public AnyGemElemental(Serial serial)
            : base(serial) { }
