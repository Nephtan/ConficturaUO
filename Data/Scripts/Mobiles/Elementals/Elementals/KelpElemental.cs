...
namespace Server.Mobiles
{
    ...
    public class KelpElemental : BaseCreature
    {
        ...
        {
            base.BreathDealDamage(target, 34);
        }
        ...
        public override void OnGaveMeleeAttack(Mobile m)
        {
            ...
            if (1 == Utility.RandomMinMax(1, 1))
            {
                ...
                {
                    if (
                        Server.Items.HiddenTrap.IAmShielding(m, 125)
                    ...
                    else if (Server.Items.HiddenTrap.CheckInsuranceOnTrap(iWrapped, m) == true)
                    {
                        m.LocalOverheadMessage(
                            ...
                            1150,
                            true,
                            "One of your protected items was almost wrapped in weeds!"
                        );
                    }
                    else
                    {
                        m.LocalOverheadMessage(
                            ...
                            0xB1F,
                            true,
                            "One of your items is wrapped in weeds!"
                        );
                        m.PlaySound(0x1BB);
        ...
        public KelpElemental(Serial serial)
            : base(serial) { }
