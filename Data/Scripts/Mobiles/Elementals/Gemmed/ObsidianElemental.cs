...
namespace Server.Mobiles
{
    ...
    public class ObsidianElemental : BaseCreature
    {
        ...
        public ObsidianElemental(Serial serial)
            : base(serial) { }
    ...
    public class ObsidianStone : Item
    {
            ...
            : base(0x364F)
        {
            ...
            if (Utility.RandomMinMax(1, 3) != 3)
            {
                ItemID = 0x364E;
                Weight = 150;
                RelicGoldValue = Utility.RandomMinMax(250, 750);
            }
        }
        ...
        public ObsidianStone(Serial serial)
            : base(serial) { }
