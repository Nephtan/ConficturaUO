...
namespace Server.Mobiles
{
    ...
    public class StormCloud : BaseCreature
    {
        ...
        [Constructable]
        public StormCloud(int oreAmount)
        ...
        public void StormHit()
        {
            ...
            IPooledEnumerable eable1 = this.GetMobilesInRange(2);
            try
            {
            ...
            foreach (Mobile m in list)
            {
                ...
                m.BoltEffect(0);
                int itHurts = (int)(
                    (Utility.RandomMinMax(10, 20) * (100 - m.EnergyResistance)) / 100
                );
                m.Damage(itHurts, m);
        ...
        public override void OnGaveMeleeAttack(Mobile m)
        {
            ...
            if (1 == Utility.RandomMinMax(1, 20))
            {
                ...
                {
                    if (
                        Server.Items.HiddenTrap.IAmShielding(m, 110)
                    ...
                    else if (Server.Items.HiddenTrap.CheckInsuranceOnTrap(iSucked, m))
                    {
                        m.LocalOverheadMessage(
                            ...
                            1150,
                            true,
                            "One of your protected items was almost carried by the wind!"
                        );
                    }
                    else
                    {
                        m.LocalOverheadMessage(
                            ...
                            0xB1F,
                            true,
                            "One of your items was carried into the wind!"
                        );
                        m.PlaySound(0x10B);
                        PackItem(iSucked);
                    }
