...
namespace Server.Items
{
    public class HeldLight : BaseEquipableLight
    {
        ...
        public HeldLight(Serial serial)
            : base(serial) { }
    ...
    class IntelligentAction
    {
        public static bool GetMyEnemies(Mobile m, Mobile me, bool checkDisguise)
        {
            ...
            if (
                ...
                && (GetPlayerInfo.EvilPlayer(m) || m is BaseCreature)
            )
                return false;
            ...
            if (
                (m.Region).Name != "the Castle of Knowledge"
                && !trick
                && m is PlayerMobile
                && m.Karma <= -5000
                && m.Skills[SkillName.Knightship].Base >= 50
                && !m.Region.IsPartOf(typeof(UmbraRegion))
                && !m.Region.IsPartOf(typeof(NecromancerRegion))
            )
            ...
            if (
                ...
                && !m.Region.IsPartOf(typeof(UmbraRegion))
                && !m.Region.IsPartOf(typeof(NecromancerRegion))
                && !m.Region.IsPartOf(typeof(GargoyleRegion))
            )
        ...
        public static void GiveTorch(Mobile m)
        {
            ...
            {
                if (
                    m.Region.IsPartOf(typeof(BardDungeonRegion))
                    || m.Region.IsPartOf(typeof(DungeonRegion))
                    || m.Region.IsPartOf(typeof(CaveRegion))
                )
                {
        ...
        public static void DoSpecialAbility(Mobile from, Mobile target)
        {
            ...
            if (Utility.RandomMinMax(1, 20) == 1 && from.EmoteHue > 0)
            {
                ...
                if (monsters < 3 && from.Mana > 39)
                {
                    ...
                    for (int i = 0; i < newmonsters; ++i)
                    {
                        ...
                        else if (from.EmoteHue == 2)
                        {
                            switch (Utility.Random(5))
                            {
                                default:
                                case 0:
                                    monster = new BloodWorm();
                                    break;
                                case 1:
                                    monster = new BloodSnake();
                                    break;
                                case 2:
                                    monster = new Viscera();
                                    break;
                                case 3:
                                    monster = new BloodSpawn();
                                    break;
                                case 4:
                                    monster = new GiantLeech();
                                    break;
                            }
                        }
                        else if (from.EmoteHue == 3)
                        {
                            switch (Utility.Random(11))
                            {
                                default:
                                case 0:
                                    monster = new LesserDemon();
                                    break;
                                case 1:
                                    monster = new LowerDemon();
                                    break;
                                case 2:
                                    monster = new LesserDemon();
                                    break;
                                ...
                                case 4:
                                    ...
                                    break;
                                case 5:
                                    monster = new ShadowHound();
                                    break;
                                case 7:
                                    monster = new Gargoyle();
                                    break;
                                case 9:
                                    monster = new SoulWorm();
                                    break;
                            }
                        }
                        else if (from.EmoteHue == 4)
                        {
                            switch (Utility.Random(31))
                            {
                                default:
                                case 0:
                                    monster = new GarnetElemental();
                                    break;
                                case 1:
                                    monster = new TopazElemental();
                                    break;
                                case 2:
                                    monster = new QuartzElemental();
                                    break;
                                case 3:
                                    monster = new SpinelElemental();
                                    break;
                                case 4:
                                    monster = new StarRubyElemental();
                                    break;
                                case 5:
                                    monster = new GarnetElemental();
                                    break;
                                ...
                                case 14:
                                    ...
                                    break;
                                case 15:
                                    monster = new EarthElemental();
                                    break;
                                case 16:
                                    monster = new AgapiteElemental();
                                    break;
                                case 17:
                                    monster = new BronzeElemental();
                                    break;
                                case 18:
                                    monster = new CopperElemental();
                                    break;
                                case 19:
                                    monster = new DullCopperElemental();
                                    break;
                                case 20:
                                    monster = new GoldenElemental();
                                    break;
                                case 21:
                                    monster = new ShadowIronElemental();
                                    break;
                                case 22:
                                    monster = new ValoriteElemental();
                                    break;
                                case 23:
                                    monster = new VeriteElemental();
                                    break;
                                case 24:
                                    monster = new PoisonElemental();
                                    break;
                                case 25:
                                    monster = new ToxicElemental();
                                    break;
                                case 26:
                                    monster = new WaterElemental();
                                    break;
                                case 27:
                                    monster = new AirElemental();
                                    break;
                                case 28:
                                    monster = new BloodElemental();
                                    break;
                                case 29:
                                    monster = new FireElemental();
                                    break;
                                case 30:
                                    monster = new ElectricalElemental();
                                    break;
                            }
                        }
                        else if (from.EmoteHue == 5)
                        {
                            switch (Utility.Random(14))
                            {
                                default:
                                case 0:
                                    monster = new BoneKnight();
                                    break;
                                case 1:
                                    monster = new BoneMagi();
                                    break;
                                case 2:
                                    monster = new Ghoul();
                                    break;
                                ...
                                case 5:
                                    ...
                                    break;
                                case 6:
                                    monster = new SkeletalKnight();
                                    break;
                                case 7:
                                    monster = new SkeletalMage();
                                    break;
                                case 8:
                        ...
                        else if (from.EmoteHue == 6)
                        {
                            switch (Utility.Random(4))
                            {
                                default:
                                case 0:
                                    monster = new DireBear();
                                    break;
                                case 1:
                                    monster = new DireBoar();
                                    break;
                                case 2:
                                    monster = new DireWolf();
                                    break;
                                case 3:
                                    monster = new WeedElemental();
                                    break;
                            }
                        }
                        else if (from.EmoteHue == 7)
                        {
                            switch (Utility.Random(9))
                            {
                                default:
                                case 0:
                                    monster = new SnowElemental();
                                    break;
                                case 1:
                                    monster = new IceSerpent();
                                    break;
                                case 2:
                                    monster = new IceElemental();
                                    break;
                                case 3:
                                    monster = new FrostOoze();
                                    break;
                                case 4:
                                    monster = new FrostSpider();
                                    break;
                                case 5:
                                    monster = new IceGolem();
                                    break;
                                case 6:
                                    monster = new IceToad();
                                    break;
                        ...
                        else if (from.EmoteHue == 8)
                        {
                            switch (Utility.Random(9))
                            {
                                ...
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    monster = new LavaPuddle();
                                    break;
                                case 2:
                                    monster = new CinderElemental();
                                    break;
                                case 3:
                                    monster = new FireElemental();
                                    break;
                        ...
                        else if (from.EmoteHue == 9)
                        {
                            switch (Utility.Random(11))
                            {
                                default:
                                case 0:
                                    monster = new GiantSerpent();
                                    break;
                                case 1:
                                    monster = new GiantAdder();
                                    break;
                                case 2:
                                    monster = new JungleViper();
                                    break;
                                case 3:
                                    monster = new LargeSnake();
                                    break;
                                case 4:
                                    monster = new Snake();
                                    break;
                        ...
                        else if (from.EmoteHue == 10)
                        {
                            switch (Utility.Random(5))
                            {
                                ...
                                case 2:
                                    ...
                                    break;
                                case 3:
                                    monster = new StormCloud();
                                    break;
                                case 4:
                                    monster = new WaterSpawn();
                                    break;
                            }
                        }
                        else if (from.EmoteHue == 11 || from.EmoteHue == 505)
                        {
                            switch (Utility.Random(5))
                            {
                                default:
                                case 0:
                                    monster = new EvilIcyVortex();
                                    break;
                                case 1:
                                    monster = new EvilPlagueVortex();
                                    break;
                                case 2:
                                    monster = new EvilEnergyVortex();
                                    break;
                                case 3:
                                    monster = new EvilScorchingVortex();
                                    break;
                                case 4:
                                    monster = new EvilBladeSpirits();
                                    break;
                        ...
                        else if (from.EmoteHue == 12)
                        {
                            switch (Utility.Random(3))
                            {
                                default:
                                case 0:
                                    monster = new WineElemental();
                                    break;
                                case 1:
                                    monster = new ManureGolem();
                                    break;
                                case 2:
                                    monster = new Fairy();
                                    break;
                        ...
                        else if (from.EmoteHue == 13)
                        {
                            ...
                            switch (Utility.RandomMinMax(0, MaxMonster))
                            {
                                ...
                                case 3:
                                    ...
                                    break;
                                case 4:
                                    monster = new GhostWarrior();
                                    break;
                                case 5:
                                    monster = new Wight();
                                    break;
                                case 6:
                                    monster = new SkeletalWarrior();
                                    break;
                                case 7:
                                    monster = new WalkingCorpse();
                                    break;
                                case 8:
                                    monster = new SkeletalKnight();
                                    break;
                        ...
                        else if (from.EmoteHue == 14)
                        {
                            switch (Utility.Random(5))
                            {
                                ...
                                case 0:
                                case 1:
                                    monster = new DeathWolf();
                                    break;
                                case 2:
                                case 3:
                                    monster = new DeathBear();
                                    break;
                                case 4:
                                    monster = new DarkReaper();
                                    break;
                            }
                        }
                        else if (from.EmoteHue == 15)
                        ...
                        else if (from.EmoteHue == 17)
                        {
                            switch (Utility.Random(7))
                            {
                                ...
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    monster = new SandVortex();
                                    break;
                                case 2:
                                    monster = new SandVortex();
                                    break;
                                case 3:
                                    monster = new DustElemental();
                                    break;
                                case 4:
                                    monster = new DustElemental();
                                    break;
                                case 5:
                                    monster = new SandSpider();
                                    break;
                                case 6:
                                    monster = new GiantAdder();
                                    break;
                    ...
                    from.Say(
                        ""
                            + NameList.RandomName("magic words")
                            + " "
                            + NameList.RandomName("magic words")
                            + " "
                            + NameList.RandomName("magic words")
            ...
            if (CanHaveShield == 1 && Utility.RandomMinMax(1, 3) == 1)
            {
                switch (Utility.Random(16))
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        armor = new MetalKiteShield();
                        break;
                    case 3:
                        armor = new HeaterShield();
                        break;
                    case 4:
                        armor = new WoodenKiteShield();
                        break;
                    case 5:
                        armor = new MetalShield();
                        break;
                    case 6:
                        armor = new GuardsmanShield();
                        break;
                    case 7:
                        armor = new ElvenShield();
                        break;
                    case 8:
                        armor = new DarkShield();
                        break;
                    case 9:
                        armor = new CrestedShield();
                        break;
                    case 10:
                        armor = new ChampionShield();
                        break;
                    case 11:
        ...
        public static void DressUpMerchants(Mobile from)
        {
            ...
            else if (from is Elementalist)
            {
                hasRobe = true;
                wizard = true;
                robeHue = Server.Spells.Elementalism.ElementalSpell.ElementalHue("any");
            }
            ...
            {
                hasRobe = true;
                robeHue = MorphingTime.GetRandomNecromancerHue();
                wizard = true;
            }
            ...
            {
                shirtHue = Utility.RandomGreenHue();
                robeHue = Utility.RandomGreenHue();
            }
            ...
            if ((Utility.RandomMinMax(1, 20) == 1 || hasRobe) && !apron)
            {
                ...
                if ((from.Body == 0x191 || from.Body == 606) && Utility.RandomBool() && !player)
                {
                    ...
                    {
                        case 1:
                            from.AddItem(new PlainDress(robeHue));
                            break;
                        case 2:
                            from.AddItem(new GildedDress(robeHue));
                            break;
                        case 3:
                            from.AddItem(new FancyDress(robeHue));
                            break;
                    }
                }
                else
                {
                    ...
                    {
                        case 1:
                            from.AddItem(new FancyRobe(robeHue));
                            break;
                        case 2:
                            from.AddItem(new GildedRobe(robeHue));
                            break;
                        case 3:
                            from.AddItem(new OrnateRobe(robeHue));
                            break;
                        case 4:
                            from.AddItem(new MagistrateRobe(robeHue));
                            break;
                        case 5:
                            from.AddItem(new RoyalRobe(robeHue));
                            break;
                        case 6:
                            from.AddItem(new ExquisiteRobe(robeHue));
                            break;
                        case 7:
                            from.AddItem(new ProphetRobe(robeHue));
                            break;
                        case 8:
                            from.AddItem(new ElegantRobe(robeHue));
                            break;
                        case 9:
                            from.AddItem(new FormalRobe(robeHue));
                            break;
                        case 10:
                            from.AddItem(new ArchmageRobe(robeHue));
                            break;
                        case 11:
                            from.AddItem(new PriestRobe(robeHue));
                            break;
                        case 12:
                            from.AddItem(new CultistRobe(robeHue));
                            break;
                        case 13:
                            from.AddItem(new SageRobe(robeHue));
                            break;
                        case 14:
                            from.AddItem(new ScholarRobe(robeHue));
                            break;
                        case 15:
                            from.AddItem(new AssassinRobe(robeHue));
                            break;
                    }
                }
            }
            ...
            if (!gown)
            {
                switch (Utility.RandomMinMax(1, 7))
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        from.AddItem(new RoyalCoat(shirtHue));
                        break;
                    case 3:
                        from.AddItem(new RoyalShirt(shirtHue));
                        break;
                    case 4:
                        from.AddItem(new SquireShirt(shirtHue));
                        break;
                    case 5:
                        from.AddItem(new FormalCoat(shirtHue));
                        break;
                    case 6:
                        from.AddItem(new WizardShirt(shirtHue));
                        break;
                    case 7:
                        from.AddItem(new Shirt(shirtHue));
                        break;
                }
                ...
                if ((from.Body == 0x191 || from.Body == 606) && Utility.RandomBool())
                {
                    ...
                    {
                        case 1:
                            from.AddItem(new RoyalSkirt(pantsHue));
                            break;
                        case 2:
                            from.AddItem(new RoyalLongSkirt(pantsHue));
                            break;
                        case 3:
                ...
                else
                {
                    ...
                    {
                        case 1:
                            from.AddItem(new LongPants(legsHue));
                            break;
                        case 2:
                            from.AddItem(new SailorPants(legsHue));
                            break;
                        case 3:
                            from.AddItem(new PiratePants(legsHue));
                            break;
                        case 4:
                            from.AddItem(new ShortPants(legsHue));
                            break;
                        case 5:
                            from.AddItem(new LongPants(legsHue));
                            break;
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                            from.AddItem(new Kilt(pantsHue));
                            break;
                        case 9:
                            from.AddItem(new ShortPants(legsHue));
                            break;
            ...
            switch (Utility.RandomMinMax(1, 10))
            {
                case 1:
                    ...
                    break;
                case 2:
                    from.AddItem(new BarbarianBoots(Utility.RandomNeutralHue()));
                    break;
                case 3:
                    from.AddItem(new Boots(Utility.RandomNeutralHue()));
                    break;
                case 4:
                    from.AddItem(new ThighBoots(Utility.RandomNeutralHue()));
                    break;
                case 5:
                    from.AddItem(new Shoes(Utility.RandomNeutralHue()));
                    break;
                case 6:
                    from.AddItem(new Sandals(Utility.RandomNeutralHue()));
                    break;
                case 7:
                    from.AddItem(new ElvenBoots(Utility.RandomNeutralHue()));
                    break;
                case 8:
                    from.AddItem(new Boots(Utility.RandomNeutralHue()));
                    break;
            ...
            if (wizard)
            {
                if (Utility.RandomBool())
                {
                    ...
                    {
                        case 0:
                            from.AddItem(new ClothCowl(robeHue));
                            break;
                        case 1:
                            from.AddItem(new ClothHood(robeHue));
                            break;
                        case 2:
                            from.AddItem(new FancyHood(robeHue));
                            break;
                        case 3:
                            from.AddItem(new WizardHood(robeHue));
                            break;
                        case 4:
                            from.AddItem(new HoodedMantle(robeHue));
                            break;
                    }
                }
                else
            ...
            if (player && Utility.RandomBool())
            {
                ...
                {
                    case 0:
                        from.AddItem(new ClothCowl(cowlHue));
                        break;
                    case 1:
                        from.AddItem(new ClothHood(cowlHue));
                        break;
                    case 2:
                        from.AddItem(new FancyHood(cowlHue));
                        break;
                    case 3:
                        from.AddItem(new WizardHood(cowlHue));
                        break;
                    case 4:
                        from.AddItem(new HoodedMantle(cowlHue));
                        break;
                    case 5:
                        from.AddItem(new FloppyHat(hatHue));
                        break;
                    case 6:
                        from.AddItem(new WideBrimHat(hatHue));
                        break;
                    case 7:
                        from.AddItem(new Cap(hatHue));
                        break;
                    case 8:
                        from.AddItem(new SkullCap(hatHue));
                        break;
                    case 9:
                        from.AddItem(new Bandana(hatHue));
                        break;
                    case 10:
                        from.AddItem(new TallStrawHat());
                        break;
                    case 11:
                        from.AddItem(new StrawHat());
                        break;
                    case 12:
                        from.AddItem(new WizardsHat(cowlHue));
                        break;
                    case 13:
                        from.AddItem(new WitchHat(cowlHue));
                        break;
                    case 14:
                        from.AddItem(new FeatheredHat(hatHue));
                        break;
                }
            }
        ...
        public static void DressUpWizards(Mobile from, bool isDojo)
        {
            ...
            if (isDojo)
            {
                ...
                {
                    case 1:
                        robe = new VagabondRobe();
                        break;
                    case 2:
                        robe = new ShinobiRobe();
                        break;
                    case 3:
                        robe = new ProphetRobe();
                        break;
                    case 4:
                        robe = new ScholarRobe();
                        break;
                    case 5:
                        robe = new Robe();
                        break;
            ...
            else if (Utility.RandomBool())
            {
                ...
                switch (wear)
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        robe = new MagistrateRobe();
                        break;
                    case 5:
                        robe = new RoyalRobe();
                        break;
                    case 6:
                        robe = new NecromancerRobe();
                        break;
                    case 7:
                        robe = new SpiderRobe();
                        break;
                    case 8:
                        ...
                        break;
                    case 9:
                        robe = new ExquisiteRobe();
                        break;
                    case 10:
                        robe = new ProphetRobe();
                        break;
                    case 11:
                        robe = new ElegantRobe();
                        break;
                    case 12:
                        robe = new FormalRobe();
                        break;
                    case 13:
                        robe = new ArchmageRobe();
                        break;
                    case 14:
                        robe = new PriestRobe();
                        break;
                    case 15:
                        robe = new CultistRobe();
                        break;
                    case 16:
                        robe = new GildedDarkRobe();
                        break;
                    case 17:
                        robe = new GildedLightRobe();
                        break;
                    case 18:
                        robe = new SageRobe();
                        break;
            ...
            if (Utility.RandomBool())
            {
                ...
                else if (Utility.RandomBool())
                {
                    ...
                    {
                        case 0:
                            hat = new ClothCowl(clothHue);
                            break;
                        case 1:
                            hat = new ClothHood(clothHue);
                            break;
                        case 2:
                            hat = new FancyHood(clothHue);
                            break;
                        case 3:
                            hat = new WizardHood(clothHue);
                            break;
                        case 4:
                            hat = new HoodedMantle(clothHue);
                            break;
                    }
                    from.AddItem(hat);
                }
        ...
        public static void DressUpBards(Mobile from)
        {
            ...
            switch (Utility.Random(4))
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    from.AddItem(new StrawHat(hatHue));
                    break;
                case 3:
                    from.AddItem(new SkullCap(hatHue));
                    break;
        ...
        public static void DressUpFighters(
            Mobile m,
            string race,
            bool isEnemy,
            bool isDojo,
        ...
        )
        {
            ...
            {
                cloakColor = Utility.RandomColor(0);
                m.AddItem(new Cloak(cloakColor));
            }

            int aHue = Utility.RandomList(
                0x973,
                0x966,
                0x96D,
                0x972,
            ...
            else if (iArmor == 5)
            {
                ...
                {
                    case 0:
                        LightPlateJingasa cloth4 = new LightPlateJingasa();
                        cloth4.Hue = lHue;
                        m.AddItem(cloth4);
                        break;
                    case 1:
                        ChainHatsuburi cloth5 = new ChainHatsuburi();
                        cloth5.Hue = lHue;
                        m.AddItem(cloth5);
                        break;
                    case 2:
                        DecorativePlateKabuto cloth6 = new DecorativePlateKabuto();
                        cloth6.Hue = lHue;
                        m.AddItem(cloth6);
                        break;
                    case 3:
                        LeatherJingasa cloth7 = new LeatherJingasa();
                        cloth7.Hue = lHue;
                        m.AddItem(cloth7);
                        break;
                }
                ...
                {
                    case 0:
                        StuddedHaidate cloth8 = new StuddedHaidate();
                        cloth8.Hue = lHue;
                        m.AddItem(cloth8);
                        break;
                    case 1:
                        LeatherSuneate cloth9 = new LeatherSuneate();
                        cloth9.Hue = lHue;
                        m.AddItem(cloth9);
                        break;
                    case 2:
                        PlateSuneate cloth0 = new PlateSuneate();
                        cloth0.Hue = lHue;
                        m.AddItem(cloth0);
                        break;
                }
            ...
            if (CanHaveHelm > 0)
            {
                if (cloakColor > 0 && Utility.Random(20) == 1)
                {
                    ...
                    {
                        case 1:
                            m.AddItem(new ClothCowl(cloakColor));
                            break;
                        case 2:
                            m.AddItem(new ClothHood(cloakColor));
                            break;
                        case 3:
                            m.AddItem(new FancyHood(cloakColor));
                            break;
                        case 4:
                            m.AddItem(new HoodedMantle(cloakColor));
                            break;
                    }
                }
                else
                {
                    ...
                    {
                        case 0:
                            Item helm1 = new PlateHelm();
                            helm1.Hue = hHue;
                            m.AddItem(helm1);
                            break;
                        case 1:
                            Item helm2 = new Bascinet();
                            helm2.Hue = hHue;
                            m.AddItem(helm2);
                            break;
                        case 2:
                            Item helm3 = new ChainCoif();
                            helm3.Hue = hHue;
                            m.AddItem(helm3);
                            break;
                        case 3:
                            Item helm4 = new CloseHelm();
                            helm4.Hue = hHue;
                            m.AddItem(helm4);
                            break;
                        case 4:
                            Item helm5 = new LeatherCap();
                            helm5.Hue = hHue;
                            m.AddItem(helm5);
                            break;
                        case 5:
                            Item helm6 = new Helmet();
                            helm6.Hue = hHue;
                            m.AddItem(helm6);
                            break;
                        case 6:
                            Item helm7 = new OrcHelm();
                            helm7.Hue = hHue;
                            m.AddItem(helm7);
                            break;
                        case 7:
                            Item helm8 = new NorseHelm();
                            helm8.Hue = hHue;
                            m.AddItem(helm8);
                            break;
                        case 8:
                            Item helm9 = new BoneHelm();
                            helm9.Hue = hHue;
                            m.AddItem(helm9);
                            break;
                        case 9:
                            Item helm10 = new OrcHelm();
                            helm10.Name = "great helm";
                            helm10.ItemID = 0x2645;
                            helm10.Hue = hHue;
                            m.AddItem(helm10);
                            break;
                        case 10:
                            Item helm11 = new MagicJewelryCirclet();
                            helm11.Hue = hHue;
                            m.AddItem(helm11);
                            break;
                    }
            ...
            if (isTown && Utility.RandomMinMax(1, 20) == 1)
            {
                ...
                switch (Utility.Random(8))
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        weapon = new ElvenCompositeLongbow();
                        break;
                    case 4:
                        weapon = new HeavyCrossbow();
                        break;
                    case 5:
                        weapon = new MagicalShortbow();
                        break;
                    case 6:
                        weapon = new RepeatingCrossbow();
                        break;
                    case 7:
                        weapon = new Yumi();
                        break;
            ...
            {
                case 0:
                    m.Title = "the " + race + "fighter";
                    break;
                case 1:
                    m.Title = "the " + race + "knight";
                    break;
                case 2:
                    m.Title = "the " + race + "champion";
                    break;
                case 3:
                    m.Title = "the " + race + "warrior";
                    break;
                case 4:
                    m.Title = "the " + race + "soldier";
                    break;
                case 5:
                    m.Title = "the " + race + "vanquisher";
                    break;
                case 6:
                    m.Title = "the " + race + "battler";
                    break;
                case 7:
                    m.Title = "the " + race + "gladiator";
                    break;
                case 8:
                    m.Title = "the " + race + "mercenary";
                    break;
                case 9:
                    m.Title = "the " + race + "nomad";
                    break;
                case 10:
                    m.Title = "the " + race + "berserker";
                    break;
                case 11:
                    m.Title = "the " + race + "barbarian";
                    if (m.Female)
                    {
                    ...
                    break;
                case 12:
                    m.Title = "the " + race + "pit fighter";
                    break;
                case 13:
                    m.Title = "the " + race + "brute";
                    break;
                case 14:
                    m.Title = "the " + race + "samurai";
                    break;
                case 15:
                    m.Title = "the " + race + "ronin";
                    break;
            }
        ...
        public static void DressUpRogues(
            Mobile m,
            string race,
            bool isEnemy,
            bool isDojo,
        ...
        )
        {
            ...
            int pantsHue = Utility.RandomList(
                0x973,
                0x966,
                0x96D,
                0x972,
            ...
            else if (iArmor == 2)
            {
                ...
                {
                    case 0:
                        m.Title = "the " + race + "assassin";
                        suit = "assassin";
                        m.YellHue = 2;
                        break;
                    case 1:
                        m.Title = "the " + race + "hunter";
                        suit = "hunter";
                        break;
                    case 2:
                        m.Title = "the " + race + "ninja";
                        suit = "ninja";
                        myHelm = Utility.RandomList(6, 10, 11, 12, 13);
                        break;
                }
            ...
            else
            {
                ...
                {
                    case 0:
                        cloth1 = new RoyalCoat();
                        break;
                    case 1:
                        cloth1 = new RoyalShirt();
                        break;
                    case 2:
                        cloth1 = new RusticShirt();
                        break;
                    case 3:
                        cloth1 = new SquireShirt();
                        break;
                    case 4:
                        cloth1 = new FormalCoat();
                        break;
                    case 5:
                        cloth1 = new WizardShirt();
                        break;
                }
                cloth1.Hue = clothHue;
                m.AddItem(cloth1);
                ...
                if ((m.Body == 0x191 || m.Body == 606) && Utility.RandomBool())
                {
                    ...
                    {
                        case 0:
                            cloth2 = new RoyalSkirt();
                            break;
                        case 1:
                            cloth2 = new RoyalLongSkirt();
                            break;
                    }
                    cloth2.Hue = pantsHue;
                    m.AddItem(cloth2);
                ...
                else
                {
                    ...
                    {
                        case 0:
                            cloth2 = new LongPants();
                            break;
                        case 1:
                            cloth2 = new SailorPants();
                            break;
                        case 2:
                            cloth2 = new PiratePants();
                            break;
                    }
                    cloth2.Hue = pantsHue;
                    m.AddItem(cloth2);
            ...
            {
                case 0:
                    m.Title = "the " + race + "thief";
                    break;
                case 1:
                    m.Title = "the " + race + "rogue";
                    break;
                case 2:
                    m.Title = "the " + race + "outlaw";
                    break;
                case 3:
                    m.Title = "the " + race + "bandit";
                    break;
                case 4:
                    m.Title = "the " + race + "pickpocket";
                    break;
                case 5:
                    m.Title = "the " + race + "burglar";
                    break;
                case 6:
                    m.Title = "the " + race + "robber";
                    break;
                case 7:
                    m.Title = "the " + race + "criminal";
                    break;
                case 8:
                    m.Title = "the " + race + "prowler";
                    break;
                case 9:
                    m.Title = "the " + race + "pilferer";
                    break;
            }
            ...
            if (Utility.RandomBool() || m.Title == "the " + race + "ninja")
            {
                ...
                {
                    case 0:
                        Item helm1 = new SkullCap();
                        helm1.Hue = clothHue;
                        m.AddItem(helm1);
                        break;
                    case 1:
                        Item helm2 = new FloppyHat();
                        helm2.Hue = clothHue;
                        m.AddItem(helm2);
                        break;
                    case 2:
                        Item helm3 = new LeatherCap();
                        helm3.Hue = clothHue;
                        m.AddItem(helm3);
                        break;
                    case 3:
                        Item helm4 = new FeatheredHat();
                        helm4.Hue = clothHue;
                        m.AddItem(helm4);
                        break;
                    case 4:
                        Item helm5 = new MagicJewelryCirclet();
                        helm5.Hue = clothHue;
                        m.AddItem(helm5);
                        break;
                    case 5:
                        Item helm6 = new WideBrimHat();
                        helm6.Hue = clothHue;
                        m.AddItem(helm6);
                        break;
                    case 6:
                        Item helm7 = new LeatherNinjaHood();
                        helm7.Hue = clothHue;
                        m.AddItem(helm7);
                        break;
                    case 7:
                        Item helm8 = new ClothCowl();
                        helm8.Hue = clothHue;
                        m.AddItem(helm8);
                        break;
                    case 8:
                        Item helm9 = new ClothHood();
                        helm9.Hue = clothHue;
                        m.AddItem(helm9);
                        break;
                    case 9:
                        Item helm10 = new HoodedMantle();
                        helm10.Hue = clothHue;
                        m.AddItem(helm10);
                        break;
                    case 10:
                        Item helm11 = new ShinobiCowl();
                        helm11.Hue = clothHue;
                        m.AddItem(helm11);
                        break;
                    case 11:
                        Item helm12 = new ShinobiHood();
                        helm12.Hue = clothHue;
                        m.AddItem(helm12);
                        break;
                    case 12:
                        Item helm13 = new ShinobiMask();
                        helm13.Hue = clothHue;
                        m.AddItem(helm13);
                        break;
                    case 13:
                        Item helm14 = new OniwabanHood();
                        helm14.Hue = clothHue;
                        m.AddItem(helm14);
                        break;
                }
            ...
            else
            {
                switch (Utility.Random(19))
                {
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        weapon = new AssassinSpike();
                        break;
                    case 12:
                        weapon = new RuneBlade();
                        CanHaveShield = 0;
                        break;
                    case 13:
                        weapon = new Leafblade();
                        break;
                    case 14:
                        weapon = new ElvenSpellblade();
                        break;
                    case 15:
                        weapon = new ElvenMachete();
                        break;
                    case 16:
                        weapon = new LargeKnife();
                        break;
                    case 17:
                        weapon = new ShortSword();
                        break;
        ...
        public static void GiveAdventureGear(BaseCreature m)
        {
            if (Utility.RandomMinMax(1, 10) > 3)
            {
                ...
                {
                    case 0:
                        m.PackItem(new BreadLoaf(Utility.RandomMinMax(1, 3)));
                        break;
                    case 1:
                        m.PackItem(new CheeseWheel(Utility.RandomMinMax(1, 3)));
                        break;
                    case 2:
                        m.PackItem(new Ribs(Utility.RandomMinMax(1, 3)));
                        break;
                    case 3:
                        m.PackItem(new Apple(Utility.RandomMinMax(1, 3)));
                        break;
                    case 4:
                        m.PackItem(new CookedBird(Utility.RandomMinMax(1, 3)));
                        break;
                    case 5:
                        m.PackItem(new LambLeg(Utility.RandomMinMax(1, 3)));
                        break;
                }
            }
            if (Utility.RandomMinMax(1, 10) > 3)
            {
                ...
                {
                    case 0:
                        m.PackItem(new BeverageBottle(BeverageType.Ale));
                        break;
                    case 1:
                        m.PackItem(new BeverageBottle(BeverageType.Wine));
                        break;
                    case 2:
                        m.PackItem(new BeverageBottle(BeverageType.Liquor));
                        break;
                    case 3:
                        m.PackItem(new Jug(BeverageType.Cider));
                        break;
                    case 4:
                        m.PackItem(new Waterskin());
                        break;
                }
            }
            if (Utility.RandomMinMax(1, 10) > 3)
            {
                ...
                {
                    case 0:
                        m.PackItem(new Torch());
                        break;
                    case 1:
                        m.PackItem(new Candle());
                        break;
                    case 2:
                        m.PackItem(new Lantern());
                        break;
                }
            }
            if (Utility.RandomMinMax(1, 10) > 3)
            {
                ...
                {
                    case 0:
                        m.PackItem(new Bandage(Utility.RandomMinMax(5, 15)));
                        break;
                    case 1:
                        LesserCurePotion pot1 = new LesserCurePotion();
                        pot1.Amount = Utility.RandomMinMax(1, 2);
                        m.PackItem(pot1);
                        break;
                    case 2:
                        LesserHealPotion pot2 = new LesserHealPotion();
                        pot2.Amount = Utility.RandomMinMax(1, 2);
                        m.PackItem(pot2);
                        break;
                }
            }
            ...
            if (Utility.RandomMinMax(1, 10) > 3)
            {
                ...
                {
                    case 0:
                        TenFootPole pole = new TenFootPole();
                        pole.Charges = Utility.RandomMinMax(1, 10);
                        Server.Items.TenFootPole.Material(pole, 1);
                        m.PackItem(pole);
                        break;
                    case 1:
                        m.PackItem(new Lockpick());
                        break;
                    case 2:
                        m.PackItem(new SkeletonsKey());
                        break;
                    case 3:
                        m.PackItem(new Bottle(Utility.RandomMinMax(1, 3)));
                        break;
                    case 4:
                        m.PackItem(new Pouch());
                        break;
                    case 5:
                        m.PackItem(new Bag());
                        break;
                    case 6:
                        ...
                        break;
                    case 7:
                        m.PackItem(new Kindling(Utility.RandomMinMax(1, 3)));
                        break;
                    case 8:
        ...
        public static void MakeAssassinNote(Mobile from)
        {
            ...
            if (MakeNote)
            {
                ...
                {
                    int gold =
                        (int)((killer.RawStr + killer.RawDex + killer.RawInt) / 12)
                        + Utility.RandomMinMax(0, 5);
                    string a = "him";
                    string b = "he";
                    string c = "his";
                    ...
                    switch (Utility.RandomMinMax(0, 9))
                    {
                        case 1:
                            ScrollText =
                                "If we are going to carry out our plans, you need to kill "
                                + killer.Name
                                + " as we think "
                                + b
                                + " will become a problem for us. We heard from the "
                                + RandomThings.GetRandomJob()
                                + " in "
                                + RandomThings.GetRandomCity()
                                + " that "
                                + b
                                ...
                                + ". Wait for "
                                + a
                                + " there and strike when the time is right. If we do not see you return to "
                                + RandomThings.GetRandomCity()
                                + " soon, we will assume you failed.<br><br> - "
                                + RandomThings.GetRandomSociety();
                            break;
                        case 2:
                            ScrollText =
                                QuestCharacters.ParchmentWriter()
                                + ",<br><br>We all know who stole the "
                                + gold.ToString()
                                + ",000 gold from me in "
                                + RandomThings.GetRandomCity()
                                + ". I will make a deal with you. You find out where "
                                + from.Name
                                + " is hiding and tell them that I will overlook this incident if they do something for me. They need to go to "
                                + Server.Misc.Worlds.GetRegionName(from.Map, from.Location)
                                + " and wait in the shadows for "
                                + killer.Name
                                + " to arrive. When "
                                + b
                                + " is spotted, they need to kill "
                                + a
                                + " before "
                                + b
                                + " finds what "
                                + b
                                + " is looking for. When the deed is done, the debt will be forgiven.<br><br> - "
                                + QuestCharacters.ParchmentWriter();
                            break;
                        case 3:
                            ScrollText =
                                from.Name
                                + ",<br><br>The time is almost near, but there are some that fear of "
                                + killer.Name
                                + " causing a problem for us. We need to send "
                                + a
                                + " away from this life before "
                                + b
                                + " realizes what we are about to do. "
                                + QuestCharacters.ParchmentWriter()
                                + " has followed "
                                + a
                                + " to "
                                ...
                                + a
                                + " there. Do not fail, as you would not want to face the judgement of "
                                + RandomThings.GetRandomSociety()
                                + ".";
                            break;
                        case 4:
                            ScrollText =
                                QuestCharacters.ParchmentWriter()
                                + ",<br><br>I have another problem for you to take care of. A "
                                + RandomThings.GetRandomJob()
                                + " in "
                                + RandomThings.GetRandomCity()
                                + " is paying us "
                                + gold.ToString()
                                + ",000 gold to assassinate the one who killed their friend. I think we should send "
                                + from.Name
                                + " to deal with "
                                + a
                                + ", and "
                                ...
                                + " is known as "
                                + killer.Name
                                + ". I believe they headed in the direction of "
                                + Server.Misc.Worlds.GetRegionName(from.Map, from.Location)
                                + ". Have them wait for "
                                + a
                                + " there.<br><br> - "
                        ...
                        case 5:
                            ScrollText =
                                ...
                                + ",<br><br>I was in "
                                + RandomThings.GetRandomCity()
                                + " and I heard some whispers of a "
                                + gold.ToString()
                                + ",000 gold bounty on "
                                + killer.Name
                                + ". I also heard that "
                                + RandomThings.GetRandomSociety()
                                + " is the one offering the gold. I don't need to remind you that we have been trying to gain their trust so we can acquire "
                                + Server.Misc.QuestCharacters.QuestItems(true)
                                + ". I paid the barkeep a few coins and found out where "
                                + b
                                + " might be. I will check out the place nearby. You head to "
                                + Server.Misc.Worlds.GetRegionName(from.Map, from.Location)
                                + " and look for "
                                + a
                                + " there. We will meet each other in "
                                + RandomThings.GetRandomCity()
                                + " in a few days. This could be the chance we were waiting for.<br><br> - "
                                + QuestCharacters.ParchmentWriter();
                            break;
                        case 6:
                            ScrollText =
                                from.Name
                                + ",<br><br>You are to slay the one they call "
                                + killer.Name
                                + ". They have been a little too curious of what lies within "
                                + Server.Misc.Worlds.GetRegionName(from.Map, from.Location)
                                + ", and we do not need "
                                + a
                                + " getting in our way to find "
                                + Server.Misc.QuestCharacters.QuestItems(true)
                                + ". If "
                                + b
                                + " finds it before we do, it could mean our very lives "
                                + RandomThings.GetRandomSociety()
                                + " will want. I will be going to "
                                + RandomThings.GetRandomCity()
                                + " to get some supplies, but I will return soon.<br><br> - "
                                + QuestCharacters.ParchmentWriter();
                            break;
                        case 7:
                            ScrollText =
                                from.Name
                                + ",<br><br>Now that you eliminated "
                                + QuestCharacters.ParchmentWriter()
                                + ", it is time for your next target. This will be well worth your time as the fee being paid for this one is "
                                + gold.ToString()
                                + ",000 gold. They are known as "
                                + killer.Name
                                + ", and "
                                + b
                                + " has been talking about exploring "
                                + Server.Misc.Worlds.GetRegionName(from.Map, from.Location)
                                + ". If this is true, then "
                                + QuestCharacters.ParchmentWriter()
                                + " would have to hide "
                                + Server.Misc.QuestCharacters.QuestItems(true)
                                + " elsewhere. You can guess by the gold being offered, that they would rather not resort to such actions. Take care of "
                                + a
                                + " and we will split the gold in "
                                + RandomThings.GetRandomCity()
                                + ".";
                            break;
                        case 8:
                            ScrollText =
                                ...
                                + ",<br><br>"
                                + killer.Name
                                + " has meddled in our plans for the last time. "
                                + QuestCharacters.ParchmentWriter()
                                + " claims that "
                                + b
                                + " doesn't even know of "
                                + c
                                + " participation in my annoyance, but the time to act is now. I think we should give this mission to "
                                + from.Name
                                + ", as they have yet to fail us. Send "
                                + from.Name
                                + " to "
                                + Server.Misc.Worlds.GetRegionName(from.Map, from.Location)
                                + " and kill "
                                ...
                                + " before "
                                + b
                                + " leaves the area. Bring back "
                                + Server.Misc.QuestCharacters.QuestItems(true)
                                + " if "
                                + b
                                + " is found with it.<br><br> - "
                                + QuestCharacters.ParchmentWriter();
                            break;
                        case 9:
                            ScrollText =
                                from.Name
                                + ",<br><br>I left that magic item in a dungeon chest for safe keeping, but "
                                + killer.Name
                                + " ended up taking it! Find "
                                + a
                                + " and kill "
                                + a
                                + "! See if "
                                + b
                                + " still has it. If you find it, head to "
                                + RandomThings.GetRandomCity()
                                + " and give it to the "
                                + RandomThings.GetRandomJob()
        ...
        public static void ChooseMonk(Mobile m, string race)
        {
            ...
            if (Utility.RandomBool())
            {
                ...
                {
                    case 1:
                        glove.WeaponAttributes.HitLeechHits = myBonus;
                        break;
                    case 2:
                        glove.WeaponAttributes.HitLeechStam = myBonus;
                        break;
                    case 3:
                        glove.WeaponAttributes.HitLeechMana = myBonus;
                        break;
                    case 4:
                        glove.WeaponAttributes.HitMagicArrow = myBonus;
                        break;
                    case 5:
                        glove.WeaponAttributes.HitHarm = myBonus;
                        break;
                    case 6:
                        glove.WeaponAttributes.HitFireball = myBonus;
                        break;
                    case 7:
                        glove.WeaponAttributes.HitLightning = myBonus;
                        break;
                    case 8:
                        glove.WeaponAttributes.HitColdArea = myBonus;
                        break;
                    case 9:
                        glove.WeaponAttributes.HitFireArea = myBonus;
                        break;
                    case 10:
                        glove.WeaponAttributes.HitPoisonArea = myBonus;
                        break;
                    case 11:
                        glove.WeaponAttributes.HitEnergyArea = myBonus;
                        break;
                    case 12:
                        glove.WeaponAttributes.HitPhysicalArea = myBonus;
                        break;
                }
            ...
            else
            {
                ...
                {
                    case 1:
                        ring.WeaponAttributes.HitLeechHits = myBonus;
                        break;
                    case 2:
                        ring.WeaponAttributes.HitLeechStam = myBonus;
                        break;
                    case 3:
                        ring.WeaponAttributes.HitLeechMana = myBonus;
                        break;
                    case 4:
                        ring.WeaponAttributes.HitMagicArrow = myBonus;
                        break;
                    case 5:
                        ring.WeaponAttributes.HitHarm = myBonus;
                        break;
                    case 6:
                        ring.WeaponAttributes.HitFireball = myBonus;
                        break;
                    case 7:
                        ring.WeaponAttributes.HitLightning = myBonus;
                        break;
                    case 8:
                        ring.WeaponAttributes.HitColdArea = myBonus;
                        break;
                    case 9:
                        ring.WeaponAttributes.HitFireArea = myBonus;
                        break;
                    case 10:
                        ring.WeaponAttributes.HitPoisonArea = myBonus;
                        break;
                    case 11:
                        ring.WeaponAttributes.HitEnergyArea = myBonus;
                        break;
                    case 12:
                        ring.WeaponAttributes.HitPhysicalArea = myBonus;
                        break;
                }
        ...
        public static void ChooseFighter(Mobile m, string race)
        {
            ...
            else if (equip == 2) // BLACK KNIGHT'S VAULT
            {
                ...
                {
                    case 0:
                        BattleAxe weapon1 = new BattleAxe();
                        weapon1.Hue = 0x497;
                        m.AddItem(weapon1);
                        break;
                    case 1:
                        Halberd weapon2 = new Halberd();
                        weapon2.Hue = 0x497;
                        m.AddItem(weapon2);
                        break;
                    case 2:
                        DoubleAxe weapon3 = new DoubleAxe();
                        weapon3.Hue = 0x497;
                        m.AddItem(weapon3);
                        break;
                    case 3:
                        ExecutionersAxe weapon4 = new ExecutionersAxe();
                        weapon4.Hue = 0x497;
                        m.AddItem(weapon4);
                        break;
                    case 4:
                        WarAxe weapon5 = new WarAxe();
                        weapon5.Hue = 0x497;
                        m.AddItem(weapon5);
                        break;
                    case 5:
                        TwoHandedAxe weapon6 = new TwoHandedAxe();
                        weapon6.Hue = 0x497;
                        m.AddItem(weapon6);
                        break;
                    case 6:
                        VikingSword weapon7 = new VikingSword();
                        weapon7.Hue = 0x497;
                        m.AddItem(weapon7);
                        ...
                        break;
                    case 7:
                        ThinLongsword weapon8 = new ThinLongsword();
                        weapon8.Hue = 0x497;
                        m.AddItem(weapon8);
                        if (Utility.Random(3) == 1)
                        {
                        ...
                        break;
                    case 8:
                        Longsword weapon9 = new Longsword();
                        weapon9.Hue = 0x497;
                        m.AddItem(weapon9);
                        if (Utility.Random(3) == 1)
                        {
                        ...
                        break;
                    case 9:
                        Broadsword weapon0 = new Broadsword();
                        weapon0.Hue = 0x497;
                        m.AddItem(weapon0);
                        if (Utility.Random(3) == 1)
                        {
        ...
        {
            if (
                (100 - m.PhysicalResistance) < Utility.RandomMinMax(1, 100)
            ...
            )
            {
                ...
                m.LocalOverheadMessage(
                    ...
                    0xB1F,
                    true,
                    "You are hit with a stunning punch!"
                );
            }
        }
        ...
        public static void PoisonVictim(Mobile m, Mobile from)
        {
            ...
            if (
                !(Server.Items.HiddenTrap.SavingThrow(m, "Poison", false))
                && Utility.RandomMinMax(1, 5) == 1
                && CanPoison == true
            )
            {
        ...
        public static void HideStealMove(Mobile from, Mobile m)
        {
            ...
            if (m != null && m.Hits > 0)
            {
                ...
                if (
                    m.Skills[SkillName.Hiding].Value >= Utility.RandomMinMax(1, 120)
                    && m.Hits <= hits
                    && Utility.RandomMinMax(1, 5) == 1
                )
                {
            ...
            {
                if (
                    m.Skills[SkillName.Stealing].Value >= Utility.RandomMinMax(1, 125)
                    && m.Skills[SkillName.Snooping].Value >= Utility.RandomMinMax(1, 100)
                )
                {
                        ...
                        foreach (Item stuff in belongings)
                        {
                            ...
                            if (c == o)
                            {
                                ...
                                from.LocalOverheadMessage(
                                    ...
                                    0xB1F,
                                    true,
                                    m.Name + " stole something from you!"
                                );
                            }
                        }
                    }
            ...
            if (
                IHide > 0
                && Utility.RandomMinMax(1, 5) == 5
                && m.Skills[SkillName.Stealth].Value >= Utility.RandomMinMax(1, 125)
            )
            {
                m.Delete();
            }
        ...
        public static void CryOut(Mobile from)
        {
            if (Utility.RandomMinMax(1, 3) == 1)
            {
                ...
                {
                    case 0:
                        from.PlaySound(from.Female ? 0x14B : 0x154);
                        break;
                    case 1:
                        from.PlaySound(from.Female ? 0x14C : 0x155);
                        break;
                    case 2:
                        from.PlaySound(from.Female ? 0x14D : 0x156);
                        break;
                    case 3:
                        from.PlaySound(from.Female ? 0x14E : 0x157);
                        break;
                    case 4:
                        from.PlaySound(from.Female ? 0x14F : 0x158);
                        break;
                    case 5:
                        from.PlaySound(from.Female ? 0x14F : 0x159);
                        break;
                }
            }
        }
        ...
        public static bool TestForReagent(Mobile from, string job)
        {
            if (
                job == "necromancer"
                && from.Skills[SkillName.Necromancy].Value >= Utility.RandomMinMax(25, 125)
            )
            {
                return true;
            }
            if (
                job == "alchemist"
                && from.Skills[SkillName.Alchemy].Value >= Utility.RandomMinMax(25, 125)
            )
            {
                return true;
            }
            if (
                job == "undertaker"
                && from.Skills[SkillName.Forensics].Value >= Utility.RandomMinMax(25, 125)
            )
            {
                return true;
            }
            ...
            if (
                job == "wizard"
                && from.Skills[SkillName.Magery].Value >= Utility.RandomMinMax(25, 125)
            )
            {
                return true;
            }
            if (
                job == "herbalist"
                && from.Skills[SkillName.Taming].Value >= Utility.RandomMinMax(25, 125)
        ...
        public static void DropReagent(Mobile player, BaseCreature monster)
        {
            ...
            if (monster is Pixie || monster is Sprite || monster is Faerie)
            {
                ...
                {
                    case 0:
                        monster.PackItem(new FairyEgg(Utility.RandomMinMax(1, 2)));
                        break;
                    case 1:
                        monster.PackItem(new PixieSkull(1));
                        break;
                    case 2:
                        monster.PackItem(new ButterflyWings(Utility.RandomMinMax(1, 2)));
                        break;
                }
            }
            ...
            if (plants.Slays(monster))
            {
                ...
                {
                    case 0:
                        monster.PackItem(new MandrakeRoot(amount));
                        break;
                    case 1:
                        monster.PackItem(new Nightshade(amount));
                        break;
                    case 2:
                        monster.PackItem(new SwampBerries(amount));
                        break;
                    case 3:
                        monster.PackItem(new RedLotus(amount));
                        break;
                    case 4:
                        monster.PackItem(new Ginseng(amount));
                        break;
                    case 5:
                        monster.PackItem(new Garlic(amount));
                        break;
                    case 6:
                        monster.PackItem(new BitterRoot(amount));
                        break;
                    case 7:
                        monster.PackItem(new VioletFungus(amount));
                        break;
                    case 8:
                        monster.PackItem(new BloodRose(amount));
                        break;
                    case 9:
                        monster.PackItem(new Wolfsbane(amount));
                        break;
                }
            }
        }
        ...
        public static void DropItem(Mobile from, Mobile killer)
        {
            if (
                from is BoneMagi
                || from is SkeletalMage
                || from is SkeletalWizard
                || from is Lich
                || from is Vordo
                || from is Nazghoul
                || from is LichLord
            ...
            )
            {
                if (from.Fame > Utility.Random(40000))
                {
                    ...
                    {
                        skull.Name = skull.Name + " " + from.Title;
                        skull.Hue = from.Hue;
                    }
                    from.AddItem(skull);
                }
        ...
        public static void BeforeMyBirth(Mobile from)
        {
            ...
            )
            {
                ...
                reg.IsPartOf("the Hidden Valley")
                && (from is EvilMage || from is ElfMage || from is OrkMage)
            )
            {
                from.EmoteHue = 6;
            ...
            )
            {
                ...
                reg.IsPartOf("the Ruins of the Black Blade")
                || reg.IsPartOf(typeof(BardDungeonRegion))
            )
            {
                from.EmoteHue = 0;
            }
            else if (from.Map == Map.IslesDread || reg.IsPartOf("the Blood Temple"))
            {
                from.EmoteHue = 2;
                PackGear = 0;
            }
            ...
            )
            {
                ...
                || (
                    Utility.RandomMinMax(1, 4) > 1
                    && Server.Misc.Worlds.TestTile(from.Map, from.X, from.Y, "forest")
                )
            ...
            else // RANDOM MAGE
            {
                switch (Utility.RandomMinMax(0, 10))
                {
                    case 0:
                        from.EmoteHue = 0;
                        break; // Mages with no Summoning
                    case 1:
                        from.EmoteHue = 1;
                        break; // Traditional Mages
                    case 2:
                        from.EmoteHue = 3;
                        break; // Demonologists
                    case 3:
            ...
            else if (from.EmoteHue == 5)
            {
                ...
                {
                    case 0:
                        from.Title = from.Title + " of death";
                        break;
                    case 1:
                        from.Title = from.Title + " of the grave";
                        break;
                    case 2:
                        from.Title = from.Title + " of the dead";
                        break;
                }
            ...
            else if (from.EmoteHue == 6)
            {
                ...
                {
                    case 0:
                        from.Title = from.Title + " of the woods";
                        break;
                    case 1:
                        from.Title = from.Title + " of the forest";
                        break;
                    case 2:
                        from.Title = from.Title + " of the glade";
                        break;
                }
            ...
            else if (from.EmoteHue == 7)
            {
                ...
                {
                    case 0:
                        from.Title = from.Title + " of ice";
                        break;
                    case 1:
                        from.Title = from.Title + " of frost";
                        break;
                    case 2:
                        from.Title = from.Title + " of the snow";
                        break;
                }
            ...
            else if (from.EmoteHue == 8)
            {
                ...
                {
                    case 0:
                        from.Title = from.Title + " of fire";
                        break;
                    case 1:
                        from.Title = from.Title + " of the flame";
                        break;
                    case 2:
                        from.Title = from.Title + " of flame";
                        break;
                }
            ...
            else if (from.EmoteHue == 9)
            {
                ...
                {
                    case 0:
                        from.Title = from.Title + " of snakes";
                        break;
                    case 1:
                        from.Title = from.Title + " of venom";
                        break;
                    case 2:
                        from.Title = from.Title + " of serpents";
                        break;
                }
            ...
            else if (from.EmoteHue == 10)
            {
                ...
                {
                    case 0:
                        from.Title = from.Title + " of the sea";
                        break;
                    case 1:
                        from.Title = from.Title + " of the deep";
                        break;
                    case 2:
                        from.Title = from.Title + " of the lake";
                        break;
                }
            ...
            else if (from.EmoteHue == 12)
            {
                ...
                {
                    case 0:
                        from.Title = from.Title + " of insanity";
                        break;
                    case 1:
                        from.Title = from.Title + " of dementia";
                        break;
                    case 2:
                        from.Title = from.Title + " of mania";
                        break;
                    case 3:
                        from.Title = from.Title + " of lunacy";
                        break;
                    case 4:
                        from.Title = from.Title + " of madness";
                        break;
                    case 5:
                        from.Title = from.Title + " of hysteria";
                        break;
                }
            ...
            else if (from.EmoteHue == 17)
            {
                ...
                {
                    case 0:
                        from.Title = from.Title + " of the sands";
                        break;
                    case 1:
                        from.Title = from.Title + " of the desert";
                        break;
                    case 2:
                        from.Title = from.Title + " of the wastes";
                        break;
                    case 3:
                        from.Title = from.Title + " of the barrens";
                        break;
                    case 4:
                        from.Title = from.Title + " of the wasteland";
                        break;
                    case 5:
                        from.Title = from.Title + " of the badlands";
                        break;
                }
            ...
            ((BaseCreature)from).SetSkill(
                SkillName.Marksmanship,
                from.Skills[SkillName.Magery].Value
            );
            if (Utility.RandomBool())
            {
                caster.Name = "staff";
                caster.ItemID = Utility.RandomList(
                    0xDF0,
                    0x13F8,
                    0xE89,
                    0x2D25,
        ...
        public static void SaySomethingWhenAttacking(Mobile from, Mobile m)
        {
            if (
                from.Name != "a sailor"
                && from.Name != "a pirate"
                && from.Name != "a follower"
                && m != null
                && from.EmoteHue != 505
                && ((BaseCreature)from).ControlSlots != 666
                && ((BaseCreature)from).GetMaster() == null
                && Utility.Random(5) == 1
            )
            {
                if (from.SpeechHue < 1)
                ...
                if (m is PlayerMobile)
                {
                    if (from is Exodus)
                    {
                        ...
                        {
                            case 0:
                                from.Say("I will vanquish your existence from all time!");
                                break;
                            case 1:
                                from.Say("" + m.Name + ", prepare to meet your end!");
                                break;
                            case 2:
                                from.Say("You cannot stop the destruction I will soon unleash!");
                                break;
                            case 3:
                                from.Say("My diligence will be your ultimate doom!");
                                break;
                        }
                        ;
                    }
                    else if (from is FleshGolem || from is AncientFleshGolem)
                    {
                        ...
                        {
                            case 0:
                                from.Say("I am fearless, and therefore powerful!");
                                break;
                            case 1:
                                from.Say("I am a monster, cut off from all the world!");
                                break;
                            case 2:
                                from.Say("To be whole again, I must destroy you!");
                                break;
                            case 3:
                                from.Say("Fell the wrath of my master!");
                                break;
                        }
                        ;
                    }
                    else if (from is BloodDemigod)
                    {
                        ...
                        {
                            case 0:
                                from.Say("Foolish mortal!");
                                break;
                            case 1:
                                from.Say("I will summon your gore to crawl these halls!");
                                break;
                            case 2:
                                from.Say("Your life only feeds my own!");
                                break;
                            case 3:
                                from.Say("Let this be your final battle!");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("Your soul will be mine!");
                                break;
                            case 1:
                                from.Say("I will use your corpse to feed my minions!");
                                break;
                            case 2:
                                from.Say("Do you think you can slay one such as me?!");
                                break;
                            case 3:
                                from.Say("I look forward to torturing your soul, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is DeepSeaDevil || from is DemonOfTheSea)
                    {
                        ...
                        {
                            case 0:
                                from.Say("Your soul will soon be one with the deep!");
                                break;
                            case 1:
                                from.Say("You dare face the power of the sea?!");
                                break;
                            case 2:
                                from.Say(
                                    "Are you ready to serve me in the depths, " + m.Name + "?!"
                                );
                                break;
                            case 3:
                                from.Say("I will drag your corpse into the sea!");
                                break;
                        }
                        ;
                    }
                    else if (from is IceDevil)
                    {
                        ...
                        {
                            case 0:
                                from.Say("Your soul will soon be encased in ice!");
                                break;
                            case 1:
                                from.Say("You dare face my glacial power?!");
                                break;
                            case 2:
                                from.Say("Are your bones cold yet, " + m.Name + "?!");
                                break;
                            case 3:
                                from.Say("I will freeze your blood and shatter your soul!");
                                break;
                        }
                        ;
                    }
                    else if (from is Succubus)
                    {
                        ...
                        {
                            case 0:
                                from.Say("Your blood smells sweet!");
                                break;
                            case 1:
                                from.Say("Are you ready to give yourself to me?!");
                                break;
                            case 2:
                                from.Say("Your life only feeds my own!");
                                break;
                            case 3:
                                from.Say("You will make me young again, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is Satan)
                    {
                        ...
                        {
                            case 0:
                                from.Say("Your soul will serve me well!");
                                break;
                            case 1:
                                from.Say("I will break a spirit such as yours!");
                                break;
                            case 2:
                                from.Say("Do you feel the power of hell on you?!");
                                break;
                            case 3:
                                from.Say("Your soul will be mine, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is VampiricDragon)
                    {
                        ...
                        {
                            case 0:
                                from.Say("I will drain every breath of life from you!");
                                break;
                            case 1:
                                from.Say("I can smell the blood from your wounds!");
                                break;
                            case 2:
                                from.Say("Fool...I cannot kill what is dead?!");
                                break;
                            case 3:
                                from.Say("Your corpse will rise and serve me, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is ShadowWyrm)
                    {
                        ...
                        {
                            case 0:
                                from.Say("I will take you from the light!");
                                break;
                            case 1:
                                from.Say("I can feel the darkness filling you!");
                                break;
                            case 2:
                                from.Say("Fool...you can never bring me to the light!");
                                break;
                            case 3:
                                from.Say("Your life will end in darkness, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is AshDragon || from is VolcanicDragon)
                    {
                        ...
                        {
                            case 0:
                                from.Say("I will leave your corpse as ashes!");
                                break;
                            case 1:
                                from.Say("I can smell your burning flesh!");
                                break;
                            case 2:
                                from.Say("Fool...you cannot survive the flames!");
                                break;
                            case 3:
                                from.Say(
                                    "Cinders will be all that is left of you, " + m.Name + "!"
                                );
                                break;
                        }
                        ;
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("I have slain those mightier than you, " + m.Name + "!");
                                break;
                            case 1:
                                from.Say("You will make me an excellent meal!");
                                break;
                            case 2:
                                from.Say("Many have died trying to take what is mine!");
                                break;
                            case 3:
                                from.Say("I will swallow you whole, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (
                        from is FireGargoyle
                        || from is Gargoyle
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("Esaeu lizz gia xes zes soth!");
                                break;
                            case 1:
                                from.Say("Dnadona qae zaaq esaeun doom!");
                                break;
                            case 2:
                                from.Say("I lizz raeq chq esaeu xaed za!");
                                break;
                            case 3:
                                from.Say("Dnadona qae gia, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is ZornTheBlacksmith)
                    {
                        ...
                        {
                            case 0:
                                from.Say("You will never have the secrets of the ore!");
                                break;
                            case 1:
                                from.Say("You should leave before I crush you!");
                                break;
                            case 2:
                                from.Say("Feel the power of my hammer!");
                                break;
                            case 3:
                                from.Say("I will tell all on how I crushed " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is OrkDemigod)
                    {
                        ...
                        {
                            case 0:
                                from.Say("Kneel before me you puny creature!");
                                break;
                            case 1:
                                from.Say("Feel the might of the orks!");
                                break;
                            case 2:
                                from.Say("I will become your new god, " + m.Name + "!");
                                break;
                            case 3:
                                from.Say("I have slain those more powerful than you!");
                                break;
                        }
                        ;
                    }
                    else if (
                        from is TrollWitchDoctor
                        || from is Troll
                        || from is SwampTroll
                        || from is SeaTroll
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("Me will be eating your " + organ + " me thinks!");
                                break;
                            case 1:
                                from.Say("Me see you living no longer!");
                                break;
                            case 2:
                                from.Say("You will be dead by me hand!");
                                break;
                            case 3:
                                from.Say("Me will be feasting on your bones soon!");
                                break;
                        }
                        ;
                    }
                    else if (
                        from is AncientEttin
                        || from is EttinShaman
                        || from is Ettin
                        || from is ArcticEttin
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("I smash you to pulp!");
                                break;
                            case 1:
                                from.Say("I will smash you into dirt!");
                                break;
                            case 2:
                                from.Say("You will make great feast for us!");
                                break;
                            case 3:
                                from.Say("You leave our land now!");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("Feel the wrath of the storm!");
                                break;
                            case 1:
                                from.Say("I unleash the storms on you!");
                                break;
                            case 2:
                                from.Say("This will be your final battle, " + m.Name + "!");
                                break;
                            case 3:
                                from.Say("You think you can defeat me?!");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("Me hit, you die!");
                                break;
                            case 1:
                                from.Say("You no match for me!");
                                break;
                            case 2:
                                from.Say("Me make soup with your " + organ + "!");
                                break;
                            case 3:
                                from.Say("You weak, me strong!");
                                break;
                        }
                        ;
                    }
                    else if (from is IceGiant)
                    {
                        ...
                        {
                            case 0:
                                from.Say("Feel the cold of glacial ice!");
                                break;
                            case 1:
                                from.Say("You are nothing but an insect to me!");
                                break;
                            case 2:
                                from.Say("" + m.Name + ", you dare face me!");
                                break;
                            case 3:
                                from.Say("Your frozen corpse will decorate my halls!");
                                break;
                        }
                        ;
                    }
                    else if (from is LavaGiant)
                    {
                        ...
                        {
                            case 0:
                                from.Say("Feel the fires of volcanic might!");
                                break;
                            case 1:
                                from.Say("You are nothing but an insect to me!");
                                break;
                            case 2:
                                ...
                                break;
                            case 3:
                                from.Say("You will soon be nothing but ashes!");
                                break;
                        }
                        ;
                    }
                    else if (from is DeepSeaGiant || from is SeaGiant)
                    {
                        switch (Utility.Random(4))
                        {
                            case 0:
                                from.Say("Feel the strength of the sea!");
                                break;
                            case 1:
                                from.Say("You will soon will rot below the waves!");
                                break;
                            case 2:
                                from.Say("" + m.Name + ", your bones will lie with the crabs!");
                                break;
                            case 3:
                                from.Say("You are no match for the gods of the sea!");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("My foot will be the last thing you see!");
                                break;
                            case 1:
                                from.Say("I will crush you into the dirt!");
                                break;
                            case 2:
                                from.Say("" + m.Name + ", you will die!");
                                break;
                            case 3:
                                from.Say("I have defeated foes larger than you!");
                                break;
                        }
                        ;
                    }
                    else if (
                        from is TheAncientTree
                        || from is Ent
                        || from is EvilEnt
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("You...dare...fight...me?!");
                                break;
                            case 1:
                                from.Say("I...will...dispatch...of...you!");
                                break;
                            case 2:
                                from.Say("My...might...outweighs...yours!");
                                break;
                            case 3:
                                from.Say("You...will...die...in...this...fight!");
                                break;
                        }
                        ;
                    }
                    else if (from is SwampThing)
                    {
                        ...
                        {
                            case 0:
                                from.Say("Gri Gril Gestroy Groo!");
                                break;
                            case 1:
                                from.Say("Groo Gran Grever Gregreat Gre!");
                                break;
                            case 2:
                                from.Say("Grour Grones Gril Gray Grin Gry Grwamp!");
                                break;
                            case 3:
                                from.Say("Groo Grar Gro Gratch Gror Gre!");
                                break;
                        }
                        ;
                    }
                    else if (from is Beholder)
                    {
                        ...
                        {
                            case 0:
                                from.Say("*blinks a red eye*");
                                break;
                            case 1:
                                from.Say("*blinks a blue eye*");
                                break;
                            case 2:
                                from.Say("*blinks a greed eye*");
                                break;
                            case 3:
                                from.Say("*blinks a yellow eye*");
                                break;
                        }
                        ;
                    }
                    else if (from is Dracolich || from is SkeletalDragon)
                    {
                        switch (Utility.Random(4))
                        {
                            case 0:
                                from.Say("Your soul will make an excellent meal!");
                                break;
                            case 1:
                                from.Say("" + m.Name + ", do I frighten you?!");
                                break;
                            case 2:
                                from.Say("I have destroyed armies of things like you!");
                                break;
                            case 3:
                                from.Say("You dare invade my lair?!");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        switch (Utility.Random(4))
                        {
                            case 0:
                                ...
                                break;
                            case 1:
                                from.Say("Look into my eyes...");
                                break;
                            case 2:
                                from.Say("Submit, and I will make it quick!");
                                break;
                            case 3:
                                from.Say("You think I have not faced mortals like you?!");
                                break;
                        }
                        ;
                    }
                    else if (from is Dracula)
                    {
                        ...
                        {
                            case 0:
                                from.Say("" + m.Name + ", your blood will fill my glass tonight!");
                                break;
                            case 1:
                                from.Say("Look into my eyes, " + m.Name + "...");
                                break;
                            case 2:
                                from.Say("Your blood will decorate these walls!");
                                break;
                            case 3:
                                from.Say("You should be honored to be slain by me!");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("Feel the power of " + from.Name + "!");
                                break;
                            case 1:
                                from.Say("I will have a place for the bones of " + m.Name + "!");
                                break;
                            case 2:
                                from.Say("" + m.Name + ", you are a fool to face me!");
                                break;
                            case 3:
                                from.Say("My magic will decimate you!");
                                break;
                        }
                        ;
                    }
                    else if (from is Executioner)
                    {
                        ...
                        {
                            case 0:
                                from.Say("" + m.Name + ", you are sentenced to death!");
                                break;
                            case 1:
                                from.Say("Your head will look good on the block!");
                                break;
                            case 2:
                                from.Say("My blade is eager to sever your head!");
                                break;
                            case 3:
                                from.Say("This will be your final fight!");
                                break;
                        }
                        ;
                    }
                    else if (from is BlackKnight)
                    {
                        ...
                        {
                            case 0:
                                from.Say("" + m.Name + ", do you think you can defeat me?!");
                                break;
                            case 1:
                                from.Say("You will never gain entry to my vault!");
                                break;
                            case 2:
                                from.Say("Many have come here and all have perished!");
                                break;
                            case 3:
                                from.Say("Your treasure will help fill my vault!");
                                break;
                        }
                        ;
                    }
                    else if (from is Archmage)
                    {
                        ...
                        {
                            case 0:
                                from.Say("" + m.Name + ", you have no hope against my power!");
                                break;
                            case 1:
                                from.Say("You will never leave this place alive!");
                                break;
                            case 2:
                                from.Say("You are no match for my magic!");
                                break;
                            case 3:
                                from.Say("All that have come here have perished!");
                                break;
                        }
                        ;
                    }
                    else if (from is BombWorshipper || from is Psionicist)
                    {
                        switch (Utility.Random(9))
                        {
                            case 0:
                                from.Say(
                                    "I have converted others stonger than you, " + m.Name + "!"
                                );
                                break;
                            case 1:
                                from.Say("You will soon be one with the glow!");
                                break;
                            case 2:
                                from.Say(
                                    "All will know that "
                                ...
                                break;
                            case 3:
                                from.Say("Maybe you should flee before it is too late!");
                                break;
                            case 4:
                                from.Say("Do you think you can beat me?!");
                                break;
                            case 5:
                                from.Say("No one desecrates the temple of the bomb!");
                                break;
                            case 6:
                                from.Say("Your life ends here!");
                                break;
                            case 7:
                                from.Say("Your life ends here, " + m.Name + "!");
                                break;
                            case 8:
                                from.Say("You will kneel before the bomb!");
                                break;
                        }
                        ;
                    }
                    else if (from is Syth)
                    {
                        switch (Utility.Random(9))
                        {
                            case 0:
                                from.Say(
                                    "The Syth will be the last thing you see, " + m.Name + "!"
                                );
                                break;
                            case 1:
                                from.Say("You will submit to my dark power!");
                                break;
                            case 2:
                                from.Say("No one will find the bones of " + m.Name + "!");
                                break;
                            case 3:
                                from.Say("You should have fled but it is too late!");
                                break;
                            case 4:
                                from.Say("Do you think you can beat me?!");
                                break;
                            case 5:
                                from.Say("No one has faced a syth and lived!");
                                break;
                            case 6:
                                from.Say("Your life ends here!");
                                break;
                            case 7:
                                ...
                                break;
                            case 8:
                                from.Say("You will kneel before the Syth!");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("I have slain others better than you, " + m.Name + "!");
                                break;
                            case 1:
                                from.Say("Your riches will soon be mine!");
                                break;
                            case 2:
                                from.Say(
                                    "All will know that " + from.Name + " defeated " + m.Name + "!"
                                );
                                break;
                            case 3:
                                from.Say("Maybe you should flee before it is too late!");
                                break;
                            case 4:
                                from.Say("Do you think you can best me?!");
                                break;
                            case 5:
                                from.Say("Let this be your final battle!");
                                break;
                            ...
                            case 7:
                                ...
                                break;
                            case 8:
                                from.Say("All should fear " + from.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is Adventurers || from is Jedi)
                    {
                        switch (Utility.Random(9))
                        {
                            case 0:
                                from.Say(
                                    "I have brought justice to others more vile than you, "
                                        + m.Name
                                        + "!"
                                );
                                break;
                            case 1:
                                from.Say("You will pay for your crimes!");
                                break;
                            case 2:
                                from.Say(
                                    "All will know that "
                                ...
                                break;
                            case 3:
                                from.Say("You should have fled this land long ago!");
                                break;
                            case 4:
                                from.Say("Do you think you can best me?!");
                                break;
                            ...
                            case 7:
                                ...
                                break;
                            case 8:
                                from.Say("Your evil will be vanquished!");
                                break;
                        }
                        ;
                    }
                    else if (Server.Mobiles.BasePirate.IsSailor(from))
                    {
                        ...
                        {
                            case 0:
                                from.Say("" + m.Name + ", you will soon walk the plank!");
                                break;
                            case 1:
                                from.Say("I could beat you if I were three sheets to the wind!");
                                break;
                            case 2:
                                from.Say("I will splice the mainbrace over your corpse!");
                                break;
                            case 3:
                                from.Say("You will soon become shark bait!");
                                break;
                            case 4:
                                from.Say("You scurvy dog, do you think you can best me?!");
                                break;
                            case 5:
                                from.Say("I fought scallywags better than you!");
                                break;
                            case 6:
                                from.Say("No pray, no pay. Your riches will be mine!");
                                break;
                            case 7:
                                from.Say("You landlubber, prepare to die!");
                                break;
                            case 8:
                                from.Say("" + from.Name + ", you will soon feed the fish!");
                                break;
                        }
                        ;
                    }
            ...
            )
            {
                ...
                if (m is PlayerMobile)
                {
                    ...
                    else if (from is FleshGolem || from is AncientFleshGolem)
                    {
                        ...
                        {
                            case 0:
                                from.Say("No...I am eternal!");
                                break;
                            case 1:
                                from.Say("No...How can this be?!");
                                break;
                            case 2:
                                from.Say("Peace has finally found me...");
                                break;
                            case 3:
                                from.Say("I failed you my master...");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("No...I will not be vanquished!");
                                break;
                            case 1:
                                from.Say("I will return...");
                                break;
                            case 2:
                                from.Say("I hope the curses of hell fill your soul!");
                                break;
                            case 3:
                                from.Say("Death is only a distraction to me!");
                                break;
                            case 4:
                                from.Say("I will come for you, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is DeepSeaDevil || from is DemonOfTheSea)
                    {
                        switch (Utility.Random(5))
                        {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                from.Say("I hope the blood of the sea drowns you!");
                                break;
                            case 3:
                                from.Say("Fool...I will rise again!");
                                break;
                            case 4:
                                from.Say("One day you will be taken by the sea, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is IceDevil)
                    {
                        switch (Utility.Random(5))
                        {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                from.Say("The frost of death will find you!");
                                break;
                            case 3:
                                from.Say("Fool...you can never destroy me!");
                                break;
                            case 4:
                                from.Say("My cold heart will come for you, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    ...
                    else if (from is Satan)
                    {
                        ...
                        {
                            case 0:
                                from.Say("No...I cannot return to hell!");
                                break;
                            case 1:
                                from.Say("Hell will not be able to hold me...");
                                break;
                            case 2:
                                from.Say("" + m.Name + ", I will return for you!");
                                break;
                            case 3:
                                from.Say("Fool...I am eternal!");
                                break;
                            case 4:
                                from.Say("I will have your soul one day, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is VampiricDragon)
                    {
                        ...
                        {
                            case 0:
                                from.Say("No...you cannot do this!");
                                break;
                            case 1:
                                from.Say("Curse you, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is ShadowWyrm)
                    {
                        ...
                        {
                            case 0:
                                from.Say("No...you cannot have light without dark!");
                                break;
                            case 1:
                                from.Say("Let the shadows take you, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    else if (from is AshDragon || from is VolcanicDragon)
                    {
                        ...
                        {
                            case 0:
                                from.Say("No...this cannot be how it ends!");
                                break;
                            case 1:
                                from.Say("Let the mountain fires take you, " + m.Name + "!");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("No...this cannot be the end!");
                                break;
                            case 1:
                                from.Say("How...can...this...be...");
                                break;
                            case 2:
                                from.Say("No, " + m.Name + "!");
                                break;
                            case 3:
                                from.Say("What is this madness?!");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("Rae...sael yor yiz xa?");
                                break;
                            case 1:
                                from.Say("Zae zes hima ends sabbia!");
                                break;
                        }
                        ;
                    }
                    else if (from is ZornTheBlacksmith)
                    {
                        ...
                        {
                            case 0:
                                from.Say("No...you will never get the ore!");
                                break;
                            case 1:
                                from.Say("You will never find the caddellite!");
                                break;
                        }
                        ;
                    }
                    else if (from is OrkDemigod)
                    {
                        ...
                        {
                            case 0:
                                from.Say("You cannot defeat the power of gods...");
                                break;
                            case 1:
                                from.Say("" + m.Name + ", you have bested me in battle...");
                                break;
                            case 2:
                                from.Say("No...");
                                break;
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("Me cannot lose!");
                                break;
                            case 1:
                                from.Say("Me curse you...");
                                break;
                        }
                        ;
                    }
                    ...
                    )
                    {
                        switch (Utility.Random(2))
                        {
                            case 0:
                                ...
                                break;
                            case 1:
                                from.Say("You...fight...good...");
                                break;
                        }
                        ;
                    }
                    else if (from is Titan || from is ElderTitan || from is StormGiant)
                    {
                        switch (Utility.Random(4))
                        {
                            case 0:
                                from.Say("By what thunder is this?");
                                break;
                            case 1:
                                from.Say("No, it cannot be...");
                                break;
                            case 2:
                                from.Say("You may have won this day, " + m.Name + "...but...");
                                break;
                            case 3:
                                from.Say("Arrgghhh...");
                                break;
                    ...
                    else if (from is IceGiant)
                    {
                        ...
                        {
                            case 0:
                                from.Say("By iceberg's might, how...");
                                break;
                            case 1:
                                from.Say("Arrgghhh...");
                                break;
                    ...
                    else if (from is DeepSeaGiant || from is SeaGiant)
                    {
                        ...
                        {
                            case 0:
                                from.Say("By Neptunes's might, how...");
                                break;
                            case 1:
                                from.Say("By Poseidon's wrath, how...");
                                break;
                            case 2:
                                from.Say("Arrgghhh...");
                                break;
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("How...did...you...");
                                break;
                            case 1:
                                from.Say("I...am...no...more...");
                                break;
                        }
                        ;
                    }
                    ...
                    else if (from is Dracolich || from is SkeletalDragon)
                    {
                        ...
                        {
                            case 0:
                                from.Say("My power is eternal!");
                                break;
                            case 1:
                                from.Say("" + m.Name + ", I will have my revenge...");
                                break;
                            case 2:
                                from.Say("No, how can this be?!");
                                break;
                    ...
                    )
                    {
                        ...
                        {
                            case 0:
                                from.Say("My magic is eternal!");
                                break;
                            case 1:
                                from.Say("" + m.Name + ", I will have vengeance...");
                                break;
                            case 2:
                                from.Say("No...how can...");
                                break;
...
namespace Server
{
    public class OppositionGroup
    {
        ...
        private static OppositionGroup m_TerathansAndOphidians = new OppositionGroup(
            new Type[][] { new Type[] { typeof(WaterSpawn) }, new Type[] { typeof(WaterSpawn) } }
        );
            ...
            if ((m_Mobile.LastMoveTime + TimeSpan.FromSeconds(1.0)) < DateTime.Now)
            {
                ...
                else
                {
                    if (m_Mobile.Combatant != null)
                    {
                        if (m_Mobile.Debug)
                            m_Mobile.DebugSay(
                                "I am still not in range of {0}",
                                m_Mobile.Combatant.Name
                            );

                        if (
                            (int)m_Mobile.GetDistanceToSqrt(m_Mobile.Combatant)
...
namespace Server.Mobiles
{
    ...
    public abstract class BaseAI
    {
        ...
        public virtual double DeactivationDelay
        {
            get { return SetDeactivation.DefaultDeactivationDelay; }
        } // delay in minutes
            ...
            public override void OnClick()
            {
                if (!m_Mobile.Deleted && m_Mobile.Controlled && m_From.CheckAlive())
                {
                    if (
                        m_Mobile.IsDeadPet
                        && (
                            m_Order == OrderType.Guard
                            || m_Order == OrderType.Attack
                    ...
                    if (!isOwner && !isFriend)
                        ...
                        isFriend
                        && m_Order != OrderType.Follow
                        && m_Order != OrderType.Stay
                        && m_Order != OrderType.Stop
                    )
                        return;
        ...
        public virtual void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            if (from.Alive && m_Mobile.Controlled && from.InRange(m_Mobile, 14))
            {
                ...
                else if (from == m_Mobile.ControlMaster)
                {
                    ...
                    {
                        list.Add(
                            new InternalEntry(from, 6110, 14, m_Mobile, this, OrderType.Friend)
                        ); // Add Friend
                        list.Add(
                            new InternalEntry(from, 6099, 14, m_Mobile, this, OrderType.Unfriend)
                        ); // Remove Friend
                        list.Add(
                            new InternalEntry(from, 6113, 14, m_Mobile, this, OrderType.Transfer)
                        ); // Transfer
                    }
        ...
        public virtual void BeginPickTarget(Mobile from, OrderType order)
        {
            if (
                m_Mobile.Deleted
                || !m_Mobile.Controlled
                || !from.InRange(m_Mobile, 14)
                || from.Map != m_Mobile.Map
            )
                return;
            ...
            if (order == OrderType.Attack)
            {
                if (
                    ...
                    || (
                        ...
                        && ((BaseCreature)target).IsScaryToPets
                        && m_Mobile.IsScaredOfScaryThings
                    )
                )
                {
        ...
        public virtual void OnSpeech(SpeechEventArgs e)
        {
            if (
                e.Mobile.Alive
                && e.Mobile.InRange(m_Mobile.Location, 3)
                && m_Mobile.IsHumanInTown()
            )
            {
                    ...
                    if (toTrain != (SkillName)(-1) && WasNamed(e.Speech))
                    {
                        ...
                        else
                        {
                            ...
                            if (
                                skill == null
                                || skill.Base < 60.0
                                || !m_Mobile.CheckTeach(toTrain, e.Mobile)
                            )
                            {
        ...
        public virtual bool DoActionWander()
        {
            ...
            else if (m_Mobile.CurrentWayPoint != null)
            {
                ...
                if (
                    (point.X != m_Mobile.Location.X || point.Y != m_Mobile.Location.Y)
                    && point.Map == m_Mobile.Map
                    && point.Parent == null
                    && !point.Deleted
                )
                {
            ...
            else if (m_Mobile.IsAnimatedDead)
            {
                ...
                if (
                    master != null
                    && master.Map == m_Mobile.Map
                    && master.InRange(m_Mobile, m_Mobile.RangePerception)
                )
        ...
        public virtual void OnCurrentOrderChanged()
        {
            if (
                ...
                || m_Mobile.ControlMaster.Deleted
            )
                return;
        ...
        public virtual bool DoOrderFollow()
        {
            if (CheckHerding())
            {
                ...
                && m_Mobile.ControlTarget != m_Mobile
            )
            {
                ...
                if (iCurrDist > m_Mobile.RangePerception)
                {
                    ...
                    {
                        m_Mobile.MoveToWorld(
                            (m_Mobile.ControlTarget).Location,
                            (m_Mobile.ControlTarget).Map
                        );
                    }
                ...
                {
                    m_Mobile.DebugSay(
                        "My master told me to follow: {0}",
                        m_Mobile.ControlTarget.Name
                    );
                    ...
                    if (fromState != null && toState != null)
                    {
                        ...
                        else
                        {
                            ...
                            from.SendLocalizedMessage(
                                1049676,
                                String.Format("{0}\t{1}", m_Mobile.Name, to.Name)
                            );
                            ...
                            to.SendLocalizedMessage(
                                1043246,
                                String.Format("{0}\t{1}", from.Name, m_Mobile.Name)
                            );
            ...
            if (aggressors.Count > 0)
            {
                for (int i = 0; i < aggressors.Count; ++i)
                {
                    ...
                    )
                    {
                        if (
                            combatant == null
                            || attacker.GetDistanceToSqrt(controlMaster)
            ...
            if (aggressed.Count > 0)
            {
                for (int i = 0; i < aggressed.Count; ++i)
                {
                    ...
                    if (
                        defender != null
                        && !defender.Deleted
                        && defender.GetDistanceToSqrt(m_Mobile) <= m_Mobile.RangePerception
                    )
                    {
                        if (
                            combatant == null
        ...
        {
            if (
                m_Mobile is HenchmanArcher
                || m_Mobile is HenchmanMonster
                || m_Mobile is HenchmanFighter
            ...
            else if (m_Mobile is Robot)
            {
                ...
                !(Server.Mobiles.BaseCreature.AlwaysInvulnerable(m_Mobile)) && m_Mobile.Blessed
            )
            {
            ...
            // Check if the mobile is NOT a CharacterClone before dropping the backpack
            if (!(m_Mobile is CharacterClone))
            {
        ...
        private class TransferItem : Item
        {
                ...
                : base(ShrinkTable.Lookup(creature))
            {
                ...
                if (!Core.AOS)
                {
                    ...
                    this.ItemID == ShrinkTable.DefaultItemID
            ...
            public override bool AllowSecureTrade(
                Mobile from,
                Mobile to,
                Mobile newOwner,
                bool accepted
            )
            {
                ...
                {
                    from.SendMessage(
                        "You may not transfer a pet that has recently been in combat."
                    );
                    to.SendMessage(
                        "The pet may not be transfered to you because it has recently been in combat."
                    );
            ...
            public override void OnSecureTrade(
                Mobile from,
                Mobile to,
                Mobile newOwner,
                bool accepted
        ...
        public virtual bool DoOrderTransfer()
        {
            ...
            )
            {
                ...
                else if (TransferItem.IsInCombat(m_Mobile))
                {
                    ...
                    to.SendMessage(
                        "The pet may not be transferred to you because it has recently been in combat."
                    );
                }
                else
                {
        ...
        {
            if (
                DateTime.Now >= m_Mobile.BardEndTime
                && (
                    m_Mobile.BardMaster == null
                    || m_Mobile.BardMaster.Deleted
        ...
        public virtual bool DoMove(Direction d, bool badStateOk)
        {
            ...
            return (
                ...
                || res == MoveResult.SuccessAutoTurn
        ...
        public virtual MoveResult DoMoveImpl(Direction d)
        {
            ...
            MoveImpl.IgnoreMovableImpassables = (
                m_Mobile.CanMoveOverObstacles && !m_Mobile.CanDestroyObstacles
            );
            ...
            else if (!m_Mobile.Move(d))
            {
                ...
                {
                    m_Mobile.DebugSay(
                        "My movement was blocked, I will try to clear some obstacles."
                    );
                    ...
                    if (map != null)
                    {
                        ...
                        IPooledEnumerable eable = map.GetItemsInRange(
                            new Point3D(x, y, m_Mobile.Location.Z),
                            1
                        );
                        ...
                        foreach (Item item in eable)
                        {
                            if (
                                canOpenDoors
                                && item is BaseDoor
                                && (item.Z + item.ItemData.Height) > m_Mobile.Z
                            ...
                            else
                            {
                                ...
                                if (item is Container)
                                {
                                    ...
                                    for (int i = 0; i < cont.Items.Count; ++i)
                                    {
                                        ...
                                        if (
                                            check.Movable
                                            && check.ItemData.Impassable
                                            && (item.Z + check.ItemData.Height) > m_Mobile.Z
                                        )
         ...
         *
         */
        public virtual bool WalkMobileRange(
            Mobile m,
            int iSteps,
            bool bRun,
            int iWantDistMin,
        ...
        )
        {
            int foll = 1;
            if (
                MyServerSettings.FriendsAvoidHeels()
                && m_Mobile.Controlled
                && !(m_Mobile.Backpack is StrongBackpack)
                && m_Mobile.ControlMaster == m
            )
            {
         ...
         *
         */
        public virtual bool AcquireFocusMob(
            int iRange,
            FightMode acqType,
            bool bPlayerOnly,
            bool bFacFriend,
        ...
        )
        {
            ...
            if (map != null)
            {
                ...
                foreach (Mobile m in mobiles)
                {
                    ...
                    if (
                        acqType == FightMode.Aggressor
                        || acqType == FightMode.Evil
                        || acqType == FightMode.CharmMonster
                        || acqType == FightMode.CharmAnimal
                    )
                    {
                        ...
                        if (acqType == FightMode.Evil && !bValid)
                        {
                            ...
                            {
                                bValid = (
                                    ((BaseCreature)m).ControlMaster.Karma < -2499
                                    || ((BaseCreature)m).ControlMaster.Criminal
                                    || ((BaseCreature)m).ControlMaster.Kills > 0
                                );
                                if (bValid)
                                {
                            ...
                            else if (m is PlayerMobile)
                            {
                                ...
                                Server.Misc.MyServerSettings.Quest()
                                && m is BaseCreature
                                && ((BaseCreature)m).ControlMaster == null
                            )
                            {
                            ...
                            (acqType == FightMode.CharmMonster || acqType == FightMode.CharmAnimal)
                            && !bValid
                        )
                        {
                            bValid = (
                                m.Karma < 0 && m is BaseCreature && !((BaseCreature)m).Controlled
                            );
                        }
        ...
        private class AITimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                else if (m_Owner.m_Mobile.PlayerRangeSensitive) //have to check this in the timer....
                {
                    ...
                    {
                        m_Owner.m_DeactivationTime =
                            DateTime.Now + TimeSpan.FromMinutes(m_Owner.DeactivationDelay);
                    }
                    // end PlayerRangeSensitiveMod
                }
...
namespace Server.Mobiles
{
    public class MageAI : BaseAI
    {
        ...
        private DateTime m_NextDispelTime = DateTime.Now + TimeSpan.FromSeconds(20);
        ...
        private const double TeleportChance = 0.15; // 15% chance to teleport at gm magery
        private const double DispelChance = 0.30; // 30% chance to dispel at gm magery
            ...
            else
            {
                ...
                if ((Utility.RandomDouble() < .05))
                {
                    ...
                    if (spell != null)
                    {
                        ...
                        if (
                            DateTime.Now > m_NextAnimateTime
                            && wizard.Slays(m_Mobile)
                            && !m_Mobile.Mounted
                        )
                        {
                            m_Mobile.PlaySound(m_Mobile.GetAngerSound());
                    ...
                    Utility.Random(
                        ...
                        4
                            + (
                                m_Mobile.Hits == 0
                                    ? m_Mobile.HitsMax
                                    : (m_Mobile.HitsMax / m_Mobile.Hits)
                            )
                    ) < 3
                )
                    return null;
        ...
        public void RunTo(Mobile m)
        {
            ...
            if (m.Paralyzed || m.Frozen)
            {
                if (m_Mobile.InRange(m, 1))
                    ...
                    !m_Mobile.InRange(m, m_Mobile.RangeFight > 2 ? m_Mobile.RangeFight : 2)
                    && !MoveTo(m, true, 1)
                )
                    OnFailedMove();
            }
        ...
        public void OnFailedMove()
        {
            if (
                ...
                && (
                    SmartAI
                        ? Utility.Random(4) == 0
                        : ScaleByMagery(TeleportChance) > Utility.RandomDouble()
                )
            )
            {
        ...
        public virtual bool CanCastNecro()
        {
            return (
                Utility.RandomBool()
                && (m_Mobile is BaseCreature)
                && ((BaseCreature)m_Mobile).IsNecromancer
            );
        }
            ...
            else
            {
                ...
                switch (Utility.Random(maxCircle * 2))
                {
                    case 0:
                        return new AttackSpells(m_Mobile, null);
                    case 1:
                        return new HarmSpell(m_Mobile, null); //return new MagicArrowSpell( m_Mobile, null );
                    case 2:
                        return new AttackSpells(m_Mobile, null);
                    case 3:
                        return new FireballSpell(m_Mobile, null); //return new HarmSpell( m_Mobile, null );
                    case 4:
                        return new AttackSpells(m_Mobile, null);
                    case 5:
                        return new LightningSpell(m_Mobile, null); //return new FireballSpell( m_Mobile, null );
                    case 6:
                        return new AttackSpells(m_Mobile, null);
                    case 7:
                        return new MindBlastSpell(m_Mobile, null); //return new LightningSpell( m_Mobile, null );
                    case 8:
                        return new AttackSpells(m_Mobile, null);
                    case 9:
                        return new FlameStrikeSpell(m_Mobile, null);
                    case 10:
                        return new AttackSpells(m_Mobile, null); //return new EnergyBoltSpell( m_Mobile, null );
                    case 11:
                        return new ChainLightningSpell(m_Mobile, null); //return new ExplosionSpell( m_Mobile, null );
                    default:
                        return new EnergyBoltSpell(m_Mobile, null); //return new FlameStrikeSpell( m_Mobile, null );
                }
            }
        }
        ...
        public virtual Spell DoDispel(Mobile toDispel)
        {
            if (!SmartAI)
            {
                // Check if we're past the cooldown and if the dispel chance passes
                if (DateTime.Now > m_NextDispelTime && ScaleByMagery(DispelChance) > Utility.RandomDouble())
                {
                    m_NextDispelTime = DateTime.Now + TimeSpan.FromSeconds(20); // Set a 20-second cooldown
            ...
            if (spell == null)
            {
                if (
                    !m_Mobile.DisallowAllMoves
                    && Utility.Random((int)m_Mobile.GetDistanceToSqrt(toDispel)) == 0
                    && !Server.Mobiles.BasePirate.IsSailor(m_Mobile)
                )
                    spell = new TeleportSpell(m_Mobile, null);
                else if (
                    Utility.Random(3) == 0
                    && !m_Mobile.InRange(toDispel, 3)
                    && !toDispel.Paralyzed
                    && !toDispel.Frozen
                )
                    spell = new ParalyzeSpell(m_Mobile, null);
                // Check if we're past the cooldown and if the dispel chance passes
                else if (DateTime.Now > m_NextDispelTime && ScaleByMagery(DispelChance) > Utility.RandomDouble())
                {
                    m_NextDispelTime = DateTime.Now + TimeSpan.FromSeconds(20); // Set a 20-second cooldown
                    return new DispelSpell(m_Mobile, null);
                }
        ...
        public override bool DoActionCombat()
        {
            ...
            )
            {
                ...
                {
                    m_Mobile.DebugSay(
                        "Something happened to my combatant, and nothing is around. I am on guard."
                    );
                    Action = ActionType.Guard;
                    return true;
                }
            ...
            if (
                SmartAI
                && !m_Mobile.StunReady
                && m_Mobile.Skills[SkillName.FistFighting].Value >= 80.0
            ...
            if (
                ...
                && m_Mobile.InRange(c, Core.ML ? 10 : 12)
            )
            {
                ...
                else if (toDispel != null && DateTime.Now > m_NextDispelTime) // Something dispellable is attacking us
                {
                    m_Mobile.DebugSay("I am going to dispel {0}", toDispel);

                    spell = DoDispel(toDispel);
                }
                else if (toDispel == null && DateTime.Now > m_NextDispelTime) // Alternative if we can't dispel yet
                {
                    // Decide on an alternative action or spell
                    // For example, choose another spell or perform a non-dispel action
                    // This is a placeholder for your logic
                    m_Mobile.DebugSay("Choosing an alternative action since dispel is on cooldown.");
                    spell = ChooseSpell(c); // Or any other logic you deem appropriate
                }
                else if (SmartAI && m_Combo != -1) // We are doing a spell combo
                {
                    ...
                    SmartAI
                    && (c.Spell is HealSpell || c.Spell is GreaterHealSpell)
                    && !c.Poisoned
        ...
        public override bool DoActionFlee()
        {
            ...
            if (
                (m_Mobile.Mana > 20 || m_Mobile.Mana == m_Mobile.ManaMax)
                && m_Mobile.Hits > (m_Mobile.HitsMax / 2)
            )
            {
        ...
        public Mobile FindDispelTarget(bool activeOnly)
        {
            ...
            if (activeOnly)
            {
                ...
                if (
                    ...
                    && m_Mobile.InRange(comb, Core.ML ? 10 : 12)
                    && CanDispel(comb)
                )
                {
                    active = comb;
                ...
                for (int i = 0; i < aggressed.Count; ++i)
                {
                    ...
                    if (
                        ...
                        && m_Mobile.InRange(m, Core.ML ? 10 : 12)
                        && CanDispel(m)
                    )
                    {
    ...
    public class MeleeAI : BaseAI
    {
        ...
        public override bool DoActionCombat()
        {
            ...
            if (
                ...
                && !m_Mobile.Summoned
                && !m_Mobile.IsParagon
                && !(m_Mobile is FrankenFighter)
                && !(m_Mobile is Robot)
                && !(m_Mobile is GolemFighter)
                && !(m_Mobile is HenchmanMonster)
                && !(m_Mobile is HenchmanArcher)
                && !(m_Mobile is HenchmanWizard)
                && !(m_Mobile is HenchmanFighter)
    ...
    public class BerserkAI : BaseAI
    {
        ...
        public override bool DoActionWander()
        {
            ...
            if (AcquireFocusMob(m_Mobile.RangePerception, FightMode.Closest, false, true, true))
            {
                if (m_Mobile.Debug)
                    m_Mobile.DebugSay(
                        "I have detected " + m_Mobile.FocusMob.Name + " and I will attack"
                    );
...
namespace Server.Mobiles
{
    ...
    {
        public CitizenAI(BaseCreature m)
            : base(m) { }
    ...
    public class PredatorAI : BaseAI
    {
        ...
        public override bool DoActionWander()
        {
            if (m_Mobile.Combatant != null)
            {
                ...
                AcquireFocusMob(m_Mobile.RangePerception, m_Mobile.FightMode, true, false, true)
            )
            {
                m_Mobile.DebugSay("There is something near, I go away");
                Action = ActionType.Backoff;
