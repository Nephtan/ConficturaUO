...
namespace Server.Mobiles
{
    public abstract class BaseHealer : BaseVendor
    {
        ...
        {
            get { return NpcGuild.HealersGuild; }
        }
        ...
        public virtual bool CheckResurrect(Mobile m)
        {
            ...
            if (this is WanderingHealer || this is EvilHealer)
            {
                ...
                ) && (m.Karma < 0 || m.Kills > 0 || m.Criminal)
            )
            {
                return true;
            }
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(BaseHealer BaseHealer, Mobile from)
                : base(6120, 12)
            {
        ...
        public void BeginHealing(Mobile from)
        {
            ...
            SayTo(
                from,
                "Did one of your henchman suffer a deathly fate? I can resurrect them for you."
            );
        ...
        private class HealingTarget : Target
        {
            ...
            public HealingTarget(BaseHealer mage)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is HenchmanFighterItem && from.Backpack != null)
                {
                    ...
                    else if (pack.ConsumeTotal(typeof(Gold), toConsume))
                    {
                        ...
                        m_BaseHealer.SayTo(
                            from,
                            "Your henchman is back in the land of the living."
                        );
                    }
                    else
                    {
                        m_BaseHealer.SayTo(
                            from,
                            "It would cost you {0} gold to have them resurrected.",
                            toConsume
                        );
