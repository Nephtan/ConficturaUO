...
namespace Server.Mobiles
{
    public abstract class BaseMount : BaseCreature, IMount
    {
        ...
        public override bool OnBeforeDeath()
        {
            if (Rider != null)
            {
                Server.Mobiles.EtherealMount.EthyDismount(Rider);
            }
            Rider = null;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (
                ...
                && !PlayerSettings.GetKeys(from, "DragonRiding")
                && (this is Dragoon || this is RidingDragon || this is GemDragon)
            )
            {
        ...
        public static void Ride(BaseMount mount, Mobile rider)
        {
            ...
            else if (mount is TigerRiding)
            {
                mount.Hue = 0x54F;
            }
            else if (mount is SabretoothTigerRiding)
            {
                mount.Hue = 0x54F;
            }
        ...
        private class BlockEntry
        {
            ...
            {
                get { return (DateTime.Now >= m_Expiration); }
            }
        ...
        public virtual void OnRiderDamaged(int amount, Mobile from, bool willKill)
        {
            ...
            if (
                !(
                    ...
                    || attacker == m_Rider
                    || willKill
                    || DateTime.Now < m_NextMountAbility
                )
            )
            {
    ...
    public class MountItem : Item, IMountItem
    {
        ...
        public override DeathMoveResult OnParentDeath(Mobile parent)
        {
            if (m_Mount != null)
            {
                if (m_Mount.Rider != null)
                {
                    Server.Mobiles.EtherealMount.EthyDismount(m_Mount.Rider);
                }
                m_Mount.Rider = null;
            }
