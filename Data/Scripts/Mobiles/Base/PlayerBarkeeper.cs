            ...
            if (buttonID > 0)
            {
                ...
                if (buttonID > 0)
                {
                    ...
                    if (buttonID >= 0 && buttonID < m_Entries.Length)
                        m_Barkeeper.EndChangeTitle(
                            m_From,
                            m_Entries[buttonID].m_Title,
                            m_Entries[buttonID].m_Vendor
                        );
                }
                else
                {
    ...
    public class BarkeeperGump : Gump
    {
        ...
        public void RenderMessageManagement()
        {
            ...
            AddHtml(
                ...
                380,
                20,
                "Remove a message and keyword from your barkeep",
                false,
                false
            );
        ...
        public void RenderDismissConfirmation()
        {
            ...
            AddHtml(
                ...
                380,
                20,
                "Are you sure you want to dismiss your barkeeper?",
                false,
                false
            );
