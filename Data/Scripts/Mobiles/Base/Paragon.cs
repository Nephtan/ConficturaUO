    ...
    public class Paragon
    {
                ...
                / (
                    Math.Max(
                        ...
                        100
                            * (
                                0.83
                                - Math.Round(Math.Log(Math.Round(fame / 6000, 3) + 0.001, 10), 3)
                            )
                    )
                    * (100 - Math.Sqrt(m.Luck))
                    / 100.0
                );
        ...
        public static void GiveArtifactTo(Mobile m)
        {
            ...
            if (m.AddToBackpack(item))
                ...
                m.SendMessage(
                    "As your backpack is full, your reward for slaying cursed creature has been placed at your feet."
                );
        }
    }
}
