...
namespace Server.Items
{
    public class XurtzarChest : Item
    {
        ...
        public XurtzarChest(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 2))
            {
                ...
                from.PrivateOverheadMessage(
                    ...
                    1150,
                    false,
                    "You have pulled Xurtzar's Vault toward you.",
                    from.NetState
                );
                ...
                if (from is PlayerMobile)
                {
                    ...
                    if (
                        ...
                        && !Server.Misc.PlayerSettings.GetSpecialsKilled(from, "Xurtzar")
                    )
                    {
                        ...
                        lexicon.m_Extra = "of Xurtzar the daemon";
                ...
                LoggingFunctions.LogGenericQuest(from, "defeated Xurtzar the daemon");
                this.Delete();
            }
            else
            {
