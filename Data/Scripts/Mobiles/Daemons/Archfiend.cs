...
namespace Server.Mobiles
{
    ...
    public class Archfiend : BaseCreature
    {
        ...
        {
            if (Server.Misc.Worlds.IsFireDungeon(this.Location, this.Map))
            {
                this.Hue = 0xB17;
            ...
            {
                this.Hue = Utility.RandomList(0xB33, 0xB34, 0xB35, 0xB36, 0xB37);
                SetResistance(ResistanceType.Fire, 10, 20);
                SetResistance(ResistanceType.Cold, 70, 80);
            }
            else if (Server.Misc.Worlds.IsSeaDungeon(this.Location, this.Map))
            {
                this.Hue = Utility.RandomList(0xB3D, 0xB3E, 0xB3F, 0xB40);
        ...
        public Archfiend(Serial serial)
            : base(serial) { }
