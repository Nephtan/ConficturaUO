...
namespace Server.Mobiles
{
    ...
    public class BlackGateDemon : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 0:
                    Title = "of the black gate";
                    break;
                case 1:
                    Title = "of the void";
                    break;
                case 2:
                    Title = "of the ethereal plane";
                    break;
                case 3:
                    Title = "of the ethereal void";
                    break;
                case 4:
                    Title = "of the dark portal";
                    break;
            }
        ...
        public BlackGateDemon(Serial serial)
            : base(serial) { }
            ...
            if (killer != null)
            {
                ...
                if (killer is PlayerMobile)
                {
                    if (
                        ...
                        && !Server.Misc.PlayerSettings.GetSpecialsKilled(killer, "BlackGateDemon")
                    )
                    {
        ...
        private class InternalTimer : Timer
        {
            ...
            public InternalTimer(BlackGateDemon owner)
