...
namespace Server.Mobiles
{
    ...
    public class BloodDemon : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 0:
                    Title = "the blood daemon";
                    break;
                case 1:
                    Title = "the daemon of blood";
                    break;
                case 2:
                    Title = "of the bloody veil";
                    break;
                case 3:
                    Title = "of the bleeding void";
                    break;
                case 4:
                    Title = "the bloodletter";
                    break;
                case 5:
                    Title = "of bloodletting";
                    break;
            }
            ...
            if (killer != null && this.Body == 320)
            {
                ...
                if (killer is PlayerMobile)
                {
                    if (GetPlayerInfo.LuckyKiller(killer.Luck) && Utility.RandomMinMax(1, 4) == 1)
                    {
                        ...
                        if (blade.Contains("of "))
                        {
                            blade = this.Title;
                        }
                        else if (blade.Contains("the "))
                        {
                            blade = "of " + this.Title;
                        }
        ...
        public override void OnGotMeleeAttack(Mobile attacker)
        {
            ...
            if (Utility.RandomMinMax(1, 4) == 1)
            {
                ...
                {
                    if (splash is MonsterSplatter && splash.Name == "thick blood")
                    {
                        goo++;
                    }
                }
        ...
        public BloodDemon(Serial serial)
            : base(serial) { }
