    ...
    public class Cronosaurus : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            if (1 == Utility.RandomMinMax(0, 2))
            {
                ...
                {
                    case 0:
                        PackItem(new SeaweedLegs());
                        break;
                    case 1:
                        PackItem(new SeaweedGloves());
                        break;
                    case 2:
                        PackItem(new SeaweedGorget());
                        break;
                    case 3:
                        PackItem(new SeaweedArms());
                        break;
                    case 4:
                        PackItem(new SeaweedChest());
                        break;
                    case 5:
                        PackItem(new SeaweedHelm());
                        break;
                }
            }
        }
        ...
        public Cronosaurus(Serial serial)
            : base(serial) { }
