...
namespace Server.Mobiles
{
    ...
    public class GorgonRiding : BaseMount
    {
        ...
        [Constructable]
        public GorgonRiding(string name)
            : base(name, 0x11C, 0x3E92, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 362;
            Hue = 0xB63;
        ...
        public override void OnGaveMeleeAttack(Mobile m)
        {
            ...
            if (1 == Utility.RandomMinMax(1, 20) && m is PlayerMobile)
            {
                ...
                {
                    if (
                        m.CheckSkill(SkillName.MagicResist, 0, 100)
                    ...
                    else if (Server.Items.HiddenTrap.CheckInsuranceOnTrap(iStone, m) == true)
                    {
                        m.LocalOverheadMessage(
                            ...
                            1150,
                            true,
                            "The GorgonRiding almost turned one of your protected items to stone!"
                        );
                    }
                    else
                    {
                        m.LocalOverheadMessage(
                            ...
                            0xB1F,
                            true,
                            "One of your items has been turned to stone!"
                        );
                        m.PlaySound(0x1FB);
        ...
        public GorgonRiding(Serial serial)
            : base(serial) { }
