...
namespace Server.Mobiles
{
    ...
    public class Beholder : BaseCreature
    {
        ...
        {
            get { return BeholderEye(this.VirtualArmor, 1); }
        }
        public override int BreathColdDamage
        {
            get { return BeholderEye(this.VirtualArmor, 2); }
        }
        public override int BreathPoisonDamage
        {
            get { return BeholderEye(this.VirtualArmor, 3); }
        }
        public override int BreathEnergyDamage
        {
            get { return BeholderEye(this.VirtualArmor, 4); }
        }
        public override int BreathEffectHue
        {
            get { return BeholderEye(this.VirtualArmor, 5); }
        }
        ...
        {
            get { return BeholderEye(this.VirtualArmor, 7); }
        }
        public override int BreathEffectItemID
        {
            get { return BeholderEye(this.VirtualArmor, 6); }
        }

        public static int BeholderEye(int cyclops, int value)
        {
            if (value == 1 && cyclops == 48)
            {
                return 100;
            } // RETURN THE FIRE DAMAGE
            if (value == 2 && cyclops == 49)
            {
                return 100;
            } // RETURN THE COLD DAMAGE
            if (value == 3 && cyclops == 50)
            {
                return 100;
            } // RETURN THE POISON DAMAGE
            if (value == 4 && cyclops == 51)
            {
                return 100;
            } // RETURN THE ENERGY DAMAGE

            if (value == 5 && cyclops == 48)
            {
                return 0;
            } // RETURN THE FIRE HUE
            if (value == 5 && cyclops == 49)
            {
                return 0x481;
            } // RETURN THE COLD HUE
            if (value == 5 && cyclops == 50)
            {
                return 0x3F;
            } // RETURN THE POISON HUE
            if (value == 5 && cyclops == 51)
            {
                return 0x9C2;
            } // RETURN THE ENERGY HUE

            if (value == 6 && cyclops == 48)
            {
                return 0x36D4;
            } // RETURN THE FIRE ID
            if (value == 6 && cyclops == 49)
            {
                return 0x36D4;
            } // RETURN THE COLD ID
            if (value == 6 && cyclops == 50)
            {
                return 0x36D4;
            } // RETURN THE POISON ID
            if (value == 6 && cyclops == 51)
            {
                return 0x3818;
            } // RETURN THE ENERGY ID

            if (value == 7 && cyclops == 48)
            {
                return 0x227;
            } // RETURN THE FIRE SOUND
            if (value == 7 && cyclops == 49)
            {
                return 0x64F;
            } // RETURN THE COLD SOUND
            if (value == 7 && cyclops == 50)
            {
                return 0x658;
            } // RETURN THE POISON SOUND
            if (value == 7 && cyclops == 51)
            {
                return 0x665;
        ...
        {
            if (this.VirtualArmor == 48)
            {
                form = 17;
            } // RETURN THE FIRE DAMAGE
            if (this.VirtualArmor == 49)
            {
                form = 19;
            } // RETURN THE COLD DAMAGE
