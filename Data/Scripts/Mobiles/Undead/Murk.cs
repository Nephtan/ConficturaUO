...
namespace Server.Mobiles
{
    ...
    public class Murk : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            MorphingTime.ColorMyClothes(this, 0x430, 0);
            ...
            if (killer != null)
            {
                ...
                if (killer is PlayerMobile)
                {
                    if (GetPlayerInfo.LuckyKiller(killer.Luck) && Utility.RandomMinMax(1, 4) == 1)
                    {
                        ...
                        {
                            case 0:
                                Item loot1 = new StuddedChest();
                                MorphingItem.MorphMyItem(
                                    loot1,
                                    "IGNORED",
                                    "Murk's Pirate",
                                    "IGNORED",
                                    MorphingTemplates.TemplateMurk("armors")
                                );
                                c.DropItem(loot1);
                                break;
                            case 1:
                                Item loot2 = new StuddedArms();
                                MorphingItem.MorphMyItem(
                                    loot2,
                                    "IGNORED",
                                    "Murk's Pirate",
                            ...
                            case 5:
                                ...
                                MorphingItem.MorphMyItem(
                                    ...
                                    "Murk's Pirate",
                                    "IGNORED",
                                    MorphingTemplates.TemplateMurk("misc")
                                );
                                c.DropItem(loot6);
                                break;
                            case 6:
                                Item loot7 = new Scimitar();
                                MorphingItem.MorphMyItem(
                                    loot7,
                                    "IGNORED",
                                    "Murk's Pirate",
                                    "IGNORED",
                                    MorphingTemplates.TemplateMurk("weapons")
                                );
                                c.DropItem(loot7);
                                break;
                            case 7:
                                Item loot8 = new Buckler();
                                MorphingItem.MorphMyItem(
                                    loot8,
                                    "IGNORED",
                                    "Murk's Pirate",
                            ...
                            case 8:
                                ...
                                break;
                            case 9:
                                Item loot10 = Loot.RandomJewelry();
                                MorphingItem.MorphMyItem(
                                    loot10,
                                    "IGNORED",
                                    "Murk's Pirate",
