...
namespace Server.Mobiles
{
    ...
    public class MummyGiant : BaseCreature
    {
        ...
        {
            base.BreathDealDamage(target, 37);
        }
            ...
            if (killer != null)
            {
                ...
                if (killer is PlayerMobile)
                {
                    if (GetPlayerInfo.LuckyKiller(killer.Luck) && Utility.RandomMinMax(1, 4) == 1)
                    {
                        ...
                        {
                            case 0:
                                c.DropItem(new DeadSkinLegs());
                                break;
                            case 1:
                                c.DropItem(new DeadSkinGloves());
                                break;
                            case 2:
                                c.DropItem(new DeadSkinGorget());
                                break;
                            case 3:
                                c.DropItem(new DeadSkinArms());
                                break;
                            case 4:
                                c.DropItem(new DeadSkinChest());
                                break;
                            case 5:
                                c.DropItem(new DeadSkinHelm());
                                break;
                        }
                    }
        ...
        public override HideType HideType
        {
            get
            {
                ...
                {
                    return HideType.Necrotic;
                }
                else
                {
                    return HideType.Goliath;
                }
            }
        }
        ...
        public MummyGiant(Serial serial)
            : base(serial) { }
