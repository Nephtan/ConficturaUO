...
namespace Server.Mobiles
{
    ...
    public class GiantSkeleton : BaseCreature
    {
            ...
            if (killer != null)
            {
                ...
                if (killer is PlayerMobile)
                {
                    ...
                    if (GetPlayerInfo.LuckyKiller(killer.Luck) && Utility.RandomMinMax(1, 4) == 1)
                    {
                        ...
                        {
                            case 0:
                                MagicBoneLegs leg = new MagicBoneLegs();
                                ...
                                break;
                            case 1:
                                MagicBoneGloves glv = new MagicBoneGloves();
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)glv,
                                    false,
                                    1000,
                                ...
                                break;
                            case 2:
                                MagicBoneArms arm = new MagicBoneArms();
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)arm,
                                    false,
                                    1000,
                                ...
                                break;
                            case 3:
                                MagicBoneChest tun = new MagicBoneChest();
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)tun,
                                    false,
                                    1000,
                                ...
                                break;
                            case 4:
                                MagicBoneHelm hlm = new MagicBoneHelm();
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)hlm,
                                    false,
                                    1000,
                                ...
                                break;
                            case 5:
                                MagicBoneSkirt skt = new MagicBoneSkirt();
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)skt,
                                    false,
                                    1000,
        ...
        public GiantSkeleton(Serial serial)
            : base(serial) { }
