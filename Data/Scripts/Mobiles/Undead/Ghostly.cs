...
namespace Server.Mobiles
{
    ...
    public class Ghostly : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 0:
                    Title = "the ruby ghost";
                    Hue = 0x5B5;
                    bump = 1;
                    break;
                case 1:
                    Title = "the azure ghost";
                    Hue = 0x5B6;
                    bump = 2;
                    break;
                case 2:
                    Title = "the emerald ghost";
                    Hue = 0xB93;
                    bump = 3;
                    break;
                case 3:
            ...
            if (killer != null)
            {
                ...
                if (killer is PlayerMobile)
                {
                    if (Server.Misc.GetPlayerInfo.LuckyKiller(killer.Luck))
                    {
                        ...
                        else if (this.Hue == 0x5B6)
                        {
                            Magic = 10;
                            Speed = 1;
                        }
                        else if (this.Hue == 0xB93)
                        {
                            Magic = 15;
                            Speed = 1;
                        }
                        else if (this.Hue == 0x8A5)
                        {
                            Magic = 20;
                            Speed = 2;
                        }
                        else if (this.Hue == 1175)
                        {
                            Magic = 25;
                            Speed = 2;
                        }
