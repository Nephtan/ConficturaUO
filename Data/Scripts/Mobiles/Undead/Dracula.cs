            ...
            if (killer != null)
            {
                ...
                if (killer is PlayerMobile)
                {
                    if (
                        ...
                        && !Server.Misc.PlayerSettings.GetSpecialsKilled(killer, "Dracula")
                    )
                    {
                        ...
                        killer.PrivateOverheadMessage(
                            MessageType.Regular,
                            1153,
                            false,
                            "You found a book and put it in your pack.",
                            killer.NetState
                        );
                    }
