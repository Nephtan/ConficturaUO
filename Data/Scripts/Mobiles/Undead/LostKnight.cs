...
namespace Server.Mobiles
{
    ...
    public class LostKnight : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            MorphingTime.ColorMyClothes(this, 0x47E, 0);
            ...
            if (1 == Utility.RandomMinMax(0, 2))
            {
                ...
                {
                    case 0:
                        armor1.LootType = LootType.Regular;
                        MorphingItem.MorphMyItem(
                            armor1,
                            "IGNORED",
                            "Spectral",
                            "IGNORED",
                            MorphingTemplates.TemplateLostKnight("armors")
                        );
                        break;
                    case 1:
                        armor2.LootType = LootType.Regular;
                        MorphingItem.MorphMyItem(
                            armor2,
                            "IGNORED",
                            "Spectral",
                        ...
                        break;
                    case 2:
                        armor3.LootType = LootType.Regular;
                        MorphingItem.MorphMyItem(
                            armor3,
                            "IGNORED",
                            "Spectral",
                        ...
                        break;
                    case 3:
                        armor4.LootType = LootType.Regular;
                        MorphingItem.MorphMyItem(
                            armor4,
                            "IGNORED",
                            "Spectral",
                        ...
                        break;
                    case 4:
                        armor5.LootType = LootType.Regular;
                        MorphingItem.MorphMyItem(
                            armor5,
                            "IGNORED",
                            "Spectral",
                        ...
                        break;
                    case 5:
                        armor6.LootType = LootType.Regular;
                        MorphingItem.MorphMyItem(
                            armor6,
                            "IGNORED",
                            "Spectral",
                        ...
                        break;
                    case 6:
                        armor7.LootType = LootType.Regular;
                        MorphingItem.MorphMyItem(
                            armor7,
                            "IGNORED",
                            "Spectral",
                            "IGNORED",
                            MorphingTemplates.TemplateLostKnight("weapons")
                        );
                        break;
                    case 7:
                        armor8.LootType = LootType.Regular;
                        MorphingItem.MorphMyItem(
                            armor8,
                            "IGNORED",
                            "Spectral",
        ...
        public LostKnight(Serial serial)
            : base(serial) { }
