...
namespace Server.Mobiles
{
    ...
    public class GhostWizard : BaseCreature
    {
            ...
            if (1 == Utility.RandomMinMax(1, 2))
            {
                switch (Utility.RandomMinMax(0, 7))
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        AddItem(new WitchHat());
                        break;
                    case 2:
                        AddItem(new ReaperCowl());
                        break;
                    case 3:
                        AddItem(new ReaperHood());
                        break;
                    case 4:
                        AddItem(new ClothHood());
                        break;
                    case 5:
                        AddItem(new ClothCowl());
                        break;
                    case 6:
                        AddItem(new FancyHood());
                        break;
                    case 7:
                        AddItem(new HoodedMantle());
                        break;
                }
            }
        ...
        public GhostWizard(Serial serial)
            : base(serial) { }
