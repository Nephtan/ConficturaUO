...
namespace Server.Items
{
    public class SurtazChest : Item
    {
        ...
        public SurtazChest(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 2))
            {
                ...
                from.PrivateOverheadMessage(
                    ...
                    1150,
                    false,
                    "You have pulled Surtaz's Vault toward you.",
                    from.NetState
                );
                ...
                if (from is PlayerMobile)
                {
                    ...
                    if (
                        ...
                        && !Server.Misc.PlayerSettings.GetSpecialsKilled(from, "Surtaz")
                    )
                    {
