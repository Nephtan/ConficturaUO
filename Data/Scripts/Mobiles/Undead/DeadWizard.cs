    ...
    public class DeadWizard : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            if (this.Female = Utility.RandomBool())
            {
                ...
                {
                    case 0:
                        Title = "the undead wizard";
                        break;
                    case 1:
                        Title = "the undead sorceress";
                        break;
                    case 2:
                        Title = "the undead mage";
                        break;
                    case 3:
                        Title = "the undead conjurer";
                        break;
                    case 4:
                        Title = "the undead magician";
                        break;
                    case 5:
                        Title = "the undead witch";
                        break;
                }
            }
            else
            ...
            if (Utility.RandomMinMax(1, 4) > 1)
            {
                ...
                staff.Name = "staff";
                staff.ItemID = Utility.RandomList(
                    0xDF0,
                    0x13F8,
                    0xE89,
                    0x2D25,
        ...
        public override void OnAfterSpawn()
        {
            ...
            if (this.Hue == 1150)
            {
                ...
                MorphingTime.ColorMyClothes(this, 1150, 0);
            }
        ...
        public DeadWizard(Serial serial)
            : base(serial) { }
