    ...
    public class VampirePrince : BaseCreature
    {
        ...
        public override void OnAfterSpawn()
        {
            ...
            else if (this.Fame >= 13650)
            {
                ...
                if (this.Body == 605)
                {
                    this.Title = "the vampire prince";
                }
                else
                {
                    this.Title = "the vampire princess";
                }
            }
            else if (this.Fame >= 12600)
            {
                ...
                if (this.Body == 605)
                {
                    this.Title = "the vampire duke";
                }
                else
                {
                    this.Title = "the vampire duchess";
                }
            }
            else if (this.Fame >= 11550)
            {
                ...
                if (this.Body == 605)
                {
                    this.Title = "the vampire earl";
                }
                else
                {
                    this.Title = "the vampire countess";
                }
            }
            else
            {
                ...
                if (this.Body == 605)
                {
                    this.Title = "the vampire baron";
                }
                else
                {
                    this.Title = "the vampire baroness";
                }
            }
        }
        ...
        public VampirePrince(Serial serial)
            : base(serial) { }
