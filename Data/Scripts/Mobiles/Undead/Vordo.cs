    ...
    public class Vordo : BaseCreature
    {
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (1 == Utility.RandomMinMax(0, 1))
            {
                ...
                {
                    case 0:
                        Item relic1 = new MagicTalisman();
                        MorphingItem.MorphMyItem(
                            relic1,
                            "IGNORED",
                            "Vordo's",
                            "IGNORED",
                            MorphingTemplates.TemplateVordo("misc")
                        );
                        c.DropItem(relic1);
                        break;
                    case 1:
                        Item relic2 = new MagicRobe();
                        relic2.ItemID = 0x1F03;
                        relic2.Name = "robe";
                        MorphingItem.MorphMyItem(
                            relic2,
                            "IGNORED",
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Item relic4 = new MagicCloak();
                        relic4.ItemID = 0x1515;
                        relic4.Name = "cloak";
                        MorphingItem.MorphMyItem(
                            relic4,
                            "IGNORED",
                        ...
                        break;
                    case 4:
                        Item relic5 = new MagicBoots();
                        relic5.ItemID = 0x170B;
                        relic5.Name = "boots";
                        MorphingItem.MorphMyItem(
                            relic5,
                            "IGNORED",
                        ...
                        break;
                    case 5:
                        Item relic6 = new MagicBelt();
                        relic6.ItemID = 0x2790;
                        relic6.Name = "belt";
                        MorphingItem.MorphMyItem(
                            relic6,
                            "IGNORED",
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        Item relic9 = new Dagger();
                        relic9.Name = "sacrificial dagger";
                        MorphingItem.MorphMyItem(
                            relic9,
                            "IGNORED",
                            "Vordo's",
                            "IGNORED",
                            MorphingTemplates.TemplateVordo("weapons")
                        );
                        c.DropItem(relic9);
                        break;
                }
                    ...
                    if (p != null)
                    {
                        foreach (PartyMemberInfo pmi in p.Members)
                        {
                            if (
                                ...
                                && pmi.Mobile.InRange(c.Location, 20)
                                && pmi.Mobile.Map == c.Map
                            )
                            {
...
namespace Server.Items
{
    public class VordoScroll : Item
    {
        ...
        public VordoScroll(Serial serial)
            : base(serial) { }
