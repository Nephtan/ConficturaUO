...
namespace Server.Mobiles
{
    ...
    public class GhostDragyn : BaseMount
    {
        ...
        {
            base.BreathDealDamage(target, 12);
        }
        ...
        [Constructable]
        public GhostDragyn(string name)
            : base(name, 62, 0x3E90, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a ghost dragyn";
            Hue = 1150;
            BaseSoundID = 362;
        ...
        public GhostDragyn(Serial serial)
            : base(serial) { }
