...
namespace Server.Mobiles
{
    ...
    public class Dracolich : BaseCreature
    {
        ...
        {
            base.BreathDealDamage(target, 25);
        }
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                case 0:
                    dracoItem = Loot.RandomWeapon(false);
                    MorphingItem.MorphMyItem(
                        dracoItem,
                        "IGNORED",
                        "Dracolich",
                        "IGNORED",
                        MorphingTemplates.TemplateDracolich("weapons")
                    );
                    PackItem(dracoItem);
                    break;
                case 1:
                    dracoItem = Loot.RandomJewelry();
                    MorphingItem.MorphMyItem(
                        dracoItem,
                        "IGNORED",
                        "Dracolich",
                        "IGNORED",
                        MorphingTemplates.TemplateDracolich("misc")
                    );
                    PackItem(dracoItem);
                    break;
                case 2:
                    ...
                    {
                        case 0:
                            dracoItem = new BoneLegs();
                            MorphingItem.MorphMyItem(
                                dracoItem,
                                "IGNORED",
                                "IGNORED",
                                "Dracolich Leggings",
                                MorphingTemplates.TemplateDracolich("armors")
                            );
                            PackItem(dracoItem);
                            break;
                        case 1:
                            dracoItem = new BoneGloves();
                            MorphingItem.MorphMyItem(
                                dracoItem,
                                "IGNORED",
                                "IGNORED",
            ...
            if (killer != null)
            {
                ...
                if (killer is PlayerMobile)
                {
                    if (
                        ...
                        && killer.Skills[SkillName.Necromancy].Base >= 50
                    )
                    {
