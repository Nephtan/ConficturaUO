...
namespace Server.Mobiles
{
    ...
    public class ManticoreRiding : BaseMount
    {
        ...
        {
            base.BreathDealDamage(target, 5);
        }
        ...
        [Constructable]
        public ManticoreRiding(string name)
            : base(name, 843, 843, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0x3EE;
        ...
        public ManticoreRiding(Serial serial)
            : base(serial) { }
