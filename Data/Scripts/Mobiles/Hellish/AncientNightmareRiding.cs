...
namespace Server.Mobiles
{
    ...
    public class AncientNightmareRiding : BaseMount
    {
        ...
        [Constructable]
        public AncientNightmareRiding()
            : this("an ancient nightmare") { }

        [Constructable]
        public AncientNightmareRiding(string name)
            : base(name, 795, 795, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0xA8;
        ...
        {
            get { return Utility.RandomList(0, 0, 0, 5); }
        }
        ...
        public AncientNightmareRiding(Serial serial)
            : base(serial) { }
