    ...
    public class OilSlick : BaseCreature
    {
        ...
        public void OilBurn()
        {
            ...
            foreach (Mobile m in list)
            {
                ...
                int itHurts = (int)(
                    (Utility.RandomMinMax(10, 20) * (100 - m.FireResistance)) / 100
                );
                m.Damage(itHurts, m);
                ...
                if (iWrapped != null)
                {
                    ...
                    else if (Server.Items.HiddenTrap.CheckInsuranceOnTrap(iWrapped, m) == true)
                    {
                        m.LocalOverheadMessage(
                            ...
                            1150,
                            true,
                            "Oil almost covered one of your protected items!"
                        );
                    }
                    else
                    {
                        m.LocalOverheadMessage(
                            ...
                            0xB1F,
                            true,
                            "One of your items is covered in oil!"
                        );
                        m.PlaySound(0x364);
