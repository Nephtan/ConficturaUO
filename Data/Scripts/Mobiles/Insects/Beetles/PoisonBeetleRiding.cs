...
namespace Server.Mobiles
{
    ...
    {
        [Constructable]
        public PoisonBeetleRiding()
            : this("a poisonous beetle") { }

        [Constructable]
        public PoisonBeetleRiding(string name)
            : base(name, 0xA9, 0x3E95, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.25, 0.5)
        {
            BaseSoundID = 0x388;
            Hue = 1167;
        ...
        public PoisonBeetleRiding(Serial serial)
            : base(serial) { }
