...
namespace Server.Mobiles
{
    public class HolyMage : BaseVendor
    {
        ...
        public override void InitSBInfo()
        {
            ...
            m_SBInfos.Add(new SBHolidayDeco());
        }
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(HolyMage HolyMage, Mobile from)
                : base(6120, 12)
            {
                m_HolyMage = HolyMage;
                m_From = from;
        ...
        public void BeginRepair(Mobile from)
        {
            ...
            if (BeggingPose(from) > 0) // LET US SEE IF THEY ARE BEGGING
            {
                ...
                SayTo(
                    from,
                    "Since you are begging, do you still want me to charge a magic wand with 5 charges, you will need to donate "
                        + nCost.ToString()
            ...
            else
            {
                SayTo(
                    from,
                    "If you want me to charge a magic wand with 5 charges, you will need to donate "
                        + nCost.ToString()
                        + " gold per spell circle of the wand."
                );
            }
        ...
        private class RepairTarget : Target
        {
            ...
            public RepairTarget(HolyMage holymage)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                {
                    m_HolyMage.SayTo(from, "That wand is something even my power cannot charge.");
                }
                else if (targeted is BaseMagicStaff && from.Backpack != null)
                {
                    ...
                    else
                    {
                        m_HolyMage.SayTo(
                            from,
                            "You must donate {0} gold to have that charged.",
                            toConsume
                        );
