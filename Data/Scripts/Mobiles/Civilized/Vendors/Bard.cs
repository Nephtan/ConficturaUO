...
namespace Server.Mobiles
{
    public class Bard : BaseVendor
    {
                    ...
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        mobile.SendGump(
                            new SpeechGump(
                                ...
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "Bard")
                            )
                        );
                    }
                }
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(Bard Bard, Mobile from)
                : base(6120, 12)
            {
                m_Bard = Bard;
                m_From = from;
        ...
        public void BeginRepair(Mobile from)
        {
            ...
            if (BeggingPose(from) > 0) // LET US SEE IF THEY ARE BEGGING
            {
                ...
                SayTo(
                    from,
                    "Since you are begging, do you still need me to identify an item for "
                        + idCost.ToString()
                        + " gold?"
                );
            }
            else
            {
                SayTo(
                    from,
                    "Do you want me to identify an item for " + idCost.ToString() + " gold?"
                );
            }
