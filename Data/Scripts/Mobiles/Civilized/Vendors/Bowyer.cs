...
namespace Server.Mobiles
{
    ...
    public class Bowyer : BaseVendor
    {
        ...
        {
            get { return NpcGuild.ArchersGuild; }
        }
        ...
        public override void InitOutfit()
        {
            ...
            switch (Utility.Random(7))
            {
                case 0:
                    ...
                    break;
                case 1:
                    AddItem(new Server.Items.Crossbow());
                    break;
                case 2:
                    AddItem(new Server.Items.HeavyCrossbow());
                    break;
                case 3:
                    AddItem(new Server.Items.RepeatingCrossbow());
                    break;
                case 4:
                    AddItem(new Server.Items.CompositeBow());
                    break;
                case 5:
                    AddItem(new Server.Items.MagicalShortbow());
                    break;
                case 6:
                    AddItem(new Server.Items.ElvenCompositeLongbow());
                    break;
            }
        }
                    ...
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        mobile.SendGump(
                            new SpeechGump(
                                mobile,
                                "When The Bow Breaks",
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "Bowyer")
                            )
                        );
                    }
                }
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(Bowyer Bowyer, Mobile from)
                : base(6120, 12)
            {
                m_Bowyer = Bowyer;
                m_From = from;
        ...
        public void BeginRepair(Mobile from)
        {
            ...
            if (BeggingPose(from) > 0) // LET US SEE IF THEY ARE BEGGING
            {
                ...
                SayTo(
                    from,
                    "Since you are begging, do you still want to hire me to repair something...at least "
                        + nCost.ToString()
            ...
            else
            {
                SayTo(
                    from,
                    "You want to hire me to repair what at "
                        + nCost.ToString()
                        + " gold per durability? Or maybe identify an item for "
                        + idCost.ToString()
                        + " gold?"
        ...
        private class RepairTarget : Target
        {
            ...
            public RepairTarget(Bowyer bowyer)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    targeted is BaseKilrathi
                    || targeted is BaseGiftStave
                    || targeted is BaseWizardStaff
                    || targeted is LightSword
                    || targeted is DoubleLaserSword
                )
                {
                    m_Bowyer.SayTo(from, "You would need a tinker to repair that.");
                }
                else if (
                    (targeted is BaseWeapon && from.Backpack != null)
                    && targeted is BaseRanged
                    && Server.Misc.MaterialInfo.IsAnyKindOfWoodItem(((Item)targeted))
                )
                {
