        ...
        public class RidingGump : Gump
        {
                ...
                : base(50, 50)
            {
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">If you see any creature that looks like these here, regardless of color, they can be used as mounts to travel with if tamed or purchased.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">* Dragons must learn to be ridden, while Dragyns can be ridden if the Zuluu legends are true.</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                AddHtml(
                    ...
                    27,
                    20,
                    @"<BODY><BASEFONT Color=" + color + "><BIG>*</BIG></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            }
