...
namespace Server.Mobiles
{
    public class Blacksmith : BaseVendor
    {
                ...
                PlayerMobile mobile = (PlayerMobile)m_Mobile;
                {
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        mobile.SendGump(
                            new SpeechGump(
                                mobile,
                                "Knocking The Dents Out",
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "Blacksmith")
                            )
                        );
                    }
                }
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(Blacksmith Blacksmith, Mobile from)
                : base(6120, 12)
            {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                if (targeted is Item)
                {
                    ...
                    )
                    {
                        ...
                        && Server.Misc.MaterialInfo.IsAnyKindOfMetalItem(ITEM)
                    )
                    {
                    ...
                    )
                    {
                        ...
                        if (
                            ...
                            && Server.Misc.MaterialInfo.IsAnyKindOfMetalItem(((Item)targeted))
                        )
                        {
                            int nCost = 10;
