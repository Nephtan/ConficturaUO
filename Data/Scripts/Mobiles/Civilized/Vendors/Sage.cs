...
namespace Server.Mobiles
{
    public class Sage : BaseVendor
    {
            ...
            if (dropped is Gold)
            {
                ...
                )
                {
                    ...
                    if (nWhenForAnotherQuest > 0)
                    {
                        ...
                        string wait = string.Format(
                            "{0:D2} days {1:D2} hours and {2:D2} minutes",
                            t.Days,
                            t.Hours,
                            t.Minutes
                        );
                        ...
                        sMessage =
                            "I have no artifact encyclopedias at the moment. Check back in "
                            + wait
                            + ".";
                        from.AddToBackpack(dropped);
                    }
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(Sage Sage, Mobile from)
                : base(6120, 12)
            {
                m_Sage = Sage;
                m_From = from;
