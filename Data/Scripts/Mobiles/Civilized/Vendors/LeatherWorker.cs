...
namespace Server.Mobiles
{
    public class LeatherWorker : BaseVendor
    {
                    ...
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        mobile.SendGump(
                            new SpeechGump(
                                mobile,
                                "Wears and Tears",
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "LeatherWorker")
                            )
                        );
                    }
                }
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(LeatherWorker LeatherWorker, Mobile from)
                : base(6120, 12)
            {
        ...
        private class RepairTarget : Target
        {
            ...
            public RepairTarget(LeatherWorker leatherworker)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else if (targeted is BaseArmor && from.Backpack != null)
                {
                    ...
                    if (
                        ...
                        && Server.Misc.MaterialInfo.IsAnyKindOfClothItem(((Item)targeted))
                    )
                    {
                        int nCost = 10;
                ...
                else if (targeted is DeerMask && from.Backpack != null)
                {
                    ...
                    && (
                        targeted is BaseWhip
                        || targeted is LevelPugilistGloves
                        || targeted is LevelThrowingGloves
                        || targeted is GiftPugilistGloves
                        || targeted is GiftThrowingGloves
                        || targeted is ThrowingGloves
                        || targeted is PugilistGlove
                        || targeted is PugilistGloves
                        || targeted is PugilistMits
                    )
                )
                {
