...
namespace Server.Mobiles
{
    public class CustomHairstylist : BaseVendor
    {
        ...
        private class BarberEntry : ContextMenuEntry
        {
            ...
            public BarberEntry(CustomHairstylist CustomHairstylist, Mobile from)
                : base(6120, 12)
            {
    ...
    public class HairstylistBuyInfo
    {
        ...
        {
            get { return m_GumpType; }
        }
        public object[] GumpArgs
        {
            get { return m_GumpArgs; }
        }
            ...
            if (info.ButtonID == 1)
            {
                ...
                if (switches.Length > 0)
                {
                    ...
                    if (index >= 0 && index < m_Entries.Length)
                    {
                        ...
                        {
                            if (
                                m_Hair && m_From.HairItemID > 0
                                || m_FacialHair && m_From.FacialHairItemID > 0
                            )
                            {
    ...
    public class ChangeHairstyleGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            AddBackground(
                0,
                0,
                81 + (tableWidth * offsetWidth),
                105 + (tableHeight * offsetHeight),
                2600
            );
            ...
            for (int i = 0; i < entries.Length; ++i)
            {
                ...
                {
                    AddRadio(
                        40 + (xTable * offsetWidth),
                        70 + (yTable * offsetHeight),
                        208,
                        209,
                        false,
                        i
                    ...
                    AddBackground(
                        87 + (xTable * offsetWidth),
                        50 + (yTable * offsetHeight),
                        50,
                        50,
                        2620
                    );
