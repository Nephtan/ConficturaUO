...
namespace Server.Mobiles
{
    public class Furtrader : BaseVendor
    {
                    ...
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        mobile.SendGump(
                            new SpeechGump(
                                mobile,
                                "Bears And Deer",
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "Furtrader")
                            )
                        );
                    }
                }
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(Furtrader Furtrader, Mobile from)
                : base(6120, 12)
            {
        ...
        public void BeginRepair(Mobile from)
        {
            ...
            if (BeggingPose(from) > 0) // LET US SEE IF THEY ARE BEGGING
            {
                ...
                SayTo(
                    from,
                    "Since you are begging, do you still want to hire me to repair a bearskin or deerskin cap for at least "
                        + nCost.ToString()
                        + " gold per durability?"
                );
            }
            else
            {
                SayTo(
                    from,
                    "You want to hire me to repair a bearskin or deerskin cap at "
                        + nCost.ToString()
                        + " gold per durability?"
                );
            }
        ...
        private class RepairTarget : Target
        {
            ...
            public RepairTarget(Furtrader Furtrader)
