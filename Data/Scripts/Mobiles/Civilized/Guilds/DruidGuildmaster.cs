...
namespace Server.Mobiles
{
    public class DruidGuildmaster : BaseGuildmaster
    {
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(DruidGuildmaster DruidGuildmaster, Mobile from)
                : base(6120, 12)
            {
        ...
        public void BeginRepair(Mobile from)
        {
            ...
            if (BeggingPose(from) > 0) // LET US SEE IF THEY ARE BEGGING
            {
                ...
                SayTo(
                    from,
                    "Since you are begging, do you still want me to tend to your pack animal for up to 5 journeys, it will only cost you "
                        + nCost.ToString()
                        + " gold?"
                );
            }
            else
            {
                SayTo(
                    from,
                    "If you want me to tend to your pack animal for up to 5 journeys, it will cost you "
                        + nCost.ToString()
                        + " gold."
                );
            }
        ...
        private class RepairTarget : Target
        {
            ...
            public RepairTarget(DruidGuildmaster druid)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                if (targeted is PackBeastItem && from.Backpack != null)
                {
                    ...
                    else
                    {
                        m_Druid.SayTo(
                            from,
                            "It would cost you {0} gold to have that pack animal tended to.",
                            toConsume
                        );
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            if (dropped is MysticalTreeSap)
            {
                ...
                {
                    sMessage =
                        "Thank you for these. Mystical tree sap is something we often look for.";
                }
            ...
            else if (dropped is PackBeastItem)
            {
                ...
                if (ball.PorterType == 291)
                {
                    ...
                    ball.PorterType = 292;
                    ball.Hue = 0;
                    sMessage = "You may like a pack llama instead.";
                }
                else if (ball.PorterType == 292)
                {
                    ...
                    ball.PorterType = 23;
                    ball.Hue = 0;
                    sMessage = "You may like a pack brown bear instead.";
                }
                else if (ball.PorterType == 23)
                {
                    ball.ItemID = 0x20CF;
                    ball.PorterType = 177;
                    ball.Hue = 0;
                    sMessage = "You may like a pack black bear instead.";
                }
                else if (ball.PorterType == 177)
                {
                    ...
                    ball.PorterType = 179;
                    ball.Hue = 0;
                    sMessage = "You may like a pack polar bear instead.";
                }
                else if (ball.PorterType == 179)
                {
                    ...
                    ball.PorterType = 291;
                    ball.Hue = 0;
                    sMessage = "You may like a pack horse instead.";
                }
                    ...
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        mobile.SendGump(
                            new SpeechGump(
                                ...
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "Druid")
                            )
                        );
                    }
                }
        ...
        public DruidGuildmaster(Serial serial)
            : base(serial) { }
