...
namespace Server.Mobiles
{
    public class ArcherGuildmaster : BaseGuildmaster
    {
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(ArcherGuildmaster ArcherGuildmaster, Mobile from)
                : base(6120, 12)
            {
        ...
        private class RepairTarget : Target
        {
            ...
            public RepairTarget(ArcherGuildmaster bowyer)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    (targeted is BaseWeapon && from.Backpack != null) && (targeted is BaseRanged)
                )
                {
        ...
        public ArcherGuildmaster(Serial serial)
            : base(serial) { }
