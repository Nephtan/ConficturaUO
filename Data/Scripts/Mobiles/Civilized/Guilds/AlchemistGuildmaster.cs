...
namespace Server.Mobiles
{
    public class AlchemistGuildmaster : BaseGuildmaster
    {
                    ...
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        mobile.SendGump(
                            new SpeechGump(
                                mobile,
                                "A Sip And A Taste",
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "Alchemist")
                            )
                        );
                    }
                }
        ...
        private class FixEntry : ContextMenuEntry
        {
            ...
            public FixEntry(AlchemistGuildmaster AlchemistGuildmaster, Mobile from)
                : base(6120, 12)
            {
        ...
        public void BeginRepair(Mobile from)
        {
            ...
            if (BeggingPose(from) > 0) // LET US SEE IF THEY ARE BEGGING
            {
                ...
                SayTo(
                    from,
                    "Since you are begging, I will ask for less to identify a liquid, bottles cost "
                        + nCost.ToString()
                        + " gold and kegs cost "
                        + nCost2.ToString()
                        + " gold."
            ...
            else
            {
                SayTo(
                    from,
                    "If you want me to identify an unknown liquid, bottles cost "
                        + nCost.ToString()
                        + " gold and kegs cost "
                        + nCost2.ToString()
                        + " gold."
        ...
        private class RepairTarget : Target
        {
            ...
            public RepairTarget(AlchemistGuildmaster mage)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is UnknownLiquid && from.Backpack != null)
                {
                    ...
                    if (pack.ConsumeTotal(typeof(Gold), toConsume))
                    {
                        ...
                        m_AlchemistGuildmaster.SayTo(
                            from,
                            "This seems to be a bottle of " + potionName + "."
                        );
                        brew.Delete();
                    }
                    else
                ...
                else if (targeted is UnknownKeg && from.Backpack != null)
                {
                    ...
                    if (pack.ConsumeTotal(typeof(Gold), toConsume))
                    {
                        ...
                        if (potionType > 31)
                        {
                            ...
                            m_AlchemistGuildmaster.SayTo(
                                from,
                                "This seems to be barrel of dirty water, which I will dump out for you."
                            );
                        }
                        ...
                        if (nBarrel == 0)
                        {
                            ...
                            m_AlchemistGuildmaster.SayTo(
                                from,
                                "This seems to be a " + barrel.Name + "."
                            );
                        }
        ...
        public AlchemistGuildmaster(Serial serial)
            : base(serial) { }
