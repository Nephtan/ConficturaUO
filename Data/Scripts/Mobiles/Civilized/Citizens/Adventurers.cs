...
namespace Server.Mobiles
{
    ...
    {
        [Constructable]
        public AdventurerEast()
            : base()
        {
            Direction = Direction.East;
        }

        public AdventurerEast(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public AdventurerWest()
            : base()
        {
            Direction = Direction.West;
        }

        public AdventurerWest(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public AdventurerSouth()
            : base()
        {
            Direction = Direction.South;
        }

        public AdventurerSouth(Serial serial)
            : base(serial) { }
    ...
    {
        [Constructable]
        public AdventurerNorth()
            : base()
        {
            Direction = Direction.North;
        }

        public AdventurerNorth(Serial serial)
            : base(serial) { }
