    ...
    public class TrainingMagery : Citizens
    {
        ...
        public override void OnAfterSpawn()
        {
            ...
            if (Utility.RandomBool())
            {
                ...
                ((BaseWeapon)wand).Attributes.SpellChanneling = 1;
        ...
        public TrainingMagery(Serial serial)
            : base(serial) { }
    ...
    public class MagicHit : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (mSp != null)
            {
                ...
                from.Say(pray_chant);
                from.Animate(
                    Utility.RandomList(236, 212, 230, 224, 209, 221, 233, 263, 245, 218, 206),
                    5,
                    1,
                    true,
                    false,
                ...
                else if (spells == 3) // lightning
                {
                    mSp.FixedParticles(
                        ...
                        15,
                        5038,
                        Utility.RandomList(0, 0x48D, 0x48E, 0x48F, 0x490, 0x491),
                        2,
                        EffectLayer.Head
                    );
                    mSp.PlaySound(0x029);
                ...
                else if (spells == 10) // dark void
                {
                    mSp.FixedParticles(
                        ...
                        30,
                        5052,
                        Utility.RandomList(0x496, 0x844, 0x9C1),
                        0,
                        EffectLayer.Head
                    );
                    mSp.PlaySound(0x108);
                ...
                {
                    mSp.FixedParticles(
                        Utility.RandomList(0x3915, 0x3924),
                        10,
                        30,
                        5052,
                        0,
                ...
                else if (spells == 56) // fire field
                {
                    ...
                    {
                        mSp.FixedParticles(
                            Utility.RandomList(0x3998, 0x398D),
                            10,
                            30,
                            5052,
                            0,
...
namespace Server.Mobiles
{
    ...
    public class SpellCritter : BaseCreature
    {
        ...
        public SpellCritter(Serial serial)
            : base(serial) { }
