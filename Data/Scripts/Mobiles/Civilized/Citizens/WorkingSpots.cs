...
namespace Server.Items
{
    public class WorkingSpots : Item
    {
        ...
        public static void Setup()
        {
            ...
            {
                if (
                    spot is WorkingSpots
                    && (
                        Utility.RandomMinMax(1, 4) > 1
                        || Server.Misc.Worlds.GetRegionName(spot.Map, spot.Location)
                            == "the Basement"
                        || Server.Misc.Worlds.GetRegionName(spot.Map, spot.Location) == "the Dojo"
                    )
                )
                    spots.Add(spot);
            }
            for (int i = 0; i < spots.Count; ++i)
            {
                ...
                {
                    Mobile citizen = new TradesmanAlchemist();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                    Add(citizen, spot, 2);
                }
                else if (spot.Name == "archer")
                {
                    Mobile citizen = new TrainingBow();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                {
                    Mobile citizen = new TrainingSingle();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                {
                    Mobile citizen = new TrainingFishing();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                {
                    Mobile citizen = new TradesmanLumber();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                {
                    Mobile citizen = new TradesmanLogger();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                {
                    Mobile citizen = new TradesmanMiner();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                {
                    Mobile citizen = new TradesmanSmelter();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                {
                    Mobile citizen = new TradesmanSmith();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                {
                    Mobile citizen = new TradesmanLeather();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                {
                    Mobile citizen = new TrainingMagery();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                else if (spot.Name == "cook")
                {
                    Mobile citizen = new TradesmanCook();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                else if (spot.Name == "butcher")
                {
                    Mobile citizen = new TradesmanButcher();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                else if (spot.Name == "bard")
                {
                    Mobile citizen = new TradesmanBard();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
                ...
                else if (spot.Name == "shrine")
                {
                    Mobile citizen = new TrainingSpirits();
                    citizen.MoveToWorld(spot.Location, spot.Map);
                    ((BaseCreature)citizen).Home = spot.Location;
                    ((BaseCreature)citizen).RangeHome = 0;
                    citizen.OnAfterSpawn();
        ...
        public static void Add(Mobile citizen, Item spots, int range)
        {
            ...
            for (int i = 0; i < items.Count; ++i)
            {
                if (hasCitizen)
                {
                    ...
                    if (
                        spot.Name == "anvil"
                        && (citizen is TradesmanSmelter || citizen is TradesmanSmith)
                    )
                    {
                        Item item = new AnvilHit();
                        item.MoveToWorld(spot.Location, spot.Map);
                        item.Weight = -2.0;
                    }
                    else if (spot.Name == "dummy" && citizen is TrainingSingle)
                    {
                        Item item = new TrainingDummy();
                        item.MoveToWorld(spot.Location, spot.Map);
                        item.Weight = -2.0;
                    }
                    else if (
                    ...
                    {
                        Item item = new ForgeHit();
                        item.MoveToWorld(spot.Location, spot.Map);
                        item.Weight = -2.0;
                    }
                    else if (
                        spot.Name == "hidden anvil"
                        && (citizen is TradesmanSmelter || citizen is TradesmanSmith)
                    )
                    {
                        Item item = new AnvilHit();
                        item.MoveToWorld(spot.Location, spot.Map); /* item.Visible = false; */
                        item.Weight = -2.0;
                    }
                    else if (
                        spot.Name == "hidden forge"
                        && (citizen is TradesmanSmelter || citizen is TradesmanSmith)
                    )
                    {
                        Item item = new ForgeHit();
                    ...
                    {
                        Item item = new CauldronHit();
                        item.MoveToWorld(spot.Location, spot.Map);
                        item.Weight = -2.0;
                        if (item.ItemID >= 0x5760 && item.ItemID <= 0x5769)
                        {
                            item.Z = item.Z - 2;
                        }
                    }
                    ...
                    {
                        Mobile knight = new Warriors();
                        knight.MoveToWorld(spot.Location, spot.Map);
                        ((BaseCreature)knight).Home = spot.Location;
                        ((BaseCreature)knight).RangeHome = 0;
                        knight.OnAfterSpawn();
                    }
                    else if (spot.Name == "hidden pan" && citizen is TradesmanCook)
                    {
                        Item item = new StoveHit();
                        item.MoveToWorld(spot.Location, spot.Map);
                        item.Visible = false;
                        item.Weight = -2.0;
                    }
                    else if (spot.Name == "pan" && citizen is TradesmanCook)
                    {
                        Item item = new StoveHit();
                        item.MoveToWorld(spot.Location, spot.Map);
                        item.Weight = -2.0;
                    }
                    else if (spot.Name == "carcass" && citizen is TradesmanButcher)
                    {
                        Item item = new ButcherHit();
                        item.MoveToWorld(spot.Location, spot.Map);
                        item.Weight = -2.0;
                    }
                    else if (spot.Name == "music" && citizen is TradesmanBard)
                    {
                        Item item = new BardHit();
                        item.MoveToWorld(spot.Location, spot.Map);
                        item.Weight = -2.0;
                    }
                }
        ...
        public WorkingSpots(Serial serial)
            : base(serial) { }
