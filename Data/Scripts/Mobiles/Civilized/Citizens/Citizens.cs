...
namespace Server.Mobiles
{
    public class Citizens : BaseCreature
    {
        ...
        public int Citizen_Service
        {
            get { return CitizenService; }
            set
            {
                CitizenService = value;
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int Citizen_Cost
        {
            get { return CitizenCost; }
            set
            {
                CitizenCost = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Citizen_Phrase
        {
            get { return CitizenPhrase; }
            set
            {
                CitizenPhrase = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string Citizen_Rumor
        {
            get { return CitizenRumor; }
            set
            {
                CitizenRumor = value;
                InvalidateProperties();
        ...
        public DateTime NextTalk
        {
            get { return m_NextTalk; }
            set { m_NextTalk = value; }
        }

        [Constructable]
        public Citizens()
            : base(AIType.AI_Citizen, FightMode.None, 10, 1, 0.2, 0.4)
        {
            ...
            switch (Utility.Random(3))
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    Server.Misc.IntelligentAction.DressUpRogues(this, "", false, false, true);
                    CitizenType = 3;
                    break;
            }
            ...
            if (this is HouseVisitor && Backpack != null)
            {
                Backpack.Delete();
            }
        }
        ...
        public void SetupCitizen()
        {
            ...
            if (this.FindItemOnLayer(Layer.OneHanded) != null)
            {
                ...
                if (
                    myOneHand.ItemID == 0x26BC
                    || myOneHand.ItemID == 0x26C6
                    || myOneHand.ItemID == 0x269D
                    || myOneHand.ItemID == 0x269E
                    || myOneHand.ItemID == 0xDF2
                    || myOneHand.ItemID == 0xDF3
                    || myOneHand.ItemID == 0xDF4
                    || myOneHand.ItemID == 0xDF5
                )
                {
            ...
            if (this.FindItemOnLayer(Layer.TwoHanded) != null)
            {
                ...
                if (
                    myTwoHand.ItemID == 0x26BC
                    || myTwoHand.ItemID == 0x26C6
                    || myTwoHand.ItemID == 0x269D
                    || myTwoHand.ItemID == 0x269E
                    || myTwoHand.ItemID == 0xDF2
                    || myTwoHand.ItemID == 0xDF3
                    || myTwoHand.ItemID == 0xDF4
                    || myTwoHand.ItemID == 0xDF5
                )
                {
            ...
            if (Utility.RandomMinMax(1, 3) == 1)
            {
                Clues = RandomThings.MadeUpDungeon();
            }
            ...
            if (Utility.RandomBool()) // CITIZENS LIE HALF THE TIME
            {
                ...
                {
                    locale = RandomThings.MadeUpDungeon();
                }
                else
                {
                    locale = QuestCharacters.SomePlace(null);
                }
            }
            ...
            switch (topic)
            {
                ...
                case 2:
                    CitizenRumor =
                        ...
                        + locale
                        + " is where you would look for "
                        + item
                        + ".";
                    break;
                case 3:
                    CitizenRumor =
                        "I heard many tales of adventurers going to "
                        + locale
                        + " and seeing "
                        + item
                        + ".";
                ...
                case 4:
                    CitizenRumor =
                        ...
                        + " was in the tavern talking about "
                        + item
                        + " and "
                        + locale
                        + ".";
                ...
                case 6:
                    CitizenRumor =
                        "I met with "
                        + QuestCharacters.RandomWords()
                        + " and they told me to bring back "
                        + item
                        + " from "
                        + locale
                        + ".";
            ...
            switch (Utility.RandomMinMax(0, 13))
            {
                case 0:
                    ...
                    break;
                case 1:
                    preface = "I heard rumours about";
                    break;
                case 2:
                    preface = "I heard a story about";
                    break;
                case 3:
                    preface = "I overheard someone tell of";
                    break;
                case 4:
                    preface = "Some " + adventurer + " found";
                    break;
                case 5:
                    preface = "Some " + adventurer + " heard rumours about";
                    break;
                case 6:
                    preface = "Some " + adventurer + " heard a story about";
                    break;
                case 7:
                    preface = "Some " + adventurer + " overheard another tell of";
                    break;
                case 8:
                    preface = "Some " + adventurer + " is spreading rumors about";
                    break;
                case 9:
                    preface = "Some " + adventurer + " is telling tales about";
                    break;
                case 10:
                    preface = "We found";
                    break;
                case 11:
                    preface = "We heard rumours about";
                    break;
                case 12:
                    preface = "We heard a story about";
                    break;
                case 13:
                    preface = "We overheard someone tell of";
                    break;
            }
            ...
            if (CitizenRumor == null)
            {
                CitizenRumor =
                    preface
                    + " "
                    + Server.Misc.TavernPatrons.CommonTalk(
                        "",
                        city,
                        dungeon,
                        this,
            ...
            else if (CitizenType == 1)
            {
                ...
                {
                    CitizenService = Utility.RandomMinMax(1, 8);
                }
            }
            ...
            if (
                this is TavernPatronNorth
                || this is TavernPatronSouth
                || this is TavernPatronEast
                || this is TavernPatronWest
            )
            {
                initPhrase = Utility.RandomMinMax(0, 4);
            }

            switch (initPhrase)
            {
                case 0:
                    phrase = "Greetings, Z~Z~Z~Z~Z.";
                    break;
                case 1:
                    phrase = "Hail, Z~Z~Z~Z~Z.";
                    break;
                case 2:
                    phrase = "Good day to you, Z~Z~Z~Z~Z.";
                    break;
                case 3:
                    phrase = "Hello, Z~Z~Z~Z~Z.";
                    break;
                case 4:
                    phrase = "We are just here to rest after exploring " + dungeon + ".";
                    break;
                case 5:
                    phrase = "This is the first time I have been to Y~Y~Y~Y~Y.";
                    break;
                case 6:
                    phrase = "Hail, Z~Z~Z~Z~Z. Welcome to Y~Y~Y~Y~Y.";
                    break;
            }
            ...
            if (CitizenService == 1)
            {
                if (CitizenType == 1)
                {
                    CitizenPhrase =
                        phrase
                        + " I can recharge any wands you may have with you, but only up to a certain amount. If you want my help, then simply hand me your wand so I can perform the ritual needed.";
                }
            ...
            else if (CitizenType == 20 && CitizenService == 20)
            {
                ...
                string sell = "willing to part with";
                if (Utility.RandomBool())
                {
                    sell = "willing to trade";
                }
                else if (Utility.RandomBool())
                {
            ...
            else if (CitizenType == 21 && CitizenService == 21)
            {
                ...
                CitizenPhrase =
                    CitizenPhrase
                    + " You can look in my backpack to examine the "
                    + contents
                    + " if you wish. If you want to trade, then hand me the gold and I will give you the "
                    + contents
                    + ".";
            ...
            else if (CitizenType == 24 && CitizenService == 24)
            {
                ...
                switch (Utility.RandomMinMax(0, 33))
                {
                    ...
                    case 31:
                        bottle = 0x641B;
                        reagent = "violet fungus";
                        break;
                    case 32:
                        bottle = 0x641C;
                        reagent = "werewolf claws";
                        break;
                    case 33:
                        bottle = 0x641D;
                        reagent = "wolfsbane";
            ...
            else if (CitizenType == 25 && CitizenService == 25)
            {
                ...
                switch (Utility.RandomMinMax(0, 36))
                {
                    case 0:
                        coins = 15;
                        potion = "nightsight potions";
                        jug = 1109;
                        break;
                    case 1:
                        coins = 15;
                        potion = "lesser cure potions";
                        jug = 45;
                        break;
                    case 2:
                        coins = 30;
                    ...
                    case 3:
                        coins = 60;
                        potion = "greater cure potions";
                        jug = 45;
                        break;
                    case 4:
                        coins = 15;
                        potion = "agility potions";
                        jug = 396;
                        break;
                    case 5:
                        coins = 60;
                        potion = "greater agility potions";
                        jug = 396;
                        break;
                    case 6:
                        coins = 15;
                        potion = "strength potions";
                        jug = 1001;
                        break;
                    case 7:
                        coins = 60;
                        potion = "greater strength potions";
                        jug = 1001;
                        break;
                    case 8:
                        coins = 15;
                        potion = "lesser poison potions";
                        jug = 73;
                        break;
                    case 9:
                        coins = 30;
                        potion = "poison potions";
                        jug = 73;
                        break;
                    case 10:
                        coins = 60;
                        potion = "greater poison potions";
                        jug = 73;
                        break;
                    case 11:
                        coins = 90;
                        potion = "deadly poison potions";
                        jug = 73;
                        break;
                    case 12:
                        coins = 120;
                        potion = "lethal poison potions";
                        jug = 73;
                        break;
                    case 13:
                        coins = 15;
                        potion = "refresh potions";
                        jug = 140;
                        break;
                    case 14:
                        coins = 30;
                        potion = "total refresh potions";
                        jug = 140;
                        break;
                    case 15:
                        coins = 15;
                        potion = "lesser heal potions";
                        jug = 50;
                        break;
                    case 16:
                        coins = 30;
                    ...
                    case 17:
                        coins = 60;
                        potion = "greater heal potions";
                        jug = 50;
                        break;
                    case 18:
                        coins = 15;
                        potion = "lesser explosion potions";
                        jug = 425;
                        break;
                    case 19:
                        coins = 30;
                        potion = "explosion potions";
                        jug = 425;
                        break;
                    case 20:
                        coins = 60;
                        potion = "greater explosion potions";
                        jug = 425;
                        break;
                    case 21:
                        coins = 15;
                        potion = "lesser invisibility potions";
                        jug = 0x490;
                        break;
                    case 22:
                        coins = 30;
                        potion = "invisibility potions";
                        jug = 0x490;
                        break;
                    case 23:
                        coins = 60;
                        potion = "greater invisibility potions";
                        jug = 0x490;
                        break;
                    case 24:
                        coins = 15;
                        potion = "lesser rejuvenate potions";
                        jug = 0x48E;
                        break;
                    case 25:
                        coins = 30;
                        potion = "rejuvenate potions";
                        jug = 0x48E;
                        break;
                    case 26:
                        coins = 60;
                        potion = "greater rejuvenate potions";
                        jug = 0x48E;
                        break;
                    case 27:
                        coins = 15;
                        potion = "lesser mana potions";
                        jug = 0x48D;
                        break;
                    case 28:
                        coins = 30;
                    ...
                    case 29:
                        coins = 60;
                        potion = "greater mana potions";
                        jug = 0x48D;
                        break;
                    case 30:
                        coins = 30;
                        potion = "conflagration potions";
                        jug = 0xAD8;
                        break;
                    case 31:
                        coins = 60;
                        potion = "greater conflagration potions";
                        jug = 0xAD8;
                        break;
                    case 32:
                        coins = 30;
                        potion = "confusion blast potions";
                        jug = 0x495;
                        break;
                    case 33:
                        coins = 60;
                        potion = "greater confusion blast potions";
                        jug = 0x495;
                        break;
                    case 34:
                        coins = 30;
                        potion = "frostbite potions";
                        jug = 0xAF3;
                        break;
                    case 35:
                        coins = 60;
                        potion = "greater frostbite potions";
                        jug = 0xAF3;
                        break;
                    case 36:
                        coins = 60;
            ...
            if (CitizenType == 1 && CitizenService == 2)
            {
                PackItem(new reagents_magic_jar1());
                CitizenCost = Utility.RandomMinMax(70, 150) * 10;
            }
            else if (CitizenType == 1 && CitizenService == 3)
            {
                PackItem(new reagents_magic_jar2());
                CitizenCost = Utility.RandomMinMax(50, 90) * 10;
            }
            else if (CitizenType == 1 && CitizenService == 4)
            {
                PackItem(new reagents_magic_jar3());
                CitizenCost = Utility.RandomMinMax(180, 300) * 10;
            }
            else if (CitizenType == 1 && CitizenService == 6)
            {
                if (Utility.RandomBool())
                {
                    ...
                    if (spellbook > 2)
                    {
                        ...
                        CitizenCost = Utility.RandomMinMax(
                            ((tome.SpellCount + 1) * 500),
                            ((tome.SpellCount + 1) * 800)
                        );
                        PackItem(tome);
                    }
                    else if (spellbook == 2)
                    ...
                    else
                    {
                        Spellbook tome = new MyNecromancerSpellbook();
                        CitizenCost = Utility.RandomMinMax(
                            ((tome.SpellCount + 1) * 600),
                            ((tome.SpellCount + 1) * 900)
                        );
                        PackItem(tome);
                    }
                }
                else
                {
                    ...
                    CitizenCost = Utility.RandomMinMax(150, 230) * 10;
                }
            }
            else if (CitizenType == 1 && CitizenService == 7)
            {
                ...
                if (
                    scroll is PainSpikeScroll
                    || scroll is EvilOmenScroll
                    || scroll is WraithFormScroll
                    || scroll is ArchCureScroll
                    || scroll is ArchProtectionScroll
                    || scroll is CurseScroll
                    || scroll is FireFieldScroll
                    || scroll is GreaterHealScroll
                    || scroll is LightningScroll
                    || scroll is ManaDrainScroll
                    || scroll is RecallScroll
                )
                {
                    mult = 10;
                }
                else if (
                    scroll is MindRotScroll
                    || scroll is SummonFamiliarScroll
                    || scroll is HorrificBeastScroll
                    || scroll is AnimateDeadScroll
                    || scroll is BladeSpiritsScroll
                    || scroll is DispelFieldScroll
                    || scroll is IncognitoScroll
                    || scroll is MagicReflectScroll
                    || scroll is MindBlastScroll
                    || scroll is ParalyzeScroll
                    || scroll is PoisonFieldScroll
                    || scroll is SummonCreatureScroll
                )
                {
                    mult = 20;
                }
                else if (
                    scroll is DispelScroll
                    || scroll is EnergyBoltScroll
                    || scroll is ExplosionScroll
                    || scroll is InvisibilityScroll
                    || scroll is MarkScroll
                    || scroll is MassCurseScroll
                    || scroll is ParalyzeFieldScroll
                    || scroll is RevealScroll
                )
                {
                    mult = 40;
                }
                else if (
                    scroll is PoisonStrikeScroll
                    || scroll is WitherScroll
                    || scroll is StrangleScroll
                    || scroll is LichFormScroll
                    || scroll is ChainLightningScroll
                    || scroll is EnergyFieldScroll
                    || scroll is FlamestrikeScroll
                    || scroll is GateTravelScroll
                    || scroll is ManaVampireScroll
                    || scroll is MassDispelScroll
                    || scroll is MeteorSwarmScroll
                    || scroll is PolymorphScroll
                )
                {
                    mult = 60;
                }
                else if (
                    scroll is ExorcismScroll
                    || scroll is VampiricEmbraceScroll
                    || scroll is VengefulSpiritScroll
                    || scroll is EarthquakeScroll
                    || scroll is EnergyVortexScroll
                    || scroll is ResurrectionScroll
                    || scroll is SummonAirElementalScroll
                    || scroll is SummonDaemonScroll
                    || scroll is SummonEarthElementalScroll
                    || scroll is SummonFireElementalScroll
                    || scroll is SummonWaterElementalScroll
                )
                {
                    mult = 80;
                }
            ...
            else if (CitizenType == 1 && CitizenService == 8)
            {
                ...
                {
                    CitizenCost = Utility.RandomMinMax(20, 60) * 5;
                }
                else if (bw.IntRequirement == 15)
                {
                    CitizenCost = Utility.RandomMinMax(20, 60) * 10;
                }
                else if (bw.IntRequirement == 20)
                {
                    CitizenCost = Utility.RandomMinMax(20, 60) * 15;
                }
                else if (bw.IntRequirement == 25)
                {
                    CitizenCost = Utility.RandomMinMax(20, 60) * 20;
                }
                else if (bw.IntRequirement == 30)
                {
                    CitizenCost = Utility.RandomMinMax(20, 60) * 25;
                }
                else if (bw.IntRequirement == 35)
                {
                    CitizenCost = Utility.RandomMinMax(20, 60) * 30;
                }
                else if (bw.IntRequirement == 40)
                {
                    CitizenCost = Utility.RandomMinMax(20, 60) * 35;
                }
                else if (bw.IntRequirement == 45)
                {
                    CitizenCost = Utility.RandomMinMax(20, 60) * 40;
                }
                PackItem(wand);
            }
            else if (CitizenService == 5)
            {
                ...
                if (chance < 80)
                {
                    ...
                    arty.Movable = false;
                    arty.Name = LootPackEntry.MagicItemName(
                        arty,
                        this,
                ...
                else if (chance < 95)
                {
                    ...
                    {
                        arty.Hue = Utility.RandomColor(0);
                    }
            ...
            else if (CitizenType == 26 && CitizenService == 26)
            {
                ...
                switch (Utility.RandomMinMax(0, 3))
                {
                    case 0:
                        cost = 6;
                        eat = 0x508B;
                        food = "cooked fish steaks";
                        break;
                    case 1:
                        cost = 8;
                        eat = 0x508C;
                        food = "cooked lamb legs";
                        break;
                    case 2:
                        cost = 7;
                        eat = 0x508D;
            ...
            )
            {
                ...
                if (CitizenService == 3)
                {
                    aty1 = "a jar of necromancer reagents";
                }
                else if (CitizenService == 4)
                {
                    aty1 = "a jar of alchemical reagents";
                }
                else if (CitizenService == 6)
                {
                    aty1 = "a book";
                }
                else if (CitizenService == 7)
                {
                    aty1 = "a scroll";
                }
                else if (CitizenService == 8)
                {
                    aty1 = "a wand";
                }
                ...
                CitizenPhrase =
                    phrase + " I have " + aty1 + " that I am " + aty3 + " for G~G~G~G~G gold.";
                CitizenPhrase =
                    CitizenPhrase
                    + " You can look in my backpack to examine the item if you wish. If you want to trade, then hand me the gold and I will give you the item.";
            }
            ...
            foreach (Item i in this.Backpack.Items)
            {
                ...
                {
                    holding = MorphingItem.AddSpacesToSentence((i.GetType()).Name);
                }
                if (Server.Misc.MaterialInfo.GetMaterialName(i) != "")
                {
                    holding = Server.Misc.MaterialInfo.GetMaterialName(i) + " " + i.Name;
                }
            ...
            if (holding != "")
            {
                CitizenPhrase = CitizenPhrase + "<br><br>" + holding;
            }
            else if (CitizenService == 5)
            {
                CitizenPhrase = null;
            }
            else if ((CitizenService >= 2 && CitizenService <= 8) && CitizenType == 1)
            {
                CitizenPhrase = null;
            }
        }
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            if (
                !(
                    this is HouseVisitor
                    || (
                        this is Humanoid && this.Body != 593 && this.Body != 597 && this.Body != 598
                    )
                )
            )
            {
                if (DateTime.Now >= m_NextTalk && InRange(m, 30))
                {
                    ...
                    m_NextTalk = (
                        DateTime.Now + TimeSpan.FromSeconds(Utility.RandomMinMax(15, 45))
                    );
                }
            }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            if (
                !(
                    this is Humanoid
                    || (this is HouseVisitor && (this.Body == 9 || this.Body == 320))
                )
            )
            {
        ...
        public class SpeechGumpEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                PlayerMobile mobile = (PlayerMobile)m_Mobile;
                {
                    ...
                    if (
                        m_Giver.Fame == 0
                        && m_Mobile.Backpack.FindItemByType(typeof(MuseumBook)) != null
                        && !(m_Giver is HouseVisitor)
                    )
                    {
                    ...
                    if (
                        speak == ""
                        && m_Giver.Fame == 0
                        && m_Mobile.Backpack.FindItemByType(typeof(QuestTome)) != null
                        && !(m_Giver is HouseVisitor)
                    )
                    {
        ...
        public static void PopulateCities()
        {
            ...
            {
                if (
                    wanderer is Citizens
                    && !(
                        wanderer is HouseVisitor
                        || wanderer is AdventurerWest
                        || wanderer is AdventurerSouth
                        || wanderer is AdventurerNorth
                        || wanderer is AdventurerEast
                        || wanderer is TavernPatronWest
                        || wanderer is TavernPatronSouth
                        || wanderer is TavernPatronNorth
                        || wanderer is TavernPatronEast
                    )
                )
                {
            ...
            foreach (Item item in World.Items.Values)
            {
                ...
                else if (item is MeetingPets)
                {
                    ...
                    (item is LawnItem || item is ShantyItem)
                    && (item.Name == "burning pit" || item.Name == "huge fire")
                )
                {
                    meetingLawns.Add(item);
                }
                else if (
                    (item is LawnPiece || item is ShantyPiece)
                    && item.Name == "summoning pentagram"
                    && (item.ItemID == 0x647 || item.ItemID == 0xFEA)
                )
                {
            ...
            for (int i = 0; i < meetingPets.Count; ++i)
            {
                ...
                if (Server.Misc.MyServerSettings.Humanoid())
                {
                    CreatePets(spot);
                }
            }
        ...
        public static void CreatePets(Item spot)
        {
            ...
            if (spot.Name == "east")
            {
                pet.Direction = Direction.East;
            }
            else if (spot.Name == "south")
            {
                pet.Direction = Direction.South;
            }
            else if (spot.Name == "west")
            {
                pet.Direction = Direction.West;
            }
            else if (spot.Name == "north")
            {
        ...
        public static void CreateCitizenss(Item spot)
        {
            ...
            if (reg.Name == "the Lyceum")
            {
                mount = false;
                mod = 3;
            }
            else if (
                Server.Mobiles.AnimalTrainer.IsNoMountRegion(m, m.Region)
                && Server.Misc.MyServerSettings.NoMountsInCertainRegions()
            )
            { /* DO NOTHING IN NO MOUNT REGIONS */
            }
            else if (
                Server.Misc.MyServerSettings.NoMountBuilding() && Server.Misc.Worlds.InBuilding(m)
            )
            { /* DO NOTHING IN NO MOUNT REGIONS */
            }
            ...
            else if (spot.Map == Map.Sosaria && spot.Z >= 105 && spot.X == 1418 && spot.Y == 3665)
            { } // UMBER VEIL TOWER...NO HORSES
            else if (Utility.RandomBool())
            {
                mount = true;
                mod = 3;
            ...
            if (!((spot.Map).CanSpawnMobile(cit1.X, cit1.Y, z_1)))
            {
                z_1 = cit1.Z;
            }
            if (
                spot is LawnItem
                && (spot.Map).CanSpawnMobile(cit1.X, cit1.Y, z_1)
                && !(Region.Find(cit1, spot.Map) is HouseRegion)
            )
            {
                canSpawn1 = true;
                cit1 = new Point3D((spot.X - mod), (spot.Y), z_1);
            }
            else if (
                spot is ShantyItem
                && (spot.Map).CanSpawnMobile(cit1.X, cit1.Y, z_1)
            ...
            if (!((spot.Map).CanSpawnMobile(cit2.X, cit2.Y, z_2)))
            {
                z_2 = cit2.Z;
            }
            if (
                spot is ShantyItem
                && (spot.Map).CanSpawnMobile(cit2.X, cit2.Y, z_2)
                && !(Region.Find(cit2, spot.Map) is HouseRegion)
            )
            {
                canSpawn2 = true;
                cit2 = new Point3D((spot.X), (spot.Y - mod), z_2);
            }
            else if (
                spot is ShantyItem
                && (spot.Map).CanSpawnMobile(cit2.X, cit2.Y, z_2)
            ...
            if (!((spot.Map).CanSpawnMobile(cit3.X, cit3.Y, z_3)))
            {
                z_3 = cit3.Z;
            }
            if (
                spot is LawnItem
                && (spot.Map).CanSpawnMobile(cit3.X, cit3.Y, z_3)
                && !(Region.Find(cit3, spot.Map) is HouseRegion)
            )
            {
                canSpawn3 = true;
                cit3 = new Point3D((spot.X + mod), (spot.Y), z_3);
            }
            else if (
                spot is LawnItem
                && (spot.Map).CanSpawnMobile(cit3.X, cit3.Y, z_3)
            ...
            if (!((spot.Map).CanSpawnMobile(cit4.X, cit4.Y, z_4)))
            {
                z_4 = cit4.Z;
            }
            if (
                spot is LawnItem
                && (spot.Map).CanSpawnMobile(cit4.X, cit4.Y, z_4)
                && !(Region.Find(cit4, spot.Map) is HouseRegion)
            )
            {
                canSpawn4 = true;
                cit4 = new Point3D((spot.X), (spot.Y + mod), z_4);
            }
            else if (
                spot is LawnItem
                && (spot.Map).CanSpawnMobile(cit4.X, cit4.Y, z_4)
            ...
            {
                w++;
                if ((spot is LawnItem || spot is ShantyItem) && w > 10)
                {
                    process = false;
                }
                ...
                if (Utility.RandomBool() && humanE == 0 && canSpawn1)
                {
                    ...
                    while (citizen == null)
                    {
                        ...
                        if (citizen != null)
                        {
                            ...
                            {
                                citizen.Delete();
                                citizen = new Humanoid();
                                humanoids++;
                            }
                            else if (spot is LawnItem || spot is ShantyItem)
                            {
                                citizen.Delete();
                                citizen = new HouseVisitor();
                            }
                            if (!(spot is LawnItem) && !(spot is ShantyItem))
                            {
                                citizen.AddItem(new LightCitizen(false));
                            }
                            citizen.MoveToWorld(cit1, spot.Map);
                            if (citizen is Humanoid)
                            {
                                Humanoid.HumanoidSetup(citizen, false);
                                total = total - 1;
                            }
                            if (mount)
                            {
        ...
        public static void MountCitizens(Mobile m, bool includeDragyns)
        {
            if (m is DragonRider)
            {
                ...
                dragon.Body = Utility.RandomList(59, 61);
                dragon.Blessed = true;
                dragon.Hue = Utility.RandomMonsterHue();
            ...
            { /* DO NOTHING IN THE CIMMERIAN CASTLE */
                ...
                m.Region.IsPartOf("Kraken Reef Docks")
                || m.Region.IsPartOf("Anchor Rock Docks")
                || m.Region.IsPartOf("Serpent Sail Docks")
                || m.Region.IsPartOf("Savage Sea Docks")
            ...
            else if (!(m is HouseVisitor))
            {
                ...
                switch (Utility.Random(30))
                {
                    case 0:
                        ...
                        {
                            case 1:
                                mount = new CaveBearRiding();
                                break;
                            case 2:
                                mount = new DireBear();
                                break;
                            case 3:
                                mount = new ElderBlackBearRiding();
                                break;
                            case 4:
                                mount = new ElderBrownBearRiding();
                                break;
                            case 5:
                                mount = new ElderPolarBearRiding();
                                break;
                            case 6:
                                mount = new GreatBear();
                                break;
                            case 7:
                                mount = new GrizzlyBearRiding();
                                break;
                            case 8:
                                mount = new KodiakBear();
                                break;
                            case 9:
                                mount = new SabretoothBearRiding();
                                break;
                            case 10:
                                mount = new PandaRiding();
                                break;
                        }
                        break;
                    case 1:
                        ...
                        {
                            case 1:
                                mount = new BullradonRiding();
                                break;
                            case 2:
                                mount = new GorceratopsRiding();
                                break;
                            case 3:
                                mount = new GorgonRiding();
                                break;
                            case 4:
                                mount = new BasiliskRiding();
                                break;
                        }
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        {
                            case 1:
                                mount = new LionRiding();
                                break;
                            case 2:
                                mount = new SnowLion();
                                break;
                            case 3:
                                mount = new TigerRiding();
                                break;
                            case 4:
                                mount = new WhiteTigerRiding();
                                break;
                            case 5:
                                mount = new PredatorHellCatRiding();
                                break;
                            case 6:
                                mount = new SabretoothTigerRiding();
                                break;
                        }
                        break;
                    case 4:
                        ...
                        {
                            case 1:
                                mount = new DesertOstard();
                                break;
                            case 2:
                                mount = new ForestOstard();
                                break;
                            case 3:
                                mount = new FrenziedOstard();
                                break;
                            case 4:
                                mount = new SnowOstard();
                                break;
                        }
                        break;
                    case 5:
                    ...
                    case 6:
                        ...
                        {
                            case 1:
                                mount = new SwampDrakeRiding();
                                break;
                            case 2:
                                mount = new Wyverns();
                                break;
                            case 3:
                                mount = new Teradactyl();
                                break;
                            case 4:
                                mount = new GemDragon();
                                mount.Hue = 0;
                                mount.ItemID = Utility.RandomMinMax(595, 596);
                                break;
                        }
                        break;
                    case 7:
                        switch (Utility.RandomMinMax(1, 6))
                        {
                            case 1:
                                ...
                                break;
                            case 2:
                                mount = new FireBeetle();
                                break;
                            case 3:
                                mount = new GlowBeetleRiding();
                                break;
                            case 4:
                                mount = new PoisonBeetleRiding();
                                break;
                            case 5:
                                mount = new TigerBeetleRiding();
                                break;
                            case 6:
                                mount = new WaterBeetleRiding();
                                break;
                        }
                        break;
                    case 8:
                        ...
                        {
                            case 1:
                                mount = new RaptorRiding();
                                break;
                            case 2:
                                mount = new RavenousRiding();
                                break;
                            case 3:
                                mount = new RaptorRiding();
                                mount.Body = 116;
                    ...
                    case 9:
                        ...
                        switch (roll)
                        {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                mount = new AncientNightmareRiding();
                                break;
                            case 6:
                                mount = new DarkUnicornRiding();
                                Server.Misc.MorphingTime.TurnToNecromancer(m);
                                break;
                            case 7:
                                mount = new HellSteed();
                    ...
                    case 10:
                        ...
                        switch (roll)
                        {
                            case 1:
                                ...
                                break;
                            case 2:
                                mount = new RidableLlama();
                                break;
                            case 3:
                                mount = new GriffonRiding();
                                break;
                            case 4:
                                mount = new HippogriffRiding();
                                break;
                            case 5:
                                mount = new Kirin();
                                break;
                            case 6:
                                mount = new ManticoreRiding();
                                break;
                            case 7:
                                mount = new SphinxRiding();
                                break;
                        }
                        break;
                }
                ...
                if (mount is Horse && Utility.RandomMinMax(1, 50) == 1)
                {
                    ...
                    {
                        case 1:
                            mount.Hue = MaterialInfo.GetMaterialColor("dull copper", "classic", 0);
                            break;
                        case 2:
                            mount.Hue = MaterialInfo.GetMaterialColor("shadow iron", "classic", 0);
                            break;
                        case 3:
                            mount.Hue = MaterialInfo.GetMaterialColor("copper", "classic", 0);
                            break;
                        case 4:
                            mount.Hue = MaterialInfo.GetMaterialColor("bronze", "classic", 0);
                            break;
                        case 5:
                            mount.Hue = MaterialInfo.GetMaterialColor("gold", "classic", 0);
                            break;
                        case 6:
                            mount.Hue = MaterialInfo.GetMaterialColor("agapite", "classic", 0);
                            break;
                        case 7:
                            mount.Hue = MaterialInfo.GetMaterialColor("verite", "classic", 0);
                            break;
                        case 8:
                            mount.Hue = MaterialInfo.GetMaterialColor("valorite", "classic", 0);
                            break;
                        case 9:
                            mount.Hue = MaterialInfo.GetMaterialColor("nepturite", "classic", 0);
                            break;
                        case 10:
                            mount.Hue = MaterialInfo.GetMaterialColor("obsidian", "classic", 0);
                            break;
                        case 11:
                            mount.Hue = MaterialInfo.GetMaterialColor("steel", "classic", 0);
                            break;
                        case 12:
                            mount.Hue = MaterialInfo.GetMaterialColor("brass", "classic", 0);
                            break;
                        case 13:
                            mount.Hue = MaterialInfo.GetMaterialColor("mithril", "classic", 0);
                            break;
                        case 14:
                            mount.Hue = MaterialInfo.GetMaterialColor("xormite", "classic", 0);
                            break;
                        case 15:
                            mount.Hue = MaterialInfo.GetMaterialColor("dwarven", "classic", 0);
                            break;
                        case 16:
                            mount.Hue = MaterialInfo.GetMaterialColor("silver", "classic", 0);
                            break;
                    }
                }
            ...
            if (!(this is Humanoid))
            {
                ...
                if (Server.Misc.Worlds.isOrientalRegion(this))
                {
                    ...
                    else if (CitizenType == 2 || this is Warriors)
                    {
                        if (Utility.RandomBool())
                        {
                            Server.Misc.IntelligentAction.DressUpFighters(
                                this,
                                "",
                                false,
                                true,
                        ...
                        {
                            Server.Misc.IntelligentAction.DressUpRogues(
                                this,
                                "",
                                false,
                                true,
        ...
        public class CitizenGump : Gump
        {
            ...
            public CitizenGump(Mobile citizen, Mobile player)
                : base(25, 25)
            {
                c_Citizen = citizen;
                ...
                AddHtml(
                    ...
                    380,
                    253,
                    @"<BODY><BASEFONT Color=" + color + ">" + speak + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)true
                );
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            bool isMetal = false;
            if (Server.Misc.MaterialInfo.IsAnyKindOfMetalItem(dropped))
            {
                isMetal = true;
            }
            bool isWood = false;
            if (Server.Misc.MaterialInfo.IsAnyKindOfWoodItem(dropped))
            {
                isWood = true;
            }
            bool isLeather = false;
            if (Server.Misc.MaterialInfo.IsAnyKindOfClothItem(dropped))
            {
                isLeather = true;
            }
            bool fixArmor = false;
