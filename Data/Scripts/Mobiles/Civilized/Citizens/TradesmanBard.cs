...
namespace Server.Mobiles
{
    public class TradesmanBard : Citizens
    {
        ...
        public TradesmanBard(Serial serial)
            : base(serial) { }
    ...
    public class BardHit : Item
    {
            ...
            if (from is TradesmanBard)
            {
                ...
                while (lyrics > 0)
                {
                    ...
                    if (added)
                    {
                        sing =
                            sing
                            + song1[Utility.RandomMinMax(0, (song1.Length - 1))]
                            + song2[Utility.RandomMinMax(0, (song2.Length - 1))]
                            + " ";
                    }
                ...
                if (this.Name != "instrument")
                {
                    if (this.ItemID == 0x64BE || this.ItemID == 0x64BF)
                    {
                        ...
                        from.PlaySound(Utility.RandomList(0x4C, 0x403, 0x40B, 0x418));
                    ...
                    {
                        this.Name = "instrument";
                        from.PlaySound(0x504);
                    } // FLUTE
                    else if (this.ItemID == 0x64C2 || this.ItemID == 0x64C3)
                    {
                        this.Name = "instrument";
                        from.PlaySound(Utility.RandomList(0x043, 0x045));
                        if (Utility.RandomBool())
                        {
                            from.Say(sing);
                        }
                    ...
                    {
                        this.Name = "instrument";
                        from.PlaySound(Utility.RandomList(0x52, 0x4B5, 0x4B6, 0x4B7));
                        if (Utility.RandomBool())
                        {
                            from.Say(sing);
                        }
                    ...
                    {
                        this.Name = "instrument";
                        from.PlaySound(Utility.RandomList(0x3CF, 0x3D0));
                    } // TRUMPET
                    else if (this.ItemID == 0x64CC || this.ItemID == 0x64CD)
                    {
                        this.Name = "instrument";
                        from.PlaySound(0x5B8);
                    } // PIPES
                }
                else
                {
                    ...
                    switch (Utility.RandomMinMax(1, 10))
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            ext3 = "called " + RandomThings.GetSongTitle() + ".";
                            break;
                        case 5:
                            ext3 = "I call " + RandomThings.GetSongTitle() + ".";
                            break;
                        case 6:
                            if (ext1 == "Here is a " || ext1 == "This is a ")
                            {
                        ...
                        case 9:
                            ext3 =
                                "about the " + ext5 + " of " + RandomThings.GetRandomCity() + ".";
                            break;
                        case 10:
                            ext3 =
                                "about the " + ext6 + " of " + RandomThings.MadeUpDungeon() + ".";
                            break;
                    }
                    ...
                    if (Utility.RandomBool())
                    {
                        ...
                        {
                            case 1:
                                book = "carved on a tablet";
                                break;
                            case 2:
                                book = "written in a book";
                                break;
                            case 3:
                                book = "scrawled on a wall";
                                break;
                        }
                        ...
                        switch (Utility.RandomMinMax(1, 9))
                        {
                            case 1:
                                say =
                                    "This " + ext2 + "was " + singer + " by " + name + title + ".";
                                break;
                            case 2:
                                say =
                                    "This "
        ...
        public static void SetInstrument(Mobile from, Item instrument)
        {
            ...
            if (facing == "south")
            {
                ...
                {
                    case 1:
                        instrument.ItemID = 0x64BF;
                        instrument.Name = "lute";
                        instrument.Z = from.Z + 9;
                        break;
                    case 2:
                        instrument.ItemID = 0x64C1;
                        instrument.Name = "flute";
                        instrument.Z = from.Z + 11;
                        break;
                    case 3:
                        instrument.ItemID = 0x64C3;
                        instrument.Name = "harp";
                        instrument.Z = from.Z + 8;
                        break;
                    case 4:
                        instrument.ItemID = 0x64C5;
                        instrument.Name = "drum";
                        instrument.Z = from.Z + 8;
                        break;
                    case 5:
                        instrument.ItemID = 0x64C7;
                        instrument.Name = "fiddle";
                        instrument.Z = from.Z + 10;
                        break;
                    case 6:
                        instrument.ItemID = 0x64C9;
                        instrument.Name = "tambourine";
                        instrument.Z = from.Z + 9;
                        break;
                    case 7:
                        instrument.ItemID = 0x64CB;
                        instrument.Name = "trumpet";
                        instrument.Z = from.Z + 9;
                        instrument.Hue = 0xB61;
                        break;
                    case 8:
                        instrument.ItemID = 0x64CD;
                        instrument.Name = "pipes";
                        instrument.Z = from.Z + 9;
                        break;
                }
            }
            else
            {
                ...
                {
                    case 1:
                        instrument.ItemID = 0x64BE;
                        instrument.Name = "lute";
                        instrument.Z = from.Z + 9;
                        break;
                    case 2:
                        instrument.ItemID = 0x64C0;
                        instrument.Name = "flute";
                        instrument.Z = from.Z + 11;
                        break;
                    case 3:
                        instrument.ItemID = 0x64C2;
                        instrument.Name = "harp";
                        instrument.Z = from.Z + 8;
                        break;
                    case 4:
                        instrument.ItemID = 0x64C4;
                        instrument.Name = "drum";
                        instrument.Z = from.Z + 8;
                        break;
                    case 5:
                        instrument.ItemID = 0x64C6;
                        instrument.Name = "fiddle";
                        instrument.Z = from.Z + 10;
                        break;
                    case 6:
                        instrument.ItemID = 0x64C8;
                        instrument.Name = "tambourine";
                        instrument.Z = from.Z + 9;
                        break;
                    case 7:
                        instrument.ItemID = 0x64CA;
                        instrument.Name = "trumpet";
                        instrument.Z = from.Z + 9;
                        instrument.Hue = 0xB61;
                        break;
                    case 8:
                        instrument.ItemID = 0x64CC;
                        instrument.Name = "pipes";
                        instrument.Z = from.Z + 9;
                        break;
                }
