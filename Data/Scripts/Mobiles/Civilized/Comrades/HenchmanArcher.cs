...
namespace Server.Mobiles
{
    ...
    public class HenchmanArcher : BaseCreature
    {
        ...
        public DateTime NextMorale
        {
            get { return m_NextMorale; }
            set { m_NextMorale = value; }
        }
        ...
        [Constructable]
        public HenchmanArcher(int myBody, int nMounted, double nSkills, int nStats)
        ...
        public HenchmanArcher(Serial serial)
            : base(serial) { }
