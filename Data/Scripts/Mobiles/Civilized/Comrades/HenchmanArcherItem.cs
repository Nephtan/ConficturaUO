...
namespace Server.Items
{
    public class HenchmanArcherItem : HenchmanItem
    {
            ...
            : base()
        {
            ...
            else
            {
                if (HenchWeaponType != 1) // BOW
                {
                    ...
                    {
                        case 0:
                            HenchWeaponID = 0x13B2;
                            break;
                        case 1:
                            HenchWeaponID = 0x2D2B;
                            break;
                        case 2:
                            HenchWeaponID = 0x26C2;
                            break;
                        case 3:
                            HenchWeaponID = 0x2D1E;
                            break;
                    }
                }
                else // CROSSBOW
                {
                    ...
                    {
                        case 0:
                            HenchWeaponID = 0x26C3;
                            break;
                        case 1:
                            HenchWeaponID = 0xF50;
                            break;
                        case 2:
                            HenchWeaponID = 0x13FD;
                            break;
                    }
                }
            }
        ...
        public HenchmanArcherItem(Serial serial)
            : base(serial) { }
