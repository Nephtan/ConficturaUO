...
namespace Server.Mobiles
{
    public class NecroGreeter : BaseNPC
    {
        ...
        string[] kfcsay = new string[] { "Fear the woods beyond.", };
        ...
        public NecroGreeter(Serial serial)
            : base(serial) { }
        ...
        public class NecroGreeterEntry : ContextMenuEntry
        {
            ...
            public NecroGreeterEntry(Mobile from, Mobile giver)
                : base(6146, 3)
            {
                m_Mobile = from;
                m_Giver = giver;
                    ...
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        mobile.SendGump(
                            new SpeechGump(
                                ...
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "NecroGreeter")
                            )
                        );
                    }
                }
