...
namespace Server.Mobiles
{
    public class LegendaryDealer : BaseVendor
    {
        ...
        [Constructable]
        public LegendaryDealer()
            : base("the legendary sage") { }
        ...
        public LegendaryDealer(Serial serial)
            : base(serial) { }
                    ...
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        mobile.SendGump(
                            new SpeechGump(
                                ...
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "Powerscroll")
                            )
                        );
                    }
                }
        ...
        public class BuyGumpEntry : ContextMenuEntry
        {
            ...
            public BuyGumpEntry(Mobile from, Mobile giver)
                : base(6103, 3)
            {
                m_Mobile = from;
                m_Giver = giver;
