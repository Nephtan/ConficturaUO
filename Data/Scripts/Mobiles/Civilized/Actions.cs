        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (from is LeatherWorker || from is Tanner)
            {
                if (ItemID == 0x1069 || ItemID == 0x106A || ItemID == 0x107A || ItemID == 0x107B)
                {
                    ...
                    else if (ItemID == 0x106A)
                    {
                        ItemID = 0x1069;
                    }
                    else if (ItemID == 0x107A)
                    {
                        ItemID = 0x107B;
                    }
                    else if (ItemID == 0x107B)
                    {
                        ItemID = 0x107A;
                    }
                    Name = "stretched hide";
            ...
            else if (from is Bowyer)
            {
                ...
                if (m_Acts == 1)
                {
                    ...
                    switch (Utility.Random(4))
                    {
                        case 0:
                            Name = "arrows";
                            ItemID = Utility.RandomList(0xF40, 0xF41);
                            break;
                        case 1:
                            Name = "bolts";
                            ItemID = Utility.RandomList(0x1BFC, 0x1BFD);
                            break;
                        case 2:
                            Name = "crossbow";
                            ItemID = Utility.RandomList(0x13FC, 0x13FD, 0xF4F, 0xF50);
                            break;
                        case 3:
                            Name = "bow";
                            ItemID = Utility.RandomList(0x13B1, 0x13B2);
                            break;
                    }
                    from.PlaySound(0x55);
                    from.Animate(230, 5, 1, true, false, 0);
            ...
            else if (from is Fisherman)
            {
                if (ItemID == 0x1797)
                {
                    ...
                    ((BaseVendor)from).m_NextAction = (
                        DateTime.Now + TimeSpan.FromSeconds(Utility.RandomMinMax(10, 20))
                    );
                }
                else if (
                    ItemID == 0x9CC
            ...
            else if (from is Baker)
            {
                ...
                else
                {
                    ...
                    {
                        Name = "bread";
                        ItemID = Utility.RandomList(0x103C, 0x98C);
                    }
                    else
                    {
                        Name = "cookies";
                        ItemID = Utility.RandomList(0x160B, 0x160C);
                    }
                    from.Animate(230, 5, 1, true, false, 0);
            ...
            else if (from is Bard || from is Minstrel)
            {
                ...
                else
                {
                    ...
                    if (this.Name == "flute")
                    {
                        from.PlaySound(0x502);
                    }
                    else if (this.Name == "harp")
                    {
                        from.PlaySound(0x45);
                    }
                    ...
                    else if (this.Name == "tambourine")
                    {
                        from.PlaySound(0x52);
                    }
                    else if (this.Name == "lute")
                    {
                        from.PlaySound(0x4C);
                    }
                    else if (this.Name == "pipes")
                    {
