                ...
                PlayerMobile mobile = (PlayerMobile)m_Mobile;
                {
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        mobile.SendGump(
                            new SpeechGump(
                                mobile,
                                "Thou Art Going To Get Hurt",
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "Healer")
                            )
                        );
                    }
                }
            ...
            if (dropped is MalletStake)
            {
                ...
                if (reward > 0)
                {
                    ...
                    if (
                        reward >= 1000
                        && from.Karma >= 2500
                        && from.Skills[SkillName.Spiritualism].Base > 0
                        && from.Skills[SkillName.Healing].Base > 0
                    )
                    {
                        ...
                        if (hasBook == 0)
                        {
                            HolyManSpellbook tome = new HolyManSpellbook((ulong)0, from);
                        ...
                        if (hasSymbol + hasBook == 0)
                        {
                            ...
                            sMessage =
                                from.Name
                                + ", take the gold and these as well. You may be a good priest one day.";
                        }
                    }
