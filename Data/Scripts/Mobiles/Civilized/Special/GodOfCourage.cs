    ...
    public class GodOfLegends : BasePerson
    {
                    ...
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        mobile.SendGump(
                            new SpeechGump(
                                mobile,
                                "Items of Legend",
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "GodOfLegends")
                            )
                        );
                    }
                }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            if (dropped is ILevelable)
            {
                ...
                string sMessage =
                    "Mark your legendary artefact so others will tell tales of it one day.";
        ...
        public GodOfLegends(Serial serial)
            : base(serial) { }
