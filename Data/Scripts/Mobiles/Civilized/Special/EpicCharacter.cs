...
namespace Server.Mobiles
{
    public class EpicCharacter : BasePerson
    {
        ...
        [CommandProperty(AccessLevel.Owner)]
        public string My_ItemText
        {
            get { return MyItemText; }
            set
            {
                MyItemText = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int My_ItemHue
        {
            get { return MyItemHue; }
            set
            {
                MyItemHue = value;
                InvalidateProperties();
        ...
        [CommandProperty(AccessLevel.Owner)]
        public int My_ItemPower
        {
            get { return MyItemPower; }
            set
            {
                MyItemPower = value;
                InvalidateProperties();
        ...
        public static void SetSpecialItemRequirement(Mobile m)
        {
            ...
            if (epicName == "NEW" || epicName == "" || epicName == null)
            {
                ...
                while (Server.Items.SummonPrison.UsedNumberCheck(KeepTrack, choice) == true)
                {
                    choice = Utility.RandomMinMax(1, 59);
                }
                ((PlayerMobile)m).EpicQuestName = Server.Items.SummonPrison.GetItemNeeded(
                    choice,
                    3
                );
        ...
        public class SpeechGumpEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                if (((EpicCharacter)m_Giver).MyAlignment == "good")
                {
                    if (m_Mobile.Fame >= 4000 && m_Mobile.Karma >= 4000)
                    {
                        PassTest = true;
                    }
                }
                else if (((EpicCharacter)m_Giver).MyAlignment == "evil")
                {
                    if (m_Mobile.Fame >= 4000 && m_Mobile.Karma <= -4000)
                    {
                        PassTest = true;
                ...
                else if (((EpicCharacter)m_Giver).MyAlignment == "neutral")
                {
                    if (m_Mobile.Fame >= 7000)
                    {
                        PassTest = true;
                    }
                }
                ...
                if (!mobile.HasGump(typeof(EpicGump)))
                {
                    mobile.SendGump(
                        new EpicGump(
                            ...
                            m_Mobile,
                            PassTest,
                            ((EpicCharacter)m_Giver).MyAlignment
                        )
                    );
                }
            }
        ...
        {
            public GiftGumpEntry(Mobile from, Mobile giver, bool pay)
                : base(6163, 3)
            {
                m_Mobile = from;
                m_Giver = giver;
            ...
            public override void OnClick()
            {
                ...
                if (((EpicCharacter)m_Giver).MyAlignment == "good" && m_Pay)
                {
                    if (m_Mobile.Fame >= 4000 && m_Mobile.Karma >= 4000)
                    {
                        PassTest = true;
                ...
                else if (((EpicCharacter)m_Giver).MyAlignment == "evil" && m_Pay)
                {
                    if (m_Mobile.Fame >= 4000 && m_Mobile.Karma <= -4000)
                    {
                        PassTest = true;
                ...
                else if (((EpicCharacter)m_Giver).MyAlignment == "neutral" && m_Pay)
                {
                    if (m_Mobile.Fame >= 7000)
                    {
                        PassTest = true;
                ...
                if (m_Mobile.TotalGold < 5000 && m_Pay)
                {
                    m_Mobile.SendMessage(
                        m_Giver.Name + " needs at least 5,000 gold to construct the item for you."
                    );
                }
                else if (!(HaveSpecialItemRequirement(m_Mobile)) && m_Pay)
                {
                    m_Mobile.SendMessage(
                        m_Giver.Name
                            + " will need the a symbol of your "
                            + merit
                            + " ("
                            + GetSpecialItemRequirement(m_Mobile)
                            + ")."
                    );
                }
        ...
        public EpicCharacter(Serial serial)
            : base(serial) { }
        ...
        {
            public EpicBookGump(Mobile from, Mobile giver, int page, bool pay)
                : base(100, 100)
            {
                string color = "#cfc990";
                m_Mobile = from;
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + "><CENTER>TRIBUTE GIFTS</CENTER></BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem1, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem1, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem2, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem2, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem3, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem3, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem4, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem4, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem5, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem5, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem6, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem6, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem7, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem7, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem8, 1) != "")
                {
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem1, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem2, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem3, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem4, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem5, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem6, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem7, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem8, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem9, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem9, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem10, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem10, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem11, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem11, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem12, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem12, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem13, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem13, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem14, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem14, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem15, 1) != "")
                {
                    AddButton(x, y, 2447, 2447, showItem15, GumpButtonType.Reply, 0);
                }
                y = y + z;
                if (Server.Items.ManualOfItems.GetRelicArtyForBook(showItem16, 1) != "")
                {
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem9, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem10, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem11, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem12, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem13, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem14, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem15, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
                ...
                AddHtml(
                    ...
                    @"<BODY><BASEFONT Color="
                        + color
                        + ">"
                        + Server.Items.ManualOfItems.GetRelicArtyForBook(showItem16, 1)
                        + "</BASEFONT></BODY>",
                    (bool)false,
                    (bool)false
                );
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                string merit = "bravery";
                if (tribute.MyAlignment == "good")
                {
                    merit = "valor";
                }
                else if (tribute.MyAlignment == "evil")
                {
                    merit = "tenacity";
                }

                if (
                    tribute.MyAlignment == "good"
                    && m_Pay
                    && info.ButtonID > 0
                    && info.ButtonID < 300
                    && from.TotalGold >= 5000
                    && HaveSpecialItemRequirement(from)
                )
                {
                ...
                else if (!(HaveSpecialItemRequirement(from)) && m_Pay)
                {
                    from.SendMessage(
                        m_Giver.Name
                            ...
                            + merit
                            + " ("
                            + GetSpecialItemRequirement(from)
                            + ")."
                    );
                }
                else if ((passTest == true && pack.ConsumeTotal(typeof(Gold), 5000)) || !m_Pay)
                {
                    ...
                    if (sName != "")
                    {
                        ...
                        if (reward is BaseGiftAxe)
                        {
                            ...
                            ((BaseGiftAxe)reward).m_Gifter =
                                "From " + m_Giver.Name + " " + m_Giver.Title;
                        ...
                        if (reward is BaseGiftRanged)
                        {
                            ...
                            ((BaseGiftRanged)reward).m_Gifter =
                                "From " + m_Giver.Name + " " + m_Giver.Title;
                        ...
                        if (reward is BaseGiftClothing)
                        {
                            ...
                            ((BaseGiftClothing)reward).m_Gifter =
                                "From " + m_Giver.Name + " " + m_Giver.Title;
                        ...
                        if (reward is BaseGiftShield)
                        {
                            ...
                            ((BaseGiftShield)reward).m_Gifter =
                                "From " + m_Giver.Name + " " + m_Giver.Title;
                        ...
                        if (reward is BaseGiftBashing)
                        {
                            ...
                            ((BaseGiftBashing)reward).m_Gifter =
                                "From " + m_Giver.Name + " " + m_Giver.Title;
                        ...
                        if (reward is BaseGiftPoleArm)
                        {
                            ...
                            ((BaseGiftPoleArm)reward).m_Gifter =
                                "From " + m_Giver.Name + " " + m_Giver.Title;
                        ...
                        string sEntry =
                            ...
                            + m_Giver.Title;
                        string sMessage =
                            "You have received the " + sArty + " from " + m_Giver.Name + ".";
        ...
        public static void GiveGiftBonus(
            Item item,
            int val1,
            int val2,
            int val3,
        ...
        )
        {
            if (item is BaseWeapon)
            {
                ...
                else if (val1 == 100 && item is BaseRanged)
                {
                    ((BaseWeapon)item).SkillBonuses.SetValues(
                        0,
                        MorphingItem.GetMorphSkill(5),
                        sk1
                    );
                }
                else if (val1 > 0)
            ...
            else if (item is BaseArmor)
            {
                ...
                {
                    ((BaseArmor)item).SkillBonuses.SetValues(0, MorphingItem.GetMorphSkill(5), sk1);
                }
                else if (val1 > 0)
                {
            ...
            else if (item is BaseJewel)
            {
                ...
                {
                    ((BaseJewel)item).SkillBonuses.SetValues(0, MorphingItem.GetMorphSkill(5), sk1);
                }
                else if (val1 > 0)
                {
        ...
        {
            if (
                (dropped is Artifact_DupresCollar && this.Name == "Dupre")
            ...
            else if (dropped is CourierMail && !from.Blessed)
            {
                ...
                if (scroll.owner == from && scroll.MsgComplete > 0 && scroll.ForWho == FullName)
                {
                    ...
                    if (scroll.ForAlignment == "evil")
                    {
                        Titles.AwardKarma(from, -KarmaFame, true);
                    }
                    else if (scroll.ForAlignment == "good")
                    {
                        Titles.AwardKarma(from, KarmaFame, true);
                    }

                    int GoldReward = scroll.MsgReward * 1000;
                    if (scroll.ForAlignment == "neutral")
                    {
                        GoldReward = scroll.MsgReward * 1500;
                    }
                    ...
                    if (scroll.ForAlignment == "good")
                    {
                        ...
                        {
                            case 0:
                                sMessage = "Thank you for bringing this to me.";
                                break;
                            case 1:
                                sMessage = "I knew you could do it.";
                                break;
                            case 2:
                                sMessage = "This is a great help to us all.";
                                break;
                            case 3:
                                sMessage = "Good work! I am glad to see you arrive well.";
                                break;
                            case 4:
                                sMessage = "Your valor will be remembered.";
                                break;
                            case 5:
                                sMessage = "You have done what most others could not.";
                                break;
                        }
                    }
                    else if (scroll.ForAlignment == "evil")
                    {
                        ...
                        {
                            case 0:
                                sMessage = "It is good that you did not fail me.";
                                break;
                            case 1:
                                sMessage = "I trust you eliminated any troubles for this?";
                                break;
                            case 2:
                                sMessage = "Ahhh...another step closer to my plan.";
                                break;
                            case 3:
                                sMessage = "You may prove to be useful yet.";
                                break;
                            case 4:
                                sMessage = "You took long enough.";
                                break;
                            case 5:
                                sMessage = "I was about to send someone to deal with you.";
                                break;
                        }
                    }
                    else
                    {
                        ...
                        {
                            case 0:
                                sMessage = "Hmmm...I see you found it.";
                                break;
                            case 1:
                                sMessage = "I trust you had little difficulty?";
                                break;
                            case 2:
                                sMessage = "Good! I thought for sure you were lost.";
                                break;
                            case 3:
                                sMessage = "I guess my trust was well placed.";
                                break;
                            case 4:
                                sMessage = "I thought you perished in the attempt.";
                                break;
                            case 5:
                                sMessage = "I wasn't sure it really existed.";
                                break;
                        }
                    }
            ...
            else if (dropped is QuestTome && !from.Blessed)
            {
                ...
                if (
                    ...
                    && (
                        book.QuestTomeNPCGood == this.Name + " " + this.Title
                        || book.QuestTomeNPCEvil == this.Name + " " + this.Title
                    )
                )
                {
                    string sMessage = "";
                    if (book.QuestTomeGoals > 3)
                    {
                        ...
                        if (this.MyAlignment == "evil")
                        {
                            Titles.AwardKarma(from, -KarmaFame, true);
                        }
                        else if (this.MyAlignment == "good")
                        {
                            Titles.AwardKarma(from, KarmaFame, true);
                        }
                        ...
                        {
                            sMessage =
                                "Ahhh...you found it and perhaps saved us all! Choose your reward.";
                        }
