...
namespace Server.Mobiles
{
    public class MadGodPriest : BaseNPC
    {
        ...
        string[] kfcsay = new string[] { "All praise the Mad God.", };
        ...
        public MadGodPriest(Serial serial)
            : base(serial) { }
        ...
        public class MadGodPriestEntry : ContextMenuEntry
        {
            ...
            public MadGodPriestEntry(Mobile from, Mobile giver)
                : base(6146, 3)
            {
                m_Mobile = from;
                m_Giver = giver;
                    ...
                    if (!m_Mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        m_Mobile.SendGump(
                            new SpeechGump(
                                m_Mobile,
                                "The Catacombs Below",
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "MadGodPriest")
                            )
                        );
                    }
                }
