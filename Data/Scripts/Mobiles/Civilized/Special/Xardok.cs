...
namespace Server.Mobiles
{
    public class Xardok : BasePerson
    {
                    ...
                    if (!mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        mobile.SendGump(
                            new SpeechGump(
                                ...
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "Xardok")
                            )
                        );
                    }
                }
        ...
        public class XardokEntry : ContextMenuEntry
        {
            ...
            public XardokEntry(Mobile from, Mobile giver)
                : base(6120, 12)
            {
                m_Mobile = from;
                m_Giver = giver;
            ...
            public override void OnClick()
            {
                ...
                {
                    m_Giver.Say(
                        "You already have your orders. Return to me when you are done with the task."
                    );
                }
                ...
                {
                    m_Giver.Say(
                        "I have nothing for you at the moment. Check back in "
        ...
        public class XardokComplete : ContextMenuEntry
        {
            ...
            public XardokComplete(Mobile from, Mobile giver)
                : base(548, 12)
            {
                m_Mobile = from;
                m_Giver = giver;
                    ...
                    if (!m_Mobile.HasGump(typeof(SpeechGump)))
                    {
                        ...
                        m_Mobile.SendGump(
                            new SpeechGump(
                                ...
                                SpeechFunctions.SpeechText(m_Giver, m_Mobile, "XardokFail")
                            )
                        );
                    }
                }
