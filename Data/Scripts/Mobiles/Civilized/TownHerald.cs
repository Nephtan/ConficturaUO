...
namespace Server.Mobiles
{
    public class TownHerald : BasePerson
    {
        ...
        public static string randomShout(Mobile m)
        {
            ...
            {
                case 1:
                    greet = "Everyone listen! ";
                    break;
                case 2:
                    greet = "All hail and hear my words! ";
                    break;
                case 3:
                    greet = "Your attention please! ";
                    break;
            }
            ;
            if (m == null)
            ...
            switch (Utility.RandomMinMax(0, 6))
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    seen = "was spotted near";
                    break;
                case 5:
                    seen = "was found leaving";
                    break;
                case 6:
                    seen = "was spotted leaving";
                    break;
            }
            ...
            {
                case 0:
                    shout = "" + greet + "" + name + " " + seen + " in " + place + "";
                    break;
                case 1:
                    shout =
                        ""
                ...
                case 2:
                    ...
                    break;
                case 3:
                    shout = "" + greet + "" + name + " " + death + " in " + dungeon + "";
                    break;
                case 4:
                    shout = "" + greet + "" + name + " is wanted for " + crime + " in " + city + "";
                    break;
                case 5:
                    shout =
                        ""
                        ...
                        + item
                        + " "
                        + QuestCharacters.QuestItems(false)
                        + "";
                    if (Utility.RandomBool())
                    {
                        shout =
                            ...
                            + item
                            + " "
                            + QuestCharacters.ArtyItems(false)
                            + "";
                    }
                    break;
            }
        ...
        public TownHerald(Serial serial)
            : base(serial) { }
        ...
        public class TownHeraldEntry : ContextMenuEntry
        {
            ...
            public TownHeraldEntry(Mobile from, Mobile giver)
                : base(6146, 3)
            {
                m_Mobile = from;
                m_Giver = giver;
