...
namespace Server.Mobiles
{
    ...
    public class CaddelliteDragon : BaseCreature
    {
        ...
        {
            base.BreathDealDamage(target, 1);
        }

        [Constructable]
        public CaddelliteDragon()
        ...
        public CaddelliteDragon(Serial serial)
            : base(serial) { }
...
namespace Server.Items
{
    public class VordinaxChest : Item
    {
        ...
        public VordinaxChest(Serial serial)
            : base(serial) { }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (from.InRange(this.GetWorldLocation(), 2))
            {
                ...
                from.PrivateOverheadMessage(
                    ...
                    1150,
                    false,
                    "You have pulled Vordinax's Vault toward you.",
                    from.NetState
                );
                ...
                if (from is PlayerMobile)
                {
                    ...
                    if (
                        GetPlayerInfo.LuckyKiller(from.Luck)
                        && !Server.Misc.PlayerSettings.GetSpecialsKilled(from, "CaddelliteDragon")
                    )
                    {
