...
namespace Server.Mobiles
{
    ...
    public class DrakkhenRed : BaseMount
    {
        ...
        [Constructable]
        public DrakkhenRed(string name)
            : base(name, 596, 596, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a drakkhen";
            Body = 596;
            BaseSoundID = 362;
        ...
        public DrakkhenRed(Serial serial)
            : base(serial) { }
    ...
    public class DrakkhenBlack : BaseMount
    {
        ...
        [Constructable]
        public DrakkhenBlack()
            : this("a drakkhen") { }

        [Constructable]
        public DrakkhenBlack(string name)
            : base(name, 595, 595, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a drakkhen";
            Body = 595;
            BaseSoundID = 362;
        ...
        public DrakkhenBlack(Serial serial)
            : base(serial) { }
