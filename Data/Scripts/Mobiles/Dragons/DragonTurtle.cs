...
namespace Server.Mobiles
{
    ...
    public class DragonTurtle : BaseCreature
    {
        ...
        {
            base.BreathDealDamage(target, 16);
        }
                ...
                if (killer is PlayerMobile)
                {
                    if (GetPlayerInfo.LuckyKiller(killer.Luck) && Utility.RandomMinMax(1, 4) == 1)
                    {
                        ...
                        switch (Utility.RandomMinMax(0, 5))
                        {
                            case 0:
                                armor = new PlateArms();
                                armor.Name = "turtle shell arms";
                                break;
                            case 1:
                                armor = new PlateChest();
                                armor.Name = "turtle shell tunic";
                                break;
                            case 2:
                                armor = new PlateGloves();
                                armor.Name = "turtle shell gloves";
                                break;
                            case 3:
                                armor = new PlateGorget();
                                armor.Name = "turtle shell gorget";
                                break;
                            case 4:
                                armor = new PlateLegs();
                                armor.Name = "turtle shell legs";
                                break;
                            case 5:
                                armor = new DreadHelm();
                                armor.Name = "turtle shell helm";
                                break;
                        }
        ...
        public DragonTurtle(Serial serial)
            : base(serial) { }
