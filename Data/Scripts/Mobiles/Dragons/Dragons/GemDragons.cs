...
namespace Server.Mobiles
{
    ...
    public class GemDragon : BaseMount
    {
        ...
        {
            base.BreathDealDamage(target, 9);
        }
        ...
        [Constructable]
        public GemDragon(string name)
            : base(name, 61, 585, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 362;
            Tamable = true;
            ControlSlots = 3;
        ...
        public GemDragon(Serial serial)
            : base(serial) { }
