...
namespace Server.Mobiles
{
    ...
    public class SwampDrakeRiding : BaseMount
    {
        ...
        [Constructable]
        public SwampDrakeRiding()
            : this("a swamp drake") { }

        [Constructable]
        public SwampDrakeRiding(string name)
            : base(name, 55, 0x3EBD, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 362;
        ...
        public SwampDrakeRiding(Serial serial)
            : base(serial) { }
